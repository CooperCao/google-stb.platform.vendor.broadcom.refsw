...
typedef struct NEXUS_97358FrontendExtensionSettings
{
    ...
    unsigned boardRev;
} NEXUS_97358FrontendExtensionSettings;

typedef struct NEXUS_97358FrontendExtensionHandles
{
    NEXUS_FrontendHandle primary;
    NEXUS_FrontendHandle secondary;
    NEXUS_FrontendHandle qpsk;
} NEXUS_97358FrontendExtensionHandles;
...
NEXUS_Error NEXUS_Frontend_Create97358Extension(
    ...
    NEXUS_97358FrontendExtensionHandles *pHandles       /* [out] */
    );
