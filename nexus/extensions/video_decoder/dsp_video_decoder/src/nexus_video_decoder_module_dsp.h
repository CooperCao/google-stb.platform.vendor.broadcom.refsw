...
#define LOCK_AUDIO()    NEXUS_Module_Lock(g_NEXUS_videoDecoderModuleInternalSettings.audio)
#define UNLOCK_AUDIO()  NEXUS_Module_Unlock(g_NEXUS_videoDecoderModuleInternalSettings.audio)
