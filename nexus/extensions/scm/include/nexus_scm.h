 ...
 */
NEXUS_ScmChannelHandle NEXUS_Scm_CreateChannel( /* attr{destructor=NEXUS_Scm_DestroyChannel} */
    NEXUS_ScmHandle scm,
...
typedef struct NEXUS_ScmCommand {
    ...
    uint32_t * cmd; /* attr{memory=cached;null_allowed=y} */
    uint32_t cmd_size;
    uint32_t * rsp; /* attr{memory=cached;null_allowed=y} */
    uint32_t rsp_size;
} NEXUS_ScmCommand;
