...
typedef enum NEXUS_OtpCmdMsp
{
    ...
    NEXUS_OtpCmdMsp_eReserved134                            =   134,
    NEXUS_OtpCmdMsp_eReserved135                            =   135,
    ...
    NEXUS_OtpCmdMsp_eReserved193                            =   193,
    ...
    NEXUS_OtpCmdMsp_eReserved217                            =   217,
    NEXUS_OtpCmdMsp_eReserved218                            =   218,
    NEXUS_OtpCmdMsp_eReserved219                            =   219,
    NEXUS_OtpCmdMsp_eReserved220                            =   220,
    ...
    NEXUS_OtpCmdMsp_eReserved518                            =   518,
    NEXUS_OtpCmdMsp_eReserved519                            =   519,
    NEXUS_OtpCmdMsp_eReserved520                            =   520,
    ...
    NEXUS_OtpCmdMsp_ePrivilegedModeActivation               =    626,
    NEXUS_OtpCmdMsp_eCarlsbadDisable                        =    627,
    ...
    NEXUS_OtpCmdMsp_eAltMarketId                            =    633,
