...
} NEXUS_SecurityEncryptedControlWord, NEXUS_SecurityEncryptedKey;
...
NEXUS_VirtualKeyLadderHandle NEXUS_Security_AllocateVKL(
    const NEXUS_SecurityVKLSettings *pVKLReqSettings    /* structure holding input VKL Request parameters */
    );
