...
foreach $moduleUpper (@ARGV) {
    ...
    my $ipc = 1;
        ...
        if ( $thunked == 1 ) {
           ...
           print OUTFILE "\n";
           print OUTFILE "\${NEXUS_$moduleUpper\_SYNCTHUNKS} : \$(wildcard \$(addsuffix /*.h,\$(NEXUS_$moduleUpper\_PUBLIC_INCLUDES))) \$(CLASS_LIST) \$(NEXUS_SYNCTHUNK_DIR)/exists\n";
        ...
        print OUTFILE "\t\@echo \"[Compile... \$(notdir \$<) ($moduleLower)]\"\n";
        print OUTFILE "\t\$(Q_)\$(CC) \$(CDEP_FLAG) -include \${NEXUS_PRECOMPILED_HEADER_H} \$(NEXUS_CFLAGS) \$(NEXUS_CFLAGS_BPROFILE) \$(NEXUS_$moduleUpper\_CFLAGS) -c \$< -o \$@\n";
        print OUTFILE "\t\$(Q_)\$(PERL) \$(NEXUS_TOP)/build/os/ucos/fix_dep.pl \$(dir \$\@) \$(notdir \$(\@:.o=.d)) \$(patsubst %.o,%.d,\$\@)\n";
        print OUTFILE "endif";
