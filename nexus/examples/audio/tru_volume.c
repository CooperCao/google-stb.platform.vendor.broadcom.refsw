...
int main(void)
{
...
#endif
    NEXUS_AudioInput processedConnector;
    ...
    NEXUS_CustomVoice_AddInput(customVoice, NEXUS_AudioDecoder_GetConnector(audioDecoder, NEXUS_AudioDecoderConnectorType_eStereo));
    processedConnector = NEXUS_CustomVoice_GetConnector(customVoice);
#else
