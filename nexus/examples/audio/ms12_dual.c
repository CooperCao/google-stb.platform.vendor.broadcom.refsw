...
int main(int argc, char **argv)
{
    ...
    platformSettings.audioModuleSettings.numPcmBuffers += 1;
    ...
    for ( i = 1; i < argc; i++ )
    {
        ...
        else if ( !strcmp(argv[i], "-spdif_pcm") )
        {
            printf("Overriding SPDIF to PCM\n");
            spdifCompressed = false;
        }
        ...
        else if ( !strcmp(argv[i], "-audio_type") && (i+1) < argc )
        {
            ...
            else if ( !strcmp(argv[i], "ac4") )
            {
                printf("AC4 Decoder\n");
                codec = NEXUS_AudioCodec_eAc4;
            }
        ...
        else if ( !strcmp(argv[i], "-secondary_audio_type") && (i+1) < argc )
        {
            ...
            {
                printf("AC4 Secondary Decoder\n");
                secondaryCodec = NEXUS_AudioCodec_eAc4;
            }
            else if ( !strcmp(argv[i], "aac") || !strcmp(argv[i], "aac_adts") )
            {
        ...
        else if ( !strcmp(argv[i], "-directmixer") )
        {
            directMixer = true;
        }
        else
    ...
    if ( (codec == NEXUS_AudioCodec_eAc3Plus || codec == NEXUS_AudioCodec_eAc4) && multich71)
    {
    ...
    printf("\nDDRE settings:\n");
    printf("\tmultichannel format: %s\n", ddreSettings.multichannelFormat==NEXUS_AudioMultichannelFormat_e7_1?"7.1": "5.1");
    printf("-------------------------\n");
    printf("\tcertificationMode %d\n", certMode);
    printf("-------------------------\n");
