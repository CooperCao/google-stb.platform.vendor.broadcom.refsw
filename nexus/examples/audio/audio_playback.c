...
int main(int argc, char **argv)
{
    ...
    do
    {
        ...
        /*BDBG_ERR(("GetBuffer reports %u bytes available to write", (unsigned)bufferSize));*/
        ...
        if (bufferSize)
        {
            ...
            /*BDBG_ERR(("Wrote %u bytes to playback", (unsigned)bufferSize));*/
        }
        else
        {
            /* Wait for data callback */
            /*BDBG_ERR(("Wait for free available event"));*/
