...
int main(void)
{
	...
	printf("Sleeping for 4 seconds to allow AVS to complete initialization!\n");
	BKNI_Sleep(4*1000); /* give the AVS time to finish initialization ... */
	...
	printf("Current voltage is: %7.3fV\n", pStatus.voltage/1000.);
	printf("Current temperature is: %+7.2fC\n", pStatus.temperature/1000.);
