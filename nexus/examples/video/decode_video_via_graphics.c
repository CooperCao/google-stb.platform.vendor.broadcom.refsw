...
int main(int argc, char **argv)
{
    ...
    while (1) {
        ...
        if (!rc && num == 1) {
            NEXUS_Graphics2DDestripeBlitSettings destripeBlitSettings;
            ...
            NEXUS_Graphics2D_GetDefaultDestripeBlitSettings(&destripeBlitSettings);
            destripeBlitSettings.source.stripedSurface = stripedSurface;
            destripeBlitSettings.output.surface = surface;
            NEXUS_Graphics2D_DestripeBlit(gfx, &destripeBlitSettings);
