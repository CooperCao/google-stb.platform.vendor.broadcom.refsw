   ...
   0x3d,0x19,0x07,0x2f,
        ...
        for(j=0; j<numAudios; j++) {
			switch(audioCodec[j])
			{
                ...
                case NEXUS_AudioCodec_eAacAdts:      ((uint8_t *) pmt)[184-5*(6-j)] = 0xf; break; /* ADTS */
                case NEXUS_AudioCodec_eAacPlusAdts:  ((uint8_t *) pmt)[184-5*(6-j)] = 0xf; break; /* ADTS */
				case NEXUS_AudioCodec_eAacLoas:      ((uint8_t *) pmt)[184-5*(6-j)] = 0x11; break;/* LOAS */
				case NEXUS_AudioCodec_eAacPlusLoas:  ((uint8_t *) pmt)[184-5*(6-j)] = 0x11; break;/* LOAS */
