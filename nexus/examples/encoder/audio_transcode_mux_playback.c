...
int main(int argc, char **argv)
{
    ...
    NEXUS_AudioMuxOutputDelayStatus audioMuxDelay;
    ...
    audioProgram.nonRealTime = nonRealTime;
    ...
    muxConfig.nonRealTime  = nonRealTime;
    ...
    NEXUS_AudioMuxOutput_GetDelayStatus(audioMuxOutput, encoderSettings.codec, &audioMuxDelay);
    printf("Audio mux output delay = %u ms\n", audioMuxDelay.endToEndDelay);
    audioMuxStartSettings.presentationDelay = audioMuxDelay.endToEndDelay;
    audioMuxStartSettings.nonRealTime       = nonRealTime;
...
#else /* NEXUS_HAS_PLAYBACK && NEXUS_HAS_STREAM_MUX && NEXUS_HAS_AUDIO_MUX_OUTPUT */
int main(void)
{
