...
int main(void)
{
    ...
    /* open a video decoder and use its RAVE context */
    ...
    **/
    ...
    scramblingSettings.raveContext = NEXUS_VideoDecoder_DetachRaveContext(videoDecoder);
    ...
    NEXUS_VideoDecoder_AttachRaveContext(videoDecoder, scramblingSettings.raveContext);
