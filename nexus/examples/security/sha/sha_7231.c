...
static void SHA_Init (SHA_Context *pContext, SHA_TYPE shaType)
{
...
static void SHA_Updata (SHA_Context *pContext, unsigned int dataPhysicalAddress, unsigned int dataSize)
{
...
int main (void)
{
	...
	SHA_Init (pContext, SHA_TYPE_160);
...
#endif
		SHA_Updata (pContext, dataPhysicalAddress, DATA_CHUNK_SIZE);
