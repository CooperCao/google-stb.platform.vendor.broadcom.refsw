 ...
 * m2m_3des_aba_cbc_keyladder_askm_record.c */
...
/* This can be any stream file recorded stream from test app cps_m2m_3des_aba_cbc_keyladder_askm_record3desecb_keyladder_askm_record with ASKM encryption. */
...
static int      setup_ca_keylader_askm ( NEXUS_PidChannelHandle videoPidChannel,
                                         NEXUS_KeySlotHandle * pVideoKeyHandle, NEXUS_SecurityOperation operation );
...
int main ( void )
{
    ...
    /* Setup the security */
    setup_ca_keylader_askm ( videoPidChannel, &keyHandle, NEXUS_SecurityOperation_eDecrypt );
