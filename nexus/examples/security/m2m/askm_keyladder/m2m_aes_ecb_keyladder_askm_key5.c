...
int main ( void )
{
    ...
    uint8_t         keys[16] =
        { 0x11, 0x12, 0x60, 0xbb, 0x5a, 0xcb, 0xc2, 0x83, 0x1f, 0x6f, 0x89, 0x9d, 0x80, 0x12, 0xc4, 0x92 };

    unsigned char   ucProcInForKey3[16] =
        { 0x11, 0x11, 0x22, 0x22, 0x12, 0x34, 0x56, 0x78, 0x98, 0x76, 0x54, 0x32, 0x09, 0x23, 0x45, 0x56 };

    unsigned char   ucProcInKey4[16] =
        { 0x83, 0x92, 0x22, 0x9a, 0xb6, 0xf5, 0xf0, 0x82, 0x65, 0xe6, 0x68, 0xd1, 0xe8, 0x54, 0x9a, 0x75, };

    unsigned char   ucProcInKey5[16] =
        { 0xba, 0x30, 0xcd, 0x0c, 0xe0, 0xf0, 0x7f, 0x18, 0x41, 0x63, 0x6e, 0xda, 0x58, 0x6f, 0x43, 0x39 };
	...
	if ( Security_AllocateVkl ( NEXUS_SecurityCustomerSubMode_eGeneric_CP_128_5, &vklId ) )
	{
		printf ( "\nAllocate VKL failed.\n" );
		return 1;
	}
