...
/* This can be any stream file recorded stream from test app m2m_aescbc_keyladder_record recording and encrypting. */
...
int main(void)  {
   ...
   NEXUS_Platform_GetDefaultSettings ( &platformSettings );
	...
	if (keySlotSetup(&keyHandle, NEXUS_SecurityOperation_eDecrypt, vklId))
	{
