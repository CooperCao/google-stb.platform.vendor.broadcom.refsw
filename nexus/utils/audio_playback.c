...
int main(void)
{
    printf("This application is not supported on this platform (needs audio playback)!\n");
    return 0;
}
#else
...
int main(int argc, const char *argv[])
{
    ...
    settings.dataCallback.context = (void *)event;
    settings.dataCallback.param = 0;
