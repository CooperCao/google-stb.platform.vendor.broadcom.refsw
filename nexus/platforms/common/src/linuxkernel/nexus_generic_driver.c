...
nexus_generic_driver_ioctl(unsigned module, void *context_, unsigned int cmd, unsigned long arg, bool compat)
{
    ...
    case IOCTL_PROXY_NEXUS_Open:
         ...
         return rc;
    case IOCTL_PROXY_NEXUS_GetOsConfig:
         {
             PROXY_NEXUS_GetOsConfig osConfig;
             osConfig.os_64bit = NEXUS_Platform_P_IsOs64();
             rc = copy_to_user_small((void*)arg, &osConfig, sizeof(osConfig));
             return rc;
         }
    default:
         break;
