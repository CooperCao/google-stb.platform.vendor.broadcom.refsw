 ...
 ******************************************************************************/
#ifndef NEXUS_PLATFORM_GPIO_COMMON_H
#define NEXUS_PLATFORM_GPIO_COMMON_H 1

#include "nexus_gpio_init.h"
#include "b_shared_gpio_types.h"

typedef struct NEXUS_Platform_P_SharedGpioState
{
    bool featureSupported;
    NEXUS_GpioModuleOsSharedBankInitSettings initSettings;
    bool capsValid;
    NEXUS_GpioModuleOsSharedBankCapabilities caps;
