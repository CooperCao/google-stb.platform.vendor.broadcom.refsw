...
#define NEXUS_PLATFORM_97125  NEXUS_COMMON_PLATFORM_VERSION
#define NEXUS_PLATFORM_97125_CUSTOM NEXUS_COMMON_PLATFORM_VERSION_CUSTOM
#else
/* define a platform-specific version here */
#define NEXUS_PLATFORM_97125        NEXUS_PLATFORM_VERSION(0,0)
