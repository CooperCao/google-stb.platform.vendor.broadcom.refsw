...
NEXUS_Error NEXUS_Platform_P_InitPinmux(void)
{
    ...
    */
...
#if (defined(NEXUS_USE_7425_VMS_SFF) || defined(NEXUS_USE_7422_VMS_SFF) || defined(NEXUS_USE_7425_SATIPSW))
#if defined(NEXUS_USE_FRONTEND_3461_DAUGHTER_CARD)
            BCHP_FIELD_DATA(SUN_TOP_CTRL_PIN_MUX_CTRL_8, gpio_020, 1) | /* PKT_VALID0 */
#else
...
#elif (defined(NEXUS_USE_7425_VMS_SFF) || defined(NEXUS_USE_7422_VMS_SFF))
            BCHP_FIELD_DATA(SUN_TOP_CTRL_PIN_MUX_CTRL_8, gpio_025, 0) | /* First set as GPIO, then MTSIF_ATS_INC after FRONTEND INIT.  */
#else
    ...
    reg |=  BCHP_FIELD_DATA(SUN_TOP_CTRL_PIN_MUX_CTRL_12, gpio_052, 1) | /* CHIP2POD_MDO3 */
            ...
            BCHP_FIELD_DATA(SUN_TOP_CTRL_PIN_MUX_CTRL_12, gpio_058, 0) | /*  First set as GPIO, then MTSIF_ATS_INC after FRONTEND INIT.   */
...
#if NEXUS_PLATFORM_4538_DBS || NEXUS_PLATFORM_4517_DBS
...
#if defined(NEXUS_USE_FRONTEND_3461_DAUGHTER_CARD)
            BCHP_FIELD_DATA(SUN_TOP_CTRL_PIN_MUX_CTRL_16, gpio_085, 0) | /* GPIO_IRQ for 3461 */
#else
