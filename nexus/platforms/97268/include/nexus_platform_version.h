...
#define NEXUS_PLATFORM_97268  NEXUS_COMMON_PLATFORM_VERSION
#define NEXUS_PLATFORM_97268_CUSTOM NEXUS_COMMON_PLATFORM_VERSION_CUSTOM
#else
#define NEXUS_PLATFORM_97268        NEXUS_PLATFORM_VERSION(0,0)
#define NEXUS_PLATFORM_97268_CUSTOM ""
#endif
