...
#define NEXUS_PLATFORM_97208  NEXUS_COMMON_PLATFORM_VERSION
#define NEXUS_PLATFORM_97208_CUSTOM NEXUS_COMMON_PLATFORM_VERSION_CUSTOM
#else
/* define a platform-specific version here */
#define NEXUS_PLATFORM_97208        NEXUS_PLATFORM_VERSION(0,0)
