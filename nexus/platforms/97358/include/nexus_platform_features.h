...
/* Not all 3416 frontend interface is via SPI */
#ifndef NEXUS_FRONTEND_3461_USES_I2C
#define NEXUS_PLATFORM_97218_3461_USES_SPI 1
#endif


/* Only really need 1 SPI interface, configure the B-SPI for master
 * mode. However the 7218 is built on top off the 7358 software so
 * need to configure 4 SPI interfaces. 
 *  
 * 2 UPG_MSPI 2 HIF_MSPI 
 */ 
