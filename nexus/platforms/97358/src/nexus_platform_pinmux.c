...
NEXUS_Error NEXUS_Platform_P_InitPinmux(void)
{
    ...
    /* GPIO 20 configure as a general GPIO for SF_M_SSb */
    /* Configured in bspi.c */
    reg = BREG_Read32(hReg,BCHP_SUN_TOP_CTRL_PIN_MUX_CTRL_3);
    reg &= ~( BCHP_MASK(SUN_TOP_CTRL_PIN_MUX_CTRL_3, gpio_20) );
    reg |=  BCHP_FIELD_DATA(SUN_TOP_CTRL_PIN_MUX_CTRL_3, gpio_20, 1); /* EBI_CS2b */
    BREG_Write32 (hReg, BCHP_SUN_TOP_CTRL_PIN_MUX_CTRL_3, reg);

    /* BCHP_SUN_TOP_CTRL_PIN_MUX_CTRL_6
    * GPIO_46...GPIO_52: default
    */

    /* BCHP_SUN_TOP_CTRL_PIN_MUX_CTRL_7
    * GPIO_53...GPIO_60: Default
    */

    /* BCHP_SUN_TOP_CTRL_PIN_MUX_CTRL_8
    * GPIO_61...GPIO_68: default
    */

    /* BCHP_SUN_TOP_CTRL_PIN_MUX_CTRL_9
    * GPIO_69...GPIO_76: default
    */
    ...
    */
    ...
    reg |=( 
        ...
        /* BCHP_FIELD_DATA(AON_PIN_CTRL_PIN_MUX_CTRL_0, aon_gpio_00, 1 ) |     check this 7218 AUD_SPDIF */
        /* BCHP_FIELD_DATA(AON_PIN_CTRL_PIN_MUX_CTRL_0, aon_gpio_01, 1 ) |     check this 7218 ENET_LINK */
        BCHP_FIELD_DATA(AON_PIN_CTRL_PIN_MUX_CTRL_0, aon_gpio_03, 1 ) |     /* LED_OUT */
        BCHP_FIELD_DATA(AON_PIN_CTRL_PIN_MUX_CTRL_0, aon_gpio_04, 4 )       /* 3461 EXT_IRQ1 */
        );
    ...
    */
    ...
    reg |=( 
        ...
        BCHP_FIELD_DATA(AON_PIN_CTRL_PIN_MUX_CTRL_1, aon_gpio_13, 6 )   /* USB0_PWRFLT */
        );
#else
    reg &=~(
	...
	* AON_SGPIO_01   : BSC_M3_SDA(1)
    ...
    /* Configure the Input Band source select options 3461 -> 7218 uses PKT3 */
    reg = BREG_Read32(hReg, BCHP_SUN_TOP_CTRL_GENERAL_CTRL_0);
    reg &= ~(BCHP_MASK(SUN_TOP_CTRL_GENERAL_CTRL_0, ib2_source));
    reg |= BCHP_FIELD_DATA(SUN_TOP_CTRL_GENERAL_CTRL_0,ib2_source, 2); /* PKT3 */
...
NEXUS_Error NEXUS_Platform_P_InitPinmux(void)
{
    ...
    */
	...
	reg |=( 
		...
		BCHP_FIELD_DATA(AON_PIN_CTRL_PIN_MUX_CTRL_1, aon_gpio_12, 1 ) |  /* LED_LS0 */
		BCHP_FIELD_DATA(AON_PIN_CTRL_PIN_MUX_CTRL_1, aon_gpio_13, 1 )    /* LED_LS1 */
		);
