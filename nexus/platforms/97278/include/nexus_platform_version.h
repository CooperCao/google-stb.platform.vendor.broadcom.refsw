...
#define NEXUS_PLATFORM_97278  NEXUS_COMMON_PLATFORM_VERSION
#define NEXUS_PLATFORM_97278_CUSTOM NEXUS_COMMON_PLATFORM_VERSION_CUSTOM
#else
#define NEXUS_PLATFORM_97278        NEXUS_PLATFORM_VERSION(0,0)
#define NEXUS_PLATFORM_97278_CUSTOM ""
#endif
