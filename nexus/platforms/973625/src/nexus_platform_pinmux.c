...
NEXUS_Error NEXUS_Platform_P_InitPinmux(void)
{
	...
	*/
	...
	reg = BREG_Read32(hReg,BCHP_SUN_TOP_CTRL_PIN_MUX_CTRL_13);
		...
		reg |=	BCHP_FIELD_DATA(SUN_TOP_CTRL_PIN_MUX_CTRL_13, gpio_107, 2) | /* PKT4_CLK */
    ...
    reg &= ~(BCHP_MASK(SUN_TOP_CTRL_PIN_MUX_CTRL_14, gpio_111));
    reg |= BCHP_FIELD_DATA (SUN_TOP_CTRL_PIN_MUX_CTRL_14, gpio_111, 0);
	...
	*/
	...
	reg |=  BCHP_FIELD_DATA(SUN_TOP_CTRL_PIN_MUX_CTRL_15, gpio_121, 3) |  /* SDIO1_DAT0 */
        BCHP_FIELD_DATA(SUN_TOP_CTRL_PIN_MUX_CTRL_15, gpio_122, 3) |      /* SDIO1_CMD */
    ...
    */
	...
	reg |=(
		...
		BCHP_FIELD_DATA(AON_PIN_CTRL_PIN_MUX_CTRL_0, aon_gpio_04, 1 ) |     /* LED_LD0 */
	...
	* AON_GPIO_07    : LED_LD3(1)
	* AON_GPIO_08    : LED_LD4(1)
	* AON_GPIO_09    : LED_LD5(1)
	* AON_GPIO_10    : LED_LD6(1)
	* AON_GPIO_11    : LED_LD7(1)
    ...
    */
	...
	reg |=(
		...
		BCHP_FIELD_DATA(AON_PIN_CTRL_PIN_MUX_CTRL_1, aon_gpio_09, 1 ) |  /* LED_LD5 */
		BCHP_FIELD_DATA(AON_PIN_CTRL_PIN_MUX_CTRL_1, aon_gpio_10, 1 ) |  /* LED_LD6 */
		BCHP_FIELD_DATA(AON_PIN_CTRL_PIN_MUX_CTRL_1, aon_gpio_11, 1 ) |  /* LED_LD7 */
