...
void NEXUS_Platform_P_GetPlatformHeapSettings(NEXUS_PlatformSettings *pSettings, unsigned boxMode)
{
    ...
    pSettings->i2c[2].clock.type = NEXUS_GpioType_eSpecial;
    pSettings->i2c[2].clock.gpio = 4;
    pSettings->i2c[2].data.type = NEXUS_GpioType_eSpecial;
