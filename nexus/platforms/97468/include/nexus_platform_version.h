...
#define NEXUS_PLATFORM_97468  NEXUS_COMMON_PLATFORM_VERSION
#define NEXUS_PLATFORM_97468_CUSTOM NEXUS_COMMON_PLATFORM_VERSION_CUSTOM
#else
/* define a platform-specific version here */
#define NEXUS_PLATFORM_97468        NEXUS_PLATFORM_VERSION(0,0)
