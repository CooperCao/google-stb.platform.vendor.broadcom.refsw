...
static void nexus_p_modifyMemoryRtsSettings(NEXUS_MemoryRtsSettings *pRtsSettings )
{
    ...
    case 12:
        ...
        break;
    case 3:
        pRtsSettings->vce[1].memcIndex = 2;
        pRtsSettings->vce[0].memcIndex = 0;
        pRtsSettings->videoEncoder[2].device  = 1;
        pRtsSettings->videoEncoder[2].channel = 0;
        break;
    case 7:
        pRtsSettings->vce[1].memcIndex = 2;
        pRtsSettings->vce[0].memcIndex = 2;
        break;
    case 8:
        pRtsSettings->vce[1].memcIndex = 1;
        pRtsSettings->vce[0].memcIndex = 0;
	...
	case 1000:
        ...
        pRtsSettings->videoEncoder[2].device  = 1;
        pRtsSettings->videoEncoder[2].channel = 0;
        pRtsSettings->videoEncoder[3].device  = 1;
        pRtsSettings->videoEncoder[3].channel = 1;
        break;
