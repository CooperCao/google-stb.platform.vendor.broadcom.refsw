...
*    This file defines a set of controllable fields for a 7408 platform.
*
***************************************************************************/
...
/* Transport Features */
#define NEXUS_NUM_PARSER_BANDS 0
#define NEXUS_NUM_PID_CHANNELS 64
#define NEXUS_NUM_VCXOS 1
#define NEXUS_NUM_MESSAGE_FILTERS 0
...
/* Audio Features */
#define NEXUS_NUM_AUDIO_DECODERS 2 
#define NEXUS_NUM_AUDIO_DACS 1
#define NEXUS_NUM_SPDIF_OUTPUTS 1
#define NEXUS_NUM_AUDIO_MIXERS 6
