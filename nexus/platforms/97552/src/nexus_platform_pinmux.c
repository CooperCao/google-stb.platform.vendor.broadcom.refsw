...
NEXUS_Error NEXUS_Platform_P_InitPinmux(void)
{
    ...
    BDBG_MSG(("Chip ID = 0x%x", chpInfo.productId));
    ...
    */
    ...
    reg |=( 
        ...
        BCHP_FIELD_DATA(AON_PIN_CTRL_PIN_MUX_CTRL_0, aon_gpio_04, 4 ) |     /* EXT_IRQ1 */
#else
    ...
    */
    ...
    else
    {
                ...
                reg |=( 
                    BCHP_FIELD_DATA(AON_PIN_CTRL_PIN_MUX_CTRL_2, aon_gpio_15, 2 ) |  /* MTSIF0_DATA2 */
                    BCHP_FIELD_DATA(AON_PIN_CTRL_PIN_MUX_CTRL_2, aon_gpio_16, 2 ) |  /* MTSIF0_DATA3 */
                    BCHP_FIELD_DATA(AON_PIN_CTRL_PIN_MUX_CTRL_2, aon_gpio_17, 2 ) |  /* MTSIF0_DATA4 */
                    BCHP_FIELD_DATA(AON_PIN_CTRL_PIN_MUX_CTRL_2, aon_sgpio_00,1 )    /* BSC_M3_SCL */
                    );
#else
        reg &=~(
