...
void nxclient_p_get_thermal_configuration_list(nxclient_ipc_t client, NxClient_ThermalConfigurationList *pConfigList)
{
    NxClient_P_GetThermalConfigurationList(client->client, pConfigList);
}

int nxclient_p_get_thermal_configuration(nxclient_ipc_t client, unsigned tempThreshold, NxClient_ThermalConfiguration *pConfig)
{
    return NxClient_P_GetThermalConfiguration(client->client, tempThreshold, pConfig);
}

int  nxclient_p_set_thermal_configuration(nxclient_ipc_t client, unsigned tempThreshold, bool pConfig_isNull, const NxClient_ThermalConfiguration *pConfig)
{
    return NxClient_P_SetThermalConfiguration(client->client, tempThreshold, pConfig_isNull, pConfig);
}
