        ...
        if (configs[i].filename)
        {
            ...
            case NEXUS_AudioCodec_eAc4:
                ...
                if (preferrLanguageOverType) {
                    codecSettings.codecSettings.ac4.preferLanguageOverAssociateType = true;
                    strcpy(codecSettings.codecSettings.ac4.languagePreference[0].selection, preferredLangauge);
                }
                codecSettings.codecSettings.ac4.enableAssociateMixing = ac4mixing;
                codecSettings.codecSettings.ac4.preferredAssociateType = ac4associateType;
                break;
