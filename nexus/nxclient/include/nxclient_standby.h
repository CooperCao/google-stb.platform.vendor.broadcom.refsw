...
typedef struct NxClient_StandbyStatus
{
    ...
    NEXUS_Timestamp lastStandbyTimestamp;          /* Last timestamp in ms when system entered standby */
    NEXUS_Timestamp lastResumeTimestamp;           /* Last timestamp in ms when system woke up */
