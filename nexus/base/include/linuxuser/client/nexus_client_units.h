...
#define B_IPC_CLIENT_END_ACQUIRE_HANDLE(type, api) done_end: NEXUS_P_ClientCall_End(&__state); if (__result) NEXUS_StartCallbacks((void*)__result); done: NEXUS_CLIENT_LEAVE(api);return __result; err_call: __result=0; goto done_end;;err_begin: __result=0;goto done;}
