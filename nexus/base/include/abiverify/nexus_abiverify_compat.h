...
#define NEXUS_P_COMPAT_CHECK_RETURN_CODE(module, api) if(__out_data->api.ret.__retval != NEXUS_SUCCESS) {__compat_out_data->api.ret.__retval=/*BERR_TRACE*/(__out_data->api.ret.__retval);break;}
