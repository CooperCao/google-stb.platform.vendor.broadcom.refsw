 ...
 *  \param[in] Flag to indicate is request coming from new connection. If true incerease RefCnt for device with same IP.
 *  \retval none.
 */
...
/*
 * Function to clean up Session list and decrease RefCnt
*/
