 ...
 */
BERR_Code B_DTCP_InitExchKeyData(B_DeviceParams_T * pDeviceParams, B_DTCP_ExchKeyData_T * pExchKeyData);
 ...
 */
BERR_Code B_DTCP_UpdateSourceExchKeys(B_DeviceParams_T * pDeviceParams, B_DTCP_ExchKeyData_T * pExchKeys);
