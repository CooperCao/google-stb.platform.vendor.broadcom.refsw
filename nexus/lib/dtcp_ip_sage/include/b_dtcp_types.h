...
{
    unsigned char * Cert;                    /*!<Device certificate pointer, baseline full/ext full or Restricted*/
    ...
    DRM_DtcpIpTlHandle hDtcpIpTl;                   /*!< DTCP Thin layer handle for SAGE communication*/
