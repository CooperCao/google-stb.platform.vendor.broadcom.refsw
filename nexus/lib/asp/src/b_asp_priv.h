...
#define B_ASP_MSG_PRE_FMT  "%s():%d: "
#define B_ASP_MSG_PRE_ARG ,BSTD_FUNCTION,BSTD_LINE

#define B_ASP_CHECK_GOTO(                                                                   \
    ...
    do {                                                                                    \
        if (!(expression)) {                                                                \
            BDBG_ERR(("ERROR: %s:%s:%d:-->", BSTD_FILE, BSTD_FUNCTION, BSTD_LINE));         \
