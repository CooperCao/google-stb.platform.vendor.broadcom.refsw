...
typedef struct BIP_TranscodeProfile
{
    ...
    struct
    {
        ...
        NEXUS_AudioCodec                    audioCodec;         /* Output codec (ignored if passthrough = true) */ /*TODO: Need to be removed since this is already part of "NEXUS_AudioEncoderCodecSettings" */
...
#define BIP_Transcode_GetDefaultProfileFor_720p30_AVC_AAC_MPEG2_TS(profile)                         \
        ...
        NEXUS_AudioEncoder_GetDefaultCodecSettings((profile)->audio.audioCodec, &(profile)->audio.settings); \
