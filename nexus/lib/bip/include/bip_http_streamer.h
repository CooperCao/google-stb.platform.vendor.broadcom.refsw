...
#define BIP_HttpStreamer_GetDefaultStartSettings(pSettings)                      \
        ...
        (pSettings)->streamingSettings.raveInterruptBasedSettings.dataReadyScaleFactor = 4;      \
        (pSettings)->streamingSettings.raveInterruptBasedSettings.timeOutIntervalInMs = 20;      \
