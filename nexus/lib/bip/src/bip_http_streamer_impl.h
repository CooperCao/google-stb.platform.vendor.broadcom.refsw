...
#define BIP_HTTP_STREAMER_DTCP_IP_AKE_TIMER_POLL_INTERVAL_IN_MSEC 100
    ...
    BIP_HttpHeaderListHandle                    hCustomResponseHeaderList;              /* Any app added response headers will be added in this list. This will be added in consecutive all response headers for hls and mpeg dash kind of usage. */
