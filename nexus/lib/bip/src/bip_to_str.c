...
const char * BIP_ToStr_BIP_PlayerSubState( int value)
{
    const namevalue_t myStrings[] = {
        ...
        { "StartingWaitConnectCompletion"       , BIP_PlayerSubState_eStartingWaitForConnectCompletion      },
...
const char * BIP_ToStr_BIP_MediaInfoCaptionType(int value)
{
    const namevalue_t   myStrings[] = {
        {"608"       ,BIP_MediaInfoCaptionType_e608},
        {"708"       ,BIP_MediaInfoCaptionType_e708},
    };
    return  (lookup_name(myStrings, (value)));
}
