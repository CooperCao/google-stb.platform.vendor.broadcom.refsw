...
* 
***************************************************************************/
#ifndef NEXUS_TUNER_3420_H__
#define NEXUS_TUNER_3420_H__
...
/***************************************************************************
Summary:
    Settings for a BCM3420 Device
 ***************************************************************************/
typedef struct NEXUS_3420Settings
{
    NEXUS_I2cHandle i2cDevice;      /* I2C device to use */
    uint16_t i2cAddr;               /* Device I2C Address */
    unsigned long ifFrequency;		/* in Hertz */
    unsigned long xtalFrequency;	/* in Hertz */
    bool enableAgcGain;             /* true=Enable AGC Gain, otherwise disabled */
} NEXUS_3420Settings;
 ...
 ***************************************************************************/
NEXUS_TunerHandle NEXUS_Tuner_Open3420(  /* attr{destructor=NEXUS_Tuner_Close} */
...
#endif /* #ifndef NEXUS_TUNER_3420_H__ */
