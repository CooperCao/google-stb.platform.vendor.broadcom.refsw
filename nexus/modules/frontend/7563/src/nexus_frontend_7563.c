...
static NEXUS_Error NEXUS_Frontend_P_7563_GetDvbt2AsyncFecStatistics (void *handle, NEXUS_FrontendDvbt2StatusType type, NEXUS_FrontendDvbt2FecStatistics *pStatistics);
...
static NEXUS_Error NEXUS_Frontend_P_7563_GetDvbt2AsyncL1PlpStatus(void *handle, NEXUS_FrontendDvbt2L1PlpStatus *pStatus);
...
NEXUS_FrontendHandle NEXUS_Frontend_Open3461(const NEXUS_3461Settings *pSettings)
{
    ...
    frontendHandle->getDvbt2AsyncFecStatistics = NEXUS_Frontend_P_7563_GetDvbt2AsyncFecStatistics;
    frontendHandle->getDvbt2AsyncL1PreStatus = NEXUS_Frontend_P_7563_GetDvbt2AsyncL1PreStatus;
    frontendHandle->getDvbt2AsyncL1PostConfigurableStatus = NEXUS_Frontend_P_7563_GetDvbt2AsyncL1PostConfigurableStatus;
    frontendHandle->getDvbt2AsyncPostDynamicStatus = NEXUS_Frontend_P_7563_GetDvbt2AsyncPostDynamicStatus;
    frontendHandle->getDvbt2AsyncL1PlpStatus = NEXUS_Frontend_P_7563_GetDvbt2AsyncL1PlpStatus;
    frontendHandle->getDvbt2AsyncBasicStatus = NEXUS_Frontend_P_7563_GetDvbt2AsyncBasicStatus;
...
static NEXUS_Error NEXUS_Frontend_P_7563_GetDvbt2AsyncFecStatistics(void *handle, NEXUS_FrontendDvbt2StatusType type, NEXUS_FrontendDvbt2FecStatistics *pStatus)
{
    NEXUS_Error  rc = NEXUS_SUCCESS;
    BODS_SelectiveAsyncStatusType statusType;
    NEXUS_7563 *pDevice;
...
static NEXUS_Error NEXUS_Frontend_P_7563_GetDvbt2AsyncL1PreStatus(void *handle, NEXUS_FrontendDvbt2L1PreStatus *pStatus)
{
    ...
    rc = BODS_GetSelectiveAsyncStatus(pDevice->ods_chn[NEXUS_7563_DVBT2_CHN], BODS_SelectiveAsyncStatusType_eDvbt2L1Pre, &pDevice->odsStatus);
    if(rc){rc = BERR_TRACE(rc); goto done;}
...
static NEXUS_Error NEXUS_Frontend_P_7563_GetDvbt2AsyncL1PostConfigurableStatus(void *handle, NEXUS_FrontendDvbt2L1PostConfigurableStatus *pStatus)
{
    ...
    rc = BODS_GetSelectiveAsyncStatus(pDevice->ods_chn[NEXUS_7563_DVBT2_CHN], BODS_SelectiveAsyncStatusType_eDvbt2L1PostConfigurable, &pDevice->odsStatus);
    if(rc){rc = BERR_TRACE(rc); goto done;}
...
static NEXUS_Error NEXUS_Frontend_P_7563_GetDvbt2AsyncPostDynamicStatus(void *handle, NEXUS_FrontendDvbt2L1PostDynamicStatus *pStatus)
{
    ...
    rc = BODS_GetSelectiveAsyncStatus(pDevice->ods_chn[NEXUS_7563_DVBT2_CHN], BODS_SelectiveAsyncStatusType_eDvbt2L1PostDynamic, &pDevice->odsStatus);
    if(rc){rc = BERR_TRACE(rc); goto done;}
...
static NEXUS_Error NEXUS_Frontend_P_7563_GetDvbt2AsyncL1PlpStatus(void *handle, NEXUS_FrontendDvbt2L1PlpStatus *pStatus)
{
    ...
    rc = BODS_GetSelectiveAsyncStatus(pDevice->ods_chn[NEXUS_7563_DVBT2_CHN], BODS_SelectiveAsyncStatusType_eDvbt2L1Plp, &pDevice->odsStatus);
    if(rc){rc = BERR_TRACE(rc); goto done;}
...
static NEXUS_Error NEXUS_Frontend_P_7563_GetDvbt2AsyncBasicStatus(void *handle, NEXUS_FrontendDvbt2BasicStatus *pStatus)
{
    ...
    rc = BODS_GetSelectiveAsyncStatus(pDevice->ods_chn[NEXUS_7563_DVBT2_CHN], BODS_SelectiveAsyncStatusType_eDvbt2Short, &pDevice->odsStatus);
    if(rc){rc = BERR_TRACE(rc); goto done;}
...
static NEXUS_Error NEXUS_Frontend_P_7563_GetOfdmAsyncStatus(void *handle, NEXUS_FrontendOfdmStatus *pStatus)
{
    ...
    case NEXUS_7563_DVBT2_CHN:
        ...
        {
            rc = NEXUS_Frontend_P_7563_GetDvbt2AsyncBasicStatus(handle, &basic);
            if(rc){rc = BERR_TRACE(rc); goto done;}
            ...
            rc = NEXUS_Frontend_P_7563_GetDvbt2AsyncFecStatistics(handle, NEXUS_FrontendDvbt2StatusType_eFecStatisticsPlpA, &pStatus->dvbt2Status.plpAStatistics);
            if(rc){rc = BERR_TRACE(rc); goto done;}

            rc = NEXUS_Frontend_P_7563_GetDvbt2AsyncL1PreStatus(handle, &pStatus->dvbt2Status.l1PreStatus);
            if(rc){rc = BERR_TRACE(rc); goto done;}

            rc = NEXUS_Frontend_P_7563_GetDvbt2AsyncL1PostConfigurableStatus(handle, &pStatus->dvbt2Status.l1PostCfgStatus);
            if(rc){rc = BERR_TRACE(rc); goto done;}

            rc = NEXUS_Frontend_P_7563_GetDvbt2AsyncL1PlpStatus(handle, &pStatus->dvbt2Status.l1PlpStatus);
            if(rc){rc = BERR_TRACE(rc); goto done;}
