...
/**
Sample code for bfile_io_write_posix:
    struct bfile_io_write_posix file;
    char buffer[1024];
    bfile_io_write_posix_open(&file, filename, false);
    file.self.write(&file.self, buffer, sizeof(buffer));
    bfile_io_write_posix_close(&file);
**/
