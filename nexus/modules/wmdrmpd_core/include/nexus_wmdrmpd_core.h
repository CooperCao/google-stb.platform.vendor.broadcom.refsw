...
#ifndef NEXUS_WMDRMPD_CORE_H_
#define NEXUS_WMDRMPD_CORE_H_

/***************************************************************************
Summary: 
WMDRMPD Handle
***************************************************************************/
typedef struct NEXUS_WmDrmPdCore *NEXUS_WmDrmPdCoreHandle;
...
***************************************************************************/
typedef struct NEXUS_WmDrmPdCoreSettings
{
    ...
    NEXUS_WmDrmPdIoHandle ioHandle;         /* I/O handle for file operations */
} NEXUS_WmDrmPdCoreSettings;
...
***************************************************************************/
void NEXUS_WmDrmPdCore_Destroy(
...
/***************************************************************************
Summary: 
Get Default ASF Digsign Object
***************************************************************************/
...
responsible for calling NEXUS_WmDrmPdCore_GetLicenseChallenge and 
NEXUS_WmDrmPdCore_LicenseChallengeComplete(). 
 
See Also: 
NEXUS_WmDrmPdCore_SetPsiObject 
NEXUS_WmDrmPdCore_SetCencrObject 
NEXUS_WmDrmPdCore_SetXcencrObject 
NEXUS_WmDrmPdCore_SetDigsignObject 
NEXUS_WmDrmPdCore_GetLicenseChallenge 
***************************************************************************/
...
Description: 
If an error is returned from NEXUS_WmDrmPdCore_LoadLicense, this routine should 
...
application should call NEXUS_WmDrmPdCore_LicenseChallengeComplete().  If 
an error occurs (e.g. timeout), the application should call 
NEXUS_WmDrmPdCore_LicenseChallengeComplete(handle, 0, 0) to report the 
failure. 
 
See Also: 
NEXUS_WmDrmPdCore_LoadLicense 
NEXUS_WmDrmPdCore_LicenseChallengeComplete 
***************************************************************************/
...
custom data is necessary, use NEXUS_WmDrmPdCore_GetLicenseChallenge() instead.
...
/***************************************************************************
Summary: 
Send License Challenge Response. Then, it attempts to bind the internal decryption
context to the newly acquired license.
 
Description: 
This call should indicate the response data length and offset to the 
response payload within the NEXUS_WmDrmPdCoreLicenseChallenge.pResponseBuffer 
buffer.  If an error occurred (e.g. timeout), pass an offset and length 
of 0 into this routine. 
 
See Also: 
NEXUS_WmDrmPdCore_GetLicenseChallenge .
NEXUS_WmDrmPdCore_ProcessLicenseAcquisitionResponse
***************************************************************************/
...
calling NEXUS_WmDrmPdCore_Bind().
 
See Also: 
NEXUS_WmDrmPdCore_Bind 
***************************************************************************/
NEXUS_Error NEXUS_WmDrmPdCore_ProcessLicenseAcquisitionResponse(
    NEXUS_WmDrmPdCoreHandle handle,
    const void *pResponse, /* attr{memory=cached} */
...
/***************************************************************************
Summary: 
Store revocation package in the secure store.
***************************************************************************/
...
See Also:
NEXUS_WmDrmPd_GetRequiredBufferSize
***************************************************************************/
...
See Also:
NEXUS_WmDrmPdCore_ContentGetProperty,
NEXUS_WmDrmPdCore_Bind,
NEXUS_WmDrmPdCore_Commit
***************************************************************************/
...
which match the header set during the call to NEXUS_WmDrmPdCore_ContentSetProperty().
...
See Also:
NEXUS_WmDrmPdCore_ContentSetProperty,
NEXUS_WmDrmPdCore_Bind,
NEXUS_WmDrmPdCore_Commit
***************************************************************************/
...
See Also:
NEXUS_WmDrmPdCore_FreeDecryptContext
***************************************************************************/
...
See Also:
NEXUS_WmDrmPdCore_AllocateDecryptContext
***************************************************************************/
...
/***************************************************************************
Summary:
Get required buffer size for NEXUS_WmDrmPdCore_LicenseAcquisitionGenerateChallengeAck
***************************************************************************/
...
#endif /* #ifndef NEXUS_WMDRMPD_CORE_H_ */
