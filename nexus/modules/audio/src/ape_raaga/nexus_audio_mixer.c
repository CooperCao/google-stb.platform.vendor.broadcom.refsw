    ...
    )
{
    ...
    mainDecodeFadeChanged = handle->settings.mixUsingDsp && (BAPE_GetDolbyMSVersion() == BAPE_DolbyMSVersion_eMS12 || BAPE_GetDolbyMSVersion() == BAPE_DolbyMSVersion_eMS11Plus) &&
