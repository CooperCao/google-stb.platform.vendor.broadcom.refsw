 ...
 *  ANY LIMITED REMEDY.
 **************************************************************************/
#ifndef NEXUS_SIMPLE_AUDIO_PLAYBACK_MODULE_H__
#define NEXUS_SIMPLE_AUDIO_PLAYBACK_MODULE_H__

#include "nexus_simple_audio_playback_thunks.h"
...
#include "nexus_simple_audio_playback_impl.h"
...
#endif
#define NEXUS_MODULE_NAME simple_audio_playback
#define NEXUS_MODULE_SELF g_NEXUS_simpleAudioPlaybackModule

NEXUS_OBJECT_CLASS_DECLARE(NEXUS_SimpleAudioPlayback);

extern NEXUS_ModuleHandle g_NEXUS_simpleAudioPlaybackModule;
