...
typedef enum NEXUS_CecLogicalAddrSearch
{
    ...
    NEXUS_CecLogicalAddrSearch_eInit,  /* Start search for unused Logical Addr */

    NEXUS_CecLogicalAddrSearch_eNext,  /* Ping next Logical Addr */
                                       /* Active device will ACK; otherwise NACK */

    NEXUS_CecLogicalAddrSearch_eReportAddrFound, /* NACK indicates Addr is available */
                                                 /* Broadcast/claim new Logical Addr */

    NEXUS_CecLogicalAddrSearch_eReady  /* CEC device config complete; ready for use */
