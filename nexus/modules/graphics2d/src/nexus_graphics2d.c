...
NEXUS_Graphics2DHandle NEXUS_Graphics2D_Open(unsigned index, const NEXUS_Graphics2DOpenSettings *pSettings)
{
    ...
    BDBG_CASSERT(BM2MC_PACKET_PixelFormat_eCompressed_A8_R8_G8_B8 == (BM2MC_PACKET_PixelFormat)NEXUS_PixelFormat_eCompressed_A8_R8_G8_B8);
    BDBG_CASSERT(BM2MC_PACKET_PixelFormat_eUIF_R8_G8_B8_A8 == (BM2MC_PACKET_PixelFormat)NEXUS_PixelFormat_eUIF_R8_G8_B8_A8);
