...
#ifndef NEXUS_OTP_MSP__H_
#define NEXUS_OTP_MSP__H_
...
typedef struct NEXUS_OtpMspRead {
    uint32_t data;                  /* OTP MSP data */
    uint32_t valid;                 /* mask indicating what bits of "data" are valid.
                                            b1 indicates the corresponding bit is prorammed and retured in "data".
                                            b0 indicates the bit is NOT prorammed and assumed to have a value of 0. */
}NEXUS_OtpMspRead;

typedef struct NEXUS_OtpMspWrite {
...
*/
NEXUS_Error NEXUS_OtpMsp_Read(
    unsigned index,                 /* MSP OTP entry locator. */
    NEXUS_OtpMspRead *pResult       /* [out] The read/returned OTP MSP value */
    );

/*
    Write an MSP OTP entry. MSP entries can only be written once.
*/
