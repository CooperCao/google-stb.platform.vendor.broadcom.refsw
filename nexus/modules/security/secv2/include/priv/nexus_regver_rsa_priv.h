...
#ifndef NEXUS_REGVER_RSA_PRIV_H__
#define NEXUS_REGVER_RSA_PRIV_H__
...
typedef struct NEXUS_RegVerRsaInfo_priv
{
    BHSM_RvRsaHandle rvRsaKeyHandle;
}NEXUS_RegVerRsaInfo_priv;
