                                         ...
                                         const NEXUS_KeyLadderSettings *pSettings )
{
    ...
    hsmSettings.keySize = pSettings->keySize;
    hsmSettings.operation = pSettings->operation;
    hsmSettings.mode = pSettings->mode;
    hsmSettings.numLevels = pSettings->numLevels;

    hsmSettings.root.type = pSettings->root.type;
    hsmSettings.root.otpKeyIndex = pSettings->root.otpKeyIndex;

    hsmSettings.root.askm.moduleId = pSettings->root.askm.moduleId ;
    ...
    hsmSettings.root.customerKey.low = pSettings->root.customerKey.low ;
    hsmSettings.root.customerKey.high = pSettings->root.customerKey.high ;
    hsmSettings.root.customerKey.lowVar = pSettings->root.customerKey.lowVar;
    hsmSettings.root.customerKey.highVar = pSettings->root.customerKey.highVar;
    hsmSettings.root.customerKey.swizzle = pSettings->root.customerKey.swizzle;
    hsmSettings.root.customerKey.swizzleIndex = pSettings->root.customerKey.swizzleIndex;
                                               ...
                                               const NEXUS_KeyLadderLevelKey *pKey )
{
    ...
    if( pKey->level > handle->settings.numLevels ) {
