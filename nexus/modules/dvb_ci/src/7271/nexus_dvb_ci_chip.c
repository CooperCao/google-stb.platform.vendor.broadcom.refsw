...
NEXUS_Error NEXUS_DvbCi_P_SetupPinmuxes(NEXUS_DvbCiHandle handle, bool pcmciaMode)
{
    ...
    if ( pcmciaMode )
    {
        ...
        regVal &= ~(
                ...
                BCHP_MASK(SUN_TOP_CTRL_PIN_MUX_CTRL_6, gpio_044) |
                BCHP_MASK(SUN_TOP_CTRL_PIN_MUX_CTRL_6, gpio_045) |
                BCHP_MASK(SUN_TOP_CTRL_PIN_MUX_CTRL_6, gpio_046) |
                BCHP_MASK(SUN_TOP_CTRL_PIN_MUX_CTRL_6, gpio_047) |
        ...
        regVal &= ~(
                ...
                BCHP_MASK(SUN_TOP_CTRL_PIN_MUX_CTRL_7, gpio_055)
                );
    ...
    { /*dvb-ci mode*/
        ...
        regVal |=
                BCHP_FIELD_ENUM(SUN_TOP_CTRL_PIN_MUX_CTRL_6, gpio_042, POD2CHIP_MCLKI) |
                BCHP_FIELD_ENUM(SUN_TOP_CTRL_PIN_MUX_CTRL_6, gpio_043, POD2CHIP_SDI) |
                BCHP_FIELD_ENUM(SUN_TOP_CTRL_PIN_MUX_CTRL_6, gpio_044, POD2CHIP_MISTRT) |
                BCHP_FIELD_ENUM(SUN_TOP_CTRL_PIN_MUX_CTRL_6, gpio_045, POD2CHIP_MIVAL) |
                BCHP_FIELD_ENUM(SUN_TOP_CTRL_PIN_MUX_CTRL_6, gpio_046, POD2CHIP_MDI0) |
                BCHP_FIELD_ENUM(SUN_TOP_CTRL_PIN_MUX_CTRL_6, gpio_047, POD2CHIP_MDI1) |
                BCHP_FIELD_ENUM(SUN_TOP_CTRL_PIN_MUX_CTRL_6, gpio_048, POD2CHIP_MDI2);
        BREG_Write32(hReg, BCHP_SUN_TOP_CTRL_PIN_MUX_CTRL_6, regVal);
        ...
        regVal |=
                BCHP_FIELD_ENUM(SUN_TOP_CTRL_PIN_MUX_CTRL_7, gpio_049, POD2CHIP_MDI3) |
                BCHP_FIELD_ENUM(SUN_TOP_CTRL_PIN_MUX_CTRL_7, gpio_050, POD2CHIP_MDI4) |
                BCHP_FIELD_ENUM(SUN_TOP_CTRL_PIN_MUX_CTRL_7, gpio_051, POD2CHIP_MDI5) |
                BCHP_FIELD_ENUM(SUN_TOP_CTRL_PIN_MUX_CTRL_7, gpio_052, POD2CHIP_MDI6) |
                BCHP_FIELD_ENUM(SUN_TOP_CTRL_PIN_MUX_CTRL_7, gpio_053, POD2CHIP_MDI7) |
                BCHP_FIELD_ENUM(SUN_TOP_CTRL_PIN_MUX_CTRL_7, gpio_055, CHIP2POD_MCLKO);
        BREG_Write32(hReg, BCHP_SUN_TOP_CTRL_PIN_MUX_CTRL_7, regVal);
        ...
        regVal |=
                BCHP_FIELD_ENUM(SUN_TOP_CTRL_PIN_MUX_CTRL_8, gpio_059, CHIP2POD_MOVAL) |
                BCHP_FIELD_ENUM(SUN_TOP_CTRL_PIN_MUX_CTRL_8, gpio_060, CHIP2POD_MOSTRT) |
                BCHP_FIELD_ENUM(SUN_TOP_CTRL_PIN_MUX_CTRL_8, gpio_061, CHIP2POD_MDO0) |
                BCHP_FIELD_ENUM(SUN_TOP_CTRL_PIN_MUX_CTRL_8, gpio_062, CHIP2POD_MDO1) |
                BCHP_FIELD_ENUM(SUN_TOP_CTRL_PIN_MUX_CTRL_8, gpio_063, CHIP2POD_MDO2) |
                BCHP_FIELD_ENUM(SUN_TOP_CTRL_PIN_MUX_CTRL_8, gpio_064, CHIP2POD_MDO3);
        BREG_Write32(hReg, BCHP_SUN_TOP_CTRL_PIN_MUX_CTRL_8, regVal);
        ...
        regVal |=
                BCHP_FIELD_ENUM(SUN_TOP_CTRL_PIN_MUX_CTRL_9, gpio_065, CHIP2POD_MDO4) |
                BCHP_FIELD_ENUM(SUN_TOP_CTRL_PIN_MUX_CTRL_9, gpio_066, CHIP2POD_MDO5) |
                BCHP_FIELD_ENUM(SUN_TOP_CTRL_PIN_MUX_CTRL_9, gpio_067, CHIP2POD_MDO6) |
                BCHP_FIELD_ENUM(SUN_TOP_CTRL_PIN_MUX_CTRL_9, gpio_068, CHIP2POD_MDO7) |
                BCHP_FIELD_ENUM(SUN_TOP_CTRL_PIN_MUX_CTRL_9, gpio_069, CHIP2POD_MOCLK);
        BREG_Write32(hReg, BCHP_SUN_TOP_CTRL_PIN_MUX_CTRL_9, regVal);
    }
...
NEXUS_Error NEXUS_DvbCi_P_InitChip(NEXUS_DvbCiHandle handle)
{
    ...
    g_gpioA15 = NEXUS_Gpio_Open(NEXUS_GpioType_eStandard, 55, &gpioSettings);
    if ( NULL == g_gpioA15 ) {errCode = BERR_TRACE(BERR_NOT_SUPPORTED); goto error;}
    g_gpioA16 = NEXUS_Gpio_Open(NEXUS_GpioType_eStandard, 59, &gpioSettings);
    if ( NULL == g_gpioA16 ) {errCode = BERR_TRACE(BERR_NOT_SUPPORTED); goto error;}
    g_gpioA17 = NEXUS_Gpio_Open(NEXUS_GpioType_eStandard, 60, &gpioSettings);
    if ( NULL == g_gpioA17 ) {errCode = BERR_TRACE(BERR_NOT_SUPPORTED); goto error;}
    g_gpioA18 = NEXUS_Gpio_Open(NEXUS_GpioType_eStandard, 61, &gpioSettings);
    if ( NULL == g_gpioA18 ) {errCode = BERR_TRACE(BERR_NOT_SUPPORTED); goto error;}
    g_gpioA19 = NEXUS_Gpio_Open(NEXUS_GpioType_eStandard, 62, &gpioSettings);
    if ( NULL == g_gpioA19 ) {errCode = BERR_TRACE(BERR_NOT_SUPPORTED); goto error;}
    g_gpioA20 = NEXUS_Gpio_Open(NEXUS_GpioType_eStandard, 63, &gpioSettings);
    if ( NULL == g_gpioA20 ) {errCode = BERR_TRACE(BERR_NOT_SUPPORTED); goto error;}
    g_gpioA21 = NEXUS_Gpio_Open(NEXUS_GpioType_eStandard, 64, &gpioSettings);
    if ( NULL == g_gpioA21 ) {errCode = BERR_TRACE(BERR_NOT_SUPPORTED); goto error;}
    g_gpioA22 = NEXUS_Gpio_Open(NEXUS_GpioType_eStandard, 65, &gpioSettings);
    if ( NULL == g_gpioA22 ) {errCode = BERR_TRACE(BERR_NOT_SUPPORTED); goto error;}
    g_gpioA23 = NEXUS_Gpio_Open(NEXUS_GpioType_eStandard, 66, &gpioSettings);
    if ( NULL == g_gpioA23 ) {errCode = BERR_TRACE(BERR_NOT_SUPPORTED); goto error;}
    g_gpioA24 = NEXUS_Gpio_Open(NEXUS_GpioType_eStandard, 67, &gpioSettings);
    if ( NULL == g_gpioA24 ) {errCode = BERR_TRACE(BERR_NOT_SUPPORTED); goto error;}
    g_gpioA25 = NEXUS_Gpio_Open(NEXUS_GpioType_eStandard, 68, &gpioSettings);
    if ( NULL == g_gpioA25 ) {errCode = BERR_TRACE(BERR_NOT_SUPPORTED); goto error;}

    g_gpioEBI = NEXUS_Gpio_Open(NEXUS_GpioType_eStandard, 39, &gpioSettings);
