...
NEXUS_Error NEXUS_DvbCi_P_SetupPinmuxes(NEXUS_DvbCiHandle handle, bool pcmciaMode)
{
    ...
    if ( pcmciaMode )
    {
        ...
        regVal &= ~(
                BCHP_MASK(SUN_TOP_CTRL_PIN_MUX_CTRL_7, gpio_041) |
                BCHP_MASK(SUN_TOP_CTRL_PIN_MUX_CTRL_7, gpio_042) |
                BCHP_MASK(SUN_TOP_CTRL_PIN_MUX_CTRL_7, gpio_043) |
        ...
        regVal &= ~(
                BCHP_MASK(SUN_TOP_CTRL_PIN_MUX_CTRL_8, gpio_049) |
                BCHP_MASK(SUN_TOP_CTRL_PIN_MUX_CTRL_8, gpio_050) |
                BCHP_MASK(SUN_TOP_CTRL_PIN_MUX_CTRL_8, gpio_051) |
                BCHP_MASK(SUN_TOP_CTRL_PIN_MUX_CTRL_8, gpio_052) |
                BCHP_MASK(SUN_TOP_CTRL_PIN_MUX_CTRL_8, gpio_053) |
        ...
        regVal &= ~(
                BCHP_MASK(SUN_TOP_CTRL_PIN_MUX_CTRL_9, gpio_057)
                );
    ...
    { /*dvb-ci mode*/
        ...
        regVal |=
                BCHP_FIELD_ENUM(SUN_TOP_CTRL_PIN_MUX_CTRL_5, gpio_031, POD2CHIP_MCLKI) |
                BCHP_FIELD_ENUM(SUN_TOP_CTRL_PIN_MUX_CTRL_5, gpio_032, CHIP2POD_MCLKO);
        BREG_Write32(hReg, BCHP_SUN_TOP_CTRL_PIN_MUX_CTRL_5, regVal);
        ...
        regVal |=
                BCHP_FIELD_ENUM(SUN_TOP_CTRL_PIN_MUX_CTRL_6, gpio_034, POD2CHIP_SDI_0) |
                BCHP_FIELD_ENUM(SUN_TOP_CTRL_PIN_MUX_CTRL_6, gpio_037, POD2CHIP_MISTRT) |
                BCHP_FIELD_ENUM(SUN_TOP_CTRL_PIN_MUX_CTRL_6, gpio_038, POD2CHIP_MIVAL) |
                BCHP_FIELD_ENUM(SUN_TOP_CTRL_PIN_MUX_CTRL_6, gpio_039, POD2CHIP_MDI0) |
                BCHP_FIELD_ENUM(SUN_TOP_CTRL_PIN_MUX_CTRL_6, gpio_040, POD2CHIP_MDI1);
        BREG_Write32(hReg, BCHP_SUN_TOP_CTRL_PIN_MUX_CTRL_6, regVal);
        ...
        regVal |=
                BCHP_FIELD_ENUM(SUN_TOP_CTRL_PIN_MUX_CTRL_7, gpio_041, POD2CHIP_MDI2) |
                BCHP_FIELD_ENUM(SUN_TOP_CTRL_PIN_MUX_CTRL_7, gpio_042, POD2CHIP_MDI3) |
                BCHP_FIELD_ENUM(SUN_TOP_CTRL_PIN_MUX_CTRL_7, gpio_043, POD2CHIP_MDI4) |
                BCHP_FIELD_ENUM(SUN_TOP_CTRL_PIN_MUX_CTRL_7, gpio_044, POD2CHIP_MDI5) |
                BCHP_FIELD_ENUM(SUN_TOP_CTRL_PIN_MUX_CTRL_7, gpio_045, POD2CHIP_MDI6) |
                BCHP_FIELD_ENUM(SUN_TOP_CTRL_PIN_MUX_CTRL_7, gpio_046, POD2CHIP_MDI7) |
                BCHP_FIELD_ENUM(SUN_TOP_CTRL_PIN_MUX_CTRL_7, gpio_048, CHIP2POD_MOVAL);
        BREG_Write32(hReg, BCHP_SUN_TOP_CTRL_PIN_MUX_CTRL_7, regVal);
        ...
        regVal |=
                BCHP_FIELD_ENUM(SUN_TOP_CTRL_PIN_MUX_CTRL_8, gpio_049, CHIP2POD_MOSTRT) |
                BCHP_FIELD_ENUM(SUN_TOP_CTRL_PIN_MUX_CTRL_8, gpio_050, CHIP2POD_MDO0) |
                BCHP_FIELD_ENUM(SUN_TOP_CTRL_PIN_MUX_CTRL_8, gpio_051, CHIP2POD_MDO1) |
                BCHP_FIELD_ENUM(SUN_TOP_CTRL_PIN_MUX_CTRL_8, gpio_052, CHIP2POD_MDO2) |
                BCHP_FIELD_ENUM(SUN_TOP_CTRL_PIN_MUX_CTRL_8, gpio_053, CHIP2POD_MDO3) |
                BCHP_FIELD_ENUM(SUN_TOP_CTRL_PIN_MUX_CTRL_8, gpio_054, CHIP2POD_MDO4) |
                BCHP_FIELD_ENUM(SUN_TOP_CTRL_PIN_MUX_CTRL_8, gpio_055, CHIP2POD_MDO5) |
                BCHP_FIELD_ENUM(SUN_TOP_CTRL_PIN_MUX_CTRL_8, gpio_056, CHIP2POD_MDO6);
        BREG_Write32(hReg, BCHP_SUN_TOP_CTRL_PIN_MUX_CTRL_8, regVal);
        ...
        regVal |=
                BCHP_FIELD_ENUM(SUN_TOP_CTRL_PIN_MUX_CTRL_9, gpio_057, CHIP2POD_MDO7);
        BREG_Write32(hReg, BCHP_SUN_TOP_CTRL_PIN_MUX_CTRL_9, regVal);
    }
...
NEXUS_Error NEXUS_DvbCi_P_InitChip(NEXUS_DvbCiHandle handle)
{
    ...
    g_gpioA15 = NEXUS_Gpio_Open(NEXUS_GpioType_eStandard, 32, &gpioSettings);
    if ( NULL == g_gpioA15 ) {errCode = BERR_TRACE(BERR_NOT_SUPPORTED); goto error;}
    g_gpioA16 = NEXUS_Gpio_Open(NEXUS_GpioType_eStandard, 48, &gpioSettings);
    if ( NULL == g_gpioA16 ) {errCode = BERR_TRACE(BERR_NOT_SUPPORTED); goto error;}
    g_gpioA17 = NEXUS_Gpio_Open(NEXUS_GpioType_eStandard, 49, &gpioSettings);
    if ( NULL == g_gpioA17 ) {errCode = BERR_TRACE(BERR_NOT_SUPPORTED); goto error;}
    g_gpioA18 = NEXUS_Gpio_Open(NEXUS_GpioType_eStandard, 50, &gpioSettings);
    if ( NULL == g_gpioA18 ) {errCode = BERR_TRACE(BERR_NOT_SUPPORTED); goto error;}
    g_gpioA19 = NEXUS_Gpio_Open(NEXUS_GpioType_eStandard, 51, &gpioSettings);
    if ( NULL == g_gpioA19 ) {errCode = BERR_TRACE(BERR_NOT_SUPPORTED); goto error;}
    g_gpioA20 = NEXUS_Gpio_Open(NEXUS_GpioType_eStandard, 52, &gpioSettings);
    if ( NULL == g_gpioA20 ) {errCode = BERR_TRACE(BERR_NOT_SUPPORTED); goto error;}
    g_gpioA21 = NEXUS_Gpio_Open(NEXUS_GpioType_eStandard, 53, &gpioSettings);
    if ( NULL == g_gpioA21 ) {errCode = BERR_TRACE(BERR_NOT_SUPPORTED); goto error;}
    g_gpioA22 = NEXUS_Gpio_Open(NEXUS_GpioType_eStandard, 54, &gpioSettings);
    if ( NULL == g_gpioA22 ) {errCode = BERR_TRACE(BERR_NOT_SUPPORTED); goto error;}
    g_gpioA23 = NEXUS_Gpio_Open(NEXUS_GpioType_eStandard, 55, &gpioSettings);
    if ( NULL == g_gpioA23 ) {errCode = BERR_TRACE(BERR_NOT_SUPPORTED); goto error;}
    g_gpioA24 = NEXUS_Gpio_Open(NEXUS_GpioType_eStandard, 56, &gpioSettings);
    if ( NULL == g_gpioA24 ) {errCode = BERR_TRACE(BERR_NOT_SUPPORTED); goto error;}
    g_gpioA25 = NEXUS_Gpio_Open(NEXUS_GpioType_eStandard, 57, &gpioSettings);
    if ( NULL == g_gpioA25 ) {errCode = BERR_TRACE(BERR_NOT_SUPPORTED); goto error;}

    g_gpioEBI = NEXUS_Gpio_Open(NEXUS_GpioType_eStandard, 97, &gpioSettings);
