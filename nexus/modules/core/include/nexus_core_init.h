...
typedef struct NEXUS_Core_Settings
{
    ...
    NEXUS_Error (*getPState)(unsigned coreId, BCHP_Pstate *pState, unsigned *command);
    NEXUS_Error (*setPState)(unsigned coreId, BCHP_Pstate pState, unsigned num, const unsigned *command);
    NEXUS_Error (*getAvsData)(unsigned idx, unsigned *value);
} NEXUS_Core_Settings;
