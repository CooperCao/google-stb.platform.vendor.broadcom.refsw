...
*
***************************************************************************/
#ifndef NEXUS_CORE_CONVERT_LOCAL_H
#define NEXUS_CORE_CONVERT_LOCAL_H
...
const char *NEXUS_P_HeapName(unsigned memcIndex, unsigned heapType, unsigned memoryType, char *buf, size_t buf_size);

#endif /* NEXUS_CORE_CONVERT_LOCAL_H */
