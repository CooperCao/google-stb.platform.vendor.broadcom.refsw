...
*  ANY LIMITED REMEDY.
***************************************************************************/
#ifndef NEXUS_CORE_AUDIO_COMPAT_H__
#define NEXUS_CORE_AUDIO_COMPAT_H__
...
typedef struct NEXUS_AudioDecoderStatus
{
    ...
    uint8_t algorithmProfileId;
    uint8_t algorithmVersionId[4];
    uint8_t firmwareVersionId;
...
{
    bool targetSyncEnabled;
    bool nonRealTime;
    bool secondaryDecoder;
    bool forceCompleteFirstFrame;
    unsigned maxOutputRate;
    bool karaokeModeEnabled;
...
#endif /* #ifndef NEXUS_CORE_AUDIO_COMPAT_H__ */
