...
void NEXUS_P_StaticHdrMetadata_FromMagnum_isrsafe(
    NEXUS_StaticHdrMetadata * pNexus,
    const BAVC_StaticHdrMetadata * pMagnum);
void NEXUS_P_StaticHdrMetadata_ToMagnum_isrsafe(
    const NEXUS_StaticHdrMetadata * pNexus,
    BAVC_StaticHdrMetadata * pMagnum);
