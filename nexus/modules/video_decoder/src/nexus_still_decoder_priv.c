...
#define STILL_DECODER_DEVICE(stillDecoder) ((stillDecoder)->parentDecoder && (stillDecoder)->parentDecoder->device ? (stillDecoder)->parentDecoder->device : &g_NEXUS_videoDecoderXvdDevices[0])
