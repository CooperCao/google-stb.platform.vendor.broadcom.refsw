...
#if BXPT_HAS_MOSAIC_SUPPORT
    {
        bool notDisableJitterAdjustment = pSettings->modeSettings.pcr.disableJitterAdjustment ? false : true;
        if (notDisableJitterAdjustment != pcr_offset_settings.EnableJitterAdjustment) {
            pcr_offset_settings.EnableJitterAdjustment = notDisableJitterAdjustment;
