...
#endif
#define NEXUS_VCXO_RESET_ADDR(i) (BCHP_VCXO_CTL_MISC_VC0_CTRL)

#define NEXUS_VCXO_RESET_MASK BCHP_MASK(VCXO_CTL_MISC_VC0_CTRL, DRESET)
#define NEXUS_VCXO_RESET_SET BCHP_FIELD_DATA(VCXO_CTL_MISC_VC0_CTRL, DRESET, 1)
#define NEXUS_VCXO_RESET_CLEAR BCHP_FIELD_DATA(VCXO_CTL_MISC_VC0_CTRL, DRESET, 0)
...
#define NEXUS_VCXO_RESET_ADDR(i) ((i)==2?BCHP_VCXO_CTL_MISC_VC2_CTRL:(i)==1?BCHP_VCXO_CTL_MISC_VC1_CTRL:BCHP_VCXO_CTL_MISC_VC0_CTRL)
#elif NEXUS_NUM_VCXOS == 2
#include "bchp_vcxo_0_rm.h"
#include "bchp_vcxo_1_rm.h"
#define NEXUS_VCXO_BASE(i) ((i)==1?BCHP_VCXO_1_RM_REG_START:BCHP_VCXO_0_RM_REG_START)
#define NEXUS_VCXO_RESET_ADDR(i) (((i)==1)?BCHP_VCXO_CTL_MISC_VC1_CTRL:BCHP_VCXO_CTL_MISC_VC0_CTRL)
