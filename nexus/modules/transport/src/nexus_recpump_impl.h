...
enum nexus_recpump_index_mapping
{
    nexus_recpump_index_mapping_none,
    nexus_recpump_index_mapping_by_pidvalue,
    nexus_recpump_index_mapping_by_pidchannel
};
...
struct NEXUS_Recpump {
    ...
    enum nexus_recpump_index_mapping scdMapMode;         /* track whether pidchannel or pid mapping is being used */
