...
enables.M24En == true || enables.M16En == true || enables.IdRejectEn == true) && handle->startSettings.format != NEXUS_MessageFormat_ePsi)
    {
        BDBG_ERR(("Attempting SAM filtering on non-PSI message."));
