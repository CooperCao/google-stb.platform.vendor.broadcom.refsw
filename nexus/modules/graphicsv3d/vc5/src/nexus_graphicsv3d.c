...
CHECK_DEFINE(NEXUS_GRAPHICSV3D_SYNC_CORE_READ,              BVC5_SYNC_CORE_READ);
CHECK_DEFINE(NEXUS_GRAPHICSV3D_SYNC_CORE_WRITE,             BVC5_SYNC_CORE_WRITE);
...
CHECK_DEFINE(NEXUS_GRAPHICSV3D_SYNC_QPU_IU_READ,            BVC5_SYNC_QPU_IU_READ);
