 ...
 *
 **************************************************************************/
#ifndef NEXUS_GRAPHICSV3D_INIT_H__
#define NEXUS_GRAPHICSV3D_INIT_H__
...
void NEXUS_Graphicsv3dModule_GetDefaultSettings(
    NEXUS_Graphicsv3dModuleSettings *psSettings /* [out] */
    );
...
NEXUS_ModuleHandle NEXUS_Graphicsv3dModule_Init(
    const NEXUS_Graphicsv3dModuleSettings *psSettings
    );
...
#endif /* NEXUS_GRAPHICSV3D_INIT_H__ */
