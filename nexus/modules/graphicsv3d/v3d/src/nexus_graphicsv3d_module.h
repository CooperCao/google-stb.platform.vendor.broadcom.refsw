...
typedef struct NEXUS_Graphicsv3d_P_ModuleState {
   ...
   BV3D_Handle        v3d;
   NEXUS_ThreadHandle worker;
   BKNI_EventHandle   sync;
   NEXUS_HeapHandle   heapHandle;
   NEXUS_HeapHandle   heapHandleSecure;
} NEXUS_Graphicsv3d_P_ModuleState;

extern NEXUS_Graphicsv3d_P_ModuleState g_NEXUS_Graphicsv3d_P_ModuleState;

#define NEXUS_MODULE_NAME graphicsv3d
#define NEXUS_MODULE_SELF g_NEXUS_Graphicsv3d_P_ModuleState.module
