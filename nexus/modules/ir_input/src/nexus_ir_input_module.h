 ...
 * 
 **************************************************************************/
#ifndef NEXUS_IR_INPUT_MODULE_H__
#define NEXUS_IR_INPUT_MODULE_H__

#include "nexus_ir_input_thunks.h"
...
#define NEXUS_MODULE_NAME irInput
#define NEXUS_MODULE_SELF g_NEXUS_irInputModule

/* global handle. there is no global data. */
extern NEXUS_ModuleHandle g_NEXUS_irInputModule;

NEXUS_OBJECT_CLASS_DECLARE(NEXUS_IrInput);
