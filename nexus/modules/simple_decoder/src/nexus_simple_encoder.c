...
{
    BDBG_MSG(("nexus_simpleencoder_p_stop %p: %d %d %p %p mode: %u", (void *)handle, handle->started, handle->audioStarted, (void *)handle->startSettings.input.video, (void *)handle->transcodeWindow, handle->settings.stopMode));
