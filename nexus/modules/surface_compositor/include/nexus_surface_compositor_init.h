 ...
 * 
 **************************************************************************/
#ifndef NEXUS_SURFACE_COMPOSITOR_INIT_H__
#define NEXUS_SURFACE_COMPOSITOR_INIT_H__
...
typedef struct NEXUS_SurfaceCompositorModuleSettings
{
    struct {
        NEXUS_ModuleHandle display;
    } modules;
} NEXUS_SurfaceCompositorModuleSettings;
