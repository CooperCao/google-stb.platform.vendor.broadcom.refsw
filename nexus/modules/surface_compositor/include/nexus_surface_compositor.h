...
/* main display and 2 slaves (SD and encoder) */
#define NEXUS_SURFACE_COMPOSITOR_MAX_DISPLAYS 3
...
typedef struct NEXUS_SurfaceCompositorSettings
{
    ...
    NEXUS_SurfaceCompositorDisplaySettings display[NEXUS_SURFACE_COMPOSITOR_MAX_DISPLAYS]; /* can only be changed if status.active is false. */
    NEXUS_CallbackDesc frameBufferCallback; /* called after all framebuffers have been updated */
    bool muteVideo[NEXUS_SURFACE_COMPOSITOR_MAX_DISPLAYS];
    struct {
...
void NEXUS_SurfaceCompositor_GetSettings(
    NEXUS_SurfaceCompositorHandle handle,
    NEXUS_SurfaceCompositorSettings *pSettings /* [out]  attr{pragma=IgnoreArrayCallbacks} */
    );
...
NEXUS_Error NEXUS_SurfaceCompositor_SetSettings(
    NEXUS_SurfaceCompositorHandle handle,
    const NEXUS_SurfaceCompositorSettings *pSettings /* attr{pragma=IgnoreArrayCallbacks} */
    );
...
typedef struct NEXUS_SurfaceCompositorClientSettings
{
    ...
    NEXUS_SurfaceCompositorClientDisplaySettings display[NEXUS_SURFACE_COMPOSITOR_MAX_DISPLAYS];
    bool backendMosaic;
