...
typedef struct NEXUS_DisplaySettings
{
    ...
    NEXUS_DisplayPriority priority;     /* prioritize the presentation of either graphics or video on this display */
    /*
     * Sets the dynamic range mode of the video on this display. This
     * dynamicRangeMode enum should be used to specify the desired dynamic range
     * mode of the video on this display instead of setting
     * NEXUS_HdmiOutputExtraSettings.overrideDynamicRangeMasteringInfoFrame = true and specifying
     * NEXUS_HdmiOutputExtraSettings.dynamicRangeMasteringInfoFrame.eotf.
     */
...
typedef struct NEXUS_DisplayStatus
{
    ...
    NEXUS_VideoDynamicRangeMode dynamicRangeMode; /* current dynamic range mode */
} NEXUS_DisplayStatus;
...
/* deprecated */
#define NEXUS_DisplayModule_SetConfigurationId(configurationId) NEXUS_NOT_SUPPORTED
