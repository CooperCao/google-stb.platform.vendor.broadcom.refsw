...
/**
Summary:
Video output connection state used in NEXUS_VideoOutputStatus
**/
typedef enum NEXUS_VideoOutputConnectionState
{
    NEXUS_VideoOutputConnectionState_eUnknown,      /* no detection available */
    NEXUS_VideoOutputConnectionState_eConnected,    /* external cable is plugged into VideoOutput */
    NEXUS_VideoOutputConnectionState_eDisconnected, /* external cable is not plugged into VideoOutput */
    NEXUS_VideoOutputConnectionState_eMax
} NEXUS_VideoOutputConnectionState;

/**
Summary:
Video output connection state returned by NEXUS_VideoOutput_GetStatus
**/
typedef struct NEXUS_VideoOutputStatus
{
    NEXUS_VideoOutputConnectionState connectionState;
} NEXUS_VideoOutputStatus;

/**
Summary:
get video output connection state
**/
NEXUS_Error NEXUS_VideoOutput_GetStatus(
    NEXUS_VideoOutputHandle output,
    NEXUS_VideoOutputStatus *pStatus
    );
