...
typedef struct NEXUS_VideoOutput_P_Iface {
    ...
    BERR_Code (*formatChange)(void *output, const NEXUS_VideoOutput_P_FormatChangeParams * pParams);
    NEXUS_Error (*checkSettings)(void *output, NEXUS_DisplayHandle display, const NEXUS_DisplaySettings * pSettings);
...
void NEXUS_VideoOutput_P_SetHdrSettings(NEXUS_HdmiOutputHandle hdmiOutput, const NEXUS_HdmiDynamicRangeMasteringInfoFrame *drmInfoFrame);
...
NEXUS_VideoOutput_P_Link * NEXUS_VideoOutput_P_OpenHdmi(NEXUS_VideoOutputHandle output);
#endif
