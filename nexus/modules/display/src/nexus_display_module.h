...
{
    nexus_vbi_resources_amole,
    nexus_vbi_resources_cce,
    nexus_vbi_resources_cgmse,
    nexus_vbi_resources_gse,
    nexus_vbi_resources_tte,
    nexus_vbi_resources_wsse,
    nexus_vbi_resources_656amole,
    nexus_vbi_resources_656cce,
    nexus_vbi_resources_656cgmse,
    nexus_vbi_resources_656gse,
    nexus_vbi_resources_656tte,
    nexus_vbi_resources_656wsse,
