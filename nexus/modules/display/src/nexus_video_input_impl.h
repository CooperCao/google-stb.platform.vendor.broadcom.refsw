...
typedef struct NEXUS_VideoInput_P_StaticHdrInfo {
...
} NEXUS_VideoInput_P_StaticHdrInfo;
...
#define B_VBI_TT_LINES 20
    ...
    struct
    {
        NEXUS_VideoInput_P_StaticHdrInfo staticInfo;
...
/* shared by hdmi input and decoder input */
