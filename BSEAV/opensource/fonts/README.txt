...
To run 'buildfont' (on set-top box):
	...
	2. copy BSEAV/opensource/fonts/mswebfonts/prerender script to your atlas bin/fonts directory
	...
	4. copy the *.bwin_font files back to the build server's BSEAV/opensource/fonts/mswebfonts/le
