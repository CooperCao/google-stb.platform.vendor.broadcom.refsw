...
typedef struct Osd * OsdHandle;

typedef struct OsdTheme
{
    unsigned textForegroundColor;
    unsigned mainPanelBackgroundColor;
    unsigned infoPanelBackgroundColor;
} OsdTheme;

typedef struct OsdCreateSettings
{
