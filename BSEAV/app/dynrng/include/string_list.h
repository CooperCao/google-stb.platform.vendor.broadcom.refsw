 ...
 * ANY LIMITED REMEDY.
 *****************************************************************************/
#ifndef STRING_LIST_H__
#define STRING_LIST_H__ 1

#include <stdbool.h>

typedef struct StringList * StringListHandle;
typedef struct StringListCursor * StringListCursorHandle;
