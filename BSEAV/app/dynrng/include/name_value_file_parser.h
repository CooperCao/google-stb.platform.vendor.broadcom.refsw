 ...
 * ANY LIMITED REMEDY.
 *****************************************************************************/
#ifndef NAME_VALUE_FILE_PARSER_H__
#define NAME_VALUE_FILE_PARSER_H__ 1

typedef struct NameValueFileParser * NameValueFileParserHandle;
typedef int (*NameValueFileParserListener)(void * listenerContext, const char * name, const char * value);
...
#endif /* NAME_VALUE_FILE_PARSER_H__ */
