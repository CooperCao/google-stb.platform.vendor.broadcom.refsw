 ...
 * ANY LIMITED REMEDY.
 *****************************************************************************/
#ifndef STRING_MAP_H__
#define STRING_MAP_H__ 1
...
typedef struct StringMap * StringMapHandle;
typedef struct StringMapCursor * StringMapCursorHandle;
