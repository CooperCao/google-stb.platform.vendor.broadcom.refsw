...
typedef struct Dbv * DbvHandle;

typedef struct DbvPlatformSettings
{
    PlatformRenderingPriority renderingPriority;
} DbvPlatformSettings;

typedef void (*SetPlatformSettingsRequestCallback)(void * context, const DbvPlatformSettings * pSettings);

typedef struct DbvCreateSettings
{
    StringMapHandle cfgMap;
    struct
    {
        SetPlatformSettingsRequestCallback callback;
        void * context;
