...
typedef int (*UnrecognizedConsoleSyntaxCallback)(void * context, const char * line);

typedef struct ConsoleCreateSettings
{
    struct
    {
    ...
    struct
    {
        UnrecognizedConsoleSyntaxCallback callback;
        void * context;
    } unrecognizedSyntax;
    StringListHandle tabCompletionList;
} ConsoleCreateSettings;
