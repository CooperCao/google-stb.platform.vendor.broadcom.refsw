 ...
 * ANY LIMITED REMEDY.
 *****************************************************************************/
#ifndef PLATFORM_SCHEDULER_PRIV_H__
#define PLATFORM_SCHEDULER_PRIV_H__ 1
...
{
    PlatformSchedulerState_eInit,
    PlatformSchedulerState_eRunning,
    PlatformSchedulerState_eDone,
    PlatformSchedulerState_eMax
} PlatformSchedulerState;

typedef struct PlatformListener
{
...
#endif /* PLATFORM_SCHEDULER_PRIV_H__ */
