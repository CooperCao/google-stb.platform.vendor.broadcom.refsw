...
/* Here's the dual-purpose code */
    ...
    ATLAS_DECLARE(PIP_PERCENTAGE,                          int,    "25",               "Percentage to shrink PIP window based on full screen window"),
    ATLAS_DECLARE(PIP_BORDER_PERCENTAGE,                   int,    "8",                "Percentage of border between PIP and main window"),
