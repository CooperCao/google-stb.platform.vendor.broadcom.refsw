...
#ifndef TUNER_UPSTREAM_H__
#define TUNER_UPSTREAM_H__
...
class CTunerUpstreamScanData : public CTunerScanData
{
public:
    CTunerUpstreamScanData(
    ...
    CTunerUpstreamScanData & operator =(const CTunerUpstreamScanData & rhs)
    {
...
class CTunerUpstream : public CTuner
{
public:
    CTunerUpstream(
            const char *     name,
    ...
    eRet                       tune(NEXUS_FrontendUpstreamSettings settings);
    ...
    NEXUS_FrontendUpstreamMode getDefaultMode(void);

protected:
    CTunerUpstreamScanData _scanData;
};
...
#endif /* ifndef TUNER_UPSTREAM_H__ */