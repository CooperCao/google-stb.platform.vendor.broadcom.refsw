...
class CSimpleAudioDecodeNx : public CSimpleAudioDecode
{
public:
    ...
    virtual bool             isEncodeSupportedDts(void)       { return(_bEncodeDts); }
    virtual bool             isAutoVolumeLevelSupported(void) { return(_bAutoVolumeLevel); }
    virtual bool             isDolbyVolumeSupported(void)     { return(_bDolbyVolume); }
