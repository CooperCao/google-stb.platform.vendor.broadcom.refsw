...
#ifndef ATLAS_PANEL_H__
#define ATLAS_PANEL_H__
...
public:
    ...
    void             setConfig(CConfig * pConfig)             { _pConfig = pConfig; _pCfg = pConfig->getCfg(); }
    CConfiguration * getCfg(void)                             { return(_pCfg); }
    bwidget_t        getFocus(void)                           { return(bwidget_get_focus(getEngine())); }
    void             setFocus(bwidget_t widget)               { bwidget_set_focus(widget); }
