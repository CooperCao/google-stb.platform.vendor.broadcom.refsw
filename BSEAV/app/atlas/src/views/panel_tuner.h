...
#ifndef ATLAS_PANEL_TUNER_H__
#define ATLAS_PANEL_TUNER_H__
...
/* CPanelTunerProp is the tag/value button used to display each tuner property
 * in the list widget. */
class CPanelTunerProp
{
public:
    CPanelTunerProp(
            CPanel *      pPanel,
