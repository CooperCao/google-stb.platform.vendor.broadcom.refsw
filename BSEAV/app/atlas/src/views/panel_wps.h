...
#ifndef ATLAS_PANEL_WPS_H__
#define ATLAS_PANEL_WPS_H__
...
protected:
    ...
    CWidgetLabel *    _pTextLabel1;
    CWidgetLabel *    _pTextLabel2;
    CWidgetLabel *    _pWpsLogo;
    CWidgetProgress * _pProgress;
    bool              _done;
