...
public:
    ...
    void                       setSettings(NEXUS_AudioMixerSettings settings) { _settings = settings; }
    NEXUS_AudioMixerSettings   getSettings(void) { return _settings; }

protected:
    NEXUS_AudioMixerHandle    _mixer;
    NEXUS_AudioMixerSettings  _settings;
};
