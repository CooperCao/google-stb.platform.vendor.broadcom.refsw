...
#ifndef _PLAYLIST_DB_H__
#define _PLAYLIST_DB_H__
...
class CPlaylistDb : public CMvcModel
{
public:
    CPlaylistDb(
            const char *     name,
    ...
    virtual ~CPlaylistDb(void);

    virtual eRet open(CWidgetEngine * pWidgetEngine);
    virtual void close(void);
    virtual eRet copyObservers(CSubject * pSubject);

    eRet        addPlaylist(void * pId, CPlaylist * pPlaylistNew);
    eRet        removePlaylist(void * pId, CPlaylist * pPlaylistNew);
