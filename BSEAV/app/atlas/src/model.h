...
public:
    ...
    void           addSimpleVideoDecode(
            CSimpleVideoDecode * pSimpleVideoDecode,
            eWindowType          windowType = eWindowType_Main
            ) { _pSimpleVideoDecode[windowType] = pSimpleVideoDecode; }
    ...
    void                 addSimpleAudioDecode(
            CSimpleAudioDecode * pSimpleAudioDecode,
            eWindowType          windowType = eWindowType_Main
            ) { _pSimpleAudioDecode[windowType] = pSimpleAudioDecode; }
