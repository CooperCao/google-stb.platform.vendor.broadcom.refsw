...
#ifndef ATLAS_WIDGET_CHECK_BUTTON_H__
#define ATLAS_WIDGET_CHECK_BUTTON_H__
...
public:
    ...
    eCheckStyle getCheckStyle(void)              { return(_checkStyle); }
    void        setCheckStyle(eCheckStyle style) { _checkStyle = style; }
...
#endif /* ATLAS_WIDGET_CHECK_BUTTON_H__ */