...
#ifndef ATLAS_WIDGET_PROGRESS_H__
#define ATLAS_WIDGET_PROGRESS_H__
...
public:
    ...
    eRet                   loadProgressImage(const char * filename, bwin_image_render_mode renderMode = bwin_image_render_mode_single);
...
#endif /* ATLAS_WIDGET_PROGRESS_H__ */