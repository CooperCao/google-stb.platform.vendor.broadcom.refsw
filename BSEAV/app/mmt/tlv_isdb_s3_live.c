...
BDBG_MODULE(tlv_isdb_s3_live);

/**
  * tlv_isdb_s3_live app decodes and renders AV from live
  * tlv stream.
  *
...
int main(int argc, char **argv)
{
    ...
    open_settings.tlv_pid = 0x0;
    /**
      * Increase the bit rate support for a parser band to 108Mbps
      * to support various bit rates from TLV files
      **/
    ...
    open_settings.input_format = ebmmt_input_format_tlv;
