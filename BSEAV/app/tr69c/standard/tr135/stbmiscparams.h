...
#ifndef __STB_MISC_PARAMS_H__
#define __STB_MISC_PARAMS_H__
...
/* Service.STBService.AVStreams.AVStream Object */
/* SVAR(Status); */
/* SVAR(Alias); */
/* SVAR(Name); */
SVAR(PVRState);
...
/* Service.STBService.AVStreams Object */
SVAR(ActiveAVStreams);
SVAR(AVStreamNumberOfEntries);
/* SVAR(AVStream); */

/* Service.STBService.AVPlayers.AVPLayer Object */
/* SVAR(Enable); */
/* SVAR(Status); */
/* SVAR(Alias); */
/* SVAR(Name); */
SVAR(AudioLanguage);
SVAR(SubtitlingStatus);
SVAR(SubtitlingLanguage);
SVAR(AudioOutputs);
SVAR(VideoOutputs);
/* SVAR(MainStream); */
SVAR(PIPStreams);

/* Service.STBService.AVPlayers Object */
SVAR(ActiveAVPlayers);
SVAR(AVPlayerNumberOfEntries);
SVAR(PreferredAudioLanguage);
SVAR(PreferredSubtitlingLanguage);
SVAR(PreferredBehaviour);
SVAR(ResetPINCode);
SVAR(AVPlayer);

/* Service.STBService.Applications.CDSPull.ContentItem Object */
/* SVAR(Alias); */
/* SVAR(ContentReferenceId); */
/* SVAR(VersionNumber); */
/* SVAR(DeleteItem); */

/* Service.STBService.Applications.CDSPull Object */
/* SVAR(Reference); */
/* SVAR(ContentItemNumberOfEntries); */
/* SVAR(ContentItem); */

/* Service.STBService.Applications.CDSPush.ContentItem Object */
/* SVAR(Alias); */
SVAR(ContentReferenceId);
SVAR(VersionNumber);
SVAR(DeleteItem);

/* Service.STBService.Applications.CDSPush Object */
/* SVAR(Reference); */
SVAR(ContentItemNumberOfEntries);
SVAR(ContentItem);

/* Service.STBService.Applications.AudienceStats.Channel Object */
/* SVAR(Alias); */
/* SVAR(Name); */
SVAR(Duration);

/* Service.STBService.Applications.AudienceStats Object */
/* SVAR(Enable); */
/* SVAR(Reset); */
/* SVAR(ResetTime); */
SVAR(ChannelNumberOfEntries);
SVAR(Channel);

/* Service.STBService.Applications.ServiceProvider Object */
/* SVAR(Alias); */
/* SVAR(Name); */
SVAR(Domain);
SVAR(ServiceDiscoveryServer);
SVAR(ActiveBCGServers);

/* Service.STBService.Applications Object */
SVAR(ServiceProviderNumberOfEntries);
SVAR(ServiceProvider);
/* SVAR(AudienceStats); */
SVAR(CDSPush);
SVAR(CDSPull);

/* Service.STBService Object */
/* SVAR(Enable); */
/* SVAR(Alias); */
SVAR(Capabilities);
