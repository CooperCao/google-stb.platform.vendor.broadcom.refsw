...
#define MOCA_LOF_BAND_H_DEF                        975
...
#define MOCA_BEACON_PWR_REDUCTION_MAX              30
...
#define MOCA_PQOS_CREATE_FLOW_PACKET_SIZE_MAX      1519
...
#define MOCA_PQOS_UPDATE_FLOW_PACKET_SIZE_MAX      1518
...
#define MOCA_6802C0_FLAG             (1 << 1)
#define MOCA_6803C0_FLAG             (1 << 2)
#define MOCA_7428B0_FLAG             (1 << 3)
#define MOCA_28NM_FLAG               (1 << 4)
#define MOCA_7445D0_FLAG             (1 << 5)
#define MOCA_74371B0_FLAG            (1 << 6)
#define MOCA_BAND_E_FLAG             (1 << 7)
#define MOCA_BAND_F_FLAG             (1 << 8)
#define MOCA_BAND_GENERIC_FLAG       (1 << 9)
#define MOCA_BAND_EX_D_FLAG          (1 << 10)
#define MOCA_BAND_D_LOW_FLAG         (1 << 11)
#define MOCA_BAND_D_HIGH_FLAG        (1 << 12)
#define MOCA_BAND_C4_FLAG            (1 << 13)
#define MOCA_BAND_H_FLAG             (1 << 14)
#define MOCA_BONDING_SUPPORTED_FLAG  (1 << 15)
#define MOCA_STANDALONE_FLAG         (1 << 16)
#define MOCA_6802B0_FLAG             (1 << 17)
#define MOCA_6816_FLAG               (1 << 18)
#define MOCA_7xxx_FLAG               (1 << 19)
#define MOCA_7425_FLAG               (1 << 20)
#define MOCA_FC_CAPABLE_CHIP_FLAG    (1 << 21)
#define MOCA_7408_FLAG               (1 << 22)
#define MOCA_SWITCH_FLAG             (1 << 23)
...
#define MOCA_MAX_TX_POWER_TUNE_OFFSET_ERR                              -1009
#define MOCA_RX_POWER_TUNE_OFFSET_ERR                                  -1010
#define MOCA_LOF_UPDATE_ERR                                            -1011
#define MOCA_PRIMARY_CH_OFFSET_ERR                                     -1012
#define MOCA_MR_SEQ_NUM_ERR                                            -1013
#define MOCA_SECONDARY_CH_OFFSET_ERR                                   -1014
#define MOCA_MAX_TX_POWER_ERR                                          -1015
#define MOCA_BEACON_PWR_REDUCTION_ERR                                  -1016
#define MOCA_BEACON_PWR_REDUCTION_EN_ERR                               -1017
#define MOCA_STAR_TOPOLOGY_EN_ERR                                      -1018
#define MOCA_OFDMA_EN_ERR                                              -1019
#define MOCA_MIN_BW_ALARM_THRESHOLD_ERR                                -1020
#define MOCA_TARGET_PHY_RATE_QAM128_ERR                                -1021
#define MOCA_TARGET_PHY_RATE_QAM256_ERR                                -1022
#define MOCA_ARPL_TH_50_ERR                                            -1023
#define MOCA_BANDWIDTH_ERR                                             -1024
#define MOCA_ARPL_TH_100_ERR                                           -1025
#define MOCA_MAX_CONSTELLATION_NODE_ID_ERR                             -1029
#define MOCA_MAX_CONSTELLATION_P2P_LIMIT_50_ERR                        -1030
#define MOCA_MAX_CONSTELLATION_GCD_LIMIT_50_ERR                        -1031
#define MOCA_MAX_CONSTELLATION_P2P_LIMIT_100_ERR                       -1032
#define MOCA_MAX_CONSTELLATION_GCD_LIMIT_100_ERR                       -1033
#define MOCA_RLAPM_TABLE_50_RLAPMTABLE_ERR                             -1037
#define MOCA_RLAPM_TABLE_100_RLAPMTABLE_ERR                            -1044
#define MOCA_NV_CAL_ENABLE_ERR                                         -1049
#define MOCA_SNR_MARGIN_RS_BASE_MARGIN_ERR                             -1050
#define MOCA_SNR_MARGIN_RS_OFFSETS_ERR                                 -1051
#define MOCA_SNR_MARGIN_LDPC_BASE_MARGIN_ERR                           -1052
#define MOCA_SNR_MARGIN_LDPC_OFFSETS_ERR                               -1053
#define MOCA_SNR_MARGIN_LDPC_SEC_CH_BASE_MARGIN_ERR                    -1054
#define MOCA_SNR_MARGIN_LDPC_SEC_CH_OFFSETS_ERR                        -1055
#define MOCA_SNR_MARGIN_LDPC_PRE5_BASE_MARGIN_ERR                      -1056
#define MOCA_SNR_MARGIN_LDPC_PRE5_OFFSETS_ERR                          -1057
#define MOCA_SNR_MARGIN_OFDMA_BASE_MARGIN_ERR                          -1058
#define MOCA_SNR_MARGIN_OFDMA_OFFSETS_ERR                              -1059
#define MOCA_SAPM_TABLE_50_VAL_ERR                                     -1060
#define MOCA_SAPM_TABLE_100_VAL_ERR                                    -1061
#define MOCA_SAPM_TABLE_SEC_VAL_ERR                                    -1062
#define MOCA_SNR_MARGIN_LDPC_PRI_CH_BASE_MARGIN_ERR                    -1063
#define MOCA_SNR_MARGIN_LDPC_PRI_CH_OFFSETS_ERR                        -1064
#define MOCA_MAX_FRAME_SIZE_ERR                                        -1065
#define MOCA_MAX_TRANSMIT_TIME_ERR                                     -1067
#define MOCA_MAX_PKT_AGGR_ERR                                          -1068
#define MOCA_RTR_CONFIG_LOW_ERR                                        -1071
#define MOCA_RTR_CONFIG_MED_ERR                                        -1072
#define MOCA_RTR_CONFIG_HIGH_ERR                                       -1073
#define MOCA_RTR_CONFIG_BG_ERR                                         -1074
#define MOCA_TLP_MODE_ERR                                              -1075
#define MOCA_MAX_PKT_AGGR_BONDING_ERR                                  -1076
#define MOCA_FC_MODE_ERR                                               -1077
#define MOCA_PER_MODE_ERR                                              -1078
#define MOCA_POLICING_EN_ERR                                           -1079
#define MOCA_ORR_EN_ERR                                                -1080
#define MOCA_BRCMTAG_ENABLE_ERR                                        -1081
#define MOCA_EGR_MC_ADDR_FILTER_ENTRYID_ERR                            -1090
#define MOCA_PAUSE_FC_EN_ERR                                           -1091
#define MOCA_STAG_PRIORITY_ENABLE_ERR                                  -1092
#define MOCA_STAG_PRIORITY_TAG_MASK_ERR                                -1093
#define MOCA_STAG_PRIORITY_MOCA_PRIORITY_0_ERR                         -1094
#define MOCA_STAG_PRIORITY_TAG_PRIORITY_0_ERR                          -1095
#define MOCA_STAG_PRIORITY_MOCA_PRIORITY_1_ERR                         -1096
#define MOCA_STAG_PRIORITY_TAG_PRIORITY_1_ERR                          -1097
#define MOCA_STAG_PRIORITY_MOCA_PRIORITY_2_ERR                         -1098
#define MOCA_STAG_PRIORITY_TAG_PRIORITY_2_ERR                          -1099
#define MOCA_STAG_PRIORITY_MOCA_PRIORITY_3_ERR                         -1100
#define MOCA_STAG_PRIORITY_TAG_PRIORITY_3_ERR                          -1101
#define MOCA_STAG_PRIORITY_MOCA_PRIORITY_4_ERR                         -1102
#define MOCA_STAG_PRIORITY_TAG_PRIORITY_4_ERR                          -1103
#define MOCA_STAG_PRIORITY_TAG_PRIORITY_5_ERR                          -1104
#define MOCA_STAG_PRIORITY_MOCA_PRIORITY_6_ERR                         -1105
#define MOCA_STAG_PRIORITY_TAG_PRIORITY_6_ERR                          -1106
#define MOCA_STAG_PRIORITY_MOCA_PRIORITY_7_ERR                         -1107
#define MOCA_STAG_PRIORITY_TAG_PRIORITY_7_ERR                          -1108
#define MOCA_STAG_REMOVAL_ENABLE_ERR                                   -1109
#define MOCA_STAG_REMOVAL_VALID_0_ERR                                  -1110
#define MOCA_STAG_REMOVAL_VALID_1_ERR                                  -1111
#define MOCA_STAG_REMOVAL_VALID_2_ERR                                  -1112
#define MOCA_STAG_REMOVAL_VALID_3_ERR                                  -1113
#define MOCA_PQOS_CREATE_FLOW_PACKET_SIZE_ERR                          -1114
#define MOCA_PQOS_CREATE_FLOW_PEAK_DATA_RATE_ERR                       -1115
#define MOCA_PQOS_CREATE_FLOW_BURST_SIZE_ERR                           -1116
#define MOCA_PQOS_CREATE_FLOW_MAX_LATENCY_ERR                          -1117
#define MOCA_PQOS_CREATE_FLOW_SHORT_TERM_AVG_RATIO_ERR                 -1118
#define MOCA_PQOS_CREATE_FLOW_MAX_RETRY_ERR                            -1119
#define MOCA_PQOS_CREATE_FLOW_FLOW_PER_ERR                             -1120
#define MOCA_PQOS_CREATE_FLOW_IN_ORDER_DELIVERY_ERR                    -1121
#define MOCA_PQOS_CREATE_FLOW_TRAFFIC_PROTOCOL_ERR                     -1122
#define MOCA_PQOS_CREATE_FLOW_INGR_CLASS_RULE_ERR                      -1123
#define MOCA_PQOS_CREATE_FLOW_VLAN_TAG_ERR                             -1124
#define MOCA_PQOS_CREATE_FLOW_DSCP_MOCA_ERR                            -1125
#define MOCA_PQOS_UPDATE_FLOW_PACKET_SIZE_ERR                          -1126
#define MOCA_PQOS_UPDATE_FLOW_PEAK_DATA_RATE_ERR                       -1127
#define MOCA_PQOS_UPDATE_FLOW_BURST_SIZE_ERR                           -1128
#define MOCA_PQOS_UPDATE_FLOW_MAX_LATENCY_ERR                          -1129
#define MOCA_PQOS_UPDATE_FLOW_SHORT_TERM_AVG_RATIO_ERR                 -1130
#define MOCA_PQOS_UPDATE_FLOW_MAX_RETRY_ERR                            -1131
#define MOCA_PQOS_UPDATE_FLOW_FLOW_PER_ERR                             -1132
#define MOCA_PQOS_UPDATE_FLOW_IN_ORDER_DELIVERY_ERR                    -1133
#define MOCA_PQOS_UPDATE_FLOW_TRAFFIC_PROTOCOL_ERR                     -1134
#define MOCA_PQOS_LIST_FLOW_MAX_RETURN_ERR                             -1135
#define MOCA_OOO_LMO_ERR                                               -1136
#define MOCA_START_ULMO_REPORT_TYPE_ERR                                -1137
#define MOCA_START_ULMO_NODE_ID_ERR                                    -1138
#define MOCA_START_ULMO_OFDMA_NODE_MASK_ERR                            -1139
#define MOCA_RXD_LMO_REQUEST_NODE_ID_ERR                               -1140
#define MOCA_RXD_LMO_REQUEST_PROBE_ID_ERR                              -1141
#define MOCA_RXD_LMO_REQUEST_CHANNEL_ID_ERR                            -1142
#define MOCA_ACA_SRC_NODE_ERR                                          -1147
#define MOCA_ACA_DEST_NODEMASK_ERR                                     -1148
#define MOCA_ACA_TYPE_ERR                                              -1149
#define MOCA_ACA_NUM_PROBES_ERR                                        -1150
#define MOCA_MOCA_RESET_RESET_TIMER_ERR                                -1151
#define MOCA_MOCA_RESET_NON_DEF_SEQ_NUM_ERR                            -1152
#define MOCA_WAKEUP_NODE_ERR                                           -1153
#define MOCA_IF_ACCESS_EN_ERR                                          -1155
#define MOCA_LED_MODE_ERR                                              -1156
#define MOCA_M1_TX_POWER_VARIATION_ERR                                 -1157
#define MOCA_NC_LISTENING_INTERVAL_ERR                                 -1158
#define MOCA_NC_HEARTBEAT_INTERVAL_ERR                                 -1159
#define MOCA_WOM_MAGIC_ENABLE_ERR                                      -1161
#define MOCA_PM_RESTORE_ON_LINK_DOWN_ERR                               -1162
#define MOCA_WOM_PATTERN_INDEX_ERR                                     -1164
#define MOCA_WOM_IP_INDEX_ERR                                          -1165
#define MOCA_STANDBY_POWER_STATE_ERR                                   -1166
#define MOCA_WOM_MODE_ERR                                              -1167
#define MOCA_PS_CMD_ERR                                                -1168
#define MOCA_PMK_EXCHANGE_INTERVAL_ERR                                 -1169
#define MOCA_TEK_EXCHANGE_INTERVAL_ERR                                 -1170
#define MOCA_AES_EXCHANGE_INTERVAL_ERR                                 -1171
#define MOCA_CONST_TX_PARAMS_CONST_TX_SUBMODE_ERR                      -1173
#define MOCA_LAB_IQ_DIAGRAM_SET_NODEID_ERR                             -1175
