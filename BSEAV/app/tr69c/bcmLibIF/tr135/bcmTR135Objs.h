...
#ifndef __BCMTR135OBJS_H__
#define __BCMTR135OBJS_H__
...
typedef struct b_sampleTCP
{
	char seconds[256];
	char packetsReceived[256];
	char packetRestransmitted[256];
	char bytesReceived[256];
} b_sampleTCP_t;

typedef struct b_sampleDejittering
{
	char seconds[256];
	char overruns[256];
	char underruns[256];
	char emptyBufferTime[256];
} b_sampleDejittering_t;

typedef struct b_sampleRTP
{
	char seconds[256];
	char packetsDiscarded[256];
	char packetsOutOfSequence[256];
	char packetsReceived[256];
	char packetsLost[256];
	char packetsLostBeforeEC[256];
	char lossEvents[256];
	char lossEventsBeforeEC[256];
} b_sampleRTP_t;

typedef struct b_sampleMPEG2Stats
{
	char seconds[256];
	char TSPacketsReceived[256];
	char TSPacketsDrained[256];
	char TSSyncByteErrorCount[256];
	char TSSyncLossCount[256];
	char packetDiscontinuityCounter[256];
	char packetDiscontinuityCounterBeforeCA[256];
} b_sampleMPEG2Stats_t;

typedef struct b_sampleVideoDecoderStats
{
	char seconds[256];
	char frameRate[256];
	char decodedFrames[256];
	char lostFrames[256];
	char concealedFrames[256];
	char IDecodedFrames[256];
	char ILostFrames[256];
	char IConcealedFrames[256];
	char PDecodedFrames[256];
	char PLostFrames[256];
	char PConcealedFrames[256];
	char BDecodedFrames[256];
	char BLostFrames[256];
	char BConcealedFrames[256];
	char AVResynchCounter[256];
} b_sampleVideoDecoderStats_t;

typedef struct b_sampleAudioDecoderStats
{
	char seconds[256];
	char decodedFrames[256];
	char decodingErrors[256];
} b_sampleAudioDecoderStats_t;
