...
1. Copy BRCM_BOLT_Generic_0_1_26_E1.tgz to a temporary directory.
2. Change directory to this location.
3. bash-4.2$ tar zxvf BRCM_BOLT_Generic_0_1_26_E1.tgz
4. bash-4.2$ cd release_bolt_v1.26/src
5. bash-4.2$ tar zxvf BRCM_Src_BOLT_Generic_0_1_26_E1.tgz
6. Copy bolt_v1.26 to the directory two levels above the directory containing BSEAV, magnum, etc.,
...
3. bash-4.2$ cd cd release_unified_cfe_v17.1/src/
4. bash-4.2$ unzip unified_cfe_v17.1.zip
5. Copy v17.1/CFE_17_1 to the directory two levels above the directory containing BSEAV, magnum, etc.,

If building for 73465 or 74295, you must change CFE_17_1\bsp\mips_config.h as follows:
