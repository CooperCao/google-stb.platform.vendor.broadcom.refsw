...
#define BSPLASH_ADDRESS_IN_RANGE_AVS_PMB(addr) ( \
...
#define BSPLASH_REGDUMP_EXCLUDE(addr)   ( \
	...
	BSPLASH_ADDRESS_IN_RANGE_AVS_PMB(addr) || \
...
#define SPLASH_SURF0_PXL_FMT  BPXL_eR5_G6_B5 /*BPXL_eCompressed_A8_R8_G8_B8*/
