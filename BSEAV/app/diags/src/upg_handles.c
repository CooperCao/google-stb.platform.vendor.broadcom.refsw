 ...
 ***********************************************************************/
    ...
    NEXUS_I2cHandle 	diags_hI2c[NEXUS_MAX_I2C_CHANNELS];
    BREG_I2C_Handle   diags_hRegI2c[NEXUS_MAX_I2C_CHANNELS];
#endif
...
BERR_Code bcmOpenI2cDevice (void)
{
    ...
    for (i=0; i<NEXUS_MAX_I2C_CHANNELS; i++)
    {
        ...
        diags_hRegI2c[i] = diags_hI2c[i] ? NEXUS_I2c_GetRegHandle(diags_hI2c[i], NULL) : NULL;
    }
