...
typedef enum b_virtual_irq_line {
    ...
    b_virtual_irq_line_bicap_fifo_inact_intr,
    b_virtual_irq_line_bicap_fifo_lvl_intr,
    b_virtual_irq_line_bicap_fifo_of_intr,
    b_virtual_irq_line_bicap_timeout0_intr,
    b_virtual_irq_line_bicap_timeout1_intr,
    b_virtual_irq_line_bicap_timeout2_intr,
    b_virtual_irq_line_bicap_timeout3_intr,
