...
typedef struct {
    uint32_t txbyte;                //!< Tx Bytes
    uint32_t txframe;               //!< Tx frames
    uint32_t txretrans;             //!< Tx re-transmissions
    uint32_t txerror;               //!< Tx Errors
    uint32_t rxbyte;                //!< Rx Bytes
    uint32_t rxframe;               //!< Rx Frames
    uint32_t rxerror;               //!< Rx Errors
} WiFiCounters_t;
