...
typedef enum {
    RsaTl_PaddingType_ePKCS1_V1_5 = 1,
    RsaTl_PaddingType_eOAEP,
    RsaTl_PaddingType_eMax
} RsaTl_PaddingType_e;
...
Description:
 Only lower 16bits of input parameter padding are used to pass padding
 information. upper 16bits are used to pass additional information.
 For example, when padding-type is OAEP, upper 16bits are used to set
 hash algorithm used.
