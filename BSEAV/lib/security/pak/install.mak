...
.PHONY: install_pak pakbin_install pakbin_dev_install

B_PAK_THIS_MFILE_DIR_FUNC := $(patsubst %/,%,$(dir $(abspath $(lastword $(MAKEFILE_LIST)))))
B_PAK_MY_TOP := $(call B_PAK_THIS_MFILE_DIR_FUNC)
...
ifneq ($(DRMBIN_FILE),)
PAKBIN_INSTALLS += drmbin_install
endif

install_pak: $(PAKBIN_INSTALLS) pak_dir

pakbin_install: pak_dir
	@${CP} -f ${PAKBIN_FILE} $(NEXUS_BIN_DIR)/pak.bin
