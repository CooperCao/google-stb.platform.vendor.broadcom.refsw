...
public:
    ...
    virtual uint32_t DecryptSample(SampleInfo *pSample, IBuffer *input, IBuffer *output, uint32_t sampleSize, bmp4_protectionSchemeInfo& trackProtectionInfo) OVERRIDE;
