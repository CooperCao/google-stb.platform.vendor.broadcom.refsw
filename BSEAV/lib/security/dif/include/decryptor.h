...
public:
    ...
    virtual bool AddKey(std::string key, bmp4_protection_info& protectionInfo) = 0;

    virtual void SetKeyId(std::string keyId) = 0;

    virtual bool CancelKeyRequest() = 0;

    virtual uint32_t DecryptSample(SampleInfo *pSample, IBuffer *input, IBuffer *output, uint32_t sampleSize, bmp4_protectionSchemeInfo& trackProtectionInfo) = 0;
...
public:
    ...
    virtual bool AddKey(std::string key, bmp4_protection_info& protectionInfo) OVERRIDE = 0;

    virtual void SetKeyId(std::string keyId) OVERRIDE = 0;

    virtual bool CancelKeyRequest() OVERRIDE = 0;

    virtual uint32_t DecryptSample(SampleInfo *pSample, IBuffer *input, IBuffer *output, uint32_t sampleSize, bmp4_protectionSchemeInfo& trackProtectionInfo) OVERRIDE = 0;
