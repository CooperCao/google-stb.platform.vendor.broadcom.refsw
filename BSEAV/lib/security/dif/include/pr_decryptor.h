 ...
 ******************************************************************************/
#ifndef _PR_DECRYPTOR_H_
#define _PR_DECRYPTOR_H_
...
class PlayreadyDecryptor : public BaseDecryptor
{
public:
    PlayreadyDecryptor();
    virtual ~PlayreadyDecryptor();
    ...
    virtual bool AddKey(std::string key, bmp4_protection_info& protectionInfo) OVERRIDE;
    ...
    virtual uint32_t DecryptSample(SampleInfo *pSample,
        ...
        uint32_t sampleSize,
        bmp4_protectionSchemeInfo& trackProtectionInfo) OVERRIDE;
...
protected:
    ...
    static DRM_Prdy_Handle_t s_drmHandle;
...
private:
    ...
    PlayreadyDecryptor(const PlayreadyDecryptor&);
    void operator=(const PlayreadyDecryptor&);
};
