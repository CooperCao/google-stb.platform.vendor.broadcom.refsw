...
::std::string NameValue::GetTypeName() const {
  return "video_widevine_client.sdk.NameValue";
}
...
const int License::kPlaybackStartTimeFieldNumber;
const int License::kLastPlaybackTimeFieldNumber;
const int License::kAppParametersFieldNumber;
#endif  // !_MSC_VER
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 7: {
        ...
        if (input->ExpectTag(64)) goto parse_playback_start_time;
        break;
      }
      ...
      case 8: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_VARINT) {
         parse_playback_start_time:
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   ::google::protobuf::int64, ::google::protobuf::internal::WireFormatLite::TYPE_INT64>(
                 input, &playback_start_time_)));
          set_has_playback_start_time();
        } else {
          goto handle_uninterpreted;
        }
        if (input->ExpectTag(72)) goto parse_last_playback_time;
        break;
      }
      ...
      case 9: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_VARINT) {
         parse_last_playback_time:
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   ::google::protobuf::int64, ::google::protobuf::internal::WireFormatLite::TYPE_INT64>(
                 input, &last_playback_time_)));
          set_has_last_playback_time();
        } else {
          goto handle_uninterpreted;
        }
        if (input->ExpectTag(82)) goto parse_app_parameters;
        break;
      }
...
void License::SerializeWithCachedSizes(
  ...
  // optional int64 playback_start_time = 8 [default = 0];
  if (has_playback_start_time()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt64(8, this->playback_start_time(), output);
  }

  // optional int64 last_playback_time = 9 [default = 0];
  if (has_last_playback_time()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt64(9, this->last_playback_time(), output);
  }

  // repeated .video_widevine_client.sdk.NameValue app_parameters = 10;
  for (int i = 0; i < this->app_parameters_size(); i++) {
    ::google::protobuf::internal::WireFormatLite::WriteMessage(
      10, this->app_parameters(i), output);
  }
...
int License::ByteSize() const {
  ...
  if (_has_bits_[8 / 32] & (0xffu << (8 % 32))) {
    ...
    if (has_last_playback_time()) {
      total_size += 1 +
        ::google::protobuf::internal::WireFormatLite::Int64Size(
          this->last_playback_time());
    }

  }
  // repeated .video_widevine_client.sdk.NameValue app_parameters = 10;
  total_size += 1 * this->app_parameters_size();
  for (int i = 0; i < this->app_parameters_size(); i++) {
    total_size +=
      ::google::protobuf::internal::WireFormatLite::MessageSizeNoVirtual(
        this->app_parameters(i));
  }
...
void License::MergeFrom(const License& from) {
  GOOGLE_CHECK_NE(&from, this);
  app_parameters_.MergeFrom(from.app_parameters_);
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_state()) {
    ...
    if (from.has_playback_start_time()) {
      set_playback_start_time(from.playback_start_time());
    }
  }
  if (from._has_bits_[8 / 32] & (0xffu << (8 % 32))) {
    if (from.has_last_playback_time()) {
      set_last_playback_time(from.last_playback_time());
    }
  }
}
...
void License::Swap(License* other) {
  if (other != this) {
    ...
    std::swap(playback_start_time_, other->playback_start_time_);
    std::swap(last_playback_time_, other->last_playback_time_);
    app_parameters_.Swap(&other->app_parameters_);
    std::swap(_has_bits_[0], other->_has_bits_[0]);
    std::swap(_cached_size_, other->_cached_size_);
  }
}
...
const int UsageInfo_ProviderSession::kKeySetIdFieldNumber;
#endif  // !_MSC_VER
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 3: {
        ...
        if (input->ExpectTag(34)) goto parse_key_set_id;
        break;
      }
...
void UsageInfo_ProviderSession::MergeFrom(const UsageInfo_ProviderSession& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_key_set_id()) {
      set_key_set_id(from.key_set_id());
    }
  }
}
...
void UsageInfo_ProviderSession::Swap(UsageInfo_ProviderSession* other) {
  if (other != this) {
    ...
    std::swap(license_request_, other->license_request_);
    std::swap(license_, other->license_);
    std::swap(key_set_id_, other->key_set_id_);
    std::swap(_has_bits_[0], other->_has_bits_[0]);
    std::swap(_cached_size_, other->_cached_size_);
  }
}
