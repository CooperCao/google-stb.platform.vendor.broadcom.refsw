...
#ifndef _ZIGBEE_SOCKET_SERVER_H_
#define _ZIGBEE_SOCKET_SERVER_H_

int Zigbee_Socket_ServerOpen(void);

/*******************************************************************************
   2nd 32 bits must contain socket number to send to.
*******************************************************************************/
...
#endif /*_ZIGBEE_SOCKET_SERVER_H_*/

/* eof zigbee_socket_server.h */