...
/*****************************************************************************
*
* FILENAME: $Workfile: trunk/stack/IEEE/MAC/include/private/bbMacFeReqProcSet.h $
*
* DESCRIPTION:
*   MLME-SET.request Processor interface.
*
* $Revision: 2722 $
...
#ifndef _BB_MAC_FE_REQ_PROC_SET_H
#define _BB_MAC_FE_REQ_PROC_SET_H
...
/************************* PROTOTYPES ***************************************************/
/*************************************************************************************//**
 * \brief   Accepts the specified event to be processed with the active MLME-SET.request.
 ...
 * \details
 *  This function takes the currently active MLME-SET.request and delivers the specified
 ...
 *  for the currently active MLME-SET.request. This Request Processor is able to process
 ...
 * \par     Documentation
 *  See IEEE 802.15.4-2006, subclause 7.1.13.1.
*****************************************************************************************/
MAC_PRIVATE void macFeReqProcSetAcceptEvent(const SYS_FSM_EventId_t eventId, MacLeReturnedParams_t *const params);


/*************************************************************************************//**
 * \brief   Accepts the RESET signal to be processed with the specified MLME-SET.request.
 * \param[in]   reqService      Pointer to the service field of the request descriptor of
 *  a particular pending MLME-SET.request to be reset.
 * \details
 *  This function finishes the specified pending MLME-GET.request without processing and
 *  issues the MLME-SET.confirm to the higher layer with RESET status.
 * \details
 *  This function is called by the MAC-FE Requests Dispatcher when performing the
 *  MLME-RESET.request.
*****************************************************************************************/
MAC_PRIVATE void macFeReqProcSetAcceptReset(MacServiceField_t *const reqService);


#endif /* _BB_MAC_FE_REQ_PROC_SET_H */