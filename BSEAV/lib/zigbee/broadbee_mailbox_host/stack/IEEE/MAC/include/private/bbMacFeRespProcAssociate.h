...
/*****************************************************************************
*
* FILENAME: $Workfile: trunk/stack/IEEE/MAC/include/private/bbMacFeRespProcAssociate.h $
*
* DESCRIPTION:
*   MLME-ASSOCIATE.response Processor interface.
*
* $Revision: 2722 $
...
#ifndef _BB_MAC_FE_RESP_PROC_ASSOCIATE_H
#define _BB_MAC_FE_RESP_PROC_ASSOCIATE_H
...
/*************************************************************************************//**
  \brief
    Accepts the specified event to be processed with the active MLME-ASSOCIATE.response.
  \param    eventId
  ...
  \details
    ...
    \li START       is originated by MAC-FE Requests Dispatcher to start processing of
                    next new request/response from the Dispatcher requests queue or
                    pending request/response picked from the Transactions queue;
...
*****************************************************************************************/
MAC_PRIVATE void macFeRespProcAssociateAcceptEvent(const SYS_FSM_EventId_t       eventId,
                                                   MacLeReturnedParams_t *const  params);


#endif /* _BB_MAC_FE_RESP_PROC_ASSOCIATE_H */