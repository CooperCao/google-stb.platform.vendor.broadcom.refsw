...
/*****************************************************************************
*
* FILENAME: $Workfile: trunk/stack/IEEE/MAC/include/bbMacSapTypesScan.h $
*
* DESCRIPTION:
*   MLME-SCAN service data types definition.
*
* $Revision: 3101 $
* $Date: 2014-07-29 09:58:06Z $
*
*****************************************************************************************/
...
{
    /* 32-bit data. */
    PHY_ChannelsSet_t    scanChannels;      /*!< Indicates which channels are to be scanned. */
    ...
    PHY_ChannelPageId_t  channelPage;       /*!< The channel page on which to perform the scan. */
...
{
    /* 32-bit data. */
    PHY_ChannelsSet_t    unscannedChannels;     /*!< Indicates which channels given in the request were not scanned. */
    ...
    PHY_ChannelPageId_t  channelPage;           /*!< The channel page on which the scan was performed. */
 ...
 */
#define MAC_SCAN_RESULT_LIST_SIZE_MAX_ED        PHY_MAX_NUMBER_OF_LOGICAL_CHANNELS_ON_PAGE
...
SYS_DbgAssertStatic(MAC_SCAN_RESULT_LIST_SIZE_MAX_ACTIVE * sizeof(MAC_PanDescriptor_t) <=
                    /*MailBox maximum payload length*/ 255);                                                                /* TODO: Use MailBox constant. */
# endif
