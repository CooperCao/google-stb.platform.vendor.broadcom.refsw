...
/*****************************************************************************
*
* FILENAME: $Workfile: trunk/stack/IEEE/MAC/include/bbMacBasics.h $
*
* DESCRIPTION:
*   Basic MAC set.
*
...
/************************* INCLUDES *****************************************************/
/*
 * Include basic MAC and SYS (system environment) headers set.
 */
#ifndef __i386__
...
#include "bbMacKeywords.h"          /* MAC macro keywords definition. */
#include "bbMacContexts.h"          /* MAC Contexts interface. */
