 ...
 *
 * DESCRIPTION:
 *      MLME-POLL.request Processor interface.
 *
*******************************************************************************/

#ifndef _BB_MAC_FE_REQ_PROC_POLL_H
#define _BB_MAC_FE_REQ_PROC_POLL_H
...
/*************************************************************************************//**
  \brief
    Accepts the specified event to be processed with the active MLME-POLL.request.
  \param    eventId
...
*****************************************************************************************/
MAC_PRIVATE void macFeReqProcPollAcceptEvent(const SYS_FSM_EventId_t eventId, MacLeReturnedParams_t *const params);
 ...
 *  a particular pending MLME-POLL.request to be reset.
 * \details
 *  This function finishes the specified pending MLME-POLL.request without processing
 *  and issues the MLME-POLL.confirm to the higher layer with RESET status.
 * \details
 *  This function is called by the MAC-FE Requests Dispatcher when performing the
 *  MLME-RESET.request.
*****************************************************************************************/
MAC_PRIVATE void macFeReqProcPollAcceptReset(MacServiceField_t *const reqService);


#endif /* _BB_MAC_FE_REQ_PROC_POLL_H */

/* eof bbMacFeReqProcPoll.h */