...
# define _MAILBOX_WRAPPERS_PROFILING_ENGINE_ WRAPPERS_BASE
#endif
...
#  define FIRMWARE_FEATURES_BIT_01 1
# else
#  define FIRMWARE_FEATURES_BIT_01 0
# endif
#
...
# define FIRMWARE_FEATURES (                 \
        ...
        | ((FIRMWARE_FEATURES_BIT_01) << 1)  \
        | ((FIRMWARE_FEATURES_BIT_02) << 2)  \
        | ((FIRMWARE_FEATURES_BIT_03) << 3))
