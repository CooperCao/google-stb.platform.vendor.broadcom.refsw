...
HOST_TO_STACK(RF4CE_NWK_MacStatsReq, RF4CE_NWK_MAC_STATS_REQ_FID,
              HAS_CB, RF4CE_NWK_MacStatsReqDescr_t,
              NO_DATA, RF4CE_NWK_MacStatsReqParams_t, payload,
              NO_DATA, RF4CE_NWK_MacStatsConfParams_t, payload)
...
HOST_TO_STACK(ZBPRO_ZCL_IASWDCmdSquawkgReq, ZBPRO_ZCL_IAS_WD_CMD_SQUAWK_REQ_FID,
...
STACK_TO_HOST(Mail_TestEngineHaltInd, TE_ASSERT_ERRID_FID,
              NO_CB, NO_APPROPRIATE_TYPE,
              NO_DATA, TE_AssertLogIdCommandIndParams_t, payload,
              NO_CONFIRM, NO_APPROPRIATE_TYPE, payload)
