 ...
 *
 * DESCRIPTION:
 *      List of includes for the NVM parameters
 *
*******************************************************************************/
...
#ifndef BB_NVM_INCLUDE_LOCK
# error This header can be used only in a NVM implementation.
#endif
...
# include "private/bbZbProApsMm.h"
    extern ZbProApsDescr_t ZbProApsMmDescr;
# include "private/bbZbProNwkMem.h"
    extern ZbProNwkDescriptor_t nwkDescriptor;
#endif /* _ZBPRO_ */
