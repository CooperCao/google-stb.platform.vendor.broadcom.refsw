 ...
 ******************************************************************************
*
* FILENAME: $Workfile: trunk/stack/common/HAL/arc601-ml507/include/bbMl507Dbg.h $
*
* DESCRIPTION:
*   ML507 Debugging Hardware interface.
*
* $Revision: 10263 $
...
#ifndef _BB_ML507_DBG_H
#define _BB_ML507_DBG_H
...
/**//**
 * \brief   Logs error via the Mailbox interface and halts program execution until reset signal is received via the
 *  Mailbox, then restarts the application.
 * \param[in]   errorUid    Error identifier to be logged.
 */
void ML507_DbgHalt(const uint32_t errorUid);
#endif
 ...
 */
void ML507_DbgLogId(const uint32_t warningUid);
#endif
 ...
 * \details The text output of this function may be directed to stdout, stderr, or UART.
 * \details The trailing End-of-Line symbol is appended automatically.
 */
void ML507_DbgLogStr(const char *const message);
#endif

#endif /* _BB_ML507_DBG_H */
