...
#else /* __i386__ */
# define HAL_RestartSw(asFactoryNew)        ((void)(asFactoryNew))
#endif

/**//**
 * \brief   Returns the type of restart has been performed.
 * \return  TRUE if the software is to be set to the factory new after this restart; FALSE otherwise.
 */
#if defined(__SoC__)
...
#else /* __i386__ */
# define HAL_GetZbProResetType()            (1)
#endif
...
#else /* __ML507__ || __i386__ */
# define HAL_ResetHw()                      while(0)
#endif
...
#else /* __ML507__ || __i386__ */
# define HAL_ConfigHw()                     while(0)
#endif

/************************* INCLUDES ***********************************************************************************/
#if defined(__SoC__)
# include "bbSocReset.h"
#elif defined(__ML507__)
# include "bbMl507Reset.h"
#endif
