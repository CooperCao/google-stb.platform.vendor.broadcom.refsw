 ...
 * \param[in]   clocks      Period of time, in main clocks, for which the program execution is to be delayed.                       // FIXME: Revise the divider. Currently set to 1.
