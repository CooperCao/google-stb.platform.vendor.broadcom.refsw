...
/*****************************************************************************
*
* FILENAME: $Workfile: trunk/stack/ZbPro/TC/include/bbZbProTcNwkKeyUpdate.h $
*
* DESCRIPTION:
...
typedef struct _ZBPRO_TC_NwkKeyUpdateReqDescr_t
{
    ...
    ZBPRO_TC_NwkKeyUpdateReqParams_t params;
    ZBPRO_TC_NwkKeyUpdateConfCallback_t *callback;
