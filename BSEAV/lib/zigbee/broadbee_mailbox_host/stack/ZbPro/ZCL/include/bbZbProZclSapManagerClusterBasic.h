 ...
 * \ingroup ZBPRO_ZCL_SetPowerSourceReq
 */
...
{
    Bool8_t                     hasBatteryBackup;       /*!< Device has Battery Backup */
    ZBPRO_ZCL_PowerSource_t     source;                 /*!< Power Source */
} ZBPRO_ZCL_SetPowerSourceReqParams_t;

/**//**
 * \brief HA Basic Cluster Power request confirmation parameters
 * \ingroup ZBPRO_ZCL_SetPowerSourceConf
 */
typedef struct _ZBPRO_ZCL_SetPowerSourceConfParams_t
{
    ZBPRO_ZCL_Status_t          status;                 /*!< Confirmation status */
...
struct _ZBPRO_ZCL_SetPowerSourceReqDescr_t
{
    ...
    ZBPRO_ZCL_SetPowerSourceConfCallback_t   *callback; /*!< Confirmation status */
    ZBPRO_ZCL_SetPowerSourceReqParams_t      params;    /*!< Request parameters */
};
...
/* eof bbZbProZclSapManagerClusterBasic.h */