...
typedef enum _ZBPRO_APS_HandlerId_t
{
    ...
    ZBPRO_APS_TX_FSM_TIMEOUT_HANDLER_ID,
    ZBPRO_APS_TX_FSM_PROCEED_HANDLER_ID,
    ZBPRO_APS_TX_FSM_ZDO_HANDLER_ID,
    ZBPRO_APS_FRAG_TX_FSM_HANDLER_ID,
    ZBPRO_APS_FRAG_RX_TIMEOUT_HANDLER_ID,
    ZBPRO_APS_FRAG_RX_PERSIST_HANDLER_ID,
