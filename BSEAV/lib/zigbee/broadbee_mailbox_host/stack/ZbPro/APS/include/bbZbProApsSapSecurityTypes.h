...
/*****************************************************************************
*
* FILENAME: $Workfile: trunk/stack/ZbPro/APS/include/bbZbProApsSapSecurityTypes.h $
*
* DESCRIPTION:
...
typedef enum _ZBPRO_APS_SecurityInitialStatus_t
{
    ...
    ZBPRO_APS_PRECONFIGURED_TRUST_CENTER_MASTER_KEY = 0x02, /* Not supported */
    ZBPRO_APS_NOT_PRECONFIGURED                     = 0x03  /* Not supported */
