 ...
 * \ingroup ZBPRO_APS_TransportKeyReq
 */
typedef struct _ZBPRO_APS_TransportKeyReqParams_t
{
    ...
    Bool8_t                 apsSecure;      /*!< Is APS secure? */
 ...
 * \ingroup ZBPRO_APS_TransportKeyConf
...
typedef struct _ZBPRO_APS_TransportKeyReqDescr_t
{
    ...
    struct
    {
        union
        {
            ...
            ZBPRO_APS_TunnelReqDescr_t  tunnelReq;          /*!< Tunnel Request descriptor. */
        };
 ...
 * \ingroup ZBPRO_APS_TransportKeyInd
 */
...
/* eof bbZbProApsSapTransportKey.h */