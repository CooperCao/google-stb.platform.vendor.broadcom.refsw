...
/*****************************************************************************
 *
 * FILENAME: $Workfile: trunk/stack/ZbPro/APS/include/private/bbZbProApsFrame.h $
 *
 * DESCRIPTION:
...
INLINE void fillFrameCtrl(ZbProApsFrameControlField_t *frameControl,
        ZbProApsFrameType_t type, ZbProApsDeliveryMode_t mode, bool security, bool ack)
{
 ...
 */
APS_PRIVATE bool zbProFrameDetachParseHeader(SYS_DataPointer_t *const apsHeader, SYS_DataPointer_t *const data,
        ZbProApsFrameHeaderCommonParsed_t *const parsedHeader);
