...
*
* DESCRIPTION:
*       ZDP Mgmt_Permit_Joining Service private interface.
*
*******************************************************************************/

#ifndef _BB_ZBPRO_ZDP_MGMT_PERMIT_JOINING_HANDLER_H
#define _BB_ZBPRO_ZDP_MGMT_PERMIT_JOINING_HANDLER_H
 ...
 *  Mgmt_Permit_Joining Service Transaction.
 ...
 */
RpcServiceDirective_t zbProZdpMgmtPermitJoiningServiceHandler(
                RpcTransaction_t   *const  rpcTransaction,
                const RpcServiceCommand_t  rpcCommand);


#endif /* _BB_ZBPRO_ZDP_MGMT_PERMIT_JOINING_HANDLER_H */

/* eof bbZbProZdpMgmtPermitJoiningHandler.h */