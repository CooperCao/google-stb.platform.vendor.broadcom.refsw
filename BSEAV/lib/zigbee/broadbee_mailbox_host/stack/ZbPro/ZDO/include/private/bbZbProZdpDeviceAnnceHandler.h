...
/*****************************************************************************
*
* FILENAME: $Workfile: trunk/stack/ZbPro/ZDO/include/private/bbZbProZdpDeviceAnnceHandler.h $
*
* DESCRIPTION:
*   ZDP Device_Annce Service private interface.
*
* $Revision: 6512 $
* $Date: 2015-04-29 01:27:00Z $
*
*****************************************************************************************/


#ifndef _BB_ZBPRO_ZDP_DEVICE_ANNCE_HANDLER_H
#define _BB_ZBPRO_ZDP_DEVICE_ANNCE_HANDLER_H
 ...
 *  Device_Annce Service Transaction.
 ...
 */
RpcServiceDirective_t zbProZdpDeviceAnnceServiceHandler(
                RpcTransaction_t   *const  rpcTransaction,
                const RpcServiceCommand_t  rpcCommand);


#endif /* _BB_ZBPRO_ZDP_DEVICE_ANNCE_HANDLER_H */
