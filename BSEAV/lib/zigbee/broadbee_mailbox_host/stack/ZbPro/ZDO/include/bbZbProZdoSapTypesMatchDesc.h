 ...
 * \ingroup ZBPRO_ZDO_MatchDescReq
 */
typedef struct _ZBPRO_ZDO_MatchDescReqParams_t
{
    ...
    ZBPRO_ZDO_ProfileId_t   profileId;             /*!< Profile ID */
    uint8_t                 numInClusters;         /*!< Number of IN clusters */
    uint8_t                 numOutClusters;        /*!< Number of OUT clusters */
 ...
 * \ingroup ZBPRO_ZDO_MatchDescConf
 */
typedef struct PACKED _ZBPRO_ZDO_MatchDescRespListItem_t
{
    ZBPRO_ZDO_NwkAddr_t     nwkAddrOfInterest;     /*!< Short address of interest */
    uint8_t                 matchLength;           /*!< Match list size */
    ZBPRO_ZDO_Endpoint_t    matchList[];           /*!< Match endpoints list */
...
struct _ZBPRO_ZDO_MatchDescReqDescr_t
{
    ...
    ZBPRO_ZDO_MatchDescConfCallback_t   *callback; /*!< Confirmation callback */
    ZBPRO_ZDO_MatchDescReqParams_t      params;    /*!< Request parameters */
};
...
/* eof bbZbProZdoSapTypesMatchDesc.h */