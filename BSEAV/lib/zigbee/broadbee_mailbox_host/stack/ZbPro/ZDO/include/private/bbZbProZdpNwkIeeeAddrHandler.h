...
/*****************************************************************************
*
* FILENAME: $Workfile: trunk/stack/ZbPro/ZDO/include/private/bbZbProZdpNwkIeeeAddrHandler.h $
*
* DESCRIPTION:
*   ZDP NWK_Addr and IEEE_Addr Services private interface.
*
* $Revision: 6512 $
...
#ifndef _BB_ZBPRO_ZDP_NWK_IEEE_ADDR_HANDLER_H
#define _BB_ZBPRO_ZDP_NWK_IEEE_ADDR_HANDLER_H
 ...
 *  NWK_Addr or IEEE_Addr Service Transaction.
 ...
 */
RpcServiceDirective_t zbProZdpNwkIeeeAddrServiceHandler(
                RpcTransaction_t   *const  rpcTransaction,
                const RpcServiceCommand_t  rpcCommand);


#endif /* _BB_ZBPRO_ZDP_NWK_IEEE_ADDR_HANDLER_H */
