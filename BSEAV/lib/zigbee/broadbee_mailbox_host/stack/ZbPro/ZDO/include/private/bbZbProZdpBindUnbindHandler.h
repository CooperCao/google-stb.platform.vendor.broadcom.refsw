...
*
* DESCRIPTION:
*       ZDP Bind and Unbind Services private interface.
*
*******************************************************************************/

#ifndef _BB_ZBPRO_ZDP_BIND_UNBIND_HANDLER_H
#define _BB_ZBPRO_ZDP_BIND_UNBIND_HANDLER_H
 ...
 *  Bind or Unbind Service Transaction.
 ...
 */
RpcServiceDirective_t zbProZdpBindUnbindServiceHandler(
                RpcTransaction_t   *const  rpcTransaction,
                const RpcServiceCommand_t  rpcCommand);


#endif /* _BB_ZBPRO_ZDP_BIND_UNBIND_HANDLER_H */

/* eof bbZbProZdpBindUnbindHandler.h */