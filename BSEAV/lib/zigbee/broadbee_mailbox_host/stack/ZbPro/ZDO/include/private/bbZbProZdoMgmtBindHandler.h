...
/*****************************************************************************
 *
 * FILENAME: $Workfile: trunk/stack/ZbPro/ZDO/include/private/bbZbProZdoMgmtBindHandler.h $
 *
 * DESCRIPTION:
 ...
 *
 ****************************************************************************************/
#ifndef _ZBPRO_ZDO_MGMT_BIND_HANDLER_H
#define _ZBPRO_ZDO_MGMT_BIND_HANDLER_H
...
*****************************************************************************************/
RpcServiceDirective_t zbProZdpMgmtBindServiceHandler(
