...
*
* DESCRIPTION:
*       ZDP Mgmt_Leave Service private interface.
*
*******************************************************************************/

#ifndef _BB_ZBPRO_ZDP_MGMT_LEAVE_HANDLER_H
#define _BB_ZBPRO_ZDP_MGMT_LEAVE_HANDLER_H
 ...
 *  Mgmt_Leave Service Transaction.
 ...
 */
RpcServiceDirective_t zbProZdpMgmtLeaveServiceHandler(
                RpcTransaction_t   *const  rpcTransaction,
                const RpcServiceCommand_t  rpcCommand);


#endif /* _BB_ZBPRO_ZDP_MGMT_LEAVE_HANDLER_H */

/* eof bbZbProZdpMgmtLeaveHandler.h */