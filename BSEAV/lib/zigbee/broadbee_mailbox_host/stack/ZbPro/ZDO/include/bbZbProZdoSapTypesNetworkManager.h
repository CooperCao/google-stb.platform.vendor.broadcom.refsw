 ...
 * \ingroup ZBPRO_ZDO_StartNetworkConf
 */
typedef struct _ZBPRO_ZDO_StartNetworkConfParams_t
{
    ZBPRO_ZDO_ExtPanId_t    extendedPanId;          /*!< ZDO extended PAN id. */
    ZBPRO_ZDO_PanId_t       panId;                  /*!< ZDO PAN id. */
    ZBPRO_ZDO_NwkAddr_t     networkAddress;         /*!< Network address. */
    PHY_Channel_t           activeChannel;          /*!< Active channel. */
    ZBPRO_ZDO_Status_t      status;                 /*!< Confirmation status. */
} ZBPRO_ZDO_StartNetworkConfParams_t;

/**//**
 * \brief ZDO Start descriptor prototype.
 * \ingroup ZBPRO_ZDO_StartNetworkReq
 */
...
struct _ZBPRO_ZDO_StartNetworkReqDescr_t
{
    ...
    } service;                                      /*!< Service fields container. */

    ZBPRO_ZDO_StartNetworkConfCallback_t *callback; /*!< Confirmation callback. */
};
...
/* eof bbZbProZdoSapTypesNetworkManager.h */