...
*
* DESCRIPTION:
*       ZDP Mgmt_NWK_Update Service private interface.
*
*******************************************************************************/

#ifndef _BB_ZBPRO_ZDP_MGMT_NWK_UPDATE_HANDLER_H
#define _BB_ZBPRO_ZDP_MGMT_NWK_UPDATE_HANDLER_H
 ...
 *  Mgmt_NWK_Update Service Transaction.
 ...
 */
RpcServiceDirective_t zbProZdpMgmtNwkUpdateServiceHandler(
                RpcTransaction_t   *const  rpcTransaction,
                const RpcServiceCommand_t  rpcCommand);


#endif /* _BB_ZBPRO_ZDP_MGMT_NWK_UPDATE_HANDLER_H */

/* eof bbZbProZdpMgmtNwkUpdateHandler.h */