...
/*****************************************************************************
 *
 * FILENAME: $Workfile: trunk/stack/ZbPro/ZDO/include/private/bbZbProZdoActiveEp.h $
 *
 * DESCRIPTION:
 *   This header describes types and Private API for the ZDO Active_Ep service.
 *
 * $Revision: 3338 $
 * $Date: 2014-08-20 09:06:10Z $
 ****************************************************************************************/

#ifndef _ZBPRO_ZDO_ACTIVE_EP_H
#define _ZBPRO_ZDO_ACTIVE_EP_H
 ...
 */
RpcServiceDirective_t zbProZdpActiveEpServiceHandler(
                RpcTransaction_t   *const  rpcTransaction,
                const RpcServiceCommand_t  rpcCommand);

#endif /* _ZBPRO_ZDO_ACTIVE_EP_H */