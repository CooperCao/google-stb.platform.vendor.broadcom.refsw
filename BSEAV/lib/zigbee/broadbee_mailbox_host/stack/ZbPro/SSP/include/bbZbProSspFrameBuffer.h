...
/*****************************************************************************
 *
 * FILENAME: $Workfile: trunk/stack/ZbPro/SSP/include/bbZbProSspFrameBuffer.h $
 *
 * DESCRIPTION:
...
/************************************************************************************//**
    ...
    \note The caller MUST be sure that the function to work with frame buffer are
