...
/************************************************************************************//**
    \brief Function generates random key and sets up it to with a specified key sequince number.
    \param[in] keySeqNumber - sequence number of new active key.
    \return true if operation was successful, false otherwise.
****************************************************************************************/
bool zbProNwkNibApiSetRandomKey(const ZbProSspNwkKeySeqNum_t keySeqNumber);
...
/* eof bbZbProNwkSecurityMaterialFriend.h */