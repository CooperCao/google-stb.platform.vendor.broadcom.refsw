 ...
 * \ingroup ZBPRO_NWK_NetworkFormationReq
...
typedef struct _ZBPRO_NWK_NetworkFormationReqParams_t
{
    ...
    /*!< \note Description for apsUseExtendedPANID says "The 64-bit address of a network to form
    ...
    uint32_t                scanChannels;        /*!< Scan channels bitfield (The 27 least significant bits) */
 ...
 * \ingroup ZBPRO_NWK_NetworkFormationConf
 */
typedef struct _ZBPRO_NWK_NetworkFormationConfParams_t
{
    ZBPRO_NWK_Status_t status;                   /*!< The result of the attempt to initialize a ZigBee coordinator */
...
typedef struct _ZBPRO_NWK_NetworkFormationReqDescr_t
{
    ...
    ZBPRO_NWK_NetworkFormationReqParams_t       params;   /*!< Request parameters */
    ZBPRO_NWK_NetworkFormationConfCallback_t    callback; /*!< Confirmation callback */
...
/* eof bbZbProNwkSapTypesNetworkFormation.h */