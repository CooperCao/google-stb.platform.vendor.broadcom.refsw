 ...
 */
#ifdef _ZBPRO_NWK_NEIGHBOR_TABLE_SIZE_
#   define ZBPRO_NWK_NEIGHBOR_TABLE_SIZE           _ZBPRO_NWK_NEIGHBOR_TABLE_SIZE_
#else
...
/**//**
 * \brief Secure frame counter NVM save mask
 */
#define ZBPRO_NWK_SEC_COUNTER_NVM_SAVE_MASK                 0xFF

/**//**
 * \brief Secure frame counter NVM save safety delta.
 *        To avoid reset impact within the secure frame counter NVM save procedure
 */
#define ZBPRO_NWK_SEC_COUNTER_NVM_SAVE_SAFETY_DELTA         10
