...
/*****************************************************************************
*
* FILENAME: $Workfile: trunk/stack/ZbPro/NWK/include/private/bbZbProNwkBroadcastTable.h $
*
* DESCRIPTION:
*   Contains definitions for interface for ZigBee PRO NWK Broadcast Table.
*
* $Revision: 2427 $
* $Date: 2014-05-19 10:39:13Z $
*
****************************************************************************************/
...
/************************************************************************************//**
  ...
  \return ZBPRO_NWK_BTR_FOUND - when duplicate packet is received.
          ZBPRO_NWK_BTR_ADDED - new packet is received and information about the packet is added to the table.
****************************************************************************************/
