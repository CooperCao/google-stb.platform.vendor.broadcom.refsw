...
/************************************************************************************//**
    \brief Returns next address.
****************************************************************************************/
NWK_PRIVATE ZbProNwkAddressMapEntry_t *zbProNwkAddressMapNextEntry(ZbProNwkAddressMapEntry_t *const prev);

#endif /* _ZBPRO_NWK_ADDRESS_MAP_H */

/* eof bbZbProNwkAddressMap.h */
