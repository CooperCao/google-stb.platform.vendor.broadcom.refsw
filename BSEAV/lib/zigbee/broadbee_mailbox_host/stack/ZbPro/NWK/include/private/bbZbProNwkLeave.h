...
/*****************************************************************************
*
* FILENAME: $Workfile: trunk/stack/ZbPro/NWK/include/private/bbZbProNwkLeave.h $
*
* DESCRIPTION:
...
/************************************************************************************//**
    \brief Initiates leaving itself procedure.
    \param[in] deviceAddress - extended address of device which left the network.
****************************************************************************************/
NWK_PRIVATE bool zbProNwkLeaveIndLeaveItself(const bool removeChildren, const bool rejoin);
