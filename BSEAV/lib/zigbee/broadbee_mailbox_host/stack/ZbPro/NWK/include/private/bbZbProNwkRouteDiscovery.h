...
/*****************************************************************************
*
* FILENAME: $Workfile: trunk/stack/ZbPro/NWK/include/private/bbZbProNwkRouteDiscovery.h $
*
* DESCRIPTION:
...
#ifndef _ZBPRO_NWK_ROUTE_DISCOVERY_PRIVATE_H
#define _ZBPRO_NWK_ROUTE_DISCOVERY_PRIVATE_H
...
/**//**
 * \brief Route Discovery handler memory descriptor initializer.
 */
#define ZBPRO_NWK_ROUTE_DISCOVERY_INITIALIZER \
    { \
        .reqQueue = SYS_QUEUE_INITIALIZER, \
    }

/**//**
 * \brief Internal memory of the route discovery request handler.
 */
typedef struct _ZbProNwkRouteDiscoveryDescr_t
{
...
****************************************************************************************/
NWK_PRIVATE void zbProNwkRouteDiscoveryReset(void);

#endif /* _ZBPRO_NWK_ROUTE_DISCOVERY_PRIVATE_H */