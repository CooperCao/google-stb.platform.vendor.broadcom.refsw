...
/**//**
 * \brief Type of MAC channel mask.
 */
typedef PHY_ChannelsSet_t       ZBPRO_NWK_ChannelMask_t;

/**//**
 * \brief Type of MAC channel number.
 */
typedef PHY_LogicalChannelId_t  ZBPRO_NWK_Channel_t;

/**//**
 * \brief Type of MAC channel page.
 */
typedef PHY_CurrentPage_t       ZBPRO_NWK_CurrentPage_t;
...
/**//**
 * \brief Type of link quality indicator.
 */
typedef PHY_Lqi_t               ZBPRO_NWK_Lqi_t;
