...
typedef enum _RF4CE_ZRC_HandlerID_t
{
    ...
    RF4CE_ZRC2_CONFIGURATION_COMPLETE_HANDLER,
...
/************************************************************************************//**
    \brief Sends the ZRC 2.0 GDP 2.0 Configuration Complete request.
     ...
     \return Nothing.
 ****************************************************************************************/
void rf4cezrc2ConfigurationCompleteHandler(SYS_QueueElement_t *queueElement);
