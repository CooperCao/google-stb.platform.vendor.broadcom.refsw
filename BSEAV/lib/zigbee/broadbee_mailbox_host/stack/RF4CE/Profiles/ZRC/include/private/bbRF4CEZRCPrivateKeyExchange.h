...
/************************************************************************************//**
 \brief Local rotuine to clean up initial key exchange key.
 \details Called on finishing the pairing procedure for the ZRC 2.0 profile.

 \param[in] pair - Pairing reference to clean up key for.
 \return Nothing.
 ****************************************************************************************/
...
/* eof bbRF4CEZRCPrivateKeyExchange.h */