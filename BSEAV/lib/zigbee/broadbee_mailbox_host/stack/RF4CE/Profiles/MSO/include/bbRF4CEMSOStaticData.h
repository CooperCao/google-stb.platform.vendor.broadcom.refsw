...
/*****************************************************************************
 *
 * FILENAME: $Workfile: trunk/stack/RF4CE/Profiles/MSO/include/bbRF4CEMSOStaticData.h $
 *
 * DESCRIPTION:
...
{
    RF4CE_MSO_ProfileAttributes_t attributes;
    SYS_SchedulerTaskDescriptor_t tasks;
    SYS_QueueDescriptor_t startResetBindQueue;
    SYS_QueueDescriptor_t startGetSetPAQueue;
    SYS_QueueDescriptor_t startGetSetRIBQueue;
    SYS_QueueDescriptor_t ucQueue;
#ifdef RF4CE_TARGET
