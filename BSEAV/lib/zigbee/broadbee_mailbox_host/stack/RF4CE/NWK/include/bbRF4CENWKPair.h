...
/*****************************************************************************
 *
 * FILENAME: $Workfile: trunk/stack/RF4CE/NWK/include/bbRF4CENWKPair.h $
 *
 * DESCRIPTION:
...
{
    RF4CE_NWK_UnpairRespParams_t params;
 ...
 * \used for NWK certification tests only
 */
...
void RF4CE_NWK_PrintKey(const uint8_t *key);
#endif
