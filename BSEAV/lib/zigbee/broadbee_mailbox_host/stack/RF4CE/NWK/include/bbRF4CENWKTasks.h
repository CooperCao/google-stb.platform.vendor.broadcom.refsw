...
/*****************************************************************************
 *
 * FILENAME: $Workfile: trunk/stack/RF4CE/NWK/include/bbRF4CENWKTasks.h $
 *
 * DESCRIPTION:
...
typedef enum _RF4CE_NWK_TaskID_t
{
    ...
    RF4CE_NWK_DATA_INDICATION_HANDLER_ID,
    ...
    RF4CE_NWK_ON_KEY_SEED_WAIT_TIMEOUT_INITIATOR_HANDLER_ID,
    RF4CE_NWK_ON_RESPONSE_WAIT_TIMEOUT_INITIATOR_HANDLER_ID,
    RF4CE_NWK_ON_KEY_SEED_WAIT_TIMEOUT_RESPONDER_HANDLER_ID,
    RF4CE_NWK_ON_RESPONSE_WAIT_TIMEOUT_RESPONDER_HANDLER_ID,
    ...
    RF4CE_NWK_RX_ENABLE_DEFERRED_HANDLER_ID
