...
int main(int argc, char *argv[])
{
    ...
    switch(key){
        case 'b':
            BroadBee_ZRC2_Set_Default_Check_Validation_Period(0);
            BroadBee_ZRC2_Set_Default_Check_Validation_Period(1);
            BroadBee_ZRC2_Set_Default_Link_Lost_Wait_Time(0);
            BroadBee_ZRC2_Set_Default_Link_Lost_Wait_Time(1);
            BroadBee_ZRC_Set_WakeUpActionCode();
            BroadBee_ZRC_Get_WakeUpActionCode();
            BroadBee_ZRC_Start_NWK();
            //printf(bindingInstruction);
            BroadBee_ZRC2_EnableBinding();
            printf("Press any button to stimulus\n");
            getchar();
            BroadBee_ZRC2_Set_PushButtonStimulus();
            break;
        case 'e':
            BroadBee_ZRC_Set_WakeUpActionCode();
            BroadBee_ZRC_Get_WakeUpActionCode();
    ...
    getchar();
    printf("Completed 'zrc2_pair' application successfully.\n");
