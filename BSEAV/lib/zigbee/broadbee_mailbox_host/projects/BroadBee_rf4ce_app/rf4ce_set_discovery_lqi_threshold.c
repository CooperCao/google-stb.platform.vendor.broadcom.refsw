...
int main(int argc, char *argv[])
{
    ...
    int times = 1;
    while(times--)
        BroadBee_RF4CE_Set_Discovery_Lqi_Threshold((uint8_t)threshold);

    printf("\nPress any key to exist\n");
    getchar();
    printf("Completed 'rf4ce_set_discovery_lqi_threshold' application successfully.\n");
...
/* eof rf4ce_set_discovery_lqi_threshold.c */