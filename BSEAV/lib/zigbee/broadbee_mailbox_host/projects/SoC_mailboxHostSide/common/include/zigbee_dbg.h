...
*
* $Revision: 3403 $
* $Date: 2014-08-26 17:57:53Z $
*
*****************************************************************************************/

#ifndef _BBPRJSTUBS_H_
#define _BBPRJSTUBS_H_

/************************* INCLUDES *****************************************************/

/* these functions are needed for the server process, but not for the non-rpc */
void TEST_DbgLogStr(const char *const message);
uint32_t TEST_DbgAssert(uint32_t errorUid, const char *fileName, uint16_t line);

/* eof bbPrjStubs.c */
#endif /* _BBPRJSTUBS_H_ */