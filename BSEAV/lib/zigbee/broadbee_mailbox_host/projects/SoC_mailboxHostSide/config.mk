...
##############################################################################
#
# FILENAME: $Workfile: trunk/projects/ml507_zrc1SingleRF4CETarget/config.mk $
#
# DESCRIPTION:
...
override LIBS += ./rf4ce_registration/libsqlite3.a -lpthread -ldl
