...
/*****************************************************************************
*
* FILENAME: projects/SoC_mailboxHostSideTest/rpc/zigbee_rf4ce_registration.h
*
* DESCRIPTION:
...
typedef struct _RF4CE_RegisterVirtualDeviceParams_t
{
    ...
    uint8_t pairRef;
    RF4CE_RegisterFieldMask_t  fieldValidMask;    /* mask bits to indicate which parameter is valid */
