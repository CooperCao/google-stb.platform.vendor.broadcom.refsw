...
CREATE_SERVER_INDICATION_API_FUNCTION(RF4CE_ZRC1_VENDORSPECIFIC_IND_FID, RF4CE_ZRC1_VendorSpecificInd, RF4CE_ZRC1_VendorSpecificIndParams_t, NoAppropriateType_t, RPC_S2C_RF4CE_ZRC1_ControlCommandInd)
...
/* DirectTV test staff */
CREATE_SERVER_REQUEST_API_FUNCTION(RF4CE_CTRL_TEST_GET_CAPS_FID, DirectTV_Test_Get_Caps_Req,                             DirectTV_Test_Get_Caps_ReqDescr_t,   DirectTV_Test_Get_Caps_ConfParams_t, RPC_C2S_DirectTV_Test_Get_Caps_Req)
CREATE_SERVER_REQUEST_API_FUNCTION(RF4CE_CTRL_TEST_SET_CHANNEL_FID, DirectTV_Test_Set_Channel_Req,                       DirectTV_Test_Set_Channel_ReqDescr_t,   DirectTV_Test_Set_Channel_ConfParams_t, RPC_C2S_DirectTV_Test_Set_Channel_Req)
CREATE_SERVER_REQUEST_API_FUNCTION(RF4CE_CTRL_TEST_CONTINUOUS_WAVE_START_FID, DirectTV_Test_Continuous_Wave_Start_Req,   DirectTV_Test_Continuous_Wave_Start_ReqDescr_t,   DirectTV_Test_Continuous_Wave_StartStop_ConfParams_t, RPC_C2S_DirectTV_Test_Continuous_Wave_Start_Req)
CREATE_SERVER_REQUEST_API_FUNCTION(RF4CE_CTRL_TEST_CONTINUOUS_WAVE_STOP_FID, DirectTV_Test_Continuous_Wave_Stop_Req,     DirectTV_Test_Continuous_Wave_Stop_ReqDescr_t,   DirectTV_Test_Continuous_Wave_StartStop_ConfParams_t, RPC_C2S_DirectTV_Test_Continuous_Wave_Stop_Req)
CREATE_SERVER_REQUEST_API_FUNCTION(RF4CE_CTRL_TEST_TRANSMIT_START_FID, DirectTV_Test_Transmit_Start_Req,                 DirectTV_Test_Transmit_Start_ReqDescr_t,   DirectTV_Test_Transmit_StartStop_ConfParams_t, RPC_C2S_DirectTV_Test_Transmit_Start_Req)
CREATE_SERVER_REQUEST_API_FUNCTION(RF4CE_CTRL_TEST_TRANSMIT_STOP_FID, DirectTV_Test_Transmit_Stop_Req,                   DirectTV_Test_Transmit_Stop_ReqDescr_t,   DirectTV_Test_Transmit_StartStop_ConfParams_t, RPC_C2S_DirectTV_Test_Transmit_Stop_Req)
CREATE_SERVER_REQUEST_API_FUNCTION(RF4CE_CTRL_TEST_RECEIVE_START_FID, DirectTV_Test_Receive_Start_Req,                   DirectTV_Test_Receive_Start_ReqDescr_t,   DirectTV_Test_Receive_StartStop_ConfParams_t, RPC_C2S_DirectTV_Test_Receive_Start_Req)
CREATE_SERVER_REQUEST_API_FUNCTION(RF4CE_CTRL_TEST_RECEIVE_STOP_FID, DirectTV_Test_Receive_Stop_Req,                     DirectTV_Test_Receive_Stop_ReqDescr_t,   DirectTV_Test_Receive_StartStop_ConfParams_t, RPC_C2S_DirectTV_Test_Receive_Stop_Req)
CREATE_SERVER_REQUEST_API_FUNCTION(RF4CE_CTRL_TEST_ECHO_START_FID, DirectTV_Test_Echo_Start_Req,                         DirectTV_Test_Echo_Start_ReqDescr_t,   DirectTV_Test_Echo_StartStop_ConfParams_t, RPC_C2S_DirectTV_Test_Echo_Start_Req)
CREATE_SERVER_REQUEST_API_FUNCTION(RF4CE_CTRL_TEST_ECHO_STOP_FID, DirectTV_Test_Echo_Stop_Req,                           DirectTV_Test_Echo_Stop_ReqDescr_t,   DirectTV_Test_Echo_StartStop_ConfParams_t, RPC_C2S_DirectTV_Test_Echo_Stop_Req)
CREATE_SERVER_REQUEST_API_FUNCTION(RF4CE_CTRL_TEST_ENERGY_DETECT_SCAN_FID, DirectTV_Test_Energy_Detect_Scan_Req,         DirectTV_Test_Energy_Detect_Scan_ReqDescr_t,   DirectTV_Test_Energy_Detect_Scan_ConfParams_t, RPC_C2S_DirectTV_Test_Energy_Detect_Scan_Req)
CREATE_SERVER_REQUEST_API_FUNCTION(RF4CE_CTRL_TEST_GET_STATS_FID, DirectTV_Test_Get_Stats_Req,                           DirectTV_Test_Get_Stats_ReqDescr_t,   DirectTV_Test_Get_Stats_ConfParams_t, RPC_C2S_DirectTV_Test_Get_Stats_Req)
CREATE_SERVER_REQUEST_API_FUNCTION(RF4CE_CTRL_TEST_RESET_STATS_FID, DirectTV_Test_Reset_Stats_Req,                       DirectTV_Test_Reset_Stats_ReqDescr_t,   DirectTV_Test_Reset_Stats_ConfParams_t, RPC_C2S_DirectTV_Test_Reset_Stats_Req)
CREATE_SERVER_REQUEST_API_FUNCTION(RF4CE_CTRL_TEST_SET_TX_POWER_FID, DirectTV_Test_Set_TX_Power_Req,                     DirectTV_Test_Set_TX_Power_ReqDescr_t,   DirectTV_Test_Set_TX_Power_ConfParams_t, RPC_C2S_DirectTV_Test_Set_TX_Power_Req)
/* End of DirectTV test staff */
...
/* DirecTV staff */
CREATE_CLIENT_REQUEST_API_FUNCTION(RF4CE_CTRL_TEST_GET_CAPS_FID, DirectTV_Test_Get_Caps_Req,                             DirectTV_Test_Get_Caps_ReqDescr_t,   DirectTV_Test_Get_Caps_ConfParams_t, RPC_C2S_DirectTV_Test_Get_Caps_Req)
CREATE_CLIENT_REQUEST_API_FUNCTION(RF4CE_CTRL_TEST_SET_CHANNEL_FID, DirectTV_Test_Set_Channel_Req,                       DirectTV_Test_Set_Channel_ReqDescr_t,   DirectTV_Test_Set_Channel_ConfParams_t, RPC_C2S_DirectTV_Test_Set_Channel_Req)
CREATE_CLIENT_REQUEST_API_FUNCTION(RF4CE_CTRL_TEST_CONTINUOUS_WAVE_START_FID, DirectTV_Test_Continuous_Wave_Start_Req,   DirectTV_Test_Continuous_Wave_Start_ReqDescr_t,   DirectTV_Test_Continuous_Wave_StartStop_ConfParams_t, RPC_C2S_DirectTV_Test_Continuous_Wave_Start_Req)
CREATE_CLIENT_REQUEST_API_FUNCTION(RF4CE_CTRL_TEST_CONTINUOUS_WAVE_STOP_FID, DirectTV_Test_Continuous_Wave_Stop_Req,     DirectTV_Test_Continuous_Wave_Stop_ReqDescr_t,   DirectTV_Test_Continuous_Wave_StartStop_ConfParams_t, RPC_C2S_DirectTV_Test_Continuous_Wave_Stop_Req)
CREATE_CLIENT_REQUEST_API_FUNCTION(RF4CE_CTRL_TEST_TRANSMIT_START_FID, DirectTV_Test_Transmit_Start_Req,                 DirectTV_Test_Transmit_Start_ReqDescr_t,   DirectTV_Test_Transmit_StartStop_ConfParams_t, RPC_C2S_DirectTV_Test_Transmit_Start_Req)
CREATE_CLIENT_REQUEST_API_FUNCTION(RF4CE_CTRL_TEST_TRANSMIT_STOP_FID, DirectTV_Test_Transmit_Stop_Req,                   DirectTV_Test_Transmit_Stop_ReqDescr_t,   DirectTV_Test_Transmit_StartStop_ConfParams_t, RPC_C2S_DirectTV_Test_Transmit_Stop_Req)
CREATE_CLIENT_REQUEST_API_FUNCTION(RF4CE_CTRL_TEST_RECEIVE_START_FID, DirectTV_Test_Receive_Start_Req,                   DirectTV_Test_Receive_Start_ReqDescr_t,   DirectTV_Test_Receive_StartStop_ConfParams_t, RPC_C2S_DirectTV_Test_Receive_Start_Req)
CREATE_CLIENT_REQUEST_API_FUNCTION(RF4CE_CTRL_TEST_RECEIVE_STOP_FID, DirectTV_Test_Receive_Stop_Req,                     DirectTV_Test_Receive_Stop_ReqDescr_t,   DirectTV_Test_Receive_StartStop_ConfParams_t, RPC_C2S_DirectTV_Test_Receive_Stop_Req)
CREATE_CLIENT_REQUEST_API_FUNCTION(RF4CE_CTRL_TEST_ECHO_START_FID, DirectTV_Test_Echo_Start_Req,                         DirectTV_Test_Echo_Start_ReqDescr_t,   DirectTV_Test_Echo_StartStop_ConfParams_t, RPC_C2S_DirectTV_Test_Echo_Start_Req)
CREATE_CLIENT_REQUEST_API_FUNCTION(RF4CE_CTRL_TEST_ECHO_STOP_FID, DirectTV_Test_Echo_Stop_Req,                           DirectTV_Test_Echo_Stop_ReqDescr_t,   DirectTV_Test_Echo_StartStop_ConfParams_t, RPC_C2S_DirectTV_Test_Echo_Stop_Req)
CREATE_CLIENT_REQUEST_API_FUNCTION(RF4CE_CTRL_TEST_ENERGY_DETECT_SCAN_FID, DirectTV_Test_Energy_Detect_Scan_Req,         DirectTV_Test_Energy_Detect_Scan_ReqDescr_t,   DirectTV_Test_Energy_Detect_Scan_ConfParams_t, RPC_C2S_DirectTV_Test_Energy_Detect_Scan_Req)
CREATE_CLIENT_REQUEST_API_FUNCTION(RF4CE_CTRL_TEST_GET_STATS_FID, DirectTV_Test_Get_Stats_Req,                           DirectTV_Test_Get_Stats_ReqDescr_t,   DirectTV_Test_Get_Stats_ConfParams_t, RPC_C2S_DirectTV_Test_Get_Stats_Req)
CREATE_CLIENT_REQUEST_API_FUNCTION(RF4CE_CTRL_TEST_RESET_STATS_FID, DirectTV_Test_Reset_Stats_Req,                       DirectTV_Test_Reset_Stats_ReqDescr_t,   DirectTV_Test_Reset_Stats_ConfParams_t, RPC_C2S_DirectTV_Test_Reset_Stats_Req)
CREATE_CLIENT_REQUEST_API_FUNCTION(RF4CE_CTRL_TEST_SET_TX_POWER_FID, DirectTV_Test_Set_TX_Power_Req,                     DirectTV_Test_Set_TX_Power_ReqDescr_t,   DirectTV_Test_Set_TX_Power_ConfParams_t, RPC_C2S_DirectTV_Test_Set_TX_Power_Req)
...
void server_RF4CE_UnpairReq_callback(RF4CE_UnpairReqDescr_t  *request, RF4CE_UnpairConfParams_t *conf)
{
    ...
    free(info);
    size += 1;
    memcpy((char *)&message_tx[size], (char*)info->clientRequestData, sizeof(List_ServerReq_Info_t));
    size += WORDALIGN(sizeof(List_ServerReq_Info_t));
    message_tx[size] = (unsigned int)conf;
    size += 1;
