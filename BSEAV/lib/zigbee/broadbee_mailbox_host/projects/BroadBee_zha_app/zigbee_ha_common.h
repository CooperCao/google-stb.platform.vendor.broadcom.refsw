...
typedef unsigned long BroadBee_ZHA_Status;

#define BROADBEE_ZHA_STATUS_SUCCESS 0x00000000
...
#define ZBPRO_ZHA_MODULE_ID         0xC0000000
...
static BroadBee_ZHA_Status BroadBee_ZHA_Set_Attribute_macTransactionPersistenceTime(MAC_TransactionPersistenceTime_t attrValue);
static BroadBee_ZHA_Status BroadBee_ZHA_Set_Attribute_macExtendedAddress(MAC_ExtendedAddress_t attrValue);
static BroadBee_ZHA_Status BroadBee_ZHA_Set_Attribute_nwkDeviceType(ZBPRO_NWK_NIB_DeviceType_t attrValue);
static BroadBee_ZHA_Status BroadBee_ZHA_Set_Attribute_apsTrustCenterAddress(ZBPRO_APS_ExtAddr_t attrValue);
static BroadBee_ZHA_Status BroadBee_ZHA_Set_Attribute_zdoInitialSecurityStatus(ZBPRO_APS_SecurityInitialStatus_t attrValue);
static BroadBee_ZHA_Status BroadBee_ZHA_Set_Attribute_nwkActiveKeySeqNumber(ZBPRO_NWK_NIB_ActiveKeySeqNumber_t attrValue);
static BroadBee_ZHA_Status BroadBee_ZHA_Set_Attribute_zdoPermitJoinDuration(ZBPRO_NWK_PermitJoinDuration_t attrValue);
...
static BroadBee_ZHA_Status BroadBee_ZHA_GetActiveEp(ZBPRO_APS_ShortAddr_t dstShortAddr,
                                                    ZBPRO_ZDO_NwkAddr_t nwkAddrOfInterest,
                                                    uint8_t *activeEpCount,
                                                    ZBPRO_APS_EndpointId_t **activeEpList,
                                                    SYS_Time_t timeout);
static BroadBee_ZHA_Status BroadBee_ZHA_GetSimpleDesc(ZBPRO_APS_ShortAddr_t dstShortAddr,
                                                      ZBPRO_ZDO_NwkAddr_t nwkAddrOfInterest,
                                                      ZBPRO_ZDO_Endpoint_t endpoint, uint8_t *length,
                                                      ZBPRO_APS_SimpleDescriptor_t *simpleDesc,
                                                      SYS_Time_t timeout);
static BroadBee_ZHA_Status BroadBee_ZHA_GetNodeDesc(ZBPRO_APS_ShortAddr_t dstShortAddr,
                                                    ZBPRO_ZDO_NwkAddr_t nwkAddrOfInterest,
                                                    ZbProZdoNodeDescriptor_t *nodeDesc,
                                                    SYS_Time_t timeout);
static BroadBee_ZHA_Status BroadBee_ZHA_EndpointRegister(ZBPRO_APS_SimpleDescriptor_t *simpleDescr);
static BroadBee_ZHA_Status BroadBee_ZHA_ConfigureReporting_Indirect(ZBPRO_APS_EndpointId_t srcEndpoint,
                                                                    ...
                                                                    SYS_Time_t timeout);
static BroadBee_ZHA_Status BroadBee_ZHA_Write_Attributes_Indirect(ZBPRO_APS_EndpointId_t srcEndpoint,
                                                                  ZBPRO_APS_EndpointId_t dstEndpoint,
                                                                  ZBPRO_ZCL_ClusterId_t  clusterId,
                                                                  ZBPRO_ZCL_AttributeId_t attributeID,
                                                                  ZBPRO_ZCL_AttrDataType_t attributeDataType,
...
/*
 *  BroadBee_ZHA_Status - return value. If everything is succesful, just return BROADBEE_ZHA_STATUS_SUCCESS.
...
static BroadBee_ZHA_Status BroadBee_ZHA_Set_Attribute_##ATTR_NAME(ATTR_TYPE attrValue)            \
{                                                                                           \
...
static bool BroadBee_ZHA_Check_NWK_Existing()
{
    ZBPRO_APS_Status_t status = (ZBPRO_APS_Status_t)0xff;
...
static BroadBee_ZHA_Status BroadBee_ZHA_Set_NWK_Key(ZbProSspKey_t *key,
                                  ZbProSspNwkKeySeqNum_t keyCounter)
{
    ...
    while(status == 0xff);
    free(reqDescr);
    return status ? (BroadBee_ZHA_Status)(ZBPRO_NWK_MODULE_ID | status) : BROADBEE_ZHA_STATUS_SUCCESS;
}

//(ZBPRO_NWK_PermitJoiningReq, ZBPRO_NWK_PermitJoiningReqDescr_t;)

static BroadBee_ZHA_Status BroadBee_ZHA_PermitJoining(ZBPRO_NWK_PermitJoinDuration_t time)
{
    ZBPRO_NWK_Status_t status = (ZBPRO_NWK_Status_t)0xff;
...
static BroadBee_ZHA_Status BroadBee_ZHA_GetNwkAddr(ZBPRO_ZDO_ExtAddr_t dstIeeeAddr, ZBPRO_ZDO_NwkAddr_t *nwkAddrOfInterest)
{
    ZBPRO_ZDO_Status_t status = (ZBPRO_ZDO_Status_t)0xff;
...
static BroadBee_ZHA_Status BroadBee_ZHA_GetActiveEp(ZBPRO_APS_ShortAddr_t dstShortAddr, ZBPRO_ZDO_NwkAddr_t nwkAddrOfInterest,
                            uint8_t *activeEpCount, ZBPRO_APS_EndpointId_t **activeEpList, SYS_Time_t timeout)
{
    ZBPRO_ZDO_Status_t status = (ZBPRO_ZDO_Status_t)0xff;
...
static BroadBee_ZHA_Status BroadBee_ZHA_GetSimpleDesc(ZBPRO_APS_ShortAddr_t dstShortAddr, ZBPRO_ZDO_NwkAddr_t nwkAddrOfInterest,
            ZBPRO_ZDO_Endpoint_t endpoint, uint8_t *length, ZBPRO_APS_SimpleDescriptor_t *simpleDesc, SYS_Time_t timeout)
{
    ZBPRO_ZDO_Status_t status = (ZBPRO_ZDO_Status_t)0xff;
...
static BroadBee_ZHA_Status BroadBee_ZHA_GetNodeDesc(ZBPRO_APS_ShortAddr_t dstShortAddr, ZBPRO_ZDO_NwkAddr_t nwkAddrOfInterest,
                                                    ZbProZdoNodeDescriptor_t *nodeDesc, SYS_Time_t timeout)
{
    ZBPRO_ZDO_Status_t status = (ZBPRO_ZDO_Status_t)0xff;
...
static BroadBee_ZHA_Status BroadBee_ZHA_Bind(ZBPRO_APS_ExtAddr_t srcExtAddr, ZBPRO_APS_ExtAddr_t dstExtAddr, ZBPRO_APS_ClusterId_t clusterId, ZBPRO_APS_EndpointId_t srcEndpoint, ZBPRO_APS_EndpointId_t dstEndpoint)
{
    ZBPRO_ZDO_Status_t status = (ZBPRO_ZDO_Status_t)0xff;
...
static BroadBee_ZHA_Status BroadBee_ZHA_OnOffCmdOn_Indirect(Bool8_t on, ZBPRO_APS_EndpointId_t srcEndpoint, ZBPRO_APS_EndpointId_t dstEndpoint, SYS_Time_t timeout)
{
    ZBPRO_ZDO_Status_t status = (ZBPRO_ZDO_Status_t)0xff;
...
static BroadBee_ZHA_Status BroadBee_ZHA_OnOffCmdOn_Direct(Bool8_t on, ZBPRO_APS_EndpointId_t srcEndpoint, ZBPRO_APS_EndpointId_t dstEndpoint, ZBPRO_APS_ExtAddr_t dstExtAddr, SYS_Time_t timeout)
{
    ZBPRO_ZDO_Status_t status = (ZBPRO_ZDO_Status_t)0xff;
...
static BroadBee_ZHA_Status BroadBee_ZHA_ConfigureReporting_Direct(ZBPRO_APS_EndpointId_t srcEndpoint,
                                                              ZBPRO_APS_EndpointId_t dstEndpoint,
...
static BroadBee_ZHA_Status BroadBee_ZHA_DoorLockCmdLockUnlock_Indirect(Bool8_t lock, ZBPRO_APS_EndpointId_t srcEndpoint,
                                ZBPRO_APS_EndpointId_t dstEndpoint, SYS_Time_t timeout)
{
    ZBPRO_ZDO_Status_t status = (ZBPRO_ZDO_Status_t)0xff;
...
static BroadBee_ZHA_Status BroadBee_ZHA_DoorLockCmdLockUnlock_Direct(Bool8_t lock, ZBPRO_APS_EndpointId_t srcEndpoint,
                                ZBPRO_APS_EndpointId_t dstEndpoint, ZBPRO_APS_ExtAddr_t dstExtAddr, SYS_Time_t timeout)
{
    ZBPRO_ZDO_Status_t status = (ZBPRO_ZDO_Status_t)0xff;
...
static BroadBee_ZHA_Status BroadBee_ZHA_DoorLockCmdLockUnlock_DirectByNwkAddr(Bool8_t lock, ZBPRO_APS_EndpointId_t srcEndpoint,
                                ZBPRO_APS_EndpointId_t dstEndpoint, ZBPRO_APS_ShortAddr_t dstNwkAddr, SYS_Time_t timeout)
{
...
static BroadBee_ZHA_Status BroadBee_ZHA_Write_Attributes_Direct(ZBPRO_APS_EndpointId_t srcEndpoint,
                                                            ZBPRO_APS_EndpointId_t dstEndpoint,
                                                            ZBPRO_APS_ExtAddr_t dstExtAddr,
                                                            ZBPRO_ZCL_ClusterId_t  clusterId,
                                                            ZBPRO_ZCL_AttributeId_t attributeID,
...
static BroadBee_ZHA_Status BroadBee_ZHA_Read_Attributes_Indirect(ZBPRO_APS_EndpointId_t srcEndpoint,
                                                            ZBPRO_APS_EndpointId_t dstEndpoint,
                                                            ZBPRO_ZCL_ClusterId_t  clusterId,
                                                            ZBPRO_ZCL_AttributeId_t attributeID,
                                                            int      *attributeSize,
...
static BroadBee_ZHA_Status BroadBee_ZHA_Read_Attributes_Direct(ZBPRO_APS_EndpointId_t srcEndpoint,
                                                            ZBPRO_APS_EndpointId_t dstEndpoint,
                                                            ZBPRO_APS_ExtAddr_t dstExtAddr,
                                                            ZBPRO_ZCL_ClusterId_t  clusterId,
                                                            ZBPRO_ZCL_AttributeId_t attributeID,
...
static BroadBee_ZHA_Status BroadBee_ZHA_Read_Attributes_DirectByNwk(ZBPRO_APS_EndpointId_t srcEndpoint,
                                                            ZBPRO_APS_EndpointId_t dstEndpoint,
...
static BroadBee_ZHA_Status BroadBee_ZHA_Cie_Enroll_Start(ZBPRO_APS_ShortAddr_t dstShortAddr,
...
static BroadBee_ZHA_Status BroadBee_ZHA_OnOffCmdOn_Indirect(ZBPRO_APS_EndpointId_t srcEndpoint, ZBPRO_APS_EndpointId_t dstEndpoint)
{
    ZBPRO_ZDO_Status_t status = (ZBPRO_ZDO_Status_t)0xff;
    void zigbee_HA_OnOffCmdOn_Indirect_Callback(ZBPRO_ZCL_OnOffCmdReqDescr_t *const reqDescr,
...
static BroadBee_ZHA_Status BroadBee_ZHA_OnOffCmdOn(ZBPRO_APS_ExtAddr_t srcExtAddr, ZBPRO_APS_ExtAddr_t dstExtAddr,
                ZBPRO_APS_ClusterId_t clusterId, ZBPRO_APS_EndpointId_t srcEndpoint, ZBPRO_APS_EndpointId_t dstEndpoint)
{
    ZBPRO_ZDO_Status_t status = (ZBPRO_ZDO_Status_t)0xff;
...
static void Sys_DbgPrint(const char *format, ...)
{
    ...
    vsnprintf(message, SYS_DBG_PRINT_BUFFER_SIZE, format, args);
    va_end(args);
