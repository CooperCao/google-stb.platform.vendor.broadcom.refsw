...
int main(int argc, char *argv[])
{
    ...
    ZBPRO_APS_ExtAddr_t myExtAddr = 0xeeffaabb12345678UL;
    ...
    zbPro_HA_Init_OnOff_Switch_SimpleDescriptor(1, &localSimpleDescr);
    ...
    //                                                          )
    BroadBee_ZHA_ConfigureReporting_Indirect(1, 0x0a, ZBPRO_ZCL_CLUSTER_ID_RELATIVE_HUMIDITY_MEASUREMENT/*ZBPRO_ZCL_CLUSTER_ID_TEMPERATURE_MEASUREMENT*/,
                                          0, ZBPRO_ZCL_ATTR_DATA_TYPE_SINT_16BIT, 1, 3);
