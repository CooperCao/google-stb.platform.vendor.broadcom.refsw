...
static void My_BroadBee_ZHA_Read_Attributes_Direct_Async_Callback(ZBPRO_ZCL_ProfileWideCmdReadAttrReqDescr_t *const reqDescr,
...
static BroadBee_ZHA_Status BroadBee_ZHA_Read_Attributes_Direct_Async(ZBPRO_APS_EndpointId_t srcEndpoint,
                                                            ...
                                                            )
{
    ...
    return BROADBEE_ZHA_STATUS_SUCCESS;
}
...
int main(int argc, char *argv[])
{
    ...
    BroadBee_ZHA_PermitJoining(0x0);
    Sys_DbgPrint("Got a new joined device, wait for about 5 seconds for normal operation\n");
    sleep(5);
#endif

    BroadBee_ZHA_Set_Attribute_zdoZdpResponseTimeout(5000);
    if(BroadBee_ZHA_GetNwkAddr(remoteDeviceExtAddr, &remoteDeviceNwkAddr) != BROADBEE_ZHA_STATUS_SUCCESS)
        goto  _exit;
    ...
    //if(BROADBEE_ZHA_STATUS_SUCCESS != (retStatus = BroadBee_ZHA_Bind(myExtAddr, remoteDeviceExtAddr, ZBPRO_ZCL_CLUSTER_ID_RELATIVE_HUMIDITY_MEASUREMENT/*ZBPRO_ZCL_CLUSTER_ID_TEMPERATURE_MEASUREMENT*/, 1, 0x0a)))
    ...
    //BroadBee_ZHA_ConfigureReporting_Direct(0x0B, 0x0A, remoteDeviceExtAddr,ZBPRO_ZCL_CLUSTER_ID_RELATIVE_HUMIDITY_MEASUREMENT,
    //                                      0, ZBPRO_ZCL_ATTR_DATA_TYPE_UINT_16BIT, 2, (uint8_t*)&valueChanged, 1, 3, 5000);

    //BroadBee_ZHA_ConfigureReporting_Direct(0x0B, 0x0A, remoteDeviceExtAddr, ZBPRO_ZCL_CLUSTER_ID_TEMPERATURE_MEASUREMENT,
    ...
    while(1){
        ...
        int attributeSize;
        uint8_t *attribute;
        //BroadBee_ZHA_Read_Attributes_Direct(0x0B, 0x0a, remoteDeviceExtAddr, ZBPRO_ZCL_CLUSTER_ID_RELATIVE_HUMIDITY_MEASUREMENT, 0, &attributeSize, &attribute, 5000);
        //BroadBee_ZHA_Read_Attributes_Direct_Async(0x0B, 0x0a, remoteDeviceExtAddr, ZBPRO_ZCL_CLUSTER_ID_RELATIVE_HUMIDITY_MEASUREMENT, 0, 3);  // 3s timeout
        getchar();
        printf("BroadBee_ZHA_Read_Attributes_Direct_Async\n");
        BroadBee_ZHA_Read_Attributes_Direct_Async(0x0B, 0x0a, remoteDeviceExtAddr, ZBPRO_ZCL_CLUSTER_ID_TEMPERATURE_MEASUREMENT, 0, 3);  // 3s timeout
...
/* eof zigbee_ha_set_attribute_report.c */