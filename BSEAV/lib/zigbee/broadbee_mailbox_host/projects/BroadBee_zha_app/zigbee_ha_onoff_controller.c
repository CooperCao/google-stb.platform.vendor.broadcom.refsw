...
int main(int argc, char *argv[])
{
    ...
    if(BROADBEE_ZHA_STATUS_SUCCESS != (retStatus = BroadBee_ZHA_Bind(myExtAddr, remoteDeviceExtAddr, ZBPRO_ZCL_CLUSTER_ID_ONOFF, 1, 1)))
...
/* eof zigbee_ha_onoff_controller.c */