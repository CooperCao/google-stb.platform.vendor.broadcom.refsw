...
extern VCOS_STATUS_T khronos_platform_semaphore_create(PLATFORM_SEMAPHORE_T *sem, uint32_t *name, int count);
...
extern VCOS_STATUS_T khronos_platform_semaphore_acquire_timeout(PLATFORM_SEMAPHORE_T *sem, int timeout);
