...
static bool initialise_group_desc()
{
   ...
   SetCounterNames(&s_driver_counter_group_desc, KHRN_PERF_HARD_CLEARS, "khrn_hard_clears", "clears");
   SetCounterNames(&s_driver_counter_group_desc, KHRN_PERF_SOFT_CLEARS, "khrn_soft_clears", "clears");
   SetCounterNames(&s_driver_counter_group_desc, KHRN_PERF_TB_GRP_COLOR_LOADS, "khrn_tb_grp_color_loads", "loads");
   SetCounterNames(&s_driver_counter_group_desc, KHRN_PERF_TB_GRP_MS_COLOR_LOADS, "khrn_tb_grp_ms_color_loads", "loads");
   SetCounterNames(&s_driver_counter_group_desc, KHRN_PERF_TB_GRP_DS_LOADS, "khrn_tb_grp_ds_loads", "loads");
   SetCounterNames(&s_driver_counter_group_desc, KHRN_PERF_TB_GRP_COLOR_STORES, "khrn_tb_grp_color_stores", "stores");
   SetCounterNames(&s_driver_counter_group_desc, KHRN_PERF_TB_GRP_MS_COLOR_STORES, "khrn_tb_grp_ms_color_stores", "stores");
   SetCounterNames(&s_driver_counter_group_desc, KHRN_PERF_TB_GRP_DS_STORES, "khrn_tb_grp_ds_stores", "stores");
   SetCounterNames(&s_driver_counter_group_desc, KHRN_PERF_TB_COLOR_LOADS, "khrn_tb_color_loads", "loads");
   SetCounterNames(&s_driver_counter_group_desc, KHRN_PERF_TB_MS_COLOR_LOADS, "khrn_tb_ms_color_loads", "loads");
   SetCounterNames(&s_driver_counter_group_desc, KHRN_PERF_TB_DS_LOADS, "khrn_tb_ds_loads", "loads");
   SetCounterNames(&s_driver_counter_group_desc, KHRN_PERF_TB_COLOR_STORES, "khrn_tb_color_stores", "stores");
   SetCounterNames(&s_driver_counter_group_desc, KHRN_PERF_TB_MS_COLOR_STORES, "khrn_tb_ms_color_stores", "stores");
   SetCounterNames(&s_driver_counter_group_desc, KHRN_PERF_TB_DS_STORES, "khrn_tb_ds_stores", "stores");
   SetCounterNames(&s_driver_counter_group_desc, KHRN_PERF_TEX_SUBMISSIONS, "khrn_tex_submissions", "submissions");
   SetCounterNames(&s_driver_counter_group_desc, KHRN_PERF_TEX_FAST_PATHS, "khrn_tex_fast_paths", "paths");
   SetCounterNames(&s_driver_counter_group_desc, KHRN_PERF_MIPMAP_GENS, "khrn_mipmap_gens", "gens");
   SetCounterNames(&s_driver_counter_group_desc, KHRN_PERF_MIPMAP_GENS_FAST, "khrn_mipmap_gens_fast", "gens");
   SetCounterNames(&s_driver_counter_group_desc, KHRN_PERF_DRAW_CALLS, "khrn_draw_calls", "calls");
   SetCounterNames(&s_driver_counter_group_desc, KHRN_PERF_NUM_SWAPS, "khrn_num_swaps", "swaps");
