...
FILE DESCRIPTION
VG backend interface. Implementation is mostly platform-specific.
=============================================================================*/
...
extern bool vg_be_install_framebuffer(void);
...
/*
   Mark the renderstate for frame_handle as having a fence sync
*/
extern void vg_be_fence_sync_used(MEM_HANDLE_T frame_handle);
