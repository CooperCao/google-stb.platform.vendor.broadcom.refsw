...
extern void glxx_texture_paletted_sub_image(GLXX_TEXTURE_T *texture, GLenum target, uint32_t levels, uint32_t width, uint32_t height, const uint32_t *palette, uint32_t palsize, const void *data, int data_length);
