...
extern GLXX_BUFFER_T * glxx_get_bound_buffer(GLXX_SERVER_STATE_T *state, GLenum target);
...
extern int glxx_get_float_or_fixed(GLXX_SERVER_STATE_T *state, GLenum pname, float *params);
