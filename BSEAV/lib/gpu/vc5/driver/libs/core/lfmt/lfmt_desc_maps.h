...
#include "libs/util/desc_map/desc_map.h"

/* BEGIN AUTO-GENERATED CODE (desc_map_decls) */
extern const struct desc_map gfx_lfmt_dims_desc_map;
extern const struct desc_map gfx_lfmt_swizzling_desc_map;
extern const struct desc_map gfx_lfmt_yflip_desc_map;
