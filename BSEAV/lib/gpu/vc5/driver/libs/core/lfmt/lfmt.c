...
bool gfx_lfmt_is_bigend_sand_family(GFX_LFMT_T lfmt)
{
   switch (lfmt & GFX_LFMT_SWIZZLING_MASK) {
   case GFX_LFMT_SWIZZLING_RSO:
   case GFX_LFMT_SWIZZLING_LT:
...
uint32_t gfx_lfmt_present_channels(GFX_LFMT_T lfmt)
{
   ...
   case GFX_LFMT_CHANNELS_VUYY:
      return GFX_LFMT_CHAN_U_BIT | GFX_LFMT_CHAN_V_BIT | GFX_LFMT_CHAN_Y_BIT;
   default:
      unreachable();
      return 0;
   }
...
GFX_LFMT_T gfx_lfmt_alpha_to_x(GFX_LFMT_T lfmt)
{
   if (!gfx_lfmt_has_alpha(lfmt))
      return lfmt;
   switch (lfmt & GFX_LFMT_CHANNELS_MASK) {
   ...
   case GFX_LFMT_CHANNELS_RA:
      switch (lfmt & GFX_LFMT_TYPE_MASK) {
      case GFX_LFMT_TYPE_UFLOAT:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_RX | GFX_LFMT_TYPE_UFLOAT;
      case GFX_LFMT_TYPE_FLOAT:
      case GFX_LFMT_TYPE_FLOAT_UINT:
      case GFX_LFMT_TYPE_FLOAT_UNORM:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_RX | GFX_LFMT_TYPE_FLOAT;
      case GFX_LFMT_TYPE_UINT:
      case GFX_LFMT_TYPE_UINT_FLOAT:
      case GFX_LFMT_TYPE_UINT_UNORM:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_RX | GFX_LFMT_TYPE_UINT;
      case GFX_LFMT_TYPE_INT:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_RX | GFX_LFMT_TYPE_INT;
      case GFX_LFMT_TYPE_UNORM:
      case GFX_LFMT_TYPE_UNORM_FLOAT:
      case GFX_LFMT_TYPE_UNORM_UINT:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_RX | GFX_LFMT_TYPE_UNORM;
      case GFX_LFMT_TYPE_SNORM:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_RX | GFX_LFMT_TYPE_SNORM;
      default:
         unreachable();
         return GFX_LFMT_NONE;
      }
   ...
   case GFX_LFMT_CHANNELS_AR:
      switch (lfmt & GFX_LFMT_TYPE_MASK) {
      case GFX_LFMT_TYPE_UFLOAT:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_XR | GFX_LFMT_TYPE_UFLOAT;
      case GFX_LFMT_TYPE_FLOAT:
      case GFX_LFMT_TYPE_UINT_FLOAT:
      case GFX_LFMT_TYPE_UNORM_FLOAT:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_XR | GFX_LFMT_TYPE_FLOAT;
      case GFX_LFMT_TYPE_UINT:
      case GFX_LFMT_TYPE_FLOAT_UINT:
      case GFX_LFMT_TYPE_UNORM_UINT:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_XR | GFX_LFMT_TYPE_UINT;
      case GFX_LFMT_TYPE_INT:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_XR | GFX_LFMT_TYPE_INT;
      case GFX_LFMT_TYPE_UNORM:
      case GFX_LFMT_TYPE_FLOAT_UNORM:
      case GFX_LFMT_TYPE_UINT_UNORM:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_XR | GFX_LFMT_TYPE_UNORM;
      case GFX_LFMT_TYPE_SNORM:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_XR | GFX_LFMT_TYPE_SNORM;
      default:
         unreachable();
         return GFX_LFMT_NONE;
      }
   ...
   case GFX_LFMT_CHANNELS_RGBA:
      switch (lfmt & GFX_LFMT_TYPE_MASK) {
      case GFX_LFMT_TYPE_UFLOAT:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_RGBX | GFX_LFMT_TYPE_UFLOAT;
      case GFX_LFMT_TYPE_FLOAT:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_RGBX | GFX_LFMT_TYPE_FLOAT;
      case GFX_LFMT_TYPE_UINT:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_RGBX | GFX_LFMT_TYPE_UINT;
      case GFX_LFMT_TYPE_INT:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_RGBX | GFX_LFMT_TYPE_INT;
      case GFX_LFMT_TYPE_UNORM:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_RGBX | GFX_LFMT_TYPE_UNORM;
      case GFX_LFMT_TYPE_SNORM:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_RGBX | GFX_LFMT_TYPE_SNORM;
      case GFX_LFMT_TYPE_SRGB_SRGB_SRGB_UNORM:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_RGBX | GFX_LFMT_TYPE_SRGB;
      default:
         unreachable();
         return GFX_LFMT_NONE;
      }
   ...
   case GFX_LFMT_CHANNELS_BGRA:
      switch (lfmt & GFX_LFMT_TYPE_MASK) {
      case GFX_LFMT_TYPE_UFLOAT:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_BGRX | GFX_LFMT_TYPE_UFLOAT;
      case GFX_LFMT_TYPE_FLOAT:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_BGRX | GFX_LFMT_TYPE_FLOAT;
      case GFX_LFMT_TYPE_UINT:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_BGRX | GFX_LFMT_TYPE_UINT;
      case GFX_LFMT_TYPE_INT:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_BGRX | GFX_LFMT_TYPE_INT;
      case GFX_LFMT_TYPE_UNORM:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_BGRX | GFX_LFMT_TYPE_UNORM;
      case GFX_LFMT_TYPE_SNORM:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_BGRX | GFX_LFMT_TYPE_SNORM;
      case GFX_LFMT_TYPE_SRGB_SRGB_SRGB_UNORM:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_BGRX | GFX_LFMT_TYPE_SRGB;
      default:
         unreachable();
         return GFX_LFMT_NONE;
      }
   ...
   case GFX_LFMT_CHANNELS_ARGB:
      switch (lfmt & GFX_LFMT_TYPE_MASK) {
      case GFX_LFMT_TYPE_UFLOAT:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_XRGB | GFX_LFMT_TYPE_UFLOAT;
      case GFX_LFMT_TYPE_FLOAT:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_XRGB | GFX_LFMT_TYPE_FLOAT;
      case GFX_LFMT_TYPE_UINT:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_XRGB | GFX_LFMT_TYPE_UINT;
      case GFX_LFMT_TYPE_INT:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_XRGB | GFX_LFMT_TYPE_INT;
      case GFX_LFMT_TYPE_UNORM:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_XRGB | GFX_LFMT_TYPE_UNORM;
      case GFX_LFMT_TYPE_SNORM:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_XRGB | GFX_LFMT_TYPE_SNORM;
      case GFX_LFMT_TYPE_UNORM_SRGB_SRGB_SRGB:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_XRGB | GFX_LFMT_TYPE_SRGB;
      default:
         unreachable();
         return GFX_LFMT_NONE;
      }
   ...
   case GFX_LFMT_CHANNELS_ABGR:
      switch (lfmt & GFX_LFMT_TYPE_MASK) {
      case GFX_LFMT_TYPE_UFLOAT:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_XBGR | GFX_LFMT_TYPE_UFLOAT;
      case GFX_LFMT_TYPE_FLOAT:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_XBGR | GFX_LFMT_TYPE_FLOAT;
      case GFX_LFMT_TYPE_UINT:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_XBGR | GFX_LFMT_TYPE_UINT;
      case GFX_LFMT_TYPE_INT:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_XBGR | GFX_LFMT_TYPE_INT;
      case GFX_LFMT_TYPE_UNORM:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_XBGR | GFX_LFMT_TYPE_UNORM;
      case GFX_LFMT_TYPE_SNORM:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_XBGR | GFX_LFMT_TYPE_SNORM;
      case GFX_LFMT_TYPE_UNORM_SRGB_SRGB_SRGB:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_XBGR | GFX_LFMT_TYPE_SRGB;
      default:
         unreachable();
         return GFX_LFMT_NONE;
      }
   ...
   case GFX_LFMT_CHANNELS_RAXX:
      switch (lfmt & GFX_LFMT_TYPE_MASK) {
      case GFX_LFMT_TYPE_UFLOAT:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_RXXX | GFX_LFMT_TYPE_UFLOAT;
      case GFX_LFMT_TYPE_FLOAT:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_RXXX | GFX_LFMT_TYPE_FLOAT;
      case GFX_LFMT_TYPE_UINT:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_RXXX | GFX_LFMT_TYPE_UINT;
      case GFX_LFMT_TYPE_INT:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_RXXX | GFX_LFMT_TYPE_INT;
      case GFX_LFMT_TYPE_UNORM:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_RXXX | GFX_LFMT_TYPE_UNORM;
      case GFX_LFMT_TYPE_SNORM:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_RXXX | GFX_LFMT_TYPE_SNORM;
      default:
         unreachable();
         return GFX_LFMT_NONE;
      }
   ...
   case GFX_LFMT_CHANNELS_XXAR:
      switch (lfmt & GFX_LFMT_TYPE_MASK) {
      case GFX_LFMT_TYPE_UFLOAT:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_XXXR | GFX_LFMT_TYPE_UFLOAT;
      case GFX_LFMT_TYPE_FLOAT:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_XXXR | GFX_LFMT_TYPE_FLOAT;
      case GFX_LFMT_TYPE_UINT:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_XXXR | GFX_LFMT_TYPE_UINT;
      case GFX_LFMT_TYPE_INT:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_XXXR | GFX_LFMT_TYPE_INT;
      case GFX_LFMT_TYPE_UNORM:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_XXXR | GFX_LFMT_TYPE_UNORM;
      case GFX_LFMT_TYPE_SNORM:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_XXXR | GFX_LFMT_TYPE_SNORM;
      default:
         unreachable();
         return GFX_LFMT_NONE;
      }
   ...
   case GFX_LFMT_CHANNELS_LA:
      switch (lfmt & GFX_LFMT_TYPE_MASK) {
      case GFX_LFMT_TYPE_UFLOAT:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_LX | GFX_LFMT_TYPE_UFLOAT;
      case GFX_LFMT_TYPE_FLOAT:
      case GFX_LFMT_TYPE_FLOAT_UINT:
      case GFX_LFMT_TYPE_FLOAT_UNORM:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_LX | GFX_LFMT_TYPE_FLOAT;
      case GFX_LFMT_TYPE_UINT:
      case GFX_LFMT_TYPE_UINT_FLOAT:
      case GFX_LFMT_TYPE_UINT_UNORM:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_LX | GFX_LFMT_TYPE_UINT;
      case GFX_LFMT_TYPE_INT:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_LX | GFX_LFMT_TYPE_INT;
      case GFX_LFMT_TYPE_UNORM:
      case GFX_LFMT_TYPE_UNORM_FLOAT:
      case GFX_LFMT_TYPE_UNORM_UINT:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_LX | GFX_LFMT_TYPE_UNORM;
      case GFX_LFMT_TYPE_SNORM:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_LX | GFX_LFMT_TYPE_SNORM;
      default:
         unreachable();
         return GFX_LFMT_NONE;
      }
   ...
   case GFX_LFMT_CHANNELS_AL:
      switch (lfmt & GFX_LFMT_TYPE_MASK) {
      case GFX_LFMT_TYPE_UFLOAT:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_XL | GFX_LFMT_TYPE_UFLOAT;
      case GFX_LFMT_TYPE_FLOAT:
      case GFX_LFMT_TYPE_UINT_FLOAT:
      case GFX_LFMT_TYPE_UNORM_FLOAT:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_XL | GFX_LFMT_TYPE_FLOAT;
      case GFX_LFMT_TYPE_UINT:
      case GFX_LFMT_TYPE_FLOAT_UINT:
      case GFX_LFMT_TYPE_UNORM_UINT:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_XL | GFX_LFMT_TYPE_UINT;
      case GFX_LFMT_TYPE_INT:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_XL | GFX_LFMT_TYPE_INT;
      case GFX_LFMT_TYPE_UNORM:
      case GFX_LFMT_TYPE_FLOAT_UNORM:
      case GFX_LFMT_TYPE_UINT_UNORM:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_XL | GFX_LFMT_TYPE_UNORM;
      case GFX_LFMT_TYPE_SNORM:
         return (lfmt & ~(GFX_LFMT_CHANNELS_MASK | GFX_LFMT_TYPE_MASK)) | GFX_LFMT_CHANNELS_XL | GFX_LFMT_TYPE_SNORM;
      default:
         unreachable();
         return GFX_LFMT_NONE;
      }
