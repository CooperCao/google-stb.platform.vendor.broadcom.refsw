...
#define V3D_MAX_TEXTURE_WIDTH (1 << V3D_MAX_TEXTURE_DIM_BITS)
#define V3D_MAX_TEXTURE_HEIGHT (1 << V3D_MAX_TEXTURE_DIM_BITS)
#define V3D_MAX_TEXTURE_DEPTH (1 << V3D_MAX_TEXTURE_DIM_BITS)
