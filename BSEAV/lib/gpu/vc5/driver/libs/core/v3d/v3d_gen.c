...
{
   switch (threading) {
   case V3D_THREADING_1: return "1";
   case V3D_THREADING_2: return "2";
   case V3D_THREADING_4: return "4";
   default:              return NULL;
   }
}
...
#endif
#if !V3D_VER_AT_LEAST(4,1,34,0)
v3d_threading_t v3d_translate_threading(uint32_t x)
{
   switch (x) {
   case 1:  return V3D_THREADING_1;
   case 2:  return V3D_THREADING_2;
   case 4:  return V3D_THREADING_4;
   default: unreachable(); return V3D_THREADING_INVALID;
   }
}
uint32_t v3d_translate_from_threading(v3d_threading_t x)
{
   switch (x) {
   case V3D_THREADING_1: return 1;
   case V3D_THREADING_2: return 2;
...
#endif
bool v3d_is_valid_attr_type(v3d_attr_type_t attr_type)
{
   switch (attr_type)
   {
   case V3D_ATTR_TYPE_HALF_FLOAT:
   case V3D_ATTR_TYPE_FLOAT:
   case V3D_ATTR_TYPE_FIXED:
   case V3D_ATTR_TYPE_BYTE:
   case V3D_ATTR_TYPE_SHORT:
   case V3D_ATTR_TYPE_INT:
   case V3D_ATTR_TYPE_INT2_10_10_10:
   return true;
   default:
      return false;
   }
...
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_TMU_TYPE_RGB5_A1_REV:                     return "rgb5_a1_rev";
#endif
   default:                                           return NULL;
   }
}
...
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_TFU_TYPE_RGB5_A1_REV:                     return "rgb5_a1_rev";
#endif
   default:                                           return NULL;
   }
}
...
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
const char *v3d_maybe_desc_max_aniso(v3d_max_aniso_t max_aniso)
{
   switch (max_aniso) {
   case V3D_MAX_ANISO_2:  return "2";
   case V3D_MAX_ANISO_4:  return "4";
   case V3D_MAX_ANISO_8:  return "8";
   case V3D_MAX_ANISO_16: return "16";
   default:               return NULL;
   }
}
const char *v3d_desc_max_aniso(v3d_max_aniso_t max_aniso)
{
   const char *desc = v3d_maybe_desc_max_aniso(max_aniso);
   assert(desc);
   return desc;
}
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
v3d_max_aniso_t v3d_translate_max_aniso(uint32_t x)
{
   switch (x) {
   case 2:  return V3D_MAX_ANISO_2;
   case 4:  return V3D_MAX_ANISO_4;
   case 8:  return V3D_MAX_ANISO_8;
   case 16: return V3D_MAX_ANISO_16;
   default: unreachable(); return V3D_MAX_ANISO_INVALID;
   }
}
uint32_t v3d_translate_from_max_aniso(v3d_max_aniso_t x)
{
   switch (x) {
   case V3D_MAX_ANISO_2:  return 2;
   case V3D_MAX_ANISO_4:  return 4;
...
{
   switch (tmu_filter) {
   case V3D_TMU_FILTER_LINEAR:  return "linear";
   case V3D_TMU_FILTER_NEAREST: return "nearest";
   default:                     return NULL;
   }
}
...
#if V3D_VER_AT_LEAST(4,1,34,0)
const char *v3d_maybe_desc_tmu_mipfilt(v3d_tmu_mipfilt_t tmu_mipfilt)
{
   switch (tmu_mipfilt) {
   case V3D_TMU_MIPFILT_LINEAR:  return "linear";
   case V3D_TMU_MIPFILT_NEAREST: return "nearest";
   default:                      return NULL;
   }
}
const char *v3d_desc_tmu_mipfilt(v3d_tmu_mipfilt_t tmu_mipfilt)
{
   const char *desc = v3d_maybe_desc_tmu_mipfilt(tmu_mipfilt);
   assert(desc);
   return desc;
}
#endif
...
const char *v3d_maybe_desc_tmu_mipfilt(v3d_tmu_mipfilt_t tmu_mipfilt)
{
   ...
   case V3D_TMU_MIPFILT_LINEAR:  return "linear";
   case V3D_TMU_MIPFILT_NEAREST: return "nearest";
   case V3D_TMU_MIPFILT_BASE:    return "base";
   default:                      return NULL;
   }
}
const char *v3d_desc_tmu_mipfilt(v3d_tmu_mipfilt_t tmu_mipfilt)
...
#endif
#if !V3D_VER_AT_LEAST(4,1,34,0)
const char *v3d_maybe_desc_tmu_filters(v3d_tmu_filters_t tmu_filters)
{
   switch (tmu_filters) {
   case V3D_TMU_FILTERS_MIN_LIN_MAG_LIN:            return "min_lin_mag_lin";
   case V3D_TMU_FILTERS_MIN_LIN_MAG_NEAR:           return "min_lin_mag_near";
   case V3D_TMU_FILTERS_MIN_NEAR_MAG_LIN:           return "min_near_mag_lin";
   case V3D_TMU_FILTERS_MIN_NEAR_MAG_NEAR:          return "min_near_mag_near";
   case V3D_TMU_FILTERS_MIN_NEAR_MIP_NEAR_MAG_LIN:  return "min_near_mip_near_mag_lin";
   case V3D_TMU_FILTERS_MIN_NEAR_MIP_NEAR_MAG_NEAR: return "min_near_mip_near_mag_near";
   case V3D_TMU_FILTERS_MIN_NEAR_MIP_LIN_MAG_LIN:   return "min_near_mip_lin_mag_lin";
   case V3D_TMU_FILTERS_MIN_NEAR_MIP_LIN_MAG_NEAR:  return "min_near_mip_lin_mag_near";
   case V3D_TMU_FILTERS_MIN_LIN_MIP_NEAR_MAG_LIN:   return "min_lin_mip_near_mag_lin";
   case V3D_TMU_FILTERS_MIN_LIN_MIP_NEAR_MAG_NEAR:  return "min_lin_mip_near_mag_near";
   case V3D_TMU_FILTERS_MIN_LIN_MIP_LIN_MAG_LIN:    return "min_lin_mip_lin_mag_lin";
   case V3D_TMU_FILTERS_MIN_LIN_MIP_LIN_MAG_NEAR:   return "min_lin_mip_lin_mag_near";
   case V3D_TMU_FILTERS_ANISOTROPIC2:               return "anisotropic2";
   case V3D_TMU_FILTERS_ANISOTROPIC4:               return "anisotropic4";
   case V3D_TMU_FILTERS_ANISOTROPIC8:               return "anisotropic8";
   case V3D_TMU_FILTERS_ANISOTROPIC16:              return "anisotropic16";
   default:                                         return NULL;
   }
}
const char *v3d_desc_tmu_filters(v3d_tmu_filters_t tmu_filters)
{
   const char *desc = v3d_maybe_desc_tmu_filters(tmu_filters);
   assert(desc);
   return desc;
}
#endif
...
#endif
bool v3d_is_valid_shader_type(v3d_shader_type_t shader_type)
{
   switch (shader_type)
   {
   case V3D_SHADER_TYPE_VERTEX:
   case V3D_SHADER_TYPE_TESSC:
   case V3D_SHADER_TYPE_TESSE:
   case V3D_SHADER_TYPE_GEOM:
   case V3D_SHADER_TYPE_FRAG:
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_SHADER_TYPE_COMPUTE:
#endif
   case V3D_SHADER_TYPE_USER:
   return true;
   default:
      return false;
   }
...
const char *v3d_maybe_desc_qpu_opcode(v3d_qpu_opcode_t qpu_opcode)
{
   ...
   case V3D_QPU_OP_BARRIERID:  return "barrierid";
   case V3D_QPU_OP_TMUWT:      return "tmuwt";
   case V3D_QPU_OP_VPMWT:      return "vpmwt";
   case V3D_QPU_OP_FLAFIRST:   return "flafirst";
#if V3D_HAS_FLNAFIRST
   case V3D_QPU_OP_FLNAFIRST:  return "flnafirst";
#endif
...
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_QPU_OP_RECIP:      return "recip";
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_QPU_OP_RSQRT:      return "rsqrt";
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_QPU_OP_EXP:        return "exp";
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_QPU_OP_LOG:        return "log";
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_QPU_OP_SIN:        return "sin";
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
...
#if V3D_VER_AT_LEAST(4,2,13,0)
   case V3D_TSY_OP_SET_QUORUM_WAIT_INC_CHECK:
#endif
...
#if V3D_VER_AT_LEAST(4,2,13,0)
   case V3D_TSY_OP_SET_QUORUM_WAIT_INC_CHECK: return "set_quorum_wait_inc_check";
#endif
...
{
   switch (tlb_rw_type) {
   case V3D_TLB_RW_TYPE_COLOR_16:   return "color_16";
...
bool v3d_is_valid_tlb_rw_color_type(v3d_tlb_rw_color_type_t tlb_rw_color_type)
{
   switch (tlb_rw_color_type)
   {
   case V3D_TLB_RW_COLOR_TYPE_16:
   case V3D_TLB_RW_COLOR_TYPE_16_SWAPPED:
#if V3D_VER_AT_LEAST(4,2,13,0)
   case V3D_TLB_RW_COLOR_TYPE_32:
#endif
#if !V3D_VER_AT_LEAST(4,2,13,0)
   case V3D_TLB_RW_COLOR_TYPE_FLOAT32:
#endif
#if !V3D_VER_AT_LEAST(4,2,13,0)
   case V3D_TLB_RW_COLOR_TYPE_INT32:
#endif
   return true;
   default:
      return false;
...
{
   switch (tlb_rw_color_type) {
   case V3D_TLB_RW_COLOR_TYPE_16:         return "16";
   case V3D_TLB_RW_COLOR_TYPE_16_SWAPPED: return "16_swapped";
#if V3D_VER_AT_LEAST(4,2,13,0)
   case V3D_TLB_RW_COLOR_TYPE_32:         return "32";
#endif
#if !V3D_VER_AT_LEAST(4,2,13,0)
...
#if V3D_VER_AT_LEAST(4,1,34,0)
bool v3d_is_valid_rt_clamp(v3d_rt_clamp_t rt_clamp)
{
   switch (rt_clamp)
   {
...
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
const char *v3d_maybe_desc_rt_clamp(v3d_rt_clamp_t rt_clamp)
{
   switch (rt_clamp) {
   case V3D_RT_CLAMP_NONE:     return "none";
   case V3D_RT_CLAMP_NORM:     return "norm";
   case V3D_RT_CLAMP_POS:      return "pos";
#if V3D_VER_AT_LEAST(4,2,13,0)
   case V3D_RT_CLAMP_INT:      return "int";
#endif
   default:                    return NULL;
   }
}
const char *v3d_desc_rt_clamp(v3d_rt_clamp_t rt_clamp)
{
   const char *desc = v3d_maybe_desc_rt_clamp(rt_clamp);
   assert(desc);
   return desc;
}
#endif
...
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_PIXEL_FORMAT_RGB5_A1:        return "rgb5_a1";
#endif
   default:                              return NULL;
   }
}
...
#endif
bool v3d_is_valid_axi_master_id(v3d_axi_master_id_t axi_master_id)
{
   switch (axi_master_id)
   {
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_AXI_MASTER_ID_L2T:
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_AXI_MASTER_ID_PTB:
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_AXI_MASTER_ID_PSE:
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_AXI_MASTER_ID_TLB:
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_AXI_MASTER_ID_CLE:
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_AXI_MASTER_ID_TFU:
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_AXI_MASTER_ID_MMU:
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_AXI_MASTER_ID_GMP:
#endif
...
#endif
#if !V3D_VER_AT_LEAST(3,3,0,0)
   case V3D_AXI_MASTER_ID_VCD:
#endif
#if !V3D_VER_AT_LEAST(3,3,0,0)
   case V3D_AXI_MASTER_ID_VDW:
#endif
#if !V3D_VER_AT_LEAST(3,3,0,0)
   case V3D_AXI_MASTER_ID_L2T:
#endif
...
const char *v3d_maybe_desc_axi_master_id(v3d_axi_master_id_t axi_master_id)
{
   switch (axi_master_id) {
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_AXI_MASTER_ID_L2T:                               return "l2t";
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_AXI_MASTER_ID_PTB:                               return "ptb";
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_AXI_MASTER_ID_PSE:                               return "pse";
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_AXI_MASTER_ID_TLB:                               return "tlb";
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_AXI_MASTER_ID_CLE:                               return "cle";
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_AXI_MASTER_ID_TFU:                               return "tfu";
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_AXI_MASTER_ID_MMU:                               return "mmu";
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_AXI_MASTER_ID_GMP:                               return "gmp";
#endif
#if !V3D_VER_AT_LEAST(4,1,34,0) && V3D_VER_AT_LEAST(3,3,0,0)
   case V3D_AXI_MASTER_ID_L2T:                               return "l2t";
#endif
...
#endif
#if !V3D_VER_AT_LEAST(3,3,0,0)
   case V3D_AXI_MASTER_ID_L2C:                               return "l2c";
#endif
#if !V3D_VER_AT_LEAST(3,3,0,0)
   case V3D_AXI_MASTER_ID_CLE:                               return "cle";
#endif
...
#endif
#if !V3D_VER_AT_LEAST(3,3,0,0)
   case V3D_AXI_MASTER_ID_VCD:                               return "vcd";
#endif
#if !V3D_VER_AT_LEAST(3,3,0,0)
   case V3D_AXI_MASTER_ID_VDW:                               return "vdw";
#endif
#if !V3D_VER_AT_LEAST(3,3,0,0)
   case V3D_AXI_MASTER_ID_L2T:                               return "l2t";
#endif
...
const char *v3d_desc_axi_master_id(v3d_axi_master_id_t axi_master_id)
{
   const char *desc = v3d_maybe_desc_axi_master_id(axi_master_id);
   assert(desc);
   return desc;
}
#if V3D_VER_AT_LEAST(4,1,34,0)
...
const char *v3d_desc_l2t_master_id(v3d_l2t_master_id_t l2t_master_id)
{
   const char *desc = v3d_maybe_desc_l2t_master_id(l2t_master_id);
   assert(desc);
   return desc;
}
#endif
bool v3d_is_valid_cl_opcode(v3d_cl_opcode_t cl_opcode)
{
...
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_CL_INDEX_BUFFER_SETUP:
#endif
#if !V3D_VER_AT_LEAST(4,1,34,0)
   ...
   case V3D_CL_CLEAR_SLICE_CACHES:
   case V3D_CL_FLUSH_L2T:
#if !V3D_VER_AT_LEAST(3,3,0,0)
   case V3D_CL_CLEAR_L2C:
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_CL_CLEAN_L1TD_DEFERRED:
#endif
...
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_CL_ZERO_ALL_NOPERSPECTIVE_FLAGS:
#endif
#if !V3D_VER_AT_LEAST(4,1,34,0)
...
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_CL_NOPERSPECTIVE_FLAGS:
#endif
#if !V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_CL_SAMPLE_STATE:
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_CL_SAMPLE_STATE:
#endif
...
const char *v3d_maybe_desc_cl_opcode(v3d_cl_opcode_t cl_opcode)
{
   ...
   case V3D_CL_CLEAR_VCD_CACHE:                    return "clear_vcd_cache";
...
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_CL_INDEX_BUFFER_SETUP:                 return "index_buffer_setup";
#endif
#if !V3D_VER_AT_LEAST(4,1,34,0)
...
#endif
   case V3D_CL_SET_PRIMITIVE_ID:                   return "set_primitive_id";
   ...
   case V3D_CL_CLEAR_SLICE_CACHES:                 return "clear_slice_caches";
   case V3D_CL_FLUSH_L2T:                          return "flush_l2t";
#if !V3D_VER_AT_LEAST(3,3,0,0)
   case V3D_CL_CLEAR_L2C:                          return "clear_l2c";
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_CL_CLEAN_L1TD_DEFERRED:                return "clean_l1td_deferred";
#endif
...
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_CL_ZERO_ALL_NOPERSPECTIVE_FLAGS:       return "zero_all_noperspective_flags";
#endif
#if !V3D_VER_AT_LEAST(4,1,34,0)
...
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_CL_NOPERSPECTIVE_FLAGS:                return "noperspective_flags";
#endif
#if !V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_CL_SAMPLE_STATE:                       return "sample_state";
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_CL_SAMPLE_STATE:                       return "sample_state";
#endif
...
void v3d_unpack_shadrec_gl_main(V3D_SHADREC_GL_MAIN_T *unpacked, const uint32_t *packed)
{
   ...
   (*unpacked).fs_needs_w = packed[0] >> 10 & 1;
...
void v3d_unpack_shadrec_gl_main(V3D_SHADREC_GL_MAIN_T *unpacked, const uint32_t *packed)
{
   ...
   (*unpacked).fs_needs_w = packed[0] >> 12 & 1;
   ...
   (*unpacked).no_prim_pack = packed[0] >> 19 & 1;
   ...
   (*unpacked).defaults = packed[2];
   (*unpacked).fs.threading = (v3d_threading_t)(packed[3] & 1);
   (*unpacked).fs.single_seg = packed[3] >> 1 & 1;
   (*unpacked).fs.propagate_nans = packed[3] >> 2 & 1;
   (*unpacked).fs.addr = packed[3] >> 3 << 3;
   (*unpacked).fs.unifs_addr = packed[4];
   (*unpacked).vs.threading = (v3d_threading_t)(packed[5] & 1);
   (*unpacked).vs.single_seg = packed[5] >> 1 & 1;
   (*unpacked).vs.propagate_nans = packed[5] >> 2 & 1;
   (*unpacked).vs.addr = packed[5] >> 3 << 3;
   (*unpacked).vs.unifs_addr = packed[6];
   (*unpacked).cs.threading = (v3d_threading_t)(packed[7] & 1);
   (*unpacked).cs.single_seg = packed[7] >> 1 & 1;
   (*unpacked).cs.propagate_nans = packed[7] >> 2 & 1;
   (*unpacked).cs.addr = packed[7] >> 3 << 3;
   (*unpacked).cs.unifs_addr = packed[8];
}
...
void v3d_unpack_shadrec_gl_main(V3D_SHADREC_GL_MAIN_T *unpacked, const uint32_t *packed)
{
   ...
   (*unpacked).vs_input_size.sectors = packed[1] >> 24 & 15;
   (*unpacked).vs_input_size.min_req = (packed[1] >> 28 & 3) + 1;
   (*unpacked).fs.threading = (v3d_threading_t)(packed[2] & 1);
   (*unpacked).fs.single_seg = packed[2] >> 1 & 1;
   (*unpacked).fs.propagate_nans = packed[2] >> 2 & 1;
   (*unpacked).fs.addr = packed[2] >> 3 << 3;
   (*unpacked).fs.unifs_addr = packed[3];
   (*unpacked).vs.threading = (v3d_threading_t)(packed[4] & 1);
   (*unpacked).vs.single_seg = packed[4] >> 1 & 1;
   (*unpacked).vs.propagate_nans = packed[4] >> 2 & 1;
   (*unpacked).vs.addr = packed[4] >> 3 << 3;
   (*unpacked).vs.unifs_addr = packed[5];
   (*unpacked).cs.threading = (v3d_threading_t)(packed[6] & 1);
   (*unpacked).cs.single_seg = packed[6] >> 1 & 1;
   (*unpacked).cs.propagate_nans = packed[6] >> 2 & 1;
   (*unpacked).cs.addr = packed[6] >> 3 << 3;
   (*unpacked).cs.unifs_addr = packed[7];
}
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
void v3d_unpack_shadrec_gl_geom(V3D_SHADREC_GL_GEOM_T *unpacked, const uint32_t *packed)
{
   (*unpacked).gs_bin.threading = (v3d_threading_t)(packed[0] & 1);
   (*unpacked).gs_bin.single_seg = packed[0] >> 1 & 1;
   (*unpacked).gs_bin.propagate_nans = packed[0] >> 2 & 1;
   (*unpacked).gs_bin.addr = packed[0] >> 3 << 3;
   (*unpacked).gs_bin.unifs_addr = packed[1];
   (*unpacked).gs_render.threading = (v3d_threading_t)(packed[2] & 1);
   (*unpacked).gs_render.single_seg = packed[2] >> 1 & 1;
...
{
   (*unpacked).tcs_bin.threading = (v3d_threading_t)(packed[0] & 1);
   (*unpacked).tcs_bin.single_seg = packed[0] >> 1 & 1;
   (*unpacked).tcs_bin.propagate_nans = packed[0] >> 2 & 1;
   (*unpacked).tcs_bin.addr = packed[0] >> 3 << 3;
   (*unpacked).tcs_bin.unifs_addr = packed[1];
   (*unpacked).tcs_render.threading = (v3d_threading_t)(packed[2] & 1);
   (*unpacked).tcs_render.single_seg = packed[2] >> 1 & 1;
   ...
   (*unpacked).tes_bin.threading = (v3d_threading_t)(packed[4] & 1);
   (*unpacked).tes_bin.single_seg = packed[4] >> 1 & 1;
   (*unpacked).tes_bin.propagate_nans = packed[4] >> 2 & 1;
   (*unpacked).tes_bin.addr = packed[4] >> 3 << 3;
   (*unpacked).tes_bin.unifs_addr = packed[5];
   (*unpacked).tes_render.threading = (v3d_threading_t)(packed[6] & 1);
   (*unpacked).tes_render.single_seg = packed[6] >> 1 & 1;
...
void v3d_unpack_shadrec_gl_tess_or_geom(V3D_SHADREC_GL_TESS_OR_GEOM_T *unpacked, const uint32_t *packed)
{
   ...
   (*unpacked).bin.tcs_batch_flush = (v3d_cl_tcs_batch_flush_mode_t)(packed[1] & 3);
   (*unpacked).bin.per_patch_depth =
      gfx_unpack_uint_0_is_max(packed[1] >> 2 & 15, 4);
   (*unpacked).bin.tcs_output.size_sectors =
      gfx_check_urange(packed[1] >> 8 & 63, 0, 16);
   (*unpacked).bin.tcs_output.pack = (v3d_cl_vpm_pack_t)(packed[1] >> 14 & 3);
   (*unpacked).bin.tes_output.size_sectors =
      gfx_check_urange(packed[1] >> 16 & 63, 0, 16);
   (*unpacked).bin.tes_output.pack = (v3d_cl_vpm_pack_t)(packed[1] >> 22 & 3);
   (*unpacked).bin.geom_output.size_sectors =
      gfx_check_urange(packed[1] >> 24 & 63, 0, 16);
   (*unpacked).bin.geom_output.pack = (v3d_cl_geom_output_pack_t)(packed[1] >> 30);
   (*unpacked).bin.max_patches_per_tcs_batch = (packed[2] & 15) + 1;
   (*unpacked).bin.max_extra_vert_segs_per_tcs_batch = packed[2] >> 4 & 3;
   (*unpacked).bin.min_tcs_segs = (packed[2] >> 6 & 7) + 1;
   (*unpacked).bin.min_per_patch_segs = (packed[2] >> 9 & 3) + 1;
   (*unpacked).bin.max_patches_per_tes_batch = (packed[2] >> 13 & 15) + 1;
   (*unpacked).bin.max_extra_vert_segs_per_tes_batch = packed[2] >> 17 & 3;
   (*unpacked).bin.max_tcs_segs_per_tes_batch = (packed[2] >> 19 & 7) + 1;
   (*unpacked).bin.min_tes_segs = (packed[2] >> 22 & 7) + 1;
   (*unpacked).bin.max_extra_vert_segs_per_gs_batch = packed[2] >> 25 & 3;
   (*unpacked).bin.min_gs_segs = (packed[2] >> 27 & 7) + 1;
   (*unpacked).render.tcs_batch_flush =
      (v3d_cl_tcs_batch_flush_mode_t)(packed[3] & 3);
   (*unpacked).render.per_patch_depth =
      gfx_unpack_uint_0_is_max(packed[3] >> 2 & 15, 4);
   (*unpacked).render.tcs_output.size_sectors =
      gfx_check_urange(packed[3] >> 8 & 63, 0, 16);
   (*unpacked).render.tcs_output.pack = (v3d_cl_vpm_pack_t)(packed[3] >> 14 & 3);
   (*unpacked).render.tes_output.size_sectors =
      gfx_check_urange(packed[3] >> 16 & 63, 0, 16);
   (*unpacked).render.tes_output.pack = (v3d_cl_vpm_pack_t)(packed[3] >> 22 & 3);
   (*unpacked).render.geom_output.size_sectors =
      gfx_check_urange(packed[3] >> 24 & 63, 0, 16);
   (*unpacked).render.geom_output.pack =
      (v3d_cl_geom_output_pack_t)(packed[3] >> 30);
   (*unpacked).render.max_patches_per_tcs_batch = (packed[4] & 15) + 1;
   (*unpacked).render.max_extra_vert_segs_per_tcs_batch = packed[4] >> 4 & 3;
   (*unpacked).render.min_tcs_segs = (packed[4] >> 6 & 7) + 1;
   (*unpacked).render.min_per_patch_segs = (packed[4] >> 9 & 3) + 1;
   (*unpacked).render.max_patches_per_tes_batch = (packed[4] >> 13 & 15) + 1;
   (*unpacked).render.max_extra_vert_segs_per_tes_batch = packed[4] >> 17 & 3;
   (*unpacked).render.max_tcs_segs_per_tes_batch = (packed[4] >> 19 & 7) + 1;
   (*unpacked).render.min_tes_segs = (packed[4] >> 22 & 7) + 1;
   (*unpacked).render.max_extra_vert_segs_per_gs_batch = packed[4] >> 25 & 3;
   (*unpacked).render.min_gs_segs = (packed[4] >> 27 & 7) + 1;
}
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
void v3d_unpack_shadrec_gl_attr(V3D_SHADREC_GL_ATTR_T *unpacked, const uint32_t *packed)
{
   ...
   (*unpacked).max_index = packed[3] & 0xffffff;
}
#endif
#if !V3D_VER_AT_LEAST(4,1,34,0)
void v3d_unpack_shadrec_gl_attr(V3D_SHADREC_GL_ATTR_T *unpacked, const uint32_t *packed)
...
void v3d_unpack_shadrec_vg(V3D_SHADREC_VG_T *unpacked, const uint32_t *packed)
{
   (*unpacked).fs.threading = (v3d_threading_t)(packed[1] & 1);
   (*unpacked).fs.single_seg = packed[1] >> 1 & 1;
   (*unpacked).fs.propagate_nans = packed[1] >> 2 & 1;
   (*unpacked).fs.addr = packed[1] >> 3 << 3;
   (*unpacked).fs.unifs_addr = packed[2];
}
...
void v3d_unpack_tmu_param1_cfg0(V3D_TMU_PARAM1_CFG0_T *unpacked, uint32_t packed0)
{
   ...
   (*unpacked).filters = (v3d_tmu_filters_t)(packed0 >> 4 & 15);
...
void v3d_unpack_tmu_param2(V3D_TMU_PARAM2_T *unpacked, uint32_t packed0)
{
   ...
   (*unpacked).sample_num = packed0 >> 2 & 3;
...
void v3d_unpack_tmu_param2(V3D_TMU_PARAM2_T *unpacked, uint32_t packed0)
{
   ...
   (*unpacked).bslod = packed0 >> 1 & 1;
   (*unpacked).sample_num = packed0 >> 2 & 3;
   (*unpacked).sampler_lod_dis = packed0 >> 4 & 1;
   (*unpacked).gather_comp = packed0 >> 5 & 3;
   (*unpacked).gather = packed0 >> 7 & 1;
   (*unpacked).offsets[0] = gfx_sext(packed0 >> 8 & 15, 4);
   (*unpacked).offsets[1] = gfx_sext(packed0 >> 12 & 15, 4);
...
void v3d_unpack_tlb_config(V3D_TLB_CONFIG_T *unpacked, uint8_t packed0)
{
   ...
   {
      (*unpacked).type = V3D_TLB_RW_TYPE_COLOR_16;
      (*unpacked).u.color_16.num_words = (uint32_t)(packed0 & 1) + 1;
      (*unpacked).u.color_16.no_swap = (uint32_t)(packed0 >> 1 & 1);
      (*unpacked).u.color_16.all_samples_same_data = (uint32_t)(packed0 >> 2 & 1);
      (*unpacked).u.color_16.rt = gfx_mask(3) - (uint32_t)(packed0 >> 3 & 7);
   ...
   else if ((uint32_t)(packed0 >> 4) == 8)
   {
      ...
      (*unpacked).u.z.all_samples_same_data = (uint32_t)(packed0 >> 2 & 1);
      (*unpacked).u.z.use_written_z = (uint32_t)(packed0 >> 3 & 1);
      assert((uint32_t)(packed0 >> 4) == 8);
   }
   else if ((uint32_t)(packed0 >> 4) == 9)
   {
      (*unpacked).type = V3D_TLB_RW_TYPE_ALPHA_MASK;
      (*unpacked).u.alpha_mask.all_samples_same_data = (uint32_t)(packed0 >> 2 & 1);
...
#if !V3D_VER_AT_LEAST(3,3,0,0)
void v3d_unpack_tmu_indirect(V3D_TMU_INDIRECT_T *unpacked, const uint32_t *packed)
{
   (*unpacked).filters = (v3d_tmu_filters_t)(packed[0] & 15);
   ...
   assert((packed[3] >> 30 & 1) == 1);
   (*unpacked).bcolour = (uint64_t)packed[4] | (uint64_t)packed[5] << 32;
   (*unpacked).min_lod = gfx_sext(packed[6] & 0xffff, 16);
   (*unpacked).max_lod = gfx_sext(packed[6] >> 16, 16);
   (*unpacked).fixed_bias = gfx_sext(packed[7] & 0xffff, 16);
   (*unpacked).base_level = packed[7] >> 16 & 15;
   (*unpacked).samp_num = packed[7] >> 20 & 3;
...
void v3d_unpack_tmu_indirect(V3D_TMU_INDIRECT_T *unpacked, const uint32_t *packed)
{
   ...
   (*unpacked).base_level = packed[7] >> 16 & 15;
   (*unpacked).samp_num = packed[7] >> 20 & 3;
   (*unpacked).output_32 = packed[7] >> 22 & 1;
   (*unpacked).ub_pad = packed[7] >> 24 & 15;
   (*unpacked).ub_xor = packed[7] >> 28 & 1;
   (*unpacked).uif_top = packed[7] >> 30 & 1;
   (*unpacked).xor_dis = packed[7] >> 31;
...
{
   (*unpacked).magfilt = (v3d_tmu_filter_t)(uint32_t)(packed[0] & 1);
   (*unpacked).minfilt = (v3d_tmu_filter_t)(uint32_t)(packed[0] >> 1 & 1);
   (*unpacked).mipfilt = (v3d_tmu_mipfilt_t)(uint32_t)(packed[0] >> 2 & 1);
   (*unpacked).aniso_en = (uint32_t)(packed[0] >> 3 & 1);
   ...
   (*unpacked).max_aniso = (v3d_max_aniso_t)(uint32_t)(packed[7] >> 5 & 3);
}
#endif
#if !V3D_VER_AT_LEAST(4,1,34,0)
...
void v3d_unpack_cl_compr_ind_common(V3D_CL_COMPR_IND_COMMON_T *unpacked, const uint8_t *packed)
{
   ...
   else if ((uint32_t)(packed[0] & 15) == 3 && (uint32_t)(packed[0] >> 5) == 3)
   {
      ...
      (*unpacked).u.clipped_prim.is_first2 = (uint32_t)(packed[1] >> 4 & 1);
...
{
   (*unpacked).tech_version = packed0 & 15;
   (*unpacked).revision = packed0 >> 4 & 15;
...
void v3d_unpack_hub_ident3(V3D_HUB_IDENT3_T *unpacked, uint32_t packed0)
{
   ...
   (*unpacked).sub_rev = packed0 >> 8 & 255;
   (*unpacked).compat_rev = packed0 >> 16 & 255;
}
#endif
#if V3D_HAS_L3C
void v3d_unpack_hub_ident(V3D_HUB_IDENT_T *unpacked, const uint32_t *packed)
{
   assert(packed[0] == 0x42554856);
   (*unpacked).tech_version = packed[1] & 15;
   (*unpacked).revision = packed[1] >> 4 & 15;
   (*unpacked).num_cores = gfx_unpack_uint_0_is_max(packed[1] >> 8 & 15, 4);
   (*unpacked).num_hosts = gfx_check_urange(packed[1] >> 12 & 15, 1, 15);
   (*unpacked).has_l3c = packed[1] >> 16 & 1;
   (*unpacked).has_tfu = packed[1] >> 17 & 1;
   (*unpacked).has_tsy = packed[1] >> 18 & 1;
   (*unpacked).has_mso = packed[1] >> 19 & 1;
   (*unpacked).has_mmu = packed[2] >> 8 & 1;
   (*unpacked).ip_recipient = (v3d_ip_recipient_t)(packed[3] & 255);
   (*unpacked).sub_rev = packed[3] >> 8 & 255;
   (*unpacked).compat_rev = packed[3] >> 16 & 255;
}
#endif
#if !V3D_HAS_L3C
void v3d_unpack_hub_ident0(uint32_t packed0)
...
#endif
#if !V3D_VER_AT_LEAST(4,1,34,0)
void v3d_unpack_ident(V3D_IDENT_T *unpacked, const uint32_t *packed)
{
   assert((packed[0] & 0xffffff) == 0x443356);
   (*unpacked).tech_version = packed[0] >> 24;
   (*unpacked).revision = packed[1] & 15;
   (*unpacked).num_slices = gfx_check_urange(packed[1] >> 4 & 15, 1, 15);
   (*unpacked).num_qpus_per_slice = gfx_check_urange(packed[1] >> 8 & 15, 1, 15);
   (*unpacked).num_tmus = gfx_check_urange(packed[1] >> 12 & 15, 1, 15);
   (*unpacked).vpm_size_in_multiples_of_8kb = packed[1] >> 28;
   (*unpacked).vri_size = (v3d_vri_size_t)(packed[2] & 15);
   (*unpacked).tlb_size = (v3d_tlb_size_t)(packed[2] >> 4 & 15);
   (*unpacked).tlb_double_buf_support = packed[2] >> 8 & 1;
   (*unpacked).icache_size = (v3d_iuc_size_t)(packed[2] >> 12 & 15);
   (*unpacked).ucache_size = (v3d_iuc_size_t)(packed[2] >> 16 & 15);
   (*unpacked).bigend = packed[2] >> 20 & 1;
   (*unpacked).endswp_support = packed[2] >> 21 & 1;
   (*unpacked).axi_rw_reorder_support = packed[2] >> 22 & 1;
   (*unpacked).no_earlyz_support = packed[2] >> 23 & 1;
   (*unpacked).core_index = packed[2] >> 24 & 15;
   (*unpacked).bcg_interrupt_control = packed[2] >> 28 & 1;
   (*unpacked).has_astc = packed[2] >> 30 & 1;
   (*unpacked).ip_recipient = (v3d_ip_recipient_t)(packed[3] & 255);
   (*unpacked).sub_rev = packed[3] >> 8 & 255;
}
#endif
...
void v3d_unpack_ident(V3D_IDENT_T *unpacked, const uint32_t *packed)
{
   ...
   (*unpacked).bcg_interrupt_control = packed[2] >> 28 & 1;
   (*unpacked).has_astc = packed[2] >> 30 & 1;
   (*unpacked).l2t_ways = packed[3] & 15;
   (*unpacked).l2t_way_depth = packed[3] >> 4 & 15;
}
#endif
...
void v3d_unpack_intr(V3D_INTR_T *unpacked, uint32_t packed0)
{
   ...
   (*unpacked).trfb = packed0 >> 4 & 1;
   (*unpacked).gmpv = packed0 >> 5 & 1;
   (*unpacked).pctr = packed0 >> 6 & 1;
   (*unpacked).compute_done = packed0 >> 7 & 1;
   (*unpacked).qpu[0] = packed0 >> 16 & 1;
   (*unpacked).qpu[1] = packed0 >> 17 & 1;
   (*unpacked).qpu[2] = packed0 >> 18 & 1;
   (*unpacked).qpu[3] = packed0 >> 19 & 1;
...
void v3d_unpack_ct1cfg(V3D_CT1CFG_T *unpacked, uint32_t packed0)
{
   ...
   (*unpacked).fill_empty_tiles = packed0 >> 6 & 1;
   (*unpacked).skip_empty_tiles = packed0 >> 7 & 1;
}
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
void v3d_unpack_ct1cfg(V3D_CT1CFG_T *unpacked, uint32_t packed0)
...
#if V3D_VER_AT_LEAST(4,1,34,0)
void v3d_unpack_ct0qts(V3D_CT0QTS_T *unpacked, uint32_t packed0)
{
   (*unpacked).enable = packed0 >> 1 & 1;
   (*unpacked).tile_state_addr = packed0 >> 6 << 6;
}
#endif
...
#if V3D_VER_AT_LEAST(4,1,34,0)
void v3d_unpack_srqpc(V3D_SRQPC_T *unpacked, uint32_t packed0)
{
   (*unpacked).threading = (v3d_threading_t)(packed0 & 1);
   (*unpacked).single_seg = packed0 >> 1 & 1;
   (*unpacked).propagate_nans = packed0 >> 2 & 1;
   (*unpacked).addr = packed0 >> 3 << 3;
}
#endif
...
#endif
void v3d_unpack_l2t_cactl(V3D_L2T_CACTL_T *unpacked, uint32_t packed0)
{
   (*unpacked).flush = packed0 & 1;
   (*unpacked).mode = (v3d_l2t_flush_mode_t)(packed0 >> 1 & 3);
   (*unpacked).flush_write_combiner = packed0 >> 8 & 1;
}
#if V3D_HAS_L2T_LOCAL_MEM
void v3d_unpack_l2t_local_ctrl(V3D_L2T_LOCAL_CTRL_T *unpacked, uint32_t packed0)
{
...
void v3d_unpack_gmp_cfg(V3D_GMP_CFG_T *unpacked, uint32_t packed0)
{
   ...
   (*unpacked).clear_prot_bits = packed0 >> 31;
}
#endif
#if V3D_VER_AT_LEAST(3,3,0,0) && !V3D_VER_AT_LEAST(4,1,34,0)
void v3d_unpack_gmp_cfg(V3D_GMP_CFG_T *unpacked, uint32_t packed0)
...
#endif
#if !V3D_VER_AT_LEAST(3,3,0,0)
void v3d_unpack_gmp_cs(V3D_GMP_CS_T *unpacked, uint32_t packed0)
{
   (*unpacked).read_vio = packed0 & 1;
   (*unpacked).write_vio = packed0 >> 1 & 1;
   (*unpacked).invalid_table = packed0 >> 2 & 1;
   (*unpacked).counter_overflow = packed0 >> 3 & 1;
   (*unpacked).load_busy = packed0 >> 7 & 1;
   (*unpacked).ardwait = packed0 >> 8 & 1;
   (*unpacked).arost = packed0 >> 9 & 1;
   (*unpacked).arqbusy = packed0 >> 10 & 1;
   (*unpacked).awbwait = packed0 >> 12 & 1;
   (*unpacked).awost = packed0 >> 13 & 1;
   (*unpacked).awqbusy = packed0 >> 14 & 1;
   (*unpacked).awburst = packed0 >> 15 & 1;
   (*unpacked).stop_request = packed0 >> 16 & 1;
   (*unpacked).clear_prot_bits = packed0 >> 30 & 1;
   (*unpacked).reset = packed0 >> 31;
}
#endif
#if V3D_VER_AT_LEAST(3,3,0,0) && !V3D_VER_AT_LEAST(4,1,34,0)
...
void v3d_unpack_gmp_status(V3D_GMP_STATUS_T *unpacked, uint32_t packed0)
{
   ...
   (*unpacked).read_active = packed0 >> 4 & 1;
   (*unpacked).write_active = packed0 >> 5 & 1;
   (*unpacked).read_count = packed0 >> 16 & 255;
   (*unpacked).write_count = packed0 >> 24;
}
#endif
#if !V3D_VER_AT_LEAST(3,3,0,0)
void v3d_unpack_gmp_vio_type(V3D_GMP_VIO_TYPE_T *unpacked, uint32_t packed0)
{
   (*unpacked).length = (packed0 & 15) + 1;
   (*unpacked).axi_internal_id = packed0 >> 16 & 31;
   (*unpacked).axi_master_id = (v3d_axi_master_id_t)(packed0 >> 21 & 15);
}
#endif
#if V3D_VER_AT_LEAST(3,3,0,0) && !V3D_VER_AT_LEAST(4,1,34,0)
void v3d_unpack_gmp_vio_type(V3D_GMP_VIO_TYPE_T *unpacked, uint32_t packed0)
{
   ...
   (*unpacked).axi_internal_id = packed0 >> 16 & 31;
   (*unpacked).axi_master_id = (v3d_axi_master_id_t)(packed0 >> 21 & 15);
   (*unpacked).write = packed0 >> 30 & 1;
   (*unpacked).valid = packed0 >> 31;
}
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
void v3d_unpack_gmp_vio_type(V3D_GMP_VIO_TYPE_T *unpacked, uint32_t packed0)
{
   (*unpacked).length = (packed0 & 15) + 1;
   (*unpacked).l2t_master_id = (v3d_l2t_master_id_t)(packed0 >> 4 & 15);
   (*unpacked).axi_internal_id = packed0 >> 16 & 31;
   (*unpacked).axi_master_id = (v3d_axi_master_id_t)(packed0 >> 21 & 15);
   (*unpacked).write = packed0 >> 30 & 1;
   (*unpacked).valid = packed0 >> 31;
...
#endif
void v3d_unpack_tsy_config0(V3D_TSY_CONFIG0_T *unpacked, uint32_t packed0)
{
   (*unpacked).version = packed0 & 255;
}
void v3d_unpack_tsy_config1(V3D_TSY_CONFIG1_T *unpacked, uint32_t packed0)
{
   (*unpacked).num_objects = packed0 & 0xffff;
   (*unpacked).num_threads = packed0 >> 16;
}
void v3d_unpack_tsy_control(V3D_TSY_CONTROL_T *unpacked, uint32_t packed0)
{
   (*unpacked).core_enable[0] = packed0 & 1;
   (*unpacked).core_enable[1] = packed0 >> 1 & 1;
   (*unpacked).core_enable[2] = packed0 >> 2 & 1;
   (*unpacked).core_enable[3] = packed0 >> 3 & 1;
   (*unpacked).core_enable[4] = packed0 >> 4 & 1;
   (*unpacked).core_enable[5] = packed0 >> 5 & 1;
   (*unpacked).core_enable[6] = packed0 >> 6 & 1;
   (*unpacked).core_enable[7] = packed0 >> 7 & 1;
   (*unpacked).core_enable[8] = packed0 >> 8 & 1;
   (*unpacked).core_enable[9] = packed0 >> 9 & 1;
   (*unpacked).core_enable[10] = packed0 >> 10 & 1;
   (*unpacked).core_enable[11] = packed0 >> 11 & 1;
   (*unpacked).core_enable[12] = packed0 >> 12 & 1;
   (*unpacked).core_enable[13] = packed0 >> 13 & 1;
   (*unpacked).core_enable[14] = packed0 >> 14 & 1;
   (*unpacked).core_enable[15] = packed0 >> 15 & 1;
}
#if !V3D_VER_AT_LEAST(4,1,34,0)
void v3d_unpack_tsy_status(V3D_TSY_STATUS_T *unpacked, uint32_t packed0)
{
   (*unpacked).busy = packed0 & 1;
}
#endif
...
{
   (*unpacked).busy = packed0 & 1;
   (*unpacked).apb_busy = packed0 >> 1 & 1;
}
#endif
void v3d_unpack_tsy_tso_data(V3D_TSY_TSO_DATA_T *unpacked, uint32_t packed0)
{
   (*unpacked).num_waiting = packed0 & 0xffff;
   (*unpacked).quorum = packed0 >> 16;
}
#if V3D_VER_AT_LEAST(4,1,34,0)
void v3d_unpack_csd_status(V3D_CSD_STATUS_T *unpacked, uint32_t packed0)
{
   (*unpacked).have_queued_dispatch = packed0 & 1;
   (*unpacked).have_current_dispatch = packed0 >> 1 & 1;
   (*unpacked).num_active_dispatches = packed0 >> 2 & 3;
   (*unpacked).num_completed_dispatches = packed0 >> 4 & 255;
}
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
void v3d_unpack_csd_cfg0(V3D_CSD_CFG0_T *unpacked, uint32_t packed0)
{
   (*unpacked).wg_x_offset = packed0 & 0xffff;
   (*unpacked).num_wgs_x = gfx_unpack_uint_0_is_max(packed0 >> 16, 16);
}
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
void v3d_unpack_csd_cfg1(V3D_CSD_CFG1_T *unpacked, uint32_t packed0)
{
   (*unpacked).wg_y_offset = packed0 & 0xffff;
   (*unpacked).num_wgs_y = gfx_unpack_uint_0_is_max(packed0 >> 16, 16);
}
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
void v3d_unpack_csd_cfg2(V3D_CSD_CFG2_T *unpacked, uint32_t packed0)
{
   (*unpacked).wg_z_offset = packed0 & 0xffff;
   (*unpacked).num_wgs_z = gfx_unpack_uint_0_is_max(packed0 >> 16, 16);
}
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
void v3d_unpack_csd_cfg3(V3D_CSD_CFG3_T *unpacked, uint32_t packed0)
{
   (*unpacked).wg_size = gfx_unpack_uint_0_is_max(packed0 & 255, 8);
   (*unpacked).wgs_per_sg = gfx_unpack_uint_0_is_max(packed0 >> 8 & 15, 4);
   (*unpacked).batches_per_sg = (packed0 >> 12 & 255) + 1;
   (*unpacked).max_sg_id = packed0 >> 20 & 63;
   (*unpacked).overlap_with_prev = packed0 >> 26 & 1;
}
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
void v3d_unpack_csd_cfg4(V3D_CSD_CFG4_T *unpacked, uint32_t packed0)
{
   (*unpacked).num_batches = (uint64_t)packed0 + 1;
}
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
void v3d_unpack_csd_cfg5(V3D_CSD_CFG5_T *unpacked, uint32_t packed0)
{
   (*unpacked).threading = (v3d_threading_t)(packed0 & 1);
   (*unpacked).single_seg = packed0 >> 1 & 1;
   (*unpacked).propagate_nans = packed0 >> 2 & 1;
   (*unpacked).shader_addr = packed0 >> 3 << 3;
}
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
void v3d_unpack_csd_cfg6(V3D_CSD_CFG6_T *unpacked, uint32_t packed0)
{
   (*unpacked).unifs_addr = packed0 >> 2 << 2;
}
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
void v3d_unpack_csd_cfg(V3D_CSD_CFG_T *unpacked, const uint32_t *packed)
{
   (*unpacked).wg_x_offset = packed[0] & 0xffff;
   (*unpacked).num_wgs_x = gfx_unpack_uint_0_is_max(packed[0] >> 16, 16);
   (*unpacked).wg_y_offset = packed[1] & 0xffff;
   (*unpacked).num_wgs_y = gfx_unpack_uint_0_is_max(packed[1] >> 16, 16);
   (*unpacked).wg_z_offset = packed[2] & 0xffff;
   (*unpacked).num_wgs_z = gfx_unpack_uint_0_is_max(packed[2] >> 16, 16);
   (*unpacked).wg_size = gfx_unpack_uint_0_is_max(packed[3] & 255, 8);
   (*unpacked).wgs_per_sg = gfx_unpack_uint_0_is_max(packed[3] >> 8 & 15, 4);
   (*unpacked).batches_per_sg = (packed[3] >> 12 & 255) + 1;
   (*unpacked).max_sg_id = packed[3] >> 20 & 63;
   (*unpacked).overlap_with_prev = packed[3] >> 26 & 1;
   (*unpacked).num_batches = (uint64_t)packed[4] + 1;
   (*unpacked).threading = (v3d_threading_t)(packed[5] & 1);
   (*unpacked).single_seg = packed[5] >> 1 & 1;
   (*unpacked).propagate_nans = packed[5] >> 2 & 1;
   (*unpacked).shader_addr = packed[5] >> 3 << 3;
   (*unpacked).unifs_addr = packed[6] >> 2 << 2;
}
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
void v3d_unpack_csd_id0(V3D_CSD_ID0_T *unpacked, uint32_t packed0)
{
   (*unpacked).l_idx = packed0 & 255;
   (*unpacked).wg_in_sg = packed0 >> 8 & 15;
   (*unpacked).wg_x = packed0 >> 16;
}
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
void v3d_unpack_csd_id1(V3D_CSD_ID1_T *unpacked, uint32_t packed0)
{
   (*unpacked).wg_y = packed0 & 0xffff;
   (*unpacked).wg_z = packed0 >> 16;
}
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
void v3d_unpack_csd_id(V3D_CSD_ID_T *unpacked, const uint32_t *packed)
{
   (*unpacked).l_idx = packed[0] & 255;
   (*unpacked).wg_in_sg = packed[0] >> 8 & 15;
   (*unpacked).wg_x = packed[0] >> 16;
   (*unpacked).wg_y = packed[1] & 0xffff;
   (*unpacked).wg_z = packed[1] >> 16;
}
#endif
...
void v3d_print_shadrec_gl_main(const uint32_t *packed, struct v3d_printer *printer)
{
   ...
   printer->vtbl->boolean_field(printer, "fs_needs_w", packed[0] >> 10 & 1);
...
void v3d_print_shadrec_gl_main(const uint32_t *packed, struct v3d_printer *printer)
{
   ...
   printer->vtbl->boolean_field(printer, "fs_needs_w", packed[0] >> 12 & 1);
   ...
   printer->vtbl->boolean_field(printer, "disable_implicit_varys",
      packed[0] >> 18 & 1);
   printer->vtbl->boolean_field(printer, "no_prim_pack", packed[0] >> 19 & 1);
   printer->vtbl->field(printer, "num_varys", "%" PRIu32 "",
   ...
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, "fs", false);
   printer->vtbl->field(printer, "threading", "%s",
      v3d_desc_threading((v3d_threading_t)(packed[3] & 1)));
   printer->vtbl->boolean_field(printer, "single_seg", packed[3] >> 1 & 1);
   printer->vtbl->boolean_field(printer, "propagate_nans", packed[3] >> 2 & 1);
   printer->vtbl->addr_field(printer, "addr", packed[3] >> 3 << 3);
   printer->vtbl->addr_field(printer, "unifs_addr", packed[4]);
   printer->vtbl->end(printer);
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, "vs", false);
   printer->vtbl->field(printer, "threading", "%s",
      v3d_desc_threading((v3d_threading_t)(packed[5] & 1)));
   printer->vtbl->boolean_field(printer, "single_seg", packed[5] >> 1 & 1);
   printer->vtbl->boolean_field(printer, "propagate_nans", packed[5] >> 2 & 1);
   printer->vtbl->addr_field(printer, "addr", packed[5] >> 3 << 3);
   printer->vtbl->addr_field(printer, "unifs_addr", packed[6]);
   printer->vtbl->end(printer);
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, "cs", false);
   printer->vtbl->field(printer, "threading", "%s",
      v3d_desc_threading((v3d_threading_t)(packed[7] & 1)));
   printer->vtbl->boolean_field(printer, "single_seg", packed[7] >> 1 & 1);
   printer->vtbl->boolean_field(printer, "propagate_nans", packed[7] >> 2 & 1);
   printer->vtbl->addr_field(printer, "addr", packed[7] >> 3 << 3);
   printer->vtbl->addr_field(printer, "unifs_addr", packed[8]);
   printer->vtbl->end(printer);
...
void v3d_print_shadrec_gl_main(const uint32_t *packed, struct v3d_printer *printer)
{
   ...
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, "fs", false);
   printer->vtbl->field(printer, "threading", "%s",
      v3d_desc_threading((v3d_threading_t)(packed[2] & 1)));
   printer->vtbl->boolean_field(printer, "single_seg", packed[2] >> 1 & 1);
   ...
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, "vs", false);
   printer->vtbl->field(printer, "threading", "%s",
      v3d_desc_threading((v3d_threading_t)(packed[4] & 1)));
   printer->vtbl->boolean_field(printer, "single_seg", packed[4] >> 1 & 1);
   ...
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, "cs", false);
   printer->vtbl->field(printer, "threading", "%s",
      v3d_desc_threading((v3d_threading_t)(packed[6] & 1)));
   printer->vtbl->boolean_field(printer, "single_seg", packed[6] >> 1 & 1);
...
void v3d_print_shadrec_gl_geom(const uint32_t *packed, struct v3d_printer *printer)
{
   ...
   printer->vtbl->field(printer, "threading", "%s",
      v3d_desc_threading((v3d_threading_t)(packed[0] & 1)));
   printer->vtbl->boolean_field(printer, "single_seg", packed[0] >> 1 & 1);
...
void v3d_print_shadrec_gl_tess_or_geom(const uint32_t *packed, struct v3d_printer *printer)
{
   ...
   printer->vtbl->field(printer, "geom_num_instances", "%" PRIu32 "",
      gfx_unpack_uint_0_is_max(packed[0] >> 19 & 31, 5));
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, "bin", false);
   printer->vtbl->field(printer, "tcs_batch_flush", "%s",
      v3d_desc_cl_tcs_batch_flush_mode(
      (v3d_cl_tcs_batch_flush_mode_t)(packed[1] & 3)));
   printer->vtbl->field(printer, "per_patch_depth", "%" PRIu32 "",
      gfx_unpack_uint_0_is_max(packed[1] >> 2 & 15, 4));
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, "tcs_output", false);
   ...
   printer->vtbl->end(printer);
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, "tes_output", false);
   printer->vtbl->field(printer, "size_sectors", "%" PRIu32 "",
      gfx_check_urange(packed[1] >> 16 & 63, 0, 16));
   printer->vtbl->field(printer, "pack", "%s", v3d_desc_cl_vpm_pack(
      (v3d_cl_vpm_pack_t)(packed[1] >> 22 & 3)));
   printer->vtbl->end(printer);
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, "geom_output", false);
   printer->vtbl->field(printer, "size_sectors", "%" PRIu32 "",
      gfx_check_urange(packed[1] >> 24 & 63, 0, 16));
   printer->vtbl->field(printer, "pack", "%s", v3d_desc_cl_geom_output_pack(
      (v3d_cl_geom_output_pack_t)(packed[1] >> 30)));
   printer->vtbl->end(printer);
   printer->vtbl->field(printer, "max_patches_per_tcs_batch", "%" PRIu32 "",
      (packed[2] & 15) + 1);
   printer->vtbl->field(printer, "max_extra_vert_segs_per_tcs_batch",
      "%" PRIu32 "", packed[2] >> 4 & 3);
   printer->vtbl->field(printer, "min_tcs_segs", "%" PRIu32 "",
      (packed[2] >> 6 & 7) + 1);
   printer->vtbl->field(printer, "min_per_patch_segs", "%" PRIu32 "",
      (packed[2] >> 9 & 3) + 1);
   printer->vtbl->field(printer, "max_patches_per_tes_batch", "%" PRIu32 "",
      (packed[2] >> 13 & 15) + 1);
   printer->vtbl->field(printer, "max_extra_vert_segs_per_tes_batch",
      "%" PRIu32 "", packed[2] >> 17 & 3);
   printer->vtbl->field(printer, "max_tcs_segs_per_tes_batch", "%" PRIu32 "",
      (packed[2] >> 19 & 7) + 1);
   printer->vtbl->field(printer, "min_tes_segs", "%" PRIu32 "",
      (packed[2] >> 22 & 7) + 1);
   printer->vtbl->field(printer, "max_extra_vert_segs_per_gs_batch",
      "%" PRIu32 "", packed[2] >> 25 & 3);
   printer->vtbl->field(printer, "min_gs_segs", "%" PRIu32 "",
      (packed[2] >> 27 & 7) + 1);
   printer->vtbl->end(printer);
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, "render", false);
   printer->vtbl->field(printer, "tcs_batch_flush", "%s",
      v3d_desc_cl_tcs_batch_flush_mode(
      (v3d_cl_tcs_batch_flush_mode_t)(packed[3] & 3)));
   printer->vtbl->field(printer, "per_patch_depth", "%" PRIu32 "",
   ...
   printer->vtbl->field(printer, "size_sectors", "%" PRIu32 "",
      gfx_check_urange(packed[3] >> 8 & 63, 0, 16));
   printer->vtbl->field(printer, "pack", "%s", v3d_desc_cl_vpm_pack(
      (v3d_cl_vpm_pack_t)(packed[3] >> 14 & 3)));
   printer->vtbl->end(printer);
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, "tes_output", false);
   printer->vtbl->field(printer, "size_sectors", "%" PRIu32 "",
      gfx_check_urange(packed[3] >> 16 & 63, 0, 16));
   printer->vtbl->field(printer, "pack", "%s", v3d_desc_cl_vpm_pack(
      (v3d_cl_vpm_pack_t)(packed[3] >> 22 & 3)));
   printer->vtbl->end(printer);
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, "geom_output", false);
   printer->vtbl->field(printer, "size_sectors", "%" PRIu32 "",
      gfx_check_urange(packed[3] >> 24 & 63, 0, 16));
   ...
   printer->vtbl->field(printer, "max_patches_per_tes_batch", "%" PRIu32 "",
      (packed[4] >> 13 & 15) + 1);
   printer->vtbl->field(printer, "max_extra_vert_segs_per_tes_batch",
      "%" PRIu32 "", packed[4] >> 17 & 3);
   printer->vtbl->field(printer, "max_tcs_segs_per_tes_batch", "%" PRIu32 "",
      (packed[4] >> 19 & 7) + 1);
   printer->vtbl->field(printer, "min_tes_segs", "%" PRIu32 "",
      (packed[4] >> 22 & 7) + 1);
   printer->vtbl->field(printer, "max_extra_vert_segs_per_gs_batch",
      "%" PRIu32 "", packed[4] >> 25 & 3);
   printer->vtbl->field(printer, "min_gs_segs", "%" PRIu32 "",
      (packed[4] >> 27 & 7) + 1);
   printer->vtbl->end(printer);
   printer->vtbl->end(printer);
...
void v3d_print_shadrec_gl_attr(const uint32_t *packed, struct v3d_printer *printer)
{
   ...
   printer->vtbl->field(printer, "max_index", "%" PRIu32 "", packed[3] & 0xffffff);
   printer->vtbl->end(printer);
}
#endif
#if !V3D_VER_AT_LEAST(4,1,34,0)
...
void v3d_print_shadrec_vg(const uint32_t *packed, struct v3d_printer *printer)
{
   ...
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, "fs", false);
   printer->vtbl->field(printer, "threading", "%s",
      v3d_desc_threading((v3d_threading_t)(packed[1] & 1)));
   printer->vtbl->boolean_field(printer, "single_seg", packed[1] >> 1 & 1);
   printer->vtbl->boolean_field(printer, "propagate_nans", packed[1] >> 2 & 1);
   printer->vtbl->addr_field(printer, "addr", packed[1] >> 3 << 3);
   printer->vtbl->addr_field(printer, "unifs_addr", packed[2]);
   printer->vtbl->end(printer);
...
void v3d_print_tmu_param1_cfg0(uint32_t packed0, struct v3d_printer *printer)
{
   ...
   printer->vtbl->field(printer, "filters", "%s", v3d_desc_tmu_filters(
      (v3d_tmu_filters_t)(packed0 >> 4 & 15)));
...
void v3d_print_tmu_param2(uint32_t packed0, struct v3d_printer *printer)
{
   ...
   printer->vtbl->field(printer, "sample_num", "%" PRIu32 "", packed0 >> 2 & 3);
...
void v3d_print_tmu_param2(uint32_t packed0, struct v3d_printer *printer)
{
   ...
   printer->vtbl->field(printer, "op", "%s",
      v3d_desc_tmu_op((v3d_tmu_op_t)(packed0 >> 20 & 15)));
   printer->vtbl->boolean_field(printer, "lod_query", packed0 >> 24 & 1);
   printer->vtbl->end(printer);
}
#endif
#if V3D_HAS_SAMPLER_LOD_DIS
void v3d_print_tmu_param2(uint32_t packed0, struct v3d_printer *printer)
{
   ...
   printer->vtbl->boolean_field(printer, "bslod", packed0 >> 1 & 1);
   printer->vtbl->field(printer, "sample_num", "%" PRIu32 "", packed0 >> 2 & 3);
   printer->vtbl->boolean_field(printer, "sampler_lod_dis", packed0 >> 4 & 1);
   printer->vtbl->field(printer, "gather_comp", "%" PRIu32 "", packed0 >> 5 & 3);
   printer->vtbl->boolean_field(printer, "gather", packed0 >> 7 & 1);
   printer->vtbl->begin(printer, V3D_PRINTER_ARRAY, "offsets", false);
   printer->vtbl->field(printer, "0", "%" PRId32 "",
...
void v3d_print_tlb_config(uint8_t packed0, struct v3d_printer *printer)
{
   ...
   if ((uint32_t)(packed0 >> 6) == 3)
   {
      printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, "color_16", false);
...
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->field(printer, "filters", "%s",
      v3d_desc_tmu_filters((v3d_tmu_filters_t)(packed[0] & 15)));
...
void v3d_print_tmu_indirect(const uint32_t *packed, struct v3d_printer *printer)
{
   ...
   printer->vtbl->field(printer, "base_level", "%" PRIu32 "", packed[7] >> 16 & 15);
   printer->vtbl->field(printer, "samp_num", "%" PRIu32 "", packed[7] >> 20 & 3);
   printer->vtbl->boolean_field(printer, "output_32", packed[7] >> 22 & 1);
   printer->vtbl->field(printer, "ub_pad", "%" PRIu32 "", packed[7] >> 24 & 15);
   printer->vtbl->boolean_field(printer, "ub_xor", packed[7] >> 28 & 1);
   printer->vtbl->boolean_field(printer, "uif_top", packed[7] >> 30 & 1);
   printer->vtbl->boolean_field(printer, "xor_dis", packed[7] >> 31);
...
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->field(printer, "magfilt", "%s", v3d_desc_tmu_filter(
      (v3d_tmu_filter_t)(uint32_t)(packed[0] & 1)));
   printer->vtbl->field(printer, "minfilt", "%s", v3d_desc_tmu_filter(
      (v3d_tmu_filter_t)(uint32_t)(packed[0] >> 1 & 1)));
   printer->vtbl->field(printer, "mipfilt", "%s", v3d_desc_tmu_mipfilt(
      (v3d_tmu_mipfilt_t)(uint32_t)(packed[0] >> 2 & 1)));
   printer->vtbl->boolean_field(printer, "aniso_en",
   ...
   printer->vtbl->field(printer, "max_aniso", "%s", v3d_desc_max_aniso(
      (v3d_max_aniso_t)(uint32_t)(packed[7] >> 5 & 3)));
   printer->vtbl->end(printer);
}
#endif
#if !V3D_VER_AT_LEAST(4,1,34,0)
...
void v3d_print_clip_record(const uint32_t *packed, struct v3d_printer *printer)
{
   ...
   printer->vtbl->field(printer, "2", "%.9g", gfx_float_from_bits(packed[6]));
   printer->vtbl->end(printer);
   printer->vtbl->field(printer, "intedges", "%" PRIu32 "", packed[7] & 7);
   printer->vtbl->end(printer);
}
#endif
...
void v3d_print_cl_compr_ind_common(const uint8_t *packed, struct v3d_printer *printer)
{
   ...
   else if ((uint32_t)(packed[0] & 15) == 3 && (uint32_t)(packed[0] >> 5) == 3)
   {
      ...
      printer->vtbl->boolean_field(printer, "is_first2",
...
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->field(printer, "tech_version", "%" PRIu32 "", packed0 & 15);
   printer->vtbl->field(printer, "revision", "%" PRIu32 "", packed0 >> 4 & 15);
...
void v3d_print_hub_ident3(uint32_t packed0, struct v3d_printer *printer)
{
   ...
   printer->vtbl->field(printer, "sub_rev", "%" PRIu32 "", packed0 >> 8 & 255);
   printer->vtbl->field(printer, "compat_rev", "%" PRIu32 "", packed0 >> 16 & 255);
   printer->vtbl->end(printer);
}
#endif
#if V3D_HAS_L3C
void v3d_print_hub_ident(const uint32_t *packed, struct v3d_printer *printer)
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->field(printer, "tech_version", "%" PRIu32 "", packed[1] & 15);
   printer->vtbl->field(printer, "revision", "%" PRIu32 "", packed[1] >> 4 & 15);
   printer->vtbl->field(printer, "num_cores", "%" PRIu32 "",
      gfx_unpack_uint_0_is_max(packed[1] >> 8 & 15, 4));
   printer->vtbl->field(printer, "num_hosts", "%" PRIu32 "",
      gfx_check_urange(packed[1] >> 12 & 15, 1, 15));
   printer->vtbl->boolean_field(printer, "has_l3c", packed[1] >> 16 & 1);
   printer->vtbl->boolean_field(printer, "has_tfu", packed[1] >> 17 & 1);
   printer->vtbl->boolean_field(printer, "has_tsy", packed[1] >> 18 & 1);
   printer->vtbl->boolean_field(printer, "has_mso", packed[1] >> 19 & 1);
   printer->vtbl->boolean_field(printer, "has_mmu", packed[2] >> 8 & 1);
   printer->vtbl->field(printer, "ip_recipient", "%s", v3d_desc_ip_recipient(
      (v3d_ip_recipient_t)(packed[3] & 255)));
   printer->vtbl->field(printer, "sub_rev", "%" PRIu32 "", packed[3] >> 8 & 255);
   printer->vtbl->field(printer, "compat_rev", "%" PRIu32 "",
      packed[3] >> 16 & 255);
   printer->vtbl->end(printer);
}
#endif
...
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->field(printer, "tech_version", "%" PRIu32 "", packed0 >> 24);
   printer->vtbl->end(printer);
}
#endif
#if !V3D_VER_AT_LEAST(4,1,34,0)
...
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->field(printer, "revision", "%" PRIu32 "", packed0 & 15);
...
#endif
#if !V3D_VER_AT_LEAST(4,1,34,0)
void v3d_print_ident(const uint32_t *packed, struct v3d_printer *printer)
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->field(printer, "tech_version", "%" PRIu32 "", packed[0] >> 24);
   printer->vtbl->field(printer, "revision", "%" PRIu32 "", packed[1] & 15);
   printer->vtbl->field(printer, "num_slices", "%" PRIu32 "",
      gfx_check_urange(packed[1] >> 4 & 15, 1, 15));
   printer->vtbl->field(printer, "num_qpus_per_slice", "%" PRIu32 "",
      gfx_check_urange(packed[1] >> 8 & 15, 1, 15));
   printer->vtbl->field(printer, "num_tmus", "%" PRIu32 "",
      gfx_check_urange(packed[1] >> 12 & 15, 1, 15));
   printer->vtbl->field(printer, "vpm_size_in_multiples_of_8kb", "%" PRIu32 "",
      packed[1] >> 28);
   printer->vtbl->field(printer, "vri_size", "%s",
      v3d_desc_vri_size((v3d_vri_size_t)(packed[2] & 15)));
   printer->vtbl->field(printer, "tlb_size", "%s",
      v3d_desc_tlb_size((v3d_tlb_size_t)(packed[2] >> 4 & 15)));
   printer->vtbl->boolean_field(printer, "tlb_double_buf_support",
      packed[2] >> 8 & 1);
   printer->vtbl->field(printer, "icache_size", "%s",
      v3d_desc_iuc_size((v3d_iuc_size_t)(packed[2] >> 12 & 15)));
   printer->vtbl->field(printer, "ucache_size", "%s",
      v3d_desc_iuc_size((v3d_iuc_size_t)(packed[2] >> 16 & 15)));
   printer->vtbl->boolean_field(printer, "bigend", packed[2] >> 20 & 1);
   printer->vtbl->boolean_field(printer, "endswp_support", packed[2] >> 21 & 1);
   printer->vtbl->boolean_field(printer, "axi_rw_reorder_support",
      packed[2] >> 22 & 1);
   printer->vtbl->boolean_field(printer, "no_earlyz_support", packed[2] >> 23 & 1);
   printer->vtbl->field(printer, "core_index", "%" PRIu32 "", packed[2] >> 24 & 15);
   printer->vtbl->boolean_field(printer, "bcg_interrupt_control",
      packed[2] >> 28 & 1);
   printer->vtbl->boolean_field(printer, "has_astc", packed[2] >> 30 & 1);
   printer->vtbl->field(printer, "ip_recipient", "%s", v3d_desc_ip_recipient(
      (v3d_ip_recipient_t)(packed[3] & 255)));
   printer->vtbl->field(printer, "sub_rev", "%" PRIu32 "", packed[3] >> 8 & 255);
   printer->vtbl->end(printer);
...
void v3d_print_ident(const uint32_t *packed, struct v3d_printer *printer)
{
   ...
   printer->vtbl->boolean_field(printer, "bcg_interrupt_control",
      packed[2] >> 28 & 1);
   printer->vtbl->boolean_field(printer, "has_astc", packed[2] >> 30 & 1);
   printer->vtbl->field(printer, "l2t_ways", "%" PRIu32 "", packed[3] & 15);
   printer->vtbl->field(printer, "l2t_way_depth", "%" PRIu32 "",
      packed[3] >> 4 & 15);
   printer->vtbl->end(printer);
}
#endif
...
void v3d_print_intr(uint32_t packed0, struct v3d_printer *printer)
{
   ...
   printer->vtbl->boolean_field(printer, "trfb", packed0 >> 4 & 1);
   printer->vtbl->boolean_field(printer, "gmpv", packed0 >> 5 & 1);
   printer->vtbl->boolean_field(printer, "pctr", packed0 >> 6 & 1);
   printer->vtbl->boolean_field(printer, "compute_done", packed0 >> 7 & 1);
   printer->vtbl->begin(printer, V3D_PRINTER_ARRAY, "qpu", false);
   printer->vtbl->boolean_field(printer, "0", packed0 >> 16 & 1);
   printer->vtbl->boolean_field(printer, "1", packed0 >> 17 & 1);
   printer->vtbl->boolean_field(printer, "2", packed0 >> 18 & 1);
...
void v3d_print_ct1cfg(uint32_t packed0, struct v3d_printer *printer)
{
   ...
   printer->vtbl->boolean_field(printer, "fill_empty_tiles", packed0 >> 6 & 1);
   printer->vtbl->boolean_field(printer, "skip_empty_tiles", packed0 >> 7 & 1);
   printer->vtbl->end(printer);
}
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
...
#if V3D_VER_AT_LEAST(4,1,34,0)
void v3d_print_ct0qts(uint32_t packed0, struct v3d_printer *printer)
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->boolean_field(printer, "enable", packed0 >> 1 & 1);
   printer->vtbl->addr_field(printer, "tile_state_addr", packed0 >> 6 << 6);
   printer->vtbl->end(printer);
}
#endif
...
#if V3D_VER_AT_LEAST(4,1,34,0)
void v3d_print_srqpc(uint32_t packed0, struct v3d_printer *printer)
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->field(printer, "threading", "%s",
      v3d_desc_threading((v3d_threading_t)(packed0 & 1)));
   printer->vtbl->boolean_field(printer, "single_seg", packed0 >> 1 & 1);
   printer->vtbl->boolean_field(printer, "propagate_nans", packed0 >> 2 & 1);
   printer->vtbl->addr_field(printer, "addr", packed0 >> 3 << 3);
   printer->vtbl->end(printer);
}
#endif
...
#endif
void v3d_print_l2t_cactl(uint32_t packed0, struct v3d_printer *printer)
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->boolean_field(printer, "flush", packed0 & 1);
   printer->vtbl->field(printer, "mode", "%s", v3d_desc_l2t_flush_mode(
      (v3d_l2t_flush_mode_t)(packed0 >> 1 & 3)));
   printer->vtbl->boolean_field(printer, "flush_write_combiner", packed0 >> 8 & 1);
   printer->vtbl->end(printer);
}
#if V3D_HAS_L2T_LOCAL_MEM
void v3d_print_l2t_local_ctrl(uint32_t packed0, struct v3d_printer *printer)
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
...
void v3d_print_gmp_cfg(uint32_t packed0, struct v3d_printer *printer)
{
   ...
   printer->vtbl->boolean_field(printer, "page_cross_detect_enable",
      packed0 >> 2 & 1);
   printer->vtbl->boolean_field(printer, "clear_prot_bits", packed0 >> 31);
   printer->vtbl->end(printer);
}
#endif
#if V3D_VER_AT_LEAST(3,3,0,0) && !V3D_VER_AT_LEAST(4,1,34,0)
...
#endif
#if !V3D_VER_AT_LEAST(3,3,0,0)
void v3d_print_gmp_cs(uint32_t packed0, struct v3d_printer *printer)
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->boolean_field(printer, "read_vio", packed0 & 1);
   printer->vtbl->boolean_field(printer, "write_vio", packed0 >> 1 & 1);
   printer->vtbl->boolean_field(printer, "invalid_table", packed0 >> 2 & 1);
   printer->vtbl->boolean_field(printer, "counter_overflow", packed0 >> 3 & 1);
   printer->vtbl->boolean_field(printer, "load_busy", packed0 >> 7 & 1);
   printer->vtbl->boolean_field(printer, "ardwait", packed0 >> 8 & 1);
   printer->vtbl->boolean_field(printer, "arost", packed0 >> 9 & 1);
   printer->vtbl->boolean_field(printer, "arqbusy", packed0 >> 10 & 1);
   printer->vtbl->boolean_field(printer, "awbwait", packed0 >> 12 & 1);
   printer->vtbl->boolean_field(printer, "awost", packed0 >> 13 & 1);
   printer->vtbl->boolean_field(printer, "awqbusy", packed0 >> 14 & 1);
   printer->vtbl->boolean_field(printer, "awburst", packed0 >> 15 & 1);
   printer->vtbl->boolean_field(printer, "stop_request", packed0 >> 16 & 1);
   printer->vtbl->boolean_field(printer, "clear_prot_bits", packed0 >> 30 & 1);
   printer->vtbl->boolean_field(printer, "reset", packed0 >> 31);
   printer->vtbl->end(printer);
}
#endif
...
void v3d_print_gmp_status(uint32_t packed0, struct v3d_printer *printer)
{
   ...
   printer->vtbl->boolean_field(printer, "cfg_busy", packed0 >> 3 & 1);
...
void v3d_print_gmp_status(uint32_t packed0, struct v3d_printer *printer)
{
   ...
   printer->vtbl->boolean_field(printer, "read_active", packed0 >> 4 & 1);
   printer->vtbl->boolean_field(printer, "write_active", packed0 >> 5 & 1);
   printer->vtbl->field(printer, "read_count", "%" PRIu32 "", packed0 >> 16 & 255);
   printer->vtbl->field(printer, "write_count", "%" PRIu32 "", packed0 >> 24);
   printer->vtbl->end(printer);
}
#endif
#if !V3D_VER_AT_LEAST(3,3,0,0)
void v3d_print_gmp_vio_type(uint32_t packed0, struct v3d_printer *printer)
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->field(printer, "length", "%" PRIu32 "", (packed0 & 15) + 1);
   printer->vtbl->field(printer, "axi_internal_id", "%" PRIu32 "",
      packed0 >> 16 & 31);
   printer->vtbl->field(printer, "axi_master_id", "%s", v3d_desc_axi_master_id(
      (v3d_axi_master_id_t)(packed0 >> 21 & 15)));
   printer->vtbl->end(printer);
}
#endif
#if V3D_VER_AT_LEAST(3,3,0,0) && !V3D_VER_AT_LEAST(4,1,34,0)
void v3d_print_gmp_vio_type(uint32_t packed0, struct v3d_printer *printer)
{
   ...
   printer->vtbl->field(printer, "axi_master_id", "%s", v3d_desc_axi_master_id(
      (v3d_axi_master_id_t)(packed0 >> 21 & 15)));
   printer->vtbl->boolean_field(printer, "write", packed0 >> 30 & 1);
   printer->vtbl->boolean_field(printer, "valid", packed0 >> 31);
   printer->vtbl->end(printer);
}
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
void v3d_print_gmp_vio_type(uint32_t packed0, struct v3d_printer *printer)
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->field(printer, "length", "%" PRIu32 "", (packed0 & 15) + 1);
   printer->vtbl->field(printer, "l2t_master_id", "%s", v3d_desc_l2t_master_id(
      (v3d_l2t_master_id_t)(packed0 >> 4 & 15)));
   printer->vtbl->field(printer, "axi_internal_id", "%" PRIu32 "",
      packed0 >> 16 & 31);
   printer->vtbl->field(printer, "axi_master_id", "%s", v3d_desc_axi_master_id(
      (v3d_axi_master_id_t)(packed0 >> 21 & 15)));
...
#endif
void v3d_print_tsy_config0(uint32_t packed0, struct v3d_printer *printer)
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->field(printer, "version", "%" PRIu32 "", packed0 & 255);
   printer->vtbl->end(printer);
}
void v3d_print_tsy_config1(uint32_t packed0, struct v3d_printer *printer)
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->field(printer, "num_objects", "%" PRIu32 "", packed0 & 0xffff);
   printer->vtbl->field(printer, "num_threads", "%" PRIu32 "", packed0 >> 16);
   printer->vtbl->end(printer);
}
void v3d_print_tsy_control(uint32_t packed0, struct v3d_printer *printer)
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->begin(printer, V3D_PRINTER_ARRAY, "core_enable", false);
   printer->vtbl->boolean_field(printer, "0", packed0 & 1);
   printer->vtbl->boolean_field(printer, "1", packed0 >> 1 & 1);
   printer->vtbl->boolean_field(printer, "2", packed0 >> 2 & 1);
   printer->vtbl->boolean_field(printer, "3", packed0 >> 3 & 1);
   printer->vtbl->boolean_field(printer, "4", packed0 >> 4 & 1);
   printer->vtbl->boolean_field(printer, "5", packed0 >> 5 & 1);
   printer->vtbl->boolean_field(printer, "6", packed0 >> 6 & 1);
   printer->vtbl->boolean_field(printer, "7", packed0 >> 7 & 1);
   printer->vtbl->boolean_field(printer, "8", packed0 >> 8 & 1);
   printer->vtbl->boolean_field(printer, "9", packed0 >> 9 & 1);
   printer->vtbl->boolean_field(printer, "10", packed0 >> 10 & 1);
   printer->vtbl->boolean_field(printer, "11", packed0 >> 11 & 1);
   printer->vtbl->boolean_field(printer, "12", packed0 >> 12 & 1);
   printer->vtbl->boolean_field(printer, "13", packed0 >> 13 & 1);
   printer->vtbl->boolean_field(printer, "14", packed0 >> 14 & 1);
   printer->vtbl->boolean_field(printer, "15", packed0 >> 15 & 1);
   printer->vtbl->end(printer);
   printer->vtbl->end(printer);
}
#if !V3D_VER_AT_LEAST(4,1,34,0)
void v3d_print_tsy_status(uint32_t packed0, struct v3d_printer *printer)
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->boolean_field(printer, "busy", packed0 & 1);
   printer->vtbl->end(printer);
...
void v3d_print_tsy_status(uint32_t packed0, struct v3d_printer *printer)
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->boolean_field(printer, "busy", packed0 & 1);
   printer->vtbl->boolean_field(printer, "apb_busy", packed0 >> 1 & 1);
   printer->vtbl->end(printer);
}
#endif
void v3d_print_tsy_tso_data(uint32_t packed0, struct v3d_printer *printer)
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->field(printer, "num_waiting", "%" PRIu32 "", packed0 & 0xffff);
   printer->vtbl->field(printer, "quorum", "%" PRIu32 "", packed0 >> 16);
   printer->vtbl->end(printer);
}
#if V3D_VER_AT_LEAST(4,1,34,0)
void v3d_print_csd_status(uint32_t packed0, struct v3d_printer *printer)
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->boolean_field(printer, "have_queued_dispatch", packed0 & 1);
   printer->vtbl->boolean_field(printer, "have_current_dispatch", packed0 >> 1 & 1);
   printer->vtbl->field(printer, "num_active_dispatches", "%" PRIu32 "",
      packed0 >> 2 & 3);
   printer->vtbl->field(printer, "num_completed_dispatches", "%" PRIu32 "",
      packed0 >> 4 & 255);
   printer->vtbl->end(printer);
}
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
void v3d_print_csd_cfg0(uint32_t packed0, struct v3d_printer *printer)
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->field(printer, "wg_x_offset", "%" PRIu32 "", packed0 & 0xffff);
   printer->vtbl->field(printer, "num_wgs_x", "%" PRIu32 "",
      gfx_unpack_uint_0_is_max(packed0 >> 16, 16));
   printer->vtbl->end(printer);
}
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
void v3d_print_csd_cfg1(uint32_t packed0, struct v3d_printer *printer)
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->field(printer, "wg_y_offset", "%" PRIu32 "", packed0 & 0xffff);
   printer->vtbl->field(printer, "num_wgs_y", "%" PRIu32 "",
      gfx_unpack_uint_0_is_max(packed0 >> 16, 16));
   printer->vtbl->end(printer);
}
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
void v3d_print_csd_cfg2(uint32_t packed0, struct v3d_printer *printer)
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->field(printer, "wg_z_offset", "%" PRIu32 "", packed0 & 0xffff);
   printer->vtbl->field(printer, "num_wgs_z", "%" PRIu32 "",
      gfx_unpack_uint_0_is_max(packed0 >> 16, 16));
   printer->vtbl->end(printer);
}
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
void v3d_print_csd_cfg3(uint32_t packed0, struct v3d_printer *printer)
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->field(printer, "wg_size", "%" PRIu32 "",
      gfx_unpack_uint_0_is_max(packed0 & 255, 8));
   printer->vtbl->field(printer, "wgs_per_sg", "%" PRIu32 "",
      gfx_unpack_uint_0_is_max(packed0 >> 8 & 15, 4));
   printer->vtbl->field(printer, "batches_per_sg", "%" PRIu32 "",
      (packed0 >> 12 & 255) + 1);
   printer->vtbl->field(printer, "max_sg_id", "%" PRIu32 "", packed0 >> 20 & 63);
   printer->vtbl->boolean_field(printer, "overlap_with_prev", packed0 >> 26 & 1);
   printer->vtbl->end(printer);
}
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
void v3d_print_csd_cfg4(uint32_t packed0, struct v3d_printer *printer)
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->field(printer, "num_batches", "%" PRIu64 "",
      (uint64_t)packed0 + 1);
   printer->vtbl->end(printer);
}
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
void v3d_print_csd_cfg5(uint32_t packed0, struct v3d_printer *printer)
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->field(printer, "threading", "%s",
      v3d_desc_threading((v3d_threading_t)(packed0 & 1)));
   printer->vtbl->boolean_field(printer, "single_seg", packed0 >> 1 & 1);
   printer->vtbl->boolean_field(printer, "propagate_nans", packed0 >> 2 & 1);
   printer->vtbl->addr_field(printer, "shader_addr", packed0 >> 3 << 3);
   printer->vtbl->end(printer);
}
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
void v3d_print_csd_cfg6(uint32_t packed0, struct v3d_printer *printer)
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->addr_field(printer, "unifs_addr", packed0 >> 2 << 2);
   printer->vtbl->end(printer);
}
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
void v3d_print_csd_cfg(const uint32_t *packed, struct v3d_printer *printer)
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->field(printer, "wg_x_offset", "%" PRIu32 "", packed[0] & 0xffff);
   printer->vtbl->field(printer, "num_wgs_x", "%" PRIu32 "",
      gfx_unpack_uint_0_is_max(packed[0] >> 16, 16));
   printer->vtbl->field(printer, "wg_y_offset", "%" PRIu32 "", packed[1] & 0xffff);
   printer->vtbl->field(printer, "num_wgs_y", "%" PRIu32 "",
      gfx_unpack_uint_0_is_max(packed[1] >> 16, 16));
   printer->vtbl->field(printer, "wg_z_offset", "%" PRIu32 "", packed[2] & 0xffff);
   printer->vtbl->field(printer, "num_wgs_z", "%" PRIu32 "",
      gfx_unpack_uint_0_is_max(packed[2] >> 16, 16));
   printer->vtbl->field(printer, "wg_size", "%" PRIu32 "",
      gfx_unpack_uint_0_is_max(packed[3] & 255, 8));
   printer->vtbl->field(printer, "wgs_per_sg", "%" PRIu32 "",
      gfx_unpack_uint_0_is_max(packed[3] >> 8 & 15, 4));
   printer->vtbl->field(printer, "batches_per_sg", "%" PRIu32 "",
      (packed[3] >> 12 & 255) + 1);
   printer->vtbl->field(printer, "max_sg_id", "%" PRIu32 "", packed[3] >> 20 & 63);
   printer->vtbl->boolean_field(printer, "overlap_with_prev", packed[3] >> 26 & 1);
   printer->vtbl->field(printer, "num_batches", "%" PRIu64 "",
      (uint64_t)packed[4] + 1);
   printer->vtbl->field(printer, "threading", "%s",
      v3d_desc_threading((v3d_threading_t)(packed[5] & 1)));
   printer->vtbl->boolean_field(printer, "single_seg", packed[5] >> 1 & 1);
   printer->vtbl->boolean_field(printer, "propagate_nans", packed[5] >> 2 & 1);
   printer->vtbl->addr_field(printer, "shader_addr", packed[5] >> 3 << 3);
   printer->vtbl->addr_field(printer, "unifs_addr", packed[6] >> 2 << 2);
   printer->vtbl->end(printer);
}
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
void v3d_print_csd_id0(uint32_t packed0, struct v3d_printer *printer)
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->field(printer, "l_idx", "%" PRIu32 "", packed0 & 255);
   printer->vtbl->field(printer, "wg_in_sg", "%" PRIu32 "", packed0 >> 8 & 15);
   printer->vtbl->field(printer, "wg_x", "%" PRIu32 "", packed0 >> 16);
   printer->vtbl->end(printer);
}
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
void v3d_print_csd_id1(uint32_t packed0, struct v3d_printer *printer)
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->field(printer, "wg_y", "%" PRIu32 "", packed0 & 0xffff);
   printer->vtbl->field(printer, "wg_z", "%" PRIu32 "", packed0 >> 16);
   printer->vtbl->end(printer);
}
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
void v3d_print_csd_id(const uint32_t *packed, struct v3d_printer *printer)
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->field(printer, "l_idx", "%" PRIu32 "", packed[0] & 255);
   printer->vtbl->field(printer, "wg_in_sg", "%" PRIu32 "", packed[0] >> 8 & 15);
   printer->vtbl->field(printer, "wg_x", "%" PRIu32 "", packed[0] >> 16);
   printer->vtbl->field(printer, "wg_y", "%" PRIu32 "", packed[1] & 0xffff);
   printer->vtbl->field(printer, "wg_z", "%" PRIu32 "", packed[1] >> 16);
   printer->vtbl->end(printer);
}
#endif
...
uint32_t v3d_cl_instr_size(v3d_cl_opcode_t opcode)
{
   ...
   case V3D_CL_CLEAR_VCD_CACHE: return V3D_CL_CLEAR_VCD_CACHE_SIZE;
...
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_CL_INDEX_BUFFER_SETUP: return V3D_CL_INDEX_BUFFER_SETUP_SIZE;
#endif
#if !V3D_VER_AT_LEAST(4,1,34,0)
...
#endif
   case V3D_CL_SET_PRIMITIVE_ID: return V3D_CL_SET_PRIMITIVE_ID_SIZE;
   ...
   case V3D_CL_CLEAR_SLICE_CACHES: return V3D_CL_CLEAR_SLICE_CACHES_SIZE;
   case V3D_CL_FLUSH_L2T: return V3D_CL_FLUSH_L2T_SIZE;
#if !V3D_VER_AT_LEAST(3,3,0,0)
   case V3D_CL_CLEAR_L2C: return V3D_CL_CLEAR_L2C_SIZE;
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_CL_CLEAN_L1TD_DEFERRED: return V3D_CL_CLEAN_L1TD_DEFERRED_SIZE;
#endif
...
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_CL_ZERO_ALL_NOPERSPECTIVE_FLAGS: return V3D_CL_ZERO_ALL_NOPERSPECTIVE_FLAGS_SIZE;
#endif
#if !V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_CL_CENTROID_FLAGS:
   ...
   case V3D_CL_CENTROID_FLAGS:
   case V3D_CL_FLATSHADE_FLAGS:
   case V3D_CL_NOPERSPECTIVE_FLAGS: return V3D_CL_VARY_FLAGS_SIZE;
#endif
#if !V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_CL_SAMPLE_STATE: return V3D_CL_SAMPLE_STATE_SIZE;
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_CL_SAMPLE_STATE: return V3D_CL_SAMPLE_STATE_SIZE;
#endif
...
bool v3d_cl_instr_ok_in_bin(v3d_cl_opcode_t opcode)
{
   ...
   case V3D_CL_CLEAR_VCD_CACHE: return true;
...
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_CL_INDEX_BUFFER_SETUP: return true;
#endif
#if !V3D_VER_AT_LEAST(4,1,34,0)
...
#endif
   case V3D_CL_SET_PRIMITIVE_ID: return true;
   ...
   case V3D_CL_CLEAR_SLICE_CACHES: return true;
   case V3D_CL_FLUSH_L2T: return true;
#if !V3D_VER_AT_LEAST(3,3,0,0)
   case V3D_CL_CLEAR_L2C: return true;
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_CL_CLEAN_L1TD_DEFERRED: return true;
#endif
...
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_CL_ZERO_ALL_NOPERSPECTIVE_FLAGS: return true;
#endif
#if !V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_CL_CENTROID_FLAGS:
   ...
   case V3D_CL_CENTROID_FLAGS:
   case V3D_CL_FLATSHADE_FLAGS:
   case V3D_CL_NOPERSPECTIVE_FLAGS: return true;
#endif
#if !V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_CL_SAMPLE_STATE: return true;
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_CL_SAMPLE_STATE: return true;
#endif
...
bool v3d_cl_instr_ok_in_render(v3d_cl_opcode_t opcode)
{
...
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_CL_INDEX_BUFFER_SETUP: return false;
#endif
#if !V3D_VER_AT_LEAST(4,1,34,0)
   ...
   case V3D_CL_SET_INSTANCE_ID: return true;
#endif
   case V3D_CL_SET_PRIMITIVE_ID: return false;
...
bool v3d_cl_instr_ok_in_tile_list(v3d_cl_opcode_t opcode)
{
   ...
   case V3D_CL_BRANCH_SUB: return true;
   case V3D_CL_RETURN: return true;
   case V3D_CL_CLEAR_VCD_CACHE: return false;
   case V3D_CL_GENERIC_TILE_LIST: return false;
   case V3D_CL_BRANCH_IMPLICIT_TILE: return false;
   case V3D_CL_BRANCH_EXPLICIT_SUPERTILE: return false;
   case V3D_CL_SUPERTILE_COORDS: return false;
...
#endif
   case V3D_CL_FLUSH_TRANSFORM_FEEDBACK_DATA: return false;
   case V3D_CL_CLEAR_SLICE_CACHES: return false;
   case V3D_CL_FLUSH_L2T: return false;
#if !V3D_VER_AT_LEAST(3,3,0,0)
   case V3D_CL_CLEAR_L2C: return false;
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_CL_CLEAN_L1TD_DEFERRED: return false;
#endif
   case V3D_CL_STENCIL_CFG: return true;
#if !V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_CL_BLEND_CFG: return true;
...
void v3d_cl_print_clear_vcd_cache(const uint8_t *packed, struct v3d_printer *printer)
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->end(printer);
}
...
void v3d_cl_print_store(const uint8_t *packed, struct v3d_printer *printer)
{
   ...
   printer->vtbl->boolean_field(printer, "chan_reverse",
      (uint32_t)(packed[2] >> 3 & 1));
   printer->vtbl->boolean_field(printer, "rb_swap", (uint32_t)(packed[2] >> 4 & 1));
...
void v3d_cl_print_load(const uint8_t *packed, struct v3d_printer *printer)
{
   ...
   printer->vtbl->field(printer, "pixel_format", "%s", v3d_desc_pixel_format(
      (v3d_pixel_format_t)((uint32_t)(packed[1] >> 4) |
      (uint32_t)(packed[2] & 3) << 4)));
   printer->vtbl->boolean_field(printer, "alpha_to_one",
...
void v3d_cl_print_indexed_prim_list(const uint8_t *packed, struct v3d_printer *printer)
{
   ...
   printer->vtbl->boolean_field(printer, "prim_restart",
      (uint32_t)(packed[4] >> 7));
   printer->vtbl->field(printer, "indices_offset", "%" PRIu32 "",
      (uint32_t)packed[5] | (uint32_t)packed[6] << 8 | (uint32_t)packed[7] << 16 |
      (uint32_t)packed[8] << 24);
   printer->vtbl->end(printer);
}
...
#if V3D_VER_AT_LEAST(4,1,34,0)
void v3d_cl_print_index_buffer_setup(const uint8_t *packed, struct v3d_printer *printer)
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->addr_field(printer, "addr",
      (uint32_t)packed[0] | (uint32_t)packed[1] << 8 | (uint32_t)packed[2] << 16 |
...
#endif
void v3d_cl_print_set_primitive_id(const uint8_t *packed, struct v3d_printer *printer)
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->field(printer, "initial_prim_id", "%" PRIu32 "",
      (uint32_t)packed[0] | (uint32_t)packed[1] << 8 | (uint32_t)packed[2] << 16 |
      (uint32_t)packed[3] << 24);
   printer->vtbl->end(printer);
}
...
void v3d_cl_print_vg_inline_shader(const uint8_t *packed, struct v3d_printer *printer)
{
   ...
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, "fs", false);
   printer->vtbl->field(printer, "threading", "%s", v3d_desc_threading(
      (v3d_threading_t)(uint32_t)(packed[0] & 1)));
   printer->vtbl->boolean_field(printer, "single_seg",
      (uint32_t)(packed[0] >> 1 & 1));
   printer->vtbl->boolean_field(printer, "propagate_nans",
      (uint32_t)(packed[0] >> 2 & 1));
   printer->vtbl->addr_field(printer, "addr",
...
void v3d_cl_print_clear_slice_caches(const uint8_t *packed, struct v3d_printer *printer)
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->field(printer, "sic", "0x%01x", (uint32_t)(packed[0] & 15));
   printer->vtbl->field(printer, "suc", "0x%01x", (uint32_t)(packed[0] >> 4));
   printer->vtbl->field(printer, "l1td", "0x%01x", (uint32_t)(packed[1] & 15));
   printer->vtbl->field(printer, "l1tc", "0x%01x", (uint32_t)(packed[1] >> 4));
   printer->vtbl->end(printer);
}
void v3d_cl_print_flush_l2t(const uint8_t *packed, struct v3d_printer *printer)
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->addr_field(printer, "start_addr",
      (uint32_t)packed[0] | (uint32_t)packed[1] << 8 | (uint32_t)packed[2] << 16 |
      (uint32_t)packed[3] << 24);
   printer->vtbl->addr_field(printer, "end_addr",
      (uint32_t)packed[4] | (uint32_t)packed[5] << 8 | (uint32_t)packed[6] << 16 |
      (uint32_t)packed[7] << 24);
   printer->vtbl->field(printer, "mode", "%s", v3d_desc_l2t_flush_mode(
      (v3d_l2t_flush_mode_t)(uint32_t)(packed[8] & 3)));
   printer->vtbl->boolean_field(printer, "deferred",
      (uint32_t)(packed[8] >> 2 & 1));
   printer->vtbl->end(printer);
}
#if !V3D_VER_AT_LEAST(3,3,0,0)
void v3d_cl_print_clear_l2c(const uint8_t *packed, struct v3d_printer *printer)
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->end(printer);
}
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
void v3d_cl_print_clean_l1td_deferred(const uint8_t *packed, struct v3d_printer *printer)
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->end(printer);
}
...
{
   printer->vtbl->field(printer, NULL, "0x%08x", gfx_check_urange(
      (uint32_t)packed[0] | (uint32_t)packed[1] << 8 | (uint32_t)packed[2] << 16 |
      (uint32_t)packed[3] << 24, 0, 0xffff));
}
...
#if V3D_VER_AT_LEAST(4,1,34,0)
void v3d_cl_print_zero_all_noperspective_flags(const uint8_t *packed, struct v3d_printer *printer)
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->end(printer);
}
...
#endif
#if !V3D_VER_AT_LEAST(4,1,34,0)
void v3d_cl_print_sample_state(const uint8_t *packed, struct v3d_printer *printer)
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->field(printer, "coverage", "%.9g", gfx_float_from_bits(
      (uint32_t)packed[0] | (uint32_t)packed[1] << 8 | (uint32_t)packed[2] << 16 |
      (uint32_t)packed[3] << 24));
   printer->vtbl->end(printer);
}
...
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->field(printer, "mask", "0x%01x", (uint32_t)(packed[0] & 15));
   printer->vtbl->field(printer, "coverage", "%.4g", gfx_float_from_bits(
...
void v3d_cl_print_depth_offset(const uint8_t *packed, struct v3d_printer *printer)
{
   ...
   printer->vtbl->field(printer, "units", "%.4g", gfx_float_from_bits(
      ((uint32_t)packed[2] | (uint32_t)packed[3] << 8) << 16));
   printer->vtbl->field(printer, "limit", "%.9g", gfx_float_from_bits(
      (uint32_t)packed[4] | (uint32_t)packed[5] << 8 | (uint32_t)packed[6] << 16 |
      (uint32_t)packed[7] << 24));
   printer->vtbl->end(printer);
}
...
void v3d_cl_print_clip(const uint8_t *packed, struct v3d_printer *printer)
{
   ...
   printer->vtbl->field(printer, "width", "%" PRIu32 "", gfx_check_urange(
      (uint32_t)packed[4] | (uint32_t)packed[5] << 8, 0, 0x1000));
   printer->vtbl->field(printer, "height", "%" PRIu32 "", gfx_check_urange(
      (uint32_t)packed[6] | (uint32_t)packed[7] << 8, 0, 0x1000));
   printer->vtbl->end(printer);
}
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
void v3d_cl_print_viewport_offset(const uint8_t *packed, struct v3d_printer *printer)
{
   ...
   printer->vtbl->field(printer, "x", "%" PRIu32 "",
      (uint32_t)packed[0] | (uint32_t)packed[1] << 8 |
      (uint32_t)(packed[2] & 63) << 16);
   printer->vtbl->field(printer, "coarse_x", "%" PRId32 "", gfx_sext(
      (uint32_t)(packed[2] >> 6) | (uint32_t)packed[3] << 2, 10));
   printer->vtbl->field(printer, "y", "%" PRIu32 "",
      (uint32_t)packed[4] | (uint32_t)packed[5] << 8 |
      (uint32_t)(packed[6] & 63) << 16);
   printer->vtbl->field(printer, "coarse_y", "%" PRId32 "", gfx_sext(
      (uint32_t)(packed[6] >> 6) | (uint32_t)packed[7] << 2, 10));
   printer->vtbl->end(printer);
}
#endif
#if !V3D_VER_AT_LEAST(4,1,34,0)
...
void v3d_cl_print_tile_binning_mode_cfg(const uint8_t *packed, struct v3d_printer *printer)
{
   ...
   printer->vtbl->field(printer, "num_rts", "%" PRIu32 "",
      gfx_check_urange((uint32_t)(packed[1] & 15) + 1, 1, 4));
   printer->vtbl->field(printer, "max_bpp", "%s", v3d_desc_rt_bpp(
      (v3d_rt_bpp_t)(uint32_t)(packed[1] >> 4 & 3)));
   printer->vtbl->boolean_field(printer, "ms_mode", (uint32_t)(packed[1] >> 6 & 1));
   printer->vtbl->boolean_field(printer, "double_buffer",
      (uint32_t)(packed[1] >> 7));
   printer->vtbl->field(printer, "w_in_pixels", "%" PRIu32 "",
      ((uint32_t)packed[4] | (uint32_t)packed[5] << 8) + 1);
   printer->vtbl->field(printer, "h_in_pixels", "%" PRIu32 "",
      ((uint32_t)packed[6] | (uint32_t)packed[7] << 8) + 1);
   printer->vtbl->end(printer);
}
#endif
#if !V3D_VER_AT_LEAST(4,1,34,0)
void v3d_cl_print_tile_binning_mode_cfg(const uint8_t *packed, struct v3d_printer *printer)
{
   ...
   if ((uint32_t)(packed[0] & 1) == 0)
   {
      ...
      printer->vtbl->field(printer, "num_rts", "%" PRIu32 "",
         gfx_check_urange((uint32_t)(packed[7] & 15), 0, 4));
      printer->vtbl->field(printer, "max_bpp", "%s", v3d_desc_rt_bpp(
...
void v3d_cl_print_tile_rendering_mode_cfg(const uint8_t *packed, struct v3d_printer *printer)
{
   ...
   if ((uint32_t)(packed[0] & 15) == 0)
   {
      ...
      printer->vtbl->field(printer, "num_rts", "%" PRIu32 "",
         gfx_check_urange((uint32_t)(packed[0] >> 4) + 1, 1, 4));
   ...
   else if ((uint32_t)(packed[0] & 15) == 1)
   {
      ...
      printer->vtbl->begin(printer, V3D_PRINTER_ARRAY, "rt_formats", false);
      printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, "0", false);
      printer->vtbl->field(printer, "bpp", "%s", v3d_desc_rt_bpp(
         (v3d_rt_bpp_t)(uint32_t)(packed[0] >> 4 & 3)));
      printer->vtbl->field(printer, "type", "%s", v3d_desc_rt_type(
         (v3d_rt_type_t)((uint32_t)(packed[0] >> 6) | (uint32_t)(packed[1] & 3) << 2)));
      printer->vtbl->field(printer, "clamp", "%s", v3d_desc_rt_clamp(
         (v3d_rt_clamp_t)(uint32_t)(packed[1] >> 2 & 3)));
      printer->vtbl->end(printer);
      printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, "1", false);
      printer->vtbl->field(printer, "bpp", "%s", v3d_desc_rt_bpp(
         (v3d_rt_bpp_t)(uint32_t)(packed[1] >> 4 & 3)));
      printer->vtbl->field(printer, "type", "%s", v3d_desc_rt_type(
         (v3d_rt_type_t)((uint32_t)(packed[1] >> 6) | (uint32_t)(packed[2] & 3) << 2)));
      printer->vtbl->field(printer, "clamp", "%s", v3d_desc_rt_clamp(
         (v3d_rt_clamp_t)(uint32_t)(packed[2] >> 2 & 3)));
      printer->vtbl->end(printer);
      printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, "2", false);
      printer->vtbl->field(printer, "bpp", "%s", v3d_desc_rt_bpp(
         (v3d_rt_bpp_t)(uint32_t)(packed[2] >> 4 & 3)));
      printer->vtbl->field(printer, "type", "%s", v3d_desc_rt_type(
         (v3d_rt_type_t)((uint32_t)(packed[2] >> 6) | (uint32_t)(packed[3] & 3) << 2)));
      printer->vtbl->field(printer, "clamp", "%s", v3d_desc_rt_clamp(
         (v3d_rt_clamp_t)(uint32_t)(packed[3] >> 2 & 3)));
      printer->vtbl->end(printer);
      printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, "3", false);
      printer->vtbl->field(printer, "bpp", "%s", v3d_desc_rt_bpp(
         (v3d_rt_bpp_t)(uint32_t)(packed[3] >> 4 & 3)));
      printer->vtbl->field(printer, "type", "%s", v3d_desc_rt_type(
         (v3d_rt_type_t)((uint32_t)(packed[3] >> 6) | (uint32_t)(packed[4] & 3) << 2)));
      printer->vtbl->field(printer, "clamp", "%s", v3d_desc_rt_clamp(
         (v3d_rt_clamp_t)(uint32_t)(packed[4] >> 2 & 3)));
      printer->vtbl->end(printer);
      printer->vtbl->end(printer);
      printer->vtbl->end(printer);
   }
   ...
   else if ((uint32_t)(packed[0] & 15) == 3)
   {
      ...
      printer->vtbl->field(printer, "rt", "%" PRIu32 "",
         gfx_check_urange((uint32_t)(packed[0] >> 4), 0, 3));
...
void v3d_cl_print_instr(const uint8_t *packed_instr, struct v3d_printer *printer)
{
   ...
   case V3D_CL_CLEAR_VCD_CACHE: v3d_cl_print_clear_vcd_cache(packed_instr + 1, printer); break;
...
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_CL_INDEX_BUFFER_SETUP: v3d_cl_print_index_buffer_setup(packed_instr + 1, printer); break;
#endif
#if !V3D_VER_AT_LEAST(4,1,34,0)
...
#endif
   case V3D_CL_SET_PRIMITIVE_ID: v3d_cl_print_set_primitive_id(packed_instr + 1, printer); break;
   ...
   case V3D_CL_CLEAR_SLICE_CACHES: v3d_cl_print_clear_slice_caches(packed_instr + 1, printer); break;
   case V3D_CL_FLUSH_L2T: v3d_cl_print_flush_l2t(packed_instr + 1, printer); break;
#if !V3D_VER_AT_LEAST(3,3,0,0)
   case V3D_CL_CLEAR_L2C: v3d_cl_print_clear_l2c(packed_instr + 1, printer); break;
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_CL_CLEAN_L1TD_DEFERRED: v3d_cl_print_clean_l1td_deferred(packed_instr + 1, printer); break;
#endif
...
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_CL_ZERO_ALL_NOPERSPECTIVE_FLAGS: v3d_cl_print_zero_all_noperspective_flags(packed_instr + 1, printer); break;
#endif
#if !V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_CL_CENTROID_FLAGS:
   ...
   case V3D_CL_CENTROID_FLAGS:
   case V3D_CL_FLATSHADE_FLAGS:
   case V3D_CL_NOPERSPECTIVE_FLAGS: v3d_cl_print_vary_flags(packed_instr + 1, printer); break;
#endif
#if !V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_CL_SAMPLE_STATE: v3d_cl_print_sample_state(packed_instr + 1, printer); break;
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_CL_SAMPLE_STATE: v3d_cl_print_sample_state(packed_instr + 1, printer); break;
#endif
...
void v3d_cl_unpack_store(V3D_CL_STORE_T *unpacked, const uint8_t *packed)
{
   ...
   (*unpacked).chan_reverse = (uint32_t)(packed[2] >> 3 & 1);
   (*unpacked).rb_swap = (uint32_t)(packed[2] >> 4 & 1);
...
void v3d_cl_unpack_load(V3D_CL_LOAD_T *unpacked, const uint8_t *packed)
{
   ...
   (*unpacked).pixel_format = (v3d_pixel_format_t)((uint32_t)(packed[1] >> 4) |
      (uint32_t)(packed[2] & 3) << 4);
   (*unpacked).alpha_to_one = (uint32_t)(packed[2] >> 2 & 1);
   (*unpacked).chan_reverse = (uint32_t)(packed[2] >> 3 & 1);
   (*unpacked).rb_swap = (uint32_t)(packed[2] >> 4 & 1);
   (*unpacked).stride = (uint32_t)(packed[3] >> 4) | (uint32_t)packed[4] << 4 |
      (uint32_t)packed[5] << 12;
...
void v3d_cl_pack_indexed_prim_list(uint8_t *packed, const V3D_CL_INDEXED_PRIM_LIST_T *unpacked)
{
   ...
   packed[5] = (uint8_t)(*unpacked).indices_offset;
   packed[6] = (uint8_t)((*unpacked).indices_offset >> 8);
   packed[7] = (uint8_t)((*unpacked).indices_offset >> 16);
   packed[8] = (uint8_t)((*unpacked).indices_offset >> 24);
}
void v3d_cl_unpack_indexed_prim_list(V3D_CL_INDEXED_PRIM_LIST_T *unpacked, const uint8_t *packed)
{
   ...
   (*unpacked).indices_offset = (uint32_t)packed[5] | (uint32_t)packed[6] << 8 |
      (uint32_t)packed[7] << 16 | (uint32_t)packed[8] << 24;
}
#endif
#if !V3D_VER_AT_LEAST(4,1,34,0)
...
void v3d_cl_pack_indexed_instanced_prim_list(uint8_t *packed, const V3D_CL_INDEXED_INSTANCED_PRIM_LIST_T *unpacked)
{
   ...
   packed[9] = (uint8_t)(*unpacked).indices_offset;
   packed[10] = (uint8_t)((*unpacked).indices_offset >> 8);
   packed[11] = (uint8_t)((*unpacked).indices_offset >> 16);
   packed[12] = (uint8_t)((*unpacked).indices_offset >> 24);
}
void v3d_cl_unpack_indexed_instanced_prim_list(V3D_CL_INDEXED_INSTANCED_PRIM_LIST_T *unpacked, const uint8_t *packed)
{
   ...
   (*unpacked).num_instances = (uint32_t)packed[5] | (uint32_t)packed[6] << 8 |
      (uint32_t)packed[7] << 16 | (uint32_t)packed[8] << 24;
   (*unpacked).indices_offset = (uint32_t)packed[9] | (uint32_t)packed[10] << 8 |
      (uint32_t)packed[11] << 16 | (uint32_t)packed[12] << 24;
}
#endif
#if !V3D_VER_AT_LEAST(4,1,34,0)
...
#if V3D_VER_AT_LEAST(4,1,34,0)
void v3d_cl_pack_index_buffer_setup(uint8_t *packed, const V3D_CL_INDEX_BUFFER_SETUP_T *unpacked)
{
   packed[0] = (uint8_t)(*unpacked).addr;
   packed[1] = (uint8_t)((*unpacked).addr >> 8);
   packed[2] = (uint8_t)((*unpacked).addr >> 16);
   packed[3] = (uint8_t)((*unpacked).addr >> 24);
   packed[4] = (uint8_t)(*unpacked).size;
   packed[5] = (uint8_t)((*unpacked).size >> 8);
   packed[6] = (uint8_t)((*unpacked).size >> 16);
   packed[7] = (uint8_t)((*unpacked).size >> 24);
}
void v3d_cl_unpack_index_buffer_setup(V3D_CL_INDEX_BUFFER_SETUP_T *unpacked, const uint8_t *packed)
{
   (*unpacked).addr = (uint32_t)packed[0] | (uint32_t)packed[1] << 8 |
      (uint32_t)packed[2] << 16 | (uint32_t)packed[3] << 24;
   (*unpacked).size = (uint32_t)packed[4] | (uint32_t)packed[5] << 8 |
      (uint32_t)packed[6] << 16 | (uint32_t)packed[7] << 24;
}
#endif
#if !V3D_VER_AT_LEAST(4,1,34,0)
...
#endif
void v3d_cl_pack_set_primitive_id(uint8_t *packed, const V3D_CL_SET_PRIMITIVE_ID_T *unpacked)
{
   packed[0] = (uint8_t)(*unpacked).initial_prim_id;
   packed[1] = (uint8_t)((*unpacked).initial_prim_id >> 8);
   packed[2] = (uint8_t)((*unpacked).initial_prim_id >> 16);
   packed[3] = (uint8_t)((*unpacked).initial_prim_id >> 24);
}
void v3d_cl_unpack_set_primitive_id(V3D_CL_SET_PRIMITIVE_ID_T *unpacked, const uint8_t *packed)
{
   (*unpacked).initial_prim_id = (uint32_t)packed[0] | (uint32_t)packed[1] << 8 |
      (uint32_t)packed[2] << 16 | (uint32_t)packed[3] << 24;
}
...
void v3d_cl_pack_vg_inline_shader(uint8_t *packed, const V3D_CL_VG_INLINE_SHADER_T *unpacked)
{
   packed[0] = (uint8_t)gfx_bits((*unpacked).fs.threading, 1) |
...
void v3d_cl_unpack_vg_inline_shader(V3D_CL_VG_INLINE_SHADER_T *unpacked, const uint8_t *packed)
{
   (*unpacked).fs.threading = (v3d_threading_t)(uint32_t)(packed[0] & 1);
   (*unpacked).fs.single_seg = (uint32_t)(packed[0] >> 1 & 1);
   (*unpacked).fs.propagate_nans = (uint32_t)(packed[0] >> 2 & 1);
   (*unpacked).fs.addr = ((uint32_t)(packed[0] >> 3) | (uint32_t)packed[1] << 5 |
      (uint32_t)packed[2] << 13 | (uint32_t)packed[3] << 21) << 3;
   (*unpacked).fs.unifs_addr = (uint32_t)packed[4] | (uint32_t)packed[5] << 8 |
...
#endif
void v3d_cl_pack_clear_slice_caches(uint8_t *packed, const V3D_CL_CLEAR_SLICE_CACHES_T *unpacked)
{
   packed[0] = (uint8_t)gfx_bits((*unpacked).sic, 4) |
      (uint8_t)(gfx_bits((*unpacked).suc, 4) << 4);
   packed[1] = (uint8_t)gfx_bits((*unpacked).l1td, 4) |
      (uint8_t)(gfx_bits((*unpacked).l1tc, 4) << 4);
}
void v3d_cl_unpack_clear_slice_caches(V3D_CL_CLEAR_SLICE_CACHES_T *unpacked, const uint8_t *packed)
{
   (*unpacked).sic = (uint32_t)(packed[0] & 15);
   (*unpacked).suc = (uint32_t)(packed[0] >> 4);
   (*unpacked).l1td = (uint32_t)(packed[1] & 15);
   (*unpacked).l1tc = (uint32_t)(packed[1] >> 4);
}
void v3d_cl_pack_flush_l2t(uint8_t *packed, const V3D_CL_FLUSH_L2T_T *unpacked)
{
   packed[0] = (uint8_t)(*unpacked).start_addr;
   packed[1] = (uint8_t)((*unpacked).start_addr >> 8);
   packed[2] = (uint8_t)((*unpacked).start_addr >> 16);
   packed[3] = (uint8_t)((*unpacked).start_addr >> 24);
   packed[4] = (uint8_t)(*unpacked).end_addr;
   packed[5] = (uint8_t)((*unpacked).end_addr >> 8);
   packed[6] = (uint8_t)((*unpacked).end_addr >> 16);
   packed[7] = (uint8_t)((*unpacked).end_addr >> 24);
   packed[8] = (uint8_t)gfx_bits((*unpacked).mode, 2) |
      (uint8_t)(gfx_bits((*unpacked).deferred, 1) << 2) | (uint8_t)0;
}
void v3d_cl_unpack_flush_l2t(V3D_CL_FLUSH_L2T_T *unpacked, const uint8_t *packed)
{
   (*unpacked).start_addr = (uint32_t)packed[0] | (uint32_t)packed[1] << 8 |
      (uint32_t)packed[2] << 16 | (uint32_t)packed[3] << 24;
   (*unpacked).end_addr = (uint32_t)packed[4] | (uint32_t)packed[5] << 8 |
      (uint32_t)packed[6] << 16 | (uint32_t)packed[7] << 24;
   (*unpacked).mode = (v3d_l2t_flush_mode_t)(uint32_t)(packed[8] & 3);
   (*unpacked).deferred = (uint32_t)(packed[8] >> 2 & 1);
}
...
{
   packed[0] = (uint8_t)gfx_check_urange(*unpacked, 0, 0xffff);
   packed[1] = (uint8_t)(gfx_check_urange(*unpacked, 0, 0xffff) >> 8);
   packed[2] = (uint8_t)(gfx_check_urange(*unpacked, 0, 0xffff) >> 16);
   packed[3] = (uint8_t)(gfx_check_urange(*unpacked, 0, 0xffff) >> 24);
}
void v3d_cl_unpack_color_wmasks(uint32_t *unpacked, const uint8_t *packed)
{
   *unpacked = gfx_check_urange((uint32_t)packed[0] | (uint32_t)packed[1] << 8 |
      (uint32_t)packed[2] << 16 | (uint32_t)packed[3] << 24, 0, 0xffff);
}
#if !V3D_VER_AT_LEAST(4,1,34,0)
...
#endif
#if !V3D_VER_AT_LEAST(4,1,34,0)
void v3d_cl_pack_sample_state(uint8_t *packed, const V3D_CL_SAMPLE_STATE_T *unpacked)
{
   packed[0] = (uint8_t)gfx_float_to_bits((*unpacked).coverage);
   packed[1] = (uint8_t)(gfx_float_to_bits((*unpacked).coverage) >> 8);
   packed[2] = (uint8_t)(gfx_float_to_bits((*unpacked).coverage) >> 16);
   packed[3] = (uint8_t)(gfx_float_to_bits((*unpacked).coverage) >> 24);
}
void v3d_cl_unpack_sample_state(V3D_CL_SAMPLE_STATE_T *unpacked, const uint8_t *packed)
{
   (*unpacked).coverage = gfx_float_from_bits(
      (uint32_t)packed[0] | (uint32_t)packed[1] << 8 | (uint32_t)packed[2] << 16 |
      (uint32_t)packed[3] << 24);
}
#endif
...
void v3d_cl_pack_sample_state(uint8_t *packed, const V3D_CL_SAMPLE_STATE_T *unpacked)
{
   packed[0] = (uint8_t)gfx_bits((*unpacked).mask, 4) | (uint8_t)0;
   packed[1] = (uint8_t)0;
   packed[2] = (uint8_t)(gfx_float_to_bits((*unpacked).coverage) >> 16);
   packed[3] = (uint8_t)(gfx_float_to_bits((*unpacked).coverage) >> 16 >> 8);
}
void v3d_cl_unpack_sample_state(V3D_CL_SAMPLE_STATE_T *unpacked, const uint8_t *packed)
{
   (*unpacked).mask = (uint32_t)(packed[0] & 15);
   (*unpacked).coverage = gfx_float_from_bits(
      ((uint32_t)packed[2] | (uint32_t)packed[3] << 8) << 16);
}
#endif
...
void v3d_cl_pack_depth_offset(uint8_t *packed, const V3D_CL_DEPTH_OFFSET_T *unpacked)
{
   ...
   packed[2] = (uint8_t)(gfx_float_to_bits((*unpacked).units) >> 16);
   packed[3] = (uint8_t)(gfx_float_to_bits((*unpacked).units) >> 16 >> 8);
   packed[4] = (uint8_t)gfx_float_to_bits((*unpacked).limit);
   packed[5] = (uint8_t)(gfx_float_to_bits((*unpacked).limit) >> 8);
   packed[6] = (uint8_t)(gfx_float_to_bits((*unpacked).limit) >> 16);
   packed[7] = (uint8_t)(gfx_float_to_bits((*unpacked).limit) >> 24);
}
void v3d_cl_unpack_depth_offset(V3D_CL_DEPTH_OFFSET_T *unpacked, const uint8_t *packed)
{
   (*unpacked).factor = gfx_float_from_bits(
   ...
   (*unpacked).units = gfx_float_from_bits(
      ((uint32_t)packed[2] | (uint32_t)packed[3] << 8) << 16);
   (*unpacked).limit = gfx_float_from_bits(
      (uint32_t)packed[4] | (uint32_t)packed[5] << 8 | (uint32_t)packed[6] << 16 |
      (uint32_t)packed[7] << 24);
}
#endif
...
void v3d_cl_pack_clip(uint8_t *packed, const V3D_CL_CLIP_T *unpacked)
{
   ...
   packed[4] = (uint8_t)gfx_check_urange((*unpacked).width, 0, 0x1000);
   packed[5] = (uint8_t)(gfx_check_urange((*unpacked).width, 0, 0x1000) >> 8);
   packed[6] = (uint8_t)gfx_check_urange((*unpacked).height, 0, 0x1000);
   packed[7] = (uint8_t)(gfx_check_urange((*unpacked).height, 0, 0x1000) >> 8);
}
...
{
   packed[0] = (uint8_t)gfx_bits((*unpacked).x, 22);
   packed[1] = (uint8_t)(gfx_bits((*unpacked).x, 22) >> 8);
   packed[2] = (uint8_t)(gfx_bits((*unpacked).x, 22) >> 16) |
      (uint8_t)(gfx_pack_sint((*unpacked).coarse_x, 10) << 6);
   packed[3] = (uint8_t)(gfx_pack_sint((*unpacked).coarse_x, 10) >> 2);
   packed[4] = (uint8_t)gfx_bits((*unpacked).y, 22);
   packed[5] = (uint8_t)(gfx_bits((*unpacked).y, 22) >> 8);
   packed[6] = (uint8_t)(gfx_bits((*unpacked).y, 22) >> 16) |
      (uint8_t)(gfx_pack_sint((*unpacked).coarse_y, 10) << 6);
   packed[7] = (uint8_t)(gfx_pack_sint((*unpacked).coarse_y, 10) >> 2);
}
void v3d_cl_unpack_viewport_offset(V3D_CL_VIEWPORT_OFFSET_T *unpacked, const uint8_t *packed)
{
   (*unpacked).x = (uint32_t)packed[0] | (uint32_t)packed[1] << 8 |
      (uint32_t)(packed[2] & 63) << 16;
   (*unpacked).coarse_x = gfx_sext(
      (uint32_t)(packed[2] >> 6) | (uint32_t)packed[3] << 2, 10);
   (*unpacked).y = (uint32_t)packed[4] | (uint32_t)packed[5] << 8 |
      (uint32_t)(packed[6] & 63) << 16;
   (*unpacked).coarse_y = gfx_sext(
      (uint32_t)(packed[6] >> 6) | (uint32_t)packed[7] << 2, 10);
}
#endif
#if !V3D_VER_AT_LEAST(4,1,34,0)
...
void v3d_cl_pack_tile_binning_mode_cfg(uint8_t *packed, const V3D_CL_TILE_BINNING_MODE_CFG_T *unpacked)
{
   ...
   packed[1] = (uint8_t)gfx_pack_uint_minus_1(
   ...
   packed[2] = (uint8_t)0;
   packed[3] = (uint8_t)0;
   packed[4] = (uint8_t)gfx_pack_uint_minus_1((*unpacked).w_in_pixels, 16);
   packed[5] = (uint8_t)(gfx_pack_uint_minus_1((*unpacked).w_in_pixels, 16) >> 8);
   packed[6] = (uint8_t)gfx_pack_uint_minus_1((*unpacked).h_in_pixels, 16);
   packed[7] = (uint8_t)(gfx_pack_uint_minus_1((*unpacked).h_in_pixels, 16) >> 8);
}
void v3d_cl_unpack_tile_binning_mode_cfg(V3D_CL_TILE_BINNING_MODE_CFG_T *unpacked, const uint8_t *packed)
{
   (*unpacked).tile_alloc_initial_block_size =
      (v3d_tile_alloc_block_size_t)(uint32_t)(packed[0] >> 2 & 3);
   (*unpacked).tile_alloc_block_size =
      (v3d_tile_alloc_block_size_t)(uint32_t)(packed[0] >> 4 & 3);
   (*unpacked).num_rts = gfx_check_urange((uint32_t)(packed[1] & 15) + 1, 1, 4);
   (*unpacked).max_bpp = (v3d_rt_bpp_t)(uint32_t)(packed[1] >> 4 & 3);
   (*unpacked).ms_mode = (uint32_t)(packed[1] >> 6 & 1);
   (*unpacked).double_buffer = (uint32_t)(packed[1] >> 7);
   (*unpacked).w_in_pixels = ((uint32_t)packed[4] | (uint32_t)packed[5] << 8) + 1;
   (*unpacked).h_in_pixels = ((uint32_t)packed[6] | (uint32_t)packed[7] << 8) + 1;
}
#endif
#if !V3D_VER_AT_LEAST(4,1,34,0)
void v3d_cl_pack_tile_binning_mode_cfg(uint8_t *packed, const V3D_CL_TILE_BINNING_MODE_CFG_T *unpacked)
{
   if ((*unpacked).type == V3D_BCFG_TYPE_PART1)
   {
      ...
      packed[6] =
         (uint8_t)(gfx_check_urange((*unpacked).u.part1.h_in_tiles, 1, 0xfff) >> 4);
      packed[7] = (uint8_t)gfx_check_urange((*unpacked).u.part1.num_rts, 0, 4) |
...
void v3d_cl_unpack_tile_binning_mode_cfg(V3D_CL_TILE_BINNING_MODE_CFG_T *unpacked, const uint8_t *packed)
{
   if ((uint32_t)(packed[0] & 1) == 0)
   {
      ...
      (*unpacked).u.part1.h_in_tiles = gfx_check_urange(
         (uint32_t)(packed[5] >> 4) | (uint32_t)packed[6] << 4, 1, 0xfff);
      (*unpacked).u.part1.num_rts = gfx_check_urange((uint32_t)(packed[7] & 15), 0, 4);
...
void v3d_cl_unpack_tile_rendering_mode_cfg(V3D_CL_TILE_RENDERING_MODE_CFG_T *unpacked, const uint8_t *packed)
{
   ...
   else if ((uint32_t)(packed[0] & 15) == 1)
   {
      ...
      (*unpacked).u.color.rt_formats[0].bpp =
         (v3d_rt_bpp_t)(uint32_t)(packed[0] >> 4 & 3);
      (*unpacked).u.color.rt_formats[0].type =
         (v3d_rt_type_t)((uint32_t)(packed[0] >> 6) | (uint32_t)(packed[1] & 3) << 2);
      (*unpacked).u.color.rt_formats[0].clamp =
         (v3d_rt_clamp_t)(uint32_t)(packed[1] >> 2 & 3);
      (*unpacked).u.color.rt_formats[1].bpp =
         (v3d_rt_bpp_t)(uint32_t)(packed[1] >> 4 & 3);
      (*unpacked).u.color.rt_formats[1].type =
         (v3d_rt_type_t)((uint32_t)(packed[1] >> 6) | (uint32_t)(packed[2] & 3) << 2);
      (*unpacked).u.color.rt_formats[1].clamp =
         (v3d_rt_clamp_t)(uint32_t)(packed[2] >> 2 & 3);
      (*unpacked).u.color.rt_formats[2].bpp =
         (v3d_rt_bpp_t)(uint32_t)(packed[2] >> 4 & 3);
      (*unpacked).u.color.rt_formats[2].type =
         (v3d_rt_type_t)((uint32_t)(packed[2] >> 6) | (uint32_t)(packed[3] & 3) << 2);
      (*unpacked).u.color.rt_formats[2].clamp =
         (v3d_rt_clamp_t)(uint32_t)(packed[3] >> 2 & 3);
      (*unpacked).u.color.rt_formats[3].bpp =
         (v3d_rt_bpp_t)(uint32_t)(packed[3] >> 4 & 3);
      (*unpacked).u.color.rt_formats[3].type =
         (v3d_rt_type_t)((uint32_t)(packed[3] >> 6) | (uint32_t)(packed[4] & 3) << 2);
      (*unpacked).u.color.rt_formats[3].clamp =
         (v3d_rt_clamp_t)(uint32_t)(packed[4] >> 2 & 3);
   }
   else if ((uint32_t)(packed[0] & 15) == 2)
   {
...
void v3d_cl_unpack_tile_rendering_mode_cfg(V3D_CL_TILE_RENDERING_MODE_CFG_T *unpacked, const uint8_t *packed)
{
   ...
   else if ((uint32_t)(packed[0] & 15) == 2)
   {
      (*unpacked).type = V3D_RCFG_TYPE_COLOR;
      assert((uint32_t)(packed[0] & 15) == 2);
      (*unpacked).u.color.rt = gfx_check_urange((uint32_t)(packed[0] >> 4), 0, 3);
...
void v3d_cl_pack_instr(uint8_t *packed_instr, const V3D_CL_INSTR_T *instr)
{
   ...
   case V3D_CL_CLEAR_VCD_CACHE: break;
...
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_CL_INDEX_BUFFER_SETUP: v3d_cl_pack_index_buffer_setup(packed_instr + 1, &instr->u.index_buffer_setup); break;
#endif
#if !V3D_VER_AT_LEAST(4,1,34,0)
...
#endif
   case V3D_CL_SET_PRIMITIVE_ID: v3d_cl_pack_set_primitive_id(packed_instr + 1, &instr->u.set_primitive_id); break;
   ...
   case V3D_CL_CLEAR_SLICE_CACHES: v3d_cl_pack_clear_slice_caches(packed_instr + 1, &instr->u.clear_slice_caches); break;
   case V3D_CL_FLUSH_L2T: v3d_cl_pack_flush_l2t(packed_instr + 1, &instr->u.flush_l2t); break;
#if !V3D_VER_AT_LEAST(3,3,0,0)
   case V3D_CL_CLEAR_L2C: break;
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_CL_CLEAN_L1TD_DEFERRED: break;
#endif
...
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_CL_ZERO_ALL_NOPERSPECTIVE_FLAGS: break;
#endif
#if !V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_CL_CENTROID_FLAGS:
   ...
   case V3D_CL_CENTROID_FLAGS:
   case V3D_CL_FLATSHADE_FLAGS:
   case V3D_CL_NOPERSPECTIVE_FLAGS: v3d_cl_pack_vary_flags(packed_instr + 1, &instr->u.vary_flags); break;
#endif
#if !V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_CL_SAMPLE_STATE: v3d_cl_pack_sample_state(packed_instr + 1, &instr->u.sample_state); break;
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_CL_SAMPLE_STATE: v3d_cl_pack_sample_state(packed_instr + 1, &instr->u.sample_state); break;
#endif
...
void v3d_cl_unpack_instr(V3D_CL_INSTR_T *instr, const uint8_t *packed_instr)
{
...
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_CL_INDEX_BUFFER_SETUP: v3d_cl_unpack_index_buffer_setup(&instr->u.index_buffer_setup, packed_instr + 1); break;
#endif
#if !V3D_VER_AT_LEAST(4,1,34,0)
...
#endif
   case V3D_CL_SET_PRIMITIVE_ID: v3d_cl_unpack_set_primitive_id(&instr->u.set_primitive_id, packed_instr + 1); break;
...
#endif
   case V3D_CL_FLUSH_TRANSFORM_FEEDBACK_DATA: break;
   case V3D_CL_CLEAR_SLICE_CACHES: v3d_cl_unpack_clear_slice_caches(&instr->u.clear_slice_caches, packed_instr + 1); break;
   case V3D_CL_FLUSH_L2T: v3d_cl_unpack_flush_l2t(&instr->u.flush_l2t, packed_instr + 1); break;
#if !V3D_VER_AT_LEAST(3,3,0,0)
   case V3D_CL_CLEAR_L2C: break;
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
   ...
   case V3D_CL_CENTROID_FLAGS:
   case V3D_CL_FLATSHADE_FLAGS:
   case V3D_CL_NOPERSPECTIVE_FLAGS: v3d_cl_unpack_vary_flags(&instr->u.vary_flags, packed_instr + 1); break;
#endif
#if !V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_CL_SAMPLE_STATE: v3d_cl_unpack_sample_state(&instr->u.sample_state, packed_instr + 1); break;
#endif
#if V3D_VER_AT_LEAST(4,1,34,0)
   case V3D_CL_SAMPLE_STATE: v3d_cl_unpack_sample_state(&instr->u.sample_state, packed_instr + 1); break;
#endif
