...
#if V3D_HAS_CLE_NOT_IN_L2T

#define V3D_L2T_MASTER_ID_TMU        0
#define V3D_L2T_MASTER_ID_VCD        1
#define V3D_L2T_MASTER_ID_TMU_CONFIG 2
#define V3D_L2T_MASTER_ID_SL0_CACHE  3
#define V3D_L2T_MASTER_ID_SL1_CACHE  4
#define V3D_L2T_MASTER_ID_SL2_CACHE  5

static const char * const v3d_l2t_master_names[7] VCOS_ATTR_POSSIBLY_UNUSED = {
   "L2T(TMU)", "L2T(VCD)", "L2T(TMU_CONF)", "L2T(SL0)", "L2T(SL1)", "L2T(SL2)", "INVALID"
};
...
#define V3D_AXI_ID_CLE 4   // Won't be seen if RTL localparam CLE_THROUGH_L2T is set
