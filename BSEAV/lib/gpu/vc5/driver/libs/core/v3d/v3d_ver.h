...
#define V3D_VER_EQ(TECH_VERSION, REVISION, SUB_REV, COMPAT_REV) \
...
#if V3D_VER_AT_LEAST(4,1,34,0) && !defined(NO_CSD)
#define V3D_USE_CSD 1
#else
#define V3D_USE_CSD 0
#endif

#if V3D_HAS_L2T_LOCAL_MEM && !defined(NO_CSD) && !defined(NO_LOCAL_MEM)
#define V3D_USE_L2T_LOCAL_MEM 1
#else
#define V3D_USE_L2T_LOCAL_MEM 0
#endif
