...
extern void early_z_init(EARLY_Z_STATE_T *state, bool enable);

/* This should be called any time one of the arguments changes. It should also
 * be called once at the start of a frame (after early_z_init) to provide the
...
extern bool early_z_update_cfg(EARLY_Z_STATE_T *state,
...
/* Disable early_z for the rest of the frame */
