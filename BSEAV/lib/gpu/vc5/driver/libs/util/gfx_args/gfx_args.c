   ...
   void (*print_usage)(FILE *, const char *))
{
   ...
   if (gfx_args_more(a) && (strcmp(gfx_args_peek(a), "--help") == 0))
   {
...
bool gfx_args_can_pop_uint64(const struct gfx_args *a)
{
   return gfx_args_more(a) && gfx_try_strtou64(NULL, gfx_args_peek(a), 0);
}
