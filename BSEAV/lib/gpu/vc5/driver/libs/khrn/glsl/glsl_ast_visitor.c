...
void glsl_statement_accept(Statement *statement, void *data,
                           StatementPreVisitor  sprev,  ExprPreVisitor  eprev,
                           StatementPostVisitor spostv, ExprPostVisitor epostv)
{
   if (!statement) return;
