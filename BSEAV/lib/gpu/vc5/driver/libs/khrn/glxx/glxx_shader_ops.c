...
void glxx_v_u3(GLXX_VEC3_T *result, uint32_t i) {
   glxx_v_vec3(result, glxx_u(i), glxx_u(i + 1), glxx_u(i + 2));
}

void glxx_v_u3t(GLXX_VEC3_T *result, uint32_t i) {//transpose of glxx_v_u3
   glxx_v_vec3(result, glxx_u(i), glxx_u(i + 4), glxx_u(i + 8));
}

void glxx_v_u4(GLXX_VEC4_T *result, uint32_t i) {
   glxx_v_vec4(result, glxx_u(i), glxx_u(i + 1), glxx_u(i + 2), glxx_u(i + 3));
}

void glxx_v_u4t(GLXX_VEC4_T *result, uint32_t i) {//transpose of glxx_v_u4
   glxx_v_vec4(result, glxx_u(i), glxx_u(i + 4), glxx_u(i + 8), glxx_u(i + 12));
}
...
void glxx_v_transform4x4(GLXX_VEC4_T *result, const GLXX_VEC4_T *row0, const GLXX_VEC4_T *row1,
                                              const GLXX_VEC4_T *row2, const GLXX_VEC4_T *row3, const GLXX_VEC4_T *v)
{
