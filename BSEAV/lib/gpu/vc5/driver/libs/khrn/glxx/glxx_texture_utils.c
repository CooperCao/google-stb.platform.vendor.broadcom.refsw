...
bool glxx_is_texture_filterable_api_fmt(GFX_LFMT_T api_fmt)
{
   ...
   case GFX_LFMT_EAC_R_UNORM:
   case GFX_LFMT_EAC_R_SNORM:
   case GFX_LFMT_EAC_EAC_RG_UNORM:
   case GFX_LFMT_EAC_EAC_RG_SNORM:
   case GFX_LFMT_ETC2_RGB_UNORM:
   case GFX_LFMT_ETC2_RGB_SRGB:
   case GFX_LFMT_PUNCHTHROUGH_ETC2_RGBA_UNORM:
   case GFX_LFMT_PUNCHTHROUGH_ETC2_RGBA_SRGB_SRGB_SRGB_UNORM:
   case GFX_LFMT_ETC2_EAC_RGBA_UNORM:
   case GFX_LFMT_ETC2_EAC_RGBA_SRGB_SRGB_SRGB_UNORM:
   case GFX_LFMT_ASTC4X4_RGBA_UNORM:
   case GFX_LFMT_ASTC5X4_RGBA_UNORM:
   case GFX_LFMT_ASTC5X5_RGBA_UNORM:
   case GFX_LFMT_ASTC6X5_RGBA_UNORM:
   case GFX_LFMT_ASTC6X6_RGBA_UNORM:
   case GFX_LFMT_ASTC8X5_RGBA_UNORM:
   case GFX_LFMT_ASTC8X6_RGBA_UNORM:
   case GFX_LFMT_ASTC8X8_RGBA_UNORM:
   case GFX_LFMT_ASTC10X5_RGBA_UNORM:
   case GFX_LFMT_ASTC10X6_RGBA_UNORM:
   case GFX_LFMT_ASTC10X8_RGBA_UNORM:
   case GFX_LFMT_ASTC10X10_RGBA_UNORM:
   case GFX_LFMT_ASTC12X10_RGBA_UNORM:
   case GFX_LFMT_ASTC12X12_RGBA_UNORM:
   case GFX_LFMT_ASTC4X4_RGBA_SRGB_SRGB_SRGB_UNORM:
   case GFX_LFMT_ASTC5X4_RGBA_SRGB_SRGB_SRGB_UNORM:
   case GFX_LFMT_ASTC5X5_RGBA_SRGB_SRGB_SRGB_UNORM:
   case GFX_LFMT_ASTC6X5_RGBA_SRGB_SRGB_SRGB_UNORM:
   case GFX_LFMT_ASTC6X6_RGBA_SRGB_SRGB_SRGB_UNORM:
   case GFX_LFMT_ASTC8X5_RGBA_SRGB_SRGB_SRGB_UNORM:
   case GFX_LFMT_ASTC8X6_RGBA_SRGB_SRGB_SRGB_UNORM:
   case GFX_LFMT_ASTC8X8_RGBA_SRGB_SRGB_SRGB_UNORM:
   case GFX_LFMT_ASTC10X5_RGBA_SRGB_SRGB_SRGB_UNORM:
   case GFX_LFMT_ASTC10X6_RGBA_SRGB_SRGB_SRGB_UNORM:
   case GFX_LFMT_ASTC10X8_RGBA_SRGB_SRGB_SRGB_UNORM:
   case GFX_LFMT_ASTC10X10_RGBA_SRGB_SRGB_SRGB_UNORM:
   case GFX_LFMT_ASTC12X10_RGBA_SRGB_SRGB_SRGB_UNORM:
   case GFX_LFMT_ASTC12X12_RGBA_SRGB_SRGB_SRGB_UNORM:
      return true;
   default:
      return false;
   }
