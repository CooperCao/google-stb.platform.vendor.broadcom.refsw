...
#include "libs/khrn/glsl/glsl_constants.h"
...
#define GLXX_CONFIG_MAX_COMBINED_SHADER_OUTPUTS (GLXX_CONFIG_MAX_IMAGE_UNITS + V3D_MAX_RENDER_TARGETS)

/* Bindings are flattened at draw time so there is no separate binding limit */
#define GLXX_CONFIG_MAX_VERTEX_ATTRIB_BINDINGS    (V3D_MAX_ATTR_ARRAYS)
...
#define GLXX_CONFIG_MAX_SAMPLE_WORDS    ((V3D_MAX_SAMPLES + 31u) / 32u)
#define GLXX_CONFIG_MAX_INTEGER_SAMPLES (V3D_VER_AT_LEAST(3,3,0,0) ? V3D_MAX_SAMPLES : 0u)
...
#define GLXX_CONFIG_MAX_SHADER_STORAGE_BLOCK_SIZE           GLSL_MAX_SHADER_STORAGE_BLOCK_SIZE
...
#define GLXX_CONFIG_MAX_COMPUTE_GROUP_COUNT 65536
#if V3D_USE_CSD
#define GLXX_CONFIG_MAX_COMPUTE_WORK_GROUP_INVOCATIONS 256
#else
#define GLXX_CONFIG_MAX_COMPUTE_WORK_GROUP_INVOCATIONS 128
#endif
#define GLXX_CONFIG_MAX_COMPUTE_GROUP_SIZE_X GLXX_CONFIG_MAX_COMPUTE_WORK_GROUP_INVOCATIONS
#define GLXX_CONFIG_MAX_COMPUTE_GROUP_SIZE_Y GLXX_CONFIG_MAX_COMPUTE_WORK_GROUP_INVOCATIONS
#define GLXX_CONFIG_MAX_COMPUTE_GROUP_SIZE_Z GLXX_CONFIG_MAX_COMPUTE_WORK_GROUP_INVOCATIONS
