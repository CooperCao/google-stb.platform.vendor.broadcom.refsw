...
static void generic_rso_to_uif_internal(
   const CopyAlgorithm_t *self,
   const struct v3d_imgconv_base_tgt *dst, void *dst_data,
   const struct v3d_imgconv_base_tgt *src, void *src_data,
   unsigned int width, unsigned int height)
...
static void generic_uif_to_rso(
   const CopyAlgorithm_t *self,
   const struct v3d_imgconv_base_tgt *dst, void *dst_data,
   const struct v3d_imgconv_base_tgt *src, void *src_data,
   unsigned int width, unsigned int height)
...
static void generic_rso_to_uif(
   const CopyAlgorithm_t *self,
   const struct v3d_imgconv_base_tgt *dst, void *dst_data,
   const struct v3d_imgconv_base_tgt *src, void *src_data,
   unsigned int width, unsigned int height)
{
   ...
   assert(self->supports(self, dst, src, width, height));
...
static void etc64rso_to_etc64uif(
   const CopyAlgorithm_t *self,
   const struct v3d_imgconv_base_tgt *dst, void *dst_data,
   const struct v3d_imgconv_base_tgt *src, void *src_data,
   unsigned int width, unsigned int height)
...
static void rso_b5g6r5_to_rso_r8g8b8a8(
   const CopyAlgorithm_t *self,
   const struct v3d_imgconv_base_tgt *dst, void *dst_data,
   const struct v3d_imgconv_base_tgt *src, void *src_data,
   unsigned int width, unsigned int height)
...
static void rso_r8g8b8x8_to_rso_r8g8b8a8(
   const CopyAlgorithm_t *self,
   const struct v3d_imgconv_base_tgt *dst, void *dst_data,
   const struct v3d_imgconv_base_tgt *src, void *src_data,
   unsigned int width, unsigned int height)
   ...
   unsigned int width, unsigned int height, unsigned int depth)
{
...
#ifdef TESTING
   {
      ...
      assert(alg2 != NULL && alg2->supports(alg, src, dst, width, height));
