...
#ifndef __HELLO_CUBE5_H__
#define __HELLO_CUBE5_H__
...
class HelloCubeApp5 : public bsg::Application
{
public:
   HelloCubeApp5(bsg::Platform &platform);
...
private:
   ...
   bsg::SceneNodeHandle m_cubeNode1;
   bsg::SceneNodeHandle m_cubeNode2;
   bsg::CameraHandle    m_camera;

   bsg::AnimationList                 m_animList;
   std::set<bsg::MaterialHandle>      m_objMaterials;
   bsg::AnimatableGroup<bsg::Vec3>    m_lightPos;
};

#endif /* __HELLO_CUBE5_H__ */
