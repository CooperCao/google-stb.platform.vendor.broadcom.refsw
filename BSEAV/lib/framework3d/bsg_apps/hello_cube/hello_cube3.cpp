...
HelloCubeApp3::HelloCubeApp3(bsg::Platform &platform) :
   ...
   m_camera        (bsg::New)
{
   ...
   bsg::AnimBindingLerpQuaternionAngle *anim = new bsg::AnimBindingLerpQuaternionAngle(&cubeNode->GetRotation());
   anim->Interpolator()->Init(now, now + 10.0f, bsg::BaseInterpolator::eREPEAT);
   anim->Evaluator()->Init(bsg::Vec3(0.7f, 1.0f, 0.0f), 0.0f, 360.0f);
...
void HelloCubeApp3::RenderFrame()
{
...
void HelloCubeApp3::KeyEventHandler(bsg::KeyEvents &queue)
{
...
void HelloCubeApp3::ResizeHandler(uint32_t width, uint32_t height)
{
   m_camera->SetAspectRatio(width, height);
}

bool HelloCubeApp3::UpdateFrame(int32_t * /*idleMs*/)
{
