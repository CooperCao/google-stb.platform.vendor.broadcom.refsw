...
/* BRCM added static */
static DRM_ALWAYS_INLINE DRM_VOID DRM_CALL mp_extend(
    __in_ecount(lnga)    const digit_t  *a,
                         const DRM_DWORD lnga,
    __inout_ecount(lngb)       digit_t  *b,
                         const DRM_DWORD lngb )
...
/****************************************************************************/
/* BRCM added static */
static DRM_ALWAYS_INLINE digit_t DRM_CALL mp_getbit( const digit_t *a, const DRM_DWORD ibit )
...
/****************************************************************************/
/* BRCM added static */
static DRM_ALWAYS_INLINE DRM_VOID DRM_CALL mp_setbit(
    __inout_ecount(lnga)       digit_t     *a,
                         const DRM_DWORD    lnga,
                         const DRM_DWORD    ibit,
                         const digit_t      new_value )
...
/****************************************************************************/
/* BRCM added static */
static DRM_ALWAYS_INLINE DRM_DWORD DRM_CALL significant_digit_count(
    __in_ecount(lng) const digit_t   *a,
    __in             const DRM_DWORD  lng )
/*
...
/* BRCM added static */
static DRM_ALWAYS_INLINE DRM_BOOL DRM_CALL digits_to_dwords(
    __in_ecount(lng_dwords)                                          const digit_t  *pdigit,
    __inout_ecount_full(lng_dwords*sizeof( digit_t )/DRM_DWORDS_PER_DIGIT) DRM_BYTE *pbyte,
    __in                                                             const DRM_DWORD lng_dwords )
{
...
/****************************************************************************/
/* BRCM added static */
static DRM_ALWAYS_INLINE DRM_BOOL DRM_CALL dwords_to_digits(
                               const DRM_DWORD  *pdword,
    __inout_ecount(lng_dwords)       digit_t    *pdigit,
                               const DRM_DWORD   lng_dwords )
{
...
/* BRCM added static */
static DRM_ALWAYS_INLINE DRM_DWORD DRM_CALL significant_bit_count (const digit_t d )
/*
...
/* BRCM added static */
static DRM_ALWAYS_INLINE DRM_DWORD DRM_CALL mp_significant_bit_count( const digit_t *a, const DRM_DWORD lnga )
/*
