...
/* ============================================================================ */
#elif defined (__GNUC__)
/*BRCM: include bstd_defs.h. Not need to include stdint.h since it's already part of  part of bstd_defs.h for linux, and doesn't exist for ucos_ii */
    #include <bstd_defs.h>
/*BRCM: removed include wchar */
                                                        /* Size */
