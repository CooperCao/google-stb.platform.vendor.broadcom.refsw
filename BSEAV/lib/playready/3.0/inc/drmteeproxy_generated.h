...
/* BRCM: we might need to increment this value if we add other ocmmands in s_rgTEEFunctionSupportedList */
#define DRM_TEE_PROXY_MAX_STACK_SIZE_FOR_SYSINFO 350
