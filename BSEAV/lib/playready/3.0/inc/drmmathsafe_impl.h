...
/* BRCM added static */
static DRM_API DRMMATHSAFEINLINE DRM_RESULT DRM_CALL DRM_WordToByte(
...
/* BRCM added static */
static DRM_API DRMMATHSAFEINLINE DRM_RESULT DRM_CALL DRM_LongToByte(
...
/* BRCM added static */
static DRM_API DRMMATHSAFEINLINE DRM_RESULT DRM_CALL DRM_LongToWord(
    __in                      DRM_LONG       f_lOperand,
...
/* BRCM added static */
static DRM_API DRMMATHSAFEINLINE DRM_RESULT DRM_CALL DRM_LongToDWord(
    __in                      DRM_LONG       f_lOperand,
...
/* BRCM added static */
static DRM_API DRMMATHSAFEINLINE DRM_RESULT DRM_CALL DRM_LongToDWordPtr(
    __in                      DRM_LONG       f_lOperand,
...
/* BRCM added static */
static DRM_API DRMMATHSAFEINLINE DRM_RESULT DRM_CALL DRM_DWordToByte(
...
/* BRCM added static */
static DRM_API DRMMATHSAFEINLINE DRM_RESULT DRM_CALL DRM_DWordToWord(
    __in                      DRM_DWORD     f_dwOperand,
    __out                     DRM_WORD     *f_pwResult )
{
    DRM_RESULT dr = DRM_SUCCESS;
...
/* BRCM added static */
static DRM_API DRMMATHSAFEINLINE DRM_RESULT DRM_CALL DRM_DWordToLong(
    __in                      DRM_DWORD     f_dwOperand,
...
/* BRCM added static */
static DRM_API DRMMATHSAFEINLINE DRM_RESULT DRM_CALL DRM_DWordPtrToDWord(
...
/* BRCM added static */
static DRM_API DRMMATHSAFEINLINE DRM_RESULT DRM_CALL DRM_Int64ToWord(
...
/* BRCM added static */
static DRM_API DRMMATHSAFEINLINE DRM_RESULT DRM_CALL DRM_Int64ToByte(
    __in                      DRM_INT64     f_i64Operand,
    __out_ecount(1)           DRM_BYTE     *f_pbResult )
{
    DRM_RESULT dr = DRM_SUCCESS;
...
/* BRCM added static */
static DRM_API DRMMATHSAFEINLINE DRM_RESULT DRM_CALL DRM_Int64ToLong(
    __in                      DRM_INT64     f_i64Operand,
    __out                     DRM_LONG     *f_plResult )
{
    DRM_RESULT dr = DRM_SUCCESS;
...
/* BRCM added static */
static DRM_API DRMMATHSAFEINLINE DRM_RESULT DRM_CALL DRM_Int64ToDWord(
    __in                      DRM_INT64     f_i64Operand,
    __out                     DRM_DWORD    *f_pdwResult )
{
    DRM_RESULT dr = DRM_SUCCESS;
...
/* BRCM added static */
static DRM_API DRMMATHSAFEINLINE DRM_RESULT DRM_CALL DRM_Int64ToUInt64(
    __in                      DRM_INT64     f_i64Operand,
...
/* BRCM added static */
static DRM_API DRMMATHSAFEINLINE DRM_RESULT DRM_CALL DRM_UInt64ToWord(
...
/* BRCM added static */
static DRM_API DRMMATHSAFEINLINE DRM_RESULT DRM_CALL DRM_UInt64ToByte(
    __in                      DRM_UINT64     f_ui64Operand,
    __out_ecount(1)           DRM_BYTE      *f_pbResult )
{
    DRM_RESULT dr = DRM_SUCCESS;
...
/* BRCM added static */
static DRM_API DRMMATHSAFEINLINE DRM_RESULT DRM_CALL DRM_UInt64ToLong(
    __in                      DRM_UINT64     f_ui64Operand,
    __out                     DRM_LONG      *f_plResult )
{
    DRM_RESULT dr = DRM_SUCCESS;
...
/* BRCM added static */
static DRM_API DRMMATHSAFEINLINE DRM_RESULT DRM_CALL DRM_UInt64ToDWord(
    __in                      DRM_UINT64     f_ui64Operand,
    __out                     DRM_DWORD     *f_pdwResult )
{
    DRMASSERT( f_pdwResult != NULL );
...
/* BRCM added static */
static DRM_API DRMMATHSAFEINLINE DRM_RESULT DRM_CALL DRM_UInt64ToDWordPtr(
    __in                      DRM_UINT64     f_ui64Operand,
    __out                     DRM_DWORD_PTR *f_pdwpResult )
{
    DRMASSERT( f_pdwpResult != NULL );
...
/* BRCM added static */
static DRM_API DRMMATHSAFEINLINE DRM_RESULT DRM_CALL DRM_UInt64ToInt64(
    __in                      DRM_UINT64     f_ui64Operand,
...
/* BYTE addition */
/* BRCM added static */
static DRM_API DRMMATHSAFEINLINE DRM_RESULT DRM_CALL DRM_ByteAdd(
...
/* WORD addition */
/* BRCM added static */
static DRM_API DRMMATHSAFEINLINE DRM_RESULT DRM_CALL DRM_WordAdd(
...
/* UINT64 addition */
/* BRCM added static */
static DRM_API DRMMATHSAFEINLINE DRM_RESULT DRM_CALL DRM_UInt64Add(
...
/* BRCM added static */
static DRM_API DRMMATHSAFEINLINE DRM_RESULT DRM_CALL DRM_UInt64AddSame(
...
/* DWORD addition */
/* BRCM added static */
static DRM_API DRMMATHSAFEINLINE DRM_RESULT DRM_CALL DRM_DWordAdd(
...
/* BRCM added static */
static DRM_API DRMMATHSAFEINLINE DRM_RESULT DRM_CALL DRM_DWordAddSame(
...
/*BYTE subtraction */
/* BRCM added static */
static DRM_API DRMMATHSAFEINLINE DRM_RESULT DRM_CALL DRM_ByteSub(
...
/* WORD subtraction */
/* BRCM added static */
static DRM_API DRMMATHSAFEINLINE DRM_RESULT DRM_CALL DRM_WordSub(
...
/* DWORD subtraction */
/* BRCM added static */
static DRM_API DRMMATHSAFEINLINE DRM_RESULT DRM_CALL DRM_DWordSub(
...
/* BRCM added static */
static DRM_API DRMMATHSAFEINLINE DRM_RESULT DRM_CALL DRM_DWordSubSame(
...
/* UINT64 subtraction */
/* BRCM added static */
static DRM_API DRMMATHSAFEINLINE DRM_RESULT DRM_CALL DRM_UInt64Sub(
...
/* WORD multiplication */
/* BRCM added static */
static DRM_API DRMMATHSAFEINLINE DRM_RESULT DRM_CALL DRM_WordMult(
...
/* BRCM added static */
static DRM_API DRMMATHSAFEINLINE DRM_RESULT DRM_CALL DRM_DWordMult(
...
/* BRCM added static */
static DRM_API DRMMATHSAFEINLINE DRM_RESULT DRM_UInt64Mult(
...
/* LONG Addition */
/* BRCM added static */
static DRM_API DRMMATHSAFEINLINE DRM_RESULT DRM_CALL DRM_LongAdd(
...
/* LONG Subtraction */
/* BRCM added static */
static DRM_API DRMMATHSAFEINLINE DRM_RESULT DRM_CALL DRM_LongSub(
...
/* LONG multiplication */
/* BRCM added static */
static DRM_API DRMMATHSAFEINLINE DRM_RESULT DRM_CALL DRM_LongMult(
