 ...
 *
 **************************************************************************/
#ifndef _NEXUS_VIDEO_DECODER_SOFT_VPX_H_
#define _NEXUS_VIDEO_DECODER_SOFT_VPX_H_

#ifdef __cplusplus
extern "C" {
#endif

b_video_softdecode_t bvpx_video_decode_create(const b_video_sofdecode_memory_methods *memory_methods, void *parent);
...
#endif /* _NEXUS_VIDEO_DECODER_SOFT_VPX_H_ */
