...
int bmmt_timestamp_queue_add_timestamp_descriptors(bmmt_timestamp_queue queue,
                                            const bmmt_mpu_timestamp_descriptor_entry * timestamps, unsigned n_timestamps);
...
typedef struct bmmt_demux_stream_config {
    ...
    int32_t video_sequence_number;
    uint32_t video_sample_number;
    int32_t audio_sequence_number;
    uint32_t audio_sample_number;
#if 0
