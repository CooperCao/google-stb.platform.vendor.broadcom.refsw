...
#ifdef ANDROID
typedef wchar_t _DRM_SHORT_WCHAR_;
#else
...
/******************************************************************************
** FUNCTION:
**   bdrm_get_ta_bin_file_path
**   bdrm_get_ta_dev_bin_file_path
**
** DESCRIPTION:
**   This function is used to retrieve the string representing the filepath
**   of the Common DRM TA bin file in rootfs
**
** PARAMETERS: N/A
**
** RETURNS: N/A
**
******************************************************************************/
char * bdrm_get_ta_bin_file_path(void);
char * bdrm_get_ta_dev_bin_file_path(void);
...
** DESCRIPTION:
**   This function is used to retrieve the string representing the filepath
**   of the Playready 3.x DRM TA bin file in rootfs
**
** PARAMETERS: N/A
**
** RETURNS: N/A
...
**
******************************************************************************/
uint32_t  bdrm_get_pr_bin_fname_lgth(void);
...
** DESCRIPTION:
**   This function is used to retrieve the string containing the path of the
** Playready 3.x DRM bin file.
**
** PARAMETERS:
**   N/A
**
** RETURNS:
**   A string containing the path of the Playready 3.x DRM bin file in the file system.
**
******************************************************************************/
_DRM_SHORT_WCHAR_ * bdrm_get_pr3x_bin_fname(void);
...
** DESCRIPTION:
**   This function is used to retrieve the string containing the path of the
** Playready 3.x Key History file.
**
** PARAMETERS:
**   N/A
**
...
**
******************************************************************************/
_DRM_SHORT_WCHAR_ * bdrm_get_pr3x_key_history_fname(void);
...
**
** DESCRIPTION:
**   This function is used to retrieve the string containing Playready 3.x data store filename.
**
** PARAMETERS:
**   N/A
**
...
**
** SEE ALSO:
**  bdrm_get_pr3x_hds_fname_lgth
**
******************************************************************************/
_DRM_SHORT_WCHAR_ * bdrm_get_pr3x_hds_fname(void);
...
**
** DESCRIPTION:
**   This function is used to retrieve the length of Playready 3.x data store filename.
**
** PARAMETERS:
**   N/A
**
...
**
******************************************************************************/
uint32_t  bdrm_get_pr3x_hds_fname_lgth(void);
