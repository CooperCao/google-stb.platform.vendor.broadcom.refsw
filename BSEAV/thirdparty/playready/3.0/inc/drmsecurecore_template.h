...
DRM_GET_FUNCTION_SIGNATURE( DecryptContent_Brcm, DRM_API, DRM_RESULT )(
    __in                                            DRM_CIPHER_CONTEXT           *f_pCipherContext,
    __inout                                         DRM_AES_COUNTER_MODE_CONTEXT *f_pCtrContext,
    __inout                                         DRM_VOID                     *f_pDmaBlocks,
    __in                                            DRM_DWORD                     f_cDmaBlocks ) DRM_SIGNATURE_POSTFIX;
...
DRM_GET_FUNCTION_SIGNATURE( LoadIv, DRM_API, DRM_RESULT)(
__in                                            DRM_CIPHER_CONTEXT       *f_pCipherContext,
__in                                            DRM_UINT64                f_ui64InitializationVector,
__in                                            DRM_UINT64                f_ui64SampleByteOffset) DRM_SIGNATURE_POSTFIX;
