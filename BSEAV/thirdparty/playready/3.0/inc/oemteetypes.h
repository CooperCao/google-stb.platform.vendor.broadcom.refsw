...
/* BRCM:  NOTE that changes to some internal structures were made in support of
 * the SW TEE platform.  Those changes are intentionally not included in this
 * version of the file because they are internal structures and are not needed
 * nor should they be accessed by PlayReady clients.
 */
