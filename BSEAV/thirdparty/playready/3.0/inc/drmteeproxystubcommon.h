...
typedef enum _tagDRM_METHOD_ID_DRM_TEE
{
    ...
    */
    ...
    DRM_METHOD_ID_DRM_TEE_AES128CTR_LoadIv                                      = 41,
    DRM_METHOD_ID_DRM_TEE_AES128CTR_FreeRessources                              = 42,
    DRM_METHOD_ID_DRM_TEE_BASE_SetSystemTime                                    = 43,
    DRM_METHOD_ID_DRM_TEE_AES128CTR_LoadIv_ByteOffset                           = 44,
    DRM_METHOD_ID_DRM_TEE_Count                                                 = 45,
