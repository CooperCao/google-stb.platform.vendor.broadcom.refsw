...
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_TEE_NW_BASE_MemAlloc(
  /*__inout_opt                 DRM_TEE_PROXY_CONTEXT        *f_pContext,*//*BRCM: This parameter is mandatory in our implementation */
    __in                        DRM_TEE_PROXY_CONTEXT        *f_pContext,
    __in                        DRM_DWORD                     f_cb,
...
/* BRCM: New api to allocate shared memory */
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_TEE_NW_BASE_SharedMemAlloc(
    __inout_opt                 DRM_TEE_PROXY_CONTEXT        *f_pContext,
    __in                        DRM_DWORD                     f_cb,
    __deref_out_bcount(f_cb)    DRM_VOID                    **f_ppv ) DRM_NO_INLINE_ATTRIBUTE;

/* BRCM: New api to free shared memory */
DRM_NO_INLINE DRM_API_VOID DRM_VOID   DRM_CALL DRM_TEE_NW_BASE_SharedMemFree(
    __inout_opt                 DRM_TEE_PROXY_CONTEXT        *f_pContext,
    __inout                     DRM_VOID                    **f_ppv ) DRM_NO_INLINE_ATTRIBUTE;
...
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_TEE_PROXY_DECRYPT_PrepareToDecrypt(
    ...
    __in                        Oem_AesHwHandle               aesHwHandle,        /* BRCM: Opaque structure used to obtain key-related info need by TEE. */
...
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_TEE_PROXY_AES128CTR_LoadIv(
    __inout                     DRM_TEE_PROXY_CONTEXT        *f_pContext,
    __in                        DRM_CIPHER_CONTEXT           *f_pCipherContext,
    __in                        DRM_UINT64                    f_ui64InitializationVector,
    __in                        DRM_UINT64                    f_ui64SampleByteOffset) DRM_NO_INLINE_ATTRIBUTE;

DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_TEE_PROXY_AES128CTR_FreeRessources(
    __inout                    DRM_TEE_PROXY_CONTEXT          *f_pContext,
    __in                 const DRM_TEE_BYTE_BLOB              *f_pCDKB) DRM_NO_INLINE_ATTRIBUTE;
