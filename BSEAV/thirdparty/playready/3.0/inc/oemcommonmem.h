...
/* BRCM added static */
static DRM_ALWAYS_INLINE DRM_VOID * DRM_CALL DRMCRT_ScrubMemory(
...
#if defined(DRM_MSC_VER) || defined(__GNUC__)
/* BRCM added static */
static DRM_ALWAYS_INLINE DRM_VOID * DRM_CALL DRMCRT_LocalMemcpy(
...
/* BRCM added static */
static DRM_ALWAYS_INLINE DRM_VOID * DRM_CALL DRMCRT_LocalMemset(
    __out_bcount_full( f_cbCount )  DRM_VOID  *f_pOut,
...
/* BRCM added static */
static DRM_ALWAYS_INLINE DRM_VOID * DRM_CALL DRMCRT_LocalDWORDSetZero(
...
/* BRCM added static */
static DRM_ALWAYS_INLINE DRM_BOOL DRM_CALL DRMCRT_LocalAreEqual(
...
/* BRCM added static */
static DRM_ALWAYS_INLINE DRM_VOID * DRM_CALL DRMCRT_LocalDWORDcpy(
