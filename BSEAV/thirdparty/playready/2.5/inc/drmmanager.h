...
DRM_API DRM_RESULT DRM_CALL Drm_Reader_Bind_Netflix_WCK(
    __in                           DRM_APP_CONTEXT      *f_poAppContext,
...
DRM_API DRM_VOID * Drm_Platform_Initialize(
    __in     OEM_Settings *pSettings);

DRM_API DRM_RESULT Drm_Platform_Uninitialize(
...
DRM_API DRM_RESULT DRM_CALL Drm_TurnSecureStop(
									DRM_APP_CONTEXT *f_poAppContext,
									DRM_BOOL f_OnOff );
...
DRM_API DRM_RESULT DRM_CALL Drm_DeleteKeyStore( __in_opt DRM_APP_CONTEXT *f_poAppContext );
