...
typedef struct __tagDRM_AES_CIPHER_CONTEXT
{
    ...
    Oem_AesHwHandle   hAesHw; /* Nexus key slot configured for AES decryption */
DRM_OBFUS_PTR_TOP
...
,   __in                                           DRM_BOOL                      f_isContentKeyProtected
#endif
);

DRM_API DRM_RESULT DRM_CALL DRM_CPHR_FreeHwKeyHandle(
    __in   DRM_CIPHER_CONTEXT    *f_pContext);
