...
#define DRM_INLINING_SUPPORTED  1 /* **FixMeDf** disabled in Secure Stop sources */
...
#else
#if defined(__ORBIS__) || defined(__APPLE__)
#define DRMINLINE
#define DRMFORCEINLINE
#else
#define DRMINLINE               inline
...
#define DRM_ALWAYS_INLINE_ATTRIBUTE __attribute__((always_inline))   /* **FixMeDf** disabled in Secure Stop sources */
...
#define TARGET_SUPPORTS_UNALIGNED_DWORD_POINTERS    1
#endif  /* TARGET_SUPPORTS_UNALIGNED_DWORD_POINTERS */
#elif (defined(_XBOX) && !defined(_XBOX_VER))     /* Microsoft XBOX compiler detected  */
#ifndef TARGET_LITTLE_ENDIAN
