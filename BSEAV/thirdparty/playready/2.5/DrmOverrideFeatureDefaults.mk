...
!elseif "$(DRM_BUILD_PROFILE)" == "OEMPLAYONLY"

!INCLUDE "DrmProfileOEMPlayOnly.mk"

!elseif "$(DRM_BUILD_PROFILE)" == "PC"

!INCLUDE "DrmProfilePC.mk"

!elseif "$(DRM_BUILD_PROFILE)" == "WP8"

!INCLUDE "drmprofilewp8.mk"
...
!elseif "$(DRM_BUILD_PROFILE)" == "PK_NO_WMDRM_NO_BBXLEGACY"

!INCLUDE "DrmProfileTEST.mk"

!elseif "$(DRM_BUILD_PROFILE)" == "PK_YES_SECUREHAL_NO_PLAYONLY"
...
!IF "$(DRM_SUPPORT_BBXLEGACY)" == ""
DRM_SUPPORT_BBXLEGACY=$(DRM_SUPPORT_BBXLEGACY_VIA_PROFILE)
!ENDIF
!IF "$(DRM_SUPPORT_BBXLEGACY)" == "1"
DRM_MODULES_BBXLEGACY_ENABLE=1
!ELSEIF "$(DRM_SUPPORT_BBXLEGACY)" == "0"
DRM_MODULES_BBXLEGACY_DISABLE=1
!ENDIF

!IF "$(DRM_SUPPORT_BBXSLK)" == ""
DRM_SUPPORT_BBXSLK=$(DRM_SUPPORT_BBXSLK_VIA_PROFILE)
!ENDIF
!IF "$(DRM_SUPPORT_BBXSLK)" == "1"
DRM_MODULES_BBXSLK_ENABLE=1
!ELSEIF "$(DRM_SUPPORT_BBXSLK)" == "0"
DRM_MODULES_BBXSLK_DISABLE=1
!ENDIF
...
!IF "$(DRM_SUPPORT_DEVICEASSETS)" == ""
DRM_SUPPORT_DEVICEASSETS=$(DRM_SUPPORT_DEVICEASSETS_VIA_PROFILE)
!ENDIF
!IF "$(DRM_SUPPORT_DEVICEASSETS)" == "1"
DRM_MODULES_DEVICEASSETS_ENABLE=1
!ELSEIF "$(DRM_SUPPORT_DEVICEASSETS)" == "0"
DRM_MODULES_DEVICEASSETS_DISABLE=1
!ENDIF
...
!IF "$(DRM_SUPPORT_LICGEN)" == ""
DRM_SUPPORT_LICGEN=$(DRM_SUPPORT_LICGEN_VIA_PROFILE)
!ENDIF
!IF "$(DRM_SUPPORT_LICGEN)" == "1"
DRM_MODULES_LICGEN_ENABLE=1
!ELSEIF "$(DRM_SUPPORT_LICGEN)" == "0"
DRM_MODULES_LICGEN_DISABLE=1
!ENDIF

!IF "$(DRM_SUPPORT_M2TSENCRYPTOR)" == ""
DRM_SUPPORT_M2TSENCRYPTOR=$(DRM_SUPPORT_M2TSENCRYPTOR_VIA_PROFILE)
!ENDIF
!IF "$(DRM_SUPPORT_M2TSENCRYPTOR)" == "1"
DRM_MODULES_M2TSENCRYPTOR_ENABLE=1
!ELSEIF "$(DRM_SUPPORT_M2TSENCRYPTOR)" == "0"
DRM_MODULES_M2TSENCRYPTOR_DISABLE=1
!ENDIF
...
!IF "$(DRM_SUPPORT_PRNDTX)" == ""
DRM_SUPPORT_PRNDTX=$(DRM_SUPPORT_PRNDTX_VIA_PROFILE)
!ENDIF
!IF "$(DRM_SUPPORT_PRNDTX)" == "1"
DRM_MODULES_PRNDTX_ENABLE=1
!ELSEIF "$(DRM_SUPPORT_PRNDTX)" == "0"
DRM_MODULES_PRNDTX_DISABLE=1
!ENDIF

!IF "$(DRM_SUPPORT_PRNDRX)" == ""
DRM_SUPPORT_PRNDRX=$(DRM_SUPPORT_PRNDRX_VIA_PROFILE)
!ENDIF
!IF "$(DRM_SUPPORT_PRNDRX)" == "1"
DRM_MODULES_PRNDRX_ENABLE=1
!ELSEIF "$(DRM_SUPPORT_PRNDRX)" == "0"
DRM_MODULES_PRNDRX_DISABLE=1
!ENDIF
...
!ELSEIF "$(DRM_SUPPORT_SECURE_CLOCK)" == "2"
DRM_MODULES_SECURE_CLOCK_EXTERNAL_ENABLE=1
...
!IF "$(DRM_SUPPORT_WMDRM)"=="1"
!IF "$(DRM_SUPPORT_BBXLEGACY)"=="0"
!ERROR Feature settings DRM_SUPPORT_WMDRM=1 and DRM_SUPPORT_BBXLEGACY=0 are strictly incompatible!
!ENDIF
!ENDIF

!IF "$(DRM_SUPPORT_LICGEN)"=="1"
!IF "$(DRM_SUPPORT_PRNDTX)"=="0"
!ERROR Feature settings DRM_SUPPORT_LICGEN=1 and DRM_SUPPORT_PRNDTX=0 are strictly incompatible!
!ENDIF
!ENDIF

!IF "$(DRM_SUPPORT_PRNDTX)"=="1"
!IF "$(DRM_SUPPORT_ANTIROLLBACK_CLOCK)"=="0"
!IF "$(DRM_SUPPORT_SECURE_CLOCK)"=="0"
!ERROR Feature settings DRM_SUPPORT_PRNDTX=1 and DRM_SUPPORT_ANTIROLLBACK_CLOCK=0 and DRM_SUPPORT_SECURE_CLOCK=0 are strictly incompatible!
!ENDIF
!ENDIF
!ENDIF

!IF "$(DRM_SUPPORT_SECURE_CLOCK)"=="2"
!IF "$(DRM_SUPPORT_WMDRM)"=="1"
!ERROR Feature settings DRM_SUPPORT_SECURE_CLOCK=2 and DRM_SUPPORT_WMDRM=1 are strictly incompatible!
!ENDIF
!ENDIF

!IF "$(DRM_SUPPORT_DEVICEASSETS)"=="0"
!IF "$(DRM_SUPPORT_ACTIVATION)"=="1"
!ERROR Feature settings DRM_SUPPORT_DEVICEASSETS=0 and DRM_SUPPORT_ACTIVATION=1 are strictly incompatible!
!ENDIF
!IF "$(DRM_SUPPORT_ANTIROLLBACK_CLOCK)"=="1"
!ERROR Feature settings DRM_SUPPORT_DEVICEASSETS=0 and DRM_SUPPORT_ANTIROLLBACK_CLOCK=1 are strictly incompatible!
!ENDIF
!IF "$(DRM_SUPPORT_APP_POLICY)"=="1"
!ERROR Feature settings DRM_SUPPORT_DEVICEASSETS=0 and DRM_SUPPORT_APP_POLICY=1 are strictly incompatible!
!ENDIF
!IF "$(DRM_SUPPORT_CERTCACHE)"=="1"
!ERROR Feature settings DRM_SUPPORT_DEVICEASSETS=0 and DRM_SUPPORT_CERTCACHE=1 are strictly incompatible!
!ENDIF
!IF "$(DRM_SUPPORT_DEVCERTKEYGEN)"=="1"
!ERROR Feature settings DRM_SUPPORT_DEVICEASSETS=0 and DRM_SUPPORT_DEVCERTKEYGEN=1 are strictly incompatible!
!ENDIF
!IF "$(DRM_SUPPORT_DEVICESTORE)"=="1"
!ERROR Feature settings DRM_SUPPORT_DEVICEASSETS=0 and DRM_SUPPORT_DEVICESTORE=1 are strictly incompatible!
!ENDIF
!IF "$(DRM_SUPPORT_DOMAIN)"=="1"
!ERROR Feature settings DRM_SUPPORT_DEVICEASSETS=0 and DRM_SUPPORT_DOMAIN=1 are strictly incompatible!
!ENDIF
!IF "$(DRM_SUPPORT_LICENSE_SYNC)"=="1"
!ERROR Feature settings DRM_SUPPORT_DEVICEASSETS=0 and DRM_SUPPORT_LICENSE_SYNC=1 are strictly incompatible!
!ENDIF
!IF "$(DRM_SUPPORT_METERING)"=="1"
!ERROR Feature settings DRM_SUPPORT_DEVICEASSETS=0 and DRM_SUPPORT_METERING=1 are strictly incompatible!
!ENDIF
!IF "$(DRM_SUPPORT_MOVE)"=="1"
!ERROR Feature settings DRM_SUPPORT_DEVICEASSETS=0 and DRM_SUPPORT_MOVE=1 are strictly incompatible!
!ENDIF
!IF "$(DRM_SUPPORT_PRNDRX)"=="1"
!ERROR Feature settings DRM_SUPPORT_DEVICEASSETS=0 and DRM_SUPPORT_PRNDRX=1 are strictly incompatible!
!ENDIF
!IF "$(DRM_SUPPORT_SECURE_CLOCK)"=="1"
!ERROR Feature settings DRM_SUPPORT_DEVICEASSETS=0 and DRM_SUPPORT_SECURE_CLOCK=1 are strictly incompatible!
!ENDIF
!IF "$(DRM_SUPPORT_SYMOPT)"=="1"
!ERROR Feature settings DRM_SUPPORT_DEVICEASSETS=0 and DRM_SUPPORT_SYMOPT=1 are strictly incompatible!
!ENDIF
!IF "$(DRM_SUPPORT_VIEWRIGHTS)"=="1"
!ERROR Feature settings DRM_SUPPORT_DEVICEASSETS=0 and DRM_SUPPORT_VIEWRIGHTS=1 are strictly incompatible!
!ENDIF
!IF "$(DRM_SUPPORT_WMDRM)"=="1"
!ERROR Feature settings DRM_SUPPORT_DEVICEASSETS=0 and DRM_SUPPORT_WMDRM=1 are strictly incompatible!
!ENDIF
!ENDIF

!IF "$(DRM_SUPPORT_SECUREOEMHAL)"=="1"
!IF "$(DRM_SUPPORT_WMDRM)"=="1"
!ERROR Feature settings DRM_SUPPORT_SECUREOEMHAL=1 and DRM_SUPPORT_WMDRM=1 are strictly incompatible!
!ENDIF
!IF "$(DRM_SUPPORT_BBXLEGACY)"=="1"
!ERROR Feature settings DRM_SUPPORT_SECUREOEMHAL=1 and DRM_SUPPORT_BBXLEGACY=1 are strictly incompatible!
!ENDIF
!IF "$(DRM_SUPPORT_BBXSLK)"=="1"
!ERROR Feature settings DRM_SUPPORT_SECUREOEMHAL=1 and DRM_SUPPORT_BBXSLK=1 are strictly incompatible!
!ENDIF
!IF "$(DRM_SUPPORT_SYMOPT)"=="1"
!ERROR Feature settings DRM_SUPPORT_SECUREOEMHAL=1 and DRM_SUPPORT_SYMOPT=1 are strictly incompatible!
!ENDIF
!ENDIF

!IF "$(DRM_SUPPORT_SECUREOEMHAL_PLAY_ONLY)"=="1"
!IF "$(DRM_SUPPORT_SECUREOEMHAL)"=="0"
!ERROR Feature settings DRM_SUPPORT_SECUREOEMHAL_PLAY_ONLY=1 and DRM_SUPPORT_SECUREOEMHAL=0 are strictly incompatible!
!ENDIF
!IF "$(DRM_SUPPORT_BBXLEGACY)"=="1"
!ERROR Feature settings DRM_SUPPORT_SECUREOEMHAL_PLAY_ONLY=1 and DRM_SUPPORT_BBXLEGACY=1 are strictly incompatible!
!ENDIF
!IF "$(DRM_SUPPORT_BBXSLK)"=="1"
!ERROR Feature settings DRM_SUPPORT_SECUREOEMHAL_PLAY_ONLY=1 and DRM_SUPPORT_BBXSLK=1 are strictly incompatible!
!ENDIF
!IF "$(DRM_SUPPORT_CERTPARSERCACHE)"=="1"
!ERROR Feature settings DRM_SUPPORT_SECUREOEMHAL_PLAY_ONLY=1 and DRM_SUPPORT_CERTPARSERCACHE=1 are strictly incompatible!
!ENDIF
!IF "$(DRM_SUPPORT_DLA)"=="1"
!ERROR Feature settings DRM_SUPPORT_SECUREOEMHAL_PLAY_ONLY=1 and DRM_SUPPORT_DLA=1 are strictly incompatible!
!ENDIF
!IF "$(DRM_SUPPORT_WMDRM)"=="1"
!ERROR Feature settings DRM_SUPPORT_SECUREOEMHAL_PLAY_ONLY=1 and DRM_SUPPORT_WMDRM=1 are strictly incompatible!
!ENDIF
!IF "$(DRM_SUPPORT_LICENSE_SYNC)"=="1"
!ERROR Feature settings DRM_SUPPORT_SECUREOEMHAL_PLAY_ONLY=1 and DRM_SUPPORT_LICENSE_SYNC=1 are strictly incompatible!
!ENDIF
!IF "$(DRM_SUPPORT_LICGEN)"=="1"
!ERROR Feature settings DRM_SUPPORT_SECUREOEMHAL_PLAY_ONLY=1 and DRM_SUPPORT_LICGEN=1 are strictly incompatible!
!ENDIF
!IF "$(DRM_SUPPORT_M2TSENCRYPTOR)"=="1"
!ERROR Feature settings DRM_SUPPORT_SECUREOEMHAL_PLAY_ONLY=1 and DRM_SUPPORT_M2TSENCRYPTOR=1 are strictly incompatible!
!ENDIF
!IF "$(DRM_SUPPORT_PRNDTX)"=="1"
!ERROR Feature settings DRM_SUPPORT_SECUREOEMHAL_PLAY_ONLY=1 and DRM_SUPPORT_PRNDTX=1 are strictly incompatible!
!ENDIF
!IF "$(DRM_SUPPORT_SYMOPT)"=="1"
!ERROR Feature settings DRM_SUPPORT_SECUREOEMHAL_PLAY_ONLY=1 and DRM_SUPPORT_SYMOPT=1 are strictly incompatible!
!ENDIF
!IF "$(DRM_SUPPORT_WMDRMNET)"=="1"
!ERROR Feature settings DRM_SUPPORT_SECUREOEMHAL_PLAY_ONLY=1 and DRM_SUPPORT_WMDRMNET=1 are strictly incompatible!
!ENDIF
!ENDIF
