...
//  $Id$
//
//  Filename:       EstbSnmpV3AccessView.h
...
#ifndef ESTBSNMPV3ACCESSVIEW_H
#define ESTBSNMPV3ACCESSVIEW_H
...
public:
    ...
    //
	BcmSnmpV3AccessView( const BcmSnmpV3AccessView& rhs );
    ...
    //
    BcmSnmpV3AccessView& operator=( const BcmSnmpV3AccessView& rhs );
    ...
    //      called.  
    //
	bool operator==( const BcmSnmpV3AccessView& rhs ) const;
	...
	bool operator<( const BcmSnmpV3AccessView& rhs ) const
   {
    ...
    bool fSubtreeSpecified;
    bool fMaskSpecified;
    bool fTypeSpecified;

    // Type 54.1: Access View Name
    BcmOctetBuffer fName;
    
    // Type 54.2: Access View OID Subtree
    BcmOctetBuffer fSubtree;
    BcmObjectId fSubtreeOID;
    
    // Type 54.3: Access View Mask
    BcmOctetBuffer fMask;
    
    // Type 54.4: Access View Type
    // 1 = included
    // 2 = excluded
...
inline ostream& operator<<( ostream& ostrm, const BcmSnmpV3AccessView& rhs )
{
