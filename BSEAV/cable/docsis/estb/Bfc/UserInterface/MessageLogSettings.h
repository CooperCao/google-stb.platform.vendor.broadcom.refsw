...
//
//****************************************************************************
//  $Id: MessageLogSettings.h 1.21 2007/01/03 21:43:16Z ceyles Release $
//
...
public:
    ...
    typedef enum
    {
        ...
        // A message tagged with this will always be printed.
        kAlwaysMessage =                0x00000000,
        ...
        kAppSpecificMessages =          0xffffffc0
