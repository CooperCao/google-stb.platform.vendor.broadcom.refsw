...
* $brcm_Date: $
*
* Description: input DSMCC data carousel from TS file.
*
* Revision History:
*
* $brcm_Log: $
* 
***************************************************************************/
#ifndef B_Dsmcc_LIB_PRIV_FILE_H__
#define B_Dsmcc_LIB_PRIV_FILE_H__
...
int b_dsmcc_lib_priv_file_start(B_Dsmcc_P_Handle h, int module_id);
...
#endif /* #ifndef B_Dsmcc_LIB_PRIV_FILE_H__ */
