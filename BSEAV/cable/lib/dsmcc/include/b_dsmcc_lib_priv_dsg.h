...
* 
***************************************************************************/
#ifndef B_Dsmcc_LIB_PRIV_DSG_H__
#define B_Dsmcc_LIB_PRIV_DSG_H__
...
int b_dsmcc_lib_priv_dsg_start(B_Dsmcc_P_Handle h, int module_id);
...
#endif /* #ifndef B_Dsmcc_LIB_PRIV_DSG_H__ */
