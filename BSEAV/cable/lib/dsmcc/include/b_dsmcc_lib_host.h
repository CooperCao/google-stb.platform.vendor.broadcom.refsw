...
* 
***************************************************************************/
#ifndef B_Dsmcc_LIB_HOST_H__
#define B_Dsmcc_LIB_HOST_H__
#ifdef __cplusplus
extern "C" {
#endif
#include <stdio.h>
...
/* debug macros */
#define BDBG_MSG(format...)  printf format;printf("\n")
#define BDBG_WRN(format...)  printf format;printf("\n")
#define BDBG_ERR(format...)  printf format;printf("\n")
...
#define B_Error int
#define BERR_INVALID_PARAMETER 2
...
#endif /* #ifndef B_Dsmcc_LIB_HOST_H__ */
