 ...
 * 
 ***************************************************************************/
#ifndef CDL_STORAGE_FILE_H
#define CDL_STORAGE_FILE_H
...
int cdl_storage_file_close(void * h) ;
int cdl_storage_file_read(void * h, void * buf, size_t count);
int cdl_storage_file_write(void * h, const void * buf, size_t count);
int cdl_storage_file_lseek(void * h, int offset, int whence);
int cdl_storage_file_expand(void * h, char * fn, int sec_header_len);
#endif  /* CDL_STORAGE_FILE_H */
