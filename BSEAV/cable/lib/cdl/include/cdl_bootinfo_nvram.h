...
int cdl_bootinfo_nvram_close(void);
int cdl_bootinfo_nvram_just_started(void);
int cdl_bootinfo_nvram_ready_to_reboot(void);
int cdl_bootinfo_nvram_get_new_storage(char * fn_kernel, char * fn_bootloader);
char * cdl_bootinfo_nvram_get_dev_name(void);
