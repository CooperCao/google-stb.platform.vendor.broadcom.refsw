 ...
 *
 * $Id: /local/public/users/ptimariu/stbnewucode/refsw/ptrepo/ucode_3wire/d11ucode_shmdefs_ulp.h Jan. 11, 2019 10:55:39 AM <pt923858> $
 */
// COMMON SHMS
//REVID Specific SHMs
#if (D11_REV == 46)
...
#define	M_ONE_TIME_CFG_BM	(0xaa9*2)
#define	M_DSX_TST_MODE	(0xaaa*2)
#define	M_FRRUN_LBCN_CNT	(0xaab*2)
#define	M_DS1_KA_CFG	(0xaac*2)
#define	M_DS1_KA_CTR	(0xaad*2)
#define	M_DS1_KA_NUM	(0xaae*2)
#define	M_DS1_KA_IPG	(0xaaf*2)
#define	M_AWK_RSN_CD	(0xab0*2)
#define	M_AWK_RSN_CTRL	(0xab1*2)
#define	M_PHY_SAMPLECMD	(0xab2*2)
...
#define	M_WAKEPULSE_TRH	(M_WAKEPULSE_DURN_BLK+(0x3*2))
#define	M_WAKEPULSE_TRH_OFFSET	(0x3*2)
#define	M_SR_TBTT_L	(0xaae*2)
#define	M_SR_TBTT_H	(0xaaf*2)
#define	M_RXBCN_BMPCTL	(M_IVLOC+(0x0*2))
#define	M_RXBCN_BMPCTL_OFFSET	(0x0*2)
#define	M_SLP_TIMEOUT	(M_PSM_SOFT_REGS_EXT+(0x18*2))
#define	M_SLP_TIMEOUT_OFFSET	(0x18*2)
...
#define	M_DRVR_UCODE_IF_BLK	(0xab6*2)
...
#define	M_TSF_ADJ_GTS_TSFTMR_WD0	(0xd8f*2)
#define	M_TSF_ADJ_GTS_TSFTMR_WD1	(0xda4*2)
#define	M_TSF_ADJ_GTS_TSFTMR_WD2	(0xda5*2)
#define	M_TSF_ADJ_GTS_TSFTMR_WD3	(0xda6*2)
#define	M_TSF_ADJ_OFFSET_TIMER	(0xda7*2)
#define	M_TSF_ADJ_GTS_SLOW_TMR_L	(0xda8*2)
#define	M_TSF_ADJ_GTS_SLOW_TMR_H	(0xda9*2)
#define	M_TSF_ADJ_OFFSET_PER	(0xdaa*2)
...
#define	M_BCNTRIM_NOTIM	(M_BCNTRIM_DBG_BLK+(0x8*2))
#define	M_BCNTRIM_NOTIM_OFFSET	(0x8*2)
#define	M_BCNTRIM_SLPTIME	(M_BCNTRIM_DBG_BLK+(0x9*2))
#define	M_BCNTRIM_SLPTIME_OFFSET	(0x9*2)
#define	M_SMPL_COL_BMP	(0xdab*2)
#define	M_SMPL_COL_CTL	(0xdb8*2)
#define	M_SLOW_CTL_SR	(0xdb9*2)
#define	M_PMU_FCBS_BLK	(0xdba*2)
...
#define	M_DS1_SCR_SAVE_BLK	(0xdd0*2)
#define	M_DS1_SCR_SAVE_BLK_SIZE	64
#define	M_NON_FCBS_EXIT_DEBUG	(0xdcf*2)
#define	M_NON_FCBS_EXIT_DEBUG_CMD_PTR	(0xe10*2)
#define	M_NON_FCBS_EXIT_DEBUG_DAT_PTR	(0xe11*2)
#define	M_FCBS_EXIT_DEBUG	(0xe12*2)
#define	M_FCBS_EXIT_DEBUG_CMD_PTR	(0xe13*2)
#define	M_FCBS_EXIT_DEBUG_DAT_PTR	(0xe14*2)
#define	M_PHY_RXFECTRL1	(M_CRX_BLK+(0xf*2))
#define	M_PHY_RXFECTRL1_OFFSET	(0xf*2)
#define	M_SR_BRWK_REGS	(M_CRX_BLK+(0x0*2))
#define	M_SR_BRWK_REGS_OFFSET	(0x0*2)
#define	M_ONE_TIME_CFG_BM	(0xe15*2)
#define	M_DSX_TST_MODE	(0xe16*2)
#define	M_FRRUN_LBCN_CNT	(0xe17*2)
#define	M_DS1_KA_CFG	(0xe18*2)
#define	M_DS1_KA_CTR	(0xe19*2)
#define	M_DS1_KA_NUM	(0xe1a*2)
#define	M_DS1_KA_IPG	(0xe1b*2)
#define	M_DS1_CTRL_STATUS	(0xe1c*2)
#define	M_DS1_CTRL_SDIO	(0xe1d*2)
#define	M_DS1_CTRL_SDIO_OOB_H	(0xe1e*2)
#define	M_DS1_CTRL_SDIO_OOB_L	(0xe1f*2)
#define	M_DS1_CTRL_SDIO_OOBTH	(0xe20*2)
#define	M_DS1_CTRL_JTAG	(0xe21*2)
#define	M_DS1_CTRL_JTAG_OOB_H	(0xe22*2)
#define	M_DS1_CTRL_JTAG_OOB_L	(0xe23*2)
#define	M_DS1_CTRL_JTAG_OOBTH	(0xe24*2)
#define	M_DS1_CTRL_SDIO_PIN	(0xe25*2)
#define	M_DS1_CTRL_JTAG_PIN	(0xe26*2)
#define	M_DS1_CTRL_FUNCAL	(0xe27*2)
#define	M_DS1_ENTER_OOBJ	(0xe28*2)
#define	M_DS1_DIS_OOBJ	(0xe29*2)
#define	M_HUDI_DS1SLP_CTR	(0xe2a*2)
#define	M_JTAG_DS1SLP_CTR	(0xe2b*2)
#define	M_HUDI_MNPOLL_CTR	(0xe2c*2)
#define	M_HUDI_PM_CTR	(0xe2d*2)
#define	M_HUDI_NO_ACTION	(0xe2e*2)
...
#define	M_AWK_RSN_CD	(0xe2f*2)
#define	M_AWK_RSN_CTRL	(0xe30*2)
#define	M_SLP_ACT_TSF_L	(0xe31*2)
#define	M_SLP_ACT_TSF_ML	(0xe32*2)
...
#define	M_PHY_SAMPLECMD	(0xe33*2)
#define	M_RXENSTAT_FLAG	(M_RXENSTAT_BLK+(0x0*2))
#define	M_RXENSTAT_FLAG_OFFSET	(0x0*2)
#define	M_RXENSTAT_NOSEC	(M_RXENSTAT_BLK+(0x1*2))
#define	M_RXENSTAT_NOSEC_OFFSET	(0x1*2)
