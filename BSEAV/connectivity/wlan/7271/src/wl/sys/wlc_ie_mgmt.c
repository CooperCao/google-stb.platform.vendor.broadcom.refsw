...
static const wlc_iem_tag_t BCMINITDATA(ie_tags_bcn)[] = {
	...
	/* 57 */ DOT11_MNG_VHT_CAP_ID,
	/* 58 */ DOT11_MNG_VHT_OPERATION_ID,
	/* 59 */ DOT11_MNG_VHT_TRANSMIT_POWER_ENVELOPE_ID,
	/* 60 */ DOT11_MNG_CHANNEL_SWITCH_WRAPPER_ID,
	/* 63 */ DOT11_MNG_OPER_MODE_NOTIF_ID,
...
static const wlc_iem_tag_t BCMINITDATA(ie_tags_assocreq)[] = {
	...
	/* XX */ DOT11_MNG_CCKM_REASSOC_ID,	/* required to initialize RN value with assoc */
#endif
	/* Last */ DOT11_MNG_VS_ID
};
