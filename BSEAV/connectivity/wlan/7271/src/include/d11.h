...
#define FCBS_DS0_BM_DATPTR_BASE	(FCBS_DS0_BM_CMDPTR_BASE + FCBS_DS0_BM_CMD_SZ)

#define FCBS_DS1_BM_CMD_SZ		0x2000	/* 8K bytes */
#define FCBS_DS1_BM_DAT_SZ		0x2000	/* 8K bytes */

#define FCBS_DS1_BM_CMDPTR_BASE	0x17B4
#define FCBS_DS1_BM_DATPTR_BASE	(FCBS_DS1_BM_CMDPTR_BASE + FCBS_DS1_BM_CMD_SZ)
...
#define MHF3_SISO_BCMC_RX	0x2000	/* Disable switch to MIMO on recving multicast TIM */
...
#define PHYMODE_BGDFS		(SCAN_CORE_ACTIVE)
...
#define M_AWDL_TX_DUR_L(x)	((0x3b4 * 2) + 0x0)
#define M_AWDL_TX_DUR_H(x)	((0x3b4 * 2) + 0x2)
#define M_AWDL_RX_DUR_L(x)	((0x3b6 * 2) + 0x0)
#define M_AWDL_RX_DUR_H(x)	((0x3b6 * 2) + 0x2)
...
#define M_HWAGG_STATS_PTR(x)       M_TXFS_PTR(x)		/**< corerev < 40 hwagg */
