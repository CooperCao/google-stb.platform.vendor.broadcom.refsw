...
{
#if (defined(PHYWAR_43012_CRWLDOT11M_2177) || defined(STB_SOC_WIFI))
	...
	int32 int_val, int err)
{
	...
	/* do not block BT during 5g scan */
	in_5g_scan = wlapi_is_lq_5g_scan(pi->sh->physhim);
...
#if !defined(PHY_VER)  || (defined(PHY_VER) && (defined(PHY_ACMAJORREV_3) || defined(PHY_ACMAJORREV_4)))
	if (ACMAJORREV_3(pi->pubpi->phy_rev) || ACMAJORREV_4(pi->pubpi->phy_rev)) {
		spb_depth = 256;
	}
#endif /* !defined(PHY_VER)  || (defined(PHY_VER) && (defined(PHY_ACMAJORREV_3) || defined(PHY_ACMAJORREV_4))) */
