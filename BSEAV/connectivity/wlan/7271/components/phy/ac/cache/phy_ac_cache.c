...
phy_ac_reg_cache_parse(phy_info_acphy_t *pi_ac, uint16 id, bool populate)
{
	...
	/* 4347 TC2 IQLOCAL Radio Reg to be stored */

#if !defined(PHY_VER)  || (defined(PHY_VER) && defined(PHY_ACMAJORREV_25))
	uint16 radioregs_txiqlocal_20694_rmajorrev1[] = {
		...
		RADIO_REG_20694(pi, RF, TX_BB_OVR1, 0),
		RADIO_REG_20694(pi, RF, TX_BB_OVR2, 0),
		RADIO_REG_20694(pi, RF, TX_LPF_REG7, 0),
	...
	/* 4347 A0 IQLOCAL Radio Reg to be stored */
	...
	uint16 radioregs_tempsense_vbat_20696[] = {
		RADIO_REG_20696(pi, TEMPSENSE_OVR1, 0),
		RADIO_REG_20696(pi, TEMPSENSE_CFG, 0),
		...
		RADIO_REG_20696(pi, AUXPGA_VMID, 0),
	...
	uint16 radioregs_txiqlocal_20696_majorrev37[] = {
		...
		RADIO_REG_20696(pi, TX2G_MIX_REG2, 0)
	};
	...
	*/
	if (!populate) {
		...
		if (ACMAJORREV_25(pi->pubpi->phy_rev)) {
			/* 4347 TC2 */
			radioreg_size = MAX(ARRAYSIZE(radioregs_txiqlocal_20694_rmajorrev1),
		...
		switch (id) {
			case RADIOREGS_TXIQCAL:
				...
				if (ACMAJORREV_25(pi->pubpi->phy_rev)) {
					/* 4347 TC2 */
					list = radioregs_txiqlocal_20694_rmajorrev1;
					sz   = ARRAYSIZE(radioregs_txiqlocal_20694_rmajorrev1);
				} else
#endif /* !defined(PHY_VER)  || (defined(PHY_VER) && defined(PHY_ACMAJORREV_25)) */
#if !defined(PHY_VER)  || (defined(PHY_VER) && defined(PHY_ACMAJORREV_37))
				if (ACMAJORREV_37(pi->pubpi->phy_rev)) {
			...
			case RADIOREGS_RXIQCAL:
				...
				if (ACMAJORREV_40(pi->pubpi->phy_rev)) {
					/* 4347 A0 */
					list = radioregs_rxiqcal_20694;
					sz   = ARRAYSIZE(radioregs_rxiqcal_20694);
				} else
#endif /* !defined(PHY_VER)  || (defined(PHY_VER) && defined(PHY_ACMAJORREV_40)) */
				{
				}
...
#if !defined(PHY_VER)  || (defined(PHY_VER) && defined(PHY_ACMAJORREV_37))
				if (ACMAJORREV_37(pi->pubpi->phy_rev)) {
					list = radioregs_tempsense_vbat_20696;
					sz   = ARRAYSIZE(radioregs_tempsense_vbat_20696);
				} else
#endif /* !defined(PHY_VER)  || (defined(PHY_VER) && defined(PHY_ACMAJORREV_37)) */
				{
		...
		if (list != NULL) {
			...
			PHY_INFORM(("***** core %d ***** : %s\n", core, __FUNCTION__));
			for (i = 0; i < sz; i++) {
#if !defined(PHY_VER)  || (defined(PHY_VER) && (defined(PHY_ACMAJORREV_25) || defined(PHY_ACMAJORREV_40)))
				if (ACMAJORREV_40(pi->pubpi->phy_rev) ||
...
#endif /* !defined(PHY_VER)  || (defined(PHY_VER) && (defined(PHY_ACMAJORREV_25) || defined(PHY_ACMAJORREV_40))) */
#if !defined(PHY_VER)  || (defined(PHY_VER) && defined(PHY_ACMAJORREV_37))
				if (ACMAJORREV_37(pi->pubpi->phy_rev)) {
					/* BCM7271 */
					cache->addr[core] = list[i];
