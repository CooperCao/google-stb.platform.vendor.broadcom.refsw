...
#define phy_ac_btcx_override_enable(p)  phy_ac_btcx_override_enable_int(PHY_COEX_TRACE_FNCTX(p))
#define phy_ac_btcx_override_disable(p) phy_ac_btcx_override_disable_int(PHY_COEX_TRACE_FNCTX(p))
static void PHY_TRACE_DECL(phy_ac_btcx_override_enable , phy_type_btcx_ctx_t *ctx)
static void PHY_TRACE_DECL(phy_ac_btcx_override_disable, phy_type_btcx_ctx_t *ctx)
	...
	phy_btcx_info_t *cmn_info)
{
	...
	fns.override_enable = phy_ac_btcx_override_enable_int;
	fns.override_disable = phy_ac_btcx_override_disable_int;
...
static void
PHY_TRACE_DEFN(phy_ac_btcx_override_enable, phy_type_btcx_ctx_t *ctx)
{
	phy_ac_btcx_info_t *btcxi = (phy_ac_btcx_info_t *)ctx;
	phy_info_t *pi = btcxi->pi;
...
static void
PHY_TRACE_DEFN(phy_ac_btcx_override_disable, phy_type_btcx_ctx_t *ctx)
{
	phy_ac_btcx_info_t *btcxi = (phy_ac_btcx_info_t *)ctx;
	phy_info_t *pi = btcxi->pi;
	...
	if ((pi->sh->machwcap & MCAP_BTCX) &&
		...
		PHY_COEX_TRACE("ac override off");
