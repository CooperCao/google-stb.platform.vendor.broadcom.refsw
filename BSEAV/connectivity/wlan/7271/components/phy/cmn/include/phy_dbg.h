...
#define PHY_COEX(args)	do {if (phyhal_msg_level & PHYHAL_COEX) PHY_PRINT(args);} while (0)
...
#if defined (PHY_COEX_DBG_TRACE)
#define PHY_COEX_TRACE_FNCTX(param)         param,__FUNCTION__,__LINE__
#define PHY_COEX_TRACE_PARMS                ,const char* fn,unsigned int line
#define PHY_COEX_TRACE_CALL(cfn, param)     cfn(param,fn,line)
#define PHY_COEX_TRACE(msg)                 PHY_COEX((#msg": %s:%s.%d\n",__FUNCTION__,fn,line))
#define PHY_COEX_TRACE_EXP(param)           param PHY_COEX_TRACE_PARMS      /* inline expand */
#else
#define PHY_COEX_TRACE_FNCTX(param)         param
#define PHY_COEX_TRACE_PARMS
#define PHY_COEX_TRACE_CALL(cfn,param)      cfn(param)
#define PHY_COEX_TRACE(msg)                 PHY_TRACE(("%s\n", __FUNCTION__))
#define PHY_COEX_TRACE_EXP(param)           param
#endif

#define PHY_TRACE_DEFN(fn, param) fn##_int(param PHY_COEX_TRACE_PARMS)
#define PHY_TRACE_DECL(fn, param) fn##_int(param PHY_COEX_TRACE_PARMS);
