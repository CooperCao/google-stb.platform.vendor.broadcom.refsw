...
typedef int (*phy_type_rxiqcal_dump_clear_fn_t)(phy_type_rxiqcal_ctx_t *ctx);
...
typedef struct {
	...
	phy_type_rxiqcal_dump_fn_t rxiqcal_dump;
	phy_type_rxiqcal_dump_clear_fn_t rxiqcal_dump_clear;
