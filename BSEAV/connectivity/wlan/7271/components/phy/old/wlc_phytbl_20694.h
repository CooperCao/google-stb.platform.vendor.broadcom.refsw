...
extern int8 BCMATTACHDATA(tia_gain_tbl_2g_maj40)[N_TIA_GAINS];
extern int8 BCMATTACHDATA(tia_gain_tbl_5g_maj40)[N_TIA_GAINS];
extern int8 BCMATTACHDATA(tia_gainbits_tbl_2g_maj40)[N_TIA_GAINS];
extern int8 BCMATTACHDATA(tia_gainbits_tbl_5g_maj40)[N_TIA_GAINS];
