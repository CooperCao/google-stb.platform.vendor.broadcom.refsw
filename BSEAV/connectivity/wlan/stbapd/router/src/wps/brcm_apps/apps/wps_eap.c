 ...
 *
 * $Id: wps_eap.c 715747 2017-08-14 10:47:34Z $
 */
...
extern uint32 wps_eap_parse_scan_result(wl_event_msg_t* event, char* ifname);
...
wps_eap_process_msg(char *buf, int buflen)
{
...
#ifdef BCMWPSAP
	CTlvSsrIE ssrmsg;
	unsigned char authorizedMacs[SIZE_MAC_ADDR * SIZE_AUTHORIZEDMACS_NUM] = {0};
	...
	if (wksp) {
...
#endif /* BCMWPSAP */
		{
			...
			printf("%s calling wps_app->process\n", __func__);
#endif
