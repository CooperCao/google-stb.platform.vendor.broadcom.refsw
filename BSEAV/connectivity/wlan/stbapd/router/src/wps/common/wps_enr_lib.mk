...
ifeq ($(BLDTYPE),debug)
export CFLAGS = -Wall -Werror -Wnested-externs -g -D_TUDEBUGTRACE -DWPS_WIRELESS_ENROLLEE
export CXXFLAGS = -Wall -Werror -Wnested-externs -g -D_TUDEBUGTRACE -DWPS_WIRELESS_ENROLLEE
else
export CFLAGS = -Os -Wall -Werror -Wnested-externs -DWPS_WIRELESS_ENROLLEE
export CXXFLAGS = -Os -Wall -Werror -Wnested-externs -DWPS_WIRELESS_ENROLLEE
endif
