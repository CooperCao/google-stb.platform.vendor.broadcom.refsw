 ...
 *
 * $Id: ap_eap_sm.c 738664 2018-01-03 05:04:52Z $
 */
...
uint32
ap_eap_sm_process_sta_msg(char *msg, int msg_len, unsigned char *authorizedMacs, int authorizedMacs_len)
{
...
uint32
ap_eap_sm_init(void *mc_dev, unsigned char *mac_sta, char * (*parse_msg)(char *, int, int *),
