 ...
 *
 * $Id: wlc_lq.h 721475 2017-09-14 13:37:18Z $
 */
...
#ifdef WLCHANIM_US
extern void wlc_lq_chanim_update_us(wlc_info_t *wlc, chanspec_t chanspec);
#else
#define wlc_lq_chanim_update_us(a, b)	do {} while (0)
#endif /* WLCHANIM_US */
