 ...
 *
 * $Id: wbd_json_utility.c 765481 2018-07-04 10:54:22Z sp888952 $
 */
...
#define JSON_SAFE_GET_DATAOBJ(object_main, object_data, TAG, ERR) \
		do { \
			json_object_object_get_ex(object_main, TAG, &object_data); \
			if (object_data == NULL) { \
