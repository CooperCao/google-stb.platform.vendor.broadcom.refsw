 ...
 *
 * $Id: wbd_error.h 753948 2018-03-23 11:36:03Z sp888952 $
 */
...
#define WBDE_SAME_EVT_OCRRD	-23	/* Same Event occured */
#define WBDE_IGNORE_OPPO_EVT	-24	/* Ignored old opposite event */
#define WBDE_NEW_EVT_OCRRD	-25	/* New event occured */
...
#define WBDE_DS_UN_DWDSSTA	-58	/* DWDS STA not found in dwdslist */
#define WBDE_DS_MAC_EXST	-59	/* MAC already exists in MAC list */
#define WBDE_DS_UN_MAC		-60	/* Unknown MAC address in MAC List */
#define WBDE_DS_UN_EVENT	-61	/* Event Not found in eventlist */
...
#define WBDERRSTRINGTABLE {			\
	...
	"STA Already Exists",			\
	"DWDS STA not found in dwdslist",	\
	"MAC Address Already Exists",		\
	"MAC Address not found in maclist",	\
	"Event Not found in eventlist",		\
	"STA is bouncing STA",			\
