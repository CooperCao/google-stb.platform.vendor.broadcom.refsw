 ...
 *
 * $Id: blanket.h 766226 2018-07-27 07:03:15Z sp888952 $
 *
 *  @author
 *  @bug No known bugs.
 */
 ...
 * @param use_ctrl_chan	Use Control channel or Center channel for 80/160 Mhz
 *
 * @return		status of the call. 0 Success. Non Zero Failure
 */
 ...
 *
 * @param ifname	interface name of the BSS
 * @param bcnreq	Beacon Request data as per 802.11 spec. Includes:  STA MAC,
...
/** @brief finds whether given interface is a bcakhaul bss
 *
 * @param ifname	interface name of the BSS
 *
 * @return true if backhaul bss interface else false
 */
bool blanket_is_iface_backhaulbss(char *ifname);
#endif /* __BLANKET_H__ */
