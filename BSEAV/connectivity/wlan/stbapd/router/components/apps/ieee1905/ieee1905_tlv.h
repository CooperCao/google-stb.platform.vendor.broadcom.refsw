...
int i5TlvAPRadioBasicCapabilitiesTypeExtract(i5_message_type *pmsg, unsigned char extractOne,
  unsigned char *outMac, ieee1905_radio_caps_type **RadioCaps);
...
int i5TlvHigherLayerDataTypeInsert(i5_message_type *pmsg,
  i5HigherLayerProtocolField_Values protocol, unsigned char *data, unsigned short data_len);
