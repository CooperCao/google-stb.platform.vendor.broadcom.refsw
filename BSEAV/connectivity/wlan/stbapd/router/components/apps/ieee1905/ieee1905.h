 ...
 *
 * $Id: ieee1905.h 767283 2018-09-04 06:20:22Z sp888952 $
 */
...
#define REGCLASS_160MHZ_MAX_CNTRL_CHAN	128
 ...
 * @param old_traffic_stats Old Traffic stats
...
typedef int ieee1905_get_assoc_sta_metric(char *ifname, unsigned char *bssid, unsigned char *sta_mac,
  ...
  const ieee1905_sta_traffic_stats *old_traffic_stats, ieee1905_vendor_data *out_vndr_data);
 ...
 *
 * @param ifname      Interface Name
 * @param erase       1 to erase all the BSS on that interface.
 * @param bss         BSS to be added
 * @param restart     Apply the setting and restart if needed as this is the last setting for BSS
 *
 * @return		            status of the call. 0 Success. Non Zero Failure
 */
typedef int ieee1905_create_bss_on_ifr(char *ifname, unsigned char erase,
 ...
 * @return            void
 */
typedef void ieee1905_process_vendor_specific_msg(ieee1905_vendor_data *msg_data);
