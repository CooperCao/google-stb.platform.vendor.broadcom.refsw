  ...
  i5_dm_clients_type *pdmclient, ieee1905_ifr_metricrpt *metricrpt, ieee1905_vendor_data *vndr_data)
{
  ...
  if (i5_config.cbs.assoc_sta_metric) {
    i5_config.cbs.assoc_sta_metric(pbss->ifname, pbss->BSSID, pdmclient->mac, &link_metric,
      &traffic_stats, &pdmclient->old_traffic_stats, vndr_data);
    clock_gettime(CLOCK_REALTIME, &link_metric.queried);
    memcpy(&pdmclient->link_metric, &link_metric, sizeof(pdmclient->link_metric));

    pdmclient->traffic_stats.bytes_sent =
      traffic_stats.bytes_sent - pdmclient->old_traffic_stats.bytes_sent;
    pdmclient->traffic_stats.bytes_recv =
      traffic_stats.bytes_recv - pdmclient->old_traffic_stats.bytes_recv;
    pdmclient->traffic_stats.packets_sent =
      traffic_stats.packets_sent - pdmclient->old_traffic_stats.packets_sent;
    pdmclient->traffic_stats.packets_recv =
      traffic_stats.packets_recv - pdmclient->old_traffic_stats.packets_recv;
    pdmclient->traffic_stats.tx_packet_err =
      traffic_stats.tx_packet_err - pdmclient->old_traffic_stats.tx_packet_err;
    pdmclient->traffic_stats.rx_packet_err =
      traffic_stats.rx_packet_err - pdmclient->old_traffic_stats.rx_packet_err;
    pdmclient->traffic_stats.retransmission_count =
      traffic_stats.retransmission_count - pdmclient->old_traffic_stats.retransmission_count;
    memcpy(&pdmclient->old_traffic_stats, &traffic_stats, sizeof(pdmclient->old_traffic_stats));
  }
}
