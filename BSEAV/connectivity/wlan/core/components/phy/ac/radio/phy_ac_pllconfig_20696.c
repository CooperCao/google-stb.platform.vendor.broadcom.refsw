...
BCMATTACHFN(phy_ac_radio20696_pll_config_const_calc)(phy_info_t *pi, pll_config_20696_tbl_t *pll)
{
	...
	PLL_CONFIG_20696_VAL_ENTRY(pll, RFPLL_VCOCAL_DELAYEND, (uint16)fp_round_64(temp_64, NF16));
	...
	/* round(0.16.16, 16) -> <0.32.0> */
	PLL_CONFIG_20696_VAL_ENTRY(pll, RFPLL_VCOCAL_PAUSECNT, (uint16)fp_round_64(temp_64, NF16));
	...
	uint8 ac_mode, pll_config_20696_tbl_t *pll)
{
	...
	*/
	...
	nf = fp_div_64(c1_passive_lf_fx, CAP_MULTIPLIER_RATIO_PLUS_ONE_20696, NF16, NF0,
	...
	/* <0.16.16> * <0.16.16> -> <0.16.16> */
	i_off_fx = (uint32)fp_mult_64(temp_32, IOFF_REF_CONST_FX, NF16, NF16, NF16);
	...
	if (temp_sign > 0) {
		/* <0.16.16> / <0.16.16> -> <0.(32-nf).nf> */
		nf = fp_div_64((uint64)temp_sign, CONST_281_21_FX, NF16, NF16, &temp_32);
	...
	if (temp_sign > 0) {
		/* <0.16.16> / <0.16.16> -> <0.(32-nf).nf> */
		nf = fp_div_64((uint64)temp_sign, CONST_P5041_FX, NF16, NF16, &temp_32);
		/* round(<0.(32-nf).nf>, nf) -> <0.32.0> */
	...
	if (temp_sign > 0) {
		/* <0.16.16> / <0.16.16> -> <0.(32-nf).nf> */
		nf = fp_div_64((uint64)temp_sign, CONST_P21758_FX, NF16, NF16, &temp_32);
		/* round(<0.(32-nf).nf>, nf) -> <0.32.0> */
	...
	if (temp_sign > 0) {
		/* <0.16.16> / <0.16.16> -> <0.(32-nf).nf> */
		nf = fp_div_64((uint64)temp_sign, CONST_P11059_FX, NF16, NF16, &temp_32);
		/* round(<0.(32-nf).nf>, nf) -> <0.32.0> */
	...
	if (temp_sign > 0) {
		/* <0.16.16> / <0.16.16> -> <0.(32-nf).nf> */
		nf = fp_div_64((uint64)temp_sign, CONST_P055381_FX, NF16, NF16, &temp_32);
		/* round(<0.(32-nf).nf>, nf) -> <0.32.0> */
	...
	rfpll_cp_ioff_dec_fx = fp_round_32(i_off_fx, NF16);
