...
#if !defined(PHY_VER) || (defined(PHY_VER) && (defined(PHY_ACMAJORREV_0) || defined(PHY_ACMAJORREV_2)) || defined(PHY_ACMAJORREV_5) || defined(PHY_ACMAJORREV_36))
...
#endif /* !defined(PHY_VER) || (defined(PHY_VER) && (defined(PHY_ACMAJORREV_0) || defined(PHY_ACMAJORREV_2)) || defined(PHY_ACMAJORREV_5) || defined(PHY_ACMAJORREV_36)) */
		info->ti->data->txpwroverrideset = FALSE;
	}
#endif /* (WLTEST || BCMINTPHYDBG || PKTENG) */
...
#define MINPWRRANGE_11DBM	44
	...
	*/
	...
	if ((ACMAJORREV_1(pi->pubpi->phy_rev) && ACMINORREV_2(pi)) || TINY_RADIO(pi)) {
	...
	if (BF3_TSSI_DIV_WAR(pi_ac) && (ACMAJORREV_2(pi->pubpi->phy_rev))) {
...
#if !defined(PHY_VER)  || (defined(PHY_VER) && defined(PHY_ACMAJORREV_4))
	if (ACMAJORREV_4(pi->pubpi->phy_rev) && (flag2rangeon || BF3_TSSI_DIV_WAR(pi_ac))) {
			...
			if (CHIPID(pi->sh->chip) == BCM4345_CHIP_ID ||
				...
				if (ACMAJORREV_4(pi->pubpi->phy_rev) ||
					...
					if (idx == 3) {
						 ...
						 * not added
						 */
						FOREACH_ACTV_CORE(pi, stf_shdata->hw_phyrxchain,
							core) {
...
wlc_phy_txpwrctrl_pwr_setup_srom12_acphy(phy_info_t *pi)
{
	...
	int32  pwr_est, pwr_est_cck, tbl_len;
	uint32 regval[128];
	...
	if (pi->u.pi_acphy->sromi->srom_low_adc_rate_en && ACMAJORREV_37(pi->pubpi->phy_rev)) {
		 ...
		 * http://confluence.broadcom.com/x/1ohlFw
		 */
		phy_ac_tssi_low_rate_adc_setup(pi);
	}
...
#if !defined(RADIO_ID)  || (defined(RADIO_ID) && (defined(RADIO_BCM20691) || defined(RADIO_BCM20693) || defined(RADIO_BCM20695)))
		if ((RADIOID_IS(pi->pubpi->radioid, BCM20691_ID)) ||
...
#endif /*  !defined(RADIO_ID)  || (defined(RADIO_ID) && ((RADIO_BCM20691) || (RADIO_BCM20693) || (RADIO_BCM20695))) */
...
#endif /* !defined(PHY_VER)  || (defined(PHY_VER) && (defined(PHY_ACMAJORREV_2) || defined(PHY_ACMAJORREV_4))) */
#if !defined(PHY_VER)  || (defined(PHY_VER) && defined(PHY_ACMAJORREV_1))
	if (ACMAJORREV_1(pi->pubpi->phy_rev) && BF3_TSSI_DIV_WAR(pi->u.pi_acphy)) {
		if (CHSPEC_IS5G(pi->radio_chanspec)) {
			*ret_int_ptr = 0x21;
		}
		else
...
#endif /* !defined(PHY_VER)  || (defined(PHY_VER) && (defined(PHY_ACMAJORREV_2) || defined(PHY_ACMAJORREV_4))) */
#if !defined(PHY_VER)  || (defined(PHY_VER) && defined(PHY_ACMAJORREV_1))
	if (tpci->ti->data->cfg->srom_tworangetssi2g &&
...
{
#if (defined(WLC_TXCAL) || (defined(BCMINTPHYDBG) || defined(WLTEST)))
	uint8 core;
	phy_info_t *pi = tpci->pi;
	uint8 phyrxchain;
	...
	wlc_phy_susp2tx_cts2self(pi, 10);
#else
	return BCME_UNSUPPORTED;
#endif /* (defined(WLC_TXCAL) || (defined (BCMINTPHYDBG) || defined(WLTEST))) */
	return BCME_OK;
}
#endif /* RADIO_HEALTH_CHECK */
...
void
phy_ac_tssi_low_rate_adc_setup(phy_info_t *pi)
{
	ACPHY_REG_LIST_START
		ACPHYREG_BCAST_ENTRY(pi, lowRateTssiDlyOFDM0, 750)
		ACPHYREG_BCAST_ENTRY(pi, lowRateTssiDlyBPHY0, 750)
		...
		//Do reset to TxPwrCtlr HW
		MOD_PHYREG_ENTRY(pi, TxPwrCtrlCmd, txpwrctrlReset, 1);
	ACPHY_REG_LIST_EXECUTE(pi);
	//usleep 20
	OSL_DELAY(20);
	ACPHY_REG_LIST_START
		...
		MOD_PHYREG(pi, TxPwrCtrlDamping, DeltaPwrDamp, 0x40);
		MOD_PHYREG(pi, TxPwrCtrlNnum, Npt_intg_log2, 0x1);
		MOD_PHYREG(pi, TssiAccumCtrl, Ntssi_intg_log2, 4);
		MOD_PHYREG(pi, TxPwrCtrlNnum, Ntssi_delay, 150);
		MOD_PHYREG(pi, TssiAccumCtrl, Ntssi_accum_delay, 0);
		MOD_PHYREG(pi, TssiAccumCtrlcck, Ntssi_accum_delay_cck, 0);
		MOD_PHYREG(pi, TssiAccumCtrlcck, Ntssi_intg_log2_cck, 4);
		MOD_PHYREG(pi, perPktIdleTssiCtrl, perPktIdleTssiUpdate_en, 1);
		MOD_PHYREG(pi, TSSIMode, TwoPwrRange, 0);
		MOD_PHYREG(pi, TxPwrCtrl_Multi_Mode0, multi_mode, 0x1);
		MOD_PHYREG(pi, TxPwrCtrl_Multi_Mode1, multi_mode, 0x1);
		MOD_PHYREG(pi, TxPwrCtrl_Multi_Mode2, multi_mode, 0x1);
		MOD_PHYREG(pi, TxPwrCtrl_Multi_Mode3, multi_mode, 0x1);
