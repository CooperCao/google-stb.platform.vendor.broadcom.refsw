...
BCMATTACHFN(phy_ac_txiqlocal_populate_params)(phy_ac_txiqlocal_info_t *iqcal_info)
{
	...
	uint8 nsamp_gctrl[3] = {0};
	uint8 nsamp_corrs[3] = {0};
...
#endif /* !defined(RADIO_ID)  || (defined(RADIO_ID) && defined(RADIO_BCM2069)) */
	{
		...
		if (ACMAJORREV_36(pi->pubpi->phy_rev) && PHY_IPA(pi)) {
		...
		if (ACMAJORREV_37(pi->pubpi->phy_rev)) {
			nsamp_gctrl[0] = 0x11; nsamp_gctrl[1] = 0x11; nsamp_gctrl[2] = 0x11;
...
#if !defined(PHY_VER)  || (defined(PHY_VER) && (defined(PHY_ACMAJORREV_36) || defined(PHY_ACMAJORREV_25) || defined(PHY_ACMAJORREV_40)))
...
#endif /* !defined(PHY_VER)  || (defined(PHY_VER) && (defined(PHY_ACMAJORREV_36) || defined(PHY_ACMAJORREV_25) || defined(PHY_ACMAJORREV_40))) */

#if !defined(PHY_VER)  || (defined(PHY_VER) && defined(PHY_ACMAJORREV_25))
			if (ACMAJORREV_25(pi->pubpi->phy_rev)) {
				nsamp_corrs[0] = 0x7F; nsamp_corrs[1] = 0x7F; nsamp_corrs[2] = 0x7F;
			} else
...
#if !defined(PHY_VER)  || (defined(PHY_VER) && (defined(PHY_ACMAJORREV_40) || defined(PHY_ACMAJORREV_40)))
...
#endif /* !defined(PHY_VER)  || (defined(PHY_VER) && (defined(PHY_ACMAJORREV_40) || defined(PHY_ACMAJORREV_40))) */
	}
	...
	params->num_cmds_refine_prerx = ARRAYSIZE(cmds_REFINE_PRERX);
	params->num_cmds_restart_prerx = ARRAYSIZE(cmds_RESTART_PRERX);
	memcpy(params->cmds_REFINE_PRERX, cmds_REFINE_PRERX, sizeof(cmds_REFINE_PRERX));
	memcpy(params->cmds_RESTART_PRERX, cmds_RESTART_PRERX, sizeof(cmds_RESTART_PRERX));
...
wlc_phy_txcal_radio_setup_acphy_20694(phy_ac_txiqlocal_info_t *ti)
{
	...
	FOREACH_ACTV_CORE(pi, phyrxchain, core) {
		...
		if (CHSPEC_IS2G(pi->radio_chanspec)) {
			MOD_RADIO_REG_20694(pi, RF, IQCAL_CFG1, core, iqcal_sel_sw, 0x8);
			...
			*/
			...
			MOD_RADIO_REG_20694(pi, RF, IQCAL_CFG1, core, iqcal_sel_sw, 0xa);
			/* #tap from PA output */
			MOD_RADIO_REG_20694(pi, RF, TX5G_CFG2_OVR, core,
			ovr_pa5g_tssi_ctrl_sel, 0x1);
			MOD_RADIO_REG_20694(pi, RF, TX5G_MISC_CFG1, core,
		...
		if (core == 0) {
			...
			MOD_RADIO_REG_20694_ENTRY(pi, RF, IQCAL_OVR1, 0,
			ovr_iqcal_PU_wbpga, 0x1)
			MOD_RADIO_REG_20694_ENTRY(pi, RF, IQCAL_CFG5, 0, wbpga_pu, 0x1)
			MOD_RADIO_REG_20694_ENTRY(pi, RF, IQCAL_OVR1, 0,
			ovr_iqcal_PU_loopback_bias, 0x1)
			MOD_RADIO_REG_20694_ENTRY(pi, RF, IQCAL_CFG5, 0,
			...
			if (ACMAJORREV_25(pi->pubpi->phy_rev)) {
				...
				MOD_RADIO_REG_20694_ENTRY(pi, RF, TX_BB_OVR2, 0,
				ovr_lpf_sw_bq1_adc, 0x1)
				MOD_RADIO_REG_20694_ENTRY(pi, RF, TX_BB_OVR2, 0,
				ovr_lpf_sw_aux_adc, 0x1)
				MOD_RADIO_REG_20694_ENTRY(pi, RF, TX_BB_OVR1, 0,
				ovr_lpf_sw_bq2_adc, 0x1)
				MOD_RADIO_REG_20694_ENTRY(pi, RF, TX_LPF_REG7, 0,
				lpf_sw_bq2_adc, 0x0)
				MOD_RADIO_REG_20694_ENTRY(pi, RF, TX_LPF_REG7, 0,
				lpf_sw_bq1_adc, 0x0)
				MOD_RADIO_REG_20694_ENTRY(pi, RF, TX_LPF_REG7, 0,
			...
			0     0    disable both
			*/
			MOD_RADIO_REG_20694_ENTRY(pi, RF, IQCAL_CFG1, 0,
			iqcal_tssi_GPIO_ctrl, 0x0)
			MOD_RADIO_REG_20694_ENTRY(pi, RF, IQCAL_CFG1, 0,
			iqcal_sel_ext_tssi, 0x0)
			/* power up iqlocal */
			MOD_RADIO_REG_20694_ENTRY(pi, RF, IQCAL_OVR1, 0,
			ovr_iqcal_PU_iqcal, 1)
			MOD_RADIO_REG_20694_ENTRY(pi, RF, IQCAL_OVR1, 0,
			ovr_iqcal_PU_tssi, 1)
			MOD_RADIO_REG_20694_ENTRY(pi, RF, IQCAL_CFG1, 0,
			iqcal_PU_iqcal, 0x1)
			...
			if (use_wbpga == 1) {
				...
				MOD_RADIO_REG_20694_ENTRY(pi, RF, IQCAL_CFG4, 0,
				iqcal2adc, 0x1)
				MOD_RADIO_REG_20694_ENTRY(pi, RF, IQCAL_CFG4, 0,
				auxpga2adc, 0x0)
				...
				if (CHSPEC_IS2G(pi->radio_chanspec)) {
					...
					MOD_RADIO_REG_20694(pi, RF, IQCAL_GAIN_RIN, 0,
					iqcal_rin, 0x0800);
					MOD_RADIO_REG_20694(pi, RF, IQCAL_GAIN_RFB, 0,
					iqcal_rfb, 0x0080);
				} else {
					/* set the gain of wbpga */
					MOD_RADIO_REG_20694(pi, RF, IQCAL_GAIN_RIN, 0,
				...
				/* set auxpga gain */
				MOD_RADIO_REG_20694_ENTRY(pi, RF, AUXPGA_OVR1, 0,
				ovr_auxpga_i_sel_gain, 1)
				MOD_RADIO_REG_20694_ENTRY(pi, RF, AUXPGA_CFG1, 0,
				auxpga_i_sel_gain, 0x3)
				MOD_RADIO_REG_20694_ENTRY(pi, RF, AUXPGA_OVR1, 0,
				ovr_auxpga_i_sel_vmid, 1)
				MOD_RADIO_REG_20694_ENTRY(pi, RF, AUXPGA_VMID, 0,
				auxpga_i_sel_vmid, 0x9c)

				/* testbuf_sel_test_port */
				MOD_RADIO_REG_20694_ENTRY(pi, RF, TESTBUF_OVR1, 0,
				ovr_testbuf_sel_test_port, 1)
				MOD_RADIO_REG_20694_ENTRY(pi, RF, TESTBUF_CFG1, 0,
				testbuf_sel_test_port, 0)
				MOD_RADIO_REG_20694_ENTRY(pi, RF, TESTBUF_OVR1, 0,
				ovr_testbuf_PU, 0x1)
				MOD_RADIO_REG_20694_ENTRY(pi, RF, TESTBUF_CFG1, 0,
				testbuf_PU, 0x1)
			...
			*/
			...
			/* Power loopback block bias and wideband PGA for IQCAL */
			MOD_RADIO_REG_20694_ENTRY(pi, RF, IQCAL_OVR1, 1,
			ovr_iqcal_PU_wbpga, 0x1)
			MOD_RADIO_REG_20694_ENTRY(pi, RF, IQCAL_CFG5, 1, wbpga_pu, 0x1)
			MOD_RADIO_REG_20694_ENTRY(pi, RF, IQCAL_OVR1, 1,
			ovr_iqcal_PU_loopback_bias, 0x1)
			MOD_RADIO_REG_20694_ENTRY(pi, RF, IQCAL_CFG5, 1,
			loopback_bias_pu, 0x1)
			...
			if (ACMAJORREV_25(pi->pubpi->phy_rev)) {
				...
				MOD_RADIO_REG_20694_ENTRY(pi, RF, TX_BB_OVR2, 1,
				ovr_lpf_sw_bq1_adc, 0x1)
				MOD_RADIO_REG_20694_ENTRY(pi, RF, TX_BB_OVR2, 1,
				ovr_lpf_sw_aux_adc, 0x1)
				MOD_RADIO_REG_20694_ENTRY(pi, RF, TX_BB_OVR1, 1,
				ovr_lpf_sw_bq2_adc, 0x1)
				MOD_RADIO_REG_20694_ENTRY(pi, RF, TX_LPF_REG7, 1,
				lpf_sw_bq2_adc, 0x0)
				MOD_RADIO_REG_20694_ENTRY(pi, RF, TX_LPF_REG7, 1,
				lpf_sw_bq1_adc, 0x0)
				MOD_RADIO_REG_20694_ENTRY(pi, RF, TX_LPF_REG7, 1,
			...
			0     0    disable both
			*/
			MOD_RADIO_REG_20694_ENTRY(pi, RF, IQCAL_CFG1, 1,
			iqcal_tssi_GPIO_ctrl, 0x0)
			MOD_RADIO_REG_20694_ENTRY(pi, RF, IQCAL_CFG1, 1,
			iqcal_sel_ext_tssi, 0x0)
			/* power up iqlocal */
			...
			if (use_wbpga == 1) {
				...
				MOD_RADIO_REG_20694_ENTRY(pi, RF, IQCAL_CFG4, 1,
				iqcal2adc, 0x1)
				MOD_RADIO_REG_20694_ENTRY(pi, RF, IQCAL_CFG4, 1,
				auxpga2adc, 0x0)
				...
				if (CHSPEC_IS2G(pi->radio_chanspec)) {
					/* set the gain of wbpga */
					MOD_RADIO_REG_20694(pi, RF, IQCAL_GAIN_RIN, 1,
					iqcal_rin, 0x0800);
					MOD_RADIO_REG_20694(pi, RF, IQCAL_GAIN_RFB, 1,
					iqcal_rfb, 0x0080);
				} else {
					/* set the gain of wbpga */
					MOD_RADIO_REG_20694(pi, RF, IQCAL_GAIN_RIN, 1,
				...
				MOD_RADIO_REG_20694_ENTRY(pi, RF, AUXPGA_OVR1, 1,
				ovr_auxpga_i_sel_vmid, 1)
				MOD_RADIO_REG_20694_ENTRY(pi, RF, AUXPGA_VMID, 1,
				auxpga_i_sel_vmid, 0x9c)
...
wlc_phy_txcal_radio_setup_acphy_20696(phy_ac_txiqlocal_info_t *ti, uint8 Biq2byp)
{
	...
	FOREACH_ACTV_CORE(pi, phyrxchain, core) {
		...
		MOD_RADIO_REG_20696(pi, IQCAL_OVR1, core, ovr_iqcal_PU_tssi,	0x1);
		MOD_RADIO_REG_20696(pi, IQCAL_CFG1, core, iqcal_PU_iqcal,	0x1);
		MOD_RADIO_REG_20696(pi, IQCAL_CFG1, core, iqcal_PU_tssi,	0x0);
		MOD_RADIO_REG_20696(pi, IQCAL_CFG5, core, wbpga_pu,		0x1);
		...
		if (CHSPEC_IS2G(pi->radio_chanspec)) {
			MOD_RADIO_REG_20696(pi, TX2G_CFG1_OVR, core, ovr_pa2g_tssi_ctrl_pu, 0x1);
			MOD_RADIO_REG_20696(pi, TX2G_MIX_REG0, core, pa2g_tssi_ctrl_pu, 0x1);

			MOD_RADIO_REG_20696(pi, IQCAL_CFG1, core, iqcal_sel_sw, 0x8);
			MOD_RADIO_REG_20696(pi, TX2G_CFG1_OVR, core, ovr_pa2g_tssi_ctrl_sel, 0x1);
			MOD_RADIO_REG_20696(pi, TX2G_MISC_CFG1, core, pa2g_tssi_ctrl_sel, 0x0);
		} else {
		...
		MOD_RADIO_REG_20696(pi, IQCAL_CFG1, core, iqcal_sel_ext_tssi,		0x0);
		MOD_RADIO_REG_20696(pi, IQCAL_CFG1, core, iqcal_tssi_GPIO_ctrl,		0x0);
		MOD_RADIO_REG_20696(pi, TX5G_CFG2_OVR, core, ovr_pa5g_tssi_ctrl_range,	0x1);
		MOD_RADIO_REG_20696(pi, TX5G_MISC_CFG1, core, pa5g_tssi_ctrl_range,	0x0);

		/* AUX PGA is powered down because we are using WBPGA */
		MOD_RADIO_REG_20696(pi, AUXPGA_OVR1, core, ovr_auxpga_i_pu,		0x1);
		MOD_RADIO_REG_20696(pi, AUXPGA_CFG1, core, auxpga_i_pu,			0x0);
		MOD_RADIO_REG_20696(pi, AUXPGA_OVR1, core, ovr_auxpga_i_sel_input,	0x1);
		MOD_RADIO_REG_20696(pi, AUXPGA_CFG1, core, auxpga_i_sel_input,		0x0);

		MOD_RADIO_REG_20696(pi, IQCAL_CFG4, core, iqcal2adc,		0x1);
		MOD_RADIO_REG_20696(pi, IQCAL_CFG4, core, auxpga2adc,		0x0);

		MOD_RADIO_REG_20696(pi, TESTBUF_OVR1, core, ovr_testbuf_PU,	0x1);
		MOD_RADIO_REG_20696(pi, TESTBUF_CFG1, core, testbuf_PU,		0x0);

		WRITE_RADIO_REG_20696(pi, IQCAL_GAIN_RIN, core,			0x1000);
		WRITE_RADIO_REG_20696(pi, IQCAL_GAIN_RFB, core,			0x0200);
	}
}
...
wlc_phy_txcal_phy_setup_acphy(phy_info_t *pi, uint8 Biq2byp)
{
	...
	if (TINY_RADIO(pi) || ACMAJORREV_25(pi->pubpi->phy_rev) ||
	...
	if (ACMAJORREV_32(pi->pubpi->phy_rev) || ACMAJORREV_33(pi->pubpi->phy_rev) ||
		...
		ACPHY_REG_LIST_START
			MOD_PHYREG_ENTRY(pi, RxFeCtrl1, swap_iq3, 1)
		ACPHY_REG_LIST_EXECUTE(pi);
	}

	/* ADC pulse clamp en fix */
	if (!ACMAJORREV_25(pi->pubpi->phy_rev) && !ACMAJORREV_36(pi->pubpi->phy_rev) &&
		!ACMAJORREV_37(pi->pubpi->phy_rev) && !ACMAJORREV_40(pi->pubpi->phy_rev)) {
...
#if !defined(PHY_VER)  || (defined(PHY_VER) && (defined(PHY_ACMAJORREV_25) || defined(PHY_ACMAJORREV_40)))
	if (ACMAJORREV_25(pi->pubpi->phy_rev) || ACMAJORREV_40(pi->pubpi->phy_rev)) {
		if (bw_idx == 0) {
                       ...
                       bool switch_gpiosel, uint16 core, bool is_tssi)
{
...
#endif /* !defined(PHY_VER)  || (defined(PHY_VER) && (defined(PHY_ACMAJORREV_32) || defined(PHY_ACMAJORREV_33))) */
#if !defined(PHY_VER)  || (defined(PHY_VER) && (defined(PHY_ACMAJORREV_36) || defined(PHY_ACMAJORREV_37)))
		if (ACMAJORREV_36(pi->pubpi->phy_rev) ||
			ACMAJORREV_37(pi->pubpi->phy_rev)) {
			int tmp;
			uint16 tssi_val = 0;
...
#endif /* !defined(PHY_VER)  || (defined(PHY_VER) && (defined(PHY_ACMAJORREV_36) || defined(PHY_ACMAJORREV_37))) */
		{
	...
	if (switch_gpiosel && (ACMAJORREV_37(pi->pubpi->phy_rev) ||
		ACMAJORREV_40(pi->pubpi->phy_rev))) {
...
wlc_phy_cal_txiqlo_acphy(phy_info_t *pi, uint8 searchmode, uint8 mphase, uint8 Biq2byp)
{
	...
	if (pi->u.pi_acphy->sromi->srom_low_adc_rate_en && ACMAJORREV_37(pi->pubpi->phy_rev)) {
		/* In low rate TSSI mode, adc running low,
		* use overrides to configure ADC to normal mode
		*/
	...
	if (mphase) {
	  ...
	  if (ti->prerxcal) {
		ti->cmd_idx = (pi->cal_info->cal_phase_id - ACPHY_CAL_PHASE_TXPRERXCAL0) *
			MPHASE_TXCAL_CMDS_PER_PHASE; /* first cmd index in this phase */
	  } else {
		ti->cmd_idx = (pi->cal_info->cal_phase_id - ACPHY_CAL_PHASE_TX0) *
			MPHASE_TXCAL_CMDS_PER_PHASE; /* first cmd index in this phase */
	  }
	...
	if ((ACMAJORREV_40(pi->pubpi->phy_rev))) {
		if (CHSPEC_IS20(pi->radio_chanspec) && CHSPEC_IS5G(pi->radio_chanspec)) {
				tone_freq = ACPHY_IQCAL_TONEFREQ_40MHz;
		}
	} else
#endif /* !defined(PHY_VER)  || (defined(PHY_VER) && defined(PHY_ACMAJORREV_40)) */
	if (!((ACMAJORREV_4(pi->pubpi->phy_rev)) ||
	...
	bcmerror = phy_ac_txiqlocal_cmd(ti, searchmode, mphase, Biq2byp, bcmerror);
...
#if !defined(PHY_VER)  || (defined(PHY_VER) && defined(PHY_ACMAJORREV_25))
			/* Turn Off Inactive cores for 4347 TC2/A0  */
			if (ACMAJORREV_25(pi->pubpi->phy_rev)) {
				uint8 off_core = 0;
				if (core == 0) {
					off_core = 1;
				...
				if (CHSPEC_IS2G(pi->radio_chanspec)) {
					MOD_RADIO_REG_20694(pi, RF, TX2G_CFG1_OVR, off_core,
						ovr_pa2g_2gtx_pu, 0x1);
					MOD_RADIO_REG_20694(pi, RF, PA2G_CFG1, off_core,
						pa2g_2gtx_pu, 0x0);
				} else {
					MOD_RADIO_REG_20694(pi, RF, TX5G_CFG1_OVR, off_core,
						ovr_pa5g_pu, 0x1);
					MOD_RADIO_REG_20694(pi, RF, PA5G_CFG4, off_core,
						pa5g_pu, 0x0);
					MOD_RADIO_REG_20694(pi, RF, TX5G_CFG1_OVR, off_core,
						ovr_pad5g_pu, 0x1);
					MOD_RADIO_REG_20694(pi, RF, TX5G_CFG1, off_core,
						pad5g_pu, 0x0);
				}
                             ...
                             bool for_iqcal, bool init_adc_inside, uint16 ADCcore, bool champ)
{
	...
	if (is_tssi) {
		...
		log2_nsamps = (for_iqcal || ACMAJORREV_32(pi->pubpi->phy_rev) ||
			ACMAJORREV_33(pi->pubpi->phy_rev) || ACMAJORREV_37(pi->pubpi->phy_rev))? 3:
		...
		FOREACH_CORE(pi, core) {
		  if (((fdiq_data_valid & (1 << core)) >> core) == 1) {
		    ...
		    if ((ACMAJORREV_32(pi->pubpi->phy_rev) || ACMAJORREV_33(pi->pubpi->phy_rev)) &&
		        CHSPEC_IS80(pi->radio_chanspec))  {
		        ACPHY_REG_LIST_START
			        MOD_PHYREG_ENTRY(pi, fdiqImbCompEnable, txfdiq_iorq, 1)
			    ACPHY_REG_LIST_EXECUTE(pi)
		    }
#endif /* !defined(PHY_VER)  || (defined(PHY_VER) && (defined(PHY_ACMAJORREV_32) || defined(PHY_ACMAJORREV_33))) */
...
#ifdef PHYCAL_CACHING
	if ((!ACREV_IS(pi->pubpi->phy_rev, 1) && (phase_id == ACPHY_CAL_PHASE_TX8)) ||
		(pi->cal_info->cal_phase_id == ACPHY_CAL_PHASE_TX_LAST)) {
		ch_calcache_t *ctx;
