...
{
#if !defined(PHY_VER)  || (defined(PHY_VER) && (defined(PHY_ACMAJORREV_1) || defined(PHY_ACMAJORREV_0) || defined(PHY_ACMAJORREV_5)))
...
#endif /* !defined(PHY_VER)  || (defined(PHY_VER) && (defined(PHY_ACMAJORREV_1) || defined(PHY_ACMAJORREV_0) || defined(PHY_ACMAJORREV_5))) */
	...
	if (ACMAJORREV_3(pi->pubpi->phy_rev) && CHIPREV(pi->sh->chiprev) >= 4) {
		/* 4345 B0 onwards */
...
#if !defined(PHY_VER)  || (defined(PHY_VER) && (defined(PHY_ACMAJORREV_37) || defined(PHY_ACMAJORREV_40)))
		if ((ACMAJORREV_37(pi->pubpi->phy_rev)) ||
...
#endif /* !defined(PHY_VER)  || (defined(PHY_VER) && (defined(PHY_ACMAJORREV_37) || defined(PHY_ACMAJORREV_40))) */
		{
	...
	bool enable_half_dB, uint8 *desense_half_dB)
{
	...
	if (glitch_cnt > glitch_th_hi) {
		...
		if (cnt > cnt_thresh) {
			...
			cnt = 0;
			if (enable_half_dB) {
				if (glitch_cnt <= glitch_th_lo) {	/* Hold the desense if glitch_cnt > glitch_th_lo to avoid high PER */
					if (*desense_half_dB) {
						*desense_half_dB = 0;
					} else {
						*desense_half_dB = 1;
...
#endif /* !defined(PHY_VER)  || (defined(PHY_VER) && defined(PHY_ACMAJORREV_32)) */
#if !defined(PHY_VER)  || (defined(PHY_VER) && (defined(PHY_ACMAJORREV_37) || defined(PHY_ACMAJORREV_33)))
...
#endif /* !defined(PHY_VER)  || (defined(PHY_VER) && (defined(PHY_ACMAJORREV_37) || defined(PHY_ACMAJORREV_33))) */
				{
					ACPHY_REG_LIST_START
						MOD_PHYREG_ENTRY(pi, ACI_Mitigation_CTRL,
							aci_mitigation_sw_enable, 0)
...
wlc_phy_enable_hwaci_rev37(phy_info_t *pi)
{
	...
	ACPHY_REG_LIST_START
		WRITE_PHYREG_ENTRY(pi, ACI_Detect_CTRL, 0xfffd);
		WRITE_PHYREG_ENTRY(pi, ACI_Detect_CTRL1, 0x3fe1);
		WRITE_PHYREG_ENTRY(pi, ACI_Detect_MAX_COUNT_HI, 0x0001);
		WRITE_PHYREG_ENTRY(pi, ACI_Detect_MAX_COUNT_LO, 0xe848);
		WRITE_PHYREG_ENTRY(pi, ACI_Detect_collect_interval, 0x80ff);
		...
		ACPHYREG_BCAST_ENTRY(pi, Tiny_ACI_config60, 0x0000);
		...
		ACPHYREG_BCAST_ENTRY(pi, Tiny_ACI_config130, 0x0000);
...
wlc_phy_desense_aci_engine_acphy(phy_info_t *pi)
{
	...
	if (ACMAJORREV_4(pi->pubpi->phy_rev) || ACMAJORREV_32(pi->pubpi->phy_rev) ||
		...
		if (!(desense->on || (avg_glitch_bphy > ACPHY_ACI_BPHY_HI_GLITCH_THRESH) ||
			(avg_glitch_ofdm > ACPHY_ACI_OFDM_LO_GLITCH_THRESH)))
			return;
	}
...
#endif /* !defined(PHY_VER)  || (defined(PHY_VER) && defined(PHY_ACMAJORREV_37)) */
#if !defined(PHY_VER)  || (defined(PHY_VER) && defined(PHY_ACMAJORREV_40))
	if (ACMAJORREV_40(pi->pubpi->phyrev)) {
		if (enable_preempt) {
