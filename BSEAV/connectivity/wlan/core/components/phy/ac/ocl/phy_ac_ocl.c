...
uint16 ocl_tx2rx_w_far_reset_cmd_rev40[] =
        {0x85, 0x04, 0x03, 0x06, 0x12, 0x3d, 0x11, 0x10, 0x16, 0x2a, 0x2b, 0x24, 0x3e, 0x86, 0x1f};
uint16 ocl_tx2rx_w_far_reset_dly_rev40[] =
        {0x04, 0x08, 0x04, 0x02, 0x02, 0x01, 0x03, 0x04, 0x06, 0x04, 0x01, 0x0a, 0x02, 0x04, 0x01};
...
#if !defined(PHY_VER)  || (defined(PHY_VER) && (defined(PHY_ACMAJORREV_4) || defined(PHY_ACMAJORREV_40)))
	if (ACMAJORREV_4(pi->pubpi->phy_rev) || ACMAJORREV_40(pi->pubpi->phy_rev)) {
		if ((ocl_cm != 1) && (ocl_cm != 2))
			ocl_cm = 1;
	}
#endif /* !defined(PHY_VER)  || (defined(PHY_VER) && (defined(PHY_ACMAJORREV_4) || defined(PHY_ACMAJORREV_40))) */
...
phy_ac_ocl_logen_config_28nm(phy_info_t *pi)
{
	...
	if (phy_ac_chanmgr_get_val_nonbf_logen_mode(pi->u.pi_acphy->chanmgri)) {
		regval = 0x9000;
