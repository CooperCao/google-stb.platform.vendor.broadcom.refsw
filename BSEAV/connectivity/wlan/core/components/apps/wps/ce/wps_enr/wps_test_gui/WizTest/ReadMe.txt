================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : WizTest Project Overview
===============================================================================

The application wizard has created this WizTest application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your WizTest application.
...
WizTest.h
    ...
    project specific headers and declares the CWizTestApp application class.
...
WizTestDlg.h, WizTestDlg.cpp - the dialog
    These files contain your CWizTestDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named WizTest.pch and a precompiled types file named StdAfx.obj.
