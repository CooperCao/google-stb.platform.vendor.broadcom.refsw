...
#undef __CONFIG_TASKSET__
#undef __CONFIG_MPSTAT__
...
#undef __CONFIG_NAND_JFFS2__
#undef __CONFIG_NAND_YAFFS2__
...
#undef __CONFIG_FAILSAFE_UPGRADE_SUPPORT__
...
#define __USRLIBDIR__ "$(TOOLCHAIN)/arm-linux-gnueabihf/sys-root/usr/lib"
...
#undef __CONFIG_WLCLMLOAD__
#undef __CONFIG_ENVRAM_UTILITY__
 ...
 */
#undef __CONFIG_BCMQOS__
#undef __CONFIG_VISUALIZATION__
#define __CONFIG_WBD__ 1
#undef __CONFIG_PLCWBD__
#define __CONFIG_BCM_APPEVENTD__ 1
#undef __CONFIG_AIRIQ__
