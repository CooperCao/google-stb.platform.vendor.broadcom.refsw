 ...
 *
 * $Id: wlc.h 745373 2018-02-08 01:53:15Z $
 */
...
#define WLC_MAXMODULES		66	/* max #  wlc_module_register() calls */
#endif
...
#define TXFID_MAX_BCMC_FID 1024 /* pre-calculated (TXFID_SEQ_MASK >> TXFID_SEQ_SHIFT) + 1 */
...
typedef struct {
	...
	chanim_acc_us_t acc_us_cnt; /* accumulative cnt */
	chanim_cnt_us_t last_cnt_us;    /* count from last read */
	wlc_chanim_stats_t cur_stats; /* normalized stats obtained in home channel */
	wlc_chanim_stats_us_t cur_stats_us; /* normalized stats obtained in home channel */
