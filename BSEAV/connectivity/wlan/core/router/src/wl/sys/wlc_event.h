 ...
 *
 * $Id: wlc_event.h 566959 2015-06-26 08:57:35Z $
 */
...
#ifdef WLNOEIND
#define wlc_eventq_register_ind(a, b, c) 0
...
#else /* WLNOEIND */
extern int wlc_eventq_register_ind(wlc_eventq_t *eq, void *bitvect, uint32 len);
...
extern int wlc_eventq_query_ind_ext(wlc_eventq_t *eq,
	eventmsgs_ext_t* in_iovar_msg, eventmsgs_ext_t* out_iovar_msg, uint8 *mask);
