 ...
 */
wlc_obj_registry_t* wlc_obj_registry_alloc(osl_t* osh, int entries);
...
#define wlc_obj_registry_alloc(o, c)	(NULL)
#define wlc_obj_registry_free(d, o)
#define wlc_obj_registry_set(d, k, v)
#define wlc_obj_registry_get(d, k)	(NULL)
#define wlc_obj_registry_ref(d, k)	(1)
#define wlc_obj_registry_unref(d, k)	(0)
