 ...
 *
 * $Id: wlc_fbt.h 330192 2012-04-29 11:10:52Z $
 */
...
extern void *wlc_fbt_send_overds_req(wlc_fbt_info_t *fbt_info, wlc_bsscfg_t *cfg,
	struct ether_addr *ea, struct scb *scb, wsec_key_t *scb_key, bool short_preamble);
...
#define wlc_fbt_send_overds_req(f, c, e, s, sk, p)          NULL
...
extern void
	wlc_fbt_set_ea(wlc_fbt_info_t *fbt_info, wlc_bsscfg_t *cfg, struct ether_addr *ea);
bool wlc_fbt_enabled(wlc_fbt_info_t *fbt_info, wlc_bsscfg_t *cfg);
#ifdef AP
