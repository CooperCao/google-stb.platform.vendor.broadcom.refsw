 ...
 *
 * $Id: eapd.h 670717 2016-11-17 05:28:55Z $
 */
...
eapd_ssd_t, eapd_eventd_t, eapd_aspm_t, eapd_visdcoll_t, eapd_wbd_t;
...
#define EAPD_UDP_SIN_ADDR (!nvram_match("safe_eapd","on") ? htonl(INADDR_ANY) : htonl(INADDR_LOOPBACK))
#endif /* _EAPD_H_ */
