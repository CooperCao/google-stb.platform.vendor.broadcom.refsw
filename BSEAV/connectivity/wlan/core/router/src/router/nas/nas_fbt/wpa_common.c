 ...
 *
 * $Id: wpa_common.c 674758 2016-12-12 10:59:04Z $
 */
	...
	struct wpa_ft_ies *parse)
{
	...
	/* Parse the IE and get the details */
	if (wpa_ft_parse_ies(wpa, ies, ies_len, parse) < 0) {
	...
	/* Check if PMKID is present or not */
...
/* RSN IE to bitfields for group cipher, pairwise cipher and management group cipher */
...
/* RSN key management to bit fields to set the bits */
...
/* WPA key management to bitfields */
