...
# Based on snit
# $Id: ae7ad4aec70e7b7d39d786c1f6dc10e673bb8efc $
# $Copyright Broadcom Corporation$
#

package provide UTF::CableModem 2.0

package require snit
package require UTF::doc
package require UTF::Base

snit::type UTF::CableModem {
...
#	wl1_bw_cap=-1
	...
	$self relay copyto \
	    ...
	    /var/lib/tftpboot
	$self relay -n $UTF::usrutf/cmeshell $options(-console2) load \
	    3384b0-nicap_kernel 3384b0-nicap_apps_nand_ubifs_bs128k_ps2k
	$self wait_for_boot 90
    }

    method setup {} {
	$self relay -n $UTF::usrutf/cmeshell $options(-console2) setup
    }
