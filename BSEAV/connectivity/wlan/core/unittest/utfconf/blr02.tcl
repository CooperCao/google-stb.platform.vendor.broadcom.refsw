...
#Summary Directory
set ::UTF::SummaryDir "/projects/hnd_sig_ext21/$::env(LOGNAME)/blr02"
...
UTF::DHD blr02tst1 \
    ...
    -pre_perf_hook {{%S wl ampdu_clear_dump} {%S wl dump rssi} {%S wl phy_cal_disable 1} {%S wl scansuppress 1}} \
...
4359b1-FC19-GO75 clone 43596a0-FC19-GO75 \
	-tag DIN07T48RC50_BRANCH_9_75 \
	-type 43596a0-roml/config_pcie_utf/rtecdc.bin \
	-nvram "bcm943596fcpagbss.txt" \

43596a0-FC19-GO75 clone 43596a0-FC19-GO75_RSDB \
	 -wlinitcmds {wl msglevel 0x101; wl down ; wl msglevel +assoc ; wl vht_features 3;wl mimo_bw_cap 1; wl up; wl ocl_enable 0} \

43596a0-FC19-GO75 clone 43596a0-GO98 \
	-tag DIN07T48RC50_BRANCH_9_75 \
	-dhd_tag DHD_REL_1_363_59_98 \
	-app_tag DHD_REL_1_363_59_98 \

43596a0-FC19-GO75 clone 43596a0-GO98_RSDB \
	-tag DIN07T48RC50_BRANCH_9_75 \
	-dhd_tag DHD_REL_1_363_59_98 \
	-app_tag DHD_REL_1_363_59_98 \
	-wlinitcmds {wl msglevel 0x101; wl down ; wl msglevel +assoc ; wl vht_features 3;wl mimo_bw_cap 1; wl up; wl ocl_enable 0} \

43596a0-GO98 clone 43596a0-GO101 \
	-tag DIN07T48RC50_REL_9_75_101 \

43596a0-GO101 clone 43596a0-GO101-RSDB \
	-wlinitcmds {wl msglevel 0x101; wl down ; wl msglevel +assoc ; wl vht_features 3;wl mimo_bw_cap 1; wl up; wl ocl_enable 0} \

43596a0-GO101 clone 43596a0-GO105 \
	-dhd_tag DHD_REL_1_363_59{_*} \
	-app_tag DHD_REL_1_363_59{_*} \
...
4359b1-FC19-DUTsr clone 4359c0-FC19-DUTsr \
...
4359b1-FC19-DUT75 clone 43596a0-FC19-DUT75 \
	-tag DIN07T48RC50_BRANCH_9_75 \
	-type 43596a0-roml/config_pcie_utf/rtecdc.bin \
	-nvram "bcm943596fcpagbss.txt" \
	
43596a0-FC19-DUT75 clone 43596a0-FC19-DUT75_RSDB \
	  -wlinitcmds {wl msglevel 0x101; wl down ; wl msglevel +assoc ; wl vht_features 3;wl mimo_bw_cap 1; wl up; wl ocl_enable 0} \

43596a0-FC19-DUT75 clone 43596a0-DUT98 \
	-tag DIN07T48RC50_BRANCH_9_75 \
	-dhd_tag DHD_REL_1_363_59_98 \
	-app_tag DHD_REL_1_363_59_98 \

43596a0-FC19-DUT75 clone 43596a0-DUT98_RSDB \
	-tag DIN07T48RC50_BRANCH_9_75 \
	-dhd_tag DHD_REL_1_363_59_98 \
	-app_tag DHD_REL_1_363_59_98 \
	-wlinitcmds {wl msglevel 0x101; wl down ; wl msglevel +assoc ; wl vht_features 3;wl mimo_bw_cap 1; wl up; wl ocl_enable 0} \

43596a0-DUT98 clone 43596a0-DUT101 \
	-tag DIN07T48RC50_REL_9_75_101 \

43596a0-DUT101 clone 43596a0-DUT101-RSDB \
	-wlinitcmds {wl msglevel 0x101; wl down ; wl msglevel +assoc ; wl vht_features 3;wl mimo_bw_cap 1; wl up; wl ocl_enable 0} \

43596a0-DUT101 clone 43596a0-DUT105 \
	-dhd_tag DHD_REL_1_363_59_105 \
	-app_tag DHD_REL_1_363_59_105 \

43596a0-DUT105 clone 43596a0-DUT105-RSDB \
	-wlinitcmds {wl msglevel 0x101; wl down ; wl msglevel +assoc ; wl vht_features 3;wl mimo_bw_cap 1; wl up; wl ocl_enable 0} \
