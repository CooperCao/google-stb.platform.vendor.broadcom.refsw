...
UTF::Power::WebRelay PowerUSB1 -lan_ip 10.19.91.131 -relay Controller
UTF::Power::WebRelay PowerUSB2 -lan_ip 10.19.91.131 -relay Controller
...
UTF::DHD 43435_p7r0_sta3\
    -lan_ip 10.19.91.100\
    -sta {43435_p7r0_3 eth0}\
	-power {Power 3} \
    -power_sta {Power 3} \
    -hostconsole "10.19.91.24:40002"\
