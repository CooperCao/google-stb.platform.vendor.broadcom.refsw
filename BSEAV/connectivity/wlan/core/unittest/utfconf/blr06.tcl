...
package require UTF::Power
UTF::Power::Synaccess npc11 -lan_ip 172.1.1.11 -relay blr06end1 -rev 1
UTF::Power::Synaccess npc21 -lan_ip 172.1.1.21 -relay blr06end1 -rev 1
...
UTF::Linux blr06ref0 \
    ...
    -wlinitcmds {wl msglevel +assoc;wl down;wl dtim 3;wl vht_features 7;wl txcore -o 0x3  -k 0x3 -c 0x3 -s 1;} \
	-pre_perf_hook  {{%S wl ampdu_clear_dump} {%S wl ampdu_clear_counters} {%S wl amsdu_clear_counters} {%S wl reset_cnts} {%S wl counters} {%S wl dump ampdu}} \
    -post_perf_hook {{%S wl rssi} {%S wl rate} {%S wl nrate} {%S wl dump phycal} {%S wl dump rssi} {%S wl counters} {%S wl dump ampdu} {%S wl ampdu_clear_dump}} \
...
#
#43596-87 clone 43596-87.2 -sta {_43596-87 eth0 43596-87.2 wl0.2} \
...
#
#43596p clone 43596p.2 -sta {_43596p eth0 43596p.2 wl0.2} \
#	-clm_blob ss_mimo.clm_blob \
#    -wlinitcmds {wl down;wl vht_features 3; wl bss -C 2 sta} \
#    -perfonly 1 -perfchans 3l \
#
#43596p.2 configure -dualband {4360b 43596p -c1 36/80 -c2 3l -b1 800m -b2 800m} \
#
#################################################################################################
#	
...
UTF::DHD blr06tst1 \
	...
	-pre_perf_hook  {{%S wl ampdu_clear_dump} {%S wl amsdu_clear_counters} {%S wl PM} {%S wl band} {%S wl chanspec} {%S wl reset_cnts} {%S wl counters} {%S wl dump ampdu}} \
	-post_perf_hook {{%S wl rssi} {%S wl rate} {%S wl nrate} {%S wl dump phycal} {%S wl dump rssi} {%S wl counters} {%S wl dump ampdu} {%S wl ampdu_clear_dump} {%S wl band} {%S wl chanspec} {wl dump rsdb}} \
	-yart {-attn5g 30-95 -attn2g 30-95} \
	-channelsweep {-usecsa 0 -no2g40} \
	-datarate {-i 0.5 -auto -sgi} \


4361B0 clone 4361B0.2 -sta {_4361B0 eth0 4361B0.2 wl0.2} \
	-perfchans {3} -channelsweep {-band b} -nocustom 1 \
	-wlinitcmds {wl interface_create sta;} \
	-clm_blob ss_mimo.clm_blob \

4361B0.2 configure -dualband {4360b 4361B0 -c1 3 -c2 36/80 -b1 1000m -b2 1000m} \


4361B0 clone 4361B0-R \
	-type 4361b0-roml/config_pcie_release_utf_ipa/rtecdc.bin \

4361B0-R clone 4361B0-R.2 -sta {_4361B0-R eth0 4361B0-R.2 wl0.2} \
	-perfchans {3} -channelsweep {-band b} -nocustom 1 \
	-wlinitcmds {wl interface_create sta;} \
	-clm_blob ss_mimo.clm_blob \

4361B0-R.2 configure -dualband {4360b 4361B0-R -c1 3 -c2 36/80 -b1 1000m -b2 1000m} \


4361B0 clone 4361B0-tput \
	-type 4361b0-roml/config_pcie_tput_ipa/rtecdc.bin \

4361B0-tput clone 4361B0-tput.2 -sta {_4361B0-tput eth0 4361B0-tput.2 wl0.2} \
	-perfonly 1 -perfchans {3} -nocustom 1 \
	-wlinitcmds {wl interface_create sta;} \
	-clm_blob ss_mimo.clm_blob \

4361B0-tput.2 configure -dualband {4360b 4361B0-tput -c1 3 -c2 36/80 -b1 1000m -b2 1000m} \

4361B0 clone 4361B0-softap \
	-wlinitcmds {wl interface_create ap;} \

4361B0 clone 4361B0-Jaguar \
	-tag JAGUAR_BRANCH_14_10 \
	-type 4361b0-ram/config_pcie_utf/rtecdc.bin \
