...
set ::UTF::SummaryDir "/projects/hnd_software/work/mbeyer/logs/x64"
...
UTF::Cygwin Win7_64_43224_p0r1_0\
	-kdpath {C:\Program Files (x86)\Debugging Tools for Windows (x86)\kd.exe} \
    -lan_ip 10.19.90.41\
    -sta {Win7_64_43224_p0r1_0_sta}\
    -user smoketest\
	-osver 764\
	  -power {Power 0}
