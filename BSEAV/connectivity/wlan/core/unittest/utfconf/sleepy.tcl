# UTF Config file for Colossus "sleepy"
# 	$Id: 7a8aed1d0cd2ccc380cc7616bd591b691229b106 $
...
set ::UTF::SummaryDir "/projects/hnd_sig/mfg/sleepy"
...
# Controller
UTF::Linux sleepytemp -lan_ip 10.19.36.199

#####################

# Reference
UTF::Cygwin sleepyR0 -lan_ip 192.168.2.20 -sta R0 \
    -usedll 1 -mfgcpath "C:/Program Files/Firefly_2.5.26" \
    -user user -installer inf -debuginf 1 -tag PBR_REL_5_10_133
R0 configure -ipaddr 192.168.1.100

#####################

# First Device under test
UTF::Cygwin sleepyD0 -lan_ip 192.168.2.10 -sta D0 \
...
UTF::Cygwin sleepyD1 -lan_ip 192.168.2.11 -sta D1 \
    -usedll 1 -mfgcpath "C:/Program Files/Firefly_2.5.29" \
    -user hwlab -installer inf -debuginf 1 \
    -kdpath {C:\Program Files\Debugging Tools for Windows (x86)\kd.exe}
...
UTF::Cygwin sleepyD2 -lan_ip 192.168.2.12 -sta D2 \
    -usedll 1 -mfgcpath "C:/Program Files/Firefly_2.5.29" \
    -user hwlab -installer inf -debuginf 1\
    -kdpath {C:\Program Files\Debugging Tools for Windows (x86)\kd.exe}
...
UTF::Cygwin sleepyD3 -lan_ip 192.168.2.13 -sta D3 \
