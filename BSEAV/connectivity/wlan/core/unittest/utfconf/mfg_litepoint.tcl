...
#set ::switchboard_location "/projects/hnd_software_ext9/bate/src/tools/wlan/emb_dvt/equipment/"
#set ::litepoint_location "/projects/hnd_software_ext9/bate/src/tools/wlan/emb_dvt/litepoint/"
#set ::litepoint_csv_results "/projects/hnd_software_ext9/bate/src/tools/wlan/emb_dvt/litepoint/utf/LitePointTestResults_bringup176_1018Eng3.csv"
...
set ::litepoint1_test_enabled 1
set ::litepoint2_test_enabled 1
...
set ::litepoint1_script "litepoint_test.py --Litepoint=bringup176_1018Eng3 --Host=10.19.39.36 --cal=DUT0.S2P:0 --SN=894 --flow=IQlite_Flow_FullTemplate_reorder.py --comment=DUT1 --do_2g=1 --do_5g=1 --do_tx=1 --do_rx=1 --do_bw20in40=0 --do_bw20=1 --do_bw40=1 --coverage=pvt --project=BCM4334 --dbuxproject=UTF_Nightly_Regression_LPT_4334Centennial --chiprev=B3 --boardtype=Centennial --boardsubtype=MURATA_MSE  --boardrev=ES6.9 --testtype=regression --ignoreversionmismatch=1 --HSICrev=P220 -i hsic::192.168.1.1 --lpt2utf"
set ::litepoint2_script "litepoint_test.py --Litepoint=bringup176_1018Eng3 --Host=10.19.39.36 --cal=DUT0.S2P:1 --SN=948 --flow=IQlite_Flow_FullTemplate_reorder.py --comment=DUT2 --do_2g=1 --do_5g=1 --do_tx=1 --do_rx=1 --do_bw20in40=0 --do_bw20=1 --do_bw40=1 --coverage=pvt --project=BCM43342 --dbuxproject=UTF_Nightly_Regression_LPT_43342Imperial --chiprev=A1 --boardtype=Imperial --boardsubtype=MURATA_MT --boardrev=ES3.6 --testtype=regression --ignoreversionmismatch=1 --HSICrev=P220 -i hsic::192.168.1.1 --lpt2utf"
...
set ::litepoint4_script "litepoint_test.py --Litepoint=bringup176_4324_2_1_5 --Host=10.19.39.36 --cal=DUT0.S2P:0 --SN=471 --flow=IQlite_Flow_NxN_2G5G_TxRx_reorder.py --comment=DUT4 --ff_control_string=2G_5G_RX_TX_ANT0_BW20_BW40 --coverage=pvt --project=BCM4324 --chiprev=B5 --boardtype=doppelbock --dbuxproject=UTF_Nightly_Regression_4324Doppelbock --boardsubtype=USI_KK  --boardrev=ES3.3 --testtype=regression --ignoreversionmismatch=1 --HSICrev=P220 -i hsic::192.168.1.1 --lpt2utf"
...
mfg_hsic clone 43342hsic_TOB \
    ...
    -brand "linux-mfgtest-dongle-usb"\
    -type "43342a0-roml/usb-ag-mfgtest-nodis-swdiv-seqcmds-sr-wlota.bin.trx"\
	-nvram "src/shared/nvram/bcm943342ChardonnayMurataMT.txt"\
    -customer "bcm"\
    -host_tag "RTRFALCON_REL_5_130_56"
