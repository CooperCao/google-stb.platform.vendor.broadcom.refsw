...
package require UTF::Power
UTF::Power::Synaccess npc21 -lan_ip 172.1.1.21 -relay blr09end1.ban.broadcom.com -rev 1
UTF::Power::Synaccess npc31 -lan_ip 172.1.1.31 -relay blr09end1.ban.broadcom.com -rev 1
UTF::Power::Synaccess npc41 -lan_ip 172.1.1.41 -relay blr09end1.ban.broadcom.com -rev 1
...
UTF::Router AP \
        ...
        -relay "blr09end1.ban.broadcom.com" \
        -lanpeer lan \
        -console "blr09end1.ban.broadcom.com:40002" \
        -power {npc21 1} \
        -brand linux-2.6.36-arm-up-external-vista-router-dhdap-full-src  \
        -tag "BISON_BRANCH_7_10" \
		-wlinitcmds {wl scansuppress 1;} \
        -nvram {
...
4708/43228 configure  -attngrp G2 \

4708/43228 clone 4708/4360   -tag BISON_BRANCH_7_10 


4708/43228 clone 4360t78   -tag BISON04T_REL_7_14_78 
4708/43228 clone 4360t89_2 -tag BISON04T_REL_7_14_89_2 

4708/43228 clone 4360a630  -tag AARDVARK_BRANCH_6_30 
4708/43228 clone 4360b714  -tag BISON04T_BRANCH_7_14
...
4360 configure -attngrp G2 -ipaddr 192.168.1.102   \
