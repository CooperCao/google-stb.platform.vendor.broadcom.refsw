# -*-tcl-*-
# MuMIMO Testbed configuration file for BLR26
# Created by Rohit B on 02-10-2016
# Edited by Rohit B on 02-10-2016
...
package require UTF::Power
UTF::Power::Synaccess npc11 -lan_ip 172.1.1.11 -relay blr26end1 -rev 1
...
#Summary Directory
set ::UTF::SummaryDir "/projects/hnd_sig_ext18/$::env(LOGNAME)/blr26"
...
G4 configure -default 10
G5 configure -default 10
...
UTF::Linux blr26softap \
	-lan_ip 10.132.116.193 \
...
4366softap configure -attngrp G5 -ap 1 -hasdhcpd 1 \
...
4366softap-mutx0 configure -ipaddr 192.168.1.125 -attngrp G5 -ap 1 -rvrnightly {-mumode su} \
	...
	-wlinitcmds {wl msglevel +assoc +mumimo; wl down; wl country US/0; wl vht_features 7;}

4366softap clone 4366atf-mutx0 
4366atf-mutx0 configure -ipaddr 192.168.1.125 -attngrp G5 -ap 1 -rvrnightly {-mumode su} \
	-modopts {assert_type=1 nompc=1 ctdma=0} \
	-wlinitcmds {wl msglevel +assoc +mumimo; wl down; wl country US/0; wl vht_features 7; wl atf 1} \
	
4366softap clone 4366softap-mutx1
4366softap-mutx1 configure -ipaddr 192.168.1.125 -attngrp G5 -ap 1 -rvrnightly {-mumode mu} \
	-modopts {assert_type=1 nompc=1 ctdma=1} \
	-wlinitcmds {wl msglevel +assoc +mumimo; wl down; wl country US/0; wl vht_features 7; wl atf 0} \
...
4361a configure -attngrp G5 \

#for 1x1
4361a clone 4361a1x1 \
    -wlinitcmds {wl msglevel +assoc; wl down; wl vht_features 7; wl infra 1; wl txchain 1; wl rxchain 1;}

#mimo mode
4361a clone 4361a2x2 \
    -wlinitcmds {wl msglevel +assoc; wl down; wl vht_features 7; wl infra 1; wl txchain 3; wl rxchain 3;}
...
UTF::DHD blr26tst2 \
	...
	-pre_perf_hook  {{%S wl ampdu_clear_dump} {%S wl amsdu_clear_counters} {%S wl reset_cnts} {%S wl counters} {%S wl dump ampdu}} \
	-post_perf_hook  {{%S wl counters} {%S wl dump ampdu}} \
    -wlinitcmds {wl msglevel +assoc; wl down; wl vht_features 7; wl elnabypass_feature 0;} \

4361b configure -attngrp G5 \
