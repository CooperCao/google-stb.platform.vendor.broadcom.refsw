...
### STA Sections ###
UTF::MacOS MacOSLion_p2r2_1    \
	-lan_ip 10.19.90.179\
	-sta {MacOSLion_p2r2_1_sta en1} \
	-brand macos-internal-wl-lion \
	-type Debug_10_7 \
	-user root     \
	-kextload 1\
	-wlinitcmds {wl msglevel +assoc +inform  btc_mode 0}

UTF::MacOS MacOSLion_p2r2_2    \
	-lan_ip 10.19.90.180\
	-sta {MacOSLion_p2r2_2_sta en1} \
	-brand macos-internal-wl-lion \
	-type Debug_10_7 \
	-user root     \
	-kextload 1\
...
UTF::MacOS MacOSLion_p2r2_3    \
	-lan_ip 10.19.90.181\
	-sta {MacOSLion_p2r2_3_sta en1} \
	-brand macos-internal-wl-lion \
	-type Debug_10_7 \
	-user root     \
	-kextload 1\
...
UTF::MacOS MacOSLion_p2r2_4    \
	-lan_ip 10.19.90.182\
	-sta {MacOSLion_p2r2_4_sta en1} \
	-brand macos-internal-wl-lion \
	-type Debug_10_7 \
	-user root     \
	-kextload 1\
...
UTF::MacOS MacOSLion_p2r2_5    \
	-lan_ip 10.19.90.183\
	-sta {MacOSLion_p2r2_5_sta en1} \
	-brand macos-internal-wl-lion \
	-type Debug_10_7 \
	-user root     \
	-kextload 1\
...
UTF::MacOS MacOSLion_p2r2_6    \
	-lan_ip 10.19.90.184\
	-sta {MacOSLion_p2r2_6_sta en1} \
	-brand macos-internal-wl-lion \
	-type Debug_10_7 \
	-user root     \
	-kextload 1\
...
UTF::MacOS MacOSLion_p2r2_7    \
	-lan_ip 10.19.90.185\
	-sta {MacOSLion_p2r2_7_sta en1} \
	-brand macos-internal-wl-lion \
	-type Debug_10_7 \
	-user root     \
	-kextload 1\
