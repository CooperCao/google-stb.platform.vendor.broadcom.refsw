...
UTF::DHD blr21dut0 \
         -lan_ip 10.132.116.143 \
         -sta {43438 eth0} \
         -tcpwindow 4M \
         -power_button "auto" \
         -slowassoc 5 -reloadoncrash 1 \
         -nobighammer 1 \
         -app_tag DHD_REL_1_141_64_24 \
         -dhd_tag DHD_REL_1_141_64_24 \
		 -tag BISON06T_REL_7_45_45_10 \
         -brand linux-external-dongle-sdio \
		 -dhd_brand linux-external-dongle-sdio \
         -nvram bcm943430wlselgs_26MHz.txt \
		 -type 43430a1-roml/sdio-g-pool-p2p-idsup-idauth-pno-pktfilter-keepalive-aoe-lpc-swdiv-srfast-fuart-btcxhybridhw.bin \
		 -slowassoc 5 \
		 -datarate {-i 0.5 -frameburst 1} \
		 -udp 800m \
         -nocal 1 \
         -wlinitcmds {sd_uhsimode=1; wl msglevel +assoc; wl down; wl vht_features 3; dmesg; } \
         -pre_perf_hook {{%S wl rssi}  {%S wl ampdu_clear_dump} {%S wl amsdu_clear_counters}} \
         -post_perf_hook {{%S wl rssi} {%S wl rate} {%S wl nrate} {%S wl dump phycal} {%S wl dump rssi} {%S wl phy_rssi_ant} } \

43438 configure -ipaddr 192.168.1.92 \
