...
UTF::DHD blr09tst1 \
        ...
        -power "npc41 1"\
        -power_button "auto" \
        -app_tag BIS120RC4_REL_7_15_168_63 \
        -dhd_tag BIS120RC4_REL_7_15_168_63 \
		-dhd_brand linux-external-dongle-sdio \
		-tag BIS120RC4_REL_7_15_168_63 \
        -brand linux-external-dongle-sdio \
		-modopts {sd_uhsimode=2} \
        -nvram bcm943907wcd2_p207.txt \
		-type 43909b0-roml/sdio-ag-p2p-pno-aoe-pktfilter-keepalive-mchan-proptxstatus-lpc-wl11u-txbf-pktctx-dmatxrc-idsup-idauth-dfsradar-mfp-swdiv-ve.bin  \
		-slowassoc 5 \
        ...
        -nocal 1 \
        -wlinitcmds { wl down; wl vht_features 3; wl country US; wl txchain 1; wl rxchain 1; wl antdiv 0} \
...
43907 configure -ipaddr 192.168.1.96 \
