...
UTF::DHD Fc15_4334_bench_sta \
-lan_ip 10.19.90.59\
-user root\
-sta {4334 eth0} \
-power {webswitch1 1}\
-brand linux-external-dongle-sdio \
-dhd_tag DHD_REL_1_48 \
-tag PHOENIX2_REL_6_10_58_52 \
-type 4334b1min-roml/sdio-ag-pno-p2p-proptxstatus-dmatxrc-rxov-pktfilter-keepalive-aoe-vsdb-mchan-sr \
-nvram bcm94334fcagb.txt \
-power_sta {PowerUSB1 1} \
-console "10.19.90.23:port_no1 \
