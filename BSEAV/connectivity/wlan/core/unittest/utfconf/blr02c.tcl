...
set ::UTF::SetupTestBed {
	...
	set ::UTF::STAList "4361-GO 4361-GC"
...
#
#
#wl txcore -o 0x3  -k 0x3 -c 0x3 -s 1 

UTF::DHD blr02tst1 \
	-lan_ip 10.132.116.27 \
	-sta {4361-GO eth0 4361-PGO wl0.2} \
	-power "npc31 2" \
	-iperf iperf208 \
	-power_button "auto" \
	-perfchans {36/80 36l 3} \
...
4361-GO configure -ipaddr 192.168.1.234 -attngrp G1
4361-PGO configure -ipaddr 192.168.5.234

4361-GO clone 4361-trunk-GO \
	-sta {4361-trunk-GO eth0 4361-trunk-PGO wl0.2} \
	-type 4361a0-ram/config_pcie_release/rtecdc.bin \
	-nvram "src/shared/nvram/bcm94361fcpagbss.txt" \
	-tag trunk \
	-clm_blob 4347a0.clm_blob \

4361-trunk-GO configure -ipaddr 192.168.1.234 -attngrp G1
4361-trunk-PGO configure -ipaddr 192.168.5.234

4361-GO clone 4357-Mst-WLAN \
	-sta {4357-Mst-WLAN eth0 4357-Mst-AWDL wl0.2} \
	-type 4357a0-ram/config_pcie_awdl/rtecdc.bin \
	-app_tag DHD_BRANCH_1_359 \
	-dhd_tag DHD_REL_1_579_* \
	-clm_blob 4347a0.clm_blob \

4357-Mst-WLAN configure -ipaddr 192.168.1.234 -attngrp G1
4357-Mst-AWDL configure -ipaddr 192.168.5.234

4361-GO clone 4361B0-GO \
...
UTF::DHD blr02tst2 \
	-lan_ip 10.132.116.28 \
	-iperf iperf208 \
	-sta {4361-GC eth0 4361-PGC wl0.2} \
	-power "npc21 2" \
	-power_button "auto" \
	-perfchans {36/80 36l 3} \
	-dhd_brand linux-internal-dongle-pcie \
...
4361-GC configure -ipaddr 192.168.1.236
4361-PGC configure -ipaddr 192.168.5.236

4361-GC clone 4361-trunk-GC \
	-sta {4361-trunk-GC eth0 4361-trunk-PGC wl0.2} \
	-type  4361a0-ram/config_pcie_release/rtecdc.bin \
	-tag trunk \
	-nvram "src/shared/nvram/bcm94361fcpagbss.txt" \
	-clm_blob 4347a0.clm_blob \

4361-trunk-GC configure -ipaddr 192.168.1.236 -attngrp G1
4361-trunk-PGC configure -ipaddr 192.168.5.236

4361-GC clone 4357-Slv-WLAN \
	-sta {4357-Slv-WLAN eth0 4357-Slv-AWDL wl0.2} \
	-type 4357a0-ram/config_pcie_awdl/rtecdc.bin \
	-app_tag DHD_BRANCH_1_359 \
	-dhd_tag DHD_REL_1_579_* \
	-clm_blob 4347a0.clm_blob \

4357-Slv-WLAN configure -ipaddr 192.168.1.236 -attngrp G1
4357-Slv-AWDL configure -ipaddr 192.168.5.236


4361-GC clone 4361B0-GC \
