...
UTF::Power::WebRelay PowerUSB1 -lan_ip 10.19.90.195 -relay Controller
UTF::Power::WebRelay PowerUSB2 -lan_ip 10.19.90.195 -relay Controller
...
# FC19x64 43342 SDIO
UTF::DHD 43342_p2r0_sta5\
    -lan_ip 10.19.90.166\
    -sta {43342_p2r0_5 eth0}\
	-power {Power 5} \
    -power_sta {Power 5} \
    -hostconsole "10.19.90.25:40004"\
    -app_tag trunk\
