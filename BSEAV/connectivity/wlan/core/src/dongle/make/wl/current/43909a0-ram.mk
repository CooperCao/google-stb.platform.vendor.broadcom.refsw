# Makefile for hndrte based 43909a0 full ram Image
#
...
#
# $Id: 43909a0-ram.mk 266614 2011-06-14 22:16:03Z $:
...
TARGETS := \
	m2m-g-assert-err-qt \
	m2m-g-assert-err-qt-msgbuf-splitrx
...
WLCONFFILE	:= wlconfig_rte_43909a0_bu
WLTUNEFILE	:= wltunable_rte_43909a0.h
...
EXTRA_DFLAGS	+= -DBCM43909 -DBCM43909A0
