# Makefile for hndrte based 43430a1 full ram Image
#
...
WLCONFFILE	:= wlconfig_rte_43430a1_bu
WLTUNEFILE	:= wltunable_rte_43430a1.h
...
# features (sync with 4345b0.mk, 4345b0-roml.mk, 4334a1-romlsim-4345b0.mk)
MEMBASE		:= 0
MEMSIZE		:= 524288
SR_MEMSIZE	:= 65536
SR_ASMSIZE	:= 2048
