# Makefile for threadx based 43012a0 full ram Image
#
...
WLCONFFILE	:= wlconfig_rte_43012a0_bu
WLTUNEFILE	:= wltunable_rte_43012a0.h
...
ifeq ($(findstring -ipa,$(TARGET_OPTIONS)),-ipa)
	# iPA radio rev 
	BCMRADIOREV     := 37
...
EXTRA_DFLAGS    += -DWLPHY_EPA_ONLY
EXTRA_DFLAGS    += -DMAXSZ_NVRAM_VARS=2560
EXTRA_DFLAGS    += -DBTCX_PRISEL_WAR_43012
