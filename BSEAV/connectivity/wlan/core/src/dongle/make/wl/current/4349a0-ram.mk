...
TARGETS := \
	sdio-ag \
	sdio-ag-p2p-mchan-assert-err \
	pcie-ag-msgbuf-splitrx
...
WLCONFFILE	:= wlconfig_rte_4349a0_rsdb_bu
WLTUNEFILE	:= wltunable_rte_4349a0.h

# use different CONFIG file for norsdb builds to add -assert-err
ifeq ($(call opt,norsdb),1)
WLCONFFILE	:= wlconfig_rte_4349a0_bu
endif
...
REMAIN := $(subst /,,$(REMAIN))
# features (sync with 4349a0.mk, 4349a0-roml.mk)
MEMBASE		:= 0x180000
...
WL_NRXD			:= 128
WL_NTXD			:= 128
#Making splitrx default for PCIE builds
...
EXTRA_DFLAGS    += -DPCIEDEV_MAX_LOCALBUF_PKT_COUNT=200
endif
