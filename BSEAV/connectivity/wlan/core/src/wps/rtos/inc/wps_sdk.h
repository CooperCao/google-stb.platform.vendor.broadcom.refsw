 ...
 * ************************************************************
*/
extern bool wps_open(void *context, fnWpsProcessCB callback, char if_name[],
	bool v2);
 ...
 * Description :
	...
	*************************************************************
*/
extern bool wps_get_AP_info(int wps_mode, uint8 *bssid, char *ssid,
                            char *pin, wps_credentials *credentials);
 ...
 * Description :
	...
	*************************************************************
*/
extern bool wps_get_AP_infoEx(int wps_mode, uint8 * bssid, char *ssid,
                            char *pin, int retries, wps_credentials *credentials);
