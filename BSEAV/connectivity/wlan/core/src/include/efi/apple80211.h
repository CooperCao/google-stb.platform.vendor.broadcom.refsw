...
#ifndef APPLE_80211_PROTOCOL_GUID
#define APPLE_80211_PROTOCOL_GUID \
	{0x71B4903C, 0x14EC, 0x42C4, {0xBD, 0xC6, 0xCE,0x14,0x49,0x93,0x0E,0x49}}
#endif /* APPLE_80211_PROTOCOL_GUID */

#ifndef APPLE_LINK_STATE_PROTOCOL_GUID
#define APPLE_LINK_STATE_PROTOCOL_GUID \
	{0xBF71D7E3, 0x4AE8, 0x47F1, {0x86, 0x05, 0x9D, 0x57, 0x6A, 0xAB, 0x44, 0x78}}
#endif /* APPLE_LINK_STATE_PROTOCOL_GUID */
	
/*
 * Forward declaration
 */
#ifdef EFI_WINBLD
EFI_FORWARD_DECLARATION (APPLE_LINK_STATE_PROTOCOL);
#else
typedef struct _APPLE_LINK_STATE_PROTOCOL APPLE_LINK_STATE_PROTOCOL;
#endif

/*
 * Protocol API Definition
 */
typedef EFI_STATUS (EFIAPI *APPLE_LINK_STATE_GET_LINK_STATE) (IN VOID   *This)
/**
	@param  This				Protocol instance pointer.

	@retval EFI_SUCCESS			Have link and has not changed since last call.
	@retval EFI_NOT_READY			Have link and has changed since last call.
	@retval EFI_NO_MEDIA			Do not have link.
	@retval EFI_INVALID_PARAMETER		The parameter "This" is null.
	@retval EFI_DEVICE_ERROR		Could get instance data.
**/
;
 ...
 * Protocol definition
 */
struct _APPLE_LINK_STATE_PROTOCOL {
	APPLE_LINK_STATE_GET_LINK_STATE         GetLinkState;
};
...
typedef struct {
	UINT32			SsidLen;
	CHAR8			Ssid[ APPLE80211_MAX_SSID_LEN ];
...
#define APPLE80211_KEY_PASSWORD_LEN	65
#define APPLE80211_KEY_RESERVED_LEN	3
...
typedef struct {
	...
	UINT16			KeyFlags;
	UINT16			KeyIndex;
	CHAR8			Password[APPLE80211_KEY_PASSWORD_LEN];	// NULL if using actual key
	CHAR8			Reserved[APPLE80211_KEY_RESERVED_LEN];
...
#define APPLE80211_JOINPARAMS_VERS	1

typedef struct {
	UINT32			vers; //version of this struct
	UINT16			bssType;
	UINT16			LowerAuth;
	UINT16			UpperAuth;
	UINT16			groupCipher; // group (multicast) cipher type
	UINT32			SsidLen;
	CHAR8			Ssid[ APPLE80211_MAX_SSID_LEN ];
	EFI_MAC_ADDRESS	bssid;
	APPLE_80211_KEY	Key;	
...
#if defined(EFI_WINBLD) && !defined(DHD_EFI)
#ifdef APPLE_BUILD
...
#else
EFI_GUID gApple80211ProtocolGuid = APPLE_80211_PROTOCOL_GUID;
