...
/* SFD frame */
#define PKTISSFDFRAME(osh, lb)		({BCM_REFERENCE(osh); lb_is_sfd_frame(LBP(lb));})
#define PKTSETSFDFRAME(osh, lb)		({BCM_REFERENCE(osh); lb_set_sfd_frame(LBP(lb));})
#define PKTRESETSFDFRAME(osh, lb)	({BCM_REFERENCE(osh); lb_reset_sfd_frame(LBP(lb));})

#define PKTISSFDTXC(osh, lb)		({BCM_REFERENCE(osh); lb_is_sfd_txc(LBP(lb));})
#define PKTSETSFDTXC(osh, lb)		({BCM_REFERENCE(osh); lb_set_sfd_txc(LBP(lb));})
#define PKTRESETSFDTXC(osh, lb)		({BCM_REFERENCE(osh); lb_reset_sfd_txc(LBP(lb));})
