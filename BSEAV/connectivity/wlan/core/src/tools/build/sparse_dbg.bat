...
REM - Sparse Source - Z:\projects\hnd_software\sparse_rev_patch
REM
...
set SPARSE_G=Z:\projects\hnd_software\sparse_rev_patch

REM Bash Stuff
if exist %TOOLSDIR_C%\sparse_dbg set SPARSE_WRAPPER=%TOOLSDIR_C%\sparse_dbg
if exist %TOOLSDIR_H%\sparse_dbg set SPARSE_WRAPPER=%TOOLSDIR_H%\sparse_dbg
if exist %TOOLSDIR_Z%\sparse_dbg set SPARSE_WRAPPER=%TOOLSDIR_Z%\sparse_dbg
