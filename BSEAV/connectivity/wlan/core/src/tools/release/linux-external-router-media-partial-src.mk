#
# BCM947xx Linux External Router Media Partial Source build/release Makefile
#
...
DEFS   += ROUTERSRC BCMWPS BCMWFI BCMVISTAROUTER
UNDEFS := $(filter-out ROUTERSRC BCMWPS BCMWFI BCMVISTAROUTER,$(UNDEFS))
