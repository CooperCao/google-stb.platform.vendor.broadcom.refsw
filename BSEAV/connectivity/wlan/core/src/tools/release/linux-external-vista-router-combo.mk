...
KERNELCFG ?= defconfig-bcm947xx-router-ipv6-combo
DEFS   := ETSRC BCMWPS BCMVISTAROUTER
UNDEFS := BCMINTERNAL BCMDBG BCMDBG_ERR ROUTERSRC ILSRC WLSRC USBDEVSRC NASSRC EZCSRC SESSRC BCMCCX BCMEXTCCX BSPSRC BCMSDIO BCMPCMCIA POCKET_PC WL_PCMCIA
