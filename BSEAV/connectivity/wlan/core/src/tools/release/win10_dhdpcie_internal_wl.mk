...
define RELEASE_SIGN_WIN10_DRIVERS
	...
	$(MAKE) -C src/dhd/wdm release_sign_driver \
		...
		WINOS=$(SIGN_OS) WDK_VER=$(WIN10_WDK_VERSION) VS_VER=$(VS_VER) \
...
build_driver: pre_build
	...
	$(MAKE) -C src/dhd/exe VS_VER=$(VS_VER) WDK_VER=$(WIN10_WDK_VERSION) BUILD_CONFS=Debug -f dhd_vs13.mk all
	@$(MARKEND)
...
$(RELEASEDIR)/$(VERSION_NAME)/checked/DriverOnly: FORCE
	...
	$(call INSTALL_DRIVER_FILES, $@/x86/, DRIVER_FILES_NVRAM, Bcm, , $(DRIVER_NAME), inf, wdi_dhd_pcie_checked/Win32, Debugw15, map pdb)
	$(call INSTALL_INF_WIN, $@/x86, $(DRIVER_INF), w10dhd, $(NDISVER_WIN10), $(ARCH_WIN32), $(NDISARCH_32), $(DRIVER_NAME))
	$(call CLEAN_INF_WIN, $@/x86, $(DRIVER_INF), w7dhd w10dhd)
	$(call INSTALL_DRIVER_FILES, $@/x64/, DRIVER_FILES_NVRAM, Bcm, 64, $(DRIVER_NAME), inf, wdi_dhd_pcie_checked/x64, x64/Debugw15, map pdb)
	$(call INSTALL_INF_WIN, $@/x64, $(DRIVER_INF), w10dhd, $(NDISVER_WIN10), $(ARCH_WIN64), $(NDISARCH_64), $(DRIVER_NAME))
	...
	$(call RELEASE_SIGN_WIN10_DRIVERS, $@/x86, x86, )
	$(call RELEASE_SIGN_WIN10_DRIVERS, $@/x64, X64, )
...
.PHONY: build_driver build_firmware build_firmware2 copy_firmware copy_dongle_images checkout mogrify build pre_build package build_include build_status build_end $(FIRMWARE_IMAGES) build_install FORCE
