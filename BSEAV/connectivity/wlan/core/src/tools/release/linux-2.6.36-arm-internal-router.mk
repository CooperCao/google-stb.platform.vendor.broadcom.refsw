#
# BCM947xx Linux 2.6.36  Internal Router build/release Makefile
#
...
#
# $Id: linux-2.6.36-arm-internal-router.mk 345226 2012-07-17 05:15:21Z $
#
...
SRCFILELISTS_COMPONENTS += src/tools/release/components/linux_router/samba-filelist.txt
...
DEFS   += BCMWPS BCMWFI BCMVISTAROUTER
UNDEFS := $(filter-out BCMWPS BCMWFI BCMVISTAROUTER,$(UNDEFS))
