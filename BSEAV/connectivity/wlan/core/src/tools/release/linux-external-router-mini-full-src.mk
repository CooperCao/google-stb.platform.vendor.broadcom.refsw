#
# BCM947xx Linux External Router Mini Full Source build/release Makefile
#
...
PARENT_MAKEFILE := linux-external-router-mini.mk
...
DEFS   += FULL ROUTERSRC WLSRC NASSRC
UNDEFS := $(filter-out FULL ROUTERSRC WLSRC NASSRC BCMDBG BCMDBG_ERR,$(UNDEFS))
