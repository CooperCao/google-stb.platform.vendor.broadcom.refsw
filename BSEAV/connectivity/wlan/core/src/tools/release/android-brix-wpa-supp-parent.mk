...
ANDROID_FRAMEWORK  ?= android-x86-local
FRAMEWORK_MANIFEST ?= http://hnd-swgit.sj.broadcom.com:8080/android/x86-local/platform/manifests
FRAMEWORK_BRANCH   ?=
FRAMEWORK_EXTRA_FLAGS ?=
SHELL              := /bin/bash
OEM_LIST           := base-wapi-ccx base-wapi base
...
ifndef FRAMEWORK_TARGET
  FRAMEWORK_TARGET   := core_mesa-eng
endif
ifndef FRAMEWORK_PRODUCT
  FRAMEWORK_PRODUCT  := core_mesa
endif
ifndef FRAMEWORK_MAKE_IMAGE
  FRAMEWORK_MAKE_IMAGE  := allimages
endif
...
VALID_BRANDS := android-brix-wpa-supp
