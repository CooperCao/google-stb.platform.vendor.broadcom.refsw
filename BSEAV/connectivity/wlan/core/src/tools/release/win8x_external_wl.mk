...
# for old chkinf and other scripts
export WDK_VER     :=7600
...
X86_WPCAP41_DIR	   := src/8021x/win32/bin/wpcap_4_1
X64_WPCAP41_DIR	   := src/8021x/win64/bin/wpcap_4_1
WDK_DIR            := $(firstword $(wildcard \
                        c:/tools/msdev/$(WDK_VER)wdksdk \
                        d:/tools/msdev/$(WDK_VER)wdksdk \
                        z:/projects/hnd/tools/win/msdev/$(WDK_VER)wdksdk \
                        c:/tools/msdev/$(WDK_VER)wdk \
                        d:/tools/msdev/$(WDK_VER)wdk \
                        z:/projects/hnd/tools/win/msdev/$(WDK_VER)wdk))
...
BUILD_WITH_WINALL_RELEASE=release_win8x release_winall
TARGET_BUILD_LIST=release_win8x release_winall

# WinXP wl drivers (monolithic)
XP_WDK_BUILDDIR     = buildxp
XP_WDK_OS_x86       = wxp
XP_WDK_OS_x64       = wnet
XP_x86_WLDRIVER     = $(subst $(space),$(empty),src/wl/sys/wdm/$(XP_WDK_BUILDDIR)/objfre_$(XP_WDK_OS_x86)_x86/i386/bcmwl5.sys)
XP_x64_WLDRIVER     = $(subst $(space),$(empty),src/wl/sys/wdm/$(XP_WDK_BUILDDIR)/objfre_$(XP_WDK_OS_x64)_amd64/amd64/bcmwl564.sys)
XP_WLINF            = $(subst $(space),$(empty),bcmwl5.inf)
...
# Broadcom Internet Sharing driver
...
VISTA_x86_WLDRIVER  = $(subst $(space),$(empty),src/wl/sys/wdm/$(VISTA_WDK_BUILDDIR)/objfre_$(VISTA_WDK_OS)_x86/i386/bcmwl6.sys)
VISTA_x64_WLDRIVER  = $(subst $(space),$(empty),src/wl/sys/wdm/$(VISTA_WDK_BUILDDIR)/objfre_$(VISTA_WDK_OS)_amd64/amd64/bcmwl664.sys)
VISTA_WLINF         = $(subst $(space),$(empty),bcmwl6.inf)

WIN8X_x86_WLDRIVER   = $(subst $(space),$(empty),src/wl/sys/wdm/obj/win8x_nic/free/x86/bcmwl63.sys)
WIN8X_x64_WLDRIVER   = $(subst $(space),$(empty),src/wl/sys/wdm/obj/win8x_nic/free/x64/bcmwl63a.sys)
...
WIN8X_x86_WLDEBUG   = src/wl/sys/wdm/obj/win8x_nic/checkedexternal/x86/bcmwl63.sys
WIN8X_x64_WLDEBUG   = src/wl/sys/wdm/obj/win8x_nic/checkedexternal/x64/bcmwl63a.sys)
WIN8X_WLINF          = $(subst $(space),$(empty),bcmwl63.inf)
...
ifeq ($(findstring _REL_,$(TAG)),_REL_)
  DOTFUSCATE_APP    := true
else
  DOTFUSCATE_APP    := false
endif
...
BCMWLHLP_DIR               := Z:/projects/hnd/software/work/HelpFiles
...
RLSPKG_DIRS_WINALL   := $(foreach oem,$(OEM_LIST_WINALL_RLSPKG),\
			   $(foreach os,WinXP Win7 WinVista Win8X,\
...
#
UNDEFS+= CONFIG_BRCM_VJ CONFIG_BCRM_93725 CONFIG_BCM93725_VJ CONFIG_BCM93725 \
         BCM4413_CHOPS BCM42XX_CHOPS BCM33XX_CHOPS CONFIG_BCM93725 BCM93725B \
         BCM94100 BCM_USB NICMODE ETSIM INTEL NETGEAR COMS BCM93352 BCM93350 \
         BCM93310 PSOS __klsi__ VX_BSD4_3 ROUTER BCMENET BCM4710A0 CONFIG_BCM4710 \
         CONFIG_MIPS_BRCM POCKET_PC BCMINTERNAL DSLCPE LINUXSIM BCMSIM       \
         BCMSIMUNIFIED WLNINTENDO WLNINTENDO2

# for Microsoft Inbox only        BCMWAPI_WPI BCMWAPI_WAI
...
define INSTALL_VISTA_REDIST_IHV
	@echo "#- $0"
#disabled#	$(INSTALL) src/wps/win32/wps_enr/WinPcap_4_0_2.exe  $@/$1
...
define NEW_INSTALL_VISTA_HSM_BIN
	@echo "#- $0"
	$(INSTALL) src/apps/fsh/win32/bin/$1/bcmfshapi.dll		$@/
	$(INSTALL) src/apps/fsh/win32/bin/$1/x64/bcmfshapi.dll		$@/x64
...
define RELEASE_SIGN_WIN8X_DRIVER
	@echo "#- $0($1,$2,$3)"
	$(MAKE) -C src/wl/sys/wdm release_sign_driver \
		SIGN_DIR=$1 SIGN_ARCH=$2 RELNUM="$(RELNUM)" WINOS=$(WINOS) \
		$(if $3,WINOS=$3) WDK_VER=$(WIN8X_WDK_VERSION) VS_VER=$(VS_VER)
...
define INSTALL_AUXAPP_SET1
	@$(MARKSTART)
	$(INSTALL) components/apps/windows/tray/winx/Remoting/Releasewb/$(1)/bcmwlrmt.dll $@/
	$(INSTALL) components/apps/windows/tray/winx/Remoting/Releasewb/x64/$(1)/bcmwlrmt.dll $@/x64
	$(INSTALL) components/apps/windows/libraries/WlAdapter/DLL/Releasewb/bcmwlapiu.dll $@/
	$(INSTALL) components/apps/windows/libraries/WlAdapter/DLL/Releasewb/x64/bcmwlapiu.dll $@/x64
	$(INSTALL) $(INS_DIR)/Utils/Inst2Gac_win8.exe $@/Inst2Gac.exe
	$(INSTALL) $(INS_DIR)/Utils/Inst2Gac_win8.exe $@/x64/Inst2Gac.exe
	$(INSTALL) $(BIN_DIR)/vs10/free/vcredist_x86.bat $@/vs10
	$(INSTALL) $(BIN_DIR)/vs10/free/vcredist_x86.exe $@/vs10
	$(INSTALL) $(BIN_DIR)/vs10/free/x64/vcredist_x64.bat $@/vs10/x64
	$(INSTALL) $(BIN_DIR)/vs10/free/x64/vcredist_x64.exe $@/vs10/x64
	$(INSTALL) $(BIN_DIR)/vs12/free/vcredist_x86.bat $@/vs12
	$(INSTALL) $(BIN_DIR)/vs12/free/vcredist_x86.exe $@/vs12
	$(INSTALL) $(BIN_DIR)/vs12/free/x64/vcredist_x64.bat $@/vs12/x64
	$(INSTALL) $(BIN_DIR)/vs12/free/x64/vcredist_x64.exe $@/vs12/x64
	$(INSTALL) $(BIN_DIR)/vs13/free/vcredist_x86.bat $@/vs13
	$(INSTALL) $(BIN_DIR)/vs13/free/vcredist_x86.exe $@/vs13
	$(INSTALL) $(BIN_DIR)/vs13/free/x64/vcredist_x64.bat $@/vs13/x64
	$(INSTALL) $(BIN_DIR)/vs13/free/x64/vcredist_x64.exe $@/vs13/x64
	#VCREDIST for IHV, since IHV is built using VC2005.
	...
	@$(MARKEND)
endef #INSTALL_AUXAPP_SET1
define INSTALL_AUXAPP_SET2
	@$(MARKSTART)
	$(INSTALL) components/apps/windows/tray/winx/ClientApp/Releasewb/$(1)/wltray.exe $@/
	$(INSTALL) components/apps/windows/tray/winx/ClientApp/Releasewb/x64/$(1)/wltray.exe $@/x64
	$(INSTALL) components/apps/windows/tray/shared/wltrysvc/Releasewb/$(1)/wltrysvc.exe $@/
	$(INSTALL) components/apps/windows/tray/shared/wltrysvc/Releasewb/x64/$(1)/wltrysvc.exe $@/x64
	$(INSTALL) components/apps/windows/tray/winx/ServerApp/Releasewb/$(1)/bcmwltry.exe $@/
	$(INSTALL) components/apps/windows/tray/winx/ServerApp/Releasewb/x64/$(1)/bcmwltry.exe $@/x64
	$(INSTALL) components/apps/windows/tray/winx/Peernet/Releasewb/$(1)/bcmpeerapi.dll $@/
    $(INSTALL) components/apps/windows/tray/winx/Peernet/Releasewb/x64/$(1)/bcmpeerapi.dll $@/x64
	$(INSTALL) components/apps/windows/tray/shared/BCMLogon/BCMLogon/Releasewb/$(1)/BCMLogon.dll $@/
	$(INSTALL) components/apps/windows/tray/shared/BCMLogon/BCMLogon/Releasewb/x64/$(1)/BCMLogon.dll $@/x64
	$(INSTALL) components/apps/windows/tray/shared/wltrynt/Releasewb/$(1)/WLTryNT.dll $@/
	$(INSTALL) components/apps/windows/tray/shared/wltrynt/Releasewb/x64/$(1)/WLTryNT.dll $@/x64
	$(call FILES_COMPONENT_PROTOCOLDRIVER)
	$(call NEW_INSTALL_VISTA_HSM_BIN,Releasewb)
	$(call INSTALL_PEERNET_INSTALLER,$@)
	# Install and sign ndis virtual wl driver bits
	$(call INSTALL_VWL_DRIVER,$@/Drivers/$(VERSION_NAME)/VWL,WIN7)
	@$(MARKEND)
endef #INSTALL_AUXAPP_SET2
define INSTALL_AUXAPP_SET3
	@$(MARKSTART)
	$(INSTALL) components/apps/windows/tray/winx/ControlPanel/Releasewb/$(1)/bcmwlcpl.cpl $@/
	$(INSTALL) components/apps/windows/tray/winx/ControlPanel/Releasewb/x64/$(1)/bcmwlcpl.cpl $@/x64
	@$(MARKEND)
endef #INSTALL_AUXAPP_SET3

define INSTALL_COMPONENT_SOFTAP
	$(call FILES_COMPONENT_SOFTAP)
	$(call FILES_BCMWLS_FOR_SOFTAP)
endef
...
# Start Temporary For Lenovo Task Scheduler

COMPONENT_BCMWLS_ROOT_PATH:= $(INS_DIR)/bcmwls_2010
define FILES_BCMWLS_FOR_SOFTAP
	$(INSTALL) $(COMPONENT_BCMWLS_ROOT_PATH)/Release/bcmwls32.exe $@/
	$(INSTALL) $(COMPONENT_BCMWLS_ROOT_PATH)/x64/Release/bcmwls64.exe $@/
	$(INSTALL) $(INS_DIR)/Utils/dpinst32.exe $@/
	$(INSTALL) $(INS_DIR)/Utils/dpinst64.exe $@/
	@$(SIGNTOOL_CMND_64) $$(cygpath -m $@/bcmwls*.exe)
endef

# End Temporary For Lenovo Task Scheduler

COMPONENT_SOFTAP_ROOT_PATH:= src/wl/cpl/vista/lenovo/WPFLenovoSoftAP
define FILES_COMPONENT_SOFTAP
	$(INSTALL) -d $@/en-US
	$(INSTALL) -d $@/zh-Hans
	$(INSTALL) $(COMPONENT_SOFTAP_ROOT_PATH)/win32/Releasewb/en-US/*      $@/en-US
	$(INSTALL) $(COMPONENT_SOFTAP_ROOT_PATH)/win32/Releasewb/zh-Hans/*    $@/zh-Hans
	$(INSTALL) $(COMPONENT_SOFTAP_ROOT_PATH)/win32/Releasewb/*.{dll,exe}  $@/

	$(INSTALL) -d $@/x64/en-US
	$(INSTALL) -d $@/x64/zh-Hans
	$(INSTALL) $(COMPONENT_SOFTAP_ROOT_PATH)/x64/Releasewb/en-US/*     $@/x64/en-US
	$(INSTALL) $(COMPONENT_SOFTAP_ROOT_PATH)/x64/Releasewb/zh-Hans/*   $@/x64/zh-Hans
	$(INSTALL) $(COMPONENT_SOFTAP_ROOT_PATH)/x64/Releasewb/*.{dll,exe} $@/x64
...
define INSTALL_COMPONENT_WINIEAPI
	$(INSTALL) $(COMPONENT_WINIEAPI_ROOT_PATH)/bcmwlanapi/Releasewb/*.{dll,lib} $@/
	$(INSTALL) $(COMPONENT_WINIEAPI_ROOT_PATH)/bcmwlanapp/Releasewb/bcmwlanapp.exe $@/
	$(INSTALL) $(COMPONENT_WINIEAPI_ROOT_PATH)/bcmwlanapi/Releasewb/x64/*.{dll,lib} $@/x64
	$(INSTALL) $(COMPONENT_WINIEAPI_ROOT_PATH)/bcmwlanapp/Releasewb/x64/bcmwlanapp.exe $@/x64
endef

define INSTALL_COMPONENT_WINIEAPI_DEBUGSYMBOLS
	$(INSTALL) $(COMPONENT_WINIEAPI_ROOT_PATH)/bcmwlanapi/Releasewb/bcmwlanapi.pdb $@/
	$(INSTALL) $(COMPONENT_WINIEAPI_ROOT_PATH)/bcmwlanapp/Releasewb/bcmwlanapp.pdb $@/
	$(INSTALL) $(COMPONENT_WINIEAPI_ROOT_PATH)/bcmwlanapi/Releasewb/x64/bcmwlanapi.pdb $@/x64
	$(INSTALL) $(COMPONENT_WINIEAPI_ROOT_PATH)/bcmwlanapp/Releasewb/x64/bcmwlanapp.pdb $@/x64
endef

define INSTALL_COMPONENT_WINIEAPI_SDK
	$(MKDIR) $@/Release/ $@/x64/Release/ $@/inc/ $@/common/ $@/bcmwlanapp/inc/
	$(INSTALL) $(COMPONENT_WINIEAPI_ROOT_PATH)/bcmwlanapi/Releasewb/*.{dll,lib} $@/Release/
	$(INSTALL) $(COMPONENT_WINIEAPI_ROOT_PATH)/bcmwlanapi/Releasewb/x64/*.{dll,lib} $@/x64/Release/
	$(INSTALL) $(COMPONENT_WINIEAPI_ROOT_PATH)/bcmwlanapp/Releasewb/bcmwlanapp.exe $@/Release/
	$(INSTALL) $(COMPONENT_WINIEAPI_ROOT_PATH)/bcmwlanapp/Releasewb/x64/bcmwlanapp.exe $@/x64/Release/
	$(INSTALL) $(COMPONENT_WINIEAPI_ROOT_PATH)/inc/*.h $@/inc/
	$(INSTALL) $(COMPONENT_WINIEAPI_ROOT_PATH)/common/*.cpp $@/common/
	$(INSTALL) $(COMPONENT_WINIEAPI_ROOT_PATH)/bcmwlanapp_vs12.sln $@/
	$(INSTALL) $(COMPONENT_WINIEAPI_ROOT_PATH)/bcmwlanapp/*.cpp $@/bcmwlanapp/
	$(INSTALL) $(COMPONENT_WINIEAPI_ROOT_PATH)/bcmwlanapp/bcmwlanapp_vs12.vcxproj $@/bcmwlanapp/
	$(INSTALL) $(COMPONENT_WINIEAPI_ROOT_PATH)/bcmwlanapp/inc/*.h $@/bcmwlanapp/inc/
endef
...
define INSTALL_COMPONENT_MIRACAST_NATIVE
	$(INSTALL) $(COMPONENT_MIRACAST_NATIVE_ROOT_PATH)/miracastnativeapi/Releasewb/*.{dll,lib} $@/
	$(INSTALL) $(COMPONENT_MIRACAST_NATIVE_ROOT_PATH)/miracastnativeapi/Releasewb/x64/*.{dll,lib} $@/x64
	$(INSTALL) $(COMPONENT_MIRACAST_NATIVE_ROOT_PATH)/miracastnativeapp/Releasewb/miracastnativeapp.exe $@/
	$(INSTALL) $(COMPONENT_MIRACAST_NATIVE_ROOT_PATH)/miracastnativeapp/Releasewb/x64/miracastnativeapp.exe $@/x64
endef

COMPONENT_MIRACAST_NATIVE_INCLUDE_PATH := src/apps/wfd_capd/include
define INSTALL_COMPONENT_MIRACAST_API_SDK
	$(MKDIR) $@/Release/ $@/x64/Release/ $@/inc/ $@/common/ $@/miracastnativeapp/
	$(INSTALL) $(COMPONENT_MIRACAST_NATIVE_ROOT_PATH)/miracastnativeapi/Releasewb/*.{dll,lib} $@/Release/
	$(INSTALL) $(COMPONENT_MIRACAST_NATIVE_ROOT_PATH)/miracastnativeapi/Releasewb/x64/*.{dll,lib} $@/x64/Release/
	$(INSTALL) $(COMPONENT_MIRACAST_NATIVE_ROOT_PATH)/miracastnativeapp/Releasewb/miracastnativeapp.exe $@/Release/
	$(INSTALL) $(COMPONENT_MIRACAST_NATIVE_ROOT_PATH)/miracastnativeapp/Releasewb/x64/miracastnativeapp.exe $@/x64/Release/
	$(INSTALL) $(COMPONENT_MIRACAST_NATIVE_ROOT_PATH)/miracastnativeappSDK-VS12.sln $@/
	$(INSTALL) $(COMPONENT_MIRACAST_NATIVE_ROOT_PATH)/miracastnativeapp/*.{cpp,vcxproj,h} $@/miracastnativeapp/
	$(INSTALL) $(COMPONENT_MIRACAST_NATIVE_INCLUDE_PATH)/*.h $@/inc/
	$(INSTALL) $(COMPONENT_WINIEAPI_ROOT_PATH)/inc/*.h $@/inc/
	$(INSTALL) $(COMPONENT_WINIEAPI_ROOT_PATH)/bcmwlanapi/Releasewb/*.{dll,lib} $@/Release/
	$(INSTALL) $(COMPONENT_WINIEAPI_ROOT_PATH)/bcmwlanapi/Releasewb/x64/*.{dll,lib} $@/x64/Release/
	$(INSTALL) $(COMPONENT_WINIEAPI_ROOT_PATH)/common/*.cpp $@/common/
...
define INSTALL_INSTALLSHIELD_FILES
	...
	$(if $(findstring Lenovo,$@),,$(call INSTALL_BCMWLS,$1,$2))
endef # INSTALL_INSTALLSHIELD_FILES

# $1 is <oem>; $2 <free or checked>; $3 <type of installshield>
define INSTALL_BCMWLMASTER_IS_FILES
	@echo "#- $0"
	$(MKDIR) $@/Disk1/Win7 $@/Disk1/WinXP
	$(INSTALL) $(INS_DIR)/installshield/$3/is_bin/$1/Setup.ini   $@/Disk1/Win7
	$(INSTALL) $(INS_DIR)/installshield/$3/is_bin/$1/Setup.ini   $@/Disk1/WinXP
...
define PACKAGING_CORE_SET1
	@$(MARKSTART)
	mkdir -pv $@/{,vs10,vs12,vs13}/x64 $@/Drivers/$(VERSION_NAME)/{WL,VWL}
	$(call WARN_PARTIAL_BUILD)
	$(call INSTALL_AUXAPP_SET1,bcm)
	$(call INSTALL_MUIDLLS,lenovo)
	$(if $(findstring Lenovo,$@),,$(call INSTALL_AUXAPP_SET2,bcm))
#	$(call INSTALL_COMPONENT_SOFTAP,bcm)
	$(call INSTALL_VISTA32BIT_BUILT_IHV,Releasewb/bcm,Drivers/$(VERSION_NAME)/WL)
	$(call INSTALL_VISTA64BIT_BUILT_IHV,x64/Releasewb/bcm,Drivers/$(VERSION_NAME)/WL)
	$(INSTALL) components/apps/windows/ihvfrm/ihv/Releasewb/wapiutil.exe  $@/
	$(INSTALL) components/apps/windows/ihvfrm/ihv/x64/Releasewb/wapiutil.exe $@/x64
	# install driver and its dependent files
	$(INSTALL) $(WIN8X_x86_WLDRIVER) $@/Drivers/$(VERSION_NAME)/WL
	$(INSTALL) $(WIN8X_x64_WLDRIVER) $@/Drivers/$(VERSION_NAME)/WL
	$(call INSTALL_INF,$(INF_DIR)/bcm/$(WIN8X_WLINF),$@/Drivers/$(VERSION_NAME)/WL)
	...
	mkdir -pv  $@/Drivers/Win8/WL
	$(INSTALL) $@/Drivers/$(VERSION_NAME)/WL/*.cat $@/Drivers/Win8/WL/

	# install installer
	$(call INSTALL_INSTALLSHIELD_FILES,$(1),free,BCMAppInstaller)
	$(INSTALL) $(INS_DIR)/ini_win8x/$(1)/free/external.ini $@/bcmwls.ini
	$(INSTALL) $(INS_DIR)/ini_win8x/$(1)/free/driver.ini $@/bcmwlsd.ini
	...
	$(if $(findstring WinALL,$@),,$(call PACKAGE_RELEASE,$(1)_Driver_$(VERSION_NAME))
	@$(MARKEND)
endef

all: build_start mogrify pre_release
all: build_driver
# all: build_auxiliary_libraries build_trayapp_xp2k build_trayapp_vista
# all: build_bluewire_win7
all: build_install
# all: build_trayapp_vista_dotfuscate
all: release

#build_dlgtest build_status build_end
...
build_trayapp: build_trayapp_vista build_trayapp_xp2k

build_trayapp_vista: mogrify build_include
	@$(MARKSTART)
	$(MAKE) -C components/apps/windows/ihvfrm/ihv -f build_vs13.mk \
	        BUILD_CONFS=Releasewb BUILD_ARCHS="x86 x64"
#disabled#	$(MAKE) -C $(dir $(INS_DIR))Co-Installer/bcmwlcoi \
#disabled#		PROJECT_CONFIGS="$(PROJECT_CONFIGS_VISTA_IHV)"

ifeq ($(BUILD_TRAYAPP),true)
#disabled#	$(MAKE) -C src/wl/cpl/vista \
#disabled#		   PROJECT_CONFIGS="$(PROJECT_CONFIGS_VISTA_APP)"
#BUILD_COMPONENT_SAMPLES#		$(MAKE) -C components/apps/windows/tray/winx/Samples \
			   PROJECT_CONFIGS="$(PROJECT_CONFIGS_VISTA_APP)" \
			   OEM_LIST=bcm
#disabled#	$(MAKE) -C components/apps/windows/tray/winx/Tools/WLVTT \
#disabled#		   PROJECT_CONFIGS="$(PROJECT_CONFIGS_VISTA)"
#disabled#	$(MAKE) -C src/wl/cpl/components/sup/eaphost/ttls \
#disabled#		   PROJECT_CONFIGS="$(PROJECT_CONFIGS_VISTA_TTLS)"
#disabled#	$(MAKE) -C $(dir $(INS_DIR))BcmSetupUtil \
#disabled#		   OEM_LIST="bcm" \
#disabled#		   PROJECT_CONFIGS="$(PROJECT_CONFIGS_XP_APP)"
	$(MAKE) -C $(INS_DIR)/MUI \
...
ifeq ($(BUILD_TRAYAPP),true)
ifeq ($(strip $(DOTFUSCATE_APP)),true)
#disabled#	# Dotfuscate all vista objects
#disabled#	$(MAKE) -C components/apps/windows/tray/winx/Obfuscator/Dotfuscator \
#disabled#		   PROJECT_CONFIGS="$(PROJECT_CONFIGS_UNICODE)"
#disabled#	# Dotfuscate just bcmwlapi
#disabled#	$(MAKE) -C components/apps/windows/tray/winx/Obfuscator/Dotfuscator \
#disabled#		   PROJECT_CONFIGS="$(PROJECT_CONFIGS_VISTA)" \
#disabled#                   WLVISTA_TEMPLATE=WLVista_File.template \
#disabled#                   SIGN_APP=false
#disabled#	# Dotfuscate vista wlvtt tool (hp)
#disabled#	$(MAKE) -C components/apps/windows/tray/winx/Tools/WLVTT/Dotfuscator \
#disabled#		   PROJECT_CONFIGS="$(PROJECT_CONFIGS_VISTA)"
else # DOTFUSCATE_APP
...
build_trayapp_xp2k: mogrify build_include
	...
	$(MAKE) -C src/epiprot
ifeq ($(BUILD_TRAYAPP),true)
#disabled#	$(MAKE) -C src/wl/cpl PROJECT_CONFIGS="$(PROJECT_CONFIGS_XP_APP)"
#disabled#	$(MAKE) -C src/wl/cpl/preflib/wlconfig PROJCFG=Release package
...
#disabled#		   PROJECT_CONFIGS="$(PROJECT_CONFIGS_GENERIC)"
	@$(MARKEND)
endif # BUILD_TRAYAPP
...
ifeq ($(BCM_MFGTEST),)
	$(MAKE) -C src/wl/sys/wdm WIN8_WDK_VER=$(WIN8X_WDK_VERSION) \
	...
	$(MAKE) -C src/wl/sys/wdm WIN8_WDK_VER=$(WIN8X_WDK_VERSION) \
                                  WINOS=$(UPPER_VERSION_NAME) WLTEST=1 \
                                  $(if $(strip ${SERVER_PATH}),SERVER_PATH=$(strip ${SERVER_PATH})) \
                                  build_win8x_driver
#disabled#	$(MAKE) -C components/ndis/ndisvwl/sys BUILD_TYPES=free WLTEST=1
#disabled#	$(MAKE) -C src/wl/exe WLTEST=1
#disabled#	$(MAKE) -C src/wl/exe -f GNUmakefile.wlm_dll WLTEST=1
#disabled#      # Vista or Win7 version of wlu dll for mfgtest
#disabled#	$(MAKE) -C src/wl/exe/win7 WLTEST=1 \
#disabled#		PROJECT_CONFIGS="$(PROJECT_CONFIGS_GENERIC_ALL)"
#disabled##	$(MAKE) -C src/tools/mfgc WLTEST=1 nokia
#disabled#	# Winxp version of wlu dll for mfgtest is built by wl_base
#disabled#	$(MAKE) -C src/tools/mfgc wl_base
#disabled#	$(MAKE) -C src/tools/mfgc nokmfg
#disabled#	$(MAKE) -C src/tools/misc nvserial.exe
endif # BCM_MFGTEST
...
VISUALSTUDIOPATH_VS13 :=$(firstword $(wildcard C:/Tools/msdev/VS2013/VC C:/Tools/msdev/VS2012/VC))

define BUILD_MSBUILD_COMMANDS_VS13
	cmd /c "$(VISUALSTUDIOPATH_VS13)\$(PRGCMD) && cd $(3) && \
	set OEM=$(1)&& \
	$(MSBUILD_CMD) /t:$(2) $(4) /p:Configuration=$(5) /p:Platform=$(6) /p:WDKContentRoot=$(WIN8X_WDK_ROOT)/"
endef
VISUALSTUDIOWDKPATH_VS13 :=$(firstword $(wildcard C:/Tools/msdev/VS2013/VC C:/Tools/msdev/VS2012/VC))
define BUILD_MSBUILD_COMMANDS_WDK_VS13
	cmd /c "$(VISUALSTUDIOWDKPATH_VS13)\$(PRGCMD) && cd $(3) && \
	set OEM=$(1)&& \
	$(MSBUILD_CMD) /t:$(2) $(4) /p:Configuration=$(5) /p:Platform=$(6) /p:WDKContentRoot=$(WIN8X_WDK_ROOT)/"
endef


VISUALSTUDIOPATH :=$(firstword $(wildcard C:/Tools/msdev/VS2012/VC C:/Tools/msdev/VS2010/VC))
...
define BUILD_MSBUILD_COMMANDS
	cmd /c "$(VISUALSTUDIOPATH)\$(PRGCMD) && cd $(3) && \
	  ...
	  $(MSBUILD_CMD) /t:$(2) $(4) /p:Configuration=$(5) /p:Platform=$(6) /p:WDKContentRoot=$(WIN8X_WDK_ROOT)/"
endef
VISUALSTUDIOWDKPATH :=$(firstword $(wildcard C:/Tools/msdev/VS2012/VC C:/Tools/msdev/VS2010/VC))
define BUILD_MSBUILD_COMMANDS_WDK
	cmd /c "$(VISUALSTUDIOWDKPATH)\$(PRGCMD) && cd $(3) && \
	  set OEM=$(1)&& \
	  $(MSBUILD_CMD) /t:$(2) $(4) /p:Configuration=$(5) /p:Platform=$(6) /p:WDKContentRoot=$(WIN8X_WDK_ROOT)/"
endef
define BUILD_CONTROLPANEL_APPS
	$(call BUILD_MSBUILD_COMMANDS_WDK_VS13,$(1),build,components\apps\windows\libraries,WLWin8_VS13.sln,Releasewb,Win32)
	$(call BUILD_MSBUILD_COMMANDS_VS13,$(1),build,components\apps\windows\tray\winx,WLWin8Tray_vs13.sln,Releasewb,Win32)
	cmd /c %SN_CMD32% components\\apps\\windows\\tray\\winx\\Remoting\\Releasewb\\$(1)\\bcmwlrmt.dll  \
		components\\apps\\windows\\tray\\winx\\Remoting\\bcmwlrmt.snk

	$(call BUILD_MSBUILD_COMMANDS_WDK_VS13,$(1),build,components\apps\windows\libraries,WLWin8_VS13.sln,Releasewb,x64)
	$(call BUILD_MSBUILD_COMMANDS_VS13,$(1),build,components\apps\windows\tray\winx,WLWin8Tray_vs13.sln,Releasewb,x64)
	cmd /c %SN_CMD64% components\\apps\\windows\\tray\\winx\\Remoting\\Releasewb\\x64\\$(1)\\bcmwlrmt.dll \
		components\\apps\\windows\\tray\\winx\\Remoting\\bcmwlrmt.snk

	cmd /c "$(VISUALSTUDIOPATH)\$(PRGCMD) && set OEM= "
endef

define BUILD_COMPONENT_SAMPLES
	@echo "#- $0"
	@$(MARKSTART)
	$(call BUILD_MSBUILD_COMMANDS_VS13,$(1),build,components\apps\windows\tray\winx\Samples,WLWin8_Samples_vs13.sln,Releasewb,Win32)
	$(call BUILD_MSBUILD_COMMANDS_VS13,$(1),build,components\apps\windows\tray\winx\Samples,WLWin8_Samples_vs13.sln,Releasewb,x64)
	@$(MARKEND)
endef
define BUILD_COMPONENT_SOFTAP
	@echo "#- $0"
	@$(MARKSTART)
	$(call BUILD_MSBUILD_COMMANDS,$(1),Rebuild,$(INS_DIR)\bcmwls_2010,bcmwls.sln,Release,Win32)
	$(call BUILD_MSBUILD_COMMANDS,$(1),Rebuild,$(INS_DIR)\bcmwls_2010,bcmwls.sln,Release,x64)
	$(call BUILD_MSBUILD_COMMANDS_WDK_VS13,$(1),build,src\wl\cpl\vista\lenovo\WPFLenovoSoftAP,LenovoSoftAP_VS13.sln,Releasewb,Win32)
	$(call BUILD_MSBUILD_COMMANDS_WDK_VS13,$(1),build,src\wl\cpl\vista\lenovo\WPFLenovoSoftAP,LenovoSoftAP_VS13.sln,Releasewb,x64)
	@$(MARKEND)
endef
...
#	@echo "#- $0"
#	@$(MARKSTART)
#	$(call BUILD_MSBUILD_COMMANDS_WDK,$(1),build,src\wl\cpl\vista\WinIEapi,bcmwlanapi.sln,Release,Win32)
#	$(call BUILD_MSBUILD_COMMANDS_WDK,$(1),build,src\wl\cpl\vista\WinIEapi,bcmwlanapi.sln,Release,x64)
#	$(call BUILD_MSBUILD_COMMANDS,$(1),build,src\wl\cpl\vista\WinIEapi,bcmwlanapp.sln,Release,Win32)
#	$(call BUILD_MSBUILD_COMMANDS,$(1),build,src\wl\cpl\vista\WinIEapi,bcmwlanapp.sln,Release,x64)
#	@$(MARKEND)
#endef
#
...
define BUILD_COMPONENT_NBM_CA
	$(call BUILD_MSBUILD_COMMANDS_WDK_VS13,$(1),build,src\wl\cpl\vista\Managed,ManagedWLWin8_VS13.sln,Releasewb,Win32)
	$(call BUILD_MSBUILD_COMMANDS_WDK_VS13,$(1),build,src\wl\cpl\vista\Managed,ManagedWLWin8_VS13.sln,Releasewb,x64)
endef

COMPONENT_NBM_ROOT_PATH:= src/wl/cpl/vista/
define INSTALL_COMPONENT_NBM_CA
	$(call INSTALL_NBM_CA_MUIDLLS)
	$(INSTALL) $(COMPONENT_NBM_ROOT_PATH)/win32/Releasewb/*.{dll,exe}  $@/
	$(INSTALL) $(COMPONENT_NBM_ROOT_PATH)/x64/Releasewb/*.{dll,exe} $@/x64
	$(INSTALL) $(COMPONENT_NBM_ROOT_PATH)/WPFNBM/WpfNetworkBandwidthManager/Images/wi-fi.ico $@/
endef

define INSTALL_NBM_CA_MUIDLLS
	@echo "#- $0"
	mkdir -p $@ $@/x64
	cd $(COMPONENT_NBM_ROOT_PATH)/win32/Releasewb; cp -prv --parents */ManagedLocalizationResourceStrings.resources.dll $@
	cd $(COMPONENT_NBM_ROOT_PATH)/x64/Releasewb; cp -prv --parents */ManagedLocalizationResourceStrings.resources.dll $@/x64
endef # INSTALL_NBM_MUIDLLS
...
#	$(call BUILD_COMPONENT_SAMPLES,bcm)
#	$(call BUILD_COMPONENT_WINIEAPI_AND_MIRACAST_NATIVE,generic)
#	$(call BUILD_COMPONENT_WINIEAPI,generic) Vishal
#	$(call BUILD_CONTROLPANEL_APPS,hp)
#	$(call BUILD_CONTROLPANEL_APPS,dell)
#	$(call BUILD_COMPONENT_SOFTAP,bcm)
#	$(call BUILD_COMPONENT_NBM_CA,bcm)
	@$(MARKEND)
...
ifneq ($(BUILD_WINALL_KIT),false)
	...
	@for oem in $(OEM_LIST_WIN8X_RLSPKG); do \
	  [ -d release/$(VERSION_NAME)/$${oem} ] || mkdir -pv release/$(VERSION_NAME)/$${oem}; \
	done
...
## Win8 release packaging after everything is built
release_win8x: pre_release
release_win8x: $(OEM_LIST_WIN8X_RLSPKG:%=$(RELEASEDIR)/$(VERSION_NAME)/%)
#disabled#	@$(MARKSTART)
#disabled#	-$(INSTALL) src/doc/ReadmeReleaseDir_$(BRAND).txt release/README.txt
#disabled#	@$(MARKEND)
...
$(RELEASEDIR)/WinALL/Bcm/Bcm_InstallShield: \
	$(RELEASEDIR)/WinALL/Bcm/Bcm_InstallShield/Disk1/$(VERSION_NAME)
...
$(RELEASEDIR)/WinALL/Bcm/Bcm_InstallShield_Driver: \
	$(RELEASEDIR)/WinALL/Bcm/Bcm_InstallShield_Driver/Disk1/$(VERSION_NAME)
	# Install Master installer files
	$(call INSTALL_BCMWLMASTER_IS_FILES,bcm,free,BcmWLMaster)
	# Generate master installer
...
$(RELEASEDIR)/WinALL/Bcm/Bcm_DriverOnly: \
	$(RELEASEDIR)/WinALL/Bcm/Bcm_DriverOnly/$(VERSION_NAME)
else # BUILD_TRAYAPP
$(RELEASEDIR)/WinXP/Bcm: \
...
$(RELEASEDIR)/WinXP/Bcm/Bcm_DriverOnly_CAB: FORCE
	...
	cd $@; $(FIND) . -type f \! -name $(subst _CAB,.CAB,$(@F)) -print | \
		xargs rm -fv
	@$(SIGNTOOL_CMND_32) $$(cygpath -m $@/*.CAB)
	@$(MARKEND)
...
$(RELEASEDIR)/$(VERSION_NAME)/Bcm/Bcm_Peernet_SDK \
$(RELEASEDIR)/$(VERSION_NAME)/HP/HP_Peernet_SDK \
$(RELEASEDIR)/$(VERSION_NAME)/Dell/Dell_Peernet_SDK: OEM=$(word 1,$(subst /, ,$(subst $(RELEASEDIR)/$(VERSION_NAME)/,,$@)))
$(RELEASEDIR)/Win7/Bcm/Bcm_Peernet_SDK $(RELEASEDIR)/$(VERSION_NAME)/Bcm/Bcm_Peernet_SDK \
$(RELEASEDIR)/Win7/HP/HP_Peernet_SDK  $(RELEASEDIR)/$(VERSION_NAME)/HP/HP_Peernet_SDK \
$(RELEASEDIR)/Win7/Dell/Dell_Peernet_SDK $(RELEASEDIR)/$(VERSION_NAME)/Dell/Dell_Peernet_SDK: FORCE $(PRE_RELEASE_DEPS_VISTA)
	@$(MARKSTART)
	mkdir -p $@
	$(call WARN_PARTIAL_BUILD)
	...
	# Copy documents
	$(INSTALL) src/wl/cpl/vista/Peernet/Docs/PeernetSDK.doc $@/Docs
	# Copy common and sample peernet sdk and test files
	tar cpf - -C src/wl/cpl/vista/Peernet \
		--exclude=*/CVS \
		--exclude=*/.svn \
		--exclude=*/ReleaseUv \
		--exclude=*/Releasev \
	...
	$(call INSTALL_VISTA_PEERNET_LIB,Releasewb/$(OEM),Sample/Lib/Release/win32)
	$(call INSTALL_VISTA_PEERNET_LIB,Releasewb/x64/$(OEM),Sample/Lib/Release/x64)
	# Copy peernet release library in Debug/{win32,x64} folders
	$(call INSTALL_VISTA_PEERNET_LIB,Releasewb/$(OEM),Sample/Lib/Debug/win32)
	$(call INSTALL_VISTA_PEERNET_LIB,Releasewb/x64/$(OEM),Sample/Lib/Debug/x64)
	# Copy peertest release binary in Release/{win32,x64} folders
	$(call INSTALL_VISTA_PEERTEST_BIN,Releasewb,Sample/Bin/Release/win32)
	$(call INSTALL_VISTA_PEERTEST_BIN,Releasewb/x64,Sample/Bin/Release/x64)
	# Copy peertest release binary in Debug/{win32,x64} folders
	$(call INSTALL_VISTA_PEERTEST_BIN,Releasewb,Sample/Bin/Debug/win32)
	$(call INSTALL_VISTA_PEERTEST_BIN,Releasewb/x64,Sample/Bin/Debug/x64)
	$(call REMOVE_WARN_PARTIAL_BUILD)
	@date +"END: $@, %D %T"
	@$(MARKEND)
...
###---------BEGIN_SECTION_WINIEAPI---------###
$(RELEASEDIR)/$(VERSION_NAME)/Bcm/Bcm_WinIEapi_SDK \
$(RELEASEDIR)/$(VERSION_NAME)/HP/HP_WinIEapi_SDK \
$(RELEASEDIR)/$(VERSION_NAME)/Dell/Dell_WinIEapi_SDK:
	@$(MARKSTART)
	$(MKDIR) $@/
#	$(call INSTALL_COMPONENT_WINIEAPI_SDK,generic)
	@$(MARKEND)
###---------END_SECTION_WINIEAPI---------###

$(RELEASEDIR)/$(VERSION_NAME)/Bcm/Bcm_MiracastApi_SDK:
	@$(MARKSTART)
	$(MKDIR) $@/
#	$(call INSTALL_COMPONENT_MIRACAST_API_SDK,bcm)
	@$(MARKEND)
...
$(RELEASEDIR)/WinALL/Bcm/Bcm_DriverOnly/Win7: FORCE
	...
	$(call INSTALL_VISTA32BIT_BUILT_IHV,Releasewb/bcm)
	$(call INSTALL_32BIT_BUILT_COINSTALLER,Release)
	$(call RELEASE_SIGN_VISTA_DRIVER,$@,X86)
	$(call INSTALL_VISTA64BIT_BUILT_IHV,x64/Releasewb/bcm)
	$(call INSTALL_64BIT_BUILT_COINSTALLER,x64/Release)
...
# WinVista and Win7
$(RELEASEDIR)/Win7/Bcm/Bcm_DriverOnly_VWL \
$(RELEASEDIR)/$(VERSION_NAME)/Bcm/Bcm_DriverOnly_VWL: FORCE
	@$(MARKSTART)
	$(call INSTALL_VWL_DRIVER,$@,WIN7)
	@$(MARKEND)

# WinVista and Win7
$(RELEASEDIR)/Win7/DebugSymbols/Bcm $(RELEASEDIR)/$(VERSION_NAME)/DebugSymbols/Bcm: FORCE $(PRE_RELEASE_DEPS_VISTA)
	@$(MARKSTART)
	mkdir -p $@/x64
	$(call INSTALL_VISTA_APP_DEBUG_SYMBOLS,Releasewb/bcm)
	$(call INSTALL_VISTA_APP_DEBUG_SYMBOLS,Releasewb/x64/bcm,x64)
	$(call INSTALL_COMPONENT_WINIEAPI_DEBUGSYMBOLS,generic)
	@$(MARKEND)

# Starting with Win8 add HP OEM
$(RELEASEDIR)/$(VERSION_NAME)/DebugSymbols/HP: FORCE $(PRE_RELEASE_DEPS_VISTA)
	@$(MARKSTART)
	mkdir -p $@/x64
	$(call INSTALL_VISTA_APP_DEBUG_SYMBOLS,Releasewb/hp)
	$(call INSTALL_VISTA_APP_DEBUG_SYMBOLS,Releasewb/x64/hp,x64)
	@$(MARKEND)
...
$(RELEASEDIR)/WinALL/Bcm/Bcm_InstallShield/Disk1/Win7: FORCE $(PRE_RELEASE_DEPS_VISTA)
	...
	$(call INSTALL_VISTA32BIT_BUILT_IHV,Releasewb/bcm,Drivers/Win7/WL)
	$(call INSTALL_VISTA_REDIST_IHV)
	$(call INSTALL_32BIT_BUILT_COINSTALLER,Release,Drivers/Win7/WL)
	$(call INSTALL_VISTA64BIT_BUILT_IHV,x64/Releasewb/bcm,Drivers/Win7/WL)
	...
	$(call INSTALL_VS0532BIT_VCREDIST,free,$@/)
	$(call INSTALL_VS0832BIT_VCREDIST,free,$@/vs08)
	$(call INSTALL_VISTA_BUILT_APPS,Releasewb/bcm)
	$(call INSTALL_BLUEWIRE,release/bcm)
	$(call INSTALL_VISTA_BUILT_TTLS,Releasewb/bcm)
	$(call INSTALL_VISTA_HSM_BIN,Releasewb)
	# install 64bit driver and app
	$(call INSTALL_VS0564BIT_VCREDIST,free,$@/x64)
	$(call INSTALL_VS0864BIT_VCREDIST,free,$@/vs08/x64)
	$(call INSTALL_VISTA_BUILT_APPS,Releasewb/x64/bcm,x64)
	$(call INSTALL_BLUEWIRE,release/x64/bcm,x64)
	$(call INSTALL_VISTA_BUILT_TTLS,x64/Releasewb/bcm,x64)
	$(call INSTALL_VISTA_HSM_BIN,Releasewb/x64,x64)
...
# Win8 only DriverOnly and Driver Installshield are supported
$(RELEASEDIR)/$(VERSION_NAME)/Bcm: \
	$(RELEASEDIR)/$(VERSION_NAME)/Internal \
	$(RELEASEDIR)/$(VERSION_NAME)/Bcm/Bcm_DriverOnly \
	$(RELEASEDIR)/$(VERSION_NAME)/Bcm/Bcm_DriverOnly_VWL \
#	$(RELEASEDIR)/$(VERSION_NAME)/Bcm/Bcm_InstallShield/Disk1 \
#	$(RELEASEDIR)/$(VERSION_NAME)/Bcm/Bcm_InstallShield_Driver/Disk1 \
	$(RELEASEDIR)/$(VERSION_NAME)/DebugSymbols/Bcm
#	$(RELEASEDIR)/$(VERSION_NAME)/Bcm/Bcm_Peernet_SDK

# Win8
$(RELEASEDIR)/$(VERSION_NAME)/Bcm/Bcm_DriverOnly \
$(RELEASEDIR)/WinALL/Bcm/Bcm_DriverOnly/$(VERSION_NAME): FORCE
	@$(MARKSTART)
	mkdir -pv $@
	$(call WARN_PARTIAL_BUILD)
	$(INSTALL) $(WIN8X_x86_WLDRIVER) $@/
	$(INSTALL) $(WIN8X_x64_WLDRIVER) $@/
#	$(call INSTALL_VISTA32BIT_BUILT_IHV,Releasewb/bcm)
#	$(call INSTALL_VISTA64BIT_BUILT_IHV,x64/Releasewb/bcm)
	$(call INSTALL_INF,$(INF_DIR)/bcm/$(WIN8X_WLINF),$@/)
	$(call RELEASE_SIGN_WIN8X_DRIVER,$@,X86)
	$(call RELEASE_SIGN_WIN8X_DRIVER,$@,X64)
	$(call REMOVE_WARN_PARTIAL_BUILD)
	@$(MARKEND)
#	# End of $(RELEASEDIR)/Win8X/Bcm/Bcm_DriverOnly

# Win8 Driver Only Installshield
$(RELEASEDIR)/$(VERSION_NAME)/Bcm/Bcm_InstallShield_Driver/Disk1 \
$(RELEASEDIR)/WinALL/Bcm/Bcm_InstallShield_Driver/Disk1/$(VERSION_NAME): FORCE $(PRE_RELEASE_DEPS_VISTA)
	@$(MARKSTART)
	mkdir -pv $@/{,vs13}/x64 $@/Drivers/$(VERSION_NAME)/WL
...
#	$(call INSTALL_COMPONENT_MIRACAST_NATIVE,bcm)
	...
	$(call INSTALL_INSTALLSHIELD_FILES,bcm,free,BCMAppInstaller)
	$(INSTALL) $(INS_DIR)/ini_win8x/bcm/free/driver.ini $@/bcmwls.ini
	$(INSTALL) $(INS_DIR)/ini_win8x/bcm/free/driver.ini $@/bcmwlsd.ini
	$(INSTALL) $(INS_DIR)/installshield/BCMAppInstaller/is_bin/bcm/Setup_win8x.ini $@/Setup.ini
	unix2dos $@/Setup.ini
	# copy package version dll
	$(INSTALL) $(INS_DIR)/Utils/PackageVersion.dll $@/
	...
	$(INSTALL) components/apps/windows/libraries/WlAdapter/DLL/Releasewb/bcmwlapiu.dll $@/
	$(INSTALL) components/apps/windows/libraries/WlAdapter/DLL/Releasewb/x64/bcmwlapiu.dll $@/x64
	# vs13 is needed by bcmwlanapi.dll and bcmwlapiu.dll
	$(INSTALL) $(BIN_DIR)/vs13/free/vcredist_x86.bat $@/vs13
	$(INSTALL) $(BIN_DIR)/vs13/free/vcredist_x86.exe $@/vs13
	$(INSTALL) $(BIN_DIR)/vs13/free/x64/vcredist_x64.bat $@/vs13/x64
	$(INSTALL) $(BIN_DIR)/vs13/free/x64/vcredist_x64.exe $@/vs13/x64
	$(call REMOVE_WARN_PARTIAL_BUILD)
	# Create single installer (for non-WinALL packages)
	$(if $(findstring WinALL,$@),,$(call PACKAGE_RELEASE,Bcm_Driver_Win8))
	@$(MARKEND)
#	End of $(RELEASEDIR)/Win8X/Bcm/Bcm_InstallShield_Driver/Disk1

# Win8 Installshield App
$(RELEASEDIR)/$(VERSION_NAME)/Bcm/Bcm_InstallShield/Disk1 \
$(RELEASEDIR)/WinALL/Bcm/Bcm_InstallShield/Disk1/$(VERSION_NAME): FORCE $(PRE_RELEASE_DEPS_VISTA)
	@$(MARKSTART)
	mkdir -pv $@/{,vs10,vs12,vs13}/x64 $@/Drivers/$(VERSION_NAME)/{WL,VWL}
	mkdir -pv $@/EAP_Plugin_Installer
	mkdir -pv $@/MUI
	$(call WARN_PARTIAL_BUILD)
	$(call INSTALL_AUXAPP_SET1,bcm)
	$(call INSTALL_AUXAPP_SET2,bcm)
	$(call INSTALL_AUXAPP_SET3,bcm)
#	$(call INSTALL_COMPONENT_SOFTAP,bcm)
#	$(call INSTALL_COMPONENT_MIRACAST_NATIVE,bcm)
	$(call INSTALL_COMPONENT_WINIEAPI,generic)
	$(call INSTALL_VISTA32BIT_BUILT_IHV,Releasewb/bcm,Drivers/$(VERSION_NAME)/WL)
	...
	# install installer
	$(call INSTALL_INSTALLSHIELD_FILES,bcm,free,BCMAppInstaller)
	$(INSTALL) $(INS_DIR)/ini_win8x/bcm/free/external.ini $@/bcmwls.ini
	$(INSTALL) $(INS_DIR)/ini_win8x/bcm/free/driver.ini $@/bcmwlsd.ini
	$(INSTALL) $(INS_DIR)/installshield/BCMAppInstaller/is_bin/bcm/Setup_win8x.ini $@/Setup.ini
	unix2dos $@/Setup.ini
	$(INSTALL) $(INS_DIR)/sysinfo/Release/SysInfo.exe $@/
	...
	$(call REMOVE_WARN_PARTIAL_BUILD)
	# Create single installer (for non-WinALL packages)
	$(if $(findstring WinALL,$@),,$(call PACKAGE_RELEASE,Bcm_Driver_$(VERSION_NAME)))
	@$(MARKEND)
#	End of $(RELEASEDIR)/Win8X/Bcm/Bcm_InstallShield/Disk1

################################################################################
# Release the Lenovo branded files.
################################################################################
# Win8 Lenovo
$(RELEASEDIR)/$(VERSION_NAME)/Lenovo: \
	$(RELEASEDIR)/$(VERSION_NAME)/Lenovo/Lenovo_InstallShield/Disk1

$(RELEASEDIR)/$(VERSION_NAME)/Lenovo/Lenovo_InstallShield/Disk1 : FORCE
	$(call PACKAGING_CORE_SET1,lenovo)
...
$(RELEASEDIR)/WinALL/HP/HP_InstallShield/Disk1/Win7: FORCE $(PRE_RELEASE_DEPS_VISTA)
	...
	$(call INSTALL_VS0532BIT_VCREDIST,free,$@/)
	$(call INSTALL_VS0832BIT_VCREDIST,free,$@/vs08)
	$(call INSTALL_VISTA_BUILT_APPS,Releasewb/hp)
	$(call INSTALL_VISTA_BUILT_TTLS,Releasewb/hp)
	$(call INSTALL_VISTA_HSM_BIN,Releasewb)
	# install 64bit driver and app
	$(call INSTALL_VS0564BIT_VCREDIST,free,$@/x64)
	$(call INSTALL_VS0864BIT_VCREDIST,free,$@/vs08/x64)
	$(call INSTALL_VISTA_BUILT_APPS,Releasewb/x64/hp,x64)
	$(call INSTALL_VISTA_BUILT_TTLS,x64/Releasewb/hp,x64)
	$(call INSTALL_VISTA_HSM_BIN,Releasewb/x64,x64)
	# install File Sharing icons
	$(call INSTALL_VISTA_FS_ICONS,$@/FshSvrAdmin)
	# install help
...
# HP Driver Only InstallShield for Win8
$(RELEASEDIR)/$(VERSION_NAME)/HP: \
		       $(RELEASEDIR)/$(VERSION_NAME)/HP/HP_DriverOnly \
		       $(RELEASEDIR)/$(VERSION_NAME)/HP/HP_InstallShield/Disk1 \
		       $(RELEASEDIR)/$(VERSION_NAME)/HP/HP_InstallShield_Driver/Disk1 \
		       $(RELEASEDIR)/$(VERSION_NAME)/DebugSymbols/HP

# HP Win8
$(RELEASEDIR)/$(VERSION_NAME)/HP/HP_DriverOnly \
$(RELEASEDIR)/WinALL/HP/HP_DriverOnly/$(VERSION_NAME): FORCE
	@$(MARKSTART)
	mkdir -p $@
	$(call WARN_PARTIAL_BUILD)
	$(INSTALL) $(WIN8X_x86_WLDRIVER) $@/
	$(INSTALL) $(WIN8X_x64_WLDRIVER) $@/
	$(call INSTALL_INF,$(INF_DIR)/hp/$(WIN8X_WLINF),$@/)
	$(call INSTALL_VISTA32BIT_BUILT_IHV,Releasewb/bcm)
	$(call INSTALL_VISTA64BIT_BUILT_IHV,x64/Releasewb/bcm)
	$(call RELEASE_SIGN_WIN8X_DRIVER,$@,X86)
	$(call RELEASE_SIGN_WIN8X_DRIVER,$@,X64)
...
# HP Win8 InstallShield Driveronly
$(RELEASEDIR)/$(VERSION_NAME)/HP/HP_InstallShield_Driver/Disk1 \
$(RELEASEDIR)/WinALL/HP/HP_InstallShield_Driver/Disk1/$(VERSION_NAME): FORCE $(PRE_RELEASE_DEPS_VISTA)
	@$(MARKSTART)
	mkdir -pv $@ $@/Drivers/$(VERSION_NAME)/WL
	$(call WARN_PARTIAL_BUILD)
	$(call INSTALL_VISTA32BIT_BUILT_IHV,Releasewb/bcm,Drivers/$(VERSION_NAME)/WL)
	$(call INSTALL_VISTA64BIT_BUILT_IHV,x64/Releasewb/bcm,Drivers/$(VERSION_NAME)/WL)
	# install driver and its dependent files
	$(INSTALL) $(WIN8X_x86_WLDRIVER) $@/Drivers/$(VERSION_NAME)/WL
	$(INSTALL) $(WIN8X_x64_WLDRIVER) $@/Drivers/$(VERSION_NAME)/WL
	$(call INSTALL_INF,$(INF_DIR)/hp/$(WIN8X_WLINF),$@/Drivers/$(VERSION_NAME)/WL)
	$(call RELEASE_SIGN_WIN8X_DRIVER,$@/Drivers/$(VERSION_NAME)/WL,X86)
	$(call RELEASE_SIGN_WIN8X_DRIVER,$@/Drivers/$(VERSION_NAME)/WL,X64)
	...
	# install installer
	$(call INSTALL_INSTALLSHIELD_FILES,hp,free,BCMAppInstaller)
	$(INSTALL) $(INS_DIR)/ini_win8x/hp/free/driver.ini $@/bcmwls.ini
	# Need this to support -justdriver switch
	$(INSTALL) $(INS_DIR)/ini_win8x/hp/free/driver.ini $@/bcmwlsd.ini
	$(INSTALL) $(INS_DIR)/installshield/BCMAppInstaller/is_bin/hp/Setup_win8x.ini $@/Setup.ini
	unix2dos $@/Setup.ini
	$(INSTALL) $(INS_DIR)/sysinfo/Release/SysInfo.exe $@/
	# copy package version dll
	$(INSTALL) $(INS_DIR)/Utils/PackageVersion.dll $@/
	$(call REMOVE_WARN_PARTIAL_BUILD)
	# Create single installer (for non-WinALL packages)
	$(if $(findstring WinALL,$@),,$(call PACKAGE_RELEASE,HP_$(VERSION_NAME)_Driver))
	@date +"END: $@, %D %T"
	@echo "============================================================"
	@$(MARKEND)
#	End of $(RELEASEDIR)/Win8X/HP/HP_InstallShield_Driver/Disk1

# HP Win8 InstallShield
$(RELEASEDIR)/$(VERSION_NAME)/HP/HP_InstallShield/Disk1 \
$(RELEASEDIR)/WinALL/HP/HP_InstallShield/Disk1/$(VERSION_NAME): FORCE $(PRE_RELEASE_DEPS_VISTA)
	@$(MARKSTART)
	mkdir -p $@/{,vs10,vs12,vs13}/x64 $@/Drivers/$(VERSION_NAME)/{WL,VWL}
	$(call WARN_PARTIAL_BUILD)
	$(call INSTALL_AUXAPP_SET1,hp)
	$(call INSTALL_AUXAPP_SET2,hp)
	$(call INSTALL_COMPONENT_WINIEAPI,generic)
	$(call INSTALL_VISTA32BIT_BUILT_IHV,Releasewb/bcm,Drivers/$(VERSION_NAME)/WL)
	$(call INSTALL_VISTA64BIT_BUILT_IHV,x64/Releasewb/bcm,Drivers/$(VERSION_NAME)/WL)
	# install driver and its dependent files
	...
	# install installer
	$(call INSTALL_INSTALLSHIELD_FILES,hp,free,BCMAppInstaller)
	$(INSTALL) $(INS_DIR)/ini_win8x/hp/free/external.ini $@/bcmwls.ini
	# Need this to support -justdriver switch
	$(INSTALL) $(INS_DIR)/ini_win8x/hp/free/driver.ini $@/bcmwlsd.ini
	$(INSTALL) $(INS_DIR)/installshield/BCMAppInstaller/is_bin/hp/Setup_win8x.ini $@/Setup.ini
	unix2dos $@/Setup.ini
...
# WinVista and Win7
$(RELEASEDIR)/Win7/DebugSymbols/Dell $(RELEASEDIR)/$(VERSION_NAME)/DebugSymbols/Dell: FORCE
	@$(MARKSTART)
	mkdir -p $@/x64
	$(call INSTALL_VISTA_APP_DEBUG_SYMBOLS,Releasewb/dell)
	$(call INSTALL_VISTA_APP_DEBUG_SYMBOLS,Releasewb/x64/dell,x64)
	@$(MARKEND)
...
$(RELEASEDIR)/Win7/Dell/Dell_InstallShield/Disk1: FORCE $(PRE_RELEASE_DEPS_VISTA)
	...
	$(call INSTALL_VS0532BIT_VCREDIST,free,$@)
	$(call INSTALL_VS0832BIT_VCREDIST,free,$@/vs08)
	$(call INSTALL_VISTA_BUILT_APPS,Releasewb/dell)
	$(call INSTALL_VISTA_BUILT_TTLS,Releasewb/dell)
	$(call INSTALL_VISTA_HSM_BIN,Releasewb)
	$(call INSTALL_VS0564BIT_VCREDIST,free,$@/x64)
	$(call INSTALL_VS0864BIT_VCREDIST,free,$@/vs08/x64)
	$(call INSTALL_VISTA_BUILT_APPS,Releasewb/x64/dell,x64)
	$(call INSTALL_VISTA_BUILT_TTLS,x64/Releasewb/dell,x64)
	$(call INSTALL_VISTA_HSM_BIN,Releasewb/x64,x64)
	# install installer
	$(call INSTALL_INSTALLSHIELD_FILES,dell,free,BCMAppInstaller)
...
# -------------------------------------------------------------------------
# Dell Win8
$(RELEASEDIR)/$(VERSION_NAME)/Dell:     $(RELEASEDIR)/$(VERSION_NAME)/Dell/Dell_DriverOnly \
			     $(RELEASEDIR)/$(VERSION_NAME)/Dell/Dell_InstallShield/Disk1 \
			     $(RELEASEDIR)/$(VERSION_NAME)/Dell/Dell_InstallShield_Driver/Disk1 \
			     $(RELEASEDIR)/$(VERSION_NAME)/DebugSymbols/Dell

# Dell Win8 DriverOnly
$(RELEASEDIR)/$(VERSION_NAME)/Dell/Dell_DriverOnly: FORCE
	@$(MARKSTART)
	mkdir -p $@
	$(call WARN_PARTIAL_BUILD)
	# install driver and its dependent files
	$(INSTALL) $(WIN8X_x86_WLDRIVER) $@
	$(INSTALL) $(WIN8X_x64_WLDRIVER) $@
	$(call INSTALL_INF,$(INF_DIR)/dell/bcmwl63.inf,$@/$(WIN8X_WLINF))
	$(call INSTALL_VISTA32BIT_BUILT_IHV,Releasewb/bcm)
	$(call INSTALL_VISTA64BIT_BUILT_IHV,x64/Releasewb/bcm)
	$(call RELEASE_SIGN_WIN8X_DRIVER,$@,X86)
	$(call RELEASE_SIGN_WIN8X_DRIVER,$@,X64)
	$(call REMOVE_WARN_PARTIAL_BUILD)
	@$(MARKEND)
#	# End of $(RELEASEDIR)/Win8X/Dell/Dell_DriverOnly

# Dell InstallShield DriverOnly for Win8
$(RELEASEDIR)/$(VERSION_NAME)/Dell/Dell_InstallShield_Driver/Disk1: FORCE $(PRE_RELEASE_DEPS_VISTA)
	@$(MARKSTART)
	mkdir -pv $@ $@/Drivers/$(VERSION_NAME)/WL
	mkdir -pv $@/EAP_Plugin_Installer
	mkdir -pv $@/MUI
	...
	$(INSTALL) $(WIN8X_x86_WLDRIVER) $@/Drivers/$(VERSION_NAME)/WL
	$(INSTALL) $(WIN8X_x64_WLDRIVER) $@/Drivers/$(VERSION_NAME)/WL
	$(call INSTALL_INF,$(INF_DIR)/dell/bcmwl63.inf,$@/Drivers/$(VERSION_NAME)/WL/$(WIN8X_WLINF))
	$(call RELEASE_SIGN_WIN8X_DRIVER,$@/Drivers/$(VERSION_NAME)/WL,X86)
	$(call RELEASE_SIGN_WIN8X_DRIVER,$@/Drivers/$(VERSION_NAME)/WL,X64)
	...
	# install installer
	$(call INSTALL_INSTALLSHIELD_FILES,dell,free,BCMAppInstaller)
	$(INSTALL) $(INS_DIR)/ini_win8x/dell/free/driver.ini $@/bcmwlsd.ini
	$(INSTALL) $(INS_DIR)/ini_win8x/dell/free/driver.ini $@/bcmwls.ini
	$(INSTALL) $(INS_DIR)/installshield/BCMAppInstaller/is_bin/dell/Setup_win8x.ini $@/Setup.ini
	unix2dos $@/Setup.ini
	$(INSTALL) $(INS_DIR)/sysinfo/Release/SysInfo.exe $@/
	$(INSTALL) $(INS_DIR)/installshield/dell/DellInfo.exe $@/
	$(INSTALL) $(INS_DIR)/installshield/dell/DellInfo64.exe $@/
	...
	$(INSTALL) src/doc/READMECli_Vista.rtf $@/README.rtf
	$(call REMOVE_WARN_PARTIAL_BUILD)
	$(call PACKAGE_RELEASE,Dell_$(VERSION_NAME))
	@$(MARKEND)

# Dell InstallShield for Win8
$(RELEASEDIR)/$(VERSION_NAME)/Dell/Dell_InstallShield/Disk1: FORCE $(PRE_RELEASE_DEPS_VISTA)
	@$(MARKSTART)
	mkdir -pv $@/{,vs10,vs12,vs13}/x64 $@/Drivers/$(VERSION_NAME)/{WL,VWL}
	mkdir -pv $@/EAP_Plugin_Installer
	mkdir -pv $@/MUI
	$(call WARN_PARTIAL_BUILD)
	$(call INSTALL_AUXAPP_SET1,dell)
	$(call INSTALL_AUXAPP_SET2,dell)
	$(call INSTALL_AUXAPP_SET3,dell)
	$(call INSTALL_COMPONENT_WINIEAPI,generic)
	$(call INSTALL_VISTA32BIT_BUILT_IHV,Releasewb/bcm,Drivers/$(VERSION_NAME)/WL)
	$(call INSTALL_VISTA64BIT_BUILT_IHV,x64/Releasewb/bcm,Drivers/$(VERSION_NAME)/WL)
	# install driver and its dependent files
	...
	# install installer
	$(call INSTALL_INSTALLSHIELD_FILES,dell,free,BCMAppInstaller)
	$(INSTALL) $(INS_DIR)/ini_win8x/dell/free/external.ini $@/bcmwls.ini
	$(INSTALL) $(INS_DIR)/ini_win8x/dell/free/driver.ini $@/bcmwlsd.ini
	$(INSTALL) $(INS_DIR)/installshield/BCMAppInstaller/is_bin/dell/Setup_win8x.ini $@/Setup.ini
	unix2dos $@/Setup.ini
	$(INSTALL) $(INS_DIR)/sysinfo/Release/SysInfo.exe $@/
...
define INTERNAL_RELEASE_ONLY
	@$(MARKSTART)
	mkdir -pv $@/x64
	$(INSTALL) src/doc/BCMLogo.gif $@/
	$(INSTALL) src/wl/exe/Releasewb/wl.exe $@/
	$(call INSTALL_UNSIGNED_DRIVER_CAT,$@)
	$(INSTALL) $($(1)_x86_WLDRIVER) $@/
	$(INSTALL) $(subst .sys,.pdb,$($(1)_x86_WLDRIVER)) $@/free_$(basename $(notdir $($(1)_x86_WLDRIVER))).pdb
	$(INSTALL) $(subst .sys,.map,$($(1)_x86_WLDRIVER)) $@/free_$(basename $(notdir $($(1)_x86_WLDRIVER))).map
	$(INSTALL) $($(1)_x64_WLDRIVER) $@/
	$(INSTALL) $(subst .sys,.pdb,$($(1)_x64_WLDRIVER)) $@/free_$(basename $(notdir $($(1)_x64_WLDRIVER))).pdb
	$(INSTALL) $(subst .sys,.map,$($(1)_x64_WLDRIVER)) $@/free_$(basename $(notdir $($(1)_x64_WLDRIVER))).map
	$(call INSTALL_INF,$(INF_DIR)/bcm/$($(1)_WLINF),$@/)
#vista>	$(INSTALL) src/doc/ReleaseNotesWl.html $@/ReleaseNotes.html
	@$(MARKEND)
#	# End of $(RELEASEDIR)/$(1)/Internal
endef

define INTERNAL_RELEASE_ONLY_PREWIN8
	$(call INSTALL_32BIT_BUILT_COINSTALLER,Release)
	$(call INSTALL_64BIT_BUILT_COINSTALLER,x64/Release)
endef

define INTERNAL_RELEASE_ONLY_MFGTEST
	$(INSTALL) $(subst objfre,objchk,$($(1)_x86_WLDRIVER)) $@/checked_$(basename $(notdir $($(1)_x86_WLDRIVER))).sys
	$(INSTALL) $(subst objfre,objchk,$(subst .sys,.pdb,$($(1)_x86_WLDRIVER))) $@/checked_$(basename $(notdir $($(1)_x86_WLDRIVER))).pdb
	$(INSTALL) $(subst objfre,objchk,$(subst .sys,.map,$($(1)_x86_WLDRIVER))) $@/checked_$(basename $(notdir $($(1)_x86_WLDRIVER))).map
endef

# Internal release for WinVista and Win7, Win8
$(RELEASEDIR)/Win7/Internal: FORCE
	$(call INTERNAL_RELEASE_ONLY,VISTA)
	$(call INTERNAL_RELEASE_ONLY_PREWIN8)
ifneq ($(BCM_MFGTEST),)
	$(call INTERNAL_RELEASE_ONLY_MFGTEST,VISTA)

endif

$(RELEASEDIR)/$(VERSION_NAME)/Internal: FORCE
	$(call INTERNAL_RELEASE_ONLY,WIN8X)
ifneq ($(BCM_MFGTEST),)
	$(call INTERNAL_RELEASE_ONLY_MFGTEST,WIN8X)
endif
...
#pragma runlocal
rundlgtest:
#disabled#	rm -f $(DLGTEST_LOG)
#disabled#	# Dialog testing for WinXP/2k built app objects
#disabled#	-$(MAKE) -C src/tools/locale/dlgtest CONFIG_NAME=Release $@
#disabled#	# Dialog testing for WinVista built app objects
#disabled#	-$(MAKE) -C src/tools/locale/dlgtest CONFIG_NAME=ReleaseUv $@
#disabled#	-$(MAKE) -C src/tools/locale/dlgtest CONFIG_NAME="ReleaseUv/x64" $@
...
.PHONY: build_tryapp build_trayapp_xp2k build_trayapp_vista build_trayapp_vista build_auxiliary_libraries build_driver copy_dongle_images mogrify pre_release release_xp build_include build_dlgtest build_status build_end FORCE
