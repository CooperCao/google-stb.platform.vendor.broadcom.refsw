...
DEFS += BCMWPS BCMWFI BCMVISTAROUTER BCMHSPOTAP
UNDEFS := $(filter-out BCMWPS BCMWFI BCMVISTAROUTER BCMHSPOTAP,$(UNDEFS))
UNDEFS += BCMDBG_ASSERT BCMDBG_MEM BCMDBG_PKT BCMDBG_DUMP BCMDBG_PCI
