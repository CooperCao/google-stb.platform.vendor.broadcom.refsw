...
MAKE_MODE          := unix
NULL               := /dev/null
BRAND              ?= win10_dhdpcie_external_wl
RETRYCMD           ?= $(firstword \
                      $(wildcard \
...
$(RELEASEDIR)/$(VERSION_NAME)/Internal: build FORCE
	...
	$(call INSTALL_DRIVER_FILES, $@/x86/, DRIVER_FILES_NVRAM, Bcm, , $(DRIVER_NAME), inf, wdi_dhd_pcie_free/Win32, Releasew15, map pdb)
	$(call INSTALL_INF_WIN, $@/x86, $(DRIVER_INF), w10dhd, $(NDISVER_WIN10), $(ARCH_WIN32), $(NDISARCH_32), $(DRIVER_NAME))
	$(call CLEAN_INF_WIN, $@/x86, $(DRIVER_INF), w7dhd)
	$(call INSTALL_DRIVER_FILES, $@/x64/, DRIVER_FILES_NVRAM, Bcm, 64, $(DRIVER_NAME), inf, wdi_dhd_pcie_free/x64, x64/Releasew15, map pdb)
	$(call INSTALL_INF_WIN, $@/x64, $(DRIVER_INF), w10dhd, $(NDISVER_WIN10), $(ARCH_WIN64), $(NDISARCH_64), $(DRIVER_NAME))
	$(call CLEAN_INF_WIN, $@/x64, $(DRIVER_INF), w7dhd)
...
$(RELEASEDIR)/$(VERSION_NAME)/Bcm/Bcm_DriverOnly: build FORCE
	...
	mkdir -pv $@
	$(call WARN_PARTIAL_BUILD)
	$(call INSTALL_DRIVER_FILES, $@/x86/, DRIVER_FILES_NVRAM, Bcm, , $(DRIVER_NAME), inf, wdi_dhd_pcie_free/Win32, Releasew15,)
	$(call INSTALL_INF_WIN, $@/x86, $(DRIVER_INF), w10dhd, $(NDISVER_WIN10), $(ARCH_WIN32), $(NDISARCH_32), $(DRIVER_NAME))
	$(call CLEAN_INF_WIN, $@/x86, $(DRIVER_INF), w7dhd, win10dhd)
	$(call INSTALL_DRIVER_FILES, $@/x64/, DRIVER_FILES_NVRAM, Bcm, 64, $(DRIVER_NAME), inf, wdi_dhd_pcie_free/x64, x64/Releasew15,)
	$(call INSTALL_INF_WIN, $@/x64, $(DRIVER_INF), w10dhd, $(NDISVER_WIN10), $(ARCH_WIN64), $(NDISARCH_64), $(DRIVER_NAME))
	$(call CLEAN_INF_WIN, $@/x64, $(DRIVER_INF), w7dhd, win10dhd)
	$(call RELEASE_SIGN_WIN10_DRIVERS, $@/x86, x86, )
	$(call RELEASE_SIGN_WIN10_DRIVERS, $@/x64, X64, )
	$(call REMOVE_WARN_PARTIAL_BUILD)
	@$(MARKEND)
