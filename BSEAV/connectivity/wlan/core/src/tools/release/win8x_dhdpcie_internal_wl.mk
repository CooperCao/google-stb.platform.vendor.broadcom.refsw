...
endef # RELEASE_SIGN_WIN7_DRIVERS
...
$(RELEASEDIR)/$(VERSION_NAME)/checked/DriverOnly: FORCE
	...
	$(call INSTALL_DRIVER_FILES, $@/x86/, DRIVER_FILES_NVRAM, Bcm, , $(DRIVER_NAME), inf, win8x_pcie_checked/Win32, Debugwb, map pdb)
	...
	$(call INSTALL_DRIVER_FILES, $@/x64/, DRIVER_FILES_NVRAM, Bcm, 64, $(DRIVER_NAME), inf, win8x_pcie_checked/x64, x64/Debugwb, map pdb)
