#
# Makefile to build wl.exe with MSbuild
#
VS_VER         ?= 2013
...
$(BUILD_VARIANTS):
	...
	:ec0\n\
	which msbuild.exe\n\
	echo msbuild.exe /p:Configuration='$(CONF)' /p:Platform=%BLDOUTARCH% wl_vs13.vcxproj /fileLoggerParameters:LogFile=$(ACTION)_$(ARCH)_$(CONF).log\n\
	msbuild.exe /p:Configuration=\"$(CONF)\" /p:Platform=%BLDOUTARCH% wl_vs13.vcxproj /fileLoggerParameters:LogFile=$(ACTION)_$(ARCH)_$(CONF).log\n\
