 ...
 *
 * $Id: wltunable_rte_4359c0.h 602345 2015-11-25 17:40:55Z $
 *
...
#define D11CONF3	0	/* should be 0 for D11 Core Rev 59 */
...
#define WLC_MAXTDLS			10		/* Max # of TDLS peer table entries */
#define WLC_MAXTDLS_CONN	1		/* Max # of TDLS links */
#define WLC_TDLS_ENABLE_IN_MIMO_ONLY 1		/* Enable Tdls For MIMO */
...
#define WLC_MAXMODULES	80	/* max #  wlc_module_register() calls */
#endif

#ifndef AIBSS_AMPDU_MAX_MPDU
#define AIBSS_AMPDU_MAX_MPDU	24 /* Max num of MPDU in AMPDU for AIBSS */
#endif
