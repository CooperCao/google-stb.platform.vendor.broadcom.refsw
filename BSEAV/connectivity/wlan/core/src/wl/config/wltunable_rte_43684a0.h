/*
 * Broadcom 802.11 Networking Device Driver Configuration file for 43684a0
 *
 ...
 * $Id$:
 *
 * wl driver tunables for 43684a0 RTE dev
 *
 */
...
#define	D11CONF		0
#define	D11CONF2	0
#define	D11CONF3	0x00000004	/* D11 Core Rev 66 */
#define ACCONF		0
#define ACCONF2		(1<<0)		/* AC-Phy rev 32; (1<<1) Rev 33 */
...
#define MAXSCB		128 /* (WLC_MAXBSSCFG + WLC_MAXDPT + WLC_MAXTDLS), NIC:128 */
#define AIDMAPSZ	32
