...
#ifdef BCMINTDBG
extern int wlc_node_ratesel_scbdump(void *ctx, void *node_ratesel, struct bcmstrbuf *b);
extern int wlc_node_ratesel_get_fixrate(void *ctx, void *node_ratesel, struct bcmstrbuf *b);
extern int wlc_node_ratesel_set_fixrate(void *ctx, void *node_ratesel, int ac, uint8 val);
#endif
