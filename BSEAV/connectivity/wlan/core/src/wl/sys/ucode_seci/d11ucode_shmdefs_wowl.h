 ...
 *
 * Ucode directory: ../
 * Derived from major_rev = 1202, minor_rev = 224
 *
 ...
 *
 * $Id: /projects/hnd_video6/samat/ucode_git_checkin/refsw/ucode_git_baseline/ucode_seci/d11ucode_shmdefs_wowl.h Oct. 13, 2017 11:21:49 AM <ss888415> $
 */
// COMMON SHMS
//REVID Specific SHMs
#if (D11_REV == 12)
...
#define	M_PMQCTLWD	(M_PSM_SOFT_REGS+(0x16*2))
#define	M_PMQCTLWD_OFFSET	(0x16*2)
#define	M_WOWL_KEEP_TSF	(M_PSM_SOFT_REGS+(0x17*2))
#define	M_WOWL_KEEP_TSF_OFFSET	(0x17*2)
...
#define	M_TXBCNFRM_CNT	(M_PSM2HOST_STATS+(0x5*2))
#define	M_TXBCNFRM_CNT_OFFSET	(0x5*2)
#define	M_TXNDPFRM_CNT	(M_PSM2HOST_STATS+(0xa*2))
#define	M_TXNDPFRM_CNT_OFFSET	(0xa*2)
#define	M_TXPSPFRM_CNT	(M_PSM2HOST_STATS+(0xb*2))
#define	M_TXPSPFRM_CNT_OFFSET	(0xb*2)
#define	M_TXGTKMSG2_CNT	(M_PSM2HOST_STATS+(0xc*2))
#define	M_TXGTKMSG2_CNT_OFFSET	(0xc*2)
...
#define	M_PHY_SAMPLECMD	(0xcd9*2)
...
#define	M_SR_BRWK_REGS	(M_CRX_BLK+(0x0*2))
#define	M_SR_BRWK_REGS_OFFSET	(0x0*2)
#define	M_PHY_SAMPLECMD	(0xc79*2)
#define	M_RXENSTAT_FLAG	(M_RXENSTAT_BLK+(0x0*2))
#define	M_RXENSTAT_FLAG_OFFSET	(0x0*2)
#define	M_RXENSTAT_NOSEC	(M_RXENSTAT_BLK+(0x1*2))
#define	M_RXENSTAT_NOSEC_OFFSET	(0x1*2)
...
#define	M_TSCPN_BLK	(0x484*2)
#define	M_TSCPN_BLK_SIZE	240
#define	M_MDNSPAT_NUM	(0x574*2)
#define	M_MDNS_PAT_BLK	(0x576*2)
#define	M_MDNS_PAT_BLK_SIZE	148
#define	M_RATE_TABLE_A	(0x60a*2)
#define	M_RATE_TABLE_A_SIZE	88
#define	M_RATE_TABLE_B	(0x662*2)
#define	M_RATE_TABLE_B_SIZE	56
#define	M_RATE_TABLE_N	(0x69a*2)
#define	M_RATE_TABLE_N_SIZE	30
#define	M_RATE_IDX_A	(0x6b8*2)
#define	M_RATE_IDX_A_SIZE	8
#define	M_TKMICKEYS_BLK	(0x6c0*2)
#define	M_TKMICKEYS_BLK_SIZE	96
#define	M_TKIP_WEPSEED	(0x720*2)
#define	M_TKIP_WEPSEED_SIZE	8
#define	M_CTX_BLKS	(0x728*2)
#define	M_CTX_BLKS_SIZE	32
#define	M_CRX_BLK	(0x748*2)
#define	M_CRX_BLK_SIZE	16
#define	M_RXFRM_BLK	(0x758*2)
#define	M_RXFRM_BLK_SIZE	768
#define	M_TXFRM_HDR	(0xa58*2)
#define	M_TXFRM_HDR_SIZE	182
#define	M_TPL_DTIM	(0xb0e*2)
#define	M_TPL_DTIM_SIZE	2
#define	M_BA_BITMAP	(0xb10*2)
#define	M_BA_BITMAP_SIZE	4
#define	M_MBS_LGCYPRS_LEN_BLK	(0xb14*2)
#define	M_MBS_LGCYPRS_LEN_BLK_SIZE	16
#define	M_ANT2x3GPIO_BLK	(0xb24*2)
#define	M_ANT2x3GPIO_BLK_SIZE	2
#define	M_USEQ_PWRUP_BLK	(0xb28*2)
#define	M_USEQ_PWRUP_BLK_SIZE	120
#define	M_USEQ_PWRDN_BLK	(0xba0*2)
#define	M_USEQ_PWRDN_BLK_SIZE	80
#define	M_TXERRADDR_BLK	(0xbf0*2)
#define	M_TXERRADDR_BLK_SIZE	4
#define	M_AMT_INFO_BLK	(0xbf4*2)
#define	M_AMT_INFO_BLK_SIZE	64
#define	M_SLOWTIMER_L	(0x575*2)
#define	M_SLOWTIMER_H	(0xb26*2)
#define	M_RSP_FRMTYPE	(0xb27*2)
#define	M_PRSRETX_CNT	(0xc34*2)
#define	M_ALT_CTX	(0xc35*2)
#define	M_ALT_TXFINDX	(0xc36*2)
#define	M_IVLOC	(0xc37*2)
#define	M_JSSI_TSTAMP	(0xc38*2)
#define	M_TXCRSEND_TSTAMP	(0xc39*2)
#define	M_CCA_TSF0	(0xc3a*2)
#define	M_CCA_TSF1	(0xc3b*2)
#define	M_TXPWR_RTADJ	(0xc3c*2)
#define	M_GOOD_RXANT	(0xc3d*2)
#define	M_CUR_RXF_INDEX	(0xc3e*2)
#define	M_BYTES_LEFT	(0xc3f*2)
#define	M_FRM_SOFAR	(0xc40*2)
#define	M_MM_XTRADUR	(0xc41*2)
#define	M_HANGTM	(0xc42*2)
#define	M_PR80959	(M_HANGTM+(0x0*2))
#define	M_PR80959_OFFSET	(0x0*2)
#define	M_PHYWATCH_TSTAMP	(0xc43*2)
#define	M_NUMMPDU	(0xc44*2)
#define	M_CURR_ANTPAT	(0xc45*2)
#define	M_TSFTMRVALTMP_WD3	(0xc46*2)
#define	M_TSFTMRVALTMP_WD2	(0xc47*2)
#define	M_TSFTMRVALTMP_WD1	(0xc48*2)
#define	M_TSFTMRVALTMP_WD0	(0xc49*2)
#define	M_LBCN_CNT	(0xc4a*2)
#define	M_MPDUNUM_LEFT	(0xc4b*2)
#define	M_SLEEP_TIME_L	(0xc4c*2)
#define	M_SLEEP_TIME_ML	(0xc4d*2)
#define	M_WOWL_LASTBCN_L	(0xc4e*2)
#define	M_WOWL_LASTBCN_ML	(0xc4f*2)
#define	M_BCN_TSF_L	(0xc50*2)
#define	M_BCN_TSF_ML	(0xc51*2)
#define	M_BCN_TSF_MU	(0xc52*2)
#define	M_BCN_TSF_H	(0xc53*2)
#define	M_WOWL_LASTWORD	(0xc54*2)
#define	M_FWMATCH	(0xc55*2)
#define	M_MD5_XWORD0	(0xc56*2)
#define	M_MD5_XWORD1	(0xc57*2)
#define	M_MD5_YWORD0	(0xc58*2)
#define	M_MD5_YWORD1	(0xc59*2)
#define	M_MD5_ZWORD0	(0xc5a*2)
#define	M_MD5_ZWORD1	(0xc5b*2)
#define	M_WOWL_MSGLEN	(0xc5c*2)
#define	M_RESMSGLEN	(0xc5d*2)
#define	M_L0_BUFFER	(0xc5e*2)
#define	M_L1_BUFFER	(0xc5f*2)
#define	M_R0_BUFFER	(0xc60*2)
#define	M_R1_BUFFER	(0xc61*2)
#define	M_WOWLTCLFLAG_BLK	(0xc64*2)
#define	M_WOWLTCLFLAG_BLK_SIZE	3
#define	M_RXANTPAT_BLK	(0xc62*2)
#define	M_PREPAYLOAD_BLK	(0xc68*2)
#define	M_PREPAYLOAD_BLK_SIZE	8
#define	M_TKIP_POSTPAYLOAD_BLK	(0xc70*2)
#define	M_TKIP_POSTPAYLOAD_BLK_SIZE	4
#define	M_ABCDBUF_BLK	(0xc74*2)
#define	M_ABCDBUF_BLK_SIZE	20
#define	M_SIPARAMS_BLK	(0xc88*2)
#define	M_SIPARAMS_BLK_SIZE	64
#define	M_WOWL_OFFLOADCFG_BASE	(0xcc8*2)
#define	M_WOWL_OFFLOADCFG_BASE_SIZE	18
#define	M_ARPOFFLOAD_CACHE	(0xcda*2)
#define	M_ARPOFFLOAD_CACHE_SIZE	12
#define	M_PHY_ANTDIV_REG	(0xc63*2)
#define	M_PHY_ANTDIV_MASK	(0xc67*2)
#define	M_PHY_EXTLNA_OVR	(0xce6*2)
#define	M_PHY_PLCPRX_DURATION	(0xce7*2)
#define	M_CTS_STRT_TIME	(0xce8*2)
#define	M_HANGTM_H	(0xce9*2)
#define	M_CRSHRXFRMHRST_CNT	(0xcea*2)
#define	M_RXENSTAT_BLK	(0xcec*2)
#define	M_RXENSTAT_BLK_SIZE	10
#define	M_RXCNT	(0xceb*2)
#define	M_WOWL_TXBITMAP	(0xcf6*2)
#define	M_WOWL_CURRTX	(0xcf7*2)
#define	M_WOWL_CURRTXLEN	(0xcf8*2)
#define	M_WOWL_CURRTXADDR	(0xcf9*2)
#define	M_WOWL_OFFLOAD_TXCTR	(0xcfa*2)
#define	M_WOWL_MICOFFSET	(0xcfb*2)
#define	M_KEEPALIVE_CURRCTR_0	(0xcfc*2)
#define	M_KEEPALIVE_CURRCTR_1	(0xcfd*2)
#define	M_NA_CKSUM_L	(0xcfe*2)
#define	M_GTK_KDVER	(0xcff*2)
#define	M_LNA_STATE	(0xd00*2)
#define	M_LASTTX_TSF	(0xd01*2)
#define	M_TKIP_TMP_TTAK	(M_CTX_BLKS+(0x0*2))
#define	M_TKIP_TMP_TTAK_OFFSET	(0x0*2)
#define	M_TXFRM_BLK	(M_RXFRM_BLK+(0x80*2))
#define	M_TXFRM_BLK_OFFSET	(0x80*2)
...
#define	M_KEYUNWRAP_DONE	(M_RXFRM_BLK+(0x28a*2))
#define	M_KEYUNWRAP_DONE_OFFSET	(0x28a*2)
#define	M_PWR_UD_BLK	(0xd02*2)
#define	M_PWR_UD_BLK_SIZE	10
#define	M_TSF_ACTV_L	(0xd0c*2)
#define	M_TSF_ACTV_H	(0xd0d*2)
#define	M_BOM_REV_MAJOR	(M_PSM_SOFT_REGS+(0x0*2))
#define	M_BOM_REV_MAJOR_OFFSET	(0x0*2)
#define	M_BOM_REV_MINOR	(M_PSM_SOFT_REGS+(0x1*2))
#define	M_BOM_REV_MINOR_OFFSET	(0x1*2)
...
#define	M_HOST_FLAGS5	(M_PSM_SOFT_REGS+(0x3d*2))
#define	M_HOST_FLAGS5_OFFSET	(0x3d*2)
#define	M_MDNS_FLAG	(M_PSM_SOFT_REGS+(0x3e*2))
#define	M_MDNS_FLAG_OFFSET	(0x3e*2)
#define	M_NETPAT_BLK_PTR	(M_PSM_SOFT_REGS+(0x3f*2))
#define	M_NETPAT_BLK_PTR_OFFSET	(0x3f*2)
#define	M_MBURST_SIZE	(M_PSM_SOFT_REGS+(0x40*2))
#define	M_MBURST_SIZE_OFFSET	(0x40*2)
...
#define	M_NETPAT_BLK3	(M_NETPAT_BLK+(0xde*2))
#define	M_NETPAT_BLK3_OFFSET	(0xde*2)
#define	M_MDNSPAT_BLK0	(M_MDNS_PAT_BLK+(0x0*2))
#define	M_MDNSPAT_BLK0_OFFSET	(0x0*2)
#define	M_MDNSPAT_BLK1	(M_MDNS_PAT_BLK+(0x4a*2))
#define	M_MDNSPAT_BLK1_OFFSET	(0x4a*2)
#define	M_RXFRM_SRA0	(M_SMACADDR_BLK+(0x0*2))
#define	M_RXFRM_SRA0_OFFSET	(0x0*2)
#define	M_RXFRM_SRA1	(M_SMACADDR_BLK+(0x1*2))
#define	M_RXFRM_SRA1_OFFSET	(0x1*2)
...
#define	M_SR_BRWK_REGS	(M_CRX_BLK+(0x0*2))
#define	M_SR_BRWK_REGS_OFFSET	(0x0*2)
#define	M_PHY_SAMPLECMD	(0xd0e*2)
#define	M_RXENSTAT_FLAG	(M_RXENSTAT_BLK+(0x0*2))
#define	M_RXENSTAT_FLAG_OFFSET	(0x0*2)
#define	M_RXENSTAT_NOSEC	(M_RXENSTAT_BLK+(0x1*2))
#define	M_RXENSTAT_NOSEC_OFFSET	(0x1*2)
