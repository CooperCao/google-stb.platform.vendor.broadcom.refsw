...
typedef void (*bcm_p2p_disc_cb_t)(void *ctx);
...
bool bcm_p2p_is_listening(bcm_p2p_disc_t *disc);
void bcm_p2p_ext_listen_count_callback(bcm_p2p_disc_t *disc, bcm_p2p_disc_cb_t fn, void *p2po);
