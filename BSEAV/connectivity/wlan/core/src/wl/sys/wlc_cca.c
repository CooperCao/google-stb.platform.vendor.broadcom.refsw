...
BCMATTACHFN(wlc_cca_attach)(wlc_info_t *wlc)
{
	...
	static const chanspec_t chanlist[CCA_CHANNELS_NUM] = {
		0x1001, 0x1002, 0x1003, 0x1004, 0x1005, 0x1006,			/*   1 - 6   */
		0x1007, 0x1008, 0x1009, 0x100a, 0x100b, 0x100c, 0x100d, 0x100e, /*   7 - 14  */
