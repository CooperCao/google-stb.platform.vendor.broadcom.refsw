...
static const bcm_iovar_t wlc_pm_mute_tx_iovars[] = {
	...
	(IOVF_SET_UP | IOVF_BSSCFG_STA_ONLY), 0, IOVT_BUFFER, sizeof(wl_pm_mute_tx_t)
	},
	{NULL, 0, 0, 0, 0, 0}
};
...
static int wlc_pm_mute_tx_doiovar(void *ctx, uint32 actionid,
...
static int
wlc_pm_mute_tx_doiovar(void *ctx, uint32 actionid,
