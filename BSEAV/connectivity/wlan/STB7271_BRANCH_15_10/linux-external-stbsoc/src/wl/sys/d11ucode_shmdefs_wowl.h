 ...
 *
 * $Id: /projects/hnd_video6/ytpark/git_refsw/refsw/wlan_ucode_repo_local_b/result/d11ucode_shmdefs_wowl.h Mar. 17, 2017 10:20:08 AM <ytpark> $
 */
// COMMON SHMS
//REVID Specific SHMs
#if (D11_REV == 12)
...
#define	M_WAPI_MICKEYS_BLK_SIZE	64
#define	M_RXENSTAT_BLK	(0xbc6*2)
#define	M_RXENSTAT_BLK_SIZE	10
#define	M_RXCNT	(0xbd0*2)
#define	M_WOWL_TXBITMAP	(0xbd1*2)
#define	M_WOWL_CURRTX	(0xbd2*2)
#define	M_WOWL_CURRTXLEN	(0xbd3*2)
#define	M_WOWL_CURRTXADDR	(0xbd4*2)
#define	M_WOWL_OFFLOAD_TXCTR	(0xbd5*2)
#define	M_WOWL_MICOFFSET	(0xbd6*2)
#define	M_KEEPALIVE_CURRCTR_0	(0xbd7*2)
#define	M_KEEPALIVE_CURRCTR_1	(0xbd8*2)
#define	M_NA_CKSUM_L	(0xbd9*2)
#define	M_GTK_KDVER	(0xbda*2)
#define	M_LNA_STATE	(0xbdb*2)
#define	M_LASTTX_TSF	(0xbdc*2)
#define	M_TKIP_TMP_TTAK	(M_CTX_BLKS+(0x0*2))
#define	M_TKIP_TMP_TTAK_OFFSET	(0x0*2)
#define	M_TXFRM_BLK	(M_RXFRM_BLK+(0x80*2))
#define	M_TXFRM_BLK_OFFSET	(0x80*2)
...
#define	M_KEYUNWRAP_DONE	(M_RXFRM_BLK+(0x28a*2))
#define	M_KEYUNWRAP_DONE_OFFSET	(0x28a*2)
#define	M_PWR_UD_BLK	(0xbdd*2)
#define	M_PWR_UD_BLK_SIZE	10
#define	M_TSF_ACTV_L	(0xbe7*2)
#define	M_TSF_ACTV_H	(0xbe8*2)
#define	M_BOM_REV_MAJOR	(M_PSM_SOFT_REGS+(0x0*2))
#define	M_BOM_REV_MAJOR_OFFSET	(0x0*2)
#define	M_BOM_REV_MINOR	(M_PSM_SOFT_REGS+(0x1*2))
#define	M_BOM_REV_MINOR_OFFSET	(0x1*2)
...
#define	M_PHY_SAMPLECMD	(0xbe9*2)
...
#define	M_TSF_ACTV_L	(0xbe7*2)
#define	M_TSF_ACTV_H	(0xbe8*2)
#define	M_SAVERESTORE_4335_BLK	(0xbea*2)
...
#define	M_RATE_IDX_A_SIZE	8
#define	M_TKIP_WEPSEED	(0x53a*2)
#define	M_TKIP_WEPSEED_SIZE	8
#define	M_CTX_BLKS	(0x544*2)
#define	M_CTX_BLKS_SIZE	32
#define	M_CRX_BLK	(0x564*2)
#define	M_CRX_BLK_SIZE	16
#define	M_RXFRM_BLK	(0x574*2)
#define	M_RXFRM_BLK_SIZE	768
#define	M_TXFRM_HDR	(0x874*2)
#define	M_TXFRM_HDR_SIZE	182
#define	M_TPL_DTIM	(0x542*2)
#define	M_TPL_DTIM_SIZE	2
#define	M_BA_BITMAP	(0x92a*2)
#define	M_BA_BITMAP_SIZE	4
#define	M_MBS_LGCYPRS_LEN_BLK	(0x92e*2)
#define	M_MBS_LGCYPRS_LEN_BLK_SIZE	16
#define	M_ANT2x3GPIO_BLK	(0x93e*2)
#define	M_ANT2x3GPIO_BLK_SIZE	2
#define	M_USEQ_PWRUP_BLK	(0x940*2)
#define	M_USEQ_PWRUP_BLK_SIZE	120
#define	M_USEQ_PWRDN_BLK	(0x9b8*2)
#define	M_USEQ_PWRDN_BLK_SIZE	80
#define	M_TXERRADDR_BLK	(0xa08*2)
#define	M_TXERRADDR_BLK_SIZE	4
#define	M_AMT_INFO_BLK	(0xa0c*2)
#define	M_AMT_INFO_BLK_SIZE	64
#define	M_SLOWTIMER_L	(0xa4c*2)
#define	M_SLOWTIMER_H	(0xa4d*2)
#define	M_RSP_FRMTYPE	(0xa4e*2)
#define	M_PRSRETX_CNT	(0xa4f*2)
#define	M_ALT_CTX	(0xa50*2)
#define	M_ALT_TXFINDX	(0xa51*2)
#define	M_IVLOC	(0xa52*2)
#define	M_JSSI_TSTAMP	(0xa53*2)
#define	M_TXCRSEND_TSTAMP	(0xa54*2)
#define	M_CCA_TSF0	(0xa55*2)
#define	M_CCA_TSF1	(0xa56*2)
#define	M_TXPWR_RTADJ	(0xa57*2)
#define	M_GOOD_RXANT	(0xa58*2)
#define	M_CUR_RXF_INDEX	(0xa59*2)
#define	M_BYTES_LEFT	(0xa5a*2)
#define	M_FRM_SOFAR	(0xa5b*2)
#define	M_MM_XTRADUR	(0xa5c*2)
#define	M_HANGTM	(0xa5d*2)
#define	M_PR80959	(M_HANGTM+(0x0*2))
#define	M_PR80959_OFFSET	(0x0*2)
#define	M_PHYWATCH_TSTAMP	(0xa5e*2)
#define	M_NUMMPDU	(0xa5f*2)
#define	M_CURR_ANTPAT	(0xa60*2)
#define	M_TSFTMRVALTMP_WD3	(0xa61*2)
#define	M_TSFTMRVALTMP_WD2	(0xa62*2)
#define	M_TSFTMRVALTMP_WD1	(0xa63*2)
#define	M_TSFTMRVALTMP_WD0	(0xa64*2)
#define	M_LBCN_CNT	(0xa65*2)
#define	M_MPDUNUM_LEFT	(0xa66*2)
#define	M_SLEEP_TIME_L	(0xa67*2)
#define	M_SLEEP_TIME_ML	(0xa68*2)
#define	M_WOWL_LASTBCN_L	(0xa69*2)
#define	M_WOWL_LASTBCN_ML	(0xa6a*2)
#define	M_BCN_TSF_L	(0xa6b*2)
#define	M_BCN_TSF_ML	(0xa6c*2)
#define	M_BCN_TSF_MU	(0xa6d*2)
#define	M_BCN_TSF_H	(0xa6e*2)
#define	M_WOWL_LASTWORD	(0xa6f*2)
#define	M_FWMATCH	(0xa70*2)
#define	M_MD5_XWORD0	(0xa71*2)
#define	M_MD5_XWORD1	(0xa72*2)
#define	M_MD5_YWORD0	(0xa73*2)
#define	M_MD5_YWORD1	(0xa74*2)
#define	M_MD5_ZWORD0	(0xa75*2)
#define	M_MD5_ZWORD1	(0xa76*2)
#define	M_WOWL_MSGLEN	(0xa77*2)
#define	M_RESMSGLEN	(0xa78*2)
#define	M_L0_BUFFER	(0xa79*2)
#define	M_L1_BUFFER	(0xa7a*2)
#define	M_R0_BUFFER	(0xa7b*2)
#define	M_R1_BUFFER	(0xa7c*2)
#define	M_WOWLTCLFLAG_BLK	(0xa80*2)
#define	M_WOWLTCLFLAG_BLK_SIZE	3
#define	M_RXANTPAT_BLK	(0xa7d*2)
#define	M_PREPAYLOAD_BLK	(0xa84*2)
#define	M_PREPAYLOAD_BLK_SIZE	8
#define	M_TKIP_POSTPAYLOAD_BLK	(0xa8c*2)
#define	M_TKIP_POSTPAYLOAD_BLK_SIZE	4
#define	M_ABCDBUF_BLK	(0xa90*2)
#define	M_ABCDBUF_BLK_SIZE	20
#define	M_SIPARAMS_BLK	(0xaa4*2)
#define	M_SIPARAMS_BLK_SIZE	64
#define	M_WOWL_OFFLOADCFG_BASE	(0xae4*2)
#define	M_WOWL_OFFLOADCFG_BASE_SIZE	18
#define	M_ARPOFFLOAD_CACHE	(0xaf6*2)
#define	M_ARPOFFLOAD_CACHE_SIZE	12
#define	M_PHY_ANTDIV_REG	(0xa7e*2)
#define	M_PHY_ANTDIV_MASK	(0xa7f*2)
#define	M_PHY_EXTLNA_OVR	(0xa83*2)
#define	M_PHY_PLCPRX_DURATION	(0xb02*2)
#define	M_CTS_STRT_TIME	(0xb03*2)
#define	M_HANGTM_H	(0xb04*2)
#define	M_CRSHRXFRMHRST_CNT	(0xb05*2)
#define	M_RXENSTAT_BLK	(0xb06*2)
#define	M_RXENSTAT_BLK_SIZE	10
#define	M_RXCNT	(0xb10*2)
#define	M_WOWL_TXBITMAP	(0xb11*2)
#define	M_WOWL_CURRTX	(0xb12*2)
#define	M_WOWL_CURRTXLEN	(0xb13*2)
#define	M_WOWL_CURRTXADDR	(0xb14*2)
#define	M_WOWL_OFFLOAD_TXCTR	(0xb15*2)
#define	M_WOWL_MICOFFSET	(0xb16*2)
#define	M_KEEPALIVE_CURRCTR_0	(0xb17*2)
#define	M_KEEPALIVE_CURRCTR_1	(0xb18*2)
#define	M_NA_CKSUM_L	(0xb19*2)
#define	M_GTK_KDVER	(0xb1a*2)
#define	M_LNA_STATE	(0xb1b*2)
#define	M_LASTTX_TSF	(0xb1c*2)
#define	M_TKIP_TMP_TTAK	(M_CTX_BLKS+(0x0*2))
#define	M_TKIP_TMP_TTAK_OFFSET	(0x0*2)
#define	M_TXFRM_BLK	(M_RXFRM_BLK+(0x80*2))
#define	M_TXFRM_BLK_OFFSET	(0x80*2)
...
#define	M_KEYUNWRAP_DONE	(M_RXFRM_BLK+(0x28a*2))
#define	M_KEYUNWRAP_DONE_OFFSET	(0x28a*2)
#define	M_PWR_UD_BLK	(0xb1d*2)
#define	M_PWR_UD_BLK_SIZE	10
#define	M_TSF_ACTV_L	(0xb27*2)
#define	M_TSF_ACTV_H	(0xb28*2)
#define	M_BOM_REV_MAJOR	(M_PSM_SOFT_REGS+(0x0*2))
#define	M_BOM_REV_MAJOR_OFFSET	(0x0*2)
#define	M_BOM_REV_MINOR	(M_PSM_SOFT_REGS+(0x1*2))
#define	M_BOM_REV_MINOR_OFFSET	(0x1*2)
...
#define	M_SR_BRWK_REGS	(M_CRX_BLK+(0x0*2))
#define	M_SR_BRWK_REGS_OFFSET	(0x0*2)
#define	M_PHY_SAMPLECMD	(0xb29*2)
#define	M_RXENSTAT_FLAG	(M_RXENSTAT_BLK+(0x0*2))
#define	M_RXENSTAT_FLAG_OFFSET	(0x0*2)
#define	M_RXENSTAT_NOSEC	(M_RXENSTAT_BLK+(0x1*2))
#define	M_RXENSTAT_NOSEC_OFFSET	(0x1*2)
