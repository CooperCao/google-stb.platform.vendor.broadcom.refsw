...
#ifdef NDIS
			eventlen = sizeof(wl_invalid_ie_event_t) + sizeof(dot11_power_cnst_t);
			wrong_ie_event = (wl_invalid_ie_event_t *)MALLOC(wlc->osh, eventlen);
...
#ifdef NDIS
			MFREE(wlc->osh, wrong_ie_event, eventlen);
