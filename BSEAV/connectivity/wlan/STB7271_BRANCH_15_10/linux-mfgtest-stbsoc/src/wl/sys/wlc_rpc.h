...
#define RPC_ID_TABLE { \
	...
	NAME_ENTRY(WLRPC_WLC_PHY_MU_GROUP_SET_ID),	\
	NAME_ENTRY(WLRPC_WLC_PHY_MIN_TXPWR_LIMIT_GET_ID),	\
	NAME_ENTRY(WLRPC_WLC_AMPDU_SIDECHANNEL_INIT),	\
	NAME_ENTRY(WLRPC_WLC_PHY_PREV_CHANSPEC_ID), \
