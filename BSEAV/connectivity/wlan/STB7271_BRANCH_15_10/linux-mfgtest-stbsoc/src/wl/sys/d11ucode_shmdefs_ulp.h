 ...
 *
 * $Id: /projects/hnd_video6/samat/ucode_git/refsw/ucode_branch/result/d11ucode_shmdefs_ulp.h Mar. 06, 2017 03:23:29 PM <ss888415> $
 */
// COMMON SHMS
//REVID Specific SHMs
#if (D11_REV == 46)
...
#define	M_ONE_TIME_CFG_BM	(0xa9f*2)
#define	M_DSX_TST_MODE	(0xaa0*2)
#define	M_FRRUN_LBCN_CNT	(0xaa1*2)
#define	M_DS1_KA_CFG	(0xaa2*2)
#define	M_DS1_KA_CTR	(0xaa3*2)
#define	M_DS1_KA_NUM	(0xaa4*2)
#define	M_DS1_KA_IPG	(0xaa5*2)
#define	M_AWK_RSN_CD	(0xaa6*2)
#define	M_AWK_RSN_CTRL	(0xaa7*2)
#define	M_PHY_SAMPLECMD	(0xaa8*2)
#endif /* (D11_REV == 46) */
#if (D11_REV == 60)
#define	M_PSM_SOFT_REGS	(0x0*2)
#define	M_PSM_SOFT_REGS_SIZE	112
...
#define	M_WAKEPULSE_TRH	(M_WAKEPULSE_DURN_BLK+(0x3*2))
#define	M_WAKEPULSE_TRH_OFFSET	(0x3*2)
#define	M_SR_TBTT_L	(0xaa4*2)
#define	M_SR_TBTT_H	(0xaa5*2)
#define	M_RXBCN_BMPCTL	(M_IVLOC+(0x0*2))
#define	M_RXBCN_BMPCTL_OFFSET	(0x0*2)
#define	M_SLP_TIMEOUT	(M_PSM_SOFT_REGS_EXT+(0x18*2))
#define	M_SLP_TIMEOUT_OFFSET	(0x18*2)
...
#define	M_DRVR_UCODE_IF_BLK	(0xaac*2)
...
#define	M_TSF_ADJ_GTS_TSFTMR_WD0	(0xd85*2)
#define	M_TSF_ADJ_GTS_TSFTMR_WD1	(0xd9a*2)
#define	M_TSF_ADJ_GTS_TSFTMR_WD2	(0xd9b*2)
#define	M_TSF_ADJ_GTS_TSFTMR_WD3	(0xd9c*2)
#define	M_TSF_ADJ_OFFSET_TIMER	(0xd9d*2)
#define	M_TSF_ADJ_GTS_SLOW_TMR_L	(0xd9e*2)
#define	M_TSF_ADJ_GTS_SLOW_TMR_H	(0xd9f*2)
#define	M_TSF_ADJ_OFFSET_PER	(0xda0*2)
#define	M_BCNTRIM_DBG_BLK	(0xda2*2)
...
#define	M_SMPL_COL_BMP	(0xda1*2)
#define	M_SMPL_COL_CTL	(0xdae*2)
#define	M_SLOW_CTL_SR	(0xdaf*2)
#define	M_PMU_FCBS_BLK	(0xdb0*2)
...
#define	M_DS1_SCR_SAVE_BLK	(0xdc6*2)
#define	M_DS1_SCR_SAVE_BLK_SIZE	64
#define	M_NON_FCBS_EXIT_DEBUG	(0xdc5*2)
#define	M_NON_FCBS_EXIT_DEBUG_CMD_PTR	(0xe06*2)
#define	M_NON_FCBS_EXIT_DEBUG_DAT_PTR	(0xe07*2)
#define	M_FCBS_EXIT_DEBUG	(0xe08*2)
#define	M_FCBS_EXIT_DEBUG_CMD_PTR	(0xe09*2)
#define	M_FCBS_EXIT_DEBUG_DAT_PTR	(0xe0a*2)
#define	M_PHY_RXFECTRL1	(M_CRX_BLK+(0xf*2))
#define	M_PHY_RXFECTRL1_OFFSET	(0xf*2)
#define	M_SR_BRWK_REGS	(M_CRX_BLK+(0x0*2))
#define	M_SR_BRWK_REGS_OFFSET	(0x0*2)
#define	M_ONE_TIME_CFG_BM	(0xe0b*2)
#define	M_DSX_TST_MODE	(0xe0c*2)
#define	M_FRRUN_LBCN_CNT	(0xe0d*2)
#define	M_DS1_KA_CFG	(0xe0e*2)
#define	M_DS1_KA_CTR	(0xe0f*2)
#define	M_DS1_KA_NUM	(0xe10*2)
#define	M_DS1_KA_IPG	(0xe11*2)
#define	M_DS1_CTRL_STATUS	(0xe12*2)
#define	M_DS1_CTRL_SDIO	(0xe13*2)
#define	M_DS1_CTRL_SDIO_OOB_H	(0xe14*2)
#define	M_DS1_CTRL_SDIO_OOB_L	(0xe15*2)
#define	M_DS1_CTRL_SDIO_OOBTH	(0xe16*2)
#define	M_DS1_CTRL_JTAG	(0xe17*2)
#define	M_DS1_CTRL_JTAG_OOB_H	(0xe18*2)
#define	M_DS1_CTRL_JTAG_OOB_L	(0xe19*2)
#define	M_DS1_CTRL_JTAG_OOBTH	(0xe1a*2)
#define	M_DS1_CTRL_SDIO_PIN	(0xe1b*2)
#define	M_DS1_CTRL_JTAG_PIN	(0xe1c*2)
#define	M_DS1_CTRL_FUNCAL	(0xe1d*2)
#define	M_DS1_ENTER_OOBJ	(0xe1e*2)
#define	M_DS1_DIS_OOBJ	(0xe1f*2)
#define	M_HUDI_DS1SLP_CTR	(0xe20*2)
#define	M_JTAG_DS1SLP_CTR	(0xe21*2)
#define	M_HUDI_MNPOLL_CTR	(0xe22*2)
#define	M_HUDI_PM_CTR	(0xe23*2)
#define	M_HUDI_NO_ACTION	(0xe24*2)
...
#define	M_AWK_RSN_CD	(0xe25*2)
#define	M_AWK_RSN_CTRL	(0xe26*2)
#define	M_SLP_ACT_TSF_L	(0xe27*2)
#define	M_SLP_ACT_TSF_ML	(0xe28*2)
#define	M_PSM_LOGGER_BLK	(0xe2c*2)
...
#define	M_PM_DEBUG_BLK	(0xe34*2)
#define	M_PM_DEBUG_BLK_SIZE	60
#define	M_PHY_SAMPLECMD	(0xe29*2)
#endif /* (D11_REV == 60) */
#if (D11_REV == 62)
#define	M_PSM_SOFT_REGS	(0x0*2)
#define	M_PSM_SOFT_REGS_SIZE	112
