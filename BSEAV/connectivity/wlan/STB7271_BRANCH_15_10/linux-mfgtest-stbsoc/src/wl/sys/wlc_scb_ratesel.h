...
extern bool wlc_scb_ratesel_hit_txaggthreshold(wlc_ratesel_info_t *wrsi, struct scb *scb);
extern int wlc_scb_ratesel_calc_txaggthreshold(wlc_ratesel_info_t *wrsi, struct scb *scb);
#endif /* WL_FRAGDUR */
