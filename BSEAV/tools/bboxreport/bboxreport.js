...
{
    var debug=0;
    var obj = document.getElementById('COMPLETION_PCT');
    if(obj)
    {
        // update progress bar
        obj.innerHTML = "&nbsp;&nbsp&nbsp;(Completion: " + percentage + "%)";
    }
    else
    {
...
function last_boxmode_received()
{
    ...
    UpdateInnerHTML ( 'COMPLETION_PCT', "");
...
function UpdateInnerHTML( elementid, newhtml )
{
    var obj = document.getElementById(elementid);
    if ( obj ) obj.innerHTML = newhtml;
    return true;
}
        ...
        if (xmlhttp.status == 200)
        {
            ...
            for (var i = 0; i < oResponses.length; i++)
            {
                ...
                if ( oResponses.length == 1 &&  xmlhttp.responseText.length == 0 ) {
                    ...
                    boxmodeTableHtml += "<tr><td class=border align=center >" + boxmodes[boxmodesIdx-1] +
                        "</td><td class=border align=left colspan=9 >Bad response; CGI may have crashed.</td></tr>";
                ...
                if (entry == "STBTIME") {
                    ...
                    //alert("percentComplete:" + percentComplete );
                    boxmodeTableHtml += "<tr><td class=border align=center >" + boxmodes[boxmodesIdx-1] +
                        "</td><td class=border align=left colspan=9 >Fatal error returned from device.</td></tr>";
                    i++;
                } else if (entry == "ALERT") {
                    ...
                    UpdateInnerHTML ( entry, boxmodeTableHtml )
