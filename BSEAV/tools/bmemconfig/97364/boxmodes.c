    ...
    )
{
    ...
    {
        /*
           1x 16-bit DDR3-1600 or DDR4-1600 - Allows high-temperature refresh
           1080p60 8-bit HEVC 8-bit
           MAIN only (no PIP)
           UHD only
           No transcode
         */
        pSettings->boxModeId = boxMode;
        pSettings->boxModeDescription          = "Display:HD Video(1080p60 HEVC 8-bit):HD Main/ No PIP + No Xcode";
    ...
    case 4:
    {
        /*
            1x 16-bit DDR3-2133
            1080p30/60i 8-bit HEVC or AVC
            1080p30/60i 8-bit HEVC or AVC
            MAIN + no PIP
            SD display
            Video transcode (Raaga) up to 480p30 or 576p25
         */
        pSettings->boxModeId = boxMode;
        pSettings->boxModeDescription          = "Display:HD Video(1080p30/60i 8-bit HEVC/AVC):HD Main/no PIP + 1 Xcode";
        ...
        pSettings->graphics[1].usage = "M2MC, primary display FB";
    ...
    case 5:
    {
        /*
           1x 16-bit DDR3-2133
           1080p60 10-bit HEVC or 1080p30/60i 8-bit 8-bit AVC
           Headless (no display)
           Video transcode (Raaga) up to 720p30
         */
        pSettings->boxModeId = boxMode;
        pSettings->boxModeDescription          = "Headless:HD Video(1080p60 HEVC 8-bit): 1 Xcode";
    ...
    {
        /*
           1x 16-bit DDR3-2133 or 1x 16-bit DDR4-2133 - Allows high-temperature refresh
           1080p60 10-bit HEVC or 1080p60 8-bit AVC
           MAIN only (no PIP)
           UHD + SD display
           No transcode
         ...
         */
        pSettings->boxModeId = boxMode;
        pSettings->boxModeDescription          = "Display:HD Video(1080p60 10-bit HEVC or 8-bit AVC):HD Main/ No PIP + SD + No Xcode";
