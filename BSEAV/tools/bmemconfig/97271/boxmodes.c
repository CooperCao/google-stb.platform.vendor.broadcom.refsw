...
/************* 97271 Box modes *****************/
        ...
        {
            pSettings->boxModeId = boxMode;
            pSettings->boxModeDescription          = "Display:UHD; Video:UHD Main/PIP(Limited Usage),Transcode:None; LPDDR4-3200";
        ...
        {
            pSettings->boxModeId = boxMode;
            pSettings->boxModeDescription          = "Display:UHD; Video:UHD Main/NO PIP,Transcode:up to 720p30; LPDDR4-3733";

            pSettings->videoDecoder[0].property                      = Memconfig_VideoDecoderProperty_eMain;
            pSettings->videoDecoder[0].pictureBufferHeapIdx          = NEXUS_MEMC0_PICTURE_BUFFER_HEAP;
            pSettings->videoDecoder[0].usage                         = "Video Decoder 0 Luma for HEVC";
            pSettings->videoDecoder[0].secondaryPictureBufferHeapIdx = NEXUS_MEMC0_PICTURE_BUFFER_HEAP;
            pSettings->videoDecoder[0].secondaryUsage                = "Video Decoder 0 Chroma for HEVC";
