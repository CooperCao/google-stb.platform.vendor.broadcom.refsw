    ...
    )
{
    ...
    switch (boxMode) {
        ...
        case 1:
        {
            ...
            pSettings->boxModeDescription   = "Display:UHD (no SD),Video (Dual 1080p30/60i),Main/PIP,No xcode";
        ...
        {
            pSettings->boxModeId            = boxMode;
            pSettings->boxModeDescription   = "Display:UHD+SD,Video (1080p60/60i),Main/no PIP,No xcode";
        ...
        {
            pSettings->boxModeId            = boxMode;
            pSettings->boxModeDescription   = "Display:UHD (no SD),Video (Dual 1080p60/60i),Main/PIP,No xcode";
        ...
        {
            pSettings->boxModeId            = boxMode;
            pSettings->boxModeDescription   = "Display:UHD,Video (4Kp60 or dual 1080p60/60i),Main/limited PIP,No xcode";
            ...
            pSettings->graphics[1].heapIdx  = NEXUS_MEMC0_GRAPHICS_HEAP;
            pSettings->graphics[1].used     = true;
            pSettings->graphics[1].usage    = "m2mc, sec graphics-only FB";
        ...
        {
            pSettings->boxModeId          = boxMode;
            pSettings->boxModeDescription = "Display:UHD; Video:4Kp60 or Dual 1080p60/PIP (only in 1080p60 mode)";
