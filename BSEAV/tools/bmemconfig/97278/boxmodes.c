...
/************* 97278 Box modes *****************/
        case 1:
        {
            ...
            pSettings->boxModeDescription          = "Display:UHD/SD gfx, Video:UHD Main/multi-PIP,Transcode:Dual up to 1080p30(Max)";
            ...
            pSettings->videoDecoder[1].secondaryPictureBufferHeapIdx = NEXUS_MEMC1_PICTURE_BUFFER_HEAP;
            ...
            pSettings->videoDecoder[2].secondaryPictureBufferHeapIdx = NEXUS_MEMC1_PICTURE_BUFFER_HEAP;
            ...
            pSettings->videoDecoder[3].secondaryPictureBufferHeapIdx = NEXUS_MEMC1_PICTURE_BUFFER_HEAP;
        ...
        {
            pSettings->boxModeId = boxMode;
            pSettings->boxModeDescription          = "Display:UHD/SD gfx, Video:4k-Main/4k-PIP, Transcode:None";
        ...
        {
            pSettings->boxModeId = boxMode;
            pSettings->boxModeDescription          = "Display:UHD/SD, Video:UHD Main/multi-PIP,Transcode:Dual up to 1080p30(Max)";
        ...
        {
            pSettings->boxModeId = boxMode;
            pSettings->boxModeDescription          = "Display:UHD/SD, Video:4k-Main/No PIP, Transcode:Single up to 1080p60(Max)";
        ...
        {
            pSettings->boxModeId = boxMode;
            pSettings->boxModeDescription          = "Display:UHD/SD, Video:UHD Main/multi-PIP,Transcode:Single 1080p60(Max) OR Dual 1080p30(Max)";
