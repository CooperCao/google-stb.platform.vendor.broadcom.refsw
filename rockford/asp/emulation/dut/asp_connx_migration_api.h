...
#ifndef __ASP_CONNX_MIGRATION_API_H__
#define __ASP_CONNX_MIGRATION_API_H__

#include <stdio.h>
#include <stdint.h>
#include "../cmodel/asp_proxy_server_message_api.h" /* defines SocketState. */
...
#endif /* __ASP_CONNX_MIGRATION_API_H__ */
