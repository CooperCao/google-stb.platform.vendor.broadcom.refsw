...
#else
	mfc0	v0,CP0_STATUS /*$12*/	/* get CPU Status Register */
	nop
	nop
	and		t0,v0,~1
	mtc0    t0,CP0_STATUS /*$12*/
	nop
	nop
    jr    $31
	nop
...
OS_CPU_SR_Restore:
    ...
    jr    $31
    mtc0  $4, CP0_STATUS /*$12*/, 0                           /* Restore the status register to its previous state    */
...
OSStartHighRdy:
        ...
        la      t0, OSTCBHighRdyPtr       /* Update the current TCB   */
        lw      sp, 0(t0)              
...
mips_exception:
		...
		la		t2, OSTCBCurPtr                      /* Save the current task's stack pointer                */
		lw		t3, 0(t2)
		sw		k1, 0(t3)
