...
#define OS_LOWEST_PRIO           254u /*35u*/   /* Defines the lowest priority that can be assigned ...         */
                                       /* ... MUST NEVER be higher than 254!                           */

#define OS_MAX_EVENTS           512u   /* Max. number of event control blocks in your application      */
#define OS_MAX_FLAGS             64u   /* Max. number of Event Flag Groups    in your application      */
#define OS_MAX_MEM_PART           0u   /* Max. number of memory partitions                             */
#define OS_MAX_QS                40u   /* Max. number of queue control blocks in your application      */
...
#define HW_TICKS_PER_SEC          202500000 /*54000000*/    /* 108 Mhz  but the counter is clock every other clock*/
...
/* set any of these to > 1 to supply external hook, when they are left at 1 
   internal simple hook implemenations are used */

  
#define OS_INIT_HOOK_BEGIN_EN 	1  
#define OS_TASK_RETURN_HOOK     1
