...
extern void glDrawElements_impl(GLenum mode, GLsizei count, GLenum type, const void *indices_pointer, GLuint indices_buffer, GLXX_ATTRIB_T *attribs, int *keys, int keys_count);
...
extern void glReadPixels_impl(GLint x, GLint y, GLsizei width, GLsizei height, GLenum format, GLenum type, GLint alignment, void *pixels);
...
extern GLboolean glTexImage2D_impl(GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, GLint alignment, const GLvoid *pixels);
...
extern void glTexSubImage2D_impl(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, GLint alignment, const void *pixels);
...
extern void glxx_RenderbufferStorageMultisampleEXT_impl(GLenum, GLsizei, GLenum, GLsizei, GLsizei);
extern void glxx_FramebufferTexture2DMultisampleEXT_impl(GLenum, GLenum, GLenum, GLuint, GLint, GLsizei);
...
extern void glRenderbufferStorage_impl(GLenum target, GLenum internalformat, GLsizei width, GLsizei height);
