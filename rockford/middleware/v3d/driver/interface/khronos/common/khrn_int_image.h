...
typedef enum {
   ...
   */
   ...
   IMAGE_FORMAT_YUV = 1 << 15,

   IMAGE_FORMAT_PIXEL_LAYOUT_MASK = 0x7 << 16,

   /* pixel size used to differentiate between eg 4444 and 8888 */
   /* unspecified (0) means one channel occupying entire pixel */
   /* IMAGE_FORMAT_32 */
   IMAGE_FORMAT_8888 = 1 << 16,
   /* IMAGE_FORMAT_24 */
   IMAGE_FORMAT_888  = 1 << 16,
   /* IMAGE_FORMAT_16 */
   IMAGE_FORMAT_4444 = 2 << 16,
   IMAGE_FORMAT_5551 = 3 << 16, /* (or 1555) */
   IMAGE_FORMAT_565  = 4 << 16,
   IMAGE_FORMAT_88   = 5 << 16,
   ...
   */
   ...
   YUV_422     = IMAGE_FORMAT_PACK(_, UNCOMP, 16, COLOR  , YUV, _, XBGRX, _ , YUYV),
   YUV_422_REV = IMAGE_FORMAT_PACK(_, UNCOMP, 16, COLOR  , YUV, _, XRGBX, _ , YUYV),
   YV12        = IMAGE_FORMAT_PACK(_, UNCOMP, 16, COLOR  , YUV, _, XBGRX, _ , YV12),
   ...
   BGRA_8888_TF = BGRA_8888 | IMAGE_FORMAT_TF,
   ...
   BGRA_8888_LT = BGRA_8888 | IMAGE_FORMAT_LT,
