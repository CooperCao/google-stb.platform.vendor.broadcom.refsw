...
static void radians__const_float__const_float(const_float* result, const_float* degrees)
{
   ...
   */
   ...
   mixed_float pi_on_180;
   pi_on_180.f = (float)atof("0.01745329252");

   op_mul__const_float__const_float__const_float(result, (const_float*)&pi_on_180.ui, degrees);
}
...
static void degrees__const_float__const_float(const_float* result, const_float* radians)
{
   ...
   */
   mixed_float _180_on_pi;
   _180_on_pi.f = (float)atof("57.29577951");

   op_mul__const_float__const_float__const_float(result, (const_float*)&_180_on_pi.ui, radians);
}
...
static void atan__const_float__const_float__const_float(const_float* result, const_float* _y, const_float* _x)
{
   ...
   pi_on_4096.f = (float)atof("7.6699039e-4");
...
{
   mixed_float e;
   e.f = (float)atof("2.718281828");

   pow__const_float__const_float__const_float(result, (const_float*)&e.ui, x);
}
...
static void log__const_float__const_float(const_float* result, const_float* x)
{
   ...
   rlog2e.f = (float)atof("0.6931471805");

   log2__const_float__const_float(&log2x, x);
   glsl_fpu_mul((unsigned *)result,(unsigned)log2x,*(unsigned *)&rlog2e.ui);
}
...
static void mod__const_float__const_float__const_float(const_float* result, const_float* x, const_float* y)
{
   /* In order to pass conformance, which does a mod(100.0, 300.0) this has a Newton-Raphson iteration to improve
      the reciprocal accuracy. We can't sadly do this in the real mod() function, as that then also fails conformance.
   */
...
static void dot__const_float__const_vec2__const_vec2(const_float* result, const_vec2* x, const_vec2* y)
{
   ...
   op_mul__const_float__const_float__const_float(&t1, &(*x)[0], &(*y)[0]);
   op_mul__const_float__const_float__const_float(&t2, &(*x)[1], &(*y)[1]);
...
static void dot__const_float__const_vec3__const_vec3(const_float* result, const_vec3* x, const_vec3* y)
{
   ...
   op_mul__const_float__const_float__const_float(&t1, &(*x)[0], &(*y)[0]);
   op_mul__const_float__const_float__const_float(&t2, &(*x)[1], &(*y)[1]);
   op_mul__const_float__const_float__const_float(&t3, &(*x)[2], &(*y)[2]);
...
static void dot__const_float__const_vec4__const_vec4(const_float* result, const_vec4* x, const_vec4* y)
{
   ...
   op_mul__const_float__const_float__const_float(&t2, &(*x)[1], &(*y)[1]);
   op_mul__const_float__const_float__const_float(&t3, &(*x)[2], &(*y)[2]);
   op_mul__const_float__const_float__const_float(&t4, &(*x)[3], &(*y)[3]);
...
static void calc_k(const_float *k, const_float *d, const_float *eta)
{
   ...
   op_mul__const_float__const_float__const_float(&t1, d,    d);
   op_sub__const_float__const_float__const_float(&t2, &one, &t1);
   op_mul__const_float__const_float__const_float(&t3, eta,  &t2);
   op_mul__const_float__const_float__const_float(&t4, eta,  &t3);
   op_sub__const_float__const_float__const_float(k,   &one, &t4);
}
