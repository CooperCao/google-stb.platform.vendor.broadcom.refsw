...
bool eglInitDriverMonitorBRCM_impl(EGLint hw_bank, EGLint l3c_bank)
{
   ...
   {
      khrn_init_driver_counters(hw_bank, l3c_bank);
   }
...
void eglGetDriverMonitorXMLBRCM_impl(EGLint bufSize, char *xmlStats)
{
   ...
   {
      KHRN_DRIVER_COUNTERS_T *counters;
#ifdef __linux__
      ...
      float cpuPct;
#endif
      khrn_update_perf_counters();
      counters = khrn_driver_counters();
