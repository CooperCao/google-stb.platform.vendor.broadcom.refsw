...
static BEGL_Error WlcSurfaceGetInfo(void *context, void *nativeSurface, BEGL_SurfaceInfo *info)
{
...
static BEGL_Error WlcSurfaceVerifyImageTarget(void *context,
      ...
      WaylandClient *wlc)
{
   ...
   if (disp)
   {
      ...
      disp->SurfaceVerifyImageTarget = WlcSurfaceVerifyImageTarget;
