...
extern const char *v3d_maybe_desc_tmu_direct_type(v3d_tmu_direct_type_t tmu_direct_type);
...
extern const char *v3d_maybe_desc_tmu_direct_op(v3d_tmu_direct_op_t tmu_direct_op);
