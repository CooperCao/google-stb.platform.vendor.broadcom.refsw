...
#endif
#define V3D_TMU_DML_CONSERVATIVE_ALIGN 16
#define V3D_TMU_DML_REC_ALIGN          64
 ...
 * - addr & V3D_QUERY_COUNTER_CORE_MASK == 0
 *
 * The actual address used by the hardware is:
 * addr + core index * V3D_QUERY_COUNTER_SINGLE_CORE_CACHE_LINE_SIZE
 *
 * Each core loads query counters into its cache in blocks of size
 * V3D_QUERY_COUNTER_SINGLE_CORE_CACHE_LINE_SIZE. The occlusion query cache
 * does *not* have per-word dirty bits,
 *
 * To make it all work, query counters should be allocated in blocks of size
 * (num cores * V3D_QUERY_COUNTER_SINGLE_CORE_CACHE_LINE_SIZE), with alignment
 * V3D_QUERY_COUNTER_FIRST_CORE_CACHE_LINE_ALIGN. You get
 * V3D_QUERY_COUNTER_SINGLE_CORE_CACHE_LINE_COUNTERS separate counters out of
 * each block. */

#define V3D_QUERY_COUNTER_LOG2_SINGLE_CORE_CACHE_LINE_SIZE 6
#define V3D_QUERY_COUNTER_CORE_BITS 4
static_assrt(V3D_MAX_CORES <= (1 << V3D_QUERY_COUNTER_CORE_BITS));

#define V3D_QUERY_COUNTER_SINGLE_CORE_CACHE_LINE_SIZE ( \
   1 << V3D_QUERY_COUNTER_LOG2_SINGLE_CORE_CACHE_LINE_SIZE)
#define V3D_QUERY_COUNTER_SINGLE_CORE_CACHE_LINE_COUNTERS ( \
   V3D_QUERY_COUNTER_SINGLE_CORE_CACHE_LINE_SIZE / 4)

#define V3D_QUERY_COUNTER_CORE_MASK ( \
   ((1 << V3D_QUERY_COUNTER_CORE_BITS) - 1) << \
   V3D_QUERY_COUNTER_LOG2_SINGLE_CORE_CACHE_LINE_SIZE)

#define V3D_QUERY_COUNTER_FIRST_CORE_CACHE_LINE_ALIGN ( \
   (1 << V3D_QUERY_COUNTER_CORE_BITS) * V3D_QUERY_COUNTER_SINGLE_CORE_CACHE_LINE_SIZE)
