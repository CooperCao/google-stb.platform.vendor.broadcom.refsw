...
static const EGL_CONFIG_T egl_configs[] = {
   ...
   /*35*/ {0, 0, GFX_LFMT_X4B4G4R4_UNORM,    GFX_LFMT_S8D24_UINT_UNORM, GFX_LFMT_NONE,    GFX_LFMT_NONE},
   /*36*/ {0, 0, GFX_LFMT_X4B4G4R4_UNORM,    GFX_LFMT_D24X8_UNORM,      GFX_LFMT_NONE,    GFX_LFMT_NONE},
   /*37*/ {0, 0, GFX_LFMT_X4B4G4R4_UNORM,    GFX_LFMT_NONE,             GFX_LFMT_S8_UINT, GFX_LFMT_NONE},
   /*38*/ {0, 0, GFX_LFMT_X4B4G4R4_UNORM,    GFX_LFMT_NONE,             GFX_LFMT_NONE,    GFX_LFMT_NONE},

   /*39*/{ 4, 0, GFX_LFMT_A4B4G4R4_UNORM,    GFX_LFMT_S8D24_UINT_UNORM, GFX_LFMT_NONE,    GFX_LFMT_NONE},
   /*40*/{ 4, 0, GFX_LFMT_A4B4G4R4_UNORM,    GFX_LFMT_D24X8_UNORM,      GFX_LFMT_NONE,    GFX_LFMT_NONE},
   /*41*/{ 4, 0, GFX_LFMT_A4B4G4R4_UNORM,    GFX_LFMT_NONE,             GFX_LFMT_S8_UINT, GFX_LFMT_NONE},
   /*42*/{ 4, 0, GFX_LFMT_A4B4G4R4_UNORM,    GFX_LFMT_NONE,             GFX_LFMT_NONE,    GFX_LFMT_NONE},

   /*43*/{ 4, 0, GFX_LFMT_X4B4G4R4_UNORM,    GFX_LFMT_S8D24_UINT_UNORM, GFX_LFMT_NONE,    GFX_LFMT_NONE},
   /*44*/{ 4, 0, GFX_LFMT_X4B4G4R4_UNORM,    GFX_LFMT_D24X8_UNORM,      GFX_LFMT_NONE,    GFX_LFMT_NONE},
   /*45*/{ 4, 0, GFX_LFMT_X4B4G4R4_UNORM,    GFX_LFMT_NONE,             GFX_LFMT_S8_UINT, GFX_LFMT_NONE},
   /*46*/{ 4, 0, GFX_LFMT_X4B4G4R4_UNORM,    GFX_LFMT_NONE,             GFX_LFMT_NONE,    GFX_LFMT_NONE},
    ...
    */
   /*47*/ {0, 0, GFX_LFMT_A1B5G5R5_UNORM,    GFX_LFMT_S8D24_UINT_UNORM, GFX_LFMT_NONE,    GFX_LFMT_NONE},
   /*48*/ {0, 0, GFX_LFMT_A1B5G5R5_UNORM,    GFX_LFMT_D24X8_UNORM,      GFX_LFMT_NONE,    GFX_LFMT_NONE},
   /*49*/ {0, 0, GFX_LFMT_A1B5G5R5_UNORM,    GFX_LFMT_NONE,             GFX_LFMT_S8_UINT, GFX_LFMT_NONE},
   /*50*/ {0, 0, GFX_LFMT_A1B5G5R5_UNORM,    GFX_LFMT_NONE,             GFX_LFMT_NONE,    GFX_LFMT_NONE},

   /*51*/ {0, 0, GFX_LFMT_X1B5G5R5_UNORM,    GFX_LFMT_S8D24_UINT_UNORM, GFX_LFMT_NONE,    GFX_LFMT_NONE},
   /*52*/ {0, 0, GFX_LFMT_X1B5G5R5_UNORM,    GFX_LFMT_D24X8_UNORM,      GFX_LFMT_NONE,    GFX_LFMT_NONE},
   /*53*/ {0, 0, GFX_LFMT_X1B5G5R5_UNORM,    GFX_LFMT_NONE,             GFX_LFMT_S8_UINT, GFX_LFMT_NONE},
   /*54*/ {0, 0, GFX_LFMT_X1B5G5R5_UNORM,    GFX_LFMT_NONE,             GFX_LFMT_NONE,    GFX_LFMT_NONE},

   /*55*/{ 4, 0, GFX_LFMT_A1B5G5R5_UNORM,    GFX_LFMT_S8D24_UINT_UNORM, GFX_LFMT_NONE,    GFX_LFMT_NONE},
   /*56*/{ 4, 0, GFX_LFMT_A1B5G5R5_UNORM,    GFX_LFMT_D24X8_UNORM,      GFX_LFMT_NONE,    GFX_LFMT_NONE},
   /*57*/{ 4, 0, GFX_LFMT_A1B5G5R5_UNORM,    GFX_LFMT_NONE,             GFX_LFMT_S8_UINT, GFX_LFMT_NONE},
   /*58*/{ 4, 0, GFX_LFMT_A1B5G5R5_UNORM,    GFX_LFMT_NONE,             GFX_LFMT_NONE,    GFX_LFMT_NONE},

   /*59*/{ 4, 0, GFX_LFMT_X1B5G5R5_UNORM,    GFX_LFMT_S8D24_UINT_UNORM, GFX_LFMT_NONE,    GFX_LFMT_NONE},
   /*60*/{ 4, 0, GFX_LFMT_X1B5G5R5_UNORM,    GFX_LFMT_D24X8_UNORM,      GFX_LFMT_NONE,    GFX_LFMT_NONE},
   /*61*/{ 4, 0, GFX_LFMT_X1B5G5R5_UNORM,    GFX_LFMT_NONE,             GFX_LFMT_S8_UINT, GFX_LFMT_NONE},
   /*62*/{ 4, 0, GFX_LFMT_X1B5G5R5_UNORM,    GFX_LFMT_NONE,             GFX_LFMT_NONE,    GFX_LFMT_NONE},
#endif
};
