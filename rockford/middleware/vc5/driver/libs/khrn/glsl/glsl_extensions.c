...
static struct {
   ...
   {{"GL_OES_sample_variables",},                      V3D_HAS_SRS, GLSL_DISABLED, GLSL_STDLIB_PROPERTY_GL_OES_SAMPLE_VARIABLES, NULL},
   {{"GL_OES_shader_multisample_interpolation",},      V3D_HAS_SRS, GLSL_DISABLED, 0, NULL },

   {{"GL_OES_texture_buffer",         "GL_EXT_texture_buffer",},        true, GLSL_DISABLED, GLSL_STDLIB_PROPERTY_GL_OES_TEXTURE_BUFFER, NULL },
   {{"GL_OES_gpu_shader5",            "GL_EXT_gpu_shader5"},            V3D_HAS_NEW_TMU_CFG, GLSL_DISABLED, GLSL_STDLIB_PROPERTY_GL_OES_GPU_SHADER5, NULL },
   {{"GL_OES_texture_cube_map_array", "GL_EXT_texture_cube_map_array"}, V3D_HAS_NEW_TMU_CFG, GLSL_DISABLED, GLSL_STDLIB_PROPERTY_GL_OES_TEXTURE_CUBE_MAP_ARRAY, NULL },
   {{"GL_OES_shader_io_blocks",       "GL_EXT_shader_io_blocks"},       false, GLSL_DISABLED, 0, NULL },

   {{"GL_OES_tessellation_shader",        "GL_EXT_tessellation_shader"},     V3D_HAS_TNG, GLSL_DISABLED, GLSL_STDLIB_PROPERTY_GL_OES_TESSELLATION_SHADER, tng_implies },
   {{"GL_OES_tessellation_point_size",    "GL_EXT_tessellation_point_size"}, V3D_HAS_TNG, GLSL_DISABLED, 0, NULL },
   ...
   {{"GL_ANDROID_extension_pack_es31a", },     V3D_HAS_SRS && V3D_HAS_NEW_TMU_CFG && false && V3D_HAS_TNG, GLSL_DISABLED, 0, aep_implies },
};
