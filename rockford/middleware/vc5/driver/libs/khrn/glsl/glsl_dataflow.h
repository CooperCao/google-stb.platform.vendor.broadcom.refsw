...
#define DF_TEXBITS_CUBE   (1<<0)
#define DF_TEXBITS_FETCH  (1<<1)
#define DF_TEXBITS_GATHER (1<<2)
#define DF_TEXBITS_BSLOD  (1<<3)
#define DF_TEXBITS_I_OFF  (1<<4)
#define DF_TEXBITS_SAMPLER_FETCH (1<<5)

#define DF_TEXBITS_GATHER_COMP_SHIFT  8
#define DF_TEXBITS_GATHER_COMP_MASK  (3 << DF_TEXBITS_GATHER_COMP_SHIFT)


#define DF_TEXBITS_OFFSET(s,t,r) (((s)&15)<<19 | ((t)&15)<<23 | ((r)&15)<<27)
