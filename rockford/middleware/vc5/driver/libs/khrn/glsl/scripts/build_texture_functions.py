...
if __name__ == "__main__":
             ...
             for offset in ['', 'Offset']:
                for dimx in ['1D', '1DX', '1DArray', '2D','2DX','3D','Cube','2DArray','CubeArray']:
                   ...
                   for g in ['','i','u','s']:
                      ...
                      print >>outf, "   return $$texture(%s, sampler, %s, %s%s%s);" % (bits, cval, lodval, drefval, offsetval)
                      print >>outf, "}"
                      print >>outf
    ...
    with open("textures.auto.props","w") as prpf:
       ...
       for f in v3functions:
           print >>prpf, "  %s" % f
       print >>prpf, "version32:"
       for f in v32functions:
           print >>prpf, "  %s" % f
       print >>prpf, "GL_BRCM_texture_1d:"
       for f in tex_1d_functions:
           print >>prpf, " %s" % f
       print >>prpf, "GL_OES_texture_cube_map_array:"
       for f in cube_array_functions:
           print >>prpf, " %s" % f
       print >>prpf, "fragment:"
       for f in fragfunctions:
           print >>prpf, "  %s" % f
       print >>prpf, "arg3-const:"
       for f in arg3offset:
           print >>prpf, "  %s" % f
       print >>prpf, "arg4-const:"
       for f in arg4offset:
           print >>prpf, "  %s" % f
       print >>prpf, "arg5-const:"
       for f in arg5offset:
           print >>prpf, "  %s" % f
