...
#define GLXX_HAS_TESSELLATION (KHRN_GLES32_DRIVER || (KHRN_GLES31_DRIVER && V3D_HAS_TNG))
#define GLXX_HAS_TNG          (KHRN_GLES32_DRIVER || (KHRN_GLES31_DRIVER && V3D_HAS_TNG))
...
#define GLXX_CONFIG_MAX_IMAGE_UNITS                   4u
#define GLXX_CONFIG_MAX_SHADER_IMAGE_UNIFORMS         4u
#define GLXX_CONFIG_MAX_VERTEX_IMAGE_UNIFORMS         (GLXX_CONFIG_ALLOW_VERTEX_OBJECTS ? GLXX_CONFIG_MAX_SHADER_IMAGE_UNIFORMS : 0u)
#define GLXX_CONFIG_MAX_COMBINED_IMAGE_UNIFORMS       4u
