...
CFLAGS += \
	...
	-mfpu=neon \
	-I${GRALLOC} \
	-I${ANDROID_TOP}/system/core/libsync/include \
...
LDFLAGS = $(NEXUS_LDFLAGS) $(NXCLIENT_LDFLAGS) -lnexuseglclient -ldl -lsync
...
SOURCES = \
	...
	tools/v3d/sfu/sfu.c \
	${PLATFORM_DIR}/android/default_android.c \
	${PLATFORM_DIR}/android/display_android.c \
	${PLATFORM_DIR}/android/memory_android.c \
	${PLATFORM_DIR}/android/egl_native_fence_sync_android.c \
	${PLATFORM_DIR}/android/sched_android.c \
	${PLATFORM_DIR}/common/sched_nexus.c \
