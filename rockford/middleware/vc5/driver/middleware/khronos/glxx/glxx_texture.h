...
#include "middleware/khronos/glxx/glxx_texture_defines.h"
#include "middleware/khronos/glxx/glxx_texture_utils.h"
#include "middleware/khronos/common/khrn_image.h"
...
typedef struct glxx_tex_sampler_state {
    ...
    * GL_CLAMP_TO_BORDER_BRCM & GL_CLAMP_TO_EDGE will be treated as one of
