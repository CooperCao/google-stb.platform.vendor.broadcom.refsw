...
struct glxx_hw_render_state
{
   ...
   // track the last server state to update this render state
   GLXX_SERVER_STATE_T     *current_server_state;

   gfx_bufstate_t          color_buffer_state   [GLXX_MAX_RENDER_TARGETS];
   gfx_bufstate_t          ms_color_buffer_state[GLXX_MAX_RENDER_TARGETS];

   gfx_bufstate_t          depth_buffer_state;
   gfx_bufstate_t          stencil_buffer_state;
