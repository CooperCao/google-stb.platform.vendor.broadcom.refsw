...
/* creates a platform fence that will be signaled when fence reaches specified
 * deps_state;
 * Important: For android, we need to return a valid native fence fd, even if
 * khrn_fence's deps have already reached the specified state;  */
