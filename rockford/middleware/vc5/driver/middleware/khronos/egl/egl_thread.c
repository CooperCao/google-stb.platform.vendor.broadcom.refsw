...
#define VCOS_LOG_CATEGORY (&egl_thread_log)
VCOS_LOG_CAT_T egl_thread_log = VCOS_LOG_INIT("egl_thread", VCOS_LOG_INFO);
...
static void init_once(void)
{
   ...
   {
      vcos_log_error("Fatal: unable to init once egl_thread");
   }
}
...
static EGL_THREAD_T *thread_create(void)
{
   ...
   vcos_log_error("Fatal: unable to allocate thread-local-storage for EGL");
