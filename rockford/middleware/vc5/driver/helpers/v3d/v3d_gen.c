...
bool v3d_is_valid_prim_type(v3d_prim_type_t prim_type)
{
   switch (prim_type)
   {
   ...
   case V3D_PRIM_TYPE_LINE_ADJ:
   case V3D_PRIM_TYPE_TRI_ADJ:
   case V3D_PRIM_TYPE_PATCH1:
   case V3D_PRIM_TYPE_PATCH2:
   case V3D_PRIM_TYPE_PATCH3:
   case V3D_PRIM_TYPE_PATCH4:
   case V3D_PRIM_TYPE_PATCH5:
   case V3D_PRIM_TYPE_PATCH6:
   case V3D_PRIM_TYPE_PATCH7:
   case V3D_PRIM_TYPE_PATCH8:
   case V3D_PRIM_TYPE_PATCH9:
   case V3D_PRIM_TYPE_PATCH10:
   case V3D_PRIM_TYPE_PATCH11:
   case V3D_PRIM_TYPE_PATCH12:
   case V3D_PRIM_TYPE_PATCH13:
   case V3D_PRIM_TYPE_PATCH14:
   case V3D_PRIM_TYPE_PATCH15:
   case V3D_PRIM_TYPE_PATCH16:
   case V3D_PRIM_TYPE_PATCH17:
   case V3D_PRIM_TYPE_PATCH18:
   case V3D_PRIM_TYPE_PATCH19:
   case V3D_PRIM_TYPE_PATCH20:
   case V3D_PRIM_TYPE_PATCH21:
   case V3D_PRIM_TYPE_PATCH22:
   case V3D_PRIM_TYPE_PATCH23:
   case V3D_PRIM_TYPE_PATCH24:
   case V3D_PRIM_TYPE_PATCH25:
   case V3D_PRIM_TYPE_PATCH26:
   case V3D_PRIM_TYPE_PATCH27:
   case V3D_PRIM_TYPE_PATCH28:
   case V3D_PRIM_TYPE_PATCH29:
   case V3D_PRIM_TYPE_PATCH30:
   case V3D_PRIM_TYPE_PATCH31:
   case V3D_PRIM_TYPE_PATCH32:
   return true;
   default:
      return false;
   }
}
const char *v3d_desc_prim_type(v3d_prim_type_t prim_type)
{
   switch (prim_type) {
   case V3D_PRIM_TYPE_POINT:    return "point";
   case V3D_PRIM_TYPE_LINE:     return "line";
   case V3D_PRIM_TYPE_TRI:      return "tri";
   case V3D_PRIM_TYPE_LINE_ADJ: return "line_adj";
   case V3D_PRIM_TYPE_TRI_ADJ:  return "tri_adj";
   case V3D_PRIM_TYPE_PATCH1:   return "patch1";
   case V3D_PRIM_TYPE_PATCH2:   return "patch2";
   case V3D_PRIM_TYPE_PATCH3:   return "patch3";
   case V3D_PRIM_TYPE_PATCH4:   return "patch4";
   case V3D_PRIM_TYPE_PATCH5:   return "patch5";
   case V3D_PRIM_TYPE_PATCH6:   return "patch6";
   case V3D_PRIM_TYPE_PATCH7:   return "patch7";
   case V3D_PRIM_TYPE_PATCH8:   return "patch8";
   case V3D_PRIM_TYPE_PATCH9:   return "patch9";
   case V3D_PRIM_TYPE_PATCH10:  return "patch10";
   case V3D_PRIM_TYPE_PATCH11:  return "patch11";
   case V3D_PRIM_TYPE_PATCH12:  return "patch12";
   case V3D_PRIM_TYPE_PATCH13:  return "patch13";
   case V3D_PRIM_TYPE_PATCH14:  return "patch14";
   case V3D_PRIM_TYPE_PATCH15:  return "patch15";
   case V3D_PRIM_TYPE_PATCH16:  return "patch16";
   case V3D_PRIM_TYPE_PATCH17:  return "patch17";
   case V3D_PRIM_TYPE_PATCH18:  return "patch18";
   case V3D_PRIM_TYPE_PATCH19:  return "patch19";
   case V3D_PRIM_TYPE_PATCH20:  return "patch20";
   case V3D_PRIM_TYPE_PATCH21:  return "patch21";
   case V3D_PRIM_TYPE_PATCH22:  return "patch22";
   case V3D_PRIM_TYPE_PATCH23:  return "patch23";
   case V3D_PRIM_TYPE_PATCH24:  return "patch24";
   case V3D_PRIM_TYPE_PATCH25:  return "patch25";
   case V3D_PRIM_TYPE_PATCH26:  return "patch26";
   case V3D_PRIM_TYPE_PATCH27:  return "patch27";
   case V3D_PRIM_TYPE_PATCH28:  return "patch28";
   case V3D_PRIM_TYPE_PATCH29:  return "patch29";
   case V3D_PRIM_TYPE_PATCH30:  return "patch30";
   case V3D_PRIM_TYPE_PATCH31:  return "patch31";
   case V3D_PRIM_TYPE_PATCH32:  return "patch32";
   default:                     unreachable(); return NULL;
   }
}
...
const char *v3d_desc_cl_tess_edge_spacing(v3d_cl_tess_edge_spacing_t cl_tess_edge_spacing)
{
   ...
   case V3D_CL_TESS_EDGE_SPACING_EVEN:            return "even";
...
const char *v3d_desc_cl_tcs_output_pack(v3d_cl_tcs_output_pack_t cl_tcs_output_pack)
{
   switch (cl_tcs_output_pack) {
   case V3D_CL_TCS_OUTPUT_PACK_X16: return "x16";
   case V3D_CL_TCS_OUTPUT_PACK_X8:  return "x8";
   case V3D_CL_TCS_OUTPUT_PACK_X4:  return "x4";
   default:                         unreachable(); return NULL;
   }
}
...
void v3d_unpack_shadrec_gl_main(V3D_SHADREC_GL_MAIN_T *unpacked, const uint32_t *packed)
{
   ...
   (*unpacked).fs_working_size = packed[0] >> 24;
   (*unpacked).cs_output_size = packed[1] & 255;
   (*unpacked).cs_working_size = packed[1] >> 8 & 255;
   (*unpacked).vs_output_size = packed[1] >> 16 & 255;
   (*unpacked).vs_working_size = packed[1] >> 24;
...
{
   (*unpacked).tess_enabled = packed[0] & 1;
   ...
   (*unpacked).tcs_output_bin.pack = (v3d_cl_tcs_output_pack_t)(packed[1] >> 6 & 3);
   (*unpacked).tcs_output_render.size_sectors =
      gfx_check_urange(packed[1] >> 8 & 63, 0, 16);
   (*unpacked).tcs_output_render.pack =
      (v3d_cl_tcs_output_pack_t)(packed[1] >> 14 & 3);
   (*unpacked).tes_output_bin.size_sectors =
      gfx_check_urange(packed[1] >> 16 & 63, 0, 16);
   (*unpacked).tes_output_bin.pack =
      (v3d_cl_tcs_output_pack_t)(packed[1] >> 22 & 3);
   (*unpacked).tes_output_render.size_sectors =
      gfx_check_urange(packed[1] >> 24 & 63, 0, 16);
   (*unpacked).tes_output_render.pack = (v3d_cl_tcs_output_pack_t)(packed[1] >> 30);
   (*unpacked).geom_enabled = packed[2] & 1;
   (*unpacked).geom_output = (v3d_cl_geom_prim_type_t)(packed[2] >> 1 & 3);
   (*unpacked).geom_clockwise = packed[2] >> 3 & 1;
   (*unpacked).geom_max_prims = packed[2] >> 16;
   (*unpacked).geom_output_bin.size_sectors =
      gfx_check_urange(packed[3] & 63, 0, 16);
   (*unpacked).geom_output_bin.pack =
      (v3d_cl_geom_output_pack_t)(packed[3] >> 6 & 3);
   (*unpacked).geom_output_render.size_sectors =
      gfx_check_urange(packed[3] >> 8 & 63, 0, 16);
   (*unpacked).geom_output_render.pack =
      (v3d_cl_geom_output_pack_t)(packed[3] >> 14 & 3);
   (*unpacked).geom_num_instances = gfx_check_urange(packed[3] >> 16 & 255, 1, 32);
}
...
{
   (*unpacked).tmuoff_per_sample = packed0 & 1;
...
{
   (*unpacked).op = (v3d_tsy_op_t)(uint32_t)packed0;
}
...
void v3d_unpack_tmu_tex_state(V3D_TMU_TEX_STATE_T *unpacked, const uint8_t *packed)
{
   ...
   (*unpacked).swapst = (uint32_t)(packed[0] >> 2 & 1);
...
void v3d_unpack_hub_ident3(V3D_HUB_IDENT3_T *unpacked, uint32_t packed0)
{
   ...
   (*unpacked).ip_recipient_revision = packed0 >> 8 & 255;
}
void v3d_unpack_hub_ident(V3D_HUB_IDENT_T *unpacked, uint32_t packed0, uint32_t packed1, uint32_t packed2, uint32_t packed3)
{
   ...
   (*unpacked).ip_recipient_revision = packed3 >> 8 & 255;
}
...
void v3d_pack_shadrec_gl_main(uint32_t *packed, const V3D_SHADREC_GL_MAIN_T *unpacked)
{
   packed[0] = gfx_bits((*unpacked).point_size_included, 1) |
      ...
      gfx_bits((*unpacked).fs_working_size, 8) << 24;
   packed[1] = gfx_bits((*unpacked).cs_output_size, 8) |
      gfx_bits((*unpacked).cs_working_size, 8) << 8 |
      gfx_bits((*unpacked).vs_output_size, 8) << 16 |
      gfx_bits((*unpacked).vs_working_size, 8) << 24;
...
{
   packed[0] = gfx_bits((*unpacked).tess_enabled, 1) |
      gfx_bits((*unpacked).tess_type, 2) << 1 |
   ...
   packed[2] = gfx_bits((*unpacked).geom_enabled, 1) |
      gfx_bits((*unpacked).geom_output, 2) << 1 |
      gfx_bits((*unpacked).geom_clockwise, 1) << 3 |
      gfx_bits((*unpacked).geom_max_prims, 16) << 16;
   packed[3] = gfx_check_urange((*unpacked).geom_output_bin.size_sectors, 0, 16) |
      gfx_bits((*unpacked).geom_output_bin.pack, 2) << 6 | gfx_check_urange(
      (*unpacked).geom_output_render.size_sectors, 0, 16) << 8 |
      gfx_bits((*unpacked).geom_output_render.pack, 2) << 14 |
      gfx_check_urange((*unpacked).geom_num_instances, 1, 32) << 16;
}
...
{
   return gfx_bits((*unpacked).tmuoff_per_sample, 1) |
...
{
   return (uint8_t)gfx_bits((*unpacked).op, 8);
}
...
void v3d_pack_tmu_indirect_not_child_image(uint32_t *packed, const V3D_TMU_INDIRECT_T *unpacked)
{
   ...
   packed[3] = gfx_pack_uint_0_is_max((*unpacked).depth, 14) >> 10 |
      ...
      gfx_bits((*unpacked).etcflip, 1) << 30 | gfx_bits((*unpacked).swapst, 1) << 31;
...
void v3d_pack_tmu_tex_state(uint8_t *packed, const V3D_TMU_TEX_STATE_T *unpacked)
{
   packed[0] = (uint8_t)gfx_bits((*unpacked).flipx, 1) |
      (uint8_t)(gfx_bits((*unpacked).flipy, 1) << 1) |
      (uint8_t)(gfx_bits((*unpacked).swapst, 1) << 2) |
...
uint32_t v3d_pack_hub_ident3(const V3D_HUB_IDENT3_T *unpacked)
{
   return gfx_bits((*unpacked).ip_recipient, 8) |
      gfx_bits((*unpacked).ip_recipient_revision, 8) << 8;
}
...
void v3d_print_shadrec_gl_main(const uint32_t *packed, struct v3d_printer *printer)
{
   ...
   printer->vtbl->field(printer, "fs_working_size", "%" PRIu32 "", packed[0] >> 24);
   printer->vtbl->field(printer, "cs_output_size", "%" PRIu32 "", packed[1] & 255);
   printer->vtbl->field(printer, "cs_working_size", "%" PRIu32 "",
      packed[1] >> 8 & 255);
   printer->vtbl->field(printer, "vs_output_size", "%" PRIu32 "",
      packed[1] >> 16 & 255);
   printer->vtbl->field(printer, "vs_working_size", "%" PRIu32 "", packed[1] >> 24);
...
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->boolean_field(printer, "tess_enabled", packed[0] & 1);
   ...
   printer->vtbl->field(printer, "size_sectors", "%" PRIu32 "",
      gfx_check_urange(packed[1] & 63, 0, 16));
   printer->vtbl->field(printer, "pack", "%s", v3d_desc_cl_tcs_output_pack(
      (v3d_cl_tcs_output_pack_t)(packed[1] >> 6 & 3)));
   printer->vtbl->end(printer);
   ...
   printer->vtbl->field(printer, "size_sectors", "%" PRIu32 "",
      gfx_check_urange(packed[1] >> 24 & 63, 0, 16));
   printer->vtbl->field(printer, "pack", "%s", v3d_desc_cl_tcs_output_pack(
      (v3d_cl_tcs_output_pack_t)(packed[1] >> 30)));
   printer->vtbl->end(printer);
   printer->vtbl->boolean_field(printer, "geom_enabled", packed[2] & 1);
   printer->vtbl->field(printer, "geom_output", "%s", v3d_desc_cl_geom_prim_type(
      (v3d_cl_geom_prim_type_t)(packed[2] >> 1 & 3)));
   printer->vtbl->boolean_field(printer, "geom_clockwise", packed[2] >> 3 & 1);
   printer->vtbl->field(printer, "geom_max_prims", "%" PRIu32 "", packed[2] >> 16);
   ...
   printer->vtbl->field(printer, "geom_num_instances", "%" PRIu32 "",
      gfx_check_urange(packed[3] >> 16 & 255, 1, 32));
   printer->vtbl->end(printer);
}
...
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->boolean_field(printer, "tmuoff_per_sample", packed0 & 1);
...
void v3d_print_tsy_config(uint8_t packed0, struct v3d_printer *printer)
{
   ...
   printer->vtbl->field(printer, "op", "%s",
      v3d_desc_tsy_op((v3d_tsy_op_t)(uint32_t)packed0));
   printer->vtbl->end(printer);
}
...
void v3d_print_tmu_indirect(const uint32_t *packed, struct v3d_printer *printer)
{
   ...
   printer->vtbl->boolean_field(printer, "swapst", packed[3] >> 31);
...
void v3d_print_tmu_tex_state(const uint8_t *packed, struct v3d_printer *printer)
{
   ...
   printer->vtbl->boolean_field(printer, "swapst", (uint32_t)(packed[0] >> 2 & 1));
...
void v3d_print_clip_record(const uint32_t *packed, struct v3d_printer *printer)
{
   ...
   printer->vtbl->field(printer, "zs", "%f", gfx_float_from_bits(packed[2]));
   printer->vtbl->field(printer, "rw", "%f", gfx_float_from_bits(packed[3]));
   printer->vtbl->begin(printer, V3D_PRINTER_ARRAY, "vcoeff", false);
   printer->vtbl->field(printer, "0", "%f", gfx_float_from_bits(packed[4]));
   printer->vtbl->field(printer, "1", "%f", gfx_float_from_bits(packed[5]));
   printer->vtbl->field(printer, "2", "%f", gfx_float_from_bits(packed[6]));
   printer->vtbl->end(printer);
   printer->vtbl->end(printer);
}
...
void v3d_print_hub_ident3(uint32_t packed0, struct v3d_printer *printer)
{
   ...
   printer->vtbl->field(printer, "ip_recipient_revision", "%" PRIu32 "",
      packed0 >> 8 & 255);
   printer->vtbl->end(printer);
}
...
uint32_t v3d_cl_instr_size(v3d_cl_opcode_t opcode)
{
   ...
   case V3D_CL_BRANCH_SUB_AUTOCHAIN:
   case V3D_CL_BRANCH_SUB:
   case V3D_CL_BRANCH: return V3D_CL_BRANCH_SIZE;
...
bool v3d_cl_instr_ok_in_bin(v3d_cl_opcode_t opcode)
{
   ...
   case V3D_CL_BRANCH_SUB_AUTOCHAIN:
   case V3D_CL_BRANCH_SUB:
   case V3D_CL_BRANCH: return true;
...
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->field(printer, "prim_type", "%s", v3d_desc_prim_type(
      (v3d_prim_type_t)(uint32_t)(packed[0] & 63)));
...
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->field(printer, "r", "%f", gfx_float16_to_float(
      (uint32_t)packed[0] | (uint32_t)packed[1] << 8));
   printer->vtbl->field(printer, "g", "%f", gfx_float16_to_float(
      (uint32_t)packed[2] | (uint32_t)packed[3] << 8));
   printer->vtbl->field(printer, "b", "%f", gfx_float16_to_float(
      (uint32_t)packed[4] | (uint32_t)packed[5] << 8));
   printer->vtbl->field(printer, "a", "%f", gfx_float16_to_float(
      (uint32_t)packed[6] | (uint32_t)packed[7] << 8));
   printer->vtbl->end(printer);
}
...
{
   printer->vtbl->field(printer, NULL, "%f", gfx_float_from_bits(
      (uint32_t)packed[0] | (uint32_t)packed[1] << 8 | (uint32_t)packed[2] << 16 |
      (uint32_t)packed[3] << 24));
}
...
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->field(printer, "factor", "%f", gfx_float_from_bits(
      ((uint32_t)packed[0] | (uint32_t)packed[1] << 8) << 16));
   printer->vtbl->field(printer, "units", "%f", gfx_float_from_bits(
...
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->field(printer, "min", "%f", gfx_float_from_bits(
      (uint32_t)packed[0] | (uint32_t)packed[1] << 8 | (uint32_t)packed[2] << 16 |
      (uint32_t)packed[3] << 24));
   printer->vtbl->field(printer, "max", "%f", gfx_float_from_bits(
      (uint32_t)packed[4] | (uint32_t)packed[5] << 8 | (uint32_t)packed[6] << 16 |
      (uint32_t)packed[7] << 24));
   printer->vtbl->end(printer);
}
...
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->field(printer, "scale_x", "%f", gfx_float_from_bits(
      (uint32_t)packed[0] | (uint32_t)packed[1] << 8 | (uint32_t)packed[2] << 16 |
      (uint32_t)packed[3] << 24));
   printer->vtbl->field(printer, "scale_y", "%f", gfx_float_from_bits(
      (uint32_t)packed[4] | (uint32_t)packed[5] << 8 | (uint32_t)packed[6] << 16 |
      (uint32_t)packed[7] << 24));
   printer->vtbl->end(printer);
}
...
{
   printer->vtbl->begin(printer, V3D_PRINTER_STRUCT, NULL, false);
   printer->vtbl->field(printer, "scale", "%f", gfx_float_from_bits(
      (uint32_t)packed[0] | (uint32_t)packed[1] << 8 | (uint32_t)packed[2] << 16 |
      (uint32_t)packed[3] << 24));
   printer->vtbl->field(printer, "offset", "%f", gfx_float_from_bits(
      (uint32_t)packed[4] | (uint32_t)packed[5] << 8 | (uint32_t)packed[6] << 16 |
      (uint32_t)packed[7] << 24));
   printer->vtbl->end(printer);
}
...
void v3d_cl_print_instr(const uint8_t *packed_instr, struct v3d_printer *printer)
{
   ...
   case V3D_CL_BRANCH_SUB_AUTOCHAIN:
   case V3D_CL_BRANCH_SUB:
   case V3D_CL_BRANCH: v3d_cl_print_branch(packed_instr + 1, printer); break;
...
{
   packed[0] = (uint8_t)gfx_bits((*unpacked).prim_type, 6) |
...
{
   (*unpacked).prim_type = (v3d_prim_type_t)(uint32_t)(packed[0] & 63);
...
void v3d_cl_pack_instr(uint8_t *packed_instr, const V3D_CL_INSTR_T *instr)
{
   ...
   case V3D_CL_BRANCH_SUB_AUTOCHAIN:
   case V3D_CL_BRANCH_SUB:
   case V3D_CL_BRANCH: v3d_cl_pack_branch(packed_instr + 1, &instr->u.branch); break;
...
void v3d_cl_unpack_instr(V3D_CL_INSTR_T *instr, const uint8_t *packed_instr)
{
   ...
   case V3D_CL_BRANCH_SUB_AUTOCHAIN:
   case V3D_CL_BRANCH_SUB:
   case V3D_CL_BRANCH: v3d_cl_unpack_branch(&instr->u.branch, packed_instr + 1); break;
   case V3D_CL_RETURN: break;
   case V3D_CL_FLUSH_VCD_CACHE: break;
