 ...
 * Module Description:
 *
 * THIS IS A STUB of bimg.h. This is only used for the xvd_save_FW_Image
 * program.
 *
 * Revision History:
 *
 * $brcm_Log: /rockford/applications/xvd_save_FW_image/bimg.h $
 *
