 ...
 *
 *****************************************************************************/
#ifndef FILE_SWITCHER_H__
#define FILE_SWITCHER_H__ 1

#include <stdbool.h>

typedef struct FileSwitcher * FileSwitcherHandle;
typedef bool (*FileFilter)(const char * filename);
