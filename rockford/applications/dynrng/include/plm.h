...
PlmHandle plm_create(const char * name, const char * sdr2hdrRoot, const char * hdr2sdrRoot, unsigned index, unsigned rect, PwlPointMutator set_point, PwlPointAccessor get_point, bool demo);
