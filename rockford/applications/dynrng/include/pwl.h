...
typedef struct PwlCurve * PwlCurveHandle;

/* mutator programs hardware */
typedef void (*PwlPointMutator)(unsigned inputIndex, unsigned rectIndex, unsigned pointIndex, double slopeMantissa, int slopeExponent, double x, double y);
