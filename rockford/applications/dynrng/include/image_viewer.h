 ...
 *
 *****************************************************************************/
#ifndef IMAGE_VIEWER_H__
#define IMAGE_VIEWER_H__ 1

#include "platform_types.h"

typedef struct ImageViewer * ImageViewerHandle;

typedef void (*ImageViewerPictureChangedCallback)(void * context, PlatformPictureHandle pic);

typedef struct ImageViewerCreateSettings
{
    ...
    struct
    {
        ImageViewerPictureChangedCallback callback;
        void * context;
    } pictureChanged;
} ImageViewerCreateSettings;
