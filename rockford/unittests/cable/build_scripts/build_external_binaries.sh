...
make -j NEXUS_SYSTEM_CABLE=y NEXUS_USE_7268_VMS=y  CABLE_SUPPORT=y CABLECARD_SUPPORT=n ESTB_CFG_SUPPORT=n NEXUS_MODE=proxy BDSP_3RDPARTY_ALGO_SUPPORT=n clean
make -j NEXUS_SYSTEM_CABLE=y NEXUS_USE_7268_VMS=y  CABLE_SUPPORT=y CABLECARD_SUPPORT=n ESTB_CFG_SUPPORT=n NEXUS_MODE=proxy BDSP_3RDPARTY_ALGO_SUPPORT=n install
cp ../../../../obj.$NEXUS_PLATFORM/BSEAV/bin/refsw-$today.$NEXUS_PLATFORM-linux-atlas.bin.tgz $destination/binaries/external/$NEXUS_PLATFORM/refsw-$reldate.97268a0_vms-linux-atlas-cable.bin.tgz
make -j NEXUS_SYSTEM_CABLE=y NEXUS_USE_7268_VMS=y  CABLE_SUPPORT=y CABLECARD_SUPPORT=n ESTB_CFG_SUPPORT=n NEXUS_MODE=proxy BDSP_3RDPARTY_ALGO_SUPPORT=n clean
