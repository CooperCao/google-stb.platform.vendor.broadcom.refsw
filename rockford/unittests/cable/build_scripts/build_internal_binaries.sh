...
cp ../../../../obj.$NEXUS_PLATFORM/BSEAV/bin/refsw-$today.97439-linux-atlas.bin.tgz $destination/binaries/internal/93390/refsw-$reldate.93390VMS52S-linux-atlas-cable.bin.tgz
...
# 97252S GW B0
source /opt/brcm/scripts/plat 97439 B0 le
make -j NEXUS_USE_7252S_GW=y VIDEO_ENCODER_SUPPORT=y clean
make -j NEXUS_USE_7252S_GW=y VIDEO_ENCODER_SUPPORT=y install
cp ../../../../obj.$NEXUS_PLATFORM/BSEAV/bin/refsw-$today.97439-linux-atlas.bin.tgz $destination/binaries/build_script/refsw-$reldate.97252S_GW-linux-atlas-cable.bin.tgz
