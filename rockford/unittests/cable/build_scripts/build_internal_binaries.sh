...
source ../../../tools/build/plat 97435 b0 le VMS_SFF
make -j CABLE_SUPPORT=y NEXUS_PLATFORM_7425_CABLE=y  NEXUS_USE_7425_VMS_SFF=y NEXUS_PLATFORM_DOCSIS_OOB_SUPPORT=y NEXUS_PLATFORM_DOCSIS_PLUS_BCM3128_IB_SUPPORT=y ESTB_SNMP_SUPPORT=n clean
make -j  CABLE_SUPPORT=y NEXUS_PLATFORM_7425_CABLE=y  NEXUS_USE_7425_VMS_SFF=y NEXUS_PLATFORM_DOCSIS_OOB_SUPPORT=y NEXUS_PLATFORM_DOCSIS_PLUS_BCM3128_IB_SUPPORT=y ESTB_SNMP_SUPPORT=n install
...
source ../../../tools/build/plat 97435 b0 le VMS_SFF
make -j CABLE_SUPPORT=y NEXUS_PLATFORM_DOCSIS_BCM33843_SUPPORT=y NEXUS_PLATFORM_7425_CABLE=y  NEXUS_USE_7425_VMS_SFF=y NEXUS_PLATFORM_DOCSIS_OOB_SUPPORT=y NEXUS_PLATFORM_DOCSIS_PLUS_BCM3128_IB_SUPPORT=y ESTB_SNMP_SUPPORT=n clean
make -j  CABLE_SUPPORT=y NEXUS_PLATFORM_DOCSIS_BCM33843_SUPPORT=y NEXUS_PLATFORM_7425_CABLE=y  NEXUS_USE_7425_VMS_SFF=y NEXUS_PLATFORM_DOCSIS_OOB_SUPPORT=y NEXUS_PLATFORM_DOCSIS_PLUS_BCM3128_IB_SUPPORT=y ESTB_SNMP_SUPPORT=n install
...
#source ../../tools/build/plat  97439 A0 le VMS_SFF
#make BHDM_CEC_SUPPORT=n CDL_SUPPORT=n  DCC_SUPPORT=n ESTB_SNMP_SUPPORT=n  NEXUS_SYSTEM_CABLE=y CABLE_SUPPORT=y NEXUS_PLATFORM_7439_VMS=y clean
#make BHDM_CEC_SUPPORT=n CDL_SUPPORT=n  DCC_SUPPORT=n ESTB_SNMP_SUPPORT=n  NEXUS_SYSTEM_CABLE=y CABLE_SUPPORT=y NEXUS_PLATFORM_7439_VMS=y install
...
make -j BHDM_CEC_SUPPORT=n CDL_SUPPORT=n  NEXUS_FRONTEND_3128=y ESTB_SNMP_SUPPORT=n  NEXUS_SYSTEM_CABLE=y CABLE_SUPPORT=y NEXUS_FRONTEND_DOCSIS=y NEXUS_PLATFORM_DOCSIS_OOB_SUPPORT=y clean
make -j BHDM_CEC_SUPPORT=n CDL_SUPPORT=n  NEXUS_FRONTEND_3128=y ESTB_SNMP_SUPPORT=n  NEXUS_SYSTEM_CABLE=y CABLE_SUPPORT=y NEXUS_FRONTEND_DOCSIS=y NEXUS_PLATFORM_DOCSIS_OOB_SUPPORT=y install
...
make -j BHDM_CEC_SUPPORT=n CDL_SUPPORT=n  ESTB_SNMP_SUPPORT=n  NEXUS_SYSTEM_CABLE=y NEXUS_FRONTEND_DOCSIS=y NEXUS_USE_3390_VMS=y clean
make -j BHDM_CEC_SUPPORT=n CDL_SUPPORT=n  ESTB_SNMP_SUPPORT=n  NEXUS_SYSTEM_CABLE=y NEXUS_FRONTEND_DOCSIS=y NEXUS_USE_3390_VMS=y install
cp ../../../../obj.$NEXUS_PLATFORM/BSEAV/bin/refsw-$today.$NEXUS_PLATFORM-linux-atlas.bin.tgz $destination/binaries/internal/93390/refsw-$reldate.93390VMS52S-linux-atlas-cable.bin.tgz
cp ../../../../obj.$NEXUS_PLATFORM/BSEAV/bin/refsw-$today.$NEXUS_PLATFORM-linux-atlas.bin.tgz $destination/binaries/build_script/refsw-$reldate.93390VMS52S-linux-atlas-cable.bin.tgz
cp ../../../cable/bin/93390/* $destination/binaries/docsis/93390/
make -j BHDM_CEC_SUPPORT=n CDL_SUPPORT=n  ESTB_SNMP_SUPPORT=n  NEXUS_SYSTEM_CABLE=y NEXUS_FRONTEND_DOCSIS=y NEXUS_USE_3390_VMS=y clean

# 97252S GW B0
source ../../../tools/build/plat 97439 B0 le
make -j NEXUS_USE_7252S_GW=y VIDEO_ENCODER_SUPPORT=y clean
make -j NEXUS_USE_7252S_GW=y VIDEO_ENCODER_SUPPORT=y install
cp ../../../../obj.$NEXUS_PLATFORM/BSEAV/bin/refsw-$today.$NEXUS_PLATFORM-linux-atlas.bin.tgz $destination/binaries/build_script/refsw-$reldate.97252S_GW-linux-atlas-cable.bin.tgz
make -j NEXUS_USE_7252S_GW=y VIDEO_ENCODER_SUPPORT=y clean

# 97268 A0 VMS
source ../../../tools/build/plat 97268 A0 32
make -j NEXUS_SYSTEM_CABLE=y NEXUS_USE_7268_VMS=y  CABLE_SUPPORT=y CABLECARD_SUPPORT=n ESTB_CFG_SUPPORT=n clean
make -j NEXUS_SYSTEM_CABLE=y NEXUS_USE_7268_VMS=y  CABLE_SUPPORT=y CABLECARD_SUPPORT=n ESTB_CFG_SUPPORT=n install
cp ../../../../obj.$NEXUS_PLATFORM/BSEAV/bin/refsw-$today.$NEXUS_PLATFORM-linux-atlas.bin.tgz $destination/binaries/internal/$NEXUS_PLATFORM/refsw-$reldate.97268a0_vms-linux-atlas-cable.bin.tgz
cp ../../../../obj.$NEXUS_PLATFORM/BSEAV/bin/refsw-$today.$NEXUS_PLATFORM-linux-atlas.bin.tgz $destination/binaries/build_scripts/refsw-$reldate.97268a0_vms-linux-atlas-cable.bin.tgz
cp ../../../cable/bin/$NEXUS_PLATFORM/*.bin $destination/binaries/docsis/$NEXUS_PLATFORM/
make -j NEXUS_SYSTEM_CABLE=y NEXUS_USE_7268_VMS=y  CABLE_SUPPORT=y CABLECARD_SUPPORT=n ESTB_CFG_SUPPORT=n clean

# 97445 E0 VMS_SFF
source ../../../tools/build/plat  97445 E0 le VMS_SFF
make -j BHDM_CEC_SUPPORT=n CDL_SUPPORT=n  DCC_SUPPORT=n  NEXUS_SYSTEM_CABLE=y CABLE_SUPPORT=y ESTB_SNMP_SUPPORT=n clean
make -j  BHDM_CEC_SUPPORT=n CDL_SUPPORT=n  DCC_SUPPORT=n  NEXUS_SYSTEM_CABLE=y CABLE_SUPPORT=y ESTB_SNMP_SUPPORT=n install
