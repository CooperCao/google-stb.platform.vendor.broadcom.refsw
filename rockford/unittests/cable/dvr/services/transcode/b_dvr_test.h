...
#define MAX_DRM_PER_STREAMPATH          4
#define MAX_DRM_PLAYBACK                2
...
struct DvrTest_StreamPath
{
    ...
    B_DVR_DRMServiceHandle drmService[MAX_DRM_PER_STREAMPATH];
...
struct DvrTest
{
    ...
    B_DVR_DRMServiceHandle drmPbService[MAX_DRM_PLAYBACK];     
    NEXUS_DmaHandle pbDma[MAX_DRM_PLAYBACK];	
};
