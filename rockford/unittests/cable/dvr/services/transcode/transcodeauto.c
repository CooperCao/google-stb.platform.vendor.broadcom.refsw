...
B_EventHandle TSBServiceReady, TSBConversionComplete;
...
unsigned AudioCodec, char *subDir, char *programName)
{
    ...
    printf("\n\n--------------------------------------\n");
    printf("Starting Dvr_FiletoFile_TranscodeStart\n");
    printf("--------------------------------------\n");
...
B_DVR_ERROR Dvr_FileToFile_TranscodeStop(unsigned pathIndex)
{
    ...
    printf("\n\n-------------------------------------\n");
    printf("Starting Dvr_FiletoFile_TranscodeStop\n");
    printf("-------------------------------------\n");
...
int main(void)
{
    ...
    for (v = 0; v < 2; v++)
    {
        for (a = 0; a < 6; a++)
        {
            VideoCodec = videoCodecArray[v];
            AudioCodec = audioCodecArray[a];
