...
B_DVR_ERROR create_metadata_list(unsigned volIndex, char *subDir, char *programName)
{
...
B_DVR_ERROR B_DVR_Recordings_List(int volIndex, char *subDir, struct recordfile_list *record_start)
{
