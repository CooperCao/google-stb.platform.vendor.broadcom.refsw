...
#ifndef DYNRNG_SHELL_H__
#define DYNRNG_SHELL_H__

typedef int (*SHELL_CommandHandler)(void * context, char * args);

typedef struct SHELL_Shell * SHELL_ShellHandle;
typedef struct SHELL_Command * SHELL_CommandHandle;
