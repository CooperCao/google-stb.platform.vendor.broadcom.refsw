...
#ifndef DYNRNG_UTILS_PRIV_H__
#define DYNRNG_UTILS_PRIV_H__

#include "blst_queue.h"

typedef struct UTILS_StringNameValuePair
{
    BLST_Q_ENTRY(UTILS_StringNameValuePair) link;
    char * key;
    char * value;
} UTILS_StringNameValuePair;

BLST_Q_HEAD(UTILS_StringMap, UTILS_StringNameValuePair) UTILS_StringMap;
