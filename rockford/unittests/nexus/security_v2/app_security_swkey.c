...
int main(int argc, char **argv)
{
    ...
    printf("Firmware Version: %d.%d.%d \n", securityCapabilities.version.bfw.major
	...
	{
        printf("    FAILED!\n");
		DEBUG_PRINT_ARRAY("key:", (int)sizeof(plaintext), key );
		DEBUG_PRINT_ARRAY("Source:", (int)sizeof(plaintext), pSrc );
		DEBUG_PRINT_ARRAY("Destination", (int)sizeof(plaintext), pDest );
	}
	else
	{
		printf("    PASSED!\n");
