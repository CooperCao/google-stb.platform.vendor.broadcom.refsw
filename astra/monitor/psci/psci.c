...
static int cpu_detach(psci_cpu_t *pcpu)
{
     ...
     * infocenter.arm.com/help/ index.jsp?topic=/com.arm.doc.ddi0500d/CACJFAJC.html
     */
    ...
    /* 2.0 Execute a ISB instruction */
    /* 2.1 Execute a DSB SY instruction */
    isb();
    dsb();

    /* 2. Clean and invalidate data cache */
    dcsw_op_all(DCCISW);
