...
#define GIC_CPU_ID_SHIFT    10
#define GIC_CPU_ID_MASK     0x7

#define GIC_INTR_ID(iid)      (((iid) >> GIC_INTR_ID_SHIFT) & GIC_INTR_ID_MASK)
#define GIC_CPU_ID(iid)       (((iid) >> GIC_CPU_ID_SHIFT)  & GIC_CPU_ID_MASK)
