...
#define CTX_INCLUDE_AARCH32_REGS	1
#define CTX_INCLUDE_FPREGS		1
#define CTX_INCLUDE_TIMER_SYSREGS	0

#define CTX_SYSREGS_FLAG_SHIFT		0
#define CTX_FPREGS_FLAG_SHIFT		1
#define CTX_EL3STATE_FLAG_SHIFT		2
#define CTX_GPREGS_FLAG_SHIFT		3

#define CTX_SYSREGS_FLAG		(1 << CTX_SYSREGS_FLAG_SHIFT)
#define CTX_FPREGS_FLAG			(1 << CTX_FPREGS_FLAG_SHIFT)
#define CTX_EL3STATE_FLAG		(1 << CTX_EL3STATE_FLAG_SHIFT)
#define CTX_GPREGS_FLAG			(1 << CTX_GPREGS_FLAG_SHIFT)
