...
__bootstrap static inline void makeBootstrapPageTables(void *dtreePhysAddr)
{
	...
	uint8_t *puart_start = PAGE_START_4K(UART0_BASE);
	...
	uart_base = (uintptr_t) vtranslated_uart_start;
...
__bootstrap void bootstrapSecondary()
{
	enableMMU();
}
