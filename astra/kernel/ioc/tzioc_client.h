...
public:
    ...
    static void kernelClientClose(
        struct tzioc_client *pClient);

    static struct tzioc_client *userClientOpen(
        const char *pName,
        TzTask *pTask,
        int msgQ);

    static void userClientClose(
        struct tzioc_client *pClient);
...
public:
    ...
    TzIocClient() = delete;
    ~TzIocClient() = delete;
    TzIocClient& operator = (const TzIocClient&) = delete;
...
private:
    ...
    static struct tzioc_client_cb clientCB;

    /* use static array for clients */
    static struct tzioc_client clients[TZIOC_CLIENT_NUM_MAX];
