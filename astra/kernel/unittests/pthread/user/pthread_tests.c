...
thread_idle(void *arg)
{
    ...
    printf("Thread idle started. pid %d\n", getpid());
    ...
    sleep(10);
    printf("Thread idle exiting. pid %d\n", getpid());
...
thread_edf1(void *arg)
{
    ...
    printf("Thread edf1 started. pid %d\n", getpid());
    ...
    sleep(10);
    printf("Thread edf1 exiting. pid %d\n", getpid());
...
thread_edf2(void *arg)
{
    ...
    printf("Thread edf2 started. pid %d\n", getpid());
    ...
    sleep(10);
    printf("Thread edf2 exiting. pid %d\n", getpid());
