...
#define SYS_CALL_EXIT(exitCode)  asm volatile("mov w1, %[arg]\r\n mov w0, %[svcnum]\r\n svc #0\r\n"::[arg] "r" (exitCode), [svcnum] "r" (SVC_NUM_SYS_CALL_EXIT): "r0", "r1")
#endif
...
#define EXT_set_thread_area     0xf0005
#define EXT_get_thread_area     0xf0006
#define EXT_tracelog_inval      0xf0007
