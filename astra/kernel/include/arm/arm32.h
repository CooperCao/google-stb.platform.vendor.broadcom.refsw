...
#define ARCH_SPECIFIC_ENABLE_FIQ asm volatile("cpsie f":::)

#define ARCH_SPECIFIC_DISABLE_INTERRUPTS asm volatile("cpsid aif":::)
#define ARCH_SPECIFIC_DISABLE_FIQ asm volatile("cpsid f":::)
