...
#ifndef INCLUDE_VIRTUALUARTFOPS_H_
#define INCLUDE_VIRTUALUARTFOPS_H_
...
int init(bool isVuartChosen);
int peerUp(void);
int peerDown(void);

/* VuartFile class is a singleton class */
class VuartFile : public IFile {
public:
    ...
    static VuartFile *getInstance(void) {
        if (!instance) {
            init();
        }
        return instance;
...
#endif /* INCLUDE_VIRTUALUARTFOPS_H_ */
