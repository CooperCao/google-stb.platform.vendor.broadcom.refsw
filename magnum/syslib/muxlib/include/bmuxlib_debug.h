...
#ifndef BMUXLIB_DEBUG_H_
#define BMUXLIB_DEBUG_H_
...
#define BMUXlib_Malloc(_size) BMUXlib_Malloc_tagged(_size, __FILE__, __LINE__)
#else
#define BMUXlib_Malloc BKNI_Malloc
#endif
