...
typedef struct
{
   uint32_t uiSignature;                     /* [DO NOT MODIFY] Populated by BMUXlib_File_PES_GetDefaultCreateSettings() */
} BMUXlib_File_PES_CreateSettings;
...
} BMUXlib_File_PES_StartSettings;
...
/* Handle to PES File Mux instance */
typedef struct BMUXlib_File_PES_P_Context *BMUXlib_File_PES_Handle;
...
/*
   ...
   Returns:
      None
*/
void BMUXlib_File_PES_GetDefaultCreateSettings(
            BMUXlib_File_PES_CreateSettings  *pCreateSettings);/* [out] location to write the default create settings */
...
*/
BERR_Code BMUXlib_File_PES_Create(
            BMUXlib_File_PES_Handle          *phPESMux,        /* [out] location to write the created PES Mux Handle */
      const BMUXlib_File_PES_CreateSettings  *pCreateSettings);/* [in] configuration settings */
...
/*
   ...
   Returns:
      None
*/
void BMUXlib_File_PES_Destroy(
            BMUXlib_File_PES_Handle          hPESMux);         /* [in] Handle of the mux to destroy */
...
/*
   ...
   Returns:
      None
*/
void BMUXlib_File_PES_GetDefaultStartSettings(
            BMUXlib_File_PES_StartSettings  *pStartSettings);  /* [out] location to write the default start settings */
...
/*
   ...
   Returns:
      ...
      BERR_NOT_SUPPORTED         - Start() invoked from invalid state (must be invoked
                                   from "stopped" state).
*/
BERR_Code BMUXlib_File_PES_Start(
            BMUXlib_File_PES_Handle          hPESMux,          /* [in] Handle of the mux */
      const BMUXlib_File_PES_StartSettings  *pStartSettings);  /* [in] Settings to use for muxing */
...
/*
   ...
   Returns:
      None
*/
void BMUXlib_File_PES_GetDefaultFinishSettings(
            BMUXlib_File_PES_FinishSettings *pFinishSettings); /* [out] location to write default finish settings */
...
*/
BERR_Code BMUXlib_File_PES_Finish(
            BMUXlib_File_PES_Handle          hPESMux,          /* [in] handle of the mux */
      const BMUXlib_File_PES_FinishSettings *pFinishSettings); /* [in] Settings to use to finish the mux */
...
*/
BERR_Code BMUXlib_File_PES_Stop(
            BMUXlib_File_PES_Handle          hPESMux);         /* [in] Handle of the mux */
...
*/
BERR_Code BMUXlib_File_PES_DoMux(
            BMUXlib_File_PES_Handle          hPESMux,          /* [in] Handle of the mux */
