...
#ifndef BMUXLIB_ASP_OUTPUT_PRIV_H_
#define BMUXLIB_ASP_OUTPUT_PRIV_H_

#include "bmuxlib_asp_output_context.h"

typedef struct BMUXlib_ASP_Output_Context_t* BMUXlib_ASP_Output_Handle;
...
BMUXlib_ASP_P_Output_Descriptor_Send(
   ...
   BMUXlib_ASP_Output_Descriptor_t *pstOutputDescriptor,
   BMUXlib_ASP_Output_Descriptor_Metadata_t *pstOutputDescriptorMetadata,
   BMUXlib_ASP_Timing_Metadata_t *pstSourceTimingMetadata
   );
...
#endif /* BMUXLIB_ASP_OUTPUT_PRIV_H_ */
