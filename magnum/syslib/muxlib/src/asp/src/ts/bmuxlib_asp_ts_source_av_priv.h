...
#ifndef BMUXLIB_ASP_SOURCE_AV_PRIV_H_
#define BMUXLIB_ASP_SOURCE_AV_PRIV_H_

#include "bmuxlib_asp_ts_channel_priv.h"
#include "bmuxlib_asp_source_entry_priv.h"

typedef struct BMUXlib_ASP_TS_Source_AV_Context_t* BMUXlib_ASP_TS_Source_AV_Handle;
...
#endif /* BMUXLIB_ASP_SOURCE_AV_PRIV_H_ */
