...
#ifndef BMUXLIB_ASP_MEMORY_PRIV_H_
#define BMUXLIB_ASP_MEMORY_PRIV_H_

#include "bmuxlib_asp_ts_memory_context.h"
#include "bmuxlib_asp_output_priv.h"

typedef struct BMUXlib_ASP_TS_Memory_Context_t* BMUXlib_ASP_TS_Memory_Handle;
...
#endif /* BMUXLIB_ASP_MEMORY_PRIV_H_ */
