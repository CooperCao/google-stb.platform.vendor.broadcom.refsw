...
#ifndef BMUXLIB_ASP_CHANNEL_H_
#define BMUXLIB_ASP_CHANNEL_H_

#include "bmuxlib_asp_ts_channel_context.h"

typedef struct BMUXlib_ASP_TS_Channel_Context_t* BMUXlib_ASP_TS_Channel_Handle;
