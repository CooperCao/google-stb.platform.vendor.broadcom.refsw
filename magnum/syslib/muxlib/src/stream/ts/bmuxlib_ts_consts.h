...
#ifndef MAGNUM_SYSLIB_MUXLIB_SRC_STREAM_TS_BMUXLIB_TS_CONSTS_H_
#define MAGNUM_SYSLIB_MUXLIB_SRC_STREAM_TS_BMUXLIB_TS_CONSTS_H_
...
#endif /* MAGNUM_SYSLIB_MUXLIB_SRC_STREAM_TS_BMUXLIB_TS_CONSTS_H_ */
