...
BSAGElib_Rai_Platform_XXX APIs to Open and Init the Platform and Modules in the Platform.
...
Description:
This API is used to Un-install the Platform/TA that has been installed by BSAGElib_Rai_Platform_Install API
...
/***************************************************************************
Summary:
Enable Callback Request support for the given platform
***************************************************************************/
BERR_Code
