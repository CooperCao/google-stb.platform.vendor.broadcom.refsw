...
typedef struct BSAGE_func{
    void_func Boot_Launch;
    void_func Boot_GetInfo;
    void_func GetStatus;
    void_func Rpc_AddRemote;
    void_func Rpc_RemoveRemote;
    void_func Rpc_SendCommand;
    void_func Rpc_SendCallbackResponse;
    void_func RegisterCallback;
    void_func UnRegisterCallback;
    void_func Management_Reset;
} BSAGE_func;
