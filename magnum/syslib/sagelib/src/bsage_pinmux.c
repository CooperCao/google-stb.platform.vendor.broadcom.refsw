...
BERR_Code BSAGE_P_Init_Serial(BSAGE_Handle hSAGE)
{
    ...
    BDBG_ENTER(BSAGE_P_Init_Serial);
     ...
     */
    reg = BREG_Read32(hSAGE->hReg,BCHP_SUN_TOP_CTRL_PIN_MUX_CTRL_13);
    ...
    BREG_Write32 (hSAGE->hReg, BCHP_SUN_TOP_CTRL_PIN_MUX_CTRL_13, reg);

    /* BCHP_SUN_TOP_CTRL_PIN_MUX_CTRL_14
     * GPIO_068    : UART_TXD_1 (4)
     */
    reg = BREG_Read32(hSAGE->hReg,BCHP_SUN_TOP_CTRL_PIN_MUX_CTRL_14);
    ...
    BREG_Write32 (hSAGE->hReg, BCHP_SUN_TOP_CTRL_PIN_MUX_CTRL_14, reg);
#endif
     ...
     * GPIO_90    : UART_RX1 (1)
     */
    reg = BREG_Read32(hSAGE->hReg,BCHP_SUN_TOP_CTRL_PIN_MUX_CTRL_11);
    reg &= ~(
    ...
    BREG_Write32 (hSAGE->hReg, BCHP_SUN_TOP_CTRL_PIN_MUX_CTRL_11, reg);
#endif
     ...
     */
    reg = BREG_Read32(hSAGE->hReg, BCHP_SUN_TOP_CTRL_PIN_MUX_CTRL_8);
    reg &=~(
    ...
    BREG_Write32 (hSAGE->hReg, BCHP_SUN_TOP_CTRL_PIN_MUX_CTRL_8, reg);
    /* Route SAGE UART to TP_IN_18/TP_OUT_19 */
    reg = BREG_Read32(hSAGE->hReg, BCHP_SUN_TOP_CTRL_UART_ROUTER_SEL_0);
    ...
    BREG_Write32 (hSAGE->hReg, BCHP_SUN_TOP_CTRL_UART_ROUTER_SEL_0, reg);
#else /* VMS_SFF */
     ...
     * GPIO_11    : TP_IN_22 (4)
     */
    reg = BREG_Read32(hSAGE->hReg, BCHP_SUN_TOP_CTRL_PIN_MUX_CTRL_9);
    reg &= ~(
    ...
    BREG_Write32 (hSAGE->hReg, BCHP_SUN_TOP_CTRL_PIN_MUX_CTRL_9, reg);
#else /* BCHP_REV */
    /* BCHP_SUN_TOP_CTRL_PIN_MUX_CTRL_7
     * GPIO_10    : TP_IN_22 (4)
     * GPIO_11    : TP_IN_22 (4)
     */
    reg = BREG_Read32(hSAGE->hReg, BCHP_SUN_TOP_CTRL_PIN_MUX_CTRL_7);
    reg &=~(
    ...
    BREG_Write32 (hSAGE->hReg, BCHP_SUN_TOP_CTRL_PIN_MUX_CTRL_7, reg);
#endif /* BCHP_REV */
    ...
    reg = BREG_Read32(hSAGE->hReg, BCHP_SUN_TOP_CTRL_TEST_PORT_CTRL);
    reg = BCHP_SUN_TOP_CTRL_TEST_PORT_CTRL_encoded_tp_enable_SYS;
    BREG_Write32 (hSAGE->hReg, BCHP_SUN_TOP_CTRL_TEST_PORT_CTRL, reg);
#endif /* BCHP_CHIP */
#if BCHP_CHIP==7439
     ...
     * GPIO_17    : UART_TXD_2
     */
    reg = BREG_Read32(hSAGE->hReg, BCHP_SUN_TOP_CTRL_PIN_MUX_CTRL_2);
    reg &= ~(
    ...
    BREG_Write32 (hSAGE->hReg, BCHP_SUN_TOP_CTRL_PIN_MUX_CTRL_2, reg);

    /* Route UART to UART_RXD_2/UART_TXD_2 */
    reg = BREG_Read32(hSAGE->hReg, BCHP_SUN_TOP_CTRL_UART_ROUTER_SEL_1);
    ...
    BREG_Write32 (hSAGE->hReg, BCHP_SUN_TOP_CTRL_UART_ROUTER_SEL_1, reg);
    ...
    /* pinmux for Tx */
    reg = BREG_Read32(hSAGE->hReg, BCHP_SUN_TOP_CTRL_PIN_MUX_CTRL_12);
    reg &= ~(
    ...
    BREG_Write32 (hSAGE->hReg, BCHP_SUN_TOP_CTRL_PIN_MUX_CTRL_12, reg);
     ...
     */
    /* pinmux for Rx */
    reg = BREG_Read32(hSAGE->hReg,BCHP_SUN_TOP_CTRL_PIN_MUX_CTRL_3);
    ...
    BREG_Write32 (hSAGE->hReg, BCHP_SUN_TOP_CTRL_PIN_MUX_CTRL_3, reg);

    /* BCHP_SUN_TOP_CTRL_PIN_MUX_CTRL_4
     * GPIO_059    : TP_OUT_00
     */
    /* pinmux for Tx */
    reg = BREG_Read32(hSAGE->hReg,BCHP_SUN_TOP_CTRL_PIN_MUX_CTRL_4);
    ...
    BREG_Write32 (hSAGE->hReg, BCHP_SUN_TOP_CTRL_PIN_MUX_CTRL_4, reg);
    ...
    reg = BREG_Read32(hSAGE->hReg, BCHP_SUN_TOP_CTRL_PIN_MUX_CTRL_15);
    reg &= ~(
    ...
    BREG_Write32 (hSAGE->hReg, BCHP_SUN_TOP_CTRL_PIN_MUX_CTRL_15, reg);
    ...
    BREG_Write32 (hSAGE->hReg, BCHP_SUN_TOP_CTRL_UART_ROUTER_SEL_0, reg);
      ...
      */
    reg = BREG_Read32(hSAGE->hReg, BCHP_AON_PIN_CTRL_PIN_MUX_CTRL_1);
    reg &= ~(
    ...
    BREG_Write32 (hSAGE->hReg, BCHP_AON_PIN_CTRL_PIN_MUX_CTRL_1, reg);
    ...
    BDBG_LEAVE(BSAGE_P_Init_Serial);
    return rc;
}
