    ...
    BSAGElib_ManagementInterface *i_management)
{
    ...
    rc = hSAGElib->bsage.RegisterCallback(BSAGE_Event_watchdog,(void *)i_management->watchdog_isr,NULL,NULL);
/*    rc = BSAGE_Management_Register(i_management);*/
    ...
    BSAGElib_ManagementInterface *i_management)
{
    ...
    rc = hSAGElib->bsage.UnRegisterCallback(BSAGE_Event_watchdog,(void *)i_management->watchdog_isr);
/*    rc = BSAGE_Management_Unregister(i_management);*/
    ...
    BSAGElib_Handle hSAGElib)
{
    ...
    hSAGElib->bsage.Management_Reset();
