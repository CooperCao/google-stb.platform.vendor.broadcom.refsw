    ...
    BSAGElib_Settings *settings /* [in] */)
{
    ...
    if (!settings->bsage.Boot_Launch      | !settings->bsage.Management_Reset         |
        !settings->bsage.Boot_GetInfo     | !settings->bsage.GetStatus                |
        !settings->bsage.Rpc_AddRemote    | !settings->bsage.Rpc_RemoveRemote         |
        !settings->bsage.Rpc_SendCommand  | !settings->bsage.Rpc_SendCallbackResponse |
    ...
    instance->bsage.Boot_Launch                = (Boot_Launch_func)              settings->bsage.Boot_Launch;
    instance->bsage.Boot_GetInfo               = (Boot_GetInfo_func)             settings->bsage.Boot_GetInfo;
    instance->bsage.GetStatus                  = (GetStatus_func)                settings->bsage.GetStatus;
    instance->bsage.Rpc_AddRemote              = (Rpc_AddRemote_func)            settings->bsage.Rpc_AddRemote;
    instance->bsage.Rpc_RemoveRemote           = (Rpc_RemoveRemote_func)         settings->bsage.Rpc_RemoveRemote;
    instance->bsage.Rpc_SendCommand            = (Rpc_SendCommand_func)          settings->bsage.Rpc_SendCommand;
    instance->bsage.Rpc_SendCallbackResponse   = (Rpc_SendCallbackResponse_func) settings->bsage.Rpc_SendCallbackResponse;
    instance->bsage.RegisterCallback           = (RegisterCallback_func)         settings->bsage.RegisterCallback;
    instance->bsage.UnRegisterCallback         = (UnRegisterCallback_func)       settings->bsage.UnRegisterCallback;
    instance->bsage.Management_Reset           = (Management_Reset_func)         settings->bsage.Management_Reset;
    ...
    instance->vkl1 = BCMD_VKL_eMax;
    instance->vkl2 = BCMD_VKL_eMax;
    ...
    BSAGElib_Status *pStatus)
{
    ...
    rc = hSAGElib->bsage.GetStatus(pStatus);
/*    rc = BSAGE_GetStatus(pStatus);*/
