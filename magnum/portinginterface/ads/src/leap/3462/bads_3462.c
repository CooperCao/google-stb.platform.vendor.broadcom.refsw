...
#if (BADS_3462_VER == BCHP_VER_A0)
#include "../../../../3462/rdb/a0/bchp_leap_ctrl.h"
#endif
...
BERR_Code BADS_3462_GetLockStatus(
    ...
    )
{
    ...
    BDBG_ENTER(BADS_3462_GetLockStatus);
    BDBG_ASSERT( hChn );
    ...
    BDBG_LEAVE(BADS_3462_GetLockStatus);    
    return retCode;
}
