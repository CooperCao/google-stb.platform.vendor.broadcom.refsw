 ...
 *  ANY LIMITED REMEDY.
 ******************************************************************************/
#ifndef BADS_7255_PRIV_H__
#define BADS_7255_PRIV_H__
...
*
*******************************************************************************/
typedef struct BADS_P_7255_Handle               *BADS_7255_Handle;
typedef struct BADS_P_7255_Handle
{
...
typedef struct BADS_P_7255_ChannelHandle            *BADS_7255_ChannelHandle;
typedef struct BADS_P_7255_ChannelHandle
{
    uint32_t magicId;                   /* Used to check if structure is corrupt */
    BADS_Handle hAds;
    unsigned int chnNo;
...
See Also:
    BADS_7255_Close(), BADS_7255_OpenChannel(), BADS_7255_CloseChannel(),
    BADS_7255_GetDefaultSettings()
...
See Also:
    BADS_7255_Open(), BADS_7255_CloseChannel()
...
See Also:
    BADS_7255_Open(), BADS_7255_Close()
...
See Also:
    BADS_7255_OpenChannel(), BADS_7255_ChannelDefaultSettings()
...
See Also:
    BADS_7255_CloseChannel(), BADS_7255_GetChannelDefaultSettings()
...
See Also:
    BADS_7255_OpenChannel(), BADS_7255_CloseChannel()
...
See Also:
    BADS_7255_GetLockStatus(), BADS_7255_GetStatus()
...
See Also:
    BADS_7255_GetLock(), BADS_7255_GetStatus(), BADS_7255_GetSoftDecision()
...
/***************************************************************************
Summary:
    This function opens configures (enables/disables) the 7255 device's
...
/***************************************************************************
Summary:
    This function opens tells if the 7255 device's RF out daisy chaining is enabled/disabled.
...
/***************************************************************************
Summary:
    This function resets the 7255 device's FEC bit error and block counters.
...
/***************************************************************************
Summary:
    This function performs an i2c read from the slave attached to the 7255's i2c bus.
...
/***************************************************************************
Summary:
    This function performs an i2c write to the slave attached to the 7255's i2c bus.
...
******************************************************************************/
BERR_Code BADS_7255_RequestSpectrumAnalyzerData(
    BADS_ChannelHandle hChn,     /* [in] Device channel handle */
...
******************************************************************************/
BERR_Code BADS_7255_GetSpectrumAnalyzerData(
    BADS_ChannelHandle hChn,     /* [in] Device channel handle */
    BADS_SpectrumData  *pSpectrumData /* [out] spectrum Data*/
    );

BERR_Code BADS_7255_TuneIfDac(
    BADS_ChannelHandle hChn,            /* [in] Device handle */
    BADS_IfDacSettings *pSettings       /* [in] IF DAC Settings */
    );

BERR_Code BADS_7255_ResetIfDacStatus(
    BADS_ChannelHandle hChn        /* [in] Device handle */
    );

BERR_Code BADS_7255_RequestIfDacStatus(
    BADS_ChannelHandle hChn        /* [in] Device handle */
    );

BERR_Code BADS_7255_GetIfDacStatus(
    BADS_ChannelHandle hChn,        /* [in] Device handle */
