 ...
 *  ANY LIMITED REMEDY.
 ******************************************************************************/
#ifndef BADS_3466_PRIV_H__
#define BADS_3466_PRIV_H__
...
*
*******************************************************************************/
typedef struct BADS_P_3466_Handle               *BADS_3466_Handle;
typedef struct BADS_P_3466_Handle
{
...
typedef struct BADS_P_3466_ChannelHandle            *BADS_3466_ChannelHandle;
typedef struct BADS_P_3466_ChannelHandle
{
    uint32_t magicId;                   /* Used to check if structure is corrupt */
    BADS_Handle hAds;
    unsigned int chnNo;
...
See Also:
    BADS_3466_Close(), BADS_3466_OpenChannel(), BADS_3466_CloseChannel(),
    BADS_3466_GetDefaultSettings()
...
See Also:
    BADS_3466_Open(), BADS_3466_CloseChannel()
...
See Also:
    BADS_3466_Open(), BADS_3466_Close()
...
See Also:
    BADS_3466_OpenChannel(), BADS_3466_ChannelDefaultSettings()
...
See Also:
    BADS_3466_CloseChannel(), BADS_3466_GetChannelDefaultSettings()
...
See Also:
    BADS_3466_OpenChannel(), BADS_3466_CloseChannel()
...
See Also:
    BADS_3466_GetLockStatus(), BADS_3466_GetStatus()
...
See Also:
    BADS_3466_GetLock(), BADS_3466_GetStatus(), BADS_3466_GetSoftDecision()
...
/***************************************************************************
Summary:
    This function opens configures (enables/disables) the 3466 device's
...
/***************************************************************************
Summary:
    This function opens tells if the 3466 device's RF out daisy chaining is enabled/disabled.
...
/***************************************************************************
Summary:
    This function resets the 3466 device's FEC bit error and block counters.
...
/***************************************************************************
Summary:
    This function performs an i2c read from the slave attached to the 3466's i2c bus.
...
/***************************************************************************
Summary:
    This function performs an i2c write to the slave attached to the 3466's i2c bus.
...
******************************************************************************/
BERR_Code BADS_3466_RequestSpectrumAnalyzerData(
    BADS_ChannelHandle hChn,     /* [in] Device channel handle */
...
******************************************************************************/
BERR_Code BADS_3466_GetSpectrumAnalyzerData(
    BADS_ChannelHandle hChn,     /* [in] Device channel handle */
    BADS_SpectrumData  *pSpectrumData /* [out] spectrum Data*/
    );

BERR_Code BADS_3466_TuneIfDac(
    BADS_ChannelHandle hChn,            /* [in] Device handle */
    BADS_IfDacSettings *pSettings       /* [in] IF DAC Settings */
    );

BERR_Code BADS_3466_ResetIfDacStatus(
    BADS_ChannelHandle hChn        /* [in] Device handle */
    );

BERR_Code BADS_3466_RequestIfDacStatus(
    BADS_ChannelHandle hChn        /* [in] Device handle */
    );

BERR_Code BADS_3466_GetIfDacStatus(
    BADS_ChannelHandle hChn,        /* [in] Device handle */
