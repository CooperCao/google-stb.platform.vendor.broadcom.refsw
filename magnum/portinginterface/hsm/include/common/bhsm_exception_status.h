...
#ifndef BHSM_VIOLATION_STATUS_H__
#define BHSM_VIOLATION_STATUS_H__
...
typedef enum{
    BHSM_ExceptionStatusDevice_eMemcArch = 0x02
}BHSM_ExceptionStatusDevice_e;
...
}BHSM_ExceptionStatusRequest_t;

/*
Summary:
    Paramater to BHSM_GetExceptionStatus.
*/
typedef struct BHSM_ExceptionStatus_t{
...
} BHSM_ExceptionStatus_t;


/**************************************************************************************************
Description:
This function returns status information on recent violations.
