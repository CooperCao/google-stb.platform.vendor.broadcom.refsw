...
typedef enum BHSM_CaModeShift {
    ...
    BHSM_CaModeShift_eDropFromRSourceShift     = 11,
    BHSM_CaModeShift_eEncryptBeforeRaveShift   = 12,
    BHSM_CaModeShift_eCustomerNoShift          = 13,
    BHSM_CaModeShift_NDVBCSA3DvbCsaVarShift    = 17,
    BHSM_CaModeShift_NDVBCSA3PermShift         = 22,
    BHSM_CaModeShift_NDVBCSA3ModXRCShift       = 25,

    BHSM_CaModeShift_NDVBCSA2KeyCtrlShift      = 17,
    BHSM_CaModeShift_NDVBCSA2IVCtrlShift       = 20,

    BHSM_CaModeShift_ESDVBCSA2ModEnShift    = 17,

    BHSM_CaModeShift_GpipeForceRestrictedShift = 26,
    BHSM_CaModeShift_RpipeForceRestrictedShift = 27
...
typedef enum BHSM_M2mModeShift {
    ...
    BHSM_M2mModeShift_eCounterSizeSel           = 11,
...
typedef struct BHSM_CACryptoAlg {
    ...
    /* In: 1 - drop R region packets */
    bool                            bDropRregionPackets;
    ...
    /* In: 1  - force output packets to R region if it's from G pipe */
    bool                            bGpipePackets2Rregion;

    /* In: 1  - force output packets to R region if it's from R pipe */
    bool                            bRpipePackets2Rregion;
...
BERR_Code BHSM_AllocateCAKeySlot_v2 (
          BHSM_Handle             hHsm,
...
BERR_Code BHSM_FreeCAKeySlot_v2 (
                BHSM_Handle hHsm,
                BHSM_KeySlotAllocate_t *pKeySlotConf
);
