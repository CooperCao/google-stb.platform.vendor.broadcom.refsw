...
{
    /* In:  Flash address of second stage code */
    uint32_t                    codePtr;

    /* In:  Flash address of second stage code signature */
    uint32_t                    codeSigPtr;

    /* In:  How to verify the second stage code  */
    BHSM_2ndStageCodeVerify_e   codeVerifyOpt;

    /* In:  Specify where the second stage code is located */
    BHSM_2ndStageCodeLocation_e codeLocation;

    /* In: second-tier key ID, to be used for verifying the second stage code  */
    BCMD_SecondTierKeyId_e        eKeySelect;
