...
typedef enum BCMD_CustomerSubMode_e
{
    ...
    BCMD_CustomerSubMode_eResserved24       = 0x18,
    BCMD_CustomerSubMode_eResserved25       = 0x19,
    BCMD_CustomerSubMode_eResserved26       = 0x1A,
    BCMD_CustomerSubMode_eResserved27       = 0x1B,
...
typedef enum BCMD_KeyDestBlockType_e
{
    ...
    BCMD_KeyDestBlockType_eUserSha          = 14,
#else
    BCMD_KeyDestBlockType_eReserved7        = 14,
#endif /* USER_SHA_KEY_INCLUDE */
    BCMD_KeyDestBlockType_eKLAD          = 15,
...
{  
    ...
    BCMD_XptM2MSecCryptoAlg_eMSMULTISWAPMAC    = 15,
...
{  
    ...
    BCMD_Key3Op_eReserve1,
    BCMD_Key3Op_eKey3Transform
}BCMD_Key3Op_e;
...
typedef enum BCMD_TerminationMode_e
{
    ...
    BCMD_TerminationMode_eClear             = BCMD_TerminationMode_eCLEAR, 
...
typedef enum BCMD_SolitarySelect_e
{
    ...
    BCMD_SolitarySelect_eReserved1          = 1, /* XPT_SECURITY_KEY_TABLE_MODULE_KEY_MODE_SOLITARY_TERM_SEL_XOR_ENC_0 */
...
|--------------|------------|-------------------------------|------------------------------------| 
|  NoKeyGenFlag| unused     | BCMD_GenKey_InCmd_eCustomerSel| BCMD_GenKey_InCmd_eRootKeySrc| 
|--------------|------------|-------------------------------|------------------------------------| 
...
|  31..24      | 23..16     | 15..8                             | 7..0                                   | 
|--------------|------------|-----------------------------------|----------------------------------------| 
|  unused      | unused     | BCMD_InvalidateKey_InCmd_eIsAllKTS| BCMD_InvalidateKey_InCmd_eKeyFlag      | 
|--------------|------------|-----------------------------------|----------------------------------------| 
...
typedef enum BCMD_InvalidateKey_InCmd_e
{
    ...
    BCMD_InvalidateKey_InCmd_eIsAllKTS          = (5 << 2) + 2, /* 8 bit index*/
