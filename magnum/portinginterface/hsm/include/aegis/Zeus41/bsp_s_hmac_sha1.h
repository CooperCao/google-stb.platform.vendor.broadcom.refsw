...
#define BPI_REGION_CONTEXT_MAX      0x1D
#define BPI_REGION_CONTEXT_TOTAL    (BPI_REGION_CONTEXT_MAX + 1)
...
typedef enum BPI_HmacSha1_Context_e
{
    ...
    BPI_HmacSha1_Context_eHvd0_Ila   = 0x0C,
    BPI_HmacSha1_Context_eHvd0_Ola   = 0x0D,

    BPI_HmacSha1_Context_eAvs        = 0x0E,
    ...
    BPI_HmacSha1_Context_eHvd1_Ila   = 0x15,
    BPI_HmacSha1_Context_eHvd1_Ola   = 0x16,

    BPI_HmacSha1_Context_eWebCpu0    = 0x17,
    ...
    BPI_HmacSha1_Context_eHvd2_Ila    = 0x1C,
    BPI_HmacSha1_Context_eHvd2_Ola    = 0x1D,
