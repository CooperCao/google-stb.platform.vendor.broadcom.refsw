...
typedef enum BCMD_CustomerSubMode_e
{
    ...
    BCMD_CustomerSubMode_eReserved20  =  0x14,
	BCMD_CustomerSubMode_eRESERVED20       =  0x14,
...
typedef enum BCMD_KeyDestBlockType_e
{
    ...
    BCMD_KeyDestBlockType_eMem2Mem          = 3,

    BCMD_KeyDestBlockType_eHdmi             = 4,

    BCMD_KeyDestBlockType_eReserved5        = 5,

    BCMD_KeyDestBlockType_eMem2Mem1         = 6,
...
typedef enum BCMD_XptM2MSecCryptoAlg_e
{
    ...
    BCMD_XptM2MSecCryptoAlg_eReserved8  =  8,
    BCMD_XptM2MSecCryptoAlg_eAesCounter0       = 8,
    BCMD_XptM2MSecCryptoAlg_eC2                = 9,
    BCMD_XptM2MSecCryptoAlg_eNotSupported10    = 10,
...
{
    BCMD_GenerateRouteFEK_InCmd_eKeySlotNumber          = (5 << 2) + 3,
    BCMD_GenerateRouteFEK_InCmd_eKeySelect            	= (6 << 2) + 3,
    BCMD_GenerateRouteFEK_InCmd_eMax
...
{
    BCMD_GenRootKey_InCmd_eKeyLadderType        = (5 << 2) + 3,
    BCMD_GenRootKey_InCmd_eRootKeySrc           = (6 << 2) + 3,
    BCMD_GenRootKey_InCmd_eSwizzle1IndexSel     = (7 << 2) + 3,
    BCMD_GenRootKey_InCmd_eSwizzleType          = (8 << 2) + 3,
    BCMD_GenRootKey_InCmd_eCusKeySelL           = (9 << 2) + 3,
    BCMD_GenRootKey_InCmd_eKeyVarL              = (10 << 2) + 3,
    BCMD_GenRootKey_InCmd_eCusKeySelH           = (11 << 2) + 3,
    BCMD_GenRootKey_InCmd_eKeyVarH              = (12 << 2) + 3,
    BCMD_GenRootKey_InCmd_eWrappedKey           = (13 << 2),
    BCMD_GenRootKey_InCmd_eDestAndDigest        = (17 << 2) ,
    BCMD_GenRootKey_InCmd_eTDesOpera            = (21 << 2) + 3,
    BCMD_GenRootKey_InCmd_eMaxOTPErr            = (22 << 2) + 3,
    BCMD_GenRootKey_InCmd_eMax
...
{
    BCMD_ProcOut_InCmd_eVKLID                   = (5 << 2)+ 3,
    BCMD_ProcOut_InCmd_eProcIn                  = 6 << 2,
    BCMD_ProcOut_InCmd_eMax
