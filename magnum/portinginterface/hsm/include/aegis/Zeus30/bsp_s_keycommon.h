...
#define BSP_SWIZZLE0A_VERSION 0x1
...
typedef enum BCMD_Swizzle0aType_e
{
    BCMD_Swizzle0aType_eNoMSP       = 0,
    BCMD_Swizzle0aType_eMSP0        = 1,
    BCMD_Swizzle0aType_eMSP1        = 2,
    BCMD_Swizzle0aType_eMax
}BCMD_Swizzle0aType_e;
...
typedef enum BCMD_GenKey_InCmd_e
{
    ...
    BCMD_GenKey_InCmd_eSwizzle0aType            = (9 << 2) + 2,
    BCMD_GenKey_InCmd_eSwizzle0aVersion         = (9 << 2) + 1,
...
{
    BCMD_SAGE_JTAG_UNLOCK_InCmd_eVKLID             = (5<<2) + 3,
    BCMD_SAGE_JTAG_UNLOCK_InCmdField_ePassword     = (6<<2) + 0,
    BCMD_SAGE_JTAG_UNLOCK_InCmdField_eMax
}BCMD_SAGE_JTAG_UNLOCK_InCmdField_e;

typedef enum BCMD_SAGE_JTAG_UNLOCK_OutCmdField_e
{
    BCMD_SAGE_JTAG_UNLOCK_OutCmdField_eStatus = (5<<2) + 3,
    BCMD_SAGE_JTAG_UNLOCK_OutCmdField_eMax
