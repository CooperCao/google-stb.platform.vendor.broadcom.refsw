...
typedef enum BPI_HmacSha1_Context_e
{
    ...
    BPI_HmacSha1_Context_eRaaga0_Imem = 0x15,
    BPI_HmacSha1_Context_eRaaga0_Dmem = 0x16,

    BPI_HmacSha1_Context_eRegionMax  = 0x16,

    BPI_HmacSha1_Context_eReserved0  = 0x17,

    BPI_HmacSha1_Context_eHmacSha1CtxMin = 0x18,
    BPI_HmacSha1_Context_eHmacSha1Ctx0 = 0x18,
    BPI_HmacSha1_Context_eHmacSha1Ctx1 = 0x19,

    BPI_HmacSha1_Context_eHmacSha1CtxSCM = 0x1a,
    BPI_HmacSha1_Context_eHmacSha1CtxMax = 0x1a,

    BPI_HmacSha1_Context_eCmdSig0    = 0x1b,
    BPI_HmacSha1_Context_eCmdSig1    = 0x1c,

    BPI_HmacSha1_Context_eMax
} BPI_HmacSha1_Context_e;

#define BPI_HMACSHA1_CONTEXT_MAX        0x1D
