...
typedef struct
{
    ...
    unsigned componentIndex;
    unsigned commandIndex;
    unsigned parameterIndex;   /* where its positioned in the list of parameters. */
...
void BHSM_BspDebug_PrintCommand( BHSM_Handle hHsm, const uint32_t *pCommand );
void BHSM_BspDebug_PrintResponse( BHSM_Handle hHsm, const uint32_t *pResponse );

/* functions to register components, their commands, and their parameters.  */
