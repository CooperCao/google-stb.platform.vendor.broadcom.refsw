...
/* COMMANDS for the "Rpmb" component */
typedef enum
{
    Bsp_CmdRpmb_eKeyGen = 0x00,
    Bsp_CmdRpmb_eDisableHmac = 0x01,
    Bsp_CmdRpmb_eMax
} Bsp_CmdRpmb_e;
...
}Bsp_Rpmb_DisableHmac_InFields_t;
/*output*/
typedef struct
{
    unsigned dummy; /*no elements*/

}Bsp_Rpmb_DisableHmac_OutFields_t;
