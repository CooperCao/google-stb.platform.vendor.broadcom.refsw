...
/*PARAMATERS for the Bsp_CmdRv_eGetSecureBootParams command  */
/*input*/
typedef struct
{
    unsigned dummy; /*no elements*/

}Bsp_CmdRv_GetSecureBootParams_InFields_t;
/*output*/
typedef struct
{
...
}Bsp_CmdRv_GetSecureBootParams_OutFields_t;
...
typedef struct
{
    uint32_t regionStatus[30]; /* enum type Bsp_CmdRv_QueryStatusBits_e */
...
typedef struct
{
    ...
    uint8_t  scbBurstSize; /* enum type Bsp_CmdRv_ScbBurstSize_e */
    uint8_t  verifyPartialDigest; /* enum type Bsp_CmdRv_VerifyPartDigest_e */
    ...
    uint8_t  reserved2;
    uint8_t  cpuType; /* enum type Bsp_CmdRv_CpuType_e */
    uint8_t  svpFwReleaseVersion;
    uint8_t  chipBindingSel;
    uint8_t  epochSel;
    uint8_t  marketIdSel;
    uint8_t  sigType; /* enum type Bsp_CmdRv_SigType_e */
    uint8_t  sigVersion;
    uint32_t marketId;
...
/*PARAMATERS for the Bsp_CmdRv_eItchResize command  */
/*input*/
typedef struct
{
    uint8_t  regionId; /* enum type Bsp_CmdRv_RegionId_e */
...
}Bsp_CmdRv_ItchResize_InFields_t;
...
/*PARAMATERS for the Bsp_CmdRv_eMemsysReadyForInit command  */
/*input*/
typedef struct
{
    unsigned dummy; /*no elements*/

}Bsp_CmdRv_MemsysReadyForInit_InFields_t;
