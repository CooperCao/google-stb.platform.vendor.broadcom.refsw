...
typedef enum
{
    ...
    Bsp_CmdKeyLadder_eConfigKkcv = 0x09,
...
typedef struct
{
    ...
    uint8_t  applyKkcv; /* enum type Bsp_KeyLadder_ApplyKkcv_e */
    uint8_t  reserved1;
...
/*PARAMATERS for the Bsp_CmdKeyLadder_eConfigKkcv command  */
/*input*/
typedef struct
{
    uint8_t  keyLayer; /* enum type Bsp_KeyLadderLayer_e */
    uint8_t  vklId; /* enum type Bsp_VklId_e */
    uint8_t  operation; /* enum type Bsp_ConfigKkcv_Operation_e */
    uint8_t  reserved0;
    uint32_t kkcv[4];

}Bsp_KeyLadder_ConfigKkcv_InFields_t;
/*output*/
typedef struct
{
    unsigned dummy; /*no elements*/

}Bsp_KeyLadder_ConfigKkcv_OutFields_t;
