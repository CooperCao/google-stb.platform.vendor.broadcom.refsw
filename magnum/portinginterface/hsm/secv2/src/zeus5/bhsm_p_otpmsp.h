...
#ifndef BHSM_P_OTPMSP__H
#define BHSM_P_OTPMSP__H
...
typedef struct BHSM_P_OtpMspRead
{
    /* input */
...
typedef struct BHSM_P_OtpMspMultiRead
{
    /* input */
    bool suppressBspStatusErrorMessage; /* true: will not print an error for non-zero BSP status */
    struct {
    ...
    struct {
        ...
        unsigned   mspRegValueSize_inPlace; /* size in bytes */
        uint8_t    *pMspRegValue_inPlace;
    }out;
} BHSM_P_OtpMspMultiRead;

typedef struct BHSM_P_OtpMspProg
{
    /* input */
    bool suppressBspStatusErrorMessage; /* true: will not print an error for non-zero BSP status */
    struct {
