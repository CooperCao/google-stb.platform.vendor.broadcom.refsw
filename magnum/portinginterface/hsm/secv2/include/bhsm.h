...
#define BHSM_STATUS_IN_PROGRESS                      BERR_MAKE_CODE(BERR_ICM_ID, 0xA4)
...
typedef struct BHSM_ModuleCapabilities
{
   ...
   BHSM_KeyslotType numKeyslotsForType[BHSM_KeyslotType_eMax];   /* Number of each type of keyslot. */
