...
typedef enum
{
    ...
    BHSM_KeyLadderDestination_eHdcp,         /* HDCP */
...
typedef struct
{
    ...
    unsigned keySize;           /* the size of the keyLadder key in bits. */
    ...
    unsigned numLevels;                    /* Number of levels on keyladder. May be restricted by "mode". */
    ...
    struct
    {
        ...
        struct{
            unsigned                        moduleId;        /* deprecated for zeus5 */
...
typedef struct
{
    unsigned level;            /* an index value between 3 and BHSM_KeyLadderSettings::numLevels */
...
typedef struct
{
    unsigned clearOwnership;  /* release the keyadder ownership also. */
}BHSM_KeyLadderInvalidate;



void BHSM_KeyLadder_GetDefaultAllocateSettings(
    BHSM_KeyLadderAllocateSettings *pSettings
    );

/*
    Allocate a KeyLadder Resource
*/
BHSM_KeyLadderHandle BHSM_KeyLadder_Allocate(
    BHSM_Handle hHsm,
...
*/
void BHSM_KeyLadder_Free(
    BHSM_KeyLadderHandle handle
    );

/*
    returns the current or default setting for the keyladder.
*/
void BHSM_KeyLadder_GetSettings(
    BHSM_KeyLadderHandle handle,
    BHSM_KeyLadderSettings *pSettings                  /* [out] */
    );

/*
    Configure the keyladder.
*/
BERR_Code BHSM_KeyLadder_SetSettings(
    BHSM_KeyLadderHandle handle,
...
*/
BERR_Code BHSM_KeyLadder_GenerateLevelKey(
    BHSM_KeyLadderHandle handle,
...
*/
BERR_Code BHSM_KeyLadder_Invalidate(
    BHSM_KeyLadderHandle handle,
    const BHSM_KeyLadderInvalidate  *pInvalidate
    );
...
*/
BERR_Code BHSM_KeyLadder_GetInfo( BHSM_KeyLadderHandle handle,
                                  BHSM_KeyLadderInfo *pInfo );
...
void BHSM_KeyLadder_GetDefaultChallenge(
    BHSM_KeyLadderChallenge  *pChallenge         /* [out] */
    );

/*
    Challange the keyladder. Can be used to authenticate the STB.
*/
BERR_Code BHSM_KeyLadder_Challenge(
    BHSM_KeyLadderHandle handle,
    const BHSM_KeyLadderChallenge  *pChallenge,
    BHSM_KeyLadderChallengeResponse *pResponse    /* [out] */
    );
