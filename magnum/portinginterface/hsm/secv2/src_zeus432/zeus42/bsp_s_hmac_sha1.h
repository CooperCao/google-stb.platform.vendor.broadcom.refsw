...
typedef enum BCMD_HmacSha1_InCmdField_e
{
    ...
    BCMD_HmacSha1_InCmdField_eDataLen = (13 << 2) + 0,
    BCMD_HmacSha1_InCmdField_eAddressOrData = (14 << 2) + 0,
...
typedef enum BCMD_VerifySecureBootParams_OutCmdField_e
{
    ...
    BCMD_VerifySecureBootParams_OutCmdField_eBspParamsSize = (6 << 2) + 2,
...
typedef enum BPI_HmacSha1_Context_e
{
    ...
    BPI_HmacSha1_Context_eReserved10  =  0x0A,

    BPI_HmacSha1_Context_eVdec0_Il2a = 0x0B,

    BPI_HmacSha1_Context_eVdec0_Ila = 0x0C,
    BPI_HmacSha1_Context_eVdec0_Ola = 0x0D,

    BPI_HmacSha1_Context_eAvs = 0x0E,
    BPI_HmacSha1_Context_eReserved14  =  0x0E,
    ...
    BPI_HmacSha1_Context_eVdec1_Ila = 0x15,
    BPI_HmacSha1_Context_eVdec1_Ola = 0x16,

    BPI_HmacSha1_Context_eReserved23  =  0x17,
    ...
    BPI_HmacSha1_Context_eVdec2_Ila = 0x1C,
