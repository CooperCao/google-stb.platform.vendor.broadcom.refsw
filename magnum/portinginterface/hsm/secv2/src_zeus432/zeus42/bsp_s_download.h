...
{
    BCMD_Download_InCmdSecondStageCodeLoad_eSecondStageCodePtr1 = (5 << 2) + 0,
    BCMD_Download_InCmdSecondStageCodeLoad_eSecondStageCodePtr2 = (6 << 2) + 0,
    BCMD_Download_InCmdSecondStageCodeLoad_eSecondStageCodeSig = (7 << 2) + 0,
    BCMD_Download_InCmdSecondStageCodeLoad_eHashLocked = (8 << 2) + 1,
    BCMD_Download_InCmdSecondStageCodeLoad_eLoadFromDram = (8 << 2) + 2,
    BCMD_Download_InCmdSecondStageCodeLoad_eKeySelect = (8 << 2) + 3,
