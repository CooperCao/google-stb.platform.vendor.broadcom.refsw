...
BHSM_KeyslotHandle _InitialiseBypassKeyslot( BHSM_Handle hHsm, BypassConfig *pConfig )
{
    ...
    keyslotAllocSettings.slotType = _convertSlotType( BHSM_KeyslotType_eIvPerSlot );
    ...
    BDBG_ERR(("Bypass Keyslot initialised. Type[%d] Number[%u] [%s%s->%s%s]", keyslotInfo.type, keyslotInfo.number
