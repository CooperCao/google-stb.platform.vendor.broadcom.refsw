...
BERR_Code BHSM_OtpMsp_Read( BHSM_Handle hHsm, BHSM_OtpMspRead *pParam )
{
    ...
    BHSM_BspMsg_GetArray( hMsg, BCMD_Otp_OutCmdOfflineMspRead_eMspValue, (uint8_t*)&pParam->data, 4 );
    BHSM_BspMsg_GetArray( hMsg, BCMD_Otp_OutCmdOfflineMspRead_eMspLockValue, (uint8_t*)&pParam->valid, 4 );
