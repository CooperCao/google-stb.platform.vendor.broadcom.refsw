...
#ifdef BCHP_HDMI_BSC_INTR2_REG_START
#include "bchp_int_id_hdmi_bsc_irq.h"
#endif
...
BDBG_OBJECT_ID_DECLARE(BI2C_P_ChannelHandle);
...
BDBG_OBJECT_ID_DECLARE(BI2C_P_Handle);

typedef struct BI2C_P_Handle
{
    BDBG_OBJECT(BI2C_P_Handle)
    BCHP_Handle     hChip;
