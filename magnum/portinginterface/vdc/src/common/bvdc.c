...
const BVDC_P_Features s_VdcFeatures =
{
	...
	/* mpg0   mpg1   mpg2   mpg3   mpg4   mpg5   vdec0  vdec1  656_0  656_1  gfx0   gfx1   gfx2   gfx3   gfx4   gfx5   gfx6   dvi0   dvi1   ds 0   vfd0   vfd1   vfd2   vfd3   vfd4   vfd5   vfd6   vfd7  */
	{  true,  true,  true,  true,  false, false, false, false, false, false, true,  true,  true,  true,  true,  true,  false, true,  false, false, true,  true,  true,  true,  true,  true,  true,  true  },
	  ...
	  uint32_t                        *pulCoverage )
{
	...
	if(ulRectsCount)
	{
		BVDC_P_GetMosaicCoverage(&hVdc->stMosaicCoverageTbl[eDispId],
			ulRectsCount, &ulCoverage);
	}
