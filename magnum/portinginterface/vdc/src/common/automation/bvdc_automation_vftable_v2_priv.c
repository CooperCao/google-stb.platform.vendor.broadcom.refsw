...
(
  ...
  BVDC_P_VF_FIELD_DATA( NEG_SYNC_AMPLITUDE_EXTN, VALUE2                   , 0x00fb ) |
...
(
  BVDC_P_VF_FIELD_DATA( NEG_SYNC_AMPLITUDE_EXTN, SEL_D_SYNC               , 0x0000 ) |
  BVDC_P_VF_FIELD_DATA( NEG_SYNC_AMPLITUDE_EXTN, VALUE2                   , 0x0084 ) |
  BVDC_P_VF_FIELD_DATA( NEG_SYNC_AMPLITUDE_EXTN, VALUE3                   , 0x0010 )
),
#endif
};
...
(
  BVDC_P_VF_FIELD_DATA( NEG_SYNC_AMPLITUDE_EXTN, SEL_D_SYNC               , 0x0000 ) |
  BVDC_P_VF_FIELD_DATA( NEG_SYNC_AMPLITUDE_EXTN, VALUE2                   , 0x0109 ) |
  BVDC_P_VF_FIELD_DATA( NEG_SYNC_AMPLITUDE_EXTN, VALUE3                   , 0x0010 )
),
#endif
};
...
(
  BVDC_P_VF_FIELD_DATA( NEG_SYNC_AMPLITUDE_EXTN, SEL_D_SYNC               , 0x0000 ) |
  BVDC_P_VF_FIELD_DATA( NEG_SYNC_AMPLITUDE_EXTN, VALUE2                   , 0x00f0 ) |
  BVDC_P_VF_FIELD_DATA( NEG_SYNC_AMPLITUDE_EXTN, VALUE3                   , 0x0010 )
),
#endif
};
