	  ...
	  uint32_t                           ulRulOffset )
{
	...
	if (stDirty.stBits.bCsc)
	{
		...
		*pulRulCur++ = BCHP_FIELD_DATA(GFD_0_CM_C00_C01, CM_C00, pGfxCsc->stCscMC.usY0) |
		               BCHP_FIELD_DATA(GFD_0_CM_C00_C01, CM_C01, pGfxCsc->stCscMC.usY1);
		*pulRulCur++ = BCHP_FIELD_DATA(GFD_0_CM_C02_C03, CM_C02, pGfxCsc->stCscMC.usY2) |
		               BCHP_FIELD_DATA(GFD_0_CM_C02_C03, CM_C03, pGfxCsc->stCscMC.usYAlpha);
		*pulRulCur++ = BCHP_FIELD_DATA(GFD_0_CM_C04,     CM_C04, pGfxCsc->stCscMC.usYOffset);

		*pulRulCur++ = BCHP_FIELD_DATA(GFD_0_CM_C10_C11, CM_C10, pGfxCsc->stCscMC.usCb0) |
		               BCHP_FIELD_DATA(GFD_0_CM_C10_C11, CM_C11, pGfxCsc->stCscMC.usCb1);
		*pulRulCur++ = BCHP_FIELD_DATA(GFD_0_CM_C12_C13, CM_C12, pGfxCsc->stCscMC.usCb2) |
		               BCHP_FIELD_DATA(GFD_0_CM_C12_C13, CM_C13, pGfxCsc->stCscMC.usCbAlpha);
		*pulRulCur++ = BCHP_FIELD_DATA(GFD_0_CM_C14,     CM_C14, pGfxCsc->stCscMC.usCbOffset);

		*pulRulCur++ = BCHP_FIELD_DATA(GFD_0_CM_C20_C21, CM_C20, pGfxCsc->stCscMC.usCr0) |
		               BCHP_FIELD_DATA(GFD_0_CM_C20_C21, CM_C21, pGfxCsc->stCscMC.usCr1);
		*pulRulCur++ = BCHP_FIELD_DATA(GFD_0_CM_C22_C23, CM_C22, pGfxCsc->stCscMC.usCr2) |
		               BCHP_FIELD_DATA(GFD_0_CM_C22_C23, CM_C23, pGfxCsc->stCscMC.usCrAlpha);
		*pulRulCur++ = BCHP_FIELD_DATA(GFD_0_CM_C24,     CM_C24, pGfxCsc->stCscMC.usCrOffset);
#endif
	}
