...
typedef struct BVDC_P_WindowContext
{
	...
	/* CMP CSC */
	BVDC_P_CscCfg                 stPriCsc;
	BVDC_P_CscCfg                 stSecCsc;
	BAVC_TransferCharacteristics  ePrevTransChar;
	BAVC_HDMI_DRM_EOTF            eInputEotf;
	bool                          bBypassCmpCsc;

#if BVDC_P_SUPPORT_CMP_MOSAIC_CSC
	BVDC_P_CscCfg                 astMosaicCscList[BVDC_P_SUPPORT_CMP_MOSAIC_CSC];
	BAVC_MatrixCoefficients       aeMosaicClrSpaceList[BAVC_MOSAIC_MAX];
	BAVC_MatrixCoefficients       aePrevMosaicClrSpaceList[BAVC_MOSAIC_MAX];
