...
static const BVDC_P_MatrixCoeffs s_aMatrixCoeffs_BAVC_to_BVDC_P[] =
{
    BVDC_P_MatrixCoeffs_eBt709,               /* BAVC_MatrixCoefficients_eHdmi_RGB = 0 */
    BVDC_P_MatrixCoeffs_eBt709,               /* BAVC_MatrixCoefficients_eItu_R_BT_709 = 1, */
    BVDC_P_MatrixCoeffs_eBt709,               /* BAVC_MatrixCoefficients_eUnknown = 2 */
    BVDC_P_MatrixCoeffs_eBt709,               /* BAVC_MatrixCoefficients_eDvi_Full_Range_RGB = 3: Forbidden */
    BVDC_P_MatrixCoeffs_eSmpte170M,           /* BAVC_MatrixCoefficients_eFCC = 4 */
    BVDC_P_MatrixCoeffs_eBt470_2_BG,          /* BAVC_MatrixCoefficients_eItu_R_BT_470_2_BG = 5 */
    BVDC_P_MatrixCoeffs_eSmpte170M,           /* BAVC_MatrixCoefficients_eSmpte_170M = 6 */
    BVDC_P_MatrixCoeffs_eSmpte170M,           /* BAVC_MatrixCoefficients_eSmpte_240M = 7 */
    BVDC_P_MatrixCoeffs_eBt709,               /* unused 8 */
    BVDC_P_MatrixCoeffs_eBt2020_NCL,          /* BAVC_MatrixCoefficients_eItu_R_BT_2020_NCL = 9, */
    BVDC_P_MatrixCoeffs_eBt2020_CL,           /* BAVC_MatrixCoefficients_eItu_R_BT_2020_CL = 10, */
    BVDC_P_MatrixCoeffs_eXvYcc709,            /* BAVC_MatrixCoefficients_eXvYCC_709 = 11 */
    BVDC_P_MatrixCoeffs_eXvYcc601,            /* BAVC_MatrixCoefficients_eXvYCC_601 = 12 */
...
BVDC_P_MatrixCoeffs BVDC_P_MatrixCoeffs_BAVC_to_BVDC_P_isr
    ( BAVC_MatrixCoefficients          eMatrixCoeffs,
      bool                             bXvYcc)
{
    BVDC_P_MatrixCoeffs eVdcMatrixCoeffs;

    if (eMatrixCoeffs <= BAVC_MatrixCoefficients_eHdmi_Full_Range_YCbCr)
    {
        eVdcMatrixCoeffs = s_aMatrixCoeffs_BAVC_to_BVDC_P[eMatrixCoeffs];
    }
    else
    {
        BDBG_WRN(("unsupported MatrixCoeffs %d, assumed BT709", eMatrixCoeffs));
        eVdcMatrixCoeffs = BVDC_P_MatrixCoeffs_eBt709;
    }

    if(bXvYcc)
    {
        if (eVdcMatrixCoeffs == BVDC_P_MatrixCoeffs_eBt709)
        {
            eVdcMatrixCoeffs = BVDC_P_MatrixCoeffs_eXvYcc709;
        }
        else if(eVdcMatrixCoeffs == BVDC_P_MatrixCoeffs_eSmpte170M)
        {
            eVdcMatrixCoeffs = BVDC_P_MatrixCoeffs_eXvYcc601;
        }
        else
        {
