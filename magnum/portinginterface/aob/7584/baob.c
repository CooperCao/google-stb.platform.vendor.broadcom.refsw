...
*
*******************************************************************************/
BERR_Code BAOB_7584_p_EventCallback_isr(
    ...
    )
{
    ...
    BDBG_ENTER(BAOB_7584_p_EventCallback_isr);
    ...
    BDBG_LEAVE(BAOB_7584_p_EventCallback_isr);
    return( retCode );
}
    ...
    )
{
    ...
    BHAB_InstallInterruptCallback( hDev->hHab,  hDev->devId, BAOB_7584_p_EventCallback_isr , (void *) hDev, event);
    ...
    )
{
    ...
    switch (event_code) {
        ...
        case 1:
            ...
            break;
        default:
            BDBG_WRN((" unknown event code from 7584 %x",event_code ));
            break;
    }
