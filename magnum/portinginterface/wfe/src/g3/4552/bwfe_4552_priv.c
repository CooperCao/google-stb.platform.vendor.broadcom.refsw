...
BERR_Code BWFE_P_SetAdcSampleFreq(BWFE_ChannelHandle h, uint32_t freqKhz)
{
   ...
   /* allow arbitrary sample rates when band-stacking disabled */
   if (!h->pDevice->settings.bFixedSampleFreq)
   {
...
BERR_Code BWFE_P_DisableDpmPilot(BWFE_ChannelHandle h)
{
   ...
   BWFE_P_WriteRegister(h, BCHP_WFE_ANA_RFFE_WRITER02, 0x105A4888);  /* default value */
