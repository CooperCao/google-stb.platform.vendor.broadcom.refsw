...
/* local functions */
static BERR_Code BWFE_45216_P_EnableSaDoneInterrupt(BWFE_Handle h, bool bEnable);
static BERR_Code BWFE_45216_P_EnableReadyInterrupt(BWFE_ChannelHandle h, bool bEnable);
static BERR_Code BWFE_45216_P_InterruptCallback_isr(void *pParm1, int parm2);
static BERR_Code BWFE_45216_P_SendCommand(BHAB_Handle h, uint32_t *pBuf, uint32_t n);
...
)
{
   ...
   pDevImpl = (BWFE_45216_P_Handle *)BKNI_Malloc(sizeof(BWFE_45216_P_Handle));
   BDBG_ASSERT(pDevImpl);
   BKNI_Memset((void*)pDevImpl, 0, sizeof(BWFE_45216_P_Handle));
   ...
   /* install callback */
   BHAB_InstallInterruptCallback(hHab, BHAB_DevId_eWFE, BWFE_45216_P_InterruptCallback_isr, (void*)hDev, 0);
...
BERR_Code BWFE_45216_P_Close(BWFE_Handle h)
{
   ...
   BDBG_ASSERT(h);
   pDevImpl = (BWFE_45216_P_Handle *)(h->pImpl);
...
******************************************************************************/
static BERR_Code BWFE_45216_P_EnableSaDoneInterrupt(
...
******************************************************************************/
static BERR_Code BWFE_45216_P_EnableReadyInterrupt(
...
/******************************************************************************
 BWFE_45216_P_InterruptCallback_isr()
******************************************************************************/
static BERR_Code BWFE_45216_P_InterruptCallback_isr(void *pParm1, int parm2)
{
