...
/* local functions */
static BERR_Code BWFE_4538_P_EnableSaDoneInterrupt(BWFE_Handle h, bool bEnable);
static BERR_Code BWFE_4538_P_EnableReadyInterrupt(BWFE_ChannelHandle h, bool bEnable);
static BERR_Code BWFE_4538_P_InterruptCallback_isr(void *pParm1, int parm2);
...
)
{
   ...
   /* install callback */
   BHAB_InstallInterruptCallback(hHab, BHAB_DevId_eWFE, BWFE_4538_P_InterruptCallback_isr, (void*)hDev, 0);
...
)
{
   ...
   BWFE_4538_CHK_RETCODE(BHAB_ReadRegister(pDevImpl->hHab, BCHP_4538_JTAG_OTP_GENERAL_STATUS_5, &otp));
...
******************************************************************************/
static BERR_Code BWFE_4538_P_EnableSaDoneInterrupt(
...
******************************************************************************/
static BERR_Code BWFE_4538_P_EnableReadyInterrupt(
...
/******************************************************************************
 BWFE_4538_P_InterruptCallback_isr()
******************************************************************************/
static BERR_Code BWFE_4538_P_InterruptCallback_isr(void *pParm1, int parm2)
{
