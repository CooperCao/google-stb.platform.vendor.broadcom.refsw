...
static const BWFE_Settings defDevSettings =
{
   /* API function table */
   {
      ...
      NULL,    /* BWFE_GetSaDoneEventHandle */
      NULL,    /* BWFE_ScanSpectrum */
      NULL,    /* BWFE_GetSaSamples */
