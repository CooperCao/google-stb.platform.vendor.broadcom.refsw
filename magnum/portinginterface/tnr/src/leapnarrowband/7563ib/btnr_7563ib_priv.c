...
*
*******************************************************************************/
BERR_Code BTNR_7563_Close(
    BTNR_Handle hDev                    /* [in] Device handle */
    )
{
    BERR_Code retCode = BERR_SUCCESS;
    BTNR_7563_Handle btnr_7563_handle;
    BTNR_P_7563_Settings btnr_7563_settings;


    BDBG_ENTER(BTNR_7563_Close);
    BDBG_ASSERT( hDev );
    BDBG_ASSERT( hDev->magicId == DEV_MAGIC_ID );

    /* verify the handle is good before using it */
    btnr_7563_handle = (BTNR_7563_Handle) hDev->hDevImpl;
    btnr_7563_settings = btnr_7563_handle ->settings;

    hDev->magicId = 0x00;       /* clear it to catch inproper use */
    BKNI_Free( (void *) hDev->hDevImpl );
    BKNI_Free( (void *) hDev );

    BDBG_LEAVE(BTNR_7563_Close);
    return retCode;
}

BERR_Code BTNR_7563_SetRfFreq(
    BTNR_7563_Handle hDev,              /* [in] Device handle */
    ...
    )
{
    ...
    BDBG_ENTER(BTNR_7563_SetRfFreq);
    BDBG_ASSERT( hDev );
    BDBG_ASSERT( hDev->magicId == DEV_MAGIC_ID );
    ...
    BDBG_LEAVE(BTNR_7563_SetRfFreq);
    return retCode;
}
            
BERR_Code BTNR_7563_GetRfFreq(
    BTNR_7563_Handle hDev,              /* [in] Device handle */
    ...
    )
{
    ...
    BDBG_ENTER(BTNR_7563_GetRfFreq);
    BDBG_ASSERT( hDev );
    BDBG_ASSERT( hDev->magicId == DEV_MAGIC_ID );
    ...
    *tunerMode = pTnrImplData->tunerMode;
    ...
    BDBG_LEAVE(BTNR_7563_GetRfFreq);
    return retCode;
}

BERR_Code BTNR_P_7563_GetAgcRegVal(
    BTNR_7563_Handle hDev,              /* [in] Device handle */
...
BERR_Code BTNR_7563_SetAgcRegVal(
    BTNR_7563_Handle hDev,              /* [in] Device handle */
    uint32_t regOffset,                 /* [in] AGC register offset */
...
{   
    ...
    BDBG_LEAVE(BTNR_7563_GetInfo);
    return retCode;
}

BERR_Code BTNR_7563_GetPowerSaver(
    BTNR_7563_Handle hDev,                      /* [in] Device handle */
...
{   
    ...
    BDBG_ENTER(BTNR_7563_GetPowerSaver);
    BDBG_ASSERT( hDev );
    BDBG_ASSERT( hDev->magicId == DEV_MAGIC_ID );  
...
BERR_Code BTNR_7563_SetPowerSaver(
    BTNR_7563_Handle hDev,                  /* [in] Device handle */
    BTNR_PowerSaverSettings *pwrSettings    /* [in] Power saver settings. */
    )
{   
    ...
    BDBG_ENTER(BTNR_7563_SetPowerSaver);
    BDBG_ASSERT( hDev );
    BDBG_ASSERT( hDev->magicId == DEV_MAGIC_ID );    
    ...
    BDBG_LEAVE(BTNR_7563_SetPowerSaver);
    return retCode;
}

BERR_Code BTNR_7563_GetSettings(
    BTNR_7563_Handle hDev,      /* [in] Device handle */
...
{   
    ...
    BDBG_ENTER(BTNR_7563_SetSettings);
    BDBG_ASSERT( hDev );
    BDBG_ASSERT( hDev->magicId == DEV_MAGIC_ID );
    ...
    BDBG_LEAVE(BTNR_7563_SetSettings);
    return retCode;
}

BERR_Code BTNR_7563_SetSettings(
    BTNR_7563_Handle hDev,      /* [in] Device handle */
