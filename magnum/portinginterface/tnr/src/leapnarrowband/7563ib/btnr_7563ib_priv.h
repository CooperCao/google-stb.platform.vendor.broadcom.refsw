 ...
 * 
 ***************************************************************************/
#ifndef BTNR_7563_PRIV_H__
#define BTNR_7563_PRIV_H__
...
typedef struct BTNR_P_7563_Handle     *BTNR_7563_Handle;

typedef struct BTNR_P_7563_Settings
{
    ...
    BTNR_Standard std;
    uint32_t bandwidth;
} BTNR_P_7563_Settings;

typedef struct BTNR_P_7563_Handle
{
    uint32_t magicId;                   /* Used to check if structure is corrupt */
    BHAB_Handle hHab;
    BTNR_P_7563_Settings settings;
