    ...
    )
{
    ...
    BDBG_LEAVE(BTNR_3466_Close);
    return retCode;
}

BERR_Code BTNR_3466_SetRfFreq(
    BTNR_3466_Handle hDev,            /* [in] Device handle */
    ...
    )
{
    ...
    BDBG_ENTER(BTNR_3466_SetRfFreq);
    BDBG_ASSERT( hDev );
    BDBG_ASSERT( hDev->magicId == DEV_MAGIC_ID );
    ...
    BDBG_LEAVE(BTNR_3466_SetRfFreq);
    return retCode;
}

BERR_Code BTNR_3466_GetRfFreq(
    BTNR_3466_Handle hDev,            /* [in] Device handle */
    ...
    )
{
    ...
    BDBG_ENTER(BTNR_3466_GetRfFreq);
    BDBG_ASSERT( hDev );
    BDBG_ASSERT( hDev->magicId == DEV_MAGIC_ID );
    ...
    *tunerMode = pTnrImplData->tunerMode;
    ...
    BDBG_LEAVE(BTNR_3466_GetRfFreq);
    return retCode;
}

BERR_Code BTNR_P_3466_GetAgcRegVal(
    BTNR_3466_Handle hDev,            /* [in] Device handle */
...
BERR_Code BTNR_3466_SetAgcRegVal(
    BTNR_3466_Handle hDev,            /* [in] Device handle */
    uint32_t regOffset,                 /* [in] AGC register offset */
...
BERR_Code BTNR_3466_SetPowerSaver(
    BTNR_3466_Handle hDev,                    /* [in] Device handle */
    BTNR_PowerSaverSettings *pwrSettings /* [in] Power saver settings. */
    )
{
    ...
    BDBG_ENTER(BTNR_3466_SetPowerSaver);
    BDBG_ASSERT( hDev );
    BDBG_ASSERT( hDev->magicId == DEV_MAGIC_ID );
    ...
    BDBG_LEAVE(BTNR_3466_SetPowerSaver);
    return retCode;
}

BERR_Code BTNR_3466_GetSettings(
    BTNR_3466_Handle hDev,    /* [in] Device handle */
    ...
    )
{
    ...
    BDBG_ENTER(BTNR_3466_GetSettings);
    BDBG_ASSERT( hDev );
    BDBG_ASSERT( hDev->magicId == DEV_MAGIC_ID );
    ...
    BDBG_LEAVE(BTNR_3466_GetSettings);
    return retCode;
}

BERR_Code BTNR_3466_SetSettings(
    BTNR_3466_Handle hDev,    /* [in] Device handle */
...

{
    ...
    BDBG_ENTER(BTNR_3466_SetSettings);
    BDBG_ASSERT( hDev );
    BDBG_ASSERT( hDev->magicId == DEV_MAGIC_ID );
    ...
    BDBG_LEAVE(BTNR_3466_SetSettings);
    return retCode;
}

BERR_Code BTNR_3466_GetVersionInfo(
    BTNR_3466_Handle hDev,          /* [in] Device handle */
    ...
    )
{
    ...
    BDBG_ENTER(BTNR_3466_GetVersionInfo);
    BDBG_ASSERT( hDev );
    BDBG_ASSERT( hDev->magicId == DEV_MAGIC_ID );
    ...
    BDBG_LEAVE(BTNR_3466_GetVersionInfo);
    return( retCode );
}