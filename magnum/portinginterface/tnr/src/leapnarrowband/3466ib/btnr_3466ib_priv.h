 ...
 *
 *****************************************************************************/
#ifndef BTNR_3466_PRIV_H__
#define BTNR_3466_PRIV_H__
...
typedef struct BTNR_P_3466_Handle     *BTNR_3466_Handle;

typedef struct BTNR_P_3466_Settings
{
    ...
    BTNR_Standard std;
    uint32_t bandwidth;
} BTNR_P_3466_Settings;

typedef struct BTNR_P_3466_Handle
{
    uint32_t magicId;                   /* Used to check if structure is corrupt */
    BHAB_Handle hHab;
    BTNR_P_3466_Settings settings;
