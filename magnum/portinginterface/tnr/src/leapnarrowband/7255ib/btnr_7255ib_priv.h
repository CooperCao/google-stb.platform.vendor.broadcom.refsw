 ...
 *
 *****************************************************************************/
#ifndef BTNR_7255_PRIV_H__
#define BTNR_7255_PRIV_H__
...
typedef struct BTNR_P_7255_Handle     *BTNR_7255_Handle;

typedef struct BTNR_P_7255_Settings
{
...
} BTNR_P_7255_Settings;

typedef struct BTNR_P_7255_Handle
{
    uint32_t magicId;                   /* Used to check if structure is corrupt */
    BHAB_Handle hHab;
    BTNR_P_7255_Settings settings;
