...
BDBG_MODULE(btnr_7584Ob_priv);


#define DEV_MAGIC_ID            ((BERR_TNR_ID<<16) | 0xFACE)

/*******************************************************************************/
BERR_Code BTNR_7584Ob_Close(
    BTNR_Handle hDev                    /* [in] Device handle */
    )
{
    BERR_Code retCode = BERR_SUCCESS;
    BTNR_7584Ob_Handle btnr_7584ob_handle;
    BTNR_P_7584Ob_Settings btnr_7584ob_settings;

    BDBG_ENTER(BTNR_7584Ob_Close);
    BDBG_ASSERT( hDev );
    BDBG_ASSERT( hDev->magicId == DEV_MAGIC_ID );

    /* verify the handle is good before using it */
    btnr_7584ob_handle = (BTNR_7584Ob_Handle) hDev->hDevImpl;
    btnr_7584ob_settings = btnr_7584ob_handle->settings;

    hDev->magicId = 0x00;       /* clear it to catch improper use */
    BKNI_Free( (void *) hDev->hDevImpl );
    BKNI_Free( (void *) hDev );

    BDBG_LEAVE(BTNR_7584Ob_Close);
    return  retCode;
}

BERR_Code BTNR_7584Ob_SetRfFreq(
    BTNR_7584Ob_Handle hDev,                /* [in] Device handle */
    ...
    )
{
    ...
    BDBG_ENTER(BTNR_7584Ob_SetRfFreq);
    BDBG_ASSERT( hDev );
    BDBG_ASSERT( hDev->magicId == DEV_MAGIC_ID );
    ...
    BDBG_LEAVE(BTNR_7584Ob_SetRfFreq);
    return  retCode;
}
            
BERR_Code BTNR_7584Ob_GetRfFreq(
    BTNR_7584Ob_Handle hDev,                /* [in] Device handle */
    ...
    )
{
    ...
    BDBG_ENTER(BTNR_7584Ob_GetRfFreq);
    BDBG_ASSERT( hDev );
    BDBG_ASSERT( hDev->magicId == DEV_MAGIC_ID );
    ...
    *tunerMode = pTnrImplData->tunerMode;
    ...
    BDBG_LEAVE(BTNR_7584Ob_GetRfFreq);
    return  retCode;
}

BERR_Code BTNR_P_7584Ob_GetAgcRegVal(
    BTNR_7584Ob_Handle hDev,                /* [in] Device handle */
    ...
    )
{
    ...
    BDBG_ENTER(BTNR_P_7584Ob_GetAgcRegVal);
    BDBG_ASSERT( hDev );
    BDBG_ASSERT( hDev->magicId == DEV_MAGIC_ID );

    retCode = BHAB_ReadMbox( hDev->hHab, regOffset, agcVal );

    BDBG_LEAVE(BTNR_P_7584Ob_GetAgcRegVal);
    return  retCode;
}

BERR_Code BTNR_7584Ob_SetAgcRegVal(
    BTNR_7584Ob_Handle hDev,                /* [in] Device handle */
    uint32_t regOffset,                 /* [in] AGC register offset */
    ...
    )
{
    ...
    BDBG_ENTER(BTNR_7584Ob_SetAgcRegVal);
    BDBG_ASSERT( hDev );
    BDBG_ASSERT( hDev->magicId == DEV_MAGIC_ID );

    retCode = BHAB_WriteMbox( hDev->hHab, regOffset, agcVal );
	
    BDBG_LEAVE(BTNR_7584Ob_SetAgcRegVal);
    return  retCode;
}

BERR_Code BTNR_7584Ob_GetInfo(
    BTNR_7584Ob_Handle hDev,                /* [in] Device handle */
...
{   
    ...
    BDBG_ENTER(BTNR_7584Ob_GetInfo);
    BDBG_ASSERT( hDev );
    BDBG_ASSERT( hDev->magicId == DEV_MAGIC_ID );
    ...
    BDBG_LEAVE(BTNR_7584Ob_GetInfo);
    return  retCode;
}

BERR_Code BTNR_7584Ob_GetPowerSaver(
	BTNR_7584Ob_Handle hDev,					/* [in] Device handle */
...
{  
    ...
    BDBG_ENTER(BTNR_7584Ob_GetPowerSaver);
    ...
    BDBG_LEAVE(BTNR_7584Ob_GetPowerSaver);
    return retCode;
}

BERR_Code BTNR_7584Ob_SetPowerSaver(
	BTNR_7584Ob_Handle hDev,					/* [in] Device handle */
	BTNR_PowerSaverSettings *pwrSettings 		/* [in] Power saver settings. */
	)
{   
    ...
    BDBG_ENTER(BTNR_7584Ob_SetPowerSaver);
    ...
    BDBG_LEAVE(BTNR_7584Ob_SetPowerSaver);
    return retCode;
}


BERR_Code BTNR_7584Ob_GetSettings(
    BTNR_7584Ob_Handle hDev,    /* [in] Device handle */
...
BERR_Code BTNR_7584Ob_SetSettings(
    BTNR_7584Ob_Handle hDev,    /* [in] Device handle */
...
BERR_Code BTNR_7584Ob_GetVersionInfo(
    BTNR_7584Ob_Handle hDev,        /* [in] Device handle */
    ...
    )
{
    ...
    BDBG_ENTER(BTNR_7584Ob_GetVersionInfo);
    BDBG_ASSERT( hDev );
    BDBG_ASSERT( hDev->magicId == DEV_MAGIC_ID );
    ...
    BDBG_LEAVE(BTNR_7584Ob_GetVersionInfo);
    return( retCode );
}
