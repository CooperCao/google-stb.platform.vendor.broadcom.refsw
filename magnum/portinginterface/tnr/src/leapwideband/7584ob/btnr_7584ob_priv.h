 ...
 * 
 ***************************************************************************/
#ifndef BTNR_7584OB_PRIV_H__
#define BTNR_7584OB_PRIV_H__
...
typedef struct BTNR_P_7584Ob_Handle     *BTNR_7584Ob_Handle;

typedef struct BTNR_P_7584Ob_Settings
{
    unsigned long rfFreq;
    unsigned long ifFreq;
    int iRevLetter, iRevNumber, iType;      /* Saved chip information */
    BTNR_TunerMode tunerMode;   
} BTNR_P_7584Ob_Settings;

typedef struct BTNR_P_7584Ob_Handle
{
    uint32_t magicId;                   /* Used to check if structure is corrupt */
    BHAB_Handle hHab;
    BTNR_P_7584Ob_Settings settings;
    bool bPowerdown;    
} BTNR_P_7584Ob_Handle;
