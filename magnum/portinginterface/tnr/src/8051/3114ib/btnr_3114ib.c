...
BDBG_MODULE(btnr_3114ib);

#define	DEV_MAGIC_ID					((BERR_TNR_ID<<16) | 0xFACE)
#define	BTNR_3114Ib_SETTINGS_I2CADDR	(0x66)			/* 7bit addr */

/*******************************************************************************/
BERR_Code BTNR_3114Ib_Open(
	BTNR_Handle *phDev,                 /* [output] Returns handle */
	BTNR_3114Ib_Settings *pSettings,    /* [Input] settings structure */
	...
	)
{
	...
	if( h31xxIbDev == NULL )
	{
		...
		BDBG_ERR(("BTNR_3114Ib_Open: BKNI_malloc() failed"));
		goto done;
	}
	...
	)
{
	...
	pDefSettings->i2cAddr = BTNR_3114Ib_SETTINGS_I2CADDR;
