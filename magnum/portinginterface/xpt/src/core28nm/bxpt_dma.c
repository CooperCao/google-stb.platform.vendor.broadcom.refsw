...
#if ( (BCHP_CHIP==7445) || (BCHP_CHIP==7145) || (BCHP_CHIP==7439) || (BCHP_CHIP==7366) || (BCHP_CHIP==74371) || (BCHP_CHIP==7250) || \
...
#define BXPT_DMA_WDMA_ENDIAN_SWAP_CBIT 1 /* CRXPT-1110 */
#endif
...
#ifdef BCHP_XPT_MEMDMA_MCPB_CH0_PARSER_BAND_ID_CTRL
{
    ...
    reg = BREG_Read32(dma->reg, BCHP_XPT_MEMDMA_MCPB_CH0_SP_PARSER_CTRL + dma->mcpbRegOffset);
#ifndef BCHP_XPT_MEMDMA_MCPB_CH0_PARSER_BAND_ID_CTRL
...
#endif /* (!B_REFSW_MINIMAL || BXPT_DMA_DESC_DUMP || BXPT_DMA_PID_TABLE_DUMP) */
