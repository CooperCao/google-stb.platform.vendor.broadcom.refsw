...
typedef enum eSpliceStopLive_state
{
    eSpliceStopLive_Disabled,
    eSpliceStopLive_Start,
    eSpliceStopLive_FoundPcrOffset,
    eSpliceStopLive_WaitOne,
    eSpliceStopLive_WaitTwo
} eSpliceStopLive_state;
...
typedef struct SoftRaveData
{
    ...
    eSpliceStopLive_state SpliceLiveState;
}
SoftRaveData;
