...
#define BXVD_P_SAVE_DISPLAY_INFO(hXvd, pInitRsp)                        \
      hXvd->pDisplayInfo0 = (void *)(hXvd->uiFWMemBaseUncachedVirtAddr + ((uint32_t)pInitRsp->dms_delivery_address0  - hXvd->uiFWMemBasePhyAddr)); \
      hXvd->pDisplayInfo1 = (void *)(hXvd->uiFWMemBaseUncachedVirtAddr + ((uint32_t)pInitRsp->dms_delivery_address1  - hXvd->uiFWMemBasePhyAddr));
