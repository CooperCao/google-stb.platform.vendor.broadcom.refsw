...
BERR_Code BXVD_P_ChipEnable_RevN0(BXVD_Handle hXvd)
{
    ...
    */
   BDBG_MSG(("OL Ibase: %0x", (unsigned int)hXvd->uiOuterLoopInstructionBase));
   BDBG_MSG(("OL EOC: %0x", (unsigned int)hXvd->uiOuterLoopEOC));

   BDBG_MSG(("IL Ibase: %0x",(unsigned int)hXvd->uiInnerLoopInstructionBase));
   BDBG_MSG(("IL EOC: %0x", (unsigned int)hXvd->uiInnerLoopEOC));
