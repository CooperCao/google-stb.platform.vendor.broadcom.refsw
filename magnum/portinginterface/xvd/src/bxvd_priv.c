...
#if BXVD_P_CORE_REVISION_NUM >= 19
      { 154944, (128 * 1024), 0, 921600, (8192 * 2), BXVD_P_VideoAtomIndex_eA, 1}, /* MPEG2 HD Still */
...
BERR_Code BXVD_P_OpenPartTwo(BXVD_Handle hXvd)
{
   ...
   BXVD_DBG_WRN(hXvd, ("BXVD_P_OpenPartTwo() - Hardware revision: %c, Firmware revision: %lx SHA: %08x",
                       BXVD_P_CORE_REVISION, hXvd->sRevisionInfo.ulDecoderFwRev, hXvd->uiDecoderFwSha));
