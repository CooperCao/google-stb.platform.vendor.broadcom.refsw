...
#ifndef BSID_POWER_H__
#define BSID_POWER_H__
...
typedef enum
{
   BSID_P_ResourceType_eClock,
   BSID_P_ResourceType_ePower,
   BSID_P_ResourceType_eLast
} BSID_P_ResourceType;
