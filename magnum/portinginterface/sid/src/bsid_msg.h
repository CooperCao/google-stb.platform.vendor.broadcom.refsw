...
BERR_Code BSID_P_SendCmdSyncChannel(BSID_ChannelHandle hSidCh);
BERR_Code BSID_P_SendCmdStartDecode(BSID_ChannelHandle hSidCh);

void BSID_P_Dispatch_isr(void *pv_Param1, int iParam2);
void BSID_P_BuildGammaCorrectionTable(BSID_Handle hSid, unsigned char *gamma_correction_table);
void BSID_P_SetDmaChunkInfo(BSID_ChannelHandle hSidCh, const BSID_DmaChunkInfo *ps_DmaChunkInfo);
void BSID_P_SetAbortDma_isr(BSID_ChannelHandle hSidCh);
void BSID_P_UpdatePlaybackInfo_isr(BSID_ChannelHandle hSidCh);
BERR_Code BSID_P_InitPlayback(BSID_ChannelHandle  hSidCh, const BSID_DecodeMotion *ps_MotionSettings);
