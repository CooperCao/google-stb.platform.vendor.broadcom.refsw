...
enum {
   BDSQ_g1_CONFIG_RRTO_US,             /* receive reply timeout in usecs */
   ...
   BDSQ_g1_CONFIG_RX_END_TIMEOUT,      /* rx termination timeout */
   BDSQ_g1_CONFIG_MAX
};
...
typedef enum BDSQ_g1_IntID{
   ...
   BDSQ_g1_IntID_eToneRise,
   BDSQ_g1_IntID_eToneFall,
...
#define BDSQ_EnableLnb                     BDSQ_g1_P_EnableLnb
