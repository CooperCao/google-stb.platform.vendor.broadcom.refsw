...
#endif
#if defined BCHP_AUD_FMM_DP_CTRL0_REG_START
#include "bchp_aud_fmm_dp_ctrl0.h"
#endif
#if defined BCHP_AUD_FMM_SRC_CTRL0_REG_START
...
#if !BAPE_AIO_SUPPORT
#undef BCHP_AUD_FMM_BF_CTRL_REG_START
#undef BCHP_AUD_FMM_DP_CTRL0_REG_START
#undef BCHP_AUD_FMM_SRC_CTRL0_REG_START
#undef BCHP_AIO_MISC_REG_START
#undef BCHP_AUD_FMM_IOP_MISC_REG_START
#undef BCHP_AUD_FMM_MISC_STC_UPPERi_ARRAY_END
#undef BCHP_AUD_MISC_STC_UPPERi_ARRAY_END
#undef BCHP_HIFIDAC_CTRL2_REG_START
#undef BCHP_HIFIDAC_CTRL_2_REG_START
#undef BCHP_HIFIDAC_CTRL1_REG_START
#undef BCHP_HIFIDAC_CTRL_1_REG_START
#undef BCHP_HIFIDAC_CTRL0_REG_START
#undef BCHP_HIFIDAC_CTRL_0_REG_START
#undef BCHP_AUD_FMM_OP_CTRL_I2SS1_CFG
#undef BCHP_AUD_FMM_IOP_OUT_I2S_STEREO_1_REG_START
#undef BCHP_AUD_FMM_IOP_OUT_I2S_1_REG_START
#undef BCHP_AUD_FMM_OP_CTRL_I2SS0_CFG
#undef BCHP_AUD_FMM_IOP_OUT_I2S_STEREO_0_REG_START
#undef BCHP_AUD_FMM_IOP_OUT_I2S_0_REG_START
#undef BCHP_AUD_FMM_IOP_CTRL_I2SIN_CFG1
#undef BCHP_AUD_FMM_IOP_IN_I2S_STEREO_1_REG_START
#undef BCHP_AUD_FMM_IOP_IN_I2S_1_REG_START
#undef BCHP_AUD_FMM_IOP_CTRL_I2SIN_CFG0
#undef BCHP_AUD_FMM_IOP_IN_I2S_STEREO_0_REG_START
#undef BCHP_AUD_FMM_IOP_IN_I2S_0_REG_START
#undef BCHP_HDMI_RCVR_CTRL_REG_START
#undef BCHP_AUD_FMM_IOP_IN_HDMI_0_REG_START
#undef BCHP_SPDIF_RCVR_CTRL_REG_START
#undef BCHP_AUD_FMM_IOP_IN_SPDIF_0_REG_START
#undef BCHP_RFM_SYSCLK_REG_START
#undef BCHP_AUD_MISC_CRC_CFGi_ARRAY_BASE
#undef BCHP_AUD_FMM_IOP_OUT_SPDIF_1_REG_START
#undef BCHP_AUD_FMM_OP_CTRL_SPDIF_CFG_0
#undef BCHP_AUD_FMM_IOP_OUT_SPDIF_0_REG_START
#undef BCHP_AUD_FMM_IOP_OUT_MAI_1_REG_START
#undef BCHP_AUD_FMM_OP_CTRL_MAI_FORMAT
#undef BCHP_AUD_FMM_IOP_OUT_MAI_0_REG_START
#undef BCHP_AUD_FMM_MISC_SEROUT_SEL_SPDIF_OUT_1_ENABLE_MASK
#undef BCHP_AUD_MISC_SEROUT_SEL_HDMI_RX_ARC_ENABLE_MASK
#undef BCHP_AUD_FMM_PLL2_REG_START
#undef BCHP_AUD_FMM_IOP_PLL_2_REG_START
#undef BCHP_AUD_FMM_PLL1_REG_START
#undef BCHP_AUD_FMM_IOP_PLL_1_REG_START
#undef BCHP_AUD_FMM_PLL0_REG_START
#undef BCHP_AUD_FMM_IOP_PLL_0_REG_START
#undef BCHP_AUD_FMM_OP_MCLKGEN_MCLK_GEN_6_CONTROL
#undef BCHP_AUD_FMM_IOP_NCO_6_REG_START
#undef BCHP_AUD_FMM_OP_MCLKGEN_MCLK_GEN_5_CONTROL
#undef BCHP_AUD_FMM_IOP_NCO_5_REG_START
#undef BCHP_AUD_FMM_OP_MCLKGEN_MCLK_GEN_4_CONTROL
#undef BCHP_AUD_FMM_IOP_NCO_4_REG_START
#undef BCHP_AUD_FMM_OP_MCLKGEN_MCLK_GEN_3_CONTROL
#undef BCHP_AUD_FMM_IOP_NCO_3_REG_START
#undef BCHP_AUD_FMM_OP_MCLKGEN_MCLK_GEN_2_CONTROL
#undef BCHP_AUD_FMM_IOP_NCO_2_REG_START
#undef BCHP_AUD_FMM_OP_MCLKGEN_MCLK_GEN_1_CONTROL
#undef BCHP_AUD_FMM_IOP_NCO_1_REG_START
#undef BCHP_AUD_FMM_OP_MCLKGEN_MCLK_GEN_0_CONTROL
#undef BCHP_AUD_FMM_IOP_NCO_0_REG_START
#undef BCHP_AUD_FMM_BF_CTRL_SOURCECH_CFGi_ARRAY_END
#undef BCHP_AUD_FMM_BF_CTRL_DESTCH_CFG0
#undef BCHP_AUD_FMM_BF_CTRL_DESTCH_CFGi_ARRAY_END
#undef BCHP_AUD_FMM_SRC_CTRL0_STRM_CFGi_ARRAY_END
#undef BCHP_AUD_FMM_DP_CTRL0_MIXER_CONFIGi_ARRAY_END
#undef BCHP_AUD_FMM_DP_CTRL0_MIXER11_CONFIG
#undef BCHP_AUD_FMM_DP_CTRL0_MIXER7_CONFIG
#undef BCHP_AUD_FMM_DP_CTRL0_MIXER0_CONFIG
#undef BCHP_AUD_FMM_DP_CTRL0_PB_FCI_IDi_ARRAY_END
#undef BCHP_AUD_FMM_IOP_DUMMYSINK_0_REG_START
#undef BCHP_AUD_FMM_IOP_CTRL_DUMMYSINK_CFGi_ARRAY_END
#undef BCHP_AUD_FMM_IOP_CTRL_LOOPBACK_CFG0
#undef BCHP_AUD_FMM_IOP_CTRL_LOOPBACK_CFG
#undef BCHP_AUD_FMM_IOP_CTRL_LOOPBACK_CFGi_ARRAY_END
#undef BCHP_AUD_FMM_IOP_LOOPBACK_0_REG_START
#undef BCHP_AUD_FMM_OP_CTRL_MCLK_CFG_FSi_ARRAY_END
#undef BCHP_AUD_FMM_OP_CTRL_MCLK_CFG_EXTi_ARRAY_END
#undef BCHP_AUD_FMM_IOP_MISC_MCLK_CFG_i_ARRAY_END
#undef BCHP_AUD_FMM_OP_CTRL_ENABLE_STATUS_reserved0_MASK
#undef BCHP_AUD_FMM_BF_CTRL_ADAPTRATE_CFGi_ARRAY_END
#undef BCHP_AUD_FMM_BF_CTRL_ADAPTRATE_9_CFG
#undef BCHP_AUD_FMM_BF_CTRL_ADAPTRATE_7_CFG
#undef BCHP_AUD_FMM_BF_CTRL_ADAPTRATE_3_CFG
#undef BCHP_AUD_FMM_IOP_CTRL_REG_START
#undef BCHP_AUD_MISC_FCI_SPLTR0_CTRLi_ARRAY_START
#undef BCHP_AIO_INTH_REG_START
#undef BCHP_AUD_INTH_REG_START
#undef BCHP_AUD_FMM_BF_ESR_REG_START
#endif /* BAPE_NOAIO_EMULATION */

#if defined BCHP_AUD_FMM_BF_CTRL_REG_START
  #define BAPE_CHIP_AIO_SUPPORT     1
#else
  #define BAPE_CHIP_AIO_SUPPORT     0
#endif

/* Max STCs */
#if defined BCHP_AUD_FMM_MISC_STC_UPPERi_ARRAY_END
/* Legacy RDB */
#define BAPE_CHIP_MAX_STCS (1+BCHP_AUD_FMM_MISC_STC_UPPERi_ARRAY_END-BCHP_AUD_FMM_MISC_STC_UPPERi_ARRAY_START)
#if defined BCHP_AUD_FMM_MISC_STC_LOWERi_ARRAY_BASE
...
#endif
#elif defined BCHP_AUD_MISC_STC_UPPERi_ARRAY_END
/* 7429 style RDB */
#define BAPE_CHIP_MAX_STCS (1+BCHP_AUD_MISC_STC_UPPERi_ARRAY_END-BCHP_AUD_MISC_STC_UPPERi_ARRAY_START)
...
#define BAPE_CHIP_MAX_CRCS (1+BCHP_AUD_MISC_CRC_CFGi_ARRAY_END-BCHP_AUD_MISC_CRC_CFGi_ARRAY_START)
#else
...
#else
#define BAPE_CHIP_MAX_SPDIF_OUTPUTS (0)
#endif
...
#else
#define BAPE_CHIP_MAX_AUDIO_RETURN_CHANNELS (0)
#endif
...
/* SFIFO Details */
#if defined BCHP_AUD_FMM_BF_CTRL_SOURCECH_CFGi_ARRAY_END
#define BAPE_CHIP_MAX_SFIFOS (1+BCHP_AUD_FMM_BF_CTRL_SOURCECH_CFGi_ARRAY_END-BCHP_AUD_FMM_BF_CTRL_SOURCECH_CFGi_ARRAY_START)
#else
#define BAPE_CHIP_MAX_SFIFOS (0)
#endif

#define BAPE_CHIP_SFIFO_PADDING 1024

/* DFIFO Details */
#if defined BCHP_AUD_FMM_BF_CTRL_DESTCH_CFG0
#define BAPE_CHIP_MAX_DFIFOS (1)  /* Required because the RDB defs change with only one channel */
#elif defined BCHP_AUD_FMM_BF_CTRL_DESTCH_CFGi_ARRAY_END
#define BAPE_CHIP_MAX_DFIFOS (1+BCHP_AUD_FMM_BF_CTRL_DESTCH_CFGi_ARRAY_END-BCHP_AUD_FMM_BF_CTRL_DESTCH_CFGi_ARRAY_START)
#else
#define BAPE_CHIP_MAX_DFIFOS (0)
#endif
...
/* SRC Details */
#if defined BCHP_AUD_FMM_SRC_CTRL0_STRM_CFGi_ARRAY_END
#define BAPE_CHIP_MAX_SRCS (1+BCHP_AUD_FMM_SRC_CTRL0_STRM_CFGi_ARRAY_END-BCHP_AUD_FMM_SRC_CTRL0_STRM_CFGi_ARRAY_START)
#else
#define BAPE_CHIP_MAX_SRCS (0)
#endif

#if BAPE_CHIP_MAX_SFIFOS == 0 || BAPE_CHIP_MAX_DFIFOS == 0
#define BAPE_CHIP_DRAM_BUFFER_MANAGEMENT 1
#else
#define BAPE_CHIP_DRAM_BUFFER_MANAGEMENT 0
#endif
...
/* Mixer Details */
#if BCHP_CHIP == 7408
#define BAPE_CHIP_MAX_BYPASS_MIXERS (0)
#define BAPE_CHIP_MAX_HW_MIXERS (6)             /* On the 7408, this is 6, others have more -- This must match the HW for coefficient loading. */
...
#define BAPE_CHIP_MAX_BYPASS_MIXERS (0)
#define BAPE_CHIP_MAX_HW_MIXERS (1+BCHP_AUD_FMM_DP_CTRL0_MIXER_CONFIGi_ARRAY_END-BCHP_AUD_FMM_DP_CTRL0_MIXER_CONFIGi_ARRAY_START)
#define BAPE_CHIP_MAX_MIXER_INPUTS (1+BCHP_AUD_FMM_DP_CTRL0_MIXER0_INPUT_CONFIGi_ARRAY_END-BCHP_AUD_FMM_DP_CTRL0_MIXER0_INPUT_CONFIGi_ARRAY_START)
#elif defined BCHP_AUD_FMM_DP_CTRL0_MIXER11_CONFIG
/* 7425-style mixer block */
#define BAPE_CHIP_MAX_BYPASS_MIXERS (0)
#define BAPE_CHIP_MAX_HW_MIXERS (12)
#define BAPE_CHIP_MAX_MIXER_INPUTS (8)
#elif defined BCHP_AUD_FMM_DP_CTRL0_MIXER7_CONFIG
/* Legacy 8-mixer block */
#define BAPE_CHIP_MAX_BYPASS_MIXERS (0)
#define BAPE_CHIP_MAX_HW_MIXERS (8)
#define BAPE_CHIP_MAX_MIXER_INPUTS (8)
#elif !defined( BCHP_AUD_FMM_DP_CTRL0_MIXER0_CONFIG )
/* No HW Mixing resources */
#define BAPE_CHIP_MAX_MIXER_INPUTS (8)
#define BAPE_CHIP_MAX_HW_MIXERS (0)
#define BAPE_CHIP_MAX_BYPASS_MIXERS (4) /* use Host based mixer - required for output mixers */
#endif
#endif

#define BAPE_CHIP_MAX_HW_MIXER_OUTPUTS (2) /* HW Mixers support two outputs */

#define BAPE_CHIP_MAX_BYPASS_MIXER_INPUTS (1)
#define BAPE_CHIP_MAX_BYPASS_MIXER_OUTPUTS (1)

#if defined BCHP_AUD_FMM_DP_CTRL0_PB_FCI_IDi_ARRAY_END
...
#else
#define BAPE_CHIP_MAX_MIXER_PLAYBACKS (0)
#endif

/* Dummysinks */
#ifdef BCHP_AUD_FMM_IOP_DUMMYSINK_0_REG_START
#include "bchp_aud_fmm_iop_dummysink_0.h"
#define BAPE_CHIP_MAX_DUMMYSINKS (1+BCHP_AUD_FMM_IOP_DUMMYSINK_0_STREAM_CFG_0_i_ARRAY_END-BCHP_AUD_FMM_IOP_DUMMYSINK_0_STREAM_CFG_0_i_ARRAY_START)
#elif defined BCHP_AUD_FMM_IOP_CTRL_DUMMYSINK_CFGi_ARRAY_END
#define BAPE_CHIP_MAX_DUMMYSINKS (1+BCHP_AUD_FMM_IOP_CTRL_DUMMYSINK_CFGi_ARRAY_END-BCHP_AUD_FMM_IOP_CTRL_DUMMYSINK_CFGi_ARRAY_START)
#else
#define BAPE_CHIP_MAX_DUMMYSINKS (0)
#endif
...
#define BAPE_CHIP_MAX_LOOPBACKS (1+BCHP_AUD_FMM_IOP_CTRL_LOOPBACK_CFGi_ARRAY_END-BCHP_AUD_FMM_IOP_CTRL_LOOPBACK_CFGi_ARRAY_START)
#elif defined BCHP_AUD_FMM_IOP_LOOPBACK_0_REG_START
#include "bchp_aud_fmm_iop_loopback_0.h"
#define BAPE_CHIP_MAX_LOOPBACKS (1+BCHP_AUD_FMM_IOP_LOOPBACK_0_STREAM_CFG_i_ARRAY_END-BCHP_AUD_FMM_IOP_LOOPBACK_0_STREAM_CFG_i_ARRAY_START)
#else
#define BAPE_CHIP_MAX_LOOPBACKS (0)
#endif

#if defined BCHP_AUD_FMM_OP_CTRL_MCLK_CFG_FSi_ARRAY_END
/* FS Timing Sources */
#define BAPE_CHIP_MAX_FS (1+BCHP_AUD_FMM_OP_CTRL_MCLK_CFG_FSi_ARRAY_END-BCHP_AUD_FMM_OP_CTRL_MCLK_CFG_FSi_ARRAY_START)
#else
#define BAPE_CHIP_MAX_FS (0)
#endif
...
#if defined BCHP_AUD_FMM_OP_CTRL_ENABLE_STATUS_reserved0_MASK
#define BAPE_CHIP_MAX_OUTPUT_PORTS (BCHP_SHIFT(AUD_FMM_OP_CTRL_ENABLE_STATUS, reserved0))    /* Total output ports  */
#else
#define BAPE_CHIP_MAX_OUTPUT_PORTS (0)
#endif

#if defined BCHP_AUD_FMM_BF_CTRL_ADAPTRATE_CFGi_ARRAY_END
#define BAPE_CHIP_MAX_ADAPTRATE_CONTROLLERS (1+BCHP_AUD_FMM_BF_CTRL_ADAPTRATE_CFGi_ARRAY_END-BCHP_AUD_FMM_BF_CTRL_ADAPTRATE_CFGi_ARRAY_START)
#elif defined BCHP_AUD_FMM_BF_CTRL_ADAPTRATE_9_CFG
#define BAPE_CHIP_MAX_ADAPTRATE_CONTROLLERS (10)
#elif defined BCHP_AUD_FMM_BF_CTRL_ADAPTRATE_7_CFG
#define BAPE_CHIP_MAX_ADAPTRATE_CONTROLLERS (8)
#elif defined BCHP_AUD_FMM_BF_CTRL_ADAPTRATE_3_CFG
#define BAPE_CHIP_MAX_ADAPTRATE_CONTROLLERS (4)
#else
#define BAPE_CHIP_MAX_ADAPTRATE_CONTROLLERS (0)
#endif
...
#define BAPE_CHIP_MAX_OUTPUTS (BAPE_CHIP_MAX_DUMMYSINKS + BAPE_CHIP_MAX_OUTPUT_CAPTURES + BAPE_CHIP_MAX_I2S_OUTPUTS + \
...
#if defined BCHP_AUD_MISC_FCI_SPLTR0_CTRLi_ARRAY_START
    ...
    #define BAPE_INPUT_CAPTURE_REQUIRES_SFIFO   (0)
        ...
        #elif BDSP_MS12_SUPPORT || BDSP_MS11PLUS_SUPPORT || BDSP_MS10_SUPPORT || defined BDSP_DDP_PASSTHRU_SUPPORT
...
#else
#define BAPE_CHIP_MAX_PLAYBACKS (8)
#endif
...
#else
#define BAPE_CHIP_MAX_OUTPUT_CAPTURES (4) /* Dram based capture */
#endif
#define BAPE_CHIP_MAX_OUTPUT_CAPTURE_CHANNELS (8)

#define BAPE_CHIP_MAX_EQUALIZERS (BAPE_CHIP_MAX_SRCS)
...
#define BAPE_CHIP_MAX_MIXER_GROUPS (BAPE_CHIP_MAX_HW_MIXERS)
...
/* keep Plls off until needed */
#define BAPE_CHIP_DYNAMIC_PLL_POWER     1
#define BAPE_CHIP_DSP_REQUIRES_PLL      1
#define BAPE_CHIP_CLOCK_VERIFY_TIMEOUT  5 /* milliseconds */
#define BAPE_CHIP_TIME_PLL_VERIFY       0
