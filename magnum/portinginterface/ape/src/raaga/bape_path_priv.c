...
BERR_Code BAPE_PathNode_P_EnumerateUpstreamPathNodes( BAPE_PathNode  *pPathNode, int level, BAPE_PathNode_P_EnumerateCallback callback)
{
    ...
    /* BDBG_MSG(("%*s%s : %d : pPathNode:%p  level:%d", level*4, "", BSTD_FUNCTION, __LINE__ ,
    ...
    {
        /* BDBG_MSG(("%*s%s : %d : pPathNode:%p  Found pPathConnection:%p", level*4, "", BSTD_FUNCTION, __LINE__ ,
...
BERR_Code BAPE_PathNode_P_EnumerateDownstreamPathNodes( BAPE_PathNode  *pPathNode, int level, BAPE_PathNode_P_EnumerateCallback callback)
{
    ...
    for ( i=0 ; i<BAPE_ConnectorFormat_eMax ; i++ )
    {
        ...
        /* BDBG_MSG(("%*s%s : %d : pPathNode:%p Found pPathConnector:%p  level:%d", level*4, "", BSTD_FUNCTION, __LINE__ ,
        ...
        {
            /* BDBG_MSG(("%*s%s : %d : pPathNode:%p pPathConnector:%p Found pPathConnection:%p  ", level*4, "", BSTD_FUNCTION, __LINE__ ,
