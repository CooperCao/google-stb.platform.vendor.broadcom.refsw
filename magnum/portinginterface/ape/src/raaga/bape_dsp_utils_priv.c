...
/*   AVC Codec                              DSP Decode                            DSP Passthrough                       DSP Encode                        Name            Max multichannel format       SPDIF? SRC?  PassthruReq'd , Simul?, mono?,     4x?,   16x? */
    ...
    {BAVC_AudioCompressionStd_eAc4,         BDSP_Algorithm_eAC4Decode,            BDSP_Algorithm_eMax,                  BDSP_Algorithm_eMax,              "AC4",          BAPE_MultichannelFormat_e5_1, true,  false, false,         true,   false,   false,   false},
...
BAPE_DolbyMSVersion BAPE_P_GetDolbyMSVersion_isrsafe(void)
{
    ...
    return BAPE_DolbyMSVersion_eMS11Plus;
