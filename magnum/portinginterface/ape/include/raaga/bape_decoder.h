...
Decoder Sync Modes
***************************************************************************/
typedef enum BAPE_DecoderTargetSyncMode
{
    BAPE_DecoderTargetSyncMode_eDisabledAfterLock=0,  /* The decoder will require a frame plus start of next frame to lock, then only a single frame to decode afterward. */
    BAPE_DecoderTargetSyncMode_eEnabled,              /* The decoder will always require a frame plus start of next frame to lock and decode. */
    BAPE_DecoderTargetSyncMode_eDisabled,             /* The decoder will lock when it finds a single frame - This mode is unsafe for any random access and may significantly degrade performance if used incorrectly */
    BAPE_DecoderTargetSyncMode_eMax
} BAPE_DecoderTargetSyncMode;
...
typedef struct BAPE_DecoderStartSettings
{
    ...
    BAPE_DecoderTargetSyncMode targetSyncEnabled;  /* Target Sync Mode.  See BAPE_DecoderTargetSyncMode for more information */
