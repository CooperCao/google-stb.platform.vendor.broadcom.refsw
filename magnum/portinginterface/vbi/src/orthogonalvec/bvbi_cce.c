...
*/
    ...
    ulLinesReg &= ~(
        BCHP_MASK       ( CCE_0_Active_Lines_SCTE_OFF, TOP_ACTIVE             ) |
        BCHP_MASK       ( CCE_0_Active_Lines_SCTE_OFF, BOT_ACTIVE             ) );
    ulLinesReg |= (
        BCHP_FIELD_DATA ( CCE_0_Active_Lines_SCTE_OFF, TOP_ACTIVE, ulLineMask ) |
        BCHP_FIELD_DATA ( CCE_0_Active_Lines_SCTE_OFF, BOT_ACTIVE, ulLineMask ) );
    BREG_Write32 (
...
*/
    ...
    ulLinesReg &= ~(
        BCHP_MASK       ( CCE_ANCIL_0_Ancil_Active_Lines_SCTE_OFF, TOP_ACTIVE             ) |
        BCHP_MASK       ( CCE_ANCIL_0_Ancil_Active_Lines_SCTE_OFF, BOT_ACTIVE             ) );
    ulLinesReg |= (
        BCHP_FIELD_DATA ( CCE_ANCIL_0_Ancil_Active_Lines_SCTE_OFF, TOP_ACTIVE, ulLineMask ) |
        BCHP_FIELD_DATA ( CCE_ANCIL_0_Ancil_Active_Lines_SCTE_OFF, BOT_ACTIVE, ulLineMask ) );
    BREG_Write32 (
