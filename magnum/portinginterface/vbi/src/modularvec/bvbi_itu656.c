...
#include "bchp_itu656.h"	/* RDB info for ITU656 registers */
	...
	BREG_Handle hReg, const BVBI_XSER_Settings* pXSERdefaultSettings )
{
    ...
    case BVBI_TTserialDataSync_EAV:
		iMode = BCHP_ITU656_ITU656_TTE_CTRL_TTE_MODE_EAV;
		break;
    case BVBI_TTserialDataSync_SAV:
		iMode = BCHP_ITU656_ITU656_TTE_CTRL_TTE_MODE_SAV;
		break;
    case BVBI_TTserialDataSync_RQ:
		iMode = BCHP_ITU656_ITU656_TTE_CTRL_TTE_MODE_RQ;
		break;
	default:
		iMode = BCHP_ITU656_ITU656_TTE_CTRL_TTE_MODE_DISABLED;
		break;
	}

	ulReg = (
	BCHP_FIELD_DATA (ITU656_ITU656_TTE_CTRL, TTE_MODE,    iMode) |
	BCHP_FIELD_DATA (ITU656_ITU656_TTE_CTRL, DELAY_COUNT, 
	      pXSERdefaultSettings->iTTserialDataSyncDelay) );
	BREG_Write32 (hReg, BCHP_ITU656_ITU656_TTE_CTRL, ulReg);
