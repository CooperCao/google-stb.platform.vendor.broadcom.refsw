...
#define		VIDEO_NTSC_BIT			4
#define		VIDEO_COFDM_BIT			3 
...
#define		VIDEO_STATUS_MODE_NTSC		0x10
#define		VIDEO_STATUS_MODE_COFDM		0x08
#define		VIDEO_STATUS_LOSS_DET		0x02
#define		VIDEO_STATUS_LOCK_DET		0x01
#endif
...
*******************************************************************************/
#define ixHI_ANALOG_VIDEO_STANDARD 		ixUC_GP_2
typedef enum
{
    VIDEO_STANDARD__NTSC_M,
    VIDEO_STANDARD__NTSC_N,
    VIDEO_STANDARD__NTSC_J,
    VIDEO_STANDARD__NTSC_443,
    VIDEO_STANDARD__PAL_B,
    VIDEO_STANDARD__PAL_B1,
    VIDEO_STANDARD__PAL_D,
    VIDEO_STANDARD__PAL_G,
    VIDEO_STANDARD__PAL_H,
    VIDEO_STANDARD__PAL_I,
    VIDEO_STANDARD__PAL_N,
    VIDEO_STANDARD__PAL_N_COMBO,
    VIDEO_STANDARD__PAL_M,
    VIDEO_STANDARD__PAL_60,
    VIDEO_STANDARD__SECAM_B,
    VIDEO_STANDARD__SECAM_D,
    VIDEO_STANDARD__SECAM_G,
    VIDEO_STANDARD__SECAM_H,
    VIDEO_STANDARD__SECAM_K,
    VIDEO_STANDARD__SECAM_K1,
    VIDEO_STANDARD__SECAM_L,
    VIDEO_STANDARD__SECAM_L1
} AnalogVideoStandard;

typedef enum
{
    VIDEO_STANDARD__60HZ,
    VIDEO_STANDARD__50HZ
} GenericVideoStandard;


typedef enum
{
    MODULATION_TYPE__NEGATIVE,
    MODULATION_TYPE__POSITIVE
} VideoModulationType;
...
/*******************************************************************************
* COFDM Acquisition Options
*******************************************************************************/
#define ixHI_COFDM_MODE_SELECT		ixUC_GP_8
#define		COFDM_MODE_MASK			0x03
#define		COFDM_INPUT_8MHZ		0x00
#define		COFDM_INPUT_7MHZ		0x01
#define		COFDM_INPUT_6MHZ		0x02
#define		COFDM_INPUT_5MHZ		0x03

#define ixHI_COFDM_CONFIG			ixUC_GP_9
#define 	COFDM_CO_ENABLE			0x80
#define		COFDM_ADJ_ENABLE		0x40
#define		COFDM_MOBILE_ENABLE		0x20
#define		COFDM_ENHANCED_ACQ_EN	0x10
#define		COFDM_LOW_PRIORITY_EN	0x08 /*HP is default. Soon to be extinct option. */
...
#define SVC_NXTENNA_RW			4
#define SVC_NXTENNA_TRACK		5
#define SVC_SET_FDC_IF			6
...
#define ixHI_ANALOG_FREQ_OFFSET_HZ_2	ixUC_GP_50
#define ixHI_ANALOG_FREQ_OFFSET_HZ_1	ixUC_GP_51
#define ixHI_ANALOG_FREQ_OFFSET_HZ_0	ixUC_GP_52

#define ixHI_ANALOG_DEMOD_STATUS	ixUC_GP_48
#define		ANALOG_DEMOD_STATUS_INACTIVE		0x00
#define		ANALOG_DEMOD_STATUS_SEARCHING		0x01
#define		ANALOG_DEMOD_STATUS_LOCKED			0x02
#define		ANALOG_DEMOD_STATUS_NO_SIGNAL		0x03
#define		ANALOG_DEMOD_STATUS_NO_CARRIER_LOCK	0x04
#define		ANALOG_DEMOD_STATUS_NO_FREQ_LOCK	0x05
#define		ANALOG_DEMOD_STATUS_NO_H_LOCK		0x06
