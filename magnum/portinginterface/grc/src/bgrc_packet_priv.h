...
typedef enum
{
    BGRC_PACKET_P_SyncState_eCleared, /* no checkpoint pending */
    BGRC_PACKET_P_SyncState_eRequested, /* checkpoint requested */
    BGRC_PACKET_P_SyncState_eQueuedInHw, /* checkpoint put into HW fifo */
    BGRC_PACKET_P_SyncState_eSynced /* checkpoint reached, need to notify upper layer */
}
...
BERR_Code BGRC_PACKET_P_ProcessSwPktFifo( BGRC_Handle hGrc, BGRC_PacketContext_Handle hContext );
