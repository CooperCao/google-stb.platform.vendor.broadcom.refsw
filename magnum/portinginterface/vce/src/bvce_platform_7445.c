         ...
         )
{
...

   {
      ...
      pstPlatformConfig->stPictureMailbox[0].uiInterruptMask = BCHP_VICE2_ARCSS_ESS_P1_INTR2_0_0_ARC_P0_SET_VIP0_INTR_MASK;
      ...
      pstPlatformConfig->stPictureMailbox[1].uiInterruptMask = BCHP_VICE2_ARCSS_ESS_P1_INTR2_0_0_ARC_P1_SET_VIP1_INTR_MASK;

#if BVCE_PLATFORM_P_NUM_OUTPUT_CHANNELS >= 3
      pstPlatformConfig->stPictureMailbox[2].uiBufferAddress = BCHP_VICE2_ARCSS_ESS_DCCM_0_0_DATAi_ARRAY_BASE + BVN2VICE_MBOX_PAYLOAD_OFFSET + ( 2 * sizeof( BVCE_P_FW_PictureBufferMailbox ) ) + iInstanceRegisterOffset;
      pstPlatformConfig->stPictureMailbox[2].uiInterruptAddress = BCHP_VICE2_ARCSS_ESS_P1_INTR2_0_0_ARC_P1_SET + iInstanceRegisterOffset;
      pstPlatformConfig->stPictureMailbox[2].uiInterruptMask = BCHP_VICE2_ARCSS_ESS_P1_INTR2_0_0_ARC_P1_SET_VIP1_INTR_MASK;
#endif
