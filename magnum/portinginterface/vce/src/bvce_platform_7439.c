         ...
         )
{
...

   {
      ...
      pstPlatformConfig->stPictureMailbox[0].uiBufferAddress = BCHP_VICE2_ARCSS_ESS_DCCM_0_0_DATAi_ARRAY_BASE + BVN2VICE_MBOX_PAYLOAD_OFFSET + ( 0 * sizeof( BVCE_P_FW_PictureBufferMailbox ) );
      pstPlatformConfig->stPictureMailbox[0].uiInterruptAddress = BCHP_VICE2_ARCSS_ESS_P1_INTR2_0_0_ARC_P1_SET;
      pstPlatformConfig->stPictureMailbox[0].uiInterruptMask = BCHP_VICE2_ARCSS_ESS_P1_INTR2_0_0_ARC_P1_SET_VIP0_INTR_MASK;

      pstPlatformConfig->stPictureMailbox[1].uiBufferAddress = BCHP_VICE2_ARCSS_ESS_DCCM_0_0_DATAi_ARRAY_BASE + BVN2VICE_MBOX_PAYLOAD_OFFSET + ( 1 * sizeof( BVCE_P_FW_PictureBufferMailbox ) );
      pstPlatformConfig->stPictureMailbox[1].uiInterruptAddress = BCHP_VICE2_ARCSS_ESS_P1_INTR2_0_0_ARC_P1_SET;
      ...
      pstPlatformConfig->stHostCPUDebugRegisterDumpList.iInstanceOffset = BCHP_VICE2_ARCSS_ESS_HOSTIF_0_0_HOSTIFi_ARRAY_BASE;
