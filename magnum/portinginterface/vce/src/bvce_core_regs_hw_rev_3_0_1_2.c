...
{ 0x0000105c, BDBG_STRING("BCHP_VICE_FME_0_AVC_MERGE_MV_COST"), BDBG_STRING("AVC Mode Merge MV overhead cost."), false },
{ 0x00001060, BDBG_STRING("BCHP_VICE_FME_0_RDO_QUANT_OFFSET"), BDBG_STRING("Quantization offset for FME RDO."), false },
{ 0x00001064, BDBG_STRING("BCHP_VICE_FME_0_RANDOM_TEST_MODE"), BDBG_STRING("Random test mode control"), false },
{ 0x00001068, BDBG_STRING("BCHP_VICE_FME_0_RANDOM_TEST_SEED"), BDBG_STRING("Random test random number generator seed"), false },
{ 0x0000106c, BDBG_STRING("BCHP_VICE_FME_0_RANDOM_TEST_MV_BITS"), BDBG_STRING("Random test number of bits for motion vector"), false },
{ 0x00001070, BDBG_STRING("BCHP_VICE_FME_0_RANDOM_TEST_CU_COST_BITS"), BDBG_STRING("Random test number of bits for CU cost"), false },
{ 0x00001074, BDBG_STRING("BCHP_VICE_FME_0_SCRATCH"), BDBG_STRING("Scratch Register"), false },
{ 0x00001078, BDBG_STRING("BCHP_VICE_FME_0_FME_DEBUG_SEL"), BDBG_STRING("FME debug information select register"), false },
{ 0x0000107c, BDBG_STRING("BCHP_VICE_FME_0_ERR_STATUS_ENABLE"), BDBG_STRING("FME error status enable register"), false },
...
{ 0x00058010, BDBG_STRING("BCHP_VICE_ARCSS_ESS_ADI_1_ADI_RX_FIFO_RSVD"), BDBG_STRING("ADI RX FIFO Reserved For Future"), false },
{ 0x00058050, BDBG_STRING("BCHP_VICE_ARCSS_ESS_ADI_1_ADI_RX_WRITE_RSVD"), BDBG_STRING("ADI RX WRITE Reserved For Future"), false },
{ 0x00058070, BDBG_STRING("BCHP_VICE_ARCSS_ESS_ADI_1_ADI_RX_READ_RSVD"), BDBG_STRING("ADI RX POINTERS Reserved For Future"), false },
{ 0x00058090, BDBG_STRING("BCHP_VICE_ARCSS_ESS_ADI_1_ADI_RX_FIFO_EN_RSVD"), BDBG_STRING("ADI RX FIFO_EN Reserved For Future"), false },
...
#if BDBG_DEBUG_BUILD
const unsigned s_uiViceHardwareRegistersCount = 576;
#else
