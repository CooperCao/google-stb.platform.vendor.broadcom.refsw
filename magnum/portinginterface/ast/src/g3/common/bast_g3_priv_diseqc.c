...
BERR_Code BAST_g3_P_CalibrateDcOffset1_isr(BAST_ChannelHandle h);
BERR_Code BAST_g3_P_ResetVsense_isr(BAST_ChannelHandle h);
BERR_Code BAST_g3_P_SendDiseqcCommand1_isr(BAST_ChannelHandle h);
