...
/* local functions */
static BERR_Code BAST_g3_P_HpAcquire1_isr(BAST_ChannelHandle h);
#ifdef BAST_ENABLE_FINE_FREQ_ESTIMATION
static void BAST_g3_P_HpSetFineFrequencyEstimate_isr(BAST_ChannelHandle h);
#endif
...
******************************************************************************/
static BERR_Code BAST_g3_P_HpEnableInterrupts_isr(BAST_ChannelHandle h)
{
   BAST_g3_P_ChannelHandle *hChn = (BAST_g3_P_ChannelHandle *)h->pImpl;
...
******************************************************************************/
static BERR_Code BAST_g3_P_HpConfig_isr(BAST_ChannelHandle h)
{
...
******************************************************************************/
static BERR_Code BAST_g3_P_OnHpStableLock_isr(BAST_ChannelHandle h)
{
   BERR_Code retCode;
   BAST_g3_P_ChannelHandle *hChn = (BAST_g3_P_ChannelHandle *)h->pImpl;
#ifndef BAST_EXCLUDE_LDPC
...
******************************************************************************/
static BERR_Code BAST_g3_P_HpCheckStableLock_isr(BAST_ChannelHandle h)
{
   BAST_g3_P_ChannelHandle *hChn = (BAST_g3_P_ChannelHandle *)h->pImpl;
