...
#define BAST_FTM_MINOR_VERSION 0x06
#define BAST_FTM_BUILD_NUM     0x0001
...
#elif ((BCHP_CHIP==7360) || (BCHP_CHIP==7362) || (BCHP_CHIP==73625) || (BCHP_CHIP==7228) || (BCHP_CHIP==4538))
   #define BAST_FTM_CORE_REV  BAST_FTM_CORE_REV_1P8
...
#define BAST_FTM_PKT_AGGR_REG_REQUEST  0x02
#define BAST_FTM_PKT_AGGR_TUNE         0x03
#define BAST_FTM_PKT_ADV_TUNE          0x04
#define BAST_FTM_PKT_XTUNE             0x05
#define BAST_FTM_PKT_HEARTBEAT         0x06
#define BAST_FTM_PKT_FTM_UP            0x08
#define BAST_FTM_PKT_VERSION           0x0A
#define BAST_FTM_PKT_DIAGS             0x0B
...
#define BAST_FTM_PKT_AGGR_REG_RESPONSE (BAST_FTM_PKT_RESP_FLAG | BAST_FTM_PKT_AGGR_REG_REQUEST)
#define BAST_FTM_PKT_AGGR_TUNE_RESP    (BAST_FTM_PKT_RESP_FLAG | BAST_FTM_PKT_AGGR_TUNE)
#define BAST_FTM_PKT_ADV_TUNE_RESP     (BAST_FTM_PKT_RESP_FLAG | BAST_FTM_PKT_ADV_TUNE)
...
#define BAST_FTM_PKT_INVALID_TUNE_PARAMS  0x3A
...
#define BAST_FTM_OPTION_ADV_FSK_DETECTED   0x1000
#define BAST_FTM_OPTION_SEND_RAW           0x4000 /* removed */
#define BAST_FTM_OPTION_OFFER_VALID        0x8000
