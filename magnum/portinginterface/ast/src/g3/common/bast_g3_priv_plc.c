...
******************************************************************************/
BERR_Code BAST_g3_P_LookupPlcTable_isr(const uint8_t *pBwTable, const uint16_t *pBwScaleTable, const uint32_t *pMinBwTable, uint32_t symRateIdx, uint32_t *pBw, uint32_t *pDamp8)
{
