...
BDBG_MODULE(BBOX_VDC_PRIV_BOX4);
BDBG_OBJECT_ID(BBOX_VDC_BOX_PRIV_BOX4);


void BBOX_P_Vdc_SetBox4SourceCapabilities
...
void BBOX_P_Vdc_SetBox4DisplayCapabilities
    ( BBOX_Vdc_Display_Capabilities *pDisplayCap )
{
    BBOX_P_VDC_SET_DISPLAY_LIMIT(pDisplayCap, Display0,     1080p, 3840x2160p_60Hz, Invalid,    Invalid,   Invalid, Class1);
        BBOX_P_VDC_SET_WINDOW_LIMIT(pDisplayCap, Display0, Video0, HD,      false, Disregard, Disregard, Disregard, BBOX_VDC_DISREGARD, BBOX_VDC_DISREGARD, Disregard);
    ...
    BBOX_P_VDC_SET_DISPLAY_LIMIT(pDisplayCap, Display1, 576p_50Hz,       576p_50Hz,       0,  Disregard, Disregard, Disregard);
        BBOX_P_VDC_SET_WINDOW_LIMIT(pDisplayCap, Display1, Video0, INVALID, false, Disregard, Disregard, Disregard, BBOX_VDC_DISREGARD, BBOX_VDC_DISREGARD, AutoDisable);
...
void BBOX_P_Vdc_SetBox4DeinterlacerCapabilities
...
void BBOX_P_Vdc_SetBox4XcodeCapabilities
    ( BBOX_Vdc_Xcode_Capabilities *pXcodeCap )
{
    BBOX_P_VDC_SET_XCODE_LIMIT(pXcodeCap, BBOX_VDC_DISREGARD, 1);
