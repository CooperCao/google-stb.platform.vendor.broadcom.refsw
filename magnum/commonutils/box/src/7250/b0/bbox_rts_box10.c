...
static const BBOX_MemConfig stBoxMemConfig_7250B0_box10 =
{
   {
...
{
    *pBoxMemConfig = stBoxMemConfig_7250B0_box10;
    pBoxMemConfig->ulNumMemc = stBoxRts_1u_0t_box10.ulNumMemc;
}

void BBOX_P_GetBox10Rts
    ( BBOX_Rts *pBoxRts )
{
    *pBoxRts = stBoxRts_1u_0t_box10;
}
