...
static const BBOX_MemConfig stBoxMemConfig_7250B0_box12 =
{
   {
...
{
    *pBoxMemConfig = stBoxMemConfig_7250B0_box12;
    pBoxMemConfig->ulNumMemc = stBoxRts_1u_0t_box12.ulNumMemc;
}

void BBOX_P_GetBox12Rts
    ( BBOX_Rts *pBoxRts )
{
    *pBoxRts = stBoxRts_1u_0t_box12;
}
