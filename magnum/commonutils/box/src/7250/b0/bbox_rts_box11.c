...
BDBG_MODULE(BBOX_RTS_BOX11);
BDBG_OBJECT_ID(BBOX_RTS_BOX11);

/* Memc Index for box mode 10. BBOX_MemcIndex_Invalid means it's not used */
static const BBOX_MemConfig stBoxMemConfig_7250B0_box11 =
{
   {
...
{
    *pBoxMemConfig = stBoxMemConfig_7250B0_box11;
    pBoxMemConfig->ulNumMemc = stBoxRts_1u_0t_box11.ulNumMemc;
}

void BBOX_P_GetBox11Rts
    ( BBOX_Rts *pBoxRts )
{
    *pBoxRts = stBoxRts_1u_0t_box11;
}
