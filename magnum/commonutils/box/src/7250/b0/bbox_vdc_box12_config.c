...
BDBG_MODULE(BBOX_VDC_PRIV_BOX12);
BDBG_OBJECT_ID(BBOX_VDC_BOX_PRIV_BOX12);

void BBOX_P_Vdc_SetBox12SourceCapabilities
...
void BBOX_P_Vdc_SetBox12DisplayCapabilities
    ( BBOX_Vdc_Display_Capabilities *pDisplayCap )
{
    BBOX_P_VDC_SET_DISPLAY_LIMIT(pDisplayCap, Display0, 1080p, 3840x2160p_60Hz, Invalid, Invalid, Invalid, Disregard);
...
void BBOX_P_Vdc_SetBox12DeinterlacerCapabilities
...
void BBOX_P_Vdc_SetBox12XcodeCapabilities
