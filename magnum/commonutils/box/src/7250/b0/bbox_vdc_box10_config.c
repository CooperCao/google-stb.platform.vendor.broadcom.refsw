...
{
    BBOX_P_VDC_RESET_DISPLAY_LIMIT(pDisplayCap, Display1);
        BBOX_P_VDC_RESET_WINDOW_LIMIT(pDisplayCap, Display1, Video0);
        BBOX_P_VDC_RESET_WINDOW_LIMIT(pDisplayCap, Display1, Gfx0);
}
