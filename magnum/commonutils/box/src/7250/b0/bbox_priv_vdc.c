      ...
      BBOX_Vdc_Source_Capabilities *pSourceCap )
{
    switch (ulBoxId)
    {
        case 1:
            ...
            break;
        case 2:
        case 9: /* box 9 is similar to box 2 */
        ...
        case 5:
            ...
            break;
        case 6: /* box 6 is similar to box 2 but with the addition of HD-DVI0 */
            BBOX_P_Vdc_SetBox2SourceCapabilities(pSourceCap);
        ...
        case 8:
            ...
            break;
        case 10: /* box 10 is similar to box 6 except for absence of GFD1 and presence of Mpeg1 */
            BBOX_P_Vdc_SetBox2SourceCapabilities(pSourceCap);
            BBOX_P_Vdc_SetBox6SourceCapabilities(pSourceCap);
      ...
      BBOX_Vdc_Display_Capabilities *pDisplayCap )
{
    switch (ulBoxId)
    {
        ...
        case 5:
            ...
            break;
        case 6: /* box 6 is similar to box 2 except that it
                   has smooth scaling on the main windows. */
            BBOX_P_Vdc_SetBox2DisplayCapabilities(pDisplayCap);
        ...
        case 8:
            ...
            break;
        case 10: /* box 10 is similar to box 6 excpet for absence of Display1 */
            BBOX_P_Vdc_SetBox2DisplayCapabilities(pDisplayCap);
            BBOX_P_Vdc_SetBox6DisplayCapabilities(pDisplayCap);
      ...
      BBOX_Vdc_Deinterlacer_Capabilities *pDeinterlacerCap )
{
    ...
    switch (ulBoxId)
    {
        case 1:
            ...
            break;
        case 2:
        case 6:  /* box 6 is similar to box 2 */
        case 9:  /* box 9 is similar to box 2 */
        case 10: /* box 10 is similar to box 6 */
