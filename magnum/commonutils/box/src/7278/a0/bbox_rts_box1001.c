...
static const BBOX_MemConfig stBoxMemConfig_7278A0_box1001 =
{
   {
...
{
    *pBoxMemConfig = stBoxMemConfig_7278A0_box1001;
    pBoxMemConfig->ulNumMemc = stBoxRts_7278_box1001_box1001.ulNumMemc;
}

void BBOX_P_GetBox1001Rts
    ( BBOX_Rts *pBoxRts )
{
    *pBoxRts = stBoxRts_7278_box1001_box1001;
}
