...
extern BBOX_Rts stBoxRts_7278_box1000_box1000;

/* Memc Index for box mode 1000. BBOX_MemcIndex_Invalid means it's not used */
static const BBOX_MemConfig stBoxMemConfig_7278A0_box1000 =
{
   {
...
{
    *pBoxMemConfig = stBoxMemConfig_7278A0_box1000;
    pBoxMemConfig->ulNumMemc = stBoxRts_7278_box1000_box1000.ulNumMemc;
}
