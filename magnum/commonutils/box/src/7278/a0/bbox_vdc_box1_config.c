    ...
    ( BBOX_Vdc_Source_Capabilities *pSourceCap )
{
    ...
    BBOX_P_VDC_SET_SRC_LIMIT(pSourceCap, Mpeg3,  MTG_DISABLE,  BBOX_VDC_DISREGARD, BBOX_VDC_DISREGARD, Disregard, 10bit,     false);
    ...
    ( BBOX_Vdc_Display_Capabilities *pDisplayCap )
{
    BBOX_P_VDC_SET_DISPLAY_LIMIT(pDisplayCap, Display0, 3840x2160p_60Hz, 3840x2160p_60Hz, Invalid, Invalid, Invalid,    Class4);
        ...
        BBOX_P_VDC_SET_WINDOW_LIMIT(pDisplayCap, Display0, Video1, DISREGARD, false, Disregard, Disregard, Disregard,                  1,                  1,         Auto);
