    ...
    ( BBOX_Vdc_Display_Capabilities *pDisplayCap )
{
    ...
    BBOX_P_VDC_SET_DISPLAY_LIMIT(pDisplayCap, Display3,           1080p,           1080p,       0,       0,       0, Disregard);
        BBOX_P_VDC_SET_WINDOW_CLASS_LIMIT(pDisplayCap, Display3, Video0, DISREGARD, false,   Unknown, Unknown,   Disregard, BBOX_VDC_DISREGARD, BBOX_VDC_DISREGARD, AutoDisable, 0_1);
