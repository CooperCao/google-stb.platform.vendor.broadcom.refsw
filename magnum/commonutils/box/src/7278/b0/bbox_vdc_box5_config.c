...
{
    BBOX_P_VDC_SET_SRC_CLASS_LIMIT(pSourceCap, Mpeg0, MTG_ENABLE, BBOX_VDC_DISREGARD, BBOX_VDC_DISREGARD, Disregard, 10bit, false, 60Hz, 4_2);
    BBOX_P_VDC_SET_SRC_CLASS_LIMIT(pSourceCap, Mpeg1, MTG_ENABLE, BBOX_VDC_DISREGARD, BBOX_VDC_DISREGARD, Disregard, 10bit, false, 60Hz, 4_2);
    BBOX_P_VDC_SET_SRC_CLASS_LIMIT(pSourceCap, Mpeg2, MTG_ENABLE, BBOX_VDC_DISREGARD, BBOX_VDC_DISREGARD, Disregard, 10bit, false, 60Hz, 4_2);
    BBOX_P_VDC_SET_SRC_CLASS_LIMIT(pSourceCap, Mpeg3, MTG_ENABLE, BBOX_VDC_DISREGARD, BBOX_VDC_DISREGARD, Disregard, 10bit, false, 60Hz, 4_2);
    ...
    ( BBOX_Vdc_Display_Capabilities *pDisplayCap )
{
    BBOX_P_VDC_SET_DISPLAY_LIMIT(pDisplayCap, Display0, 3840x2160p_60Hz, 3840x2160p_60Hz, Invalid, Invalid, Invalid,    Class4);
        BBOX_P_VDC_SET_WINDOW_CLASS_LIMIT(pDisplayCap, Display0, Video0, DISREGARD, false,      Cap0,      Vfd0,      Scl0, BBOX_VDC_DISREGARD, BBOX_VDC_DISREGARD, SclBeforeCap, 4_1);
        BBOX_P_VDC_SET_WINDOW_CLASS_LIMIT(pDisplayCap, Display0, Video1, DISREGARD, false,      Cap1,      Vfd1,      Scl1,                  2,                  2, SclBeforeCap, 4_2);
    ...
    BBOX_P_VDC_SET_DISPLAY_LIMIT(pDisplayCap, Display2,           1080p,           1080p,       1,       0,       1, Disregard);
        BBOX_P_VDC_SET_WINDOW_CLASS_LIMIT(pDisplayCap, Display2, Video0, DISREGARD, false,      Cap2,      Vfd2,      Scl2, BBOX_VDC_DISREGARD, BBOX_VDC_DISREGARD,  AutoDisable, 0_1);

    BBOX_P_VDC_SET_DISPLAY_LIMIT(pDisplayCap, Display3,      1080p_30Hz,      1080p_30Hz,       0,       0,       0, Disregard);
        BBOX_P_VDC_SET_WINDOW_CLASS_LIMIT(pDisplayCap, Display3, Video0, DISREGARD, false,      Cap3,      Vfd3,      Scl3, BBOX_VDC_DISREGARD, BBOX_VDC_DISREGARD,  AutoDisable, 0_1);
}
...
{
    BBOX_P_VDC_SET_XCODE_LIMIT(pXcodeCap, 1, 0);
}
