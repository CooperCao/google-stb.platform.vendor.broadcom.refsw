    ...
    ( BBOX_MemConfig                *pBoxMemConfig )
{
    ...
    BBOX_P_SET_NUM_MEMC(pBoxMemConfig, stBoxRts_7278B0_box3_box_mid_performance_sm_supportalt_box3.ulNumMemc);
}

void BBOX_P_GetBox3Rts
    ( BBOX_Rts *pBoxRts )
{
    *pBoxRts = stBoxRts_7278B0_box3_box_mid_performance_sm_supportalt_box3;
}
