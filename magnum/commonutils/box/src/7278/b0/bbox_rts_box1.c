    ...
    ( BBOX_MemConfig                *pBoxMemConfig )
{
    ...
    BBOX_P_SET_VIDEO_WIN_MEMC(pBoxMemConfig, Display2,  Video0,  0,       1);

    BBOX_P_SET_VIDEO_WIN_MEMC(pBoxMemConfig, Display3,  Video0,  0,       1);

    BBOX_P_SET_NUM_MEMC(pBoxMemConfig, stBoxRts_7278B0_box1_box_mid_performance_sm_box1.ulNumMemc);
}

void BBOX_P_GetBox1Rts
    ( BBOX_Rts *pBoxRts )
{
    *pBoxRts = stBoxRts_7278B0_box1_box_mid_performance_sm_box1;
}
