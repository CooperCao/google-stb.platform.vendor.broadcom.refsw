    ...
    ( BBOX_MemConfig                *pBoxMemConfig )
{
    ...
    /* No CAP/VFD for transcode path */
    BBOX_P_SET_VIDEO_WIN_MEMC(pBoxMemConfig, Display3,  Video0,  Invalid, 0);

    BBOX_P_SET_NUM_MEMC(pBoxMemConfig, stBoxRts_7278B0_box4_box_mid_performance_sm_box4.ulNumMemc);
}

void BBOX_P_GetBox4Rts
    ( BBOX_Rts *pBoxRts )
{
    *pBoxRts = stBoxRts_7278B0_box4_box_mid_performance_sm_box4;
}
