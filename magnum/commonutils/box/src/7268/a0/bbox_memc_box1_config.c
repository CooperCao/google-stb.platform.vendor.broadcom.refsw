 ...
 *   at: Fri Mar 10 22:25:32 2017 GMT
 *   by: kranawet
 *   for: Box UHDwSDout
...
static const uint32_t aulMemc0_20170310222532_UHDwSDout[] = {
...
static const BBOX_Rts_PfriClient stBoxRts_PfriClient_20170310222532_UHDwSDout[] = {
  {BCHP_MEMC_GEN_0_PFRI_0_THROTTLE_CONFIG,      0x803f0e05}, /* HVD0_PFRI (gHVC) 233280.00 ns/40 */
...
static const uint32_t* const paulMemc_box1[] = { &aulMemc0_20170310222532_UHDwSDout[0]};

const BBOX_Rts stBoxRts_UHDwSDout_box1 = {
  "20170310222532_UHDwSDout_box1",
  7268,
  1,
  1,
  256,
  ...
  4,
  stBoxRts_PfriClient_20170310222532_UHDwSDout
};
