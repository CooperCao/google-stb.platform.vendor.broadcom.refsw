...
BDBG_MODULE(BBOX_RTS_BOX19);
BDBG_OBJECT_ID(BBOX_RTS_BOX19);

extern BBOX_Rts stBoxRts_7252_4Kstb_box19;


/* Memc Index for box mode 19. BBOX_MemcIndex_Invalid means it's not used */
static const BBOX_MemConfig stBoxMemConfig_7445D0_box19 =
{
   {
      ...
      BBOX_MK_DVI_CFC_MEMC_IDX(Invalid), /* HDMI display CFC */
      {
         ...
         BBOX_MK_WIN_MEMC_IDX(0,       Invalid, Invalid, Invalid, 1      ),  /* disp 1 */
...
{
    *pBoxMemConfig = stBoxMemConfig_7445D0_box19;
    pBoxMemConfig->ulNumMemc = stBoxRts_7252_4Kstb_box19.ulNumMemc;
}

void BBOX_P_GetBox19Rts
    ( BBOX_Rts *pBoxRts )
{
    *pBoxRts = stBoxRts_7252_4Kstb_box19;
}
