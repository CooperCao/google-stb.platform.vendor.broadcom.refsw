...
extern BBOX_Rts stBoxRts_7445_4k2t_box9;
...
{
   {
      BBOX_MK_RDC_MEMC_IDX(2),       /* RDC */
      {
         ...
         BBOX_MK_WIN_MEMC_IDX(0,       Invalid, 0,       Invalid, 1      ), /* disp 5 */
         BBOX_MK_WIN_MEMC_IDX(0,       Invalid, 0,       Invalid, 1      ), /* disp 6 */
      }
   },
...
static const BBOX_MemConfig stBoxMemConfig_7445D0_box9 =
{
   {
      BBOX_MK_RDC_MEMC_IDX(2),       /* RDC */
      {
...
{
   {
      BBOX_MK_RDC_MEMC_IDX(0),       /* RDC */
      {
         ...
         BBOX_MK_WIN_MEMC_IDX(0,       0,       0,       0,       1      ),  /* disp 1 */
         BBOX_MK_WIN_MEMC_IDX(Invalid, Invalid, Invalid, Invalid, Invalid),  /* disp 2 */
         BBOX_MK_WIN_MEMC_IDX(Invalid, Invalid, Invalid, Invalid, Invalid),  /* disp 3 */
         BBOX_MK_WIN_MEMC_IDX(Invalid, Invalid, Invalid, Invalid, Invalid),  /* disp 4 */
         BBOX_MK_WIN_MEMC_IDX(Invalid, Invalid, Invalid, Invalid, Invalid),  /* disp 5 */
...
{
   {
      BBOX_MK_RDC_MEMC_IDX(2),       /* RDC */
      {
         BBOX_MK_WIN_MEMC_IDX(2,       2,       Invalid, Invalid,       2),  /* disp 0 */
         BBOX_MK_WIN_MEMC_IDX(Invalid, Invalid, Invalid, Invalid, Invalid),  /* disp 1 */
         BBOX_MK_WIN_MEMC_IDX(Invalid, Invalid, Invalid, Invalid, Invalid),  /* disp 2 */
         BBOX_MK_WIN_MEMC_IDX(Invalid, Invalid, Invalid, Invalid, Invalid),  /* disp 3 */
         BBOX_MK_WIN_MEMC_IDX(Invalid, Invalid, Invalid, Invalid, Invalid),  /* disp 4 */
...
{
   {
      BBOX_MK_RDC_MEMC_IDX(2),       /* RDC */
      {
         ...
         BBOX_MK_WIN_MEMC_IDX(2,       Invalid, 2,       Invalid, 2      ),  /* disp  1 */
         BBOX_MK_WIN_MEMC_IDX(Invalid, Invalid, 1,       Invalid, Invalid),  /* disp  2 */
	...
	(uint32_t                ulId)
{
	...
	if ((ulId != 1000 && ulId != 1001) && (ulId == 0 || ulId == 11 || ulId > BBOX_MODES_SUPPORTED))
	{
	  ...
	  BBOX_Vdc_Capabilities *pBoxVdc )
{
	...
	if ((ulBoxId != 1000 && ulBoxId != 1001) && (ulBoxId == 0 || ulBoxId == 11 || ulBoxId > BBOX_MODES_SUPPORTED))
	{
	...
	switch (ulBoxId)
	{
		...
		case 8:
			*pBoxMemConfig = stBoxMemConfig_7445D0_box8;
			...
			break;
		case 9:
			*pBoxMemConfig = stBoxMemConfig_7445D0_box9;
			pBoxMemConfig->ulNumMemc = stBoxRts_7445_4k2t_box9.ulNumMemc;
			break;
		case 10:
	...
	else
	{
		...
		switch (ulBoxId)
		{
			...
			case 8:
				...
				break;
			case 9:
				pBoxRts = &stBoxRts_7445_4k2t_box9;
				break;
			case 10:
