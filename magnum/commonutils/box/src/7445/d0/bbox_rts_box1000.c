...
void BBOX_P_SetBox1000MemConfig
    ( BBOX_MemConfig                *pBoxMemConfig )
{
    BBOX_P_SET_RDC_MEMC(pBoxMemConfig, 2);

    BBOX_P_SET_VIDEO_WIN_MEMC(pBoxMemConfig, Display0,  Video0,  2,       2);
    ...
    BBOX_P_SET_NUM_MEMC(pBoxMemConfig, stBoxRts_7445_TEMP_box1000.ulNumMemc);
}
