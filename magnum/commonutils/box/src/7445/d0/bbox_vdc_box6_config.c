    ...
    ( BBOX_Vdc_Display_Capabilities *pDisplayCap )
{
    ...
    BBOX_P_VDC_SET_DISPLAY_LIMIT(pDisplayCap, Display3, 720p,            720p,            1,       0,       1,       Disregard);
    ...
    BBOX_P_VDC_SET_DISPLAY_LIMIT(pDisplayCap, Display4, 720p,            720p,            0,       0,       0,       Disregard);
    ...
    ( BBOX_Vdc_Deinterlacer_Capabilities *pDeinterlacerCap )
{
    ...
    BBOX_P_VDC_SET_DEINTERLACER_LIMIT(pDeinterlacerCap, Deinterlacer2, BFMT_PAL_WIDTH, BFMT_PAL_HEIGHT, 1280);
    BBOX_P_VDC_SET_DEINTERLACER_LIMIT(pDeinterlacerCap, Deinterlacer3, BFMT_PAL_WIDTH, BFMT_PAL_HEIGHT, 1280);
}
