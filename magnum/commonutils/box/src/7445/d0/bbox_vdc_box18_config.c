    ...
    ( BBOX_Vdc_Display_Capabilities *pDisplayCap )
{
        ...
        BBOX_P_VDC_SET_WINDOW_LIMIT(pDisplayCap, Display4, Video0, DISREGARD, 1,                  1,                  AutoDisable);

        BBOX_P_VDC_SET_WINDOW_LIMIT(pDisplayCap, Display5, Video0, DISREGARD, 1,                  1,                  AutoDisable);
