...
BDBG_MODULE(BBOX_VDC_PRIV_BOX15);
BDBG_OBJECT_ID(BBOX_VDC_BOX_PRIV_BOX15);

void BBOX_P_Vdc_SetBox15SourceCapabilities
...
void BBOX_P_Vdc_SetBox15DeinterlacerCapabilities
...
void BBOX_P_Vdc_SetBox15XcodeCapabilities
    ( BBOX_Vdc_Xcode_Capabilities *pXcodeCap )
{
    BBOX_P_VDC_SET_XCODE_LIMIT(pXcodeCap, BBOX_VDC_DISREGARD, 0);
}
