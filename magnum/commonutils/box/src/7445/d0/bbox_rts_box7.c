    ...
    ( BBOX_MemConfig                *pBoxMemConfig )
{
    ...
    BBOX_P_SET_GFX_WIN_MEMC(  pBoxMemConfig, Display3,  Gfx0,    2         );

    BBOX_P_SET_VIDEO_WIN_MEMC(pBoxMemConfig, Display4,  Video0,  1,       1);
    BBOX_P_SET_GFX_WIN_MEMC(  pBoxMemConfig, Display4,  Gfx0,    2         );
    ...
    BBOX_P_SET_GFX_WIN_MEMC(  pBoxMemConfig, Display6,  Gfx0,    1         );

    BBOX_P_SET_NUM_MEMC(pBoxMemConfig, stBoxRts_7445_6T_box7.ulNumMemc);
}
