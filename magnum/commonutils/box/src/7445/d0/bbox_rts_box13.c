...
BDBG_MODULE(BBOX_RTS_BOX13);
BDBG_OBJECT_ID(BBOX_RTS_BOX13);

void BBOX_P_SetBox13MemConfig
    ( BBOX_MemConfig                *pBoxMemConfig )
{
    ...
    BBOX_P_SET_NUM_MEMC(pBoxMemConfig, stBoxRts_7445_4kstb1t_box13.ulNumMemc);
}
