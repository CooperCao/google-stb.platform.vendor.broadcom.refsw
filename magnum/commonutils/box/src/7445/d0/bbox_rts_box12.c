...
BDBG_MODULE(BBOX_RTS_BOX12);
BDBG_OBJECT_ID(BBOX_RTS_BOX12);

void BBOX_P_SetBox12MemConfig
    ( BBOX_MemConfig                *pBoxMemConfig )
{
    ...
    BBOX_P_SET_NUM_MEMC(pBoxMemConfig, stBoxRts_7445D0_box12.ulNumMemc);
}

void BBOX_P_GetBox12Rts
    ( BBOX_Rts *pBoxRts )
{
