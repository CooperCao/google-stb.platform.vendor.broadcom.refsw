...
BDBG_MODULE(BBOX_RTS_BOX1000);
BDBG_OBJECT_ID(BBOX_RTS_BOX1000);

extern BBOX_Rts stBoxRts_TEMP_1000_UHDp60_box1000;

/* Memc Index for box mode 1. BBOX_MemcIndex_Invalid means it's not used */
static const BBOX_MemConfig stBoxMemConfig_7260A0_box1000 =
{
   {
...
void BBOX_P_GetBox1000MemConfig
    ( BBOX_MemConfig                *pBoxMemConfig )
{
    *pBoxMemConfig = stBoxMemConfig_7260A0_box1000;
    pBoxMemConfig->ulNumMemc = stBoxRts_TEMP_1000_UHDp60_box1000.ulNumMemc;
}

void BBOX_P_GetBox1000Rts
    ( BBOX_Rts *pBoxRts )
{
    *pBoxRts = stBoxRts_TEMP_1000_UHDp60_box1000;
}
