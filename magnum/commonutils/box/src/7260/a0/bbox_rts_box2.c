...
extern BBOX_Rts stBoxRts_HDwSDout_box2;

/* Memc Index for box mode 2. BBOX_MemcIndex_Invalid means it's not used */
const BBOX_MemConfig stBoxMemConfig_7260A0_box2 =
{
   {
...
{
    *pBoxMemConfig = stBoxMemConfig_7260A0_box2;
    pBoxMemConfig->ulNumMemc = stBoxRts_HDwSDout_box2.ulNumMemc;
}

void BBOX_P_GetBox2Rts
    ( BBOX_Rts *pBoxRts )
{
    *pBoxRts = stBoxRts_HDwSDout_box2;
}
