...
BDBG_MODULE(BBOX_RTS_BOX1005);
BDBG_OBJECT_ID(BBOX_RTS_BOX1005);
...
static const BBOX_MemConfig stBoxMemConfig_7260A0_box1005 =
{
   {
...
{
    *pBoxMemConfig = stBoxMemConfig_7260A0_box1005;
    pBoxMemConfig->ulNumMemc = stBoxRts_TEMP_1005_UHDp60_or_DualHDPiP_box1005.ulNumMemc;
}

void BBOX_P_GetBox1005Rts
    ( BBOX_Rts *pBoxRts )
{
    *pBoxRts = stBoxRts_TEMP_1005_UHDp60_or_DualHDPiP_box1005;
}
