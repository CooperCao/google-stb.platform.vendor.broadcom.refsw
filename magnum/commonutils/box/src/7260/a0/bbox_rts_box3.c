...
BDBG_MODULE(BBOX_RTS_BOX3);
BDBG_OBJECT_ID(BBOX_RTS_BOX3);

extern BBOX_Rts stBoxRts_DualHDp60wPiP_box3;

/* Memc Index for box mode 2. BBOX_MemcIndex_Invalid means it's not used */
const BBOX_MemConfig stBoxMemConfig_7260_box3 =
{
   {
...
{
    *pBoxMemConfig = stBoxMemConfig_7260_box3;
    pBoxMemConfig->ulNumMemc = stBoxRts_DualHDp60wPiP_box3.ulNumMemc;
}

void BBOX_P_GetBox3Rts
    ( BBOX_Rts *pBoxRts )
{
    *pBoxRts = stBoxRts_DualHDp60wPiP_box3;
}
