...
extern BBOX_Rts stBoxRts_DualHDwPiP_box1;

/* Memc Index for box mode 1. BBOX_MemcIndex_Invalid means it's not used */
static const BBOX_MemConfig stBoxMemConfig_7260A0_box1 =
{
   {
...
{
    *pBoxMemConfig = stBoxMemConfig_7260A0_box1;
    pBoxMemConfig->ulNumMemc = stBoxRts_DualHDwPiP_box1.ulNumMemc;
}

void BBOX_P_GetBox1Rts
    ( BBOX_Rts *pBoxRts )
{
    *pBoxRts = stBoxRts_DualHDwPiP_box1;
}
