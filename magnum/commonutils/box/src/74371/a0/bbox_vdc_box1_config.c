...
BDBG_MODULE(BBOX_VDC_PRIV_BOX1);
BDBG_OBJECT_ID(BBOX_VDC_BOX_PRIV_BOX1);
...
void BBOX_P_Vdc_SetBox1SourceCapabilities
    ( BBOX_Vdc_Source_Capabilities *pSourceCap )
{
    BBOX_P_VDC_SET_SRC_LIMIT(pSourceCap, Mpeg0,  MTG_ENABLE,   BBOX_VDC_DISREGARD, BBOX_VDC_DISREGARD, Disregard, Disregard, false);
    BBOX_P_VDC_SET_SRC_LIMIT(pSourceCap, Mpeg1,  MTG_ENABLE,   BBOX_VDC_DISREGARD, BBOX_VDC_DISREGARD, Disregard, Disregard, false);
...
void BBOX_P_Vdc_SetBox1DisplayCapabilities
    ( BBOX_Vdc_Display_Capabilities *pDisplayCap )
{
    BBOX_P_VDC_SET_DISPLAY_LIMIT(pDisplayCap, Display0, 1080p, 3840x2160p_30Hz, Invalid, Invalid, Invalid, Class1);
        ...
        BBOX_P_VDC_SET_WINDOW_LIMIT(pDisplayCap, Display0, Video1, INVALID,   Disregard, Disregard, Disregard, 2,                  2,                  SclBeforeCap);
    ...
    BBOX_P_VDC_SET_DISPLAY_LIMIT(pDisplayCap, Display1, PAL_G, PAL_G,           Invalid, Invalid, Invalid, Class0);
        ...
        BBOX_P_VDC_SET_WINDOW_LIMIT(pDisplayCap, Display1, Video1, INVALID, Disregard, Disregard, Disregard, 2,                  2,                  SclBeforeCap);
...
void BBOX_P_Vdc_SetBox1DeinterlacerCapabilities
...
void BBOX_P_Vdc_SetBox1XcodeCapabilities
