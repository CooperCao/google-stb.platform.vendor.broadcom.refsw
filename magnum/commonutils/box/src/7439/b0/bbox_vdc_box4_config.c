    ...
    ( BBOX_Vdc_Source_Capabilities *pSourceCap )
{
    ...
    BBOX_P_VDC_SET_SRC_CLASS_LIMIT(pSourceCap, Mpeg2,  MTG_DISABLE,  BBOX_VDC_DISREGARD, BBOX_VDC_DISREGARD, Disregard, 8bit,  false, 60Hz, 3_1);
    BBOX_P_VDC_SET_SRC_CLASS_LIMIT(pSourceCap, Mpeg3,  MTG_DISABLE,  BBOX_VDC_DISREGARD, BBOX_VDC_DISREGARD, Disregard, 8bit,  false, 60Hz, 3_1);
    ...
    ( BBOX_Vdc_Display_Capabilities *pDisplayCap )
{
    ...
    BBOX_P_VDC_SET_DISPLAY_LIMIT(pDisplayCap, Display2, 1080p_25Hz,      1080p_25Hz,      1,       0,       1,       Disregard);
    ...
    BBOX_P_VDC_SET_DISPLAY_LIMIT(pDisplayCap, Display3, 1080p_25Hz,      1080p_25Hz,      0,       0,       0,       Disregard);
