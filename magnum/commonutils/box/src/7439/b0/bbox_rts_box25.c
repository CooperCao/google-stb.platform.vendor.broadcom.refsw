...
BDBG_MODULE(BBOX_RTS_BOX25);
BDBG_OBJECT_ID(BBOX_RTS_BOX25);

void BBOX_P_SetBox25MemConfig
    ( BBOX_MemConfig                *pBoxMemConfig )
{
    ...
    BBOX_P_SET_NUM_MEMC(pBoxMemConfig, stBoxRts_7439_1stb2t_box25.ulNumMemc);
}

void BBOX_P_GetBox25Rts
    ( BBOX_Rts *pBoxRts )
{
