...
BDBG_MODULE(BBOX_VDC_PRIV_BOX13);
BDBG_OBJECT_ID(BBOX_VDC_BOX_PRIV_BOX13);
...
void BBOX_P_Vdc_SetBox13SourceCapabilities
...
void BBOX_P_Vdc_SetBox13DeinterlacerCapabilities
