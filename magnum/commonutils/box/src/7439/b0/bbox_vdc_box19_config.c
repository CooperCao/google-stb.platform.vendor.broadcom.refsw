...
BDBG_MODULE(BBOX_VDC_PRIV_BOX19);
BDBG_OBJECT_ID(BBOX_VDC_BOX_PRIV_BOX19);

void BBOX_P_Vdc_SetBox19SourceCapabilities
    ( BBOX_Vdc_Source_Capabilities *pSourceCap )
{
    ...
    BBOX_P_VDC_SET_SRC_CLASS_LIMIT(pSourceCap, Mpeg1,  MTG_ENABLE,   BBOX_VDC_DISREGARD, BBOX_VDC_DISREGARD, Disregard, 10bit,     false, 60Hz, 2_1);
...
void BBOX_P_Vdc_SetBox19DisplayCapabilities
...
void BBOX_P_Vdc_SetBox19DeinterlacerCapabilities
...
void BBOX_P_Vdc_SetBox19XcodeCapabilities
