...
BDBG_MODULE(BBOX_RTS_BOX28);
BDBG_OBJECT_ID(BBOX_RTS_BOX28);

void BBOX_P_SetBox28MemConfig
    ( BBOX_MemConfig                *pBoxMemConfig )
{
    ...
    BBOX_P_SET_NUM_MEMC(pBoxMemConfig, stBoxRts_7251_4kstb_smallpip_box28.ulNumMemc);
