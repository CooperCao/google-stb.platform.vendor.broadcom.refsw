...
{
    BBOX_P_VDC_SET_SRC_CLASS_LIMIT(pSourceCap, Mpeg0,  MTG_ENABLE,   BBOX_VDC_DISREGARD, BBOX_VDC_DISREGARD, Disregard, 10bit,     false, 60Hz, 4_1);
...
void BBOX_P_Vdc_SetBox10DisplayCapabilities
...
void BBOX_P_Vdc_SetBox10DeinterlacerCapabilities
...
void BBOX_P_Vdc_SetBox10XcodeCapabilities
