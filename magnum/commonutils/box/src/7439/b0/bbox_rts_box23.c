...
BDBG_MODULE(BBOX_RTS_BOX23);
BDBG_OBJECT_ID(BBOX_RTS_BOX23);

void BBOX_P_SetBox23MemConfig
    ( BBOX_MemConfig                *pBoxMemConfig )
{
    ...
    BBOX_P_SET_NUM_MEMC(pBoxMemConfig, stBoxRts_7251S_1u1t4k_box23.ulNumMemc);
