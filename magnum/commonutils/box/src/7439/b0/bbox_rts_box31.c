...
BDBG_MODULE(BBOX_RTS_BOX31);
BDBG_OBJECT_ID(BBOX_RTS_BOX31);
    ...
    ( BBOX_MemConfig                *pBoxMemConfig )
{
    ...
    BBOX_P_SET_NUM_MEMC(pBoxMemConfig, stBoxRts_7439_4Kstb1t_box31.ulNumMemc);
...
void BBOX_P_GetBox31Rts
    ( BBOX_Rts *pBoxRts )
{
    *pBoxRts = stBoxRts_7439_4Kstb1t_box31;
}
