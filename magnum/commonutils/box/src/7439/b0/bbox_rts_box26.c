...
BDBG_MODULE(BBOX_RTS_BOX26);
BDBG_OBJECT_ID(BBOX_RTS_BOX26);

void BBOX_P_SetBox26MemConfig
    ( BBOX_MemConfig                *pBoxMemConfig )
{
    ...
    BBOX_P_SET_NUM_MEMC(pBoxMemConfig, stBoxRts_7251_4kstb50_box26.ulNumMemc);
}
