...
#ifndef BBOX_PRIV_VDC_BOX9_H__
#define BBOX_PRIV_VDC_BOX9_H__
...
void BBOX_P_Vdc_SetBox9DisplayCapabilities
    ( BBOX_Vdc_Display_Capabilities *pDisplayCap );

void BBOX_P_Vdc_SetBox9DeinterlacerCapabilities
    ( BBOX_Vdc_Deinterlacer_Capabilities *pDeinterlacerCap );

void BBOX_P_Vdc_SetBox9XcodeCapabilities
    ( BBOX_Vdc_Xcode_Capabilities *pXcodeCap );

void BBOX_P_GetBox9MemConfig
