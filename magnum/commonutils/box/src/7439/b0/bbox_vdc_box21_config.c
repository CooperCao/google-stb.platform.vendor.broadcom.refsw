    ...
    ( BBOX_Vdc_Display_Capabilities *pDisplayCap )
{
    ...
    BBOX_P_VDC_SET_DISPLAY_LIMIT(pDisplayCap, Display3, 720p,            720p,            0,       0,       0,       Disregard);
        BBOX_P_VDC_SET_WINDOW_CLASS_LIMIT(pDisplayCap, Display3, Video0, DISREGARD, false, Disregard, Disregard, Disregard, BBOX_VDC_DISREGARD, BBOX_VDC_DISREGARD, Disregard, 0_1);
}
