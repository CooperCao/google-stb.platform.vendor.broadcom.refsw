...
BDBG_MODULE(BBOX_VDC_PRIV_BOX31);
BDBG_OBJECT_ID(BBOX_VDC_BOX_PRIV_BOX31);


void BBOX_P_Vdc_SetBox31SourceCapabilities
    ( BBOX_Vdc_Source_Capabilities *pSourceCap )
{
    ...
    BBOX_P_VDC_SET_SRC_CLASS_LIMIT(pSourceCap, Mpeg2,  MTG_DISABLE,   BBOX_VDC_DISREGARD, BBOX_VDC_DISREGARD, Disregard, 10bit,     false, 60Hz, 3_1);
...
void BBOX_P_Vdc_SetBox31DisplayCapabilities
    ( BBOX_Vdc_Display_Capabilities *pDisplayCap )
{
    BBOX_P_VDC_SET_DISPLAY_LIMIT(pDisplayCap, Display0, 3840x2160p_60Hz, 3840x2160p_60Hz, Invalid, Invalid, Invalid, Class4);
        ...
        BBOX_P_VDC_SET_WINDOW_CLASS_LIMIT(pDisplayCap, Display0, Video1, DISREGARD, false, Disregard, Disregard, Disregard, 1,                  1,                  SclBeforeCap, 4_1);
    ...
    BBOX_P_VDC_SET_DISPLAY_LIMIT(pDisplayCap, Display1, PAL_G,           PAL_G,           Invalid, Invalid, Invalid, Class0);
        ...
        BBOX_P_VDC_SET_WINDOW_CLASS_LIMIT(pDisplayCap, Display1, Video1, INVALID,   false, Disregard, Disregard, Disregard, 1,                  1,                  SclBeforeCap, 1_1);
...
void BBOX_P_Vdc_SetBox31DeinterlacerCapabilities
...
void BBOX_P_Vdc_SetBox31XcodeCapabilities
