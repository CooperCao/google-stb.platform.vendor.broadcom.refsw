...
BDBG_MODULE(BBOX_RTS_BOX30);
BDBG_OBJECT_ID(BBOX_RTS_BOX30);

void BBOX_P_SetBox30MemConfig
    ( BBOX_MemConfig                *pBoxMemConfig )
{
    ...
    BBOX_P_SET_VIDEO_WIN_MEMC(pBoxMemConfig, Display2,  Video0,  1, Invalid);
    BBOX_P_SET_GFX_WIN_MEMC(  pBoxMemConfig, Display2,  Gfx0,    1         );

    BBOX_P_SET_NUM_MEMC(pBoxMemConfig, stBoxRts_7439_4K_1080p_pal_3display_box30.ulNumMemc);
}
