...
BDBG_MODULE(BBOX_VDC_PRIV_BOX26);
BDBG_OBJECT_ID(BBOX_VDC_BOX_PRIV_BOX26);

/* Memc Index for box mode 26. BBOX_MemcIndex_Invalid means it's not used */
static const BBOX_MemConfig stBoxMemConfig_7439B0_box26 =
{
   {
...
void BBOX_P_Vdc_SetBox26SourceCapabilities
    ( BBOX_Vdc_Source_Capabilities *pSourceCap )
{
    BBOX_P_VDC_RESET_SRC_LIMIT(pSourceCap, Gfx1);
}

void BBOX_P_Vdc_SetBox26DisplayCapabilities
    ( BBOX_Vdc_Display_Capabilities *pDisplayCap )
{
    BBOX_P_VDC_SET_DISPLAY_LIMIT(pDisplayCap, Display0, 3840x2160p_50Hz, 3840x2160p_50Hz, Invalid, Invalid, Invalid, Class4);
        BBOX_P_VDC_SET_WINDOW_LIMIT(pDisplayCap, Display0, Video0, DISREGARD, Disregard, Disregard, Disregard, BBOX_VDC_DISREGARD, BBOX_VDC_DISREGARD, AutoDisable1080p);
        BBOX_P_VDC_SET_WINDOW_LIMIT(pDisplayCap, Display0, Video1, DISREGARD, Disregard, Disregard, Disregard, 2,                  2,                  SclBeforeCap);
...
void BBOX_P_Vdc_SetBox26DeinterlacerCapabilities
...
void BBOX_P_Vdc_SetBox26XcodeCapabilities
    ( BBOX_Vdc_Xcode_Capabilities *pXcodeCap )
{
    BBOX_P_VDC_SET_XCODE_LIMIT(pXcodeCap, BBOX_VDC_DISREGARD, BBOX_VDC_DISREGARD);
}

void BBOX_P_GetBox26MemConfig
    ( BBOX_MemConfig                *pBoxMemConfig )
{
    *pBoxMemConfig = stBoxMemConfig_7439B0_box26;
    pBoxMemConfig->ulNumMemc = stBoxRts_7251_4kstb50_box26.ulNumMemc;
}

void BBOX_P_GetBox26Rts
    ( BBOX_Rts *pBoxRts )
{
    *pBoxRts = stBoxRts_7251_4kstb50_box26;
}
