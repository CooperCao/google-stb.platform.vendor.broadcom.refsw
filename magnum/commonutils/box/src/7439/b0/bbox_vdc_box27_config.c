...
BDBG_MODULE(BBOX_VDC_PRIV_BOX27);
BDBG_OBJECT_ID(BBOX_VDC_BOX_PRIV_BOX27);

extern BBOX_Rts stBoxRts_7252S_4K2t_dual1080p30_box27;

/* Memc Index for box mode 26. BBOX_MemcIndex_Invalid means it's not used */
static const BBOX_MemConfig stBoxMemConfig_7439B0_box27 =
{
   {
      ...
      BBOX_MK_DVI_CFC_MEMC_IDX(Invalid), /* HDMI display CFC */
      {
         ...
         BBOX_MK_WIN_MEMC_IDX(0,       Invalid, 1,       Invalid, Invalid),  /* disp 2 */
         BBOX_MK_WIN_MEMC_IDX(0,       Invalid, 1,       Invalid, Invalid),  /* disp 3 */
...
void BBOX_P_Vdc_SetBox27SourceCapabilities
...
void BBOX_P_Vdc_SetBox27DisplayCapabilities
...
void BBOX_P_Vdc_SetBox27DeinterlacerCapabilities
...
void BBOX_P_Vdc_SetBox27XcodeCapabilities
    ( BBOX_Vdc_Xcode_Capabilities *pXcodeCap )
{
    BBOX_P_VDC_SET_XCODE_LIMIT(pXcodeCap, 1, BBOX_VDC_DISREGARD);
}

void BBOX_P_GetBox27MemConfig
    ( BBOX_MemConfig                *pBoxMemConfig )
{
    *pBoxMemConfig = stBoxMemConfig_7439B0_box27;
    pBoxMemConfig->ulNumMemc = stBoxRts_7252S_4K2t_dual1080p30_box27.ulNumMemc;
}

void BBOX_P_GetBox27Rts
    ( BBOX_Rts *pBoxRts )
{
    *pBoxRts = stBoxRts_7252S_4K2t_dual1080p30_box27;
}
