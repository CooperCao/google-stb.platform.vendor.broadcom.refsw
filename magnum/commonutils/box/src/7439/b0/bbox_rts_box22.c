...
BDBG_MODULE(BBOX_RTS_BOX22);
BDBG_OBJECT_ID(BBOX_RTS_BOX22);

void BBOX_P_SetBox22MemConfig
    ( BBOX_MemConfig                *pBoxMemConfig )
{
    ...
    BBOX_P_SET_NUM_MEMC(pBoxMemConfig, stBoxRts_7251_headless_dualxcode_box22.ulNumMemc);
