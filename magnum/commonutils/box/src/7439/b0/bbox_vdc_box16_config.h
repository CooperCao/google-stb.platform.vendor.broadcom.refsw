...
#ifndef BBOX_PRIV_VDC_BOX16_H__
#define BBOX_PRIV_VDC_BOX16_H__
...
void BBOX_P_Vdc_SetBox16DisplayCapabilities
    ( BBOX_Vdc_Display_Capabilities *pDisplayCap );

void BBOX_P_Vdc_SetBox16DeinterlacerCapabilities
    ( BBOX_Vdc_Deinterlacer_Capabilities *pDeinterlacerCap );

void BBOX_P_Vdc_SetBox16XcodeCapabilities
    ( BBOX_Vdc_Xcode_Capabilities *pXcodeCap );

void BBOX_P_GetBox16MemConfig
    ( BBOX_MemConfig *pBoxMemConfig );

void BBOX_P_GetBox16Rts
    ( BBOX_Rts *pBoxRts );
