...
#if (BCHP_VER == BHCP_VER_A0)
    if (ulId > 4)
    {
        BDBG_ERR(("Running Box Mode %d is not recommended on this chip. The RTS is configured for a b0, you are likely experience strange behaviour.", ulId));
    }
#endif
