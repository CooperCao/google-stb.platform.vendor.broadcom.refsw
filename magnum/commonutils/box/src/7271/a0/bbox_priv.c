...
static const BBOX_MemConfig stBoxMemConfig_7271A0_box2 =
{
   {
      BBOX_MK_RDC_MEMC_IDX(0),       /* RDC */
      {
...
static const BBOX_MemConfig stBoxMemConfig_7271A0_box4 =
{
   {
      BBOX_MK_RDC_MEMC_IDX(0),       /* RDC */
      {
...
static const BBOX_MemConfig stBoxMemConfig_7271A0_box1000 =
{
   {
      BBOX_MK_RDC_MEMC_IDX(0),       /* RDC */
      {
    ...
    switch (ulBoxId)
    {
        case 1:
            *pBoxMemConfig = stBoxMemConfig_7271A0_box1;
            ...
            break;
        case 2:
            *pBoxMemConfig = stBoxMemConfig_7271A0_box2;
        ...
        case 3:
            *pBoxMemConfig = stBoxMemConfig_7271A0_box3;
            ...
            break;
        case 4:
            *pBoxMemConfig = stBoxMemConfig_7271A0_box4;
            pBoxMemConfig->ulNumMemc = stBoxRts_LPDDR4_1600_box4.ulNumMemc;
            break;
        case 1000:
            *pBoxMemConfig = stBoxMemConfig_7271A0_box1000;
