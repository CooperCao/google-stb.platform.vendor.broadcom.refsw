...
BDBG_MODULE(BBOX_RTS_BOX10);
BDBG_OBJECT_ID(BBOX_RTS_BOX10);


void BBOX_P_SetBox10MemConfig
    ( BBOX_MemConfig                *pBoxMemConfig )
{
    ...
    BBOX_P_SET_NUM_MEMC(pBoxMemConfig, stBoxRts_GfxPiP_box10.ulNumMemc);
}

void BBOX_P_GetBox10Rts
    ( BBOX_Rts *pBoxRts )
{
    *pBoxRts = stBoxRts_GfxPiP_box10;
}
