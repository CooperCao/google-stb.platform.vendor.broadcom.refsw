...
static const BBOX_MemConfig stBoxMemConfig_7271A0_box5 =
{
   {
...
{
    *pBoxMemConfig = stBoxMemConfig_7271A0_box5;
    pBoxMemConfig->ulNumMemc = stBoxRts_UHD_3200_box5.ulNumMemc;
}

void BBOX_P_GetBox5Rts
    ( BBOX_Rts *pBoxRts )
{
    *pBoxRts = stBoxRts_UHD_3200_box5;
}
