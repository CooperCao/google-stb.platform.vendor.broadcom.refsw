...
static const BBOX_MemConfig stBoxMemConfig_7271A0_box9 =
{
   {
...
{
    *pBoxMemConfig = stBoxMemConfig_7271A0_box9;
    pBoxMemConfig->ulNumMemc = stBoxRts_2X_refresh_3200_box9.ulNumMemc;
}

void BBOX_P_GetBox9Rts
    ( BBOX_Rts *pBoxRts )
{
    *pBoxRts = stBoxRts_2X_refresh_3200_box9;
}
