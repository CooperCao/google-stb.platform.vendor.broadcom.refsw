...
static const BBOX_MemConfig stBoxMemConfig_7271A0_box8 =
{
   {
...
{
    *pBoxMemConfig = stBoxMemConfig_7271A0_box8;
    pBoxMemConfig->ulNumMemc = stBoxRts_KT_B03733_box8.ulNumMemc;
}

void BBOX_P_GetBox8Rts
    ( BBOX_Rts *pBoxRts )
{
    *pBoxRts = stBoxRts_KT_B03733_box8;
}
