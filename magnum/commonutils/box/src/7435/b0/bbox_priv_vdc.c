      ...
      BBOX_Vdc_Source_Capabilities *pSourceCap )
{
    switch(ulBoxId)
    {
        case 1:
        case 2:
            BBOX_P_Vdc_SetBoxSourceCapabilities(pSourceCap);
            break;
    }
}
      ...
      BBOX_Vdc_Display_Capabilities *pDisplayCap )
{
    switch (ulBoxId)
    {
        case 1:
        case 2:
            BBOX_P_Vdc_SetBoxDisplayCapabilities(pDisplayCap);
            break;
    }
}
      ...
      BBOX_Vdc_Deinterlacer_Capabilities *pDeinterlacerCap )
{
    switch (ulBoxId)
    {
        case 1:
        case 2:
            BBOX_P_Vdc_SetBoxDeinterlacerCapabilities(pDeinterlacerCap);
            break;
    }
 }
