...
{
    BBOX_P_VDC_SET_DISPLAY_LIMIT(pDisplayCap, Display1, 1080p_30Hz, 1080p_30Hz, 0, 0, 0, Class1);
        BBOX_P_VDC_SET_WINDOW_LIMIT(pDisplayCap, Display1, Video0, DISREGARD, BBOX_VDC_DISREGARD, BBOX_VDC_DISREGARD, AutoDisable);
    ...
    ( BBOX_Vdc_Deinterlacer_Capabilities *pDeinterlacerCap )
{
    ...
    BBOX_P_VDC_SET_DEINTERLACER_LIMIT(pDeinterlacerCap, Deinterlacer1, BFMT_1080I_WIDTH, BFMT_1080I_HEIGHT, 1920);
}
