...
#define BBOX_RTS_INVALID_ADDR  0x0
#define BBOX_RTS_INVALID_VALUE 0xFFFFFFFF

typedef struct
{
    uint32_t              ulAddr;
    uint32_t              ulData;
} BBOX_Rts_AddrDataPair;

typedef BBOX_Rts_AddrDataPair BBOX_Rts_PfriClient;
...
typedef struct BBOX_Rts
{
    ...
    uint32_t         ulNumAddrDataPairs;
    const BBOX_Rts_AddrDataPair *pastAddrDataPairs;
} BBOX_Rts;
