 ...
 *  ANY LIMITED REMEDY.
 ******************************************************************************/
#ifndef BRDC_PRIVATE_H__
#define BRDC_PRIVATE_H__
...
#define BRDC_P_MAX_NUM_OF_DISPLAYS     (3)
    ...
    #define BRDC_P_SCRATCH_REG_END     (BCHP_RDC_scratch64_i_ARRAY_END)
    ...
    #else
    #define BRDC_P_SCRATCH_REG_END     (BCHP_RDC_scratch_i_ARRAY_END)
