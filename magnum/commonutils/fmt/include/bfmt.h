...
#define BFMT_VERT_7_493Hz            0x01000000
#define BFMT_VERT_7_5Hz              0x02000000
#define BFMT_VERT_9_99Hz             0x04000000
#define BFMT_VERT_10Hz               0x08000000
#define BFMT_VERT_11_988Hz           0x10000000
#define BFMT_VERT_12Hz               0x20000000
#define BFMT_VERT_19_98Hz            0x40000000

/* This enum describes clock frequencies that are exact, multiplied by 1.001, or divided by 1.001. */
typedef enum
{
    BFMT_ClockMod_eNone = 0,
    BFMT_ClockMod_eDiv  = 1,
    BFMT_ClockMod_eMul  = 2
}
BFMT_ClockMod;
...
#define BFMT_PXL_25_2MHz_DIV_1_001   BFMT_SHIFT32(BFMT_PXL_25_2MHz)

/* NTSC and 480p, NTSC is upsampled in VEC from 13.5MHz */
#define BFMT_PXL_27MHz               0x00000002
#define BFMT_PXL_27MHz_MUL_1_001     BFMT_SHIFT32(BFMT_PXL_27MHz)
#define BFMT_PXL_27MHz_DIV_1_001     0x00000000 /* not used */

/* 1080i and 720p */
#define BFMT_PXL_74_25MHz            0x00000004
#define BFMT_PXL_74_25MHz_MUL_1_001  0x00000000 /* not used */
#define BFMT_PXL_74_25MHz_DIV_1_001  BFMT_SHIFT32(BFMT_PXL_74_25MHz)

/* 1080p60 3D or 1080p100/120
 * Reuse bits. BFMT_PXL_39_79MHz and BFMT_PXL_39_79MHz_DIV_1_001
 * are used for input only */
#define BFMT_PXL_297MHz              0x00000008 /* 60    Hz */
#define BFMT_PXL_297MHz_DIV_1_001    BFMT_SHIFT32(BFMT_PXL_297MHz)

/* VESA mode: 1024x768p @ 60/59.94Hz */
#define BFMT_PXL_65MHz               0x00000010
#define BFMT_PXL_65MHz_DIV_1_001     BFMT_SHIFT32(BFMT_PXL_65MHz)

/* VESA mode: 1280x720p @ 50Hz */
#define BFMT_PXL_60_4656MHz          0x00000020
#define BFMT_PXL_60_375MHz           0x00000000 /* not used */

/* 480P output, with 54 MHz pixel sampling with pixel doubling */
#define BFMT_PXL_54MHz               0x00000040
#define BFMT_PXL_54MHz_MUL_1_001     BFMT_SHIFT32(BFMT_PXL_54MHz)

/* VESA mode: 800x600p @ 60/59.94Hz */
#define BFMT_PXL_40MHz               0x00000000 /* not used */
#define BFMT_PXL_39_79MHz            0x00000080 /* 60    Hz */
#define BFMT_PXL_39_79MHz_DIV_1_001  BFMT_SHIFT32(BFMT_PXL_39_79MHz)

/* VESA mode: 640x480p_CVT @ 60Hz */
#define BFMT_PXL_23_75MHz            0x00000100
#define BFMT_PXL_23_75MHz_DIV_1_001  BFMT_SHIFT32(BFMT_PXL_23_75MHz)

/* VESA mode: 1280x800p @ 60Hz */
#define BFMT_PXL_83_5MHz             0x00000200
#define BFMT_PXL_83_5MHz_DIV_1_001   BFMT_SHIFT32(BFMT_PXL_83_5MHz)

/* VESA mode: 1280x1024p @ 60Hz */
#define BFMT_PXL_108MHz              0x00000400
#define BFMT_PXL_108MHz_DIV_1_001    BFMT_SHIFT32(BFMT_PXL_108MHz)

/* VESA mode: 1440x900p @ 60Hz */
#define BFMT_PXL_106_5MHz            0x00000800
#define BFMT_PXL_106_5MHz_DIV_1_001  BFMT_SHIFT32(BFMT_PXL_106_5MHz)

/* VESA mode: 1360x768p @ 60Hz */
#define BFMT_PXL_85_5MHz             0x00001000
#define BFMT_PXL_85_5MHz_DIV_1_001   BFMT_SHIFT32(BFMT_PXL_85_5MHz)

/* 1080p */
#define BFMT_PXL_148_5MHz            0x00002000 /* 60Hz */
#define BFMT_PXL_148_5MHz_DIV_1_001  BFMT_SHIFT32(BFMT_PXL_148_5MHz)

/* 1600x1200p_60Hz */
#define BFMT_PXL_162MHz              0x00004000 /* 60Hz */
...
#define BFMT_PXL_67_565MHz_DIV_1_001 BFMT_SHIFT32(BFMT_PXL_67_565MHz) /* 59.94 Hz */

/* VESA mode: 1280x720p @ 60/59.94Hz Reduced Blanking */
#define BFMT_PXL_64MHz               0x00000000 /* not used */
#define BFMT_PXL_64_022MHz           0x40000000
#define BFMT_PXL_64_022MHz_DIV_1_001 BFMT_SHIFT32(BFMT_PXL_64_022MHz)

/* VESA mode: 1280x768p @ 60/59.94Hz */
#define BFMT_PXL_65_286MHz           0x00008000
#define BFMT_PXL_65_286MHz_DIV_1_001 BFMT_SHIFT32(BFMT_PXL_65_286MHz)

/* 4k2k@50/60 */
#define BFMT_PXL_594MHz              0x00010000
#define BFMT_PXL_594MHz_DIV_1_001    BFMT_SHIFT32(BFMT_PXL_594MHz)

/* 640x480 VESA */
#define BFMT_PXL_75_5MHz             0x00020000
#define BFMT_PXL_75_5MHz_DIV_1_001   BFMT_SHIFT32(BFMT_PXL_75_5MHz)

/* 480p, 1440x480i, 576p, 144x576i MHL */
#define BFMT_PXL_81MHz               0x00040000
#define BFMT_PXL_81MHz_MUL_1_001     BFMT_SHIFT32(BFMT_PXL_81MHz)

/* 720p, 1080i, 1080p MHL */
#define BFMT_PXL_222_75MHz           0x00080000
#define BFMT_PXL_222_75MHz_DIV_1_001 BFMT_SHIFT32(BFMT_PXL_222_75MHz)
...
#define BFMT_PXL_36MHz               0x00000000 /* not used */
#define BFMT_PXL_49_50MHz            0x00000000 /* not used */
#define BFMT_PXL_50MHz               0x00000000 /* not used */
#define BFMT_PXL_56_25MHz            0x00000000 /* not used */
#define BFMT_PXL_75MHz               0x00000000 /* not used */
...
/* Here is a list of pixel frequencies known to hardware experts, but not used
 * in reference software
 */
#define BFMT_PXL_25MHz 0
#define BFMT_PXL_25MHz_DIV_1_001 0
#define BFMT_PXL_25_175MHz 0
#define BFMT_PXL_25_175MHz_DIV_1_001 0
#define BFMT_PXL_31_5MHz 0
#define BFMT_PXL_31_5MHz_DIV_1_001 0
#define BFMT_PXL_33_75MHz 0
#define BFMT_PXL_33_75MHz_DIV_1_001 0
#define BFMT_PXL_35_5MHz 0
#define BFMT_PXL_35_5MHz_DIV_1_001 0
#define BFMT_PXL_38_21568MHz 0
#define BFMT_PXL_38_21568MHz_DIV_1_001 0
#define BFMT_PXL_39_5MHz 0
#define BFMT_PXL_39_5MHz_DIV_1_001 0
#define BFMT_PXL_39_75MHz 0
#define BFMT_PXL_39_75MHz_DIV_1_001 0
#define BFMT_PXL_39_79008MHz 0
#define BFMT_PXL_39_79008MHz_DIV_1_001 0
#define BFMT_PXL_40_0MHz 0
#define BFMT_PXL_40_0MHz_DIV_1_001 0
#define BFMT_PXL_40_5MHz 0
#define BFMT_PXL_40_5MHz_DIV_1_001 0
#define BFMT_PXL_44_9MHz 0
#define BFMT_PXL_44_9MHz_DIV_1_001 0
#define BFMT_PXL_49MHz 0
#define BFMT_PXL_49MHz_DIV_1_001 0
#define BFMT_PXL_49_5MHz 0
#define BFMT_PXL_49_5MHz_DIV_1_001 0
#define BFMT_PXL_54_0MHz 0
#define BFMT_PXL_54_0MHz_DIV_1_001 0
#define BFMT_PXL_56_25MHz_DIV_1_001 0
#define BFMT_PXL_59_4MHz 0
#define BFMT_PXL_59_4MHz_DIV_1_001 0
#define BFMT_PXL_60_4656MHz_DIV_1_001 0
#define BFMT_PXL_63_958MHz 0
#define BFMT_PXL_63_958MHz_DIV_1_001 0
#define BFMT_PXL_64_0224MHz 0
#define BFMT_PXL_64_0224MHz_DIV_1_001 0
#define BFMT_PXL_64_93MHz 0
#define BFMT_PXL_64_93MHz_DIV_1_001 0
#define BFMT_PXL_65_0_MHz 0
#define BFMT_PXL_65_0_MHz_DIV_1_001 0
#define BFMT_PXL_65_22MHz 0
#define BFMT_PXL_65_22MHz_DIV_1_001 0
#define BFMT_PXL_67_497MHz 0
#define BFMT_PXL_67_497MHz_DIV_1_001 0
#define BFMT_PXL_67_5MHz 0
#define BFMT_PXL_67_5MHz_DIV_1_001 0
#define BFMT_PXL_67_5648MHz 0
#define BFMT_PXL_67_5648MHz_DIV_1_001 0
#define BFMT_PXL_68_25MHz 0
#define BFMT_PXL_68_25MHz_DIV_1_001 0
#define BFMT_PXL_72MHz 0
#define BFMT_PXL_72MHz_DIV_1_001 0
#define BFMT_PXL_78_75MHz_DIV_1_001 0
#define BFMT_PXL_79_5MHz 0
#define BFMT_PXL_79_5MHz_DIV_1_001 0
#define BFMT_PXL_80_136MHz 0
#define BFMT_PXL_80_136MHz_DIV_1_001 0
#define BFMT_PXL_82MHz 0
#define BFMT_PXL_82MHz_DIV_1_001 0
#define BFMT_PXL_83_4624MHz 0
#define BFMT_PXL_83_4624MHz_DIV_1_001 0
#define BFMT_PXL_84_7152MHz 0
#define BFMT_PXL_84_7152MHz_DIV_1_001 0
#define BFMT_PXL_84_75MHz 0
#define BFMT_PXL_84_75MHz_DIV_1_001 0
#define BFMT_PXL_88_75MHz 0
#define BFMT_PXL_88_75MHz_DIV_1_001 0
#define BFMT_PXL_92_8125MHz 0
#define BFMT_PXL_92_8125MHz_DIV_1_001 0
#define BFMT_PXL_94_5MHz 0
#define BFMT_PXL_94_5MHz_DIV_1_001 0
#define BFMT_PXL_101_0MHz 0
#define BFMT_PXL_101_0MHz_DIV_1_001 0
#define BFMT_PXL_101_25MHz 0
#define BFMT_PXL_101_25MHz_DIV_1_001 0
#define BFMT_PXL_102_5MHz 0
#define BFMT_PXL_102_5MHz_DIV_1_001 0
#define BFMT_PXL_102_25MHz 0
#define BFMT_PXL_102_25MHz_DIV_1_001 0
#define BFMT_PXL_108_0MHz 0
#define BFMT_PXL_108_0MHz_DIV_1_001 0
#define BFMT_PXL_108_108MHz 0
#define BFMT_PXL_108_108MHz_DIV_1_001 0
#define BFMT_PXL_109MHz 0
#define BFMT_PXL_109MHz_DIV_1_001 0
#define BFMT_PXL_111_375MHz 0
#define BFMT_PXL_111_375MHz_DIV_1_001 0
#define BFMT_PXL_117_5MHz 0
#define BFMT_PXL_117_5MHz_DIV_1_001 0
#define BFMT_PXL_119MHz 0
#define BFMT_PXL_119MHz_DIV_1_001 0
#define BFMT_PXL_121_75MHz_DIV_1_001 0
#define BFMT_PXL_135MHz 0
#define BFMT_PXL_135MHz_DIV_1_001 0
#define BFMT_PXL_136_75MHz 0
#define BFMT_PXL_136_75MHz_DIV_1_001 0
#define BFMT_PXL_146_25MHz 0
#define BFMT_PXL_146_25MHz_DIV_1_001 0
#define BFMT_PXL_154MHz 0
#define BFMT_PXL_154MHz_DIV_1_001 0
#define BFMT_PXL_156_0MHz 0
#define BFMT_PXL_156_0MHz_DIV_1_001 0
#define BFMT_PXL_157MHz 0
#define BFMT_PXL_157MHz_DIV_1_001 0
#define BFMT_PXL_157_5MHz 0
#define BFMT_PXL_157_5MHz_DIV_1_001 0
#define BFMT_PXL_161MHz 0
#define BFMT_PXL_161MHz_DIV_1_001 0
#define BFMT_PXL_162_0MHz 0
#define BFMT_PXL_162_0MHz_DIV_1_001 0
#define BFMT_PXL_162_0MHz_MUL_1_001 0
#define BFMT_PXL_175_5MHz 0
#define BFMT_PXL_175_5MHz_DIV_1_001 0
#define BFMT_PXL_185MHz 0
#define BFMT_PXL_185MHz_DIV_1_001 0
#define BFMT_PXL_185_625MHz 0
#define BFMT_PXL_185_625MHz_DIV_1_001 0
#define BFMT_PXL_187MHz 0
#define BFMT_PXL_187MHz_DIV_1_001 0
#define BFMT_PXL_189MHz 0
#define BFMT_PXL_189MHz_DIV_1_001 0
#define BFMT_PXL_193_25MHz 0
#define BFMT_PXL_193_25MHz_DIV_1_001 0
#define BFMT_PXL_202_5MHz 0
#define BFMT_PXL_202_5MHz_DIV_1_001 0
#define BFMT_PXL_204_75MHz 0
#define BFMT_PXL_204_75MHz_DIV_1_001 0
#define BFMT_PXL_214_75MHz 0
#define BFMT_PXL_214_75MHz_DIV_1_001 0
#define BFMT_PXL_218_25MHz 0
#define BFMT_PXL_218_25MHz_DIV_1_001 0
#define BFMT_PXL_229_5MHz 0
#define BFMT_PXL_229_5MHz_DIV_1_001 0
#define BFMT_PXL_234MHz 0
#define BFMT_PXL_234MHz_DIV_1_001 0
#define BFMT_PXL_245_25MHz 0
#define BFMT_PXL_245_25MHz_DIV_1_001 0
#define BFMT_PXL_261MHz 0
#define BFMT_PXL_261MHz_DIV_1_001 0
#define BFMT_PXL_281_25MHz 0
#define BFMT_PXL_281_25MHz_DIV_1_001 0
#define BFMT_PXL_288MHz 0
#define BFMT_PXL_288MHz_DIV_1_001 0
#define BFMT_PXL_297_0MHz 0
#define BFMT_PXL_297_0MHz_DIV_1_001 0
#define BFMT_PXL_312_25MHz 0
#define BFMT_PXL_312_25MHz_DIV_1_001 0
#define BFMT_PXL_348_5MHz 0
#define BFMT_PXL_348_5MHz_DIV_1_001 0
#define BFMT_PXL_600MHz 0
#define BFMT_PXL_600MHz_DIV_1_001 0
