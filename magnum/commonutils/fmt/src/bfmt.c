...
#if BFMT_DO_PICK
#define P_STRINGIZE(a) NULL
#else
#define P_STRINGIZE(a) #a
#endif
...
#define BFMT_P_MAKE_FMT__(pick__, fmt__, width, height, raster_width, \
    raster_height,       \
    top_active, top_max_vbi, bot_max_vbi, active_space, vert_freq_mask,        \
    vert_freq, pxl_freq_mask, pxl_freq, interlaced, aspect_ratio, orientation) \
BFMT_P_MAKE_FMT_##pick__(fmt__, width, height, raster_width, \
    raster_height,       \
    top_active, top_max_vbi, bot_max_vbi, active_space, vert_freq_mask,        \
    vert_freq, pxl_freq_mask, pxl_freq, interlaced, aspect_ratio, orientation)
 ...
 *            BFMT_PICK_eNTSC ==> 1 */
#define BFMT_P_MAKE_FMT_(pick_, fmt_, width, height, raster_width, \
    raster_height,       \
    top_active, top_max_vbi, bot_max_vbi, active_space, vert_freq_mask,        \
    vert_freq, pxl_freq_mask, pxl_freq, interlaced, aspect_ratio, orientation) \
BFMT_P_MAKE_FMT__(pick_, fmt_, width, height, raster_width, \
    raster_height,       \
    top_active, top_max_vbi, bot_max_vbi, active_space, vert_freq_mask,        \
    vert_freq, pxl_freq_mask, pxl_freq, interlaced, aspect_ratio, orientation)
...
#define BFMT_P_MAKE_FMT(fmt, width, height, raster_width, raster_height,       \
    top_active, top_max_vbi, bot_max_vbi, active_space, vert_freq_mask,        \
    vert_freq, pxl_freq_mask, pxl_freq, interlaced, aspect_ratio, orientation) \
BFMT_P_MAKE_FMT_(BFMT_PICK_##fmt, BFMT_VideoFmt_##fmt, width, height, \
    ...
    ( BFMT_VideoFmt                      eVideoFmt )
{
    ...
    default:
        ...
        BDBG_ASSERT (pVideoInfo->eVideoFmt == eVideoFmt);
        break;
    }
