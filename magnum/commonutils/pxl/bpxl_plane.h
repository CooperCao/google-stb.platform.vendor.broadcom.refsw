...
Description:
    ...
    with default values (size and pitch are aligned), based on the user
    specified information.

    For 420 Cb, Cr or CbCr planes, width / height passed in should be
    half of the Y plane width / height.
