   ...
   )
{
   ...
   if( bSignalFirstPPB )
   {
      ...
      BDBG_MODULE_MSG( BXDM_PPCB, ("%x:[%02x.xxx] BXDM_PictureProvider_Callback_eFirstPtsReady(%08x)",
      ...
      BXDM_PPDFIFO_P_QueString_isr( hXdmPP, BXDM_Debug_MsgType_eCB, true,
                                 "%x:[%02x.xxx] BXDM_PictureProvider_Callback_eFirstPtsReady(%08x)",
                                 hXdmPP->stDMState.stDecode.stDebug.uiVsyncCount,
                                 BXDM_PPDBG_FORMAT_INSTANCE_ID( hXdmPP ),
                                 hXdmPP->stDMState.stDecode.stFirstCodedPts.ui32RunningPTS );
   ...
   )
{
   ...
   if( bSignalFirstCodedPts )
   {
      ...
      BDBG_MODULE_MSG( BXDM_PPCB, ("%x:[%02x.xxx] BXDM_PictureProvider_Callback_eFirstCodedPtsReady(%08x)",
                                 hXdmPP->stDMState.stDecode.stDebug.uiVsyncCount,
                                 BXDM_PPDBG_FORMAT_INSTANCE_ID( hXdmPP ),
                                 hXdmPP->stDMState.stDecode.stFirstCodedPts.ui32RunningPTS ));

      BXDM_PPDFIFO_P_QueString_isr( hXdmPP, BXDM_Debug_MsgType_eCB, true,
                                 "%x:[%02x.xxx] BXDM_PictureProvider_Callback_eFirstCodedPtsReady(%08x)",
                                 hXdmPP->stDMState.stDecode.stDebug.uiVsyncCount,
                                 BXDM_PPDBG_FORMAT_INSTANCE_ID( hXdmPP ),
                                 hXdmPP->stDMState.stDecode.stFirstCodedPts.ui32RunningPTS );
   ...
   )
{
   ...
   if( bSignalTsmPass )
   {
      ...
      BDBG_MODULE_MSG( BXDM_PPCB, ("%x:[%02x.xxx] BXDM_PictureProvider_Callback_eFirstPtsPassed(%08x)",
                                 hXdmPP->stDMState.stDecode.stDebug.uiVsyncCount,
                                 BXDM_PPDBG_FORMAT_INSTANCE_ID( hXdmPP ),
                                 hXdmPP->stDMStatus.stCurrentPTS.ui32RunningPTS ));

      BXDM_PPDFIFO_P_QueString_isr( hXdmPP, BXDM_Debug_MsgType_eCB, true,
                                 "%x:[%02x.xxx] BXDM_PictureProvider_Callback_eFirstPtsPassed(%08x)",
                                 hXdmPP->stDMState.stDecode.stDebug.uiVsyncCount,
                                 BXDM_PPDBG_FORMAT_INSTANCE_ID( hXdmPP ),
                                 hXdmPP->stDMStatus.stCurrentPTS.ui32RunningPTS );
   ...
   )
{
   ...
   if (pLocalState->bForcePtsError)
   {
      ...
      BDBG_MODULE_MSG( BXDM_PPCB, ("%x:[%02x.xxx] Force PTS Error",
                                 hXdmPP->stDMState.stDecode.stDebug.uiVsyncCount,
                                 BXDM_PPDBG_FORMAT_INSTANCE_ID( hXdmPP ) ));

      BXDM_PPDFIFO_P_QueString_isr( hXdmPP, BXDM_Debug_MsgType_eCB, true,
                                 "%x:[%02x.xxx] Force PTS Error",
                                 hXdmPP->stDMState.stDecode.stDebug.uiVsyncCount,
                                 BXDM_PPDBG_FORMAT_INSTANCE_ID( hXdmPP ) );
   ...
   if( bSignalPtsError )
   {
      ...
      BDBG_MODULE_MSG( BXDM_PPCB, ("%x:[%02x.xxx] BXDM_PictureProvider_Callback_ePtsError(%08x)",
                                 hXdmPP->stDMState.stDecode.stDebug.uiVsyncCount,
                                 BXDM_PPDBG_FORMAT_INSTANCE_ID( hXdmPP ),
                                 hXdmPP->stDMState.stDecode.stErrorPts.ui32RunningPTS ));

      BXDM_PPDFIFO_P_QueString_isr( hXdmPP, BXDM_Debug_MsgType_eCB, true,
                                 "%x:[%02x.xxx] BXDM_PictureProvider_Callback_ePtsError(%08x)",
                                 hXdmPP->stDMState.stDecode.stDebug.uiVsyncCount,
                                 BXDM_PPDBG_FORMAT_INSTANCE_ID( hXdmPP ),
                                 hXdmPP->stDMState.stDecode.stErrorPts.ui32RunningPTS );
   ...
   )
{
   ...
   if ( bSignalPtsStcOffset )
   {
      ...
      BDBG_MODULE_MSG( BXDM_PPCB, ("%x:[%02x.xxx] BXDM_PictureProvider_Callback_eStcPtsOffset(%08x)",
                hXdmPP->stDMState.stDecode.stDebug.uiVsyncCount,
                BXDM_PPDBG_FORMAT_INSTANCE_ID( hXdmPP ),
   ...
   )
{
   ...
   if( bSignalIFrame )
   {
      ...
      BDBG_MODULE_MSG( BXDM_PPCB, ("%x:[%02x.xxx] BXDM_PictureProvider_Callback_eIFrame(%d)",
                hXdmPP->stDMState.stDecode.stDebug.uiVsyncCount,
                BXDM_PPDBG_FORMAT_INSTANCE_ID( hXdmPP ),
                hXdmPP->stDMStatus.bIPictureFound ));

      BXDM_PPDFIFO_P_QueString_isr( hXdmPP, BXDM_Debug_MsgType_eCB, true,
                  "%x:[%02x.xxx] BXDM_PictureProvider_Callback_eIFrame(%d)",
                  hXdmPP->stDMState.stDecode.stDebug.uiVsyncCount,
                  BXDM_PPDBG_FORMAT_INSTANCE_ID( hXdmPP ),
                  hXdmPP->stDMStatus.bIPictureFound );
   ...
   )
{
   ...
   if ( bSignalRequestStc )
   {
      ...
      BDBG_MODULE_MSG( BXDM_PPCB, ("%x:[%02x.xxx] BXDM_PictureProvider_Callback_eRequestSTC(%08x)",
                hXdmPP->stDMState.stDecode.stDebug.uiVsyncCount,
                BXDM_PPDBG_FORMAT_INSTANCE_ID( hXdmPP ),
                stPTSInfo.ui32RunningPTS ));

      BXDM_PPDFIFO_P_QueString_isr( hXdmPP, BXDM_Debug_MsgType_eCB, true,
                  "%x:[%02x.xxx] BXDM_PictureProvider_Callback_eRequestSTC(%08x)",
                  hXdmPP->stDMState.stDecode.stDebug.uiVsyncCount,
                  BXDM_PPDBG_FORMAT_INSTANCE_ID( hXdmPP ),
                  stPTSInfo.ui32RunningPTS );
   ...
   )
{
   ...
   if ( bSignalClipStart )
   {
      ...
      BDBG_MODULE_MSG( BXDM_PPCB, ("%x:[%02x.xxx] BXDM_PictureProvider_Callback_eClipStart(0x%lu)",
                                 hXdmPP->stDMState.stDecode.stDebug.uiVsyncCount,
                                 BXDM_PPDBG_FORMAT_INSTANCE_ID( hXdmPP ),
                                 (unsigned long)&pLocalState->stCallbackInfo.stClipStart.stClipEventInfo ));

      BXDM_PPDFIFO_P_QueString_isr( hXdmPP, BXDM_Debug_MsgType_eCB, true,
                                    "%x:[%02x.xxx] BXDM_PictureProvider_Callback_eClipStart(0x%lu)",
                                    hXdmPP->stDMState.stDecode.stDebug.uiVsyncCount,
                                    BXDM_PPDBG_FORMAT_INSTANCE_ID( hXdmPP ),
                                    (unsigned long)&pLocalState->stCallbackInfo.stClipStart.stClipEventInfo );
   ...
   )
{
   ...
   if ( bSignalClipStop )
   {
      ...
      BDBG_MODULE_MSG( BXDM_PPCB, ("%x:[%02x.xxx] BXDM_PictureProvider_Callback_eClipStop(0x%lu)",
                                 hXdmPP->stDMState.stDecode.stDebug.uiVsyncCount,
                                 BXDM_PPDBG_FORMAT_INSTANCE_ID( hXdmPP ),
                                 (unsigned long)&pLocalState->stCallbackInfo.stClipStop.stClipEventInfo ));

      BXDM_PPDFIFO_P_QueString_isr( hXdmPP, BXDM_Debug_MsgType_eCB, true,
                                       "%x:[%02x.xxx] BXDM_PictureProvider_Callback_eClipStop(0x%lu)",
                                       hXdmPP->stDMState.stDecode.stDebug.uiVsyncCount,
                                       BXDM_PPDBG_FORMAT_INSTANCE_ID( hXdmPP ),
                                       (unsigned long)&pLocalState->stCallbackInfo.stClipStop.stClipEventInfo );
   ...
   )
{
   ...
   if ( bSignalPictureMarker )
   {
      ...
      BDBG_MODULE_MSG( BXDM_PPCB, ("%x:[%02x.xxx] BXDM_PictureProvider_Callback_ePictureMarker(0x%lu)",
                                 hXdmPP->stDMState.stDecode.stDebug.uiVsyncCount,
                                 BXDM_PPDBG_FORMAT_INSTANCE_ID( hXdmPP ),
                                 (unsigned long)&pLocalState->stCallbackInfo.stPictureMarker.stClipEventInfo ));

      BXDM_PPDFIFO_P_QueString_isr( hXdmPP, BXDM_Debug_MsgType_eCB, true,
                                       "%x:[%02x.xxx] BXDM_PictureProvider_Callback_ePictureMarker(0x%lu)",
                                       hXdmPP->stDMState.stDecode.stDebug.uiVsyncCount,
                                       BXDM_PPDBG_FORMAT_INSTANCE_ID( hXdmPP ),
                                       (unsigned long)&pLocalState->stCallbackInfo.stPictureMarker.stClipEventInfo );
   ...
   )
{
   ...
   if( bSignalDecodeError )
   {
      ...
      BDBG_MODULE_MSG( BXDM_PPCB, ("%x:[%02x.xxx] BXDM_PPCB_S_DecodeError_isr(%d)",
                hXdmPP->stDMState.stDecode.stDebug.uiVsyncCount,
                BXDM_PPDBG_FORMAT_INSTANCE_ID( hXdmPP ),
                hXdmPP->stDMStatus.stCounters.uiDecodeErrorCount ));

      BXDM_PPDFIFO_P_QueString_isr( hXdmPP, BXDM_Debug_MsgType_eCB, true,
                  "%x:[%02x.xxx] BXDM_PPCB_S_DecodeError_isr(%d)",
                  hXdmPP->stDMState.stDecode.stDebug.uiVsyncCount,
                  BXDM_PPDBG_FORMAT_INSTANCE_ID( hXdmPP ),
                  hXdmPP->stDMStatus.stCounters.uiDecodeErrorCount );
   ...
   )
{
   ...
   if( bSignalChunkDone )
   {
      ...
      BDBG_MODULE_MSG( BXDM_PPCB, ("%x:[%02x.xxx] BXDM_PPCB_S_ChunkDone_isr:: uiChunkId:%08x",
                hXdmPP->stDMState.stDecode.stDebug.uiVsyncCount,
                BXDM_PPDBG_FORMAT_INSTANCE_ID( hXdmPP ),
