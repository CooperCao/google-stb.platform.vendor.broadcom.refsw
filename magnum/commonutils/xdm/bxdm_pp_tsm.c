   ...
   )
{
    ...
    * SWSTB-9275: for 3:2 content, don't force single field mode.  Need to be able to select
    * any element in the picture to keep the STC/PTS phase constant */

   bTreatAsSingleElement |= ( pstPicture->stPicParms.stDisplay.stDynamic.bForceSingleFieldMode
                             & ( pstPicture->stPicParms.stDisplay.stStatic.b32FilmSource == false ));;
