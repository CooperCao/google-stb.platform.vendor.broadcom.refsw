...
typedef struct BHAB_7255_Settings
{
   bool bUseInternalMemory; /* true if LEAP is loaded in 7255 internal memory */
...
BERR_Code BHAB_7255_Configure(
    BHAB_Handle h,
    BHAB_7255_Settings *pSettings
);

/***************************************************************************
Summary:
    This function returns the default settings for 7255 module.

Description:
    This function is responsible for returns the default setting for
    7255 module. The returning default setting should be used when
    opening the device.
