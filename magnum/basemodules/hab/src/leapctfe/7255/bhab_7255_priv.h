...
#define BHAB_GET_EVENT_ID(data) (data >> 24)
#define BHAB_GET_CORE_ID(data) ((data & BHAB_CORE_ID_MASK) >> 11)
#define BHAB_GET_CORE_TYPE(data) ((data & BHAB_CORE_TYPE_MASK) >> 19)
#define BHAB_GET_LOCK_STATUS(data) ((data & BHAB_EVENT_DATA_MASK) >> 6)

#define BHAB_COMMAND_BUF_SIZE   80

typedef enum BHAB_LockStatus
{
    BHAB_LockStatus_eUnknown=0,
    BHAB_LockStatus_eLocked=1,
    BHAB_LockStatus_eUnlocked=2,
    BHAB_LockStatus_eNoSignal=3,
    BHAB_LockStatus_eLast
} BHAB_LockStatus;
...
typedef enum BHAB_EventId
{
    ...
    BHAB_EventId_eNewDiversityMaster = 90,
    BHAB_EventId_eLast
} BHAB_EventId;
...
#define BHAB_P_ACQUIRE_MUTEX(handle) BKNI_AcquireMutex(((BHAB_7255_P_Handle *)(handle->pImpl))->hMutex)
#define BHAB_P_RELEASE_MUTEX(handle) BKNI_ReleaseMutex(((BHAB_7255_P_Handle *)(handle->pImpl))->hMutex)
#define BHAB_P_ACQUIRE_REG_ACCESS_MUTEX(handle) BKNI_AcquireMutex(((BHAB_7255_P_Handle *)(handle->pImpl))->hRegAccessMutex)
#define BHAB_P_RELEASE_REG_ACCESS_MUTEX(handle) BKNI_ReleaseMutex(((BHAB_7255_P_Handle *)(handle->pImpl))->hRegAccessMutex)
...
typedef struct BHAB_7255_P_Handle
{
#if BHAB_CHIP==7364
...
#elif BHAB_CHIP==7255
    BHAB_7255_Settings settings;
    BHAB_7255_StandbySettings standbySettings;
#endif
...
Description:
   This function clears the host interrupt enable bits on the BCM7255.
Returns:
   BERR_Code
******************************************************************************/
BERR_Code BHAB_7255_P_DisableInterrupts(
...
Returns:
   BERR_Code
******************************************************************************/
BERR_Code BHAB_7255_P_EnableInitDoneInterrupt(
   BHAB_Handle handle  /* [in] BHAB Handle */
);
...
Returns:
   BERR_Code
******************************************************************************/
BERR_Code BHAB_7255_P_WriteHab(
    BHAB_Handle handle,   /* [in] BHAB PI Handle */
...
/******************************************************************************
Summary:
   Sets certain BKNI_Events based on the source of the BCM7255 host interrupt.
Description:
   This function reads and clears the BCM7255 interrupt status registers,
   clears the enable mask of the interrupts, and sets BKNI_Events based on the
   interrupt sources.
Returns:
   BERR_Code
******************************************************************************/
BERR_Code BHAB_7255_P_DecodeInterrupt(
    BHAB_Handle handle /* [in] BHAB Handle */
);
...
/****************** BCM7255 implementation of API functions *****************/
...
BERR_Code BHAB_7255_ReadMemory(
    BHAB_Handle h,  /* [in] BHAB PI Handle */
...
BERR_Code BHAB_7255_WriteMemory(
    BHAB_Handle handle, /* [in] BHAB PI Handle */
