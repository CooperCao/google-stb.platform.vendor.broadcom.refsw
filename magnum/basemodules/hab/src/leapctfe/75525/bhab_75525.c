...
/******************************************************************************
 BHAB_75525_Configure()
******************************************************************************/
BERR_Code BHAB_75525_Configure(BHAB_Handle h, BHAB_75525_Settings *pSettings)
{
    ...
    BKNI_Memcpy((void*)&(pImpl->settings), (void*)pSettings, sizeof(BHAB_75525_Settings));
