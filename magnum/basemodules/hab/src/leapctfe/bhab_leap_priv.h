...
Description:
   This function clears the host interrupt enable bits on the BCMLeap.
Returns:
   BERR_Code
******************************************************************************/
BERR_Code BHAB_Leap_P_DisableInterrupts(
...
Returns:
   BERR_Code
******************************************************************************/
BERR_Code BHAB_Leap_P_EnableInitDoneInterrupt(
   BHAB_Handle handle  /* [in] BHAB Handle */
);
...
Returns:
   BERR_Code
******************************************************************************/
BERR_Code BHAB_Leap_P_WriteHab(
    BHAB_Handle handle,   /* [in] BHAB PI Handle */
...
/******************************************************************************
Summary:
   Sets certain BKNI_Events based on the source of the BCMLeap host interrupt.
Description:
   This function reads and clears the BCMLeap interrupt status registers,
   clears the enable mask of the interrupts, and sets BKNI_Events based on the
   interrupt sources.
Returns:
   BERR_Code
******************************************************************************/
BERR_Code BHAB_Leap_P_DecodeInterrupt(
    BHAB_Handle handle /* [in] BHAB Handle */
);
...
/****************** BCMLeap implementation of API functions *****************/
...
BERR_Code BHAB_Leap_ReadMemory(
    BHAB_Handle h,  /* [in] BHAB PI Handle */
...
BERR_Code BHAB_Leap_WriteMemory(
    BHAB_Handle handle, /* [in] BHAB PI Handle */
