...
BDBG_MODULE(interruptinterface_7362);
...
static void BINT_P_7362_ClearInt( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static void BINT_P_7362_SetMask( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static void BINT_P_7362_ClearMask( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static uint32_t BINT_P_7362_ReadStatus( BREG_Handle regHandle, uint32_t baseAddr );
static uint32_t GetRaveIntEnableOffset( uint32_t BaseAddr );

static const BINT_P_IntMap bint_7362[] =
{
...
static const BINT_Settings bint_7362Settings =
{
	NULL,
	BINT_P_7362_ClearInt,
	BINT_P_7362_SetMask,
	BINT_P_7362_ClearMask,
	NULL,
	BINT_P_7362_ReadStatus,
	bint_7362,
	"7362"
};
...
const BINT_Settings *BINT_7362_GetSettings( void )
{
    return &bint_7362Settings;
}
