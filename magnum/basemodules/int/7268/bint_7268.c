...
static const BINT_P_IntMap bint_map[] =
{
    ...
    BINT_MAP_L3(2, XPT_RAV, XPT_RAVE_CPU_INTR_AGGREGATOR_INTR_W0, RAVE_LAST_CMD_INTR, "_CX00_31", XPT_RAVE_LAST_CMD_CX00_31_L2_INTR_CPU_STATUS_0_31, STANDARD, ALL, 0),
#endif
