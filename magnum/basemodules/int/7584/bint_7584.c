...
static const BINT_P_IntMap bint_7584[] =
{
    ...
    BINT_MAP_STD(2, RFM, RFM_L2_CPU),
    /*
    BINT_MAP(2, DS_0_WFE, "", DS_WFE_MICRO_IRQSTS, STANDARD, ALL, 0),
    BINT_MAP(2, DS_0, "", DS_TOPM_L2_IRQSTS, STANDARD, ALL, 0),
    BINT_MAP(2, DS_0_OOB_0, "", OOB_IRQSTA2C, STANDARD, ALL, 0),
    BINT_MAP(2, DS_0_OOB_1, "", OOB_IRQSTA2C, STANDARD, ALL, 0),
    */
    BINT_MAP_STD(2, MCIF, MCIF_INTR2_CPU),
    BINT_MAP_EXT(2, LEAP),
    BINT_MAP_STD(1, SCPU, SCPU_HOST_INTR2_CPU),
    BINT_MAP_LAST()
};
