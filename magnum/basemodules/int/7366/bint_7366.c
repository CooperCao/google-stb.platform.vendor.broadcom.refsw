...
/*  BINT_MAP_STD(1, SYS_PM, AON_PM_L2_CPU,  CHECK*/
...
#else
    BINT_MAP_STD(2, XPT_MSG, XPT_MSG_BUF_DAT_RDY_CPU_INTR_AGGREGATOR_INTR_W0),
    ...
    BINT_MAP_STD(2, XPT_MSG, XPT_MSG_BUF_OVFL_CPU_INTR_AGGREGATOR_INTR_W2),
    ...
    BINT_MAP_STD(2, XPT_RAV, XPT_RAVE_CPU_INTR_AGGREGATOR_INTR_W0),
    ...
    BINT_MAP_STD(2, XPT_MDMA_MCPB, XPT_MEMDMA_MCPB_CPU_INTR_AGGREGATOR_INTR_W0),
    ...
    BINT_MAP_STD(2, XPT_WMDMA, XPT_WDMA_CPU_INTR_AGGREGATOR_INTR_W0),
    ...
    BINT_MAP_STD(2, XPT_MCPB, XPT_MCPB_CPU_INTR_AGGREGATOR_INTR_W0),
