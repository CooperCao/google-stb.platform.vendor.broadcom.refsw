...
#include "bchp_ods_intr.h"
#include "bchp_ods_intr1.h"
...
BDBG_MODULE(interruptinterface_75525);
...
static void BINT_P_75525_ClearInt( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static void BINT_P_75525_SetMask( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static void BINT_P_75525_ClearMask( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static uint32_t BINT_P_75525_ReadStatus( BREG_Handle regHandle, uint32_t baseAddr );
static uint32_t GetRaveIntEnableOffset( uint32_t BaseAddr );

static const BINT_P_IntMap bint_75525[] =
{
    ...
    /* ODS */
    BINT_MAP_STD(1, ODS_RCVR_0, ODS_INTR_CPU),
    BINT_MAP_STD(1, ODS_RCVR_1,  ODS_INTR1_CPU),
    ...
    BINT_MAP_STD(2,LEAP, LEAP_HOST_L1_INTR_W0),
    BINT_MAP_LAST()
};

static const BINT_Settings bint_75525Settings =
{
    NULL,
    BINT_P_75525_ClearInt,
    BINT_P_75525_SetMask,
    BINT_P_75525_ClearMask,
    NULL,
    BINT_P_75525_ReadStatus,
    bint_75525,
    "75525"
};
...
const BINT_Settings *BINT_75525_GetSettings( void )
{
    return &bint_75525Settings;
}
