...
BDBG_MODULE(interruptinterface_7228);
...
static void BINT_P_7228_ClearInt( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static void BINT_P_7228_SetMask( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static void BINT_P_7228_ClearMask( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static uint32_t BINT_P_7228_ReadStatus( BREG_Handle regHandle, uint32_t baseAddr );
static uint32_t GetRaveIntEnableOffset( uint32_t BaseAddr );

static const BINT_P_IntMap bint_7228[] =
{
...
static const BINT_Settings bint_7228Settings =
{
	NULL,
	BINT_P_7228_ClearInt,
	BINT_P_7228_SetMask,
	BINT_P_7228_ClearMask,
	NULL,
	BINT_P_7228_ReadStatus,
	bint_7228,
	"7228"
};
