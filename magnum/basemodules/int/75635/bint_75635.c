...
#include "bchp_t2_bicm_intr2_0.h"
#include "bchp_t2_bicm_intr2_1.h"
#include "bchp_t2_intr.h"
#include "bchp_t2_intr_oi.h"
...
BDBG_MODULE(interruptinterface_75635);
...
static void BINT_P_75635_ClearInt( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static void BINT_P_75635_SetMask( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static void BINT_P_75635_ClearMask( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static uint32_t BINT_P_75635_ReadStatus( BREG_Handle regHandle, uint32_t baseAddr );
static uint32_t GetRaveIntEnableOffset( uint32_t BaseAddr );

static const BINT_P_IntMap bint_75635[] =
{
    ...
    /* SPARE_00_CPU_INTR to SPARE_02_CPU_INTRis not mapped */
    ...
    BINT_MAP_STD(1, T2_BICM_0, T2_BICM_INTR2_0_CPU),
    BINT_MAP_STD(1, T2_BICM_1, T2_BICM_INTR2_1_CPU),
    BINT_MAP_STD(1, T2_RCVR, T2_INTR_CPU),
    BINT_MAP_STD(1, T2_RCVR_OI, T2_INTR_OI_CPU),
    /* SPARE 0 to 8  is not mapped */
    BINT_MAP_STD(1, SYS, SUN_L2_CPU),
    BINT_MAP_STD(1, SYS_AON, AON_L2_CPU),
    /* BINT_MAP(1, SYS_PM, "" , AON_PM_L2_CPU_STATUS, STANDARD, NONE, 0), */
    ...
    BINT_MAP(2, XPT_MSG_STAT, "_ERR", XPT_MSG_DAT_ERR_INTR,       REGULAR, ALL, 0),
...
static const BINT_Settings bint_75635Settings =
{
    NULL,
    BINT_P_75635_ClearInt,
    BINT_P_75635_SetMask,
    BINT_P_75635_ClearMask,
    NULL,
    BINT_P_75635_ReadStatus,
    bint_75635,
    "75635"
};
...
static void BINT_P_75635_SetMask( BREG_Handle regHandle, uint32_t baseAddr, int shift )
{
    uint32_t intEnable, RaveEnReg = 0;
...
const BINT_Settings *BINT_75635_GetSettings( void )
{
    return &bint_75635Settings;
}
