...
BDBG_MODULE(interruptinterface_7250);
...
static void BINT_P_7250_ClearInt( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static void BINT_P_7250_SetMask( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static void BINT_P_7250_ClearMask( BREG_Handle regHandle, uint32_t baseAddr, int shift );

static uint32_t BINT_P_7250_ReadStatus( BREG_Handle regHandle, uint32_t baseAddr );

#if NEXUS_WEBCPU_core1_server
static const BINT_P_IntMap bint_7250[] =
{
...
/* in webcpu mode, core0 doesn't get M2MC1 L1 ??? */
    ...
    /* Power Management not set up yet for 7250 B0
...
#endif
    BINT_MAP(2, V3D, "_INT", V3D_CTL_INT_STS, REGULAR, NONE, 0),
...
static const BINT_Settings bint_7250Settings =
{
    NULL,
    BINT_P_7250_ClearInt,
    BINT_P_7250_SetMask,
    BINT_P_7250_ClearMask,
    NULL,
    BINT_P_7250_ReadStatus,
    bint_7250,
    "7250"
};
...
const BINT_Settings *BINT_7250_GetSettings( void )
{
    return &bint_7250Settings;
}
