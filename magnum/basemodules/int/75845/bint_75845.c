...
BDBG_MODULE(interruptinterface_75845);
...
static void BINT_P_75845_ClearInt( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static void BINT_P_75845_SetMask( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static void BINT_P_75845_ClearMask( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static uint32_t BINT_P_75845_ReadStatus( BREG_Handle regHandle, uint32_t baseAddr );
static uint32_t GetRaveIntEnableOffset( uint32_t BaseAddr );

static const BINT_P_IntMap bint_75845[] =
{
...
static const BINT_Settings bint_75845Settings =
{
    NULL,
    BINT_P_75845_ClearInt,
    BINT_P_75845_SetMask,
    BINT_P_75845_ClearMask,
    NULL,
    BINT_P_75845_ReadStatus,
    bint_75845,
    "75845"
};
...
const BINT_Settings *BINT_75845_GetSettings( void )
{
    return &bint_75845Settings;
}
