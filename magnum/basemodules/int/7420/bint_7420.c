...
#if(BCHP_VER >= BCHP_VER_B0)
    { BCHP_HIF_CPU_INTR1_INTR_W1_STATUS_XPT_PCR_CPU_INTR_SHIFT + 32,  		BCHP_XPT_DPCR4_INTR_STATUS_REG,        0,                   "XPT_DPCR4"},
    { BCHP_HIF_CPU_INTR1_INTR_W1_STATUS_XPT_PCR_CPU_INTR_SHIFT + 32,  		BCHP_XPT_DPCR5_INTR_STATUS_REG,        0,                   "XPT_DPCR5"},
    { BCHP_HIF_CPU_INTR1_INTR_W1_STATUS_XPT_PCR_CPU_INTR_SHIFT + 32,  		BCHP_XPT_DPCR6_INTR_STATUS_REG,        0,                   "XPT_DPCR6"},
    { BCHP_HIF_CPU_INTR1_INTR_W1_STATUS_XPT_PCR_CPU_INTR_SHIFT + 32,  		BCHP_XPT_DPCR7_INTR_STATUS_REG,        0,                   "XPT_DPCR7"},
#endif
