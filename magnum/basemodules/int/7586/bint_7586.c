...
#include "bchp_aif_wb_cab_core_intr2.h"
...
BDBG_MODULE(interruptinterface_7586);
...
static void BINT_P_7586_ClearInt( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static void BINT_P_7586_SetMask( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static void BINT_P_7586_ClearMask( BREG_Handle regHandle, uint32_t baseAddr, int shift );

static uint32_t BINT_P_7586_ReadStatus( BREG_Handle regHandle, uint32_t baseAddr );

#if NEXUS_WEBCPU_core1_server
static const BINT_P_IntMap bint_7586[] =
{
...
static const BINT_P_IntMap bint_7586[] =
{
    ...
    /*
    XPTSEC_0,       XPT_SECURITY_NS_INTR2_0_CPU
    XPTSEC_1,       XPT_SECURITY_NS_INTR2_1_CPU
    NMI_PIN,         POLARITY_ADJUST_PAD_NMI
    */
    ...
    /* DEMOD_XPT_FE, DEMOD_XPT_WAKEUP not mapped, refer to below xpt_fe part */
...
/* in webcpu mode, core0 doesn't get M2MC1 L1 ??? */
    ...
    /* MOCA, HIF, HIF_SPI, not mapped */

     /* new for 7586, disable it at first
    BINT_MAP_STD(1, IPI0, IPI0_INTR2_CPU),
    BINT_MAP_STD(1, IPI1, IPI1_INTR2_CPU),
    */
    /* SDIO*, WEBHIF_*, pcie, AVS_CPU_INTR is not mapped */
    ...
    /* !!!! TO ADD: Power Management not set up yet for 7586A0
    ...
    */
    ...
    /* upg uart, usb, sata,  upg mc, not mapped */
    ...
    /* DAT_RDY_INTR_128* ~ 224*, no such int reg in 7586 after checking rdb "XPT_MSG_BLOCKDEF", Feb. 13, 2015  */
    ...
    /* BUF_OVFL_INTR_128* ~ 224*, no such int reg in 7586 after checking rdb "XPT_MSG_BLOCKDEF", Feb. 13, 2015  */
    ...
    /*no reg of "XPT_DPCR6 - 13" in 7586 after checking rdb "PCR_TIMEBASE", Feb. 13, 2015  */
    ...
    /* no reg of "XPT_MDMA_MCPB" in 7586 after checking rdb "MEMDMA", Feb. 13, 2015 */
    ...
    BINT_MAP_STD(3, LEAP,AIF_WB_CAB_CORE_INTR2_CPU),
...
static const BINT_Settings bint_7586Settings =
{
    NULL,
    BINT_P_7586_ClearInt,
    BINT_P_7586_SetMask,
    BINT_P_7586_ClearMask,
    NULL,
    BINT_P_7586_ReadStatus,
    bint_7586,
    "7586"
};
