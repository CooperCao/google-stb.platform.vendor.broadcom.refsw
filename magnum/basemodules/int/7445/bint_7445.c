...
static const BINT_P_IntMap bint_7445[] =
{
  ...
  /* { BCHP_HIF_CPU_INTR1_INTR_W1_STATUS_SYS_PM_CPU_INTR_SHIFT + 32,         BCHP_AON_PM_L2_CPU_STATUS,             0,                   "SYS_PM"}, */
    ...
    BINT_MAP_STD(3, XPT_MSG, XPT_MSG_BUF_OVFL_CPU_INTR_AGGREGATOR_INTR_W2),
        BINT_MAP_L3(3, XPT_MSG, XPT_MSG_BUF_OVFL_CPU_INTR_AGGREGATOR_INTR_W2,MSG_BUF_OVFL_INTR_00_31, "", XPT_MSG_BUF_OVFL_INTR_00_31_L2_W8_CPU_STATUS, STANDARD, ALL, 0),
        BINT_MAP_L3(3, XPT_MSG, XPT_MSG_BUF_OVFL_CPU_INTR_AGGREGATOR_INTR_W2,MSG_BUF_OVFL_INTR_32_63, "", XPT_MSG_BUF_OVFL_INTR_32_63_L2_W9_CPU_STATUS, STANDARD, ALL, 0),
        BINT_MAP_L3(3, XPT_MSG, XPT_MSG_BUF_OVFL_CPU_INTR_AGGREGATOR_INTR_W2,MSG_BUF_OVFL_INTR_64_95, "", XPT_MSG_BUF_OVFL_INTR_64_95_L2_W10_CPU_STATUS, STANDARD, ALL, 0),
        BINT_MAP_L3(3, XPT_MSG, XPT_MSG_BUF_OVFL_CPU_INTR_AGGREGATOR_INTR_W2,MSG_BUF_OVFL_INTR_96_127, "", XPT_MSG_BUF_OVFL_INTR_96_127_L2_W11_CPU_STATUS, STANDARD, ALL, 0),
        BINT_MAP_L3(3, XPT_MSG, XPT_MSG_BUF_OVFL_CPU_INTR_AGGREGATOR_INTR_W2,MSG_BUF_OVFL_INTR_128_159, "", XPT_MSG_BUF_OVFL_INTR_128_159_L2_W12_CPU_STATUS, STANDARD, ALL, 0),
        BINT_MAP_L3(3, XPT_MSG, XPT_MSG_BUF_OVFL_CPU_INTR_AGGREGATOR_INTR_W2,MSG_BUF_OVFL_INTR_160_191, "", XPT_MSG_BUF_OVFL_INTR_160_191_L2_W13_CPU_STATUS, STANDARD, ALL, 0),
        BINT_MAP_L3(3, XPT_MSG, XPT_MSG_BUF_OVFL_CPU_INTR_AGGREGATOR_INTR_W2,MSG_BUF_OVFL_INTR_192_223, "", XPT_MSG_BUF_OVFL_INTR_192_223_L2_W14_CPU_STATUS, STANDARD, ALL, 0),
        BINT_MAP_L3(3, XPT_MSG, XPT_MSG_BUF_OVFL_CPU_INTR_AGGREGATOR_INTR_W2,MSG_BUF_OVFL_INTR_224_255, "", XPT_MSG_BUF_OVFL_INTR_224_255_L2_W15_CPU_STATUS, STANDARD, ALL, 0),
    ...
    BINT_MAP(2, UPG_MAIN, "", IRQ0_IRQEN, REGULAR, MASK, 0xFFFFFC00),
    ...
    BINT_MAP_STD(3, XPT_RAV, XPT_RAVE_CPU_INTR_AGGREGATOR_INTR_W0),
    ...
    BINT_MAP_STD(3, XPT_MDMA_MCPB, XPT_MEMDMA_MCPB_CPU_INTR_AGGREGATOR_INTR_W0),
    ...
    BINT_MAP_STD(3, XPT_MCPB, XPT_MCPB_CPU_INTR_AGGREGATOR_INTR_W0),
    ...
    BINT_MAP_STD(3, XPT_WMDMA, XPT_WDMA_CPU_INTR_AGGREGATOR_INTR_W0),
    ...
    BINT_MAP_STD(3, XPT_MSG, XPT_MSG_BUF_DAT_RDY_CPU_INTR_AGGREGATOR_INTR_W0),
