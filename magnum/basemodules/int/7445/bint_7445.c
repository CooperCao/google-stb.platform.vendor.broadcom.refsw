...
static const BINT_P_IntMap bint_7445[] =
{
  ...
  /* { BCHP_HIF_CPU_INTR1_INTR_W1_STATUS_SYS_PM_CPU_INTR_SHIFT + 32,         BCHP_AON_PM_L2_CPU_STATUS,             0,                   "SYS_PM"}, */
    ...
    BINT_MAP_STD(2, XPT_OVFL, XPT_MSG_BUF_OVFL_CPU_INTR_AGGREGATOR_INTR_W2),
   ...
   BINT_MAP_L3(3, XPT_RAV, XPT_RAVE_CPU_INTR_AGGREGATOR_INTR_W0, RAVE_LAST_CMD_INTR, "_CX00_31", XPT_RAVE_LAST_CMD_CX00_31_L2_INTR_CPU_STATUS_0_31, STANDARD, ALL, 0),
   BINT_MAP_L3(3, XPT_RAV, XPT_RAVE_CPU_INTR_AGGREGATOR_INTR_W0, RAVE_LAST_CMD_INTR, "_CX32_47", XPT_RAVE_LAST_CMD_CX32_47_L2_INTR_CPU_STATUS_32_47, STANDARD, ALL, 0),
