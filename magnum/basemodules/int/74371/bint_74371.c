...
/*  BINT_MAP_STD(1, SYS_PM, AON_PM_L2_CPU,  CHECK*/
    ...
    BINT_MAP(2, XPT_MSG_STAT, "_ERR", XPT_MSG_DAT_ERR_INTR_L2_CPU_STATUS,       REGULAR, ALL, 0),
    ...
    BINT_MAP(2, XPT_RAV, "DMA_END_CX32_47", XPT_RAVE_TSIO_DMA_END_CX32_47_L2_INTR_CPU_STATUS_32_47, STANDARD, ALL, 0),
    ...
    BINT_MAP_STD(3, XPT_MDMA_MCPB,  XPT_MEMDMA_MCPB_MISC_ASF_FATAL_ERR_INTR_L2_CPU),
    ...
    BINT_MAP_STD(3, XPT_MCPB, XPT_MCPB_MISC_ASF_FATAL_ERR_INTR_L2_CPU),
