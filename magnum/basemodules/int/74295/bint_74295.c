...
BDBG_MODULE(interruptinterface_74295);
...
static void BINT_P_74295_ClearInt( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static void BINT_P_74295_SetMask( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static void BINT_P_74295_ClearMask( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static uint32_t BINT_P_74295_ReadStatus( BREG_Handle regHandle, uint32_t baseAddr );
static uint32_t GetRaveIntEnableOffset( uint32_t BaseAddr );

static const BINT_P_IntMap bint_74295[] =
{
...
static const BINT_Settings bint_74295Settings =
{
    NULL,
    BINT_P_74295_ClearInt,
    BINT_P_74295_SetMask,
    BINT_P_74295_ClearMask,
    NULL,
    BINT_P_74295_ReadStatus,
    bint_74295,
    "74295"
};
