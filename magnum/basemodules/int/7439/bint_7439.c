...
BDBG_MODULE(interruptinterface_7439);
...
static void BINT_P_7439_ClearInt( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static void BINT_P_7439_SetMask( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static void BINT_P_7439_ClearMask( BREG_Handle regHandle, uint32_t baseAddr, int shift );

static uint32_t BINT_P_7439_ReadStatus( BREG_Handle regHandle, uint32_t baseAddr );
static uint32_t GetRaveIntEnableOffset( uint32_t BaseAddr );

#if NEXUS_WEBCPU_core1_server
static const BINT_P_IntMap bint_7439[] =
{
...
/*  BINT_MAP_STD(1, SYS_PM, AON_PM_L2_CPU,  CHECK*/
   ...
   BINT_MAP(2, UPG_SPI, "" , IRQ0_AON_IRQEN, REGULAR, MASK, 0xFFFFFF7F),
    ...
    BINT_MAP_STD( 3, XPT_MSG, XPT_MSG_BUF_DAT_RDY_INTR_00_31_L2_W0_CPU ),
    BINT_MAP_STD( 3, XPT_MSG, XPT_MSG_BUF_DAT_RDY_INTR_32_63_L2_W1_CPU ),
    BINT_MAP_STD( 3, XPT_MSG, XPT_MSG_BUF_DAT_RDY_INTR_64_95_L2_W2_CPU ),
    BINT_MAP_STD( 3, XPT_MSG, XPT_MSG_BUF_DAT_RDY_INTR_96_127_L2_W3_CPU ),
    BINT_MAP_STD( 3, XPT_MSG, XPT_MSG_BUF_DAT_RDY_INTR_128_159_L2_W4_CPU ),
    BINT_MAP_STD( 3, XPT_MSG, XPT_MSG_BUF_DAT_RDY_INTR_160_191_L2_W5_CPU ),
    BINT_MAP_STD( 3, XPT_MSG, XPT_MSG_BUF_DAT_RDY_INTR_192_223_L2_W6_CPU ),
    BINT_MAP_STD( 3, XPT_MSG, XPT_MSG_BUF_DAT_RDY_INTR_224_255_L2_W7_CPU ),

    BINT_MAP_STD( 3, XPT_OVFL, XPT_MSG_BUF_OVFL_INTR_00_31_L2_W8_CPU ),
    BINT_MAP_STD( 3, XPT_OVFL, XPT_MSG_BUF_OVFL_INTR_32_63_L2_W9_CPU ),
    BINT_MAP_STD( 3, XPT_OVFL, XPT_MSG_BUF_OVFL_INTR_64_95_L2_W10_CPU ),
    BINT_MAP_STD( 3, XPT_OVFL, XPT_MSG_BUF_OVFL_INTR_96_127_L2_W11_CPU ),
    BINT_MAP_STD( 3, XPT_OVFL, XPT_MSG_BUF_OVFL_INTR_128_159_L2_W12_CPU ),
    BINT_MAP_STD( 3, XPT_OVFL, XPT_MSG_BUF_OVFL_INTR_160_191_L2_W13_CPU ),
    BINT_MAP_STD( 3, XPT_OVFL, XPT_MSG_BUF_OVFL_INTR_192_223_L2_W14_CPU ),
    BINT_MAP_STD( 3, XPT_OVFL, XPT_MSG_BUF_OVFL_INTR_224_255_L2_W15_CPU ),
    ...
    BINT_MAP_STD(3, XPT_MDMA_MCPB, XPT_MEMDMA_MCPB_DESC_DONE_INTR_L2_CPU),
    BINT_MAP_STD(3, XPT_MDMA_MCPB, XPT_MEMDMA_MCPB_MISC_FALSE_WAKE_INTR_L2_CPU),
    BINT_MAP_STD(3, XPT_MDMA_MCPB,  XPT_MEMDMA_MCPB_MISC_OOS_INTR_L2_CPU),
    BINT_MAP_STD(3, XPT_MDMA_MCPB,  XPT_MEMDMA_MCPB_MISC_TS_PARITY_ERR_INTR_L2_CPU),
    BINT_MAP_STD(3, XPT_MDMA_MCPB,  XPT_MEMDMA_MCPB_MISC_TEI_INTR_L2_CPU),
    BINT_MAP_STD(3, XPT_MDMA_MCPB,  XPT_MEMDMA_MCPB_MISC_ASF_LEN_ERR_INTR_L2_CPU),
    BINT_MAP_STD(3, XPT_MDMA_MCPB,  XPT_MEMDMA_MCPB_MISC_ASF_COMPRESSED_DATA_RECEIVED_INTR_L2_CPU),
    BINT_MAP_STD(3, XPT_MDMA_MCPB,  XPT_MEMDMA_MCPB_MISC_ASF_PROTOCOL_ERR_INTR_L2_CPU),
    BINT_MAP_STD(3, XPT_MDMA_MCPB,  XPT_MEMDMA_MCPB_MISC_ASF_PADDING_LEN_ERR_INTR_L2_CPU),
    BINT_MAP_STD(3, XPT_MDMA_MCPB,  XPT_MEMDMA_MCPB_MISC_TS_RANGE_ERR_INTR_L2_CPU),
    BINT_MAP_STD(3, XPT_MDMA_MCPB,  XPT_MEMDMA_MCPB_MISC_PES_NEXT_TS_RANGE_ERR_INTR_L2_CPU),
    BINT_MAP_STD(3, XPT_MDMA_MCPB,  XPT_MEMDMA_MCPB_MISC_PAUSE_AT_DESC_READ_INTR_L2_CPU),
    BINT_MAP_STD(3, XPT_MDMA_MCPB,  XPT_MEMDMA_MCPB_MISC_PAUSE_AT_DESC_END_INTR_L2_CPU),
    BINT_MAP_STD(3, XPT_MDMA_MCPB,  XPT_MEMDMA_MCPB_MISC_PAUSE_AFTER_GROUP_PACKETS_INTR_L2_CPU),
    BINT_MAP_STD(3, XPT_MDMA_MCPB, XPT_MEMDMA_MCPB_MISC_DESC_TAGID_MISMATCH_INTR_L2_CPU),
    BINT_MAP_STD(3, XPT_MDMA_MCPB, XPT_MEMDMA_MCPB_MISC_DATA_TAGID_MISMATCH_INTR_L2_CPU),
    BINT_MAP_STD(3, XPT_MDMA_MCPB,  XPT_MEMDMA_MCPB_MISC_CRC_COMPARE_ERROR_INTR_L2_CPU),
    BINT_MAP_STD(3, XPT_MCPB,  XPT_MCPB_DESC_DONE_INTR_L2_CPU),
    BINT_MAP_STD(3, XPT_MCPB,  XPT_MCPB_MISC_FALSE_WAKE_INTR_L2_CPU),
    BINT_MAP_STD(3, XPT_MCPB,  XPT_MCPB_MISC_OOS_INTR_L2_CPU),
    BINT_MAP_STD(3, XPT_MCPB,  XPT_MCPB_MISC_TS_PARITY_ERR_INTR_L2_CPU),
    BINT_MAP_STD(3, XPT_MCPB,  XPT_MCPB_MISC_TEI_INTR_L2_CPU),
    BINT_MAP_STD(3, XPT_MCPB,  XPT_MCPB_MISC_ASF_LEN_ERR_INTR_L2_CPU),
    BINT_MAP_STD(3, XPT_MCPB,  XPT_MCPB_MISC_ASF_COMPRESSED_DATA_RECEIVED_INTR_L2_CPU),
    BINT_MAP_STD(3, XPT_MCPB,  XPT_MCPB_MISC_ASF_PROTOCOL_ERR_INTR_L2_CPU),
    BINT_MAP_STD(3, XPT_MCPB,  XPT_MCPB_MISC_ASF_PADDING_LEN_ERR_INTR_L2_CPU),
    BINT_MAP_STD(3, XPT_MCPB,  XPT_MCPB_MISC_TS_RANGE_ERR_INTR_L2_CPU),
    BINT_MAP_STD(3, XPT_MCPB,  XPT_MCPB_MISC_PES_NEXT_TS_RANGE_ERR_INTR_L2_CPU),
    BINT_MAP_STD(3, XPT_MCPB,  XPT_MCPB_MISC_PAUSE_AT_DESC_READ_INTR_L2_CPU),
    BINT_MAP_STD(3, XPT_MCPB,  XPT_MCPB_MISC_PAUSE_AT_DESC_END_INTR_L2_CPU),
    BINT_MAP_STD(3, XPT_MCPB,  XPT_MCPB_MISC_PAUSE_AFTER_GROUP_PACKETS_INTR_L2_CPU),
    BINT_MAP_STD(3, XPT_MCPB,  XPT_MCPB_MISC_DESC_TAGID_MISMATCH_INTR_L2_CPU),
    BINT_MAP_STD(3, XPT_MCPB,  XPT_MCPB_MISC_DATA_TAGID_MISMATCH_INTR_L2_CPU),
    BINT_MAP_STD(3, XPT_MCPB,  XPT_MCPB_MISC_CRC_COMPARE_ERROR_INTR_L2_CPU),
    BINT_MAP_STD(3, XPT_WMDMA,XPT_WDMA_BTP_INTR_L2_CPU),
    BINT_MAP_STD(3, XPT_WMDMA, XPT_WDMA_OVERFLOW_INTR_L2_CPU),
    BINT_MAP_STD(3, XPT_WMDMA, XPT_WDMA_DESC_DONE_INTR_L2_CPU),

    BINT_MAP_STD(3, XPT_EXTCARD, XPT_TSIO_INTR_L2_CPU),

    BINT_MAP(3, V3D, "_INT", V3D_CTL_INT_STS, REGULAR, NONE, 0),
...
static const BINT_Settings bint_7439Settings =
{
    NULL,
    BINT_P_7439_ClearInt,
    BINT_P_7439_SetMask,
    BINT_P_7439_ClearMask,
    NULL,
    BINT_P_7439_ReadStatus,
    bint_7439,
    "7439"
};
...
const BINT_Settings *BINT_7439_GetSettings( void )
{
    return &bint_7439Settings;
}
