...
static const BINT_P_IntMap bint_map[] =
{
    ...
    BINT_MAP_STD(3, XPT_MCPB,  XPT_MCPB_DESC_DONE_INTR_L2_HOST),
    BINT_MAP_STD(3, XPT_MCPB,  XPT_MCPB_MISC_FALSE_WAKE_INTR_L2_HOST),
    BINT_MAP_STD(3, XPT_MCPB,  XPT_MCPB_MISC_TEI_INTR_L2_HOST),
    BINT_MAP_STD(3, XPT_MCPB,  XPT_MCPB_MISC_TS_RANGE_ERR_INTR_L2_HOST),
