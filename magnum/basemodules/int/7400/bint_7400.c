...
static const BINT_P_IntMap bint_7400[] =
{
	...
	BINT_MAP_STD_SUFFIX_STR(0, AVD0, AVD_INTR2_0_CPU,0,"AVD_0"),
    BINT_MAP_STD_SUFFIX_STR(0, BVNF, BVNF_INTR2_5_R5F, 3, "BVNF_3"),
	BINT_MAP(0, UHF1, "" , UHFR_1_IMSK, REGULAR, ALL, 0),
    BINT_MAP(0, UHF2, "", UHFR_2_IMSK, REGULAR, ALL, 0),
	BINT_MAP(0, SUN, "" , SUN_L2_CPU_STATUS, STANDARD, MASK, 0xFFE00000),
	BINT_MAP(0, UPG, "" , IRQ0_IRQEN, REGULAR, MASK, 0xFFFFF800),
	BINT_MAP(0, UPG_BSC, "" , IRQ0_IRQEN, REGULAR, MASK, 0xE0FFFFFF),
	...
	BINT_MAP_STD_SUFFIX_STR(0, BVNF, BVNF_INTR2_2_R5F, 2, "BVNF_2"),
	...
	BINT_MAP(0, GFX, "" , MEMC16_GFX_L2_CPU_STATUS, STANDARD, MASK, 0xFFF9FFC0),
	...
	BINT_MAP_STD_SUFFIX_STR(1, AVD1, AVD_INTR2_1_CPU,1,"AVD_1"),
	BINT_MAP_STD_SUFFIX_STR(1, BVNF, BVNF_INTR2_6_R5F, 6, "BVNF_6"),
	BINT_MAP(1, PX3D, "", PX3D_L2_CPU_STATUS, STANDARD, ALL, 0),
...
static void BINT_P_7400_SetMask( BREG_Handle regHandle, uint32_t baseAddr, int shift )
{
	...
	default:
		...
		BDBG_ERR(("Unhandled interrupt base address %p",baseAddr));
		BDBG_ASSERT( false );
		break;
	}
}
