...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HDMI_TX_TMDS[] = {{
    BCHP_PWR_P_ResourceType_eNonLeaf,
    BCHP_PWR_RESOURCE_HDMI_TX_TMDS,
    "HDMI_TX_TMDS"
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HDMI_TX_CEC_HOTPLUG[] = {{
    BCHP_PWR_P_ResourceType_eNonLeaf,
    BCHP_PWR_RESOURCE_HDMI_TX_CEC_HOTPLUG,
    "HDMI_TX_CEC_HOTPLUG"
}};
...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_RAAGA_SRAM[] = {{
    BCHP_PWR_P_ResourceType_eLeaf,
    BCHP_PWR_HW_RAAGA_SRAM,
    "HW_RAAGA_SRAM"
}};
...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_HDMI_SRAM[] = {{
    BCHP_PWR_P_ResourceType_eLeaf,
    BCHP_PWR_HW_HDMI_SRAM,
    "HW_HDMI_SRAM"
}};
...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_RAAGA[] = {{
    BCHP_PWR_P_ResourceType_eNonLeafHw,
    BCHP_PWR_HW_RAAGA,
    "HW_RAAGA"
}};
...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_HDMI_TX_TMDS[] = {{
    BCHP_PWR_P_ResourceType_eNonLeafHw,
    BCHP_PWR_HW_HDMI_TX_TMDS,
    "HW_HDMI_TX_TMDS"
}};
...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_HDMI_TX_TMDS_CH[] = {{
    BCHP_PWR_P_ResourceType_eNonLeafHw,
    BCHP_PWR_HW_HDMI_TX_TMDS_CH,
    "HW_HDMI_TX_TMDS_CH"
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_HDMI_TX_CEC_HOTPLUG[] = {{
    BCHP_PWR_P_ResourceType_eNonLeafHw,
    BCHP_PWR_HW_HDMI_TX_CEC_HOTPLUG,
    "HW_HDMI_TX_CEC_HOTPLUG"
}};
...
const BCHP_PWR_P_Resource* const BCHP_PWR_P_ResourceList[BCHP_PWR_P_NUM_ALLNODES] = {
    ...
    BCHP_PWR_P_Resource_HDMI_TX_TMDS,
    BCHP_PWR_P_Resource_HDMI_TX_CEC_HOTPLUG,
    ...
    BCHP_PWR_P_Resource_HW_RAAGA,
    BCHP_PWR_P_Resource_HW_AUD_PLL0,
    BCHP_PWR_P_Resource_HW_AUD_PLL1,
    BCHP_PWR_P_Resource_HW_RAAGA_SRAM,
    BCHP_PWR_P_Resource_HW_HDMI_TX_TMDS,
    ...
    BCHP_PWR_P_Resource_HW_HDMI_TX_TMDS_CH,
    BCHP_PWR_P_Resource_HW_HDMI_SRAM,
    BCHP_PWR_P_Resource_HW_HDMI_TX_CEC_HOTPLUG,
...
static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HDMI_TX_TMDS[] = {
    BCHP_PWR_P_Resource_HW_HDMI_TX_TMDS,
    BCHP_PWR_P_Resource_HW_HDMI_TX_TMDS_CH,
    BCHP_PWR_P_Resource_HW_HDMI_SRAM,
    NULL
...
static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HDMI_TX_CEC_HOTPLUG[] = {
    BCHP_PWR_P_Resource_HW_HDMI_TX_CEC_HOTPLUG,
    BCHP_PWR_P_Resource_HW_HDMI_TX_TMDS_CH,
    NULL
};
...
static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_RAAGA[] = {
    BCHP_PWR_P_Resource_HW_PLL_AVD_CH2,
    NULL
};
...
static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_HDMI_TX_TMDS[] = {
    BCHP_PWR_P_Resource_HW_HDMI_TX_108M,
    BCHP_PWR_P_Resource_HW_BVN_108M,
    NULL
};
...
static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_HDMI_TX_TMDS_CH[] = {
    BCHP_PWR_P_Resource_HW_HDMI_TX_108M,
    BCHP_PWR_P_Resource_HW_BVN_108M,
    NULL
};

static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_HDMI_TX_CEC_HOTPLUG[] = {
    BCHP_PWR_P_Resource_HW_HDMI_TX_108M,
    BCHP_PWR_P_Resource_HW_BVN_108M,
    NULL
};
...
const BCHP_PWR_P_Resource* const * const BCHP_PWR_P_DependList[BCHP_PWR_P_NUM_ALLNODES] = {
    ...
    BCHP_PWR_P_Depend_HDMI_TX_TMDS,
    BCHP_PWR_P_Depend_HDMI_TX_CEC_HOTPLUG,
    ...
    BCHP_PWR_P_Depend_HW_RAAGA,
    BCHP_PWR_P_Depend_HW_AUD_PLL0,
    BCHP_PWR_P_Depend_HW_AUD_PLL1,
    NULL,
    BCHP_PWR_P_Depend_HW_HDMI_TX_TMDS,
    NULL,
    NULL,
    NULL,
    NULL,
    ...
    NULL,
    NULL,
    BCHP_PWR_P_Depend_HW_HDMI_TX_TMDS_CH,
    NULL,
    BCHP_PWR_P_Depend_HW_HDMI_TX_CEC_HOTPLUG,
    NULL,
...
void BCHP_PWR_P_HW_ControlId(BCHP_Handle handle, unsigned id, bool activate)
{
    switch(id) {
        ...
        case BCHP_PWR_HW_VEC_AIO:
            ...
            break;
        case BCHP_PWR_HW_RAAGA:
            BCHP_PWR_P_HW_RAAGA_Control(handle, activate);
            break;
        ...
        case BCHP_PWR_HW_AUD_PLL1:
            ...
            break;
        case BCHP_PWR_HW_RAAGA_SRAM:
            BCHP_PWR_P_HW_RAAGA_SRAM_Control(handle, activate);
            break;
        case BCHP_PWR_HW_HDMI_TX_TMDS:
            BCHP_PWR_P_HW_HDMI_TX_TMDS_Control(handle, activate);
            break;
        ...
        case BCHP_PWR_HW_XPT_SRAM:
            ...
            break;
        case BCHP_PWR_HW_HDMI_TX_TMDS_CH:
            BCHP_PWR_P_HW_HDMI_TX_TMDS_CH_Control(handle, activate);
            break;
        case BCHP_PWR_HW_HDMI_SRAM:
            BCHP_PWR_P_HW_HDMI_SRAM_Control(handle, activate);
            break;
        case BCHP_PWR_HW_HDMI_TX_CEC_HOTPLUG:
            BCHP_PWR_P_HW_HDMI_TX_CEC_HOTPLUG_Control(handle, activate);
            break;
