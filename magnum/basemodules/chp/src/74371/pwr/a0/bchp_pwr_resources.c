...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HDMI_TX1_CLK[] = {{
    BCHP_PWR_P_ResourceType_eNonLeaf,
    BCHP_PWR_RESOURCE_HDMI_TX1_CLK,
    BDBG_STRING("HDMI_TX1_CLK")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HDMI_TX_SRAM[] = {{
    BCHP_PWR_P_ResourceType_eNonLeaf,
    BCHP_PWR_RESOURCE_HDMI_TX_SRAM,
    BDBG_STRING("HDMI_TX_SRAM")
}};
...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_RAAGA0_AIO_SECBUS[] = {{
    BCHP_PWR_P_ResourceType_eLeaf,
    BCHP_PWR_HW_RAAGA0_AIO_SECBUS,
    BDBG_STRING("HW_RAAGA0_AIO_SECBUS")
}};
...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_HVD0_SID_SECBUS[] = {{
    BCHP_PWR_P_ResourceType_eLeaf,
    BCHP_PWR_HW_HVD0_SID_SECBUS,
    BDBG_STRING("HW_HVD0_SID_SECBUS")
}};
...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_BVN_DVPHR0_DVPHT0_DVPHT1_VEC[] = {{
    BCHP_PWR_P_ResourceType_eLeaf,
    BCHP_PWR_HW_BVN_DVPHR0_DVPHT0_DVPHT1_VEC,
    BDBG_STRING("HW_BVN_DVPHR0_DVPHT0_DVPHT1_VEC")
}};
...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_DVPHT0_DVPHT1[] = {{
    BCHP_PWR_P_ResourceType_eLeaf,
    BCHP_PWR_HW_DVPHT0_DVPHT1,
    BDBG_STRING("HW_DVPHT0_DVPHT1")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_DVPHT1[] = {{
    BCHP_PWR_P_ResourceType_eLeaf,
    BCHP_PWR_HW_DVPHT1,
    BDBG_STRING("HW_DVPHT1")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_DVPHT_SRAM[] = {{
    BCHP_PWR_P_ResourceType_eLeaf,
    BCHP_PWR_HW_DVPHT_SRAM,
    BDBG_STRING("HW_DVPHT_SRAM")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_HVD_LDO_PWRON_LDO_PWRON_PLL[] = {{
    BCHP_PWR_P_ResourceType_eLeaf,
    BCHP_PWR_HW_HVD_LDO_PWRON_LDO_PWRON_PLL,
    BDBG_STRING("HW_HVD_LDO_PWRON_LDO_PWRON_PLL")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_MOCA_CH_CTRL_CH_3_DIS_CH3[] = {{
    BCHP_PWR_P_ResourceType_eLeaf,
    BCHP_PWR_HW_MOCA_CH_CTRL_CH_3_DIS_CH3,
    BDBG_STRING("HW_MOCA_CH_CTRL_CH_3_DIS_CH3")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_MOCA_CH_CTRL_CH_4_DIS_CH4[] = {{
    BCHP_PWR_P_ResourceType_eLeaf,
    BCHP_PWR_HW_MOCA_CH_CTRL_CH_4_DIS_CH4,
    BDBG_STRING("HW_MOCA_CH_CTRL_CH_4_DIS_CH4")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_RAAGA_LDO_PWRON_LDO_PWRON_PLL[] = {{
    BCHP_PWR_P_ResourceType_eLeaf,
    BCHP_PWR_HW_RAAGA_LDO_PWRON_LDO_PWRON_PLL,
    BDBG_STRING("HW_RAAGA_LDO_PWRON_LDO_PWRON_PLL")
}};
...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_SC0_CH_CTRL_CH_0_DIS_CH0[] = {{
    BCHP_PWR_P_ResourceType_eLeaf,
    BCHP_PWR_HW_SC0_CH_CTRL_CH_0_DIS_CH0,
    BDBG_STRING("HW_SC0_CH_CTRL_CH_0_DIS_CH0")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_SC1_CH_CTRL_CH_0_DIS_CH0[] = {{
    BCHP_PWR_P_ResourceType_eLeaf,
    BCHP_PWR_HW_SC1_CH_CTRL_CH_0_DIS_CH0,
    BDBG_STRING("HW_SC1_CH_CTRL_CH_0_DIS_CH0")
}};
...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_XPT_CH_CTRL_CH_1_DIS_CH1[] = {{
    BCHP_PWR_P_ResourceType_eLeaf,
    BCHP_PWR_HW_XPT_CH_CTRL_CH_1_DIS_CH1,
    BDBG_STRING("HW_XPT_CH_CTRL_CH_1_DIS_CH1")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_XPT_CH_CTRL_CH_2_DIS_CH2[] = {{
    BCHP_PWR_P_ResourceType_eLeaf,
    BCHP_PWR_HW_XPT_CH_CTRL_CH_2_DIS_CH2,
    BDBG_STRING("HW_XPT_CH_CTRL_CH_2_DIS_CH2")
}};
...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_XPT_XPT_WAKEUP_SECBUS_XPT_REMUX[] = {{
    BCHP_PWR_P_ResourceType_eLeaf,
    BCHP_PWR_HW_XPT_XPT_WAKEUP_SECBUS_XPT_REMUX,
    BDBG_STRING("HW_XPT_XPT_WAKEUP_SECBUS_XPT_REMUX")
}};
...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_VICE20_SRAM[] = {{
    BCHP_PWR_P_ResourceType_eLeaf,
    BCHP_PWR_HW_VICE20_SRAM,
    BDBG_STRING("HW_VICE20_SRAM")
}};
...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_RAAGA_DSP_0_RAAGA_DSP[] = {{
    BCHP_PWR_P_ResourceType_eNonLeafHw,
    BCHP_PWR_HW_RAAGA_DSP_0_RAAGA_DSP,
    BDBG_STRING("HW_RAAGA_DSP_0_RAAGA_DSP")
}};
...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_HVD_SID0_HVD_CORE[] = {{
    BCHP_PWR_P_ResourceType_eNonLeafHw,
    BCHP_PWR_HW_HVD_SID0_HVD_CORE,
    BDBG_STRING("HW_HVD_SID0_HVD_CORE")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_HVD_SID0_HVD_CPU[] = {{
    BCHP_PWR_P_ResourceType_eNonLeafHw,
    BCHP_PWR_HW_HVD_SID0_HVD_CPU,
    BDBG_STRING("HW_HVD_SID0_HVD_CPU")
}};
...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_GRAPHICS_M2MC1_GFX_M2MC1[] = {{
    BCHP_PWR_P_ResourceType_eNonLeafHw,
    BCHP_PWR_HW_GRAPHICS_M2MC1_GFX_M2MC1,
    BDBG_STRING("HW_GRAPHICS_M2MC1_GFX_M2MC1")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_MOCA_CH_CTRL_CH_4_POST_DIV_HOLD_CH4[] = {{
    BCHP_PWR_P_ResourceType_eNonLeafHw,
    BCHP_PWR_HW_MOCA_CH_CTRL_CH_4_POST_DIV_HOLD_CH4,
    BDBG_STRING("HW_MOCA_CH_CTRL_CH_4_POST_DIV_HOLD_CH4")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_GRAPHICS_M2MC_GFX_54_M2MC[] = {{
    BCHP_PWR_P_ResourceType_eNonLeafHw,
    BCHP_PWR_HW_GRAPHICS_M2MC_GFX_54_M2MC,
    BDBG_STRING("HW_GRAPHICS_M2MC_GFX_54_M2MC")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_HVD_CH_CTRL_CH_0_DIS_CH0[] = {{
    BCHP_PWR_P_ResourceType_eNonLeafHw,
    BCHP_PWR_HW_HVD_CH_CTRL_CH_0_DIS_CH0,
    BDBG_STRING("HW_HVD_CH_CTRL_CH_0_DIS_CH0")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_HVD_RESET_RESETD[] = {{
    BCHP_PWR_P_ResourceType_eNonLeafHw,
    BCHP_PWR_HW_HVD_RESET_RESETD,
    BDBG_STRING("HW_HVD_RESET_RESETD")
}};
...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_HVD_CH_CTRL_CH_1_DIS_CH1[] = {{
    BCHP_PWR_P_ResourceType_eNonLeafHw,
    BCHP_PWR_HW_HVD_CH_CTRL_CH_1_DIS_CH1,
    BDBG_STRING("HW_HVD_CH_CTRL_CH_1_DIS_CH1")
}};
...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_HVD_PWRON_PWRON_PLL[] = {{
    BCHP_PWR_P_ResourceType_eNonLeafHw,
    BCHP_PWR_HW_HVD_PWRON_PWRON_PLL,
    BDBG_STRING("HW_HVD_PWRON_PWRON_PLL")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_HVD_RESET_RESETA[] = {{
    BCHP_PWR_P_ResourceType_eNonLeafHw,
    BCHP_PWR_HW_HVD_RESET_RESETA,
    BDBG_STRING("HW_HVD_RESET_RESETA")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_PM_LDO_POWERUP_ISO_HVD[] = {{
    BCHP_PWR_P_ResourceType_eNonLeafHw,
    BCHP_PWR_HW_PM_LDO_POWERUP_ISO_HVD,
    BDBG_STRING("HW_PM_LDO_POWERUP_ISO_HVD")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_MOCA_CH_CTRL_CH_3_POST_DIV_HOLD_CH3[] = {{
    BCHP_PWR_P_ResourceType_eNonLeafHw,
    BCHP_PWR_HW_MOCA_CH_CTRL_CH_3_POST_DIV_HOLD_CH3,
    BDBG_STRING("HW_MOCA_CH_CTRL_CH_3_POST_DIV_HOLD_CH3")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_PM_LDO_POWERUP_ISO_RAAGA[] = {{
    BCHP_PWR_P_ResourceType_eNonLeafHw,
    BCHP_PWR_HW_PM_LDO_POWERUP_ISO_RAAGA,
    BDBG_STRING("HW_PM_LDO_POWERUP_ISO_RAAGA")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_RAAGA_PWRON_PWRON_PLL[] = {{
    BCHP_PWR_P_ResourceType_eNonLeafHw,
    BCHP_PWR_HW_RAAGA_PWRON_PWRON_PLL,
    BDBG_STRING("HW_RAAGA_PWRON_PWRON_PLL")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_PM_LDO_POWERUP_ISO_VCXO0[] = {{
    BCHP_PWR_P_ResourceType_eNonLeafHw,
    BCHP_PWR_HW_PM_LDO_POWERUP_ISO_VCXO0,
    BDBG_STRING("HW_PM_LDO_POWERUP_ISO_VCXO0")
}};
...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_PM_LDO_POWERUP_ISO_VCXO1[] = {{
    BCHP_PWR_P_ResourceType_eNonLeafHw,
    BCHP_PWR_HW_PM_LDO_POWERUP_ISO_VCXO1,
    BDBG_STRING("HW_PM_LDO_POWERUP_ISO_VCXO1")
}};
...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_RAAGA_CH_CTRL_CH_0_DIS_CH0[] = {{
    BCHP_PWR_P_ResourceType_eNonLeafHw,
    BCHP_PWR_HW_RAAGA_CH_CTRL_CH_0_DIS_CH0,
    BDBG_STRING("HW_RAAGA_CH_CTRL_CH_0_DIS_CH0")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_RAAGA_RESET_RESETD[] = {{
    BCHP_PWR_P_ResourceType_eNonLeafHw,
    BCHP_PWR_HW_RAAGA_RESET_RESETD,
    BDBG_STRING("HW_RAAGA_RESET_RESETD")
}};
...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_RAAGA_CH_CTRL_CH_3_DIS_CH3[] = {{
    BCHP_PWR_P_ResourceType_eNonLeafHw,
    BCHP_PWR_HW_RAAGA_CH_CTRL_CH_3_DIS_CH3,
    BDBG_STRING("HW_RAAGA_CH_CTRL_CH_3_DIS_CH3")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_RAAGA_CH_CTRL_CH_3_POST_DIV_HOLD_CH3[] = {{
    BCHP_PWR_P_ResourceType_eNonLeafHw,
    BCHP_PWR_HW_RAAGA_CH_CTRL_CH_3_POST_DIV_HOLD_CH3,
    BDBG_STRING("HW_RAAGA_CH_CTRL_CH_3_POST_DIV_HOLD_CH3")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_RAAGA_RESET_RESETA[] = {{
    BCHP_PWR_P_ResourceType_eNonLeafHw,
    BCHP_PWR_HW_RAAGA_RESET_RESETA,
    BDBG_STRING("HW_RAAGA_RESET_RESETA")
}};
...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_VCXO0_CH_CTRL_CH_0_DIS_CH0[] = {{
    BCHP_PWR_P_ResourceType_eNonLeafHw,
    BCHP_PWR_HW_VCXO0_CH_CTRL_CH_0_DIS_CH0,
    BDBG_STRING("HW_VCXO0_CH_CTRL_CH_0_DIS_CH0")
}};
...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_VCXO0_CH_CTRL_CH_1_DIS_CH1[] = {{
    BCHP_PWR_P_ResourceType_eNonLeafHw,
    BCHP_PWR_HW_VCXO0_CH_CTRL_CH_1_DIS_CH1,
    BDBG_STRING("HW_VCXO0_CH_CTRL_CH_1_DIS_CH1")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_VCXO0_RESET_RESETA[] = {{
    BCHP_PWR_P_ResourceType_eNonLeafHw,
    BCHP_PWR_HW_VCXO0_RESET_RESETA,
    BDBG_STRING("HW_VCXO0_RESET_RESETA")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_VCXO1_CH_CTRL_CH_0_DIS_CH0[] = {{
    BCHP_PWR_P_ResourceType_eNonLeafHw,
    BCHP_PWR_HW_VCXO1_CH_CTRL_CH_0_DIS_CH0,
    BDBG_STRING("HW_VCXO1_CH_CTRL_CH_0_DIS_CH0")
}};
...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_VCXO1_CH_CTRL_CH_1_DIS_CH1[] = {{
    BCHP_PWR_P_ResourceType_eNonLeafHw,
    BCHP_PWR_HW_VCXO1_CH_CTRL_CH_1_DIS_CH1,
    BDBG_STRING("HW_VCXO1_CH_CTRL_CH_1_DIS_CH1")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_VCXO1_RESET_RESETA[] = {{
    BCHP_PWR_P_ResourceType_eNonLeafHw,
    BCHP_PWR_HW_VCXO1_RESET_RESETA,
    BDBG_STRING("HW_VCXO1_RESET_RESETA")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_VICE2_0_VICE2_0_CORE[] = {{
    BCHP_PWR_P_ResourceType_eNonLeafHw,
    BCHP_PWR_HW_VICE2_0_VICE2_0_CORE,
    BDBG_STRING("HW_VICE2_0_VICE2_0_CORE")
}};
...
const BCHP_PWR_P_Resource* const BCHP_PWR_P_ResourceList[BCHP_PWR_P_NUM_ALLNODES] = {
    ...
    BCHP_PWR_P_Resource_HDMI_TX1_CLK,
    BCHP_PWR_P_Resource_HDMI_TX_SRAM,
    ...
    BCHP_PWR_P_Resource_HW_RAAGA0_AIO_SECBUS,
    BCHP_PWR_P_Resource_HW_RAAGA_DSP_0_RAAGA_DSP,
    ...
    BCHP_PWR_P_Resource_HW_HVD0_SID_SECBUS,
    BCHP_PWR_P_Resource_HW_HVD_SID0_HVD_CORE,
    BCHP_PWR_P_Resource_HW_HVD_SID0_HVD_CPU,
    BCHP_PWR_P_Resource_HW_HVD0_SRAM,
    BCHP_PWR_P_Resource_HW_BVN,
    BCHP_PWR_P_Resource_HW_BVN_DVPHR0_DVPHT0_DVPHT1_VEC,
    ...
    BCHP_PWR_P_Resource_HW_DVPHT0_DVPHT1,
    BCHP_PWR_P_Resource_HW_HDMI_TX0_PHY,
    BCHP_PWR_P_Resource_HW_DVPHT1,
    BCHP_PWR_P_Resource_HW_DVPHT_SRAM,
    BCHP_PWR_P_Resource_HW_GRAPHICS_M2MC1_GFX_M2MC1,
    BCHP_PWR_P_Resource_HW_MOCA_CH_CTRL_CH_4_POST_DIV_HOLD_CH4,
    BCHP_PWR_P_Resource_HW_GRAPHICS_M2MC_GFX_54_M2MC,
    BCHP_PWR_P_Resource_HW_HVD_CH_CTRL_CH_0_DIS_CH0,
    BCHP_PWR_P_Resource_HW_HVD_RESET_RESETD,
    BCHP_PWR_P_Resource_HW_HVD_CH_CTRL_CH_0_POST_DIV_HOLD_CH0,
    BCHP_PWR_P_Resource_HW_HVD_CH_CTRL_CH_1_DIS_CH1,
    BCHP_PWR_P_Resource_HW_HVD_CH_CTRL_CH_1_POST_DIV_HOLD_CH1,
    BCHP_PWR_P_Resource_HW_HVD_PWRON_PWRON_PLL,
    BCHP_PWR_P_Resource_HW_HVD_LDO_PWRON_LDO_PWRON_PLL,
    BCHP_PWR_P_Resource_HW_HVD_RESET_RESETA,
    BCHP_PWR_P_Resource_HW_PM_LDO_POWERUP_ISO_HVD,
    BCHP_PWR_P_Resource_HW_MOCA_CH_CTRL_CH_3_POST_DIV_HOLD_CH3,
    BCHP_PWR_P_Resource_HW_MOCA_CH_CTRL_CH_3_DIS_CH3,
    BCHP_PWR_P_Resource_HW_MOCA_CH_CTRL_CH_4_DIS_CH4,
    BCHP_PWR_P_Resource_HW_PM_LDO_POWERUP_ISO_RAAGA,
    BCHP_PWR_P_Resource_HW_RAAGA_PWRON_PWRON_PLL,
    BCHP_PWR_P_Resource_HW_PM_LDO_POWERUP_ISO_VCXO0,
    BCHP_PWR_P_Resource_HW_VCXO0_PWRON_PWRON_PLL,
    BCHP_PWR_P_Resource_HW_PM_LDO_POWERUP_ISO_VCXO1,
    BCHP_PWR_P_Resource_HW_VCXO1_PWRON_PWRON_PLL,
    BCHP_PWR_P_Resource_HW_RAAGA_CH_CTRL_CH_0_DIS_CH0,
    BCHP_PWR_P_Resource_HW_RAAGA_RESET_RESETD,
    BCHP_PWR_P_Resource_HW_RAAGA_CH_CTRL_CH_0_POST_DIV_HOLD_CH0,
    BCHP_PWR_P_Resource_HW_RAAGA_CH_CTRL_CH_3_DIS_CH3,
    BCHP_PWR_P_Resource_HW_RAAGA_CH_CTRL_CH_3_POST_DIV_HOLD_CH3,
    BCHP_PWR_P_Resource_HW_RAAGA_LDO_PWRON_LDO_PWRON_PLL,
    BCHP_PWR_P_Resource_HW_RAAGA_RESET_RESETA,
    BCHP_PWR_P_Resource_HW_RFM_PHY,
    BCHP_PWR_P_Resource_HW_RFM,
    BCHP_PWR_P_Resource_HW_SC0_CH_CTRL_CH_0_POST_DIV_HOLD_CH0,
    BCHP_PWR_P_Resource_HW_SC0_CH_CTRL_CH_0_DIS_CH0,
    BCHP_PWR_P_Resource_HW_SC1_CH_CTRL_CH_0_POST_DIV_HOLD_CH0,
    BCHP_PWR_P_Resource_HW_SC1_CH_CTRL_CH_0_DIS_CH0,
    BCHP_PWR_P_Resource_HW_VCXO0_CH_CTRL_CH_0_DIS_CH0,
    BCHP_PWR_P_Resource_HW_VCXO0_RESET_RESETD,
    BCHP_PWR_P_Resource_HW_VCXO0_CH_CTRL_CH_0_POST_DIV_HOLD_CH0,
    BCHP_PWR_P_Resource_HW_VCXO0_CH_CTRL_CH_1_DIS_CH1,
    BCHP_PWR_P_Resource_HW_VCXO0_LDO_PWRON_LDO_PWRON_PLL,
    BCHP_PWR_P_Resource_HW_VCXO0_RESET_RESETA,
    BCHP_PWR_P_Resource_HW_VCXO1_CH_CTRL_CH_0_DIS_CH0,
    BCHP_PWR_P_Resource_HW_VCXO1_RESET_RESETD,
    BCHP_PWR_P_Resource_HW_VCXO1_CH_CTRL_CH_0_POST_DIV_HOLD_CH0,
    BCHP_PWR_P_Resource_HW_VCXO1_CH_CTRL_CH_1_DIS_CH1,
    BCHP_PWR_P_Resource_HW_VCXO1_LDO_PWRON_LDO_PWRON_PLL,
    BCHP_PWR_P_Resource_HW_VCXO1_RESET_RESETA,
    BCHP_PWR_P_Resource_HW_VICE2_0_VICE2_0_CORE,
    BCHP_PWR_P_Resource_HW_XPT_CH_CTRL_CH_1_POST_DIV_HOLD_CH1,
    BCHP_PWR_P_Resource_HW_XPT_CH_CTRL_CH_1_DIS_CH1,
    BCHP_PWR_P_Resource_HW_XPT_CH_CTRL_CH_2_POST_DIV_HOLD_CH2,
    BCHP_PWR_P_Resource_HW_XPT_CH_CTRL_CH_2_DIS_CH2,
    ...
    BCHP_PWR_P_Resource_HW_XPT_XPT_WAKEUP_SECBUS_XPT_REMUX,
    ...
    BCHP_PWR_P_Resource_HW_VICE20_SRAM,
...
static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HDMI_TX1_CLK[] = {
    BCHP_PWR_P_Resource_HW_BVN_DVPHR0_DVPHT0_DVPHT1_VEC,
    BCHP_PWR_P_Resource_HW_DVPHT0_DVPHT1,
    BCHP_PWR_P_Resource_HW_DVPHT1,
    NULL
...
static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HDMI_TX_SRAM[] = {
    BCHP_PWR_P_Resource_HW_DVPHT_SRAM,
    NULL
};
...
static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_RAAGA_DSP_0_RAAGA_DSP[] = {
    BCHP_PWR_P_Resource_HW_RAAGA_CH_CTRL_CH_0_POST_DIV_HOLD_CH0,
    NULL
};
...
static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_HVD_SID0_HVD_CORE[] = {
    BCHP_PWR_P_Resource_HW_HVD_CH_CTRL_CH_0_POST_DIV_HOLD_CH0,
    NULL
};

static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_HVD_SID0_HVD_CPU[] = {
    BCHP_PWR_P_Resource_HW_HVD_CH_CTRL_CH_1_POST_DIV_HOLD_CH1,
    NULL
};
...
static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_GRAPHICS_M2MC1_GFX_M2MC1[] = {
    BCHP_PWR_P_Resource_HW_MOCA_CH_CTRL_CH_4_POST_DIV_HOLD_CH4,
    NULL
};

static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_MOCA_CH_CTRL_CH_4_POST_DIV_HOLD_CH4[] = {
    BCHP_PWR_P_Resource_HW_MOCA_CH_CTRL_CH_4_DIS_CH4,
    NULL
};

static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_GRAPHICS_M2MC_GFX_54_M2MC[] = {
    BCHP_PWR_P_Resource_HW_MOCA_CH_CTRL_CH_4_POST_DIV_HOLD_CH4,
    NULL
};

static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_HVD_CH_CTRL_CH_0_DIS_CH0[] = {
    BCHP_PWR_P_Resource_HW_HVD_RESET_RESETD,
    NULL
};

static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_HVD_RESET_RESETD[] = {
    BCHP_PWR_P_Resource_HW_HVD_RESET_RESETA,
    NULL
};
...
static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_HVD_CH_CTRL_CH_1_DIS_CH1[] = {
    BCHP_PWR_P_Resource_HW_HVD_RESET_RESETD,
    NULL
};
...
static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_HVD_PWRON_PWRON_PLL[] = {
    BCHP_PWR_P_Resource_HW_HVD_LDO_PWRON_LDO_PWRON_PLL,
    NULL
};

static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_HVD_RESET_RESETA[] = {
    BCHP_PWR_P_Resource_HW_PM_LDO_POWERUP_ISO_HVD,
    NULL
};

static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_PM_LDO_POWERUP_ISO_HVD[] = {
    BCHP_PWR_P_Resource_HW_HVD_PWRON_PWRON_PLL,
    NULL
};

static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_MOCA_CH_CTRL_CH_3_POST_DIV_HOLD_CH3[] = {
    BCHP_PWR_P_Resource_HW_MOCA_CH_CTRL_CH_3_DIS_CH3,
    NULL
};

static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_PM_LDO_POWERUP_ISO_RAAGA[] = {
    BCHP_PWR_P_Resource_HW_RAAGA_PWRON_PWRON_PLL,
    NULL
};

static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_RAAGA_PWRON_PWRON_PLL[] = {
    BCHP_PWR_P_Resource_HW_RAAGA_LDO_PWRON_LDO_PWRON_PLL,
    NULL
};

static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_PM_LDO_POWERUP_ISO_VCXO0[] = {
    BCHP_PWR_P_Resource_HW_VCXO0_PWRON_PWRON_PLL,
    NULL
};
...
static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_PM_LDO_POWERUP_ISO_VCXO1[] = {
    BCHP_PWR_P_Resource_HW_VCXO1_PWRON_PWRON_PLL,
    NULL
};
...
static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_RAAGA_CH_CTRL_CH_0_DIS_CH0[] = {
    BCHP_PWR_P_Resource_HW_RAAGA_RESET_RESETD,
    NULL
};

static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_RAAGA_RESET_RESETD[] = {
    BCHP_PWR_P_Resource_HW_RAAGA_RESET_RESETA,
    NULL
};
...
static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_RAAGA_CH_CTRL_CH_3_DIS_CH3[] = {
    BCHP_PWR_P_Resource_HW_RAAGA_RESET_RESETD,
    NULL
};

static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_RAAGA_CH_CTRL_CH_3_POST_DIV_HOLD_CH3[] = {
    BCHP_PWR_P_Resource_HW_RAAGA_CH_CTRL_CH_3_DIS_CH3,
    NULL
};

static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_RAAGA_RESET_RESETA[] = {
    BCHP_PWR_P_Resource_HW_PM_LDO_POWERUP_ISO_RAAGA,
    NULL
};
...
static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_VCXO0_CH_CTRL_CH_0_DIS_CH0[] = {
    BCHP_PWR_P_Resource_HW_VCXO0_RESET_RESETD,
    NULL
};
...
static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_VCXO0_CH_CTRL_CH_1_DIS_CH1[] = {
    BCHP_PWR_P_Resource_HW_VCXO0_RESET_RESETD,
    NULL
};

static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_VCXO0_RESET_RESETA[] = {
    BCHP_PWR_P_Resource_HW_PM_LDO_POWERUP_ISO_VCXO0,
    NULL
};

static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_VCXO1_CH_CTRL_CH_0_DIS_CH0[] = {
    BCHP_PWR_P_Resource_HW_VCXO1_RESET_RESETD,
    NULL
};
...
static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_VCXO1_CH_CTRL_CH_1_DIS_CH1[] = {
    BCHP_PWR_P_Resource_HW_VCXO1_RESET_RESETD,
    NULL
};

static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_VCXO1_RESET_RESETA[] = {
    BCHP_PWR_P_Resource_HW_PM_LDO_POWERUP_ISO_VCXO1,
    NULL
};

static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_VICE2_0_VICE2_0_CORE[] = {
    BCHP_PWR_P_Resource_HW_RAAGA_CH_CTRL_CH_3_POST_DIV_HOLD_CH3,
    NULL
};
...
const BCHP_PWR_P_Resource* const * const BCHP_PWR_P_DependList[BCHP_PWR_P_NUM_ALLNODES] = {
    ...
    BCHP_PWR_P_Depend_HDMI_TX1_CLK,
    BCHP_PWR_P_Depend_HDMI_TX_SRAM,
    ...
    NULL,
    NULL,
    BCHP_PWR_P_Depend_HW_RAAGA_DSP_0_RAAGA_DSP,
    ...
    NULL,
    NULL,
    BCHP_PWR_P_Depend_HW_HVD_SID0_HVD_CORE,
    BCHP_PWR_P_Depend_HW_HVD_SID0_HVD_CPU,
    NULL,
    NULL,
    NULL,
    NULL,
    ...
    NULL,
    NULL,
    BCHP_PWR_P_Depend_HW_GRAPHICS_M2MC1_GFX_M2MC1,
    BCHP_PWR_P_Depend_HW_MOCA_CH_CTRL_CH_4_POST_DIV_HOLD_CH4,
    BCHP_PWR_P_Depend_HW_GRAPHICS_M2MC_GFX_54_M2MC,
    BCHP_PWR_P_Depend_HW_HVD_CH_CTRL_CH_0_DIS_CH0,
    BCHP_PWR_P_Depend_HW_HVD_RESET_RESETD,
    BCHP_PWR_P_Depend_HW_HVD_CH_CTRL_CH_0_POST_DIV_HOLD_CH0,
    BCHP_PWR_P_Depend_HW_HVD_CH_CTRL_CH_1_DIS_CH1,
    BCHP_PWR_P_Depend_HW_HVD_CH_CTRL_CH_1_POST_DIV_HOLD_CH1,
    BCHP_PWR_P_Depend_HW_HVD_PWRON_PWRON_PLL,
    NULL,
    BCHP_PWR_P_Depend_HW_HVD_RESET_RESETA,
    BCHP_PWR_P_Depend_HW_PM_LDO_POWERUP_ISO_HVD,
    BCHP_PWR_P_Depend_HW_MOCA_CH_CTRL_CH_3_POST_DIV_HOLD_CH3,
    NULL,
    NULL,
    BCHP_PWR_P_Depend_HW_PM_LDO_POWERUP_ISO_RAAGA,
    BCHP_PWR_P_Depend_HW_RAAGA_PWRON_PWRON_PLL,
    BCHP_PWR_P_Depend_HW_PM_LDO_POWERUP_ISO_VCXO0,
    BCHP_PWR_P_Depend_HW_VCXO0_PWRON_PWRON_PLL,
    BCHP_PWR_P_Depend_HW_PM_LDO_POWERUP_ISO_VCXO1,
    BCHP_PWR_P_Depend_HW_VCXO1_PWRON_PWRON_PLL,
    BCHP_PWR_P_Depend_HW_RAAGA_CH_CTRL_CH_0_DIS_CH0,
    BCHP_PWR_P_Depend_HW_RAAGA_RESET_RESETD,
    BCHP_PWR_P_Depend_HW_RAAGA_CH_CTRL_CH_0_POST_DIV_HOLD_CH0,
    BCHP_PWR_P_Depend_HW_RAAGA_CH_CTRL_CH_3_DIS_CH3,
    BCHP_PWR_P_Depend_HW_RAAGA_CH_CTRL_CH_3_POST_DIV_HOLD_CH3,
    NULL,
    BCHP_PWR_P_Depend_HW_RAAGA_RESET_RESETA,
    ...
    NULL,
    BCHP_PWR_P_Depend_HW_VCXO0_CH_CTRL_CH_0_DIS_CH0,
    BCHP_PWR_P_Depend_HW_VCXO0_RESET_RESETD,
    BCHP_PWR_P_Depend_HW_VCXO0_CH_CTRL_CH_0_POST_DIV_HOLD_CH0,
    BCHP_PWR_P_Depend_HW_VCXO0_CH_CTRL_CH_1_DIS_CH1,
    NULL,
    BCHP_PWR_P_Depend_HW_VCXO0_RESET_RESETA,
    BCHP_PWR_P_Depend_HW_VCXO1_CH_CTRL_CH_0_DIS_CH0,
    BCHP_PWR_P_Depend_HW_VCXO1_RESET_RESETD,
    BCHP_PWR_P_Depend_HW_VCXO1_CH_CTRL_CH_0_POST_DIV_HOLD_CH0,
    BCHP_PWR_P_Depend_HW_VCXO1_CH_CTRL_CH_1_DIS_CH1,
    NULL,
    BCHP_PWR_P_Depend_HW_VCXO1_RESET_RESETA,
    BCHP_PWR_P_Depend_HW_VICE2_0_VICE2_0_CORE,
...
void BCHP_PWR_P_HW_ControlId(BCHP_Handle handle, unsigned id, bool activate)
{
    switch(id) {
        ...
        case BCHP_PWR_HW_RAAGA0_AIO:
            ...
            break;
        case BCHP_PWR_HW_RAAGA0_AIO_SECBUS:
            BCHP_PWR_P_HW_RAAGA0_AIO_SECBUS_Control(handle, activate);
            break;
        case BCHP_PWR_HW_RAAGA_DSP_0_RAAGA_DSP:
            BCHP_PWR_P_HW_RAAGA_DSP_0_RAAGA_DSP_Control(handle, activate);
            break;
        ...
        case BCHP_PWR_HW_HVD0_SID:
            ...
            break;
        case BCHP_PWR_HW_HVD0_SID_SECBUS:
            BCHP_PWR_P_HW_HVD0_SID_SECBUS_Control(handle, activate);
            break;
        case BCHP_PWR_HW_HVD_SID0_HVD_CORE:
            BCHP_PWR_P_HW_HVD_SID0_HVD_CORE_Control(handle, activate);
            break;
        case BCHP_PWR_HW_HVD_SID0_HVD_CPU:
            BCHP_PWR_P_HW_HVD_SID0_HVD_CPU_Control(handle, activate);
            break;
        ...
        case BCHP_PWR_HW_BVN:
            ...
            break;
        case BCHP_PWR_HW_BVN_DVPHR0_DVPHT0_DVPHT1_VEC:
            BCHP_PWR_P_HW_BVN_DVPHR0_DVPHT0_DVPHT1_VEC_Control(handle, activate);
            break;
        ...
        case BCHP_PWR_HW_DVPHT0:
            ...
            break;
        case BCHP_PWR_HW_DVPHT0_DVPHT1:
            BCHP_PWR_P_HW_DVPHT0_DVPHT1_Control(handle, activate);
            break;
        case BCHP_PWR_HW_HDMI_TX0_PHY:
            BCHP_PWR_P_HW_HDMI_TX0_PHY_Control(handle, activate);
            break;
        case BCHP_PWR_HW_DVPHT1:
            BCHP_PWR_P_HW_DVPHT1_Control(handle, activate);
            break;
        case BCHP_PWR_HW_DVPHT_SRAM:
            BCHP_PWR_P_HW_DVPHT_SRAM_Control(handle, activate);
            break;
        case BCHP_PWR_HW_GRAPHICS_M2MC1_GFX_M2MC1:
            BCHP_PWR_P_HW_GRAPHICS_M2MC1_GFX_M2MC1_Control(handle, activate);
            break;
        case BCHP_PWR_HW_MOCA_CH_CTRL_CH_4_POST_DIV_HOLD_CH4:
            BCHP_PWR_P_HW_MOCA_CH_CTRL_CH_4_POST_DIV_HOLD_CH4_Control(handle, activate);
            break;
        case BCHP_PWR_HW_GRAPHICS_M2MC_GFX_54_M2MC:
            BCHP_PWR_P_HW_GRAPHICS_M2MC_GFX_54_M2MC_Control(handle, activate);
            break;
        case BCHP_PWR_HW_HVD_CH_CTRL_CH_0_DIS_CH0:
            BCHP_PWR_P_HW_HVD_CH_CTRL_CH_0_DIS_CH0_Control(handle, activate);
            break;
        case BCHP_PWR_HW_HVD_RESET_RESETD:
            BCHP_PWR_P_HW_HVD_RESET_RESETD_Control(handle, activate);
            break;
        case BCHP_PWR_HW_HVD_CH_CTRL_CH_0_POST_DIV_HOLD_CH0:
            ...
            break;
        case BCHP_PWR_HW_HVD_CH_CTRL_CH_1_DIS_CH1:
            BCHP_PWR_P_HW_HVD_CH_CTRL_CH_1_DIS_CH1_Control(handle, activate);
            break;
        case BCHP_PWR_HW_HVD_CH_CTRL_CH_1_POST_DIV_HOLD_CH1:
            ...
            break;
        case BCHP_PWR_HW_HVD_PWRON_PWRON_PLL:
            BCHP_PWR_P_HW_HVD_PWRON_PWRON_PLL_Control(handle, activate);
            break;
        case BCHP_PWR_HW_HVD_LDO_PWRON_LDO_PWRON_PLL:
            BCHP_PWR_P_HW_HVD_LDO_PWRON_LDO_PWRON_PLL_Control(handle, activate);
            break;
        case BCHP_PWR_HW_HVD_RESET_RESETA:
            BCHP_PWR_P_HW_HVD_RESET_RESETA_Control(handle, activate);
            break;
        case BCHP_PWR_HW_PM_LDO_POWERUP_ISO_HVD:
            BCHP_PWR_P_HW_PM_LDO_POWERUP_ISO_HVD_Control(handle, activate);
            break;
        case BCHP_PWR_HW_MOCA_CH_CTRL_CH_3_POST_DIV_HOLD_CH3:
            BCHP_PWR_P_HW_MOCA_CH_CTRL_CH_3_POST_DIV_HOLD_CH3_Control(handle, activate);
            break;
        case BCHP_PWR_HW_MOCA_CH_CTRL_CH_3_DIS_CH3:
            BCHP_PWR_P_HW_MOCA_CH_CTRL_CH_3_DIS_CH3_Control(handle, activate);
            break;
        case BCHP_PWR_HW_MOCA_CH_CTRL_CH_4_DIS_CH4:
            BCHP_PWR_P_HW_MOCA_CH_CTRL_CH_4_DIS_CH4_Control(handle, activate);
            break;
        case BCHP_PWR_HW_PM_LDO_POWERUP_ISO_RAAGA:
            BCHP_PWR_P_HW_PM_LDO_POWERUP_ISO_RAAGA_Control(handle, activate);
            break;
        case BCHP_PWR_HW_RAAGA_PWRON_PWRON_PLL:
            BCHP_PWR_P_HW_RAAGA_PWRON_PWRON_PLL_Control(handle, activate);
            break;
        case BCHP_PWR_HW_PM_LDO_POWERUP_ISO_VCXO0:
            BCHP_PWR_P_HW_PM_LDO_POWERUP_ISO_VCXO0_Control(handle, activate);
            break;
        case BCHP_PWR_HW_VCXO0_PWRON_PWRON_PLL:
            BCHP_PWR_P_HW_VCXO0_PWRON_PWRON_PLL_Control(handle, activate);
            break;
        case BCHP_PWR_HW_PM_LDO_POWERUP_ISO_VCXO1:
            BCHP_PWR_P_HW_PM_LDO_POWERUP_ISO_VCXO1_Control(handle, activate);
            break;
        case BCHP_PWR_HW_VCXO1_PWRON_PWRON_PLL:
            BCHP_PWR_P_HW_VCXO1_PWRON_PWRON_PLL_Control(handle, activate);
            break;
        case BCHP_PWR_HW_RAAGA_CH_CTRL_CH_0_DIS_CH0:
            BCHP_PWR_P_HW_RAAGA_CH_CTRL_CH_0_DIS_CH0_Control(handle, activate);
            break;
        case BCHP_PWR_HW_RAAGA_RESET_RESETD:
            BCHP_PWR_P_HW_RAAGA_RESET_RESETD_Control(handle, activate);
            break;
        case BCHP_PWR_HW_RAAGA_CH_CTRL_CH_0_POST_DIV_HOLD_CH0:
            ...
            break;
        case BCHP_PWR_HW_RAAGA_CH_CTRL_CH_3_DIS_CH3:
            BCHP_PWR_P_HW_RAAGA_CH_CTRL_CH_3_DIS_CH3_Control(handle, activate);
            break;
        case BCHP_PWR_HW_RAAGA_CH_CTRL_CH_3_POST_DIV_HOLD_CH3:
            BCHP_PWR_P_HW_RAAGA_CH_CTRL_CH_3_POST_DIV_HOLD_CH3_Control(handle, activate);
            break;
        case BCHP_PWR_HW_RAAGA_LDO_PWRON_LDO_PWRON_PLL:
            BCHP_PWR_P_HW_RAAGA_LDO_PWRON_LDO_PWRON_PLL_Control(handle, activate);
            break;
        case BCHP_PWR_HW_RAAGA_RESET_RESETA:
            BCHP_PWR_P_HW_RAAGA_RESET_RESETA_Control(handle, activate);
            break;
        ...
        case BCHP_PWR_HW_SC0_CH_CTRL_CH_0_POST_DIV_HOLD_CH0:
            ...
            break;
        case BCHP_PWR_HW_SC0_CH_CTRL_CH_0_DIS_CH0:
            BCHP_PWR_P_HW_SC0_CH_CTRL_CH_0_DIS_CH0_Control(handle, activate);
            break;
        case BCHP_PWR_HW_SC1_CH_CTRL_CH_0_POST_DIV_HOLD_CH0:
            ...
            break;
        case BCHP_PWR_HW_SC1_CH_CTRL_CH_0_DIS_CH0:
            BCHP_PWR_P_HW_SC1_CH_CTRL_CH_0_DIS_CH0_Control(handle, activate);
            break;
        case BCHP_PWR_HW_VCXO0_CH_CTRL_CH_0_DIS_CH0:
            BCHP_PWR_P_HW_VCXO0_CH_CTRL_CH_0_DIS_CH0_Control(handle, activate);
            break;
        ...
        case BCHP_PWR_HW_VCXO0_CH_CTRL_CH_0_POST_DIV_HOLD_CH0:
            ...
            break;
        case BCHP_PWR_HW_VCXO0_CH_CTRL_CH_1_DIS_CH1:
            BCHP_PWR_P_HW_VCXO0_CH_CTRL_CH_1_DIS_CH1_Control(handle, activate);
            break;
        case BCHP_PWR_HW_VCXO0_LDO_PWRON_LDO_PWRON_PLL:
            BCHP_PWR_P_HW_VCXO0_LDO_PWRON_LDO_PWRON_PLL_Control(handle, activate);
            break;
        case BCHP_PWR_HW_VCXO0_RESET_RESETA:
            BCHP_PWR_P_HW_VCXO0_RESET_RESETA_Control(handle, activate);
            break;
        case BCHP_PWR_HW_VCXO1_CH_CTRL_CH_0_DIS_CH0:
            BCHP_PWR_P_HW_VCXO1_CH_CTRL_CH_0_DIS_CH0_Control(handle, activate);
            break;
        ...
        case BCHP_PWR_HW_VCXO1_CH_CTRL_CH_0_POST_DIV_HOLD_CH0:
            ...
            break;
        case BCHP_PWR_HW_VCXO1_CH_CTRL_CH_1_DIS_CH1:
            BCHP_PWR_P_HW_VCXO1_CH_CTRL_CH_1_DIS_CH1_Control(handle, activate);
            break;
        case BCHP_PWR_HW_VCXO1_LDO_PWRON_LDO_PWRON_PLL:
            BCHP_PWR_P_HW_VCXO1_LDO_PWRON_LDO_PWRON_PLL_Control(handle, activate);
            break;
        case BCHP_PWR_HW_VCXO1_RESET_RESETA:
            BCHP_PWR_P_HW_VCXO1_RESET_RESETA_Control(handle, activate);
            break;
        case BCHP_PWR_HW_VICE2_0_VICE2_0_CORE:
            BCHP_PWR_P_HW_VICE2_0_VICE2_0_CORE_Control(handle, activate);
            break;
        case BCHP_PWR_HW_XPT_CH_CTRL_CH_1_POST_DIV_HOLD_CH1:
            ...
            break;
        case BCHP_PWR_HW_XPT_CH_CTRL_CH_1_DIS_CH1:
            BCHP_PWR_P_HW_XPT_CH_CTRL_CH_1_DIS_CH1_Control(handle, activate);
            break;
        case BCHP_PWR_HW_XPT_CH_CTRL_CH_2_POST_DIV_HOLD_CH2:
            ...
            break;
        case BCHP_PWR_HW_XPT_CH_CTRL_CH_2_DIS_CH2:
            BCHP_PWR_P_HW_XPT_CH_CTRL_CH_2_DIS_CH2_Control(handle, activate);
            break;
        ...
        case BCHP_PWR_HW_XPT_SECBUS_XPT_REMUX:
            ...
            break;
        case BCHP_PWR_HW_XPT_XPT_WAKEUP_SECBUS_XPT_REMUX:
            BCHP_PWR_P_HW_XPT_XPT_WAKEUP_SECBUS_XPT_REMUX_Control(handle, activate);
            break;
        ...
        case BCHP_PWR_HW_VICE20:
            ...
            break;
        case BCHP_PWR_HW_VICE20_SRAM:
            BCHP_PWR_P_HW_VICE20_SRAM_Control(handle, activate);
            break;
