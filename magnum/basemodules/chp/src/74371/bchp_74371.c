    ...
    ( const BCHP_Handle                hChip )
{
    ...
    BREG_Write32(hRegister, BCHP_SUN_TOP_CTRL_SW_INIT_0_CLEAR,
         ...
         BCHP_FIELD_DATA( SUN_TOP_CTRL_SW_INIT_0_CLEAR, dvp_ht0_sw_init, 1));
    ...
    ulRegVal |= BCHP_FIELD_DATA(CLKGEN_PLL_SYS0_PLL_CHANNEL_CTRL_CH_1, MDIV_CH1, 12);
...
#if BCHP_PWR_HW_RAAGA_LDO_PWRON_LDO_PWRON_PLL
    BCHP_PWR_P_HW_ControlId(hChip, BCHP_PWR_HW_RAAGA_LDO_PWRON_LDO_PWRON_PLL, true);
#endif
#if BCHP_PWR_HW_RAAGA_PWRON_PWRON_PLL
    BCHP_PWR_P_HW_ControlId(hChip, BCHP_PWR_HW_RAAGA_PWRON_PWRON_PLL, true);
#endif
#if BCHP_PWR_HW_PM_LDO_POWERUP_ISO_RAAGA
    BCHP_PWR_P_HW_ControlId(hChip, BCHP_PWR_HW_PM_LDO_POWERUP_ISO_RAAGA, true);
#endif
#if BCHP_PWR_HW_RAAGA_RESET_RESETA
    BCHP_PWR_P_HW_ControlId(hChip, BCHP_PWR_HW_RAAGA_RESET_RESETA, true);
#endif
#if BCHP_PWR_HW_RAAGA_RESET_RESETD
    BCHP_PWR_P_HW_ControlId(hChip, BCHP_PWR_HW_RAAGA_RESET_RESETD, true);
#endif
#if BCHP_PWR_HW_RAAGA_CH_CTRL_CH_0_DIS_CH0
    BCHP_PWR_P_HW_ControlId(hChip, BCHP_PWR_HW_RAAGA_CH_CTRL_CH_0_DIS_CH0, true);
#endif
...
#endif
#if BCHP_PWR_HW_RAAGA_DSP_0_RAAGA_DSP
    BCHP_PWR_P_HW_ControlId(hChip, BCHP_PWR_HW_RAAGA_DSP_0_RAAGA_DSP, true);
#endif
#if BCHP_PWR_HW_RAAGA0_AIO_SECBUS
    BCHP_PWR_P_HW_ControlId(hChip, BCHP_PWR_HW_RAAGA0_AIO_SECBUS, true);
#endif
...
BSTD_UNUSED(hReg);
#else /* Add B0 Support */
#if BCHP_PWR_HW_MOCA_CH_CTRL_CH_3_DIS_CH3
    BCHP_PWR_P_HW_ControlId(hChip, BCHP_PWR_HW_MOCA_CH_CTRL_CH_3_DIS_CH3, true);
#endif
#if BCHP_PWR_HW_MOCA_CH_CTRL_CH_3_POST_DIV_HOLD_CH3
    BCHP_PWR_P_HW_ControlId(hChip, BCHP_PWR_HW_MOCA_CH_CTRL_CH_3_POST_DIV_HOLD_CH3, true);
#endif
...
#endif
#if BCHP_PWR_HW_MOCA_CH_CTRL_CH_3_POST_DIV_HOLD_CH3
    BCHP_PWR_P_HW_ControlId(hChip, BCHP_PWR_HW_MOCA_CH_CTRL_CH_3_POST_DIV_HOLD_CH3, false);
#endif
#if BCHP_PWR_HW_MOCA_CH_CTRL_CH_3_DIS_CH3
    BCHP_PWR_P_HW_ControlId(hChip, BCHP_PWR_HW_MOCA_CH_CTRL_CH_3_DIS_CH3, false);
#endif
#endif
}
