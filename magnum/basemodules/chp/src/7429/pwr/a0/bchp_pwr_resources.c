...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HD_DVI_INPUT[] = {{
    BCHP_PWR_P_ResourceType_eNonLeaf,
    BCHP_PWR_RESOURCE_HD_DVI_INPUT,
    BDBG_STRING("HD_DVI_INPUT")
}};
...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_RAAGA0_216M[] = {{
    BCHP_PWR_P_ResourceType_eLeaf,
    BCHP_PWR_HW_RAAGA0_216M,
    BDBG_STRING("HW_RAAGA0_216M")
}};
...
const BCHP_PWR_P_Resource* const BCHP_PWR_P_ResourceList[BCHP_PWR_P_NUM_ALLNODES] = {
    ...
    BCHP_PWR_P_Resource_HD_DVI_INPUT,
    ...
    BCHP_PWR_P_Resource_HW_RAAGA0_216M,
...
static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HD_DVI_INPUT[] = {
    BCHP_PWR_P_Resource_HW_HDMI_RX0_CLK,
    BCHP_PWR_P_Resource_HW_HDMI_RX0_SRAM,
    BCHP_PWR_P_Resource_HW_RAAGA0_216M,
    NULL
...
const BCHP_PWR_P_Resource* const * const BCHP_PWR_P_DependList[BCHP_PWR_P_NUM_ALLNODES] = {
    ...
    BCHP_PWR_P_Depend_HD_DVI_INPUT,
...
void BCHP_PWR_P_HW_ControlId(BCHP_Handle handle, unsigned id, bool activate)
{
    switch(id) {
        ...
        case BCHP_PWR_HW_RAAGA0_CLK:
            ...
            break;
        case BCHP_PWR_HW_RAAGA0_216M:
            BCHP_PWR_P_HW_RAAGA0_216M_Control(handle, activate);
            break;
