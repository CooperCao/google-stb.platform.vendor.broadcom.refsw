...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_DVPHR_RBUS[] = {{
    BCHP_PWR_P_ResourceType_eLeaf,
    BCHP_PWR_HW_DVPHR_RBUS,
    BDBG_STRING("HW_DVPHR_RBUS")
}};
...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_SID_GISB[] = {{
    BCHP_PWR_P_ResourceType_eLeaf,
    BCHP_PWR_HW_SID_GISB,
    BDBG_STRING("HW_SID_GISB")
}};
...
const BCHP_PWR_P_Resource* const BCHP_PWR_P_ResourceList[BCHP_PWR_P_NUM_ALLNODES] = {
    ...
    BCHP_PWR_P_Resource_HW_DVPHR_RBUS,
    ...
    BCHP_PWR_P_Resource_HW_SID_GISB,
...
void BCHP_PWR_P_HW_ControlId(BCHP_Handle handle, unsigned id, bool activate)
{
    switch(id) {
        ...
        case BCHP_PWR_HW_DVPHT:
            ...
            break;
        case BCHP_PWR_HW_DVPHR_RBUS:
            BCHP_PWR_P_HW_DVPHR_RBUS_Control(handle, activate);
            break;
        ...
        case BCHP_PWR_HW_SID:
            ...
            break;
        case BCHP_PWR_HW_SID_GISB:
            BCHP_PWR_P_HW_SID_GISB_Control(handle, activate);
            break;
