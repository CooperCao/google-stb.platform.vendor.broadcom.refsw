...
const BCHP_PmapSettings BCHP_PWR_P_DefaultPMapSettings[BCHP_PWR_NUM_P_PMAPSETTINGS] = {
    ...
    PMAP(CLKGEN_PLL_HVD_PLL_CHANNEL_CTRL_CH_2, MDIV_CH2, 9),
    PMAP(CLKGEN_PLL_HVD_PLL_CHANNEL_CTRL_CH_5, MDIV_CH5, 8),
    PMAP(CLKGEN_PLL_SYS0_PLL_CHANNEL_CTRL_CH_3, MDIV_CH3, 11),
    PMAP(CLKGEN_PLL_SYS0_PLL_CHANNEL_CTRL_CH_4, MDIV_CH4, 6),
};

DIVTABLE(DV_PLL_HVD_CH0, -1, -1, 0);
DIVTABLE(DV_PLL_HVD_CH1, -1, -1, 1);
DIVTABLE(DV_PLL_HVD_CH2, -1, -1, 2);
DIVTABLE(DV_PLL_HVD_CH5, -1, -1, 3);
DIVTABLE(DV_PLL_SYS_PLL_CH3, -1, -1, 4);
DIVTABLE(DV_PLL_SYS_PLL_CH4, -1, -1, 5);
...
const BCHP_PWR_P_FreqMap BCHP_PWR_P_FreqMapList[BCHP_PWR_P_NUM_DIVS] = {
    ...
    FREQMAP(DV_PLL_HVD_CH5),
    FREQMAP(DV_PLL_SYS_PLL_CH3),
    FREQMAP(DV_PLL_SYS_PLL_CH4),
};
