...
static void BCHP_PWR_P_HW_DVPHR_RBUS_Control(BCHP_Handle handle, bool activate)
{
    uint32_t mask, reg;

    BDBG_MSG(("HW_DVPHR_RBUS: %s", activate?"on":"off"));
...
static void BCHP_PWR_P_HW_SID_Control(BCHP_Handle handle, bool activate)
{
    ...
    mask = (BCHP_CLKGEN_HVD_SID1_TOP_INST_CLOCK_ENABLE_SID_HVD1_SCB_CLOCK_ENABLE_SID_MASK |
...
static void BCHP_PWR_P_HW_SID_GISB_Control(BCHP_Handle handle, bool activate)
{
    uint32_t mask, reg;

    BDBG_MSG(("HW_SID_GISB: %s", activate?"on":"off"));
