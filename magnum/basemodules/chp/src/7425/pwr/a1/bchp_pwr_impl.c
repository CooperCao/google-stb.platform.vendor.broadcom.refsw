...
static void BCHP_PWR_P_HW_SVD0_CLK_Control(BCHP_Handle handle, bool activate)
{
    ...
    /* SVD Core, CPU, SCB, 108M clock */
    mask = (BCHP_CLKGEN_SVD0_TOP_INST_CLOCK_ENABLE_SVD0_CORE_CLOCK_ENABLE_MASK |
	    BCHP_CLKGEN_SVD0_TOP_INST_CLOCK_ENABLE_SVD0_CPU_CLOCK_ENABLE_MASK |
	    BCHP_CLKGEN_SVD0_TOP_INST_CLOCK_ENABLE_SVD0_108_CLOCK_ENABLE_MASK);

    BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_SVD0_TOP_INST_CLOCK_ENABLE, mask, activate?mask:0);
}

static void BCHP_PWR_P_HW_SVD0_SCB_Control(BCHP_Handle handle, bool activate)
{
    uint32_t mask;
    BDBG_MSG(("HW_SVD0_SCB: %s", activate?"on":"off"));
...
static void BCHP_PWR_P_HW_AVD1_CLK_Control(BCHP_Handle handle, bool activate)
{
    uint32_t mask;
    BDBG_MSG(("HW_AVD1_CLK: %s", activate?"on":"off"));

    /* AVD Core, CPU, SCB, 108M clock */
    mask = (BCHP_CLKGEN_AVD1_TOP_INST_CLOCK_ENABLE_AVD1_CORE_CLOCK_ENABLE_MASK |
	    BCHP_CLKGEN_AVD1_TOP_INST_CLOCK_ENABLE_AVD1_CPU_CLOCK_ENABLE_MASK |
	    BCHP_CLKGEN_AVD1_TOP_INST_CLOCK_ENABLE_AVD1_SCB_CLOCK_ENABLE_MASK |
	    BCHP_CLKGEN_AVD1_TOP_INST_CLOCK_ENABLE_AVD1_108_CLOCK_ENABLE_MASK);

    BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_AVD1_TOP_INST_CLOCK_ENABLE, mask, activate?mask:0);
}

static void BCHP_PWR_P_HW_AVD1_PWR_Control(BCHP_Handle handle, bool activate)
{
    uint32_t mask;

    BDBG_MSG(("HW_AVD1_PWR: %s", activate?"on":"off"));

     mask = BCHP_CLKGEN_AVD1_TOP_INST_POWER_SWITCH_MEMORY_AVD1_POWER_SWITCH_MEMORY_MASK;

    if(activate) {
	BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_AVD1_TOP_INST_POWER_SWITCH_MEMORY, mask, 2);
	BKNI_Delay(10);
	BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_AVD1_TOP_INST_POWER_SWITCH_MEMORY, mask, 0);
	BKNI_Delay(10);
    } else {
	BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_AVD1_TOP_INST_POWER_SWITCH_MEMORY, mask, mask);
    }
}
...
static void BCHP_PWR_P_HW_VICE0_CLK_Control(BCHP_Handle handle, bool activate)
{
    ...
    mask = (BCHP_CLKGEN_VICE2_INST_CLOCK_ENABLE_VICE_SCB_CLOCK_ENABLE_MASK |
	    BCHP_CLKGEN_VICE2_INST_CLOCK_ENABLE_VICE_CORE_CLOCK_ENABLE_MASK |
 	    BCHP_CLKGEN_VICE2_INST_CLOCK_ENABLE_VICE_GISB_CLOCK_ENABLE_MASK |
	    BCHP_CLKGEN_VICE2_INST_CLOCK_ENABLE_VICE_BVB_CLOCK_ENABLE_MASK);

    BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_VICE2_INST_CLOCK_ENABLE, mask, activate?mask:0);
}

static void BCHP_PWR_P_HW_VICE0_PWR_Control(BCHP_Handle handle, bool activate)
{
    uint32_t mask;
...
static void BCHP_PWR_P_HW_VEC_AIO_Control(BCHP_Handle handle, bool activate)
{
    ...
    mask = (BCHP_CLKGEN_VEC_AIO_TOP_INST_CLOCK_ENABLE_VEC_AIO_ALTERNATE_SCB_CLOCK_ENABLE_MASK |
	    BCHP_CLKGEN_VEC_AIO_TOP_INST_CLOCK_ENABLE_VEC_AIO_ALTERNATE_216_CLOCK_ENABLE_MASK |
	    BCHP_CLKGEN_VEC_AIO_TOP_INST_CLOCK_ENABLE_VEC_AIO_ALTERNATE_108_CLOCK_ENABLE_MASK |
	    BCHP_CLKGEN_VEC_AIO_TOP_INST_CLOCK_ENABLE_VEC_AIO_ALTERNATE2_216_CLOCK_ENABLE_MASK |
	    BCHP_CLKGEN_VEC_AIO_TOP_INST_CLOCK_ENABLE_VEC_AIO_ALTERNATE2_108_CLOCK_ENABLE_MASK |
	    BCHP_CLKGEN_VEC_AIO_TOP_INST_CLOCK_ENABLE_VEC_AIO_216_CLOCK_ENABLE_MASK |
	    BCHP_CLKGEN_VEC_AIO_TOP_INST_CLOCK_ENABLE_VEC_AIO_108_CLOCK_ENABLE_MASK );
    ...
    mask = (BCHP_CLKGEN_VEC_AIO_TOP_INST_CLOCK_ENABLE_VEC_VEC_AIO_CLK_324_ENABLE_VEC_MASK |
    ...
    mask = (BCHP_CLKGEN_VEC_AIO_TOP_INST_CLOCK_ENABLE_VEC_AIO_ALTERNATE_108_CLOCK_ENABLE_MASK );
    BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_VEC_AIO_TOP_INST_CLOCK_ENABLE, mask, activate?mask:0);

#endif
}

static void BCHP_PWR_P_HW_RAAGA_Control(BCHP_Handle handle, bool activate)
{
    uint32_t mask;
...
static void BCHP_PWR_P_HW_AIO_SRAM_Control(BCHP_Handle handle, bool activate)
{
    ...
    mask = BCHP_CLKGEN_VEC_AIO_TOP_INST_POWER_SWITCH_MEMORY_B_AIO_POWER_SWITCH_MEMORY_B_MASK;

    if(activate)
	{
	   BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_VEC_AIO_TOP_INST_POWER_SWITCH_MEMORY_B, mask, 2);
	   BKNI_Delay(10);
	   BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_VEC_AIO_TOP_INST_POWER_SWITCH_MEMORY_B, mask, 0);
	   BKNI_Delay(10);
    }
	else
	{
	   BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_VEC_AIO_TOP_INST_POWER_SWITCH_MEMORY_B, mask, mask);
    }
...
static void BCHP_PWR_P_HW_RAAGA_SRAM_Control(BCHP_Handle handle, bool activate)
{
    uint32_t mask;
...
static void BCHP_PWR_P_HW_VDC_DAC_Control(BCHP_Handle handle, bool activate)
{
    ...
    mask = BCHP_CLKGEN_VEC_AIO_TOP_INST_VEC_DACADC_CLOCK_DISABLE_DISABLE_VEC_DACADC_CLOCK_MASK;
    BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_VEC_AIO_TOP_INST_VEC_DACADC_CLOCK_DISABLE, mask, activate?0:mask);

    mask = BCHP_CLKGEN_VEC_AIO_TOP_INST_CLOCK_ENABLE_QDAC_216_CLOCK_ENABLE_MASK;
    BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_VEC_AIO_TOP_INST_CLOCK_ENABLE, mask, activate?mask:0);

    mask = BCHP_CLKGEN_VEC_AIO_TOP_INST_CLOCK_ENABLE_QDAC_SCB_CLOCK_ENABLE_MASK;
    BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_VEC_AIO_TOP_INST_CLOCK_ENABLE, mask, activate?mask:0);

#elif (BCHP_VER == BCHP_VER_B0)

    mask = BCHP_CLKGEN_VEC_AIO_TOP_INST_CLOCK_ENABLE_VEC_VEC_QDAC_216_CLOCK_ENABLE_VEC_MASK;
    BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_VEC_AIO_TOP_INST_CLOCK_ENABLE_VEC, mask, activate?0:mask);
...
static void BCHP_PWR_P_HW_HDMI_TX_TMDS_Control(BCHP_Handle handle, bool activate)
{
    uint32_t mask, val;
...
static void BCHP_PWR_P_HW_HDMI_TX_TMDS_CH_Control(BCHP_Handle handle, bool activate)
{
    uint32_t mask, val;
	...
	mask = (BCHP_HDMI_TX_PHY_POWERDOWN_CTL_TX_0_PWRDN_MASK |
		...
		BCHP_HDMI_TX_PHY_POWERDOWN_CTL_RNDGEN_PWRDN_MASK |
		BCHP_HDMI_TX_PHY_POWERDOWN_CTL_PLL_PWRDN_MASK |
		BCHP_HDMI_TX_PHY_POWERDOWN_CTL_BIAS_PWRDN_MASK |
		BCHP_HDMI_TX_PHY_POWERDOWN_CTL_PHY_PWRDN_MASK);
        val &= ~mask;
...
static void BCHP_PWR_P_HW_HDMI_SRAM_Control(BCHP_Handle handle, bool activate)
{
    uint32_t mask;
...
static void BCHP_PWR_P_HW_HDMI_TX_CEC_HOTPLUG_Control(BCHP_Handle handle, bool activate)
{
...
static void BCHP_PWR_P_HW_HDMI_RX0_216M_Control(BCHP_Handle handle, bool activate)
{
    uint32_t mask;

    BDBG_MSG(("HW_HDMI_RX0_216M: %s", activate?"on":"off"));

    mask = (BCHP_CLKGEN_DVP_HR_INST_CLOCK_ENABLE_DVPHR_216_CLOCK_ENABLE_MASK |
...
#if (BCHP_VER == BCHP_VER_A0 || BCHP_VER == BCHP_VER_A1)
    mask = BCHP_CLKGEN_DVP_HR_INST_ENABLE_DVPHR_CLK_MAX_ENABLE_MASK;
    BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_DVP_HR_INST_ENABLE, mask, activate?mask:0);
#elif (BCHP_VER == BCHP_VER_B0)
    mask = BCHP_CLKGEN_DVP_HR_INST_CLOCK_ENABLE_DVPHR_CLK_324_ENABLE_MASK;
    BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_DVP_HR_INST_CLOCK_ENABLE, mask, activate?mask:0);
#endif
}

static void BCHP_PWR_P_HW_HDMI_RX0_ALT_216M_Control(BCHP_Handle handle, bool activate)
{
    uint32_t mask;
    ...
    mask = (BCHP_CLKGEN_DVP_HR_INST_CLOCK_ENABLE_DVPHR_ALTERNATE_216_CLOCK_ENABLE_MASK |
	    BCHP_CLKGEN_DVP_HR_INST_CLOCK_ENABLE_DVPHR_ALTERNATE_108_CLOCK_ENABLE_MASK);
    BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_DVP_HR_INST_CLOCK_ENABLE, mask, activate?mask:0);
}
...
static void BCHP_PWR_P_HW_V3D_Control(BCHP_Handle handle, bool activate)
{
    ...
    mask = BCHP_CLKGEN_V3D_TOP_INST_V3D_CLOCK_ENABLE_V3D_CLOCK_ENABLE_MASK;
    BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_V3D_TOP_INST_V3D_CLOCK_ENABLE, mask, activate ? mask : 0);

	/* TODO: Check with yarran */
    mask = BCHP_CLKGEN_V3D_TOP_INST_POWER_SWITCH_MEMORY_V3D_POWER_SWITCH_MEMORY_MASK;
    BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_V3D_TOP_INST_POWER_SWITCH_MEMORY, mask, activate ? mask : 0);
#endif
}
...
static void BCHP_PWR_P_HW_GFX_108M_Control(BCHP_Handle handle, bool activate)
{
    ...
    mask = (BCHP_CLKGEN_GRAPHICS_INST_CLOCK_ENABLE_GFX_SCB_CLOCK_ENABLE_MASK |
            ...
            BCHP_CLKGEN_GRAPHICS_INST_CLOCK_ENABLE_GFX_ALTERNATE_108_CLOCK_ENABLE_MASK |
...
{
    uint32_t mask;
    BDBG_MSG(("HW_UHF: %s", activate?"on":"off"));
...
static void BCHP_PWR_P_HW_AVS_Control(BCHP_Handle handle, bool activate)
{
    uint32_t mask, val;

    BDBG_MSG(("HW_AVS: %s", activate?"on":"off"));
...
#if 0
    val = BREG_Read32(handle->regHandle, BCHP_AVS_HW_MNTR_ENABLE_DEFAULT_PVT_MNTR);
    mask = BCHP_AVS_HW_MNTR_ENABLE_DEFAULT_PVT_MNTR_pvt_mntr_pwrdn_default_MASK;
    if (activate) {
        val &= ~mask;
    }
    else {
    ...
    BREG_Write32(handle->regHandle, BCHP_AVS_HW_MNTR_ENABLE_DEFAULT_PVT_MNTR, val);

    val = BREG_Read32(handle->regHandle, BCHP_AVS_HW_MNTR_ENABLE_DEFAULT_CEN_ROSC_0);
    mask = BCHP_AVS_HW_MNTR_ENABLE_DEFAULT_CEN_ROSC_0_cen_rosc_enable_default_MASK;
    if (activate) {
	val |= mask;
    }
    else {
    ...
    BREG_Write32(handle->regHandle, BCHP_AVS_HW_MNTR_ENABLE_DEFAULT_CEN_ROSC_0, val);

    val = BREG_Read32(handle->regHandle, BCHP_AVS_HW_MNTR_ENABLE_DEFAULT_CEN_ROSC_1);
    mask = BCHP_AVS_HW_MNTR_ENABLE_DEFAULT_CEN_ROSC_1_cen_rosc_enable_default_MASK;
    if (activate) {
	val |= mask;
    }
    else {
    ...
    BREG_Write32(handle->regHandle, BCHP_AVS_HW_MNTR_ENABLE_DEFAULT_CEN_ROSC_1, val);
#endif
}
...
static void BCHP_PWR_P_HW_PLL_AVD1_CH4_Control(BCHP_Handle handle, bool activate)
{
#if (BCHP_VER == BCHP_VER_A0 || BCHP_VER == BCHP_VER_A1)
    uint32_t mask;

    BDBG_MSG(("HW_PLL_AVD1_CH4: %s", activate?"on":"off"));

    if(activate) {
	mask = BCHP_CLKGEN_PLL_AVD1_PLL_CHANNEL_CTRL_CH_4_CLOCK_DIS_CH4_MASK;
	BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_PLL_AVD1_PLL_CHANNEL_CTRL_CH_4, mask, 0);
	mask = BCHP_CLKGEN_PLL_AVD1_PLL_CHANNEL_CTRL_CH_4_POST_DIVIDER_HOLD_CH4_MASK;
	BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_PLL_AVD1_PLL_CHANNEL_CTRL_CH_4, mask, 0);
    } else {
	mask = BCHP_CLKGEN_PLL_AVD1_PLL_CHANNEL_CTRL_CH_4_POST_DIVIDER_HOLD_CH4_MASK;
	BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_PLL_AVD1_PLL_CHANNEL_CTRL_CH_4, mask, mask);
	mask = BCHP_CLKGEN_PLL_AVD1_PLL_CHANNEL_CTRL_CH_4_CLOCK_DIS_CH4_MASK;
	BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_PLL_AVD1_PLL_CHANNEL_CTRL_CH_4, mask, mask);
    }
#else
...
static void BCHP_PWR_P_HW_PLL_AVD_Control(BCHP_Handle handle, bool activate)
{
	...
	mask = (BCHP_CLKGEN_PLL_AVD1_PLL_RESET_RESETD_MASK |
		BCHP_CLKGEN_PLL_AVD1_PLL_RESET_RESETA_MASK);
