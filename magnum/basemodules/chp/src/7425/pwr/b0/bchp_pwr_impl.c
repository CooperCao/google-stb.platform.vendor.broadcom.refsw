...
static void BCHP_PWR_P_HW_SVD0_CLK_Control(BCHP_Handle handle, bool activate)
{
    ...
    if (activate)
    {
       /* Enable SVD Core, CPU, SCB, and 108M clock */
    ...
    {
       /* Disable SVD Core, CPU, SCB, and 108M clock */
       mask = BCHP_CLKGEN_SVD0_TOP_INST_CLOCK_ENABLE_SVD0_CPU_CLOCK_ENABLE_MASK;
...
static void BCHP_PWR_P_HW_AVD1_CLK_Control(BCHP_Handle handle, bool activate)
{
    ...
    if (activate)
    {
       /* Enable AVD Core, CPU, SCB, 108M clock */
       mask = (BCHP_CLKGEN_AVD1_TOP_INST_CLOCK_ENABLE_AVD1_108_CLOCK_ENABLE_MASK);
       BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_AVD1_TOP_INST_CLOCK_ENABLE, mask, mask);

       mask = (BCHP_CLKGEN_AVD1_TOP_INST_CLOCK_ENABLE_AVD1_SCB_CLOCK_ENABLE_MASK);
       BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_AVD1_TOP_INST_CLOCK_ENABLE, mask, mask);

       mask = (BCHP_CLKGEN_AVD1_TOP_INST_CLOCK_ENABLE_AVD1_CORE_CLOCK_ENABLE_MASK);
       BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_AVD1_TOP_INST_CLOCK_ENABLE, mask, mask);

       mask = (BCHP_CLKGEN_AVD1_TOP_INST_CLOCK_ENABLE_AVD1_CPU_CLOCK_ENABLE_MASK);
       BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_AVD1_TOP_INST_CLOCK_ENABLE, mask, mask);
    }
    else
    {
       /* Disable AVD Core, CPU, SCB, 108M clock */
       mask = (BCHP_CLKGEN_AVD1_TOP_INST_CLOCK_ENABLE_AVD1_CPU_CLOCK_ENABLE_MASK);
       BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_AVD1_TOP_INST_CLOCK_ENABLE, mask, 0);
...
static void BCHP_PWR_P_HW_VICE0_CLK_Control(BCHP_Handle handle, bool activate)
{
    ...
    mask = (BCHP_CLKGEN_VICE2_INST_CLOCK_ENABLE_VICE_CORE_CLOCK_ENABLE_MASK |
	    ...
	    BCHP_CLKGEN_VICE2_INST_CLOCK_ENABLE_VICE_SCB_CLOCK_ENABLE_MASK |
...
static void BCHP_PWR_P_HW_BVN_Control(BCHP_Handle handle, bool activate)
{
    ...
    mask = (BCHP_CLKGEN_BVN_MCVP_TOP_INST_CLOCK_ENABLE_BVND_108_CLOCK_ENABLE_MASK |
            BCHP_CLKGEN_BVN_MCVP_TOP_INST_CLOCK_ENABLE_BVND_216_CLOCK_ENABLE_MASK |
            BCHP_CLKGEN_BVN_MCVP_TOP_INST_CLOCK_ENABLE_BVND_SCB_CLOCK_ENABLE_MASK);

    BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_BVN_MCVP_TOP_INST_CLOCK_ENABLE, mask, activate?mask:0);
}
...
static void BCHP_PWR_P_HW_VEC_Control(BCHP_Handle handle, bool activate)
{
    ...
    mask = (BCHP_CLKGEN_VEC_AIO_TOP_INST_CLOCK_ENABLE_VEC_VEC_216_CLOCK_ENABLE_VEC_MASK |
	    ...
	    BCHP_CLKGEN_VEC_AIO_TOP_INST_CLOCK_ENABLE_VEC_VEC_AIO_CLK_324_ENABLE_VEC_MASK );
    BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_VEC_AIO_TOP_INST_CLOCK_ENABLE_VEC, mask, activate?mask:0);
...
static void BCHP_PWR_P_HW_HDMI_TX_CLK_Control(BCHP_Handle handle, bool activate)
{
    ...
    mask = (BCHP_CLKGEN_DVP_HT_INST_CLOCK_ENABLE_DVPHT_CLK_VEC_ENABLE_MASK |
...
static void BCHP_PWR_P_HW_HDMI_RX0_CLK_Control(BCHP_Handle handle, bool activate)
{
    ...
    mask = (BCHP_CLKGEN_DVP_HR_INST_CLOCK_ENABLE_DVPHR_CLK_324_ENABLE_MASK |
            BCHP_CLKGEN_DVP_HR_INST_CLOCK_ENABLE_DVPHR_ALTERNATE_216_CLOCK_ENABLE_MASK |
...
static void BCHP_PWR_P_HW_PLL_SCD_Control(BCHP_Handle handle, bool activate)
{
	...
	mask = BCHP_CLKGEN_PAD_CLOCK_DISABLE_DISABLE_PAD_OUTPUT_SC_CLOCK_MASK;
    BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_PAD_CLOCK_DISABLE, mask, 0);
	...
	mask = BCHP_CLKGEN_PAD_CLOCK_DISABLE_DISABLE_PAD_OUTPUT_SC_CLOCK_MASK;
    BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_PAD_CLOCK_DISABLE, mask, mask);
