...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_UHF_INPUT_SRAM[] = {{
    BCHP_PWR_P_ResourceType_eLeaf,
    BCHP_PWR_HW_UHF_INPUT_SRAM,
    BDBG_STRING("HW_UHF_INPUT_SRAM")
}};
...
const BCHP_PWR_P_Resource* const BCHP_PWR_P_ResourceList[BCHP_PWR_P_NUM_ALLNODES] = {
    ...
    BCHP_PWR_P_Resource_HW_UHF_INPUT_SRAM,
...
void BCHP_PWR_P_HW_ControlId(BCHP_Handle handle, unsigned id, bool activate)
{
    switch(id) {
        ...
        case BCHP_PWR_HW_UHF_INPUT:
            ...
            break;
        case BCHP_PWR_HW_UHF_INPUT_SRAM:
            BCHP_PWR_P_HW_UHF_INPUT_SRAM_Control(handle, activate);
            break;
