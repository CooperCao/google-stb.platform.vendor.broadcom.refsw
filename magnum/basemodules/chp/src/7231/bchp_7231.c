...
static const BCHP_P_7231_Info s_aChipInfoTable[] =
{
   ...
   {0x72310000, BCHP_BCM7231, BCHP_MAJOR_A, BCHP_MINOR_0},
    ...
    /* B0 code will run on B0,B1 & B2, B1 code is same as B0 code. */
      ...
      const BREG_Handle                hReg )
{
    ...
    BREG_Write32(hReg, BCHP_SID_GR_SW_INIT_0, BCHP_FIELD_DATA(SID_GR_SW_INIT_0, SID_CLK_108_SW_INIT, 0));
}
...
static void BCHP_P_ResetV3dCore( const BCHP_Handle hChip, const BREG_Handle hReg )
{
    ...
    BREG_Write32(hReg, BCHP_GFX_GR_SW_INIT_0, BCHP_FIELD_ENUM(GFX_GR_SW_INIT_0, V3D_CLK_108_SW_INIT, ASSERT));
    BREG_Write32(hReg, BCHP_GFX_GR_SW_INIT_0, BCHP_FIELD_ENUM(GFX_GR_SW_INIT_0, V3D_CLK_108_SW_INIT, DEASSERT));
