...
static void BCHP_PWR_P_HW_HDMI_TX_CLK_Control(BCHP_Handle handle, bool activate)
{
    ...
    mask = BCHP_CLKGEN_DVP_HT_CLOCK_ENABLE_DVPHT_MAX_CLOCK_ENABLE_MASK;
...
static void BCHP_PWR_P_HW_PLL_AVD_CH4_Control(BCHP_Handle handle, bool activate)
{
    ...
    BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_PLL_AVD_PLL_CHANNEL_CTRL_CH_4, mask, activate?0:mask);
}
