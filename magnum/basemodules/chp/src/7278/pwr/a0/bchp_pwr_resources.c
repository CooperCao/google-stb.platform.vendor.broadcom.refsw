...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_M2MCTFU0[] = {{
    BCHP_PWR_P_ResourceType_eNonLeaf,
    BCHP_PWR_RESOURCE_M2MCTFU0,
    BDBG_STRING("M2MCTFU0")
}};
...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_SC0_CTRL_WRAPPER_CONTROL_PWRDN_REQ[] = {{
    BCHP_PWR_P_ResourceType_eLeaf,
    BCHP_PWR_HW_SC0_CTRL_WRAPPER_CONTROL_PWRDN_REQ,
    BDBG_STRING("HW_SC0_CTRL_WRAPPER_CONTROL_PWRDN_REQ")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_SC1_CTRL_WRAPPER_CONTROL_PWRDN_REQ[] = {{
    BCHP_PWR_P_ResourceType_eLeaf,
    BCHP_PWR_HW_SC1_CTRL_WRAPPER_CONTROL_PWRDN_REQ,
    BDBG_STRING("HW_SC1_CTRL_WRAPPER_CONTROL_PWRDN_REQ")
}};
...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_VCXO0_CTRL_WRAPPER_CONTROL_PWRDN_REQ[] = {{
    BCHP_PWR_P_ResourceType_eLeaf,
    BCHP_PWR_HW_VCXO0_CTRL_WRAPPER_CONTROL_PWRDN_REQ,
    BDBG_STRING("HW_VCXO0_CTRL_WRAPPER_CONTROL_PWRDN_REQ")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_VCXO1_CTRL_WRAPPER_CONTROL_PWRDN_REQ[] = {{
    BCHP_PWR_P_ResourceType_eLeaf,
    BCHP_PWR_HW_VCXO1_CTRL_WRAPPER_CONTROL_PWRDN_REQ,
    BDBG_STRING("HW_VCXO1_CTRL_WRAPPER_CONTROL_PWRDN_REQ")
}};
...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_VICE20_SECBUS[] = {{
    BCHP_PWR_P_ResourceType_eLeaf,
    BCHP_PWR_HW_VICE20_SECBUS,
    BDBG_STRING("HW_VICE20_SECBUS")
}};
...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_XPT_SECBUS_XPT_REMUX[] = {{
    BCHP_PWR_P_ResourceType_eLeaf,
    BCHP_PWR_HW_XPT_SECBUS_XPT_REMUX,
    BDBG_STRING("HW_XPT_SECBUS_XPT_REMUX")
}};
...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_HVDP0_HVDP0_CORE[] = {{
    BCHP_PWR_P_ResourceType_eNonLeafHw,
    BCHP_PWR_HW_HVDP0_HVDP0_CORE,
    BDBG_STRING("HW_HVDP0_HVDP0_CORE")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_HVDP0_HVDP0_CPU[] = {{
    BCHP_PWR_P_ResourceType_eNonLeafHw,
    BCHP_PWR_HW_HVDP0_HVDP0_CPU,
    BDBG_STRING("HW_HVDP0_HVDP0_CPU")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_HVDP1_HVDP1_CORE[] = {{
    BCHP_PWR_P_ResourceType_eNonLeafHw,
    BCHP_PWR_HW_HVDP1_HVDP1_CORE,
    BDBG_STRING("HW_HVDP1_HVDP1_CORE")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_HVDP1_HVDP1_CPU[] = {{
    BCHP_PWR_P_ResourceType_eNonLeafHw,
    BCHP_PWR_HW_HVDP1_HVDP1_CPU,
    BDBG_STRING("HW_HVDP1_HVDP1_CPU")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_HVDS0_HVDS0_CORE[] = {{
    BCHP_PWR_P_ResourceType_eNonLeafHw,
    BCHP_PWR_HW_HVDS0_HVDS0_CORE,
    BDBG_STRING("HW_HVDS0_HVDS0_CORE")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_HVDS0_HVDS0_CPU[] = {{
    BCHP_PWR_P_ResourceType_eNonLeafHw,
    BCHP_PWR_HW_HVDS0_HVDS0_CPU,
    BDBG_STRING("HW_HVDS0_HVDS0_CPU")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_HVDS1_HVDS1_CORE[] = {{
    BCHP_PWR_P_ResourceType_eNonLeafHw,
    BCHP_PWR_HW_HVDS1_HVDS1_CORE,
    BDBG_STRING("HW_HVDS1_HVDS1_CORE")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_HVDS1_HVDS1_CPU[] = {{
    BCHP_PWR_P_ResourceType_eNonLeafHw,
    BCHP_PWR_HW_HVDS1_HVDS1_CPU,
    BDBG_STRING("HW_HVDS1_HVDS1_CPU")
}};
...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_XPT_CH_CTRL_CH_5_POST_DIV_HOLD_CH5[] = {{
    BCHP_PWR_P_ResourceType_eNonLeafHw,
    BCHP_PWR_HW_XPT_CH_CTRL_CH_5_POST_DIV_HOLD_CH5,
    BDBG_STRING("HW_XPT_CH_CTRL_CH_5_POST_DIV_HOLD_CH5")
}};
...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_DV_XPT_CTRL_CH5_div[] = {{
    BCHP_PWR_P_ResourceType_eDiv,
    BCHP_PWR_DV_XPT_CTRL_CH5_div,
    BDBG_STRING("DV_XPT_CTRL_CH5_div")
}};
...
const BCHP_PWR_P_Resource* const BCHP_PWR_P_ResourceList[BCHP_PWR_P_NUM_ALLNODES] = {
    ...
    BCHP_PWR_P_Resource_HW_HVDP0_HVDP0_CORE,
    BCHP_PWR_P_Resource_HW_HVDP0_HVDP0_CPU,
    BCHP_PWR_P_Resource_HW_HVDP0_SRAM,
    BCHP_PWR_P_Resource_HW_HVDP1_HVDP1_CORE,
    BCHP_PWR_P_Resource_HW_HVDP1_HVDP1_CPU,
    BCHP_PWR_P_Resource_HW_HVDP1_SRAM,
    BCHP_PWR_P_Resource_HW_HVDS0_HVDS0_CORE,
    BCHP_PWR_P_Resource_HW_HVDS0_HVDS0_CPU,
    BCHP_PWR_P_Resource_HW_HVDS0_SRAM,
    BCHP_PWR_P_Resource_HW_HVDS1_HVDS1_CORE,
    BCHP_PWR_P_Resource_HW_HVDS1_HVDS1_CPU,
    ...
    BCHP_PWR_P_Resource_HW_SC0_CTRL_WRAPPER_CONTROL_PWRDN_REQ,
    BCHP_PWR_P_Resource_HW_SC1_CH_CTRL_CH_0_POST_DIV_HOLD_CH0,
    BCHP_PWR_P_Resource_HW_SC1_CTRL_WRAPPER_CONTROL_PWRDN_REQ,
    ...
    BCHP_PWR_P_Resource_HW_VCXO0_CTRL_WRAPPER_CONTROL_PWRDN_REQ,
    BCHP_PWR_P_Resource_HW_VCXO1_CH_CTRL_CH_0_POST_DIV_HOLD_CH0,
    BCHP_PWR_P_Resource_HW_VCXO1_CH_CTRL_CH_1_POST_DIV_HOLD_CH1,
    BCHP_PWR_P_Resource_HW_VCXO1_CTRL_WRAPPER_CONTROL_PWRDN_REQ,
    ...
    BCHP_PWR_P_Resource_HW_VICE20_SECBUS,
    ...
    BCHP_PWR_P_Resource_HW_XPT_CH_CTRL_CH_5_POST_DIV_HOLD_CH5,
    BCHP_PWR_P_Resource_HW_XPT_REMUX,
    BCHP_PWR_P_Resource_HW_XPT_SECBUS_XPT_REMUX,
    ...
    BCHP_PWR_P_Resource_DV_XPT_CTRL_CH5_div,
};
...
static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_M2MCTFU0[] = {
    BCHP_PWR_P_Resource_HW_HVD_CH_CTRL_CH_2_POST_DIV_HOLD_CH2,
    NULL
};
...
static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_HVDP0_HVDP0_CORE[] = {
    BCHP_PWR_P_Resource_HW_HVD_CH_CTRL_CH_0_POST_DIV_HOLD_CH0,
    NULL
};

static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_HVDP0_HVDP0_CPU[] = {
    BCHP_PWR_P_Resource_HW_HVD_CH_CTRL_CH_1_POST_DIV_HOLD_CH1,
    BCHP_PWR_P_Resource_HW_HVD_CH_CTRL_CH_1_POST_DIV_HOLD_CH1,
    BCHP_PWR_P_Resource_HW_HVDP0_HVDP0_CORE,
    BCHP_PWR_P_Resource_HW_HVD0_SID,
...
static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_HVDP1_HVDP1_CORE[] = {
    BCHP_PWR_P_Resource_HW_HVD_CH_CTRL_CH_0_POST_DIV_HOLD_CH0,
    NULL
};

static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_HVDP1_HVDP1_CPU[] = {
    BCHP_PWR_P_Resource_HW_HVD_CH_CTRL_CH_1_POST_DIV_HOLD_CH1,
    BCHP_PWR_P_Resource_HW_HVDP1_HVDP1_CORE,
    BCHP_PWR_P_Resource_HW_HVD1,
    BCHP_PWR_P_Resource_HW_HVD_CH_CTRL_CH_1_POST_DIV_HOLD_CH1,
...
static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_HVDS0_HVDS0_CORE[] = {
    BCHP_PWR_P_Resource_HW_HVD_CH_CTRL_CH_0_POST_DIV_HOLD_CH0,
    NULL
};

static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_HVDS0_HVDS0_CPU[] = {
    BCHP_PWR_P_Resource_HW_HVD_CH_CTRL_CH_1_POST_DIV_HOLD_CH1,
    BCHP_PWR_P_Resource_HW_HVD_CH_CTRL_CH_1_POST_DIV_HOLD_CH1,
    BCHP_PWR_P_Resource_HW_HVDP0_HVDP0_CORE,
    BCHP_PWR_P_Resource_HW_HVD0_SID,
...
static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_HVDS1_HVDS1_CORE[] = {
    BCHP_PWR_P_Resource_HW_HVD_CH_CTRL_CH_0_POST_DIV_HOLD_CH0,
    NULL
};

static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_HVDS1_HVDS1_CPU[] = {
    BCHP_PWR_P_Resource_HW_HVD_CH_CTRL_CH_1_POST_DIV_HOLD_CH1,
    BCHP_PWR_P_Resource_HW_HVDP1_HVDP1_CORE,
    BCHP_PWR_P_Resource_HW_HVD1,
    BCHP_PWR_P_Resource_HW_HVD_CH_CTRL_CH_1_POST_DIV_HOLD_CH1,
...
static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_XPT_CH_CTRL_CH_5_POST_DIV_HOLD_CH5[] = {
    BCHP_PWR_P_Resource_DV_XPT_CTRL_CH5_div,
    NULL
};
...
const BCHP_PWR_P_Resource* const * const BCHP_PWR_P_DependList[BCHP_PWR_P_NUM_ALLNODES] = {
    ...
    NULL,
    NULL,
    BCHP_PWR_P_Depend_HW_HVDP0_HVDP0_CORE,
    BCHP_PWR_P_Depend_HW_HVDP0_HVDP0_CPU,
    NULL,
    BCHP_PWR_P_Depend_HW_HVDP1_HVDP1_CORE,
    BCHP_PWR_P_Depend_HW_HVDP1_HVDP1_CPU,
    NULL,
    BCHP_PWR_P_Depend_HW_HVDS0_HVDS0_CORE,
    BCHP_PWR_P_Depend_HW_HVDS0_HVDS0_CPU,
    NULL,
    BCHP_PWR_P_Depend_HW_HVDS1_HVDS1_CORE,
    BCHP_PWR_P_Depend_HW_HVDS1_HVDS1_CPU,
    NULL,
    ...
    BCHP_PWR_P_Depend_HW_XPT_CH_CTRL_CH_5_POST_DIV_HOLD_CH5,
    NULL,
    NULL,
    NULL,
    NULL,
...
void BCHP_PWR_P_HW_ControlId(BCHP_Handle handle, unsigned id, bool activate)
{
    switch(id) {
        ...
        case BCHP_PWR_HW_HVD1_SRAM:
            ...
            break;
        case BCHP_PWR_HW_HVDP0_HVDP0_CORE:
            BCHP_PWR_P_HW_HVDP0_HVDP0_CORE_Control(handle, activate);
            break;
        case BCHP_PWR_HW_HVDP0_HVDP0_CPU:
            BCHP_PWR_P_HW_HVDP0_HVDP0_CPU_Control(handle, activate);
            break;
        case BCHP_PWR_HW_HVDP0_SRAM:
            BCHP_PWR_P_HW_HVDP0_SRAM_Control(handle, activate);
            break;
        case BCHP_PWR_HW_HVDP1_HVDP1_CORE:
            BCHP_PWR_P_HW_HVDP1_HVDP1_CORE_Control(handle, activate);
            break;
        case BCHP_PWR_HW_HVDP1_HVDP1_CPU:
            BCHP_PWR_P_HW_HVDP1_HVDP1_CPU_Control(handle, activate);
            break;
        case BCHP_PWR_HW_HVDP1_SRAM:
            BCHP_PWR_P_HW_HVDP1_SRAM_Control(handle, activate);
            break;
        case BCHP_PWR_HW_HVDS0_HVDS0_CORE:
            BCHP_PWR_P_HW_HVDS0_HVDS0_CORE_Control(handle, activate);
            break;
        case BCHP_PWR_HW_HVDS0_HVDS0_CPU:
            BCHP_PWR_P_HW_HVDS0_HVDS0_CPU_Control(handle, activate);
            break;
        case BCHP_PWR_HW_HVDS0_SRAM:
            BCHP_PWR_P_HW_HVDS0_SRAM_Control(handle, activate);
            break;
        case BCHP_PWR_HW_HVDS1_HVDS1_CORE:
            BCHP_PWR_P_HW_HVDS1_HVDS1_CORE_Control(handle, activate);
            break;
        case BCHP_PWR_HW_HVDS1_HVDS1_CPU:
            BCHP_PWR_P_HW_HVDS1_HVDS1_CPU_Control(handle, activate);
            break;
        ...
        case BCHP_PWR_HW_SC0_CH_CTRL_CH_0_POST_DIV_HOLD_CH0:
            ...
            break;
        case BCHP_PWR_HW_SC0_CTRL_WRAPPER_CONTROL_PWRDN_REQ:
            BCHP_PWR_P_HW_SC0_CTRL_WRAPPER_CONTROL_PWRDN_REQ_Control(handle, activate);
            break;
        case BCHP_PWR_HW_SC1_CH_CTRL_CH_0_POST_DIV_HOLD_CH0:
            ...
            break;
        case BCHP_PWR_HW_SC1_CTRL_WRAPPER_CONTROL_PWRDN_REQ:
            BCHP_PWR_P_HW_SC1_CTRL_WRAPPER_CONTROL_PWRDN_REQ_Control(handle, activate);
            break;
        ...
        case BCHP_PWR_HW_VCXO0_CH_CTRL_CH_1_POST_DIV_HOLD_CH1:
            ...
            break;
        case BCHP_PWR_HW_VCXO0_CTRL_WRAPPER_CONTROL_PWRDN_REQ:
            BCHP_PWR_P_HW_VCXO0_CTRL_WRAPPER_CONTROL_PWRDN_REQ_Control(handle, activate);
            break;
        ...
        case BCHP_PWR_HW_VCXO1_CH_CTRL_CH_1_POST_DIV_HOLD_CH1:
            ...
            break;
        case BCHP_PWR_HW_VCXO1_CTRL_WRAPPER_CONTROL_PWRDN_REQ:
            BCHP_PWR_P_HW_VCXO1_CTRL_WRAPPER_CONTROL_PWRDN_REQ_Control(handle, activate);
            break;
        ...
        case BCHP_PWR_HW_VICE20:
            ...
            break;
        case BCHP_PWR_HW_VICE20_SECBUS:
            BCHP_PWR_P_HW_VICE20_SECBUS_Control(handle, activate);
            break;
        ...
        case BCHP_PWR_HW_XPT_CH_CTRL_CH_4_POST_DIV_HOLD_CH4:
            ...
            break;
        case BCHP_PWR_HW_XPT_CH_CTRL_CH_5_POST_DIV_HOLD_CH5:
            BCHP_PWR_P_HW_XPT_CH_CTRL_CH_5_POST_DIV_HOLD_CH5_Control(handle, activate);
            break;
        case BCHP_PWR_HW_XPT_REMUX:
            BCHP_PWR_P_HW_XPT_REMUX_Control(handle, activate);
            break;
        case BCHP_PWR_HW_XPT_SECBUS_XPT_REMUX:
            BCHP_PWR_P_HW_XPT_SECBUS_XPT_REMUX_Control(handle, activate);
            break;
...
void BCHP_PWR_P_DIV_Control(BCHP_Handle handle, const BCHP_PWR_P_Resource *resource, unsigned *mult, unsigned *prediv, unsigned *postdiv, bool set)
{
    ...
    switch(resource->id) {
        ...
        case BCHP_PWR_DV_XPT_CTRL_CH4_div:
            ...
            break;
        case BCHP_PWR_DV_XPT_CTRL_CH5_div:
            BCHP_PWR_P_DV_XPT_CTRL_CH5_div_Control(handle, mult, prediv, postdiv, set);
            break;
        default:
            BDBG_ASSERT(0);
            break;
...
const BCHP_PWR_P_MuxTable BCHP_PWR_P_MuxTable_MX_ITU656_0_MUX_SELECT_VEC_ITU656_0_CLOCK[] = {{0},{0},{0},{0},};
const BCHP_PWR_P_MuxTable BCHP_PWR_P_MuxTable_MX_RAAGA_DSP_0_RAAGA0_DSP_SELECT_RAAGA0[] = {{0},{0},{0},{0},};
const BCHP_PWR_P_MuxTable BCHP_PWR_P_MuxTable_MX_SMARTCARD_MUX_SELECT_SC0_CLOCK[] = {{0},{0},{0},{0},};
const BCHP_PWR_P_MuxTable BCHP_PWR_P_MuxTable_MX_SMARTCARD_MUX_SELECT_SC1_CLOCK[] = {{0},{0},{0},{0},};
...
const BCHP_PWR_P_DivTable BCHP_PWR_P_DivTable_DV_HVD_CTRL_CH0_div[] = {{200,3,8},{200,3,0},{200,3,0},{200,3,0},{200,3,101},};
const BCHP_PWR_P_DivTable BCHP_PWR_P_DivTable_DV_HVD_CTRL_CH1_div[] = {{200,3,6},{200,3,0},{200,3,0},{200,3,0},{200,3,100},};
const BCHP_PWR_P_DivTable BCHP_PWR_P_DivTable_DV_HVD_CTRL_CH2_div[] = {{200,3,7},{200,3,0},{200,3,0},{200,3,0},{200,3,100},};
const BCHP_PWR_P_DivTable BCHP_PWR_P_DivTable_DV_HVD_CTRL_CH5_div[] = {{200,3,6},{200,3,0},{200,3,0},{200,3,0},{200,3,100},};
const BCHP_PWR_P_DivTable BCHP_PWR_P_DivTable_DV_NETWORK_CTRL_CH5_div[] = {{125,3,3},{125,3,0},{125,3,0},{125,3,0},{125,3,100},};
const BCHP_PWR_P_DivTable BCHP_PWR_P_DivTable_DV_XPT_CTRL_CH4_div[] = {{120,2,7},{120,2,0},{120,2,0},{120,2,0},{120,2,100},};
...
const BCHP_PWR_P_FreqMap BCHP_PWR_P_FreqMapList[BCHP_PWR_P_NUM_DIVS] = {
    ...
    {BCHP_PWR_DV_HVD_CTRL_CH1_div, BCHP_PWR_P_DivTable_DV_HVD_CTRL_CH1_div},
    {BCHP_PWR_DV_HVD_CTRL_CH2_div, BCHP_PWR_P_DivTable_DV_HVD_CTRL_CH2_div},
    {BCHP_PWR_DV_HVD_CTRL_CH5_div, BCHP_PWR_P_DivTable_DV_HVD_CTRL_CH5_div},
    {BCHP_PWR_DV_NETWORK_CTRL_CH5_div, BCHP_PWR_P_DivTable_DV_NETWORK_CTRL_CH5_div},
    {BCHP_PWR_DV_XPT_CTRL_CH4_div, BCHP_PWR_P_DivTable_DV_XPT_CTRL_CH4_div},
};
