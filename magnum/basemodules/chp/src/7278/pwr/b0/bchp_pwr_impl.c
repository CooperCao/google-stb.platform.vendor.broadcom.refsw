...
static void BCHP_PWR_P_HW_ASP_Control(BCHP_Handle handle, bool activate)
{
    ...
    mask = (BCHP_CLKGEN_ASP_TOP_INST_CLOCK_ENABLE_ASPT_SCB_CLOCK_ENABLE_MASK |
            BCHP_CLKGEN_ASP_TOP_INST_CLOCK_ENABLE_ASPT54_CLOCK_ENABLE_MASK |
...
static void BCHP_PWR_P_HW_ASP_HVD0_HVD1_Control(BCHP_Handle handle, bool activate)
{
    uint32_t mask, reg;

    BDBG_MSG(("HW_ASP_HVD0_HVD1: %s", activate?"on":"off"));

    reg = BREG_Read32(handle->regHandle, BCHP_CLKGEN_HVD0_TOP_INST_CLOCK_ENABLE);
    mask = BCHP_CLKGEN_HVD0_TOP_INST_CLOCK_ENABLE_HVD0_ASP_SEC_CLOCK_ENABLE_MASK;
    reg &= ~mask;
    reg |= activate?mask:0;
...
static void BCHP_PWR_P_HW_HVD1_Control(BCHP_Handle handle, bool activate)
{
    ...
    mask = (BCHP_CLKGEN_HVD1_TOP_INST_CLOCK_ENABLE_HVD1_SCB_CLOCK_ENABLE_MASK |
            BCHP_CLKGEN_HVD1_TOP_INST_CLOCK_ENABLE_HVD1_108_CLOCK_ENABLE_MASK |
...
static void BCHP_PWR_P_HW_SC1_RESET_RESETD_Control(BCHP_Handle handle, bool activate)
{
    ...
    mask = (BCHP_CLKGEN_PLL_SC1_PLL_RESET_RESETA_MASK |
            BCHP_CLKGEN_PLL_SC1_PLL_RESET_RESETD_MASK);
    reg &= ~mask;
    reg |= activate?0:mask;
...
static void BCHP_PWR_P_HW_VICE20_Control(BCHP_Handle handle, bool activate)
{
    ...
    mask = (BCHP_CLKGEN_VICE_0_INST_CLOCK_ENABLE_VICE_0_54_CLOCK_ENABLE_MASK |
            ...
            BCHP_CLKGEN_VICE_0_INST_CLOCK_ENABLE_VICE_0_BVB_BUS1_CLOCK_ENABLE_MASK |
...
static void BCHP_PWR_P_HW_XPT_XPT_CORE_XPT_REMUX_Control(BCHP_Handle handle, bool activate)
{
    uint32_t mask, reg;

    BDBG_MSG(("HW_XPT_XPT_CORE_XPT_REMUX: %s", activate?"on":"off"));
