...
static void BCHP_PWR_P_HW_DVPHR0_Control(BCHP_Handle handle, bool activate)
{
    ...
    mask = (BCHP_CLKGEN_DVP_HR_INST_CLOCK_ENABLE_DVPHR_BVB_324_CLOCK_ENABLE_MASK |
...
static void BCHP_PWR_P_HW_VEC_Control(BCHP_Handle handle, bool activate)
{
    ...
    mask = (BCHP_CLKGEN_VEC_AIO_GFX_TOP_INST_CLOCK_ENABLE_VEC_VEC_BVB_648_CLOCK_ENABLE_VEC_MASK |
            ...
            BCHP_CLKGEN_VEC_AIO_GFX_TOP_INST_CLOCK_ENABLE_VEC_VEC_BVB_BUS1_CLOCK_ENABLE_VEC_MASK |
