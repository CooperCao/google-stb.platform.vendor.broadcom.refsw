...
const BCHP_PmapSettings BCHP_PWR_P_DefaultPMapSettings[BCHP_PWR_NUM_P_PMAPSETTINGS] = {
    PMAP(CLKGEN_PLL_AVX_PLL_CHANNEL_CTRL_CH_0, MDIV_CH0, 9),
    PMAP(CLKGEN_PLL_AVX_PLL_CHANNEL_CTRL_CH_1, MDIV_CH1, 7),
    PMAP(CLKGEN_PLL_AVX_PLL_CHANNEL_CTRL_CH_2, MDIV_CH2, 9),
    PMAP(CLKGEN_PLL_AVX_PLL_CHANNEL_CTRL_CH_3, MDIV_CH3, 6),
    PMAP(CLKGEN_PLL_AVX_PLL_CHANNEL_CTRL_CH_4, MDIV_CH4, 8),
    PMAP(CLKGEN_PLL_CPU_PLL_CHANNEL_CTRL_CH_1, MDIV_CH1, 7),
    ...
    PMAP(CLKGEN_PLL_CPU_PLL_CHANNEL_CTRL_CH_5, MDIV_CH5, 9),
    PMAP(CLKGEN_PLL_RAAGA_PLL_CHANNEL_CTRL_CH_0, MDIV_CH0, 5),
};

DIVTABLE(DV_PLL_AVX_CH0, -1, -1, 0);
DIVTABLE(DV_PLL_AVX_CH1, -1, -1, 1);
DIVTABLE(DV_PLL_AVX_CH2, -1, -1, 2);
DIVTABLE(DV_PLL_AVX_CH3, -1, -1, 3);
DIVTABLE(DV_PLL_AVX_CH4, -1, -1, 4);
DIVTABLE(DV_PLL_CPU_CH1, -1, -1, 5);
DIVTABLE(DV_PLL_CPU_CH2, -1, -1, 6);
DIVTABLE(DV_PLL_CPU_CH3, -1, -1, 7);
DIVTABLE(DV_PLL_CPU_CH4, -1, -1, 8);
DIVTABLE(DV_PLL_CPU_CH5, -1, -1, 9);
DIVTABLE(DV_PLL_RAAGA_PLL_CH0, -1, -1, 10);

const BCHP_PWR_P_FreqMap BCHP_PWR_P_FreqMapList[BCHP_PWR_P_NUM_DIVS] = {
    FREQMAP(DV_PLL_AVX_CH0),
    FREQMAP(DV_PLL_AVX_CH1),
    FREQMAP(DV_PLL_AVX_CH2),
    FREQMAP(DV_PLL_AVX_CH3),
    FREQMAP(DV_PLL_AVX_CH4),
    FREQMAP(DV_PLL_CPU_CH1),
    FREQMAP(DV_PLL_CPU_CH2),
    FREQMAP(DV_PLL_CPU_CH3),
    FREQMAP(DV_PLL_CPU_CH4),
    FREQMAP(DV_PLL_CPU_CH5),
