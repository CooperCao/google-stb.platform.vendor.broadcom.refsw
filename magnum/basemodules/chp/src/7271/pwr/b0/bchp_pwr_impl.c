...
static void BCHP_PWR_P_HW_CPU_CH_CTRL_CH_4_POST_DIV_HOLD_CH4_Control(BCHP_Handle handle, bool activate)
{
    ...
    reg = BREG_Read32(handle->regHandle, BCHP_CLKGEN_PLL_CPU_PLL_CHANNEL_CTRL_CH_4);
    mask = (BCHP_CLKGEN_PLL_CPU_PLL_CHANNEL_CTRL_CH_4_CLOCK_DIS_CH4_MASK |
            BCHP_CLKGEN_PLL_CPU_PLL_CHANNEL_CTRL_CH_4_POST_DIVIDER_HOLD_CH4_MASK);
    reg &= ~mask;
    reg |= activate?0:mask;
    BREG_Write32(handle->regHandle, BCHP_CLKGEN_PLL_CPU_PLL_CHANNEL_CTRL_CH_4, reg);
}
...
static void BCHP_PWR_P_HW_HVD0_Control(BCHP_Handle handle, bool activate)
{
    ...
    mask = (BCHP_CLKGEN_STB_HVDS0_TOP_INST_CLOCK_ENABLE_HVDS0_108_CLOCK_ENABLE_MASK |
...
static void BCHP_PWR_P_HW_M2MC0_Control(BCHP_Handle handle, bool activate)
{
    ...
    mask = (BCHP_CLKGEN_STB_VEC_AIO_GFX_TOP_INST_CLOCK_ENABLE_M2MC0_SYSTEM_SCB_CLOCK_ENABLE_M2MC0_MASK |
            BCHP_CLKGEN_STB_VEC_AIO_GFX_TOP_INST_CLOCK_ENABLE_M2MC0_SYSTEM_GISB_CLOCK_ENABLE_M2MC0_MASK);
    reg &= ~mask;
    reg |= activate?mask:0;
...
static void BCHP_PWR_P_HW_XPT_REMUX_Control(BCHP_Handle handle, bool activate)
{
    ...
    mask = (BCHP_CLKGEN_STB_CORE_XPT_HIF_INST_CLOCK_DISABLE_DISABLE_XPT_81_CLOCK_MASK |
