...
static void BCHP_PWR_P_HW_AIO_RAAGA0_Control(BCHP_Handle handle, bool activate)
{
    ...
    mask = (BCHP_CLKGEN_STB_RAAGA_DSP_TOP_0_INST_CLOCK_ENABLE_RAAGA0_SYSTEM_GISB_CLOCK_ENABLE_RAAGA0_MASK |
...
static void BCHP_PWR_P_HW_AVX_CH_CTRL_CH_3_POST_DIV_HOLD_CH3_Control(BCHP_Handle handle, bool activate)
{
    ...
    reg = BREG_Read32(handle->regHandle, BCHP_CLKGEN_PLL_AVX_PLL_CHANNEL_CTRL_CH_3);
    mask = (BCHP_CLKGEN_PLL_AVX_PLL_CHANNEL_CTRL_CH_3_CLOCK_DIS_CH3_MASK |
            BCHP_CLKGEN_PLL_AVX_PLL_CHANNEL_CTRL_CH_3_POST_DIVIDER_HOLD_CH3_MASK);
    reg &= ~mask;
    reg |= activate?0:mask;
    BREG_Write32(handle->regHandle, BCHP_CLKGEN_PLL_AVX_PLL_CHANNEL_CTRL_CH_3, reg);
}
...
static void BCHP_PWR_P_HW_DVPHT0_Control(BCHP_Handle handle, bool activate)
{
    ...
    mask = (BCHP_CLKGEN_STB_DVP_MHT_INST_CLOCK_ENABLE_DVPMHT_108_CLOCK_ENABLE_MASK |
...
static void BCHP_PWR_P_HW_V3D_RESET_RESETD_Control(BCHP_Handle handle, bool activate)
{
    ...
    mask = (BCHP_CLKGEN_PLL_V3D_PLL_RESET_RESETD_MASK |
            BCHP_CLKGEN_PLL_V3D_PLL_RESET_RESETA_MASK);
    reg &= ~mask;
    reg |= activate?0:mask;
...
static void BCHP_PWR_P_HW_VEC_Control(BCHP_Handle handle, bool activate)
{
    ...
    mask = (BCHP_CLKGEN_STB_VEC_AIO_GFX_TOP_INST_CLOCK_ENABLE_VEC_SYSTEM_BVB_324_CLOCK_ENABLE_VEC_MASK |
...
static void BCHP_PWR_P_HW_XPT_REMUX_Control(BCHP_Handle handle, bool activate)
{
    ...
    mask = (BCHP_CLKGEN_STB_CORE_XPT_HIF_INST_CLOCK_DISABLE_DISABLE_XPT_20P25_CLOCK_MASK |
