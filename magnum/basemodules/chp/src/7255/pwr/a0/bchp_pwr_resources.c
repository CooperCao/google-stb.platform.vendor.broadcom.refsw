...
const BCHP_PmapSettings BCHP_PWR_P_DefaultPMapSettings[BCHP_PWR_NUM_P_PMAPSETTINGS] = {
    PMAP(CLKGEN_PLL_AVX_PLL_CHANNEL_CTRL_CH_0, MDIV_CH0, 120),
    PMAP(CLKGEN_PLL_AVX_PLL_CHANNEL_CTRL_CH_1, MDIV_CH1, 100),
    PMAP(CLKGEN_PLL_AVX_PLL_CHANNEL_CTRL_CH_2, MDIV_CH2, 101),
    PMAP(CLKGEN_PLL_AVX_PLL_CHANNEL_CTRL_CH_3, MDIV_CH3, 100),
    PMAP(CLKGEN_PLL_AVX_PLL_CHANNEL_CTRL_CH_4, MDIV_CH4, 135),
    ...
    PMAP(CLKGEN_PLL_RAAGA_PLL_CHANNEL_CTRL_CH_0, MDIV_CH0, 87),
