...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_PLL_AC1[] = {{
    BCHP_PWR_P_ResourceType_eLeaf,
    BCHP_PWR_HW_PLL_AC1,
    "HW_PLL_AC1"
}};
...
const BCHP_PWR_P_Resource* const BCHP_PWR_P_ResourceList[BCHP_PWR_P_NUM_ALLNODES] = {
    ...
    BCHP_PWR_P_Resource_HW_PLL_AC1,
};
...
void BCHP_PWR_P_HW_ControlId(BCHP_Handle handle, unsigned id, bool activate)
{
    switch(id) {
        ...
        case BCHP_PWR_HW_SCD:
            ...
            break;
        case BCHP_PWR_HW_PLL_AC1:
            BCHP_PWR_P_HW_PLL_AC1_Control(handle, activate);
            break;
        default:
            BDBG_ASSERT(0);
            break;
