...
static void BCHP_PWR_P_HW_PLL_AC1_Control(BCHP_Handle handle, bool activate)
{
    uint32_t val;
    ...
    if (activate) {
        /* power up VC */
		 BREG_AtomicUpdate32(handle->regHandle, BCHP_VCXO_CTL_MISC_VC0_CTRL, BCHP_VCXO_CTL_MISC_VC0_CTRL_DRESET_MASK, 0);
		 BREG_AtomicUpdate32(handle->regHandle, BCHP_VCXO_CTL_MISC_VC0_CTRL, BCHP_VCXO_CTL_MISC_VC0_CTRL_ARESET_MASK, 0);   
		 BREG_AtomicUpdate32(handle->regHandle, BCHP_VCXO_CTL_MISC_VC0_CTRL, BCHP_VCXO_CTL_MISC_VC0_CTRL_POWERDOWN_MASK, 0);
        ...
        /* power down VC */
		 BREG_AtomicUpdate32(handle->regHandle, BCHP_VCXO_CTL_MISC_VC0_CTRL, BCHP_VCXO_CTL_MISC_VC0_CTRL_DRESET_MASK, BCHP_VCXO_CTL_MISC_VC0_CTRL_DRESET_MASK);
		 BREG_AtomicUpdate32(handle->regHandle, BCHP_VCXO_CTL_MISC_VC0_CTRL, BCHP_VCXO_CTL_MISC_VC0_CTRL_ARESET_MASK, BCHP_VCXO_CTL_MISC_VC0_CTRL_ARESET_MASK);   
		 BREG_AtomicUpdate32(handle->regHandle, BCHP_VCXO_CTL_MISC_VC0_CTRL, BCHP_VCXO_CTL_MISC_VC0_CTRL_POWERDOWN_MASK, BCHP_VCXO_CTL_MISC_VC0_CTRL_POWERDOWN_MASK);
