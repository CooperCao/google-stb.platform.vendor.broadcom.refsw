...
sub generate_brcm_copyright_header
{
    ...
    push @lines, " /******************************************************************************\n";
    push @lines, " *  Copyright (C) 2018 Broadcom.\n";
    push @lines, " *  The term".' "Broadcom" '."refers to Broadcom Limited and/or its subsidiaries.\n";
    push @lines, " *\n";
    push @lines, " *  This program is the proprietary software of Broadcom and/or its licensors,\n";
    push @lines, " *  and may only be used, duplicated, modified or distributed pursuant to\n";
    push @lines, " *  the terms and conditions of a separate, written license agreement executed\n";
    push @lines, " *  between you and Broadcom (an ".'"Authorized License"'.").  Except as set forth in\n";
    push @lines, " *  an Authorized License, Broadcom grants no license (express or implied),\n";
    push @lines, " *  right to use, or waiver of any kind with respect to the Software, and\n";
    push @lines, " *  Broadcom expressly reserves all rights in and to the Software and all\n";
    push @lines, " *  intellectual property rights therein.  IF YOU HAVE NO AUTHORIZED LICENSE,\n";
    push @lines, " *  THEN YOU HAVE NO RIGHT TO USE THIS SOFTWARE IN ANY WAY, AND SHOULD \n";
    push @lines, " *  IMMEDIATELY NOTIFY BROADCOM AND DISCONTINUE ALL USE OF THE SOFTWARE.\n";
    push @lines, " *\n";
    push @lines, " *  Except as expressly set forth in the Authorized License,\n";
    push @lines, " *\n";
    push @lines, " *  1.     This program, including its structure, sequence and organization,\n";
    push @lines, " *  constitutes the valuable trade secrets of Broadcom, and you shall use all\n";
    push @lines, " *  reasonable efforts to protect the confidentiality thereof, and to use this\n";
    push @lines, " *  information only in connection with your use of Broadcom integrated circuit\n";
    push @lines, " *  products.\n";
    push @lines, " *\n";
    push @lines, " *  2.     TO THE MAXIMUM EXTENT PERMITTED BY LAW, THE SOFTWARE IS PROVIDED\n";
    push @lines, " *  ".' "AS IS"'." AND WITH ALL FAULTS AND BROADCOM MAKES NO PROMISES, REPRESENTATIONS\n";
    push @lines, " *  OR WARRANTIES, EITHER EXPRESS, IMPLIED, STATUTORY, OR OTHERWISE, WITH\n";
    push @lines, " *  RESPECT TO THE SOFTWARE.  BROADCOM SPECIFICALLY DISCLAIMS ANY AND ALL\n";
    push @lines, " *  IMPLIED WARRANTIES OF TITLE, MERCHANTABILITY, NONINFRINGEMENT, FITNESS FOR\n";
    push @lines, " *  A PARTICULAR PURPOSE, LACK OF VIRUSES, ACCURACY OR COMPLETENESS, QUIET\n";
    push @lines, " *  ENJOYMENT, QUIET POSSESSION OR CORRESPONDENCE TO DESCRIPTION. YOU ASSUME\n";
    push @lines, " *  THE ENTIRE RISK ARISING OUT OF USE OR PERFORMANCE OF THE SOFTWARE.\n";
    push @lines, " *\n";
    push @lines, " *  3.     TO THE MAXIMUM EXTENT PERMITTED BY LAW, IN NO EVENT SHALL BROADCOM\n";
    push @lines, " *  OR ITS LICENSORS BE LIABLE FOR (i) CONSEQUENTIAL, INCIDENTAL, SPECIAL,\n";
    push @lines, " *  INDIRECT, OREXEMPLARY DAMAGES WHATSOEVER ARISING OUT OF OR IN ANY WAY\n";
    push @lines, " *  RELATING TO YOUR USE OF OR INABILITY TO USE THE SOFTWARE EVEN IF BROADCOM\n";
    push @lines, " *  HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES; OR (ii) ANY AMOUNT IN\n";
    push @lines, " *  EXCESS OF THE AMOUNT ACTUALLY PAID FOR THE SOFTWARE ITSELF OR U.S.".' $1'.",\n";
    push @lines, " *  WHICHEVER IS GREATER. THESE LIMITATIONS SHALL APPLY NOTWITHSTANDING ANY\n";
    push @lines, " *  FAILURE OF ESSENTIAL PURPOSE OF ANY LIMITED REMEDY.\n";
    push @lines, "\n";
    push @lines, " ******************************************************************************/\n";
    push @lines, "\n";
    return @lines;
