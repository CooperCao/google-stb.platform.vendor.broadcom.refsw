...
#endif
#ifdef BCHP_V3D_TOP_GR_BRIDGE_REG_START
#if defined (BCHP_V3D_TOP_GR_BRIDGE_SW_INIT_0_V3D_SW_INIT_SHIFT)
    BREG_Write32(hReg, BCHP_V3D_TOP_GR_BRIDGE_SW_INIT_0, BCHP_FIELD_ENUM(V3D_TOP_GR_BRIDGE_SW_INIT_0, V3D_SW_INIT, ASSERT));
    BREG_Write32(hReg, BCHP_V3D_TOP_GR_BRIDGE_SW_INIT_0, BCHP_FIELD_ENUM(V3D_TOP_GR_BRIDGE_SW_INIT_0, V3D_SW_INIT, DEASSERT));
#elif defined (BCHP_V3D_TOP_GR_BRIDGE_SW_INIT_0_SPARE_SW_INIT_SHIFT)
