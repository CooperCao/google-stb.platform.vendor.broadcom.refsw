...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_VEC_AIO_54[] = {{
    BCHP_PWR_P_ResourceType_eLeaf,
    BCHP_PWR_HW_VEC_AIO_54,
    BDBG_STRING("HW_VEC_AIO_54")
}};
...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_VEC_BVB_216[] = {{
    BCHP_PWR_P_ResourceType_eLeaf,
    BCHP_PWR_HW_VEC_BVB_216,
    BDBG_STRING("HW_VEC_BVB_216")
}};
...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_M2MC_54[] = {{
    BCHP_PWR_P_ResourceType_eLeaf,
    BCHP_PWR_HW_M2MC_54,
    BDBG_STRING("HW_M2MC_54")
}};
...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_PLL_V3D_CH0[] = {{
    BCHP_PWR_P_ResourceType_eNonLeafHw,
    BCHP_PWR_HW_PLL_V3D_CH0,
    BDBG_STRING("HW_PLL_V3D_CH0")
}};
...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_DV_PLL_V3D_CH0[] = {{
    BCHP_PWR_P_ResourceType_eDiv,
    BCHP_PWR_DV_PLL_V3D_CH0,
    BDBG_STRING("DV_PLL_V3D_CH0")
}};
...
const BCHP_PWR_P_Resource* const BCHP_PWR_P_ResourceList[BCHP_PWR_P_NUM_ALLNODES] = {
    ...
    BCHP_PWR_P_Resource_HW_VEC_AIO_54,
    ...
    BCHP_PWR_P_Resource_HW_VEC_BVB_216,
    ...
    BCHP_PWR_P_Resource_HW_M2MC_54,
    ...
    BCHP_PWR_P_Resource_HW_PLL_V3D_CH0,
    ...
    BCHP_PWR_P_Resource_DV_PLL_V3D_CH0,
...
static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_PLL_V3D_CH0[] = {
    BCHP_PWR_P_Resource_DV_PLL_V3D_CH0,
    NULL
};
...
const BCHP_PWR_P_Resource* const * const BCHP_PWR_P_DependList[BCHP_PWR_P_NUM_ALLNODES] = {
    ...
    NULL,
    NULL,
    BCHP_PWR_P_Depend_HW_PLL_V3D_CH0,
...
void BCHP_PWR_P_HW_ControlId(BCHP_Handle handle, unsigned id, bool activate)
{
    switch(id) {
        ...
        case BCHP_PWR_HW_AIO:
            ...
            break;
        case BCHP_PWR_HW_VEC_AIO_54:
            BCHP_PWR_P_HW_VEC_AIO_54_Control(handle, activate);
            break;
        ...
        case BCHP_PWR_HW_VEC:
            ...
            break;
        case BCHP_PWR_HW_VEC_BVB_216:
            BCHP_PWR_P_HW_VEC_BVB_216_Control(handle, activate);
            break;
        ...
        case BCHP_PWR_HW_M2MC0:
            ...
            break;
        case BCHP_PWR_HW_M2MC_54:
            BCHP_PWR_P_HW_M2MC_54_Control(handle, activate);
            break;
        ...
        case BCHP_PWR_HW_PLL_VCXO_PLL1_CH2:
            ...
            break;
        case BCHP_PWR_HW_PLL_V3D_CH0:
            BCHP_PWR_P_HW_PLL_V3D_CH0_Control(handle, activate);
            break;
...
void BCHP_PWR_P_DIV_Control(BCHP_Handle handle, const BCHP_PWR_P_Resource *resource, unsigned *mult, unsigned *prediv, unsigned *postdiv, bool set)
{
    ...
    switch(resource->id) {
        ...
        case BCHP_PWR_DV_PLL_HVD_CH1:
            ...
            break;
        case BCHP_PWR_DV_PLL_V3D_CH0:
            BCHP_PWR_P_DV_PLL_V3D_CH0_Control(handle, mult, prediv, postdiv, set);
            break;
