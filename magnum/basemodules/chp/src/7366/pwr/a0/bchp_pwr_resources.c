...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_HVD0_SCB_54_CLK[] = {{
    BCHP_PWR_P_ResourceType_eLeaf,
    BCHP_PWR_HW_HVD0_SCB_54_CLK,
    BDBG_STRING("HW_HVD0_SCB_54_CLK")
}};
...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_PLL_XPT_CH5[] = {{
    BCHP_PWR_P_ResourceType_eLeaf,
    BCHP_PWR_HW_PLL_XPT_CH5,
    BDBG_STRING("HW_PLL_XPT_CH5")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_PLL_NETWORK_CH3[] = {{
    BCHP_PWR_P_ResourceType_eLeaf,
    BCHP_PWR_HW_PLL_NETWORK_CH3,
    BDBG_STRING("HW_PLL_NETWORK_CH3")
}};
...
const BCHP_PWR_P_Resource* const BCHP_PWR_P_ResourceList[BCHP_PWR_P_NUM_ALLNODES] = {
    ...
    BCHP_PWR_P_Resource_HW_HVD0_SCB_54_CLK,
    ...
    BCHP_PWR_P_Resource_HW_PLL_XPT_CH5,
    BCHP_PWR_P_Resource_HW_PLL_NETWORK_CH3,
...
void BCHP_PWR_P_HW_ControlId(BCHP_Handle handle, unsigned id, bool activate)
{
    switch(id) {
        ...
        case BCHP_PWR_HW_HVD0_CPU_CLK:
            ...
            break;
        case BCHP_PWR_HW_HVD0_SCB_54_CLK:
            BCHP_PWR_P_HW_HVD0_SCB_54_CLK_Control(handle, activate);
            break;
        ...
        case BCHP_PWR_HW_PLL_VCXO_PLL1:
            ...
            break;
        case BCHP_PWR_HW_PLL_XPT_CH5:
            BCHP_PWR_P_HW_PLL_XPT_CH5_Control(handle, activate);
            break;
        case BCHP_PWR_HW_PLL_NETWORK_CH3:
            BCHP_PWR_P_HW_PLL_NETWORK_CH3_Control(handle, activate);
            break;
