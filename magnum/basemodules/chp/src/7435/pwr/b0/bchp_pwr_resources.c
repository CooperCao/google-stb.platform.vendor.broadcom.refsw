...
const BCHP_PmapSettings BCHP_PWR_P_DefaultPMapSettings[BCHP_PWR_NUM_P_PMAPSETTINGS] = {
    PMAP(CLKGEN_PLL_AVD1_PLL_CHANNEL_CTRL_CH_0, MDIV_CH0, 9),
    PMAP(CLKGEN_PLL_AVD1_PLL_CHANNEL_CTRL_CH_1, MDIV_CH1, 7),
    PMAP(CLKGEN_PLL_AVD1_PLL_CHANNEL_CTRL_CH_2, MDIV_CH2, 9),
    PMAP(CLKGEN_PLL_AVD1_PLL_CHANNEL_CTRL_CH_3, MDIV_CH3, 7),
    PMAP(CLKGEN_PLL_MOCA_PLL_CHANNEL_CTRL_CH_3, MDIV_CH3, 9),
    PMAP(CLKGEN_PLL_XPT_PLL_CHANNEL_CTRL_CH_1, MDIV_CH1, 10),
    PMAP(CLKGEN_PLL_XPT_PLL_CHANNEL_CTRL_CH_2, MDIV_CH2, 10),
};

DIVTABLE(DV_PLL_AVD1_CH0, -1, -1, 0);
DIVTABLE(DV_PLL_AVD1_CH1, -1, -1, 1);
DIVTABLE(DV_PLL_AVD1_CH2, -1, -1, 2);
DIVTABLE(DV_PLL_AVD1_CH3, -1, -1, 3);
DIVTABLE(DV_PLL_MOCA_CH3, -1, -1, 4);
DIVTABLE(DV_PLL_XPT_CH1, -1, -1, 5);
DIVTABLE(DV_PLL_XPT_CH2, -1, -1, 6);

const BCHP_PWR_P_FreqMap BCHP_PWR_P_FreqMapList[BCHP_PWR_P_NUM_DIVS] = {
    FREQMAP(DV_PLL_AVD1_CH0),
    FREQMAP(DV_PLL_AVD1_CH1),
    FREQMAP(DV_PLL_AVD1_CH2),
    FREQMAP(DV_PLL_AVD1_CH3),
    FREQMAP(DV_PLL_MOCA_CH3),
    FREQMAP(DV_PLL_XPT_CH1),
    FREQMAP(DV_PLL_XPT_CH2),
};
