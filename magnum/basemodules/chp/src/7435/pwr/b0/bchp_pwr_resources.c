...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_SVD0_SCB_108_CLK[] = {{
    ...
    BDBG_STRING("HW_SVD0_SCB_108_CLK")
}};
...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_VICE0_108_CLK[] = {{
    BCHP_PWR_P_ResourceType_eLeaf,
    BCHP_PWR_HW_VICE0_108_CLK,
    BDBG_STRING("HW_VICE0_108_CLK")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_VICE0_PWR[] = {{
    BCHP_PWR_P_ResourceType_eLeaf,
    BCHP_PWR_HW_VICE0_PWR,
    BDBG_STRING("HW_VICE0_PWR")
}};
...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_VICE1_108_CLK[] = {{
    BCHP_PWR_P_ResourceType_eLeaf,
    BCHP_PWR_HW_VICE1_108_CLK,
    BDBG_STRING("HW_VICE1_108_CLK")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_VICE1_PWR[] = {{
    BCHP_PWR_P_ResourceType_eLeaf,
    BCHP_PWR_HW_VICE1_PWR,
    BDBG_STRING("HW_VICE1_PWR")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_RAAGA0_SCB_CLK[] = {{
    BCHP_PWR_P_ResourceType_eLeaf,
    BCHP_PWR_HW_RAAGA0_SCB_CLK,
    BDBG_STRING("HW_RAAGA0_SCB_CLK")
}};
...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_RAAGA1_SCB_CLK[] = {{
    BCHP_PWR_P_ResourceType_eLeaf,
    BCHP_PWR_HW_RAAGA1_SCB_CLK,
    BDBG_STRING("HW_RAAGA1_SCB_CLK")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_RAAGA1_108_CLK[] = {{
    BCHP_PWR_P_ResourceType_eLeaf,
    BCHP_PWR_HW_RAAGA1_108_CLK,
    BDBG_STRING("HW_RAAGA1_108_CLK")
}};
...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_RAAGA1_DSP_CLK[] = {{
    BCHP_PWR_P_ResourceType_eNonLeafHw,
    BCHP_PWR_HW_RAAGA1_DSP_CLK,
    BDBG_STRING("HW_RAAGA1_DSP_CLK")
}};
...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_PLL_VCXO_PLL2_CH1[] = {{
    BCHP_PWR_P_ResourceType_eNonLeafHw,
    BCHP_PWR_HW_PLL_VCXO_PLL2_CH1,
    BDBG_STRING("HW_PLL_VCXO_PLL2_CH1")
}};
...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_PLL_XPT_CH1[] = {{
    BCHP_PWR_P_ResourceType_eNonLeafHw,
    BCHP_PWR_HW_PLL_XPT_CH1,
    BDBG_STRING("HW_PLL_XPT_CH1")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_PLL_XPT_CH2[] = {{
    BCHP_PWR_P_ResourceType_eNonLeafHw,
    BCHP_PWR_HW_PLL_XPT_CH2,
    BDBG_STRING("HW_PLL_XPT_CH2")
}};
...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_DV_PLL_AVD1_CH0[] = {{
    BCHP_PWR_P_ResourceType_eDiv,
    BCHP_PWR_DV_PLL_AVD1_CH0,
    BDBG_STRING("DV_PLL_AVD1_CH0")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_DV_PLL_AVD1_CH1[] = {{
    BCHP_PWR_P_ResourceType_eDiv,
    BCHP_PWR_DV_PLL_AVD1_CH1,
    BDBG_STRING("DV_PLL_AVD1_CH1")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_DV_PLL_AVD1_CH2[] = {{
    BCHP_PWR_P_ResourceType_eDiv,
    BCHP_PWR_DV_PLL_AVD1_CH2,
    BDBG_STRING("DV_PLL_AVD1_CH2")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_DV_PLL_AVD1_CH3[] = {{
    BCHP_PWR_P_ResourceType_eDiv,
    BCHP_PWR_DV_PLL_AVD1_CH3,
    BDBG_STRING("DV_PLL_AVD1_CH3")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_DV_PLL_XPT_CH1[] = {{
    BCHP_PWR_P_ResourceType_eDiv,
    BCHP_PWR_DV_PLL_XPT_CH1,
    BDBG_STRING("DV_PLL_XPT_CH1")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_DV_PLL_XPT_CH2[] = {{
    BCHP_PWR_P_ResourceType_eDiv,
    BCHP_PWR_DV_PLL_XPT_CH2,
    BDBG_STRING("DV_PLL_XPT_CH2")
}};
...
const BCHP_PWR_P_Resource* const BCHP_PWR_P_ResourceList[BCHP_PWR_P_NUM_ALLNODES] = {
    ...
    BCHP_PWR_P_Resource_HW_RAAGA1_SCB_CLK,
    BCHP_PWR_P_Resource_HW_RAAGA1_108_CLK,
    BCHP_PWR_P_Resource_HW_RAAGA1_DSP_CLK,
    ...
    BCHP_PWR_P_Resource_HW_PLL_VCXO_PLL2_CH1,
    ...
    BCHP_PWR_P_Resource_HW_PLL_XPT_CH1,
    BCHP_PWR_P_Resource_HW_PLL_XPT_CH2,
    BCHP_PWR_P_Resource_HW_PLL_MOCA_CH3,
    BCHP_PWR_P_Resource_DV_PLL_AVD1_CH0,
    BCHP_PWR_P_Resource_DV_PLL_AVD1_CH1,
    BCHP_PWR_P_Resource_DV_PLL_AVD1_CH2,
    BCHP_PWR_P_Resource_DV_PLL_AVD1_CH3,
    BCHP_PWR_P_Resource_DV_PLL_XPT_CH1,
    BCHP_PWR_P_Resource_DV_PLL_XPT_CH2,
...
static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_SVD0_CORE_CLK[] = {
    BCHP_PWR_P_Resource_HW_PLL_AVD1_CH2,
    NULL
};

static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_SVD0_CPU_CLK[] = {
    BCHP_PWR_P_Resource_HW_PLL_AVD1_CH3,
    NULL
};

static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_AVD1_CORE_CLK[] = {
    BCHP_PWR_P_Resource_HW_PLL_AVD1_CH0,
    NULL
};

static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_AVD1_CPU_CLK[] = {
    BCHP_PWR_P_Resource_HW_PLL_AVD1_CH1,
    NULL
};
...
static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_RAAGA1_DSP_CLK[] = {
    BCHP_PWR_P_Resource_HW_PLL_RAAGA_PLL_CH1,
    NULL
};
...
static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_PLL_AVD1_CH0[] = {
    BCHP_PWR_P_Resource_DV_PLL_AVD1_CH0,
    NULL
};

static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_PLL_AVD1_CH1[] = {
    BCHP_PWR_P_Resource_DV_PLL_AVD1_CH1,
    NULL
};

static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_PLL_AVD1_CH2[] = {
    BCHP_PWR_P_Resource_DV_PLL_AVD1_CH2,
    NULL
};

static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_PLL_AVD1_CH3[] = {
    BCHP_PWR_P_Resource_DV_PLL_AVD1_CH3,
    NULL
};
...
static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_PLL_VCXO_PLL2_CH1[] = {
    BCHP_PWR_P_Resource_HW_PLL_VCXO_PLL2,
    NULL
};
...
static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_PLL_XPT_CH1[] = {
    BCHP_PWR_P_Resource_DV_PLL_XPT_CH1,
    NULL
};

static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_HW_PLL_XPT_CH2[] = {
    BCHP_PWR_P_Resource_DV_PLL_XPT_CH2,
    NULL
};
...
const BCHP_PWR_P_Resource* const * const BCHP_PWR_P_DependList[BCHP_PWR_P_NUM_ALLNODES] = {
    ...
    NULL,
    NULL,
    BCHP_PWR_P_Depend_HW_RAAGA1_DSP_CLK,
    NULL,
    NULL,
    NULL,
    NULL,
    ...
    BCHP_PWR_P_Depend_HW_PLL_VCXO_PLL2_CH1,
    ...
    NULL,
    BCHP_PWR_P_Depend_HW_PLL_XPT_CH1,
    BCHP_PWR_P_Depend_HW_PLL_XPT_CH2,
...
void BCHP_PWR_P_HW_ControlId(BCHP_Handle handle, unsigned id, bool activate)
{
    switch(id) {
        ...
        case BCHP_PWR_HW_VICE0_CORE_CLK:
            ...
            break;
        case BCHP_PWR_HW_VICE0_108_CLK:
            BCHP_PWR_P_HW_VICE0_108_CLK_Control(handle, activate);
            break;
        ...
        case BCHP_PWR_HW_VICE1_CORE_CLK:
            ...
            break;
        case BCHP_PWR_HW_VICE1_108_CLK:
            BCHP_PWR_P_HW_VICE1_108_CLK_Control(handle, activate);
            break;
        ...
        case BCHP_PWR_HW_AIO:
            ...
            break;
        case BCHP_PWR_HW_RAAGA0_SCB_CLK:
            BCHP_PWR_P_HW_RAAGA0_SCB_CLK_Control(handle, activate);
            break;
        ...
        case BCHP_PWR_HW_RAAGA0_SRAM:
            ...
            break;
        case BCHP_PWR_HW_RAAGA1_SCB_CLK:
            BCHP_PWR_P_HW_RAAGA1_SCB_CLK_Control(handle, activate);
            break;
        case BCHP_PWR_HW_RAAGA1_108_CLK:
            BCHP_PWR_P_HW_RAAGA1_108_CLK_Control(handle, activate);
            break;
        case BCHP_PWR_HW_RAAGA1_DSP_CLK:
            BCHP_PWR_P_HW_RAAGA1_DSP_CLK_Control(handle, activate);
            break;
        ...
        case BCHP_PWR_HW_PLL_VCXO_PLL2_CH0:
            ...
            break;
        case BCHP_PWR_HW_PLL_VCXO_PLL2_CH1:
            BCHP_PWR_P_HW_PLL_VCXO_PLL2_CH1_Control(handle, activate);
            break;
        ...
        case BCHP_PWR_HW_PLL_RAAGA:
            ...
            break;
        case BCHP_PWR_HW_PLL_XPT_CH1:
            BCHP_PWR_P_HW_PLL_XPT_CH1_Control(handle, activate);
            break;
        case BCHP_PWR_HW_PLL_XPT_CH2:
            BCHP_PWR_P_HW_PLL_XPT_CH2_Control(handle, activate);
            break;
...
void BCHP_PWR_P_DIV_Control(BCHP_Handle handle, const BCHP_PWR_P_Resource *resource, unsigned *mult, unsigned *prediv, unsigned *postdiv, bool set)
{
    ...
    switch(resource->id) {
        case BCHP_PWR_DV_PLL_AVD1_CH0:
            BCHP_PWR_P_DV_PLL_AVD1_CH0_Control(handle, mult, prediv, postdiv, set);
            break;
        case BCHP_PWR_DV_PLL_AVD1_CH1:
            BCHP_PWR_P_DV_PLL_AVD1_CH1_Control(handle, mult, prediv, postdiv, set);
            break;
        case BCHP_PWR_DV_PLL_AVD1_CH2:
            BCHP_PWR_P_DV_PLL_AVD1_CH2_Control(handle, mult, prediv, postdiv, set);
            break;
        case BCHP_PWR_DV_PLL_AVD1_CH3:
            BCHP_PWR_P_DV_PLL_AVD1_CH3_Control(handle, mult, prediv, postdiv, set);
            break;
        case BCHP_PWR_DV_PLL_XPT_CH1:
            BCHP_PWR_P_DV_PLL_XPT_CH1_Control(handle, mult, prediv, postdiv, set);
            break;
        case BCHP_PWR_DV_PLL_XPT_CH2:
            BCHP_PWR_P_DV_PLL_XPT_CH2_Control(handle, mult, prediv, postdiv, set);
            break;
...
const BCHP_PWR_P_DivTable BCHP_PWR_P_DivTable_DV_PLL_AVD1_CH0[] = {{164,3,9},{164,3,144}};
const BCHP_PWR_P_DivTable BCHP_PWR_P_DivTable_DV_PLL_AVD1_CH1[] = {{164,3,7},{164,3,112}};
const BCHP_PWR_P_DivTable BCHP_PWR_P_DivTable_DV_PLL_AVD1_CH2[] = {{164,3,9},{164,3,144}};
const BCHP_PWR_P_DivTable BCHP_PWR_P_DivTable_DV_PLL_AVD1_CH3[] = {{164,3,7},{164,3,112}};
const BCHP_PWR_P_DivTable BCHP_PWR_P_DivTable_DV_PLL_MOCA_CH3[] = {{200,3,9},{200,3,144}};
const BCHP_PWR_P_DivTable BCHP_PWR_P_DivTable_DV_PLL_XPT_CH1[] = {{130,2,10},{130,2,160}};
const BCHP_PWR_P_DivTable BCHP_PWR_P_DivTable_DV_PLL_XPT_CH2[] = {{130,2,10},{130,2,160}};

const BCHP_PWR_P_FreqMap BCHP_PWR_P_FreqMapList[BCHP_PWR_P_NUM_DIVS] = {
    {BCHP_PWR_DV_PLL_AVD1_CH0, BCHP_PWR_P_DivTable_DV_PLL_AVD1_CH0},
    {BCHP_PWR_DV_PLL_AVD1_CH1, BCHP_PWR_P_DivTable_DV_PLL_AVD1_CH1},
    {BCHP_PWR_DV_PLL_AVD1_CH2, BCHP_PWR_P_DivTable_DV_PLL_AVD1_CH2},
    {BCHP_PWR_DV_PLL_AVD1_CH3, BCHP_PWR_P_DivTable_DV_PLL_AVD1_CH3},
    {BCHP_PWR_DV_PLL_MOCA_CH3, BCHP_PWR_P_DivTable_DV_PLL_MOCA_CH3},
    {BCHP_PWR_DV_PLL_XPT_CH1, BCHP_PWR_P_DivTable_DV_PLL_XPT_CH1},
    {BCHP_PWR_DV_PLL_XPT_CH2, BCHP_PWR_P_DivTable_DV_PLL_XPT_CH2},
};
