...
static void BCHP_PWR_P_HW_RAAGA0_Control(BCHP_Handle handle, bool activate)
{
    ...
    mask = (BCHP_CLKGEN_RAAGA_DSP_TOP_WRAP_INST_CLOCK_ENABLE0_RAAGA_SCB_CLOCK_ENABLE0_MASK |
	    BCHP_CLKGEN_RAAGA_DSP_TOP_WRAP_INST_CLOCK_ENABLE0_RAAGA_DSP_CLOCK_ENABLE0_MASK |
	    BCHP_CLKGEN_RAAGA_DSP_TOP_WRAP_INST_CLOCK_ENABLE0_RAAGA_108_CLOCK_ENABLE0_MASK);

    BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_RAAGA_DSP_TOP_WRAP_INST_CLOCK_ENABLE0, mask, activate?mask:0);
}
...
static void BCHP_PWR_P_HW_RAAGA0_SRAM_Control(BCHP_Handle handle, bool activate)
{
    ...
    mask = BCHP_CLKGEN_RAAGA_DSP_TOP_WRAP_INST_POWER_SWITCH_MEMORY0_RAAGA_POWER_SWITCH_MEMORY0_MASK;

    if(activate) {
	BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_RAAGA_DSP_TOP_WRAP_INST_POWER_SWITCH_MEMORY0, mask, 2);
	BKNI_Delay(10);
	BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_RAAGA_DSP_TOP_WRAP_INST_POWER_SWITCH_MEMORY0, mask, 0);
	BKNI_Delay(10);
    } else {
	BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_RAAGA_DSP_TOP_WRAP_INST_POWER_SWITCH_MEMORY0, mask, mask);
    }    
}
...
static void BCHP_PWR_P_HW_RAAGA1_Control(BCHP_Handle handle, bool activate)
{
    ...
    mask = (BCHP_CLKGEN_RAAGA_DSP_TOP_WRAP_INST_CLOCK_ENABLE1_RAAGA_SCB_CLOCK_ENABLE1_MASK |
	    BCHP_CLKGEN_RAAGA_DSP_TOP_WRAP_INST_CLOCK_ENABLE1_RAAGA_DSP_CLOCK_ENABLE1_MASK |
	    BCHP_CLKGEN_RAAGA_DSP_TOP_WRAP_INST_CLOCK_ENABLE1_RAAGA_108_CLOCK_ENABLE1_MASK);

    BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_RAAGA_DSP_TOP_WRAP_INST_CLOCK_ENABLE1, mask, activate?mask:0);
}
...
static void BCHP_PWR_P_HW_RAAGA1_SRAM_Control(BCHP_Handle handle, bool activate)
{
    ...
    mask = BCHP_CLKGEN_RAAGA_DSP_TOP_WRAP_INST_POWER_SWITCH_MEMORY1_RAAGA_POWER_SWITCH_MEMORY1_MASK;

    if(activate) {
	BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_RAAGA_DSP_TOP_WRAP_INST_POWER_SWITCH_MEMORY1, mask, 2);
	BKNI_Delay(10);
	BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_RAAGA_DSP_TOP_WRAP_INST_POWER_SWITCH_MEMORY1, mask, 0);
	BKNI_Delay(10);
    } else {
	BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_RAAGA_DSP_TOP_WRAP_INST_POWER_SWITCH_MEMORY1, mask, mask);
    }
}
...
static void BCHP_PWR_P_HW_SID_Control(BCHP_Handle handle, bool activate)
{
    ...
    mask = BCHP_CLKGEN_AVD0_TOP_INST_CLOCK_ENABLE_SID_SID_216_CLOCK_ENABLE_SID_MASK;
...
static void BCHP_PWR_P_HW_PLL_AVD_Control(BCHP_Handle handle, bool activate)
{
	...
	mask = BCHP_CLKGEN_PM_PLL_LDO_POWERUP_ISO_CLOCK_PLL_AVD1_MASK;
