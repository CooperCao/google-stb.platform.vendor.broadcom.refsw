...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_AVD0_SCB_CLK[] = {{
    BCHP_PWR_P_ResourceType_eLeaf,
    BCHP_PWR_HW_AVD0_SCB_CLK,
    BDBG_STRING("HW_AVD0_SCB_CLK")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_AVD0_108_CLK[] = {{
    BCHP_PWR_P_ResourceType_eLeaf,
    BCHP_PWR_HW_AVD0_108_CLK,
    BDBG_STRING("HW_AVD0_108_CLK")
}};
...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_RFM_SRAM[] = {{
    BCHP_PWR_P_ResourceType_eLeaf,
    BCHP_PWR_HW_RFM_SRAM,
    BDBG_STRING("HW_RFM_SRAM")
}};
...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_DV_PLL_AVD_CH0[] = {{
    BCHP_PWR_P_ResourceType_eDiv,
    BCHP_PWR_DV_PLL_AVD_CH0,
    BDBG_STRING("DV_PLL_AVD_CH0")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_DV_PLL_AVD_CH1[] = {{
    BCHP_PWR_P_ResourceType_eDiv,
    BCHP_PWR_DV_PLL_AVD_CH1,
    BDBG_STRING("DV_PLL_AVD_CH1")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_DV_PLL_AVD_CH2[] = {{
    BCHP_PWR_P_ResourceType_eDiv,
    BCHP_PWR_DV_PLL_AVD_CH2,
    BDBG_STRING("DV_PLL_AVD_CH2")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_DV_PLL_AVD_CH3[] = {{
    BCHP_PWR_P_ResourceType_eDiv,
    BCHP_PWR_DV_PLL_AVD_CH3,
    BDBG_STRING("DV_PLL_AVD_CH3")
}};

const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_DV_PLL_AVD_CH4[] = {{
    BCHP_PWR_P_ResourceType_eDiv,
    BCHP_PWR_DV_PLL_AVD_CH4,
    BDBG_STRING("DV_PLL_AVD_CH4")
}};
...
const BCHP_PWR_P_Resource* const BCHP_PWR_P_ResourceList[BCHP_PWR_P_NUM_ALLNODES] = {
    ...
    BCHP_PWR_P_Resource_HW_AVD0_SCB_CLK,
    BCHP_PWR_P_Resource_HW_AVD0_108_CLK,
    ...
    BCHP_PWR_P_Resource_HW_RFM_SRAM,
    ...
    BCHP_PWR_P_Resource_DV_PLL_AVD_CH0,
    BCHP_PWR_P_Resource_DV_PLL_AVD_CH1,
    BCHP_PWR_P_Resource_DV_PLL_AVD_CH2,
    BCHP_PWR_P_Resource_DV_PLL_AVD_CH3,
    BCHP_PWR_P_Resource_DV_PLL_AVD_CH4,
};
...
static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_DV_PLL_AVD_CH0[] = {
    BCHP_PWR_P_Resource_HW_PLL_AVD,
    NULL
};

static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_DV_PLL_AVD_CH1[] = {
    BCHP_PWR_P_Resource_HW_PLL_AVD,
    NULL
};

static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_DV_PLL_AVD_CH2[] = {
    BCHP_PWR_P_Resource_HW_PLL_AVD,
    NULL
};

static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_DV_PLL_AVD_CH3[] = {
    BCHP_PWR_P_Resource_HW_PLL_AVD,
    NULL
};

static const BCHP_PWR_P_Resource* const BCHP_PWR_P_Depend_DV_PLL_AVD_CH4[] = {
    BCHP_PWR_P_Resource_HW_PLL_AVD,
    NULL
};
...
const BCHP_PWR_P_Resource* const * const BCHP_PWR_P_DependList[BCHP_PWR_P_NUM_ALLNODES] = {
    ...
    NULL,
    BCHP_PWR_P_Depend_DV_PLL_AVD_CH0,
    BCHP_PWR_P_Depend_DV_PLL_AVD_CH1,
    BCHP_PWR_P_Depend_DV_PLL_AVD_CH2,
    BCHP_PWR_P_Depend_DV_PLL_AVD_CH3,
    BCHP_PWR_P_Depend_DV_PLL_AVD_CH4,
};
...
void BCHP_PWR_P_HW_ControlId(BCHP_Handle handle, unsigned id, bool activate)
{
    switch(id) {
        ...
        case BCHP_PWR_HW_AVD0_CPU_CLK:
            ...
            break;
        case BCHP_PWR_HW_AVD0_SCB_CLK:
            BCHP_PWR_P_HW_AVD0_SCB_CLK_Control(handle, activate);
            break;
        case BCHP_PWR_HW_AVD0_108_CLK:
            BCHP_PWR_P_HW_AVD0_108_CLK_Control(handle, activate);
            break;
        ...
        case BCHP_PWR_HW_RFM:
            ...
            break;
        case BCHP_PWR_HW_RFM_SRAM:
            BCHP_PWR_P_HW_RFM_SRAM_Control(handle, activate);
            break;
...
void BCHP_PWR_P_DIV_Control(BCHP_Handle handle, const BCHP_PWR_P_Resource *resource, unsigned *mult, unsigned *prediv, unsigned *postdiv, bool set)
{
    ...
    switch(resource->id) {
        case BCHP_PWR_DV_PLL_AVD_CH0:
            BCHP_PWR_P_DV_PLL_AVD_CH0_Control(handle, mult, prediv, postdiv, set);
            break;
        case BCHP_PWR_DV_PLL_AVD_CH1:
            BCHP_PWR_P_DV_PLL_AVD_CH1_Control(handle, mult, prediv, postdiv, set);
            break;
        case BCHP_PWR_DV_PLL_AVD_CH2:
            BCHP_PWR_P_DV_PLL_AVD_CH2_Control(handle, mult, prediv, postdiv, set);
            break;
        case BCHP_PWR_DV_PLL_AVD_CH3:
            BCHP_PWR_P_DV_PLL_AVD_CH3_Control(handle, mult, prediv, postdiv, set);
            break;
        case BCHP_PWR_DV_PLL_AVD_CH4:
            BCHP_PWR_P_DV_PLL_AVD_CH4_Control(handle, mult, prediv, postdiv, set);
            break;
        default:
            BDBG_ASSERT(0);
            break;
...
const BCHP_PWR_P_DivTable BCHP_PWR_P_DivTable_DV_PLL_AVD_CH0[] = {{135,3,7},{135,3,112}};
const BCHP_PWR_P_DivTable BCHP_PWR_P_DivTable_DV_PLL_AVD_CH1[] = {{135,3,9},{135,3,144}};
const BCHP_PWR_P_DivTable BCHP_PWR_P_DivTable_DV_PLL_AVD_CH2[] = {{135,3,4},{135,3,64}};
const BCHP_PWR_P_DivTable BCHP_PWR_P_DivTable_DV_PLL_AVD_CH3[] = {{135,3,7},{135,3,112}};
const BCHP_PWR_P_DivTable BCHP_PWR_P_DivTable_DV_PLL_AVD_CH4[] = {{135,3,7},{135,3,112}};

const BCHP_PWR_P_FreqMap BCHP_PWR_P_FreqMapList[BCHP_PWR_P_NUM_DIVS] = {
    {BCHP_PWR_DV_PLL_AVD_CH0, BCHP_PWR_P_DivTable_DV_PLL_AVD_CH0},
    {BCHP_PWR_DV_PLL_AVD_CH1, BCHP_PWR_P_DivTable_DV_PLL_AVD_CH1},
    {BCHP_PWR_DV_PLL_AVD_CH2, BCHP_PWR_P_DivTable_DV_PLL_AVD_CH2},
    {BCHP_PWR_DV_PLL_AVD_CH3, BCHP_PWR_P_DivTable_DV_PLL_AVD_CH3},
    {BCHP_PWR_DV_PLL_AVD_CH4, BCHP_PWR_P_DivTable_DV_PLL_AVD_CH4},
};
