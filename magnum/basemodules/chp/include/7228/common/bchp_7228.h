 ...
 *
 ***************************************************************************/
#ifndef BCHP_7228_H__
#define BCHP_7228_H__
...
/***************************************************************************
Summary:
    Open a chip handle for Bcm7228 chip

Description:
    This function open a chip handle for Bcm7228 chip.

Input:
    hRegister - A valid Bcm7228 register handle previous open using BREG_Open.
