 ...
 ***************************************************************************/
#define BCHP_DVI_CSC_0_CSC_REV_ID                0x00684a00 /* Revision ID register */
#define BCHP_DVI_CSC_0_CSC_MODE                  0x00684a08 /* Color space converter mode register */
#define BCHP_DVI_CSC_0_CSC_MIN_MAX               0x00684a0c /* Color space converter min_max clamp register */
#define BCHP_DVI_CSC_0_CSC_COEFF_C01_C00         0x00684a10 /* Video Encoder Color Matrix coefficients c01 and c00 */
#define BCHP_DVI_CSC_0_CSC_COEFF_C03_C02         0x00684a14 /* Video Encoder Color Matrix coefficients c03 and c02 */
#define BCHP_DVI_CSC_0_CSC_COEFF_C11_C10         0x00684a18 /* Video Encoder Color Matrix coefficients c11 and c10 */
#define BCHP_DVI_CSC_0_CSC_COEFF_C13_C12         0x00684a1c /* Video Encoder Color Matrix coefficients c13 and c12 */
#define BCHP_DVI_CSC_0_CSC_COEFF_C21_C20         0x00684a20 /* Video Encoder Color Matrix coefficients c21 and c20 */
#define BCHP_DVI_CSC_0_CSC_COEFF_C23_C22         0x00684a24 /* Video Encoder Color Matrix coefficients c23 and c22 */
#define BCHP_DVI_CSC_0_DITHER_CONTROL            0x00684a28 /* Color Space Converter Dither Control */
#define BCHP_DVI_CSC_0_DITHER_LFSR               0x00684a2c /* Color Space Converter Dither LFSR Control */
#define BCHP_DVI_CSC_0_DITHER_LFSR_INIT          0x00684a30 /* Color Space Converter Dither LFSR Init value and control */
