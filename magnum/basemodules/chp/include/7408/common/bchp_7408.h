 ...
 * 
 ***************************************************************************/
#ifndef BCHP_7408_H__
#define BCHP_7408_H__
...
/***************************************************************************
Summary:
    Open a chip handle for Bcm7408 chip

Description:
    This function open a chip handle for Bcm7408 chip.

Input:
    hRegister - A valid Bcm7408 register handle previous open using BREG_Open.
