 ...
 *
 *
 * Date:           Generated on         Wed Aug  4 16:37:34 2010
 ...
 ***************************************************************************/
#define BCHP_XPT_BUS_IF_MISC_CTRL0               0x00740000 /* Data Transport Misc Control 0 Register */
#define BCHP_XPT_BUS_IF_TEST_MODE                0x00740004 /* Data transport test register */
#define BCHP_XPT_BUS_IF_REVISION                 0x00740008 /* Data Transport Revision Register */
#define BCHP_XPT_BUS_IF_INTR_STATUS_REG          0x00740020 /* Interrupt Status Register */
#define BCHP_XPT_BUS_IF_INTR_STATUS_REG_EN       0x00740024 /* Interrupt Status Enable Register */
#define BCHP_XPT_BUS_IF_INTR_STATUS2_REG         0x00740028 /* Interrupt Status2 Register */
#define BCHP_XPT_BUS_IF_INTR_STATUS2_REG_EN      0x0074002c /* Interrupt Status2 Enable Register */
#define BCHP_XPT_BUS_IF_INTR_STATUS3_REG         0x00740030 /* Interrupt Status3 Register */
#define BCHP_XPT_BUS_IF_INTR_STATUS3_REG_EN      0x00740034 /* Interrupt Status3 Enable Register */
#define BCHP_XPT_BUS_IF_INTR_STATUS4_REG         0x00740038 /* Interrupt Status4 Register */
#define BCHP_XPT_BUS_IF_INTR_STATUS4_REG_EN      0x0074003c /* Interrupt Status4 Enable Register */
#define BCHP_XPT_BUS_IF_INTR_STATUS5_REG         0x00740040 /* Interrupt Status5 Register */
#define BCHP_XPT_BUS_IF_INTR_STATUS5_REG_EN      0x00740044 /* Interrupt Status5 Enable Register */
#define BCHP_XPT_BUS_IF_XMEMIF_RD_LC_DEBUG_REG   0x00740048 /* LCIF to XMEMIF Debug Registers */
#define BCHP_XPT_BUS_IF_XMEMIF_WR_LC_DEBUG_REG   0x0074004c /* LCIF to XMEMIF Debug Registers */
#define BCHP_XPT_BUS_IF_MAX_PLAYBACKS            0x00740050 /* Data Transport max number of playbacks supported */
#define BCHP_XPT_BUS_IF_MAX_PID_PARSERS          0x00740054 /* Data Transport max number of PID parsers supported */
#define BCHP_XPT_BUS_IF_MAX_PID_CHANNELS         0x00740058 /* Data Transport max number of PID channels supported */
#define BCHP_XPT_BUS_IF_MAX_INPUT_BANDS          0x0074005c /* Data Transport max number of input bands supported */
#define BCHP_XPT_BUS_IF_MAX_PCRS                 0x00740060 /* Data Transport max number of PCRs supported */
#define BCHP_XPT_BUS_IF_MAX_TPIT_CHANNELS        0x00740064 /* Data Transport max number of TPIT channels supported */
#define BCHP_XPT_BUS_IF_MAX_RAVE_CONTEXTS        0x00740068 /* Data Transport max number of RAVE contexts supported */
#define BCHP_XPT_BUS_IF_MAX_RMX_CHANNELS         0x0074006c /* Data Transport max number of RMX channels supported */
#define BCHP_XPT_BUS_IF_MAX_MSG_BUFFERS          0x00740070 /* Data Transport max number of MSG buffers supported */
#define BCHP_XPT_BUS_IF_MAX_SCDS                 0x00740074 /* Data Transport max number of SCDs supported */

/***************************************************************************
 *MISC_CTRL0 - Data Transport Misc Control 0 Register
 ***************************************************************************/
/* XPT_BUS_IF :: MISC_CTRL0 :: reserved0 [31:05] */
#define BCHP_XPT_BUS_IF_MISC_CTRL0_reserved0_MASK                  0xffffffe0
#define BCHP_XPT_BUS_IF_MISC_CTRL0_reserved0_SHIFT                 5
 ...
 ***************************************************************************/
/* XPT_BUS_IF :: INTR_STATUS2_REG :: reserved0 [31:04] */
#define BCHP_XPT_BUS_IF_INTR_STATUS2_REG_reserved0_MASK            0xfffffff0
#define BCHP_XPT_BUS_IF_INTR_STATUS2_REG_reserved0_SHIFT           4

/* XPT_BUS_IF :: INTR_STATUS2_REG :: JTAG_OTP_GR_BRIDGE_INTR [03:03] */
#define BCHP_XPT_BUS_IF_INTR_STATUS2_REG_JTAG_OTP_GR_BRIDGE_INTR_MASK 0x00000008
#define BCHP_XPT_BUS_IF_INTR_STATUS2_REG_JTAG_OTP_GR_BRIDGE_INTR_SHIFT 3
...
/* XPT_BUS_IF :: INTR_STATUS2_REG :: MEM_DMA_INT [00:00] */
#define BCHP_XPT_BUS_IF_INTR_STATUS2_REG_MEM_DMA_INT_MASK          0x00000001
#define BCHP_XPT_BUS_IF_INTR_STATUS2_REG_MEM_DMA_INT_SHIFT         0

/***************************************************************************
 *INTR_STATUS2_REG_EN - Interrupt Status2 Enable Register
 ***************************************************************************/
/* XPT_BUS_IF :: INTR_STATUS2_REG_EN :: reserved0 [31:04] */
#define BCHP_XPT_BUS_IF_INTR_STATUS2_REG_EN_reserved0_MASK         0xfffffff0
#define BCHP_XPT_BUS_IF_INTR_STATUS2_REG_EN_reserved0_SHIFT        4

/* XPT_BUS_IF :: INTR_STATUS2_REG_EN :: JTAG_OTP_GR_BRIDGE_INTR_EN [03:03] */
#define BCHP_XPT_BUS_IF_INTR_STATUS2_REG_EN_JTAG_OTP_GR_BRIDGE_INTR_EN_MASK 0x00000008
#define BCHP_XPT_BUS_IF_INTR_STATUS2_REG_EN_JTAG_OTP_GR_BRIDGE_INTR_EN_SHIFT 3
...
/* XPT_BUS_IF :: INTR_STATUS2_REG_EN :: MEM_DMA_INT_EN [00:00] */
#define BCHP_XPT_BUS_IF_INTR_STATUS2_REG_EN_MEM_DMA_INT_EN_MASK    0x00000001
#define BCHP_XPT_BUS_IF_INTR_STATUS2_REG_EN_MEM_DMA_INT_EN_SHIFT   0
