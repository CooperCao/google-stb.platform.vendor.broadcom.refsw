 ...
 *PHY - PHY registers
 ***************************************************************************/
#define BCHP_PHY_FIXD_CMN_VER_1                  0x00fe0000 /* [RO] Shows the version number of the HDL */
#define BCHP_PHY_FIXD_CMN_CPU_CTRL_1             0x00fe0004 /* [RW] Register enables the CPU to control the PHY */
#define BCHP_PHY_FIXD_CMN_MPC_MPR_CLK_RATE       0x00fe0008 /* [RW] hold the rate of  the MPC clocks */
#define BCHP_PHY_FIXD_CMN_TEST_PORTS             0x00fe000c /* [RW] test ports select regsiter */
#define BCHP_PHY_FIXD_CMN_TP_SEL                 0x00fe0010 /* [RW] Selection of the tp overlay */
#define BCHP_PHY_FIXD_CMN_TPCAP_SEL              0x00fe0014 /* [RW] Selection of data forwarded towards the TPCAP */
#define BCHP_PHY_FIXD_RX_PROBES_STATUS           0x00fe0018 /* [RO] Indicates if the probe ( I or III) results are ready */
#define BCHP_PHY_FIXD_RX_OFDMA_CFO_0             0x00fe001c /* [RO] CFO of OFDMA - result of the pilots , register set index 0. */
#define BCHP_PHY_FIXD_RX_OFDMA_CFO_1             0x00fe0020 /* [RO] CFO of OFDMA - result of the pilots , register set index 1. */
#define BCHP_PHY_FIXD_RX_OFDMA_CFO_2             0x00fe0024 /* [RO] CFO of OFDMA - result of the pilots , register set index 2. */
#define BCHP_PHY_FIXD_RX_OFDMA_CFO_3             0x00fe0028 /* [RO] CFO of OFDMA - result of the pilots , register set index 3. */
#define BCHP_PHY_FIXD_RX_SP_0                    0x00fe002c /* [RW] SP Rx bits 7_0 */
#define BCHP_PHY_FIXD_RX_SP_1                    0x00fe0030 /* [RW] SP Rx bits 15_8 */
#define BCHP_PHY_FIXD_RX_SP_2                    0x00fe0034 /* [RW] SP Rx bits 23_16 */
#define BCHP_PHY_FIXD_RX_SP_3                    0x00fe0038 /* [RW] SP Rx bits 29-24 */
#define BCHP_PHY_FIXD_RX_LP1_0                   0x00fe003c /* [RW] "LP1 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 0. */
#define BCHP_PHY_FIXD_RX_LP1_1                   0x00fe0040 /* [RW] "LP1 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 1. */
#define BCHP_PHY_FIXD_RX_LP1_2                   0x00fe0044 /* [RW] "LP1 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 2. */
#define BCHP_PHY_FIXD_RX_LP1_3                   0x00fe0048 /* [RW] "LP1 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 3. */
#define BCHP_PHY_FIXD_RX_LP1_4                   0x00fe004c /* [RW] "LP1 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 4. */
#define BCHP_PHY_FIXD_RX_LP1_5                   0x00fe0050 /* [RW] "LP1 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 5. */
#define BCHP_PHY_FIXD_RX_LP1_6                   0x00fe0054 /* [RW] "LP1 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 6. */
#define BCHP_PHY_FIXD_RX_LP1_7                   0x00fe0058 /* [RW] "LP1 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 7. */
#define BCHP_PHY_FIXD_RX_LP2_0                   0x00fe005c /* [RW] "LP2 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 0. */
#define BCHP_PHY_FIXD_RX_LP2_1                   0x00fe0060 /* [RW] "LP2 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 1. */
#define BCHP_PHY_FIXD_RX_LP2_2                   0x00fe0064 /* [RW] "LP2 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 2. */
#define BCHP_PHY_FIXD_RX_LP2_3                   0x00fe0068 /* [RW] "LP2 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 3. */
#define BCHP_PHY_FIXD_RX_LP2_4                   0x00fe006c /* [RW] "LP2 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 4. */
#define BCHP_PHY_FIXD_RX_LP2_5                   0x00fe0070 /* [RW] "LP2 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 5. */
#define BCHP_PHY_FIXD_RX_LP2_6                   0x00fe0074 /* [RW] "LP2 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 6. */
#define BCHP_PHY_FIXD_RX_LP2_7                   0x00fe0078 /* [RW] "LP2 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 7. */
#define BCHP_PHY_FIXD_RX_LP3_0                   0x00fe007c /* [RW] "LP3 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 0. */
#define BCHP_PHY_FIXD_RX_LP3_1                   0x00fe0080 /* [RW] "LP3 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 1. */
#define BCHP_PHY_FIXD_RX_LP3_2                   0x00fe0084 /* [RW] "LP3 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 2. */
#define BCHP_PHY_FIXD_RX_LP3_3                   0x00fe0088 /* [RW] "LP3 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 3. */
#define BCHP_PHY_FIXD_RX_LP3_4                   0x00fe008c /* [RW] "LP3 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 4. */
#define BCHP_PHY_FIXD_RX_LP3_5                   0x00fe0090 /* [RW] "LP3 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 5. */
#define BCHP_PHY_FIXD_RX_LP3_6                   0x00fe0094 /* [RW] "LP3 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 6. */
#define BCHP_PHY_FIXD_RX_LP3_7                   0x00fe0098 /* [RW] "LP3 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 7. */
#define BCHP_PHY_FIXD_RX_LP4_0                   0x00fe009c /* [RW] "LP3 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 0. */
#define BCHP_PHY_FIXD_RX_LP4_1                   0x00fe00a0 /* [RW] "LP3 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 1. */
#define BCHP_PHY_FIXD_RX_LP4_2                   0x00fe00a4 /* [RW] "LP3 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 2. */
#define BCHP_PHY_FIXD_RX_LP4_3                   0x00fe00a8 /* [RW] "LP3 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 3. */
#define BCHP_PHY_FIXD_RX_LP4_4                   0x00fe00ac /* [RW] "LP3 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 4. */
#define BCHP_PHY_FIXD_RX_LP4_5                   0x00fe00b0 /* [RW] "LP3 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 5. */
#define BCHP_PHY_FIXD_RX_LP4_6                   0x00fe00b4 /* [RW] "LP3 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 6. */
#define BCHP_PHY_FIXD_RX_LP4_7                   0x00fe00b8 /* [RW] "LP3 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 7. */
#define BCHP_PHY_FIXD_RX_LP5_0                   0x00fe00bc /* [RW] long preamble sequence for moca2.0 rx data burst , register set index 0. */
#define BCHP_PHY_FIXD_RX_LP5_1                   0x00fe00c0 /* [RW] long preamble sequence for moca2.0 rx data burst , register set index 1. */
#define BCHP_PHY_FIXD_RX_LP5_2                   0x00fe00c4 /* [RW] long preamble sequence for moca2.0 rx data burst , register set index 2. */
#define BCHP_PHY_FIXD_RX_LP5_3                   0x00fe00c8 /* [RW] long preamble sequence for moca2.0 rx data burst , register set index 3. */
#define BCHP_PHY_FIXD_RX_LP5_4                   0x00fe00cc /* [RW] long preamble sequence for moca2.0 rx data burst , register set index 4. */
#define BCHP_PHY_FIXD_RX_LP5_5                   0x00fe00d0 /* [RW] long preamble sequence for moca2.0 rx data burst , register set index 5. */
#define BCHP_PHY_FIXD_RX_LP5_6                   0x00fe00d4 /* [RW] long preamble sequence for moca2.0 rx data burst , register set index 6. */
#define BCHP_PHY_FIXD_RX_LP5_7                   0x00fe00d8 /* [RW] long preamble sequence for moca2.0 rx data burst , register set index 7. */
#define BCHP_PHY_FIXD_RX_LP6_0                   0x00fe00dc /* [RW] long preamble sequence for moca2.0 rx map burst , register set index 0. */
#define BCHP_PHY_FIXD_RX_LP6_1                   0x00fe00e0 /* [RW] long preamble sequence for moca2.0 rx map burst , register set index 1. */
#define BCHP_PHY_FIXD_RX_LP6_2                   0x00fe00e4 /* [RW] long preamble sequence for moca2.0 rx map burst , register set index 2. */
#define BCHP_PHY_FIXD_RX_LP6_3                   0x00fe00e8 /* [RW] long preamble sequence for moca2.0 rx map burst , register set index 3. */
#define BCHP_PHY_FIXD_RX_LP6_4                   0x00fe00ec /* [RW] long preamble sequence for moca2.0 rx map burst , register set index 4. */
#define BCHP_PHY_FIXD_RX_LP6_5                   0x00fe00f0 /* [RW] long preamble sequence for moca2.0 rx map burst , register set index 5. */
#define BCHP_PHY_FIXD_RX_LP6_6                   0x00fe00f4 /* [RW] long preamble sequence for moca2.0 rx map burst , register set index 6. */
#define BCHP_PHY_FIXD_RX_LP6_7                   0x00fe00f8 /* [RW] long preamble sequence for moca2.0 rx map burst , register set index 7. */
#define BCHP_PHY_FIXD_RX_LP7_0                   0x00fe00fc /* [RW] moca2.0 CE sequence  for cross correlation  in RX , register set index 0. */
#define BCHP_PHY_FIXD_RX_LP7_1                   0x00fe0100 /* [RW] moca2.0 CE sequence  for cross correlation  in RX , register set index 1. */
#define BCHP_PHY_FIXD_RX_LP7_2                   0x00fe0104 /* [RW] moca2.0 CE sequence  for cross correlation  in RX , register set index 2. */
#define BCHP_PHY_FIXD_RX_LP7_3                   0x00fe0108 /* [RW] moca2.0 CE sequence  for cross correlation  in RX , register set index 3. */
#define BCHP_PHY_FIXD_RX_LP7_4                   0x00fe010c /* [RW] moca2.0 CE sequence  for cross correlation  in RX , register set index 4. */
#define BCHP_PHY_FIXD_RX_LP7_5                   0x00fe0110 /* [RW] moca2.0 CE sequence  for cross correlation  in RX , register set index 5. */
#define BCHP_PHY_FIXD_RX_LP7_6                   0x00fe0114 /* [RW] moca2.0 CE sequence  for cross correlation  in RX , register set index 6. */
#define BCHP_PHY_FIXD_RX_LP7_7                   0x00fe0118 /* [RW] moca2.0 CE sequence  for cross correlation  in RX , register set index 7. */
#define BCHP_PHY_FIXD_CMN_M2_CE_BIT_LOAD_0       0x00fe011c /* [RW] RX channel estimation bit load , register set index 0. */
#define BCHP_PHY_FIXD_CMN_M2_CE_BIT_LOAD_1       0x00fe0120 /* [RW] RX channel estimation bit load , register set index 1. */
#define BCHP_PHY_FIXD_CMN_M2_CE_BIT_LOAD_2       0x00fe0124 /* [RW] RX channel estimation bit load , register set index 2. */
#define BCHP_PHY_FIXD_CMN_M2_CE_BIT_LOAD_3       0x00fe0128 /* [RW] RX channel estimation bit load , register set index 3. */
#define BCHP_PHY_FIXD_CMN_M2_CE_BIT_LOAD_4       0x00fe012c /* [RW] RX channel estimation bit load , register set index 4. */
#define BCHP_PHY_FIXD_CMN_M2_CE_BIT_LOAD_5       0x00fe0130 /* [RW] RX channel estimation bit load , register set index 5. */
#define BCHP_PHY_FIXD_CMN_M2_CE_BIT_LOAD_6       0x00fe0134 /* [RW] RX channel estimation bit load , register set index 6. */
#define BCHP_PHY_FIXD_CMN_M2_CE_BIT_LOAD_7       0x00fe0138 /* [RW] RX channel estimation bit load , register set index 7. */
#define BCHP_PHY_FIXD_CMN_M2_CE_BIT_LOAD_8       0x00fe013c /* [RW] RX channel estimation bit load , register set index 8. */
#define BCHP_PHY_FIXD_CMN_M2_CE_BIT_LOAD_9       0x00fe0140 /* [RW] RX channel estimation bit load , register set index 9. */
#define BCHP_PHY_FIXD_CMN_M2_CE_BIT_LOAD_10      0x00fe0144 /* [RW] RX channel estimation bit load , register set index 10. */
#define BCHP_PHY_FIXD_CMN_M2_CE_BIT_LOAD_11      0x00fe0148 /* [RW] RX channel estimation bit load , register set index 11. */
#define BCHP_PHY_FIXD_CMN_M2_CE_BIT_LOAD_12      0x00fe014c /* [RW] RX channel estimation bit load , register set index 12. */
#define BCHP_PHY_FIXD_CMN_M2_CE_BIT_LOAD_13      0x00fe0150 /* [RW] RX channel estimation bit load , register set index 13. */
#define BCHP_PHY_FIXD_CMN_M2_CE_BIT_LOAD_14      0x00fe0154 /* [RW] RX channel estimation bit load , register set index 14. */
#define BCHP_PHY_FIXD_CMN_M2_CE_BIT_LOAD_15      0x00fe0158 /* [RW] RX channel estimation bit load , register set index 15. */
#define BCHP_PHY_FIXD_CMN_GPIO_OUT               0x00fe015c /* [RW] GPIO output data */
#define BCHP_PHY_FIXD_CMN_DPM_TMR_CFG_0          0x00fe0160 /* [RW] DMP counters */
#define BCHP_PHY_FIXD_CMN_DPM_TMR_CFG_1          0x00fe0164 /* [RW] DMP counters */
#define BCHP_PHY_FIXD_CMN_DPM_ZONE_CTRL          0x00fe0168 /* [RW] DMP counters */
#define BCHP_PHY_FIXD_CMN_DPM_STAT               0x00fe016c /* [RO] per zone power status */
#define BCHP_PHY_BRST_CMN_BYPASS_1               0x00fe2000 /* [RW] Debug Bypass Register */
#define BCHP_PHY_BRST_CMN_DELAYES_1              0x00fe2004 /* [RW] Delays in the PHY and some TDU parameters */
#define BCHP_PHY_BRST_CMN_DELAYES_2              0x00fe2008 /* [RW] Delays in the PHY and some TDU parameters */
#define BCHP_PHY_BRST_CMN_MPD_CLK_RATE           0x00fe200c /* [RW] hold the rate of  the MPI clocks */
#define BCHP_PHY_BRST_TX_NOR_FAC                 0x00fe2010 /* [RW] Probe and Preamble Factor related params */
#define BCHP_PHY_BRST_RX_ACQUISITION_1           0x00fe2014 /* [RW] Fixed acquisition registers */
#define BCHP_PHY_BRST_RX_ACQUISITION_2           0x00fe2018 /* [RW] Fixed acquisition registers */
#define BCHP_PHY_BRST_CMN_AFE_COUNTERS           0x00fe201c /* [RW] AFE Counters */
#define BCHP_PHY_BRST_TX_TXON_TIMER              0x00fe2020 /* [RW] TXON Timer */
#define BCHP_PHY_BRST_TX_TXOFF_TIMER             0x00fe2024 /* [RW] TXOFF Timer */
#define BCHP_PHY_BRST_RX_RXON_TIMER              0x00fe2028 /* [RW] RXON Timer */
#define BCHP_PHY_BRST_RX_AFE_TEST_MODE           0x00fe202c /* [RW] RX Gain Set */
#define BCHP_PHY_BRST_RX_AGC_PARAM_1             0x00fe2030 /* [RW] AGC Parameter - Windows */
#define BCHP_PHY_BRST_RX_AGC_PARAM_2             0x00fe2034 /* [RW] AGC Parameter - Threshold */
#define BCHP_PHY_BRST_RX_AGC_PARAM_3             0x00fe2038 /* [RW] AGC Parameter Gain Settings */
#define BCHP_PHY_BRST_RX_AGC_PARAM_4             0x00fe203c /* [RW] AGC Parameter Gain Settings */
#define BCHP_PHY_BRST_RX_CFO_SFO_STEP_PYLD       0x00fe2040 /* [RW] CFO & SFO step sizes */
#define BCHP_PHY_BRST_RX_CFO_SFO_STEP_CE         0x00fe2044 /* [RW] CFO & SFO step sizes */
#define BCHP_PHY_BRST_TX_TD_TONE_0               0x00fe2048 /* [RW] TD tone parameters */
#define BCHP_PHY_BRST_TX_TD_TONE_1               0x00fe204c /* [RW] TD tone parameters */
#define BCHP_PHY_BRST_TX_IQ_COR                  0x00fe2050 /* [RW] IQ correction parameters */
#define BCHP_PHY_BRST_RX_PILOTS_FACTORS          0x00fe2054 /* [RW] RX Burst Parameters #2 */
#define BCHP_PHY_BRST_RX_PILOTS_CE_FACTORS       0x00fe2058 /* [RW] RX Burst Parameters #2 */
#define BCHP_PHY_BRST_CMN_FEC                    0x00fe205c /* [RW] LDPC and RS parameters */
#define BCHP_PHY_BRST_CMN_AES_INITIAL_VAL_0      0x00fe2060 /* [RW] AES initial value , register set index 0. */
#define BCHP_PHY_BRST_CMN_AES_INITIAL_VAL_1      0x00fe2064 /* [RW] AES initial value , register set index 1. */
#define BCHP_PHY_BRST_CMN_AES_INITIAL_VAL_2      0x00fe2068 /* [RW] AES initial value , register set index 2. */
#define BCHP_PHY_BRST_CMN_AES_INITIAL_VAL_3      0x00fe206c /* [RW] AES initial value , register set index 3. */
#define BCHP_PHY_BRST_TX_GAIN                    0x00fe2070 /* [RW] Preamble Processing Parameters II + Normal RS + Farrow */
#define BCHP_PHY_BRST_CMN_GEN                    0x00fe2074 /* [RW] Preamble Processing Parameters II + Normal RS + Farrow */
#define BCHP_PHY_BRST_TX_INIT_GEN                0x00fe2078 /* [RW] TX init regsiter */
#define BCHP_PHY_BRST_CMN_INIT_TP_SC_LOCATION    0x00fe207c /* [RW] "ProbeII SC1, SC2" */
#define BCHP_PHY_BRST_CMN_INIT_AES_DES_KEY_0     0x00fe2080 /* [RW] DES key sequence - Low Portion , register set index 0. */
#define BCHP_PHY_BRST_CMN_INIT_AES_DES_KEY_1     0x00fe2084 /* [RW] DES key sequence - Low Portion , register set index 1. */
#define BCHP_PHY_BRST_CMN_INIT_AES_DES_KEY_2     0x00fe2088 /* [RW] DES key sequence - Low Portion , register set index 2. */
#define BCHP_PHY_BRST_CMN_INIT_AES_DES_KEY_3     0x00fe208c /* [RW] DES key sequence - Low Portion , register set index 3. */
#define BCHP_PHY_BRST_CMN_INIT_SCRM_SEED         0x00fe2090 /* [RW] Rx and Tx Burst Parameters #1 */
#define BCHP_PHY_BRST_CMN_INIT_FRAME             0x00fe2094 /* [RW] Rx and Tx Burst Parameters #2 */
#define BCHP_PHY_BRST_CMN_INIT_FEC               0x00fe2098 /* [RW] Fec Parameters */
#define BCHP_PHY_BRST_CMN_INIT_GEN               0x00fe209c /* [RW] common Burst Init Parameters */
#define BCHP_PHY_BRST_CMN_INIT_FRAME_1           0x00fe20a0 /* [RW] Rx and Tx Burst Parameters #2 */
#define BCHP_PHY_BRST_RX_INIT_RESULTS_READ       0x00fe20a4 /* [RW] RX Results Reading Register and RX-Learning Parameters Load */
#define BCHP_PHY_BRST_RX_INIT_TIMEOUT            0x00fe20a8 /* [RW] RX Burst Init Parameters #2 */
#define BCHP_PHY_BRST_RX_INIT_GEN                0x00fe20ac /* [RW] RX Burst Init Parameters #1 */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1            0x00fe2200 /* [RW] TX Burst Switches */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2            0x00fe2204 /* [RW] TX Burst Switches */
#define BCHP_PHY_BRST_TX_PROF_RF_1               0x00fe2208 /* [RW] Profile TX - Gain */
#define BCHP_PHY_BRST_TX_PROF_GAIN               0x00fe220c /* [RW] Profile TX */
#define BCHP_PHY_BRST_TX_PROF_MAIN_CFO           0x00fe2210 /* [RW] Profile TX */
#define BCHP_PHY_BRST_TX_PROF_MAIN_SFO           0x00fe2214 /* [RW] Profile TX */
#define BCHP_PHY_BRST_CMN_PROF_MODE              0x00fe2218 /* [RW] profile mode */
#define BCHP_PHY_BRST_CMN_PROF_GEN               0x00fe221c /* [RW] common profiles */
#define BCHP_PHY_BRST_RX_PROF_PILOT_SC_MASK_0    0x00fe2500 /* [RW] Pilot sub  carrier mask vector  #1 , register set index 0. */
#define BCHP_PHY_BRST_RX_PROF_PILOT_SC_MASK_1    0x00fe2504 /* [RW] Pilot sub  carrier mask vector  #1 , register set index 1. */
#define BCHP_PHY_BRST_RX_PROF_PILOT_SC_MASK_2    0x00fe2508 /* [RW] Pilot sub  carrier mask vector  #1 , register set index 2. */
#define BCHP_PHY_BRST_RX_PROF_PILOT_SC_MASK_3    0x00fe250c /* [RW] Pilot sub  carrier mask vector  #1 , register set index 3. */
#define BCHP_PHY_BRST_RX_PROF_PILOT_SC_MASK_4    0x00fe2510 /* [RW] Pilot sub  carrier mask vector  #1 , register set index 4. */
#define BCHP_PHY_BRST_RX_PROF_PILOT_SC_MASK_5    0x00fe2514 /* [RW] Pilot sub  carrier mask vector  #1 , register set index 5. */
#define BCHP_PHY_BRST_RX_PROF_PILOT_SC_MASK_6    0x00fe2518 /* [RW] Pilot sub  carrier mask vector  #1 , register set index 6. */
#define BCHP_PHY_BRST_RX_PROF_PILOT_SC_MASK_7    0x00fe251c /* [RW] Pilot sub  carrier mask vector  #1 , register set index 7. */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1            0x00fe2520 /* [RW] RX Burst Switches */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2            0x00fe2524 /* [RW] RX Burst Switches */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3            0x00fe2528 /* [RW] RX Burst Switches */
#define BCHP_PHY_BRST_RX_PROF_LDPC_SLOTS         0x00fe252c /* [RW] LDPC slots */
#define BCHP_PHY_BRST_RX_PROF_ACQ_HPF            0x00fe2530 /* [RW] HPF Poles and Gains */
#define BCHP_PHY_BRST_RX_PROF_ACQUISITION_0      0x00fe2534 /* [RW] Acquisition */
#define BCHP_PHY_BRST_RX_PROF_ACQUISITION_1      0x00fe2538 /* [RW] Acquisition Parameter #1 */
#define BCHP_PHY_BRST_RX_PROF_ACQUISITION_2      0x00fe253c /* [RW] Acquisition Parameter #1 */
#define BCHP_PHY_BRST_RX_PROF_ACQUISITION_3      0x00fe2540 /* [RW] Acquisition Parameter #1 */
#define BCHP_PHY_BRST_RX_PROF_COG_LUT_1          0x00fe2544 /* [RW] COG K factor LUT */
#define BCHP_PHY_BRST_RX_PROF_COG_LUT_2          0x00fe2548 /* [RW] COG K factor LUT */
#define BCHP_PHY_BRST_RX_PROF_IQ_COR             0x00fe254c /* [RW] IQ correction profile */
#define BCHP_PHY_BRST_RX_PROF_GEN_1              0x00fe2550 /* [RW] RX generic profile */
#define BCHP_PHY_BRST_RX_PROF_GEN_2              0x00fe2554 /* [RW] RX generic profile */
#define BCHP_PHY_BRST_RX_PROF_CFO_SFO_OFFSET     0x00fe2558 /* [RW] CFO and SFO offsets - different number in turbo */
#define BCHP_PHY_BRST_RX_PROF_DETECT_DELAY_EXPECTED 0x00fe255c /* [RW] expected detect delay in derived line clocks */
#define BCHP_PHY_BRST_RX_PROF_RF_1               0x00fe2560 /* [RW] Rx RF Parameters */
#define BCHP_PHY_BRST_RX_PROF_RF_2               0x00fe2564 /* [RW] Rx RF Parameters */
#define BCHP_PHY_BRST_RX_PROF_CFO                0x00fe2568 /* [RW] Rx Burst Learn Parameters #1 */
#define BCHP_PHY_BRST_RX_PROF_SFO                0x00fe256c /* [RW] Rx Burst Learn Parameters #2 */
#define BCHP_PHY_RSLT_RX_STATISTICS_STATUS       0x00fe3000 /* [RO] Indicates the receive burst status */
#define BCHP_PHY_RSLT_RX_STATISTICS_FEC_UNERROR  0x00fe3004 /* [RO] The number of blocks has no FEC error */
#define BCHP_PHY_RSLT_RX_STATISTICS_FEC_CORRECTED 0x00fe3008 /* [RO] The number of blocks has FEC errors and corrections */
#define BCHP_PHY_RSLT_RX_STATISTICS_FEC_UNCORRECTED 0x00fe300c /* [RO] The number of blocks has un-correctable FEC errors */
#define BCHP_PHY_RSLT_RX_STATISTICS_LDPC_ITER    0x00fe3010 /* [RO] The number of iterrations performed by LDPC */
#define BCHP_PHY_RSLT_RX_STATISTICS_PP_P_EN_DATA 0x00fe3014 /* [RO] Samples the absolute value of the Power function at the maximum level found so far */
#define BCHP_PHY_RSLT_RX_STATISTICS_PP_A_AC_MAX_REAL 0x00fe3018 /* [RO] Samples the real value of the auto-correlation function at the maximum level found so far */
#define BCHP_PHY_RSLT_RX_STATISTICS_PP_A_AC_MAX_IMAG 0x00fe301c /* [RO] Samples the image value of the auto-correlation function at the maximum level found so far */
#define BCHP_PHY_RSLT_RX_STATISTICS_PP_ABS_VAL   0x00fe3020 /* [RO] Samples the absolute value of the auto-correlation function maximum found so far */
#define BCHP_PHY_RSLT_RX_STATISTICS_COG_OFFSET   0x00fe3024 /* [RO] COG offset */
#define BCHP_PHY_RSLT_RX_LEARNING_AGC_STAT_RSSI_AVRG 0x00fe3028 /* [RO] AGC RSSI */
#define BCHP_PHY_RSLT_RX_LEARNING_GAIN           0x00fe302c /* [RO] Gain Result */
#define BCHP_PHY_RSLT_RX_LEARNING_CFO            0x00fe3030 /* [RO] Rx Learning register #1 */
#define BCHP_PHY_RSLT_RX_LEARNING_SFO            0x00fe3034 /* [RO] Rx Learning register #2 */
#define BCHP_PHY_RSLT_RX_LEARNING_DETECT_DELAY_OFFSET 0x00fe3038 /* [RO] "Rx Learning detection delay,Learning_detect_delay_offset = detect_delay_measure - detect_delay_expected" */
#define BCHP_PHY_RSLT_RX_LEARNING_FEC_UNCORRECTED 0x00fe303c /* [RO] "The number of blocks has un-correctable FEC errors,,this has the same value as in the statistics uncorrected, it was required by,the SW for figuring out if the learning belong to a CRC error burst" */
#define BCHP_PHY_RSLT_TX_CALIBRATION_GOERTZEL    0x00fe3040 /* [RO] Gortzel Results */
...
/***************************************************************************
 *FIXD_CMN_TP_SEL - Selection of the tp overlay
 ***************************************************************************/
/* PHY :: FIXD_CMN_TP_SEL :: gpio_overlay_tp_sel [31:00] */
#define BCHP_PHY_FIXD_CMN_TP_SEL_gpio_overlay_tp_sel_MASK          0xffffffff
#define BCHP_PHY_FIXD_CMN_TP_SEL_gpio_overlay_tp_sel_SHIFT         0
#define BCHP_PHY_FIXD_CMN_TP_SEL_gpio_overlay_tp_sel_DEFAULT       0x00000000

/***************************************************************************
 *FIXD_CMN_TPCAP_SEL - Selection of data forwarded towards the TPCAP
 ***************************************************************************/
/* PHY :: FIXD_CMN_TPCAP_SEL :: reserved0 [31:08] */
#define BCHP_PHY_FIXD_CMN_TPCAP_SEL_reserved0_MASK                 0xffffff00
#define BCHP_PHY_FIXD_CMN_TPCAP_SEL_reserved0_SHIFT                8

/* PHY :: FIXD_CMN_TPCAP_SEL :: tpcap_stop_trig [07:07] */
#define BCHP_PHY_FIXD_CMN_TPCAP_SEL_tpcap_stop_trig_MASK           0x00000080
#define BCHP_PHY_FIXD_CMN_TPCAP_SEL_tpcap_stop_trig_SHIFT          7
#define BCHP_PHY_FIXD_CMN_TPCAP_SEL_tpcap_stop_trig_DEFAULT        0x00000000

/* PHY :: FIXD_CMN_TPCAP_SEL :: tpcap_start_trig [06:06] */
#define BCHP_PHY_FIXD_CMN_TPCAP_SEL_tpcap_start_trig_MASK          0x00000040
#define BCHP_PHY_FIXD_CMN_TPCAP_SEL_tpcap_start_trig_SHIFT         6
#define BCHP_PHY_FIXD_CMN_TPCAP_SEL_tpcap_start_trig_DEFAULT       0x00000000

/* PHY :: FIXD_CMN_TPCAP_SEL :: tpcap_force_clken [05:05] */
#define BCHP_PHY_FIXD_CMN_TPCAP_SEL_tpcap_force_clken_MASK         0x00000020
#define BCHP_PHY_FIXD_CMN_TPCAP_SEL_tpcap_force_clken_SHIFT        5
#define BCHP_PHY_FIXD_CMN_TPCAP_SEL_tpcap_force_clken_DEFAULT      0x00000000

/* PHY :: FIXD_CMN_TPCAP_SEL :: tpcap_tp_sel [04:04] */
#define BCHP_PHY_FIXD_CMN_TPCAP_SEL_tpcap_tp_sel_MASK              0x00000010
#define BCHP_PHY_FIXD_CMN_TPCAP_SEL_tpcap_tp_sel_SHIFT             4
#define BCHP_PHY_FIXD_CMN_TPCAP_SEL_tpcap_tp_sel_DEFAULT           0x00000000

/* PHY :: FIXD_CMN_TPCAP_SEL :: tpcap_overlay_sel [03:03] */
#define BCHP_PHY_FIXD_CMN_TPCAP_SEL_tpcap_overlay_sel_MASK         0x00000008
#define BCHP_PHY_FIXD_CMN_TPCAP_SEL_tpcap_overlay_sel_SHIFT        3
#define BCHP_PHY_FIXD_CMN_TPCAP_SEL_tpcap_overlay_sel_DEFAULT      0x00000000

/* PHY :: FIXD_CMN_TPCAP_SEL :: tpcap_data_sel [02:00] */
#define BCHP_PHY_FIXD_CMN_TPCAP_SEL_tpcap_data_sel_MASK            0x00000007
#define BCHP_PHY_FIXD_CMN_TPCAP_SEL_tpcap_data_sel_SHIFT           0
#define BCHP_PHY_FIXD_CMN_TPCAP_SEL_tpcap_data_sel_DEFAULT         0x00000000
...
/***************************************************************************
 *FIXD_CMN_GPIO_OUT - GPIO output data
 ***************************************************************************/
/* PHY :: FIXD_CMN_GPIO_OUT :: gpio_out [31:00] */
#define BCHP_PHY_FIXD_CMN_GPIO_OUT_gpio_out_MASK                   0xffffffff
#define BCHP_PHY_FIXD_CMN_GPIO_OUT_gpio_out_SHIFT                  0
#define BCHP_PHY_FIXD_CMN_GPIO_OUT_gpio_out_DEFAULT                0x00000000

/***************************************************************************
 *FIXD_CMN_DPM_TMR_CFG_0 - DMP counters
 ***************************************************************************/
/* PHY :: FIXD_CMN_DPM_TMR_CFG_0 :: reserved0 [31:26] */
#define BCHP_PHY_FIXD_CMN_DPM_TMR_CFG_0_reserved0_MASK             0xfc000000
#define BCHP_PHY_FIXD_CMN_DPM_TMR_CFG_0_reserved0_SHIFT            26

/* PHY :: FIXD_CMN_DPM_TMR_CFG_0 :: phy_dpm_off_st [25:13] */
#define BCHP_PHY_FIXD_CMN_DPM_TMR_CFG_0_phy_dpm_off_st_MASK        0x03ffe000
#define BCHP_PHY_FIXD_CMN_DPM_TMR_CFG_0_phy_dpm_off_st_SHIFT       13
#define BCHP_PHY_FIXD_CMN_DPM_TMR_CFG_0_phy_dpm_off_st_DEFAULT     0x00000000

/* PHY :: FIXD_CMN_DPM_TMR_CFG_0 :: phy_dpm_on_st [12:00] */
#define BCHP_PHY_FIXD_CMN_DPM_TMR_CFG_0_phy_dpm_on_st_MASK         0x00001fff
#define BCHP_PHY_FIXD_CMN_DPM_TMR_CFG_0_phy_dpm_on_st_SHIFT        0
#define BCHP_PHY_FIXD_CMN_DPM_TMR_CFG_0_phy_dpm_on_st_DEFAULT      0x00000000

/***************************************************************************
 *FIXD_CMN_DPM_TMR_CFG_1 - DMP counters
 ***************************************************************************/
/* PHY :: FIXD_CMN_DPM_TMR_CFG_1 :: reserved0 [31:14] */
#define BCHP_PHY_FIXD_CMN_DPM_TMR_CFG_1_reserved0_MASK             0xffffc000
#define BCHP_PHY_FIXD_CMN_DPM_TMR_CFG_1_reserved0_SHIFT            14

/* PHY :: FIXD_CMN_DPM_TMR_CFG_1 :: phy_dpm_burst_init_delay [13:00] */
#define BCHP_PHY_FIXD_CMN_DPM_TMR_CFG_1_phy_dpm_burst_init_delay_MASK 0x00003fff
#define BCHP_PHY_FIXD_CMN_DPM_TMR_CFG_1_phy_dpm_burst_init_delay_SHIFT 0
#define BCHP_PHY_FIXD_CMN_DPM_TMR_CFG_1_phy_dpm_burst_init_delay_DEFAULT 0x00000000

/***************************************************************************
 *FIXD_CMN_DPM_ZONE_CTRL - DMP counters
 ***************************************************************************/
/* PHY :: FIXD_CMN_DPM_ZONE_CTRL :: reserved0 [31:17] */
#define BCHP_PHY_FIXD_CMN_DPM_ZONE_CTRL_reserved0_MASK             0xfffe0000
#define BCHP_PHY_FIXD_CMN_DPM_ZONE_CTRL_reserved0_SHIFT            17

/* PHY :: FIXD_CMN_DPM_ZONE_CTRL :: phy_dpm_enable [16:16] */
#define BCHP_PHY_FIXD_CMN_DPM_ZONE_CTRL_phy_dpm_enable_MASK        0x00010000
#define BCHP_PHY_FIXD_CMN_DPM_ZONE_CTRL_phy_dpm_enable_SHIFT       16
#define BCHP_PHY_FIXD_CMN_DPM_ZONE_CTRL_phy_dpm_enable_DEFAULT     0x00000000

/* PHY :: FIXD_CMN_DPM_ZONE_CTRL :: phy_dpm_zone_pwr_z_ctl7 [15:14] */
#define BCHP_PHY_FIXD_CMN_DPM_ZONE_CTRL_phy_dpm_zone_pwr_z_ctl7_MASK 0x0000c000
#define BCHP_PHY_FIXD_CMN_DPM_ZONE_CTRL_phy_dpm_zone_pwr_z_ctl7_SHIFT 14
#define BCHP_PHY_FIXD_CMN_DPM_ZONE_CTRL_phy_dpm_zone_pwr_z_ctl7_DEFAULT 0x00000000

/* PHY :: FIXD_CMN_DPM_ZONE_CTRL :: phy_dpm_zone_pwr_z_ctl6 [13:12] */
#define BCHP_PHY_FIXD_CMN_DPM_ZONE_CTRL_phy_dpm_zone_pwr_z_ctl6_MASK 0x00003000
#define BCHP_PHY_FIXD_CMN_DPM_ZONE_CTRL_phy_dpm_zone_pwr_z_ctl6_SHIFT 12
#define BCHP_PHY_FIXD_CMN_DPM_ZONE_CTRL_phy_dpm_zone_pwr_z_ctl6_DEFAULT 0x00000000

/* PHY :: FIXD_CMN_DPM_ZONE_CTRL :: phy_dpm_zone_pwr_z_ctl5 [11:10] */
#define BCHP_PHY_FIXD_CMN_DPM_ZONE_CTRL_phy_dpm_zone_pwr_z_ctl5_MASK 0x00000c00
#define BCHP_PHY_FIXD_CMN_DPM_ZONE_CTRL_phy_dpm_zone_pwr_z_ctl5_SHIFT 10
#define BCHP_PHY_FIXD_CMN_DPM_ZONE_CTRL_phy_dpm_zone_pwr_z_ctl5_DEFAULT 0x00000000

/* PHY :: FIXD_CMN_DPM_ZONE_CTRL :: phy_dpm_zone_pwr_z_ctl4 [09:08] */
#define BCHP_PHY_FIXD_CMN_DPM_ZONE_CTRL_phy_dpm_zone_pwr_z_ctl4_MASK 0x00000300
#define BCHP_PHY_FIXD_CMN_DPM_ZONE_CTRL_phy_dpm_zone_pwr_z_ctl4_SHIFT 8
#define BCHP_PHY_FIXD_CMN_DPM_ZONE_CTRL_phy_dpm_zone_pwr_z_ctl4_DEFAULT 0x00000000

/* PHY :: FIXD_CMN_DPM_ZONE_CTRL :: phy_dpm_zone_pwr_z_ctl3 [07:06] */
#define BCHP_PHY_FIXD_CMN_DPM_ZONE_CTRL_phy_dpm_zone_pwr_z_ctl3_MASK 0x000000c0
#define BCHP_PHY_FIXD_CMN_DPM_ZONE_CTRL_phy_dpm_zone_pwr_z_ctl3_SHIFT 6
#define BCHP_PHY_FIXD_CMN_DPM_ZONE_CTRL_phy_dpm_zone_pwr_z_ctl3_DEFAULT 0x00000000

/* PHY :: FIXD_CMN_DPM_ZONE_CTRL :: phy_dpm_zone_pwr_z_ctl2 [05:04] */
#define BCHP_PHY_FIXD_CMN_DPM_ZONE_CTRL_phy_dpm_zone_pwr_z_ctl2_MASK 0x00000030
#define BCHP_PHY_FIXD_CMN_DPM_ZONE_CTRL_phy_dpm_zone_pwr_z_ctl2_SHIFT 4
#define BCHP_PHY_FIXD_CMN_DPM_ZONE_CTRL_phy_dpm_zone_pwr_z_ctl2_DEFAULT 0x00000000

/* PHY :: FIXD_CMN_DPM_ZONE_CTRL :: phy_dpm_zone_pwr_z_ctl1 [03:02] */
#define BCHP_PHY_FIXD_CMN_DPM_ZONE_CTRL_phy_dpm_zone_pwr_z_ctl1_MASK 0x0000000c
#define BCHP_PHY_FIXD_CMN_DPM_ZONE_CTRL_phy_dpm_zone_pwr_z_ctl1_SHIFT 2
#define BCHP_PHY_FIXD_CMN_DPM_ZONE_CTRL_phy_dpm_zone_pwr_z_ctl1_DEFAULT 0x00000000

/* PHY :: FIXD_CMN_DPM_ZONE_CTRL :: phy_dpm_zone_pwr_z_ctl0 [01:00] */
#define BCHP_PHY_FIXD_CMN_DPM_ZONE_CTRL_phy_dpm_zone_pwr_z_ctl0_MASK 0x00000003
#define BCHP_PHY_FIXD_CMN_DPM_ZONE_CTRL_phy_dpm_zone_pwr_z_ctl0_SHIFT 0
#define BCHP_PHY_FIXD_CMN_DPM_ZONE_CTRL_phy_dpm_zone_pwr_z_ctl0_DEFAULT 0x00000000

/***************************************************************************
 *FIXD_CMN_DPM_STAT - per zone power status
 ***************************************************************************/
/* PHY :: FIXD_CMN_DPM_STAT :: reserved0 [31:08] */
#define BCHP_PHY_FIXD_CMN_DPM_STAT_reserved0_MASK                  0xffffff00
#define BCHP_PHY_FIXD_CMN_DPM_STAT_reserved0_SHIFT                 8

/* PHY :: FIXD_CMN_DPM_STAT :: phy_dpm_zone_pwr_status [07:00] */
#define BCHP_PHY_FIXD_CMN_DPM_STAT_phy_dpm_zone_pwr_status_MASK    0x000000ff
#define BCHP_PHY_FIXD_CMN_DPM_STAT_phy_dpm_zone_pwr_status_SHIFT   0
#define BCHP_PHY_FIXD_CMN_DPM_STAT_phy_dpm_zone_pwr_status_DEFAULT 0x0000000f

/***************************************************************************
 *FIXD_RX_AGC_VGA_LUT0_MEM%i - AGC LUT0
 ***************************************************************************/
#define BCHP_PHY_FIXD_RX_AGC_VGA_LUT0_MEMi_ARRAY_BASE              0x00fe0400
#define BCHP_PHY_FIXD_RX_AGC_VGA_LUT0_MEMi_ARRAY_START             0
#define BCHP_PHY_FIXD_RX_AGC_VGA_LUT0_MEMi_ARRAY_END               255
#define BCHP_PHY_FIXD_RX_AGC_VGA_LUT0_MEMi_ARRAY_ELEMENT_SIZE      32

/***************************************************************************
 *FIXD_RX_AGC_VGA_LUT0_MEM%i - AGC LUT0
 ***************************************************************************/
/* PHY :: FIXD_RX_AGC_VGA_LUT0_MEMi :: reserved0 [31:29] */
#define BCHP_PHY_FIXD_RX_AGC_VGA_LUT0_MEMi_reserved0_MASK          0xe0000000
#define BCHP_PHY_FIXD_RX_AGC_VGA_LUT0_MEMi_reserved0_SHIFT         29

/* PHY :: FIXD_RX_AGC_VGA_LUT0_MEMi :: total_gain0 [28:19] */
#define BCHP_PHY_FIXD_RX_AGC_VGA_LUT0_MEMi_total_gain0_MASK        0x1ff80000
#define BCHP_PHY_FIXD_RX_AGC_VGA_LUT0_MEMi_total_gain0_SHIFT       19

/* PHY :: FIXD_RX_AGC_VGA_LUT0_MEMi :: lna_gain0 [18:15] */
#define BCHP_PHY_FIXD_RX_AGC_VGA_LUT0_MEMi_lna_gain0_MASK          0x00078000
#define BCHP_PHY_FIXD_RX_AGC_VGA_LUT0_MEMi_lna_gain0_SHIFT         15

/* PHY :: FIXD_RX_AGC_VGA_LUT0_MEMi :: RFpga_gain0 [14:09] */
#define BCHP_PHY_FIXD_RX_AGC_VGA_LUT0_MEMi_RFpga_gain0_MASK        0x00007e00
#define BCHP_PHY_FIXD_RX_AGC_VGA_LUT0_MEMi_RFpga_gain0_SHIFT       9

/* PHY :: FIXD_RX_AGC_VGA_LUT0_MEMi :: LPF_Gain0 [08:07] */
#define BCHP_PHY_FIXD_RX_AGC_VGA_LUT0_MEMi_LPF_Gain0_MASK          0x00000180
#define BCHP_PHY_FIXD_RX_AGC_VGA_LUT0_MEMi_LPF_Gain0_SHIFT         7

/* PHY :: FIXD_RX_AGC_VGA_LUT0_MEMi :: Mixer_Gain0 [06:05] */
#define BCHP_PHY_FIXD_RX_AGC_VGA_LUT0_MEMi_Mixer_Gain0_MASK        0x00000060
#define BCHP_PHY_FIXD_RX_AGC_VGA_LUT0_MEMi_Mixer_Gain0_SHIFT       5

/* PHY :: FIXD_RX_AGC_VGA_LUT0_MEMi :: PGA_Gain0 [04:00] */
#define BCHP_PHY_FIXD_RX_AGC_VGA_LUT0_MEMi_PGA_Gain0_MASK          0x0000001f
#define BCHP_PHY_FIXD_RX_AGC_VGA_LUT0_MEMi_PGA_Gain0_SHIFT         0


/***************************************************************************
 *FIXD_RX_PROBE3_REF_MEM%i - Probe3 referance memory for MoCA2 only
 ***************************************************************************/
#define BCHP_PHY_FIXD_RX_PROBE3_REF_MEMi_ARRAY_BASE                0x00fe0800
 ...
 ***************************************************************************/
#define BCHP_PHY_FIXD_TX_LONG_PREAMBLE_MEMi_ARRAY_BASE             0x00fe0c00
 ...
 ***************************************************************************/
#define BCHP_PHY_FIXD_TX_LONG_MAP_PREAMBLE_MEMi_ARRAY_BASE         0x00fe0e00
 ...
 ***************************************************************************/
#define BCHP_PHY_FIXD_CMN_M2_DIVERSITY_MEMi_ARRAY_BASE             0x00fe1000
 ...
 *FIXD_CMN_M2_DIVERSITY_MEM%i - RX diversity mapping
 ***************************************************************************/
/* PHY :: FIXD_CMN_M2_DIVERSITY_MEMi :: available_carier_3 [31:31] */
#define BCHP_PHY_FIXD_CMN_M2_DIVERSITY_MEMi_available_carier_3_MASK 0x80000000
#define BCHP_PHY_FIXD_CMN_M2_DIVERSITY_MEMi_available_carier_3_SHIFT 31
...
/* PHY :: FIXD_CMN_M2_DIVERSITY_MEMi :: available_carier_2 [23:23] */
#define BCHP_PHY_FIXD_CMN_M2_DIVERSITY_MEMi_available_carier_2_MASK 0x00800000
#define BCHP_PHY_FIXD_CMN_M2_DIVERSITY_MEMi_available_carier_2_SHIFT 23
...
/* PHY :: FIXD_CMN_M2_DIVERSITY_MEMi :: available_carier_1 [15:15] */
#define BCHP_PHY_FIXD_CMN_M2_DIVERSITY_MEMi_available_carier_1_MASK 0x00008000
#define BCHP_PHY_FIXD_CMN_M2_DIVERSITY_MEMi_available_carier_1_SHIFT 15
...
/* PHY :: FIXD_CMN_M2_DIVERSITY_MEMi :: available_carier_0 [07:07] */
#define BCHP_PHY_FIXD_CMN_M2_DIVERSITY_MEMi_available_carier_0_MASK 0x00000080
#define BCHP_PHY_FIXD_CMN_M2_DIVERSITY_MEMi_available_carier_0_SHIFT 7
 ...
 ***************************************************************************/
#define BCHP_PHY_FIXD_TX_SHORT_PREAMBLE_MEMi_ARRAY_BASE            0x00fe1200
...
/***************************************************************************
 *FIXD_RX_AGC_VGA_LUT1_MEM%i - AGC LUT1
 ***************************************************************************/
#define BCHP_PHY_FIXD_RX_AGC_VGA_LUT1_MEMi_ARRAY_BASE              0x00fe1400
#define BCHP_PHY_FIXD_RX_AGC_VGA_LUT1_MEMi_ARRAY_START             0
#define BCHP_PHY_FIXD_RX_AGC_VGA_LUT1_MEMi_ARRAY_END               255
#define BCHP_PHY_FIXD_RX_AGC_VGA_LUT1_MEMi_ARRAY_ELEMENT_SIZE      32

/***************************************************************************
 *FIXD_RX_AGC_VGA_LUT1_MEM%i - AGC LUT1
 ***************************************************************************/
/* PHY :: FIXD_RX_AGC_VGA_LUT1_MEMi :: reserved0 [31:29] */
#define BCHP_PHY_FIXD_RX_AGC_VGA_LUT1_MEMi_reserved0_MASK          0xe0000000
#define BCHP_PHY_FIXD_RX_AGC_VGA_LUT1_MEMi_reserved0_SHIFT         29

/* PHY :: FIXD_RX_AGC_VGA_LUT1_MEMi :: total_gain1 [28:19] */
#define BCHP_PHY_FIXD_RX_AGC_VGA_LUT1_MEMi_total_gain1_MASK        0x1ff80000
#define BCHP_PHY_FIXD_RX_AGC_VGA_LUT1_MEMi_total_gain1_SHIFT       19

/* PHY :: FIXD_RX_AGC_VGA_LUT1_MEMi :: lna_gain1 [18:15] */
#define BCHP_PHY_FIXD_RX_AGC_VGA_LUT1_MEMi_lna_gain1_MASK          0x00078000
#define BCHP_PHY_FIXD_RX_AGC_VGA_LUT1_MEMi_lna_gain1_SHIFT         15

/* PHY :: FIXD_RX_AGC_VGA_LUT1_MEMi :: RFpga_gain1 [14:09] */
#define BCHP_PHY_FIXD_RX_AGC_VGA_LUT1_MEMi_RFpga_gain1_MASK        0x00007e00
#define BCHP_PHY_FIXD_RX_AGC_VGA_LUT1_MEMi_RFpga_gain1_SHIFT       9

/* PHY :: FIXD_RX_AGC_VGA_LUT1_MEMi :: LPF_Gain1 [08:07] */
#define BCHP_PHY_FIXD_RX_AGC_VGA_LUT1_MEMi_LPF_Gain1_MASK          0x00000180
#define BCHP_PHY_FIXD_RX_AGC_VGA_LUT1_MEMi_LPF_Gain1_SHIFT         7

/* PHY :: FIXD_RX_AGC_VGA_LUT1_MEMi :: Mixer_Gain1 [06:05] */
#define BCHP_PHY_FIXD_RX_AGC_VGA_LUT1_MEMi_Mixer_Gain1_MASK        0x00000060
#define BCHP_PHY_FIXD_RX_AGC_VGA_LUT1_MEMi_Mixer_Gain1_SHIFT       5

/* PHY :: FIXD_RX_AGC_VGA_LUT1_MEMi :: PGA_Gain1 [04:00] */
#define BCHP_PHY_FIXD_RX_AGC_VGA_LUT1_MEMi_PGA_Gain1_MASK          0x0000001f
#define BCHP_PHY_FIXD_RX_AGC_VGA_LUT1_MEMi_PGA_Gain1_SHIFT         0


/***************************************************************************
 *BRST_CMN_BYPASS_1 - Debug Bypass Register
 ***************************************************************************/
/* PHY :: BRST_CMN_BYPASS_1 :: reserved0 [31:15] */
#define BCHP_PHY_BRST_CMN_BYPASS_1_reserved0_MASK                  0xffff8000
#define BCHP_PHY_BRST_CMN_BYPASS_1_reserved0_SHIFT                 15

/* PHY :: BRST_CMN_BYPASS_1 :: tx_ce_only_mode [14:14] */
#define BCHP_PHY_BRST_CMN_BYPASS_1_tx_ce_only_mode_MASK            0x00004000
#define BCHP_PHY_BRST_CMN_BYPASS_1_tx_ce_only_mode_SHIFT           14
#define BCHP_PHY_BRST_CMN_BYPASS_1_tx_ce_only_mode_DEFAULT         0x00000000
...
/* PHY :: BRST_CMN_BYPASS_1 :: afe_3450_sw_cfg_en [04:04] */
#define BCHP_PHY_BRST_CMN_BYPASS_1_afe_3450_sw_cfg_en_MASK         0x00000010
#define BCHP_PHY_BRST_CMN_BYPASS_1_afe_3450_sw_cfg_en_SHIFT        4
#define BCHP_PHY_BRST_CMN_BYPASS_1_afe_3450_sw_cfg_en_DEFAULT      0x00000000
...
/* PHY :: BRST_CMN_BYPASS_1 :: rate4to3_conv_bypass [00:00] */
#define BCHP_PHY_BRST_CMN_BYPASS_1_rate4to3_conv_bypass_MASK       0x00000001
#define BCHP_PHY_BRST_CMN_BYPASS_1_rate4to3_conv_bypass_SHIFT      0
#define BCHP_PHY_BRST_CMN_BYPASS_1_rate4to3_conv_bypass_DEFAULT    0x00000000
...
/* PHY :: BRST_RX_ACQUISITION_1 :: reserved0 [25:22] */
#define BCHP_PHY_BRST_RX_ACQUISITION_1_reserved0_MASK              0x03c00000
#define BCHP_PHY_BRST_RX_ACQUISITION_1_reserved0_SHIFT             22
...
/* PHY :: BRST_TX_TXOFF_TIMER :: spare [23:16] */
#define BCHP_PHY_BRST_TX_TXOFF_TIMER_spare_MASK                    0x00ff0000
#define BCHP_PHY_BRST_TX_TXOFF_TIMER_spare_SHIFT                   16
 ...
 ***************************************************************************/
/* PHY :: BRST_RX_AFE_TEST_MODE :: reserved0 [31:28] */
#define BCHP_PHY_BRST_RX_AFE_TEST_MODE_reserved0_MASK              0xf0000000
#define BCHP_PHY_BRST_RX_AFE_TEST_MODE_reserved0_SHIFT             28

/* PHY :: BRST_RX_AFE_TEST_MODE :: trxdig_tx_data_en_test_mode [27:27] */
#define BCHP_PHY_BRST_RX_AFE_TEST_MODE_trxdig_tx_data_en_test_mode_MASK 0x08000000
#define BCHP_PHY_BRST_RX_AFE_TEST_MODE_trxdig_tx_data_en_test_mode_SHIFT 27
#define BCHP_PHY_BRST_RX_AFE_TEST_MODE_trxdig_tx_data_en_test_mode_DEFAULT 0x00000000

/* PHY :: BRST_RX_AFE_TEST_MODE :: trxdig_tx_blk_en_test_mode [26:26] */
#define BCHP_PHY_BRST_RX_AFE_TEST_MODE_trxdig_tx_blk_en_test_mode_MASK 0x04000000
#define BCHP_PHY_BRST_RX_AFE_TEST_MODE_trxdig_tx_blk_en_test_mode_SHIFT 26
#define BCHP_PHY_BRST_RX_AFE_TEST_MODE_trxdig_tx_blk_en_test_mode_DEFAULT 0x00000000

/* PHY :: BRST_RX_AFE_TEST_MODE :: rx_swHPF_test_mode [25:23] */
#define BCHP_PHY_BRST_RX_AFE_TEST_MODE_rx_swHPF_test_mode_MASK     0x03800000
#define BCHP_PHY_BRST_RX_AFE_TEST_MODE_rx_swHPF_test_mode_SHIFT    23
#define BCHP_PHY_BRST_RX_AFE_TEST_MODE_rx_swHPF_test_mode_DEFAULT  0x00000000

/* PHY :: BRST_RX_AFE_TEST_MODE :: rx_FGA_Gain_test_mode [22:18] */
#define BCHP_PHY_BRST_RX_AFE_TEST_MODE_rx_FGA_Gain_test_mode_MASK  0x007c0000
#define BCHP_PHY_BRST_RX_AFE_TEST_MODE_rx_FGA_Gain_test_mode_SHIFT 18
#define BCHP_PHY_BRST_RX_AFE_TEST_MODE_rx_FGA_Gain_test_mode_DEFAULT 0x00000000

/* PHY :: BRST_RX_AFE_TEST_MODE :: rx_LPFGain_test_mode [17:16] */
#define BCHP_PHY_BRST_RX_AFE_TEST_MODE_rx_LPFGain_test_mode_MASK   0x00030000
#define BCHP_PHY_BRST_RX_AFE_TEST_MODE_rx_LPFGain_test_mode_SHIFT  16
#define BCHP_PHY_BRST_RX_AFE_TEST_MODE_rx_LPFGain_test_mode_DEFAULT 0x00000000

/* PHY :: BRST_RX_AFE_TEST_MODE :: rx_MIXGain_test_mode [15:14] */
#define BCHP_PHY_BRST_RX_AFE_TEST_MODE_rx_MIXGain_test_mode_MASK   0x0000c000
#define BCHP_PHY_BRST_RX_AFE_TEST_MODE_rx_MIXGain_test_mode_SHIFT  14
#define BCHP_PHY_BRST_RX_AFE_TEST_MODE_rx_MIXGain_test_mode_DEFAULT 0x00000000

/* PHY :: BRST_RX_AFE_TEST_MODE :: rx_RFpga_gain_test_mode [13:08] */
#define BCHP_PHY_BRST_RX_AFE_TEST_MODE_rx_RFpga_gain_test_mode_MASK 0x00003f00
 ...
 ***************************************************************************/
/* PHY :: BRST_RX_AGC_PARAM_3 :: reserved0 [31:30] */
#define BCHP_PHY_BRST_RX_AGC_PARAM_3_reserved0_MASK                0xc0000000
#define BCHP_PHY_BRST_RX_AGC_PARAM_3_reserved0_SHIFT               30

/* PHY :: BRST_RX_AGC_PARAM_3 :: force_3450_master [29:29] */
#define BCHP_PHY_BRST_RX_AGC_PARAM_3_force_3450_master_MASK        0x20000000
#define BCHP_PHY_BRST_RX_AGC_PARAM_3_force_3450_master_SHIFT       29
#define BCHP_PHY_BRST_RX_AGC_PARAM_3_force_3450_master_DEFAULT     0x00000000
 ...
 ***************************************************************************/
/* PHY :: BRST_CMN_FEC :: reserved0 [31:23] */
#define BCHP_PHY_BRST_CMN_FEC_reserved0_MASK                       0xff800000
#define BCHP_PHY_BRST_CMN_FEC_reserved0_SHIFT                      23

/* PHY :: BRST_CMN_FEC :: ldpc_sc_en [22:22] */
#define BCHP_PHY_BRST_CMN_FEC_ldpc_sc_en_MASK                      0x00400000
#define BCHP_PHY_BRST_CMN_FEC_ldpc_sc_en_SHIFT                     22
#define BCHP_PHY_BRST_CMN_FEC_ldpc_sc_en_DEFAULT                   0x00000001
 ...
 ***************************************************************************/
/* PHY :: BRST_CMN_GEN :: reserved0 [31:19] */
#define BCHP_PHY_BRST_CMN_GEN_reserved0_MASK                       0xfff80000
#define BCHP_PHY_BRST_CMN_GEN_reserved0_SHIFT                      19
...
/* PHY :: BRST_CMN_INIT_FRAME :: reserved0 [29:16] */
#define BCHP_PHY_BRST_CMN_INIT_FRAME_reserved0_MASK                0x3fff0000
#define BCHP_PHY_BRST_CMN_INIT_FRAME_reserved0_SHIFT               16
 ...
 ***************************************************************************/
/* PHY :: BRST_CMN_INIT_FEC :: ldpc_cw_load [31:20] */
#define BCHP_PHY_BRST_CMN_INIT_FEC_ldpc_cw_load_MASK               0xfff00000
#define BCHP_PHY_BRST_CMN_INIT_FEC_ldpc_cw_load_SHIFT              20
#define BCHP_PHY_BRST_CMN_INIT_FEC_ldpc_cw_load_DEFAULT            0x00000000

/* PHY :: BRST_CMN_INIT_FEC :: ldpc_rs_num_of_cw [19:12] */
#define BCHP_PHY_BRST_CMN_INIT_FEC_ldpc_rs_num_of_cw_MASK          0x000ff000
...
/***************************************************************************
 *BRST_CMN_INIT_FRAME_1 - Rx and Tx Burst Parameters #2
 ***************************************************************************/
/* PHY :: BRST_CMN_INIT_FRAME_1 :: reserved0 [31:19] */
#define BCHP_PHY_BRST_CMN_INIT_FRAME_1_reserved0_MASK              0xfff80000
#define BCHP_PHY_BRST_CMN_INIT_FRAME_1_reserved0_SHIFT             19

/* PHY :: BRST_CMN_INIT_FRAME_1 :: frame_length [18:00] */
#define BCHP_PHY_BRST_CMN_INIT_FRAME_1_frame_length_MASK           0x0007ffff
#define BCHP_PHY_BRST_CMN_INIT_FRAME_1_frame_length_SHIFT          0
#define BCHP_PHY_BRST_CMN_INIT_FRAME_1_frame_length_DEFAULT        0x00000000
 ...
 ***************************************************************************/
#define BCHP_PHY_BRST_TX_PROF_BIT_LOAD_MEMi_ARRAY_BASE             0x00fe2100
 ...
 ***************************************************************************/
/* PHY :: BRST_TX_PROF_RF_SW_1 :: tx_extra_sw0_off [31:31] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_extra_sw0_off_MASK        0x80000000
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_extra_sw0_off_SHIFT       31
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_extra_sw0_off_DEFAULT     0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_1 :: tx_extra_sw0_on [30:30] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_extra_sw0_on_MASK         0x40000000
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_extra_sw0_on_SHIFT        30
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_extra_sw0_on_DEFAULT      0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_1 :: tx_clk_d2c_pup_hv_off [29:29] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_clk_d2c_pup_hv_off_MASK   0x20000000
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_clk_d2c_pup_hv_off_SHIFT  29
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_clk_d2c_pup_hv_off_DEFAULT 0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_1 :: tx_clk_d2c_pup_hv_on [28:28] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_clk_d2c_pup_hv_on_MASK    0x10000000
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_clk_d2c_pup_hv_on_SHIFT   28
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_clk_d2c_pup_hv_on_DEFAULT 0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_1 :: tx_clk_mux_pup_hv_off [27:27] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_clk_mux_pup_hv_off_MASK   0x08000000
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_clk_mux_pup_hv_off_SHIFT  27
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_clk_mux_pup_hv_off_DEFAULT 0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_1 :: tx_clk_mux_pup_hv_on [26:26] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_clk_mux_pup_hv_on_MASK    0x04000000
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_clk_mux_pup_hv_on_SHIFT   26
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_clk_mux_pup_hv_on_DEFAULT 0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_1 :: tx_ldo_ser_pup_hv_off [25:25] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_ldo_ser_pup_hv_off_MASK   0x02000000
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_ldo_ser_pup_hv_off_SHIFT  25
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_ldo_ser_pup_hv_off_DEFAULT 0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_1 :: tx_ldo_ser_pup_hv_on [24:24] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_ldo_ser_pup_hv_on_MASK    0x01000000
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_ldo_ser_pup_hv_on_SHIFT   24
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_ldo_ser_pup_hv_on_DEFAULT 0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_1 :: tx_ldo_ana_pup_hv_off [23:23] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_ldo_ana_pup_hv_off_MASK   0x00800000
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_ldo_ana_pup_hv_off_SHIFT  23
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_ldo_ana_pup_hv_off_DEFAULT 0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_1 :: tx_ldo_ana_pup_hv_on [22:22] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_ldo_ana_pup_hv_on_MASK    0x00400000
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_ldo_ana_pup_hv_on_SHIFT   22
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_ldo_ana_pup_hv_on_DEFAULT 0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_1 :: tx_ldo_latch_pup_hv_off [21:21] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_ldo_latch_pup_hv_off_MASK 0x00200000
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_ldo_latch_pup_hv_off_SHIFT 21
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_ldo_latch_pup_hv_off_DEFAULT 0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_1 :: tx_ldo_latch_pup_hv_on [20:20] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_ldo_latch_pup_hv_on_MASK  0x00100000
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_ldo_latch_pup_hv_on_SHIFT 20
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_ldo_latch_pup_hv_on_DEFAULT 0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_1 :: tx_ldo_dec_pup_hv_off [19:19] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_ldo_dec_pup_hv_off_MASK   0x00080000
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_ldo_dec_pup_hv_off_SHIFT  19
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_ldo_dec_pup_hv_off_DEFAULT 0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_1 :: tx_ldo_dec_pup_hv_on [18:18] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_ldo_dec_pup_hv_on_MASK    0x00040000
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_ldo_dec_pup_hv_on_SHIFT   18
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_ldo_dec_pup_hv_on_DEFAULT 0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_1 :: tx_ldo_clk_pup_hv_off [17:17] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_ldo_clk_pup_hv_off_MASK   0x00020000
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_ldo_clk_pup_hv_off_SHIFT  17
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_ldo_clk_pup_hv_off_DEFAULT 0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_1 :: tx_ldo_clk_pup_hv_on [16:16] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_ldo_clk_pup_hv_on_MASK    0x00010000
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_ldo_clk_pup_hv_on_SHIFT   16
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_ldo_clk_pup_hv_on_DEFAULT 0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_1 :: tx_txdac_pup_hv_off [15:15] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_txdac_pup_hv_off_MASK     0x00008000
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_txdac_pup_hv_off_SHIFT    15
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_txdac_pup_hv_off_DEFAULT  0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_1 :: tx_txdac_pup_hv_on [14:14] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_txdac_pup_hv_on_MASK      0x00004000
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_txdac_pup_hv_on_SHIFT     14
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_txdac_pup_hv_on_DEFAULT   0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_1 :: tx_wbdac_rst_lv_off [13:13] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_wbdac_rst_lv_off_MASK     0x00002000
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_wbdac_rst_lv_off_SHIFT    13
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_wbdac_rst_lv_off_DEFAULT  0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_1 :: tx_wbdac_rst_lv_on [12:12] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_wbdac_rst_lv_on_MASK      0x00001000
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_wbdac_rst_lv_on_SHIFT     12
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_wbdac_rst_lv_on_DEFAULT   0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_1 :: tx_dac_rst_off [11:11] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_dac_rst_off_MASK          0x00000800
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_dac_rst_off_SHIFT         11
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_dac_rst_off_DEFAULT       0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_1 :: tx_dac_rst_on [10:10] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_dac_rst_on_MASK           0x00000400
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_dac_rst_on_SHIFT          10
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_dac_rst_on_DEFAULT        0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_1 :: tx_tonegen_pup_1p0_off [09:09] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_tonegen_pup_1p0_off_MASK  0x00000200
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_tonegen_pup_1p0_off_SHIFT 9
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_tonegen_pup_1p0_off_DEFAULT 0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_1 :: tx_tonegen_pup_1p0_on [08:08] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_tonegen_pup_1p0_on_MASK   0x00000100
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_tonegen_pup_1p0_on_SHIFT  8
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_tonegen_pup_1p0_on_DEFAULT 0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_1 :: tx_lb_sf_pup_1p0_off [07:07] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_lb_sf_pup_1p0_off_MASK    0x00000080
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_lb_sf_pup_1p0_off_SHIFT   7
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_lb_sf_pup_1p0_off_DEFAULT 0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_1 :: tx_lb_sf_pup_1p0_on [06:06] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_lb_sf_pup_1p0_on_MASK     0x00000040
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_lb_sf_pup_1p0_on_SHIFT    6
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_lb_sf_pup_1p0_on_DEFAULT  0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_1 :: tx_lb_sf_bias_pup_1p0_off [05:05] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_lb_sf_bias_pup_1p0_off_MASK 0x00000020
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_lb_sf_bias_pup_1p0_off_SHIFT 5
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_lb_sf_bias_pup_1p0_off_DEFAULT 0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_1 :: tx_lb_sf_bias_pup_1p0_on [04:04] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_lb_sf_bias_pup_1p0_on_MASK 0x00000010
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_lb_sf_bias_pup_1p0_on_SHIFT 4
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_lb_sf_bias_pup_1p0_on_DEFAULT 0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_1 :: tx_tonegen_en_off [03:03] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_tonegen_en_off_MASK       0x00000008
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_tonegen_en_off_SHIFT      3
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_tonegen_en_off_DEFAULT    0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_1 :: tx_tonegen_en_on [02:02] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_tonegen_en_on_MASK        0x00000004
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_tonegen_en_on_SHIFT       2
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_tonegen_en_on_DEFAULT     0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_1 :: tx_lb_en_off [01:01] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_lb_en_off_MASK            0x00000002
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_lb_en_off_SHIFT           1
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_lb_en_off_DEFAULT         0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_1 :: tx_lb_en_on [00:00] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_lb_en_on_MASK             0x00000001
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_lb_en_on_SHIFT            0
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1_tx_lb_en_on_DEFAULT          0x00000000

/***************************************************************************
 *BRST_TX_PROF_RF_SW_2 - TX Burst Switches
 ***************************************************************************/
/* PHY :: BRST_TX_PROF_RF_SW_2 :: tx_extra_sw1_off [31:31] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw1_off_MASK        0x80000000
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw1_off_SHIFT       31
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw1_off_DEFAULT     0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_2 :: tx_extra_sw1_on [30:30] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw1_on_MASK         0x40000000
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw1_on_SHIFT        30
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw1_on_DEFAULT      0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_2 :: tx_extra_sw2_off [29:29] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw2_off_MASK        0x20000000
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw2_off_SHIFT       29
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw2_off_DEFAULT     0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_2 :: tx_extra_sw2_on [28:28] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw2_on_MASK         0x10000000
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw2_on_SHIFT        28
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw2_on_DEFAULT      0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_2 :: tx_extra_sw3_off [27:27] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw3_off_MASK        0x08000000
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw3_off_SHIFT       27
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw3_off_DEFAULT     0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_2 :: tx_extra_sw3_on [26:26] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw3_on_MASK         0x04000000
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw3_on_SHIFT        26
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw3_on_DEFAULT      0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_2 :: tx_extra_sw4_off [25:25] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw4_off_MASK        0x02000000
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw4_off_SHIFT       25
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw4_off_DEFAULT     0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_2 :: tx_extra_sw4_on [24:24] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw4_on_MASK         0x01000000
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw4_on_SHIFT        24
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw4_on_DEFAULT      0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_2 :: tx_extra_sw5_off [23:23] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw5_off_MASK        0x00800000
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw5_off_SHIFT       23
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw5_off_DEFAULT     0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_2 :: tx_extra_sw5_on [22:22] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw5_on_MASK         0x00400000
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw5_on_SHIFT        22
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw5_on_DEFAULT      0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_2 :: tx_extra_sw6_off [21:21] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw6_off_MASK        0x00200000
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw6_off_SHIFT       21
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw6_off_DEFAULT     0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_2 :: tx_extra_sw6_on [20:20] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw6_on_MASK         0x00100000
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw6_on_SHIFT        20
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw6_on_DEFAULT      0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_2 :: tx_extra_sw7_off [19:19] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw7_off_MASK        0x00080000
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw7_off_SHIFT       19
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw7_off_DEFAULT     0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_2 :: tx_extra_sw7_on [18:18] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw7_on_MASK         0x00040000
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw7_on_SHIFT        18
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw7_on_DEFAULT      0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_2 :: tx_extra_sw8_off [17:17] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw8_off_MASK        0x00020000
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw8_off_SHIFT       17
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw8_off_DEFAULT     0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_2 :: tx_extra_sw8_on [16:16] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw8_on_MASK         0x00010000
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw8_on_SHIFT        16
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw8_on_DEFAULT      0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_2 :: tx_extra_sw9_off [15:15] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw9_off_MASK        0x00008000
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw9_off_SHIFT       15
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw9_off_DEFAULT     0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_2 :: tx_extra_sw9_on [14:14] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw9_on_MASK         0x00004000
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw9_on_SHIFT        14
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw9_on_DEFAULT      0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_2 :: tx_extra_sw10_off [13:13] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw10_off_MASK       0x00002000
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw10_off_SHIFT      13
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw10_off_DEFAULT    0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_2 :: tx_extra_sw10_on [12:12] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw10_on_MASK        0x00001000
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw10_on_SHIFT       12
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw10_on_DEFAULT     0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_2 :: tx_extra_sw11_off [11:11] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw11_off_MASK       0x00000800
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw11_off_SHIFT      11
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw11_off_DEFAULT    0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_2 :: tx_extra_sw11_on [10:10] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw11_on_MASK        0x00000400
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw11_on_SHIFT       10
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw11_on_DEFAULT     0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_2 :: tx_extra_sw12_off [09:09] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw12_off_MASK       0x00000200
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw12_off_SHIFT      9
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw12_off_DEFAULT    0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_2 :: tx_extra_sw12_on [08:08] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw12_on_MASK        0x00000100
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw12_on_SHIFT       8
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw12_on_DEFAULT     0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_2 :: tx_extra_sw13_off [07:07] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw13_off_MASK       0x00000080
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw13_off_SHIFT      7
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw13_off_DEFAULT    0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_2 :: tx_extra_sw13_on [06:06] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw13_on_MASK        0x00000040
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw13_on_SHIFT       6
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw13_on_DEFAULT     0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_2 :: tx_extra_sw14_off [05:05] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw14_off_MASK       0x00000020
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw14_off_SHIFT      5
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw14_off_DEFAULT    0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_2 :: tx_extra_sw14_on [04:04] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw14_on_MASK        0x00000010
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw14_on_SHIFT       4
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw14_on_DEFAULT     0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_2 :: tx_extra_sw15_off [03:03] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw15_off_MASK       0x00000008
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw15_off_SHIFT      3
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw15_off_DEFAULT    0x00000000

/* PHY :: BRST_TX_PROF_RF_SW_2 :: tx_extra_sw15_on [02:02] */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw15_on_MASK        0x00000004
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw15_on_SHIFT       2
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2_tx_extra_sw15_on_DEFAULT     0x00000000
 ...
 ***************************************************************************/
/* PHY :: BRST_TX_PROF_RF_1 :: tx_trx_param_time_smp_sel [31:31] */
#define BCHP_PHY_BRST_TX_PROF_RF_1_tx_trx_param_time_smp_sel_MASK  0x80000000
#define BCHP_PHY_BRST_TX_PROF_RF_1_tx_trx_param_time_smp_sel_SHIFT 31
#define BCHP_PHY_BRST_TX_PROF_RF_1_tx_trx_param_time_smp_sel_DEFAULT 0x00000000

/* PHY :: BRST_TX_PROF_RF_1 :: s_p_a_r_e_tx01 [30:23] */
#define BCHP_PHY_BRST_TX_PROF_RF_1_s_p_a_r_e_tx01_MASK             0x7f800000
#define BCHP_PHY_BRST_TX_PROF_RF_1_s_p_a_r_e_tx01_SHIFT            23
#define BCHP_PHY_BRST_TX_PROF_RF_1_s_p_a_r_e_tx01_DEFAULT          0x00000000

/* PHY :: BRST_TX_PROF_RF_1 :: tx_dac_pbo_hv [22:18] */
#define BCHP_PHY_BRST_TX_PROF_RF_1_tx_dac_pbo_hv_MASK              0x007c0000
#define BCHP_PHY_BRST_TX_PROF_RF_1_tx_dac_pbo_hv_SHIFT             18
#define BCHP_PHY_BRST_TX_PROF_RF_1_tx_dac_pbo_hv_DEFAULT           0x00000004

/* PHY :: BRST_TX_PROF_RF_1 :: tx_dac_gain_hv [17:12] */
#define BCHP_PHY_BRST_TX_PROF_RF_1_tx_dac_gain_hv_MASK             0x0003f000
#define BCHP_PHY_BRST_TX_PROF_RF_1_tx_dac_gain_hv_SHIFT            12
#define BCHP_PHY_BRST_TX_PROF_RF_1_tx_dac_gain_hv_DEFAULT          0x00000004
...
/* PHY :: BRST_TX_PROF_RF_1 :: spare2 [07:05] */
#define BCHP_PHY_BRST_TX_PROF_RF_1_spare2_MASK                     0x000000e0
#define BCHP_PHY_BRST_TX_PROF_RF_1_spare2_SHIFT                    5
#define BCHP_PHY_BRST_TX_PROF_RF_1_spare2_DEFAULT                  0x00000000

/* PHY :: BRST_TX_PROF_RF_1 :: trx_phy0_if_freq_inc [04:00] */
#define BCHP_PHY_BRST_TX_PROF_RF_1_trx_phy0_if_freq_inc_MASK       0x0000001f
#define BCHP_PHY_BRST_TX_PROF_RF_1_trx_phy0_if_freq_inc_SHIFT      0
#define BCHP_PHY_BRST_TX_PROF_RF_1_trx_phy0_if_freq_inc_DEFAULT    0x00000000

/***************************************************************************
 *BRST_TX_PROF_GAIN - Profile TX
 ***************************************************************************/
/* PHY :: BRST_TX_PROF_GAIN :: reserved0 [31:29] */
#define BCHP_PHY_BRST_TX_PROF_GAIN_reserved0_MASK                  0xe0000000
#define BCHP_PHY_BRST_TX_PROF_GAIN_reserved0_SHIFT                 29

/* PHY :: BRST_TX_PROF_GAIN :: tx_remove_ramp_up [28:21] */
#define BCHP_PHY_BRST_TX_PROF_GAIN_tx_remove_ramp_up_MASK          0x1fe00000
#define BCHP_PHY_BRST_TX_PROF_GAIN_tx_remove_ramp_up_SHIFT         21
#define BCHP_PHY_BRST_TX_PROF_GAIN_tx_remove_ramp_up_DEFAULT       0x00000000

/* PHY :: BRST_TX_PROF_GAIN :: tx_flip_spectrum [20:20] */
#define BCHP_PHY_BRST_TX_PROF_GAIN_tx_flip_spectrum_MASK           0x00100000
#define BCHP_PHY_BRST_TX_PROF_GAIN_tx_flip_spectrum_SHIFT          20
#define BCHP_PHY_BRST_TX_PROF_GAIN_tx_flip_spectrum_DEFAULT        0x00000000
 ...
 ***************************************************************************/
/* PHY :: BRST_TX_PROF_MAIN_CFO :: tx_decrease_dur [31:20] */
#define BCHP_PHY_BRST_TX_PROF_MAIN_CFO_tx_decrease_dur_MASK        0xfff00000
#define BCHP_PHY_BRST_TX_PROF_MAIN_CFO_tx_decrease_dur_SHIFT       20
#define BCHP_PHY_BRST_TX_PROF_MAIN_CFO_tx_decrease_dur_DEFAULT     0x00000000
 ...
 ***************************************************************************/
#define BCHP_PHY_BRST_RX_PROF_TX_ID_MEMi_ARRAY_BASE                0x00fe2300
 ...
 *BRST_RX_PROF_TX_ID_MEM%i - OFDMA trasmitter ID
 ***************************************************************************/
/* PHY :: BRST_RX_PROF_TX_ID_MEMi :: pilot_sc_mask_0 [31:31] */
#define BCHP_PHY_BRST_RX_PROF_TX_ID_MEMi_pilot_sc_mask_0_MASK      0x80000000
#define BCHP_PHY_BRST_RX_PROF_TX_ID_MEMi_pilot_sc_mask_0_SHIFT     31
...
/* PHY :: BRST_RX_PROF_TX_ID_MEMi :: pilot_sc_mask_1 [27:27] */
#define BCHP_PHY_BRST_RX_PROF_TX_ID_MEMi_pilot_sc_mask_1_MASK      0x08000000
#define BCHP_PHY_BRST_RX_PROF_TX_ID_MEMi_pilot_sc_mask_1_SHIFT     27
...
/* PHY :: BRST_RX_PROF_TX_ID_MEMi :: pilot_sc_mask_2 [23:23] */
#define BCHP_PHY_BRST_RX_PROF_TX_ID_MEMi_pilot_sc_mask_2_MASK      0x00800000
#define BCHP_PHY_BRST_RX_PROF_TX_ID_MEMi_pilot_sc_mask_2_SHIFT     23
...
/* PHY :: BRST_RX_PROF_TX_ID_MEMi :: pilot_sc_mask_3 [19:19] */
#define BCHP_PHY_BRST_RX_PROF_TX_ID_MEMi_pilot_sc_mask_3_MASK      0x00080000
#define BCHP_PHY_BRST_RX_PROF_TX_ID_MEMi_pilot_sc_mask_3_SHIFT     19
...
/* PHY :: BRST_RX_PROF_TX_ID_MEMi :: pilot_sc_mask_4 [15:15] */
#define BCHP_PHY_BRST_RX_PROF_TX_ID_MEMi_pilot_sc_mask_4_MASK      0x00008000
#define BCHP_PHY_BRST_RX_PROF_TX_ID_MEMi_pilot_sc_mask_4_SHIFT     15
...
/* PHY :: BRST_RX_PROF_TX_ID_MEMi :: pilot_sc_mask_5 [11:11] */
#define BCHP_PHY_BRST_RX_PROF_TX_ID_MEMi_pilot_sc_mask_5_MASK      0x00000800
#define BCHP_PHY_BRST_RX_PROF_TX_ID_MEMi_pilot_sc_mask_5_SHIFT     11
...
/* PHY :: BRST_RX_PROF_TX_ID_MEMi :: pilot_sc_mask_6 [07:07] */
#define BCHP_PHY_BRST_RX_PROF_TX_ID_MEMi_pilot_sc_mask_6_MASK      0x00000080
#define BCHP_PHY_BRST_RX_PROF_TX_ID_MEMi_pilot_sc_mask_6_SHIFT     7
...
/* PHY :: BRST_RX_PROF_TX_ID_MEMi :: pilot_sc_mask_7 [03:03] */
#define BCHP_PHY_BRST_RX_PROF_TX_ID_MEMi_pilot_sc_mask_7_MASK      0x00000008
#define BCHP_PHY_BRST_RX_PROF_TX_ID_MEMi_pilot_sc_mask_7_SHIFT     3
 ...
 ***************************************************************************/
#define BCHP_PHY_BRST_RX_PROF_BIT_LOAD_MEMi_ARRAY_BASE             0x00fe2400
 ...
 ***************************************************************************/
/* PHY :: BRST_RX_PROF_RF_SW_1 :: rx_dpll_post_en_outclk_cmos_se_1p0_rssi_off [31:31] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_dpll_post_en_outclk_cmos_se_1p0_rssi_off_MASK 0x80000000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_dpll_post_en_outclk_cmos_se_1p0_rssi_off_SHIFT 31
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_dpll_post_en_outclk_cmos_se_1p0_rssi_off_DEFAULT 0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_1 :: rx_dpll_post_en_outclk_cmos_se_1p0_rssi_on [30:30] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_dpll_post_en_outclk_cmos_se_1p0_rssi_on_MASK 0x40000000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_dpll_post_en_outclk_cmos_se_1p0_rssi_on_SHIFT 30
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_dpll_post_en_outclk_cmos_se_1p0_rssi_on_DEFAULT 0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_1 :: rx_dpll_post_en_outclk_1p0_adc_off [29:29] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_dpll_post_en_outclk_1p0_adc_off_MASK 0x20000000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_dpll_post_en_outclk_1p0_adc_off_SHIFT 29
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_dpll_post_en_outclk_1p0_adc_off_DEFAULT 0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_1 :: rx_dpll_post_en_outclk_1p0_adc_on [28:28] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_dpll_post_en_outclk_1p0_adc_on_MASK 0x10000000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_dpll_post_en_outclk_1p0_adc_on_SHIFT 28
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_dpll_post_en_outclk_1p0_adc_on_DEFAULT 0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_1 :: rx_adc_digisum_resetb_off [27:27] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_adc_digisum_resetb_off_MASK 0x08000000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_adc_digisum_resetb_off_SHIFT 27
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_adc_digisum_resetb_off_DEFAULT 0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_1 :: rx_adc_digisum_resetb_on [26:26] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_adc_digisum_resetb_on_MASK 0x04000000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_adc_digisum_resetb_on_SHIFT 26
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_adc_digisum_resetb_on_DEFAULT 0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_1 :: rx_adc_pwrup_off [25:25] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_adc_pwrup_off_MASK        0x02000000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_adc_pwrup_off_SHIFT       25
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_adc_pwrup_off_DEFAULT     0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_1 :: rx_adc_pwrup_on [24:24] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_adc_pwrup_on_MASK         0x01000000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_adc_pwrup_on_SHIFT        24
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_adc_pwrup_on_DEFAULT      0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_1 :: rx_adc_resetb_off [23:23] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_adc_resetb_off_MASK       0x00800000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_adc_resetb_off_SHIFT      23
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_adc_resetb_off_DEFAULT    0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_1 :: rx_adc_resetb_on [22:22] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_adc_resetb_on_MASK        0x00400000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_adc_resetb_on_SHIFT       22
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_adc_resetb_on_DEFAULT     0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_1 :: rx_connectrfpga_off [21:21] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_connectrfpga_off_MASK     0x00200000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_connectrfpga_off_SHIFT    21
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_connectrfpga_off_DEFAULT  0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_1 :: rx_connectrfpga_on [20:20] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_connectrfpga_on_MASK      0x00100000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_connectrfpga_on_SHIFT     20
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_connectrfpga_on_DEFAULT   0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_1 :: rx_rfpga_in_lb_en_off [19:19] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_rfpga_in_lb_en_off_MASK   0x00080000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_rfpga_in_lb_en_off_SHIFT  19
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_rfpga_in_lb_en_off_DEFAULT 0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_1 :: rx_rfpga_in_lb_en_on [18:18] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_rfpga_in_lb_en_on_MASK    0x00040000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_rfpga_in_lb_en_on_SHIFT   18
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_rfpga_in_lb_en_on_DEFAULT 0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_1 :: rx_logen_reset_1p0_off [17:17] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_logen_reset_1p0_off_MASK  0x00020000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_logen_reset_1p0_off_SHIFT 17
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_logen_reset_1p0_off_DEFAULT 0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_1 :: rx_logen_reset_1p0_on [16:16] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_logen_reset_1p0_on_MASK   0x00010000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_logen_reset_1p0_on_SHIFT  16
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_logen_reset_1p0_on_DEFAULT 0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_1 :: rx_logen_start_1p0_off [15:15] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_logen_start_1p0_off_MASK  0x00008000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_logen_start_1p0_off_SHIFT 15
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_logen_start_1p0_off_DEFAULT 0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_1 :: rx_logen_start_1p0_on [14:14] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_logen_start_1p0_on_MASK   0x00004000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_logen_start_1p0_on_SHIFT  14
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_logen_start_1p0_on_DEFAULT 0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_1 :: rx_pup_rfpga_1p8_off [13:13] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_pup_rfpga_1p8_off_MASK    0x00002000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_pup_rfpga_1p8_off_SHIFT   13
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_pup_rfpga_1p8_off_DEFAULT 0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_1 :: rx_pup_rfpga_1p8_on [12:12] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_pup_rfpga_1p8_on_MASK     0x00001000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_pup_rfpga_1p8_on_SHIFT    12
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_pup_rfpga_1p8_on_DEFAULT  0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_1 :: rx_pup_mix_lo_d2d_1p8_off [11:11] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_pup_mix_lo_d2d_1p8_off_MASK 0x00000800
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_pup_mix_lo_d2d_1p8_off_SHIFT 11
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_pup_mix_lo_d2d_1p8_off_DEFAULT 0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_1 :: rx_pup_mix_lo_d2d_1p8_on [10:10] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_pup_mix_lo_d2d_1p8_on_MASK 0x00000400
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_pup_mix_lo_d2d_1p8_on_SHIFT 10
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_pup_mix_lo_d2d_1p8_on_DEFAULT 0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_1 :: rx_pup_ldo_d2d_1p8_off [09:09] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_pup_ldo_d2d_1p8_off_MASK  0x00000200
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_pup_ldo_d2d_1p8_off_SHIFT 9
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_pup_ldo_d2d_1p8_off_DEFAULT 0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_1 :: rx_pup_ldo_d2d_1p8_on [08:08] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_pup_ldo_d2d_1p8_on_MASK   0x00000100
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_pup_ldo_d2d_1p8_on_SHIFT  8
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_pup_ldo_d2d_1p8_on_DEFAULT 0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_1 :: rx_pup_mix_ldo_1p8_off [07:07] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_pup_mix_ldo_1p8_off_MASK  0x00000080
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_pup_mix_ldo_1p8_off_SHIFT 7
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_pup_mix_ldo_1p8_off_DEFAULT 0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_1 :: rx_pup_mix_ldo_1p8_on [06:06] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_pup_mix_ldo_1p8_on_MASK   0x00000040
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_pup_mix_ldo_1p8_on_SHIFT  6
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_pup_mix_ldo_1p8_on_DEFAULT 0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_1 :: rx_pup_mix_bias_1p8_off [05:05] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_pup_mix_bias_1p8_off_MASK 0x00000020
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_pup_mix_bias_1p8_off_SHIFT 5
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_pup_mix_bias_1p8_off_DEFAULT 0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_1 :: rx_pup_mix_bias_1p8_on [04:04] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_pup_mix_bias_1p8_on_MASK  0x00000010
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_pup_mix_bias_1p8_on_SHIFT 4
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_pup_mix_bias_1p8_on_DEFAULT 0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_1 :: rx_pup_mix_q_1p8_off [03:03] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_pup_mix_q_1p8_off_MASK    0x00000008
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_pup_mix_q_1p8_off_SHIFT   3
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_pup_mix_q_1p8_off_DEFAULT 0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_1 :: rx_pup_mix_q_1p8_on [02:02] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_pup_mix_q_1p8_on_MASK     0x00000004
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_pup_mix_q_1p8_on_SHIFT    2
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_pup_mix_q_1p8_on_DEFAULT  0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_1 :: rx_pup_mix_1p8_off [01:01] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_pup_mix_1p8_off_MASK      0x00000002
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_pup_mix_1p8_off_SHIFT     1
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_pup_mix_1p8_off_DEFAULT   0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_1 :: rx_pup_mix_1p8_on [00:00] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_pup_mix_1p8_on_MASK       0x00000001
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_pup_mix_1p8_on_SHIFT      0
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1_rx_pup_mix_1p8_on_DEFAULT    0x00000000

/***************************************************************************
 *BRST_RX_PROF_RF_SW_2 - RX Burst Switches
 ***************************************************************************/
/* PHY :: BRST_RX_PROF_RF_SW_2 :: rx_extra_sw0_off [31:31] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_extra_sw0_off_MASK        0x80000000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_extra_sw0_off_SHIFT       31
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_extra_sw0_off_DEFAULT     0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_2 :: rx_extra_sw0_on [30:30] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_extra_sw0_on_MASK         0x40000000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_extra_sw0_on_SHIFT        30
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_extra_sw0_on_DEFAULT      0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_2 :: rx_extra_sw1_off [29:29] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_extra_sw1_off_MASK        0x20000000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_extra_sw1_off_SHIFT       29
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_extra_sw1_off_DEFAULT     0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_2 :: rx_extra_sw1_on [28:28] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_extra_sw1_on_MASK         0x10000000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_extra_sw1_on_SHIFT        28
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_extra_sw1_on_DEFAULT      0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_2 :: rx_extra_sw2_off [27:27] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_extra_sw2_off_MASK        0x08000000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_extra_sw2_off_SHIFT       27
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_extra_sw2_off_DEFAULT     0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_2 :: rx_extra_sw2_on [26:26] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_extra_sw2_on_MASK         0x04000000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_extra_sw2_on_SHIFT        26
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_extra_sw2_on_DEFAULT      0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_2 :: rx_rfpga_out_lb_en_off [25:25] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_rfpga_out_lb_en_off_MASK  0x02000000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_rfpga_out_lb_en_off_SHIFT 25
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_rfpga_out_lb_en_off_DEFAULT 0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_2 :: rx_rfpga_out_lb_en_on [24:24] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_rfpga_out_lb_en_on_MASK   0x01000000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_rfpga_out_lb_en_on_SHIFT  24
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_rfpga_out_lb_en_on_DEFAULT 0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_2 :: lna_pu_off [23:23] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_lna_pu_off_MASK              0x00800000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_lna_pu_off_SHIFT             23
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_lna_pu_off_DEFAULT           0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_2 :: lna_pu_on [22:22] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_lna_pu_on_MASK               0x00400000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_lna_pu_on_SHIFT              22
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_lna_pu_on_DEFAULT            0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_2 :: rx_pup_fga_bias_force_1p8_off [21:21] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_fga_bias_force_1p8_off_MASK 0x00200000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_fga_bias_force_1p8_off_SHIFT 21
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_fga_bias_force_1p8_off_DEFAULT 0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_2 :: rx_pup_fga_bias_force_1p8_on [20:20] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_fga_bias_force_1p8_on_MASK 0x00100000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_fga_bias_force_1p8_on_SHIFT 20
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_fga_bias_force_1p8_on_DEFAULT 0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_2 :: rx_pup_fga_q_1p8_off [19:19] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_fga_q_1p8_off_MASK    0x00080000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_fga_q_1p8_off_SHIFT   19
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_fga_q_1p8_off_DEFAULT 0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_2 :: rx_pup_fga_q_1p8_on [18:18] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_fga_q_1p8_on_MASK     0x00040000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_fga_q_1p8_on_SHIFT    18
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_fga_q_1p8_on_DEFAULT  0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_2 :: rx_pup_fga_1p8_off [17:17] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_fga_1p8_off_MASK      0x00020000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_fga_1p8_off_SHIFT     17
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_fga_1p8_off_DEFAULT   0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_2 :: rx_pup_fga_1p8_on [16:16] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_fga_1p8_on_MASK       0x00010000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_fga_1p8_on_SHIFT      16
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_fga_1p8_on_DEFAULT    0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_2 :: rx_pup_lpf_q_1p8_off [15:15] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_lpf_q_1p8_off_MASK    0x00008000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_lpf_q_1p8_off_SHIFT   15
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_lpf_q_1p8_off_DEFAULT 0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_2 :: rx_pup_lpf_q_1p8_on [14:14] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_lpf_q_1p8_on_MASK     0x00004000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_lpf_q_1p8_on_SHIFT    14
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_lpf_q_1p8_on_DEFAULT  0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_2 :: rx_pup_lpf_1p9_off [13:13] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_lpf_1p9_off_MASK      0x00002000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_lpf_1p9_off_SHIFT     13
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_lpf_1p9_off_DEFAULT   0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_2 :: rx_pup_lpf_1p9_on [12:12] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_lpf_1p9_on_MASK       0x00001000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_lpf_1p9_on_SHIFT      12
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_lpf_1p9_on_DEFAULT    0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_2 :: rx_pup_lpf_bias_1p8_off [11:11] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_lpf_bias_1p8_off_MASK 0x00000800
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_lpf_bias_1p8_off_SHIFT 11
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_lpf_bias_1p8_off_DEFAULT 0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_2 :: rx_pup_lpf_bias_1p8_on [10:10] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_lpf_bias_1p8_on_MASK  0x00000400
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_lpf_bias_1p8_on_SHIFT 10
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_lpf_bias_1p8_on_DEFAULT 0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_2 :: rx_pup_lpf_f_1p8_off [09:09] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_lpf_f_1p8_off_MASK    0x00000200
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_lpf_f_1p8_off_SHIFT   9
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_lpf_f_1p8_off_DEFAULT 0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_2 :: rx_pup_lpf_f_1p8_on [08:08] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_lpf_f_1p8_on_MASK     0x00000100
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_lpf_f_1p8_on_SHIFT    8
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_lpf_f_1p8_on_DEFAULT  0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_2 :: rx_pup_pga_q_1p8_off [07:07] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_pga_q_1p8_off_MASK    0x00000080
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_pga_q_1p8_off_SHIFT   7
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_pga_q_1p8_off_DEFAULT 0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_2 :: rx_pup_pga_q_1p8_on [06:06] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_pga_q_1p8_on_MASK     0x00000040
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_pga_q_1p8_on_SHIFT    6
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_pga_q_1p8_on_DEFAULT  0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_2 :: rx_pup_pga_1p8_off [05:05] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_pga_1p8_off_MASK      0x00000020
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_pga_1p8_off_SHIFT     5
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_pga_1p8_off_DEFAULT   0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_2 :: rx_pup_pga_1p8_on [04:04] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_pga_1p8_on_MASK       0x00000010
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_pga_1p8_on_SHIFT      4
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_pga_1p8_on_DEFAULT    0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_2 :: rx_pup_pga_bias_1p9_off [03:03] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_pga_bias_1p9_off_MASK 0x00000008
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_pga_bias_1p9_off_SHIFT 3
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_pga_bias_1p9_off_DEFAULT 0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_2 :: rx_pup_pga_bias_1p9_on [02:02] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_pga_bias_1p9_on_MASK  0x00000004
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_pga_bias_1p9_on_SHIFT 2
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_pga_bias_1p9_on_DEFAULT 0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_2 :: rx_pup_pga_f_1p9_off [01:01] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_pga_f_1p9_off_MASK    0x00000002
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_pga_f_1p9_off_SHIFT   1
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_pga_f_1p9_off_DEFAULT 0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_2 :: rx_pup_pga_f_1p9_on [00:00] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_pga_f_1p9_on_MASK     0x00000001
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_pga_f_1p9_on_SHIFT    0
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2_rx_pup_pga_f_1p9_on_DEFAULT  0x00000000

/***************************************************************************
 *BRST_RX_PROF_RF_SW_3 - RX Burst Switches
 ***************************************************************************/
/* PHY :: BRST_RX_PROF_RF_SW_3 :: rx_extra_sw3_off [31:31] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw3_off_MASK        0x80000000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw3_off_SHIFT       31
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw3_off_DEFAULT     0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_3 :: rx_extra_sw3_on [30:30] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw3_on_MASK         0x40000000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw3_on_SHIFT        30
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw3_on_DEFAULT      0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_3 :: rx_extra_sw4_off [29:29] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw4_off_MASK        0x20000000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw4_off_SHIFT       29
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw4_off_DEFAULT     0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_3 :: rx_extra_sw4_on [28:28] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw4_on_MASK         0x10000000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw4_on_SHIFT        28
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw4_on_DEFAULT      0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_3 :: rx_extra_sw5_off [27:27] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw5_off_MASK        0x08000000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw5_off_SHIFT       27
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw5_off_DEFAULT     0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_3 :: rx_extra_sw5_on [26:26] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw5_on_MASK         0x04000000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw5_on_SHIFT        26
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw5_on_DEFAULT      0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_3 :: rx_extra_sw6_off [25:25] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw6_off_MASK        0x02000000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw6_off_SHIFT       25
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw6_off_DEFAULT     0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_3 :: rx_extra_sw6_on [24:24] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw6_on_MASK         0x01000000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw6_on_SHIFT        24
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw6_on_DEFAULT      0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_3 :: rx_extra_sw7_off [23:23] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw7_off_MASK        0x00800000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw7_off_SHIFT       23
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw7_off_DEFAULT     0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_3 :: rx_extra_sw7_on [22:22] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw7_on_MASK         0x00400000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw7_on_SHIFT        22
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw7_on_DEFAULT      0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_3 :: rx_extra_sw8_off [21:21] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw8_off_MASK        0x00200000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw8_off_SHIFT       21
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw8_off_DEFAULT     0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_3 :: rx_extra_sw8_on [20:20] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw8_on_MASK         0x00100000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw8_on_SHIFT        20
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw8_on_DEFAULT      0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_3 :: rx_extra_sw9_off [19:19] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw9_off_MASK        0x00080000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw9_off_SHIFT       19
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw9_off_DEFAULT     0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_3 :: rx_extra_sw9_on [18:18] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw9_on_MASK         0x00040000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw9_on_SHIFT        18
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw9_on_DEFAULT      0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_3 :: rx_extra_sw10_off [17:17] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw10_off_MASK       0x00020000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw10_off_SHIFT      17
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw10_off_DEFAULT    0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_3 :: rx_extra_sw10_on [16:16] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw10_on_MASK        0x00010000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw10_on_SHIFT       16
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw10_on_DEFAULT     0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_3 :: rx_extra_sw11_off [15:15] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw11_off_MASK       0x00008000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw11_off_SHIFT      15
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw11_off_DEFAULT    0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_3 :: rx_extra_sw11_on [14:14] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw11_on_MASK        0x00004000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw11_on_SHIFT       14
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_extra_sw11_on_DEFAULT     0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_3 :: rx_swhpf2_off [13:13] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_swhpf2_off_MASK           0x00002000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_swhpf2_off_SHIFT          13
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_swhpf2_off_DEFAULT        0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_3 :: rx_swhpf2_on [12:12] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_swhpf2_on_MASK            0x00001000
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_swhpf2_on_SHIFT           12
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_swhpf2_on_DEFAULT         0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_3 :: rx_swhpf1_off [11:11] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_swhpf1_off_MASK           0x00000800
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_swhpf1_off_SHIFT          11
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_swhpf1_off_DEFAULT        0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_3 :: rx_swhpf1_on [10:10] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_swhpf1_on_MASK            0x00000400
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_swhpf1_on_SHIFT           10
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_swhpf1_on_DEFAULT         0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_3 :: rx_swhpf0_off [09:09] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_swhpf0_off_MASK           0x00000200
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_swhpf0_off_SHIFT          9
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_swhpf0_off_DEFAULT        0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_3 :: rx_swhpf0_on [08:08] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_swhpf0_on_MASK            0x00000100
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_swhpf0_on_SHIFT           8
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_swhpf0_on_DEFAULT         0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_3 :: rx_rssi_resetb_data_1p0_off [07:07] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_rssi_resetb_data_1p0_off_MASK 0x00000080
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_rssi_resetb_data_1p0_off_SHIFT 7
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_rssi_resetb_data_1p0_off_DEFAULT 0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_3 :: rx_rssi_resetb_data_1p0_on [06:06] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_rssi_resetb_data_1p0_on_MASK 0x00000040
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_rssi_resetb_data_1p0_on_SHIFT 6
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_rssi_resetb_data_1p0_on_DEFAULT 0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_3 :: rx_pup_rssi_1p8_off [05:05] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_pup_rssi_1p8_off_MASK     0x00000020
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_pup_rssi_1p8_off_SHIFT    5
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_pup_rssi_1p8_off_DEFAULT  0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_3 :: rx_pup_rssi_1p8_on [04:04] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_pup_rssi_1p8_on_MASK      0x00000010
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_pup_rssi_1p8_on_SHIFT     4
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_pup_rssi_1p8_on_DEFAULT   0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_3 :: rx_pup_rssi_ldo_1p8_off [03:03] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_pup_rssi_ldo_1p8_off_MASK 0x00000008
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_pup_rssi_ldo_1p8_off_SHIFT 3
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_pup_rssi_ldo_1p8_off_DEFAULT 0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_3 :: rx_pup_rssi_ldo_1p8_on [02:02] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_pup_rssi_ldo_1p8_on_MASK  0x00000004
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_pup_rssi_ldo_1p8_on_SHIFT 2
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_pup_rssi_ldo_1p8_on_DEFAULT 0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_3 :: rx_pup_rssi_bias_1p8_off [01:01] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_pup_rssi_bias_1p8_off_MASK 0x00000002
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_pup_rssi_bias_1p8_off_SHIFT 1
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_pup_rssi_bias_1p8_off_DEFAULT 0x00000000

/* PHY :: BRST_RX_PROF_RF_SW_3 :: rx_pup_rssi_bias_1p8_on [00:00] */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_pup_rssi_bias_1p8_on_MASK 0x00000001
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_pup_rssi_bias_1p8_on_SHIFT 0
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3_rx_pup_rssi_bias_1p8_on_DEFAULT 0x00000000
 ...
 ***************************************************************************/
/* PHY :: BRST_RX_PROF_ACQUISITION_0 :: fc_sfo_conv_factor [31:16] */
#define BCHP_PHY_BRST_RX_PROF_ACQUISITION_0_fc_sfo_conv_factor_MASK 0xffff0000
#define BCHP_PHY_BRST_RX_PROF_ACQUISITION_0_fc_sfo_conv_factor_SHIFT 16
#define BCHP_PHY_BRST_RX_PROF_ACQUISITION_0_fc_sfo_conv_factor_DEFAULT 0x00000000
 ...
 ***************************************************************************/
/* PHY :: BRST_RX_PROF_ACQUISITION_3 :: pp_cc_peak_num_th [31:28] */
#define BCHP_PHY_BRST_RX_PROF_ACQUISITION_3_pp_cc_peak_num_th_MASK 0xf0000000
#define BCHP_PHY_BRST_RX_PROF_ACQUISITION_3_pp_cc_peak_num_th_SHIFT 28
#define BCHP_PHY_BRST_RX_PROF_ACQUISITION_3_pp_cc_peak_num_th_DEFAULT 0x00000000

/* PHY :: BRST_RX_PROF_ACQUISITION_3 :: rx_sfo_baseband_en [27:27] */
#define BCHP_PHY_BRST_RX_PROF_ACQUISITION_3_rx_sfo_baseband_en_MASK 0x08000000
#define BCHP_PHY_BRST_RX_PROF_ACQUISITION_3_rx_sfo_baseband_en_SHIFT 27
#define BCHP_PHY_BRST_RX_PROF_ACQUISITION_3_rx_sfo_baseband_en_DEFAULT 0x00000000

/* PHY :: BRST_RX_PROF_ACQUISITION_3 :: cfo_sfo_clr_en [26:26] */
#define BCHP_PHY_BRST_RX_PROF_ACQUISITION_3_cfo_sfo_clr_en_MASK    0x04000000
#define BCHP_PHY_BRST_RX_PROF_ACQUISITION_3_cfo_sfo_clr_en_SHIFT   26
#define BCHP_PHY_BRST_RX_PROF_ACQUISITION_3_cfo_sfo_clr_en_DEFAULT 0x00000000

/* PHY :: BRST_RX_PROF_ACQUISITION_3 :: pp_sm_p1_mode [25:25] */
#define BCHP_PHY_BRST_RX_PROF_ACQUISITION_3_pp_sm_p1_mode_MASK     0x02000000
#define BCHP_PHY_BRST_RX_PROF_ACQUISITION_3_pp_sm_p1_mode_SHIFT    25
#define BCHP_PHY_BRST_RX_PROF_ACQUISITION_3_pp_sm_p1_mode_DEFAULT  0x00000000
...
/* PHY :: BRST_RX_PROF_GEN_2 :: reserved1 [16:16] */
#define BCHP_PHY_BRST_RX_PROF_GEN_2_reserved1_MASK                 0x00010000
#define BCHP_PHY_BRST_RX_PROF_GEN_2_reserved1_SHIFT                16
 ...
 ***************************************************************************/
/* PHY :: BRST_RX_PROF_CFO_SFO_OFFSET :: reserved0 [31:25] */
#define BCHP_PHY_BRST_RX_PROF_CFO_SFO_OFFSET_reserved0_MASK        0xfe000000
#define BCHP_PHY_BRST_RX_PROF_CFO_SFO_OFFSET_reserved0_SHIFT       25

/* PHY :: BRST_RX_PROF_CFO_SFO_OFFSET :: rx_flip_spectrum [24:24] */
#define BCHP_PHY_BRST_RX_PROF_CFO_SFO_OFFSET_rx_flip_spectrum_MASK 0x01000000
#define BCHP_PHY_BRST_RX_PROF_CFO_SFO_OFFSET_rx_flip_spectrum_SHIFT 24
#define BCHP_PHY_BRST_RX_PROF_CFO_SFO_OFFSET_rx_flip_spectrum_DEFAULT 0x00000000

/* PHY :: BRST_RX_PROF_CFO_SFO_OFFSET :: rx_gain_scale [23:20] */
#define BCHP_PHY_BRST_RX_PROF_CFO_SFO_OFFSET_rx_gain_scale_MASK    0x00f00000
#define BCHP_PHY_BRST_RX_PROF_CFO_SFO_OFFSET_rx_gain_scale_SHIFT   20
#define BCHP_PHY_BRST_RX_PROF_CFO_SFO_OFFSET_rx_gain_scale_DEFAULT 0x00000000

/* PHY :: BRST_RX_PROF_CFO_SFO_OFFSET :: rx_gain [19:12] */
#define BCHP_PHY_BRST_RX_PROF_CFO_SFO_OFFSET_rx_gain_MASK          0x000ff000
#define BCHP_PHY_BRST_RX_PROF_CFO_SFO_OFFSET_rx_gain_SHIFT         12
#define BCHP_PHY_BRST_RX_PROF_CFO_SFO_OFFSET_rx_gain_DEFAULT       0x00000000
 ...
 ***************************************************************************/
/* PHY :: BRST_RX_PROF_RF_1 :: rx_trx_param_time_smp_sel [31:31] */
#define BCHP_PHY_BRST_RX_PROF_RF_1_rx_trx_param_time_smp_sel_MASK  0x80000000
#define BCHP_PHY_BRST_RX_PROF_RF_1_rx_trx_param_time_smp_sel_SHIFT 31
#define BCHP_PHY_BRST_RX_PROF_RF_1_rx_trx_param_time_smp_sel_DEFAULT 0x00000000

/* PHY :: BRST_RX_PROF_RF_1 :: s_p_a_r_e_rx01 [30:30] */
#define BCHP_PHY_BRST_RX_PROF_RF_1_s_p_a_r_e_rx01_MASK             0x40000000
#define BCHP_PHY_BRST_RX_PROF_RF_1_s_p_a_r_e_rx01_SHIFT            30
#define BCHP_PHY_BRST_RX_PROF_RF_1_s_p_a_r_e_rx01_DEFAULT          0x00000000

/* PHY :: BRST_RX_PROF_RF_1 :: trx_rx_if_freq_inc [29:25] */
#define BCHP_PHY_BRST_RX_PROF_RF_1_trx_rx_if_freq_inc_MASK         0x3e000000
#define BCHP_PHY_BRST_RX_PROF_RF_1_trx_rx_if_freq_inc_SHIFT        25
#define BCHP_PHY_BRST_RX_PROF_RF_1_trx_rx_if_freq_inc_DEFAULT      0x00000000

/* PHY :: BRST_RX_PROF_RF_1 :: lpf_cap [24:23] */
#define BCHP_PHY_BRST_RX_PROF_RF_1_lpf_cap_MASK                    0x01800000
#define BCHP_PHY_BRST_RX_PROF_RF_1_lpf_cap_SHIFT                   23
#define BCHP_PHY_BRST_RX_PROF_RF_1_lpf_cap_DEFAULT                 0x00000000

/* PHY :: BRST_RX_PROF_RF_1 :: afe_agc_lut_sel [22:21] */
#define BCHP_PHY_BRST_RX_PROF_RF_1_afe_agc_lut_sel_MASK            0x00600000
...
/* PHY :: BRST_RX_PROF_RF_1 :: rx_fga_c_ctrl [13:05] */
#define BCHP_PHY_BRST_RX_PROF_RF_1_rx_fga_c_ctrl_MASK              0x00003fe0
#define BCHP_PHY_BRST_RX_PROF_RF_1_rx_fga_c_ctrl_SHIFT             5
#define BCHP_PHY_BRST_RX_PROF_RF_1_rx_fga_c_ctrl_DEFAULT           0x00000000

/* PHY :: BRST_RX_PROF_RF_1 :: lpf_res [04:00] */
#define BCHP_PHY_BRST_RX_PROF_RF_1_lpf_res_MASK                    0x0000001f
#define BCHP_PHY_BRST_RX_PROF_RF_1_lpf_res_SHIFT                   0
#define BCHP_PHY_BRST_RX_PROF_RF_1_lpf_res_DEFAULT                 0x00000000

/***************************************************************************
 *BRST_RX_PROF_RF_2 - Rx RF Parameters
 ***************************************************************************/
/* PHY :: BRST_RX_PROF_RF_2 :: s_p_a_r_e_rx02 [31:03] */
#define BCHP_PHY_BRST_RX_PROF_RF_2_s_p_a_r_e_rx02_MASK             0xfffffff8
#define BCHP_PHY_BRST_RX_PROF_RF_2_s_p_a_r_e_rx02_SHIFT            3
#define BCHP_PHY_BRST_RX_PROF_RF_2_s_p_a_r_e_rx02_DEFAULT          0x00000000

/* PHY :: BRST_RX_PROF_RF_2 :: rx_fga_bias_ctrl [02:00] */
#define BCHP_PHY_BRST_RX_PROF_RF_2_rx_fga_bias_ctrl_MASK           0x00000007
#define BCHP_PHY_BRST_RX_PROF_RF_2_rx_fga_bias_ctrl_SHIFT          0
#define BCHP_PHY_BRST_RX_PROF_RF_2_rx_fga_bias_ctrl_DEFAULT        0x00000000
 ...
 ***************************************************************************/
/* PHY :: RSLT_RX_STATISTICS_FEC_UNERROR :: reserved0 [31:08] */
#define BCHP_PHY_RSLT_RX_STATISTICS_FEC_UNERROR_reserved0_MASK     0xffffff00
#define BCHP_PHY_RSLT_RX_STATISTICS_FEC_UNERROR_reserved0_SHIFT    8

/* PHY :: RSLT_RX_STATISTICS_FEC_UNERROR :: fec_unerror [07:00] */
#define BCHP_PHY_RSLT_RX_STATISTICS_FEC_UNERROR_fec_unerror_MASK   0x000000ff
 ...
 ***************************************************************************/
/* PHY :: RSLT_RX_STATISTICS_FEC_CORRECTED :: reserved0 [31:08] */
#define BCHP_PHY_RSLT_RX_STATISTICS_FEC_CORRECTED_reserved0_MASK   0xffffff00
#define BCHP_PHY_RSLT_RX_STATISTICS_FEC_CORRECTED_reserved0_SHIFT  8

/* PHY :: RSLT_RX_STATISTICS_FEC_CORRECTED :: fec_corrected [07:00] */
#define BCHP_PHY_RSLT_RX_STATISTICS_FEC_CORRECTED_fec_corrected_MASK 0x000000ff
 ...
 ***************************************************************************/
/* PHY :: RSLT_RX_STATISTICS_FEC_UNCORRECTED :: reserved0 [31:08] */
#define BCHP_PHY_RSLT_RX_STATISTICS_FEC_UNCORRECTED_reserved0_MASK 0xffffff00
#define BCHP_PHY_RSLT_RX_STATISTICS_FEC_UNCORRECTED_reserved0_SHIFT 8

/* PHY :: RSLT_RX_STATISTICS_FEC_UNCORRECTED :: fec_uncorrected [07:00] */
#define BCHP_PHY_RSLT_RX_STATISTICS_FEC_UNCORRECTED_fec_uncorrected_MASK 0x000000ff
 ...
 ***************************************************************************/
/* PHY :: RSLT_RX_LEARNING_FEC_UNCORRECTED :: reserved0 [31:08] */
#define BCHP_PHY_RSLT_RX_LEARNING_FEC_UNCORRECTED_reserved0_MASK   0xffffff00
#define BCHP_PHY_RSLT_RX_LEARNING_FEC_UNCORRECTED_reserved0_SHIFT  8

/* PHY :: RSLT_RX_LEARNING_FEC_UNCORRECTED :: learn_fec_uncorrected [07:00] */
#define BCHP_PHY_RSLT_RX_LEARNING_FEC_UNCORRECTED_learn_fec_uncorrected_MASK 0x000000ff
 ...
 ***************************************************************************/
/* PHY :: RSLT_TX_CALIBRATION_GOERTZEL :: goertzel_am_f1_quad [31:16] */
#define BCHP_PHY_RSLT_TX_CALIBRATION_GOERTZEL_goertzel_am_f1_quad_MASK 0xffff0000
#define BCHP_PHY_RSLT_TX_CALIBRATION_GOERTZEL_goertzel_am_f1_quad_SHIFT 16
#define BCHP_PHY_RSLT_TX_CALIBRATION_GOERTZEL_goertzel_am_f1_quad_DEFAULT 0x00000000

/* PHY :: RSLT_TX_CALIBRATION_GOERTZEL :: goertzel_am_f1_inph [15:00] */
#define BCHP_PHY_RSLT_TX_CALIBRATION_GOERTZEL_goertzel_am_f1_inph_MASK 0x0000ffff
#define BCHP_PHY_RSLT_TX_CALIBRATION_GOERTZEL_goertzel_am_f1_inph_SHIFT 0
#define BCHP_PHY_RSLT_TX_CALIBRATION_GOERTZEL_goertzel_am_f1_inph_DEFAULT 0x00000000

/***************************************************************************
 *RSLT_RX_PROBES_MEM%i - Probes Memory
 ***************************************************************************/
#define BCHP_PHY_RSLT_RX_PROBES_MEMi_ARRAY_BASE                    0x00fe3800
 ...
 ***************************************************************************/
#define BCHP_PHY_RSLT_RX_PROBEI_BIAS_MEMi_ARRAY_BASE               0x00fe4000
