 ...
 ***************************************************************************/
#define BCHP_MEMC_TRACELOG_0_0_VERSION           0x01103800 /* [RO] Tracelog version */
#define BCHP_MEMC_TRACELOG_0_0_CONTROL           0x01103804 /* [RW] Control register for static parameters */
#define BCHP_MEMC_TRACELOG_0_0_REMOTE            0x01103808 /* [RW] Control register for Remote TraceLog sync */
#define BCHP_MEMC_TRACELOG_0_0_COMMAND           0x0110380c /* [WO] Command register for all actions */
#define BCHP_MEMC_TRACELOG_0_0_STATUS            0x01103810 /* [RO] Monitor status */
#define BCHP_MEMC_TRACELOG_0_0_DEBUG             0x01103814 /* [RO] Debug fields */
#define BCHP_MEMC_TRACELOG_0_0_ELAPSED_TIME_LOWER 0x01103820 /* [RO] Elapsed time since enabled, lower 32 bits */
#define BCHP_MEMC_TRACELOG_0_0_ELAPSED_TIME_UPPER 0x01103824 /* [RO] Elapsed time since enabled, upper 16 bits */
#define BCHP_MEMC_TRACELOG_0_0_COUNT_TRANS_TOTAL 0x01103828 /* [RO] Count of all transactions snooped (matched and unmatched) */
#define BCHP_MEMC_TRACELOG_0_0_COUNT_TRIGGER_EVENTS 0x0110382c /* [RO] Count of all events marked as triggers */
#define BCHP_MEMC_TRACELOG_0_0_COUNT_MATCHES_TOTAL 0x01103830 /* [RO] Count of all transactions matched for capture */
#define BCHP_MEMC_TRACELOG_0_0_COUNT_MATCHES_DROPPED 0x01103834 /* [RO] Count of transactions matched for capture, but dropped */
#define BCHP_MEMC_TRACELOG_0_0_COUNT_MATCHES_PRE_TRIGGER 0x01103838 /* [RO] Count of transactions matched and captured before the trigger */
#define BCHP_MEMC_TRACELOG_0_0_COUNT_MATCHES_POST_TRIGGER 0x0110383c /* [RO] Count of transactions matched and captured after the trigger */
#define BCHP_MEMC_TRACELOG_0_0_BUFFER_PTR        0x01103850 /* [RW] Capture buffer pointer, lower 32 bits */
#define BCHP_MEMC_TRACELOG_0_0_BUFFER_PTR_EXT    0x01103854 /* [RW] Capture buffer pointer, upper 8 bits */
#define BCHP_MEMC_TRACELOG_0_0_BUFFER_SIZE       0x01103858 /* [RW] Size of the DRAM buffer in bytes */
#define BCHP_MEMC_TRACELOG_0_0_BUFFER_WR_PTR     0x0110385c /* [RO] Pointer offset into buffer to write next capture data */
#define BCHP_MEMC_TRACELOG_0_0_BUFFER_DATA_WD_0  0x01103870 /* [RO] Internal capture buffer data word 0 (Bits [31:0]) */
#define BCHP_MEMC_TRACELOG_0_0_BUFFER_DATA_WD_1  0x01103874 /* [RO] Internal capture buffer data word 1 (Bits [63:32]) */
#define BCHP_MEMC_TRACELOG_0_0_BUFFER_DATA_WD_2  0x01103878 /* [RO] Internal capture buffer data word 2 (Bits [95:64]) */
#define BCHP_MEMC_TRACELOG_0_0_BUFFER_DATA_WD_3  0x0110387c /* [RO] Internal capture buffer data word 3 (Bits [127:96]) */
#define BCHP_MEMC_TRACELOG_0_0_BUFFER_DATA_WD_4  0x01103880 /* [RO] Internal capture buffer data word 4 (Bits [159:128]) */
#define BCHP_MEMC_TRACELOG_0_0_BUFFER_DATA_WD_5  0x01103884 /* [RO] Internal capture buffer data word 5 (Bits [191:160]) */
#define BCHP_MEMC_TRACELOG_0_0_BUFFER_DATA_WD_6  0x01103888 /* [RO] Internal capture buffer data word 6 (Bits [223:192]) */
#define BCHP_MEMC_TRACELOG_0_0_BUFFER_DATA_WD_7  0x0110388c /* [RO] Internal capture buffer data word 7 (Bits [255:224]) */
#define BCHP_MEMC_TRACELOG_0_0_TRIGGER_MODE      0x01103890 /* [RW] Trigger parameter configuration */
#define BCHP_MEMC_TRACELOG_0_0_TRIGGER_COUNT     0x01103894 /* [RW] Count of events required to trigger */
#define BCHP_MEMC_TRACELOG_0_0_TRIGGER_DELAY_TIME_LOWER 0x01103898 /* [RW] Time interval for delayed trigger mode, lower 32 bits */
#define BCHP_MEMC_TRACELOG_0_0_TRIGGER_DELAY_TIME_UPPER 0x0110389c /* [RW] Time interval for delayed trigger mode, upper 16 bits */
#define BCHP_MEMC_TRACELOG_0_0_TRIGGER_WR_PTR    0x011038a0 /* [RO] Pointer offset into buffer at the time of trigger */
#define BCHP_MEMC_TRACELOG_0_0_TRIGGER_TIME_LOWER 0x011038a8 /* [RO] Time of trigger, lower 32 bits */
#define BCHP_MEMC_TRACELOG_0_0_TRIGGER_TIME_UPPER 0x011038ac /* [RO] Time of trigger, upper 16 bits */
...
#define BCHP_MEMC_TRACELOG_0_0_VERSION_MINOR_REVISION_DEFAULT      0x00000002
