 ...
 ***************************************************************************/
#define BCHP_BSPI_REVISION_ID                    0x003e3200 /* [RO] Revision ID */
#define BCHP_BSPI_SCRATCH                        0x003e3204 /* [RW] Revision ID */
#define BCHP_BSPI_MAST_N_BOOT_CTRL               0x003e3208 /* [RW] Master/Boot SPI Control Register */
#define BCHP_BSPI_BUSY_STATUS                    0x003e320c /* [RO] BSPI Busy Status Register */
#define BCHP_BSPI_INTR_STATUS                    0x003e3210 /* [RO] Interrupt Status Register */
#define BCHP_BSPI_B0_STATUS                      0x003e3214 /* [RO] Prefetch Buffer 0 Status Register */
#define BCHP_BSPI_B0_CTRL                        0x003e3218 /* [WO] Prefetch Buffer 0 Control Register */
#define BCHP_BSPI_B1_STATUS                      0x003e321c /* [RO] Prefetch Buffer 1 Status Register */
#define BCHP_BSPI_B1_CTRL                        0x003e3220 /* [WO] Prefetch Buffer 1 Control Register */
#define BCHP_BSPI_STRAP_OVERRIDE_CTRL            0x003e3224 /* [RW] Dual/Single Receive Mode Control Register */
#define BCHP_BSPI_FLEX_MODE_ENABLE               0x003e3228 /* [RW] Flexible Control Mode Enable Register */
#define BCHP_BSPI_BITS_PER_CYCLE                 0x003e322c /* [RW] Bits per cycle "b-p-c" Control Register */
#define BCHP_BSPI_BITS_PER_PHASE                 0x003e3230 /* [RW] Bits per Phase "b-p-p" Control Register */
#define BCHP_BSPI_CMD_AND_MODE_BYTE              0x003e3234 /* [RW] Command and Mode Data Register */
#define BCHP_BSPI_BSPI_FLASH_UPPER_ADDR_BYTE     0x003e3238 /* [RW] Bspi FLash upper address byte register */
#define BCHP_BSPI_BSPI_XOR_VALUE                 0x003e323c /* [RW] BSPI FLASH XOR Value Register */
#define BCHP_BSPI_BSPI_XOR_ENABLE                0x003e3240 /* [RW] BSPI FLASH XOR Enable Register */
#define BCHP_BSPI_BSPI_PIO_MODE_ENABLE           0x003e3244 /* [RW] BSPI Pin  Programmed IO Mode Enable Register */
#define BCHP_BSPI_BSPI_PIO_IODIR                 0x003e3248 /* [RW] BSPI Pin  Programmed IO Mode Direction Register */
#define BCHP_BSPI_BSPI_PIO_DATA                  0x003e324c /* [RW] BSPI Pin  Programmed IO Mode Data Register */
