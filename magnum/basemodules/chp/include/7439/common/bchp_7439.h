 ...
 * 
 ***************************************************************************/
#ifndef BCHP_7439_H__
#define BCHP_7439_H__
...
/***************************************************************************
Summary:
    Open a chip handle for Bcm7439 chip

Description:
    This function open a chip handle for Bcm7439 chip.

Input:
    hRegister - A valid Bcm7439 register handle previous open using BREG_Open.
