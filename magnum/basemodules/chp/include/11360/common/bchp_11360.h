 ...
 *
 ***************************************************************************/
#ifndef BCHP_11360_H__
#define BCHP_11360_H__
...
/***************************************************************************
Summary:
    Open a chip handle for Bcm11360 chip

Description:
    This function open a chip handle for Bcm11360 chip.

Input:
    hRegister - A valid Bcm11360 register handle previous open using BREG_Open.
