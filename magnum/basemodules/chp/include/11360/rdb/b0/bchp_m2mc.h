 ...
 ***************************************************************************/
#define BCHP_M2MC_REVISION                       0x000a8000 /* M2MC Revision register */
#define BCHP_M2MC_BLIT_GO                        0x000a8004 /* Blit GO bit */
#define BCHP_M2MC_SCRATCH_NOT_LIST               0x000a8008 /* M2MC Scratch register (not included in DMA list structure) */
#define BCHP_M2MC_LIST_CTRL                      0x000a800c /* RDMA Linked List Control Register */
#define BCHP_M2MC_LIST_STATUS                    0x000a8010 /* RDMA Linked List Status Register */
#define BCHP_M2MC_LIST_FIRST_PKT_ADDR            0x000a8014 /* RDMA Linked List First Packet Address Register */
#define BCHP_M2MC_LIST_CURR_PKT_ADDR             0x000a8018 /* RDMA Linked List Current Packet Address Register */
#define BCHP_M2MC_BLIT_STATUS                    0x000a801c /* Blit status */
#define BCHP_M2MC_BLIT_SRC_ADDRESS_MSB           0x000a8020 /* Blit status source feeder current address MSB */
#define BCHP_M2MC_BLIT_SRC_ADDRESS               0x000a8024 /* Blit status source feeder current address */
...
#define BCHP_M2MC_BLIT_DEST_ADDRESS_MSB          0x000a8028 /* Blit status destination feeder current address MSB */
#define BCHP_M2MC_BLIT_DEST_ADDRESS              0x000a802c /* Blit status destination feeder current address */
#define BCHP_M2MC_BLIT_OUTPUT_ADDRESS_MSB        0x000a8030 /* Blit status output feeder current address MSB */
#define BCHP_M2MC_BLIT_OUTPUT_ADDRESS            0x000a8034 /* Blit status output feeder current address */
#define BCHP_M2MC_BLIT_MEM_HI                    0x000a8038 /* Blit memory protection address high */
#define BCHP_M2MC_BLIT_MEM_LO                    0x000a803c /* Blit memory protection address low */
#define BCHP_M2MC_BLIT_EXT_MEM_HI_MSB            0x000a8040 /* Blit memory protection address high for Extension area */
#define BCHP_M2MC_BLIT_EXT_MEM_HI                0x000a8044 /* Blit memory protection address high */
#define BCHP_M2MC_BLIT_EXT_MEM_LO_MSB            0x000a8048 /* Blit memory protection address low for Extension area */
#define BCHP_M2MC_BLIT_EXT_MEM_LO                0x000a804c /* Blit memory protection address low */
#define BCHP_M2MC_SCBADDRSEL                     0x000a8050 /* scb address map select register */
#define BCHP_M2MC_SCBADDRSEL_EXT                 0x000a8054 /* scb address map select register for extension area */
...
#define BCHP_M2MC_SCRATCH_LIST                   0x000a8100 /* M2MC Scratch register (Included in DMA list structure) */
#define BCHP_M2MC_SRC_FEEDER_ENABLE              0x000a8104 /* Source plane enable */
#define BCHP_M2MC_SRC_SURFACE_ADDR_0_MSB         0x000a8108 /* Source surface 0 address MSB */
#define BCHP_M2MC_SRC_SURFACE_ADDR_0             0x000a810c /* Source surface 0 address */
#define BCHP_M2MC_SRC_SURFACE_ADDR_0_BOT_FLD_MSB 0x000a8110 /* Source surface 0, field 1 address MSB */
#define BCHP_M2MC_SRC_SURFACE_ADDR_0_BOT_FLD     0x000a8114 /* Source surface 0, field 1  address */
#define BCHP_M2MC_SRC_SURFACE_STRIDE_0           0x000a8118 /* Source surface 0 STRIDE */
#define BCHP_M2MC_SRC_SURFACE_ADDR_1_MSB         0x000a811c /* Source surface 1 address MSB */
#define BCHP_M2MC_SRC_SURFACE_ADDR_1             0x000a8120 /* Source surface 1 address */
#define BCHP_M2MC_SRC_SURFACE_ADDR_1_BOT_FLD_MSB 0x000a8124 /* Source surface 1, field 1 address MSB */
#define BCHP_M2MC_SRC_SURFACE_ADDR_1_BOT_FLD     0x000a8128 /* Source surface 1, field 1 address */
#define BCHP_M2MC_SRC_SURFACE_STRIDE_1           0x000a812c /* Source surface 1 STRIDE */
#define BCHP_M2MC_SRC_SURFACE_0_FORMAT_DEF_1     0x000a8130 /* Source pixel format 1 for surface 0 */
#define BCHP_M2MC_SRC_SURFACE_0_FORMAT_DEF_2     0x000a8134 /* Source pixel format 2 for surface 0 */
#define BCHP_M2MC_SRC_SURFACE_0_FORMAT_DEF_3     0x000a8138 /* Source pixel format 3 for surface 0 */
#define BCHP_M2MC_SRC_SURFACE_1_FORMAT_DEF_1     0x000a813c /* Source pixel format 1 for surface 1 */
#define BCHP_M2MC_SRC_SURFACE_1_FORMAT_DEF_2     0x000a8140 /* Source pixel format 2 for surface 1 */
#define BCHP_M2MC_SRC_SURFACE_1_FORMAT_DEF_3     0x000a8144 /* Source pixel format 3 for surface 1 */
#define BCHP_M2MC_SRC_W_ALPHA                    0x000a8148 /* Source Alpha W format */
#define BCHP_M2MC_SRC_CONSTANT_COLOR             0x000a814c /* Source constant color */
#define BCHP_M2MC_DEST_FEEDER_ENABLE             0x000a8150 /* Destination plane enable */
#define BCHP_M2MC_DEST_SURFACE_ADDR_0_MSB        0x000a8154 /* Destination surface 0 address MSB */
#define BCHP_M2MC_DEST_SURFACE_ADDR_0            0x000a8158 /* Destination surface 0 address */
#define BCHP_M2MC_DEST_SURFACE_STRIDE_0          0x000a815c /* Destination surface 0 STRIDE */
#define BCHP_M2MC_DEST_SURFACE_ADDR_1_MSB        0x000a8160 /* Destination surface 1 address MSB */
#define BCHP_M2MC_DEST_SURFACE_ADDR_1            0x000a8164 /* Destination surface 1 address */
#define BCHP_M2MC_DEST_SURFACE_STRIDE_1          0x000a8168 /* Destination surface 1 STRIDE */
#define BCHP_M2MC_DEST_SURFACE_FORMAT_DEF_1      0x000a816c /* Destination pixel format 1 */
#define BCHP_M2MC_DEST_SURFACE_FORMAT_DEF_2      0x000a8170 /* Destination pixel format 2 */
#define BCHP_M2MC_DEST_SURFACE_FORMAT_DEF_3      0x000a8174 /* Destination pixel format 3 */
#define BCHP_M2MC_DEST_W_ALPHA                   0x000a8178 /* Destination Alpha W format */
#define BCHP_M2MC_DEST_CONSTANT_COLOR            0x000a817c /* Destination constant color */
#define BCHP_M2MC_OUTPUT_FEEDER_ENABLE           0x000a8180 /* Output plane enable */
#define BCHP_M2MC_OUTPUT_SURFACE_ADDR_0_MSB      0x000a8184 /* Output surface 0 address MSB */
#define BCHP_M2MC_OUTPUT_SURFACE_ADDR_0          0x000a8188 /* Output surface 0 address */
#define BCHP_M2MC_OUTPUT_SURFACE_STRIDE_0        0x000a818c /* Output surface 0 STRIDE */
#define BCHP_M2MC_OUTPUT_SURFACE_ADDR_1_MSB      0x000a8190 /* Output surface 1 address MSB */
#define BCHP_M2MC_OUTPUT_SURFACE_ADDR_1          0x000a8194 /* Output surface 1 address */
#define BCHP_M2MC_OUTPUT_SURFACE_STRIDE_1        0x000a8198 /* Output surface 1 STRIDE */
#define BCHP_M2MC_OUTPUT_SURFACE_FORMAT_DEF_1    0x000a819c /* Output pixel format 1 */
#define BCHP_M2MC_OUTPUT_SURFACE_FORMAT_DEF_2    0x000a81a0 /* Output pixel format 2 */
#define BCHP_M2MC_OUTPUT_SURFACE_FORMAT_DEF_3    0x000a81a4 /* Output pixel format 3 */
#define BCHP_M2MC_BLIT_HEADER                    0x000a81a8 /* Blit header and control */
#define BCHP_M2MC_BLIT_SRC_TOP_LEFT_0            0x000a81ac /* Top left pixel coordinate in the Source surface 0. */
#define BCHP_M2MC_BLIT_SRC_SIZE_0                0x000a81b0 /* Pixel width and height of operation in Source surface 0. */
#define BCHP_M2MC_BLIT_SRC_TOP_LEFT_1            0x000a81b4 /* Top left pixel coordinate in the Source surface 1. */
#define BCHP_M2MC_BLIT_SRC_SIZE_1                0x000a81b8 /* Pixel width and height of operation in Source surface 1. */
#define BCHP_M2MC_BLIT_SRC_STRIPE_HEIGHT_WIDTH_0 0x000a81bc /* width and height of stripe for surface 0 for the decoded frame image format. */
#define BCHP_M2MC_BLIT_SRC_STRIPE_HEIGHT_WIDTH_1 0x000a81c0 /* width and height of stripe for surface 1 for the decoded frame image format. */
#define BCHP_M2MC_BLIT_DEST_TOP_LEFT             0x000a81c4 /* Top left pixel coordinate in the Destination */
#define BCHP_M2MC_BLIT_DEST_SIZE                 0x000a81c8 /* Pixel width and height of operation in destination */
#define BCHP_M2MC_BLIT_OUTPUT_TOP_LEFT           0x000a81cc /* Top left pixel coordinate in the Output */
#define BCHP_M2MC_BLIT_OUTPUT_SIZE               0x000a81d0 /* Pixel width and height of operation in the Output */
#define BCHP_M2MC_BLIT_INPUT_STRIPE_WIDTH_0      0x000a81d4 /* Pixel width of input stripe when striping for surface 0 */
#define BCHP_M2MC_BLIT_INPUT_STRIPE_WIDTH_1      0x000a81d8 /* Pixel width of input stripe when striping for surface 1 */
#define BCHP_M2MC_BLIT_OUTPUT_STRIPE_WIDTH       0x000a81dc /* Pixel width of output stripe when striping */
#define BCHP_M2MC_BLIT_STRIPE_OVERLAP_0          0x000a81e0 /* Pixel width of stripe overlap when striping for surface 0. */
#define BCHP_M2MC_BLIT_STRIPE_OVERLAP_1          0x000a81e4 /* Pixel width of stripe overlap when striping for surface 1. */
#define BCHP_M2MC_BLIT_CTRL                      0x000a81e8 /* Blit control */
#define BCHP_M2MC_DCEG_CFG                       0x000a81ec /* M2MC DCEG configuration register */
#define BCHP_M2MC_SCALER_CTRL                    0x000a81f0 /* Scaler control */
#define BCHP_M2MC_HORIZ_AVERAGER_COUNT           0x000a81f4 /* Horizontal averager control count */
#define BCHP_M2MC_HORIZ_AVERAGER_COEFF           0x000a81f8 /* Horizontal averager control coefficient */
#define BCHP_M2MC_VERT_AVERAGER_COUNT            0x000a81fc /* Vertical averager control count */
#define BCHP_M2MC_VERT_AVERAGER_COEFF            0x000a8200 /* Vertical averager control coefficient */
#define BCHP_M2MC_HORIZ_SCALER_0_INITIAL_PHASE   0x000a8204 /* Horizontal scaler 0 initial phase */
#define BCHP_M2MC_HORIZ_SCALER_0_STEP            0x000a8208 /* Horizontal scaler 0 step */
#define BCHP_M2MC_HORIZ_SCALER_1_INITIAL_PHASE   0x000a820c /* Horizontal scaler 1 initial phase */
#define BCHP_M2MC_HORIZ_SCALER_1_STEP            0x000a8210 /* Horizontal scaler 1 step */
#define BCHP_M2MC_VERT_SCALER_0_INITIAL_PHASE    0x000a8214 /* Vertical scaler 0 initial phase */
#define BCHP_M2MC_VERT_SCALER_0_STEP             0x000a8218 /* Vertical scaler 0 step */
#define BCHP_M2MC_VERT_SCALER_1_INITIAL_PHASE    0x000a821c /* Vertical scaler 1 initial phase */
#define BCHP_M2MC_VERT_SCALER_1_STEP             0x000a8220 /* Vertical scaler 1 step */
#define BCHP_M2MC_BLEND_COLOR_OP                 0x000a8224 /* Color blend operation descriptor */
#define BCHP_M2MC_BLEND_ALPHA_OP                 0x000a8228 /* Alpha blend operation descriptor */
#define BCHP_M2MC_BLEND_CONSTANT_COLOR           0x000a822c /* Blend constant color */
#define BCHP_M2MC_BLEND_COLOR_KEY_ACTION         0x000a8230 /* Action color keyed samples take in blender */
#define BCHP_M2MC_ROP_OPERATION                  0x000a8234 /* Raster operation vector */
#define BCHP_M2MC_ROP_PATTERN_TOP                0x000a8238 /* Top half of ROP pattern */
#define BCHP_M2MC_ROP_PATTERN_BOTTOM             0x000a823c /* Bottom half of ROP pattern */
#define BCHP_M2MC_ROP_PATTERN_COLOR_0            0x000a8240 /* ROP Color for 0 */
#define BCHP_M2MC_ROP_PATTERN_COLOR_1            0x000a8244 /* ROP Color for 1 */
#define BCHP_M2MC_SRC_COLOR_KEY_HIGH             0x000a8248 /* Source color key high */
#define BCHP_M2MC_SRC_COLOR_KEY_LOW              0x000a824c /* Source color key low */
#define BCHP_M2MC_SRC_COLOR_KEY_MASK             0x000a8250 /* Source color key mask */
#define BCHP_M2MC_SRC_COLOR_KEY_REPLACEMENT      0x000a8254 /* Source color key replacement */
#define BCHP_M2MC_SRC_COLOR_KEY_REPLACEMENT_MASK 0x000a8258 /* Source color key replacement mask */
#define BCHP_M2MC_DEST_COLOR_KEY_HIGH            0x000a825c /* Destination color key high */
#define BCHP_M2MC_DEST_COLOR_KEY_LOW             0x000a8260 /* Destination color key low */
#define BCHP_M2MC_DEST_COLOR_KEY_MASK            0x000a8264 /* Destination color key mask */
#define BCHP_M2MC_DEST_COLOR_KEY_REPLACEMENT     0x000a8268 /* Destination color key replacement */
#define BCHP_M2MC_DEST_COLOR_KEY_REPLACEMENT_MASK 0x000a826c /* Destination color key replacement mask */
#define BCHP_M2MC_HORIZ_FIR_0_COEFF_PHASE0_01    0x000a8270 /* Horizontal Scaler 0 Poly-Phase Filter Phase 0 Coefficients */
#define BCHP_M2MC_HORIZ_FIR_0_COEFF_PHASE0_2     0x000a8274 /* Horizontal Scaler 0 Poly-Phase Filter Phase 0 Coefficients */
#define BCHP_M2MC_HORIZ_FIR_0_COEFF_PHASE1_01    0x000a8278 /* Horizontal Scaler 0 Poly-Phase Filter Phase 1 Coefficients */
#define BCHP_M2MC_HORIZ_FIR_0_COEFF_PHASE1_2     0x000a827c /* Horizontal Scaler 0 Poly-Phase Filter Phase 1 Coefficients */
#define BCHP_M2MC_HORIZ_FIR_1_COEFF_PHASE0_01    0x000a8280 /* Horizontal Scaler 1 Poly-Phase Filter Phase 0 Coefficients */
#define BCHP_M2MC_HORIZ_FIR_1_COEFF_PHASE0_2     0x000a8284 /* Horizontal Scaler 1 Poly-Phase Filter Phase 0 Coefficients */
#define BCHP_M2MC_HORIZ_FIR_1_COEFF_PHASE1_01    0x000a8288 /* Horizontal Scaler 1 Poly-Phase Filter Phase 1 Coefficients */
#define BCHP_M2MC_HORIZ_FIR_1_COEFF_PHASE1_2     0x000a828c /* Horizontal Scaler 1 Poly-Phase Filter Phase 1 Coefficients */
#define BCHP_M2MC_VERT_FIR_0_COEFF_PHASE0_01     0x000a8290 /* Vertical Scaler 0 Poly-Phase Filter Phase 0 Coefficients */
#define BCHP_M2MC_VERT_FIR_0_COEFF_PHASE0_2      0x000a8294 /* Vertical Scaler 0 Poly-Phase Filter Phase 0 Coefficients */
#define BCHP_M2MC_VERT_FIR_0_COEFF_PHASE1_01     0x000a8298 /* Vertical Scaler 0 Poly-Phase Filter Phase 1 Coefficients */
#define BCHP_M2MC_VERT_FIR_0_COEFF_PHASE1_2      0x000a829c /* Vertical Scaler 0 Poly-Phase Filter Phase 1 Coefficients */
#define BCHP_M2MC_VERT_FIR_1_COEFF_PHASE0_01     0x000a82a0 /* Vertical Scaler 1 Poly-Phase Filter Phase 0 Coefficients */
#define BCHP_M2MC_VERT_FIR_1_COEFF_PHASE0_2      0x000a82a4 /* Vertical Scaler 1 Poly-Phase Filter Phase 0 Coefficients */
#define BCHP_M2MC_VERT_FIR_1_COEFF_PHASE1_01     0x000a82a8 /* Vertical Scaler 1 Poly-Phase Filter Phase 1 Coefficients */
#define BCHP_M2MC_VERT_FIR_1_COEFF_PHASE1_2      0x000a82ac /* Vertical Scaler 1 Poly-Phase Filter Phase 1 Coefficients */
#define BCHP_M2MC_SRC_CM_C00_C01                 0x000a82b0 /* Color Conversion Matrix Coefficients C00 and C01 */
#define BCHP_M2MC_SRC_CM_C02_C03                 0x000a82b4 /* Color Conversion Matrix Coefficients C02 and C03 */
#define BCHP_M2MC_SRC_CM_C04                     0x000a82b8 /* Color Conversion Matrix Coefficients C04 */
#define BCHP_M2MC_SRC_CM_C10_C11                 0x000a82bc /* Color Conversion Matrix Coefficients C10 and C11 */
#define BCHP_M2MC_SRC_CM_C12_C13                 0x000a82c0 /* Color Conversion Matrix Coefficients C12 and C13 */
#define BCHP_M2MC_SRC_CM_C14                     0x000a82c4 /* Color Conversion Matrix Coefficients C14 */
#define BCHP_M2MC_SRC_CM_C20_C21                 0x000a82c8 /* Color Conversion Matrix Coefficients C20 and C21 */
#define BCHP_M2MC_SRC_CM_C22_C23                 0x000a82cc /* Color Conversion Matrix Coefficients C22 and C23 */
#define BCHP_M2MC_SRC_CM_C24                     0x000a82d0 /* Color Conversion Matrix Coefficients C24 */
#define BCHP_M2MC_SRC_CM_C30_C31                 0x000a82d4 /* Color Conversion Matrix Coefficients C30 and C31 */
#define BCHP_M2MC_SRC_CM_C32_C33                 0x000a82d8 /* Color Conversion Matrix Coefficients C32 and C33 */
#define BCHP_M2MC_SRC_CM_C34                     0x000a82dc /* Color Conversion Matrix Coefficients C34 */
#define BCHP_M2MC_TIMEOUT_COUNTER_CONTROL        0x000a82e0 /* M2MC timeout counter control register */
#define BCHP_M2MC_CLK_GATE_AND_SW_INIT_CONTROL   0x000a82e4 /* M2MC clock gating and software init control register */
 ...
 ***************************************************************************/
#define BCHP_M2MC_SRC_CLUT_ENTRY_i_ARRAY_BASE                      0x000a8400
