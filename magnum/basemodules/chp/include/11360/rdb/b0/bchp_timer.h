...
/*
 * We disable any timer support by magnum for Cygnus,
 * so this must be harmless (reading/writing 0x180a0000 (relative 0x0) does not affect anything)
 */
#define BCHP_TIMER_WDCMD                         0x00000000 /* WATCHDOG COMMAND REGISTER */
