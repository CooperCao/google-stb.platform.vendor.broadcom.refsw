 ...
 * 
 ***************************************************************************/
#ifndef BCHP_7362_H__
#define BCHP_7362_H__
...
/***************************************************************************
Summary:
    Open a chip handle for Bcm7362 chip

Description:
    This function open a chip handle for Bcm7362 chip.

Input:
    hRegister - A valid Bcm7362 register handle previous open using BREG_Open.
