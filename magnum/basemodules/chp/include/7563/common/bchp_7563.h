 ...
 * 
 ***************************************************************************/
#ifndef BCHP_7563_H__
#define BCHP_7563_H__
...
/***************************************************************************
Summary:
    Open a chip handle for Bcm7563 chip

Description:
    This function open a chip handle for Bcm7563 chip.

Input:
    hRegister - A valid Bcm7563 register handle previous open using BREG_Open.
