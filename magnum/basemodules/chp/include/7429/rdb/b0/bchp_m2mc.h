 ...
 ***************************************************************************/
#define BCHP_M2MC_REVISION                       0x00460000 /* M2MC Revision register */
#define BCHP_M2MC_BLIT_GO                        0x00460004 /* Blit GO bit */
#define BCHP_M2MC_SCRATCH_NOT_LIST               0x00460008 /* M2MC Scratch register (not included in DMA list structure) */
#define BCHP_M2MC_LIST_CTRL                      0x0046000c /* RDMA Linked List Control Register */
#define BCHP_M2MC_LIST_STATUS                    0x00460010 /* RDMA Linked List Status Register */
#define BCHP_M2MC_LIST_FIRST_PKT_ADDR            0x00460014 /* RDMA Linked List First Packet Address Register */
#define BCHP_M2MC_LIST_CURR_PKT_ADDR             0x00460018 /* RDMA Linked List Current Packet Address Register */
#define BCHP_M2MC_BLIT_STATUS                    0x0046001c /* Blit status */
#define BCHP_M2MC_BLIT_SRC_ADDRESS               0x00460020 /* Blit status source feeder current address */
#define BCHP_M2MC_BLIT_DEST_ADDRESS              0x00460024 /* Blit status destination feeder current address */
#define BCHP_M2MC_BLIT_OUTPUT_ADDRESS            0x00460028 /* Blit status output feeder current address */
#define BCHP_M2MC_BLIT_MEM_HI                    0x0046002c /* Blit memory protection address high */
#define BCHP_M2MC_BLIT_MEM_LO                    0x00460030 /* Blit memory protection address low */
#define BCHP_M2MC_SCBADDRSEL                     0x00460040 /* scb address map select register */
#define BCHP_M2MC_SCRATCH_LIST                   0x00460100 /* M2MC Scratch register (Included in DMA list structure) */
#define BCHP_M2MC_SRC_FEEDER_ENABLE              0x00460104 /* Source plane enable */
#define BCHP_M2MC_SRC_SURFACE_ADDR_0             0x00460108 /* Source surface 0 address */
#define BCHP_M2MC_SRC_SURFACE_STRIDE_0           0x0046010c /* Source surface 0 STRIDE */
#define BCHP_M2MC_SRC_SURFACE_ADDR_1             0x00460110 /* Source surface 1 address */
#define BCHP_M2MC_SRC_SURFACE_STRIDE_1           0x00460114 /* Source surface 1 STRIDE */
#define BCHP_M2MC_SRC_SURFACE_0_FORMAT_DEF_1     0x00460118 /* Source pixel format 1 for surface 0 */
#define BCHP_M2MC_SRC_SURFACE_0_FORMAT_DEF_2     0x0046011c /* Source pixel format 2 for surface 0 */
#define BCHP_M2MC_SRC_SURFACE_0_FORMAT_DEF_3     0x00460120 /* Source pixel format 3 for surface 0 */
#define BCHP_M2MC_SRC_SURFACE_1_FORMAT_DEF_1     0x00460124 /* Source pixel format 1 for surface 1 */
#define BCHP_M2MC_SRC_SURFACE_1_FORMAT_DEF_2     0x00460128 /* Source pixel format 2 for surface 1 */
#define BCHP_M2MC_SRC_SURFACE_1_FORMAT_DEF_3     0x0046012c /* Source pixel format 3 for surface 1 */
#define BCHP_M2MC_SRC_W_ALPHA                    0x00460130 /* Source Alpha W format */
#define BCHP_M2MC_SRC_CONSTANT_COLOR             0x00460134 /* Source constant color */
#define BCHP_M2MC_DEST_FEEDER_ENABLE             0x00460138 /* Destination plane enable */
#define BCHP_M2MC_DEST_SURFACE_ADDR_0            0x0046013c /* Destination surface 0 address */
#define BCHP_M2MC_DEST_SURFACE_STRIDE_0          0x00460140 /* Destination surface 0 STRIDE */
#define BCHP_M2MC_DEST_SURFACE_ADDR_1            0x00460144 /* Destination surface 1 address */
#define BCHP_M2MC_DEST_SURFACE_STRIDE_1          0x00460148 /* Destination surface 1 STRIDE */
#define BCHP_M2MC_DEST_SURFACE_FORMAT_DEF_1      0x0046014c /* Destination pixel format 1 */
#define BCHP_M2MC_DEST_SURFACE_FORMAT_DEF_2      0x00460150 /* Destination pixel format 2 */
#define BCHP_M2MC_DEST_SURFACE_FORMAT_DEF_3      0x00460154 /* Destination pixel format 3 */
#define BCHP_M2MC_DEST_W_ALPHA                   0x00460158 /* Destination Alpha W format */
#define BCHP_M2MC_DEST_CONSTANT_COLOR            0x0046015c /* Destination constant color */
#define BCHP_M2MC_OUTPUT_FEEDER_ENABLE           0x00460160 /* Output plane enable */
#define BCHP_M2MC_OUTPUT_SURFACE_ADDR_0          0x00460164 /* Output surface 0 address */
#define BCHP_M2MC_OUTPUT_SURFACE_STRIDE_0        0x00460168 /* Output surface 0 STRIDE */
#define BCHP_M2MC_OUTPUT_SURFACE_ADDR_1          0x0046016c /* Output surface 1 address */
#define BCHP_M2MC_OUTPUT_SURFACE_STRIDE_1        0x00460170 /* Output surface 1 STRIDE */
#define BCHP_M2MC_OUTPUT_SURFACE_FORMAT_DEF_1    0x00460174 /* Output pixel format 1 */
#define BCHP_M2MC_OUTPUT_SURFACE_FORMAT_DEF_2    0x00460178 /* Output pixel format 2 */
#define BCHP_M2MC_OUTPUT_SURFACE_FORMAT_DEF_3    0x0046017c /* Output pixel format 3 */
#define BCHP_M2MC_BLIT_HEADER                    0x00460180 /* Blit header and control */
#define BCHP_M2MC_BLIT_SRC_TOP_LEFT_0            0x00460184 /* Top left pixel coordinate in the Source surface 0. */
#define BCHP_M2MC_BLIT_SRC_SIZE_0                0x00460188 /* Pixel width and height of operation in Source surface 0. */
#define BCHP_M2MC_BLIT_SRC_TOP_LEFT_1            0x0046018c /* Top left pixel coordinate in the Source surface 1. */
#define BCHP_M2MC_BLIT_SRC_SIZE_1                0x00460190 /* Pixel width and height of operation in Source surface 1. */
#define BCHP_M2MC_BLIT_SRC_STRIPE_HEIGHT_WIDTH_0 0x00460194 /* width and height of stripe for surface 0 for the decoded frame image format. */
#define BCHP_M2MC_BLIT_SRC_STRIPE_HEIGHT_WIDTH_1 0x00460198 /* width and height of stripe for surface 1 for the decoded frame image format. */
#define BCHP_M2MC_BLIT_DEST_TOP_LEFT             0x0046019c /* Top left pixel coordinate in the Destination */
#define BCHP_M2MC_BLIT_DEST_SIZE                 0x004601a0 /* Pixel width and height of operation in destination */
#define BCHP_M2MC_BLIT_OUTPUT_TOP_LEFT           0x004601a4 /* Top left pixel coordinate in the Output */
#define BCHP_M2MC_BLIT_OUTPUT_SIZE               0x004601a8 /* Pixel width and height of operation in the Output */
#define BCHP_M2MC_BLIT_INPUT_STRIPE_WIDTH_0      0x004601ac /* Pixel width of input stripe when striping for surface 0 */
#define BCHP_M2MC_BLIT_INPUT_STRIPE_WIDTH_1      0x004601b0 /* Pixel width of input stripe when striping for surface 1 */
#define BCHP_M2MC_BLIT_OUTPUT_STRIPE_WIDTH       0x004601b4 /* Pixel width of output stripe when striping */
#define BCHP_M2MC_BLIT_STRIPE_OVERLAP_0          0x004601b8 /* Pixel width of stripe overlap when striping for surface 0. */
#define BCHP_M2MC_BLIT_STRIPE_OVERLAP_1          0x004601bc /* Pixel width of stripe overlap when striping for surface 1. */
#define BCHP_M2MC_BLIT_CTRL                      0x004601c0 /* Blit control */
#define BCHP_M2MC_SCALER_CTRL                    0x004601c4 /* Scaler control */
#define BCHP_M2MC_HORIZ_AVERAGER_COUNT           0x004601c8 /* Horizontal averager control count */
#define BCHP_M2MC_HORIZ_AVERAGER_COEFF           0x004601cc /* Horizontal averager control coefficient */
#define BCHP_M2MC_VERT_AVERAGER_COUNT            0x004601d0 /* Vertical averager control count */
#define BCHP_M2MC_VERT_AVERAGER_COEFF            0x004601d4 /* Vertical averager control coefficient */
#define BCHP_M2MC_HORIZ_SCALER_0_INITIAL_PHASE   0x004601d8 /* Horizontal scaler 0 initial phase */
#define BCHP_M2MC_HORIZ_SCALER_0_STEP            0x004601dc /* Horizontal scaler 0 step */
#define BCHP_M2MC_HORIZ_SCALER_1_INITIAL_PHASE   0x004601e0 /* Horizontal scaler 1 initial phase */
#define BCHP_M2MC_HORIZ_SCALER_1_STEP            0x004601e4 /* Horizontal scaler 1 step */
#define BCHP_M2MC_VERT_SCALER_0_INITIAL_PHASE    0x004601e8 /* Vertical scaler 0 initial phase */
#define BCHP_M2MC_VERT_SCALER_0_STEP             0x004601ec /* Vertical scaler 0 step */
#define BCHP_M2MC_VERT_SCALER_1_INITIAL_PHASE    0x004601f0 /* Vertical scaler 1 initial phase */
#define BCHP_M2MC_VERT_SCALER_1_STEP             0x004601f4 /* Vertical scaler 1 step */
#define BCHP_M2MC_BLEND_COLOR_OP                 0x004601f8 /* Color blend operation descriptor */
#define BCHP_M2MC_BLEND_ALPHA_OP                 0x004601fc /* Alpha blend operation descriptor */
#define BCHP_M2MC_BLEND_CONSTANT_COLOR           0x00460200 /* Blend constant color */
#define BCHP_M2MC_BLEND_COLOR_KEY_ACTION         0x00460204 /* Action color keyed samples take in blender */
#define BCHP_M2MC_ROP_OPERATION                  0x00460208 /* Raster operation vector */
#define BCHP_M2MC_ROP_PATTERN_TOP                0x0046020c /* Top half of ROP pattern */
#define BCHP_M2MC_ROP_PATTERN_BOTTOM             0x00460210 /* Bottom half of ROP pattern */
#define BCHP_M2MC_ROP_PATTERN_COLOR_0            0x00460214 /* ROP Color for 0 */
#define BCHP_M2MC_ROP_PATTERN_COLOR_1            0x00460218 /* ROP Color for 1 */
#define BCHP_M2MC_SRC_COLOR_KEY_HIGH             0x0046021c /* Source color key high */
#define BCHP_M2MC_SRC_COLOR_KEY_LOW              0x00460220 /* Source color key low */
#define BCHP_M2MC_SRC_COLOR_KEY_MASK             0x00460224 /* Source color key mask */
#define BCHP_M2MC_SRC_COLOR_KEY_REPLACEMENT      0x00460228 /* Source color key replacement */
#define BCHP_M2MC_SRC_COLOR_KEY_REPLACEMENT_MASK 0x0046022c /* Source color key replacement mask */
#define BCHP_M2MC_DEST_COLOR_KEY_HIGH            0x00460230 /* Destination color key high */
#define BCHP_M2MC_DEST_COLOR_KEY_LOW             0x00460234 /* Destination color key low */
#define BCHP_M2MC_DEST_COLOR_KEY_MASK            0x00460238 /* Destination color key mask */
#define BCHP_M2MC_DEST_COLOR_KEY_REPLACEMENT     0x0046023c /* Destination color key replacement */
#define BCHP_M2MC_DEST_COLOR_KEY_REPLACEMENT_MASK 0x00460240 /* Destination color key replacement mask */
#define BCHP_M2MC_HORIZ_FIR_0_COEFF_PHASE0_01    0x00460244 /* Horizontal Scaler 0 Poly-Phase Filter Phase 0 Coefficients */
#define BCHP_M2MC_HORIZ_FIR_0_COEFF_PHASE0_2     0x00460248 /* Horizontal Scaler 0 Poly-Phase Filter Phase 0 Coefficients */
#define BCHP_M2MC_HORIZ_FIR_0_COEFF_PHASE1_01    0x0046024c /* Horizontal Scaler 0 Poly-Phase Filter Phase 1 Coefficients */
#define BCHP_M2MC_HORIZ_FIR_0_COEFF_PHASE1_2     0x00460250 /* Horizontal Scaler 0 Poly-Phase Filter Phase 1 Coefficients */
#define BCHP_M2MC_HORIZ_FIR_1_COEFF_PHASE0_01    0x00460254 /* Horizontal Scaler 1 Poly-Phase Filter Phase 0 Coefficients */
#define BCHP_M2MC_HORIZ_FIR_1_COEFF_PHASE0_2     0x00460258 /* Horizontal Scaler 1 Poly-Phase Filter Phase 0 Coefficients */
#define BCHP_M2MC_HORIZ_FIR_1_COEFF_PHASE1_01    0x0046025c /* Horizontal Scaler 1 Poly-Phase Filter Phase 1 Coefficients */
#define BCHP_M2MC_HORIZ_FIR_1_COEFF_PHASE1_2     0x00460260 /* Horizontal Scaler 1 Poly-Phase Filter Phase 1 Coefficients */
#define BCHP_M2MC_VERT_FIR_0_COEFF_PHASE0_01     0x00460264 /* Vertical Scaler 0 Poly-Phase Filter Phase 0 Coefficients */
#define BCHP_M2MC_VERT_FIR_0_COEFF_PHASE0_2      0x00460268 /* Vertical Scaler 0 Poly-Phase Filter Phase 0 Coefficients */
#define BCHP_M2MC_VERT_FIR_0_COEFF_PHASE1_01     0x0046026c /* Vertical Scaler 0 Poly-Phase Filter Phase 1 Coefficients */
#define BCHP_M2MC_VERT_FIR_0_COEFF_PHASE1_2      0x00460270 /* Vertical Scaler 0 Poly-Phase Filter Phase 1 Coefficients */
#define BCHP_M2MC_VERT_FIR_1_COEFF_PHASE0_01     0x00460274 /* Vertical Scaler 1 Poly-Phase Filter Phase 0 Coefficients */
#define BCHP_M2MC_VERT_FIR_1_COEFF_PHASE0_2      0x00460278 /* Vertical Scaler 1 Poly-Phase Filter Phase 0 Coefficients */
#define BCHP_M2MC_VERT_FIR_1_COEFF_PHASE1_01     0x0046027c /* Vertical Scaler 1 Poly-Phase Filter Phase 1 Coefficients */
#define BCHP_M2MC_VERT_FIR_1_COEFF_PHASE1_2      0x00460280 /* Vertical Scaler 1 Poly-Phase Filter Phase 1 Coefficients */
#define BCHP_M2MC_SRC_CM_C00_C01                 0x00460284 /* Color Conversion Matrix Coefficients C00 and C01 */
#define BCHP_M2MC_SRC_CM_C02_C03                 0x00460288 /* Color Conversion Matrix Coefficients C02 and C03 */
#define BCHP_M2MC_SRC_CM_C04                     0x0046028c /* Color Conversion Matrix Coefficients C04 */
#define BCHP_M2MC_SRC_CM_C10_C11                 0x00460290 /* Color Conversion Matrix Coefficients C10 and C11 */
#define BCHP_M2MC_SRC_CM_C12_C13                 0x00460294 /* Color Conversion Matrix Coefficients C12 and C13 */
#define BCHP_M2MC_SRC_CM_C14                     0x00460298 /* Color Conversion Matrix Coefficients C14 */
#define BCHP_M2MC_SRC_CM_C20_C21                 0x0046029c /* Color Conversion Matrix Coefficients C20 and C21 */
#define BCHP_M2MC_SRC_CM_C22_C23                 0x004602a0 /* Color Conversion Matrix Coefficients C22 and C23 */
#define BCHP_M2MC_SRC_CM_C24                     0x004602a4 /* Color Conversion Matrix Coefficients C24 */
#define BCHP_M2MC_SRC_CM_C30_C31                 0x004602a8 /* Color Conversion Matrix Coefficients C30 and C31 */
#define BCHP_M2MC_SRC_CM_C32_C33                 0x004602ac /* Color Conversion Matrix Coefficients C32 and C33 */
#define BCHP_M2MC_SRC_CM_C34                     0x004602b0 /* Color Conversion Matrix Coefficients C34 */
#define BCHP_M2MC_TIMEOUT_COUNTER_CONTROL        0x004602b4 /* M2MC timeout counter control register */
#define BCHP_M2MC_CLK_GATE_AND_SW_INIT_CONTROL   0x004602b8 /* M2MC clock gating and software init control register */
