 ...
 ***************************************************************************/
#define BCHP_DVP_HR_TMR_TIMER_IS                 0x006a8cc0 /* TIMER INTERRUPT STATUS REGISTER */
#define BCHP_DVP_HR_TMR_TIMER_IE0                0x006a8cc4 /* TIMER CPU INTERRUPT ENABLE REGISTER */
#define BCHP_DVP_HR_TMR_TIMER0_CTRL              0x006a8cc8 /* TIMER0 CONTROL REGISTER */
#define BCHP_DVP_HR_TMR_TIMER1_CTRL              0x006a8ccc /* TIMER1 CONTROL REGISTER */
#define BCHP_DVP_HR_TMR_TIMER2_CTRL              0x006a8cd0 /* TIMER2 CONTROL REGISTER */
#define BCHP_DVP_HR_TMR_TIMER3_CTRL              0x006a8cd4 /* TIMER3 CONTROL REGISTER */
#define BCHP_DVP_HR_TMR_TIMER0_STAT              0x006a8cd8 /* TIMER0 STATUS REGISTER */
#define BCHP_DVP_HR_TMR_TIMER1_STAT              0x006a8cdc /* TIMER1 STATUS REGISTER */
#define BCHP_DVP_HR_TMR_TIMER2_STAT              0x006a8ce0 /* TIMER2 STATUS REGISTER */
#define BCHP_DVP_HR_TMR_TIMER3_STAT              0x006a8ce4 /* TIMER3 STATUS REGISTER */
#define BCHP_DVP_HR_TMR_WDTIMEOUT                0x006a8ce8 /* WATCHDOG TIMEOUT REGISTER */
#define BCHP_DVP_HR_TMR_WDCMD                    0x006a8cec /* WATCHDOG COMMAND REGISTER */
#define BCHP_DVP_HR_TMR_WDCHIPRST_CNT            0x006a8cf0 /* WATCHDOG CHIP RESET COUNT REGISTER */
#define BCHP_DVP_HR_TMR_WDCRS                    0x006a8cf4 /* WATCHDOG CHIP RESET STATUS REGISTER */
#define BCHP_DVP_HR_TMR_TIMER_IE1                0x006a8cf8 /* TIMER PCI INTERRUPT ENABLE REGISTER */
#define BCHP_DVP_HR_TMR_WDCTRL                   0x006a8cfc /* WATCHDOG CONTROL REGISTER */
