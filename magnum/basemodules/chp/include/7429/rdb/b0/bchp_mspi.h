 ...
 *MSPI - Master SPI
 ***************************************************************************/
#define BCHP_MSPI_SPCR0_LSB                      0x00409400 /* SPCR0_LSB REGISTER */
#define BCHP_MSPI_SPCR0_MSB                      0x00409404 /* SPCR0_MSB Register */
#define BCHP_MSPI_SPCR1_LSB                      0x00409408 /* SPCR1_LSB REGISTER */
#define BCHP_MSPI_SPCR1_MSB                      0x0040940c /* SPCR1_MSB REGISTER */
#define BCHP_MSPI_NEWQP                          0x00409410 /* NEWQP REGISTER */
#define BCHP_MSPI_ENDQP                          0x00409414 /* ENDQP REGISTER */
#define BCHP_MSPI_SPCR2                          0x00409418 /* SPCR2 REGISTER */
#define BCHP_MSPI_MSPI_STATUS                    0x00409420 /* MSPI STATUS REGISTER */
#define BCHP_MSPI_CPTQP                          0x00409424 /* CPTQP REGISTER */
#define BCHP_MSPI_SPCR3                          0x00409428 /* SPCR3 REGISTER */
#define BCHP_MSPI_TXRAM00                        0x00409440 /* Most significant byte of TXRAM[0] (queue pointer = 0) */
#define BCHP_MSPI_TXRAM01                        0x00409444 /* Least significant byte of TXRAM[0] (queue pointer = 0) */
#define BCHP_MSPI_TXRAM02                        0x00409448 /* Most significant byte of TXRAM[1] (queue pointer = 1) */
#define BCHP_MSPI_TXRAM03                        0x0040944c /* Least significant byte of TXRAM[1] (queue pointer = 1) */
#define BCHP_MSPI_TXRAM04                        0x00409450 /* Most significant byte of TXRAM[2] (queue pointer = 2) */
#define BCHP_MSPI_TXRAM05                        0x00409454 /* Least significant byte of TXRAM[2] (queue pointer = 2) */
#define BCHP_MSPI_TXRAM06                        0x00409458 /* Most significant byte of TXRAM[3] (queue pointer = 3) */
#define BCHP_MSPI_TXRAM07                        0x0040945c /* Least significant byte of TXRAM[3] (queue pointer = 3) */
#define BCHP_MSPI_TXRAM08                        0x00409460 /* Most significant byte of TXRAM[4] (queue pointer = 4) */
#define BCHP_MSPI_TXRAM09                        0x00409464 /* Least significant byte of TXRAM[4] (queue pointer = 4) */
#define BCHP_MSPI_TXRAM10                        0x00409468 /* Most significant byte of TXRAM[5] (queue pointer = 5) */
#define BCHP_MSPI_TXRAM11                        0x0040946c /* Least significant byte of TXRAM[5] (queue pointer = 5) */
#define BCHP_MSPI_TXRAM12                        0x00409470 /* Most significant byte of TXRAM[6] (queue pointer = 6) */
#define BCHP_MSPI_TXRAM13                        0x00409474 /* Least significant byte of TXRAM[6] (queue pointer = 6) */
#define BCHP_MSPI_TXRAM14                        0x00409478 /* Most significant byte of TXRAM[7] (queue pointer = 7) */
#define BCHP_MSPI_TXRAM15                        0x0040947c /* Least significant byte of TXRAM[7] (queue pointer = 7) */
#define BCHP_MSPI_TXRAM16                        0x00409480 /* Most significant byte of TXRAM[8] (queue pointer = 8) */
#define BCHP_MSPI_TXRAM17                        0x00409484 /* Least significant byte of TXRAM[8] (queue pointer = 8) */
#define BCHP_MSPI_TXRAM18                        0x00409488 /* Most significant byte of TXRAM[9] (queue pointer = 9) */
#define BCHP_MSPI_TXRAM19                        0x0040948c /* Least significant byte of TXRAM[9] (queue pointer = 9) */
#define BCHP_MSPI_TXRAM20                        0x00409490 /* Most significant byte of TXRAM[10] (queue pointer = 10) */
#define BCHP_MSPI_TXRAM21                        0x00409494 /* Least significant byte of TXRAM[10] (queue pointer = 10) */
#define BCHP_MSPI_TXRAM22                        0x00409498 /* Most significant byte of TXRAM[11] (queue pointer = 11) */
#define BCHP_MSPI_TXRAM23                        0x0040949c /* Least significant byte of TXRAM[11] (queue pointer = 11) */
#define BCHP_MSPI_TXRAM24                        0x004094a0 /* Most significant byte of TXRAM[12] (queue pointer = 12) */
#define BCHP_MSPI_TXRAM25                        0x004094a4 /* Least significant byte of TXRAM[12] (queue pointer = 12) */
#define BCHP_MSPI_TXRAM26                        0x004094a8 /* Most significant byte of TXRAM[13] (queue pointer = 13) */
#define BCHP_MSPI_TXRAM27                        0x004094ac /* Least significant byte of TXRAM[13] (queue pointer = 13) */
#define BCHP_MSPI_TXRAM28                        0x004094b0 /* Most significant byte of TXRAM[14] (queue pointer = 14) */
#define BCHP_MSPI_TXRAM29                        0x004094b4 /* Least significant byte of TXRAM[14] (queue pointer = 14) */
#define BCHP_MSPI_TXRAM30                        0x004094b8 /* Most significant byte of TXRAM[15] (queue pointer = 15) */
#define BCHP_MSPI_TXRAM31                        0x004094bc /* Least significant byte of TXRAM[15] (queue pointer = 15) */
#define BCHP_MSPI_RXRAM00                        0x004094c0 /* Most significant byte of RXRAM[0] (queue pointer = 0) */
#define BCHP_MSPI_RXRAM01                        0x004094c4 /* Least significant byte of RXRAM[0] (queue pointer = 0) */
#define BCHP_MSPI_RXRAM02                        0x004094c8 /* Most significant byte of RXRAM[1] (queue pointer = 1) */
#define BCHP_MSPI_RXRAM03                        0x004094cc /* Least significant byte of RXRAM[1] (queue pointer = 1) */
#define BCHP_MSPI_RXRAM04                        0x004094d0 /* Most significant byte of RXRAM[2] (queue pointer = 2) */
#define BCHP_MSPI_RXRAM05                        0x004094d4 /* Least significant byte of RXRAM[2] (queue pointer = 2) */
#define BCHP_MSPI_RXRAM06                        0x004094d8 /* Most significant byte of RXRAM[3] (queue pointer = 3) */
#define BCHP_MSPI_RXRAM07                        0x004094dc /* Least significant byte of RXRAM[3] (queue pointer = 3) */
#define BCHP_MSPI_RXRAM08                        0x004094e0 /* Most significant byte of RXRAM[4] (queue pointer = 4) */
#define BCHP_MSPI_RXRAM09                        0x004094e4 /* Least significant byte of RXRAM[4] (queue pointer = 4) */
#define BCHP_MSPI_RXRAM10                        0x004094e8 /* Most significant byte of RXRAM[5] (queue pointer = 5) */
#define BCHP_MSPI_RXRAM11                        0x004094ec /* Least significant byte of RXRAM[5] (queue pointer = 5) */
#define BCHP_MSPI_RXRAM12                        0x004094f0 /* Most significant byte of RXRAM[6] (queue pointer = 6) */
#define BCHP_MSPI_RXRAM13                        0x004094f4 /* Least significant byte of RXRAM[6] (queue pointer = 6) */
#define BCHP_MSPI_RXRAM14                        0x004094f8 /* Most significant byte of RXRAM[7] (queue pointer = 7) */
#define BCHP_MSPI_RXRAM15                        0x004094fc /* Least significant byte of RXRAM[7] (queue pointer = 7) */
#define BCHP_MSPI_RXRAM16                        0x00409500 /* Most significant byte of RXRAM[8] (queue pointer = 8) */
#define BCHP_MSPI_RXRAM17                        0x00409504 /* Least significant byte of RXRAM[8] (queue pointer = 8) */
#define BCHP_MSPI_RXRAM18                        0x00409508 /* Most significant byte of RXRAM[9] (queue pointer = 9) */
#define BCHP_MSPI_RXRAM19                        0x0040950c /* Least significant byte of RXRAM[9] (queue pointer = 9) */
#define BCHP_MSPI_RXRAM20                        0x00409510 /* Most significant byte of RXRAM[10] (queue pointer = 10) */
#define BCHP_MSPI_RXRAM21                        0x00409514 /* Least significant byte of RXRAM[10] (queue pointer = 10) */
#define BCHP_MSPI_RXRAM22                        0x00409518 /* Most significant byte of RXRAM[11] (queue pointer = 11) */
#define BCHP_MSPI_RXRAM23                        0x0040951c /* Least significant byte of RXRAM[11] (queue pointer = 11) */
#define BCHP_MSPI_RXRAM24                        0x00409520 /* Most significant byte of RXRAM[12] (queue pointer = 12) */
#define BCHP_MSPI_RXRAM25                        0x00409524 /* Least significant byte of RXRAM[12] (queue pointer = 12) */
#define BCHP_MSPI_RXRAM26                        0x00409528 /* Most significant byte of RXRAM[13] (queue pointer = 13) */
#define BCHP_MSPI_RXRAM27                        0x0040952c /* Least significant byte of RXRAM[13] (queue pointer = 13) */
#define BCHP_MSPI_RXRAM28                        0x00409530 /* Most significant byte of RXRAM[14] (queue pointer = 14) */
#define BCHP_MSPI_RXRAM29                        0x00409534 /* Least significant byte of RXRAM[14] (queue pointer = 14) */
#define BCHP_MSPI_RXRAM30                        0x00409538 /* Most significant byte of RXRAM[15] (queue pointer = 15) */
#define BCHP_MSPI_RXRAM31                        0x0040953c /* Least significant byte of RXRAM[15] (queue pointer = 15) */
#define BCHP_MSPI_CDRAM00                        0x00409540 /* 8-bit command (queue pointer = 0) */
#define BCHP_MSPI_CDRAM01                        0x00409544 /* 8-bit command (queue pointer = 1) */
#define BCHP_MSPI_CDRAM02                        0x00409548 /* 8-bit command (queue pointer = 2) */
#define BCHP_MSPI_CDRAM03                        0x0040954c /* 8-bit command (queue pointer = 3) */
#define BCHP_MSPI_CDRAM04                        0x00409550 /* 8-bit command (queue pointer = 4) */
#define BCHP_MSPI_CDRAM05                        0x00409554 /* 8-bit command (queue pointer = 5) */
#define BCHP_MSPI_CDRAM06                        0x00409558 /* 8-bit command (queue pointer = 6) */
#define BCHP_MSPI_CDRAM07                        0x0040955c /* 8-bit command (queue pointer = 7) */
#define BCHP_MSPI_CDRAM08                        0x00409560 /* 8-bit command (queue pointer = 8) */
#define BCHP_MSPI_CDRAM09                        0x00409564 /* 8-bit command (queue pointer = 9) */
#define BCHP_MSPI_CDRAM10                        0x00409568 /* 8-bit command (queue pointer = a) */
#define BCHP_MSPI_CDRAM11                        0x0040956c /* 8-bit command (queue pointer = b) */
#define BCHP_MSPI_CDRAM12                        0x00409570 /* 8-bit command (queue pointer = c) */
#define BCHP_MSPI_CDRAM13                        0x00409574 /* 8-bit command (queue pointer = d) */
#define BCHP_MSPI_CDRAM14                        0x00409578 /* 8-bit command (queue pointer = e) */
#define BCHP_MSPI_CDRAM15                        0x0040957c /* 8-bit command (queue pointer = f) */
