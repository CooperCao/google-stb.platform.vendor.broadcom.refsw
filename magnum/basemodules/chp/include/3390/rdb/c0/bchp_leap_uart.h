 ...
 ***************************************************************************/
#define BCHP_LEAP_UART_UARTDR                    0x020c9000 /* [RW][32] Data register (12 or 8 bits) */
#define BCHP_LEAP_UART_UARTRSR                   0x020c9004 /* [RW][32] Receive status register/error clear register */
#define BCHP_LEAP_UART_UARTFR                    0x020c9018 /* [RO][32] Flag register */
#define BCHP_LEAP_UART_UARTILPR                  0x020c9020 /* [RW][32] IrDA low-power counter register */
#define BCHP_LEAP_UART_UARTIBRD                  0x020c9024 /* [RW][32] Integer baud rate register */
#define BCHP_LEAP_UART_UARTFBRD                  0x020c9028 /* [RW][32] Fractional baud rate register */
#define BCHP_LEAP_UART_UARTLCR_H                 0x020c902c /* [RW][32] Line control register */
#define BCHP_LEAP_UART_UARTCR                    0x020c9030 /* [RW][32] Control register */
#define BCHP_LEAP_UART_UARTIFLS                  0x020c9034 /* [RW][32] Interrupt FIFO level select register */
#define BCHP_LEAP_UART_UARTIMSC                  0x020c9038 /* [RW][32] Interrupt mask set/clear register */
#define BCHP_LEAP_UART_UARTRIS                   0x020c903c /* [RO][32] Raw interrupt status register */
#define BCHP_LEAP_UART_UARTMIS                   0x020c9040 /* [RO][32] Masked interrupt status register */
#define BCHP_LEAP_UART_UARTICR                   0x020c9044 /* [WO][32] Interrupt clear register */
#define BCHP_LEAP_UART_UARTDMACR                 0x020c9048 /* [RW][32] DMA control register */
#define BCHP_LEAP_UART_UARTPERIPHID0             0x020c9fe0 /* [RO][32] UARTPeriphID0 */
#define BCHP_LEAP_UART_UARTPERIPHID1             0x020c9fe4 /* [RO][32] UARTPeriphID1 */
#define BCHP_LEAP_UART_UARTPERIPHID2             0x020c9fe8 /* [RO][32] UARTPeriphID2 */
#define BCHP_LEAP_UART_UARTPERIPHID3             0x020c9fec /* [RO][32] UARTPeriphID3 */
#define BCHP_LEAP_UART_UARTPCELLID0              0x020c9ff0 /* [RO][32] UARTPCellID0 */
#define BCHP_LEAP_UART_UARTPCELLID1              0x020c9ff4 /* [RO][32] UARTPCellID1 */
#define BCHP_LEAP_UART_UARTPCELLID2              0x020c9ff8 /* [RO][32] UARTPCellID2 */
#define BCHP_LEAP_UART_UARTPCELLID3              0x020c9ffc /* [RO][32] UARTPCellID3 */
