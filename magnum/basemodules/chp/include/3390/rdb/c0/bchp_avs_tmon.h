 ...
 ***************************************************************************/
#define BCHP_AVS_TMON_TEMPERATURE_MEASUREMENT_STATUS 0x20431500 /* [RO][32] Indicate temperature measurement data and validity of data */
#define BCHP_AVS_TMON_ENABLE_OVER_TEMPERATURE_RESET 0x20431504 /* [RW][32] Enable over temperature reset */
#define BCHP_AVS_TMON_TEMPERATURE_RESET_THRESHOLD 0x20431508 /* [RW][32] Represent threshold for over temperature reset */
#define BCHP_AVS_TMON_TEMPERATURE_INTERRUPT_IDLE_TIME 0x20431510 /* [RW][32] No new temperature interrupt can be generated for interval defined by this idle time */
#define BCHP_AVS_TMON_ENABLE_TEMPERATURE_INTERRUPT_SOURCES 0x20431514 /* [RW][32] Enable high and low temperature interrupts */
#define BCHP_AVS_TMON_TEMPERATURE_INTERRUPT_THRESHOLDS 0x20431518 /* [RW][32] Represent thresholds for high and low temperature interrupts */
#define BCHP_AVS_TMON_TEMPERATURE_INTERRUPT_TEMPERATURE 0x2043151c /* [RO][32] Temperature code associated with temperature interrupt event */
#define BCHP_AVS_TMON_TP_TMON_TEST_ENABLE        0x20431520 /* [RW][32] Enabling TP mode to use data from tp_in for testing TMON */
#define BCHP_AVS_TMON_SPARE_0                    0x20431524 /* [RW][32] Spare register 0 for AVS TEMPERATURE MONITOR core */
