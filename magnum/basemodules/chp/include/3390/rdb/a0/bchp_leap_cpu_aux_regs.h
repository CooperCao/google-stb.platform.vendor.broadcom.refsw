 ...
 ***************************************************************************/
#define BCHP_LEAP_CPU_AUX_REGS_STATUS            0x020c0000 /* [RO] Auxiliary Register STATUS */
#define BCHP_LEAP_CPU_AUX_REGS_SEMAPHORE         0x020c0004 /* [RW] Inter-process/Host semaphore register */
#define BCHP_LEAP_CPU_AUX_REGS_LP_START          0x020c0008 /* [RW] Loop start address (32-bit) */
#define BCHP_LEAP_CPU_AUX_REGS_LP_END            0x020c000c /* [RW] Loop end address (32-bit) */
#define BCHP_LEAP_CPU_AUX_REGS_IDENTITY          0x020c0010 /* [RO] Processor Identification register */
#define BCHP_LEAP_CPU_AUX_REGS_DEBUG             0x020c0014 /* [RW] Debug register */
#define BCHP_LEAP_CPU_AUX_REGS_PC                0x020c0018 /* [RO] Program Counter register (32-bit) */
#define BCHP_LEAP_CPU_AUX_REGS_STATUS32          0x020c0028 /* [RO] Status register (32-bit) */
#define BCHP_LEAP_CPU_AUX_REGS_STATUS32_L1       0x020c002c /* [RW] Status register save for level 1 interrupts */
#define BCHP_LEAP_CPU_AUX_REGS_STATUS32_L2       0x020c0030 /* [RW] Status register save for level 2 interrupts */
#define BCHP_LEAP_CPU_AUX_REGS_IC_IVIC           0x020c0040 /* [WO] Invalidate cache */
#define BCHP_LEAP_CPU_AUX_REGS_IC_CTRL           0x020c0044 /* [RW] Cache Control Register */
#define BCHP_LEAP_CPU_AUX_REGS_IC_LIL            0x020c004c /* [WO] Lock instruction line */
#define BCHP_LEAP_CPU_AUX_REGS_IC_IVIL           0x020c0064 /* [WO] Invalidate instruction line */
#define BCHP_LEAP_CPU_AUX_REGS_TIMER0_CONTROL    0x020c0084 /* [RW] Processor Timer0 Count value */
#define BCHP_LEAP_CPU_AUX_REGS_TIMER0_COUNT      0x020c0088 /* [RW] Processor Timer0 Control value */
#define BCHP_LEAP_CPU_AUX_REGS_TIMER0_LIMIT      0x020c008c /* [RW] Processor Timer0 Limit value */
#define BCHP_LEAP_CPU_AUX_REGS_INT_VEC_BASE      0x020c0094 /* [RW] Interrupt Vector Base address */
#define BCHP_LEAP_CPU_AUX_REGS_AUX_IRQ_LV12      0x020c010c /* [RW] Interrupt Level Status */
#define BCHP_LEAP_CPU_AUX_REGS_DC_IVDC           0x020c011c /* [WO] Invalidate cache */
#define BCHP_LEAP_CPU_AUX_REGS_DC_CTRL           0x020c0120 /* [RW] Cache Control register */
#define BCHP_LEAP_CPU_AUX_REGS_DC_LDL            0x020c0124 /* [RW] Lock data line at this address */
#define BCHP_LEAP_CPU_AUX_REGS_DC_IVDL           0x020c0128 /* [RW] Invalidate data line */
#define BCHP_LEAP_CPU_AUX_REGS_DC_FLSH           0x020c012c /* [RW] Flush data cache */
#define BCHP_LEAP_CPU_AUX_REGS_DC_FLDL           0x020c0130 /* [RW] Flush data line */
#define BCHP_LEAP_CPU_AUX_REGS_DC_RAM_ADDR       0x020c0160 /* [RW] External Address RAM address */
#define BCHP_LEAP_CPU_AUX_REGS_DC_TAG            0x020c0164 /* [RW] Tag Access */
#define BCHP_LEAP_CPU_AUX_REGS_DC_WP             0x020c0168 /* [RW] Way Pointer Access */
#define BCHP_LEAP_CPU_AUX_REGS_DC_DATA           0x020c016c /* [RW] Data Accesse */
#define BCHP_LEAP_CPU_AUX_REGS_CRC_BUILD_BCR     0x020c0188 /* [RO] Build configuration register for CRC instruction. */
#define BCHP_LEAP_CPU_AUX_REGS_DVBF_BUILD        0x020c0190 /* [RO] Build configuration register for dual viterbi butterfly instruction. */
#define BCHP_LEAP_CPU_AUX_REGS_EXT_ARITH_BUILD   0x020c0194 /* [RO] Build configuration register to specify that the processor has the extended arithmetic instructions. */
#define BCHP_LEAP_CPU_AUX_REGS_DATASPACE         0x020c0198 /* [RO] Build configuration register for dataspace. */
#define BCHP_LEAP_CPU_AUX_REGS_MEMSUBSYS         0x020c019c /* [RO] Build configuration register for memory subsytem. */
#define BCHP_LEAP_CPU_AUX_REGS_VECBASE_AC_BUILD  0x020c01a0 /* [RO] Build configuration register for ARC600 interrupt vector base address. */
#define BCHP_LEAP_CPU_AUX_REGS_P_BASE_ADDR       0x020c01a4 /* [RO] Build configuration register for peripheral base address. */
#define BCHP_LEAP_CPU_AUX_REGS_MPU_BUILD         0x020c01b4 /* [RO] Build configuration register for memory protection unit. */
#define BCHP_LEAP_CPU_AUX_REGS_RF_BUILD          0x020c01b8 /* [RO] Build configuration register for register file. */
#define BCHP_LEAP_CPU_AUX_REGS_D_CACHE_BUILD     0x020c01c8 /* [RO] Build configuration register for data cache. */
#define BCHP_LEAP_CPU_AUX_REGS_MADI_BUILD        0x020c01cc /* [RO] Build configuration register for multiple ARC debug interface. */
#define BCHP_LEAP_CPU_AUX_REGS_DCCM_BUILD        0x020c01d0 /* [RO] Build configuration register for data closely coupled memory. */
#define BCHP_LEAP_CPU_AUX_REGS_TIMER_BUILD       0x020c01d4 /* [RO] Build configuration register for timers. */
#define BCHP_LEAP_CPU_AUX_REGS_AP_BUILD          0x020c01d8 /* [RO] Build configuration register for actionpoints. */
#define BCHP_LEAP_CPU_AUX_REGS_I_CACHE_BUILD     0x020c01dc /* [RO] Build configuration register for instruction cache. */
#define BCHP_LEAP_CPU_AUX_REGS_ICCM_BUILD        0x020c01e0 /* [RO] Build configuration register for instruction closely coupled memory. */
#define BCHP_LEAP_CPU_AUX_REGS_DSPRAM_BUILD      0x020c01e4 /* [RO] Build configuration register for XY memory. */
#define BCHP_LEAP_CPU_AUX_REGS_MAC_BUILD         0x020c01e8 /* [RO] Build configuration register for Xmac. */
#define BCHP_LEAP_CPU_AUX_REGS_MULTIPLY_BUILD    0x020c01ec /* [RO] Build configuration register for instruction closely coupled memory. */
#define BCHP_LEAP_CPU_AUX_REGS_SWAP_BUILD        0x020c01f0 /* [RO] Build configuration register for swap instruction. */
#define BCHP_LEAP_CPU_AUX_REGS_NORM_BUILD        0x020c01f4 /* [RO] Build configuration register for normalise instruction. */
#define BCHP_LEAP_CPU_AUX_REGS_MINMAX_BUILD      0x020c01f8 /* [RO] Build configuration register for min/max instruction. */
#define BCHP_LEAP_CPU_AUX_REGS_BARREL_BUILD      0x020c01fc /* [RO] Build configuration register for barrel shifter. */
#define BCHP_LEAP_CPU_AUX_REGS_ARC600_BUILD      0x020c0304 /* [RO] Build configuration register for ARC 600. */
#define BCHP_LEAP_CPU_AUX_REGS_AUX_SYSTEM_BUILD  0x020c0308 /* [RW] Build configuration register for AS221BD. */
#define BCHP_LEAP_CPU_AUX_REGS_MCD_BCR           0x020c0310 /* [RO] MCD configuration register for AS221BD. */
#define BCHP_LEAP_CPU_AUX_REGS_IFETCHQUEUE_BUILD 0x020c03f8 /* [RO] Build configuration register for the InstructionFetchQueue component. */
#define BCHP_LEAP_CPU_AUX_REGS_TIMER1_CONTROL    0x020c0400 /* [RW] Processor Timer 1 Count value */
#define BCHP_LEAP_CPU_AUX_REGS_TIMER1_COUNT      0x020c0404 /* [RW] Processor Timer 1 Control value */
#define BCHP_LEAP_CPU_AUX_REGS_TIMER1_LIMIT      0x020c0408 /* [RW] Processor Timer 1 Limit value */
#define BCHP_LEAP_CPU_AUX_REGS_AUX_IRQ_LEV       0x020c0800 /* [RW] Interrupt Level Programming */
#define BCHP_LEAP_CPU_AUX_REGS_AUX_IRQ_HINT      0x020c0804 /* [RW] Software Triggered Interrupt */
#define BCHP_LEAP_CPU_AUX_REGS_AUX_ALIGN_CTRL    0x020c0808 /* [RW] Memory Alignment Detection Control */
#define BCHP_LEAP_CPU_AUX_REGS_AUX_ALIGN_ADDR    0x020c080c /* [RO] Memory Alignment Detected Address */
#define BCHP_LEAP_CPU_AUX_REGS_AUX_ALIGN_SIZE    0x020c0810 /* [RO] Memory Alignment Detected Size */
#define BCHP_LEAP_CPU_AUX_REGS_AUX_INTER_CORE_INTERRUPT 0x020c0a00 /* [RO] Inter-core Interrupt Register */
#define BCHP_LEAP_CPU_AUX_REGS_AX_IPC_SEM_N      0x020c0a04 /* [RO] Inter-core Sempahore Register */
#define BCHP_LEAP_CPU_AUX_REGS_AUX_INTER_CORE_ACK 0x020c0a08 /* [RO] Inter-core Interrupt Acknowledge Register */
#define BCHP_LEAP_CPU_AUX_REGS_ERET              0x020c1000 /* [RO] Exception Return Address */
#define BCHP_LEAP_CPU_AUX_REGS_ERBTA             0x020c1004 /* [RO] Exception Return Branch Target Address */
#define BCHP_LEAP_CPU_AUX_REGS_ERSTATUS          0x020c1008 /* [RO] Exception Return Status */
#define BCHP_LEAP_CPU_AUX_REGS_ECR               0x020c100c /* [RO] Exception Cause Register */
#define BCHP_LEAP_CPU_AUX_REGS_EFA               0x020c1010 /* [RO] Exception Fault Address */
#define BCHP_LEAP_CPU_AUX_REGS_ICAUSE1           0x020c1028 /* [RO] Level 1 Interrupt Cause Register */
#define BCHP_LEAP_CPU_AUX_REGS_ICAUSE2           0x020c102c /* [RO] Level 2 Interrupt Cause Register */
#define BCHP_LEAP_CPU_AUX_REGS_AUX_IENABLE       0x020c1030 /* [RO] Interrupt Mask Programming */
#define BCHP_LEAP_CPU_AUX_REGS_AUX_ITRIGGER      0x020c1034 /* [RO] Interrupt Sensitivity Programming */
#define BCHP_LEAP_CPU_AUX_REGS_BTA               0x020c1048 /* [RO] Branch Target Address */
#define BCHP_LEAP_CPU_AUX_REGS_BTA_L1            0x020c104c /* [RO] Level 1 Return Branch Target */
#define BCHP_LEAP_CPU_AUX_REGS_BTA_L2            0x020c1050 /* [RO] Level 2 Return Branch Target */
#define BCHP_LEAP_CPU_AUX_REGS_AUX_IRQ_PULSE_CANCEL 0x020c1054 /* [RO] Interrupt Pulse Cancel */
#define BCHP_LEAP_CPU_AUX_REGS_AUX_IRQ_PENDING   0x020c1058 /* [RO] Interrupt Pending Register */
