 ...
 *MISC - VEC Registers
 ***************************************************************************/
#define BCHP_MISC_MISC_REVISION_ID               0x006a0000 /* [RO] Revision ID Register */
#define BCHP_MISC_DAC_0_CFG                      0x006a0004 /* [RW] Config register for DAC_0 */
#define BCHP_MISC_SYNC_0_CFG                     0x006a0008 /* [RW] Config Register for Sync Port 0 */
#define BCHP_MISC_RFM_0_CFG                      0x006a000c /* [RW] Config Register for RF Port 0 */
#define BCHP_MISC_RFM_0_SYNC_0_CFG               0x006a0010 /* [RW] Sync Config Register 0 for RF Port 0 */
#define BCHP_MISC_IT_0_MASTER_SEL                0x006a0014 /* [RW] Master Select for IT_0 */
#define BCHP_MISC_IT_1_MASTER_SEL                0x006a0018 /* [RW] Master Select for IT_1 */
#define BCHP_MISC_DVI_DTG_0_MASTER_SEL           0x006a001c /* [RW] Master Select for DVI DTG_0 */
#define BCHP_MISC_DVI_DTG_1_MASTER_SEL           0x006a0020 /* [RW] Master Select for DVI DTG_1 */
#define BCHP_MISC_ITU656_DTG_0_MASTER_SEL        0x006a0024 /* [RW] Master Select for 656 DTG_0 */
#define BCHP_MISC_DVI_0_SA_CONFIG                0x006a0028 /* [RW] SA config for DVI_0 */
#define BCHP_MISC_DVI_0_SA_CH0_STATUS            0x006a002c /* [RO] SA status for channel 0 for DVI_0 */
#define BCHP_MISC_DVI_0_SA_CH1_STATUS            0x006a0030 /* [RO] SA status for channel 1 for DVI_0 */
#define BCHP_MISC_DVI_0_SA_CH2_STATUS            0x006a0034 /* [RO] SA status for channel 2 for DVI_0 */
#define BCHP_MISC_DVI_1_SA_CONFIG                0x006a0038 /* [RW] SA config for DVI_1 */
#define BCHP_MISC_DVI_1_SA_CH0_STATUS            0x006a003c /* [RO] SA status for channel 0 for DVI_1 */
#define BCHP_MISC_DVI_1_SA_CH1_STATUS            0x006a0040 /* [RO] SA status for channel 1 for DVI_1 */
#define BCHP_MISC_DVI_1_SA_CH2_STATUS            0x006a0044 /* [RO] SA status for channel 2 for DVI_1 */
#define BCHP_MISC_ADC_CTRL_0                     0x006a0048 /* [RW] ADC control register for DAC0 */
#define BCHP_MISC_DAC_INST_BIAS_CTRL_0           0x006a004c /* [RW] DAC bais control register for QDAC0 */
#define BCHP_MISC_DAC_0_CTRL                     0x006a0050 /* [RW] DAC control register for DAC 0 */
#define BCHP_MISC_DAC_0_SCALE_CTRL               0x006a0054 /* [RW] DAC Scale control register for DAC 0 */
#define BCHP_MISC_DAC_CAL_CTRL_0                 0x006a0058 /* [RW] DAC calibration control register for DAC0 */
#define BCHP_MISC_DAC_CAL_ADC_DATA_0             0x006a005c /* [RW] DAC calibration cal ADC data register for DAC0 */
#define BCHP_MISC_DAC_ADC_DATA_0                 0x006a0060 /* [RW] DAC calibration adc data register for DAC0 */
#define BCHP_MISC_DAC_DETECT_CTRL_0              0x006a0064 /* [RW] DAC CABLE DETECT control register for DAC0 */
#define BCHP_MISC_DAC_DETECT_EN_0                0x006a0068 /* [RW] DAC CABLE DETECT Enable register for DAC0 */
#define BCHP_MISC_DAC_DETECT_SYNC_CTRL_0         0x006a006c /* [RW] DAC sync present register */
#define BCHP_MISC_DAC_SQWAVE_LEVEL_0             0x006a0070 /* [RW] Square Wave levels for cable detect */
#define BCHP_MISC_DAC_DETECT_TIMING_0            0x006a0074 /* [RW] Cable Detect timing control register */
#define BCHP_MISC_DAC_CABLE_STATUS_0             0x006a0078 /* [RW] DAC cable connect status */
#define BCHP_MISC_DAC_CABLE_DETECT_DEBUG_0       0x006a007c /* [RO] Dac Cable detect debug register */
#define BCHP_MISC_DAC_CABLE_RECALIBRATE_0        0x006a0080 /* [RW] DAC cable recalibrate for dac instance 0 */
#define BCHP_MISC_DAC_CRC_CTRL                   0x006a0084 /* [RW] Dac CRC control register */
#define BCHP_MISC_DAC_CRC_VALUE                  0x006a0088 /* [RW] DAC CRC value register */
#define BCHP_MISC_VEC_CRC_VALUE                  0x006a008c /* [RW] VEC CRC value register */
#define BCHP_MISC_DAC_CRC_STATUS                 0x006a0090 /* [RW] DAC CRC status register */
#define BCHP_MISC_ADC_RESET_DEASSERT_DELAY       0x006a0094 /* [RW] ADC RESET DEASSERTION delay register */
