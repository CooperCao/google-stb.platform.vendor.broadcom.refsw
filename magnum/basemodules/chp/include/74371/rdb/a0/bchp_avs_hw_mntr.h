...
#define BCHP_AVS_HW_MNTR_MEASUREMENTS_INIT_RMT_ROSC_0 0x004d2014 /* [RW] Software to reset the remote roscs measurements' valid bits in RO registers */
#define BCHP_AVS_HW_MNTR_MEASUREMENTS_INIT_RMT_ROSC_1 0x004d2018 /* [RW] Software to reset the remote roscs measurements' valid bits in RO registers */
...
#define BCHP_AVS_HW_MNTR_SEQUENCER_MASK_RMT_ROSC_0 0x004d2048 /* [RW] Indicate which remote ring oscillators should  be masked(skipped) in the measurement sequence */
#define BCHP_AVS_HW_MNTR_SEQUENCER_MASK_RMT_ROSC_1 0x004d204c /* [RW] Indicate which remote ring oscillators should  be masked(skipped) in the measurement sequence */
...
#define BCHP_AVS_HW_MNTR_REMOTE_SENSOR_TYPE      0x004d209c /* [RW] Identify the technology type (8T or 10T) of ring oscillators used in AVS remote sensors */
