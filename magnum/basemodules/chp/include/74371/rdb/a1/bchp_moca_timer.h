 ...
 ***************************************************************************/
#define BCHP_MOCA_TIMER_TMR_VALUE_0              0x00ffe400 /* [RO] Timer Up Counter State , register set index 0. */
#define BCHP_MOCA_TIMER_REFERENCE_0              0x00ffe404 /* [RW] reference value for one shot and periodic mode , register set index 0. */
#define BCHP_MOCA_TIMER_CTRL_0                   0x00ffe408 /* [RW] Contains the control bits of the counter , register set index 0. */
#define BCHP_MOCA_TIMER_RESTART_0                0x00ffe40c /* [WO] Restart the counter , register set index 0. */
#define BCHP_MOCA_TIMER_TMR_VALUE_1              0x00ffe420 /* [RO] Timer Up Counter State , register set index 1. */
#define BCHP_MOCA_TIMER_REFERENCE_1              0x00ffe424 /* [RW] reference value for one shot and periodic mode , register set index 1. */
#define BCHP_MOCA_TIMER_CTRL_1                   0x00ffe428 /* [RW] Contains the control bits of the counter , register set index 1. */
#define BCHP_MOCA_TIMER_RESTART_1                0x00ffe42c /* [WO] Restart the counter , register set index 1. */
#define BCHP_MOCA_TIMER_TMR_VALUE_2              0x00ffe440 /* [RO] Timer Up Counter State , register set index 2. */
#define BCHP_MOCA_TIMER_REFERENCE_2              0x00ffe444 /* [RW] reference value for one shot and periodic mode , register set index 2. */
#define BCHP_MOCA_TIMER_CTRL_2                   0x00ffe448 /* [RW] Contains the control bits of the counter , register set index 2. */
#define BCHP_MOCA_TIMER_RESTART_2                0x00ffe44c /* [WO] Restart the counter , register set index 2. */
#define BCHP_MOCA_TIMER_TMR_VALUE_3              0x00ffe460 /* [RO] Timer Up Counter State , register set index 3. */
#define BCHP_MOCA_TIMER_REFERENCE_3              0x00ffe464 /* [RW] reference value for one shot and periodic mode , register set index 3. */
#define BCHP_MOCA_TIMER_CTRL_3                   0x00ffe468 /* [RW] Contains the control bits of the counter , register set index 3. */
#define BCHP_MOCA_TIMER_RESTART_3                0x00ffe46c /* [WO] Restart the counter , register set index 3. */
#define BCHP_MOCA_TIMER_TMR_VALUE_4              0x00ffe480 /* [RO] Timer Up Counter State , register set index 4. */
#define BCHP_MOCA_TIMER_REFERENCE_4              0x00ffe484 /* [RW] reference value for one shot and periodic mode , register set index 4. */
#define BCHP_MOCA_TIMER_CTRL_4                   0x00ffe488 /* [RW] Contains the control bits of the counter , register set index 4. */
#define BCHP_MOCA_TIMER_RESTART_4                0x00ffe48c /* [WO] Restart the counter , register set index 4. */
#define BCHP_MOCA_TIMER_TMR_VALUE_5              0x00ffe4a0 /* [RO] Timer Up Counter State , register set index 5. */
#define BCHP_MOCA_TIMER_REFERENCE_5              0x00ffe4a4 /* [RW] reference value for one shot and periodic mode , register set index 5. */
#define BCHP_MOCA_TIMER_CTRL_5                   0x00ffe4a8 /* [RW] Contains the control bits of the counter , register set index 5. */
#define BCHP_MOCA_TIMER_RESTART_5                0x00ffe4ac /* [WO] Restart the counter , register set index 5. */
#define BCHP_MOCA_TIMER_TMR_VALUE_6              0x00ffe4c0 /* [RO] Timer Up Counter State , register set index 6. */
#define BCHP_MOCA_TIMER_REFERENCE_6              0x00ffe4c4 /* [RW] reference value for one shot and periodic mode , register set index 6. */
#define BCHP_MOCA_TIMER_CTRL_6                   0x00ffe4c8 /* [RW] Contains the control bits of the counter , register set index 6. */
#define BCHP_MOCA_TIMER_RESTART_6                0x00ffe4cc /* [WO] Restart the counter , register set index 6. */
#define BCHP_MOCA_TIMER_TMR_VALUE_7              0x00ffe4e0 /* [RO] Timer Up Counter State , register set index 7. */
#define BCHP_MOCA_TIMER_REFERENCE_7              0x00ffe4e4 /* [RW] reference value for one shot and periodic mode , register set index 7. */
#define BCHP_MOCA_TIMER_CTRL_7                   0x00ffe4e8 /* [RW] Contains the control bits of the counter , register set index 7. */
#define BCHP_MOCA_TIMER_RESTART_7                0x00ffe4ec /* [WO] Restart the counter , register set index 7. */
