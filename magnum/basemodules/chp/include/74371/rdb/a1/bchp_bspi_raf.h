 ...
 ***************************************************************************/
#define BCHP_BSPI_RAF_START_ADDR                 0x00443300 /* [RW] Physical Starting Address Location in Flash device */
#define BCHP_BSPI_RAF_NUM_WORDS                  0x00443304 /* [RW] Number of Words to be fetched */
#define BCHP_BSPI_RAF_CTRL                       0x00443308 /* [RW] RAF Session Control Register */
#define BCHP_BSPI_RAF_FULLNESS                   0x0044330c /* [RO] Fullness indicator for the read ahead buffer */
#define BCHP_BSPI_RAF_WATERMARK                  0x00443310 /* [RW] Watermark level in the read ahead buffer that triggers an interrupt */
#define BCHP_BSPI_RAF_STATUS                     0x00443314 /* [RO] Linear Read Status Register */
#define BCHP_BSPI_RAF_READ_DATA                  0x00443318 /* [RO] Read data from Raf-buffer */
#define BCHP_BSPI_RAF_WORD_CNT                   0x0044331c /* [RO] Current number of words fetched from Flash */
#define BCHP_BSPI_RAF_CURR_ADDR                  0x00443320 /* [RO] Current read address for the linear read session */
