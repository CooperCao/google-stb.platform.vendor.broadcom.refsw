 ...
 ***************************************************************************/
#define BCHP_AVS_BSTI_BSTI_CMD_ADDR_WDATA        0x04811400 /* [RW][32] Dedicate to issue BSTI commands which includes access type, address and write data. (NOTE: A write to the register will trigger a transaction on the BSTI) */
#define BCHP_AVS_BSTI_BSTI_STATUS_RDATA          0x04811404 /* [RO][32] Indicate the status of BSTI and read data */
