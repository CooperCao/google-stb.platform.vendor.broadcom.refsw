 ...
 ***************************************************************************/
#define BCHP_LEAP_CPU_AUX_REGS_STATUS            0x000e0000 /* [RO][32] Auxiliary Register STATUS */
#define BCHP_LEAP_CPU_AUX_REGS_SEMAPHORE         0x000e0004 /* [RW][32] Inter-process/Host semaphore register */
#define BCHP_LEAP_CPU_AUX_REGS_LP_START          0x000e0008 /* [RW][32] Loop start address (32-bit) */
#define BCHP_LEAP_CPU_AUX_REGS_LP_END            0x000e000c /* [RW][32] Loop end address (32-bit) */
#define BCHP_LEAP_CPU_AUX_REGS_IDENTITY          0x000e0010 /* [RO][32] Processor Identification register */
#define BCHP_LEAP_CPU_AUX_REGS_DEBUG             0x000e0014 /* [RW][32] Debug register */
#define BCHP_LEAP_CPU_AUX_REGS_PC                0x000e0018 /* [RO][32] Program Counter register (32-bit) */
#define BCHP_LEAP_CPU_AUX_REGS_STATUS32          0x000e0028 /* [RO][32] Status register (32-bit) */
#define BCHP_LEAP_CPU_AUX_REGS_STATUS32_L1       0x000e002c /* [RW][32] Status register save for level 1 interrupts */
#define BCHP_LEAP_CPU_AUX_REGS_STATUS32_L2       0x000e0030 /* [RW][32] Status register save for level 2 interrupts */
#define BCHP_LEAP_CPU_AUX_REGS_IC_IVIC           0x000e0040 /* [WO][32] Invalidate cache */
#define BCHP_LEAP_CPU_AUX_REGS_IC_CTRL           0x000e0044 /* [RW][32] Cache Control Register */
#define BCHP_LEAP_CPU_AUX_REGS_IC_LIL            0x000e004c /* [WO][32] Lock instruction line */
#define BCHP_LEAP_CPU_AUX_REGS_AUX_DCCM          0x000e0060 /* [WO][32] Address of Local RAM */
#define BCHP_LEAP_CPU_AUX_REGS_IC_IVIL           0x000e0064 /* [WO][32] Invalidate instruction line */
#define BCHP_LEAP_CPU_AUX_REGS_TIMER0_COUNT      0x000e0084 /* [RW][32] Processor Timer0 Control value */
#define BCHP_LEAP_CPU_AUX_REGS_TIMER0_CONTROL    0x000e0088 /* [RW][32] Processor Timer0 Count value */
#define BCHP_LEAP_CPU_AUX_REGS_TIMER0_LIMIT      0x000e008c /* [RW][32] Processor Timer0 Limit value */
#define BCHP_LEAP_CPU_AUX_REGS_INT_VEC_BASE      0x000e0094 /* [RW][32] Interrupt Vector Base address */
#define BCHP_LEAP_CPU_AUX_REGS_AUX_IRQ_LV12      0x000e010c /* [RW][32] Interrupt Level Status */
#define BCHP_LEAP_CPU_AUX_REGS_DC_IVDC           0x000e011c /* [WO][32] Invalidate cache */
#define BCHP_LEAP_CPU_AUX_REGS_DC_CTRL           0x000e0120 /* [RW][32] Cache Control register */
#define BCHP_LEAP_CPU_AUX_REGS_DC_LDL            0x000e0124 /* [RW][32] Lock data line at this address */
#define BCHP_LEAP_CPU_AUX_REGS_DC_IVDL           0x000e0128 /* [RW][32] Invalidate data line */
#define BCHP_LEAP_CPU_AUX_REGS_DC_FLSH           0x000e012c /* [RW][32] Flush data cache */
#define BCHP_LEAP_CPU_AUX_REGS_DC_FLDL           0x000e0130 /* [RW][32] Flush data line */
#define BCHP_LEAP_CPU_AUX_REGS_DC_RAM_ADDR       0x000e0160 /* [RW][32] External Address RAM address */
#define BCHP_LEAP_CPU_AUX_REGS_DC_TAG            0x000e0164 /* [RW][32] Tag Access */
#define BCHP_LEAP_CPU_AUX_REGS_DC_WP             0x000e0168 /* [RW][32] Way Pointer Access */
#define BCHP_LEAP_CPU_AUX_REGS_DC_DATA           0x000e016c /* [RW][32] Data Accesse */
#define BCHP_LEAP_CPU_AUX_REGS_CRC_BUILD_BCR     0x000e0188 /* [RO][32] Build configuration register for CRC instruction. */
#define BCHP_LEAP_CPU_AUX_REGS_DVBF_BUILD        0x000e0190 /* [RO][32] Build configuration register for dual viterbi butterfly instruction. */
#define BCHP_LEAP_CPU_AUX_REGS_EXT_ARITH_BUILD   0x000e0194 /* [RO][32] Build configuration register to specify that the processor has the extended arithmetic instructions. */
#define BCHP_LEAP_CPU_AUX_REGS_DATASPACE         0x000e0198 /* [RO][32] Build configuration register for dataspace. */
#define BCHP_LEAP_CPU_AUX_REGS_MEMSUBSYS         0x000e019c /* [RO][32] Build configuration register for memory subsytem. */
#define BCHP_LEAP_CPU_AUX_REGS_VECBASE_AC_BUILD  0x000e01a0 /* [RO][32] Build configuration register for ARC600 interrupt vector base address. */
#define BCHP_LEAP_CPU_AUX_REGS_P_BASE_ADDR       0x000e01a4 /* [RO][32] Build configuration register for peripheral base address. */
#define BCHP_LEAP_CPU_AUX_REGS_MPU_BUILD         0x000e01b4 /* [RO][32] Build configuration register for memory protection unit. */
#define BCHP_LEAP_CPU_AUX_REGS_RF_BUILD          0x000e01b8 /* [RO][32] Build configuration register for register file. */
#define BCHP_LEAP_CPU_AUX_REGS_D_CACHE_BUILD     0x000e01c8 /* [RO][32] Build configuration register for data cache. */
#define BCHP_LEAP_CPU_AUX_REGS_MADI_BUILD        0x000e01cc /* [RO][32] Build configuration register for multiple ARC debug interface. */
#define BCHP_LEAP_CPU_AUX_REGS_DCCM_BUILD        0x000e01d0 /* [RO][32] Build configuration register for data closely coupled memory. */
#define BCHP_LEAP_CPU_AUX_REGS_TIMER_BUILD       0x000e01d4 /* [RO][32] Build configuration register for timers. */
#define BCHP_LEAP_CPU_AUX_REGS_AP_BUILD          0x000e01d8 /* [RO][32] Build configuration register for actionpoints. */
#define BCHP_LEAP_CPU_AUX_REGS_I_CACHE_BUILD     0x000e01dc /* [RO][32] Build configuration register for instruction cache. */
#define BCHP_LEAP_CPU_AUX_REGS_ICCM_BUILD        0x000e01e0 /* [RO][32] Build configuration register for instruction closely coupled memory. */
#define BCHP_LEAP_CPU_AUX_REGS_DSPRAM_BUILD      0x000e01e4 /* [RO][32] Build configuration register for XY memory. */
#define BCHP_LEAP_CPU_AUX_REGS_MAC_BUILD         0x000e01e8 /* [RO][32] Build configuration register for Xmac. */
#define BCHP_LEAP_CPU_AUX_REGS_MULTIPLY_BUILD    0x000e01ec /* [RO][32] Build configuration register for instruction closely coupled memory. */
#define BCHP_LEAP_CPU_AUX_REGS_SWAP_BUILD        0x000e01f0 /* [RO][32] Build configuration register for swap instruction. */
#define BCHP_LEAP_CPU_AUX_REGS_NORM_BUILD        0x000e01f4 /* [RO][32] Build configuration register for normalise instruction. */
#define BCHP_LEAP_CPU_AUX_REGS_MINMAX_BUILD      0x000e01f8 /* [RO][32] Build configuration register for min/max instruction. */
#define BCHP_LEAP_CPU_AUX_REGS_BARREL_BUILD      0x000e01fc /* [RO][32] Build configuration register for barrel shifter. */
#define BCHP_LEAP_CPU_AUX_REGS_ARC600_BUILD      0x000e0304 /* [RO][32] Build configuration register for ARC 600. */
#define BCHP_LEAP_CPU_AUX_REGS_AUX_SYSTEM_BUILD  0x000e0308 /* [RW][32] Build configuration register for AS221BD. */
#define BCHP_LEAP_CPU_AUX_REGS_MCD_BCR           0x000e0310 /* [RO][32] MCD configuration register for AS221BD. */
#define BCHP_LEAP_CPU_AUX_REGS_IFETCHQUEUE_BUILD 0x000e03f8 /* [RO][32] Build configuration register for the InstructionFetchQueue component. */
#define BCHP_LEAP_CPU_AUX_REGS_TIMER1_COUNT      0x000e0400 /* [RW][32] Processor Timer 1 Control value */
#define BCHP_LEAP_CPU_AUX_REGS_TIMER1_CONTROL    0x000e0404 /* [RW][32] Processor Timer 1 Count value */
#define BCHP_LEAP_CPU_AUX_REGS_TIMER1_LIMIT      0x000e0408 /* [RW][32] Processor Timer 1 Limit value */
#define BCHP_LEAP_CPU_AUX_REGS_AUX_IRQ_LEV       0x000e0800 /* [RW][32] Interrupt Level Programming */
#define BCHP_LEAP_CPU_AUX_REGS_AUX_IRQ_HINT      0x000e0804 /* [RW][32] Software Triggered Interrupt */
#define BCHP_LEAP_CPU_AUX_REGS_AUX_ALIGN_CTRL    0x000e0808 /* [RW][32] Memory Alignment Detection Control */
#define BCHP_LEAP_CPU_AUX_REGS_AUX_ALIGN_ADDR    0x000e080c /* [RO][32] Memory Alignment Detected Address */
#define BCHP_LEAP_CPU_AUX_REGS_AUX_ALIGN_SIZE    0x000e0810 /* [RO][32] Memory Alignment Detected Size */
#define BCHP_LEAP_CPU_AUX_REGS_AUX_INTER_CORE_INTERRUPT 0x000e0a00 /* [RO][32] Inter-core Interrupt Register */
#define BCHP_LEAP_CPU_AUX_REGS_AX_IPC_SEM_N      0x000e0a04 /* [RO][32] Inter-core Sempahore Register */
#define BCHP_LEAP_CPU_AUX_REGS_AUX_INTER_CORE_ACK 0x000e0a08 /* [RO][32] Inter-core Interrupt Acknowledge Register */
#define BCHP_LEAP_CPU_AUX_REGS_MPUEN             0x000e1024 /* [RW][32] MPU Enable */
#define BCHP_LEAP_CPU_AUX_REGS_MPUIC             0x000e1080 /* [RO][32] MPU Interrupt Cause */
#define BCHP_LEAP_CPU_AUX_REGS_MPUFA             0x000e1084 /* [RO][32] MPU Fault Address */
#define BCHP_LEAP_CPU_AUX_REGS_MPURDB0           0x000e1088 /* [RW][32] MPU Region Descriptor Base 0 */
#define BCHP_LEAP_CPU_AUX_REGS_MPURDP0           0x000e108c /* [RW][32] MPU Region Descriptor Permissions 0 */
#define BCHP_LEAP_CPU_AUX_REGS_MPURDB1           0x000e1090 /* [RW][32] MPU Region Descriptor Base 1 */
#define BCHP_LEAP_CPU_AUX_REGS_MPURDP1           0x000e1094 /* [RW][32] MPU Region Descriptor Permissions 1 */
#define BCHP_LEAP_CPU_AUX_REGS_MPURDB2           0x000e1098 /* [RW][32] MPU Region Descriptor Base 2 */
#define BCHP_LEAP_CPU_AUX_REGS_MPURDP2           0x000e109c /* [RW][32] MPU Region Descriptor Permissions 2 */
#define BCHP_LEAP_CPU_AUX_REGS_MPURDB3           0x000e10a0 /* [RW][32] MPU Region Descriptor Base 3 */
#define BCHP_LEAP_CPU_AUX_REGS_MPURDP3           0x000e10a4 /* [RW][32] MPU Region Descriptor Permissions 3 */
#define BCHP_LEAP_CPU_AUX_REGS_MPURDB4           0x000e10a8 /* [RW][32] MPU Region Descriptor Base 4 */
#define BCHP_LEAP_CPU_AUX_REGS_MPURDP4           0x000e10ac /* [RW][32] MPU Region Descriptor Permissions 4 */
#define BCHP_LEAP_CPU_AUX_REGS_MPURDB5           0x000e10b0 /* [RW][32] MPU Region Descriptor Base 5 */
#define BCHP_LEAP_CPU_AUX_REGS_MPURDP5           0x000e10b4 /* [RW][32] MPU Region Descriptor Permissions 5 */
#define BCHP_LEAP_CPU_AUX_REGS_MPURDB6           0x000e10b8 /* [RW][32] MPU Region Descriptor Base 6 */
#define BCHP_LEAP_CPU_AUX_REGS_MPURDP6           0x000e10bc /* [RW][32] MPU Region Descriptor Permissions 6 */
#define BCHP_LEAP_CPU_AUX_REGS_MPURDB7           0x000e10c0 /* [RW][32] MPU Region Descriptor Base 7 */
#define BCHP_LEAP_CPU_AUX_REGS_MPURDP7           0x000e10c4 /* [RW][32] MPU Region Descriptor Permissions 7 */
