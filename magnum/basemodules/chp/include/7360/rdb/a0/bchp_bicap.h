 ...
 ***************************************************************************/
#define BCHP_BICAP_REVISION                      0x00408e00 /* BICAP Revision */
#define BCHP_BICAP_CONTROL0                      0x00408e04 /* BICAP CONTROL FOR INPUT 0 */
#define BCHP_BICAP_CONTROL1                      0x00408e08 /* BICAP CONTROL FOR INPUT 1 */
#define BCHP_BICAP_FILTER0                       0x00408e0c /* BICAP FILTER REGISTER FOR INPUT 0 */
#define BCHP_BICAP_FILTER1                       0x00408e10 /* BICAP FILTER REGISTER FOR INPUT 1 */
#define BCHP_BICAP_TIMEOUT0                      0x00408e14 /* TIMEOUT REGISTER 0 (Timeout Code: 0xFFF) */
#define BCHP_BICAP_TIMEOUT1                      0x00408e18 /* TIMEOUT REGISTER 1 (Timeout Code: 0xFFE) */
#define BCHP_BICAP_TIMEOUT2                      0x00408e1c /* TIMEOUT REGISTER 2 (Timeout Code: 0xFFD) */
#define BCHP_BICAP_TIMEOUT3                      0x00408e20 /* TIMEOUT REGISTER 3 (Timeout Code: 0xFFC) */
#define BCHP_BICAP_FIFO_INACT_TIMEOUT            0x00408e24 /* FIFO INACTIVITY TIMEOUT REGISTER */
#define BCHP_BICAP_FIFO_DATA                     0x00408e28 /* BICAP FIFO DATA REGISTER */
#define BCHP_BICAP_FIFO_CONTROL                  0x00408e2c /* BICAP FIFO CONTROL */
#define BCHP_BICAP_STATUS                        0x00408e30 /* BICAP FIFO and TIMEOUT STATUS */
#define BCHP_BICAP_PWC0                          0x00408e34 /* BICAP PULSE WIDTH COUNTER VALUE FOR INPUT 0 */
#define BCHP_BICAP_PWC1                          0x00408e38 /* BICAP PULSE WIDTH COUNTER VALUE FOR INPUT 1 */
