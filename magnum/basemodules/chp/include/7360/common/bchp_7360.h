 ...
 * 
 ***************************************************************************/
#ifndef BCHP_7360_H__
#define BCHP_7360_H__
...
/***************************************************************************
Summary:
    Open a chip handle for Bcm7360 chip

Description:
    This function open a chip handle for Bcm7360 chip.

Input:
    hRegister - A valid Bcm7360 register handle previous open using BREG_Open.
