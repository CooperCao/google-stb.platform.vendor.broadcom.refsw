...
#ifndef BCHP_7278_H__
#define BCHP_7278_H__
...
/***************************************************************************
Summary:
    Open a chip handle for Bcm7278 chip

Description:
    This function open a chip handle for Bcm7278 chip.

Input:
    hRegister - A valid Bcm7278 register handle previous open using BREG_Open.
