 ...
 ***************************************************************************/
#define BCHP_RAAGA_DSP_FP_MISC_1_INTERRUPT_IRQ_STATUS 0x01034300 /* [RO][32] External interrupt request status */
#define BCHP_RAAGA_DSP_FP_MISC_1_INTERRUPT_IRQ_SET 0x01034304 /* [WO][32] External interrupt request set */
#define BCHP_RAAGA_DSP_FP_MISC_1_INTERRUPT_IRQ_CLEAR 0x01034308 /* [WO][32] External interrupt request clear */
#define BCHP_RAAGA_DSP_FP_MISC_1_INTERRUPT_SRQ_STATUS 0x01034310 /* [RO][32] External super interrupt request status */
#define BCHP_RAAGA_DSP_FP_MISC_1_INTERRUPT_SRQ_SET 0x01034314 /* [WO][32] External super interrupt request set */
#define BCHP_RAAGA_DSP_FP_MISC_1_INTERRUPT_SRQ_CLEAR 0x01034318 /* [WO][32] External super interrupt request clear */
#define BCHP_RAAGA_DSP_FP_MISC_1_INTERRUPT_DRQ_STATUS 0x01034320 /* [RO][32] External debug request status */
#define BCHP_RAAGA_DSP_FP_MISC_1_INTERRUPT_DRQ_SET 0x01034324 /* [WO][32] External debub request set */
#define BCHP_RAAGA_DSP_FP_MISC_1_INTERRUPT_DRQ_CLEAR 0x01034328 /* [WO][32] External debug request clear */
#define BCHP_RAAGA_DSP_FP_MISC_1_INTERRUPT_FRQ_STATUS 0x01034330 /* [RO][32] External fatal request status */
#define BCHP_RAAGA_DSP_FP_MISC_1_INTERRUPT_FRQ_SET 0x01034334 /* [WO][32] External fatal request set */
#define BCHP_RAAGA_DSP_FP_MISC_1_INTERRUPT_FRQ_CLEAR 0x01034338 /* [WO][32] External fatal request clear */
#define BCHP_RAAGA_DSP_FP_MISC_1_INTERRUPT_HOST_IRQ_LATCHED 0x01034340 /* [RO][32] Host interrupt request status */
#define BCHP_RAAGA_DSP_FP_MISC_1_INTERRUPT_HOST_IRQ_SET 0x01034344 /* [WO][32] Host interrupt request set */
#define BCHP_RAAGA_DSP_FP_MISC_1_INTERRUPT_HOST_IRQ_CLEAR 0x01034348 /* [WO][32] Host interrupt request clear */
#define BCHP_RAAGA_DSP_FP_MISC_1_INTERRUPT_HOST_IRQ_ENABLE 0x0103434c /* [CFG][32] Host interrupt enable */
#define BCHP_RAAGA_DSP_FP_MISC_1_INTERRUPT_OBUSFAULT_STATUS 0x01034350 /* [RO][32] OBUS fault status */
#define BCHP_RAAGA_DSP_FP_MISC_1_INTERRUPT_OBUSFAULT_CLEAR 0x01034354 /* [WO][32] OBUS fault clear */
#define BCHP_RAAGA_DSP_FP_MISC_1_INTERRUPT_OBUSFAULT_ADDRESS 0x01034358 /* [RO][32] OBUS fault address */
