...
#define BCHP_HD_ANR_AND_0_AND_ENABLE             0x00089808 /* [CFG][32] AND Enable */
#define BCHP_HD_ANR_AND_0_AND_MODE               0x0008980c /* [CFG][32] AND Window Size */
#define BCHP_HD_ANR_AND_0_NOISE_LOWER_TH_0       0x00089810 /* [CFG][32] Noise Range Lower Threshold 0 */
#define BCHP_HD_ANR_AND_0_NOISE_LOWER_TH_1       0x00089814 /* [CFG][32] Noise Range Lower Threshold 1 */
#define BCHP_HD_ANR_AND_0_NOISE_LOWER_TH_2       0x00089818 /* [CFG][32] Noise Range Lower Threshold 2 */
#define BCHP_HD_ANR_AND_0_NOISE_LOWER_TH_3       0x0008981c /* [CFG][32] Noise Range Lower Threshold 3 */
#define BCHP_HD_ANR_AND_0_NOISE_LOWER_TH_4       0x00089820 /* [CFG][32] Noise Range Lower Threshold 4 */
#define BCHP_HD_ANR_AND_0_NOISE_UPPER_TH_0       0x00089824 /* [CFG][32] Noise Range upper Threshold 0 */
#define BCHP_HD_ANR_AND_0_NOISE_UPPER_TH_1       0x00089828 /* [CFG][32] Noise Range upper Threshold 1 */
#define BCHP_HD_ANR_AND_0_NOISE_UPPER_TH_2       0x0008982c /* [CFG][32] Noise Range upper Threshold 2 */
#define BCHP_HD_ANR_AND_0_NOISE_UPPER_TH_3       0x00089830 /* [CFG][32] Noise Range upper Threshold 3 */
#define BCHP_HD_ANR_AND_0_NOISE_UPPER_TH_4       0x00089834 /* [CFG][32] Noise Range upper Threshold 4 */
#define BCHP_HD_ANR_AND_0_EDGE_TH                0x00089838 /* [CFG][32] Edge gradient threshold */
#define BCHP_HD_ANR_AND_0_CONTENT_TH             0x0008983c /* [CFG][32] Content level threshold */
#define BCHP_HD_ANR_AND_0_NOISY_SAMPLE_NUM_BIN_0 0x00089840 /* [RO][32] Number of noisy pixel in frame for noise level category 0 */
#define BCHP_HD_ANR_AND_0_NOISY_SAMPLE_NUM_BIN_1 0x00089844 /* [RO][32] Number of noisy pixel in frame for noise level category 1 */
#define BCHP_HD_ANR_AND_0_NOISY_SAMPLE_NUM_BIN_2 0x00089848 /* [RO][32] Number of noisy pixel in frame for noise level category 2 */
#define BCHP_HD_ANR_AND_0_NOISY_SAMPLE_NUM_BIN_3 0x0008984c /* [RO][32] Number of noisy pixel in frame for noise level category 3 */
#define BCHP_HD_ANR_AND_0_NOISY_SAMPLE_NUM_BIN_4 0x00089850 /* [RO][32] Number of noisy pixel in frame for noise level category 4 */
#define BCHP_HD_ANR_AND_0_NOISE_LEVEL_0_MSB      0x00089854 /* [RO][32] The means result of noise category 0 (MSB) */
#define BCHP_HD_ANR_AND_0_NOISE_LEVEL_0_LSB      0x00089858 /* [RO][32] The means result of noise category 0 (LSB) */
#define BCHP_HD_ANR_AND_0_NOISE_LEVEL_1_MSB      0x0008985c /* [RO][32] The means result of noise category 1 (MSB) */
#define BCHP_HD_ANR_AND_0_NOISE_LEVEL_1_LSB      0x00089860 /* [RO][32] The means result of noise category 1 (LSB) */
#define BCHP_HD_ANR_AND_0_NOISE_LEVEL_2_MSB      0x00089864 /* [RO][32] The means result of noise category 2 (MSB) */
#define BCHP_HD_ANR_AND_0_NOISE_LEVEL_2_LSB      0x00089868 /* [RO][32] The means result of noise category 2 (LSB) */
#define BCHP_HD_ANR_AND_0_NOISE_LEVEL_3_MSB      0x0008986c /* [RO][32] The means result of noise category 3 (MSB) */
#define BCHP_HD_ANR_AND_0_NOISE_LEVEL_3_LSB      0x00089870 /* [RO][32] The means result of noise category 3 (LSB) */
#define BCHP_HD_ANR_AND_0_NOISE_LEVEL_4_MSB      0x00089874 /* [RO][32] The means result of noise category 4 (MSB) */
#define BCHP_HD_ANR_AND_0_NOISE_LEVEL_4_LSB      0x00089878 /* [RO][32] The means result of noise category 4 (LSB) */
#define BCHP_HD_ANR_AND_0_X_LOWER_0              0x0008987c /* [CFG][32] The lower boundary for statistics collection at horizontal direction */
#define BCHP_HD_ANR_AND_0_X_UPPER_0              0x00089880 /* [CFG][32] The upper boundary for statistics collection at horizontal direction */
#define BCHP_HD_ANR_AND_0_Y_LOWER_0              0x00089884 /* [CFG][32] The lower boundary for statistics collection at vertical direction */
#define BCHP_HD_ANR_AND_0_Y_UPPER_0              0x00089888 /* [CFG][32] The upper boundary for statistics collection at vertical direction */
