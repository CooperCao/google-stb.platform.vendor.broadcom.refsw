...
#define BCHP_INT_ID_SPARE_WAKEUP_EVENT_16     BCHP_INT_ID_CREATE(BCHP_AON_PM_L2_CPU_STATUS, BCHP_AON_PM_L2_CPU_STATUS_SPARE_WAKEUP_EVENT_16_SHIFT)
#define BCHP_INT_ID_SPARE_WAKEUP_EVENT_7      BCHP_INT_ID_CREATE(BCHP_AON_PM_L2_CPU_STATUS, BCHP_AON_PM_L2_CPU_STATUS_SPARE_WAKEUP_EVENT_7_SHIFT)
#define BCHP_INT_ID_SPARE_WAKEUP_EVENT_9      BCHP_INT_ID_CREATE(BCHP_AON_PM_L2_CPU_STATUS, BCHP_AON_PM_L2_CPU_STATUS_SPARE_WAKEUP_EVENT_9_SHIFT)
...
#define BCHP_INT_ID_WOL_SYSTEMPORT_0          BCHP_INT_ID_CREATE(BCHP_AON_PM_L2_CPU_STATUS, BCHP_AON_PM_L2_CPU_STATUS_WOL_SYSTEMPORT_0_SHIFT)
#define BCHP_INT_ID_WOL_SYSTEMPORT_1          BCHP_INT_ID_CREATE(BCHP_AON_PM_L2_CPU_STATUS, BCHP_AON_PM_L2_CPU_STATUS_WOL_SYSTEMPORT_1_SHIFT)
