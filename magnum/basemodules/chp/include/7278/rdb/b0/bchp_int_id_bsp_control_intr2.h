...
#define BCHP_INT_ID_OLOAD1_INTR               BCHP_INT_ID_CREATE(BCHP_BSP_CONTROL_INTR2_CPU_STATUS, BCHP_BSP_CONTROL_INTR2_CPU_STATUS_OLOAD1_INTR_SHIFT)
#define BCHP_INT_ID_OLOAD2_INTR               BCHP_INT_ID_CREATE(BCHP_BSP_CONTROL_INTR2_CPU_STATUS, BCHP_BSP_CONTROL_INTR2_CPU_STATUS_OLOAD2_INTR_SHIFT)
#define BCHP_INT_ID_OLOAD_CR_INTR             BCHP_INT_ID_CREATE(BCHP_BSP_CONTROL_INTR2_CPU_STATUS, BCHP_BSP_CONTROL_INTR2_CPU_STATUS_OLOAD_CR_INTR_SHIFT)
