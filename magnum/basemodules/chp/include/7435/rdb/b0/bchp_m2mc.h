...
#define BCHP_M2MC_BLIT_SRC_ADDRESS               0x00be4020 /* Blit status source feeder current address */
#define BCHP_M2MC_BLIT_DEST_ADDRESS              0x00be4024 /* Blit status destination feeder current address */
#define BCHP_M2MC_BLIT_OUTPUT_ADDRESS            0x00be4028 /* Blit status output feeder current address */
#define BCHP_M2MC_BLIT_MEM_HI                    0x00be402c /* Blit memory protection address high */
#define BCHP_M2MC_BLIT_MEM_LO                    0x00be4030 /* Blit memory protection address low */
#define BCHP_M2MC_SCBADDRSEL                     0x00be4040 /* scb address map select register */
...
#define BCHP_M2MC_SRC_SURFACE_ADDR_0             0x00be4108 /* Source surface 0 address */
#define BCHP_M2MC_SRC_SURFACE_STRIDE_0           0x00be410c /* Source surface 0 STRIDE */
#define BCHP_M2MC_SRC_SURFACE_ADDR_1             0x00be4110 /* Source surface 1 address */
#define BCHP_M2MC_SRC_SURFACE_STRIDE_1           0x00be4114 /* Source surface 1 STRIDE */
#define BCHP_M2MC_SRC_SURFACE_0_FORMAT_DEF_1     0x00be4118 /* Source pixel format 1 for surface 0 */
#define BCHP_M2MC_SRC_SURFACE_0_FORMAT_DEF_2     0x00be411c /* Source pixel format 2 for surface 0 */
#define BCHP_M2MC_SRC_SURFACE_0_FORMAT_DEF_3     0x00be4120 /* Source pixel format 3 for surface 0 */
#define BCHP_M2MC_SRC_SURFACE_1_FORMAT_DEF_1     0x00be4124 /* Source pixel format 1 for surface 1 */
#define BCHP_M2MC_SRC_SURFACE_1_FORMAT_DEF_2     0x00be4128 /* Source pixel format 2 for surface 1 */
#define BCHP_M2MC_SRC_SURFACE_1_FORMAT_DEF_3     0x00be412c /* Source pixel format 3 for surface 1 */
#define BCHP_M2MC_SRC_W_ALPHA                    0x00be4130 /* Source Alpha W format */
#define BCHP_M2MC_SRC_CONSTANT_COLOR             0x00be4134 /* Source constant color */
#define BCHP_M2MC_DEST_FEEDER_ENABLE             0x00be4138 /* Destination plane enable */
#define BCHP_M2MC_DEST_SURFACE_ADDR_0            0x00be413c /* Destination surface 0 address */
#define BCHP_M2MC_DEST_SURFACE_STRIDE_0          0x00be4140 /* Destination surface 0 STRIDE */
#define BCHP_M2MC_DEST_SURFACE_ADDR_1            0x00be4144 /* Destination surface 1 address */
#define BCHP_M2MC_DEST_SURFACE_STRIDE_1          0x00be4148 /* Destination surface 1 STRIDE */
#define BCHP_M2MC_DEST_SURFACE_FORMAT_DEF_1      0x00be414c /* Destination pixel format 1 */
#define BCHP_M2MC_DEST_SURFACE_FORMAT_DEF_2      0x00be4150 /* Destination pixel format 2 */
#define BCHP_M2MC_DEST_SURFACE_FORMAT_DEF_3      0x00be4154 /* Destination pixel format 3 */
#define BCHP_M2MC_DEST_W_ALPHA                   0x00be4158 /* Destination Alpha W format */
#define BCHP_M2MC_DEST_CONSTANT_COLOR            0x00be415c /* Destination constant color */
#define BCHP_M2MC_OUTPUT_FEEDER_ENABLE           0x00be4160 /* Output plane enable */
#define BCHP_M2MC_OUTPUT_SURFACE_ADDR_0          0x00be4164 /* Output surface 0 address */
#define BCHP_M2MC_OUTPUT_SURFACE_STRIDE_0        0x00be4168 /* Output surface 0 STRIDE */
#define BCHP_M2MC_OUTPUT_SURFACE_ADDR_1          0x00be416c /* Output surface 1 address */
#define BCHP_M2MC_OUTPUT_SURFACE_STRIDE_1        0x00be4170 /* Output surface 1 STRIDE */
#define BCHP_M2MC_OUTPUT_SURFACE_FORMAT_DEF_1    0x00be4174 /* Output pixel format 1 */
#define BCHP_M2MC_OUTPUT_SURFACE_FORMAT_DEF_2    0x00be4178 /* Output pixel format 2 */
#define BCHP_M2MC_OUTPUT_SURFACE_FORMAT_DEF_3    0x00be417c /* Output pixel format 3 */
#define BCHP_M2MC_BLIT_HEADER                    0x00be4180 /* Blit header and control */
#define BCHP_M2MC_BLIT_SRC_TOP_LEFT_0            0x00be4184 /* Top left pixel coordinate in the Source surface 0. */
#define BCHP_M2MC_BLIT_SRC_SIZE_0                0x00be4188 /* Pixel width and height of operation in Source surface 0. */
#define BCHP_M2MC_BLIT_SRC_TOP_LEFT_1            0x00be418c /* Top left pixel coordinate in the Source surface 1. */
#define BCHP_M2MC_BLIT_SRC_SIZE_1                0x00be4190 /* Pixel width and height of operation in Source surface 1. */
#define BCHP_M2MC_BLIT_SRC_STRIPE_HEIGHT_WIDTH_0 0x00be4194 /* width and height of stripe for surface 0 for the decoded frame image format. */
#define BCHP_M2MC_BLIT_SRC_STRIPE_HEIGHT_WIDTH_1 0x00be4198 /* width and height of stripe for surface 1 for the decoded frame image format. */
#define BCHP_M2MC_BLIT_DEST_TOP_LEFT             0x00be419c /* Top left pixel coordinate in the Destination */
#define BCHP_M2MC_BLIT_DEST_SIZE                 0x00be41a0 /* Pixel width and height of operation in destination */
#define BCHP_M2MC_BLIT_OUTPUT_TOP_LEFT           0x00be41a4 /* Top left pixel coordinate in the Output */
#define BCHP_M2MC_BLIT_OUTPUT_SIZE               0x00be41a8 /* Pixel width and height of operation in the Output */
#define BCHP_M2MC_BLIT_INPUT_STRIPE_WIDTH_0      0x00be41ac /* Pixel width of input stripe when striping for surface 0 */
#define BCHP_M2MC_BLIT_INPUT_STRIPE_WIDTH_1      0x00be41b0 /* Pixel width of input stripe when striping for surface 1 */
#define BCHP_M2MC_BLIT_OUTPUT_STRIPE_WIDTH       0x00be41b4 /* Pixel width of output stripe when striping */
#define BCHP_M2MC_BLIT_STRIPE_OVERLAP_0          0x00be41b8 /* Pixel width of stripe overlap when striping for surface 0. */
#define BCHP_M2MC_BLIT_STRIPE_OVERLAP_1          0x00be41bc /* Pixel width of stripe overlap when striping for surface 1. */
#define BCHP_M2MC_BLIT_CTRL                      0x00be41c0 /* Blit control */
#define BCHP_M2MC_SCALER_CTRL                    0x00be41c4 /* Scaler control */
#define BCHP_M2MC_HORIZ_AVERAGER_COUNT           0x00be41c8 /* Horizontal averager control count */
#define BCHP_M2MC_HORIZ_AVERAGER_COEFF           0x00be41cc /* Horizontal averager control coefficient */
#define BCHP_M2MC_VERT_AVERAGER_COUNT            0x00be41d0 /* Vertical averager control count */
#define BCHP_M2MC_VERT_AVERAGER_COEFF            0x00be41d4 /* Vertical averager control coefficient */
#define BCHP_M2MC_HORIZ_SCALER_0_INITIAL_PHASE   0x00be41d8 /* Horizontal scaler 0 initial phase */
#define BCHP_M2MC_HORIZ_SCALER_0_STEP            0x00be41dc /* Horizontal scaler 0 step */
#define BCHP_M2MC_HORIZ_SCALER_1_INITIAL_PHASE   0x00be41e0 /* Horizontal scaler 1 initial phase */
#define BCHP_M2MC_HORIZ_SCALER_1_STEP            0x00be41e4 /* Horizontal scaler 1 step */
#define BCHP_M2MC_VERT_SCALER_0_INITIAL_PHASE    0x00be41e8 /* Vertical scaler 0 initial phase */
#define BCHP_M2MC_VERT_SCALER_0_STEP             0x00be41ec /* Vertical scaler 0 step */
#define BCHP_M2MC_VERT_SCALER_1_INITIAL_PHASE    0x00be41f0 /* Vertical scaler 1 initial phase */
#define BCHP_M2MC_VERT_SCALER_1_STEP             0x00be41f4 /* Vertical scaler 1 step */
#define BCHP_M2MC_BLEND_COLOR_OP                 0x00be41f8 /* Color blend operation descriptor */
#define BCHP_M2MC_BLEND_ALPHA_OP                 0x00be41fc /* Alpha blend operation descriptor */
#define BCHP_M2MC_BLEND_CONSTANT_COLOR           0x00be4200 /* Blend constant color */
#define BCHP_M2MC_BLEND_COLOR_KEY_ACTION         0x00be4204 /* Action color keyed samples take in blender */
#define BCHP_M2MC_ROP_OPERATION                  0x00be4208 /* Raster operation vector */
#define BCHP_M2MC_ROP_PATTERN_TOP                0x00be420c /* Top half of ROP pattern */
#define BCHP_M2MC_ROP_PATTERN_BOTTOM             0x00be4210 /* Bottom half of ROP pattern */
#define BCHP_M2MC_ROP_PATTERN_COLOR_0            0x00be4214 /* ROP Color for 0 */
#define BCHP_M2MC_ROP_PATTERN_COLOR_1            0x00be4218 /* ROP Color for 1 */
#define BCHP_M2MC_SRC_COLOR_KEY_HIGH             0x00be421c /* Source color key high */
#define BCHP_M2MC_SRC_COLOR_KEY_LOW              0x00be4220 /* Source color key low */
#define BCHP_M2MC_SRC_COLOR_KEY_MASK             0x00be4224 /* Source color key mask */
#define BCHP_M2MC_SRC_COLOR_KEY_REPLACEMENT      0x00be4228 /* Source color key replacement */
#define BCHP_M2MC_SRC_COLOR_KEY_REPLACEMENT_MASK 0x00be422c /* Source color key replacement mask */
#define BCHP_M2MC_DEST_COLOR_KEY_HIGH            0x00be4230 /* Destination color key high */
#define BCHP_M2MC_DEST_COLOR_KEY_LOW             0x00be4234 /* Destination color key low */
#define BCHP_M2MC_DEST_COLOR_KEY_MASK            0x00be4238 /* Destination color key mask */
#define BCHP_M2MC_DEST_COLOR_KEY_REPLACEMENT     0x00be423c /* Destination color key replacement */
#define BCHP_M2MC_DEST_COLOR_KEY_REPLACEMENT_MASK 0x00be4240 /* Destination color key replacement mask */
#define BCHP_M2MC_HORIZ_FIR_0_COEFF_PHASE0_01    0x00be4244 /* Horizontal Scaler 0 Poly-Phase Filter Phase 0 Coefficients */
#define BCHP_M2MC_HORIZ_FIR_0_COEFF_PHASE0_2     0x00be4248 /* Horizontal Scaler 0 Poly-Phase Filter Phase 0 Coefficients */
#define BCHP_M2MC_HORIZ_FIR_0_COEFF_PHASE1_01    0x00be424c /* Horizontal Scaler 0 Poly-Phase Filter Phase 1 Coefficients */
#define BCHP_M2MC_HORIZ_FIR_0_COEFF_PHASE1_2     0x00be4250 /* Horizontal Scaler 0 Poly-Phase Filter Phase 1 Coefficients */
#define BCHP_M2MC_HORIZ_FIR_1_COEFF_PHASE0_01    0x00be4254 /* Horizontal Scaler 1 Poly-Phase Filter Phase 0 Coefficients */
#define BCHP_M2MC_HORIZ_FIR_1_COEFF_PHASE0_2     0x00be4258 /* Horizontal Scaler 1 Poly-Phase Filter Phase 0 Coefficients */
#define BCHP_M2MC_HORIZ_FIR_1_COEFF_PHASE1_01    0x00be425c /* Horizontal Scaler 1 Poly-Phase Filter Phase 1 Coefficients */
#define BCHP_M2MC_HORIZ_FIR_1_COEFF_PHASE1_2     0x00be4260 /* Horizontal Scaler 1 Poly-Phase Filter Phase 1 Coefficients */
#define BCHP_M2MC_VERT_FIR_0_COEFF_PHASE0_01     0x00be4264 /* Vertical Scaler 0 Poly-Phase Filter Phase 0 Coefficients */
#define BCHP_M2MC_VERT_FIR_0_COEFF_PHASE0_2      0x00be4268 /* Vertical Scaler 0 Poly-Phase Filter Phase 0 Coefficients */
#define BCHP_M2MC_VERT_FIR_0_COEFF_PHASE1_01     0x00be426c /* Vertical Scaler 0 Poly-Phase Filter Phase 1 Coefficients */
#define BCHP_M2MC_VERT_FIR_0_COEFF_PHASE1_2      0x00be4270 /* Vertical Scaler 0 Poly-Phase Filter Phase 1 Coefficients */
#define BCHP_M2MC_VERT_FIR_1_COEFF_PHASE0_01     0x00be4274 /* Vertical Scaler 1 Poly-Phase Filter Phase 0 Coefficients */
#define BCHP_M2MC_VERT_FIR_1_COEFF_PHASE0_2      0x00be4278 /* Vertical Scaler 1 Poly-Phase Filter Phase 0 Coefficients */
#define BCHP_M2MC_VERT_FIR_1_COEFF_PHASE1_01     0x00be427c /* Vertical Scaler 1 Poly-Phase Filter Phase 1 Coefficients */
#define BCHP_M2MC_VERT_FIR_1_COEFF_PHASE1_2      0x00be4280 /* Vertical Scaler 1 Poly-Phase Filter Phase 1 Coefficients */
#define BCHP_M2MC_SRC_CM_C00_C01                 0x00be4284 /* Color Conversion Matrix Coefficients C00 and C01 */
#define BCHP_M2MC_SRC_CM_C02_C03                 0x00be4288 /* Color Conversion Matrix Coefficients C02 and C03 */
#define BCHP_M2MC_SRC_CM_C04                     0x00be428c /* Color Conversion Matrix Coefficients C04 */
#define BCHP_M2MC_SRC_CM_C10_C11                 0x00be4290 /* Color Conversion Matrix Coefficients C10 and C11 */
#define BCHP_M2MC_SRC_CM_C12_C13                 0x00be4294 /* Color Conversion Matrix Coefficients C12 and C13 */
#define BCHP_M2MC_SRC_CM_C14                     0x00be4298 /* Color Conversion Matrix Coefficients C14 */
#define BCHP_M2MC_SRC_CM_C20_C21                 0x00be429c /* Color Conversion Matrix Coefficients C20 and C21 */
#define BCHP_M2MC_SRC_CM_C22_C23                 0x00be42a0 /* Color Conversion Matrix Coefficients C22 and C23 */
#define BCHP_M2MC_SRC_CM_C24                     0x00be42a4 /* Color Conversion Matrix Coefficients C24 */
#define BCHP_M2MC_SRC_CM_C30_C31                 0x00be42a8 /* Color Conversion Matrix Coefficients C30 and C31 */
#define BCHP_M2MC_SRC_CM_C32_C33                 0x00be42ac /* Color Conversion Matrix Coefficients C32 and C33 */
#define BCHP_M2MC_SRC_CM_C34                     0x00be42b0 /* Color Conversion Matrix Coefficients C34 */
#define BCHP_M2MC_TIMEOUT_COUNTER_CONTROL        0x00be42b4 /* M2MC timeout counter control register */
#define BCHP_M2MC_CLK_GATE_AND_SW_INIT_CONTROL   0x00be42b8 /* M2MC clock gating and software init control register */
