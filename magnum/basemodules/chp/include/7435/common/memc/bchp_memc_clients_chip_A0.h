...
/*****
GENERATED by:
perl magnum/basemodules/chp/src/common/bchp_memc_clients_chip.pl magnum/basemodules/chp/include/7435/common/memc/bchp_memc_clients_chip_A0.txt magnum/basemodules/chp/include/7435/common/memc/bchp_memc_clients_chip_A0.h
*******/
...
BCHP_P_MEMC_DEFINE_CLIENT(TPCAP,27,INVALID)                 /*             Test Port Capture */
...
BCHP_P_MEMC_DEFINE_CLIENT(MCIF_RD,33,INVALID)               /*             Smart Card; New in 7435: UART_DMA (for Bluetooth interaction), traffic multiplexed. */
...
BCHP_P_MEMC_DEFINE_CLIENT(FLASH_DMA,39,39)                  /*         New client in 7435, accelerates NAND and Parallel-NOR transfers */
...
BCHP_P_MEMC_DEFINE_CLIENT(AUD_AIO,50,50)                    /*         "AIO" is the new name for "FMM"; 7435 has AIO on both SCBs (bugfix) */
...
BCHP_P_MEMC_DEFINE_CLIENT(BVN_MAD_PIX_CAP,74,74)            /*         MAD_R pixel capture (write) */
