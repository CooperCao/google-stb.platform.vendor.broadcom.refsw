...
#ifndef BCHP_7260_H__
#define BCHP_7260_H__
...
/***************************************************************************
Summary:
    Open a chip handle for Bcm7260 chip

Description:
    This function open a chip handle for Bcm7260 chip.

Input:
    hRegister - A valid Bcm7260 register handle previous open using BREG_Open.
