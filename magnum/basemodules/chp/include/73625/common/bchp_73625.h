 ...
 *
 ***************************************************************************/
#ifndef BCHP_73625_H__
#define BCHP_73625_H__
...
/***************************************************************************
Summary:
    Open a chip handle for Bcm73625 chip

Description:
    This function open a chip handle for Bcm73625 chip.

Input:
    hRegister - A valid Bcm73625 register handle previous open using BREG_Open.
