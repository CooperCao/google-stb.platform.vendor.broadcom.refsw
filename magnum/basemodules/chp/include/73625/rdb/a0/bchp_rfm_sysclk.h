 ...
 ***************************************************************************/
#define BCHP_RFM_SYSCLK_CLKCTL                   0x00b00000 /* [RW] RF Modulator clock control */
#define BCHP_RFM_SYSCLK_RESET                    0x00b00004 /* [RW] RF modulator soft reset */
#define BCHP_RFM_SYSCLK_NCOINVID                 0x00b00008 /* [RW] Audio Input VID - NCO control word */
#define BCHP_RFM_SYSCLK_VIDCNTL                  0x00b0000c /* [RW] Audio BTSC VID - Delayed start control */
#define BCHP_RFM_SYSCLK_VIDPHASE                 0x00b00010 /* [RW] Audio BTSC VID - Initial values of NCOs */
#define BCHP_RFM_SYSCLK_NCOINT                   0x00b00014 /* [RW] Audio BTSC VID - Integer numerator for internal NCO */
#define BCHP_RFM_SYSCLK_NCOREM                   0x00b00018 /* [RW] Audio BTSC VID - Remainder for internal NCO */
#define BCHP_RFM_SYSCLK_NCODEN                   0x00b0001c /* [RW] Audio BTSC VID - Denominator for internal NCO */
#define BCHP_RFM_SYSCLK_DACCTL                   0x00b00020 /* [RW] RF modulator DAC control */
#define BCHP_RFM_SYSCLK_AMFREQ                   0x00b00024 /* [RW] Frequency control word for the RF carrier DDFS */
#define BCHP_RFM_SYSCLK_MODBYP                   0x00b00028 /* [RW] Bypass control for the sub-blocks in the amplitude modulator portion of the RF Modulator */
#define BCHP_RFM_SYSCLK_MODTST                   0x00b0002c /* [RW] Testability control for the amplitude modulator */
#define BCHP_RFM_SYSCLK_TPRATE                   0x00b00030 /* [RW] Control for the testport output decimation ratio of amplitude modulator */
#define BCHP_RFM_SYSCLK_OUTSCL                   0x00b00034 /* [RW] Control for the scaler at the output of the RF Modulator block */
#define BCHP_RFM_SYSCLK_LINEFCW                  0x00b00038 /* [RW] Line sync frequency control word for artificial line sync */
#define BCHP_RFM_SYSCLK_VCLK1                    0x00b0003c /* [RW] Video input FIFO freezing control */
#define BCHP_RFM_SYSCLK_BISTCNTL                 0x00b00060 /* [RW] RF modulator logic BIST control */
#define BCHP_RFM_SYSCLK_BISTSTAT                 0x00b00064 /* [RO] Read-only RF modulator logic BIST test status */
#define BCHP_RFM_SYSCLK_AUCRC1                   0x00b00068 /* [RO] Read-only RF modulator audio channel 1 pre-FIFO data CRC signature */
#define BCHP_RFM_SYSCLK_AUCRC2                   0x00b0006c /* [RO] Read-only RF modulator audio channel 2 pre-FIFO data CRC signature */
#define BCHP_RFM_SYSCLK_AUCRC3                   0x00b00070 /* [RO] Read-only RF modulator audio channel 1 post-FIFO data CRC signature */
#define BCHP_RFM_SYSCLK_AUCRC4                   0x00b00074 /* [RO] Read-only RF modulator audio channel 2 post-FIFO data CRC signature */
#define BCHP_RFM_SYSCLK_AUCRC5                   0x00b00078 /* [RO] Read-only RF modulator audio L+R channel output Cauer filter CRC signature */
#define BCHP_RFM_SYSCLK_AUCRC6                   0x00b0007c /* [RO] Read-only RF modulator audio L-R channel output Cauer filter CRC signature */
#define BCHP_RFM_SYSCLK_AUCRC7                   0x00b00080 /* [RO] Read-only RF modulator audio spectral gain logic BIST CRC signature */
#define BCHP_RFM_SYSCLK_AUCRC8                   0x00b00084 /* [RO] Read-only RF modulator audio wide-band gain logic BIST CRC signature */
#define BCHP_RFM_SYSCLK_VICRC1                   0x00b00088 /* [RO] Read-only RF modulator video pre-FIFO data CRC signature */
#define BCHP_RFM_SYSCLK_VICRC2                   0x00b0008c /* [RO] Read-only RF modulator video post-FIFO data CRC signature */
#define BCHP_RFM_SYSCLK_AVCRC                    0x00b00090 /* [RO] Read-only RF modulator audio/video logic BIST CRC signature */
#define BCHP_RFM_SYSCLK_AMCRC                    0x00b00094 /* [RO] Read-only RF modulator amplitude modulator logic BIST CRC signature */
#define BCHP_RFM_SYSCLK_TPCRC1                   0x00b00098 /* [RO] Read-only RF modulator audio 27MHz testport output CRC signature */
#define BCHP_RFM_SYSCLK_TPCRC2                   0x00b0009c /* [RO] Read-only RF modulator video 27MHz testport output CRC signature */
#define BCHP_RFM_SYSCLK_STATUS                   0x00b000a4 /* [RO] Read-only RFM status register for interrupt conditions */
#define BCHP_RFM_SYSCLK_MISC                     0x00b000ac /* [RW] Miscellaneous register */
#define BCHP_RFM_SYSCLK_REVID                    0x00b000b0 /* [RO] Read-only RF Modulator REVID register */
#define BCHP_RFM_SYSCLK_TSTCNTL                  0x00b000b4 /* [RW] General control for the RF Modulator testport IOs */
#define BCHP_RFM_SYSCLK_TPOUT                    0x00b000b8 /* [RO] TP_OUT bus value */
#define BCHP_RFM_SYSCLK_RFMPHY_BISTCNTL          0x00b000e4 /* [RW] RFMPHY Logic BIST Control Register */
#define BCHP_RFM_SYSCLK_RFMPHY_STATUS            0x00b000e8 /* [RO] Read-only RFMPHY CRC Register */
#define BCHP_RFM_SYSCLK_RFMPHY_BIASCNTL          0x00b000ec /* [RW] RFMPHY Bias Control Register */
#define BCHP_RFM_SYSCLK_DPLL_DIV1                0x00b000f4 /* [RW] Phase Lock Loop Divider Control Register 1 */
#define BCHP_RFM_SYSCLK_DPLL_DIV2                0x00b000f8 /* [RW] Phase Lock Loop Divider Control Register 2 */
#define BCHP_RFM_SYSCLK_DPLL_CH0                 0x00b000fc /* [RW] Phase Lock Loop Channel Control Register */
#define BCHP_RFM_SYSCLK_DPLL_MISC1               0x00b00100 /* [RW] Phase Lock Loop Misc Control Register 1 */
#define BCHP_RFM_SYSCLK_DPLL_MISC2               0x00b00104 /* [RW] Phase Lock Loop Misc Control Register 2 */
#define BCHP_RFM_SYSCLK_DPLL_MISC3               0x00b00108 /* [RW] Phase Lock Loop Misc Control Register 3 */
#define BCHP_RFM_SYSCLK_WDAC_CTL                 0x00b0010c /* [RW] RFM DAC Control Register 2 */
#define BCHP_RFM_SYSCLK_RFMPHY_EXTRA_CTL         0x00b00110 /* [RW] Additional RFMPHY Control Register */
#define BCHP_RFM_SYSCLK_RFMPHY_EXTRA_STATUS      0x00b00114 /* [RO] Additional RFMPHY Status Register */
#define BCHP_RFM_SYSCLK_RESERVED1                0x00b00118 /* [RW] Reserved register */
