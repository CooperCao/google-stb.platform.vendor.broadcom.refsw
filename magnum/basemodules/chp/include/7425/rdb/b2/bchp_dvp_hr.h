 ...
 ***************************************************************************/
#define BCHP_DVP_HR_CORE_REV                     0x006a6000 /* Digital Video Port Core Revision Number */
#define BCHP_DVP_HR_TOP_SW_INIT                  0x006a6004 /* Software Init for Top level Core */
#define BCHP_DVP_HR_HDMI_FE_0_SW_INIT            0x006a6008 /* Software Init for HDMI Receiver Front End 0 */
#define BCHP_DVP_HR_HDMI_RX_0_SW_INIT            0x006a6018 /* Software Init for HDMI Receiver 0 */
#define BCHP_DVP_HR_POWER_CONTROL                0x006a6028 /* Power Control */
#define BCHP_DVP_HR_PTHRU_CFG                    0x006a602c /* HDMI Pass Through Configuration */
#define BCHP_DVP_HR_PTHRU_STATUS                 0x006a6030 /* HDMI Pass Through Status */
#define BCHP_DVP_HR_VMS_LOOPBACK_ENABLE          0x006a6034 /* VMS loopback enable */
#define BCHP_DVP_HR_TEST_PORT_CONFIGURATION      0x006a6038 /* Configure which data is output on the test port */
#define BCHP_DVP_HR_DVP_FLOW_CONTROL             0x006a603c /* DVP Flow Control */
#define BCHP_DVP_HR_I2C_CONTROL                  0x006a6040 /* I2C Control Register */
#define BCHP_DVP_HR_DVP_HR_TIMER_1S_CONTROL      0x006a6044 /* Timer Control Register - 1S */
#define BCHP_DVP_HR_DVP_HR_TIMER_1MS_CONTROL     0x006a6048 /* Timer Control Register - 1MS */
#define BCHP_DVP_HR_DVP_HR_TIMER_1US_CONTROL     0x006a604c /* Timer Control Register - 1US */
#define BCHP_DVP_HR_FREQ_MEASURE_CONTROL         0x006a6050 /* Freq Measurement Control */
#define BCHP_DVP_HR_FREQ_MEASURE                 0x006a6054 /* Freq Measurement Current Value */
#define BCHP_DVP_HR_MAX_FREQ                     0x006a6058 /* Freq Measurement Max Value */
#define BCHP_DVP_HR_MIN_FREQ                     0x006a605c /* Freq Measurement Min Value */
#define BCHP_DVP_HR_RBUS_MONITOR_0_CFG_0         0x006a6060 /* RBUS Monitor Configuration */
#define BCHP_DVP_HR_RBUS_MONITOR_0_CTL_0         0x006a6064 /* RBUS Monitor Control */
#define BCHP_DVP_HR_RBUS_MONITOR_0_RESULTS_0     0x006a6068 /* RBUS Monitor Results */
#define BCHP_DVP_HR_RBUS_MONITOR_0_RESULTS_1     0x006a606c /* RBUS Monitor Results */
#define BCHP_DVP_HR_RBUS_MONITOR_0_RESULTS_2     0x006a6070 /* RBUS Monitor Results */
#define BCHP_DVP_HR_RBUS_MONITOR_0_RESULTS_3     0x006a6074 /* RBUS Monitor Results */
#define BCHP_DVP_HR_RBUS_MONITOR_0_RESULTS_4     0x006a6078 /* RBUS Monitor Results */
#define BCHP_DVP_HR_RBUS_MONITOR_1_CFG_0         0x006a607c /* RBUS Monitor Configuration */
#define BCHP_DVP_HR_RBUS_MONITOR_1_CTL_0         0x006a6080 /* RBUS Monitor Control */
#define BCHP_DVP_HR_RBUS_MONITOR_1_RESULTS_0     0x006a6084 /* RBUS Monitor Results */
#define BCHP_DVP_HR_RBUS_MONITOR_1_RESULTS_1     0x006a6088 /* RBUS Monitor Results */
#define BCHP_DVP_HR_RBUS_MONITOR_1_RESULTS_2     0x006a608c /* RBUS Monitor Results */
#define BCHP_DVP_HR_RBUS_MONITOR_1_RESULTS_3     0x006a6090 /* RBUS Monitor Results */
#define BCHP_DVP_HR_RBUS_MONITOR_1_RESULTS_4     0x006a6094 /* RBUS Monitor Results */
#define BCHP_DVP_HR_FSM_DEBUG_SAT_THLD           0x006a6098 /* FSM Debug Feature Related */
#define BCHP_DVP_HR_FSM_DEBUG_CNT_ENABLES        0x006a609c /* FSM Debug Feature Related */
#define BCHP_DVP_HR_FSM_DEBUG_CONTROL_SIGNALS    0x006a60a0 /* FSM Debug Feature Related */
#define BCHP_DVP_HR_FSM_DEBUG_LUMP_STATES        0x006a60a4 /* FSM Debug Feature Related */
#define BCHP_DVP_HR_FSM_DEBUG_FSM_STUCK          0x006a60a8 /* FSM Debug Feature Related */
#define BCHP_DVP_HR_FSM_DEBUG_INFO_OF_SELECTED_FSM 0x006a60ac /* FSM Debug Feature Related */
#define BCHP_DVP_HR_SPARE_REGISTER_BITS          0x006a61bc /* Spare Bits For ECO's */
...
#define BCHP_DVP_HR_DVP_FLOW_CONTROL_HDMI_RX_0_ALWAYS_ACCEPT_DEFAULT 0x00000000
