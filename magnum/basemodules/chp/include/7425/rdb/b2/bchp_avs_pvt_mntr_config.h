 ...
 ***************************************************************************/
#define BCHP_AVS_PVT_MNTR_CONFIG_PVT_MNTR_CTRL   0x00432900 /* Control bits for PVT monitor */
#define BCHP_AVS_PVT_MNTR_CONFIG_PVT_MNTR_IDOFFMON_PWRDN 0x00432904 /* Power down the IDOFFMON */
#define BCHP_AVS_PVT_MNTR_CONFIG_PVT_MNTR_TP_MODE_ENABLE 0x00432908 /* Enabling TP mode to use data from tp_in/out pins */
#define BCHP_AVS_PVT_MNTR_CONFIG_DAC_CODE_PROGRAMMING_ENABLE 0x00432910 /* SW must set this bit to 1 to modify DAC_CODE, MIN_DAC_CODE and MAX_DAC_CODE */
#define BCHP_AVS_PVT_MNTR_CONFIG_DAC_CODE        0x00432914 /* Represents the input code of the DAC */
#define BCHP_AVS_PVT_MNTR_CONFIG_MIN_DAC_CODE    0x00432918 /* SW may set this to a lower value to prevent the DAC from driving too high of a voltage */
#define BCHP_AVS_PVT_MNTR_CONFIG_MAX_DAC_CODE    0x0043291c /* SW may set this to a higher value to prevent the DAC from driving too low of a voltage */
