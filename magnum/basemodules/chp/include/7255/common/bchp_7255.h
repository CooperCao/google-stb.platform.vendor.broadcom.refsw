...
#ifndef BCHP_7255_H__
#define BCHP_7255_H__
...
/***************************************************************************
Summary:
    Open a chip handle for Bcm7255 chip

Description:
    This function open a chip handle for Bcm7255 chip.

Input:
    hRegister - A valid Bcm7255 register handle previous open using BREG_Open.
