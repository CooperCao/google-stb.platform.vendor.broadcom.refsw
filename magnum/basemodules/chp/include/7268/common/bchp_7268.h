...
#ifndef BCHP_7268_H__
#define BCHP_7268_H__
...
/***************************************************************************
Summary:
    Open a chip handle for Bcm7268 chip

Description:
    This function open a chip handle for Bcm7268 chip.

Input:
    hRegister - A valid Bcm7268 register handle previous open using BREG_Open.
