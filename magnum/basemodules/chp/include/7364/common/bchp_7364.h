 ...
 * 
 ***************************************************************************/
#ifndef BCHP_7364_H__
#define BCHP_7364_H__
...
/***************************************************************************
Summary:
    Open a chip handle for Bcm7364 chip

Description:
    This function open a chip handle for Bcm7364 chip.

Input:
    hRegister - A valid Bcm7364 register handle previous open using BREG_Open.
