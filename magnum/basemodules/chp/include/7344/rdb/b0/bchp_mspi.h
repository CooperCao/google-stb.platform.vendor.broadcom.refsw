 ...
 *
 *
 * Date:           Generated on         Tue May 31 14:13:36 2011
 ...
 *MSPI - Master SPI
 ***************************************************************************/
#define BCHP_MSPI_SPCR0_LSB                      0x00408a00 /* SPCR0_LSB REGISTER */
#define BCHP_MSPI_SPCR0_MSB                      0x00408a04 /* SPCR0_MSB Register */
#define BCHP_MSPI_SPCR1_LSB                      0x00408a08 /* SPCR1_LSB REGISTER */
#define BCHP_MSPI_SPCR1_MSB                      0x00408a0c /* SPCR1_MSB REGISTER */
#define BCHP_MSPI_NEWQP                          0x00408a10 /* NEWQP REGISTER */
#define BCHP_MSPI_ENDQP                          0x00408a14 /* ENDQP REGISTER */
#define BCHP_MSPI_SPCR2                          0x00408a18 /* SPCR2 REGISTER */
#define BCHP_MSPI_MSPI_STATUS                    0x00408a20 /* MSPI STATUS REGISTER */
#define BCHP_MSPI_CPTQP                          0x00408a24 /* CPTQP REGISTER */
#define BCHP_MSPI_SPCR3                          0x00408a28 /* SPCR3 REGISTER */
#define BCHP_MSPI_TXRAM00                        0x00408a40 /* Most significant byte of TXRAM[0] (queue pointer = 0) */
#define BCHP_MSPI_TXRAM01                        0x00408a44 /* Least significant byte of TXRAM[0] (queue pointer = 0) */
#define BCHP_MSPI_TXRAM02                        0x00408a48 /* Most significant byte of TXRAM[1] (queue pointer = 1) */
#define BCHP_MSPI_TXRAM03                        0x00408a4c /* Least significant byte of TXRAM[1] (queue pointer = 1) */
#define BCHP_MSPI_TXRAM04                        0x00408a50 /* Most significant byte of TXRAM[2] (queue pointer = 2) */
#define BCHP_MSPI_TXRAM05                        0x00408a54 /* Least significant byte of TXRAM[2] (queue pointer = 2) */
#define BCHP_MSPI_TXRAM06                        0x00408a58 /* Most significant byte of TXRAM[3] (queue pointer = 3) */
#define BCHP_MSPI_TXRAM07                        0x00408a5c /* Least significant byte of TXRAM[3] (queue pointer = 3) */
#define BCHP_MSPI_TXRAM08                        0x00408a60 /* Most significant byte of TXRAM[4] (queue pointer = 4) */
#define BCHP_MSPI_TXRAM09                        0x00408a64 /* Least significant byte of TXRAM[4] (queue pointer = 4) */
#define BCHP_MSPI_TXRAM10                        0x00408a68 /* Most significant byte of TXRAM[5] (queue pointer = 5) */
#define BCHP_MSPI_TXRAM11                        0x00408a6c /* Least significant byte of TXRAM[5] (queue pointer = 5) */
#define BCHP_MSPI_TXRAM12                        0x00408a70 /* Most significant byte of TXRAM[6] (queue pointer = 6) */
#define BCHP_MSPI_TXRAM13                        0x00408a74 /* Least significant byte of TXRAM[6] (queue pointer = 6) */
#define BCHP_MSPI_TXRAM14                        0x00408a78 /* Most significant byte of TXRAM[7] (queue pointer = 7) */
#define BCHP_MSPI_TXRAM15                        0x00408a7c /* Least significant byte of TXRAM[7] (queue pointer = 7) */
#define BCHP_MSPI_TXRAM16                        0x00408a80 /* Most significant byte of TXRAM[8] (queue pointer = 8) */
#define BCHP_MSPI_TXRAM17                        0x00408a84 /* Least significant byte of TXRAM[8] (queue pointer = 8) */
#define BCHP_MSPI_TXRAM18                        0x00408a88 /* Most significant byte of TXRAM[9] (queue pointer = 9) */
#define BCHP_MSPI_TXRAM19                        0x00408a8c /* Least significant byte of TXRAM[9] (queue pointer = 9) */
#define BCHP_MSPI_TXRAM20                        0x00408a90 /* Most significant byte of TXRAM[10] (queue pointer = 10) */
#define BCHP_MSPI_TXRAM21                        0x00408a94 /* Least significant byte of TXRAM[10] (queue pointer = 10) */
#define BCHP_MSPI_TXRAM22                        0x00408a98 /* Most significant byte of TXRAM[11] (queue pointer = 11) */
#define BCHP_MSPI_TXRAM23                        0x00408a9c /* Least significant byte of TXRAM[11] (queue pointer = 11) */
#define BCHP_MSPI_TXRAM24                        0x00408aa0 /* Most significant byte of TXRAM[12] (queue pointer = 12) */
#define BCHP_MSPI_TXRAM25                        0x00408aa4 /* Least significant byte of TXRAM[12] (queue pointer = 12) */
#define BCHP_MSPI_TXRAM26                        0x00408aa8 /* Most significant byte of TXRAM[13] (queue pointer = 13) */
#define BCHP_MSPI_TXRAM27                        0x00408aac /* Least significant byte of TXRAM[13] (queue pointer = 13) */
#define BCHP_MSPI_TXRAM28                        0x00408ab0 /* Most significant byte of TXRAM[14] (queue pointer = 14) */
#define BCHP_MSPI_TXRAM29                        0x00408ab4 /* Least significant byte of TXRAM[14] (queue pointer = 14) */
#define BCHP_MSPI_TXRAM30                        0x00408ab8 /* Most significant byte of TXRAM[15] (queue pointer = 15) */
#define BCHP_MSPI_TXRAM31                        0x00408abc /* Least significant byte of TXRAM[15] (queue pointer = 15) */
#define BCHP_MSPI_RXRAM00                        0x00408ac0 /* Most significant byte of RXRAM[0] (queue pointer = 0) */
#define BCHP_MSPI_RXRAM01                        0x00408ac4 /* Least significant byte of RXRAM[0] (queue pointer = 0) */
#define BCHP_MSPI_RXRAM02                        0x00408ac8 /* Most significant byte of RXRAM[1] (queue pointer = 1) */
#define BCHP_MSPI_RXRAM03                        0x00408acc /* Least significant byte of RXRAM[1] (queue pointer = 1) */
#define BCHP_MSPI_RXRAM04                        0x00408ad0 /* Most significant byte of RXRAM[2] (queue pointer = 2) */
#define BCHP_MSPI_RXRAM05                        0x00408ad4 /* Least significant byte of RXRAM[2] (queue pointer = 2) */
#define BCHP_MSPI_RXRAM06                        0x00408ad8 /* Most significant byte of RXRAM[3] (queue pointer = 3) */
#define BCHP_MSPI_RXRAM07                        0x00408adc /* Least significant byte of RXRAM[3] (queue pointer = 3) */
#define BCHP_MSPI_RXRAM08                        0x00408ae0 /* Most significant byte of RXRAM[4] (queue pointer = 4) */
#define BCHP_MSPI_RXRAM09                        0x00408ae4 /* Least significant byte of RXRAM[4] (queue pointer = 4) */
#define BCHP_MSPI_RXRAM10                        0x00408ae8 /* Most significant byte of RXRAM[5] (queue pointer = 5) */
#define BCHP_MSPI_RXRAM11                        0x00408aec /* Least significant byte of RXRAM[5] (queue pointer = 5) */
#define BCHP_MSPI_RXRAM12                        0x00408af0 /* Most significant byte of RXRAM[6] (queue pointer = 6) */
#define BCHP_MSPI_RXRAM13                        0x00408af4 /* Least significant byte of RXRAM[6] (queue pointer = 6) */
#define BCHP_MSPI_RXRAM14                        0x00408af8 /* Most significant byte of RXRAM[7] (queue pointer = 7) */
#define BCHP_MSPI_RXRAM15                        0x00408afc /* Least significant byte of RXRAM[7] (queue pointer = 7) */
#define BCHP_MSPI_RXRAM16                        0x00408b00 /* Most significant byte of RXRAM[8] (queue pointer = 8) */
#define BCHP_MSPI_RXRAM17                        0x00408b04 /* Least significant byte of RXRAM[8] (queue pointer = 8) */
#define BCHP_MSPI_RXRAM18                        0x00408b08 /* Most significant byte of RXRAM[9] (queue pointer = 9) */
#define BCHP_MSPI_RXRAM19                        0x00408b0c /* Least significant byte of RXRAM[9] (queue pointer = 9) */
#define BCHP_MSPI_RXRAM20                        0x00408b10 /* Most significant byte of RXRAM[10] (queue pointer = 10) */
#define BCHP_MSPI_RXRAM21                        0x00408b14 /* Least significant byte of RXRAM[10] (queue pointer = 10) */
#define BCHP_MSPI_RXRAM22                        0x00408b18 /* Most significant byte of RXRAM[11] (queue pointer = 11) */
#define BCHP_MSPI_RXRAM23                        0x00408b1c /* Least significant byte of RXRAM[11] (queue pointer = 11) */
#define BCHP_MSPI_RXRAM24                        0x00408b20 /* Most significant byte of RXRAM[12] (queue pointer = 12) */
#define BCHP_MSPI_RXRAM25                        0x00408b24 /* Least significant byte of RXRAM[12] (queue pointer = 12) */
#define BCHP_MSPI_RXRAM26                        0x00408b28 /* Most significant byte of RXRAM[13] (queue pointer = 13) */
#define BCHP_MSPI_RXRAM27                        0x00408b2c /* Least significant byte of RXRAM[13] (queue pointer = 13) */
#define BCHP_MSPI_RXRAM28                        0x00408b30 /* Most significant byte of RXRAM[14] (queue pointer = 14) */
#define BCHP_MSPI_RXRAM29                        0x00408b34 /* Least significant byte of RXRAM[14] (queue pointer = 14) */
#define BCHP_MSPI_RXRAM30                        0x00408b38 /* Most significant byte of RXRAM[15] (queue pointer = 15) */
#define BCHP_MSPI_RXRAM31                        0x00408b3c /* Least significant byte of RXRAM[15] (queue pointer = 15) */
#define BCHP_MSPI_CDRAM00                        0x00408b40 /* 8-bit command (queue pointer = 0) */
#define BCHP_MSPI_CDRAM01                        0x00408b44 /* 8-bit command (queue pointer = 1) */
#define BCHP_MSPI_CDRAM02                        0x00408b48 /* 8-bit command (queue pointer = 2) */
#define BCHP_MSPI_CDRAM03                        0x00408b4c /* 8-bit command (queue pointer = 3) */
#define BCHP_MSPI_CDRAM04                        0x00408b50 /* 8-bit command (queue pointer = 4) */
#define BCHP_MSPI_CDRAM05                        0x00408b54 /* 8-bit command (queue pointer = 5) */
#define BCHP_MSPI_CDRAM06                        0x00408b58 /* 8-bit command (queue pointer = 6) */
#define BCHP_MSPI_CDRAM07                        0x00408b5c /* 8-bit command (queue pointer = 7) */
#define BCHP_MSPI_CDRAM08                        0x00408b60 /* 8-bit command (queue pointer = 8) */
#define BCHP_MSPI_CDRAM09                        0x00408b64 /* 8-bit command (queue pointer = 9) */
#define BCHP_MSPI_CDRAM10                        0x00408b68 /* 8-bit command (queue pointer = a) */
#define BCHP_MSPI_CDRAM11                        0x00408b6c /* 8-bit command (queue pointer = b) */
#define BCHP_MSPI_CDRAM12                        0x00408b70 /* 8-bit command (queue pointer = c) */
#define BCHP_MSPI_CDRAM13                        0x00408b74 /* 8-bit command (queue pointer = d) */
#define BCHP_MSPI_CDRAM14                        0x00408b78 /* 8-bit command (queue pointer = e) */
#define BCHP_MSPI_CDRAM15                        0x00408b7c /* 8-bit command (queue pointer = f) */
...
#define BCHP_MSPI_SPCR0_LSB_SPBR_DEFAULT                           0
...
#define BCHP_MSPI_SPCR0_MSB_MSTR_DEFAULT                           1
...
#define BCHP_MSPI_SPCR1_LSB_DTL_DEFAULT                            0
...
#define BCHP_MSPI_SPCR1_MSB_RDSCLK_DEFAULT                         0
...
#define BCHP_MSPI_NEWQP_newqp_DEFAULT                              0
...
#define BCHP_MSPI_ENDQP_endqp_DEFAULT                              0
...
#define BCHP_MSPI_SPCR3_rxramdam_DEFAULT                           0
