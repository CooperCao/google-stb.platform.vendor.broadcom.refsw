...
#define BCHP_MISC_DAC_INST_BIAS_CTRL_0           0x00680040 /* DAC Bias Control register for QDAC */
#define BCHP_MISC_DAC_INST_PRBS_CTRL_0           0x00680044 /* DAC Bias PRBS register for QDAC */
#define BCHP_MISC_DAC_0_CTRL                     0x00680048 /* DAC control register for DAC 0 */
#define BCHP_MISC_DAC_1_CTRL                     0x0068004c /* DAC control register for DAC 1 */
#define BCHP_MISC_DAC_2_CTRL                     0x00680050 /* DAC control register for DAC 2 */
#define BCHP_MISC_DAC_3_CTRL                     0x00680054 /* DAC control register for DAC 3 */
#define BCHP_MISC_DAC_0_SCALE_CTRL               0x00680058 /* DAC Scale control register for DAC 0 */
#define BCHP_MISC_DAC_1_SCALE_CTRL               0x0068005c /* DAC Scale control register for DAC 1 */
#define BCHP_MISC_DAC_2_SCALE_CTRL               0x00680060 /* DAC Scale control register for DAC 2 */
#define BCHP_MISC_DAC_3_SCALE_CTRL               0x00680064 /* DAC Scale control register for DAC 3 */
#define BCHP_MISC_DAC_CAL_CTRL_0                 0x00680068 /* DAC calibration control register for DAC0 */
#define BCHP_MISC_DAC_CAL_ADC_DATA_0             0x0068006c /* DAC calibration cal ADC data register for DAC0 */
#define BCHP_MISC_DAC_ADC_DATA_0                 0x00680070 /* DAC calibration adc data register for DAC0 */
#define BCHP_MISC_DAC_DETECT_CTRL_0              0x00680074 /* DAC CABLE DETECT control register for DAC0 */
#define BCHP_MISC_DAC_DETECT_EN_0                0x00680078 /* DAC CABLE DETECT Enable register for DAC0 */
#define BCHP_MISC_DAC_DETECT_SYNC_CTRL_0         0x0068007c /* DAC sync present register */
#define BCHP_MISC_DAC_SQWAVE_LEVEL_0             0x00680080 /* Square Wave levels for cable detect */
#define BCHP_MISC_DAC_DETECT_TIMING_0            0x00680084 /* Cable Detect timing control register */
#define BCHP_MISC_DAC_CABLE_STATUS_0             0x00680088 /* DAC cable connect status */
#define BCHP_MISC_DAC_CABLE_DETECT_DEBUG_0       0x0068008c /* Dac Cable detect debug register */
#define BCHP_MISC_DAC_CABLE_RECALIBRATE_0        0x00680090 /* DAC cable recalibrate for dac instance 0 */
#define BCHP_MISC_DAC_CRC_CTRL                   0x00680094 /* Dac CRC control register */
#define BCHP_MISC_DAC_CRC_VALUE                  0x00680098 /* DAC CRC value register */
#define BCHP_MISC_DAC_CRC_STATUS                 0x0068009c /* DAC CRC status register */
