 ...
 ***************************************************************************/
#define BCHP_AVS_HW_MNTR_SW_CONTROLS             0x00101800 /* Software control command registers for AVS */
#define BCHP_AVS_HW_MNTR_SW_MEASUREMENT_UNIT_BUSY 0x00101804 /* Indicate measurement unit is busy and SW should not de-assert sw_takeover while this is asserted */
#define BCHP_AVS_HW_MNTR_MEASUREMENTS_INIT_PVT_MNTR 0x00101808 /* Software to reset the pvt monitors measurements' valid bits in RO registers */
#define BCHP_AVS_HW_MNTR_MEASUREMENTS_INIT_CEN_ROSC_0 0x0010180c /* Software to reset the central roscs measurements' valid bits in RO registers */
#define BCHP_AVS_HW_MNTR_MEASUREMENTS_INIT_CEN_ROSC_1 0x00101810 /* Software to reset the central roscs measurements' valid bits in RO registers */
#define BCHP_AVS_HW_MNTR_MEASUREMENTS_INIT_RMT_ROSC_0 0x00101814 /* Software to reset the remote roscs measurements' valid bits in RO registers */
#define BCHP_AVS_HW_MNTR_MEASUREMENTS_INIT_POW_WDOG 0x0010181c /* Software to reset the power watchdog measurment's valid bits in RO registers */
#define BCHP_AVS_HW_MNTR_SEQUENCER_INIT          0x00101820 /* Initialize the sensor sequencer */
#define BCHP_AVS_HW_MNTR_SEQUENCER_MASK_PVT_MNTR 0x00101824 /* Indicate which PVT Monitor measurements should  be masked(skipped) in the measurement sequence */
#define BCHP_AVS_HW_MNTR_SEQUENCER_MASK_CEN_ROSC_0 0x00101828 /* Indicate which central ring oscillators should  be masked(skipped) in the measurement sequence */
#define BCHP_AVS_HW_MNTR_SEQUENCER_MASK_CEN_ROSC_1 0x0010182c /* Indicate which central ring oscillators should  be masked(skipped) in the measurement sequence */
#define BCHP_AVS_HW_MNTR_SEQUENCER_MASK_RMT_ROSC_0 0x00101830 /* Indicate which remote ring oscillators should  be masked(skipped) in the measurement sequence */
#define BCHP_AVS_HW_MNTR_ENABLE_DEFAULT_PVT_MNTR 0x00101838 /* Enabling/Disabling PVT monitor */
#define BCHP_AVS_HW_MNTR_ENABLE_DEFAULT_CEN_ROSC_0 0x0010183c /* Enabling/Disabling of central ring oscillators */
#define BCHP_AVS_HW_MNTR_ENABLE_DEFAULT_CEN_ROSC_1 0x00101840 /* Enabling/Disabling of central ring oscillators */
#define BCHP_AVS_HW_MNTR_ROSC_MEASUREMENT_TIME_CONTROL 0x00101844 /* Control the time taken for a rosc/pwd measurement */
#define BCHP_AVS_HW_MNTR_ROSC_COUNTING_MODE      0x00101848 /* Control the counting event for rosc signal counter */
#define BCHP_AVS_HW_MNTR_INTERRUPT_POW_WDOG_EN   0x0010184c /* Software to program a mask(1 bit per PWD) to indicate which PWD signals may trigger an interrupt */
#define BCHP_AVS_HW_MNTR_INTERRUPT_SW_MEASUREMENT_DONE_EN 0x00101850 /* Enable to trigger an interrupt when the measurement is done */
#define BCHP_AVS_HW_MNTR_LAST_MEASURED_SENSOR    0x00101854 /* The last sensor that has been measured */
#define BCHP_AVS_HW_MNTR_AVS_INTERRUPT_FLAGS     0x00101858 /* Indicate AVS interrupts status whether they are triggered or not */
#define BCHP_AVS_HW_MNTR_AVS_INTERRUPT_FLAGS_CLEAR 0x0010185c /* Software to clear the respective AVS interrupt flags */
#define BCHP_AVS_HW_MNTR_REMOTE_SENSOR_TYPE      0x00101860 /* Identify the technology type (8T or 10T) of ring oscillators used in AVS remote sensors */
#define BCHP_AVS_HW_MNTR_AVS_REGISTERS_LOCKS     0x00101864 /* To lock read/write accesses to AVS sensors and regulators registers for security purpose */
#define BCHP_AVS_HW_MNTR_TEMPERATURE_RESET_ENABLE 0x00101868 /* Software to enable chip's temperature monitoring and temperature reset */
#define BCHP_AVS_HW_MNTR_TEMPERATURE_THRESHOLD   0x0010186c /* Threshold value for chip's temperature monitoring */
#define BCHP_AVS_HW_MNTR_IDLE_STATE_0_CEN_ROSC_0 0x00101870 /* Set the output value of ring oscillators when not enabled. */
#define BCHP_AVS_HW_MNTR_IDLE_STATE_0_CEN_ROSC_1 0x00101874 /* Set the output value of ring oscillators when not enabled. */
 ...
 ***************************************************************************/
/* AVS_HW_MNTR :: MEASUREMENTS_INIT_RMT_ROSC_0 :: reserved0 [31:22] */
#define BCHP_AVS_HW_MNTR_MEASUREMENTS_INIT_RMT_ROSC_0_reserved0_MASK 0xffc00000
#define BCHP_AVS_HW_MNTR_MEASUREMENTS_INIT_RMT_ROSC_0_reserved0_SHIFT 22

/* AVS_HW_MNTR :: MEASUREMENTS_INIT_RMT_ROSC_0 :: m_init_rmt_rosc [21:00] */
#define BCHP_AVS_HW_MNTR_MEASUREMENTS_INIT_RMT_ROSC_0_m_init_rmt_rosc_MASK 0x003fffff
 ...
 ***************************************************************************/
/* AVS_HW_MNTR :: SEQUENCER_MASK_RMT_ROSC_0 :: reserved0 [31:22] */
#define BCHP_AVS_HW_MNTR_SEQUENCER_MASK_RMT_ROSC_0_reserved0_MASK  0xffc00000
#define BCHP_AVS_HW_MNTR_SEQUENCER_MASK_RMT_ROSC_0_reserved0_SHIFT 22

/* AVS_HW_MNTR :: SEQUENCER_MASK_RMT_ROSC_0 :: seq_mask_rmt_rosc [21:00] */
#define BCHP_AVS_HW_MNTR_SEQUENCER_MASK_RMT_ROSC_0_seq_mask_rmt_rosc_MASK 0x003fffff
 ...
 ***************************************************************************/
/* AVS_HW_MNTR :: INTERRUPT_POW_WDOG_EN :: reserved0 [31:11] */
#define BCHP_AVS_HW_MNTR_INTERRUPT_POW_WDOG_EN_reserved0_MASK      0xfffff800
#define BCHP_AVS_HW_MNTR_INTERRUPT_POW_WDOG_EN_reserved0_SHIFT     11

/* AVS_HW_MNTR :: INTERRUPT_POW_WDOG_EN :: irq_en [10:00] */
#define BCHP_AVS_HW_MNTR_INTERRUPT_POW_WDOG_EN_irq_en_MASK         0x000007ff
 ...
 ***************************************************************************/
/* AVS_HW_MNTR :: REMOTE_SENSOR_TYPE :: reserved0 [31:11] */
#define BCHP_AVS_HW_MNTR_REMOTE_SENSOR_TYPE_reserved0_MASK         0xfffff800
#define BCHP_AVS_HW_MNTR_REMOTE_SENSOR_TYPE_reserved0_SHIFT        11

/* AVS_HW_MNTR :: REMOTE_SENSOR_TYPE :: type [10:00] */
#define BCHP_AVS_HW_MNTR_REMOTE_SENSOR_TYPE_type_MASK              0x000007ff
