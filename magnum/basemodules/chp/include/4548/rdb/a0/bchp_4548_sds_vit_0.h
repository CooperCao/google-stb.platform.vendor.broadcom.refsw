...
/***************************************************************************
 *SDS_VIT_0 - 0 SDS Viterbi Decoder Register Set
 ***************************************************************************/
#define BCHP_SDS_VIT_0_VTCTL                     0x01240400 /* Viterbi Decoder Configuration Register (Formerly,VTCTL2,VTCTL1) */
#define BCHP_SDS_VIT_0_V10                       0x01240404 /* Viterbi decoder sync error threshold 1/0 (Formerly, V1,V0, DVB/DTV 2/3, DC 1/2 */
#define BCHP_SDS_VIT_0_V32                       0x01240408 /* Viterbi decoder sync error threshold 3/2 (Formerly, V3,V2, DVB/DTV 5/6, DC 2/3 */
#define BCHP_SDS_VIT_0_V54                       0x0124040c /* Viterbi decoder sync error threshold 5/4 (Formerly, V5,V4, DVB/DTV 7/8, DC 4/5 */
#define BCHP_SDS_VIT_0_V76                       0x01240410 /* Viterbi decoder sync error threshold 7/6 (Formerly, V7,V6, DVB/DTV unused, DC 7/8 */
#define BCHP_SDS_VIT_0_VINT                      0x01240414 /* Viterbi decoder sync integration period */
#define BCHP_SDS_VIT_0_VCNT                      0x01240418 /* Viterbi decoder integration counter value */
#define BCHP_SDS_VIT_0_VSTC                      0x0124041c /* Viterbi decoder state change counter values */
#define BCHP_SDS_VIT_0_VST                       0x01240420 /* Viterbi decoder internal status monitor */
#define BCHP_SDS_VIT_0_VREC                      0x01240424 /* Viterbi re-encoding register error value */
#define BCHP_SDS_VIT_0_VRCV                      0x01240428 /* Viterbi re-encoding register count value */
