...
/***************************************************************************
 *SDS_CL_0 - 0 SDS Carrier Loop Register Set
 ***************************************************************************/
#define BCHP_SDS_CL_0_CLCTL1                     0x01240180 /* Carrier Loop Control 1 (Formerly, CLQCFD,CLPDCTL,CLCTL) */
#define BCHP_SDS_CL_0_CLCTL2                     0x01240184 /* Carrier Loop Control 2 (Formerly, CLOON,CLSTS,CLMISC2,CLMISC) */
#define BCHP_SDS_CL_0_FLLC                       0x01240188 /* Set 1 front carrier loop linear coefficient and scaling values */
#define BCHP_SDS_CL_0_FLLC1                      0x0124018c /* Set 2 front carrier loop linear coefficient and scaling values */
#define BCHP_SDS_CL_0_FLIC                       0x01240190 /* Set 1 front carrier loop integrator coefficient and scaling values */
#define BCHP_SDS_CL_0_FLIC1                      0x01240194 /* Set 2 front carrier loop integrator coefficient and scaling values */
#define BCHP_SDS_CL_0_FLSW                       0x01240198 /* Front carrier loop sweep rate */
#define BCHP_SDS_CL_0_FLI                        0x0124019c /* Front carrier loop integrator value */
#define BCHP_SDS_CL_0_FLIF                       0x012401a0 /* Front carrier loop IF frequency control word */
#define BCHP_SDS_CL_0_FLPA                       0x012401a4 /* Front carrier loop phase accumulator value */
#define BCHP_SDS_CL_0_FLTD                       0x012401a8 /* Front carrier loop frequency detector threshold */
#define BCHP_SDS_CL_0_PEEST                      0x012401ac /* Back carrier loop phase error estimator output */
#define BCHP_SDS_CL_0_PLTD                       0x012401b0 /* Back carrier loop frequency detector threshold */
#define BCHP_SDS_CL_0_PLC                        0x012401b4 /* 1st set of back carrier loop linear and integrator coefficients and scaling values */
#define BCHP_SDS_CL_0_PLC1                       0x012401b8 /* 2nd set of back carrier loop linear and integrator coefficients and scaling values */
#define BCHP_SDS_CL_0_PLSW                       0x012401bc /* Back carrier loop sweep rate */
#define BCHP_SDS_CL_0_PLI                        0x012401c0 /* Back carrier loop integrator value */
#define BCHP_SDS_CL_0_PLPA                       0x012401c4 /* Back carrier loop phase accumulator value */
#define BCHP_SDS_CL_0_CRBFD                      0x012401c8 /* Carrier loop QAM/8PSK phase detector threshold */
#define BCHP_SDS_CL_0_CLHT                       0x012401cc /* Carrier loop lock high threshold value */
#define BCHP_SDS_CL_0_CLLT                       0x012401d0 /* Carrier loop lock low threshold value */
#define BCHP_SDS_CL_0_CLLA                       0x012401d4 /* Carrier loop lock accumulator value */
#define BCHP_SDS_CL_0_CLCT                       0x012401d8 /* Carrier loop lock control */
#define BCHP_SDS_CL_0_CLFFCTL                    0x012401dc /* Fine Frequency Mixer Control */
#define BCHP_SDS_CL_0_FFLPA                      0x012401e0 /* Fine frequency adjustment phase accumulator */
#define BCHP_SDS_CL_0_CLFBCTL                    0x012401e4 /* Forward Backward Loop Control (Formerly, CLFBCTL2,CLFBCTL) */
#define BCHP_SDS_CL_0_FBLC                       0x012401e8 /* Forward Backward Loop Filter Coefficient */
#define BCHP_SDS_CL_0_FBLI                       0x012401ec /* Forward Backward Loop Filter Integrator */
#define BCHP_SDS_CL_0_FBPA                       0x012401f0 /* Forward Backward Loop Phase Accumulator */
#define BCHP_SDS_CL_0_CLDAFECTL                  0x012401f4 /* DAFE Loop Control */
#define BCHP_SDS_CL_0_DAFELI                     0x012401f8 /* DAFE Loop Filter Integrator */
#define BCHP_SDS_CL_0_DAFEINT                    0x012401fc /* DAFE Loop Filter Integrator */
