 ...
 ***************************************************************************/
#define BCHP_LBOX_0_REVISION_ID                  0x00622000 /* [RO] Chip Revision ID. */
#define BCHP_LBOX_0_CTRL                         0x00622004 /* [RW] OPERATIONS MODES (Control). */
#define BCHP_LBOX_0_CONFIGURATION                0x00622008 /* [RW] OPERATIONS MODES (Control). */
#define BCHP_LBOX_0_HORIZONTAL_WINDOW_REGION     0x0062200c /* [RW] Top/Bottom Horizontal Region (Control). */
#define BCHP_LBOX_0_VERTICAL_WINDOW_REGION       0x00622010 /* [RW] Left/Right Vertical Region (Control). */
#define BCHP_LBOX_0_PIXEL_THRESHOLD              0x00622014 /* [RW] Black Pixel Threshold (Control). */
#define BCHP_LBOX_0_BLACK_LINE_THRESHOLD_NTA     0x00622018 /* [RW] Black Line Threshold (Control - Number & Threshold Algorithm) */
#define BCHP_LBOX_0_BLACK_COL_THRESHOLD_NTA      0x0062201c /* [RW] Black Column Threshold (Control - Number & Threshold Algorithm) */
#define BCHP_LBOX_0_WHITE_LINE_THRESHOLD_NTA     0x00622020 /* [RW] White Line Threshold (Control - Number & Threshold Algorithm) */
#define BCHP_LBOX_0_WHITE_COL_THRESHOLD_NTA      0x00622024 /* [RW] White Column Threshold (Control - Number & Threshold Algorithm) */
#define BCHP_LBOX_0_BLACK_LINE_THRESHOLD_LSUM    0x00622028 /* [RW] Black Line Threshold (Control - Luma Sum Algorithm) */
#define BCHP_LBOX_0_WHITE_LINE_THRESHOLD_LSUM    0x0062202c /* [RW] White Line Threshold (Control - Luma Sum Algorithm) */
#define BCHP_LBOX_0_NON_BLACK_LINE               0x00622030 /* [RO] First/Last Non-Black Line (Status - Number & Threshold and Luma Sum Algorithms) */
#define BCHP_LBOX_0_FIRST_WHITE_LINE             0x00622034 /* [RO] First White Line Statistics (Status - Number & Threshold and Luma Sum Algorithms) */
#define BCHP_LBOX_0_LAST_WHITE_LINE              0x00622038 /* [RO] Last White Line Statistics (Status - Number & Threshold and Luma Sum Algorithms) */
#define BCHP_LBOX_0_MINMAX_NON_BLACK_LINES       0x0062203c /* [RO] Min/Max Non-Black Line (Status - Number & Threshold and Luma Sum Algorithms) */
#define BCHP_LBOX_0_MIN_WHITE_LINE               0x00622040 /* [RO] Minimum First White Line Statistics (Status - Number & Threshold and Luma Sum Algorithms) */
#define BCHP_LBOX_0_MAX_WHITE_LINE               0x00622044 /* [RO] Maximum Last White Line Statistics (Status - Number & Threshold and Luma Sum Algorithms) */
#define BCHP_LBOX_0_NON_BLACK_COL                0x00622048 /* [RO] First/Last Non-Black Column (Status - Number & Threshold Algorithm) */
#define BCHP_LBOX_0_FIRST_WHITE_COL              0x0062204c /* [RO] First White Column Statistics (Status - Number & Threshold Algorithm) */
#define BCHP_LBOX_0_LAST_WHITE_COL               0x00622050 /* [RO] Last White Column Statistics (Status - Number & Threshold Algorithm) */
#define BCHP_LBOX_0_MINMAX_NON_BLACK_COL         0x00622054 /* [RO] Min/Max Non-Black Column (Status - Number & Threshold Algorithm) */
#define BCHP_LBOX_0_MIN_WHITE_COL                0x00622058 /* [RO] Minimum First White Column Statistics (Status - Number & Threshold Algorithm) */
#define BCHP_LBOX_0_MAX_WHITE_COL                0x0062205c /* [RO] Maximum Last White Column Statistics (Status - Number & Threshold Algorithm) */
#define BCHP_LBOX_0_MIN_LUMA_VALUE               0x00622060 /* [RO] The minimum luma value over all time (Control). */
#define BCHP_LBOX_0_CLEAR_STATUS                 0x0062206c /* [WO] Clear all of the Status registers. */
#define BCHP_LBOX_0_SCRATCH                      0x00622070 /* [RW] Reserved Register For Future Use. */
