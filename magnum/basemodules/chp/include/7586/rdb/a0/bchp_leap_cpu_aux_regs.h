 ...
 ***************************************************************************/
#define BCHP_LEAP_CPU_AUX_REGS_STATUS            0x010c0000 /* [RO] Auxiliary Register STATUS */
#define BCHP_LEAP_CPU_AUX_REGS_SEMAPHORE         0x010c0004 /* [RW] Inter-process/Host semaphore register */
#define BCHP_LEAP_CPU_AUX_REGS_LP_START          0x010c0008 /* [RW] Loop start address (32-bit) */
#define BCHP_LEAP_CPU_AUX_REGS_LP_END            0x010c000c /* [RW] Loop end address (32-bit) */
#define BCHP_LEAP_CPU_AUX_REGS_IDENTITY          0x010c0010 /* [RO] Processor Identification register */
#define BCHP_LEAP_CPU_AUX_REGS_DEBUG             0x010c0014 /* [RW] Debug register */
#define BCHP_LEAP_CPU_AUX_REGS_PC                0x010c0018 /* [RO] Program Counter register (32-bit) */
#define BCHP_LEAP_CPU_AUX_REGS_STATUS32          0x010c0028 /* [RO] Status register (32-bit) */
#define BCHP_LEAP_CPU_AUX_REGS_STATUS32_L1       0x010c002c /* [RW] Status register save for level 1 interrupts */
#define BCHP_LEAP_CPU_AUX_REGS_STATUS32_L2       0x010c0030 /* [RW] Status register save for level 2 interrupts */
#define BCHP_LEAP_CPU_AUX_REGS_IC_IVIC           0x010c0040 /* [WO] Invalidate cache */
#define BCHP_LEAP_CPU_AUX_REGS_IC_CTRL           0x010c0044 /* [RW] Cache Control Register */
#define BCHP_LEAP_CPU_AUX_REGS_IC_LIL            0x010c004c /* [WO] Lock instruction line */
#define BCHP_LEAP_CPU_AUX_REGS_AUX_DCCM          0x010c0060 /* [WO] Address of Local RAM */
#define BCHP_LEAP_CPU_AUX_REGS_IC_IVIL           0x010c0064 /* [WO] Invalidate instruction line */
#define BCHP_LEAP_CPU_AUX_REGS_TIMER0_COUNT      0x010c0084 /* [RW] Processor Timer0 Control value */
#define BCHP_LEAP_CPU_AUX_REGS_TIMER0_CONTROL    0x010c0088 /* [RW] Processor Timer0 Count value */
#define BCHP_LEAP_CPU_AUX_REGS_TIMER0_LIMIT      0x010c008c /* [RW] Processor Timer0 Limit value */
#define BCHP_LEAP_CPU_AUX_REGS_INT_VEC_BASE      0x010c0094 /* [RW] Interrupt Vector Base address */
#define BCHP_LEAP_CPU_AUX_REGS_AUX_IRQ_LV12      0x010c010c /* [RW] Interrupt Level Status */
#define BCHP_LEAP_CPU_AUX_REGS_DC_IVDC           0x010c011c /* [WO] Invalidate cache */
#define BCHP_LEAP_CPU_AUX_REGS_DC_CTRL           0x010c0120 /* [RW] Cache Control register */
#define BCHP_LEAP_CPU_AUX_REGS_DC_LDL            0x010c0124 /* [RW] Lock data line at this address */
#define BCHP_LEAP_CPU_AUX_REGS_DC_IVDL           0x010c0128 /* [RW] Invalidate data line */
#define BCHP_LEAP_CPU_AUX_REGS_DC_FLSH           0x010c012c /* [RW] Flush data cache */
#define BCHP_LEAP_CPU_AUX_REGS_DC_FLDL           0x010c0130 /* [RW] Flush data line */
#define BCHP_LEAP_CPU_AUX_REGS_DC_RAM_ADDR       0x010c0160 /* [RW] External Address RAM address */
#define BCHP_LEAP_CPU_AUX_REGS_DC_TAG            0x010c0164 /* [RW] Tag Access */
#define BCHP_LEAP_CPU_AUX_REGS_DC_WP             0x010c0168 /* [RW] Way Pointer Access */
#define BCHP_LEAP_CPU_AUX_REGS_DC_DATA           0x010c016c /* [RW] Data Accesse */
#define BCHP_LEAP_CPU_AUX_REGS_CRC_BUILD_BCR     0x010c0188 /* [RO] Build configuration register for CRC instruction. */
#define BCHP_LEAP_CPU_AUX_REGS_DVBF_BUILD        0x010c0190 /* [RO] Build configuration register for dual viterbi butterfly instruction. */
#define BCHP_LEAP_CPU_AUX_REGS_EXT_ARITH_BUILD   0x010c0194 /* [RO] Build configuration register to specify that the processor has the extended arithmetic instructions. */
#define BCHP_LEAP_CPU_AUX_REGS_DATASPACE         0x010c0198 /* [RO] Build configuration register for dataspace. */
#define BCHP_LEAP_CPU_AUX_REGS_MEMSUBSYS         0x010c019c /* [RO] Build configuration register for memory subsytem. */
#define BCHP_LEAP_CPU_AUX_REGS_VECBASE_AC_BUILD  0x010c01a0 /* [RO] Build configuration register for ARC600 interrupt vector base address. */
#define BCHP_LEAP_CPU_AUX_REGS_P_BASE_ADDR       0x010c01a4 /* [RO] Build configuration register for peripheral base address. */
#define BCHP_LEAP_CPU_AUX_REGS_MPU_BUILD         0x010c01b4 /* [RO] Build configuration register for memory protection unit. */
#define BCHP_LEAP_CPU_AUX_REGS_RF_BUILD          0x010c01b8 /* [RO] Build configuration register for register file. */
#define BCHP_LEAP_CPU_AUX_REGS_D_CACHE_BUILD     0x010c01c8 /* [RO] Build configuration register for data cache. */
#define BCHP_LEAP_CPU_AUX_REGS_MADI_BUILD        0x010c01cc /* [RO] Build configuration register for multiple ARC debug interface. */
#define BCHP_LEAP_CPU_AUX_REGS_DCCM_BUILD        0x010c01d0 /* [RO] Build configuration register for data closely coupled memory. */
#define BCHP_LEAP_CPU_AUX_REGS_TIMER_BUILD       0x010c01d4 /* [RO] Build configuration register for timers. */
#define BCHP_LEAP_CPU_AUX_REGS_AP_BUILD          0x010c01d8 /* [RO] Build configuration register for actionpoints. */
#define BCHP_LEAP_CPU_AUX_REGS_I_CACHE_BUILD     0x010c01dc /* [RO] Build configuration register for instruction cache. */
#define BCHP_LEAP_CPU_AUX_REGS_ICCM_BUILD        0x010c01e0 /* [RO] Build configuration register for instruction closely coupled memory. */
#define BCHP_LEAP_CPU_AUX_REGS_DSPRAM_BUILD      0x010c01e4 /* [RO] Build configuration register for XY memory. */
#define BCHP_LEAP_CPU_AUX_REGS_MAC_BUILD         0x010c01e8 /* [RO] Build configuration register for Xmac. */
#define BCHP_LEAP_CPU_AUX_REGS_MULTIPLY_BUILD    0x010c01ec /* [RO] Build configuration register for instruction closely coupled memory. */
#define BCHP_LEAP_CPU_AUX_REGS_SWAP_BUILD        0x010c01f0 /* [RO] Build configuration register for swap instruction. */
#define BCHP_LEAP_CPU_AUX_REGS_NORM_BUILD        0x010c01f4 /* [RO] Build configuration register for normalise instruction. */
#define BCHP_LEAP_CPU_AUX_REGS_MINMAX_BUILD      0x010c01f8 /* [RO] Build configuration register for min/max instruction. */
#define BCHP_LEAP_CPU_AUX_REGS_BARREL_BUILD      0x010c01fc /* [RO] Build configuration register for barrel shifter. */
#define BCHP_LEAP_CPU_AUX_REGS_ARC600_BUILD      0x010c0304 /* [RO] Build configuration register for ARC 600. */
#define BCHP_LEAP_CPU_AUX_REGS_AUX_SYSTEM_BUILD  0x010c0308 /* [RW] Build configuration register for AS221BD. */
#define BCHP_LEAP_CPU_AUX_REGS_MCD_BCR           0x010c0310 /* [RO] MCD configuration register for AS221BD. */
#define BCHP_LEAP_CPU_AUX_REGS_IFETCHQUEUE_BUILD 0x010c03f8 /* [RO] Build configuration register for the InstructionFetchQueue component. */
#define BCHP_LEAP_CPU_AUX_REGS_TIMER1_COUNT      0x010c0400 /* [RW] Processor Timer 1 Control value */
#define BCHP_LEAP_CPU_AUX_REGS_TIMER1_CONTROL    0x010c0404 /* [RW] Processor Timer 1 Count value */
#define BCHP_LEAP_CPU_AUX_REGS_TIMER1_LIMIT      0x010c0408 /* [RW] Processor Timer 1 Limit value */
#define BCHP_LEAP_CPU_AUX_REGS_AUX_IRQ_LEV       0x010c0800 /* [RW] Interrupt Level Programming */
#define BCHP_LEAP_CPU_AUX_REGS_AUX_IRQ_HINT      0x010c0804 /* [RW] Software Triggered Interrupt */
#define BCHP_LEAP_CPU_AUX_REGS_AUX_ALIGN_CTRL    0x010c0808 /* [RW] Memory Alignment Detection Control */
#define BCHP_LEAP_CPU_AUX_REGS_AUX_ALIGN_ADDR    0x010c080c /* [RO] Memory Alignment Detected Address */
#define BCHP_LEAP_CPU_AUX_REGS_AUX_ALIGN_SIZE    0x010c0810 /* [RO] Memory Alignment Detected Size */
#define BCHP_LEAP_CPU_AUX_REGS_AUX_INTER_CORE_INTERRUPT 0x010c0a00 /* [RO] Inter-core Interrupt Register */
#define BCHP_LEAP_CPU_AUX_REGS_AX_IPC_SEM_N      0x010c0a04 /* [RO] Inter-core Sempahore Register */
#define BCHP_LEAP_CPU_AUX_REGS_AUX_INTER_CORE_ACK 0x010c0a08 /* [RO] Inter-core Interrupt Acknowledge Register */
#define BCHP_LEAP_CPU_AUX_REGS_MPUEN             0x010c1024 /* [RW] MPU Enable */
#define BCHP_LEAP_CPU_AUX_REGS_MPUIC             0x010c1080 /* [RO] MPU Interrupt Cause */
#define BCHP_LEAP_CPU_AUX_REGS_MPUFA             0x010c1084 /* [RO] MPU Fault Address */
#define BCHP_LEAP_CPU_AUX_REGS_MPURDB0           0x010c1088 /* [RW] MPU Region Descriptor Base 0 */
#define BCHP_LEAP_CPU_AUX_REGS_MPURDP0           0x010c108c /* [RW] MPU Region Descriptor Permissions 0 */
#define BCHP_LEAP_CPU_AUX_REGS_MPURDB1           0x010c1090 /* [RW] MPU Region Descriptor Base 1 */
#define BCHP_LEAP_CPU_AUX_REGS_MPURDP1           0x010c1094 /* [RW] MPU Region Descriptor Permissions 1 */
#define BCHP_LEAP_CPU_AUX_REGS_MPURDB2           0x010c1098 /* [RW] MPU Region Descriptor Base 2 */
#define BCHP_LEAP_CPU_AUX_REGS_MPURDP2           0x010c109c /* [RW] MPU Region Descriptor Permissions 2 */
#define BCHP_LEAP_CPU_AUX_REGS_MPURDB3           0x010c10a0 /* [RW] MPU Region Descriptor Base 3 */
#define BCHP_LEAP_CPU_AUX_REGS_MPURDP3           0x010c10a4 /* [RW] MPU Region Descriptor Permissions 3 */
#define BCHP_LEAP_CPU_AUX_REGS_MPURDB4           0x010c10a8 /* [RW] MPU Region Descriptor Base 4 */
#define BCHP_LEAP_CPU_AUX_REGS_MPURDP4           0x010c10ac /* [RW] MPU Region Descriptor Permissions 4 */
#define BCHP_LEAP_CPU_AUX_REGS_MPURDB5           0x010c10b0 /* [RW] MPU Region Descriptor Base 5 */
#define BCHP_LEAP_CPU_AUX_REGS_MPURDP5           0x010c10b4 /* [RW] MPU Region Descriptor Permissions 5 */
#define BCHP_LEAP_CPU_AUX_REGS_MPURDB6           0x010c10b8 /* [RW] MPU Region Descriptor Base 6 */
#define BCHP_LEAP_CPU_AUX_REGS_MPURDP6           0x010c10bc /* [RW] MPU Region Descriptor Permissions 6 */
#define BCHP_LEAP_CPU_AUX_REGS_MPURDB7           0x010c10c0 /* [RW] MPU Region Descriptor Base 7 */
#define BCHP_LEAP_CPU_AUX_REGS_MPURDP7           0x010c10c4 /* [RW] MPU Region Descriptor Permissions 7 */
