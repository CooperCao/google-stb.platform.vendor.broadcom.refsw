 ...
 ***************************************************************************/
#define BCHP_PCIE_0_DMA_TX_FIRST_DESC_L_ADDR_LIST0 0x00474400 /* [RW] Tx Descriptor List0 First Descriptor lower Address */
#define BCHP_PCIE_0_DMA_TX_FIRST_DESC_U_ADDR_LIST0 0x00474404 /* [RW] Tx Descriptor List0 First Descriptor Upper Address */
#define BCHP_PCIE_0_DMA_TX_FIRST_DESC_L_ADDR_LIST1 0x00474408 /* [RW] Tx Descriptor List1 First Descriptor Lower Address */
#define BCHP_PCIE_0_DMA_TX_FIRST_DESC_U_ADDR_LIST1 0x0047440c /* [RW] Tx Descriptor List1 First Descriptor Upper Address */
#define BCHP_PCIE_0_DMA_TX_SW_DESC_LIST_CTRL_STS 0x00474410 /* [RW] Tx Software Descriptor List Control and Status */
#define BCHP_PCIE_0_DMA_TX_WAKE_CTRL             0x00474414 /* [RW] Tx Wake Control */
#define BCHP_PCIE_0_DMA_TX_ERROR_STATUS          0x00474418 /* [RW] Tx Engine Error Status */
#define BCHP_PCIE_0_DMA_TX_LIST0_CUR_DESC_L_ADDR 0x0047441c /* [RO] Tx List0 Current Descriptor Lower Address */
#define BCHP_PCIE_0_DMA_TX_LIST0_CUR_DESC_U_ADDR 0x00474420 /* [RO] Tx List0 Current Descriptor Upper Address */
#define BCHP_PCIE_0_DMA_TX_LIST0_CUR_BYTE_CNT    0x00474424 /* [RO] Tx List0 Current Descriptor Byte Count */
#define BCHP_PCIE_0_DMA_TX_LIST1_CUR_DESC_L_ADDR 0x00474428 /* [RO] Tx List1 Current Descriptor Lower Address */
#define BCHP_PCIE_0_DMA_TX_LIST1_CUR_DESC_U_ADDR 0x0047442c /* [RO] Tx List1 Current Descriptor Upper Address */
#define BCHP_PCIE_0_DMA_TX_LIST1_CUR_BYTE_CNT    0x00474430 /* [RO] Tx List1 Current Descriptor Byte Count */
#define BCHP_PCIE_0_DMA_RX_FIRST_DESC_L_ADDR_LIST0 0x00474434 /* [RW] Rx Descriptor List0 First Descriptor Lower Address */
#define BCHP_PCIE_0_DMA_RX_FIRST_DESC_U_ADDR_LIST0 0x00474438 /* [RW] Rx Descriptor List0 First Descriptor Upper Address */
#define BCHP_PCIE_0_DMA_RX_FIRST_DESC_L_ADDR_LIST1 0x0047443c /* [RW] Rx Descriptor List1 First Descriptor Lower Address */
#define BCHP_PCIE_0_DMA_RX_FIRST_DESC_U_ADDR_LIST1 0x00474440 /* [RW] Rx Descriptor List1 First Descriptor Upper Address */
#define BCHP_PCIE_0_DMA_RX_SW_DESC_LIST_CTRL_STS 0x00474444 /* [RW] Rx Software Descriptor List Control and Status */
#define BCHP_PCIE_0_DMA_RX_WAKE_CTRL             0x00474448 /* [RW] Rx DMA Wake Control */
#define BCHP_PCIE_0_DMA_RX_ERROR_STATUS          0x0047444c /* [RW] Rx Engine Error Status */
#define BCHP_PCIE_0_DMA_RX_LIST0_CUR_DESC_L_ADDR 0x00474450 /* [RO] Rx List0 Current Descriptor Lower Address */
#define BCHP_PCIE_0_DMA_RX_LIST0_CUR_DESC_U_ADDR 0x00474454 /* [RO] Rx List0 Current Descriptor Upper Address */
#define BCHP_PCIE_0_DMA_RX_LIST0_CUR_BYTE_CNT    0x00474458 /* [RO] Rx List0 Current Descriptor Byte Count */
#define BCHP_PCIE_0_DMA_RX_LIST1_CUR_DESC_L_ADDR 0x0047445c /* [RO] Rx List1 Current Descriptor Lower address */
#define BCHP_PCIE_0_DMA_RX_LIST1_CUR_DESC_U_ADDR 0x00474460 /* [RO] Rx List1 Current Descriptor Upper address */
#define BCHP_PCIE_0_DMA_RX_LIST1_CUR_BYTE_CNT    0x00474464 /* [RO] Rx List1 Current Descriptor Byte Count */
#define BCHP_PCIE_0_DMA_DMA_DEBUG_OPTIONS_REG    0x00474468 /* [RW] DMA Debug Options Register */
#define BCHP_PCIE_0_DMA_READ_CHANNEL_ERROR_STATUS 0x0047446c /* [RO] Read Channel Error Status */
