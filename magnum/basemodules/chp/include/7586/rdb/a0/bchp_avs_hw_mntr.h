...
#define BCHP_AVS_HW_MNTR_INTERRUPT_POW_WDOG_EN_2 0x004d2084 /* [RW] Software to program a mask(1 bit per PWD) to indicate which PWD signals may trigger an interrupt */
#define BCHP_AVS_HW_MNTR_INTERRUPT_POW_WDOG_EN_3 0x004d2088 /* [RW] Software to program a mask(1 bit per PWD) to indicate which PWD signals may trigger an interrupt */
