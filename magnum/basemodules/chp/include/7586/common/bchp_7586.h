 ...
 *
 ***************************************************************************/
#ifndef BCHP_7586_H__
#define BCHP_7586_H__
...
/***************************************************************************
Summary:
    Open a chip handle for Bcm7586 chip

Description:
    This function open a chip handle for Bcm7586 chip.

Input:
    hRegister - A valid Bcm7586 register handle previous open using BREG_Open.
