 ...
 ***************************************************************************/
#define BCHP_IT_1_IT_REV_ID                      0x006a2000 /* Revision ID register */
#define BCHP_IT_1_TG_CONFIG                      0x006a2004 /* Timing Generator Configuration Register */
#define BCHP_IT_1_ADDR_0_3                       0x006a2008 /* Timing Generator Address 0-3 Register */
#define BCHP_IT_1_ADDR_4_6                       0x006a200c /* Timing Generator Address 4-6 Register */
#define BCHP_IT_1_STACK_reg_0_1                  0x006a2010 /* General Lookup Registers 0&1 Register */
#define BCHP_IT_1_STACK_reg_2_3                  0x006a2014 /* General Lookup Registers 2&3 Register */
#define BCHP_IT_1_STACK_reg_4_5                  0x006a2018 /* General Lookup Registers 4&5 Register */
#define BCHP_IT_1_STACK_reg_6_7                  0x006a201c /* General Lookup Registers 6&7 Register */
#define BCHP_IT_1_EVENT_SELECTION                0x006a2020 /* Timing Generator Event Selection Register. */
#define BCHP_IT_1_PCL_0                          0x006a2024 /* External Digital H/V Syncs and Negative Sync PCL Register. */
#define BCHP_IT_1_PCL_1                          0x006a2028 /* Color Burst and Bottles PCL Register. */
#define BCHP_IT_1_PCL_2                          0x006a202c /* External Digital H/V Syncs and U and V flip PCL Register. */
#define BCHP_IT_1_PCL_3                          0x006a2030 /* VSync, VBlank, Active Video and Odd/Even Field PCL Register. */
#define BCHP_IT_1_PCL_4                          0x006a2034 /* Positive Sync A/B PCL Register. */
#define BCHP_IT_1_PCL_5                          0x006a2038 /* Patten Generation PCL Register. */
#define BCHP_IT_1_PCL_6                          0x006a203c /* Positive Sync C/D PCL Register. */
#define BCHP_IT_1_PCL_7                          0x006a2040 /* Negative Sync D1 PCL Register. */
#define BCHP_IT_1_PCL_8                          0x006a2044 /* Negative Sync D2 PCL Register. */
#define BCHP_IT_1_STACK_reg_8_9                  0x006a2048 /* General Lookup Registers 8&9 Register */
#define BCHP_IT_1_BVB_SIZE                       0x006a204c /* BVB Size Register. */
#define BCHP_IT_1_BVB_RSTATUS                    0x006a2050 /* BVB status read Register. */
#define BCHP_IT_1_BVB_CSTATUS                    0x006a2054 /* BVB status clear Register. */
#define BCHP_IT_1_VEC_TRIGGER_0                  0x006a2058 /* VEC Trigger Register 0 */
#define BCHP_IT_1_VEC_TRIGGER_1                  0x006a205c /* VEC Trigger Register 1 */
#define BCHP_IT_1_VEC_CTRL_STAT                  0x006a2060 /* VEC Control BUS Status Register */
#define BCHP_IT_1_IT_LCNTR                       0x006a2064 /* Line Counter Register */
#define BCHP_IT_1_ALT_RM_CNTRL                   0x006a2068 /* ALTERNATE RATE MANAGER CONTROL REGISTER */
#define BCHP_IT_1_CABLE_DETECT_SEL               0x006a206c /* Cable detect select register */
#define BCHP_IT_1_ACCESS_CNTRL                   0x006a2070 /* VEC Access Control Register */
#define BCHP_IT_1_ACCESS_STATUS                  0x006a2074 /* VEC Access Status Register */
#define BCHP_IT_1_MSYNC_CTRL                     0x006a21bc /* Master Sync Control */
#define BCHP_IT_1_SSYNC_CTRL                     0x006a21c0 /* Slave Sync Control */
#define BCHP_IT_1_MS_TIMEOUT                     0x006a21c4 /* Master Slave Time Out register */
#define BCHP_IT_1_MSSYNC_START                   0x006a21c8 /* Master Slave Sync Start */
#define BCHP_IT_1_MSSYNC_PCL                     0x006a21cc /* Master Slave flag select PCL */
#define BCHP_IT_1_MSYNC_PHASE                    0x006a21d0 /* Master Sync Phase */
#define BCHP_IT_1_EOF0_LINE                      0x006a21d4 /* Field0 End line number for interlaced format */
#define BCHP_IT_1_MSSYNC_STATUS                  0x006a21d8 /* "Status register for MSSYNC" */
#define BCHP_IT_1_AS_CONTROL                     0x006a22b4 /* Active Space Control register */
#define BCHP_IT_1_AS_PIXEL_C0_C1                 0x006a22b8 /* Active Space Pixel Value Register */
#define BCHP_IT_1_AS_PIXEL_C2                    0x006a22bc /* Active Space Pixel Value Register */
#define BCHP_IT_1_AS_LINE_NUMBER                 0x006a22c0 /* Active Space Line Number Register */
