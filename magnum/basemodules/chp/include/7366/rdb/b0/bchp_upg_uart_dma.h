 ...
 ***************************************************************************/
#define BCHP_UPG_UART_DMA_CONTROL                0x0040b0c0 /* UART DMA CONTROL REGISTER */
#define BCHP_UPG_UART_DMA_TX_BUF_PTR_LO          0x0040b0c4 /* STARTING ADDRESS OF DATA TO BE WRITTEN TO UART */
#define BCHP_UPG_UART_DMA_TX_BUF_PTR_HI          0x0040b0c8 /* STARTING ADDRESS OF DATA TO BE WRITTEN TO UART */
#define BCHP_UPG_UART_DMA_RX_BUF_PTR_LO          0x0040b0cc /* STARTING ADDRESS OF BUFFER FOR DATA READ FROM UART */
#define BCHP_UPG_UART_DMA_RX_BUF_PTR_HI          0x0040b0d0 /* STARTING ADDRESS OF BUFFER FOR DATA READ FROM UART */
#define BCHP_UPG_UART_DMA_TX_CTRL                0x0040b0d4 /* UART TRANSMIT CONTROL */
#define BCHP_UPG_UART_DMA_RX_CTRL                0x0040b0d8 /* UART RECEIVE CONTROL */
#define BCHP_UPG_UART_DMA_TX_DST_ADDR            0x0040b0dc /* UART DMA TRANSMIT DESTINATION ADDRESS */
#define BCHP_UPG_UART_DMA_RX_SRC_ADDR            0x0040b0e0 /* UART DMA RECEIVE SOURCE ADDRESS */
#define BCHP_UPG_UART_DMA_TX_STATUS              0x0040b0e4 /* UART DMA TRANSMIT STATUS REGISTER */
#define BCHP_UPG_UART_DMA_RX_STATUS              0x0040b0e8 /* UART DMA RECEIVE STATUS REGISTER */
#define BCHP_UPG_UART_DMA_TX_REQ_SEL             0x0040b0ec /* UART SELECT FOR TRANSMIT */
#define BCHP_UPG_UART_DMA_RX_REQ_SEL             0x0040b0f0 /* UART SELECT FOR RECEIVE */
