 ...
 ***************************************************************************/
#define BCHP_HD_ANR_AND_0_REVISION_ID            0x00645800 /* AND Revision register */
#define BCHP_HD_ANR_AND_0_SW_RESET               0x00645804 /* AND Software Reset */
#define BCHP_HD_ANR_AND_0_AND_ENABLE             0x00645808 /* AND Enable */
#define BCHP_HD_ANR_AND_0_AND_MODE               0x0064580c /* AND Window Size */
#define BCHP_HD_ANR_AND_0_NOISE_LOWER_TH_0       0x00645810 /* Noise Range Lower Threshold 0 */
#define BCHP_HD_ANR_AND_0_NOISE_LOWER_TH_1       0x00645814 /* Noise Range Lower Threshold 1 */
#define BCHP_HD_ANR_AND_0_NOISE_LOWER_TH_2       0x00645818 /* Noise Range Lower Threshold 2 */
#define BCHP_HD_ANR_AND_0_NOISE_LOWER_TH_3       0x0064581c /* Noise Range Lower Threshold 3 */
#define BCHP_HD_ANR_AND_0_NOISE_LOWER_TH_4       0x00645820 /* Noise Range Lower Threshold 4 */
#define BCHP_HD_ANR_AND_0_NOISE_UPPER_TH_0       0x00645824 /* Noise Range upper Threshold 0 */
#define BCHP_HD_ANR_AND_0_NOISE_UPPER_TH_1       0x00645828 /* Noise Range upper Threshold 1 */
#define BCHP_HD_ANR_AND_0_NOISE_UPPER_TH_2       0x0064582c /* Noise Range upper Threshold 2 */
#define BCHP_HD_ANR_AND_0_NOISE_UPPER_TH_3       0x00645830 /* Noise Range upper Threshold 3 */
#define BCHP_HD_ANR_AND_0_NOISE_UPPER_TH_4       0x00645834 /* Noise Range upper Threshold 4 */
#define BCHP_HD_ANR_AND_0_EDGE_TH                0x00645838 /* Edge gradient threshold */
#define BCHP_HD_ANR_AND_0_CONTENT_TH             0x0064583c /* Content level threshold */
#define BCHP_HD_ANR_AND_0_NOISY_SAMPLE_NUM_BIN_0 0x00645840 /* Number of noisy pixel in frame for noise level category 0 */
#define BCHP_HD_ANR_AND_0_NOISY_SAMPLE_NUM_BIN_1 0x00645844 /* Number of noisy pixel in frame for noise level category 1 */
#define BCHP_HD_ANR_AND_0_NOISY_SAMPLE_NUM_BIN_2 0x00645848 /* Number of noisy pixel in frame for noise level category 2 */
#define BCHP_HD_ANR_AND_0_NOISY_SAMPLE_NUM_BIN_3 0x0064584c /* Number of noisy pixel in frame for noise level category 3 */
#define BCHP_HD_ANR_AND_0_NOISY_SAMPLE_NUM_BIN_4 0x00645850 /* Number of noisy pixel in frame for noise level category 4 */
#define BCHP_HD_ANR_AND_0_NOISE_LEVEL_0_MSB      0x00645854 /* The means result of noise category 0 (MSB) */
#define BCHP_HD_ANR_AND_0_NOISE_LEVEL_0_LSB      0x00645858 /* The means result of noise category 0 (LSB) */
#define BCHP_HD_ANR_AND_0_NOISE_LEVEL_1_MSB      0x0064585c /* The means result of noise category 1 (MSB) */
#define BCHP_HD_ANR_AND_0_NOISE_LEVEL_1_LSB      0x00645860 /* The means result of noise category 1 (LSB) */
#define BCHP_HD_ANR_AND_0_NOISE_LEVEL_2_MSB      0x00645864 /* The means result of noise category 2 (MSB) */
#define BCHP_HD_ANR_AND_0_NOISE_LEVEL_2_LSB      0x00645868 /* The means result of noise category 2 (LSB) */
#define BCHP_HD_ANR_AND_0_NOISE_LEVEL_3_MSB      0x0064586c /* The means result of noise category 3 (MSB) */
#define BCHP_HD_ANR_AND_0_NOISE_LEVEL_3_LSB      0x00645870 /* The means result of noise category 3 (LSB) */
#define BCHP_HD_ANR_AND_0_NOISE_LEVEL_4_MSB      0x00645874 /* The means result of noise category 4 (MSB) */
#define BCHP_HD_ANR_AND_0_NOISE_LEVEL_4_LSB      0x00645878 /* The means result of noise category 4 (LSB) */
#define BCHP_HD_ANR_AND_0_X_LOWER_0              0x0064587c /* The lower boundary for statistics collection at horizontal direction */
#define BCHP_HD_ANR_AND_0_X_UPPER_0              0x00645880 /* The upper boundary for statistics collection at horizontal direction */
#define BCHP_HD_ANR_AND_0_Y_LOWER_0              0x00645884 /* The lower boundary for statistics collection at vertical direction */
#define BCHP_HD_ANR_AND_0_Y_UPPER_0              0x00645888 /* The upper boundary for statistics collection at vertical direction */
