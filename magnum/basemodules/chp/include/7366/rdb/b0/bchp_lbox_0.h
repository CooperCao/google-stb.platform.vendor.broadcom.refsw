 ...
 ***************************************************************************/
#define BCHP_LBOX_0_REVISION_ID                  0x00624000 /* Chip Revision ID. */
#define BCHP_LBOX_0_CTRL                         0x00624004 /* OPERATIONS MODES (Control). */
#define BCHP_LBOX_0_CONFIGURATION                0x00624008 /* OPERATIONS MODES (Control). */
#define BCHP_LBOX_0_HORIZONTAL_WINDOW_REGION     0x0062400c /* Top/Bottom Horizontal Region (Control). */
#define BCHP_LBOX_0_VERTICAL_WINDOW_REGION       0x00624010 /* Left/Right Vertical Region (Control). */
#define BCHP_LBOX_0_PIXEL_THRESHOLD              0x00624014 /* Black Pixel Threshold (Control). */
#define BCHP_LBOX_0_BLACK_LINE_THRESHOLD_NTA     0x00624018 /* Black Line Threshold (Control - Number & Threshold Algorithm) */
#define BCHP_LBOX_0_BLACK_COL_THRESHOLD_NTA      0x0062401c /* Black Column Threshold (Control - Number & Threshold Algorithm) */
#define BCHP_LBOX_0_WHITE_LINE_THRESHOLD_NTA     0x00624020 /* White Line Threshold (Control - Number & Threshold Algorithm) */
#define BCHP_LBOX_0_WHITE_COL_THRESHOLD_NTA      0x00624024 /* White Column Threshold (Control - Number & Threshold Algorithm) */
#define BCHP_LBOX_0_BLACK_LINE_THRESHOLD_LSUM    0x00624028 /* Black Line Threshold (Control - Luma Sum Algorithm) */
#define BCHP_LBOX_0_WHITE_LINE_THRESHOLD_LSUM    0x0062402c /* White Line Threshold (Control - Luma Sum Algorithm) */
#define BCHP_LBOX_0_NON_BLACK_LINE               0x00624030 /* First/Last Non-Black Line (Status - Number & Threshold and Luma Sum Algorithms) */
#define BCHP_LBOX_0_FIRST_WHITE_LINE             0x00624034 /* First White Line Statistics (Status - Number & Threshold and Luma Sum Algorithms) */
#define BCHP_LBOX_0_LAST_WHITE_LINE              0x00624038 /* Last White Line Statistics (Status - Number & Threshold and Luma Sum Algorithms) */
#define BCHP_LBOX_0_MINMAX_NON_BLACK_LINES       0x0062403c /* Min/Max Non-Black Line (Status - Number & Threshold and Luma Sum Algorithms) */
#define BCHP_LBOX_0_MIN_WHITE_LINE               0x00624040 /* Minimum First White Line Statistics (Status - Number & Threshold and Luma Sum Algorithms) */
#define BCHP_LBOX_0_MAX_WHITE_LINE               0x00624044 /* Maximum Last White Line Statistics (Status - Number & Threshold and Luma Sum Algorithms) */
#define BCHP_LBOX_0_NON_BLACK_COL                0x00624048 /* First/Last Non-Black Column (Status - Number & Threshold Algorithm) */
#define BCHP_LBOX_0_FIRST_WHITE_COL              0x0062404c /* First White Column Statistics (Status - Number & Threshold Algorithm) */
#define BCHP_LBOX_0_LAST_WHITE_COL               0x00624050 /* Last White Column Statistics (Status - Number & Threshold Algorithm) */
#define BCHP_LBOX_0_MINMAX_NON_BLACK_COL         0x00624054 /* Min/Max Non-Black Column (Status - Number & Threshold Algorithm) */
#define BCHP_LBOX_0_MIN_WHITE_COL                0x00624058 /* Minimum First White Column Statistics (Status - Number & Threshold Algorithm) */
#define BCHP_LBOX_0_MAX_WHITE_COL                0x0062405c /* Maximum Last White Column Statistics (Status - Number & Threshold Algorithm) */
#define BCHP_LBOX_0_MIN_LUMA_VALUE               0x00624060 /* The minimum luma value over all time (Control). */
#define BCHP_LBOX_0_CLEAR_STATUS                 0x0062406c /* Clear all of the Status registers. */
#define BCHP_LBOX_0_SCRATCH                      0x00624070 /* Reserved Register For Future Use. */
