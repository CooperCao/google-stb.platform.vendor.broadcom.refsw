 ...
 ***************************************************************************/
#define BCHP_MCIF_CONTROL                        0x0040aa40 /* MCIF CONTROL REGISTER */
#define BCHP_MCIF_TX_BUF_PTR_LO                  0x0040aa44 /* STARTING ADDRESS OF DATA TO BE WRITTEN TO M-CARD */
#define BCHP_MCIF_TX_BUF_PTR_HI                  0x0040aa48 /* STARTING ADDRESS OF DATA TO BE WRITTEN TO M-CARD */
#define BCHP_MCIF_RX_BUF_PTR_LO                  0x0040aa4c /* STARTING ADDRESS OF BUFFER FOR DATA READ FROM M-CARD */
#define BCHP_MCIF_RX_BUF_PTR_HI                  0x0040aa50 /* STARTING ADDRESS OF BUFFER FOR DATA READ FROM M-CARD */
#define BCHP_MCIF_TX_LEN                         0x0040aa54 /* M-CARD WRITE LENGTH REGISTER */
#define BCHP_MCIF_TX_CTRL                        0x0040aa58 /* M-CARD WRITE CONTROL REGISTER */
#define BCHP_MCIF_RX_TEST                        0x0040aa5c /* M-CARD READ DATA STATUS FOR TEST */
#define BCHP_MCIF_RX_STATUS                      0x0040aa60 /* M-CARD HOST READY TO RECEIVE STATUS REGISTER */
#define BCHP_MCIF_RX_DATA_STATUS                 0x0040aa64 /* M-CARD READ DATA STATUS REGISTER */
#define BCHP_MCIF_SPARE                          0x0040aa68 /* RESERVED */
