 ...
 *XPT_MEMDMA_XMEMIF
 ***************************************************************************/
#define BCHP_XPT_MEMDMA_XMEMIF_SCB_WR_ARB_SEL_WDMA_DATA 0x00a6ff00 /* SCB Write Client select register for Write_DMA Data */
#define BCHP_XPT_MEMDMA_XMEMIF_SCB_RD_ARB_SEL_WDMA_DESC 0x00a6ff14 /* SCB Read Client select register for RSBUFF */
#define BCHP_XPT_MEMDMA_XMEMIF_SCB_RD_ARB_SEL_MCPB0_DESC 0x00a6ff2c /* SCB Read Client select register for Playback0 */
#define BCHP_XPT_MEMDMA_XMEMIF_SCB_RD_ARB_SEL_MCPB0_DATA 0x00a6ff30 /* SCB Read Client select register for Playback1 */
#define BCHP_XPT_MEMDMA_XMEMIF_SCB_WR_ARB_MODE   0x00a6ff54 /* SCB Write Client Arbiter Mode Control */
#define BCHP_XPT_MEMDMA_XMEMIF_SCB_RD_ARB_MODE   0x00a6ff58 /* SCB Read Client Arbiter Mode Control */
#define BCHP_XPT_MEMDMA_XMEMIF_INTR_STATUS_REG   0x00a6ff5c /* Interrupt Status Register */
#define BCHP_XPT_MEMDMA_XMEMIF_INTR_STATUS_REG_EN 0x00a6ff60 /* Interrupt Status Enable Register */
#define BCHP_XPT_MEMDMA_XMEMIF_WR_DEBUG          0x00a6ff6c /* Debug and Test register for XMEMIF write */
#define BCHP_XPT_MEMDMA_XMEMIF_RD_DEBUG0         0x00a6ff70 /* Debug and Test register for XMEMIF read */
#define BCHP_XPT_MEMDMA_XMEMIF_RD_DEBUG1         0x00a6ff74 /* Debug and Test register for XMEMIF read */
#define BCHP_XPT_MEMDMA_XMEMIF_WR_RDY_ACCEPT_STATUS 0x00a6ff78 /* Ready Accept Status On the Wr XMEM interface */
#define BCHP_XPT_MEMDMA_XMEMIF_RD_RDY_ACCEPT_STATUS 0x00a6ff7c /* Ready Accept Status On the RD XMEM interface */
#define BCHP_XPT_MEMDMA_XMEMIF_RD_RDY_ACCEPT_PB_LCTOXMEM 0x00a6ff80 /* Ready Accept Status on the RD XMEM interface for Playback LC to xmem */
#define BCHP_XPT_MEMDMA_XMEMIF_RD_RDY_ACCEPT_PB_XMEMTOLC 0x00a6ff84 /* Ready Accept Status On the RD XMEM interface for Playback xmem to LC */
#define BCHP_XPT_MEMDMA_XMEMIF_SEC_REGION_CTRL   0x00a6ff8c /* DRAM Secured Address Range1-7 status */
#define BCHP_XPT_MEMDMA_XMEMIF_SEC_REGION1_START_LO 0x00a6ff90 /* DRAM Secured Address Range1 Start (LSbs) */
#define BCHP_XPT_MEMDMA_XMEMIF_SEC_REGION1_START_HI 0x00a6ff94 /* DRAM Secured Address Range1 Start (MSbs) */
#define BCHP_XPT_MEMDMA_XMEMIF_SEC_REGION1_END_LO 0x00a6ff98 /* DRAM Secured Address Range1 Start (LSbs) */
#define BCHP_XPT_MEMDMA_XMEMIF_SEC_REGION1_END_HI 0x00a6ff9c /* DRAM Secured Address Range1 Start (MSbs) */
#define BCHP_XPT_MEMDMA_XMEMIF_SEC_REGION2_START_LO 0x00a6ffa0 /* DRAM Secured Address Range2 Start (LSbs) */
#define BCHP_XPT_MEMDMA_XMEMIF_SEC_REGION2_START_HI 0x00a6ffa4 /* DRAM Secured Address Range2 Start (MSbs) */
#define BCHP_XPT_MEMDMA_XMEMIF_SEC_REGION2_END_LO 0x00a6ffa8 /* DRAM Secured Address Range2 Start (LSbs) */
#define BCHP_XPT_MEMDMA_XMEMIF_SEC_REGION2_END_HI 0x00a6ffac /* DRAM Secured Address Range2 Start (MSbs) */
#define BCHP_XPT_MEMDMA_XMEMIF_SEC_REGION3_START_LO 0x00a6ffb0 /* DRAM Secured Address Range3 Start (LSbs) */
#define BCHP_XPT_MEMDMA_XMEMIF_SEC_REGION3_START_HI 0x00a6ffb4 /* DRAM Secured Address Range3 Start (MSbs) */
#define BCHP_XPT_MEMDMA_XMEMIF_SEC_REGION3_END_LO 0x00a6ffb8 /* DRAM Secured Address Range3 Start (LSbs) */
#define BCHP_XPT_MEMDMA_XMEMIF_SEC_REGION3_END_HI 0x00a6ffbc /* DRAM Secured Address Range3 Start (MSbs) */
#define BCHP_XPT_MEMDMA_XMEMIF_SEC_REGION4_START_LO 0x00a6ffc0 /* DRAM Secured Address Range4 Start (LSbs) */
#define BCHP_XPT_MEMDMA_XMEMIF_SEC_REGION4_START_HI 0x00a6ffc4 /* DRAM Secured Address Range4 Start (MSbs) */
#define BCHP_XPT_MEMDMA_XMEMIF_SEC_REGION4_END_LO 0x00a6ffc8 /* DRAM Secured Address Range4 Start (LSbs) */
#define BCHP_XPT_MEMDMA_XMEMIF_SEC_REGION4_END_HI 0x00a6ffcc /* DRAM Secured Address Range4 Start (MSbs) */
#define BCHP_XPT_MEMDMA_XMEMIF_SEC_REGION5_START_LO 0x00a6ffd0 /* DRAM Secured Address Range5 Start (LSbs) */
#define BCHP_XPT_MEMDMA_XMEMIF_SEC_REGION5_START_HI 0x00a6ffd4 /* DRAM Secured Address Range5 Start (MSbs) */
#define BCHP_XPT_MEMDMA_XMEMIF_SEC_REGION5_END_LO 0x00a6ffd8 /* DRAM Secured Address Range5 Start (LSbs) */
#define BCHP_XPT_MEMDMA_XMEMIF_SEC_REGION5_END_HI 0x00a6ffdc /* DRAM Secured Address Range5 Start (MSbs) */
#define BCHP_XPT_MEMDMA_XMEMIF_SEC_REGION6_START_LO 0x00a6ffe0 /* DRAM Secured Address Range6 Start (LSbs) */
#define BCHP_XPT_MEMDMA_XMEMIF_SEC_REGION6_START_HI 0x00a6ffe4 /* DRAM Secured Address Range6 Start (MSbs) */
#define BCHP_XPT_MEMDMA_XMEMIF_SEC_REGION6_END_LO 0x00a6ffe8 /* DRAM Secured Address Range6 Start (LSbs) */
#define BCHP_XPT_MEMDMA_XMEMIF_SEC_REGION6_END_HI 0x00a6ffec /* DRAM Secured Address Range6 Start (MSbs) */
#define BCHP_XPT_MEMDMA_XMEMIF_SEC_REGION7_START_LO 0x00a6fff0 /* DRAM Secured Address Range7 Start (LSbs) */
#define BCHP_XPT_MEMDMA_XMEMIF_SEC_REGION7_START_HI 0x00a6fff4 /* DRAM Secured Address Range7 Start (MSbs) */
#define BCHP_XPT_MEMDMA_XMEMIF_SEC_REGION7_END_LO 0x00a6fff8 /* DRAM Secured Address Range7 Start (LSbs) */
#define BCHP_XPT_MEMDMA_XMEMIF_SEC_REGION7_END_HI 0x00a6fffc /* DRAM Secured Address Range7 Start (MSbs) */
