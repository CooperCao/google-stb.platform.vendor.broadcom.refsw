 ...
 ***************************************************************************/
#define BCHP_SCPU_MISB_BRIDGE_CORE_REV_ID        0x00310400 /* MISB Bridge Revision ID Register. */
#define BCHP_SCPU_MISB_BRIDGE_EXCEPTION_VECTOR_OFFSET 0x00310404 /* "Exception Vector Offset Address" */
#define BCHP_SCPU_MISB_BRIDGE_PROCESSOR_ID       0x00310408 /* Processor ID Register. */
#define BCHP_SCPU_MISB_BRIDGE_WG_MODE_N_TIMEOUT  0x0031040c /* Write Gathering Mode & Timeout. */
#define BCHP_SCPU_MISB_BRIDGE_MISB_SPLIT_MODE    0x00310410 /* MISB Split Mode */
