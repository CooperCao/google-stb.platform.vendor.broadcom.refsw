 ...
 ***************************************************************************/
#define BCHP_XPT_XMEMIF_SCB_WR_ARB_SEL_RSBUFF    0x00a00100 /* SCB Write Client select register for RSBUFF */
#define BCHP_XPT_XMEMIF_SCB_WR_ARB_SEL_XCBUFF    0x00a00104 /* SCB Write Client select register for XCBUFF */
#define BCHP_XPT_XMEMIF_SCB_WR_ARB_SEL_RAVE_CDB  0x00a00108 /* SCB Write Client select register for RAVE CDB */
#define BCHP_XPT_XMEMIF_SCB_WR_ARB_SEL_RAVE_ITB  0x00a0010c /* SCB Write Client select register for RAVE ITB */
#define BCHP_XPT_XMEMIF_SCB_WR_ARB_SEL_MSG       0x00a00110 /* SCB Write Client select register for MESSAGE */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_RSBUFF    0x00a00114 /* SCB Read Client select register for RSBUFF */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_RSBUFF_MPOD 0x00a00118 /* SCB Read Client select register for RSBUFF MPOD */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_XCBUFF_RAVE 0x00a0011c /* SCB Read Client select register for XCBUFF RAVE */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_XCBUFF_RMX0 0x00a00120 /* SCB Read Client select register for XCBUFF RMX0 */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_XCBUFF_RMX1 0x00a00124 /* SCB Read Client select register for XCBUFF RMX1 */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_XCBUFF_MSG 0x00a00128 /* SCB Read Client select register for XCBUFF MSG */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_MCPB0_DESC 0x00a0012c /* SCB Read Client select register for MCPB0 Descriptor */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_MCPB0_DATA 0x00a00130 /* SCB Read Client select register for MCPB0 Data */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_RSBUFF_TSIO 0x00a00134 /* SCB Read Client select register for RSBUFF TSIO */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_PSUB      0x00a00150 /* SCB Read Client select register for PSUB */
#define BCHP_XPT_XMEMIF_SCB_WR_ARB_MODE          0x00a00154 /* SCB Write Client Arbiter Mode Control */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_MODE          0x00a00158 /* SCB Read Client Arbiter Mode Control */
#define BCHP_XPT_XMEMIF_INTR_STATUS_REG          0x00a0015c /* Interrupt Status Register */
#define BCHP_XPT_XMEMIF_INTR_STATUS_REG_EN       0x00a00160 /* Interrupt Status Enable Register */
#define BCHP_XPT_XMEMIF_WR_DEBUG                 0x00a0016c /* Debug and Test register for XMEMIF write */
#define BCHP_XPT_XMEMIF_RD_DEBUG0                0x00a00170 /* Debug and Test register for XMEMIF read */
#define BCHP_XPT_XMEMIF_RD_DEBUG1                0x00a00174 /* Debug and Test register for XMEMIF read */
#define BCHP_XPT_XMEMIF_WR_RDY_ACCEPT_STATUS     0x00a00178 /* Ready Accept Status On the Wr XMEM interface */
#define BCHP_XPT_XMEMIF_RD_RDY_ACCEPT_STATUS_CL0_6 0x00a0017c /* Ready Accept Status On the RD XMEM interface for CL0_6 */
#define BCHP_XPT_XMEMIF_RD_RDY_ACCEPT_PB_LCTOXMEM 0x00a00180 /* Ready Accept Status on the RD XMEM interface for Playback LC to xmem */
#define BCHP_XPT_XMEMIF_RD_RDY_ACCEPT_PB_XMEMTOLC 0x00a00184 /* Ready Accept Status On the RD XMEM interface for Playback xmem to LC */
#define BCHP_XPT_XMEMIF_SEC_REGION_CTRL          0x00a0018c /* DRAM Secured Address Range1-7 status */
#define BCHP_XPT_XMEMIF_SEC_REGION1_START_LO     0x00a00190 /* DRAM Secured Address Range1 Start (LSbs) */
#define BCHP_XPT_XMEMIF_SEC_REGION1_START_HI     0x00a00194 /* DRAM Secured Address Range1 Start (MSbs) */
#define BCHP_XPT_XMEMIF_SEC_REGION1_END_LO       0x00a00198 /* DRAM Secured Address Range1 Start (LSbs) */
#define BCHP_XPT_XMEMIF_SEC_REGION1_END_HI       0x00a0019c /* DRAM Secured Address Range1 Start (MSbs) */
#define BCHP_XPT_XMEMIF_SEC_REGION2_START_LO     0x00a001a0 /* DRAM Secured Address Range2 Start (LSbs) */
#define BCHP_XPT_XMEMIF_SEC_REGION2_START_HI     0x00a001a4 /* DRAM Secured Address Range2 Start (MSbs) */
#define BCHP_XPT_XMEMIF_SEC_REGION2_END_LO       0x00a001a8 /* DRAM Secured Address Range2 Start (LSbs) */
#define BCHP_XPT_XMEMIF_SEC_REGION2_END_HI       0x00a001ac /* DRAM Secured Address Range2 Start (MSbs) */
#define BCHP_XPT_XMEMIF_SEC_REGION3_START_LO     0x00a001b0 /* DRAM Secured Address Range3 Start (LSbs) */
#define BCHP_XPT_XMEMIF_SEC_REGION3_START_HI     0x00a001b4 /* DRAM Secured Address Range3 Start (MSbs) */
#define BCHP_XPT_XMEMIF_SEC_REGION3_END_LO       0x00a001b8 /* DRAM Secured Address Range3 Start (LSbs) */
#define BCHP_XPT_XMEMIF_SEC_REGION3_END_HI       0x00a001bc /* DRAM Secured Address Range3 Start (MSbs) */
#define BCHP_XPT_XMEMIF_SEC_REGION4_START_LO     0x00a001c0 /* DRAM Secured Address Range4 Start (LSbs) */
#define BCHP_XPT_XMEMIF_SEC_REGION4_START_HI     0x00a001c4 /* DRAM Secured Address Range4 Start (MSbs) */
#define BCHP_XPT_XMEMIF_SEC_REGION4_END_LO       0x00a001c8 /* DRAM Secured Address Range4 Start (LSbs) */
#define BCHP_XPT_XMEMIF_SEC_REGION4_END_HI       0x00a001cc /* DRAM Secured Address Range4 Start (MSbs) */
#define BCHP_XPT_XMEMIF_SEC_REGION5_START_LO     0x00a001d0 /* DRAM Secured Address Range5 Start (LSbs) */
#define BCHP_XPT_XMEMIF_SEC_REGION5_START_HI     0x00a001d4 /* DRAM Secured Address Range5 Start (MSbs) */
#define BCHP_XPT_XMEMIF_SEC_REGION5_END_LO       0x00a001d8 /* DRAM Secured Address Range5 Start (LSbs) */
#define BCHP_XPT_XMEMIF_SEC_REGION5_END_HI       0x00a001dc /* DRAM Secured Address Range5 Start (MSbs) */
#define BCHP_XPT_XMEMIF_SEC_REGION6_START_LO     0x00a001e0 /* DRAM Secured Address Range6 Start (LSbs) */
#define BCHP_XPT_XMEMIF_SEC_REGION6_START_HI     0x00a001e4 /* DRAM Secured Address Range6 Start (MSbs) */
#define BCHP_XPT_XMEMIF_SEC_REGION6_END_LO       0x00a001e8 /* DRAM Secured Address Range6 Start (LSbs) */
#define BCHP_XPT_XMEMIF_SEC_REGION6_END_HI       0x00a001ec /* DRAM Secured Address Range6 Start (MSbs) */
#define BCHP_XPT_XMEMIF_SEC_REGION7_START_LO     0x00a001f0 /* DRAM Secured Address Range7 Start (LSbs) */
#define BCHP_XPT_XMEMIF_SEC_REGION7_START_HI     0x00a001f4 /* DRAM Secured Address Range7 Start (MSbs) */
#define BCHP_XPT_XMEMIF_SEC_REGION7_END_LO       0x00a001f8 /* DRAM Secured Address Range7 Start (LSbs) */
#define BCHP_XPT_XMEMIF_SEC_REGION7_END_HI       0x00a001fc /* DRAM Secured Address Range7 Start (MSbs) */
