 ...
 *DCD_PIPE_CTL_0
 ***************************************************************************/
#define BCHP_DCD_PIPE_CTL_0_CORE_CONFIG          0x00126000 /* Decoder Core configuration information */
#define BCHP_DCD_PIPE_CTL_0_AVD_CLK_GATE         0x00126004 /* pipe clock gating */
#define BCHP_DCD_PIPE_CTL_0_SW_RESET_REG         0x00126008 /* Software reset register */
#define BCHP_DCD_PIPE_CTL_0_BLD_CLK_GATE         0x0012600c /* BLD pipe clock gating */
#define BCHP_DCD_PIPE_CTL_0_OUTPUT_CLIENT_SEL    0x00126010 /* Output SCB Client Selection */
#define BCHP_DCD_PIPE_CTL_0_MULTIPIPE_PFRI_ARB_CTL 0x00126014 /* Multipipe PFRI Arbiter Controls */
#define BCHP_DCD_PIPE_CTL_0_IL_RM2_ARB_TIMEOUT   0x00126024 /* RM2 ARBITER TIMEOUT Register */
#define BCHP_DCD_PIPE_CTL_0_IL_RM2_ARB_TIMEOUT_SEEN 0x00126028 /* Arbiter timeout detected */
#define BCHP_DCD_PIPE_CTL_0_IPCOMM_L2R_TRANSMIT  0x00126030 /* Inter-CPU L2R Transmit Data Register */
#define BCHP_DCD_PIPE_CTL_0_IPCOMM_L2R_RECEIVE   0x00126034 /* Inter-CPU L2R Receive Data Register */
#define BCHP_DCD_PIPE_CTL_0_IPCOMM_L2R_STATUS    0x00126038 /* Inter-CPU L2R Status Register */
#define BCHP_DCD_PIPE_CTL_0_IPCOMM_R2L_TRANSMIT  0x0012603c /* Inter-CPU R2L Transmit Data Register */
#define BCHP_DCD_PIPE_CTL_0_IPCOMM_R2L_RECEIVE   0x00126040 /* Inter-CPU R2L Receive Data Register */
#define BCHP_DCD_PIPE_CTL_0_IPCOMM_R2L_STATUS    0x00126044 /* Inter-CPU R2L Status Register */
#define BCHP_DCD_PIPE_CTL_0_RECON_DEBUG_REG      0x00126080 /* Reconstructor debug register */
#define BCHP_DCD_PIPE_CTL_0_IXFORM_DEBUG_REG     0x00126084 /* Ixform debug register */
#define BCHP_DCD_PIPE_CTL_0_ILSI_DEBUG_REG       0x00126088 /* ILSI debug register */
#define BCHP_DCD_PIPE_CTL_0_SHIM_DEBUG_CTL       0x0012608c /* SCB Shim debug register */
#define BCHP_DCD_PIPE_CTL_0_SHIM_DEBUG_READ      0x00126090 /* SCB Shim debug register */
#define BCHP_DCD_PIPE_CTL_0_SHIM_ERROR_REG       0x00126094 /* SCB Shim error register */
#define BCHP_DCD_PIPE_CTL_0_DBLK_STRIPE_HEIGHT   0x00126100 /* Legacy deblock stripe height */
#define BCHP_DCD_PIPE_CTL_0_DBLK_STRIPE_WIDTH    0x00126180 /* Legacy deblock stripe width */
#define BCHP_DCD_PIPE_CTL_0_DBLK_PICT_BASE_LUMA  0x00126400 /* Legacy deblock luma picture base */
#define BCHP_DCD_PIPE_CTL_0_DBLK_PICT_BASE_CHROMA 0x00126404 /* Legacy deblock chroma picture base */
