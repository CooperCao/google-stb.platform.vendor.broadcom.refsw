 ...
 ***************************************************************************/
#define BCHP_MEMC_TRACELOG_0_0_VERSION           0x00503800 /* [RO] Tracelog version */
#define BCHP_MEMC_TRACELOG_0_0_CONTROL           0x00503804 /* [RW] Control register for static parameters */
#define BCHP_MEMC_TRACELOG_0_0_REMOTE            0x00503808 /* [RW] Control register for Remote TraceLog sync */
#define BCHP_MEMC_TRACELOG_0_0_COMMAND           0x0050380c /* [WO] Command register for all actions */
#define BCHP_MEMC_TRACELOG_0_0_STATUS            0x00503810 /* [RO] Monitor status */
#define BCHP_MEMC_TRACELOG_0_0_DEBUG             0x00503814 /* [RO] Debug fields */
#define BCHP_MEMC_TRACELOG_0_0_ELAPSED_TIME_LOWER 0x00503820 /* [RO] Elapsed time since enabled, lower 32 bits */
#define BCHP_MEMC_TRACELOG_0_0_ELAPSED_TIME_UPPER 0x00503824 /* [RO] Elapsed time since enabled, upper 16 bits */
#define BCHP_MEMC_TRACELOG_0_0_COUNT_TRANS_TOTAL 0x00503828 /* [RO] Count of all transactions snooped (matched and unmatched) */
#define BCHP_MEMC_TRACELOG_0_0_COUNT_TRIGGER_EVENTS 0x0050382c /* [RO] Count of all events marked as triggers */
#define BCHP_MEMC_TRACELOG_0_0_COUNT_MATCHES_TOTAL 0x00503830 /* [RO] Count of all transactions matched for capture */
#define BCHP_MEMC_TRACELOG_0_0_COUNT_MATCHES_DROPPED 0x00503834 /* [RO] Count of transactions matched for capture, but dropped */
#define BCHP_MEMC_TRACELOG_0_0_COUNT_MATCHES_PRE_TRIGGER 0x00503838 /* [RO] Count of transactions matched and captured before the trigger */
#define BCHP_MEMC_TRACELOG_0_0_COUNT_MATCHES_POST_TRIGGER 0x0050383c /* [RO] Count of transactions matched and captured after the trigger */
#define BCHP_MEMC_TRACELOG_0_0_BUFFER_PTR        0x00503850 /* [RW] Capture buffer pointer, lower 32 bits */
#define BCHP_MEMC_TRACELOG_0_0_BUFFER_PTR_EXT    0x00503854 /* [RW] Capture buffer pointer, upper 8 bits */
#define BCHP_MEMC_TRACELOG_0_0_BUFFER_SIZE       0x00503858 /* [RW] Size of the DRAM buffer in bytes */
#define BCHP_MEMC_TRACELOG_0_0_BUFFER_WR_PTR     0x0050385c /* [RO] Pointer offset into buffer to write next capture data */
#define BCHP_MEMC_TRACELOG_0_0_BUFFER_DATA_WD_0  0x00503870 /* [RO] Internal capture buffer data word 0 (Bits [31:0]) */
#define BCHP_MEMC_TRACELOG_0_0_BUFFER_DATA_WD_1  0x00503874 /* [RO] Internal capture buffer data word 1 (Bits [63:32]) */
#define BCHP_MEMC_TRACELOG_0_0_BUFFER_DATA_WD_2  0x00503878 /* [RO] Internal capture buffer data word 2 (Bits [95:64]) */
#define BCHP_MEMC_TRACELOG_0_0_BUFFER_DATA_WD_3  0x0050387c /* [RO] Internal capture buffer data word 3 (Bits [127:96]) */
#define BCHP_MEMC_TRACELOG_0_0_BUFFER_DATA_WD_4  0x00503880 /* [RO] Internal capture buffer data word 4 (Bits [159:128]) */
#define BCHP_MEMC_TRACELOG_0_0_BUFFER_DATA_WD_5  0x00503884 /* [RO] Internal capture buffer data word 5 (Bits [191:160]) */
#define BCHP_MEMC_TRACELOG_0_0_BUFFER_DATA_WD_6  0x00503888 /* [RO] Internal capture buffer data word 6 (Bits [223:192]) */
#define BCHP_MEMC_TRACELOG_0_0_BUFFER_DATA_WD_7  0x0050388c /* [RO] Internal capture buffer data word 7 (Bits [255:224]) */
#define BCHP_MEMC_TRACELOG_0_0_TRIGGER_MODE      0x00503890 /* [RW] Trigger parameter configuration */
#define BCHP_MEMC_TRACELOG_0_0_TRIGGER_COUNT     0x00503894 /* [RW] Count of events required to trigger */
#define BCHP_MEMC_TRACELOG_0_0_TRIGGER_DELAY_TIME_LOWER 0x00503898 /* [RW] Time interval for delayed trigger mode, lower 32 bits */
#define BCHP_MEMC_TRACELOG_0_0_TRIGGER_DELAY_TIME_UPPER 0x0050389c /* [RW] Time interval for delayed trigger mode, upper 16 bits */
#define BCHP_MEMC_TRACELOG_0_0_TRIGGER_WR_PTR    0x005038a0 /* [RO] Pointer offset into buffer at the time of trigger */
#define BCHP_MEMC_TRACELOG_0_0_TRIGGER_TIME_LOWER 0x005038a8 /* [RO] Time of trigger, lower 32 bits */
#define BCHP_MEMC_TRACELOG_0_0_TRIGGER_TIME_UPPER 0x005038ac /* [RO] Time of trigger, upper 16 bits */
 ...
 ***************************************************************************/
#define BCHP_MEMC_TRACELOG_0_0_FILTER_MODEi_ARRAY_BASE             0x00503900
 ...
 ***************************************************************************/
#define BCHP_MEMC_TRACELOG_0_0_FILTER_MEM_SIZEi_ARRAY_BASE         0x00503910
 ...
 ***************************************************************************/
#define BCHP_MEMC_TRACELOG_0_0_FILTER_IO_DATAi_ARRAY_BASE          0x00503920
 ...
 ***************************************************************************/
#define BCHP_MEMC_TRACELOG_0_0_FILTER_IO_DATA_MASKi_ARRAY_BASE     0x00503930
 ...
 ***************************************************************************/
#define BCHP_MEMC_TRACELOG_0_0_FILTER_ADDR_LOWERi_ARRAY_BASE       0x00503940
 ...
 ***************************************************************************/
#define BCHP_MEMC_TRACELOG_0_0_FILTER_ADDR_LOWER_EXTi_ARRAY_BASE   0x00503950
 ...
 ***************************************************************************/
#define BCHP_MEMC_TRACELOG_0_0_FILTER_ADDR_UPPERi_ARRAY_BASE       0x00503960
 ...
 ***************************************************************************/
#define BCHP_MEMC_TRACELOG_0_0_FILTER_ADDR_UPPER_EXTi_ARRAY_BASE   0x00503970
 ...
 ***************************************************************************/
#define BCHP_MEMC_TRACELOG_0_0_FILTER_CLIENT_0_MASKi_ARRAY_BASE    0x00503980
 ...
 ***************************************************************************/
#define BCHP_MEMC_TRACELOG_0_0_FILTER_CLIENT_1_MASKi_ARRAY_BASE    0x00503990
 ...
 ***************************************************************************/
#define BCHP_MEMC_TRACELOG_0_0_FILTER_CLIENT_2_MASKi_ARRAY_BASE    0x005039a0
 ...
 ***************************************************************************/
#define BCHP_MEMC_TRACELOG_0_0_FILTER_CLIENT_3_MASKi_ARRAY_BASE    0x005039b0
 ...
 ***************************************************************************/
#define BCHP_MEMC_TRACELOG_0_0_FILTER_CLIENT_4_MASKi_ARRAY_BASE    0x005039c0
 ...
 ***************************************************************************/
#define BCHP_MEMC_TRACELOG_0_0_FILTER_CLIENT_5_MASKi_ARRAY_BASE    0x005039d0
 ...
 ***************************************************************************/
#define BCHP_MEMC_TRACELOG_0_0_FILTER_CLIENT_6_MASKi_ARRAY_BASE    0x005039e0
 ...
 ***************************************************************************/
#define BCHP_MEMC_TRACELOG_0_0_FILTER_CLIENT_7_MASKi_ARRAY_BASE    0x005039f0
