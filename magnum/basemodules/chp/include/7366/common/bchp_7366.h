 ...
 * 
 ***************************************************************************/
#ifndef BCHP_7366_H__
#define BCHP_7366_H__
...
/***************************************************************************
Summary:
    Open a chip handle for Bcm7366 chip

Description:
    This function open a chip handle for Bcm7366 chip.

Input:
    hRegister - A valid Bcm7366 register handle previous open using BREG_Open.
