 ...
 *
 ***************************************************************************/
#ifndef BCHP_75525_H__
#define BCHP_75525_H__
...
/***************************************************************************
Summary:
    Open a chip handle for Bcm75525 chip

Description:
    This function open a chip handle for Bcm75525 chip.

Input:
    hRegister - A valid Bcm75525 register handle previous open using BREG_Open.
