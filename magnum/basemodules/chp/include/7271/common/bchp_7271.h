...
#ifndef BCHP_7271_H__
#define BCHP_7271_H__
...
/***************************************************************************
Summary:
    Open a chip handle for Bcm7271 chip

Description:
    This function open a chip handle for Bcm7271 chip.

Input:
    hRegister - A valid Bcm7271 register handle previous open using BREG_Open.
