 ...
 * 
 ***************************************************************************/
#ifndef BCHP_7358_H__
#define BCHP_7358_H__
...
/***************************************************************************
Summary:
    Open a chip handle for Bcm7358 chip

Description:
    This function open a chip handle for Bcm7358 chip.

Input:
    hRegister - A valid Bcm7358 register handle previous open using BREG_Open.
