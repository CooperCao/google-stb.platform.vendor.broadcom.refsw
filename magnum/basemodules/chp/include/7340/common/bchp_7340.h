...
#ifndef BCHP_7340_H__
#define BCHP_7340_H__
...
/***************************************************************************
Summary:
    Open a chip handle for Bcm7340 chip

Description:
    This function open a chip handle for Bcm7340 chip.

Input:
    hRegister - A valid Bcm7340 register handle previous open using BREG_Open.
