 ...
 *
 *
 * Date:           Generated on         Tue Nov 17 17:17:09 2009
 ...
 ***************************************************************************/
#define BCHP_M2MC_REVISION                       0x00480000 /* M2MC Revision register */
#define BCHP_M2MC_BLIT_GO                        0x00480004 /* Blit GO bit */
#define BCHP_M2MC_SCRATCH_NOT_LIST               0x00480008 /* M2MC Scratch register (not included in DMA list structure) */
#define BCHP_M2MC_LIST_CTRL                      0x0048000c /* RDMA Linked List Control Register */
#define BCHP_M2MC_LIST_STATUS                    0x00480010 /* RDMA Linked List Status Register */
#define BCHP_M2MC_LIST_FIRST_PKT_ADDR            0x00480014 /* RDMA Linked List First Packet Address Register */
#define BCHP_M2MC_LIST_CURR_PKT_ADDR             0x00480018 /* RDMA Linked List Current Packet Address Register */
#define BCHP_M2MC_BLIT_STATUS                    0x0048001c /* Blit status */
#define BCHP_M2MC_BLIT_SRC_ADDRESS               0x00480020 /* Blit status source feeder current address */
#define BCHP_M2MC_BLIT_DEST_ADDRESS              0x00480024 /* Blit status destination feeder current address */
#define BCHP_M2MC_BLIT_OUTPUT_ADDRESS            0x00480028 /* Blit status output feeder current address */
#define BCHP_M2MC_BLIT_MEM_HI                    0x0048002c /* Blit memory protection address high */
#define BCHP_M2MC_BLIT_MEM_LO                    0x00480030 /* Blit memory protection address low */
#define BCHP_M2MC_SCBADDRSEL                     0x00480040 /* scb address map select register */
#define BCHP_M2MC_SCRATCH_LIST                   0x00480100 /* M2MC Scratch register (Included in DMA list structure) */
#define BCHP_M2MC_SRC_FEEDER_ENABLE              0x00480104 /* Source plane enable */
#define BCHP_M2MC_SRC_SURFACE_ADDR_0             0x00480108 /* Source surface 0 address */
#define BCHP_M2MC_SRC_SURFACE_STRIDE_0           0x0048010c /* Source surface 0 STRIDE */
#define BCHP_M2MC_SRC_SURFACE_ADDR_1             0x00480110 /* Source surface 1 address */
#define BCHP_M2MC_SRC_SURFACE_STRIDE_1           0x00480114 /* Source surface 1 STRIDE */
#define BCHP_M2MC_SRC_SURFACE_0_FORMAT_DEF_1     0x00480118 /* Source pixel format 1 for surface 0 */
#define BCHP_M2MC_SRC_SURFACE_0_FORMAT_DEF_2     0x0048011c /* Source pixel format 2 for surface 0 */
#define BCHP_M2MC_SRC_SURFACE_0_FORMAT_DEF_3     0x00480120 /* Source pixel format 3 for surface 0 */
#define BCHP_M2MC_SRC_SURFACE_1_FORMAT_DEF_1     0x00480124 /* Source pixel format 1 for surface 1 */
#define BCHP_M2MC_SRC_SURFACE_1_FORMAT_DEF_2     0x00480128 /* Source pixel format 2 for surface 1 */
#define BCHP_M2MC_SRC_SURFACE_1_FORMAT_DEF_3     0x0048012c /* Source pixel format 3 for surface 1 */
#define BCHP_M2MC_SRC_W_ALPHA                    0x00480130 /* Source Alpha W format */
#define BCHP_M2MC_SRC_CONSTANT_COLOR             0x00480134 /* Source constant color */
#define BCHP_M2MC_DEST_FEEDER_ENABLE             0x00480138 /* Destination plane enable */
#define BCHP_M2MC_DEST_SURFACE_ADDR_0            0x0048013c /* Destination surface 0 address */
#define BCHP_M2MC_DEST_SURFACE_STRIDE_0          0x00480140 /* Destination surface 0 STRIDE */
#define BCHP_M2MC_DEST_SURFACE_ADDR_1            0x00480144 /* Destination surface 1 address */
#define BCHP_M2MC_DEST_SURFACE_STRIDE_1          0x00480148 /* Destination surface 1 STRIDE */
#define BCHP_M2MC_DEST_SURFACE_FORMAT_DEF_1      0x0048014c /* Destination pixel format 1 */
#define BCHP_M2MC_DEST_SURFACE_FORMAT_DEF_2      0x00480150 /* Destination pixel format 2 */
#define BCHP_M2MC_DEST_SURFACE_FORMAT_DEF_3      0x00480154 /* Destination pixel format 3 */
#define BCHP_M2MC_DEST_W_ALPHA                   0x00480158 /* Destination Alpha W format */
#define BCHP_M2MC_DEST_CONSTANT_COLOR            0x0048015c /* Destination constant color */
#define BCHP_M2MC_OUTPUT_FEEDER_ENABLE           0x00480160 /* Output plane enable */
#define BCHP_M2MC_OUTPUT_SURFACE_ADDR_0          0x00480164 /* Output surface 0 address */
#define BCHP_M2MC_OUTPUT_SURFACE_STRIDE_0        0x00480168 /* Output surface 0 STRIDE */
#define BCHP_M2MC_OUTPUT_SURFACE_ADDR_1          0x0048016c /* Output surface 1 address */
#define BCHP_M2MC_OUTPUT_SURFACE_STRIDE_1        0x00480170 /* Output surface 1 STRIDE */
#define BCHP_M2MC_OUTPUT_SURFACE_FORMAT_DEF_1    0x00480174 /* Output pixel format 1 */
#define BCHP_M2MC_OUTPUT_SURFACE_FORMAT_DEF_2    0x00480178 /* Output pixel format 2 */
#define BCHP_M2MC_OUTPUT_SURFACE_FORMAT_DEF_3    0x0048017c /* Output pixel format 3 */
#define BCHP_M2MC_BLIT_HEADER                    0x00480180 /* Blit header and control */
#define BCHP_M2MC_BLIT_SRC_TOP_LEFT_0            0x00480184 /* Top left pixel coordinate in the Source surface 0. */
#define BCHP_M2MC_BLIT_SRC_SIZE_0                0x00480188 /* Pixel width and height of operation in Source surface 0. */
#define BCHP_M2MC_BLIT_SRC_TOP_LEFT_1            0x0048018c /* Top left pixel coordinate in the Source surface 1. */
#define BCHP_M2MC_BLIT_SRC_SIZE_1                0x00480190 /* Pixel width and height of operation in Source surface 1. */
#define BCHP_M2MC_BLIT_SRC_STRIPE_HEIGHT_WIDTH_0 0x00480194 /* width and height of stripe for surface 0 for the decoded frame image format. */
#define BCHP_M2MC_BLIT_SRC_STRIPE_HEIGHT_WIDTH_1 0x00480198 /* width and height of stripe for surface 1 for the decoded frame image format. */
#define BCHP_M2MC_BLIT_DEST_TOP_LEFT             0x0048019c /* Top left pixel coordinate in the Destination */
#define BCHP_M2MC_BLIT_DEST_SIZE                 0x004801a0 /* Pixel width and height of operation in destination */
#define BCHP_M2MC_BLIT_OUTPUT_TOP_LEFT           0x004801a4 /* Top left pixel coordinate in the Output */
#define BCHP_M2MC_BLIT_OUTPUT_SIZE               0x004801a8 /* Pixel width and height of operation in the Output */
#define BCHP_M2MC_BLIT_INPUT_STRIPE_WIDTH_0      0x004801ac /* Pixel width of input stripe when striping for surface 0 */
#define BCHP_M2MC_BLIT_INPUT_STRIPE_WIDTH_1      0x004801b0 /* Pixel width of input stripe when striping for surface 1 */
#define BCHP_M2MC_BLIT_OUTPUT_STRIPE_WIDTH       0x004801b4 /* Pixel width of output stripe when striping */
#define BCHP_M2MC_BLIT_STRIPE_OVERLAP_0          0x004801b8 /* Pixel width of stripe overlap when striping for surface 0. */
#define BCHP_M2MC_BLIT_STRIPE_OVERLAP_1          0x004801bc /* Pixel width of stripe overlap when striping for surface 1. */
#define BCHP_M2MC_BLIT_CTRL                      0x004801c0 /* Blit control */
#define BCHP_M2MC_SCALER_CTRL                    0x004801c4 /* Scaler control */
#define BCHP_M2MC_HORIZ_AVERAGER_COUNT           0x004801c8 /* Horizontal averager control count */
#define BCHP_M2MC_HORIZ_AVERAGER_COEFF           0x004801cc /* Horizontal averager control coefficient */
#define BCHP_M2MC_VERT_AVERAGER_COUNT            0x004801d0 /* Vertical averager control count */
#define BCHP_M2MC_VERT_AVERAGER_COEFF            0x004801d4 /* Vertical averager control coefficient */
#define BCHP_M2MC_HORIZ_SCALER_0_INITIAL_PHASE   0x004801d8 /* Horizontal scaler 0 initial phase */
#define BCHP_M2MC_HORIZ_SCALER_0_STEP            0x004801dc /* Horizontal scaler 0 step */
#define BCHP_M2MC_HORIZ_SCALER_1_INITIAL_PHASE   0x004801e0 /* Horizontal scaler 1 initial phase */
#define BCHP_M2MC_HORIZ_SCALER_1_STEP            0x004801e4 /* Horizontal scaler 1 step */
#define BCHP_M2MC_VERT_SCALER_0_INITIAL_PHASE    0x004801e8 /* Vertical scaler 0 initial phase */
#define BCHP_M2MC_VERT_SCALER_0_STEP             0x004801ec /* Vertical scaler 0 step */
#define BCHP_M2MC_VERT_SCALER_1_INITIAL_PHASE    0x004801f0 /* Vertical scaler 1 initial phase */
#define BCHP_M2MC_VERT_SCALER_1_STEP             0x004801f4 /* Vertical scaler 1 step */
#define BCHP_M2MC_BLEND_COLOR_OP                 0x004801f8 /* Color blend operation descriptor */
#define BCHP_M2MC_BLEND_ALPHA_OP                 0x004801fc /* Alpha blend operation descriptor */
#define BCHP_M2MC_BLEND_CONSTANT_COLOR           0x00480200 /* Blend constant color */
#define BCHP_M2MC_BLEND_COLOR_KEY_ACTION         0x00480204 /* Action color keyed samples take in blender */
#define BCHP_M2MC_ROP_OPERATION                  0x00480208 /* Raster operation vector */
#define BCHP_M2MC_ROP_PATTERN_TOP                0x0048020c /* Top half of ROP pattern */
#define BCHP_M2MC_ROP_PATTERN_BOTTOM             0x00480210 /* Bottom half of ROP pattern */
#define BCHP_M2MC_ROP_PATTERN_COLOR_0            0x00480214 /* ROP Color for 0 */
#define BCHP_M2MC_ROP_PATTERN_COLOR_1            0x00480218 /* ROP Color for 1 */
#define BCHP_M2MC_SRC_COLOR_KEY_HIGH             0x0048021c /* Source color key high */
#define BCHP_M2MC_SRC_COLOR_KEY_LOW              0x00480220 /* Source color key low */
#define BCHP_M2MC_SRC_COLOR_KEY_MASK             0x00480224 /* Source color key mask */
#define BCHP_M2MC_SRC_COLOR_KEY_REPLACEMENT      0x00480228 /* Source color key replacement */
#define BCHP_M2MC_SRC_COLOR_KEY_REPLACEMENT_MASK 0x0048022c /* Source color key replacement mask */
#define BCHP_M2MC_DEST_COLOR_KEY_HIGH            0x00480230 /* Destination color key high */
#define BCHP_M2MC_DEST_COLOR_KEY_LOW             0x00480234 /* Destination color key low */
#define BCHP_M2MC_DEST_COLOR_KEY_MASK            0x00480238 /* Destination color key mask */
#define BCHP_M2MC_DEST_COLOR_KEY_REPLACEMENT     0x0048023c /* Destination color key replacement */
#define BCHP_M2MC_DEST_COLOR_KEY_REPLACEMENT_MASK 0x00480240 /* Destination color key replacement mask */
#define BCHP_M2MC_HORIZ_FIR_0_COEFF_PHASE0_01    0x00480244 /* Horizontal Scaler 0 Poly-Phase Filter Phase 0 Coefficients */
#define BCHP_M2MC_HORIZ_FIR_0_COEFF_PHASE0_2     0x00480248 /* Horizontal Scaler 0 Poly-Phase Filter Phase 0 Coefficients */
#define BCHP_M2MC_HORIZ_FIR_0_COEFF_PHASE1_01    0x0048024c /* Horizontal Scaler 0 Poly-Phase Filter Phase 1 Coefficients */
#define BCHP_M2MC_HORIZ_FIR_0_COEFF_PHASE1_2     0x00480250 /* Horizontal Scaler 0 Poly-Phase Filter Phase 1 Coefficients */
#define BCHP_M2MC_HORIZ_FIR_1_COEFF_PHASE0_01    0x00480254 /* Horizontal Scaler 1 Poly-Phase Filter Phase 0 Coefficients */
#define BCHP_M2MC_HORIZ_FIR_1_COEFF_PHASE0_2     0x00480258 /* Horizontal Scaler 1 Poly-Phase Filter Phase 0 Coefficients */
#define BCHP_M2MC_HORIZ_FIR_1_COEFF_PHASE1_01    0x0048025c /* Horizontal Scaler 1 Poly-Phase Filter Phase 1 Coefficients */
#define BCHP_M2MC_HORIZ_FIR_1_COEFF_PHASE1_2     0x00480260 /* Horizontal Scaler 1 Poly-Phase Filter Phase 1 Coefficients */
#define BCHP_M2MC_VERT_FIR_0_COEFF_PHASE0_01     0x00480264 /* Vertical Scaler 0 Poly-Phase Filter Phase 0 Coefficients */
#define BCHP_M2MC_VERT_FIR_0_COEFF_PHASE0_2      0x00480268 /* Vertical Scaler 0 Poly-Phase Filter Phase 0 Coefficients */
#define BCHP_M2MC_VERT_FIR_0_COEFF_PHASE1_01     0x0048026c /* Vertical Scaler 0 Poly-Phase Filter Phase 1 Coefficients */
#define BCHP_M2MC_VERT_FIR_0_COEFF_PHASE1_2      0x00480270 /* Vertical Scaler 0 Poly-Phase Filter Phase 1 Coefficients */
#define BCHP_M2MC_VERT_FIR_1_COEFF_PHASE0_01     0x00480274 /* Vertical Scaler 1 Poly-Phase Filter Phase 0 Coefficients */
#define BCHP_M2MC_VERT_FIR_1_COEFF_PHASE0_2      0x00480278 /* Vertical Scaler 1 Poly-Phase Filter Phase 0 Coefficients */
#define BCHP_M2MC_VERT_FIR_1_COEFF_PHASE1_01     0x0048027c /* Vertical Scaler 1 Poly-Phase Filter Phase 1 Coefficients */
#define BCHP_M2MC_VERT_FIR_1_COEFF_PHASE1_2      0x00480280 /* Vertical Scaler 1 Poly-Phase Filter Phase 1 Coefficients */
#define BCHP_M2MC_SRC_CM_C00_C01                 0x00480284 /* Color Conversion Matrix Coefficients C00 and C01 */
#define BCHP_M2MC_SRC_CM_C02_C03                 0x00480288 /* Color Conversion Matrix Coefficients C02 and C03 */
#define BCHP_M2MC_SRC_CM_C04                     0x0048028c /* Color Conversion Matrix Coefficients C04 */
#define BCHP_M2MC_SRC_CM_C10_C11                 0x00480290 /* Color Conversion Matrix Coefficients C10 and C11 */
#define BCHP_M2MC_SRC_CM_C12_C13                 0x00480294 /* Color Conversion Matrix Coefficients C12 and C13 */
#define BCHP_M2MC_SRC_CM_C14                     0x00480298 /* Color Conversion Matrix Coefficients C14 */
#define BCHP_M2MC_SRC_CM_C20_C21                 0x0048029c /* Color Conversion Matrix Coefficients C20 and C21 */
#define BCHP_M2MC_SRC_CM_C22_C23                 0x004802a0 /* Color Conversion Matrix Coefficients C22 and C23 */
#define BCHP_M2MC_SRC_CM_C24                     0x004802a4 /* Color Conversion Matrix Coefficients C24 */
#define BCHP_M2MC_SRC_CM_C30_C31                 0x004802a8 /* Color Conversion Matrix Coefficients C30 and C31 */
#define BCHP_M2MC_SRC_CM_C32_C33                 0x004802ac /* Color Conversion Matrix Coefficients C32 and C33 */
#define BCHP_M2MC_SRC_CM_C34                     0x004802b0 /* Color Conversion Matrix Coefficients C34 */
#define BCHP_M2MC_TIMEOUT_COUNTER_CONTROL        0x004802b4 /* M2MC timeout counter control register */
 ...
 ***************************************************************************/
#define BCHP_M2MC_SRC_CLUT_ENTRY_i_ARRAY_BASE                      0x00480400
