 ...
 *
 *
 * Date:           Generated on         Thu Apr 22 17:41:05 2010
 ...
 ***************************************************************************/
#define BCHP_RFM_BBE_SYSCLK_RESET                0x0048c804 /* RF modulator soft reset */
#define BCHP_RFM_BBE_SYSCLK_NCOINVID             0x0048c808 /* Audio Input VID - NCO control word */
#define BCHP_RFM_BBE_SYSCLK_VIDCNTL              0x0048c80c /* Audio BTSC VID - Delayed start control */
#define BCHP_RFM_BBE_SYSCLK_VIDPHASE             0x0048c810 /* Audio BTSC VID - Initial values of NCOs */
#define BCHP_RFM_BBE_SYSCLK_NCOINT               0x0048c814 /* Audio BTSC VID - Integer numerator for internal NCO */
#define BCHP_RFM_BBE_SYSCLK_NCOREM               0x0048c818 /* Audio BTSC VID - Remainder for internal NCO */
#define BCHP_RFM_BBE_SYSCLK_NCODEN               0x0048c81c /* Audio BTSC VID - Denominator for internal NCO */
#define BCHP_RFM_BBE_SYSCLK_AMFREQ               0x0048c824 /* Frequency control word for the RF carrier DDFS */
#define BCHP_RFM_BBE_SYSCLK_MODBYP               0x0048c828 /* Bypass control for the sub-blocks in the amplitude modulator portion of the RF Modulator */
#define BCHP_RFM_BBE_SYSCLK_MODTST               0x0048c82c /* Testability control for the amplitude modulator */
#define BCHP_RFM_BBE_SYSCLK_TPRATE               0x0048c830 /* Control for the testport output decimation ratio of amplitude modulator */
#define BCHP_RFM_BBE_SYSCLK_OUTSCL               0x0048c834 /* Control for the scaler at the output of the RF Modulator block */
#define BCHP_RFM_BBE_SYSCLK_LINEFCW              0x0048c838 /* Line sync frequency control word for artificial line sync */
#define BCHP_RFM_BBE_SYSCLK_BISTCNTL             0x0048c860 /* RF modulator logic BIST control */
#define BCHP_RFM_BBE_SYSCLK_AUCRC1               0x0048c868 /* Read-only RF modulator audio channel 1 pre-FIFO data CRC signature */
#define BCHP_RFM_BBE_SYSCLK_AUCRC2               0x0048c86c /* Read-only RF modulator audio channel 2 pre-FIFO data CRC signature */
#define BCHP_RFM_BBE_SYSCLK_AUCRC3               0x0048c870 /* Read-only RF modulator audio channel 1 post-FIFO data CRC signature */
#define BCHP_RFM_BBE_SYSCLK_AUCRC4               0x0048c874 /* Read-only RF modulator audio channel 2 post-FIFO data CRC signature */
#define BCHP_RFM_BBE_SYSCLK_AUCRC5               0x0048c878 /* Read-only RF modulator audio L+R channel output Cauer filter CRC signature */
#define BCHP_RFM_BBE_SYSCLK_AUCRC6               0x0048c87c /* Read-only RF modulator audio L-R channel output Cauer filter CRC signature */
#define BCHP_RFM_BBE_SYSCLK_AUCRC7               0x0048c880 /* Read-only RF modulator audio spectral gain logic BIST CRC signature */
#define BCHP_RFM_BBE_SYSCLK_AUCRC8               0x0048c884 /* Read-only RF modulator audio wide-band gain logic BIST CRC signature */
#define BCHP_RFM_BBE_SYSCLK_AVCRC                0x0048c890 /* Read-only RF modulator audio/video logic BIST CRC signature */
#define BCHP_RFM_BBE_SYSCLK_AMCRC                0x0048c894 /* Read-only RF modulator amplitude modulator logic BIST CRC signature */
#define BCHP_RFM_BBE_SYSCLK_TPCRC1               0x0048c898 /* Read-only RF modulator audio 27MHz testport output CRC signature */
#define BCHP_RFM_BBE_SYSCLK_STATUS               0x0048c8a4 /* Read-only RFM status register for interrupt conditions */
#define BCHP_RFM_BBE_SYSCLK_MISC                 0x0048c8ac /* Miscellaneous register */
#define BCHP_RFM_BBE_SYSCLK_REVID                0x0048c8b0 /* Read-only RF Modulator REVID register */
#define BCHP_RFM_BBE_SYSCLK_TSTCNTL              0x0048c8b4 /* General control for the RF Modulator testport IOs */
#define BCHP_RFM_BBE_SYSCLK_TPOUT                0x0048c8b8 /* TP_OUT bus value */
#define BCHP_RFM_BBE_SYSCLK_RESERVED1            0x0048c900 /* Reserved register */
...
/* RFM_BBE_SYSCLK :: MISC :: reserved1 [04:04] */
#define BCHP_RFM_BBE_SYSCLK_MISC_reserved1_MASK                    0x00000010
#define BCHP_RFM_BBE_SYSCLK_MISC_reserved1_SHIFT                   4

/* RFM_BBE_SYSCLK :: MISC :: reserved_for_eco2 [03:03] */
#define BCHP_RFM_BBE_SYSCLK_MISC_reserved_for_eco2_MASK            0x00000008
#define BCHP_RFM_BBE_SYSCLK_MISC_reserved_for_eco2_SHIFT           3
