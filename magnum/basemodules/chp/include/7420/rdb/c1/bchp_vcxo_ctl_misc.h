 ...
 *
 *
 * Date:           Generated on         Thu Apr 22 17:39:29 2010
...
#define BCHP_VCXO_CTL_MISC_VC1_CTRL              0x00462814 /* VCXO 1 PLL reset, ndiv_mode, powerdown */
#define BCHP_VCXO_CTL_MISC_VC1_PM_CLOCK_ENA_1    0x00462818 /* VCXO 1  clock outputs enable */
#define BCHP_VCXO_CTL_MISC_VC1_PM_DIS_CHL_1      0x0046281c /* VCXO 1 channel 1 powerdown post divider */
#define BCHP_VCXO_CTL_MISC_VC1_PM_DIS_CHL_2      0x00462820 /* VCXO 1 channel 2 powerdown post divider */
#define BCHP_VCXO_CTL_MISC_VC1_PM_DIS_CHL_3      0x00462824 /* VCXO 1 channel 3 powerdown post divider */
#define BCHP_VCXO_CTL_MISC_AC0_CTRL              0x00462828 /* Audio PLL 0 reset, ndiv_mode and powerdown */
#define BCHP_VCXO_CTL_MISC_AC0_PM_CLOCK_ENA_1    0x0046282c /* Audio PLL 0  clock outputs enable */
#define BCHP_VCXO_CTL_MISC_AC0_PM_DIS_CHL_1      0x00462830 /* Audio PLL 0 channel 1 powerdown post divider */
#define BCHP_VCXO_CTL_MISC_AC0_PM_DIS_CHL_2      0x00462834 /* Audio PLL 0 channel 2 powerdown post divider */
#define BCHP_VCXO_CTL_MISC_AC0_PM_DIS_CHL_3      0x00462838 /* Audio PLL 0 channel 3 powerdown post divider */
#define BCHP_VCXO_CTL_MISC_AC1_CTRL              0x0046283c /* Audio PLL 1 reset, ndiv_mode and powerdown */
#define BCHP_VCXO_CTL_MISC_AC1_PM_CLOCK_ENA_1    0x00462840 /* Audio PLL 1  clock outputs enable */
#define BCHP_VCXO_CTL_MISC_AC1_PM_DIS_CHL_1      0x00462844 /* Audio PLL 1 channel 1 powerdown post divider */
#define BCHP_VCXO_CTL_MISC_AC1_PM_DIS_CHL_2      0x00462848 /* Audio PLL 1 channel 2 powerdown post divider */
#define BCHP_VCXO_CTL_MISC_AC1_PM_DIS_CHL_3      0x0046284c /* Audio PLL 1 channel 3 powerdown post divider */
#define BCHP_VCXO_CTL_MISC_AC2_CTRL              0x00462850 /* Audio PLL 2 reset, ndiv_mode and powerdown */
#define BCHP_VCXO_CTL_MISC_AC2_PM_CLOCK_ENA_1    0x00462854 /* Audio PLL 2  clock outputs enable */
#define BCHP_VCXO_CTL_MISC_AC2_PM_DIS_CHL_1      0x00462858 /* Audio PLL 2 channel 1 powerdown post divider */
#define BCHP_VCXO_CTL_MISC_AC2_PM_DIS_CHL_2      0x0046285c /* Audio PLL 2 channel 2 powerdown post divider */
#define BCHP_VCXO_CTL_MISC_AC2_PM_DIS_CHL_3      0x00462860 /* Audio PLL 2 channel 3 powerdown post divider */
#define BCHP_VCXO_CTL_MISC_SC_CTRL               0x00462864 /* smart card PLL reset, ndiv_mode and powerdown */
#define BCHP_VCXO_CTL_MISC_SC_PM_CLOCK_ENA_1     0x00462868 /* smart card PLL  clock outputs enable */
#define BCHP_VCXO_CTL_MISC_SC_PM_DIS_CHL_1       0x0046286c /* smart card PLL channel 1 powerdown post divider */
#define BCHP_VCXO_CTL_MISC_RAP_AVD_PLL_CTRL      0x00462870 /* RAP_AVD PLL reset */
#define BCHP_VCXO_CTL_MISC_RAP_AVD_PLL_CHL_1     0x00462874 /* RAP_AVD_PLL channel 1: 250 MHz raptor DSP clock,  PLL source post divider powerdown, channel gate on/off and cml buffer enable */
#define BCHP_VCXO_CTL_MISC_RAP_AVD_PLL_CHL_6     0x00462878 /* RAP_AVD_PLL channel 6: 250 MHz AVD clock,  PLL source post divider powerdown, channel gate on/off and cml buffer enable */
#define BCHP_VCXO_CTL_MISC_LOCK                  0x0046287c /* VCXO core lock status */
#define BCHP_VCXO_CTL_MISC_VC0_DIV               0x00462880 /* VCXO 0 PLL divider settings */
#define BCHP_VCXO_CTL_MISC_VC1_DIV               0x00462884 /* VCXO 1 PLL divider settings */
#define BCHP_VCXO_CTL_MISC_AVD_RAP_DIV           0x00462888 /* AVD RAP PLL divider settings */
#define BCHP_VCXO_CTL_MISC_LOCK_CNTR_RESET       0x0046288c /* VCXO Lock Counter Reset */
#define BCHP_VCXO_CTL_MISC_VC0_LOCK_CNT          0x00462890 /* VCXO 0 PLL Lock Counter */
#define BCHP_VCXO_CTL_MISC_VC1_LOCK_CNT          0x00462894 /* VCXO 1 PLL Lock Counter */
#define BCHP_VCXO_CTL_MISC_AC0_LOCK_CNT          0x00462898 /* Audio PLL 0 Lock Counter */
#define BCHP_VCXO_CTL_MISC_AC1_LOCK_CNT          0x0046289c /* Audio PLL 1 Lock Counter */
#define BCHP_VCXO_CTL_MISC_AC2_LOCK_CNT          0x004628a0 /* Audio PLL 2 Lock Counter */
#define BCHP_VCXO_CTL_MISC_SC_LOCK_CNT           0x004628a4 /* Smart Card PLL  Lock Counter */
#define BCHP_VCXO_CTL_MISC_AUDDSP_LOCK_CNT       0x004628a8 /* Audio DSP PLL Lock Counter */
#define BCHP_VCXO_CTL_MISC_TEST_SEL              0x004628ac /* TOP LEVEL PLLs (except MIPS, RAPAVD and NETWORK PLL) test select */
#define BCHP_VCXO_CTL_MISC_MIPS_RAPAVD_PLL_TEST_SEL 0x004628b0 /* MIPS and RAPAVD PLL test select */
#define BCHP_VCXO_CTL_MISC_NETWORK_PLL_TEST_SEL  0x004628b4 /* NETWORK PLL test select */
