 ...
 *
 *
 * Date:           Generated on         Thu Apr 22 17:30:49 2010
 ...
 ***************************************************************************/
#define BCHP_RFM_SYSCLK_CLKCTL                   0x0048c000 /* RF Modulator clock control */
#define BCHP_RFM_SYSCLK_RESET                    0x0048c004 /* RF modulator soft reset */
#define BCHP_RFM_SYSCLK_NCOINVID                 0x0048c008 /* Audio Input VID - NCO control word */
#define BCHP_RFM_SYSCLK_VIDCNTL                  0x0048c00c /* Audio BTSC VID - Delayed start control */
#define BCHP_RFM_SYSCLK_VIDPHASE                 0x0048c010 /* Audio BTSC VID - Initial values of NCOs */
#define BCHP_RFM_SYSCLK_NCOINT                   0x0048c014 /* Audio BTSC VID - Integer numerator for internal NCO */
#define BCHP_RFM_SYSCLK_NCOREM                   0x0048c018 /* Audio BTSC VID - Remainder for internal NCO */
#define BCHP_RFM_SYSCLK_NCODEN                   0x0048c01c /* Audio BTSC VID - Denominator for internal NCO */
#define BCHP_RFM_SYSCLK_DACCTL                   0x0048c020 /* RF modulator DAC control */
#define BCHP_RFM_SYSCLK_AMFREQ                   0x0048c024 /* Frequency control word for the RF carrier DDFS */
#define BCHP_RFM_SYSCLK_MODBYP                   0x0048c028 /* Bypass control for the sub-blocks in the amplitude modulator portion of the RF Modulator */
#define BCHP_RFM_SYSCLK_MODTST                   0x0048c02c /* Testability control for the amplitude modulator */
#define BCHP_RFM_SYSCLK_TPRATE                   0x0048c030 /* Control for the testport output decimation ratio of amplitude modulator */
#define BCHP_RFM_SYSCLK_OUTSCL                   0x0048c034 /* Control for the scaler at the output of the RF Modulator block */
#define BCHP_RFM_SYSCLK_LINEFCW                  0x0048c038 /* Line sync frequency control word for artificial line sync */
#define BCHP_RFM_SYSCLK_VCLK1                    0x0048c03c /* Video input FIFO freezing control */
#define BCHP_RFM_SYSCLK_BISTCNTL                 0x0048c060 /* RF modulator logic BIST control */
#define BCHP_RFM_SYSCLK_BISTSTAT                 0x0048c064 /* Read-only RF modulator logic BIST test status */
#define BCHP_RFM_SYSCLK_AUCRC1                   0x0048c068 /* Read-only RF modulator audio channel 1 pre-FIFO data CRC signature */
#define BCHP_RFM_SYSCLK_AUCRC2                   0x0048c06c /* Read-only RF modulator audio channel 2 pre-FIFO data CRC signature */
#define BCHP_RFM_SYSCLK_AUCRC3                   0x0048c070 /* Read-only RF modulator audio channel 1 post-FIFO data CRC signature */
#define BCHP_RFM_SYSCLK_AUCRC4                   0x0048c074 /* Read-only RF modulator audio channel 2 post-FIFO data CRC signature */
#define BCHP_RFM_SYSCLK_AUCRC5                   0x0048c078 /* Read-only RF modulator audio L+R channel output Cauer filter CRC signature */
#define BCHP_RFM_SYSCLK_AUCRC6                   0x0048c07c /* Read-only RF modulator audio L-R channel output Cauer filter CRC signature */
#define BCHP_RFM_SYSCLK_AUCRC7                   0x0048c080 /* Read-only RF modulator audio spectral gain logic BIST CRC signature */
#define BCHP_RFM_SYSCLK_AUCRC8                   0x0048c084 /* Read-only RF modulator audio wide-band gain logic BIST CRC signature */
#define BCHP_RFM_SYSCLK_VICRC1                   0x0048c088 /* Read-only RF modulator video pre-FIFO data CRC signature */
#define BCHP_RFM_SYSCLK_VICRC2                   0x0048c08c /* Read-only RF modulator video post-FIFO data CRC signature */
#define BCHP_RFM_SYSCLK_AVCRC                    0x0048c090 /* Read-only RF modulator audio/video logic BIST CRC signature */
#define BCHP_RFM_SYSCLK_AMCRC                    0x0048c094 /* Read-only RF modulator amplitude modulator logic BIST CRC signature */
#define BCHP_RFM_SYSCLK_TPCRC1                   0x0048c098 /* Read-only RF modulator audio 27MHz testport output CRC signature */
#define BCHP_RFM_SYSCLK_TPCRC2                   0x0048c09c /* Read-only RF modulator video 27MHz testport output CRC signature */
#define BCHP_RFM_SYSCLK_STATUS                   0x0048c0a4 /* Read-only RFM status register for interrupt conditions */
#define BCHP_RFM_SYSCLK_MISC                     0x0048c0ac /* Miscellaneous register */
#define BCHP_RFM_SYSCLK_REVID                    0x0048c0b0 /* Read-only RF Modulator REVID register */
#define BCHP_RFM_SYSCLK_TSTCNTL                  0x0048c0b4 /* General control for the RF Modulator testport IOs */
#define BCHP_RFM_SYSCLK_TPOUT                    0x0048c0b8 /* TP_OUT bus value */
#define BCHP_RFM_SYSCLK_PLL_DIV1                 0x0048c0bc /* Phase Lock Loop Divider Control Register 1 */
#define BCHP_RFM_SYSCLK_PLL_DIV2                 0x0048c0c0 /* Phase Lock Loop Divider Control Register 2 */
#define BCHP_RFM_SYSCLK_PLL_MISC1                0x0048c0d0 /* Phase Lock Loop Misc Control Register 1 */
#define BCHP_RFM_SYSCLK_PLL_MISC2                0x0048c0d4 /* Phase Lock Loop Misc Control Register 2 */
#define BCHP_RFM_SYSCLK_PLL_MISC3                0x0048c0d8 /* Phase Lock Loop Misc Control Register 3 */
#define BCHP_RFM_SYSCLK_RFM_PHASEITP_CTL         0x0048c0dc /* RFM Phase Interpolator Control Register */
#define BCHP_RFM_SYSCLK_RFM_PHASEITP_CTL2        0x0048c0e0 /* RFM Phase Interpolator Control Register 2 */
#define BCHP_RFM_SYSCLK_RFMPHY_BISTCNTL          0x0048c0e4 /* RFMPHY Logic BIST Control Register */
#define BCHP_RFM_SYSCLK_RFMPHY_STATUS            0x0048c0e8 /* Read-only RFMPHY CRC Register */
#define BCHP_RFM_SYSCLK_RFMPHY_BIASCNTL          0x0048c0ec /* RFMPHY Bias Control Register */
#define BCHP_RFM_SYSCLK_RFMPHY_DAC2_CRC          0x0048c0f0 /* Read-only RFMPHY CRC Register for Second DAC */
#define BCHP_RFM_SYSCLK_RFMPHY_EXTRA_CTL_1       0x0048c0f4 /* Additional RFMPHY Control Register 1 */
#define BCHP_RFM_SYSCLK_RFMPHY_EXTRA_CTL_2       0x0048c0f8 /* Additional RFMPHY Control Register 2 */
#define BCHP_RFM_SYSCLK_RFMPHY_EXTRA_STATUS      0x0048c0fc /* Additional RFMPHY Status Register */
#define BCHP_RFM_SYSCLK_RESERVED1                0x0048c100 /* Reserved register */
 ...
 ***************************************************************************/
/* RFM_SYSCLK :: PLL_MISC3 :: reserved_for_eco0 [31:07] */
#define BCHP_RFM_SYSCLK_PLL_MISC3_reserved_for_eco0_MASK           0xffffff80
#define BCHP_RFM_SYSCLK_PLL_MISC3_reserved_for_eco0_SHIFT          7

/* RFM_SYSCLK :: PLL_MISC3 :: PLL_CTRL_38_32 [06:00] */
#define BCHP_RFM_SYSCLK_PLL_MISC3_PLL_CTRL_38_32_MASK              0x0000007f
#define BCHP_RFM_SYSCLK_PLL_MISC3_PLL_CTRL_38_32_SHIFT             0
...
/***************************************************************************
 *RFMPHY_EXTRA_CTL_1 - Additional RFMPHY Control Register 1
 ***************************************************************************/
/* RFM_SYSCLK :: RFMPHY_EXTRA_CTL_1 :: extra_ctrl [31:00] */
#define BCHP_RFM_SYSCLK_RFMPHY_EXTRA_CTL_1_extra_ctrl_MASK         0xffffffff
#define BCHP_RFM_SYSCLK_RFMPHY_EXTRA_CTL_1_extra_ctrl_SHIFT        0

/***************************************************************************
 *RFMPHY_EXTRA_CTL_2 - Additional RFMPHY Control Register 2
 ***************************************************************************/
/* RFM_SYSCLK :: RFMPHY_EXTRA_CTL_2 :: extra_ctrl [31:00] */
#define BCHP_RFM_SYSCLK_RFMPHY_EXTRA_CTL_2_extra_ctrl_MASK         0xffffffff
#define BCHP_RFM_SYSCLK_RFMPHY_EXTRA_CTL_2_extra_ctrl_SHIFT        0
