 ...
 *DECODE_MAIN_0
 ***************************************************************************/
#define BCHP_DECODE_MAIN_0_REG_MAINCTL           0x00020100 /* Decoder Control */
#define BCHP_DECODE_MAIN_0_REG_FRAMESIZE         0x00020104 /* Size of the picture being decoded */
#define BCHP_DECODE_MAIN_0_REG_DEC_VERSION       0x00020108 /* Version of the decoder core */
#define BCHP_DECODE_MAIN_0_REG_STATUS            0x00020110 /* Provides back-end decoder processing status */
#define BCHP_DECODE_MAIN_0_REG_PMONCTL           0x00020120 /* Performance Monitoring */
#define BCHP_DECODE_MAIN_0_REG_PMONCNT0          0x00020124 /* REG_PMONCNT0 */
#define BCHP_DECODE_MAIN_0_REG_PMONCNT1          0x00020128 /* REG_PMONCNT1 */
#define BCHP_DECODE_MAIN_0_REG_PMON_MBCTL        0x0002012c /* REG_PMON_MBCTL */
#define BCHP_DECODE_MAIN_0_DBLK_BUFF_CONTROL     0x00020130 /* DBLK_BUFF_CONTROL */
#define BCHP_DECODE_MAIN_0_CRC_CONTROL           0x00020134 /* DBLK CRC CONTROL register */
#define BCHP_DECODE_MAIN_0_CRC_SEED              0x00020138 /* DBLK CRC SEED register */
#define BCHP_DECODE_MAIN_0_CRC_CHKSUM_Y          0x0002013c /* DBLK Luma CRC/Checksum result register */
#define BCHP_DECODE_MAIN_0_CRC_CHKSUM_CB         0x00020140 /* DBLK Chroma (Cb) CRC/Checksum result register */
#define BCHP_DECODE_MAIN_0_CRC_CHKSUM_CR         0x00020144 /* DBLK Chroma (Cr) CRC/Checksum result register */
#define BCHP_DECODE_MAIN_0_REG_VP6_MCOM_CONTROL  0x00020150 /* VP6 Mocomp Control */
#define BCHP_DECODE_MAIN_0_REG_VP6_MCOM_AUTO     0x00020154 /* VP6 Mocomp Auto Filter Selection */
#define BCHP_DECODE_MAIN_0_REG_VP6_MCOM_ALPHA    0x00020158 /* VP6 Mocomp Alpha Filter Selection */
#define BCHP_DECODE_MAIN_0_REG_VP6_MCOM_FLIMIT   0x0002015c /* VP6 Mocomp Flimit Control */
#define BCHP_DECODE_MAIN_0_REG_BACKEND_DEBUG     0x00020160 /* Backend debug Select */
#define BCHP_DECODE_MAIN_0_REG_VC1_MC_DEBUG      0x00020164 /* VC1 Mocomp Debug */
#define BCHP_DECODE_MAIN_0_REG_QPEL_FIFO_DEBUG   0x00020168 /* Qpel FIFO Debug */
#define BCHP_DECODE_MAIN_0_REG_MAIN_END          0x000201fc /* REG_MAIN_END */
