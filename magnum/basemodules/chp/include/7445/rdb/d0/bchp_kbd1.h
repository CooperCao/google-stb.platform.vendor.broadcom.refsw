 ...
 ***************************************************************************/
#define BCHP_KBD1_STATUS                         0x004170c0 /* KEYBOARD/REMOTE RECEIVER STATUS REGISTER */
#define BCHP_KBD1_DIVISOR                        0x004170c4 /* KEYBOARD/REMOTE RECEIVER DIVISOR */
#define BCHP_KBD1_FILTER1                        0x004170c8 /* KEYBOARD FILTER1 */
#define BCHP_KBD1_DATA1                          0x004170cc /* KEYBOARD/REMOTE RECEIVER DATA WORD 1 (MS Word) */
#define BCHP_KBD1_DATA0                          0x004170d0 /* KEYBOARD/REMOTE RECEIVER DATA WORD 0 (LS Word) */
#define BCHP_KBD1_CMD                            0x004170d4 /* KEYBOARD/REMOTE RECEIVER COMMAND REGISTER */
#define BCHP_KBD1_CIR_ADDR                       0x004170d8 /* CONSUMER IR DECODER ADDRESS REGISTER */
#define BCHP_KBD1_CIR_DATA                       0x004170dc /* CONSUMER IR DECODER DATA (LSB) */
#define BCHP_KBD1_KBD_MASK0                      0x004170e0 /* KEBOARD INPUT MASK 0 */
#define BCHP_KBD1_KBD_MASK1                      0x004170e4 /* KEBOARD INPUT MASK 1 */
#define BCHP_KBD1_KBD_MASK2                      0x004170e8 /* KEBOARD INPUT MASK 2 */
#define BCHP_KBD1_KBD_PAT0                       0x004170ec /* KEBOARD INPUT PATTERN MATCH 0 */
#define BCHP_KBD1_KBD_PAT1                       0x004170f0 /* KEBOARD INPUT PATTERN MATCH 1 */
#define BCHP_KBD1_KBD_PAT2                       0x004170f4 /* KEBOARD INPUT PATTERN MATCH 2 */
#define BCHP_KBD1_STATUS2                        0x004170fc /* KEYBOARD/REMOTE RECEIVER STATUS2 REGISTER */
