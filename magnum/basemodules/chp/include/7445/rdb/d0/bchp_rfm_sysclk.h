 ...
 ***************************************************************************/
#define BCHP_RFM_SYSCLK_CLKCTL                   0x0045c000 /* RF Modulator clock control */
#define BCHP_RFM_SYSCLK_RESET                    0x0045c004 /* RF modulator soft reset */
#define BCHP_RFM_SYSCLK_NCOINVID                 0x0045c008 /* Audio Input VID - NCO control word */
#define BCHP_RFM_SYSCLK_VIDCNTL                  0x0045c00c /* Audio BTSC VID - Delayed start control */
#define BCHP_RFM_SYSCLK_VIDPHASE                 0x0045c010 /* Audio BTSC VID - Initial values of NCOs */
#define BCHP_RFM_SYSCLK_NCOINT                   0x0045c014 /* Audio BTSC VID - Integer numerator for internal NCO */
#define BCHP_RFM_SYSCLK_NCOREM                   0x0045c018 /* Audio BTSC VID - Remainder for internal NCO */
#define BCHP_RFM_SYSCLK_NCODEN                   0x0045c01c /* Audio BTSC VID - Denominator for internal NCO */
#define BCHP_RFM_SYSCLK_DACCTL                   0x0045c020 /* RF modulator DAC control */
#define BCHP_RFM_SYSCLK_AMFREQ                   0x0045c024 /* Frequency control word for the RF carrier DDFS */
#define BCHP_RFM_SYSCLK_MODBYP                   0x0045c028 /* Bypass control for the sub-blocks in the amplitude modulator portion of the RF Modulator */
#define BCHP_RFM_SYSCLK_MODTST                   0x0045c02c /* Testability control for the amplitude modulator */
#define BCHP_RFM_SYSCLK_TPRATE                   0x0045c030 /* Control for the testport output decimation ratio of amplitude modulator */
#define BCHP_RFM_SYSCLK_OUTSCL                   0x0045c034 /* Control for the scaler at the output of the RF Modulator block */
#define BCHP_RFM_SYSCLK_LINEFCW                  0x0045c038 /* Line sync frequency control word for artificial line sync */
#define BCHP_RFM_SYSCLK_VCLK1                    0x0045c03c /* Video input FIFO freezing control */
#define BCHP_RFM_SYSCLK_BISTCNTL                 0x0045c060 /* RF modulator logic BIST control */
#define BCHP_RFM_SYSCLK_BISTSTAT                 0x0045c064 /* Read-only RF modulator logic BIST test status */
#define BCHP_RFM_SYSCLK_AUCRC1                   0x0045c068 /* Read-only RF modulator audio channel 1 pre-FIFO data CRC signature */
#define BCHP_RFM_SYSCLK_AUCRC2                   0x0045c06c /* Read-only RF modulator audio channel 2 pre-FIFO data CRC signature */
#define BCHP_RFM_SYSCLK_AUCRC3                   0x0045c070 /* Read-only RF modulator audio channel 1 post-FIFO data CRC signature */
#define BCHP_RFM_SYSCLK_AUCRC4                   0x0045c074 /* Read-only RF modulator audio channel 2 post-FIFO data CRC signature */
#define BCHP_RFM_SYSCLK_AUCRC5                   0x0045c078 /* Read-only RF modulator audio L+R channel output Cauer filter CRC signature */
#define BCHP_RFM_SYSCLK_AUCRC6                   0x0045c07c /* Read-only RF modulator audio L-R channel output Cauer filter CRC signature */
#define BCHP_RFM_SYSCLK_AUCRC7                   0x0045c080 /* Read-only RF modulator audio spectral gain logic BIST CRC signature */
#define BCHP_RFM_SYSCLK_AUCRC8                   0x0045c084 /* Read-only RF modulator audio wide-band gain logic BIST CRC signature */
#define BCHP_RFM_SYSCLK_VICRC1                   0x0045c088 /* Read-only RF modulator video pre-FIFO data CRC signature */
#define BCHP_RFM_SYSCLK_VICRC2                   0x0045c08c /* Read-only RF modulator video post-FIFO data CRC signature */
#define BCHP_RFM_SYSCLK_AVCRC                    0x0045c090 /* Read-only RF modulator audio/video logic BIST CRC signature */
#define BCHP_RFM_SYSCLK_AMCRC                    0x0045c094 /* Read-only RF modulator amplitude modulator logic BIST CRC signature */
#define BCHP_RFM_SYSCLK_TPCRC1                   0x0045c098 /* Read-only RF modulator audio 27MHz testport output CRC signature */
#define BCHP_RFM_SYSCLK_TPCRC2                   0x0045c09c /* Read-only RF modulator video 27MHz testport output CRC signature */
#define BCHP_RFM_SYSCLK_STATUS                   0x0045c0a4 /* Read-only RFM status register for interrupt conditions */
#define BCHP_RFM_SYSCLK_MISC                     0x0045c0ac /* Miscellaneous register */
#define BCHP_RFM_SYSCLK_REVID                    0x0045c0b0 /* Read-only RF Modulator REVID register */
#define BCHP_RFM_SYSCLK_TSTCNTL                  0x0045c0b4 /* General control for the RF Modulator testport IOs */
#define BCHP_RFM_SYSCLK_TPOUT                    0x0045c0b8 /* TP_OUT bus value */
#define BCHP_RFM_SYSCLK_RFMPHY_BISTCNTL          0x0045c0e4 /* RFMPHY Logic BIST Control Register */
#define BCHP_RFM_SYSCLK_RFMPHY_STATUS            0x0045c0e8 /* Read-only RFMPHY CRC Register */
#define BCHP_RFM_SYSCLK_RFMPHY_BIASCNTL          0x0045c0ec /* RFMPHY Bias Control Register */
#define BCHP_RFM_SYSCLK_DPLL_DIV1                0x0045c0f4 /* Phase Lock Loop Divider Control Register 1 */
#define BCHP_RFM_SYSCLK_DPLL_DIV2                0x0045c0f8 /* Phase Lock Loop Divider Control Register 2 */
#define BCHP_RFM_SYSCLK_DPLL_CH0                 0x0045c0fc /* Phase Lock Loop Channel 0 Control Register */
#define BCHP_RFM_SYSCLK_DPLL_MISC1               0x0045c100 /* Phase Lock Loop Misc Control Register 1 */
#define BCHP_RFM_SYSCLK_DPLL_MISC2               0x0045c104 /* Phase Lock Loop Misc Control Register 2 */
#define BCHP_RFM_SYSCLK_DPLL_MISC3               0x0045c108 /* Phase Lock Loop Misc Control Register 3 */
#define BCHP_RFM_SYSCLK_WDAC_CTL                 0x0045c10c /* RFM DAC Control Register 2 */
#define BCHP_RFM_SYSCLK_RFMPHY_EXTRA_STATUS      0x0045c110 /* Additional RFMPHY Status Register */
#define BCHP_RFM_SYSCLK_SARADC_CH                0x0045c114 /* SARADC Channel Register */
#define BCHP_RFM_SYSCLK_SARADC_CTL               0x0045c118 /* SARADC Control Register */
#define BCHP_RFM_SYSCLK_SARADC_DATA              0x0045c11c /* PLL Channel 1 SARADC data */
#define BCHP_RFM_SYSCLK_GLB_PWRUP                0x0045c120 /* RFMPHY Global Powerup Register */
#define BCHP_RFM_SYSCLK_RESERVED1                0x0045c124 /* Reserved register */
