 ...
 ***************************************************************************/
#define BCHP_UPG_UART_DMA_CONTROL                0x0040b600 /* UART DMA CONTROL REGISTER */
#define BCHP_UPG_UART_DMA_TX_BUF_PTR_LO          0x0040b604 /* STARTING ADDRESS OF DATA TO BE WRITTEN TO UART */
#define BCHP_UPG_UART_DMA_TX_BUF_PTR_HI          0x0040b608 /* STARTING ADDRESS OF DATA TO BE WRITTEN TO UART */
#define BCHP_UPG_UART_DMA_RX_BUF_PTR_LO          0x0040b60c /* STARTING ADDRESS OF BUFFER FOR DATA READ FROM UART */
#define BCHP_UPG_UART_DMA_RX_BUF_PTR_HI          0x0040b610 /* STARTING ADDRESS OF BUFFER FOR DATA READ FROM UART */
#define BCHP_UPG_UART_DMA_TX_CTRL                0x0040b614 /* UART TRANSMIT CONTROL */
#define BCHP_UPG_UART_DMA_RX_CTRL                0x0040b618 /* UART RECEIVE CONTROL */
#define BCHP_UPG_UART_DMA_TX_DST_ADDR            0x0040b61c /* UART DMA TRANSMIT DESTINATION ADDRESS */
#define BCHP_UPG_UART_DMA_RX_SRC_ADDR            0x0040b620 /* UART DMA RECEIVE SOURCE ADDRESS */
#define BCHP_UPG_UART_DMA_TX_STATUS              0x0040b624 /* UART DMA TRANSMIT STATUS REGISTER */
#define BCHP_UPG_UART_DMA_RX_STATUS              0x0040b628 /* UART DMA RECEIVE STATUS REGISTER */
#define BCHP_UPG_UART_DMA_TX_REQ_SEL             0x0040b62c /* UART SELECT FOR TRANSMIT */
#define BCHP_UPG_UART_DMA_RX_REQ_SEL             0x0040b630 /* UART SELECT FOR RECEIVE */
