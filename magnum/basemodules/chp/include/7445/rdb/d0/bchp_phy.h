 ...
 *
 *
 * Date:           Generated on              Wed Feb 12 17:00:10 2014
 ...
 *PHY - PHY registers
 ***************************************************************************/
#define BCHP_PHY_FIXD_CMN_VER_1                  0x00fe0000 /* Shows the version number of the HDL */
#define BCHP_PHY_FIXD_CMN_CPU_CTRL_1             0x00fe0004 /* Register enables the CPU to control the PHY */
#define BCHP_PHY_FIXD_CMN_MPC_MPR_CLK_RATE       0x00fe0008 /* hold the rate of  the MPC clocks */
#define BCHP_PHY_FIXD_CMN_TEST_PORTS             0x00fe000c /* test ports select regsiter */
#define BCHP_PHY_FIXD_CMN_TP_SEL                 0x00fe0010 /* Selection of the tp overlay */
#define BCHP_PHY_FIXD_CMN_TPCAP_SEL              0x00fe0014 /* Selection of data forwarded towards the TPCAP */
#define BCHP_PHY_FIXD_RX_PROBES_STATUS           0x00fe0018 /* Indicates if the probe ( I or III) results are ready */
#define BCHP_PHY_FIXD_RX_OFDMA_CFO_0             0x00fe001c /* CFO of OFDMA - result of the pilots , register set index 0. */
#define BCHP_PHY_FIXD_RX_OFDMA_CFO_1             0x00fe0020 /* CFO of OFDMA - result of the pilots , register set index 1. */
#define BCHP_PHY_FIXD_RX_OFDMA_CFO_2             0x00fe0024 /* CFO of OFDMA - result of the pilots , register set index 2. */
#define BCHP_PHY_FIXD_RX_OFDMA_CFO_3             0x00fe0028 /* CFO of OFDMA - result of the pilots , register set index 3. */
#define BCHP_PHY_FIXD_RX_SP_0                    0x00fe002c /* SP Rx bits 7_0 */
#define BCHP_PHY_FIXD_RX_SP_1                    0x00fe0030 /* SP Rx bits 15_8 */
#define BCHP_PHY_FIXD_RX_SP_2                    0x00fe0034 /* SP Rx bits 23_16 */
#define BCHP_PHY_FIXD_RX_SP_3                    0x00fe0038 /* SP Rx bits 29-24 */
#define BCHP_PHY_FIXD_RX_LP1_0                   0x00fe003c /* "LP1 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 0. */
#define BCHP_PHY_FIXD_RX_LP1_1                   0x00fe0040 /* "LP1 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 1. */
#define BCHP_PHY_FIXD_RX_LP1_2                   0x00fe0044 /* "LP1 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 2. */
#define BCHP_PHY_FIXD_RX_LP1_3                   0x00fe0048 /* "LP1 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 3. */
#define BCHP_PHY_FIXD_RX_LP1_4                   0x00fe004c /* "LP1 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 4. */
#define BCHP_PHY_FIXD_RX_LP1_5                   0x00fe0050 /* "LP1 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 5. */
#define BCHP_PHY_FIXD_RX_LP1_6                   0x00fe0054 /* "LP1 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 6. */
#define BCHP_PHY_FIXD_RX_LP1_7                   0x00fe0058 /* "LP1 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 7. */
#define BCHP_PHY_FIXD_RX_LP2_0                   0x00fe005c /* "LP2 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 0. */
#define BCHP_PHY_FIXD_RX_LP2_1                   0x00fe0060 /* "LP2 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 1. */
#define BCHP_PHY_FIXD_RX_LP2_2                   0x00fe0064 /* "LP2 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 2. */
#define BCHP_PHY_FIXD_RX_LP2_3                   0x00fe0068 /* "LP2 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 3. */
#define BCHP_PHY_FIXD_RX_LP2_4                   0x00fe006c /* "LP2 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 4. */
#define BCHP_PHY_FIXD_RX_LP2_5                   0x00fe0070 /* "LP2 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 5. */
#define BCHP_PHY_FIXD_RX_LP2_6                   0x00fe0074 /* "LP2 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 6. */
#define BCHP_PHY_FIXD_RX_LP2_7                   0x00fe0078 /* "LP2 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 7. */
#define BCHP_PHY_FIXD_RX_LP3_0                   0x00fe007c /* "LP3 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 0. */
#define BCHP_PHY_FIXD_RX_LP3_1                   0x00fe0080 /* "LP3 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 1. */
#define BCHP_PHY_FIXD_RX_LP3_2                   0x00fe0084 /* "LP3 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 2. */
#define BCHP_PHY_FIXD_RX_LP3_3                   0x00fe0088 /* "LP3 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 3. */
#define BCHP_PHY_FIXD_RX_LP3_4                   0x00fe008c /* "LP3 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 4. */
#define BCHP_PHY_FIXD_RX_LP3_5                   0x00fe0090 /* "LP3 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 5. */
#define BCHP_PHY_FIXD_RX_LP3_6                   0x00fe0094 /* "LP3 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 6. */
#define BCHP_PHY_FIXD_RX_LP3_7                   0x00fe0098 /* "LP3 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 7. */
#define BCHP_PHY_FIXD_RX_LP4_0                   0x00fe009c /* "LP3 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 0. */
#define BCHP_PHY_FIXD_RX_LP4_1                   0x00fe00a0 /* "LP3 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 1. */
#define BCHP_PHY_FIXD_RX_LP4_2                   0x00fe00a4 /* "LP3 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 2. */
#define BCHP_PHY_FIXD_RX_LP4_3                   0x00fe00a8 /* "LP3 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 3. */
#define BCHP_PHY_FIXD_RX_LP4_4                   0x00fe00ac /* "LP3 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 4. */
#define BCHP_PHY_FIXD_RX_LP4_5                   0x00fe00b0 /* "LP3 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 5. */
#define BCHP_PHY_FIXD_RX_LP4_6                   0x00fe00b4 /* "LP3 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 6. */
#define BCHP_PHY_FIXD_RX_LP4_7                   0x00fe00b8 /* "LP3 Rx bits 63_0,  4bits selec for each bit,  split to eight registers" , register set index 7. */
#define BCHP_PHY_FIXD_RX_LP5_0                   0x00fe00bc /* long preamble sequence for moca2.0 rx data burst , register set index 0. */
#define BCHP_PHY_FIXD_RX_LP5_1                   0x00fe00c0 /* long preamble sequence for moca2.0 rx data burst , register set index 1. */
#define BCHP_PHY_FIXD_RX_LP5_2                   0x00fe00c4 /* long preamble sequence for moca2.0 rx data burst , register set index 2. */
#define BCHP_PHY_FIXD_RX_LP5_3                   0x00fe00c8 /* long preamble sequence for moca2.0 rx data burst , register set index 3. */
#define BCHP_PHY_FIXD_RX_LP5_4                   0x00fe00cc /* long preamble sequence for moca2.0 rx data burst , register set index 4. */
#define BCHP_PHY_FIXD_RX_LP5_5                   0x00fe00d0 /* long preamble sequence for moca2.0 rx data burst , register set index 5. */
#define BCHP_PHY_FIXD_RX_LP5_6                   0x00fe00d4 /* long preamble sequence for moca2.0 rx data burst , register set index 6. */
#define BCHP_PHY_FIXD_RX_LP5_7                   0x00fe00d8 /* long preamble sequence for moca2.0 rx data burst , register set index 7. */
#define BCHP_PHY_FIXD_RX_LP6_0                   0x00fe00dc /* long preamble sequence for moca2.0 rx map burst , register set index 0. */
#define BCHP_PHY_FIXD_RX_LP6_1                   0x00fe00e0 /* long preamble sequence for moca2.0 rx map burst , register set index 1. */
#define BCHP_PHY_FIXD_RX_LP6_2                   0x00fe00e4 /* long preamble sequence for moca2.0 rx map burst , register set index 2. */
#define BCHP_PHY_FIXD_RX_LP6_3                   0x00fe00e8 /* long preamble sequence for moca2.0 rx map burst , register set index 3. */
#define BCHP_PHY_FIXD_RX_LP6_4                   0x00fe00ec /* long preamble sequence for moca2.0 rx map burst , register set index 4. */
#define BCHP_PHY_FIXD_RX_LP6_5                   0x00fe00f0 /* long preamble sequence for moca2.0 rx map burst , register set index 5. */
#define BCHP_PHY_FIXD_RX_LP6_6                   0x00fe00f4 /* long preamble sequence for moca2.0 rx map burst , register set index 6. */
#define BCHP_PHY_FIXD_RX_LP6_7                   0x00fe00f8 /* long preamble sequence for moca2.0 rx map burst , register set index 7. */
#define BCHP_PHY_FIXD_RX_LP7_0                   0x00fe00fc /* moca2.0 CE sequence  for cross correlation  in RX , register set index 0. */
#define BCHP_PHY_FIXD_RX_LP7_1                   0x00fe0100 /* moca2.0 CE sequence  for cross correlation  in RX , register set index 1. */
#define BCHP_PHY_FIXD_RX_LP7_2                   0x00fe0104 /* moca2.0 CE sequence  for cross correlation  in RX , register set index 2. */
#define BCHP_PHY_FIXD_RX_LP7_3                   0x00fe0108 /* moca2.0 CE sequence  for cross correlation  in RX , register set index 3. */
#define BCHP_PHY_FIXD_RX_LP7_4                   0x00fe010c /* moca2.0 CE sequence  for cross correlation  in RX , register set index 4. */
#define BCHP_PHY_FIXD_RX_LP7_5                   0x00fe0110 /* moca2.0 CE sequence  for cross correlation  in RX , register set index 5. */
#define BCHP_PHY_FIXD_RX_LP7_6                   0x00fe0114 /* moca2.0 CE sequence  for cross correlation  in RX , register set index 6. */
#define BCHP_PHY_FIXD_RX_LP7_7                   0x00fe0118 /* moca2.0 CE sequence  for cross correlation  in RX , register set index 7. */
#define BCHP_PHY_FIXD_CMN_M2_CE_BIT_LOAD_0       0x00fe011c /* RX channel estimation bit load , register set index 0. */
#define BCHP_PHY_FIXD_CMN_M2_CE_BIT_LOAD_1       0x00fe0120 /* RX channel estimation bit load , register set index 1. */
#define BCHP_PHY_FIXD_CMN_M2_CE_BIT_LOAD_2       0x00fe0124 /* RX channel estimation bit load , register set index 2. */
#define BCHP_PHY_FIXD_CMN_M2_CE_BIT_LOAD_3       0x00fe0128 /* RX channel estimation bit load , register set index 3. */
#define BCHP_PHY_FIXD_CMN_M2_CE_BIT_LOAD_4       0x00fe012c /* RX channel estimation bit load , register set index 4. */
#define BCHP_PHY_FIXD_CMN_M2_CE_BIT_LOAD_5       0x00fe0130 /* RX channel estimation bit load , register set index 5. */
#define BCHP_PHY_FIXD_CMN_M2_CE_BIT_LOAD_6       0x00fe0134 /* RX channel estimation bit load , register set index 6. */
#define BCHP_PHY_FIXD_CMN_M2_CE_BIT_LOAD_7       0x00fe0138 /* RX channel estimation bit load , register set index 7. */
#define BCHP_PHY_FIXD_CMN_M2_CE_BIT_LOAD_8       0x00fe013c /* RX channel estimation bit load , register set index 8. */
#define BCHP_PHY_FIXD_CMN_M2_CE_BIT_LOAD_9       0x00fe0140 /* RX channel estimation bit load , register set index 9. */
#define BCHP_PHY_FIXD_CMN_M2_CE_BIT_LOAD_10      0x00fe0144 /* RX channel estimation bit load , register set index 10. */
#define BCHP_PHY_FIXD_CMN_M2_CE_BIT_LOAD_11      0x00fe0148 /* RX channel estimation bit load , register set index 11. */
#define BCHP_PHY_FIXD_CMN_M2_CE_BIT_LOAD_12      0x00fe014c /* RX channel estimation bit load , register set index 12. */
#define BCHP_PHY_FIXD_CMN_M2_CE_BIT_LOAD_13      0x00fe0150 /* RX channel estimation bit load , register set index 13. */
#define BCHP_PHY_FIXD_CMN_M2_CE_BIT_LOAD_14      0x00fe0154 /* RX channel estimation bit load , register set index 14. */
#define BCHP_PHY_FIXD_CMN_M2_CE_BIT_LOAD_15      0x00fe0158 /* RX channel estimation bit load , register set index 15. */
#define BCHP_PHY_FIXD_CMN_GPIO_OUT               0x00fe015c /* GPIO output data */
#define BCHP_PHY_FIXD_CMN_DPM_TMR_CFG_0          0x00fe0160 /* DMP counters */
#define BCHP_PHY_FIXD_CMN_DPM_TMR_CFG_1          0x00fe0164 /* DMP counters */
#define BCHP_PHY_FIXD_CMN_DPM_ZONE_CTRL          0x00fe0168 /* DMP counters */
#define BCHP_PHY_FIXD_CMN_DPM_STAT               0x00fe016c /* per zone power status */
#define BCHP_PHY_BRST_CMN_BYPASS_1               0x00fe2000 /* Debug Bypass Register */
#define BCHP_PHY_BRST_CMN_DELAYES_1              0x00fe2004 /* Delays in the PHY and some TDU parameters */
#define BCHP_PHY_BRST_CMN_DELAYES_2              0x00fe2008 /* Delays in the PHY and some TDU parameters */
#define BCHP_PHY_BRST_CMN_MPD_CLK_RATE           0x00fe200c /* hold the rate of  the MPI clocks */
#define BCHP_PHY_BRST_TX_NOR_FAC                 0x00fe2010 /* Probe and Preamble Factor related params */
#define BCHP_PHY_BRST_RX_ACQUISITION_1           0x00fe2014 /* Fixed acquisition registers */
#define BCHP_PHY_BRST_RX_ACQUISITION_2           0x00fe2018 /* Fixed acquisition registers */
#define BCHP_PHY_BRST_CMN_AFE_COUNTERS           0x00fe201c /* AFE Counters */
#define BCHP_PHY_BRST_TX_TXON_TIMER              0x00fe2020 /* TXON Timer */
#define BCHP_PHY_BRST_TX_TXOFF_TIMER             0x00fe2024 /* TXOFF Timer */
#define BCHP_PHY_BRST_RX_RXON_TIMER              0x00fe2028 /* RXON Timer */
#define BCHP_PHY_BRST_RX_AFE_TEST_MODE           0x00fe202c /* RX Gain Set */
#define BCHP_PHY_BRST_RX_AGC_PARAM_1             0x00fe2030 /* AGC Parameter - Windows */
#define BCHP_PHY_BRST_RX_AGC_PARAM_2             0x00fe2034 /* AGC Parameter - Threshold */
#define BCHP_PHY_BRST_RX_AGC_PARAM_3             0x00fe2038 /* AGC Parameter Gain Settings */
#define BCHP_PHY_BRST_RX_AGC_PARAM_4             0x00fe203c /* AGC Parameter Gain Settings */
#define BCHP_PHY_BRST_RX_CFO_SFO_STEP_PYLD       0x00fe2040 /* CFO & SFO step sizes */
#define BCHP_PHY_BRST_RX_CFO_SFO_STEP_CE         0x00fe2044 /* CFO & SFO step sizes */
#define BCHP_PHY_BRST_TX_TD_TONE_0               0x00fe2048 /* TD tone parameters */
#define BCHP_PHY_BRST_TX_TD_TONE_1               0x00fe204c /* TD tone parameters */
#define BCHP_PHY_BRST_TX_IQ_COR                  0x00fe2050 /* IQ correction parameters */
#define BCHP_PHY_BRST_RX_PILOTS_FACTORS          0x00fe2054 /* RX Burst Parameters #2 */
#define BCHP_PHY_BRST_RX_PILOTS_CE_FACTORS       0x00fe2058 /* RX Burst Parameters #2 */
#define BCHP_PHY_BRST_CMN_FEC                    0x00fe205c /* LDPC and RS parameters */
#define BCHP_PHY_BRST_CMN_AES_INITIAL_VAL_0      0x00fe2060 /* AES initial value , register set index 0. */
#define BCHP_PHY_BRST_CMN_AES_INITIAL_VAL_1      0x00fe2064 /* AES initial value , register set index 1. */
#define BCHP_PHY_BRST_CMN_AES_INITIAL_VAL_2      0x00fe2068 /* AES initial value , register set index 2. */
#define BCHP_PHY_BRST_CMN_AES_INITIAL_VAL_3      0x00fe206c /* AES initial value , register set index 3. */
#define BCHP_PHY_BRST_TX_GAIN                    0x00fe2070 /* Preamble Processing Parameters II + Normal RS + Farrow */
#define BCHP_PHY_BRST_CMN_GEN                    0x00fe2074 /* Preamble Processing Parameters II + Normal RS + Farrow */
#define BCHP_PHY_BRST_TX_INIT_GEN                0x00fe2078 /* TX init regsiter */
#define BCHP_PHY_BRST_CMN_INIT_TP_SC_LOCATION    0x00fe207c /* "ProbeII SC1, SC2" */
#define BCHP_PHY_BRST_CMN_INIT_AES_DES_KEY_0     0x00fe2080 /* DES key sequence - Low Portion , register set index 0. */
#define BCHP_PHY_BRST_CMN_INIT_AES_DES_KEY_1     0x00fe2084 /* DES key sequence - Low Portion , register set index 1. */
#define BCHP_PHY_BRST_CMN_INIT_AES_DES_KEY_2     0x00fe2088 /* DES key sequence - Low Portion , register set index 2. */
#define BCHP_PHY_BRST_CMN_INIT_AES_DES_KEY_3     0x00fe208c /* DES key sequence - Low Portion , register set index 3. */
#define BCHP_PHY_BRST_CMN_INIT_SCRM_SEED         0x00fe2090 /* Rx and Tx Burst Parameters #1 */
#define BCHP_PHY_BRST_CMN_INIT_FRAME             0x00fe2094 /* Rx and Tx Burst Parameters #2 */
#define BCHP_PHY_BRST_CMN_INIT_FEC               0x00fe2098 /* Fec Parameters */
#define BCHP_PHY_BRST_CMN_INIT_GEN               0x00fe209c /* common Burst Init Parameters */
#define BCHP_PHY_BRST_CMN_INIT_FRAME_1           0x00fe20a0 /* Rx and Tx Burst Parameters #2 */
#define BCHP_PHY_BRST_RX_INIT_RESULTS_READ       0x00fe20a4 /* RX Results Reading Register and RX-Learning Parameters Load */
#define BCHP_PHY_BRST_RX_INIT_TIMEOUT            0x00fe20a8 /* RX Burst Init Parameters #2 */
#define BCHP_PHY_BRST_RX_INIT_GEN                0x00fe20ac /* RX Burst Init Parameters #1 */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_1            0x00fe2200 /* TX Burst Switches */
#define BCHP_PHY_BRST_TX_PROF_RF_SW_2            0x00fe2204 /* TX Burst Switches */
#define BCHP_PHY_BRST_TX_PROF_RF_1               0x00fe2208 /* Profile TX - Gain */
#define BCHP_PHY_BRST_TX_PROF_GAIN               0x00fe220c /* Profile TX */
#define BCHP_PHY_BRST_TX_PROF_MAIN_CFO           0x00fe2210 /* Profile TX */
#define BCHP_PHY_BRST_TX_PROF_MAIN_SFO           0x00fe2214 /* Profile TX */
#define BCHP_PHY_BRST_CMN_PROF_MODE              0x00fe2218 /* profile mode */
#define BCHP_PHY_BRST_CMN_PROF_GEN               0x00fe221c /* common profiles */
#define BCHP_PHY_BRST_RX_PROF_PILOT_SC_MASK_0    0x00fe2500 /* Pilot sub  carrier mask vector  #1 , register set index 0. */
#define BCHP_PHY_BRST_RX_PROF_PILOT_SC_MASK_1    0x00fe2504 /* Pilot sub  carrier mask vector  #1 , register set index 1. */
#define BCHP_PHY_BRST_RX_PROF_PILOT_SC_MASK_2    0x00fe2508 /* Pilot sub  carrier mask vector  #1 , register set index 2. */
#define BCHP_PHY_BRST_RX_PROF_PILOT_SC_MASK_3    0x00fe250c /* Pilot sub  carrier mask vector  #1 , register set index 3. */
#define BCHP_PHY_BRST_RX_PROF_PILOT_SC_MASK_4    0x00fe2510 /* Pilot sub  carrier mask vector  #1 , register set index 4. */
#define BCHP_PHY_BRST_RX_PROF_PILOT_SC_MASK_5    0x00fe2514 /* Pilot sub  carrier mask vector  #1 , register set index 5. */
#define BCHP_PHY_BRST_RX_PROF_PILOT_SC_MASK_6    0x00fe2518 /* Pilot sub  carrier mask vector  #1 , register set index 6. */
#define BCHP_PHY_BRST_RX_PROF_PILOT_SC_MASK_7    0x00fe251c /* Pilot sub  carrier mask vector  #1 , register set index 7. */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_1            0x00fe2520 /* RX Burst Switches */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_2            0x00fe2524 /* RX Burst Switches */
#define BCHP_PHY_BRST_RX_PROF_RF_SW_3            0x00fe2528 /* RX Burst Switches */
#define BCHP_PHY_BRST_RX_PROF_LDPC_SLOTS         0x00fe252c /* LDPC slots */
#define BCHP_PHY_BRST_RX_PROF_ACQ_HPF            0x00fe2530 /* HPF Poles and Gains */
#define BCHP_PHY_BRST_RX_PROF_ACQUISITION_0      0x00fe2534 /* Acquisition */
#define BCHP_PHY_BRST_RX_PROF_ACQUISITION_1      0x00fe2538 /* Acquisition Parameter #1 */
#define BCHP_PHY_BRST_RX_PROF_ACQUISITION_2      0x00fe253c /* Acquisition Parameter #1 */
#define BCHP_PHY_BRST_RX_PROF_ACQUISITION_3      0x00fe2540 /* Acquisition Parameter #1 */
#define BCHP_PHY_BRST_RX_PROF_COG_LUT_1          0x00fe2544 /* COG K factor LUT */
#define BCHP_PHY_BRST_RX_PROF_COG_LUT_2          0x00fe2548 /* COG K factor LUT */
#define BCHP_PHY_BRST_RX_PROF_IQ_COR             0x00fe254c /* IQ correction profile */
#define BCHP_PHY_BRST_RX_PROF_GEN_1              0x00fe2550 /* RX generic profile */
#define BCHP_PHY_BRST_RX_PROF_GEN_2              0x00fe2554 /* RX generic profile */
#define BCHP_PHY_BRST_RX_PROF_CFO_SFO_OFFSET     0x00fe2558 /* CFO and SFO offsets - different number in turbo */
#define BCHP_PHY_BRST_RX_PROF_DETECT_DELAY_EXPECTED 0x00fe255c /* expected detect delay in derived line clocks */
#define BCHP_PHY_BRST_RX_PROF_RF_1               0x00fe2560 /* Rx RF Parameters */
#define BCHP_PHY_BRST_RX_PROF_RF_2               0x00fe2564 /* Rx RF Parameters */
#define BCHP_PHY_BRST_RX_PROF_CFO                0x00fe2568 /* Rx Burst Learn Parameters #1 */
#define BCHP_PHY_BRST_RX_PROF_SFO                0x00fe256c /* Rx Burst Learn Parameters #2 */
#define BCHP_PHY_RSLT_RX_STATISTICS_STATUS       0x00fe3000 /* Indicates the receive burst status */
#define BCHP_PHY_RSLT_RX_STATISTICS_FEC_UNERROR  0x00fe3004 /* The number of blocks has no FEC error */
#define BCHP_PHY_RSLT_RX_STATISTICS_FEC_CORRECTED 0x00fe3008 /* The number of blocks has FEC errors and corrections */
#define BCHP_PHY_RSLT_RX_STATISTICS_FEC_UNCORRECTED 0x00fe300c /* The number of blocks has un-correctable FEC errors */
#define BCHP_PHY_RSLT_RX_STATISTICS_LDPC_ITER    0x00fe3010 /* The number of iterrations performed by LDPC */
#define BCHP_PHY_RSLT_RX_STATISTICS_PP_P_EN_DATA 0x00fe3014 /* Samples the absolute value of the Power function at the maximum level found so far */
#define BCHP_PHY_RSLT_RX_STATISTICS_PP_A_AC_MAX_REAL 0x00fe3018 /* Samples the real value of the auto-correlation function at the maximum level found so far */
#define BCHP_PHY_RSLT_RX_STATISTICS_PP_A_AC_MAX_IMAG 0x00fe301c /* Samples the image value of the auto-correlation function at the maximum level found so far */
#define BCHP_PHY_RSLT_RX_STATISTICS_PP_ABS_VAL   0x00fe3020 /* Samples the absolute value of the auto-correlation function maximum found so far */
#define BCHP_PHY_RSLT_RX_STATISTICS_COG_OFFSET   0x00fe3024 /* COG offset */
#define BCHP_PHY_RSLT_RX_LEARNING_AGC_STAT_RSSI_AVRG 0x00fe3028 /* AGC RSSI */
#define BCHP_PHY_RSLT_RX_LEARNING_GAIN           0x00fe302c /* Gain Result */
#define BCHP_PHY_RSLT_RX_LEARNING_CFO            0x00fe3030 /* Rx Learning register #1 */
#define BCHP_PHY_RSLT_RX_LEARNING_SFO            0x00fe3034 /* Rx Learning register #2 */
#define BCHP_PHY_RSLT_RX_LEARNING_DETECT_DELAY_OFFSET 0x00fe3038 /* "Rx Learning detection delay,Learning_detect_delay_offset = detect_delay_measure - detect_delay_expected" */
#define BCHP_PHY_RSLT_RX_LEARNING_FEC_UNCORRECTED 0x00fe303c /* "The number of blocks has un-correctable FEC errors,,this has the same value as in the statistics uncorrected, it was required by,the SW for figuring out if the learning belong to a CRC error burst" */
#define BCHP_PHY_RSLT_TX_CALIBRATION_GOERTZEL    0x00fe3040 /* Gortzel Results */
