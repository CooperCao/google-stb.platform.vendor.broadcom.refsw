 ...
 ***************************************************************************/
#define BCHP_XPT_TSIO_CALIB_REGISTERS_PAD_CTRL   0x00a0f000 /* TSIO Pad Control Register */
#define BCHP_XPT_TSIO_CALIB_REGISTERS_CALIB_CTRL 0x00a0f004 /* TSIO Control Register */
#define BCHP_XPT_TSIO_CALIB_REGISTERS_DLCM_L_PHASE_SELECT 0x00a0f010 /* Sampling Clock Phase Select for the 'left' line monitor */
#define BCHP_XPT_TSIO_CALIB_REGISTERS_CENTER_TAP_PHASE_SELECT 0x00a0f014 /* Sampling Clock Phase Select for the 'center' line monitor */
#define BCHP_XPT_TSIO_CALIB_REGISTERS_DLCM_R_PHASE_SELECT 0x00a0f018 /* Sampling Clock Phase Select for the 'right' line monitor */
#define BCHP_XPT_TSIO_CALIB_REGISTERS_TRAINING_CTRL 0x00a0f020 /* TSIO Training Control Register */
#define BCHP_XPT_TSIO_CALIB_REGISTERS_TRAINING_PATTERN 0x00a0f024 /* TSIO Training Pattern */
#define BCHP_XPT_TSIO_CALIB_REGISTERS_TRAINING_MEMORY_START_ADDR 0x00a0f028 /* Start Address of the Training Memory */
#define BCHP_XPT_TSIO_CALIB_REGISTERS_CURR_TRAINING_MEMORY_ADDR 0x00a0f02c /* Current Address of the Training Memory */
#define BCHP_XPT_TSIO_CALIB_REGISTERS_NUM_VDL_ITERATIONS 0x00a0f030 /* Number of VDL Iterations */
#define BCHP_XPT_TSIO_CALIB_REGISTERS_VDL_INCREMENT 0x00a0f034 /* VDL Increment Value */
#define BCHP_XPT_TSIO_CALIB_REGISTERS_XVDL_A_VALUE 0x00a0f040 /* Value for XVDL_A */
#define BCHP_XPT_TSIO_CALIB_REGISTERS_XVDL_B_VALUE 0x00a0f044 /* Value for XVDL_B */
#define BCHP_XPT_TSIO_CALIB_REGISTERS_XVDL_C_VALUE 0x00a0f048 /* Value for XVDL_C */
#define BCHP_XPT_TSIO_CALIB_REGISTERS_XVDL_TX_CLK 0x00a0f04c /* Value for XVDL on Tx clk path */
#define BCHP_XPT_TSIO_CALIB_REGISTERS_XVDL_TX_DATA 0x00a0f050 /* Value for XVDL on Tx data path */
#define BCHP_XPT_TSIO_CALIB_REGISTERS_XVDL_CFG   0x00a0f054 /* Special XVDL config mode for robustness on Rx path */
#define BCHP_XPT_TSIO_CALIB_REGISTERS_VDL_STEP_CALIB_CTRL 0x00a0f058 /* TSIO VDL Auto Step Size Calibration Control Register */
#define BCHP_XPT_TSIO_CALIB_REGISTERS_VDL_CALIB_STATUS 0x00a0f05c /* VDL auto-calib status register */
#define BCHP_XPT_TSIO_CALIB_REGISTERS_VDL_SEGMENT 0x00a0f060 /* Number of VDL segments in each XVDL */
#define BCHP_XPT_TSIO_CALIB_REGISTERS_CURR_XVDL_A_VALUE 0x00a0f064 /* Current Value for XVDL_A */
#define BCHP_XPT_TSIO_CALIB_REGISTERS_CURR_XVDL_B_VALUE 0x00a0f068 /* Current Value for XVDL_B */
#define BCHP_XPT_TSIO_CALIB_REGISTERS_CURR_XVDL_C_VALUE 0x00a0f06c /* Current Value for XVDL_C */
#define BCHP_XPT_TSIO_CALIB_REGISTERS_SYNC_COUNT 0x00a0f070 /* TSIO Sync Count register */
#define BCHP_XPT_TSIO_CALIB_REGISTERS_SYNC_STATUS 0x00a0f074 /* TSIO Sync status */
#define BCHP_XPT_TSIO_CALIB_REGISTERS_DEBUG_SYNC_COUNT 0x00a0f078 /* Received sync count statistics for debug purposes */
#define BCHP_XPT_TSIO_CALIB_REGISTERS_CALIB_DEBUG_0 0x00a0f07c /* TSIO Debug Register */
#define BCHP_XPT_TSIO_CALIB_REGISTERS_CALIB_DEBUG_1 0x00a0f080 /* TSIO Debug Register */
#define BCHP_XPT_TSIO_CALIB_REGISTERS_CALIB_DEBUG_2 0x00a0f084 /* TSIO Debug Register */
#define BCHP_XPT_TSIO_CALIB_REGISTERS_DEBUG_DLCM_CTRL1 0x00a0f090 /* DLCM debug control register */
#define BCHP_XPT_TSIO_CALIB_REGISTERS_DEBUG_DLCM_CTRL2 0x00a0f094 /* DLCM debug control register */
#define BCHP_XPT_TSIO_CALIB_REGISTERS_DEBUG_DLCM_STATUS 0x00a0f098 /* Status register for DLCM event capture logic */
#define BCHP_XPT_TSIO_CALIB_REGISTERS_DEBUG_DLCM_GLOBAL_CLK_COUNT 0x00a0f09c /* Total number of clock cycles elapsed during DLCM observation */
#define BCHP_XPT_TSIO_CALIB_REGISTERS_DEBUG_DLCML_EVENT_COUNT 0x00a0f0a0 /* DLCM_L event count register */
#define BCHP_XPT_TSIO_CALIB_REGISTERS_DEBUG_DLCML_MARKER_COUNT1 0x00a0f0a4 /* DLCM_L event marker#1 register */
#define BCHP_XPT_TSIO_CALIB_REGISTERS_DEBUG_DLCML_MARKER_COUNT2 0x00a0f0a8 /* DLCM_L event marker#2 register */
#define BCHP_XPT_TSIO_CALIB_REGISTERS_DEBUG_DLCML_MARKER_COUNT3 0x00a0f0ac /* DLCM_L event marker#3 register */
#define BCHP_XPT_TSIO_CALIB_REGISTERS_DEBUG_DLCMR_EVENT_COUNT 0x00a0f0b0 /* DLCM_R event count register */
#define BCHP_XPT_TSIO_CALIB_REGISTERS_DEBUG_DLCMR_MARKER_COUNT1 0x00a0f0b4 /* DLCM_R event marker#1 register */
#define BCHP_XPT_TSIO_CALIB_REGISTERS_DEBUG_DLCMR_MARKER_COUNT2 0x00a0f0b8 /* DLCM_R event marker#2 register */
#define BCHP_XPT_TSIO_CALIB_REGISTERS_DEBUG_DLCMR_MARKER_COUNT3 0x00a0f0bc /* DLCM_R event marker#3 register */
#define BCHP_XPT_TSIO_CALIB_REGISTERS_DEBUG_DLCML_SAMPLES 0x00a0f0c0 /* Bit samples of the DLCM_L bit */
#define BCHP_XPT_TSIO_CALIB_REGISTERS_DEBUG_CENTER_SAMPLES 0x00a0f0c4 /* Bit samples of the center tap bit */
#define BCHP_XPT_TSIO_CALIB_REGISTERS_DEBUG_DLCMR_SAMPLES 0x00a0f0c8 /* Bit samples of the DLCM_R bit */
