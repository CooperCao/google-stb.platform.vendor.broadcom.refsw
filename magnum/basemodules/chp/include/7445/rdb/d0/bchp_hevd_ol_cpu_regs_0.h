 ...
 *HEVD_OL_CPU_REGS_0
 ***************************************************************************/
#define BCHP_HEVD_OL_CPU_REGS_0_HST2CPU_MBX      0x00000000 /* Host 2 CPU mailbox register */
#define BCHP_HEVD_OL_CPU_REGS_0_CPU2HST_MBX      0x00000004 /* CPU to Host mailbox register */
#define BCHP_HEVD_OL_CPU_REGS_0_MBX_STAT         0x00000008 /* Mailbox status flags */
#define BCHP_HEVD_OL_CPU_REGS_0_INST_BASE        0x0000000c /* Instruction base address register */
#define BCHP_HEVD_OL_CPU_REGS_0_CPU_INT_ENA      0x00000010 /* CPU interrupt enable */
#define BCHP_HEVD_OL_CPU_REGS_0_CPU_INT_STAT     0x00000014 /* CPU interrupt status */
#define BCHP_HEVD_OL_CPU_REGS_0_HST2CPU_STAT     0x00000018 /* Host to CPU status register */
#define BCHP_HEVD_OL_CPU_REGS_0_CPU2HST_STAT     0x0000001c /* CPU to Host status register */
#define BCHP_HEVD_OL_CPU_REGS_0_CPU_INTGEN_SET   0x00000020 /* CPU interrupt set register */
#define BCHP_HEVD_OL_CPU_REGS_0_CPU_INTGEN_CLR   0x00000024 /* CPU interrupt clear register */
#define BCHP_HEVD_OL_CPU_REGS_0_CPU_ICACHE_MISS  0x00000028 /* Instruction cache miss counter */
#define BCHP_HEVD_OL_CPU_REGS_0_CPU_INTGEN_MASK  0x0000002c /* CPU interrupt mask register */
#define BCHP_HEVD_OL_CPU_REGS_0_DRAM_RD_CNTR     0x00000030 /* CPU DRAM Read access Counter */
#define BCHP_HEVD_OL_CPU_REGS_0_END_OF_CODE      0x00000034 /* End of code register */
#define BCHP_HEVD_OL_CPU_REGS_0_GLOBAL_IO_BASE   0x00000038 /* Global IO base register */
#define BCHP_HEVD_OL_CPU_REGS_0_DEBUG_TRACE_FIFO_WR 0x0000003c /* CPU debug trace fifo write */
#define BCHP_HEVD_OL_CPU_REGS_0_DEBUG_TRACE_FIFO_RD 0x00000040 /* CPU debug trace fifo read */
#define BCHP_HEVD_OL_CPU_REGS_0_DEBUG_TRACE_FIFO_CTL 0x00000044 /* CPU debug trace fifo control */
#define BCHP_HEVD_OL_CPU_REGS_0_DRAM_WR_CNTR     0x00000048 /* CPU DRAM Write access Counter */
#define BCHP_HEVD_OL_CPU_REGS_0_WATCHDOG_TMR     0x0000004c /* Watchdog timer register */
#define BCHP_HEVD_OL_CPU_REGS_0_SDRAM_STATUS     0x00000050 /* SDRAM Status register */
#define BCHP_HEVD_OL_CPU_REGS_0_DEBUG_CTL        0x00000054 /* Debug Control */
#define BCHP_HEVD_OL_CPU_REGS_0_CMD_REG0         0x00000060 /* Command register 0 */
#define BCHP_HEVD_OL_CPU_REGS_0_CMD_REG1         0x00000064 /* Command register 1 */
#define BCHP_HEVD_OL_CPU_REGS_0_CMD_REG2         0x00000068 /* Command register 2 */
#define BCHP_HEVD_OL_CPU_REGS_0_CMD_REG3         0x0000006c /* Command register 3 */
#define BCHP_HEVD_OL_CPU_REGS_0_DEC_VERSION      0x00000108 /* Decoder versions */
