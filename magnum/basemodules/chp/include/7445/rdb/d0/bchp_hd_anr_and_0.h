 ...
 ***************************************************************************/
#define BCHP_HD_ANR_AND_0_REVISION_ID            0x00689800 /* AND Revision register */
#define BCHP_HD_ANR_AND_0_SW_RESET               0x00689804 /* AND Software Reset */
#define BCHP_HD_ANR_AND_0_AND_ENABLE             0x00689808 /* AND Enable */
#define BCHP_HD_ANR_AND_0_AND_MODE               0x0068980c /* AND Window Size */
#define BCHP_HD_ANR_AND_0_NOISE_LOWER_TH_0       0x00689810 /* Noise Range Lower Threshold 0 */
#define BCHP_HD_ANR_AND_0_NOISE_LOWER_TH_1       0x00689814 /* Noise Range Lower Threshold 1 */
#define BCHP_HD_ANR_AND_0_NOISE_LOWER_TH_2       0x00689818 /* Noise Range Lower Threshold 2 */
#define BCHP_HD_ANR_AND_0_NOISE_LOWER_TH_3       0x0068981c /* Noise Range Lower Threshold 3 */
#define BCHP_HD_ANR_AND_0_NOISE_LOWER_TH_4       0x00689820 /* Noise Range Lower Threshold 4 */
#define BCHP_HD_ANR_AND_0_NOISE_UPPER_TH_0       0x00689824 /* Noise Range upper Threshold 0 */
#define BCHP_HD_ANR_AND_0_NOISE_UPPER_TH_1       0x00689828 /* Noise Range upper Threshold 1 */
#define BCHP_HD_ANR_AND_0_NOISE_UPPER_TH_2       0x0068982c /* Noise Range upper Threshold 2 */
#define BCHP_HD_ANR_AND_0_NOISE_UPPER_TH_3       0x00689830 /* Noise Range upper Threshold 3 */
#define BCHP_HD_ANR_AND_0_NOISE_UPPER_TH_4       0x00689834 /* Noise Range upper Threshold 4 */
#define BCHP_HD_ANR_AND_0_EDGE_TH                0x00689838 /* Edge gradient threshold */
#define BCHP_HD_ANR_AND_0_CONTENT_TH             0x0068983c /* Content level threshold */
#define BCHP_HD_ANR_AND_0_NOISY_SAMPLE_NUM_BIN_0 0x00689840 /* Number of noisy pixel in frame for noise level category 0 */
#define BCHP_HD_ANR_AND_0_NOISY_SAMPLE_NUM_BIN_1 0x00689844 /* Number of noisy pixel in frame for noise level category 1 */
#define BCHP_HD_ANR_AND_0_NOISY_SAMPLE_NUM_BIN_2 0x00689848 /* Number of noisy pixel in frame for noise level category 2 */
#define BCHP_HD_ANR_AND_0_NOISY_SAMPLE_NUM_BIN_3 0x0068984c /* Number of noisy pixel in frame for noise level category 3 */
#define BCHP_HD_ANR_AND_0_NOISY_SAMPLE_NUM_BIN_4 0x00689850 /* Number of noisy pixel in frame for noise level category 4 */
#define BCHP_HD_ANR_AND_0_NOISE_LEVEL_0_MSB      0x00689854 /* The means result of noise category 0 (MSB) */
#define BCHP_HD_ANR_AND_0_NOISE_LEVEL_0_LSB      0x00689858 /* The means result of noise category 0 (LSB) */
#define BCHP_HD_ANR_AND_0_NOISE_LEVEL_1_MSB      0x0068985c /* The means result of noise category 1 (MSB) */
#define BCHP_HD_ANR_AND_0_NOISE_LEVEL_1_LSB      0x00689860 /* The means result of noise category 1 (LSB) */
#define BCHP_HD_ANR_AND_0_NOISE_LEVEL_2_MSB      0x00689864 /* The means result of noise category 2 (MSB) */
#define BCHP_HD_ANR_AND_0_NOISE_LEVEL_2_LSB      0x00689868 /* The means result of noise category 2 (LSB) */
#define BCHP_HD_ANR_AND_0_NOISE_LEVEL_3_MSB      0x0068986c /* The means result of noise category 3 (MSB) */
#define BCHP_HD_ANR_AND_0_NOISE_LEVEL_3_LSB      0x00689870 /* The means result of noise category 3 (LSB) */
#define BCHP_HD_ANR_AND_0_NOISE_LEVEL_4_MSB      0x00689874 /* The means result of noise category 4 (MSB) */
#define BCHP_HD_ANR_AND_0_NOISE_LEVEL_4_LSB      0x00689878 /* The means result of noise category 4 (LSB) */
#define BCHP_HD_ANR_AND_0_X_LOWER_0              0x0068987c /* The lower boundary for statistics collection at horizontal direction */
#define BCHP_HD_ANR_AND_0_X_UPPER_0              0x00689880 /* The upper boundary for statistics collection at horizontal direction */
#define BCHP_HD_ANR_AND_0_Y_LOWER_0              0x00689884 /* The lower boundary for statistics collection at vertical direction */
#define BCHP_HD_ANR_AND_0_Y_UPPER_0              0x00689888 /* The upper boundary for statistics collection at vertical direction */
