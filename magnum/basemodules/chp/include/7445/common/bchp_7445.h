 ...
 * 
 ***************************************************************************/
#ifndef BCHP_7445_H__
#define BCHP_7445_H__
...
/***************************************************************************
Summary:
    Open a chip handle for Bcm7445 chip

Description:
    This function open a chip handle for Bcm7445 chip.

Input:
    hRegister - A valid Bcm7445 register handle previous open using BREG_Open.
