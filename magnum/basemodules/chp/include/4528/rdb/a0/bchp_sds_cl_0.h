 ...
 *
 *
 * Date:           Generated on         Fri Feb  4 12:05:27 2011
 ...
 ***************************************************************************/
#define BCHP_SDS_CL_0_CLCTL1                     0x000b0180 /* Carrier Loop Control 1 (Formerly, CLQCFD,CLPDCTL,CLCTL) */
#define BCHP_SDS_CL_0_CLCTL2                     0x000b0184 /* Carrier Loop Control 2 (Formerly, CLOON,CLSTS,CLMISC2,CLMISC) */
#define BCHP_SDS_CL_0_FLLC                       0x000b0188 /* Set 1 front carrier loop linear coefficient and scaling values */
#define BCHP_SDS_CL_0_FLLC1                      0x000b018c /* Set 2 front carrier loop linear coefficient and scaling values */
#define BCHP_SDS_CL_0_FLIC                       0x000b0190 /* Set 1 front carrier loop integrator coefficient and scaling values */
#define BCHP_SDS_CL_0_FLIC1                      0x000b0194 /* Set 2 front carrier loop integrator coefficient and scaling values */
#define BCHP_SDS_CL_0_FLSW                       0x000b0198 /* Front carrier loop sweep rate */
#define BCHP_SDS_CL_0_FLI                        0x000b019c /* Front carrier loop integrator value */
#define BCHP_SDS_CL_0_FLIF                       0x000b01a0 /* Front carrier loop IF frequency control word */
#define BCHP_SDS_CL_0_FLPA                       0x000b01a4 /* Front carrier loop phase accumulator value */
#define BCHP_SDS_CL_0_FLTD                       0x000b01a8 /* Front carrier loop frequency detector threshold */
#define BCHP_SDS_CL_0_PEEST                      0x000b01ac /* Back carrier loop phase error estimator output */
#define BCHP_SDS_CL_0_PLTD                       0x000b01b0 /* Back carrier loop frequency detector threshold */
#define BCHP_SDS_CL_0_PLC                        0x000b01b4 /* 1st set of back carrier loop linear and integrator coefficients and scaling values */
#define BCHP_SDS_CL_0_PLC1                       0x000b01b8 /* 2nd set of back carrier loop linear and integrator coefficients and scaling values */
#define BCHP_SDS_CL_0_PLSW                       0x000b01bc /* Back carrier loop sweep rate */
#define BCHP_SDS_CL_0_PLI                        0x000b01c0 /* Back carrier loop integrator value */
#define BCHP_SDS_CL_0_PLPA                       0x000b01c4 /* Back carrier loop phase accumulator value */
#define BCHP_SDS_CL_0_CRBFD                      0x000b01c8 /* Carrier loop QAM/8PSK phase detector threshold */
#define BCHP_SDS_CL_0_CLHT                       0x000b01cc /* Carrier loop lock high threshold value */
#define BCHP_SDS_CL_0_CLLT                       0x000b01d0 /* Carrier loop lock low threshold value */
#define BCHP_SDS_CL_0_CLLA                       0x000b01d4 /* Carrier loop lock accumulator value */
#define BCHP_SDS_CL_0_CLCT                       0x000b01d8 /* Carrier loop lock control */
#define BCHP_SDS_CL_0_CLFFCTL                    0x000b01dc /* Fine Frequency Mixer Control */
#define BCHP_SDS_CL_0_FFLPA                      0x000b01e0 /* Fine frequency adjustment phase accumulator */
#define BCHP_SDS_CL_0_CLFBCTL                    0x000b01e4 /* Forward Backward Loop Control (Formerly, CLFBCTL2,CLFBCTL) */
#define BCHP_SDS_CL_0_FBLC                       0x000b01e8 /* Forward Backward Loop Filter Coefficient */
#define BCHP_SDS_CL_0_FBLI                       0x000b01ec /* Forward Backward Loop Filter Integrator */
#define BCHP_SDS_CL_0_FBPA                       0x000b01f0 /* Forward Backward Loop Phase Accumulator */
#define BCHP_SDS_CL_0_CLDAFECTL                  0x000b01f4 /* DAFE Loop Control */
#define BCHP_SDS_CL_0_DAFELI                     0x000b01f8 /* DAFE Loop Filter Integrator */
#define BCHP_SDS_CL_0_DAFEINT                    0x000b01fc /* DAFE Loop Filter Integrator */
