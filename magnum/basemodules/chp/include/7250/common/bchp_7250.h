 ...
 *
 ***************************************************************************/
#ifndef BCHP_7250_H__
#define BCHP_7250_H__
...
/***************************************************************************
Summary:
    Open a chip handle for Bcm7250 chip

Description:
    This function open a chip handle for Bcm7250 chip.

Input:
    hRegister - A valid Bcm7250 register handle previous open using BREG_Open.
