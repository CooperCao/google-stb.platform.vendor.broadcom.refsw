 ...
 ***************************************************************************/
#define BCHP_XPT_WDMA_PM_RESULTS_INPUT_DATA_MOVED 0x00a68600 /* [RO][32] Perfmeter: Number of accepted input data words. */
#define BCHP_XPT_WDMA_PM_RESULTS_INPUT_DATA_NOT_READY 0x00a68604 /* [RO][32] Perfmeter: Number of cycles with READY=0 at the input */
#define BCHP_XPT_WDMA_PM_RESULTS_INPUT_DATA_NOT_ACCEPTED 0x00a68608 /* [RO][32] Perfmeter: Number of cycles with READY=1, ACCEPT=0 at the input */
#define BCHP_XPT_WDMA_PM_RESULTS_INPUT_HEADER_MOVED 0x00a6860c /* [RO][32] Perfmeter: Total number of X-header words accepted from XPT Security */
#define BCHP_XPT_WDMA_PM_RESULTS_INPUT_PAYLD_MOVED 0x00a68610 /* [RO][32] Perfmeter: Total number of X-packet payload words accepted from XPT Security */
#define BCHP_XPT_WDMA_PM_RESULTS_NUM_INPUT_PACKETS_TOTAL 0x00a68614 /* [RO][32] Perfmeter: Total number of packets accepted from XPT Security */
#define BCHP_XPT_WDMA_PM_RESULTS_OUTPUT_DATA_MOVED 0x00a68618 /* [RO][32] Perfmeter: Number of accepted output data words */
#define BCHP_XPT_WDMA_PM_RESULTS_OUTPUT_DATA_NOT_READY 0x00a6861c /* [RO][32] Perfmeter: Number of cycles with READY=0 at the output */
#define BCHP_XPT_WDMA_PM_RESULTS_OUTPUT_DATA_NOT_ACCEPTED 0x00a68620 /* [RO][32] Perfmeter: Number of cycles with READY=1, ACCEPT=0 at the output */
#define BCHP_XPT_WDMA_PM_RESULTS_OUTPUT_HEADER_MOVED 0x00a68624 /* [RO][32] Perfmeter: Total number of X-header words sent to XMEMIF */
#define BCHP_XPT_WDMA_PM_RESULTS_OUTPUT_PAYLD_MOVED 0x00a68628 /* [RO][32] Perfmeter: Total number of X-packet payload sent to XMEMIF */
#define BCHP_XPT_WDMA_PM_RESULTS_NUM_OUTPUT_PACKETS_TOTAL 0x00a6862c /* [RO][32] Perfmeter: Total number of packets sent to XMEMIF Security */
#define BCHP_XPT_WDMA_PM_RESULTS_NUM_DESCRIPTORS 0x00a68630 /* [RO][32] Perfmeter: Number of Descriptors read */
#define BCHP_XPT_WDMA_PM_RESULTS_DESCR_READS     0x00a68634 /* [RO][32] Perfmeter: Number of Descriptor read Transactions */
#define BCHP_XPT_WDMA_PM_RESULTS_DATA_STALL_CLOCKS 0x00a68638 /* [RO][32] Perfmeter: Number of clocks when the data transfer was stalled */
#define BCHP_XPT_WDMA_PM_RESULTS_CHAN_SELECT     0x00a6863c /* [RW][32] Perfmeter: Specify the channel number for per_channel statistics. */
#define BCHP_XPT_WDMA_PM_RESULTS_CHAN_BYTES_TXFERED 0x00a68640 /* [RO][32] Perfmeter: Number of bytes transferred by the channel */
#define BCHP_XPT_WDMA_PM_RESULTS_CHAN_DATA_STALL_CLOCKS 0x00a68644 /* [RO][32] Perfmeter: Number of clocks when the data transfer was stalled for the channel */
#define BCHP_XPT_WDMA_PM_RESULTS_CHAN_PACKETS_ACCEPTED 0x00a68648 /* [RO][32] Perfmeter: Number of Packets accepted by the channel */
#define BCHP_XPT_WDMA_PM_RESULTS_CHAN_PACKETS_REJECTED_OVERFLOW 0x00a6864c /* [RO][32] Perfmeter: Number of Packets dropped by the channel due to Overflow */
#define BCHP_XPT_WDMA_PM_RESULTS_CHAN_PACKETS_REJECTED_RUN_VERSION 0x00a68650 /* [RO][32] Perfmeter: Number of Packets dropped by the channel due to RUN_VERSION mismatch */
#define BCHP_XPT_WDMA_PM_RESULTS_CHAN_READING_DESCRIPTORS 0x00a68654 /* [RO][32] Perfmeter: Number of clocks spent by the channel reading descriptors */
#define BCHP_XPT_WDMA_PM_RESULTS_CHAN_SLEEP      0x00a68658 /* [RO][32] Perfmeter: Number of clocks spent by the channel in SLEEP state */
