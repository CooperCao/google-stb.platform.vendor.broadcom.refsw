 ...
 ***************************************************************************/
#define BCHP_AVS_CPU_AUX_REGS_STATUS             0x0020a000 /* [RO] Auxiliary Register STATUS */
#define BCHP_AVS_CPU_AUX_REGS_SEMAPHORE          0x0020a004 /* [RW] Inter-process/Host semaphore register */
#define BCHP_AVS_CPU_AUX_REGS_LP_START           0x0020a008 /* [RW] Loop start address (32-bit) */
#define BCHP_AVS_CPU_AUX_REGS_LP_END             0x0020a00c /* [RW] Loop end address (32-bit) */
#define BCHP_AVS_CPU_AUX_REGS_IDENTITY           0x0020a010 /* [RO] Processor Identification register */
#define BCHP_AVS_CPU_AUX_REGS_DEBUG_AVS          0x0020a014 /* [RW] Debug register */
#define BCHP_AVS_CPU_AUX_REGS_PC                 0x0020a018 /* [RO] Program Counter register (32-bit) */
#define BCHP_AVS_CPU_AUX_REGS_STATUS32           0x0020a028 /* [RO] Status register (32-bit) */
#define BCHP_AVS_CPU_AUX_REGS_STATUS32_L1        0x0020a02c /* [RW] Status register save for level 1 interrupts */
#define BCHP_AVS_CPU_AUX_REGS_STATUS32_L2        0x0020a030 /* [RW] Status register save for level 2 interrupts */
#define BCHP_AVS_CPU_AUX_REGS_AUX_DCCM           0x0020a060 /* [RW] Status register save for level 2 interrupts */
#define BCHP_AVS_CPU_AUX_REGS_TIMER0_CONTROL     0x0020a084 /* [RW] Processor Timer0 Count value */
#define BCHP_AVS_CPU_AUX_REGS_TIMER0_COUNT       0x0020a088 /* [RW] Processor Timer0 Control value */
#define BCHP_AVS_CPU_AUX_REGS_TIMER0_LIMIT       0x0020a08c /* [RW] Processor Timer0 Limit value */
#define BCHP_AVS_CPU_AUX_REGS_INT_VEC_BASE       0x0020a094 /* [RW] Interrupt Vector Base address */
#define BCHP_AVS_CPU_AUX_REGS_AUX_IRQ_LV12       0x0020a10c /* [RW] Interrupt Level Status */
#define BCHP_AVS_CPU_AUX_REGS_CRC_BUILD_BCR      0x0020a188 /* [RO] Build configuration register for CRC instruction. */
#define BCHP_AVS_CPU_AUX_REGS_DVBF_BUILD         0x0020a190 /* [RO] Build configuration register for dual viterbi butterfly instruction. */
#define BCHP_AVS_CPU_AUX_REGS_EXT_ARITH_BUILD    0x0020a194 /* [RO] Build configuration register to specify that the processor has the extended arithmetic instructions. */
#define BCHP_AVS_CPU_AUX_REGS_DATASPACE          0x0020a198 /* [RO] Build configuration register for dataspace. */
#define BCHP_AVS_CPU_AUX_REGS_MEMSUBSYS          0x0020a19c /* [RO] Build configuration register for memory subsytem. */
#define BCHP_AVS_CPU_AUX_REGS_VECBASE_AC_BUILD   0x0020a1a0 /* [RO] Build configuration register for ARC600 interrupt vector base address. */
#define BCHP_AVS_CPU_AUX_REGS_P_BASE_ADDR        0x0020a1a4 /* [RO] Build configuration register for peripheral base address. */
#define BCHP_AVS_CPU_AUX_REGS_MPU_BUILD          0x0020a1b4 /* [RO] Build configuration register for memory protection unit. */
#define BCHP_AVS_CPU_AUX_REGS_RF_BUILD           0x0020a1b8 /* [RO] Build configuration register for register file. */
#define BCHP_AVS_CPU_AUX_REGS_D_CACHE_BUILD      0x0020a1c8 /* [RO] Build configuration register for data cache. */
#define BCHP_AVS_CPU_AUX_REGS_MADI_BUILD         0x0020a1cc /* [RO] Build configuration register for multiple ARC debug interface. */
#define BCHP_AVS_CPU_AUX_REGS_DCCM_BUILD         0x0020a1d0 /* [RO] Build configuration register for data closely coupled memory. */
#define BCHP_AVS_CPU_AUX_REGS_TIMER_BUILD        0x0020a1d4 /* [RO] Build configuration register for timers. */
#define BCHP_AVS_CPU_AUX_REGS_AP_BUILD           0x0020a1d8 /* [RO] Build configuration register for actionpoints. */
#define BCHP_AVS_CPU_AUX_REGS_I_CACHE_BUILD      0x0020a1dc /* [RO] Build configuration register for instruction cache. */
#define BCHP_AVS_CPU_AUX_REGS_ICCM_BUILD         0x0020a1e0 /* [RO] Build configuration register for instruction closely coupled memory. */
#define BCHP_AVS_CPU_AUX_REGS_DSPRAM_BUILD       0x0020a1e4 /* [RO] Build configuration register for XY memory. */
#define BCHP_AVS_CPU_AUX_REGS_MAC_BUILD          0x0020a1e8 /* [RO] Build configuration register for Xmac. */
#define BCHP_AVS_CPU_AUX_REGS_MULTIPLY_BUILD     0x0020a1ec /* [RO] Build configuration register for instruction closely coupled memory. */
#define BCHP_AVS_CPU_AUX_REGS_SWAP_BUILD         0x0020a1f0 /* [RO] Build configuration register for swap instruction. */
#define BCHP_AVS_CPU_AUX_REGS_NORM_BUILD         0x0020a1f4 /* [RO] Build configuration register for normalise instruction. */
#define BCHP_AVS_CPU_AUX_REGS_MINMAX_BUILD       0x0020a1f8 /* [RO] Build configuration register for min/max instruction. */
#define BCHP_AVS_CPU_AUX_REGS_BARREL_BUILD       0x0020a1fc /* [RO] Build configuration register for barrel shifter. */
#define BCHP_AVS_CPU_AUX_REGS_ARC600_BUILD       0x0020a304 /* [RO] Build configuration register for ARC 600. */
#define BCHP_AVS_CPU_AUX_REGS_AUX_SYSTEM_BUILD   0x0020a308 /* [RW] Build configuration register for AS221BD. */
#define BCHP_AVS_CPU_AUX_REGS_MCD_BCR            0x0020a310 /* [RO] MCD configuration register for AS221BD. */
#define BCHP_AVS_CPU_AUX_REGS_IFETCHQUEUE_BUILD  0x0020a3f8 /* [RO] Build configuration register for the InstructionFetchQueue component. */
#define BCHP_AVS_CPU_AUX_REGS_TIMER1_CONTROL     0x0020a400 /* [RW] Processor Timer 1 Count value */
#define BCHP_AVS_CPU_AUX_REGS_TIMER1_COUNT       0x0020a404 /* [RW] Processor Timer 1 Control value */
#define BCHP_AVS_CPU_AUX_REGS_TIMER1_LIMIT       0x0020a408 /* [RW] Processor Timer 1 Limit value */
#define BCHP_AVS_CPU_AUX_REGS_AUX_IRQ_LEV        0x0020a800 /* [RW] Interrupt Level Programming */
#define BCHP_AVS_CPU_AUX_REGS_AUX_IRQ_HINT       0x0020a804 /* [RW] Software Triggered Interrupt */
#define BCHP_AVS_CPU_AUX_REGS_AUX_ALIGN_CTRL     0x0020a808 /* [RW] Memory Alignment Detection Control */
#define BCHP_AVS_CPU_AUX_REGS_AUX_ALIGN_ADDR     0x0020a80c /* [RO] Memory Alignment Detected Address */
#define BCHP_AVS_CPU_AUX_REGS_AUX_ALIGN_SIZE     0x0020a810 /* [RO] Memory Alignment Detected Size */
#define BCHP_AVS_CPU_AUX_REGS_AUX_INTER_CORE_INTERRUPT 0x0020aa00 /* [RO] Inter-core Interrupt Register */
#define BCHP_AVS_CPU_AUX_REGS_AX_IPC_SEM_N       0x0020aa04 /* [RO] Inter-core Sempahore Register */
#define BCHP_AVS_CPU_AUX_REGS_AUX_INTER_CORE_ACK 0x0020aa08 /* [RO] Inter-core Interrupt Acknowledge Register */
#define BCHP_AVS_CPU_AUX_REGS_ERET               0x0020b000 /* [RO] Exception Return Address */
#define BCHP_AVS_CPU_AUX_REGS_ERBTA              0x0020b004 /* [RO] Exception Return Branch Target Address */
#define BCHP_AVS_CPU_AUX_REGS_ERSTATUS           0x0020b008 /* [RO] Exception Return Status */
#define BCHP_AVS_CPU_AUX_REGS_ECR                0x0020b00c /* [RO] Exception Cause Register */
#define BCHP_AVS_CPU_AUX_REGS_EFA                0x0020b010 /* [RO] Exception Fault Address */
#define BCHP_AVS_CPU_AUX_REGS_ICAUSE1            0x0020b028 /* [RO] Level 1 Interrupt Cause Register */
#define BCHP_AVS_CPU_AUX_REGS_ICAUSE2            0x0020b02c /* [RO] Level 2 Interrupt Cause Register */
#define BCHP_AVS_CPU_AUX_REGS_AUX_IENABLE        0x0020b030 /* [RO] Interrupt Mask Programming */
#define BCHP_AVS_CPU_AUX_REGS_AUX_ITRIGGER       0x0020b034 /* [RO] Interrupt Sensitivity Programming */
#define BCHP_AVS_CPU_AUX_REGS_BTA                0x0020b048 /* [RO] Branch Target Address */
#define BCHP_AVS_CPU_AUX_REGS_BTA_L1             0x0020b04c /* [RO] Level 1 Return Branch Target */
#define BCHP_AVS_CPU_AUX_REGS_BTA_L2             0x0020b050 /* [RO] Level 2 Return Branch Target */
#define BCHP_AVS_CPU_AUX_REGS_AUX_IRQ_PULSE_CANCEL 0x0020b054 /* [RO] Interrupt Pulse Cancel */
#define BCHP_AVS_CPU_AUX_REGS_AUX_IRQ_PENDING    0x0020b058 /* [RO] Interrupt Pending Register */
