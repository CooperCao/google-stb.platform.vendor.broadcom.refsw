 ...
 ***************************************************************************/
#define BCHP_AVS_BSTI_BSTI_CMD_ADDR_WDATA        0x00211400 /* [RW] Dedicate to issue BSTI commands which includes access type, address and write data. (NOTE: A write to the register will trigger a transaction on the BSTI) */
#define BCHP_AVS_BSTI_BSTI_STATUS_RDATA          0x00211404 /* [RO] Indicate the status of BSTI and read data */
