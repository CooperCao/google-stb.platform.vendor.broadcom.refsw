 ...
 ***************************************************************************/
#define BCHP_LEAP_UART_UARTDR                    0x000c9000 /* [RW] Data register (12 or 8 bits) */
#define BCHP_LEAP_UART_UARTRSR                   0x000c9004 /* [RW] Receive status register/error clear register */
#define BCHP_LEAP_UART_UARTFR                    0x000c9018 /* [RO] Flag register */
#define BCHP_LEAP_UART_UARTILPR                  0x000c9020 /* [RW] IrDA low-power counter register */
#define BCHP_LEAP_UART_UARTIBRD                  0x000c9024 /* [RW] Integer baud rate register */
#define BCHP_LEAP_UART_UARTFBRD                  0x000c9028 /* [RW] Fractional baud rate register */
#define BCHP_LEAP_UART_UARTLCR_H                 0x000c902c /* [RW] Line control register */
#define BCHP_LEAP_UART_UARTCR                    0x000c9030 /* [RW] Control register */
#define BCHP_LEAP_UART_UARTIFLS                  0x000c9034 /* [RW] Interrupt FIFO level select register */
#define BCHP_LEAP_UART_UARTIMSC                  0x000c9038 /* [RW] Interrupt mask set/clear register */
#define BCHP_LEAP_UART_UARTRIS                   0x000c903c /* [RO] Raw interrupt status register */
#define BCHP_LEAP_UART_UARTMIS                   0x000c9040 /* [RO] Masked interrupt status register */
#define BCHP_LEAP_UART_UARTICR                   0x000c9044 /* [WO] Interrupt clear register */
#define BCHP_LEAP_UART_UARTDMACR                 0x000c9048 /* [RW] DMA control register */
#define BCHP_LEAP_UART_UARTPERIPHID0             0x000c9fe0 /* [RO] UARTPeriphID0 */
#define BCHP_LEAP_UART_UARTPERIPHID1             0x000c9fe4 /* [RO] UARTPeriphID1 */
#define BCHP_LEAP_UART_UARTPERIPHID2             0x000c9fe8 /* [RO] UARTPeriphID2 */
#define BCHP_LEAP_UART_UARTPERIPHID3             0x000c9fec /* [RO] UARTPeriphID3 */
#define BCHP_LEAP_UART_UARTPCELLID0              0x000c9ff0 /* [RO] UARTPCellID0 */
#define BCHP_LEAP_UART_UARTPCELLID1              0x000c9ff4 /* [RO] UARTPCellID1 */
#define BCHP_LEAP_UART_UARTPCELLID2              0x000c9ff8 /* [RO] UARTPCellID2 */
#define BCHP_LEAP_UART_UARTPCELLID3              0x000c9ffc /* [RO] UARTPCellID3 */
