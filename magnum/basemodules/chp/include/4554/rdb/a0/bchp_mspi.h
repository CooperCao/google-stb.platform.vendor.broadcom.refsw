 ...
 ***************************************************************************/
#define BCHP_MSPI_SPCR0_LSB                      0x00100800 /* [RW] SPCR0_LSB REGISTER */
#define BCHP_MSPI_SPCR0_MSB                      0x00100804 /* [RW] SPCR0_MSB Register */
#define BCHP_MSPI_SPCR1_LSB                      0x00100808 /* [RW] SPCR1_LSB REGISTER */
#define BCHP_MSPI_SPCR1_MSB                      0x0010080c /* [RW] SPCR1_MSB REGISTER */
#define BCHP_MSPI_NEWQP                          0x00100810 /* [RW] NEWQP REGISTER */
#define BCHP_MSPI_ENDQP                          0x00100814 /* [RW] ENDQP REGISTER */
#define BCHP_MSPI_SPCR2                          0x00100818 /* [RW] SPCR2 REGISTER */
#define BCHP_MSPI_MSPI_STATUS                    0x00100820 /* [RW] MSPI STATUS REGISTER */
#define BCHP_MSPI_CPTQP                          0x00100824 /* [RO] CPTQP REGISTER */
#define BCHP_MSPI_TXRAM00                        0x00100840 /* [RW] MSbyte for bit 16 or bit 8 operation (queue pointer = 0) */
#define BCHP_MSPI_TXRAM01                        0x00100844 /* [RW] LSbyte for bit 16 operation only (queue pointer = 0) */
#define BCHP_MSPI_TXRAM02                        0x00100848 /* [RW] MSbyte for bit 16 or bit 8 operation (queue pointer = 1) */
#define BCHP_MSPI_TXRAM03                        0x0010084c /* [RW] LSbyte for bit 16 operation only (queue pointer = 1) */
#define BCHP_MSPI_TXRAM04                        0x00100850 /* [RW] MSbyte for bit 16 or bit 8 operation (queue pointer = 2) */
#define BCHP_MSPI_TXRAM05                        0x00100854 /* [RW] LSbyte for bit 16 operation only (queue pointer = 2) */
#define BCHP_MSPI_TXRAM06                        0x00100858 /* [RW] MSbyte for bit 16 or bit 8 operation (queue pointer = 3) */
#define BCHP_MSPI_TXRAM07                        0x0010085c /* [RW] LSbyte for bit 16 operation only (queue pointer = 3) */
#define BCHP_MSPI_TXRAM08                        0x00100860 /* [RW] MSbyte for bit 16 or bit 8 operation (queue pointer = 4) */
#define BCHP_MSPI_TXRAM09                        0x00100864 /* [RW] LSbyte for bit 16 operation only (queue pointer = 4) */
#define BCHP_MSPI_TXRAM10                        0x00100868 /* [RW] MSbyte for bit 16 or bit 8 operation (queue pointer = 5) */
#define BCHP_MSPI_TXRAM11                        0x0010086c /* [RW] LSbyte for bit 16 operation only (queue pointer = 5) */
#define BCHP_MSPI_TXRAM12                        0x00100870 /* [RW] MSbyte for bit 16 or bit 8 operation (queue pointer = 6) */
#define BCHP_MSPI_TXRAM13                        0x00100874 /* [RW] LSbyte for bit 16 operation only (queue pointer = 6) */
#define BCHP_MSPI_TXRAM14                        0x00100878 /* [RW] MSbyte for bit 16 or bit 8 operation (queue pointer = 7) */
#define BCHP_MSPI_TXRAM15                        0x0010087c /* [RW] LSbyte for bit 16 operation only (queue pointer = 7) */
#define BCHP_MSPI_TXRAM16                        0x00100880 /* [RW] MSbyte for bit 16 or bit 8 operation (queue pointer = 8) */
#define BCHP_MSPI_TXRAM17                        0x00100884 /* [RW] LSbyte for bit 16 operation only (queue pointer = 8) */
#define BCHP_MSPI_TXRAM18                        0x00100888 /* [RW] MSbyte for bit 16 or bit 8 operation (queue pointer = 9) */
#define BCHP_MSPI_TXRAM19                        0x0010088c /* [RW] LSbyte for bit 16 operation only (queue pointer = 9) */
#define BCHP_MSPI_TXRAM20                        0x00100890 /* [RW] MSbyte for bit 16 or bit 8 operation (queue pointer = a) */
#define BCHP_MSPI_TXRAM21                        0x00100894 /* [RW] LSbyte for bit 16 operation only (queue pointer = a) */
#define BCHP_MSPI_TXRAM22                        0x00100898 /* [RW] MSbyte for bit 16 or bit 8 operation (queue pointer = b) */
#define BCHP_MSPI_TXRAM23                        0x0010089c /* [RW] LSbyte for bit 16 operation only (queue pointer = b) */
#define BCHP_MSPI_TXRAM24                        0x001008a0 /* [RW] MSbyte for bit 16 or bit 8 operation (queue pointer = c) */
#define BCHP_MSPI_TXRAM25                        0x001008a4 /* [RW] LSbyte for bit 16 operation only (queue pointer = c) */
#define BCHP_MSPI_TXRAM26                        0x001008a8 /* [RW] MSbyte for bit 16 or bit 8 operation (queue pointer = d) */
#define BCHP_MSPI_TXRAM27                        0x001008ac /* [RW] LSbyte for bit 16 operation only (queue pointer = d) */
#define BCHP_MSPI_TXRAM28                        0x001008b0 /* [RW] MSbyte for bit 16 or bit 8 operation (queue pointer = e) */
#define BCHP_MSPI_TXRAM29                        0x001008b4 /* [RW] LSbyte for bit 16 operation only (queue pointer = e) */
#define BCHP_MSPI_TXRAM30                        0x001008b8 /* [RW] MSbyte for bit 16 or bit 8 operation (queue pointer = f) */
#define BCHP_MSPI_TXRAM31                        0x001008bc /* [RW] LSbyte for bit 16 operation only (queue pointer = f) */
#define BCHP_MSPI_RXRAM00                        0x001008c0 /* [RW] MSbyte for bit 16 or bit 8 operation (queue pointer = 0) */
#define BCHP_MSPI_RXRAM01                        0x001008c4 /* [RW] LSbyte for bit 16 operation only (queue pointer = 0) */
#define BCHP_MSPI_RXRAM02                        0x001008c8 /* [RW] MSbyte for bit 16 or bit 8 operation (queue pointer = 1) */
#define BCHP_MSPI_RXRAM03                        0x001008cc /* [RW] LSbyte for bit 16 operation only (queue pointer = 1) */
#define BCHP_MSPI_RXRAM04                        0x001008d0 /* [RW] MSbyte for bit 16 or bit 8 operation (queue pointer = 2) */
#define BCHP_MSPI_RXRAM05                        0x001008d4 /* [RW] LSbyte for bit 16 operation only (queue pointer = 2) */
#define BCHP_MSPI_RXRAM06                        0x001008d8 /* [RW] MSbyte for bit 16 or bit 8 operation (queue pointer = 3) */
#define BCHP_MSPI_RXRAM07                        0x001008dc /* [RW] LSbyte for bit 16 operation only (queue pointer = 3) */
#define BCHP_MSPI_RXRAM08                        0x001008e0 /* [RW] MSbyte for bit 16 or bit 8 operation (queue pointer = 4) */
#define BCHP_MSPI_RXRAM09                        0x001008e4 /* [RW] LSbyte for bit 16 operation only (queue pointer = 4) */
#define BCHP_MSPI_RXRAM10                        0x001008e8 /* [RW] MSbyte for bit 16 or bit 8 operation (queue pointer = 5) */
#define BCHP_MSPI_RXRAM11                        0x001008ec /* [RW] LSbyte for bit 16 operation only (queue pointer = 5) */
#define BCHP_MSPI_RXRAM12                        0x001008f0 /* [RW] MSbyte for bit 16 or bit 8 operation (queue pointer = 6) */
#define BCHP_MSPI_RXRAM13                        0x001008f4 /* [RW] LSbyte for bit 16 operation only (queue pointer = 6) */
#define BCHP_MSPI_RXRAM14                        0x001008f8 /* [RW] MSbyte for bit 16 or bit 8 operation (queue pointer = 7) */
#define BCHP_MSPI_RXRAM15                        0x001008fc /* [RW] LSbyte for bit 16 operation only (queue pointer = 7) */
#define BCHP_MSPI_RXRAM16                        0x00100900 /* [RW] MSbyte for bit 16 or bit 8 operation (queue pointer = 8) */
#define BCHP_MSPI_RXRAM17                        0x00100904 /* [RW] LSbyte for bit 16 operation only (queue pointer = 8) */
#define BCHP_MSPI_RXRAM18                        0x00100908 /* [RW] MSbyte for bit 16 or bit 8 operation (queue pointer = 9) */
#define BCHP_MSPI_RXRAM19                        0x0010090c /* [RW] LSbyte for bit 16 operation only (queue pointer = 9) */
#define BCHP_MSPI_RXRAM20                        0x00100910 /* [RW] MSbyte for bit 16 or bit 8 operation (queue pointer = a) */
#define BCHP_MSPI_RXRAM21                        0x00100914 /* [RW] LSbyte for bit 16 operation only (queue pointer = a) */
#define BCHP_MSPI_RXRAM22                        0x00100918 /* [RW] MSbyte for bit 16 or bit 8 operation (queue pointer = b) */
#define BCHP_MSPI_RXRAM23                        0x0010091c /* [RW] LSbyte for bit 16 operation only (queue pointer = b) */
#define BCHP_MSPI_RXRAM24                        0x00100920 /* [RW] MSbyte for bit 16 or bit 8 operation (queue pointer = c) */
#define BCHP_MSPI_RXRAM25                        0x00100924 /* [RW] LSbyte for bit 16 operation only (queue pointer = c) */
#define BCHP_MSPI_RXRAM26                        0x00100928 /* [RW] MSbyte for bit 16 or bit 8 operation (queue pointer = d) */
#define BCHP_MSPI_RXRAM27                        0x0010092c /* [RW] LSbyte for bit 16 operation only (queue pointer = d) */
#define BCHP_MSPI_RXRAM28                        0x00100930 /* [RW] MSbyte for bit 16 or bit 8 operation (queue pointer = e) */
#define BCHP_MSPI_RXRAM29                        0x00100934 /* [RW] LSbyte for bit 16 operation only (queue pointer = e) */
#define BCHP_MSPI_RXRAM30                        0x00100938 /* [RW] MSbyte for bit 16 or bit 8 operation (queue pointer = f) */
#define BCHP_MSPI_RXRAM31                        0x0010093c /* [RW] LSbyte for bit 16 operation only (queue pointer = f) */
#define BCHP_MSPI_CDRAM00                        0x00100940 /* [RW] 8-bit command (queue pointer = 0) */
#define BCHP_MSPI_CDRAM01                        0x00100944 /* [RW] 8-bit command (queue pointer = 1) */
#define BCHP_MSPI_CDRAM02                        0x00100948 /* [RW] 8-bit command (queue pointer = 2) */
#define BCHP_MSPI_CDRAM03                        0x0010094c /* [RW] 8-bit command (queue pointer = 3) */
#define BCHP_MSPI_CDRAM04                        0x00100950 /* [RW] 8-bit command (queue pointer = 4) */
#define BCHP_MSPI_CDRAM05                        0x00100954 /* [RW] 8-bit command (queue pointer = 5) */
#define BCHP_MSPI_CDRAM06                        0x00100958 /* [RW] 8-bit command (queue pointer = 6) */
#define BCHP_MSPI_CDRAM07                        0x0010095c /* [RW] 8-bit command (queue pointer = 7) */
#define BCHP_MSPI_CDRAM08                        0x00100960 /* [RW] 8-bit command (queue pointer = 8) */
#define BCHP_MSPI_CDRAM09                        0x00100964 /* [RW] 8-bit command (queue pointer = 9) */
#define BCHP_MSPI_CDRAM10                        0x00100968 /* [RW] 8-bit command (queue pointer = a) */
#define BCHP_MSPI_CDRAM11                        0x0010096c /* [RW] 8-bit command (queue pointer = b) */
#define BCHP_MSPI_CDRAM12                        0x00100970 /* [RW] 8-bit command (queue pointer = c) */
#define BCHP_MSPI_CDRAM13                        0x00100974 /* [RW] 8-bit command (queue pointer = d) */
#define BCHP_MSPI_CDRAM14                        0x00100978 /* [RW] 8-bit command (queue pointer = e) */
#define BCHP_MSPI_CDRAM15                        0x0010097c /* [RW] 8-bit command (queue pointer = f) */
#define BCHP_MSPI_WRITE_LOCK                     0x00100980 /* [RW] Control bit to lock group of write commands */
#define BCHP_MSPI_DISABLE_FLUSH_GEN              0x00100984 /* [RW] Debug bit to mask the generation of flush signals from Mspi */
