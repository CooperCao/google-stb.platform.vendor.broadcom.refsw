 ...
 *
 ***************************************************************************/
#ifndef BCHP_75635_H__
#define BCHP_75635_H__
...
/***************************************************************************
Summary:
    Open a chip handle for Bcm75635 chip

Description:
    This function open a chip handle for Bcm75635 chip.

Input:
    hRegister - A valid Bcm75635 register handle previous open using BREG_Open.
