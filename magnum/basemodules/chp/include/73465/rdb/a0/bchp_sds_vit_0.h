 ...
 ***************************************************************************/
#define BCHP_SDS_VIT_0_VTCTL                     0x00700400 /* [RW] Viterbi Decoder Configuration Register (Formerly,VTCTL2,VTCTL1) */
#define BCHP_SDS_VIT_0_V10                       0x00700404 /* [RW] Viterbi decoder sync error threshold 1/0 (Formerly, V1,V0, DVB/DTV 2/3, DC 1/2 */
#define BCHP_SDS_VIT_0_V32                       0x00700408 /* [RW] Viterbi decoder sync error threshold 3/2 (Formerly, V3,V2, DVB/DTV 5/6, DC 2/3 */
#define BCHP_SDS_VIT_0_V54                       0x0070040c /* [RW] Viterbi decoder sync error threshold 5/4 (Formerly, V5,V4, DVB/DTV 7/8, DC 4/5 */
#define BCHP_SDS_VIT_0_V76                       0x00700410 /* [RW] Viterbi decoder sync error threshold 7/6 (Formerly, V7,V6, DVB/DTV unused, DC 7/8 */
#define BCHP_SDS_VIT_0_VINT                      0x00700414 /* [RW] Viterbi decoder sync integration period */
#define BCHP_SDS_VIT_0_VCNT                      0x00700418 /* [RO] Viterbi decoder integration counter value */
#define BCHP_SDS_VIT_0_VSTC                      0x0070041c /* [RO] Viterbi decoder state change counter values */
#define BCHP_SDS_VIT_0_VST                       0x00700420 /* [RO] Viterbi decoder internal status monitor */
#define BCHP_SDS_VIT_0_VREC                      0x00700424 /* [RO] Viterbi re-encoding register error value */
#define BCHP_SDS_VIT_0_VRCV                      0x00700428 /* [RO] Viterbi re-encoding register count value */
