...
#define BCHP_NAND_CS_NAND_SELECT                 0x00412814 /* [RW] Nand Flash EBI CS Select */
#define BCHP_NAND_CS_NAND_XOR                    0x00412818 /* [RW] Nand Flash EBI CS Address XOR with 1FC0 Control */
#define BCHP_NAND_SPARE_AREA_READ_OFS_0          0x00412820 /* [RO] Nand Flash Spare Area Read Bytes 0-3 */
#define BCHP_NAND_SPARE_AREA_READ_OFS_4          0x00412824 /* [RO] Nand Flash Spare Area Read Bytes 4-7 */
#define BCHP_NAND_SPARE_AREA_READ_OFS_8          0x00412828 /* [RO] Nand Flash Spare Area Read Bytes 8-11 */
#define BCHP_NAND_SPARE_AREA_READ_OFS_C          0x0041282c /* [RO] Nand Flash Spare Area Read Bytes 12-15 */
#define BCHP_NAND_SPARE_AREA_WRITE_OFS_0         0x00412830 /* [RW] Nand Flash Spare Area Write Bytes 0-3 */
#define BCHP_NAND_SPARE_AREA_WRITE_OFS_4         0x00412834 /* [RW] Nand Flash Spare Area Write Bytes 4-7 */
#define BCHP_NAND_SPARE_AREA_WRITE_OFS_8         0x00412838 /* [RW] Nand Flash Spare Area Write Bytes 8-11 */
#define BCHP_NAND_SPARE_AREA_WRITE_OFS_C         0x0041283c /* [RW] Nand Flash Spare Area Write Bytes 12-15 */
#define BCHP_NAND_ACC_CONTROL                    0x00412840 /* [RW] Nand Flash Access Control */
#define BCHP_NAND_CONFIG                         0x00412848 /* [RW] Nand Flash Config */
#define BCHP_NAND_TIMING_1                       0x00412850 /* [RW] Nand Flash Timing Parameters 1 */
#define BCHP_NAND_TIMING_2                       0x00412854 /* [RW] Nand Flash Timing Parameters 2 */
#define BCHP_NAND_SEMAPHORE                      0x00412858 /* [RW] Semaphore */
#define BCHP_NAND_FLASH_DEVICE_ID                0x00412860 /* [RO] Nand Flash Device ID */
#define BCHP_NAND_FLASH_DEVICE_ID_EXT            0x00412864 /* [RO] Nand Flash Extended Device ID */
#define BCHP_NAND_BLOCK_LOCK_STATUS              0x00412868 /* [RO] Nand Flash Block Lock Status */
#define BCHP_NAND_INTFC_STATUS                   0x0041286c /* [RO] Nand Flash Interface Status */
#define BCHP_NAND_ECC_CORR_EXT_ADDR              0x00412870 /* [RO] ECC Correctable Error Extended Address */
#define BCHP_NAND_ECC_CORR_ADDR                  0x00412874 /* [RO] ECC Correctable Error Address */
#define BCHP_NAND_ECC_UNC_EXT_ADDR               0x00412878 /* [RO] ECC Uncorrectable Error Extended Address */
#define BCHP_NAND_ECC_UNC_ADDR                   0x0041287c /* [RO] ECC Uncorrectable Error Address */
#define BCHP_NAND_READ_ERROR_COUNT               0x00412880 /* [RO] Read Error Count */
#define BCHP_NAND_CORR_STAT_THRESHOLD            0x00412884 /* [RW] Correctable Error Reporting Threshold */
#define BCHP_NAND_ONFI_STATUS                    0x00412888 /* [RW] ONFI Status */
#define BCHP_NAND_ONFI_DEBUG_DATA                0x0041288c /* [RO] ONFI Debug Data */
#define BCHP_NAND_FLASH_READ_EXT_ADDR            0x00412890 /* [RO] Flash Read Data Extended Address */
#define BCHP_NAND_FLASH_READ_ADDR                0x00412894 /* [RO] Flash Read Data Address */
#define BCHP_NAND_PROGRAM_PAGE_EXT_ADDR          0x00412898 /* [RO] Page Program Extended Address */
#define BCHP_NAND_PROGRAM_PAGE_ADDR              0x0041289c /* [RO] Page Program Address */
#define BCHP_NAND_COPY_BACK_EXT_ADDR             0x004128a0 /* [RO] Copy Back Extended Address */
#define BCHP_NAND_COPY_BACK_ADDR                 0x004128a4 /* [RO] Copy Back Address */
#define BCHP_NAND_BLOCK_ERASE_EXT_ADDR           0x004128a8 /* [RO] Block Erase Extended Address */
#define BCHP_NAND_BLOCK_ERASE_ADDR               0x004128ac /* [RO] Block Erase Address */
#define BCHP_NAND_INV_READ_EXT_ADDR              0x004128b0 /* [RO] Flash Invalid Data Extended Address */
#define BCHP_NAND_INV_READ_ADDR                  0x004128b4 /* [RO] Flash Invalid Data Address */
#define BCHP_NAND_BLK_WR_PROTECT                 0x004128c0 /* [RW] Block Write Protect Enable and Size for EBI_CS0b */
#define BCHP_NAND_ACC_CONTROL_CS1                0x004128d0 /* [RW] Nand Flash Access Control */
#define BCHP_NAND_CONFIG_CS1                     0x004128d4 /* [RW] Nand Flash Config */
#define BCHP_NAND_TIMING_1_CS1                   0x004128d8 /* [RW] Nand Flash Timing Parameters 1 */
#define BCHP_NAND_TIMING_2_CS1                   0x004128dc /* [RW] Nand Flash Timing Parameters 2 */
#define BCHP_NAND_ACC_CONTROL_CS2                0x004128e0 /* [RW] Nand Flash Access Control */
#define BCHP_NAND_CONFIG_CS2                     0x004128e4 /* [RW] Nand Flash Config */
#define BCHP_NAND_TIMING_1_CS2                   0x004128e8 /* [RW] Nand Flash Timing Parameters 1 */
#define BCHP_NAND_TIMING_2_CS2                   0x004128ec /* [RW] Nand Flash Timing Parameters 2 */
#define BCHP_NAND_ACC_CONTROL_CS3                0x004128f0 /* [RW] Nand Flash Access Control */
#define BCHP_NAND_CONFIG_CS3                     0x004128f4 /* [RW] Nand Flash Config */
#define BCHP_NAND_TIMING_1_CS3                   0x004128f8 /* [RW] Nand Flash Timing Parameters 1 */
#define BCHP_NAND_TIMING_2_CS3                   0x004128fc /* [RW] Nand Flash Timing Parameters 2 */
#define BCHP_NAND_ACC_CONTROL_CS4                0x00412900 /* [RW] Nand Flash Access Control */
#define BCHP_NAND_CONFIG_CS4                     0x00412904 /* [RW] Nand Flash Config */
#define BCHP_NAND_TIMING_1_CS4                   0x00412908 /* [RW] Nand Flash Timing Parameters 1 */
#define BCHP_NAND_TIMING_2_CS4                   0x0041290c /* [RW] Nand Flash Timing Parameters 2 */
#define BCHP_NAND_ACC_CONTROL_CS5                0x00412910 /* [RW] Nand Flash Access Control */
#define BCHP_NAND_CONFIG_CS5                     0x00412914 /* [RW] Nand Flash Config */
#define BCHP_NAND_TIMING_1_CS5                   0x00412918 /* [RW] Nand Flash Timing Parameters 1 */
#define BCHP_NAND_TIMING_2_CS5                   0x0041291c /* [RW] Nand Flash Timing Parameters 2 */
#define BCHP_NAND_SPARE_AREA_READ_OFS_10         0x00412930 /* [RO] Nand Flash Spare Area Read Bytes 16-19 */
#define BCHP_NAND_SPARE_AREA_READ_OFS_14         0x00412934 /* [RO] Nand Flash Spare Area Read Bytes 20-23 */
#define BCHP_NAND_SPARE_AREA_READ_OFS_18         0x00412938 /* [RO] Nand Flash Spare Area Read Bytes 24-27 */
#define BCHP_NAND_SPARE_AREA_READ_OFS_1C         0x0041293c /* [RO] Nand Flash Spare Area Read Bytes 28-31 */
#define BCHP_NAND_SPARE_AREA_WRITE_OFS_10        0x00412940 /* [RW] Nand Flash Spare Area Write Bytes 16-19 */
#define BCHP_NAND_SPARE_AREA_WRITE_OFS_14        0x00412944 /* [RW] Nand Flash Spare Area Write Bytes 20-23 */
#define BCHP_NAND_SPARE_AREA_WRITE_OFS_18        0x00412948 /* [RW] Nand Flash Spare Area Write Bytes 24-27 */
#define BCHP_NAND_SPARE_AREA_WRITE_OFS_1C        0x0041294c /* [RW] Nand Flash Spare Area Write Bytes 28-31 */
#define BCHP_NAND_LL_OP                          0x00412978 /* [RW] Nand Flash Low Level Operation */
#define BCHP_NAND_LL_RDDATA                      0x0041297c /* [RO] Nand Flash Low Level Read Data */
