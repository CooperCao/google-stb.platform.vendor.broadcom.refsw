 ...
 ***************************************************************************/
#define BCHP_SDS_CG_0_RSTCTL                     0x000c0000 /* Reset Control */
#define BCHP_SDS_CG_0_CGDIV00                    0x000c0010 /* Clock Generator Divider register 0 (Formerly,CGDIV4,CGDIV3,CGDIV7[7:4],CGMISC,CGCTRL) */
#define BCHP_SDS_CG_0_CGDIV01                    0x000c0014 /* Clock Generator Divider register 1 (Formerly,CGDIV11,CGDIV10,CGDIV9,CGDIV8) */
#define BCHP_SDS_CG_0_SPLL_NPDIV                 0x000c0020 /* Sample Clock PLL Feedback Divider Control */
#define BCHP_SDS_CG_0_SPLL_MDIV_CTRL             0x000c0024 /* Sample Clock PLL Post-divider Control */
#define BCHP_SDS_CG_0_SPLL_CTRL                  0x000c0028 /* Sample Clock PLL Control */
#define BCHP_SDS_CG_0_SPLL_SSC_CTRL1             0x000c002c /* Sample Clock PLL Spread Spectrum Control 1 */
#define BCHP_SDS_CG_0_SPLL_SSC_CTRL0             0x000c0030 /* Sample Clock PLL Spread Spectrum Control 0 */
#define BCHP_SDS_CG_0_SPLL_STATUS                0x000c0034 /* Sample Clock PLL Status */
#define BCHP_SDS_CG_0_SPLL_PWRDN_RST             0x000c0038 /* Sample Clock PLL Power Down and Reset Control */
