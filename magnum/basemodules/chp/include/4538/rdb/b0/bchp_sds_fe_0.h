 ...
 ***************************************************************************/
#define BCHP_SDS_FE_0_ADCPCTL                    0x000c0080 /* ADC Capture Control (Formerly, ADCDBIT, ADCPCLP, ADCPCTL) */
#define BCHP_SDS_FE_0_DCOCTL                     0x000c0088 /* DC Offset Cancellor Control (Formerly, DCOLKCTL, DCOCTL2, DCOCTL1) */
#define BCHP_SDS_FE_0_DCOI                       0x000c008c /* DCO Integrator Values (Formerly, DCO) */
#define BCHP_SDS_FE_0_IQCTL                      0x000c0094 /* I/Q Imbalance Control (Formerly, IQAMP, IQPHS) */
#define BCHP_SDS_FE_0_IQAEST                     0x000c0098 /* IQ Imbalance Amplitude Integrator Value (Formerly, AEST) */
#define BCHP_SDS_FE_0_IQPEST                     0x000c009c /* IQ Imbalance Phase Integrator Value (Formerly, PEST) */
#define BCHP_SDS_FE_0_MIXCTL                     0x000c00a0 /* Frontend Mixer Control */
#define BCHP_SDS_FE_0_DSTGCTL                    0x000c00a4 /* Destagger Control */
#define BCHP_SDS_FE_0_FILTCTL                    0x000c00a8 /* Decimating Halfband Filter/Non-decimating Filter Control (Formerly, NDFCTL,FILTCTL) */
#define BCHP_SDS_FE_0_DFCTL                      0x000c00ac /* Decimation Filter Bank Upsampling Control */
#define BCHP_SDS_FE_0_AGFCTL                     0x000c00b0 /* Automatic Fine Gain Control */
#define BCHP_SDS_FE_0_AGF                        0x000c00b4 /* AGF Gain and Threshold Control */
#define BCHP_SDS_FE_0_AIF                        0x000c00b8 /* AGF Integrator Value */
#define BCHP_SDS_FE_0_NVCTL                      0x000c00bc /* Nyquist and VID Filter Control */
