...
/***************************************************************************
 *MSPI - Master SPI Registers
 ***************************************************************************/
#define BCHP_MSPI_SPCR0_LSB                      0x00080600 /* SPCR0_LSB REGISTER */
#define BCHP_MSPI_SPCR0_MSB                      0x00080604 /* SPCR0_MSB Register */
#define BCHP_MSPI_SPCR1_LSB                      0x00080608 /* SPCR1_LSB REGISTER */
#define BCHP_MSPI_SPCR1_MSB                      0x0008060c /* SPCR1_MSB REGISTER */
#define BCHP_MSPI_NEWQP                          0x00080610 /* NEWQP REGISTER */
#define BCHP_MSPI_ENDQP                          0x00080614 /* ENDQP REGISTER */
#define BCHP_MSPI_SPCR2                          0x00080618 /* SPCR2 REGISTER */
#define BCHP_MSPI_MSPI_STATUS                    0x00080620 /* MSPI STATUS REGISTER */
#define BCHP_MSPI_CPTQP                          0x00080624 /* CPTQP REGISTER */
#define BCHP_MSPI_TXRAM00                        0x00080640 /* MSbyte for bit 16 or bit 8 operation (queue pointer = 0) */
#define BCHP_MSPI_TXRAM01                        0x00080644 /* LSbyte for bit 16 operation only (queue pointer = 0) */
#define BCHP_MSPI_TXRAM02                        0x00080648 /* MSbyte for bit 16 or bit 8 operation (queue pointer = 1) */
#define BCHP_MSPI_TXRAM03                        0x0008064c /* LSbyte for bit 16 operation only (queue pointer = 1) */
#define BCHP_MSPI_TXRAM04                        0x00080650 /* MSbyte for bit 16 or bit 8 operation (queue pointer = 2) */
#define BCHP_MSPI_TXRAM05                        0x00080654 /* LSbyte for bit 16 operation only (queue pointer = 2) */
#define BCHP_MSPI_TXRAM06                        0x00080658 /* MSbyte for bit 16 or bit 8 operation (queue pointer = 3) */
#define BCHP_MSPI_TXRAM07                        0x0008065c /* LSbyte for bit 16 operation only (queue pointer = 3) */
#define BCHP_MSPI_TXRAM08                        0x00080660 /* MSbyte for bit 16 or bit 8 operation (queue pointer = 4) */
#define BCHP_MSPI_TXRAM09                        0x00080664 /* LSbyte for bit 16 operation only (queue pointer = 4) */
#define BCHP_MSPI_TXRAM10                        0x00080668 /* MSbyte for bit 16 or bit 8 operation (queue pointer = 5) */
#define BCHP_MSPI_TXRAM11                        0x0008066c /* LSbyte for bit 16 operation only (queue pointer = 5) */
#define BCHP_MSPI_TXRAM12                        0x00080670 /* MSbyte for bit 16 or bit 8 operation (queue pointer = 6) */
#define BCHP_MSPI_TXRAM13                        0x00080674 /* LSbyte for bit 16 operation only (queue pointer = 6) */
#define BCHP_MSPI_TXRAM14                        0x00080678 /* MSbyte for bit 16 or bit 8 operation (queue pointer = 7) */
#define BCHP_MSPI_TXRAM15                        0x0008067c /* LSbyte for bit 16 operation only (queue pointer = 7) */
#define BCHP_MSPI_TXRAM16                        0x00080680 /* MSbyte for bit 16 or bit 8 operation (queue pointer = 8) */
#define BCHP_MSPI_TXRAM17                        0x00080684 /* LSbyte for bit 16 operation only (queue pointer = 8) */
#define BCHP_MSPI_TXRAM18                        0x00080688 /* MSbyte for bit 16 or bit 8 operation (queue pointer = 9) */
#define BCHP_MSPI_TXRAM19                        0x0008068c /* LSbyte for bit 16 operation only (queue pointer = 9) */
#define BCHP_MSPI_TXRAM20                        0x00080690 /* MSbyte for bit 16 or bit 8 operation (queue pointer = a) */
#define BCHP_MSPI_TXRAM21                        0x00080694 /* LSbyte for bit 16 operation only (queue pointer = a) */
#define BCHP_MSPI_TXRAM22                        0x00080698 /* MSbyte for bit 16 or bit 8 operation (queue pointer = b) */
#define BCHP_MSPI_TXRAM23                        0x0008069c /* LSbyte for bit 16 operation only (queue pointer = b) */
#define BCHP_MSPI_TXRAM24                        0x000806a0 /* MSbyte for bit 16 or bit 8 operation (queue pointer = c) */
#define BCHP_MSPI_TXRAM25                        0x000806a4 /* LSbyte for bit 16 operation only (queue pointer = c) */
#define BCHP_MSPI_TXRAM26                        0x000806a8 /* MSbyte for bit 16 or bit 8 operation (queue pointer = d) */
#define BCHP_MSPI_TXRAM27                        0x000806ac /* LSbyte for bit 16 operation only (queue pointer = d) */
#define BCHP_MSPI_TXRAM28                        0x000806b0 /* MSbyte for bit 16 or bit 8 operation (queue pointer = e) */
#define BCHP_MSPI_TXRAM29                        0x000806b4 /* LSbyte for bit 16 operation only (queue pointer = e) */
#define BCHP_MSPI_TXRAM30                        0x000806b8 /* MSbyte for bit 16 or bit 8 operation (queue pointer = f) */
#define BCHP_MSPI_TXRAM31                        0x000806bc /* LSbyte for bit 16 operation only (queue pointer = f) */
#define BCHP_MSPI_RXRAM00                        0x000806c0 /* MSbyte for bit 16 or bit 8 operation (queue pointer = 0) */
#define BCHP_MSPI_RXRAM01                        0x000806c4 /* LSbyte for bit 16 operation only (queue pointer = 0) */
#define BCHP_MSPI_RXRAM02                        0x000806c8 /* MSbyte for bit 16 or bit 8 operation (queue pointer = 1) */
#define BCHP_MSPI_RXRAM03                        0x000806cc /* LSbyte for bit 16 operation only (queue pointer = 1) */
#define BCHP_MSPI_RXRAM04                        0x000806d0 /* MSbyte for bit 16 or bit 8 operation (queue pointer = 2) */
#define BCHP_MSPI_RXRAM05                        0x000806d4 /* LSbyte for bit 16 operation only (queue pointer = 2) */
#define BCHP_MSPI_RXRAM06                        0x000806d8 /* MSbyte for bit 16 or bit 8 operation (queue pointer = 3) */
#define BCHP_MSPI_RXRAM07                        0x000806dc /* LSbyte for bit 16 operation only (queue pointer = 3) */
#define BCHP_MSPI_RXRAM08                        0x000806e0 /* MSbyte for bit 16 or bit 8 operation (queue pointer = 4) */
#define BCHP_MSPI_RXRAM09                        0x000806e4 /* LSbyte for bit 16 operation only (queue pointer = 4) */
#define BCHP_MSPI_RXRAM10                        0x000806e8 /* MSbyte for bit 16 or bit 8 operation (queue pointer = 5) */
#define BCHP_MSPI_RXRAM11                        0x000806ec /* LSbyte for bit 16 operation only (queue pointer = 5) */
#define BCHP_MSPI_RXRAM12                        0x000806f0 /* MSbyte for bit 16 or bit 8 operation (queue pointer = 6) */
#define BCHP_MSPI_RXRAM13                        0x000806f4 /* LSbyte for bit 16 operation only (queue pointer = 6) */
#define BCHP_MSPI_RXRAM14                        0x000806f8 /* MSbyte for bit 16 or bit 8 operation (queue pointer = 7) */
#define BCHP_MSPI_RXRAM15                        0x000806fc /* LSbyte for bit 16 operation only (queue pointer = 7) */
#define BCHP_MSPI_RXRAM16                        0x00080700 /* MSbyte for bit 16 or bit 8 operation (queue pointer = 8) */
#define BCHP_MSPI_RXRAM17                        0x00080704 /* LSbyte for bit 16 operation only (queue pointer = 8) */
#define BCHP_MSPI_RXRAM18                        0x00080708 /* MSbyte for bit 16 or bit 8 operation (queue pointer = 9) */
#define BCHP_MSPI_RXRAM19                        0x0008070c /* LSbyte for bit 16 operation only (queue pointer = 9) */
#define BCHP_MSPI_RXRAM20                        0x00080710 /* MSbyte for bit 16 or bit 8 operation (queue pointer = a) */
#define BCHP_MSPI_RXRAM21                        0x00080714 /* LSbyte for bit 16 operation only (queue pointer = a) */
#define BCHP_MSPI_RXRAM22                        0x00080718 /* MSbyte for bit 16 or bit 8 operation (queue pointer = b) */
#define BCHP_MSPI_RXRAM23                        0x0008071c /* LSbyte for bit 16 operation only (queue pointer = b) */
#define BCHP_MSPI_RXRAM24                        0x00080720 /* MSbyte for bit 16 or bit 8 operation (queue pointer = c) */
#define BCHP_MSPI_RXRAM25                        0x00080724 /* LSbyte for bit 16 operation only (queue pointer = c) */
#define BCHP_MSPI_RXRAM26                        0x00080728 /* MSbyte for bit 16 or bit 8 operation (queue pointer = d) */
#define BCHP_MSPI_RXRAM27                        0x0008072c /* LSbyte for bit 16 operation only (queue pointer = d) */
#define BCHP_MSPI_RXRAM28                        0x00080730 /* MSbyte for bit 16 or bit 8 operation (queue pointer = e) */
#define BCHP_MSPI_RXRAM29                        0x00080734 /* LSbyte for bit 16 operation only (queue pointer = e) */
#define BCHP_MSPI_RXRAM30                        0x00080738 /* MSbyte for bit 16 or bit 8 operation (queue pointer = f) */
#define BCHP_MSPI_RXRAM31                        0x0008073c /* LSbyte for bit 16 operation only (queue pointer = f) */
#define BCHP_MSPI_CDRAM00                        0x00080740 /* 8-bit command (queue pointer = 0) */
#define BCHP_MSPI_CDRAM01                        0x00080744 /* 8-bit command (queue pointer = 1) */
#define BCHP_MSPI_CDRAM02                        0x00080748 /* 8-bit command (queue pointer = 2) */
#define BCHP_MSPI_CDRAM03                        0x0008074c /* 8-bit command (queue pointer = 3) */
#define BCHP_MSPI_CDRAM04                        0x00080750 /* 8-bit command (queue pointer = 4) */
#define BCHP_MSPI_CDRAM05                        0x00080754 /* 8-bit command (queue pointer = 5) */
#define BCHP_MSPI_CDRAM06                        0x00080758 /* 8-bit command (queue pointer = 6) */
#define BCHP_MSPI_CDRAM07                        0x0008075c /* 8-bit command (queue pointer = 7) */
#define BCHP_MSPI_CDRAM08                        0x00080760 /* 8-bit command (queue pointer = 8) */
#define BCHP_MSPI_CDRAM09                        0x00080764 /* 8-bit command (queue pointer = 9) */
#define BCHP_MSPI_CDRAM10                        0x00080768 /* 8-bit command (queue pointer = a) */
#define BCHP_MSPI_CDRAM11                        0x0008076c /* 8-bit command (queue pointer = b) */
#define BCHP_MSPI_CDRAM12                        0x00080770 /* 8-bit command (queue pointer = c) */
#define BCHP_MSPI_CDRAM13                        0x00080774 /* 8-bit command (queue pointer = d) */
#define BCHP_MSPI_CDRAM14                        0x00080778 /* 8-bit command (queue pointer = e) */
#define BCHP_MSPI_CDRAM15                        0x0008077c /* 8-bit command (queue pointer = f) */
#define BCHP_MSPI_WRITE_LOCK                     0x00080780 /* Control bit to lock group of write commands */
#define BCHP_MSPI_DISABLE_FLUSH_GEN              0x00080784 /* Debug bit to mask the generation of flush signals from Mspi */
...
#define BCHP_MSPI_SPCR0_MSB_MSTR_DEFAULT                           0x00000001

/* MSPI :: SPCR0_MSB :: StartTransDelay [06:06] */
#define BCHP_MSPI_SPCR0_MSB_StartTransDelay_MASK                   0x00000040
#define BCHP_MSPI_SPCR0_MSB_StartTransDelay_SHIFT                  6
#define BCHP_MSPI_SPCR0_MSB_StartTransDelay_DEFAULT                0x00000000
 ...
 ***************************************************************************/
/* MSPI :: WRITE_LOCK :: reserved0 [31:01] */
#define BCHP_MSPI_WRITE_LOCK_reserved0_MASK                        0xfffffffe
#define BCHP_MSPI_WRITE_LOCK_reserved0_SHIFT                       1

/* MSPI :: WRITE_LOCK :: WriteLock [00:00] */
#define BCHP_MSPI_WRITE_LOCK_WriteLock_MASK                        0x00000001
#define BCHP_MSPI_WRITE_LOCK_WriteLock_SHIFT                       0
#define BCHP_MSPI_WRITE_LOCK_WriteLock_DEFAULT                     0x00000000

/***************************************************************************
 *DISABLE_FLUSH_GEN - Debug bit to mask the generation of flush signals from Mspi
 ***************************************************************************/
/* MSPI :: DISABLE_FLUSH_GEN :: reserved0 [31:01] */
#define BCHP_MSPI_DISABLE_FLUSH_GEN_reserved0_MASK                 0xfffffffe
#define BCHP_MSPI_DISABLE_FLUSH_GEN_reserved0_SHIFT                1

/* MSPI :: DISABLE_FLUSH_GEN :: DisableFlushGen [00:00] */
#define BCHP_MSPI_DISABLE_FLUSH_GEN_DisableFlushGen_MASK           0x00000001
#define BCHP_MSPI_DISABLE_FLUSH_GEN_DisableFlushGen_SHIFT          0
#define BCHP_MSPI_DISABLE_FLUSH_GEN_DisableFlushGen_DEFAULT        0x00000000
