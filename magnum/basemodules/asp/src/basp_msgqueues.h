...
#ifndef _BASP_MSGQUEUES_H_
#define _BASP_MSGQUEUES_H_
...
typedef struct BASP_P_Msgqueue  *BASP_MsgqueueHandle;


typedef enum BASP_MsgqueueType
{
    BASP_MsgqueueType_eFwToHost,
    BASP_MsgqueueType_eHostToFw,
    BASP_MsgqueueType_eRaToFw,
    BASP_MsgqueueType_eFwToRa,
    BASP_MsgqueueType_eMax
} BASP_MsgqueueType;


BERR_Code BASP_Msgqueue_Init(BASP_Handle hAsp,
...
BERR_Code BASP_Msgqueue_Destroy(
...
void BASP_P_Msgqueue_FW2H_Receive_isr(void *pContext,int iParam);

#endif /* _BASP_MSGQUEUES_H_ */
