...
#define BMEM_Heap_Alloc(Heap, Size) \
	BMEM_P_Heap_TagAllocAligned(Heap, Size, 0, 0, BSTD_FILE, BSTD_LINE)
#else
#define BMEM_Heap_Alloc(Heap, Size) \
	BMEM_Heap_AllocAligned(Heap, Size, 0, 0)
#endif
...
#define BMEM_Heap_ConvertOffsetToAddress BMEM_Heap_ConvertOffsetToAddress_isrsafe
...
#define BMEM_Heap_ConvertAddressToOffset_isr(Heap, pvAddress, pulOffset) \
    BMEM_Heap_ConvertAddressToOffset_isrsafe(Heap, pvAddress, pulOffset)
#define BMEM_Heap_ConvertAddressToOffset BMEM_Heap_ConvertAddressToOffset_isrsafe
...
#define BMEM_ConvertOffsetToAddress_isr BMEM_Heap_ConvertOffsetToAddress_isr
