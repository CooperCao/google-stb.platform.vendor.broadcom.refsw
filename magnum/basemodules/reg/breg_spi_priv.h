...
typedef struct BREG_SPI_Impl
{
    ...
    BERR_Code (*BREG_SPI_Multiple_Write_Func)(void * context, const BREG_SPI_Data *pWriteData, size_t count);
    ...
    BERR_Code (*BREG_SPI_Set_Slave_Select_Func)(void * context, bool bEnable);
} BREG_SPI_Impl;
