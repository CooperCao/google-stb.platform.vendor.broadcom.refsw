...
See Also:
	BKNI_EnterCriticalSection, Magnum InterruptSafe rules
****************************************************************************/
void BKNI_AssertIsrContext_isr(void);

#ifdef BDBG_DEBUG_BUILD
#define BKNI_ASSERT_ISR_CONTEXT() BKNI_AssertIsrContext_isr()
#else
...
void BKNI_AssertIsrContextTagged_isr(const char *filename, unsigned lineno);
...
#define BKNI_AssertIsrContext_isr() BKNI_AssertIsrContextTagged_isr(__FILE__, __LINE__)
