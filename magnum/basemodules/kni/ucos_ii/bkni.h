...
#else /* _BKNI_PRINT_H_ */
#define BKNI_Printf BKNI_Print_Printf
#define BKNI_Vprintf BKNI_Print_Vprintf
...
/**
BKNI_TRACK_MALLOCS requires implementation of BKNI_GetMallocEntryInfo_isrsafe,etc. instead use tagged malloc
**/
