...
/***************************************************************************
Summary:
    Enum data type describing the mode of Target Sync evaluation

Description:
    Enum data type that describes if the Target Sync evaluation is to be
    enabled/disabled/conditionally disabled
...
{
    BDSP_AF_P_TargetSyncEvalMode_eDisableIfDecoderIsLocked = 0x0,
