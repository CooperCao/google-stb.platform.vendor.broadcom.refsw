...
{
	/*
	Input channel routing [Default : 01234567]
	...
	Use 'x' instead of a number to route silence to an input.
	Example: 000x11 routes the first interleaved channel to
	left, center, and right, routes silence to LFE, and routes
	the second interleaved channel to Ls and Rs.
	*/
	signed int		i32ChannelRouting[8];
	...
	*/
	unsigned int	ui32AudioCodingMode;
	...
	2 = 0.500 (-6.0 dB)
	3 = not set */
	unsigned int	ui32CenterMixLevel;
	...
	31 = -31dB (quiet input)
	*/
	unsigned int	ui32DialNorm;


	/* Dialog Normalization channel 2 [Default : 31] */
	unsigned int	ui32DialNormChannel2;
	...
	*/
	unsigned int	ui32DolbySurroundMode;


	/*
	Low frequency effects channel on/off [Default : 0 = LFE off]
	0 = LFE off
	1 = LFE on
	*/
	unsigned int	ui32LfeEnable;


	/* Evolution metadata [Default : 0] */
	unsigned int	ui32EvoMdAvailable;
	...
	2 = 0.000 (-inf dB)
	3 = not set */
	unsigned int	ui32SurroundMixLevel;


	/*
	90 deg phase shift surrounds [Default : 0 = disabled]
	0 = disabled
	1 = enabled
	*/
	unsigned int	ui32NinetyDegreeFilterEnable;

	/* Datarate (in kilobits per second) [Default : 640] */
	unsigned int	ui32Datarate;

	/*
	Preferred stereo downmix mode [Default : 0 = not indicated]
	0 = not indicated
	1 = Pro Logic downmix preferred
	2 = Stereo downmix preferred
	3 = Pro Logic II downmix preferred
	*/
	unsigned int	ui32Downmix;

	/*
	Lt/Rt center mix level [Default : 4 = 0.707 (-3.0 dB)]
	0 = 1.414 (+3.0 dB)
	1 = 1.189 (+1.5 dB)
	2 = 1.000 (0.0 dB)
	3 = 0.841 (-1.5 dB)
	...
	7 = 0.000 (-inf dB)
	8 = not set */
	unsigned int	ui32LtRtCenterMixLevel;
	...
	7 = 0.000 (-inf dB)
	8 = not set */
	unsigned int	ui32LtRtSurrMixLevel;
	...
	7 = 0.000 (-inf dB)
	8 = not set */
	unsigned int	ui32LoRoCenterMixLevel;

	/*
	Lo/Ro surround mix level [Default : 4 = 0.707 (-3.0 dB)]
	3 = 0.841 (-1.5 dB)
	4 = 0.707 (-3.0 dB)
	5 = 0.595 (-4.5 dB)
	6 = 0.500 (-6.0 dB)
	7 = 0.000 (-inf dB)
	8 = not set */
	unsigned int	ui32LoRoSurrMixLevel;


	/*
	Dolby Surround EX mode [Default : 0 = not indicated]
	0 = not indicated
	1 = Dolby Surround EX disabled
	2 = Dolby Surround EX enabled
	*/
	unsigned int	ui32DolbyEXMode;


	/*
	Dolby Headphone mode [Default : 0 = not indicated]
	0 = not indicated
	1 = Dolby Headphone disabled
	2 = Dolby Headphone enabled
	*/
	unsigned int	ui32DolbyHeadPhoneMode;


	/*
	A/D Converter Type [Default : 0 = Standard]
	0 = Standard
	1 = HDCD
	*/
	unsigned int	ui32ADConvType;


	/*
	Send Audio Production Info [Default : 0 = Don't send info]
	0 = Don't send info
	1 = Send info
	*/
	unsigned int	ui32SendAudioProductionInfo;


	/*
	Send Audio Production Info 2 [Default : 0 = Don't send info]
	0 = Don't send info
	1 = Send info
	*/
	unsigned int	ui32SendAudioProductionInfo2;


	/*
	Audio production mixing level [Default : 105 = 105 dB SPL]
	80 =  80 dB SPL
	105 = 105 dB SPL
	111 = 111 dB SPL
	*/
	unsigned int	ui32AudioProductionMixLevel;


	/*
	Audio production mixing level 2 [Default : 105 = 105 dB SPL]
	80 =  80 dB SPL
	105 = 105 dB SPL
	111 = 111 dB SPL
	*/
	unsigned int	ui32AudioProductionMixLevel2;


	/*
	Copyright flag [Default : 1 = copyrighted material]
	0 = non-copyrighted material
	1 = copyrighted material
	*/
	unsigned int	ui32CopyrightFlag;


	/*
	Original Bitstream flag [Default : 1 = not copied]
	0 = copied
	1 = not copied
	*/
	unsigned int	ui32OriginalBitstream;


	/*
	Bitstream Mode [Default : 0 = Main audio service: complete main (CM)]
	...
	*/
	unsigned int	ui32BitstreamMode;


	/*
	Audio production room type [Default : 2 = Small room, flat monitor]
	0 = Not Indicated
	1 = Large Room, X curve monitor
	2 = Small room, flat monitor
	*/
	unsigned int	ui32AudioProductionRoomType;


	/*
	Audio production room type 2 [Default : 2 = Small room, flat monitor]
	0 = Not Indicated
	1 = Large Room, X curve monitor
	2 = Small room, flat monitor
	*/
	unsigned int	ui32AudioProductionRoomType2;
	...
	1 = Enabled
	*/
	unsigned int	ui32AdditionalBsiEnable;
	...
	1 = Enabled
	*/
	unsigned int	ui32DolbyCertificationFlag;
	...
	*/
	unsigned int	ui32LowComplexity;


	/* Bitmask of payload IDs to try to pass-through */
	unsigned int		ui32SupportedEvolutionPayloads;
