 ...
 * ANY LIMITED REMEDY.
 *****************************************************************************/
#ifndef BDSP_COMMON_FW_ALGO_H_
#define BDSP_COMMON_FW_ALGO_H_

#define BDSP_STREAMINFO_VALID_OFFSET(typ,var) (unsigned)((unsigned long)(&((typ *)NULL)->var))
#define BDSP_P_LookupAlgorithmInfo BDSP_P_LookupAlgorithmInfo_isrsafe
...
typedef struct BDSP_P_AlgorithmCodeInfo
{
    ...
    size_t 				algoCodeSize;
	size_t              idsCodeSize;
    const char         *pCodeLibName;
    const char         *pIdsLibName;
} BDSP_P_AlgorithmCodeInfo;
const BDSP_P_AlgorithmInfo *BDSP_P_LookupAlgorithmInfo_isrsafe(
    BDSP_Algorithm algorithm
);
#endif /*BDSP_COMMON_FW_ALGO_H_*/
