...
#define BDSP_ARM_SYSTEM_OPEN_COMMAND_ID_HI (0x52414147)
#define BDSP_ARM_SYSTEM_OPEN_COMMAND_ID_LO (0x4141524d)

#define BDSP_ARM_SYSTEM_OPEN_COMMAND_ID (((uint64_t)BDSP_ARM_SYSTEM_OPEN_COMMAND_ID_HI<<32)|(BDSP_ARM_SYSTEM_OPEN_COMMAND_ID_LO))

#define BDSP_ARM_MAX_NUM_ROMFS_LIB           14
#define BDSP_ARM_MAX_REGISTER_REGIONS         4

#define BDSP_MAX_NUM_TASKS                   12 /* Maximum no.of Tasks to run on DSP */
