...
typedef struct BDSP_P_MsgQueueParams
{
    BDSP_MMA_Memory Memory;
    uint32_t ui32Size;
    uint32_t ui32FifoId;  /* Fifo Id for this message queue */
} BDSP_P_MsgQueueParams;

typedef struct BDSP_P_MsgQueue
{
    ...
    BDSP_P_BufferPointer QueueAddress; /*Structure describing the pointers of the Queue*/
    BDSP_MMA_Memory FifoMemory; /*Memory of the soft FIFOs, if registers are not available*/
} BDSP_P_MsgQueue;

typedef struct BDSP_P_MsgQueue *BDSP_P_MsgQueueHandle;
