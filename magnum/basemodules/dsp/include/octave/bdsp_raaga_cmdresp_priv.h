...
#define BDSP_RAAGA_MAX_NUM_PREEMPTION_LEVELS  3 /* No.of Preemption levels */
#define BDSP_RAAGA_MAX_NUM_SYSTEM_LEVELS      2 /* Maximum no.of system scheduling levels , Idle and RP*/
#define BDSP_RAAGA_MAX_NUM_TASKS              2 /* Maximum no.of Tasks to run on DSP */
#define BDSP_RAAGA_NUM_PROCESS_PER_TASK       2 /* Maximum no.of user process per task */

#define BDSP_RAAGA_MAX_NUM_SCHED_LEVELS (BDSP_RAAGA_MAX_NUM_PREEMPTION_LEVELS + BDSP_RAAGA_MAX_NUM_SYSTEM_LEVELS) /* Total scheduling levels */
#define BDSP_RAAGA_MAX_NUM_USER_PROCESS BDSP_RAAGA_MAX_NUM_TASKS * BDSP_RAAGA_NUM_PROCESS_PER_TASK /* No.of user processs */
...
typedef struct BDSP_Raaga_P_HeapInfo
{
    ...
    BDSP_Raaga_P_HeapLimitsInfo sHeapLimits[BDSP_RAAGA_MAX_NUM_HEAP_RANGES]; /* Entry for each heap range */
...
typedef struct BDSP_Raaga_P_CustomMMInfo
{
    ...
    uint32_t ui32WorkBufferBlockSizePerLevel[BDSP_RAAGA_MAX_NUM_PREEMPTION_LEVELS]; /* Working buffer block size */
...
typedef struct BDSP_P_AudioOutputFreezeCommand{
    uint32_t  dummy;			  /* Element added to make structure size 64 bit aligned*/
...
typedef struct BDSP_Raaga_P_UnlicensedAlgoInfo
{
    uint32_t        ui32AudioAlgorithm; /* Algorithm Name */
    uint32_t		ui32Dummy0;			  /* Element added to make structure size 64 bit aligned*/
} BDSP_Raaga_P_UnlicensedAlgoInfo;

typedef struct BDSP_Raaga_P_AsynMsg
{
	...
	union{
		...
		BDSP_Raaga_P_UnlicensedAlgoInfo sUnlicensedAlgoInfo;
	}uInfo;
}BDSP_Raaga_P_AsynMsg;
