...
#ifndef BDSP_ARM_FWINTERFACE_PRIV_H_
#define BDSP_ARM_FWINTERFACE_PRIV_H_
...
BERR_Code BDSP_Arm_P_ReadMsg_isr(
    BDSP_P_MsgQueueHandle  hMsgQueue,  /*[in]*/
    void                  *pMsg,       /*[out]*/
    unsigned int           uiMsgSize   /*[in]*/
);
BERR_Code BDSP_Arm_P_GetResponse(
    BDSP_P_MsgQueueHandle  hMsgQueue,  /*[in]*/
    void                  *pMsgBuf,    /*[out]*/
    unsigned int           uiMsgSize   /*[in]*/
);
...
#endif /*BDSP_ARM_FWINTERFACE_PRIV_H_*/
