...
#ifndef BDSP_ARM_FWDOWNLOAD_PRIV_H_
#define BDSP_ARM_FWDOWNLOAD_PRIV_H_

#include "bdsp_arm_priv_include.h"

typedef struct BDSP_Arm_P_CodeDownloadInfo
{
    bool  preloadImages;    /* If true, all firmware images will be loaded on startup.  Default=false. */
    BDSP_P_FwBuffer imgInfo[BDSP_ARM_IMG_ID_MAX];
    BDSP_P_LoadableImageInfo  sLoadableImageInfo;
}BDSP_Arm_P_CodeDownloadInfo;
...
#endif /*BDSP_ARM_FWDOWNLOAD_PRIV_H_*/
