...
#define BDSP_ARM_MSG_WAIT_TIME_MSEC  1000


BDBG_MODULE(bdsp_arm_dsp_priv);
            ...
            )
{
	...
	BTEE_Connection_Close(pArm->armDspApp.hConnection);

    /* Close the application */
    BTEE_Application_Close(pArm->armDspApp.hApplication);


    /* Close the ArmDsp Client */
    BTEE_Client_Destroy(pArm->armDspApp.hClient);
