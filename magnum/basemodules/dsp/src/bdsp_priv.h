...
/* PAUSE-UNPAUSE */
    ...
    BERR_Code (*peekAtPicture_isr)(void *pTaskHandle, unsigned index,uint32_t **pUnifiedPicture);
    ...
    BERR_Code (*getPictureBuffer_isr)(void *pTaskHandle, uint32_t   *pPpBuf);
    BERR_Code (*putPicture_isr)(void *pTaskHandle, uint32_t pPictureParamBufAddress);
