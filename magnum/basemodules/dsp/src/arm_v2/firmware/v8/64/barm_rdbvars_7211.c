...
const uint32_t BDSP_ARM_IMG_system_rdbvars_array1[] = {
  ...
  0,/*BDSP_ARM_P_eRdbVarIndices_DSP_RAAGA_REG_REGION_BASE_ADDR*/
  0,/*BDSP_ARM_P_eRdbVarIndices_DSP_RAAGA_REG_REGION_SIZE*/
  0x01a00000,/*BDSP_ARM_P_eRdbVarIndices_DSP_XPT_REG_REGION_BASE_ADDR*/
  0x00000400,/*BDSP_ARM_P_eRdbVarIndices_DSP_XPT_REG_REGION_SIZE*/
  0x02f60000,/*BDSP_ARM_P_eRdbVarIndices_DSP_AUD_RATE_MANAGER_2711_BASE_ADDR*/
  0x00000074,/*BDSP_ARM_P_eRdbVarIndices_DSP_AUD_RATE_MANAGER_2711_SIZE*/
