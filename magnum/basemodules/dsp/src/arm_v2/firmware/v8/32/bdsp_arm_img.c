...
static void *BDSP_ARM_IMG_P_GetArray(unsigned imgId)
{
    switch ( imgId )
    {
		...
		case BDSP_ARM_IMG_ID_CODE(BDSP_Algorithm_eUdcDecode):					return BDSP_ARM_IMG_adec_ms11plus_udc;
		case BDSP_ARM_IMG_ID_TABLE(BDSP_Algorithm_eUdcDecode): 					return BDSP_ARM_IMG_adec_ms11plus_udc_tables;
		case BDSP_ARM_IMG_ID_IFRAME(BDSP_Algorithm_eUdcDecode):					return BDSP_ARM_IMG_adec_ms11plus_udc_inter_frame;
#else
		...
		case BDSP_ARM_IMG_ID_CODE(BDSP_Algorithm_eMixerDapv2):					return BDSP_ARM_IMG_app_ms11plus_mixer;
		case BDSP_ARM_IMG_ID_TABLE(BDSP_Algorithm_eMixerDapv2): 				return BDSP_ARM_IMG_app_ms11plus_mixer_tables;
		case BDSP_ARM_IMG_ID_IFRAME(BDSP_Algorithm_eMixerDapv2):				return BDSP_ARM_IMG_app_ms11plus_mixer_inter_frame;
#else/* Mixer with DAP */
...
#ifdef BDSP_MS11PLUS_SUPPORT
		case BDSP_ARM_IMG_ID_CODE(BDSP_Algorithm_eDolbyAacheAdtsDecode):		return BDSP_ARM_IMG_adec_ms11plus_dolby_aache;
		case BDSP_ARM_IMG_ID_CODE(BDSP_Algorithm_eDolbyAacheLoasDecode):		return BDSP_ARM_IMG_adec_ms11plus_dolby_aache;
		case BDSP_ARM_IMG_ID_TABLE(BDSP_Algorithm_eDolbyAacheAdtsDecode):		return BDSP_ARM_IMG_adec_ms11plus_dolby_aache_tables;
		case BDSP_ARM_IMG_ID_TABLE(BDSP_Algorithm_eDolbyAacheLoasDecode):		return BDSP_ARM_IMG_adec_ms11plus_dolby_aache_tables;
		case BDSP_ARM_IMG_ID_IFRAME(BDSP_Algorithm_eDolbyAacheAdtsDecode):		return BDSP_ARM_IMG_adec_ms11plus_dolby_aache_inter_frame;
		case BDSP_ARM_IMG_ID_IFRAME(BDSP_Algorithm_eDolbyAacheLoasDecode):		return BDSP_ARM_IMG_adec_ms11plus_dolby_aache_inter_frame;
#else
...
#ifdef BDSP_MS11PLUS_SUPPORT
		case BDSP_ARM_IMG_ID_CODE(BDSP_Algorithm_eDpcmr):						return BDSP_ARM_IMG_app_ms11plus_dpcmr;
		case BDSP_ARM_IMG_ID_TABLE(BDSP_Algorithm_eDpcmr):						return BDSP_ARM_IMG_app_ms11plus_dpcmr_tables;
		case BDSP_ARM_IMG_ID_IFRAME(BDSP_Algorithm_eDpcmr): 					return BDSP_ARM_IMG_app_ms11plus_dpcmr_inter_frame;
#else
...
#ifdef BDSP_MS11PLUS_SUPPORT
		case BDSP_ARM_IMG_ID_CODE(BDSP_Algorithm_eDDPEncode):					return BDSP_ARM_IMG_aenc_ms11plus_dd;
		case BDSP_ARM_IMG_ID_TABLE(BDSP_Algorithm_eDDPEncode):					return BDSP_ARM_IMG_aenc_ms11plus_dd_tables;
		case BDSP_ARM_IMG_ID_IFRAME(BDSP_Algorithm_eDDPEncode): 				return BDSP_ARM_IMG_aenc_ms11plus_dd_inter_frame;
#else
		...
		case BDSP_ARM_IMG_ID_CODE(BDSP_Algorithm_eMpegAudioPassthrough):		return BDSP_ARM_IMG_adec_passthru;
		case BDSP_ARM_IMG_ID_TABLE(BDSP_Algorithm_eMpegAudioPassthrough): 		return BDSP_ARM_IMG_adec_passthru_tables;
		case BDSP_ARM_IMG_ID_IFRAME(BDSP_Algorithm_eMpegAudioPassthrough):		return BDSP_ARM_IMG_adec_passthru_inter_frame;
		case BDSP_ARM_IMG_ID_IDS(BDSP_Algorithm_eMpegAudioPassthrough):			return BDSP_ARM_IMG_aids_mpeg1;
#endif /*BDSP_MPEG_PASSTHRU_SUPPORT*/
#ifdef BDSP_OPUSDEC_SUPPORT
        case BDSP_ARM_IMG_ID_CODE(BDSP_Algorithm_eOpusDecode):            		return BDSP_ARM_IMG_adec_opus;
        case BDSP_ARM_IMG_ID_TABLE(BDSP_Algorithm_eOpusDecode):            		return BDSP_ARM_IMG_adec_opus_tables;
