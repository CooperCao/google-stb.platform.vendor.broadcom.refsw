...
#define BFPSDK_LIBDSPCONTROL_FEATURE_DBG_CORE_BRIDGE_UNBUFF                 48
#define BFPSDK_LIBDSPCONTROL_FEATURE_DBG_CORE_DEBUG_SERVER                  49
#define BFPSDK_LIBDSPCONTROL_FEATURE_DBG_CORE_DEBUG_SERVER_MP               50
#define BFPSDK_LIBDSPCONTROL_FEATURE_DBG_CORE_NONE                          51
#define BFPSDK_LIBDSPCONTROL_FEATURE_DBG_HOST_IF_NONE                       52
#define BFPSDK_LIBDSPCONTROL_FEATURE_DBG_HOST_IF_SOCKET                     53
#define BFPSDK_LIBDSPCONTROL_FEATURE_DBG_TARGET_IF_MISC_BLOCK               54
#define BFPSDK_LIBDSPCONTROL_FEATURE_DBG_TARGET_IF_MISC_BLOCK_BUFFER        55
#define BFPSDK_LIBDSPCONTROL_FEATURE_DBG_TARGET_IF_NONE                     56
#define BFPSDK_LIBDSPCONTROL_FEATURE_DBG_TARGET_IF_SOCKET                   57
#define BFPSDK_LIBDSPCONTROL_FEATURE_DSPLOG_SINK_MEMORY                     58
#define BFPSDK_LIBDSPCONTROL_FEATURE_DSPLOG_SINK_NULL                       59
#define BFPSDK_LIBDSPCONTROL_FEATURE_DSPLOG_SINK_STDIO                      60
#define BFPSDK_LIBDSPCONTROL_FEATURE_DSP_SYS_ADDR_DIRECT_ACCESS_SUPPORTED   61
#define BFPSDK_LIBDSPCONTROL_FEATURE_DSP_SYS_ADDR_DIRECT_ACCESS_UNSUPPORTED 62
...
#define BFPSDK_LIBDSPCONTROL_FEATURE_IMAGE_OVERLAY_UNSUPPORTED              67
#define BFPSDK_LIBDSPCONTROL_FEATURE_IMAGE_VERIFY_UNSUPPORTED               68
#define BFPSDK_LIBDSPCONTROL_FEATURE_IMAGE_VOM_UNSUPPORTED                  69
#define BFPSDK_LIBDSPCONTROL_FEATURE_LIBC_FREESTANDING                      70
#define BFPSDK_LIBDSPCONTROL_FEATURE_LIBC_HOSTED                            71
#define BFPSDK_LIBDSPCONTROL_FEATURE_SOCKETS_SUPPORTED                      72
#define BFPSDK_LIBDSPCONTROL_FEATURE_SOCKETS_UNSUPPORTED                    73
#define BFPSDK_LIBDSPCONTROL_FEATURE_SW_HOST_FREERTOS                       74
#define BFPSDK_LIBDSPCONTROL_FEATURE_SW_HOST_LINUX                          75
#define BFPSDK_LIBDSPCONTROL_FEATURE_SW_HOST_RAAGA_MAGNUM                   76
#define BFPSDK_LIBDSPCONTROL_FEATURE_TB_VARIANT_CIRCULAR                    77
#define BFPSDK_LIBDSPCONTROL_FEATURE_TB_VARIANT_MULTIBUFFER                 78
#define BFPSDK_LIBDSPCONTROL_FEATURE_TB_VARIANT_NONE                        79
#define BFPSDK_LIBDSPCONTROL_HOST_ENV_BM                                    80
#define BFPSDK_LIBDSPCONTROL_HOST_ENV_DSP_LESS                              81
#define BFPSDK_LIBDSPCONTROL_HOST_ENV_SILICON                               82
#define GenericFPM1015_bm                                                   83
#define Leap_Phy                                                            84
#define Pike_bm                                                             85
#define Pike_haps                                                           86
...
#  error "BFPSDK_LIBDSPCONTROL_TARGET_SOC must be defined and be one of Pike_wkstn, Pike_haps, BCM93160A0_OFDMA_Rx_si, Leap_Phy, YellowstoneA0_si, RaagaFP4015_si_magnum_permissive, RaagaFP4015_bm, Pmc3, YellowstoneA0_bm, BCM93160_wkstn, BCM93160A0_OFDMA_Rx_bm, GenericFPM1015_bm, RaagaFP4015_haps_bm, RaagaFP4015_barebone, RaagaFP4015_si_magnum, BCM93160B0_USOOB_bm, RaagaFP4015_haps, RaagaFP4015_wkstn, Pike_bm"
#elif !((BFPSDK_LIBDSPCONTROL_TARGET_SOC == Pike_wkstn) || (BFPSDK_LIBDSPCONTROL_TARGET_SOC == Pike_haps) || (BFPSDK_LIBDSPCONTROL_TARGET_SOC == BCM93160A0_OFDMA_Rx_si) || (BFPSDK_LIBDSPCONTROL_TARGET_SOC == Leap_Phy) || (BFPSDK_LIBDSPCONTROL_TARGET_SOC == YellowstoneA0_si) || (BFPSDK_LIBDSPCONTROL_TARGET_SOC == RaagaFP4015_si_magnum_permissive) || (BFPSDK_LIBDSPCONTROL_TARGET_SOC == RaagaFP4015_bm) || (BFPSDK_LIBDSPCONTROL_TARGET_SOC == Pmc3) || (BFPSDK_LIBDSPCONTROL_TARGET_SOC == YellowstoneA0_bm) || (BFPSDK_LIBDSPCONTROL_TARGET_SOC == BCM93160_wkstn) || (BFPSDK_LIBDSPCONTROL_TARGET_SOC == BCM93160A0_OFDMA_Rx_bm) || (BFPSDK_LIBDSPCONTROL_TARGET_SOC == GenericFPM1015_bm) || (BFPSDK_LIBDSPCONTROL_TARGET_SOC == RaagaFP4015_haps_bm) || (BFPSDK_LIBDSPCONTROL_TARGET_SOC == RaagaFP4015_barebone) || (BFPSDK_LIBDSPCONTROL_TARGET_SOC == RaagaFP4015_si_magnum) || (BFPSDK_LIBDSPCONTROL_TARGET_SOC == BCM93160B0_USOOB_bm) || (BFPSDK_LIBDSPCONTROL_TARGET_SOC == RaagaFP4015_haps) || (BFPSDK_LIBDSPCONTROL_TARGET_SOC == RaagaFP4015_wkstn) || (BFPSDK_LIBDSPCONTROL_TARGET_SOC == Pike_bm))
...
#if (defined(PIKE) || defined(RAAGA) || defined(LEAP_PHY) || defined(MCPHY) || defined(PMC3) || defined(GENERIC) || defined(YELLOWSTONE))
/* Check if multiple CHIPs are defined */
#  if !(!((defined(PIKE) && ((defined(RAAGA) || defined(LEAP_PHY) || defined(GENERIC) || defined(PMC3) || defined(MCPHY) || defined(YELLOWSTONE)))) || (defined(YELLOWSTONE) && ((defined(PIKE) || defined(RAAGA) || defined(LEAP_PHY) || defined(GENERIC) || defined(PMC3) || defined(MCPHY)))) || (defined(RAAGA) && ((defined(PIKE) || defined(LEAP_PHY) || defined(GENERIC) || defined(PMC3) || defined(MCPHY) || defined(YELLOWSTONE)))) || (defined(LEAP_PHY) && ((defined(PIKE) || defined(RAAGA) || defined(GENERIC) || defined(PMC3) || defined(MCPHY) || defined(YELLOWSTONE)))) || (defined(GENERIC) && ((defined(PIKE) || defined(RAAGA) || defined(LEAP_PHY) || defined(MCPHY) || defined(PMC3) || defined(YELLOWSTONE)))) || (defined(MCPHY) && ((defined(PIKE) || defined(RAAGA) || defined(LEAP_PHY) || defined(GENERIC) || defined(PMC3) || defined(YELLOWSTONE)))) || (defined(PMC3) && ((defined(PIKE) || defined(RAAGA) || defined(LEAP_PHY) || defined(GENERIC) || defined(MCPHY) || defined(YELLOWSTONE))))))
...
#    define MCPHY
#  endif
#  if BFPSDK_LIBDSPCONTROL_TARGET_SOC == Leap_Phy
#    define LEAP_PHY
#  endif
...
#    define RAAGA
#  endif
#  if BFPSDK_LIBDSPCONTROL_TARGET_SOC == Pmc3
#    define PMC3
#  endif
...
#endif
#if BFPSDK_LIBDSPCONTROL_TARGET_SOC == Leap_Phy
#  define BFPSDK_LIBDSPCONTROL_TARGET_NAME                        "Leap_Phy"
...
#endif
#if BFPSDK_LIBDSPCONTROL_TARGET_SOC == Pmc3
#  define BFPSDK_LIBDSPCONTROL_TARGET_NAME                        "Pmc3"
#  define BFPSDK_LIBDSPCONTROL_HOST_ENV                           BFPSDK_LIBDSPCONTROL_HOST_ENV_BM
#  define BFPSDK_LIBDSPCONTROL_FEATURE_IMAGE_VERIFY               BFPSDK_LIBDSPCONTROL_FEATURE_IMAGE_VERIFY_UNSUPPORTED
#  define BFPSDK_LIBDSPCONTROL_FEATURE_BAREBONE                   BFPSDK_LIBDSPCONTROL_FEATURE_BAREBONE_NO
#  define BFPSDK_LIBDSPCONTROL_FEATURE_DBG_CORE                   BFPSDK_LIBDSPCONTROL_FEATURE_DBG_CORE_DEBUG_SERVER
