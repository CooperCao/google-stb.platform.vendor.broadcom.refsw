...
DSP_RET DSP_enable(DSP *dsp, DSP_CORE core)
{
    ...
    /* Clear the MISC block mailbox which is used for DBG interaction, as valid stale data
     * in the mailbox result in miscommunication between the DSP and the host
     * */
