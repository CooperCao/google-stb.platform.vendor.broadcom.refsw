...
#  define TB_SHARED_BUFF_ATTRS  __absolute
#else
...
TB_SHARED_BUFF_ATTRS extern uint8_t Buffer_TargetPrint[];
TB_SHARED_BUFF_ATTRS extern uint8_t BufSize_TargetPrint;
TB_SHARED_BUFF_ATTRS extern uint8_t Buffer_StatProf[];
TB_SHARED_BUFF_ATTRS extern uint8_t BufSize_StatProf;
TB_SHARED_BUFF_ATTRS extern uint8_t Buffer_Instrumentation[];
TB_SHARED_BUFF_ATTRS extern uint8_t BufSize_Instrumentation;
#  else
TB_SHARED_BUFF_ATTRS extern uint8_t Buffer_TB_Common[];
TB_SHARED_BUFF_ATTRS extern uint8_t BufSize_TB_Common;
#  endif
