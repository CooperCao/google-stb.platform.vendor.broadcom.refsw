 ...
 */
#ifdef __FIREPATH__
#  define TB_BUFF_PTR   uint8_t *
#else
#  define TB_BUFF_PTR   uint32_t
#endif
#define TB_BUFF_SIZE    uint32_t
...
typedef struct __attribute__((packed))
{
    ...
    TB_BUFF_PTR storage;        /**< data buffer location */
    TB_BUFF_PTR read_ptr;       /**< where the next read should start from */
    TB_BUFF_PTR write_ptr;      /**< where the next write should occur */
} TB_shared;
