...
)
{
	...
	BDBG_ENTER(BDSP_Raaga_P_Analyse_CIT_TSMConfig);
	...
	BDBG_MSG(("-------------------- "));
	BDBG_LEAVE(BDSP_Raaga_P_Analyse_CIT_TSMConfig);
}
...
)
{
	...
	BDBG_ENTER(BDSP_Raaga_P_Analyse_CIT_GateOpenConfig);
	...
	BDBG_MSG(("-------------------- "));
	BDBG_LEAVE(BDSP_Raaga_P_Analyse_CIT_GateOpenConfig);
}
...
)
{
	...
	BDBG_ENTER(BDSP_Raaga_P_Analyse_CIT_SchedulingConfig);
	...
	BDBG_MSG(("-------------------- "));
	BDBG_LEAVE(BDSP_Raaga_P_Analyse_CIT_SchedulingConfig);
}
...
{
	unsigned index = 0;
	BDBG_ENTER(BDSP_Raaga_P_Analyse_CIT_PPMConfig);
	BDBG_MSG(("PPM CONFIG"));
	BDBG_MSG(("-------------------- "));
	...
	BDBG_MSG(("---------------------"));
	BDBG_LEAVE(BDSP_Raaga_P_Analyse_CIT_PPMConfig);
}
...
{
	BDBG_ENTER(BDSP_Raaga_P_Analyse_CIT_DataAccess);
	BDBG_MSG(("--"));
	...
	BDBG_MSG(("--"));
	BDBG_LEAVE(BDSP_Raaga_P_Analyse_CIT_DataAccess);
}
...
)
{
	...
	BDBG_ENTER(BDSP_Raaga_P_Analyse_CIT_BufferDetails);
	...
	BDBG_LEAVE(BDSP_Raaga_P_Analyse_CIT_BufferDetails);
}
