...
#define BDSP_IMG_USER_PROCESS_SPAWN_MEM_SIZE                         ((uint32_t)240000)
...
#define BDSP_IMG_SYSTEM_LIB_SIZE                                     ((uint32_t)615424)
...
#define BDSP_IMG_ADEC_AC4_SIZE                                       ((uint32_t)520704)
...
#define BDSP_IMG_AIDS_WAVFORMATEX_SIZE                               ((uint32_t)14336)
...
#define BDSP_IMG_AENC_DDP_TABLES_SIZE                                ((uint32_t)156160)
...
#define BDSP_IMG_ADEC_OPUS_SIZE                                      ((uint32_t)98816)
