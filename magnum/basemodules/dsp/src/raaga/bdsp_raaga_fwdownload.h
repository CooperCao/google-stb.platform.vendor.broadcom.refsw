...
#ifndef BDSP_RAAGA_FWDOWNLOAD_H__
#define BDSP_RAAGA_FWDOWNLOAD_H__
...
typedef struct BDSP_RaagaImgCacheEntry
{
    ...
    dramaddr_t offset;        /* Physical address of allocated memory */
} BDSP_RaagaImgCacheEntry;
