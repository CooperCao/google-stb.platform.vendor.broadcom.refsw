...
typedef struct BDSP_AF_P_sALGO_SCHEDULING_GROUP_INFO
{
    uint32_t        NumSchedulingGroups;
    bool            IsSchedulingGroupSupported[BDSP_AF_P_eSchedulingGroup_Max];
} BDSP_AF_P_sALGO_SCHEDULING_GROUP_INFO;
...
typedef struct BDSP_Raaga_P_AlgorithmSupportInfo
{
	...
	BDSP_AF_P_sALGO_SCHEDULING_GROUP_INFO sAlgoSchedulingGroupInfo;
