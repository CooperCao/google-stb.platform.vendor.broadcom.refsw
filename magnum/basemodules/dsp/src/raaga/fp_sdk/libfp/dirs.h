...
{
#ifdef __FPM1015_ONWARDS__
    return __fp_dirr_l(DIR_TIME_TOTC);
#else
    return __fp_dirr(DIR_TIME_TOTC);
#endif
}
...
#else
    __fp_dirw(new_value, DIR_TIME_TOTC);
#endif
}
...
#else
    return __fp_dirr(DIR_TIME_COMP1);
#endif
}
...
#else
    __fp_dirw(interrupt_time, DIR_TIME_COMP1);
#endif
}
...
#else
    return __fp_dirr(DIR_TIME_COMP2);
#endif
}
...
#else
    __fp_dirw(interrupt_time, DIR_TIME_COMP2);
#endif
}
...
#else
    return __fp_dirr(DIR_TIME_USRC);
#endif
}
#endif
...
#else
    return __fp_dirr(DIR_TIME_COMP3);
#endif
}
...
#else
    __fp_dirw(interrupt_time, DIR_TIME_COMP3);
#endif
}
#endif // DIR_USRC_CMP
