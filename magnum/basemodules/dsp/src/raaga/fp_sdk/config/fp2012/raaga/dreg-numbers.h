...
#define DIR_BUSERROR_STATUS_X                    108
#define DIR_BUSERROR_STATUS_Y                    109

/* total cycles since reset */
#define DIR_TOTC                                 128

/* total user bank cycles since reset */
#define DIR_USRC                                 129
...
#define DIR_CORE_ID                              151
#define DIR_ICACHE_CONTROL                       144

/* increments once per fetched instruction not in ICache */
#define DIR_ICACHE_MISS_INSN_CTR                 152

/* increments approximately once per cycle spent waiting for instruction */
#define DIR_ICACHE_MISS_CYCLE_CTR                153

/* increments once per issued operation - usually once per instruction but more if it explodes in decode */
...
#define DIR_DICTOP_TABLE_PTR                     172
#define DIR_DICTOP_TABLE_DATA                    173
#define DIR_MB_LINK_REG                          174
#define DIR_SOFT_BIST_CONTROL                    179
#define DIR_SOFTBPT_TRAMPOLINE                   190
#define DIR_SOFTBPT_MASK1                        191
#define DIR_DEBUG_CONTROL                        195
#define DIR_SVC_VECTOR                           196
#define DIR_INT_VECTOR                           197
#define DIR_SINT_VECTOR                          198
#define DIR_BPT_VECTOR                           199
#define DIR_SMEM_PARITY_VECTOR                   200
#define DIR_VOM_VECTOR                           201
#define DIR_BRB_VECTOR                           202
#define DIR_UNIMPL_VECTOR                        203
#define DIR_RESET_VECTOR                         204
#define DIR_UARCH_CONTROL                         67
#define DIR_GP_CFG0                              180
#define DIR_GREG_CACHE                           181
...
#define DIR_VALIDITY_MASK2 0xfc00ffd8
#define DIR_VALIDITY_MASK3 0x00003fff
#define DIR_VALIDITY_MASK4 0x3fc17fff
#define DIR_VALIDITY_MASK5 0xc0387e50
#define DIR_VALIDITY_MASK6 0x00001ff8
