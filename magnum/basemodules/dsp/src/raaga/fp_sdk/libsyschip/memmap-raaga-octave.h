...
#define DATA_START          SYMBOL_ADDR_TO_ADDR(__data_start)
#define DATA_END            SYMBOL_ADDR_TO_ADDR(__data_end)
...
#    define HEARTBEAT_SHARED_ADDRESS_CORE0  (&FPMISC_BLOCK_FOR_CORE(0)->corestate_sys_mbx4)
#    define HEARTBEAT_SHARED_ADDRESS_CORE1  (&FPMISC_BLOCK_FOR_CORE(1)->corestate_sys_mbx4)
#  else
#    define HEARTBEAT_SHARED_ADDRESS_CORE0  (taddr_Misc_Block + FPMISC_CORE_SPACING * 0 + MISC_BLOCK_CORESTATE_SYS_MBX4)
#    define HEARTBEAT_SHARED_ADDRESS_CORE1  (taddr_Misc_Block + FPMISC_CORE_SPACING * 1 + MISC_BLOCK_CORESTATE_SYS_MBX4)
#  endif
#endif
