...
#endif  /* FEATURE_IS(SW_HOST, LINUX) || FEATURE_IS(SW_HOST, FREERTOS) || FEATURE_IS(SW_HOST, RAAGA_ROCKFORD) */
...
#endif  /* FEATURE_IS(SW_HOST, LINUX) || FEATURE_IS(SW_HOST, RAAGA_ROCKFORD) || IS_HOST(BM) || IS_HOST(DSP_LESS) */
