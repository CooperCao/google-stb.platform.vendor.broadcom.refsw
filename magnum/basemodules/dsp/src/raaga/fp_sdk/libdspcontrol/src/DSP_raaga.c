...
#ifndef OS_POSIX
#  error "This module targets only Posix"
#endif
...
#endif /* !defined(RAAGA_HOST_SI_MAGNUM) */
...
const DSP_MEMORY_LAYOUT *DSP_getMemoryLayout(DSP *dsp __unused)
{
    ...
    static int areas_set = 0;
    if (! areas_set)
    {
        layout.areasCount = sizeof (areas) / sizeof (DSP_MEMORY_AREA);
        layout.areas      = areas;
        areas_set         = 1;
    }
 ...
 */
#ifdef __FP2012__
static int DSP_checkBuffersInitialised (DSP *dsp)
{
