...
#  define MISC_BLOCK_INTERRUPT_OBUSFAULT_CLEAR          MISC_BLOCK_OBUS_FAULT_OBUS_FAULT_ADDRESS
#  define MISC_BLOCK_INTERRUPT_OBUSFAULT_ADDRESS        MISC_BLOCK_OBUS_FAULT_OBUS_FAULT_CLEAR
...
#  define MISC_BLOCK_BASE_ADDR(dsp_p, core)     0xe0000000
#elif defined(LEAP_PHY)
#  define MISC_BLOCK_BASE_ADDR(dsp_p, core)     0x000d0000
...
#elif IS_TARGET(RaagaFP4015_haps) || IS_TARGET(RaagaFP4015_haps_bm) || IS_TARGET(RaagaFP4015_bm) || IS_TARGET(RaagaFP4015_si_magnum)
#  if IS_TARGET(RaagaFP4015_bm)     /* FIXME: these addresses are BCM7278A0 specific, make it generic */
#    define MISC_BLOCK_BASE_ADDR_0              0x09034000
#    define MISC_BLOCK_BASE_ADDR_1              0x09034200
#  elif IS_TARGET(RaagaFP4015_haps) || IS_TARGET(RaagaFP4015_haps_bm)
#    define MISC_BLOCK_BASE_ADDR_0              0xf0c34000
#    define MISC_BLOCK_BASE_ADDR_1              0xf0c34200
#  elif IS_TARGET(RaagaFP4015_si_magnum)
#    define MISC_BLOCK_BASE_ADDR_0              BCHP_RAAGA_DSP_FP_MISC_0_CORECTRL_REG_START
#    define MISC_BLOCK_BASE_ADDR_1              BCHP_RAAGA_DSP_FP_MISC_1_CORECTRL_REG_START
#  endif
...
#  define MISC_BLOCK_BASE_ADDR_0                0x283f0000
#  define MISC_BLOCK_CORE_SPACING               0x1000      /* See memmap-yellowstone-core.h */
#  define MISC_BLOCK_BASE_ADDR(dsp_p, core)     (MISC_BLOCK_BASE_ADDR_0 + (core) * MISC_BLOCK_CORE_SPACING)
#endif
