...
#define BDSP_IMG_AC3_DECODE_SIZE                                     ((uint32_t)185292)
...
#define BDSP_IMG_AC4_DECODE_SIZE                                     ((uint32_t)440612)
...
#define BDSP_IMG_DDP_DECODE_SIZE                                     ((uint32_t)185320)
#define BDSP_IMG_DDP_DECODE_TABLES_SIZE                              ((uint32_t)42288)
#define BDSP_IMG_DDP_ENCODE_CODE_SIZE                                ((uint32_t)279448)
...
#define BDSP_IMG_DDRE_CODE_SIZE                                      ((uint32_t)33320)
...
#define BDSP_IMG_DOLBY_AACHE_DECODE_SIZE                             ((uint32_t)380988)
...
#define BDSP_IMG_DOLBY_MS_DDP_DECODE_SIZE                            ((uint32_t)110752)
...
#define BDSP_IMG_DOLBY_PULSE_DECODE_SIZE                             ((uint32_t)400672)
...
#define BDSP_IMG_FW_MIXER_CODE_SIZE                                  ((uint32_t)32152)
...
#define BDSP_IMG_H264_ENCODE_SIZE                                    ((uint32_t)127068)
...
#define BDSP_IMG_SYSTEM_CODE_SIZE                                    ((uint32_t)68664)
...
#define BDSP_IMG_UDC_DECODE_SIZE                                     ((uint32_t)181776)
...
#define BDSP_IMG_X264_ENCODE_SIZE                                    ((uint32_t)47516)
