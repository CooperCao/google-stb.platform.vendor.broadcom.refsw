...
#define BDSP_IMG_AC4_DECODE_SIZE                                     ((uint32_t)440932)
...
#define BDSP_IMG_DOLBY_AACHE_DECODE_SIZE                             ((uint32_t)380788)
...
#define BDSP_IMG_DOLBY_PULSE_DECODE_SIZE                             ((uint32_t)400556)
...
#define BDSP_IMG_IDSCOMMON_CODE_SIZE                                 ((uint32_t)36152)
...
#define BDSP_IMG_MIXER_DAPV2_IDS_SIZE                                ((uint32_t)8616)
