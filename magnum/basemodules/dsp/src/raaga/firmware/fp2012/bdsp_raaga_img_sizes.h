...
#define BDSP_IMG_AACHE_DECODE_SIZE                                   ((uint32_t)156596)
...
#define BDSP_IMG_AC3_DECODE_SIZE                                     ((uint32_t)184904)
...
#define BDSP_IMG_AC4_DECODE_SIZE                                     ((uint32_t)440360)
...
#define BDSP_IMG_AMBISONICS_CODE_SIZE                                ((uint32_t)14408)
...
#define BDSP_IMG_AMRWB_DECODE_SIZE                                   ((uint32_t)48392)
...
#define BDSP_IMG_AMR_ENCODE_SIZE                                     ((uint32_t)72824)
...
#define BDSP_IMG_CDB_PASSTHRU_CODE_SIZE                              ((uint32_t)29516)
...
#define BDSP_IMG_DDP_DECODE_SIZE                                     ((uint32_t)184936)
#define BDSP_IMG_DDP_DECODE_TABLES_SIZE                              ((uint32_t)42288)
#define BDSP_IMG_DDP_ENCODE_CODE_SIZE                                ((uint32_t)275916)
...
#define BDSP_IMG_DOLBY_AACHE_DECODE_SIZE                             ((uint32_t)212812)
...
#define BDSP_IMG_DOLBY_MS_DDP_DECODE_SIZE                            ((uint32_t)110608)
...
#define BDSP_IMG_DOLBY_PULSE_DECODE_SIZE                             ((uint32_t)232940)
...
#define BDSP_IMG_DTSHD_DECODE_SIZE                                   ((uint32_t)79780)
...
#define BDSP_IMG_FW_MIXER_CODE_SIZE                                  ((uint32_t)32128)
...
#define BDSP_IMG_ISAC_ENCODE_SIZE                                    ((uint32_t)51484)
...
#define BDSP_IMG_MIXER_DAPV2_CODE_SIZE                               ((uint32_t)196664)
...
#define BDSP_IMG_MP3_ENCODE_SIZE                                     ((uint32_t)37932)
...
#define BDSP_IMG_OPUS_DECODE_SIZE                                    ((uint32_t)94112)
...
#define BDSP_IMG_SRS_TRUSURROUNDHD_CODE_SIZE                         ((uint32_t)23504)
...
#define BDSP_IMG_SRS_TVOL_CODE_SIZE                                  ((uint32_t)22164)
#define BDSP_IMG_SRS_TVOL_INTER_FRAME_SIZE                           ((uint32_t)7344)
#define BDSP_IMG_SRS_TVOL_TABLES_SIZE                                ((uint32_t)4624)
#define BDSP_IMG_SYSLIB_CODE_SIZE                                    ((uint32_t)16320)
#define BDSP_IMG_SYSTEM_CODE_SIZE                                    ((uint32_t)68160)
#define BDSP_IMG_TRUEHD_DECODE_INTER_FRAME_SIZE                      ((uint32_t)5108)
#define BDSP_IMG_TRUEHD_DECODE_SIZE                                  ((uint32_t)54288)
...
#define BDSP_IMG_UDC_DECODE_SIZE                                     ((uint32_t)181348)
...
#define BDSP_IMG_VIDEO_DECODE_TASK_CODE_SIZE                         ((uint32_t)4080)
#define BDSP_IMG_VIDEO_ENCODE_TASK_CODE_SIZE                         ((uint32_t)4420)
#define BDSP_IMG_VIDIDSCOMMON_CODE_SIZE                              ((uint32_t)6700)
...
#define BDSP_IMG_VORBIS_DECODE_SIZE                                  ((uint32_t)49948)
...
#define BDSP_IMG_VP6_DECODE_SIZE                                     ((uint32_t)58044)
...
#define BDSP_IMG_WMA_PRO_DECODE_SIZE                                 ((uint32_t)290228)
...
#define BDSP_IMG_X264_ENCODE_SIZE                                    ((uint32_t)47584)
