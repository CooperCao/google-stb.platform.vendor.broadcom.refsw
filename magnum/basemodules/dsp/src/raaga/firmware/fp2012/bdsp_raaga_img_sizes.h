...
#define BDSP_IMG_DOLBY_MS_DDP_DECODE_SIZE                            ((uint32_t)110632)
...
#define BDSP_IMG_GEN_CDBITB_CODE_SIZE                                ((uint32_t)10108)
...
#define BDSP_IMG_MIXER_DAPV2_CODE_SIZE                               ((uint32_t)196852)
...
#define BDSP_IMG_X264_ENCODE_SIZE                                    ((uint32_t)47560)
