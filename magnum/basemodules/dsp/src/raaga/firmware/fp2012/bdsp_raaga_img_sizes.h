...
#define BDSP_IMG_AC4_DECODE_SIZE                                     ((uint32_t)440836)
...
#define BDSP_IMG_IDSCOMMON_CODE_SIZE                                 ((uint32_t)36120)
...
#define BDSP_IMG_MIXER_DAPV2_CODE_SIZE                               ((uint32_t)198332)
#define BDSP_IMG_MIXER_DAPV2_IDS_INTER_FRAME_SIZE                    ((uint32_t)3964)
#define BDSP_IMG_MIXER_DAPV2_IDS_SIZE                                ((uint32_t)8484)
...
#define BDSP_IMG_OPUS_DECODE_SIZE                                    ((uint32_t)98040)
