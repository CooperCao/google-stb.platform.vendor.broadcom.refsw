...
#define BDSP_IMG_AC4_DECODE_SIZE                                     ((uint32_t)440852)
...
#define BDSP_IMG_DDP_ENCODE_CODE_SIZE                                ((uint32_t)279120)
...
#define BDSP_IMG_DPCMR_CODE_SIZE                                     ((uint32_t)47852)
...
#define BDSP_IMG_MIXER_DAPV2_CODE_SIZE                               ((uint32_t)197324)
#define BDSP_IMG_MIXER_DAPV2_IDS_INTER_FRAME_SIZE                    ((uint32_t)3916)
#define BDSP_IMG_MIXER_DAPV2_IDS_SIZE                                ((uint32_t)8084)
