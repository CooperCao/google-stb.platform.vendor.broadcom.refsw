...
#define BDSP_IMG_AC3_DECODE_SIZE                                     ((uint32_t)184800)
...
#define BDSP_IMG_AC4_DECODE_SIZE                                     ((uint32_t)440672)
...
#define BDSP_IMG_DDP_DECODE_SIZE                                     ((uint32_t)184832)
#define BDSP_IMG_DDP_DECODE_TABLES_SIZE                              ((uint32_t)42288)
#define BDSP_IMG_DDP_ENCODE_CODE_SIZE                                ((uint32_t)276044)
...
#define BDSP_IMG_DOLBY_MS_DDP_DECODE_SIZE                            ((uint32_t)110580)
...
#define BDSP_IMG_DOLBY_PULSE_DECODE_SIZE                             ((uint32_t)400588)
#define BDSP_IMG_DOLBY_PULSE_DECODE_TABLES_SIZE                      ((uint32_t)126844)
#define BDSP_IMG_DPCMR_CODE_SIZE                                     ((uint32_t)47716)
...
#define BDSP_IMG_MIXER_DAPV2_CODE_SIZE                               ((uint32_t)196768)
...
#define BDSP_IMG_TRUEHD_DECODE_SIZE                                  ((uint32_t)54524)
...
#define BDSP_IMG_UDC_DECODE_SIZE                                     ((uint32_t)181252)
