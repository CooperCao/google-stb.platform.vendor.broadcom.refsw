...
#define BDSP_IMG_ALS_DECODE_SIZE                                     ((uint32_t)29680)
...
#define BDSP_IMG_BRCM_AVL_CODE_SIZE                                  ((uint32_t)10364)
...
#define BDSP_IMG_DPCMR_CODE_SIZE                                     ((uint32_t)51528)
...
#define BDSP_IMG_FW_MIXER_CODE_SIZE                                  ((uint32_t)35324)
...
#define BDSP_IMG_GEN_CDBITB_CODE_SIZE                                ((uint32_t)11364)
...
#define BDSP_IMG_IDSCOMMON_CODE_SIZE                                 ((uint32_t)38404)
...
#define BDSP_IMG_MIXER_IDS_SIZE                                      ((uint32_t)3388)
...
#define BDSP_IMG_MPEG1_DECODE_SIZE                                   ((uint32_t)37044)
...
#define BDSP_IMG_SRC_CODE_SIZE                                       ((uint32_t)16548)
...
#define BDSP_IMG_SYSTEM_CODE_SIZE                                    ((uint32_t)70840)
#define BDSP_IMG_TRUEHD_DECODE_INTER_FRAME_SIZE                      ((uint32_t)5108)
#define BDSP_IMG_TRUEHD_DECODE_SIZE                                  ((uint32_t)57008)
...
#define BDSP_IMG_XVP8_ENCODE_SIZE                                    ((uint32_t)66556)
