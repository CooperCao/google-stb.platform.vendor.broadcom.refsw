...
#define BDSP_IMG_GEN_CDBITB_CODE_SIZE                                ((uint32_t)10056)
...
#define BDSP_IMG_IDSCOMMON_CODE_SIZE                                 ((uint32_t)35960)
...
#define BDSP_IMG_SYSLIB_CODE_SIZE                                    ((uint32_t)16164)
#define BDSP_IMG_SYSTEM_CODE_SIZE                                    ((uint32_t)68144)
...
#define BDSP_IMG_VIDEO_ENCODE_TASK_CODE_SIZE                         ((uint32_t)4420)
...
#define BDSP_IMG_X264_ENCODE_SIZE                                    ((uint32_t)47572)
