...
#define BDSP_IMG_AC4_DECODE_SIZE                                     ((uint32_t)440364)
...
#define BDSP_IMG_ADPCM_DECODE_SIZE                                   ((uint32_t)9472)
...
#define BDSP_IMG_ALS_DECODE_SIZE                                     ((uint32_t)26596)
#define BDSP_IMG_ALS_DECODE_TABLES_SIZE                              ((uint32_t)928)
#define BDSP_IMG_ALS_IDS_INTER_FRAME_SIZE                            ((uint32_t)16876)
#define BDSP_IMG_ALS_IDS_SIZE                                        ((uint32_t)9016)
#define BDSP_IMG_AMBISONICS_CODE_SIZE                                ((uint32_t)14400)
...
#define BDSP_IMG_AMRWB_DECODE_SIZE                                   ((uint32_t)48404)
...
#define BDSP_IMG_AMR_DECODE_SIZE                                     ((uint32_t)40396)
...
#define BDSP_IMG_BRCM_3DSURROUND_CODE_SIZE                           ((uint32_t)7308)
...
#define BDSP_IMG_DDP_DECODE_SIZE                                     ((uint32_t)185056)
#define BDSP_IMG_DDP_DECODE_TABLES_SIZE                              ((uint32_t)42288)
#define BDSP_IMG_DDP_ENCODE_CODE_SIZE                                ((uint32_t)275988)
...
#define BDSP_IMG_DDRE_CODE_SIZE                                      ((uint32_t)33276)
...
#define BDSP_IMG_DOLBY_AACHE_DECODE_SIZE                             ((uint32_t)212804)
...
#define BDSP_IMG_DOLBY_MS_DDP_DECODE_SIZE                            ((uint32_t)110696)
...
#define BDSP_IMG_DOLBY_PULSE_DECODE_SIZE                             ((uint32_t)232952)
#define BDSP_IMG_DOLBY_PULSE_DECODE_TABLES_SIZE                      ((uint32_t)40992)
#define BDSP_IMG_DPCMR_CODE_SIZE                                     ((uint32_t)47532)
...
#define BDSP_IMG_DRA_DECODE_SIZE                                     ((uint32_t)26624)
...
#define BDSP_IMG_DV258_CODE_SIZE                                     ((uint32_t)48064)
...
#define BDSP_IMG_FADECTRL_CODE_SIZE                                  ((uint32_t)3760)
...
#define BDSP_IMG_FLAC_DECODE_SIZE                                    ((uint32_t)25672)
...
#define BDSP_IMG_FW_MIXER_CODE_SIZE                                  ((uint32_t)32080)
...
#define BDSP_IMG_G722_ENCODE_SIZE                                    ((uint32_t)4392)
...
#define BDSP_IMG_MAC_DECODE_SIZE                                     ((uint32_t)14708)
...
#define BDSP_IMG_MIXER_DAPV2_CODE_SIZE                               ((uint32_t)196580)
#define BDSP_IMG_MIXER_DAPV2_IDS_INTER_FRAME_SIZE                    ((uint32_t)3916)
#define BDSP_IMG_MIXER_DAPV2_IDS_SIZE                                ((uint32_t)7888)
...
#define BDSP_IMG_MLP_PASSTHROUGH_CODE_SIZE                           ((uint32_t)6148)
...
#define BDSP_IMG_OPUS_DECODE_SIZE                                    ((uint32_t)94092)
#define BDSP_IMG_OPUS_DECODE_TABLES_SIZE                             ((uint32_t)17248)
#define BDSP_IMG_OPUS_ENCODE_CODE_SIZE                               ((uint32_t)177220)
...
#define BDSP_IMG_PCMWAV_IDS_SIZE                                     ((uint32_t)4088)
...
#define BDSP_IMG_RALBR_DECODE_SIZE                                   ((uint32_t)27272)
...
#define BDSP_IMG_SRS_TVOL_CODE_SIZE                                  ((uint32_t)22160)
#define BDSP_IMG_SRS_TVOL_INTER_FRAME_SIZE                           ((uint32_t)7344)
#define BDSP_IMG_SRS_TVOL_TABLES_SIZE                                ((uint32_t)4624)
#define BDSP_IMG_SYSLIB_CODE_SIZE                                    ((uint32_t)14632)
#define BDSP_IMG_SYSTEM_CODE_SIZE                                    ((uint32_t)72040)
#define BDSP_IMG_TRUEHD_DECODE_INTER_FRAME_SIZE                      ((uint32_t)5108)
#define BDSP_IMG_TRUEHD_DECODE_SIZE                                  ((uint32_t)54292)
...
#define BDSP_IMG_UDC_DECODE_SIZE                                     ((uint32_t)181468)
...
#define BDSP_IMG_VIDEO_DECODE_TASK_CODE_SIZE                         ((uint32_t)4072)
...
#define BDSP_IMG_VORBIS_DECODE_SIZE                                  ((uint32_t)49932)
...
#define BDSP_IMG_VP6_DECODE_SIZE                                     ((uint32_t)58036)
...
#define BDSP_IMG_WMA_DECODE_SIZE                                     ((uint32_t)47828)
...
#define BDSP_IMG_WMA_PRO_DECODE_SIZE                                 ((uint32_t)290212)
