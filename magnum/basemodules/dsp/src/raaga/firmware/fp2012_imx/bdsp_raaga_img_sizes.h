...
#define BDSP_IMG_DDRE_CODE_SIZE                                      ((uint32_t)33312)
...
#define BDSP_IMG_DOLBY_MS_DDP_DECODE_SIZE                            ((uint32_t)110756)
...
#define BDSP_IMG_MIXER_DAPV2_CODE_SIZE                               ((uint32_t)196752)
