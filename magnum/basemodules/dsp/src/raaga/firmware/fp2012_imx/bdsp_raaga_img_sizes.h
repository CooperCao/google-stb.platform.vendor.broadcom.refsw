...
#define BDSP_IMG_AACHE_DECODE_SIZE                                   ((uint32_t)168160)
...
#define BDSP_IMG_DOLBY_AACHE_DECODE_SIZE                             ((uint32_t)380980)
...
#define BDSP_IMG_DOLBY_PULSE_DECODE_SIZE                             ((uint32_t)400760)
...
#define BDSP_IMG_IDSCOMMON_CODE_SIZE                                 ((uint32_t)36104)
...
#define BDSP_IMG_MIXER_DAPV2_IDS_SIZE                                ((uint32_t)8608)
