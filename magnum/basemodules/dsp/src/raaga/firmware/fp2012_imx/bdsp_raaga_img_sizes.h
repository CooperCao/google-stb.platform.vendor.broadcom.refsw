...
#define BDSP_IMG_AACHEADTS_IDS_INTER_FRAME_SIZE                      ((uint32_t)16880)
#define BDSP_IMG_AACHEADTS_IDS_SIZE                                  ((uint32_t)3588)
#define BDSP_IMG_AACHELOAS_IDS_INTER_FRAME_SIZE                      ((uint32_t)16880)
#define BDSP_IMG_AACHELOAS_IDS_SIZE                                  ((uint32_t)4696)
#define BDSP_IMG_AACHE_DECODE_INTER_FRAME_SIZE                       ((uint32_t)197260)
#define BDSP_IMG_AACHE_DECODE_SIZE                                   ((uint32_t)168144)
#define BDSP_IMG_AACHE_DECODE_TABLES_SIZE                            ((uint32_t)85852)
#define BDSP_IMG_AACHE_ENCODE_INTER_FRAME_SIZE                       ((uint32_t)178812)
#define BDSP_IMG_AACHE_ENCODE_SIZE                                   ((uint32_t)254972)
#define BDSP_IMG_AACHE_ENCODE_TABLES_SIZE                            ((uint32_t)23944)
#define BDSP_IMG_AC3_DECODE_INTER_FRAME_SIZE                         ((uint32_t)566564)
#define BDSP_IMG_AC3_DECODE_SIZE                                     ((uint32_t)186516)
#define BDSP_IMG_AC3_DECODE_TABLES_SIZE                              ((uint32_t)42288)
#define BDSP_IMG_AC3_IDS_INTER_FRAME_SIZE                            ((uint32_t)16880)
#define BDSP_IMG_AC3_IDS_SIZE                                        ((uint32_t)9568)
#define BDSP_IMG_AC4_DECODE_INTER_FRAME_SIZE                         ((uint32_t)8688288)
#define BDSP_IMG_AC4_DECODE_SIZE                                     ((uint32_t)441416)
#define BDSP_IMG_AC4_DECODE_TABLES_SIZE                              ((uint32_t)174080)
#define BDSP_IMG_AC4_IDS_INTER_FRAME_SIZE                            ((uint32_t)16880)
#define BDSP_IMG_AC4_IDS_SIZE                                        ((uint32_t)4240)
...
#define BDSP_IMG_ALGOLIB_CODE_SIZE                                   ((uint32_t)32960)
#define BDSP_IMG_ALGOLIB_TABLES_SIZE                                 ((uint32_t)13680)
#define BDSP_IMG_ALS_DECODE_INTER_FRAME_SIZE                         ((uint32_t)536)
#define BDSP_IMG_ALS_DECODE_SIZE                                     ((uint32_t)26600)
#define BDSP_IMG_ALS_DECODE_TABLES_SIZE                              ((uint32_t)928)
#define BDSP_IMG_ALS_IDS_INTER_FRAME_SIZE                            ((uint32_t)16880)
#define BDSP_IMG_ALS_IDS_SIZE                                        ((uint32_t)9012)
#define BDSP_IMG_AMBISONICS_CODE_SIZE                                ((uint32_t)14116)
...
#define BDSP_IMG_DD_TRANSCODE_SIZE                                   ((uint32_t)38620)
#define BDSP_IMG_DD_TRANSCODE_TABLES_SIZE                            ((uint32_t)10864)
#define BDSP_IMG_DOLBY_AACHE_DECODE_INTER_FRAME_SIZE                 ((uint32_t)409048)
#define BDSP_IMG_DOLBY_AACHE_DECODE_SIZE                             ((uint32_t)382120)
#define BDSP_IMG_DOLBY_AACHE_DECODE_TABLES_SIZE                      ((uint32_t)122016)
#define BDSP_IMG_DOLBY_MS_DDP_DECODE_INTER_FRAME_SIZE                ((uint32_t)62916)
#define BDSP_IMG_DOLBY_MS_DDP_DECODE_SIZE                            ((uint32_t)110944)
...
#define BDSP_IMG_DOLBY_PULSE_DECODE_SIZE                             ((uint32_t)401080)
#define BDSP_IMG_DOLBY_PULSE_DECODE_TABLES_SIZE                      ((uint32_t)126844)
#define BDSP_IMG_DPCMR_CODE_SIZE                                     ((uint32_t)48068)
...
#define BDSP_IMG_DRA_DECODE_SIZE                                     ((uint32_t)26784)
#define BDSP_IMG_DRA_DECODE_TABLES_SIZE                              ((uint32_t)37304)
#define BDSP_IMG_DRA_IDS_INTER_FRAME_SIZE                            ((uint32_t)16880)
#define BDSP_IMG_DRA_IDS_SIZE                                        ((uint32_t)2704)
...
#define BDSP_IMG_DTSHD_DECODE_SIZE                                   ((uint32_t)79704)
#define BDSP_IMG_DTSHD_DECODE_TABLES_SIZE                            ((uint32_t)129164)
#define BDSP_IMG_DTSHD_IDS_INTER_FRAME_SIZE                          ((uint32_t)16880)
#define BDSP_IMG_DTSHD_IDS_SIZE                                      ((uint32_t)11372)
#define BDSP_IMG_DTS_ENCODE_INTER_FRAME_SIZE                         ((uint32_t)37428)
#define BDSP_IMG_DTS_ENCODE_SIZE                                     ((uint32_t)31208)
#define BDSP_IMG_DTS_ENCODE_TABLES_SIZE                              ((uint32_t)44132)
#define BDSP_IMG_DTS_EXPRESS_DECODE_INTER_FRAME_SIZE                 ((uint32_t)39624)
#define BDSP_IMG_DTS_EXPRESS_DECODE_SIZE                             ((uint32_t)108284)
#define BDSP_IMG_DTS_EXPRESS_DECODE_TABLES_SIZE                      ((uint32_t)29920)
#define BDSP_IMG_DTS_EXPRESS_IDS_DECODE_SIZE                         ((uint32_t)7756)
#define BDSP_IMG_DTS_EXPRESS_IDS_INTER_FRAME_SIZE                    ((uint32_t)16880)
#define BDSP_IMG_DTS_IDS_INTER_FRAME_SIZE                            ((uint32_t)16880)
#define BDSP_IMG_DTS_IDS_SIZE                                        ((uint32_t)5000)
#define BDSP_IMG_DV258_CODE_SIZE                                     ((uint32_t)48088)
#define BDSP_IMG_DV258_INTER_FRAME_SIZE                              ((uint32_t)19048)
#define BDSP_IMG_DV258_TABLES_SIZE                                   ((uint32_t)2268)
#define BDSP_IMG_DVDLPCM_IDS_INTER_FRAME_SIZE                        ((uint32_t)16880)
#define BDSP_IMG_DVDLPCM_IDS_SIZE                                    ((uint32_t)4184)
#define BDSP_IMG_FADECTRL_CODE_SIZE                                  ((uint32_t)3764)
...
#define BDSP_IMG_FLAC_DECODE_SIZE                                    ((uint32_t)25748)
#define BDSP_IMG_FLAC_DECODE_TABLES_SIZE                             ((uint32_t)772)
#define BDSP_IMG_FLAC_IDS_INTER_FRAME_SIZE                           ((uint32_t)16880)
#define BDSP_IMG_FLAC_IDS_SIZE                                       ((uint32_t)3472)
#define BDSP_IMG_FW_MIXER_CODE_SIZE                                  ((uint32_t)32092)
...
#define BDSP_IMG_MAC_DECODE_SIZE                                     ((uint32_t)14716)
#define BDSP_IMG_MAC_DECODE_TABLES_SIZE                              ((uint32_t)2112)
#define BDSP_IMG_MAC_IDS_INTER_FRAME_SIZE                            ((uint32_t)16880)
#define BDSP_IMG_MAC_IDS_SIZE                                        ((uint32_t)3856)
#define BDSP_IMG_MIXER_DAPV2_CODE_SIZE                               ((uint32_t)199912)
#define BDSP_IMG_MIXER_DAPV2_IDS_INTER_FRAME_SIZE                    ((uint32_t)3996)
#define BDSP_IMG_MIXER_DAPV2_IDS_SIZE                                ((uint32_t)9104)
...
#define BDSP_IMG_MIXER_IDS_SIZE                                      ((uint32_t)3380)
#define BDSP_IMG_MLP_IDS_INTER_FRAME_SIZE                            ((uint32_t)16880)
...
#define BDSP_IMG_PCMWAV_DECODE_SIZE                                  ((uint32_t)10360)
#define BDSP_IMG_PCMWAV_DECODE_TABLES_SIZE                           ((uint32_t)4)
#define BDSP_IMG_PCMWAV_IDS_INTER_FRAME_SIZE                         ((uint32_t)16880)
#define BDSP_IMG_PCMWAV_IDS_SIZE                                     ((uint32_t)4136)
#define BDSP_IMG_PCM_IDS_INTER_FRAME_SIZE                            ((uint32_t)16880)
#define BDSP_IMG_PCM_IDS_SIZE                                        ((uint32_t)2224)
#define BDSP_IMG_RALBR_DECODE_INTER_FRAME_SIZE                       ((uint32_t)17872)
#define BDSP_IMG_RALBR_DECODE_SIZE                                   ((uint32_t)27184)
#define BDSP_IMG_RALBR_DECODE_TABLES_SIZE                            ((uint32_t)29012)
#define BDSP_IMG_RALBR_IDS_INTER_FRAME_SIZE                          ((uint32_t)16880)
#define BDSP_IMG_RALBR_IDS_SIZE                                      ((uint32_t)3432)
...
#define BDSP_IMG_SRS_TVOL_CODE_SIZE                                  ((uint32_t)22152)
#define BDSP_IMG_SRS_TVOL_INTER_FRAME_SIZE                           ((uint32_t)7344)
#define BDSP_IMG_SRS_TVOL_TABLES_SIZE                                ((uint32_t)4624)
#define BDSP_IMG_SYSLIB_CODE_SIZE                                    ((uint32_t)14668)
#define BDSP_IMG_SYSTEM_CODE_SIZE                                    ((uint32_t)72760)
#define BDSP_IMG_TRUEHD_DECODE_INTER_FRAME_SIZE                      ((uint32_t)5108)
#define BDSP_IMG_TRUEHD_DECODE_SIZE                                  ((uint32_t)60952)
#define BDSP_IMG_TRUEHD_DECODE_TABLES_SIZE                           ((uint32_t)4824)
#define BDSP_IMG_TSMCORRECTION_CODE_SIZE                             ((uint32_t)8656)
#define BDSP_IMG_TSMCORRECTION_INTER_FRAME_SIZE                      ((uint32_t)98440)
#define BDSP_IMG_TSMCORRECTION_TABLES_SIZE                           ((uint32_t)1024)
#define BDSP_IMG_UDC_DECODE_INTER_FRAME_SIZE                         ((uint32_t)566564)
#define BDSP_IMG_UDC_DECODE_SIZE                                     ((uint32_t)183000)
#define BDSP_IMG_UDC_DECODE_TABLES_SIZE                              ((uint32_t)42288)
#define BDSP_IMG_UDC_IDS_INTER_FRAME_SIZE                            ((uint32_t)16880)
#define BDSP_IMG_UDC_IDS_SIZE                                        ((uint32_t)9568)
#define BDSP_IMG_VIDEO_DECODE_TASK_CODE_SIZE                         ((uint32_t)4088)
#define BDSP_IMG_VIDEO_ENCODE_TASK_CODE_SIZE                         ((uint32_t)4796)
#define BDSP_IMG_VIDIDSCOMMON_CODE_SIZE                              ((uint32_t)6616)
#define BDSP_IMG_VIDIDSCOMMON_INTER_FRAME_SIZE                       ((uint32_t)2196)
#define BDSP_IMG_VOCALS_CODE_SIZE                                    ((uint32_t)4632)
...
#define BDSP_IMG_VORBIS_DECODE_SIZE                                  ((uint32_t)50168)
#define BDSP_IMG_VORBIS_DECODE_TABLES_SIZE                           ((uint32_t)26772)
#define BDSP_IMG_VORBIS_IDS_INTER_FRAME_SIZE                         ((uint32_t)16880)
#define BDSP_IMG_VORBIS_IDS_SIZE                                     ((uint32_t)4160)
#define BDSP_IMG_VP6_DECODE_INTER_FRAME_SIZE                         ((uint32_t)4472)
#define BDSP_IMG_VP6_DECODE_SIZE                                     ((uint32_t)57992)
#define BDSP_IMG_VP6_DECODE_TABLES_SIZE                              ((uint32_t)6824)
#define BDSP_IMG_VP6_IDS_INTER_FRAME_SIZE                            ((uint32_t)16880)
#define BDSP_IMG_VP6_IDS_SIZE                                        ((uint32_t)2156)
#define BDSP_IMG_WMA_DECODE_INTER_FRAME_SIZE                         ((uint32_t)32908)
#define BDSP_IMG_WMA_DECODE_SIZE                                     ((uint32_t)47840)
#define BDSP_IMG_WMA_DECODE_TABLES_SIZE                              ((uint32_t)36144)
#define BDSP_IMG_WMA_IDS_INTER_FRAME_SIZE                            ((uint32_t)16880)
#define BDSP_IMG_WMA_IDS_SIZE                                        ((uint32_t)4956)
#define BDSP_IMG_WMA_PRO_DECODE_INTER_FRAME_SIZE                     ((uint32_t)267936)
#define BDSP_IMG_WMA_PRO_DECODE_SIZE                                 ((uint32_t)290036)
#define BDSP_IMG_WMA_PRO_DECODE_TABLES_SIZE                          ((uint32_t)117468)
#define BDSP_IMG_WMA_PRO_IDS_INTER_FRAME_SIZE                        ((uint32_t)16880)
#define BDSP_IMG_WMA_PRO_IDS_SIZE                                    ((uint32_t)4900)
#define BDSP_IMG_X264_ENCODE_INTER_FRAME_SIZE                        ((uint32_t)38720)
#define BDSP_IMG_X264_ENCODE_SIZE                                    ((uint32_t)52468)
#define BDSP_IMG_X264_ENCODE_TABLES_SIZE                             ((uint32_t)201444)
#define BDSP_IMG_XVP8_ENCODE_INTER_FRAME_SIZE                        ((uint32_t)3123208)
#define BDSP_IMG_XVP8_ENCODE_SIZE                                    ((uint32_t)62544)
