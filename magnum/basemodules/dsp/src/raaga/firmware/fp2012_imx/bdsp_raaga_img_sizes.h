...
#define BDSP_IMG_AC4_DECODE_SIZE                                     ((uint32_t)440892)
...
#define BDSP_IMG_ALGOLIB_CODE_SIZE                                   ((uint32_t)12376)
...
#define BDSP_IMG_DDP_ENCODE_CODE_SIZE                                ((uint32_t)279116)
...
#define BDSP_IMG_DPCMR_CODE_SIZE                                     ((uint32_t)47828)
...
#define BDSP_IMG_MIXER_DAPV2_CODE_SIZE                               ((uint32_t)197224)
#define BDSP_IMG_MIXER_DAPV2_IDS_INTER_FRAME_SIZE                    ((uint32_t)3916)
#define BDSP_IMG_MIXER_DAPV2_IDS_SIZE                                ((uint32_t)8068)
...
#define BDSP_IMG_SYSTEM_CODE_SIZE                                    ((uint32_t)72128)
...
#define BDSP_IMG_VIDEO_ENCODE_TASK_CODE_SIZE                         ((uint32_t)4800)
...
#define BDSP_IMG_VORBIS_DECODE_SIZE                                  ((uint32_t)50176)
