...
#define BDSP_IMG_AC3_DECODE_SIZE                                     ((uint32_t)184808)
...
#define BDSP_IMG_AC4_DECODE_SIZE                                     ((uint32_t)440712)
...
#define BDSP_IMG_ALS_DECODE_SIZE                                     ((uint32_t)26692)
...
#define BDSP_IMG_DDP_DECODE_SIZE                                     ((uint32_t)184840)
#define BDSP_IMG_DDP_DECODE_TABLES_SIZE                              ((uint32_t)42288)
#define BDSP_IMG_DDP_ENCODE_CODE_SIZE                                ((uint32_t)276156)
...
#define BDSP_IMG_DDRE_CODE_SIZE                                      ((uint32_t)33296)
...
#define BDSP_IMG_DD_TRANSCODE_SIZE                                   ((uint32_t)38604)
...
#define BDSP_IMG_DOLBY_AACHE_DECODE_SIZE                             ((uint32_t)380688)
...
#define BDSP_IMG_DOLBY_MS_DDP_DECODE_SIZE                            ((uint32_t)110660)
...
#define BDSP_IMG_DOLBY_PULSE_DECODE_SIZE                             ((uint32_t)400384)
#define BDSP_IMG_DOLBY_PULSE_DECODE_TABLES_SIZE                      ((uint32_t)126844)
#define BDSP_IMG_DPCMR_CODE_SIZE                                     ((uint32_t)47720)
...
#define BDSP_IMG_MIXER_DAPV2_CODE_SIZE                               ((uint32_t)196756)
...
#define BDSP_IMG_TRUEHD_DECODE_SIZE                                  ((uint32_t)54236)
...
#define BDSP_IMG_UDC_DECODE_SIZE                                     ((uint32_t)181260)
