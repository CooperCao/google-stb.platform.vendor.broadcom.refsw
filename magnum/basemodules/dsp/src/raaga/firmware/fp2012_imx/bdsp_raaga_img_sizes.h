...
#define BDSP_IMG_AC4_DECODE_SIZE                                     ((uint32_t)440956)
...
#define BDSP_IMG_ALGOLIB_CODE_SIZE                                   ((uint32_t)32904)
...
#define BDSP_IMG_DDP_ENCODE_CODE_SIZE                                ((uint32_t)279696)
...
#define BDSP_IMG_DOLBY_AACHE_DECODE_SIZE                             ((uint32_t)381020)
...
#define BDSP_IMG_DOLBY_MS_DDP_DECODE_SIZE                            ((uint32_t)110884)
...
#define BDSP_IMG_DOLBY_PULSE_DECODE_SIZE                             ((uint32_t)400892)
#define BDSP_IMG_DOLBY_PULSE_DECODE_TABLES_SIZE                      ((uint32_t)126844)
#define BDSP_IMG_DPCMR_CODE_SIZE                                     ((uint32_t)48072)
...
#define BDSP_IMG_OUTPUTFORMATTER_CODE_SIZE                           ((uint32_t)1768)
...
#define BDSP_IMG_SYSTEM_CODE_SIZE                                    ((uint32_t)72768)
#define BDSP_IMG_TRUEHD_DECODE_INTER_FRAME_SIZE                      ((uint32_t)5108)
#define BDSP_IMG_TRUEHD_DECODE_SIZE                                  ((uint32_t)60956)
