...
#define BDSP_IMG_DDP_ENCODE_CODE_SIZE                                ((uint32_t)298448)
...
#define BDSP_IMG_UDC_DECODE_SIZE                                     ((uint32_t)236376)
