...
#define BDSP_IMG_AC3_DECODE_SIZE                                     ((uint32_t)183728)
...
#define BDSP_IMG_AC4_DECODE_SIZE                                     ((uint32_t)444840)
...
#define BDSP_IMG_DDP_DECODE_SIZE                                     ((uint32_t)183752)
#define BDSP_IMG_DDP_DECODE_TABLES_SIZE                              ((uint32_t)42288)
#define BDSP_IMG_DDP_ENCODE_CODE_SIZE                                ((uint32_t)277496)
...
#define BDSP_IMG_DOLBY_AACHE_DECODE_SIZE                             ((uint32_t)381260)
...
#define BDSP_IMG_DOLBY_PULSE_DECODE_SIZE                             ((uint32_t)401360)
...
#define BDSP_IMG_MIXER_DAPV2_CODE_SIZE                               ((uint32_t)196512)
...
#define BDSP_IMG_UDC_DECODE_SIZE                                     ((uint32_t)180216)
...
#define BDSP_IMG_WMA_PRO_DECODE_SIZE                                 ((uint32_t)285788)
