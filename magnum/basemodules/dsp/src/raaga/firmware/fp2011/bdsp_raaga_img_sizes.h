...
#define BDSP_IMG_AC4_DECODE_SIZE                                     ((uint32_t)445700)
...
#define BDSP_IMG_DOLBY_AACHE_DECODE_SIZE                             ((uint32_t)382156)
...
#define BDSP_IMG_IDSCOMMON_CODE_SIZE                                 ((uint32_t)35792)
...
#define BDSP_IMG_MIXER_DAPV2_CODE_SIZE                               ((uint32_t)199320)
#define BDSP_IMG_MIXER_DAPV2_IDS_INTER_FRAME_SIZE                    ((uint32_t)3964)
#define BDSP_IMG_MIXER_DAPV2_IDS_SIZE                                ((uint32_t)8516)
...
#define BDSP_IMG_PCMWAV_IDS_SIZE                                     ((uint32_t)4220)
...
#define BDSP_IMG_UDC_DECODE_SIZE                                     ((uint32_t)181332)
...
#define BDSP_IMG_VP6_IDS_SIZE                                        ((uint32_t)2200)
