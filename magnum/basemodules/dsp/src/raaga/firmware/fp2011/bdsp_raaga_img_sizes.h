...
#define BDSP_IMG_AC3_DECODE_SIZE                                     ((uint32_t)183808)
...
#define BDSP_IMG_AC4_DECODE_SIZE                                     ((uint32_t)434440)
...
#define BDSP_IMG_DDP_DECODE_SIZE                                     ((uint32_t)183832)
#define BDSP_IMG_DDP_DECODE_TABLES_SIZE                              ((uint32_t)42288)
#define BDSP_IMG_DDP_ENCODE_CODE_SIZE                                ((uint32_t)277500)
...
#define BDSP_IMG_DOLBY_AACHE_DECODE_SIZE                             ((uint32_t)213564)
...
#define BDSP_IMG_DOLBY_PULSE_DECODE_SIZE                             ((uint32_t)234136)
...
#define BDSP_IMG_DTS_EXPRESS_DECODE_SIZE                             ((uint32_t)109912)
...
#define BDSP_IMG_MIXER_DAPV2_CODE_SIZE                               ((uint32_t)195540)
...
#define BDSP_IMG_OPUS_ENCODE_CODE_SIZE                               ((uint32_t)179644)
...
#define BDSP_IMG_SCM3_DECODE_SIZE                                    ((uint32_t)112360)
...
#define BDSP_IMG_SYSTEM_CODE_SIZE                                    ((uint32_t)69800)
...
#define BDSP_IMG_UDC_DECODE_SIZE                                     ((uint32_t)180296)
...
#define BDSP_IMG_WMA_PRO_DECODE_SIZE                                 ((uint32_t)285288)
