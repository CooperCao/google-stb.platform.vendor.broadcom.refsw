...
#define BDSP_IMG_ALS_DECODE_SIZE                                     ((uint32_t)26224)
...
#define BDSP_IMG_FW_MIXER_CODE_SIZE                                  ((uint32_t)32340)
...
#define BDSP_IMG_IDSCOMMON_CODE_SIZE                                 ((uint32_t)35640)
...
#define BDSP_IMG_MPEG1_DECODE_SIZE                                   ((uint32_t)35224)
...
#define BDSP_IMG_SYSTEM_CODE_SIZE                                    ((uint32_t)68744)
...
#define BDSP_IMG_WMA_PRO_DECODE_SIZE                                 ((uint32_t)285484)
