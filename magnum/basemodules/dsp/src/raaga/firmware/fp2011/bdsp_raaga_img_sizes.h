...
#define BDSP_IMG_AC3_DECODE_SIZE                                     ((uint32_t)183872)
...
#define BDSP_IMG_AC4_DECODE_SIZE                                     ((uint32_t)434376)
...
#define BDSP_IMG_DDP_DECODE_SIZE                                     ((uint32_t)183896)
#define BDSP_IMG_DDP_DECODE_TABLES_SIZE                              ((uint32_t)42288)
#define BDSP_IMG_DDP_ENCODE_CODE_SIZE                                ((uint32_t)277444)
...
#define BDSP_IMG_DOLBY_AACHE_DECODE_SIZE                             ((uint32_t)213584)
...
#define BDSP_IMG_DTS_EXPRESS_DECODE_SIZE                             ((uint32_t)109944)
...
#define BDSP_IMG_G729_DECODE_SIZE                                    ((uint32_t)37904)
...
#define BDSP_IMG_IDSCOMMON_CODE_SIZE                                 ((uint32_t)35572)
...
#define BDSP_IMG_MIXER_DAPV2_CODE_SIZE                               ((uint32_t)195908)
...
#define BDSP_IMG_OPUS_DECODE_SIZE                                    ((uint32_t)94964)
...
#define BDSP_IMG_SCM3_DECODE_SIZE                                    ((uint32_t)112348)
...
#define BDSP_IMG_UDC_DECODE_SIZE                                     ((uint32_t)180360)
...
#define BDSP_IMG_VIDIDSCOMMON_CODE_SIZE                              ((uint32_t)6756)
...
#define BDSP_IMG_WMA_PRO_DECODE_SIZE                                 ((uint32_t)285224)
