...
#define BDSP_IMG_AC3_DECODE_SIZE                                     ((uint32_t)183936)
...
#define BDSP_IMG_CDB_PASSTHRU_CODE_SIZE                              ((uint32_t)29292)
...
#define BDSP_IMG_DDP_DECODE_SIZE                                     ((uint32_t)183960)
#define BDSP_IMG_DDP_DECODE_TABLES_SIZE                              ((uint32_t)42288)
#define BDSP_IMG_DDP_ENCODE_CODE_SIZE                                ((uint32_t)277832)
...
#define BDSP_IMG_DTS_EXPRESS_DECODE_SIZE                             ((uint32_t)109940)
...
#define BDSP_IMG_G729_DECODE_SIZE                                    ((uint32_t)37880)
...
#define BDSP_IMG_UDC_DECODE_SIZE                                     ((uint32_t)180424)
