...
#define BDSP_IMG_AC3_DECODE_SIZE                                     ((uint32_t)183860)
...
#define BDSP_IMG_AC4_DECODE_SIZE                                     ((uint32_t)444800)
...
#define BDSP_IMG_BRCM_3DSURROUND_CODE_SIZE                           ((uint32_t)7384)
...
#define BDSP_IMG_CDB_PASSTHRU_CODE_SIZE                              ((uint32_t)29268)
...
#define BDSP_IMG_DDP_DECODE_SIZE                                     ((uint32_t)183884)
#define BDSP_IMG_DDP_DECODE_TABLES_SIZE                              ((uint32_t)42288)
#define BDSP_IMG_DDP_ENCODE_CODE_SIZE                                ((uint32_t)280792)
...
#define BDSP_IMG_DOLBY_AACHE_DECODE_SIZE                             ((uint32_t)381276)
...
#define BDSP_IMG_DPCMR_CODE_SIZE                                     ((uint32_t)65152)
...
#define BDSP_IMG_ILBC_ENCODE_SIZE                                    ((uint32_t)30524)
...
#define BDSP_IMG_MIXER_DAPV2_CODE_SIZE                               ((uint32_t)196280)
#define BDSP_IMG_MIXER_DAPV2_IDS_INTER_FRAME_SIZE                    ((uint32_t)3916)
#define BDSP_IMG_MIXER_DAPV2_IDS_SIZE                                ((uint32_t)7864)
...
#define BDSP_IMG_MPEG1_DECODE_SIZE                                   ((uint32_t)35372)
...
#define BDSP_IMG_OPUS_DECODE_SIZE                                    ((uint32_t)98544)
...
#define BDSP_IMG_UDC_DECODE_SIZE                                     ((uint32_t)180348)
...
#define BDSP_IMG_VORBIS_DECODE_SIZE                                  ((uint32_t)50516)
...
#define BDSP_IMG_WMA_PRO_DECODE_SIZE                                 ((uint32_t)285712)
