...
#define BDSP_IMG_AC4_DECODE_SIZE                                     ((uint32_t)444908)
...
#define BDSP_IMG_ALGOLIB_CODE_SIZE                                   ((uint32_t)12876)
...
#define BDSP_IMG_DDP_ENCODE_CODE_SIZE                                ((uint32_t)280904)
...
#define BDSP_IMG_DPCMR_CODE_SIZE                                     ((uint32_t)65088)
...
#define BDSP_IMG_DTSHD_DECODE_SIZE                                   ((uint32_t)81688)
...
#define BDSP_IMG_DTS_EXPRESS_DECODE_SIZE                             ((uint32_t)109868)
...
#define BDSP_IMG_IDSCOMMON_CODE_SIZE                                 ((uint32_t)35676)
...
#define BDSP_IMG_MIXER_DAPV2_IDS_SIZE                                ((uint32_t)7968)
...
#define BDSP_IMG_OPUS_ENCODE_CODE_SIZE                               ((uint32_t)179620)
...
#define BDSP_IMG_WMA_PRO_DECODE_SIZE                                 ((uint32_t)285732)
