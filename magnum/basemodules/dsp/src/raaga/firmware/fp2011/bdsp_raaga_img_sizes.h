...
#define BDSP_IMG_AC3_DECODE_SIZE                                     ((uint32_t)183736)
...
#define BDSP_IMG_AC4_DECODE_SIZE                                     ((uint32_t)444528)
...
#define BDSP_IMG_ALS_DECODE_SIZE                                     ((uint32_t)26656)
...
#define BDSP_IMG_CDB_PASSTHRU_CODE_SIZE                              ((uint32_t)28708)
...
#define BDSP_IMG_DDP_DECODE_SIZE                                     ((uint32_t)183760)
#define BDSP_IMG_DDP_DECODE_TABLES_SIZE                              ((uint32_t)42288)
#define BDSP_IMG_DDP_ENCODE_CODE_SIZE                                ((uint32_t)277608)
...
#define BDSP_IMG_DOLBY_AACHE_DECODE_SIZE                             ((uint32_t)213408)
...
#define BDSP_IMG_DOLBY_PULSE_DECODE_SIZE                             ((uint32_t)233972)
...
#define BDSP_IMG_DTSHD_DECODE_SIZE                                   ((uint32_t)81712)
...
#define BDSP_IMG_DTS_EXPRESS_DECODE_SIZE                             ((uint32_t)109916)
...
#define BDSP_IMG_ISAC_ENCODE_SIZE                                    ((uint32_t)51988)
...
#define BDSP_IMG_MIXER_DAPV2_CODE_SIZE                               ((uint32_t)196248)
...
#define BDSP_IMG_OPUS_ENCODE_CODE_SIZE                               ((uint32_t)179628)
