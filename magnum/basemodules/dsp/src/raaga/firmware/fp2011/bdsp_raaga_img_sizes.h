...
#define BDSP_IMG_AC3_DECODE_SIZE                                     ((uint32_t)184284)
...
#define BDSP_IMG_AC4_DECODE_SIZE                                     ((uint32_t)445240)
...
#define BDSP_IMG_DDP_DECODE_SIZE                                     ((uint32_t)184308)
#define BDSP_IMG_DDP_DECODE_TABLES_SIZE                              ((uint32_t)42288)
#define BDSP_IMG_DDP_ENCODE_CODE_SIZE                                ((uint32_t)280964)
...
#define BDSP_IMG_DOLBY_MS_DDP_DECODE_SIZE                            ((uint32_t)123244)
...
#define BDSP_IMG_DOLBY_PULSE_DECODE_SIZE                             ((uint32_t)401580)
...
#define BDSP_IMG_G729_DECODE_SIZE                                    ((uint32_t)37884)
...
#define BDSP_IMG_MAC_DECODE_SIZE                                     ((uint32_t)14884)
...
#define BDSP_IMG_MIXER_DAPV2_CODE_SIZE                               ((uint32_t)198092)
...
#define BDSP_IMG_UDC_DECODE_SIZE                                     ((uint32_t)180804)
...
#define BDSP_IMG_WMA_PRO_DECODE_SIZE                                 ((uint32_t)285780)
