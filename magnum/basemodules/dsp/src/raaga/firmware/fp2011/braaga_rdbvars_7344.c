...
const uint32_t BDSP_IMG_system_rdbvars_array1[] = {
	...
	0x100a0124, /* RAAGA_DSP_DOLBY_LICENSE_OTP0_REGISTER */
#else /* B0/B1/B2 */
	0x100b4124, /* RAAGA_DSP_DOLBY_LICENSE_OTP0_REGISTER */
#endif
	0x00080000, /* RAAGA_DSP_DOLBY_LICENSE_OTP0_MASK */
	0x00000013, /* RAAGA_DSP_DOLBY_LICENSE_OTP0_SHIFT */
#if (BCHP_VER == BCHP_VER_A0)   /* A0 */
	0x100a0124, /* RAAGA_DSP_DOLBY_LICENSE_OTP1_REGISTER */
#else /* B0/B1/B2 */
	0x100b4124, /* RAAGA_DSP_DOLBY_LICENSE_OTP1_REGISTER */
#endif
	...
	0x1038ffff, /* MEM_PROTECT_REGION0_END */
	0x1039a6a0, /* MEM_PROTECT_REGION1_START */
	0x1039afff, /* MEM_PROTECT_REGION1_END */
	0x1039c000, /* MEM_PROTECT_REGION2_START */
	0x112fffff, /* MEM_PROTECT_REGION2_END */
	0x11400000, /* MEM_PROTECT_REGION3_START */
