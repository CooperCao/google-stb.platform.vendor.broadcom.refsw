...
#define BDSP_IMG_AACHELOAS_IDS_SIZE                                  ((uint32_t)4388)
#define BDSP_IMG_AACHE_DECODE_INTER_FRAME_SIZE                       ((uint32_t)184316)
#define BDSP_IMG_AACHE_DECODE_SIZE                                   ((uint32_t)189320)
...
#define BDSP_IMG_AC3_DECODE_SIZE                                     ((uint32_t)124836)
...
#define BDSP_IMG_CDB_PASSTHRU_CODE_SIZE                              ((uint32_t)33160)
...
#define BDSP_IMG_DDP_DECODE_SIZE                                     ((uint32_t)124952)
...
#define BDSP_IMG_FADECTRL_CODE_SIZE                                  ((uint32_t)4288)
...
#define BDSP_IMG_IDSCOMMON_CODE_SIZE                                 ((uint32_t)36920)
...
#define BDSP_IMG_SYSLIB_CODE_SIZE                                    ((uint32_t)17404)
...
#define BDSP_IMG_WMA_PRO_DECODE_SIZE                                 ((uint32_t)313280)
