...
#define BDSP_IMG_AC3_DECODE_SIZE                                     ((uint32_t)124860)
...
#define BDSP_IMG_DDP_DECODE_SIZE                                     ((uint32_t)124976)
...
#define BDSP_IMG_DOLBY_MS_DDP_DECODE_SIZE                            ((uint32_t)124988)
...
#define BDSP_IMG_DOLBY_PULSE_DECODE_SIZE                             ((uint32_t)461904)
...
#define BDSP_IMG_DV258_CODE_SIZE                                     ((uint32_t)62736)
...
#define BDSP_IMG_IDSCOMMON_CODE_SIZE                                 ((uint32_t)36956)
...
#define BDSP_IMG_VORBIS_DECODE_SIZE                                  ((uint32_t)55604)
