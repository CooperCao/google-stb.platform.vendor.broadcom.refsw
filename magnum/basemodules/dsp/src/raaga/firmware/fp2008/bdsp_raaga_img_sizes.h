...
#define BDSP_IMG_AC3_DECODE_SIZE                                     ((uint32_t)124840)
...
#define BDSP_IMG_ALGOLIB_CODE_SIZE                                   ((uint32_t)13560)
...
#define BDSP_IMG_CDB_PASSTHRU_CODE_SIZE                              ((uint32_t)33420)
...
#define BDSP_IMG_DDP_DECODE_SIZE                                     ((uint32_t)124956)
...
#define BDSP_IMG_DDRE_CODE_SIZE                                      ((uint32_t)42552)
...
#define BDSP_IMG_DOLBY_MS_DDP_DECODE_SIZE                            ((uint32_t)124968)
...
#define BDSP_IMG_DOLBY_PULSE_DECODE_SIZE                             ((uint32_t)461896)
...
#define BDSP_IMG_FW_MIXER_CODE_SIZE                                  ((uint32_t)36800)
...
#define BDSP_IMG_GEN_CDBITB_CODE_SIZE                                ((uint32_t)13592)
...
#define BDSP_IMG_IDSCOMMON_CODE_SIZE                                 ((uint32_t)36884)
...
#define BDSP_IMG_MIXER_DAPV2_IDS_SIZE                                ((uint32_t)8644)
...
#define BDSP_IMG_TSMCORRECTION_CODE_SIZE                             ((uint32_t)7868)
#define BDSP_IMG_TSMCORRECTION_INTER_FRAME_SIZE                      ((uint32_t)12328)
