...
#define BDSP_IMG_FW_MIXER_CODE_SIZE                                  ((uint32_t)35872)
...
#define BDSP_IMG_GEN_CDBITB_CODE_SIZE                                ((uint32_t)13608)
...
#define BDSP_IMG_IDSCOMMON_CODE_SIZE                                 ((uint32_t)36900)
...
#define BDSP_IMG_MIXER_IDS_SIZE                                      ((uint32_t)3400)
...
#define BDSP_IMG_MPEG1_DECODE_SIZE                                   ((uint32_t)37720)
...
#define BDSP_IMG_SRC_CODE_SIZE                                       ((uint32_t)19304)
...
#define BDSP_IMG_SYSTEM_CODE_SIZE                                    ((uint32_t)65664)
