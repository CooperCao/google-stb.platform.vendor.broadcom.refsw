...
#define BDSP_IMG_AC3_DECODE_SIZE                                     ((uint32_t)124984)
...
#define BDSP_IMG_DDP_DECODE_SIZE                                     ((uint32_t)125100)
...
#define BDSP_IMG_DOLBY_MS_DDP_DECODE_SIZE                            ((uint32_t)125112)
...
#define BDSP_IMG_DOLBY_PULSE_DECODE_SIZE                             ((uint32_t)462044)
...
#define BDSP_IMG_MIXER_DAPV2_IDS_SIZE                                ((uint32_t)9252)
