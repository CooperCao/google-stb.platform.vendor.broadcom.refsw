...
#define BDSP_IMG_FW_MIXER_CODE_SIZE                                  ((uint32_t)36644)
...
#define BDSP_IMG_IDSCOMMON_CODE_SIZE                                 ((uint32_t)36864)
...
#define BDSP_IMG_MIXER_DAPV2_IDS_SIZE                                ((uint32_t)8536)
...
#define BDSP_IMG_SRC_CODE_SIZE                                       ((uint32_t)19688)
