...
#define BDSP_IMG_AC3_DECODE_SIZE                                     ((uint32_t)124856)
...
#define BDSP_IMG_ALGOLIB_CODE_SIZE                                   ((uint32_t)35864)
...
#define BDSP_IMG_DDP_DECODE_SIZE                                     ((uint32_t)124972)
...
#define BDSP_IMG_DOLBY_MS_DDP_DECODE_SIZE                            ((uint32_t)124984)
...
#define BDSP_IMG_DOLBY_PULSE_DECODE_SIZE                             ((uint32_t)462064)
...
#define BDSP_IMG_IDSCOMMON_CODE_SIZE                                 ((uint32_t)37020)
...
#define BDSP_IMG_MIXER_DAPV2_IDS_SIZE                                ((uint32_t)8924)
...
#define BDSP_IMG_OPUS_DECODE_SIZE                                    ((uint32_t)106864)
...
#define BDSP_IMG_PCMWAV_DECODE_SIZE                                  ((uint32_t)14136)
...
#define BDSP_IMG_SRC_CODE_SIZE                                       ((uint32_t)19776)
