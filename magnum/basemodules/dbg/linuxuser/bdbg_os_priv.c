...
void
BDBG_P_GetTimeStamp_isrsafe(char *timeStamp, int size)
{
...
{
    (void)pthread_mutex_lock(&g_mutex); /* don't add BDBG_ASSERT, this is a low level BDBG functions that shouldn't use BDBG facilities */
    return;
}
